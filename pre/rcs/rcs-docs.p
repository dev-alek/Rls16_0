...
define variable vss-include-info6 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
    ...
    [
        "приход внешний",                                   'ie':U,             2,
        "расход внешний",                                   'ee':U,             0,
        "расход внешний возврат поставщику",                'ep':U,          3,
        "расход внешний продажа через кассу",               'es':U,        0,
        "возврат внешний",                                  're':U,         3,
        "возврат внешний через кассу",                      'rs':U,    0,
        "списание внешнее",                                 'we':U,             4,
        "инвентаризация",                                   'vt':U,                   6,
        "пересортица",                                      'vp':U,              6,
        "коррекция учетных цен",                            'ap':U,        6,
        "смена типа приобретения",                          'pc':U,        6,
        "корретировка отрицательных партий",                'mp':U,      6,
        "приход перемещение",                               'iv':U,             2,
        "расход перемещение",                               'ev':U,             0,
        "возврат перемещение",                              'rv':U,         3,
        "списание производство",                            'wm':U,              4,
        "приход производство",                              'im':U,              2,
        "документ переоценки",                              'ot':U,              5
    ]                                                           no-undo.
