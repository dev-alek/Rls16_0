...
assign
    p-gds-inf-po = integer(entry (1, v-param-list, chr(4)))
    p-gds-active = integer(entry (2, v-param-list, chr(4)))
    p-directory  = entry (3, v-param-list, chr(4))
    p-code_pnpo  = entry (4, v-param-list, chr(4))
    p-bge-active = logical(entry (5, v-param-list, chr(4)))
    p-bge-inf-po = logical(entry (6, v-param-list, chr(4)))
    p-per        = integer(ENTRY(7, v-param-list, chr(4)))
    .
