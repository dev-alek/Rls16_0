...
for each b-clients where b-clients.obj-type eq 'орг':U no-lock:
...
then do:
   ...
   mparent1 = substitute ("CashObj&1&2",chr(4),v-sys-key).
   for each b-clients where b-clients.obj-type = 'маг':U no-lock:
      create tt-code.
      assign
      ...
      mparent2 = substitute ("&2&1&3",chr(4),mparent1,tt-code.code).
