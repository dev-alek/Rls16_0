...
:
    ...
    assign
        v-parameter-list         =  substitute( "&1,&2,&3,&4,&5,&6,&7,&8,&9"
                                               , 4
                                               , "docName"          , "cashPay":U
                                               , "version"          , replace("12.3 " + replace( vss-revision + vss-date, "$", " " ),',','')
...
run bgelib-tag-put in this-procedure ( input 2, "payCode"        , input string( buf_cash-pay.pay-code          ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "payLimit"       , input string( buf_cash-pay.pay-limit         ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "wthCode"        , input string( buf_cash-pay.wth-code          ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "isCash"         , input string( buf_cash-pay.is-cash           ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "isCreditCard"   , input string( buf_cash-pay.is-credit-card    ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "isDebetCard"    , input string( buf_cash-pay.is-debet-card     ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "payCardView"    , input string( buf_cash-pay.pay-card-view     ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "atr1"           , input string( buf_cash-pay.atr1              ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "atr2"           , input string( buf_cash-pay.atr2              ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "atr4"           , input string( buf_cash-pay.atr4              ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "atr8"           , input string( buf_cash-pay.atr8              ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "atr16"          , input string( buf_cash-pay.atr16             ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "atr32"          , input string( buf_cash-pay.atr32             ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "atr64"          , input string( buf_cash-pay.atr64             ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "atr128"         , input string( buf_cash-pay.atr128            ), input 0 ).
