...
procedure create-mark :
    ...
    find first cr_gen-attr no-lock where cr_gen-attr.table-name = 'excise-mark':U
                                     and cr_gen-attr.p-key begins "parts"
                                     and num-entries (cr_gen-attr.p-key, chr(3)) >= 8
                                     and entry(8, cr_gen-attr.p-key, chr(3)) <> 'free-zone':U
                                     and cr_gen-attr.attr-code = p-mark no-error .
    if available cr_gen-attr
    then do :
        p-ok = false .
        p-mes = substitute ("Уже есть запись с маркой &1&2&3", p-mark, chr(10), cr_gen-attr.p-key)  .
        return .
    end.
    else do :
        find first cr_gen-attr no-lock where cr_gen-attr.table-name = 'excise-mark':U
        ...
        then do :
            ...
            create cr_gen-attr .
            assign
                cr_gen-attr.table-name = 'excise-mark':U
            ...
            then do :
                p-ok = false .
                p-mes = "Ошибка! " + chr(10) + error-status:get-message (1)  .
                return .
            end.
            else do :
                p-ok = true .
