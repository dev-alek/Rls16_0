...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  run fill-tt.
define variable vss-include-info0 as character format "x(65)" no-undo initial "@(#)$Workfile$ Библиотека изменения размеров окна".
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse br-objs-diff :handle
      .
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY br-objs-diff FOR EACH tt-objs-diff.
END PROCEDURE.
