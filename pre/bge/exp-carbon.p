...
DEFINE INPUT PARAMETER p-company AS char NO-UNDO.
DEFINE INPUT PARAMETER p-directory AS CHARACTER NO-UNDO.
DEFINE INPUT PARAMETER p-prefix AS char NO-UNDO.
DEFINE INPUT PARAMETER p-grp-fuel AS char NO-UNDO.
DEFINE INPUT PARAMETER p-grp-spec AS char NO-UNDO.
