...
assign
  v-str-recid8 = trim( string( recid( tt-objs ) , "->>>>>>>>>>>9":U ) )
  v-num-entry8 = lookup( v-str-recid8 , select-list )
.
if v-num-entry8 > 0 then do:
  assign
    entry( v-num-entry8, select-list ) = "":U
    select-list = trim( replace( select-list , chr(44) + chr(44) , chr(44) ) , chr(44) )
  .
end.
else do:
  assign
    select-list = select-list + ( if select-list = "":U then "":U else chr(44) ) + v-str-recid8
  .
end.
  end.
...
assign
  v-str-recid13 = trim( string( recid( tt-objs ) , "->>>>>>>>>>>9":U ) )
