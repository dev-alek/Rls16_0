...
define input parameter p-host-code       like ub.fin-ob-before.host-code no-undo .
define input parameter p-doc-code        like ub.fin-ob-before.before-code no-undo.
...
define variable vss-workfile    as character no-undo init "$Workfile: xmlfob.p $":U .
define variable vss-archive     as character no-undo init "$Archive: bge/xmlfob.p $":U .
define variable vss-description as character no-undo init "Выгрузка ПФО в формате xml".
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run basecode in g#library
  ...
  .
define stream fin-out.
if paroutput-file = ?  or
   paroutput-file = ""
   then do:
   output stream fin-out to value ("./" + "fb":U + string(p-doc-code) + ".tmp").
  ...
  if p-first-document then do:
    output stream fin-out to value (paroutput-file).
    run write-string in this-procedure
      (input '<?xml version="1.0" encoding="windows-1251"?>':u + chr(10) + '<root>':u + chr(10)
      ).
  end.
  else do:
    output stream fin-out to value(paroutput-file) append.
  end.
end.
 find first buf_fin-ob-before no-lock where
           buf_fin-ob-before.host-code = p-host-code
       AND buf_fin-ob-before.before-code = p-doc-code no-error .
if not available buf_fin-ob-before then do:
...
define variable vss-include-info3 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
  ...
  define variable v-suffix as character no-undo .
    assign
      ...
      v-suffix = chr(10)
    .
run write-string in this-procedure  (input (substitute("&1<&2>", fill( chr(32), 2 * (0 + 1) ), 'fin-ob-before') + chr(10)) ) .
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'DocID', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.before-code))) + v-suffix ) .
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'DocID_FO', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.doc-code))) + v-suffix ) .
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'Status_', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.status_))) + v-suffix ) .
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'host', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.host-code))) + v-suffix ) .
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'DateDoc', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.doc-date, '99.99.9999':U))) + v-suffix ) .
if buf_fin-ob-before.fact-date <> ? then do:
      run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'DateFact', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.fact-date, '99.99.9999':U))) + v-suffix ) .
end.
if buf_fin-ob-before.pay-date <> ? then do:
      run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'DatePay', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.pay-date, '99.99.9999':U))) + v-suffix ) .
end.
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'DocDBNum', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.user-db-num-doc))) + v-suffix ) .
if buf_fin-ob-before.fact-date <> ? then do:
      run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'FactDBNum', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.user-db-num-fact))) + v-suffix ) .
end.
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'DocUserName', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.user-name-doc))) + v-suffix ) .
if buf_fin-ob-before.fact-date <> ? then do:
      run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'FactUserName', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.user-name-fact))) + v-suffix ) .
end.
find first buf_currency no-lock where
...
v-exch-name = "":U
.
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'sumDoc', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.sum-doc))) + v-suffix ) .
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'CrcCode', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.curr-code))) + v-suffix ) .
...
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'CrcRate', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.exch-rate))) + v-suffix ) .
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'CrcScale', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.exch-scale))) + v-suffix ) .
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'actualCrcRate', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.actual-exch-rate))) + v-suffix ) .
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'actualCrcScale', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.actual-exch-scale))) + v-suffix ) .
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'sumRubl', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.sum-rubl))) + v-suffix ) .
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'sumBase', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.sum-base))) + v-suffix ) .
...
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'baseCrcRate', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.base-rate))) + v-suffix ) .
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'baseCrcScale', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.base-scale))) + v-suffix ) .
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'actualBaseCrcRate', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.actual-base-rate))) + v-suffix ) .
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'actualBaseCrcScale', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.actual-base-scale))) + v-suffix ) .
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'sum-tax-doc', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.sum-tax-doc))) + v-suffix ) .
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'sum-tax-rubl', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.sum-tax-rubl))) + v-suffix ) .
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'sum-tax-base', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.sum-tax-base))) + v-suffix ) .
if buf_fin-ob-before.contract-code <> 0 then do:
  ...
  .
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'contractCode', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.contract-code))) + v-suffix ) .
  ...
  v-contr-name = "":U
  .
      run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'sumcontract', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.sum-contr))) + v-suffix ) .
      run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'contractCrcCode', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.contract-curr))) + v-suffix ) .
  if v-exch-abbr <> "":U then do:
  ...
  if v-exch-name <> "":U then do:
      ...
      run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'contractCrcRate', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.contract-rate))) + v-suffix ) .
      run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'contractCrcScale', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.contract-scale))) + v-suffix ) .
      run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'actualContractCrcRate', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.actual-contract-rate))) + v-suffix ) .
      run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'actualContractCrcScale', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.actual-contract-scale))) + v-suffix ) .
      run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'sumTaxContract', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.sum-tax-contract))) + v-suffix ) .
end.
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'payer', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.payer-type + string(buf_fin-ob-before.payer-code)))) + v-suffix ) .
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'payerName', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.payer-name))) + v-suffix ) .
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'receiver', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.receiver-type + string(buf_fin-ob-before.receiver-code)))) + v-suffix ) .
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'receiverName', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.receiver-name))) + v-suffix ) .
run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'comment', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.PS))) + v-suffix ) .
run write-string in this-procedure (input (substitute("&1</&2>", fill( chr(32), 2 * (0 + 1) ), 'fin-ob-before') + chr(10))).
...
:
      run write-string in this-procedure  (input (substitute("&1<&2>", fill( chr(32), 2 * (0 + 1) ), 'taxLineBefore') + chr(10)) ) .
      run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'DocID', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-before.before-code))) + v-suffix ) .
      run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'taxLineNum', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-tax-before.line-num))) + v-suffix ) .
      run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'lineSumDoc', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-tax-before.sum-line-doc))) + v-suffix ) .
      run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'lineSumRubl', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-tax-before.sum-line-rubl))) + v-suffix ) .
      run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'lineSumBase', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-tax-before.sum-line-base))) + v-suffix ) .
  if buf_fin-ob-before.contract-code <> 0 then do:
            run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'lineSumContr', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-tax-before.sum-line-contr))) + v-suffix ) .
  end.
      run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'lineVatSumDoc', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-tax-before.sum-vat-line-doc))) + v-suffix ) .
      run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'lineVatSumRubl', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-tax-before.sum-vat-line-rubl))) + v-suffix ) .
      run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'lineVatSumBase', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-tax-before.sum-vat-line-base))) + v-suffix ) .
  if buf_fin-ob-before.contract-code <> 0 then do:
            run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'lineVatSumContr', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-tax-before.sum-vat-line-contr))) + v-suffix ) .
  end.
      run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'lineVat', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-tax-before.vat-pc))) + v-suffix ) .
      run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'lineWithVat', xml-doc_ReplaceSpecSymbols(string((if buf_fin-ob-tax-before.with-vat then "yes" else "no")))) + v-suffix ) .
  if buf_fin-ob-tax-before.SLT-pc <> 0 then do:
            run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'lineSLTSumDoc', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-tax-before.sum-SLT-line-doc))) + v-suffix ) .
            run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'lineSLTSumRubl', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-tax-before.sum-SLT-line-rubl))) + v-suffix ) .
            run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'lineSLTSumBase', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-tax-before.sum-SLT-line-base))) + v-suffix ) .
    if buf_fin-ob-before.contract-code <> 0 then do:
                  run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'lineSLTSumContr', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-tax-before.sum-SLT-line-contr))) + v-suffix ) .
    end.
            run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'lineSLT', xml-doc_ReplaceSpecSymbols(string(buf_fin-ob-tax-before.SLT-pc))) + v-suffix ) .
            run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'lineWithSLT', xml-doc_ReplaceSpecSymbols(string((if buf_fin-ob-tax-before.with-SLT then "yes" else "no")))) + v-suffix ) .
  end.
      run write-string in this-procedure (input (substitute("&1</&2>", fill( chr(32), 2 * (0 + 1) ), 'taxLineBefore') + chr(10))).
end.
...
:
  ...
  run write-string in this-procedure  (input v-prefix + substitute('<&1>&2</&1>', 'fact-date', xml-doc_ReplaceSpecSymbols(string(buf_fin-gds-part.fact-date))) + v-suffix ) .
...
output stream fin-out close.
if paroutput-file = ?  or
   paroutput-file = "" then do:
  if search ("./" + "fb":U + string(p-doc-code) + ".xml") <> ? then do:
     os-delete value ("./" + "fb":U + string(p-doc-code) + ".xml").
  end.
  os-copy value ("./" + "fb":U + string(p-doc-code) + ".tmp") value ("./" + "fb":U + string(p-doc-code) + ".xml").
  os-delete value ("./" + "fb":U +  string(p-doc-code) + ".tmp").
  run gbl/filename.p
  (
                  input "./" + "fb":U + string(p-doc-code) + ".xml"
...
procedure write-string :
 ...
 put stream fin-out unformatted parstring.
end.
