...
run write-log-and-file in p-log-handle (      input 1                                                          , input log-file-name                                              , input 1                                                          , input SUBSTITUTE("Удаление маршрутизации ВС.")).
...
do:
  ...
  .
    run write-log-and-file in p-log-handle (      input 1                                                          , input log-file-name                                              , input 1                                                          , input SUBSTITUTE("Установлено &1 дн. хранения пакетов.", v-day-shift)).
  do j = 1 to num-entries (v-rec-extsys-list, ',') .
    ...
    if not available ub.ext-system then next .
        run write-log-and-file in p-log-handle (      input 1                                                          , input log-file-name                                              , input 1                                                          , input SUBSTITUTE("ВС " + ub.ext-system.esys-name + " № " + string (ub.ext-system.esys-id) + ". Удаление..." )).
    ...
    :
      ...
      assign
        ...
        run write-log-and-file in p-log-handle (      input 1                                                          , input log-file-name                                              , input 1                                                          , input SUBSTITUTE("Удалено &1 пакетов ВС № &2.", kk, ub.ext-system.esys-id)).
    assign
      kk = 0 .
  end.
    run write-log-and-file in p-log-handle (      input 1                                                          , input log-file-name                                              , input 1                                                          , input SUBSTITUTE("Удаление завершено.")).
end.
else do:
    run write-log-and-file in p-log-handle (      input 1                                                          , input log-file-name                                              , input 1                                                          , input SUBSTITUTE("Не заданны параметры удаления. Удаление завершено.")).
end.
