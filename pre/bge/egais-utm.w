...
on choose of menu-item m_ver-xsd-1 in menu popup-menu-ver-xsd
DO:
  if AdmUtmObj:IsSent
  then do:
...
END.
on choose of menu-item m_ver-xsd-2 in menu popup-menu-ver-xsd
DO:
  if AdmUtmObj:IsSent
  then do:
    message "Запрос уже был отправлен. Дождитесь ответа." view-as alert-box error.
...
ON choose OF btn_dwl IN FRAME Dialog-Frame
do:
...
DO:
  ...
  run refresh-view.
END.
ON CHOOSE OF Btn_reqwb IN FRAME Dialog-Frame
DO:
...
END.
ON VALUE-CHANGED OF CB_typedoc IN FRAME Dialog-Frame
DO:
  apply "choose" to Btn_desmark in frame Dialog-Frame.
  run refresh-view.
END.
ON leave OF f_date IN FRAME Dialog-Frame
do:
  run refresh-view.
end.
ON return OF f_date IN FRAME Dialog-Frame
do:
  apply "choose" to Btn_desmark in frame Dialog-Frame.
  run refresh-view.
end.
...
DO:
  ...
  run refresh-view.
END.
ON VALUE-CHANGED OF tb_no_date IN FRAME Dialog-Frame
DO:
  apply "choose" to Btn_desmark in frame Dialog-Frame.
  run refresh-view.
END.
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse-hdl-analiz
      .
...
procedure get-context :
  ...
  CB_typedoc = "Все".
  assign
    btn_chg-xsd :popup-menu in frame Dialog-Frame = menu popup-menu-ver-xsd:handle
