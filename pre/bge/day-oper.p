...
:
    ...
    assign
        ...
        v-write-good                    = no
    .
    run form-turn-over in this-procedure ( input 'csdt':U, input 'ie':U          , input recid( buf_gds-obj ) ).
    run form-turn-over in this-procedure ( input 'csdt':U, input 'ee':U          , input recid( buf_gds-obj ) ).
    run form-turn-over in this-procedure ( input 'csdt':U, input 'ep':U       , input recid( buf_gds-obj ) ).
    run form-turn-over in this-procedure ( input 'csdt':U, input 'es':U     , input recid( buf_gds-obj ) ).
    run form-turn-over in this-procedure ( input 'csdt':U, input 're':U      , input recid( buf_gds-obj ) ).
    run form-turn-over in this-procedure ( input 'csdt':U, input 'rs':U , input recid( buf_gds-obj ) ).
    run form-turn-over in this-procedure ( input 'csdt':U, input 'we':U          , input recid( buf_gds-obj ) ).
    run form-turn-over in this-procedure ( input 'csdt':U, input 'vt':U                , input recid( buf_gds-obj ) ).
    run form-turn-over in this-procedure ( input 'csdt':U, input 'vp':U           , input recid( buf_gds-obj ) ).
    run form-turn-over in this-procedure ( input 'csdt':U, input 'ap':U     , input recid( buf_gds-obj ) ).
    run form-turn-over in this-procedure ( input 'csdt':U, input 'pc':U     , input recid( buf_gds-obj ) ).
    run form-turn-over in this-procedure ( input 'csdt':U, input 'mp':U   , input recid( buf_gds-obj ) ).
    run form-turn-over in this-procedure ( input 'csdt':U, input 'iv':U          , input recid( buf_gds-obj ) ).
    run form-turn-over in this-procedure ( input 'csdt':U, input 'ev':U          , input recid( buf_gds-obj ) ).
    run form-turn-over in this-procedure ( input 'csdt':U, input 'rv':U      , input recid( buf_gds-obj ) ).
    run form-turn-over in this-procedure ( input 'csdt':U, input 'em':U           , input recid( buf_gds-obj ) ).
    run form-turn-over in this-procedure ( input 'csdt':U, input 'wm':U           , input recid( buf_gds-obj ) ).
    run form-turn-over in this-procedure ( input 'csdt':U, input 'im':U           , input recid( buf_gds-obj ) ).
    run form-turn-over in this-procedure ( input 'csdt':U, input 'ot':U           , input recid( buf_gds-obj ) ).
    run form-stk in this-procedure ( input 'cost':U, input "cost", input recid( buf_gds-obj ) , output temp_good.qnty-first, output temp_good.qnty-last ).
    run form-stk in this-procedure ( input 'crsa':U, input "sale", input recid( buf_gds-obj ) , output v-qnty, output v-qnty ).
    if v-write-good = yes
    then do:
