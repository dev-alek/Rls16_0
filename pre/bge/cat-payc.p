...
define input parameter p-log-file-name  as character    no-undo.
    ...
    .
run wp-XMLTagOpen( input 2, input "paycode", input "").
...
run wp-XMLTagPut( input 3, "payCode"        , input string( buf_cash-pay.pay-code       ), input 0 ).
run wp-XMLTagPut( input 3, "payLimit"       , input string( buf_cash-pay.pay-limit      ), input 0 ).
run wp-XMLTagPut( input 3, "wthCode"        , input string( buf_cash-pay.wth-code       ), input 0 ).
run wp-XMLTagPut( input 3, "isCash"         , input string( buf_cash-pay.is-cash        ), input 0 ).
run wp-XMLTagPut( input 3, "isCreditCard"   , input string( buf_cash-pay.is-credit-card ), input 0 ).
run wp-XMLTagPut( input 3, "isDebetCard"    , input string( buf_cash-pay.is-debet-card  ), input 0 ).
run wp-XMLTagPut( input 3, "payCardView"    , input string( buf_cash-pay.pay-card-view  ), input 0 ).
run wp-XMLTagPut( input 3, "atr1"           , input string( buf_cash-pay.atr1           ), input 0 ).
run wp-XMLTagPut( input 3, "atr2"           , input string( buf_cash-pay.atr2           ), input 0 ).
run wp-XMLTagPut( input 3, "atr4"           , input string( buf_cash-pay.atr4           ), input 0 ).
run wp-XMLTagPut( input 3, "atr8"           , input string( buf_cash-pay.atr8           ), input 0 ).
run wp-XMLTagPut( input 3, "atr16"          , input string( buf_cash-pay.atr16          ), input 0 ).
run wp-XMLTagPut( input 3, "atr32"          , input string( buf_cash-pay.atr32          ), input 0 ).
run wp-XMLTagPut( input 3, "atr64"          , input string( buf_cash-pay.atr64          ), input 0 ).
run wp-XMLTagPut( input 3, "atr128"         , input string( buf_cash-pay.atr128         ), input 0 ).
run wp-XMLTagClose( input 2, input "paycode" ).
end.
end procedure.
