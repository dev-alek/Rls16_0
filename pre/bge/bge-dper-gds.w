...
define output parameter p-gds-type          as character init 'all' no-undo.
...
do:
  ...
  then do:
    ASSIGN
      date_from :POPUP-MENU in frame Dialog-Frame = MENU m-ed-date15 :HANDLE
      date_from :MENU-MOUSE in frame Dialog-Frame = 3
    .
  end.
  define variable v-label-handle15 as handle no-undo .
  assign
    v-label-handle15 = date_from :side-label-handle in frame Dialog-Frame
  .
...
do:
  ...
  then do:
    ASSIGN
      date_to :POPUP-MENU in frame Dialog-Frame = MENU m-ed-date17 :HANDLE
      date_to :MENU-MOUSE in frame Dialog-Frame = 3
    .
  end.
  define variable v-label-handle17 as handle no-undo .
  assign
    v-label-handle17 = date_to :side-label-handle in frame Dialog-Frame
  .
