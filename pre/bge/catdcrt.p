...
:
    ...
    assign
        v-parameter-list         =  substitute( "&1,&2,&3,&4,&5,&6,&7,&8,&9"
                                               , 4
                                               , "docName"          , "discCard":U
                                               , "version"          , replace("15.0 " + replace( vss-revision + vss-date, "$", " " ),',','')
...
run bgelib-tag-put in this-procedure ( input 2, "cardNum"        , input string( buf_dis-card.card-num           ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "sourceDCard"    , input string( buf_dis-card.sourced-card       ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "validDate"      , input string( buf_dis-card.valid-date         ), input 0 ).
...
run bgelib-tag-put in this-procedure ( input 2, "hostcode"       , input string( buf_dis-card.emitent-host-code  ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "isCreditCard"   , input string( buf_dis-card.credit-card        ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "creditLimit"    , input string( buf_dis-card.lim-kr             ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "pcntDiscount"   , input string( buf_dis-card.d-pcnt             ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "pcntDiscItog"   , input string( buf_dis-card.cash-d-pcnt        ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "pcntDiscMethod" , input string( buf_dis-card.d-pcnt-method      ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "issureCode"     , input string( buf_dis-card.issue-code         ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "issureDate"     , input string( buf_dis-card.issue-date         ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "saldoBase"      , input string( buf_dis-card.saldo-base         ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "saldoRubl"      , input string( buf_dis-card.saldo-rubl         ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "status"         , input string( buf_dis-card.status_            ), input 0 ).
run bgelib-tag-put in this-procedure ( input 2, "type"           , input string( buf_dis-card.type               ), input 0 ).
