...
define shared temp-table temp-host no-undo
  field host-code like ub.store.host-code
  index xpk host-code
.
define shared temp-table temp-obj no-undo
  field obj-type  like ub.clients.obj-type
  field obj-code  like ub.clients.obj-code
  field host-code like ub.store.host-code
...
:
  ...
  :
    ...
    on error undo, return error
    :
      if buf_c-fin-doc.status_ <> 'факт':U then NEXT export-deleted-documents.
...
run wp-xmltagopen in this-procedure ( input 0 + 4, substitute("&1", 'findoc'),  "" ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentDocID'),  input string(buf_fin-doc.fin-doc-code), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'cashbookid'),  input string(buf_fin-doc.cashbookid), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentCodeOperation'),  input string(buf_fin-doc.fin-ext-doc-type), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentStatus'),  input string(buf_fin-doc.status_), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'host'),  input string(buf_fin-doc.host-code), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentDocCode'),  input string(buf_fin-doc.prn-doc-code), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'object'),  input string(buf_fin-doc.obj-type + string(buf_fin-doc.obj-code)), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentDateDoc'),  input string(buf_fin-doc.doc-date, '99.99.9999'), input 1 ).
if buf_fin-doc.fact-date <> ? then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentDateFact'),  input string(buf_fin-doc.fact-date, '99.99.9999'), input 1 ).
end.
if buf_fin-doc.pay-date <> ? then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentDatePay'),  input string(buf_fin-doc.pay-date, '99.99.9999'), input 1 ).
end.
if buf_fin-doc.perm-date <> ? then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentDatePermission'),  input string(buf_fin-doc.perm-date, '99.99.9999'), input 1 ).
end.
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentDocDBNum'),  input string(buf_fin-doc.user-db-num-doc), input 1 ).
if buf_fin-doc.fact-date <> ? then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentFactDBNum'),  input string(buf_fin-doc.user-db-num-fact), input 1 ).
end.
if buf_fin-doc.pay-date <> ? then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentPayDBNum'),  input string(buf_fin-doc.user-db-num-pl), input 1 ).
end.
if buf_fin-doc.perm-date <> ? then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentPermissionDBNum'),  input string(buf_fin-doc.user-db-num-perm), input 1 ).
end.
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentDocUserName'),  input string(buf_fin-doc.user-name-doc), input 1 ).
if buf_fin-doc.fact-date <> ? then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentFactUserName'),  input string(buf_fin-doc.user-name-fact), input 1 ).
end.
if buf_fin-doc.pay-date <> ? then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentPayUserName'),  input string(buf_fin-doc.user-name-pl), input 1 ).
end.
if buf_fin-doc.perm-date <> ? then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentPermissionUserName'),  input string(buf_fin-doc.user-name-perm), input 1 ).
end.
find first buf_currency no-lock where
...
v-exch-name = "":U
.
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'sumDoc'),  input string(buf_fin-doc.sum-doc), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentCrcCode'),  input string(buf_fin-doc.curr-code), input 1 ).
if v-exch-abbr <> "":U then do:
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentCrcAbbr'),  input string(v-exch-abbr), input 1 ).
end.
if v-exch-name <> "":U then do:
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentCrcname'),  input string(v-exch-name), input 1 ).
end.
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentCrcRate'),  input string(buf_fin-doc.exch-rate), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentCrcScale'),  input string(buf_fin-doc.exch-scale), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'actualPaymentCrcRate'),  input string(buf_fin-doc.actual-exch-rate), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'actualPaymentCrcScale'),  input string(buf_fin-doc.actual-exch-scale), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'sumRubl'),  input string(buf_fin-doc.sum-rubl), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'sumBase'),  input string(buf_fin-doc.sum-base), input 1 ).
...
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'baseCrcRate'),  input string(buf_fin-doc.base-rate), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'baseCrcScale'),  input string(buf_fin-doc.base-scale), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'actualBaseCrcRate'),  input string(buf_fin-doc.actual-base-rate), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'actualBaseCrcScale'),  input string(buf_fin-doc.actual-base-scale), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'conStat'),  input string(buf_fin-doc.con-stat), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'conSumBase'),  input string(buf_fin-doc.con-sum-base), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'conSumRubl'),  input string(buf_fin-doc.con-sum-rubl), input 1 ).
if buf_fin-doc.contract-code <> 0 then do:
  ...
  .
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'contractCode'),  input string(buf_fin-doc.contract-code), input 1 ).
  ...
  v-contr-name = "":U
  .
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'sumcontract'),  input string(buf_fin-doc.sum-contr), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'contractCrcCode'),  input string(buf_fin-doc.contract-curr), input 1 ).
  if v-exch-abbr <> "":U then do:
  ...
  if v-exch-name <> "":U then do:
      ...
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'contractCrcRate'),  input string(buf_fin-doc.contract-rate), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'contractCrcScale'),  input string(buf_fin-doc.contract-scale), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'actualContractCrcRate'),  input string(buf_fin-doc.actual-contract-rate), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'actualContractCrcScale'),  input string(buf_fin-doc.actual-contract-scale), input 1 ).
end.
if buf_fin-doc.an-uchet-code <> 0 then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'analiticCode'),  input string(buf_fin-doc.an-uchet-code), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'analiticCodeValue'),  input string(buf_fin-doc.an-uchet-value), input 1 ).
end.
if buf_fin-doc.cel-nazn-code <> 0 then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'destinationCode'),  input string(buf_fin-doc.cel-nazn-code), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'destinationCodeValue'),  input string(buf_fin-doc.cel-nazn-value), input 1 ).
end.
if buf_fin-doc.cor-acc <> 0 then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'corAccCode'),  input string(buf_fin-doc.cor-acc), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'corAccCodeValue'),  input string(buf_fin-doc.cor-acc-value), input 1 ).
end.
if buf_fin-doc.cor-acc1 <> 0 then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'corAcc1Code'),  input string(buf_fin-doc.cor-acc1), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'corAcc1CodeValue'),  input string(buf_fin-doc.cor-acc1-value), input 1 ).
end.
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentPurpose'),  input string(replace(buf_fin-doc.naznach-plat, "@", "":U)), input 1 ).
if buf_fin-doc.fin-doc-type = 'пко':U
or buf_fin-doc.fin-doc-type = 'рко':U then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'enclosure'),  input string(buf_fin-doc.enclosure), input 1 ).
end.
if buf_fin-doc.fin-doc-type = 'пко':U
...
then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'strDepart'),  input string(buf_fin-doc.str-podr-type + string(buf_fin-doc.str-podr-code)), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'strDepartName'),  input string(buf_fin-doc.str-podr-name), input 1 ).
end.
...
or buf_fin-doc.fin-doc-type = 'апр':U then do:
  if num-entries(buf_fin-doc.payer-sign1, chr(4)) > 1 then do:
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'fromPayerHeadPosition'),  input string(entry(1, buf_fin-doc.payer-sign1, chr(4))), input 1 ).
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'fromPayer'),  input string(entry(2, buf_fin-doc.payer-sign1, chr(4))), input 1 ).
  end.
  else do:
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'fromPayer'),  input string(buf_fin-doc.payer-sign1), input 1 ).
  end.
  if num-entries(buf_fin-doc.receiver-sign1, chr(4)) > 1 then do:
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'fromReceiverHeadPosition'),  input string(entry(1, buf_fin-doc.receiver-sign1, chr(4))), input 1 ).
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'fromReceiver'),  input string(entry(2, buf_fin-doc.receiver-sign1, chr(4))), input 1 ).
  end.
  else do:
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'fromReceiver'),  input string(buf_fin-doc.receiver-sign1), input 1 ).
  end.
end.
if buf_fin-doc.fin-doc-type = 'пко':U then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'seniorAccounter'),  input string(buf_fin-doc.receiver-sign2), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'cashier'),  input string(buf_fin-doc.receiver-sign3), input 1 ).
end.
if buf_fin-doc.fin-doc-type = 'рко':U then do:
  if num-entries(buf_fin-doc.payer-sign1, chr(4)) > 1 then do:
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'payerHeadPosition'),  input string(entry(1, buf_fin-doc.payer-sign1, chr(4))), input 1 ).
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'payerDirector'),  input string(entry(2, buf_fin-doc.payer-sign1, chr(4))), input 1 ).
  end.
  else do:
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'payerDirector'),  input string(buf_fin-doc.payer-sign1), input 1 ).
  end.
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'seniorAccounter'),  input string(buf_fin-doc.payer-sign2), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'cashier'),  input string(buf_fin-doc.payer-sign3), input 1 ).
end.
...
if buf_fin-doc.fin-doc-type = 'пко':U then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'including'),  input string(replace(buf_fin-doc.including, "@":U, "":U)), input 1 ).
end.
if buf_fin-doc.fin-doc-type = 'ппп':U
or buf_fin-doc.fin-doc-type = 'рпп':U then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentQueue'),  input string(buf_fin-doc.ocher-pl), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentPurposeCode'),  input string(buf_fin-doc.nazn-pl), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'f22'),  input string(buf_fin-doc.f23), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'f23ReservField'),  input string(buf_fin-doc.f23), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'operationType'),  input string(buf_fin-doc.vid-opl), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentType'),  input string(buf_fin-doc.vid-plat), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentTerm'),  input string(buf_fin-doc.srok-pl), input 1 ).
  if buf_fin-doc.stat-pl <> "":U then do:
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'taxPayerStatus'),  input string(buf_fin-doc.stat-pl), input 1 ).
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'KBK'),  input string(buf_fin-doc.f104), input 1 ).
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'OKATO'),  input string(buf_fin-doc.f105), input 1 ).
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'taxPaymentBase'),  input string(buf_fin-doc.f106), input 1 ).
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'taxPeriod'),  input string(buf_fin-doc.f107), input 1 ).
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'taxDocumentNo'),  input string(buf_fin-doc.f108), input 1 ).
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'taxDocumentDAte'),  input string(buf_fin-doc.f109), input 1 ).
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'taxPaymentType'),  input string(buf_fin-doc.f110), input 1 ).
  end.
end.
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'payer'),  input string(buf_fin-doc.payer-type + string(buf_fin-doc.payer-code)), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'payerName'),  input string(buf_fin-doc.payer-name), input 1 ).
if buf_fin-doc.fin-doc-type = 'ппп':U
or buf_fin-doc.fin-doc-type = 'рпп':U then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'payerINN'),  input string(buf_fin-doc.payer-INN), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'payerKPP'),  input string(buf_fin-doc.payer-KPP), input 1 ).
  if false then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'payerOKPO'),  input string(buf_fin-doc.payer-OKPO), input 1 ).
  end.
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'payerBankName'),  input string((buf_fin-doc.payer-bank-name + chr(44) + chr(32) + buf_fin-doc.payer-bank-city)), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'payerBIK'),  input string(buf_fin-doc.payer-bIK), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'payerAccountCode'),  input string(buf_fin-doc.payer-code-schet), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'payerAccount'),  input string(buf_fin-doc.payer-r-schet), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'payerCorrAccount'),  input string(buf_fin-doc.payer-c-schet), input 1 ).
end.
if buf_fin-doc.payer-dop1 <> "":U then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'payerAddInfo1'),  input string(buf_fin-doc.payer-dop1), input 1 ).
end.
if buf_fin-doc.payer-dop2 <> "":U then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'payerAddInfo2'),  input string(buf_fin-doc.payer-dop2), input 1 ).
end.
if buf_fin-doc.payer-dop3 <> "":U then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'payerAddInfo3'),  input string(buf_fin-doc.payer-dop3), input 1 ).
end.
if buf_fin-doc.payer-dop4 <> "":U then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'payerAddInfo4'),  input string(buf_fin-doc.payer-dop4), input 1 ).
end.
if buf_fin-doc.fin-doc-type = 'пко':U
or buf_fin-doc.fin-doc-type = 'рко':U then do:
  if buf_fin-doc.payer-passport <> "":U then do:
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'payerPassport'),  input string(buf_fin-doc.payer-passport), input 1 ).
  end.
end.
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'receiver'),  input string(buf_fin-doc.receiver-type + string(buf_fin-doc.receiver-code)), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'receiverName'),  input string(buf_fin-doc.receiver-name), input 1 ).
if buf_fin-doc.fin-doc-type = 'ппп':U
or buf_fin-doc.fin-doc-type = 'рпп':U then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'receiverINN'),  input string(buf_fin-doc.receiver-INN), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'receiverKPP'),  input string(buf_fin-doc.receiver-KPP), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'receiverBankName'),  input string((buf_fin-doc.receiver-bank-name + chr(44) + chr(32) + buf_fin-doc.receiver-bank-city)), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'receiverBIK'),  input string(buf_fin-doc.receiver-bIK), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'receiverAccountCode'),  input string(buf_fin-doc.receiver-code-schet), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'receiverAccount'),  input string(buf_fin-doc.receiver-r-schet), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'receiverCorrAccount'),  input string(buf_fin-doc.receiver-c-schet), input 1 ).
end.
if buf_fin-doc.fin-doc-type = 'пко':U or buf_fin-doc.fin-doc-type = 'апп':U then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'receiverOKPO'),  input string(buf_fin-doc.receiver-OKPO), input 1 ).
end.
if buf_fin-doc.receiver-dop1 <> "":U then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'receiverAddInfo1'),  input string(buf_fin-doc.receiver-dop1), input 1 ).
end.
if buf_fin-doc.receiver-dop2 <> "":U then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'receiverAddInfo2'),  input string(buf_fin-doc.receiver-dop2), input 1 ).
end.
if buf_fin-doc.receiver-dop3 <> "":U then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'receiverAddInfo3'),  input string(buf_fin-doc.receiver-dop3), input 1 ).
end.
if buf_fin-doc.receiver-dop4 <> "":U then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'receiverAddInfo4'),  input string(buf_fin-doc.receiver-dop4), input 1 ).
end.
if buf_fin-doc.fin-doc-type = 'пко':U
or buf_fin-doc.fin-doc-type = 'рко':U then do:
  if buf_fin-doc.receiver-passport <> "":U then do:
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'receiverPassport'),  input string(buf_fin-doc.receiver-passport), input 1 ).
  end.
end.
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'comment'),  input string(buf_fin-doc.PS), input 1 ).
run wp-xmltagclose in this-procedure ( input 0 + 4, substitute("&1", 'findoc')).
...
:
      ...
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'paymentDocID'),  input string(buf_fin-doc.fin-doc-code), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'cashbookid'),  input string(buf_fin-doc.cashbookid), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'taxLineNum'),  input string(buf_fin-doc-tax.line-num), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'lineSumDoc'),  input string(buf_fin-doc-tax.sum-line-doc), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'lineSumRubl'),  input string(buf_fin-doc-tax.sum-line-rubl), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'lineSumBase'),  input string(buf_fin-doc-tax.sum-line-base), input 1 ).
  if buf_fin-doc.contract-code <> 0 then do:
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'lineSumContr'),  input string(buf_fin-doc-tax.sum-line-contr), input 1 ).
  end.
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'lineVatSumDoc'),  input string(buf_fin-doc-tax.sum-vat-line-doc), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'lineVatSumRubl'),  input string(buf_fin-doc-tax.sum-vat-line-rubl), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'lineVatSumBase'),  input string(buf_fin-doc-tax.sum-vat-line-base), input 1 ).
  if buf_fin-doc.contract-code <> 0 then do:
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'lineVatSumContr'),  input string(buf_fin-doc-tax.sum-vat-line-contr), input 1 ).
  end.
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'lineVat'),  input string(buf_fin-doc-tax.vat-pc), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'lineWithVat'),  input string((if buf_fin-doc-tax.with-vat then "yes" else "no")), input 1 ).
