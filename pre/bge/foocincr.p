...
:
  ...
  :
     find first buf_fin-ob-attr no-lock where
      ...
      AND buf_fin-ob-attr.attr-code = 'bge-date':U no-error .
...
run wp-xmltagopen in this-procedure ( input 0 + 4, substitute("&1", 'fin-ob'),  "" ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'DocID'),  input string(buf_fin-ob.doc-code), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'Status_'),  input string(buf_fin-ob.status_), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'host'),  input string(buf_fin-ob.host-code), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'DocCode'),  input string(buf_fin-ob.prn-doc-code), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'object'),  input string(buf_fin-ob.obj-type + string(buf_fin-ob.obj-code)), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'DateDoc'),  input string(buf_fin-ob.doc-date, '99.99.9999'), input 1 ).
if buf_fin-ob.fact-date <> ? then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'DateFact'),  input string(buf_fin-ob.fact-date, '99.99.9999'), input 1 ).
end.
if buf_fin-ob.pay-date <> ? then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'DatePay'),  input string(buf_fin-ob.pay-date, '99.99.9999'), input 1 ).
end.
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'DocDBNum'),  input string(buf_fin-ob.user-db-num-doc), input 1 ).
if buf_fin-ob.fact-date <> ? then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'FactDBNum'),  input string(buf_fin-ob.user-db-num-fact), input 1 ).
end.
if buf_fin-ob.pay-date <> ? then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'PayDBNum'),  input string(buf_fin-ob.user-db-num-pay), input 1 ).
end.
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'DocUserName'),  input string(buf_fin-ob.user-name-doc), input 1 ).
if buf_fin-ob.fact-date <> ? then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'FactUserName'),  input string(buf_fin-ob.user-name-fact), input 1 ).
end.
if buf_fin-ob.pay-date <> ? then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'PayUserName'),  input string(buf_fin-ob.user-name-pay), input 1 ).
end.
find first buf_currency no-lock where
...
v-exch-name = "":U
.
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'sumDoc'),  input string(buf_fin-ob.sum-doc), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'CrcCode'),  input string(buf_fin-ob.curr-code), input 1 ).
if v-exch-abbr <> "":U then do:
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'CrcAbbr'),  input string(v-exch-abbr), input 1 ).
end.
if v-exch-name <> "":U then do:
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'Crcname'),  input string(v-exch-name), input 1 ).
end.
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'CrcRate'),  input string(buf_fin-ob.exch-rate), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'CrcScale'),  input string(buf_fin-ob.exch-scale), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'actualCrcRate'),  input string(buf_fin-ob.actual-exch-rate), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'actualCrcScale'),  input string(buf_fin-ob.actual-exch-scale), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'sumRubl'),  input string(buf_fin-ob.sum-rubl), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'sumBase'),  input string(buf_fin-ob.sum-base), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'baseCrcCode'),  input string(v-base-code), input 1 ).
if v-base-abbr <> "":U then do:
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'baseCrcAbbr'),  input string(v-base-abbr), input 1 ).
end.
if v-base-name <> "":U then do:
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'baseCrcname'),  input string(v-base-name), input 1 ).
end.
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'baseCrcRate'),  input string(buf_fin-ob.base-rate), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'baseCrcScale'),  input string(buf_fin-ob.base-scale), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'actualBaseCrcRate'),  input string(buf_fin-ob.actual-base-rate), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'actualBaseCrcScale'),  input string(buf_fin-ob.actual-base-scale), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'conStat'),  input string(buf_fin-ob.con-stat), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'conSumBase'),  input string(buf_fin-ob.con-sum-base), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'conSumRubl'),  input string(buf_fin-ob.con-sum-rubl), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'sum-tax-doc'),  input string(buf_fin-ob.sum-tax-doc), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'sum-tax-rubl'),  input string(buf_fin-ob.sum-tax-rubl), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'sum-tax-base'),  input string(buf_fin-ob.sum-tax-base), input 1 ).
               run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'conSumDoc'),  input string(buf_fin-ob.con-sum-doc), input 1 ).
if buf_fin-ob.contract-code <> 0 then do:
  ...
  .
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'contractCode'),  input string(buf_fin-ob.contract-code), input 1 ).
  if v-contract-prn-code <> "":U then do:
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'contractNo'),  input string(v-contract-prn-code), input 1 ).
  end.
  if v-contract-date <> ? then do:
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'contractDate'),  input string(v-contract-date, '99.99.9999'), input 1 ).
  end.
  find first buf_currency no-lock where
  ...
  v-contr-name = "":U
  .
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'sumcontract'),  input string(buf_fin-ob.sum-contr), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'contractCrcCode'),  input string(buf_fin-ob.contract-curr), input 1 ).
  if v-exch-abbr <> "":U then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'contractCrcAbbr'),  input string(v-contr-abbr), input 1 ).
  end.
  if v-exch-name <> "":U then do:
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'contractCrcname'),  input string(v-contr-name), input 1 ).
  end.
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'contractCrcRate'),  input string(buf_fin-ob.contract-rate), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'contractCrcScale'),  input string(buf_fin-ob.contract-scale), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'actualContractCrcRate'),  input string(buf_fin-ob.actual-contract-rate), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'actualContractCrcScale'),  input string(buf_fin-ob.actual-contract-scale), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'conSumcontract'),  input string(buf_fin-ob.con-sum-contr), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'sumTaxContract'),  input string(buf_fin-ob.sum-tax-contract), input 1 ).
end.
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'payer'),  input string(buf_fin-ob.payer-type + string(buf_fin-ob.payer-code)), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'payerName'),  input string(buf_fin-ob.payer-name), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'receiver'),  input string(buf_fin-ob.receiver-type + string(buf_fin-ob.receiver-code)), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'receiverName'),  input string(buf_fin-ob.receiver-name), input 1 ).
run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'comment'),  input string(buf_fin-ob.PS), input 1 ).
run wp-xmltagclose in this-procedure ( input 0 + 4, substitute("&1", 'fin-ob')).
...
on error undo, return error
:
      run wp-xmltagopen in this-procedure ( input 0 + 4, substitute("&1", 'taxLine'),  "" ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'DocID'),  input string(buf_fin-ob.doc-code), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'taxLineNum'),  input string(buf_fin-ob-tax.line-num), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'lineSumDoc'),  input string(buf_fin-ob-tax.sum-line-doc), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'lineSumRubl'),  input string(buf_fin-ob-tax.sum-line-rubl), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'lineSumBase'),  input string(buf_fin-ob-tax.sum-line-base), input 1 ).
  if buf_fin-ob.contract-code <> 0 then do:
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'lineSumContr'),  input string(buf_fin-ob-tax.sum-line-contr), input 1 ).
  end.
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'lineVatSumDoc'),  input string(buf_fin-ob-tax.sum-vat-line-doc), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'lineVatSumRubl'),  input string(buf_fin-ob-tax.sum-vat-line-rubl), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'lineVatSumBase'),  input string(buf_fin-ob-tax.sum-vat-line-base), input 1 ).
  if buf_fin-ob.contract-code <> 0 then do:
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'lineVatSumContr'),  input string(buf_fin-ob-tax.sum-vat-line-contr), input 1 ).
  end.
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'lineVat'),  input string(buf_fin-ob-tax.vat-pc), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'lineWithVat'),  input string((if buf_fin-ob-tax.with-vat then "yes" else "no")), input 1 ).
  if buf_fin-ob-tax.SLT-pc <> 0 then do:
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'lineSLTSumDoc'),  input string(buf_fin-ob-tax.sum-SLT-line-doc), input 1 ).
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'lineSLTSumRubl'),  input string(buf_fin-ob-tax.sum-SLT-line-rubl), input 1 ).
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'lineSLTSumBase'),  input string(buf_fin-ob-tax.sum-SLT-line-base), input 1 ).
    if buf_fin-ob.contract-code <> 0 then do:
                  run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'lineSLTSumContr'),  input string(buf_fin-ob-tax.sum-SLT-line-contr), input 1 ).
    end.
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'lineSLT'),  input string(buf_fin-ob-tax.SLT-pc), input 1 ).
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'lineWithSLT'),  input string((if buf_fin-ob-tax.with-SLT then "yes" else "no")), input 1 ).
  end.
      run wp-xmltagclose in this-procedure ( input 0 + 4, substitute("&1", 'taxLine')).
end.
...
on error undo, return error
:
      run wp-xmltagopen in this-procedure ( input 0 + 4, substitute("&1", 'finObTrn'),  "" ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'DocID'),  input string(buf_fin-ob.doc-code), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'TrnDocId'),  input string(buf_fin-ob-trn.trn-doc-code), input 1 ).
  if buf_fin-ob-trn.ps <> "" then do:
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'Comment'),  input string(buf_fin-ob-trn.ps), input 1 ).
  end.
      run wp-xmltagclose in this-procedure ( input 0 + 4, substitute("&1", 'finObTrn')).
end.
...
on error undo, return error
:
      run wp-xmltagopen in this-procedure ( input 0 + 4, substitute("&1", 'finParts'),  "" ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'DocID'),  input string(buf_fin-gds-part.fin-ob-code), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'gds-code'),  input string(buf_fin-gds-part.gds-code), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'doc-qnty'),  input string(buf_fin-gds-part.doc-qnty), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'exch-rate'),  input string(buf_fin-gds-part.exch-rate), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'exch-scale'),  input string(buf_fin-gds-part.exch-scale), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'base-rate'),  input string(buf_fin-gds-part.base-rate), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'base-scale'),  input string(buf_fin-gds-part.base-scale), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'fact-date'),  input string(buf_fin-gds-part.fact-date, '99.99.9999'), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'fact-qnty'),  input string(buf_fin-gds-part.fact-qnty), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'fact-time'),  input string(buf_fin-gds-part.fact-time), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'part-code'),  input string(buf_fin-gds-part.part-code), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'in-code'),  input string(buf_fin-gds-part.in-code), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'out-code'),  input string(buf_fin-gds-part.out-code), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'object'),  input string(buf_fin-gds-part.obj-type + string(buf_fin-gds-part.obj-code)), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'other-base'),  input string(buf_fin-gds-part.other-base), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'other-contract'),  input string(buf_fin-gds-part.other-contract), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'other-rubl'),  input string(buf_fin-gds-part.other-rubl), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'road-tax-base'),  input string(buf_fin-gds-part.road-tax-base), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'road-tax-contract'),  input string(buf_fin-gds-part.road-tax-contract), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'road-tax-rubl'),  input string(buf_fin-gds-part.road-tax-rubl), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'status_dop'),  input string(buf_fin-gds-part.status_dop), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'sum-base'),  input string(buf_fin-gds-part.sum-base), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'sum-contract'),  input string(buf_fin-gds-part.sum-contract), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'sum-rubl'),  input string(buf_fin-gds-part.sum-rubl), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'transport-base'),  input string(buf_fin-gds-part.transport-base), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'transport-contract'),  input string(buf_fin-gds-part.transport-contract), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'transport-rubl'),  input string(buf_fin-gds-part.transport-rubl), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'user-db-num'),  input string(buf_fin-gds-part.user-db-num), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'user-name'),  input string(buf_fin-gds-part.user-name), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'vat-pc'),  input string(buf_fin-gds-part.vat-pc), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'vat-type'),  input string(buf_fin-gds-part.vat-type), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'vat-rubl'),  input string(buf_fin-gds-part.vat-rubl), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'vat-base'),  input string(buf_fin-gds-part.vat-base), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'vat-contract'),  input string(buf_fin-gds-part.vat-contract), input 1 ).
  if buf_fin-gds-part.SLT-pc <> 0 then do:
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'SLT-pc'),  input string(buf_fin-gds-part.SLT-pc), input 1 ).
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'SLT-type'),  input string(buf_fin-gds-part.SLT-type), input 1 ).
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'slt-rubl'),  input string(buf_fin-gds-part.slt-rubl), input 1 ).
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'slt-base'),  input string(buf_fin-gds-part.slt-base), input 1 ).
            run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'slt-contract'),  input string(buf_fin-gds-part.slt-contract), input 1 ).
  end.
      run wp-xmltagclose in this-procedure ( input 0 + 4, substitute("&1", 'finParts')).
end.
...
on error undo, return error
:
      run wp-xmltagopen in this-procedure ( input 0 + 4, substitute("&1", 'finConnect'),  "" ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'DocID'),  input string(buf_fin-connect.fin-ob-code), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'PS'),  input string(buf_fin-connect.PS), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'base-rate'),  input string(buf_fin-connect.base-rate), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'base-scale'),  input string(buf_fin-connect.base-scale), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'connect-code'),  input string(buf_fin-connect.connect-code), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'contract-code'),  input string(buf_fin-connect.contract-code), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'contract-curr'),  input string(buf_fin-connect.contract-curr), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'contract-rate'),  input string(buf_fin-connect.contract-rate), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'contract-scale'),  input string(buf_fin-connect.contract-scale), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'curr-code'),  input string(buf_fin-connect.curr-code), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'exch-rate'),  input string(buf_fin-connect.exch-rate), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'exch-scale'),  input string(buf_fin-connect.exch-scale), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'fact-date'),  input string(buf_fin-connect.fact-date, '99.99.9999'), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'fact-time'),  input string(buf_fin-connect.fact-time), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'fin-doc-code'),  input string(buf_fin-connect.fin-doc-code), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'host'),  input string(buf_fin-connect.host-code), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'status_'),  input string(buf_fin-connect.status_), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'sum-base-ob'),  input string(buf_fin-connect.sum-base-ob), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'sum-base'),  input string(buf_fin-connect.sum-base), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'sum-contr-ob'),  input string(buf_fin-connect.sum-contr-ob), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'sum-contr'),  input string(buf_fin-connect.sum-contr), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'sum-doc'),  input string(buf_fin-connect.sum-doc), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'sum-rubl-ob'),  input string(buf_fin-connect.sum-rubl-ob), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'sum-rubl'),  input string(buf_fin-connect.sum-rubl), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'user-db-num'),  input string(buf_fin-connect.user-db-num), input 1 ).
      run wp-xmltagput in this-procedure ( input 1 + 4, input substitute('&1', 'user-name'),  input string(buf_fin-connect.user-name), input 1 ).
      run wp-xmltagclose in this-procedure ( input 0 + 4, substitute("&1", 'finConnect')).
end.
