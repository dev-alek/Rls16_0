...
assign
  ...
  v-place  = integer(entry(2,v-param-list,chr(4)))
     v-login = entry(3,v-param-list,chr(4))
    v-password = entry(4,v-param-list,chr(4))
    v-code_TNP =entry(5,v-param-list,chr(4))
    v-code_pool = entry(6,v-param-list,chr(4))
    v-code_system = integer(entry(7,v-param-list,chr(4)))
