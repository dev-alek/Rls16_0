...
define input parameter p-r-b-is-base    as logical          no-undo.
    ...
    define variable v-GoodsGrpCode as character no-undo.
    define variable v-GoodsPackQnty as character no-undo.
    define variable v-GoodsUnitBase as character no-undo.
    define variable v-GoodsPS as character no-undo.
    define variable v-GoodsCountryName as character no-undo.
    define variable v-GoodsEnglName as character no-undo.
    define variable v-GoodsProdName as character no-undo.
    define variable v-GoodsWeight as character no-undo.
    define variable v-GoodsWidth as character no-undo.
    define variable v-GoodsLength as character no-undo.
    define variable v-GoodsHeight as character no-undo.
...
:
    find last buf_cost_stk-line no-lock
        where buf_cost_stk-line.obj-type  = p-obj-type
          ...
          and buf_cost_stk-line.sum-type  = 'cost':U
          and buf_cost_stk-line.cat-id    = '##,##':U
    ...
    find last buf_crsa_stk-line no-lock
        where buf_crsa_stk-line.obj-type  = p-obj-type
          ...
          and buf_crsa_stk-line.sum-type  = 'crsa':U
          and buf_crsa_stk-line.cat-id    = '##,##':U
    ...
    then do:
        ...
        if p-parts = "yes" then do:
          for each buf_reserv_parts where buf_reserv_parts.artic = p-artic
                                  ...
                                  and buf_reserv_parts.out-code = 'free-zone':U:
                assign
