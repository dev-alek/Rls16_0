...
DEF VAR iRep       AS INTEGER  INIT 0      NO-UNDO.
DEF VAR ErrorLevel AS INTEGER              NO-UNDO.
DEF VAR iOperNum   AS INTEGER              NO-UNDO.
...
ASSIGN sLogFile = sHomeDir + "\" + "Actions.log".
...
RUN wp-XMLTagOpen(2, "manifest","").
RUN wp-XMLTagOpen(3, "document","").
RUN wp-XMLTagPut(4, "name","kass", 0).
RUN wp-XMLTagPut(4, "description","", 0).
RUN wp-XMLTagClose(3, "document").
RUN wp-XMLTagClose(2, "manifest").
RUN wp-XMLTagClose(1, "header").
