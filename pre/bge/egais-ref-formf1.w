...
DO:
  ...
  do while qh-journal-egais:get-next ():
    ...
    if glog then do :
      ...
      then do:
        put stream str1 unformatted chr(10) + egaisFormF1:Msg.
      ...
      do ii = 1 to ExtFormF1Obj:NumBundles:
        ...
        put stream str1 unformatted chr(10) substitute ('Запись &1/&2 обновлена', bh-egais-goods:buffer-field ('alcCode'):buffer-value (), bh-egais-goods:buffer-field ('formF1Code'):buffer-value () ).
        jj = jj + 1.
      end.
    end.
    delete object egaisFormF1.
