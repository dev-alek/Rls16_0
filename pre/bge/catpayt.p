...
define variable vss-workfile    as character no-undo init "$Workfile: catpayt.p $":U .
define variable vss-archive     as character no-undo init "$Archive: bge/catpayt.p $":U .
