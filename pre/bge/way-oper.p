...
run form-temp_good in this-procedure ( input 'при':U,     input  1 ).
run form-temp_good in this-procedure ( input 'рас':U,    input -1 ).
run form-temp_good in this-procedure ( input 'возврат':U,     input -1 ).
run form-temp_good in this-procedure ( input 'спи':U,  input -1 ).
if v-no-goods = no
then do:
