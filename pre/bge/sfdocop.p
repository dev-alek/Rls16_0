...
export-documents:
  for each buf_schet-fact-doc no-lock
    where buf_schet-fact-doc.host-code = p-host-code
      ...
      AND buf_schet-fact-doc.status_ = 'факт':U
  on error undo, return error
  :
...
initial "@(#)$Workfile$".
run bgelib-tag-open in this-procedure ( input 0, substitute("&1", 'schet-fact-doc'),  "" ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'doc-code'),  input string(buf_schet-fact-doc.doc-code), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'doc-date'),  input string(buf_schet-fact-doc.doc-date, '99.99.9999'), input 1 ).
if buf_schet-fact-doc.pay-date <> ? then do:
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'pay-date'),  input string(buf_schet-fact-doc.pay-date, '99.99.9999'), input 1 ).
end.
if buf_schet-fact-doc.in-date <> ? then do:
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'in-date'),  input string(buf_schet-fact-doc.in-date, '99.99.9999'), input 1 ).
end.
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'doc-type'),  input string(buf_schet-fact-doc.doc-type), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'ext-doc-type'),  input string(buf_schet-fact-doc.ext-doc-type), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'status_'),  input string(buf_schet-fact-doc.status_), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'contract-code'),  input string(buf_schet-fact-doc.contract-code), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'host-code'),  input string(buf_schet-fact-doc.host-code), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'book-code'),  input string(buf_schet-fact-doc.book-code), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'obj-type'),  input string(buf_schet-fact-doc.obj-type), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'obj-code'),  input string(buf_schet-fact-doc.obj-code), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'cli-type'),  input string(buf_schet-fact-doc.cli-type), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'cli-code'),  input string(buf_schet-fact-doc.cli-code), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'cli-name'),  input string(buf_schet-fact-doc.cli-name), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'cli-inn'),  input string(buf_schet-fact-doc.cli-inn), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'cli-address'),  input string(buf_schet-fact-doc.cli-address), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'Gruz-otprav'),  input string(buf_schet-fact-doc.Gruz-otprav), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'Gruz-poluch'),  input string(buf_schet-fact-doc.Gruz-poluch), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'own-name'),  input string(buf_schet-fact-doc.own-name), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'own-inn'),  input string(buf_schet-fact-doc.own-inn), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'own-address'),  input string(buf_schet-fact-doc.own-address), input 1 ).
if buf_schet-fact-doc.fact-order <> ? then do:
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'fact-order'),  input string(buf_schet-fact-doc.fact-order), input 1 ).
end.
if buf_schet-fact-doc.in-doc-code <> "" then do:
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'in-doc-code'),  input string(buf_schet-fact-doc.in-doc-code), input 1 ).
end.
if buf_schet-fact-doc.in-doc-date <> ? then do:
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'in-doc-date'),  input string(buf_schet-fact-doc.in-doc-date, '99.99.9999'), input 1 ).
end.
if buf_schet-fact-doc.base-rate <> ? then do:
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'base-rate'),  input string(buf_schet-fact-doc.base-rate), input 1 ).
end.
if buf_schet-fact-doc.base-scale <> ? then do:
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'base-scale'),  input string(buf_schet-fact-doc.base-scale), input 1 ).
end.
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'sum-rubl'),  input string(buf_schet-fact-doc.sum-rubl), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'sum-VAT-20-rubl'),  input string(buf_schet-fact-doc.sum-VAT-20-rubl), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'VAT-20-rubl'),  input string(buf_schet-fact-doc.VAT-20-rubl), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'sum-VAT-10-rubl'),  input string(buf_schet-fact-doc.sum-VAT-10-rubl), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'VAT-10-rubl'),  input string(buf_schet-fact-doc.VAT-10-rubl), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'sum-VAT-0-rubl'),  input string(buf_schet-fact-doc.sum-VAT-0-rubl), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'sum-VAT-no-rubl'),  input string(buf_schet-fact-doc.sum-VAT-no-rubl), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'sum-base'),  input string(buf_schet-fact-doc.sum-base), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'sum-VAT-20-base'),  input string(buf_schet-fact-doc.sum-VAT-20-base), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'VAT-20-base'),  input string(buf_schet-fact-doc.VAT-20-base), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'sum-VAT-10-base'),  input string(buf_schet-fact-doc.sum-VAT-10-base), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'VAT-10-base'),  input string(buf_schet-fact-doc.VAT-10-base), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'sum-VAT-0-base'),  input string(buf_schet-fact-doc.sum-VAT-0-base), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'sum-VAT-no-base'),  input string(buf_schet-fact-doc.sum-VAT-no-base), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'PS'),  input string(buf_schet-fact-doc.PS), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'out-code-list'),  input string(buf_schet-fact-doc.out-code-list), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'gtd'),  input string(buf_schet-fact-doc.gtd), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'country'),  input string(buf_schet-fact-doc.country), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'fact-user-db-num'),  input string(buf_schet-fact-doc.fact-user-db-num), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'fact-user-name'),  input string(buf_schet-fact-doc.fact-user-name), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'user-db-num'),  input string(buf_schet-fact-doc.user-db-num), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'user-name'),  input string(buf_schet-fact-doc.user-name), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'PS'),  input string(buf_schet-fact-doc.PS), input 1 ).
if buf_schet-fact-doc.fact-date <> ? then do:
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'fact-date'),  input string(buf_schet-fact-doc.fact-date, '99.99.9999'), input 1 ).
end.
if buf_schet-fact-doc.fact-time <> ? then do:
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'fact-time'),  input string(buf_schet-fact-doc.fact-time), input 1 ).
end.
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'sys-date'),  input string(buf_schet-fact-doc.sys-date, '99.99.9999'), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'sys-time'),  input string(buf_schet-fact-doc.sys-time), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'office'),  input string(buf_schet-fact-doc.office), input 1 ).
run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'curr-code'),  input string(buf_schet-fact-doc.curr-code), input 1 ).
run bgelib-tag-close in this-procedure ( input 0, substitute("&1", 'schet-fact-doc')).
...
on error undo, return error
:
      run bgelib-tag-open in this-procedure ( input 0, substitute("&1", 'schet-fact-line'),  "" ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'doc-code'),  input string(buf_schet-fact-line.doc-code), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'gds-code'),  input string(buf_schet-fact-line.gds-code), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'fact-qnty'),  input string(buf_schet-fact-line.fact-qnty), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'price-rubl'),  input string(buf_schet-fact-line.price-rubl), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'price-base'),  input string(buf_schet-fact-line.price-base), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'sum-rubl'),  input string(buf_schet-fact-line.sum-rubl), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'sum-base'),  input string(buf_schet-fact-line.sum-base), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'VAT-rubl'),  input string(buf_schet-fact-line.VAT-rubl), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'VAT-base'),  input string(buf_schet-fact-line.VAT-base), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'sum-rubl-VAT'),  input string(buf_schet-fact-line.sum-rubl-VAT), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'sum-base-VAT'),  input string(buf_schet-fact-line.sum-base-VAT), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'obj-type'),  input string(buf_schet-fact-line.obj-type), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'obj-code'),  input string(buf_schet-fact-line.obj-code), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'VAT-pc'),  input string(buf_schet-fact-line.VAT-pc), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'ext-doc-type'),  input string(buf_schet-fact-line.ext-doc-type), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'fact-order'),  input string(buf_schet-fact-line.fact-order), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'status_'),  input string(buf_schet-fact-line.status_), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'line-num'),  input string(buf_schet-fact-line.line-num), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'excise'),  input string(buf_schet-fact-line.excise), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'other-base'),  input string(buf_schet-fact-line.other-base), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'other-rubl'),  input string(buf_schet-fact-line.other-rubl), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'gtd'),  input string(buf_schet-fact-line.gtd), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'country'),  input string(buf_schet-fact-line.country), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'host-code'),  input string(buf_schet-fact-line.host-code), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'gds-code'),  input string(buf_schet-fact-line.gds-code), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'in-code'),  input string(buf_schet-fact-line.in-code), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'part-code'),  input string(buf_schet-fact-line.part-code), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'gds-name'),  input string(buf_schet-fact-line.gds-name), input 1 ).
      run bgelib-tag-put in this-procedure ( input 1, input substitute('&1', 'unit-base'),  input string(buf_schet-fact-line.unit-base), input 1 ).
      run bgelib-tag-close in this-procedure ( input 0, substitute("&1", 'schet-fact-line')).
end.
    if v-last-file-position = 0 or seek( stmxmlout ) - v-last-file-position > 1048576 then do:
      run gbl/chkfree.p ( input substring( p-xml-file-name, 1, 1 ), input 200, output v-need-disk-spc ) .
      if v-need-disk-spc = yes then do:
        run gbl/waitfrsp.w ( input substring( p-xml-file-name, 1, 1 ), input 200, output v-cancel ) .
