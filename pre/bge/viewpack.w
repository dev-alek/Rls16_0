...
END.
ON CHOOSE OF bView IN FRAME Dialog-Frame
DO:
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY BROWSE-route FOR EACH esys-route       WHERE esys-route.esys-id = iEsysId and  esys-route.db-num  = iDbNum and esys-route.esr-last-pack = iPackNum NO-LOCK,       EACH esys-route-dump WHERE esys-route-dump.esrd-dump-ord   = esys-route.esr-dump-ord NO-LOCK     BY esys-route.esr-dump-ord INDEXED-REPOSITION.
END PROCEDURE.
