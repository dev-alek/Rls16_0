...
define input parameter p-file-name      as character    no-undo.
    ...
    define variable iRepeater       AS INT  INIT 0          NO-UNDO.
    define variable bolLKfile       AS LOG  INIT NO         NO-UNDO.
...
:
    ...
    ASSIGN sLogFile = strHomeDir + "\" + "Actions.log".
...
run wp-XMLTagOpen in this-procedure ( input 2, "firm","").
            ...
            :
                ...
                then do:
                    ...
                    then do:
                        ...
                        run wp-XMLTagPut in this-procedure ( input 4, input "Address1"      , input string( entry(1, buf_fin-bank.addres, chr(4)))    , input 0 ).
...
run wp-XMLTagClose in this-procedure ( input 2, input "firm" ).
end.
end procedure.
...
run wp-XMLTagPut in this-procedure   ( input 4, input "name"        , input "firm", input 0).
