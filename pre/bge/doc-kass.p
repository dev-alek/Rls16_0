  ...
  ELSE DO:
    ...
    :
      ...
      find first temp-kass no-lock
           ...
           and   temp-kass.oper-num = (if buf_chk-doc.netto >= 0 then "es" else "rs")
      no-error.
      ...
      DO:
        ...
        ASSIGN
          ...
          temp-kass.oper-num = (IF buf_chk-doc.netto >= 0 THEN "es" ELSE "rs")
      ...
      :
          ...
          THEN DO:
                run update-temp-kass-goods in this-procedure ( input "es", input 1 ).
          END.
          ELSE DO:
                run update-temp-kass-goods in this-procedure ( input "rs", input -1 ).
          END.
      END.
      ...
      :
          ...
          IF buf_chk-doc.netto >= 0
          THEN DO:
                run update-temp-kass-pay in this-procedure ( input "es", input 1 ).
          END.
          ELSE DO:
                run update-temp-kass-pay in this-procedure ( input "rs", input -1 ).
          END.
      END.
    END.
  END.
...
def input parameter p-sign     as integer no-undo.
