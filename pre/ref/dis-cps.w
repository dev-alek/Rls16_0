...
DEFINE BROWSE BR-dis-cp-rule
  QUERY BR-dis-cp-rule NO-LOCK DISPLAY
      mark-string(recid(X_dis-cp-rule), v-rid-list) COLUMN-LABEL '*' FORMAT "X(1)"
X_cash-pay.cdpay-code COLUMN-LABEL 'Код платежа' format ">>>>9"
X_cash-pay.curr-code COLUMN-LABEL 'Код валюты'
X_dis-cp-rule.templ-rl-root COLUMN-LABEL 'Тип правила' FORMAT ">>>>>>>>9"
entry (lookup (X_dis-cp-rule.pos-type, 'IBM,IBM-XML,IPC-Servis+,OMRON-NEW,OMRON,NCR-GM,MAGIA-XML,NCR-AS@R,IBS-TH,IBS-TH-MOB,r-keeper,InfoKiosk,pricecheck-Servis+,Emulator-NKT-IBM,MARIA,-,bo,Autotank':U), 'IBM,IBM-XML,IPC-Servis+,OMRON-NEW,OMRON,NCR-GM,MAGIA-XML,NCR-AS@R,IBS-TH,IBS-TH-MOB,R-KEEPER,InfoKiosk,Прайс-чекер Servis+,Emulator-NKT-IBM,MARIA,Накладная,Бэкофис,Autotank':U) COLUMN-LABEL 'Место использ.' FORMAT "X(20)"
X_dis-cp-rule.obj-type COLUMN-LABEL 'Тип объ' FORMAT "X(3)"
X_dis-cp-rule.obj-code COLUMN-LABEL 'Код объ' FORMAT ">>>>9"
entry (lookup (X_dis-cp-rule.discnt-role, 'simple-pay,qnty-pay':u) + 1, ',' + 'Скидка при оплате,Скидка на количество при оплате':u) COLUMN-LABEL 'Тип скидки' FORMAT "X(70)" width 40
X_dis-cp-rule.rule-num COLUMN-LABEL '№ правила' FORMAT ">>>>>>>>9"
X_dis-cp-rule.rl-root COLUMN-LABEL '№ корн.!правила' FORMAT ">>>>>>>>9"
...
apply "entry" to br-dis-cp-rule in frame Dialog-Frame.
END.
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse br-dis-cp-rule :handle
      .
...
do:
   v-doc-rec = recid(X_dis-cp-rule).  Run OpenBR in this-procedure ( input yes, input no, input '':U).  REPOSITION br-dis-cp-rule to recid v-doc-rec No-ERROR.               apply 'value-changed' to br-dis-cp-rule.
...
def var sort-labelbr-dis-cp-rule   as character no-undo .
def var sort-clmnbr-dis-cp-rule    as handle    no-undo .
def var cur-clmnbr-dis-cp-rule     as handle    no-undo .
def var cur-clmn-locbr-dis-cp-rule as integer   no-undo .
def var re-querybr-dis-cp-rule     as logical   initial no no-undo .
on start-search, ctrl-o of br-dis-cp-rule in frame Dialog-Frame do:
   run sort-brbr-dis-cp-rule
     (input (if available X_dis-cp-rule
             then recid(X_dis-cp-rule)
             else ?
            )
     ).
end.
PROCEDURE sort-brbr-dis-cp-rule :
  define input parameter p-recid as recid no-undo .
  if re-querybr-dis-cp-rule = no then do:
    assign
       cur-clmnbr-dis-cp-rule = br-dis-cp-rule:current-column in frame Dialog-Frame
    .
    if sort-clmnbr-dis-cp-rule <> ? then sort-clmnbr-dis-cp-rule:column-fgcolor = 0.
    if cur-clmnbr-dis-cp-rule = sort-clmnbr-dis-cp-rule then do:
      assign
         sort-labelbr-dis-cp-rule = ""
         sort-clmnbr-dis-cp-rule = ?
      .
     end.
     else do:
       assign
         sort-labelbr-dis-cp-rule = cur-clmnbr-dis-cp-rule:label
         sort-clmnbr-dis-cp-rule  = cur-clmnbr-dis-cp-rule
         sort-clmnbr-dis-cp-rule:column-fgcolor = 4
       .
     end.
   end.
  assign
    cur-clmn-locbr-dis-cp-rule = 1
  .
  def var column-handle as handle no-undo .
  column-handle = br-dis-cp-rule:first-column.
  do while valid-handle(column-handle) :
    if column-handle = cur-clmnbr-dis-cp-rule then do:
      leave .
    end.
    column-handle = column-handle:NEXT-COLUMN.
    assign
      cur-clmn-locbr-dis-cp-rule = cur-clmn-locbr-dis-cp-rule + 1
    .
  end.
  case sort-labelbr-dis-cp-rule:
        when '*'  then DO:   assign     sort-column-name = "mark-string(recid(X_dis-cp-rule), v-rid-list)"   .   run OpenBr in this-procedure ( input yes, input no, input no).   . END.
        when 'Код платежа'  then DO:   assign     sort-column-name = "X_cash-pay.cdpay-code"   .   run OpenBr in this-procedure ( input yes, input no, input no).   . END.
        when 'Код валюты'  then DO:   assign     sort-column-name = "X_cash-pay.curr-code"   .   run OpenBr in this-procedure ( input yes, input no, input no).   . END.
        when 'Тип правила'  then DO:   assign     sort-column-name = "X_dis-cp-rule.templ-rl-root"   .   run OpenBr in this-procedure ( input yes, input no, input no).   . END.
        when 'Место использ.'  then DO:   assign     sort-column-name = "entry (lookup (X_dis-cp-rule.pos-type, 'IBM,IBM-XML,IPC-Servis+,OMRON-NEW,OMRON,NCR-GM,MAGIA-XML,NCR-AS@R,IBS-TH,IBS-TH-MOB,r-keeper,InfoKiosk,pricecheck-Servis+,Emulator-NKT-IBM,MARIA,-,bo,Autotank':U), 'IBM,IBM-XML,IPC-Servis+,OMRON-NEW,OMRON,NCR-GM,MAGIA-XML,NCR-AS@R,IBS-TH,IBS-TH-MOB,R-KEEPER,InfoKiosk,Прайс-чекер Servis+,Emulator-NKT-IBM,MARIA,Накладная,Бэкофис,Autotank':U)"   .   run OpenBr in this-procedure ( input yes, input no, input no).   . END.
        when 'Тип объ'  then DO:   assign     sort-column-name = "X_dis-cp-rule.obj-type"   .   run OpenBr in this-procedure ( input yes, input no, input no).   . END.
        when 'Код объ'  then DO:   assign     sort-column-name = "X_dis-cp-rule.obj-code"   .   run OpenBr in this-procedure ( input yes, input no, input no).   . END.
        when 'Тип скидки'  then DO:   assign     sort-column-name = "entry (lookup (X_dis-cp-rule.discnt-role, 'simple-pay,qnty-pay':u) + 1, ',' + 'Скидка при оплате,Скидка на количество при оплате':u)"   .   run OpenBr in this-procedure ( input yes, input no, input no).   . END.
        when '№ правила'  then DO:   assign     sort-column-name = "X_dis-cp-rule.rule-num"   .   run OpenBr in this-procedure ( input yes, input no, input no).   . END.
        when '№ корн.!правила'  then DO:   assign     sort-column-name = "X_dis-cp-rule.rl-root"   .   run OpenBr in this-procedure ( input yes, input no, input no).   . END.
    otherwise do:
      assign
        sort-column-name = ""
      .
      run OpenBr in this-procedure ( input yes, input no, input no).
      if sort-labelbr-dis-cp-rule <> "" then do:
        assign
          cur-clmnbr-dis-cp-rule:column-fgcolor = 0
        .
      end.
      assign
        cur-clmn-locbr-dis-cp-rule = ?
      .
    end.
  end case.
  if p-recid <> ? then do:
    reposition br-dis-cp-rule to recid p-recid no-error.
    apply "value-changed" to br-dis-cp-rule in frame Dialog-Frame.
  end.
  apply "entry" to br-dis-cp-rule in frame Dialog-Frame.
END PROCEDURE.
procedure re-open-query-srt-clmnbr-dis-cp-rule:
if cur-clmnbr-dis-cp-rule = ? then do:
   run OpenBr in this-procedure ( input yes, input no, input no).
end.
else do:
   assign re-querybr-dis-cp-rule = yes.
   run sort-brbr-dis-cp-rule
     (input (if available X_dis-cp-rule
             then recid(X_dis-cp-rule)
             else ?
   ...
   assign re-querybr-dis-cp-rule = no.
end.
end.
define variable vss-include-info17 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
do:
  BR-dis-cp-rule :SET-REPOSITIONED-ROW(5, "CONDITIONAL") .
end.
MAIN-BLOCK:
...
define variable vss-include-info18 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
  ...
  IF LOOKUP( "discnt-role", p-list-mode) > 0 THEN DO:
    FIND FIRST par_dis-cfg-rule NO-LOCK WHERE
          ...
          AND par_dis-cfg-rule.TABLE-name = 'dis-cp-rule':U NO-ERROR.
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY BR-dis-cp-rule FOR EACH X_dis-cp-rule NO-LOCK ,            FIRST X_cash-pay NO-LOCK WHERE           X_cash-pay.curr-code = X_dis-cp-rule.curr-code        AND X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code INDEXED-REPOSITION.
END PROCEDURE.
PROCEDURE MyEnable :
define variable v-h as handle no-undo .
define variable v-ii as integer no-undo .
v-h = BR-dis-cp-rule:FIRST-COLUMN IN FRAME Dialog-Frame.
DO while valid-handle(v-h)
and  v-ii < br-dis-cp-rule:num-COLUMNs IN FRAME Dialog-Frame:
  v-ii = v-ii + 1.
  if v-h:LABEL = 'Место использ.'
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-21 as character no-undo .
      ...
      parameter-5-21 = (" " + "" + " " + ", FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code")
    ...
    :
      ...
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-dis-cp-rule:handle
  ...
  if l-filter-open-21 = false then do:
    OPEN QUERY br-dis-cp-rule FOR EACH X_dis-cp-rule
      where  TRUE
    , FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code
      indexed-reposition
  .
      assign
        l-query-was-opened = true
  ...
  assign
    v-doc-rec = recid( X_dis-cp-rule )
  .
  do
  on stop undo, leave
  on error undo, leave
  :
    if QUERY br-dis-cp-rule:handle:get-buffer-handle(1) = (buffer X_dis-cp-rule:handle) then do:
      assign
    ...
    .
      run fltopend_fltfindd in this-procedure  (
                          ...
                          ,input QUERY br-dis-cp-rule:handle
                          ,input rowid(X_dis-cp-rule)
                          ,input logical(parameter-2-21)
                          ,input no-lock
                          ,input (buffer X_dis-cp-rule:handle)
                          ,input parameter-4-21
                          ,input parameter-5-21
                          ) no-error.
      .
      ...
      assign
      parameter-2-21 = (if p-find-next then "true":u else "false":u )
      parameter-3-21 =  "FOR EACH X_dis-cp-rule"
      parameter-4-21 =
        (
          if (" TRUE " + " " + where-phrase-21) <> ""
          then " TRUE " + " " + where-phrase-21
      ...
      parameter-5-21 = (" " + "" + " " + ", FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code" + " " + p-find-condition)
      parameter-6-21 = if sort-phrase-21 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-23 as character no-undo .
      ...
      parameter-4-23 =
        (
          if (" X_dis-cp-rule.obj-type = p-curr-obj-type and X_dis-cp-rule.obj-code = p-curr-obj-code " + " " + where-phrase-23) <> ""
          then  substitute('X_dis-cp-rule.obj-type = &1&2&1 and X_dis-cp-rule.obj-code = &3 ', chr(34), p-curr-obj-type, p-curr-obj-code) + " " + where-phrase-23
          else "true"
        )
      parameter-5-23 = (" " + "" + " " + ", FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code")
    ...
    :
      assign
        l-disable-where-23 =
          (" X_dis-cp-rule.obj-type = p-curr-obj-type and X_dis-cp-rule.obj-code = p-curr-obj-code " + " " + where-phrase-23 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-dis-cp-rule:handle
  ...
  if l-filter-open-23 = false then do:
    OPEN QUERY br-dis-cp-rule FOR EACH X_dis-cp-rule
      where  X_dis-cp-rule.obj-type = p-curr-obj-type and X_dis-cp-rule.obj-code = p-curr-obj-code
    , FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code
      indexed-reposition
  .
      assign
  ...
  :
    if QUERY br-dis-cp-rule:handle:get-buffer-handle(1) = (buffer X_dis-cp-rule:handle) then do:
      ...
      parameter-4-23 =
        "where ":u +  substitute('X_dis-cp-rule.obj-type = &1&2&1 and X_dis-cp-rule.obj-code = &3 ', chr(34), p-curr-obj-type, p-curr-obj-code) + " ":u + where-phrase-23 + " ":u + p-find-condition + " " + ""
      parameter-5-23 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-23 = (if p-find-next then "true":u else "false":u )
      parameter-3-23 =  "FOR EACH X_dis-cp-rule"
      parameter-4-23 =
        (
          if (" X_dis-cp-rule.obj-type = p-curr-obj-type and X_dis-cp-rule.obj-code = p-curr-obj-code " + " " + where-phrase-23) <> ""
          then  substitute('X_dis-cp-rule.obj-type = &1&2&1 and X_dis-cp-rule.obj-code = &3 ', chr(34), p-curr-obj-type, p-curr-obj-code) + " " + where-phrase-23
      ...
      parameter-5-23 = (" " + "" + " " + ", FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code" + " " + p-find-condition)
      parameter-6-23 = if sort-phrase-23 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-25 as character no-undo .
      ...
      parameter-4-25 =
        (
          if (" X_dis-cp-rule.obj-type = p-curr-obj-type and X_dis-cp-rule.obj-code = p-curr-obj-code                       AND X_dis-cp-rule.pos-type = p-pos-type " + " " + where-phrase-25) <> ""
          then  substitute('X_dis-cp-rule.obj-type = &1&2&1 and X_dis-cp-rule.obj-code = &3                       AND X_dis-cp-rule.pos-type = &1&4&1 ', chr(34), p-curr-obj-type, p-curr-obj-code, p-pos-type) + " " + where-phrase-25
          else "true"
        )
      parameter-5-25 = (" " + "" + " " + ", FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code")
    ...
    :
      assign
        l-disable-where-25 =
          (" X_dis-cp-rule.obj-type = p-curr-obj-type and X_dis-cp-rule.obj-code = p-curr-obj-code                       AND X_dis-cp-rule.pos-type = p-pos-type " + " " + where-phrase-25 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-dis-cp-rule:handle
  ...
  if l-filter-open-25 = false then do:
    OPEN QUERY br-dis-cp-rule FOR EACH X_dis-cp-rule
      where  X_dis-cp-rule.obj-type = p-curr-obj-type and X_dis-cp-rule.obj-code = p-curr-obj-code                       AND X_dis-cp-rule.pos-type = p-pos-type
    , FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code
      indexed-reposition
  .
      assign
  ...
  :
    if QUERY br-dis-cp-rule:handle:get-buffer-handle(1) = (buffer X_dis-cp-rule:handle) then do:
      ...
      parameter-4-25 =
        "where ":u +  substitute('X_dis-cp-rule.obj-type = &1&2&1 and X_dis-cp-rule.obj-code = &3                       AND X_dis-cp-rule.pos-type = &1&4&1 ', chr(34), p-curr-obj-type, p-curr-obj-code, p-pos-type) + " ":u + where-phrase-25 + " ":u + p-find-condition + " " + ""
      parameter-5-25 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-25 = (if p-find-next then "true":u else "false":u )
      parameter-3-25 =  "FOR EACH X_dis-cp-rule"
      parameter-4-25 =
        (
          if (" X_dis-cp-rule.obj-type = p-curr-obj-type and X_dis-cp-rule.obj-code = p-curr-obj-code                       AND X_dis-cp-rule.pos-type = p-pos-type " + " " + where-phrase-25) <> ""
          then  substitute('X_dis-cp-rule.obj-type = &1&2&1 and X_dis-cp-rule.obj-code = &3                       AND X_dis-cp-rule.pos-type = &1&4&1 ', chr(34), p-curr-obj-type, p-curr-obj-code, p-pos-type) + " " + where-phrase-25
      ...
      parameter-5-25 = (" " + "" + " " + ", FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code" + " " + p-find-condition)
      parameter-6-25 = if sort-phrase-25 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-27 as character no-undo .
      ...
      parameter-4-27 =
        (
          if (" X_dis-cp-rule.obj-type = p-curr-obj-type and X_dis-cp-rule.obj-code = p-curr-obj-code                       AND X_dis-cp-rule.templ-rl-root = p-templ-rl-root " + " " + where-phrase-27) <> ""
          then  substitute('X_dis-cp-rule.obj-type = &1&2&1 and X_dis-cp-rule.obj-code = &3                       AND X_dis-cp-rule.templ-rl-root = &4', chr(34), p-curr-obj-type, p-curr-obj-code, p-templ-rl-root) + " " + where-phrase-27
          else "true"
        )
      parameter-5-27 = (" " + "" + " " + ", FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code")
    ...
    :
      assign
        l-disable-where-27 =
          (" X_dis-cp-rule.obj-type = p-curr-obj-type and X_dis-cp-rule.obj-code = p-curr-obj-code                       AND X_dis-cp-rule.templ-rl-root = p-templ-rl-root " + " " + where-phrase-27 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-dis-cp-rule:handle
  ...
  if l-filter-open-27 = false then do:
    OPEN QUERY br-dis-cp-rule FOR EACH X_dis-cp-rule
      where  X_dis-cp-rule.obj-type = p-curr-obj-type and X_dis-cp-rule.obj-code = p-curr-obj-code                       AND X_dis-cp-rule.templ-rl-root = p-templ-rl-root
    , FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code
      indexed-reposition
  .
      assign
  ...
  :
    if QUERY br-dis-cp-rule:handle:get-buffer-handle(1) = (buffer X_dis-cp-rule:handle) then do:
      ...
      parameter-4-27 =
        "where ":u +  substitute('X_dis-cp-rule.obj-type = &1&2&1 and X_dis-cp-rule.obj-code = &3                       AND X_dis-cp-rule.templ-rl-root = &4', chr(34), p-curr-obj-type, p-curr-obj-code, p-templ-rl-root) + " ":u + where-phrase-27 + " ":u + p-find-condition + " " + ""
      parameter-5-27 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-27 = (if p-find-next then "true":u else "false":u )
      parameter-3-27 =  "FOR EACH X_dis-cp-rule"
      parameter-4-27 =
        (
          if (" X_dis-cp-rule.obj-type = p-curr-obj-type and X_dis-cp-rule.obj-code = p-curr-obj-code                       AND X_dis-cp-rule.templ-rl-root = p-templ-rl-root " + " " + where-phrase-27) <> ""
          then  substitute('X_dis-cp-rule.obj-type = &1&2&1 and X_dis-cp-rule.obj-code = &3                       AND X_dis-cp-rule.templ-rl-root = &4', chr(34), p-curr-obj-type, p-curr-obj-code, p-templ-rl-root) + " " + where-phrase-27
      ...
      parameter-5-27 = (" " + "" + " " + ", FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code" + " " + p-find-condition)
      parameter-6-27 = if sort-phrase-27 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-29 as character no-undo .
      ...
      parameter-4-29 =
        (
          if (" X_dis-cp-rule.obj-type = p-curr-obj-type and X_dis-cp-rule.obj-code = p-curr-obj-code                       AND X_dis-cp-rule.discnt-role = p-discnt-role " + " " + where-phrase-29) <> ""
          then  substitute('X_dis-cp-rule.obj-type = &1&2&1 and X_dis-cp-rule.obj-code = &3                       AND X_dis-cp-rule.discnt-role = &1&4&1 ', chr(34), p-curr-obj-type, p-curr-obj-code, p-discnt-role) + " " + where-phrase-29
          else "true"
        )
      parameter-5-29 = (" " + "" + " " + ", FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code")
    ...
    :
      assign
        l-disable-where-29 =
          (" X_dis-cp-rule.obj-type = p-curr-obj-type and X_dis-cp-rule.obj-code = p-curr-obj-code                       AND X_dis-cp-rule.discnt-role = p-discnt-role " + " " + where-phrase-29 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-dis-cp-rule:handle
  ...
  if l-filter-open-29 = false then do:
    OPEN QUERY br-dis-cp-rule FOR EACH X_dis-cp-rule
      where  X_dis-cp-rule.obj-type = p-curr-obj-type and X_dis-cp-rule.obj-code = p-curr-obj-code                       AND X_dis-cp-rule.discnt-role = p-discnt-role
    , FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code
      indexed-reposition
  .
      assign
  ...
  :
    if QUERY br-dis-cp-rule:handle:get-buffer-handle(1) = (buffer X_dis-cp-rule:handle) then do:
      ...
      parameter-4-29 =
        "where ":u +  substitute('X_dis-cp-rule.obj-type = &1&2&1 and X_dis-cp-rule.obj-code = &3                       AND X_dis-cp-rule.discnt-role = &1&4&1 ', chr(34), p-curr-obj-type, p-curr-obj-code, p-discnt-role) + " ":u + where-phrase-29 + " ":u + p-find-condition + " " + ""
      parameter-5-29 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-29 = (if p-find-next then "true":u else "false":u )
      parameter-3-29 =  "FOR EACH X_dis-cp-rule"
      parameter-4-29 =
        (
          if (" X_dis-cp-rule.obj-type = p-curr-obj-type and X_dis-cp-rule.obj-code = p-curr-obj-code                       AND X_dis-cp-rule.discnt-role = p-discnt-role " + " " + where-phrase-29) <> ""
          then  substitute('X_dis-cp-rule.obj-type = &1&2&1 and X_dis-cp-rule.obj-code = &3                       AND X_dis-cp-rule.discnt-role = &1&4&1 ', chr(34), p-curr-obj-type, p-curr-obj-code, p-discnt-role) + " " + where-phrase-29
      ...
      parameter-5-29 = (" " + "" + " " + ", FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code" + " " + p-find-condition)
      parameter-6-29 = if sort-phrase-29 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-31 as character no-undo .
      ...
      parameter-4-31 =
        (
          if (" X_dis-cp-rule.templ-rl-root = p-templ-rl-root " + " " + where-phrase-31) <> ""
          then  substitute('X_dis-cp-rule.templ-rl-root = &1', p-templ-rl-root ) + " " + where-phrase-31
          else "true"
        )
      parameter-5-31 = (" " + "" + " " + ", FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code")
    ...
    :
      assign
        l-disable-where-31 =
          (" X_dis-cp-rule.templ-rl-root = p-templ-rl-root " + " " + where-phrase-31 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-dis-cp-rule:handle
  ...
  if l-filter-open-31 = false then do:
    OPEN QUERY br-dis-cp-rule FOR EACH X_dis-cp-rule
      where  X_dis-cp-rule.templ-rl-root = p-templ-rl-root
    , FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code
      indexed-reposition
  .
      assign
  ...
  :
    if QUERY br-dis-cp-rule:handle:get-buffer-handle(1) = (buffer X_dis-cp-rule:handle) then do:
      ...
      parameter-4-31 =
        "where ":u +  substitute('X_dis-cp-rule.templ-rl-root = &1', p-templ-rl-root ) + " ":u + where-phrase-31 + " ":u + p-find-condition + " " + ""
      parameter-5-31 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-31 = (if p-find-next then "true":u else "false":u )
      parameter-3-31 =  "FOR EACH X_dis-cp-rule"
      parameter-4-31 =
        (
          if (" X_dis-cp-rule.templ-rl-root = p-templ-rl-root " + " " + where-phrase-31) <> ""
          then  substitute('X_dis-cp-rule.templ-rl-root = &1', p-templ-rl-root ) + " " + where-phrase-31
      ...
      parameter-5-31 = (" " + "" + " " + ", FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code" + " " + p-find-condition)
      parameter-6-31 = if sort-phrase-31 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-33 as character no-undo .
      ...
      parameter-4-33 =
        (
          if (" X_dis-cp-rule.rule-num = p-rule-num " + " " + where-phrase-33) <> ""
          then  substitute('X_dis-cp-rule.rule-num = &1', p-rule-num)  + " " + where-phrase-33
          else "true"
        )
      parameter-5-33 = (" " + "" + " " + ", FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code")
    ...
    :
      assign
        l-disable-where-33 =
          (" X_dis-cp-rule.rule-num = p-rule-num " + " " + where-phrase-33 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-dis-cp-rule:handle
  ...
  if l-filter-open-33 = false then do:
    OPEN QUERY br-dis-cp-rule FOR EACH X_dis-cp-rule
      where  X_dis-cp-rule.rule-num = p-rule-num
    , FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code
      indexed-reposition
  .
      assign
  ...
  :
    if QUERY br-dis-cp-rule:handle:get-buffer-handle(1) = (buffer X_dis-cp-rule:handle) then do:
      ...
      parameter-4-33 =
        "where ":u +  substitute('X_dis-cp-rule.rule-num = &1', p-rule-num)  + " ":u + where-phrase-33 + " ":u + p-find-condition + " " + ""
      parameter-5-33 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-33 = (if p-find-next then "true":u else "false":u )
      parameter-3-33 =  "FOR EACH X_dis-cp-rule"
      parameter-4-33 =
        (
          if (" X_dis-cp-rule.rule-num = p-rule-num " + " " + where-phrase-33) <> ""
          then  substitute('X_dis-cp-rule.rule-num = &1', p-rule-num)  + " " + where-phrase-33
      ...
      parameter-5-33 = (" " + "" + " " + ", FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code" + " " + p-find-condition)
      parameter-6-33 = if sort-phrase-33 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-35 as character no-undo .
      ...
      parameter-4-35 =
        (
          if (" X_dis-cp-rule.rl-root = p-rule-num " + " " + where-phrase-35) <> ""
          then  substitute('X_dis-cp-rule.rl-root = &1', p-rule-num)  + " " + where-phrase-35
          else "true"
        )
      parameter-5-35 = (" " + "" + " " + ", FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code")
    ...
    :
      assign
        l-disable-where-35 =
          (" X_dis-cp-rule.rl-root = p-rule-num " + " " + where-phrase-35 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-dis-cp-rule:handle
  ...
  if l-filter-open-35 = false then do:
    OPEN QUERY br-dis-cp-rule FOR EACH X_dis-cp-rule
      where  X_dis-cp-rule.rl-root = p-rule-num
    , FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code
      indexed-reposition
  .
      assign
  ...
  :
    if QUERY br-dis-cp-rule:handle:get-buffer-handle(1) = (buffer X_dis-cp-rule:handle) then do:
      ...
      parameter-4-35 =
        "where ":u +  substitute('X_dis-cp-rule.rl-root = &1', p-rule-num)  + " ":u + where-phrase-35 + " ":u + p-find-condition + " " + ""
      parameter-5-35 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-35 = (if p-find-next then "true":u else "false":u )
      parameter-3-35 =  "FOR EACH X_dis-cp-rule"
      parameter-4-35 =
        (
          if (" X_dis-cp-rule.rl-root = p-rule-num " + " " + where-phrase-35) <> ""
          then  substitute('X_dis-cp-rule.rl-root = &1', p-rule-num)  + " " + where-phrase-35
      ...
      parameter-5-35 = (" " + "" + " " + ", FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code" + " " + p-find-condition)
      parameter-6-35 = if sort-phrase-35 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-37 as character no-undo .
      ...
      parameter-4-37 =
        (
          if (" X_dis-cp-rule.pos-type = p-pos-type " + " " + where-phrase-37) <> ""
          then  substitute('X_dis-cp-rule.pos-type = &1&2&1', chr(34), p-pos-type)  + " " + where-phrase-37
          else "true"
        )
      parameter-5-37 = (" " + "" + " " + ", FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code")
    ...
    :
      assign
        l-disable-where-37 =
          (" X_dis-cp-rule.pos-type = p-pos-type " + " " + where-phrase-37 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-dis-cp-rule:handle
  ...
  if l-filter-open-37 = false then do:
    OPEN QUERY br-dis-cp-rule FOR EACH X_dis-cp-rule
      where  X_dis-cp-rule.pos-type = p-pos-type
    , FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code
      indexed-reposition
  .
      assign
  ...
  :
    if QUERY br-dis-cp-rule:handle:get-buffer-handle(1) = (buffer X_dis-cp-rule:handle) then do:
      ...
      parameter-4-37 =
        "where ":u +  substitute('X_dis-cp-rule.pos-type = &1&2&1', chr(34), p-pos-type)  + " ":u + where-phrase-37 + " ":u + p-find-condition + " " + ""
      parameter-5-37 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-37 = (if p-find-next then "true":u else "false":u )
      parameter-3-37 =  "FOR EACH X_dis-cp-rule"
      parameter-4-37 =
        (
          if (" X_dis-cp-rule.pos-type = p-pos-type " + " " + where-phrase-37) <> ""
          then  substitute('X_dis-cp-rule.pos-type = &1&2&1', chr(34), p-pos-type)  + " " + where-phrase-37
      ...
      parameter-5-37 = (" " + "" + " " + ", FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code" + " " + p-find-condition)
      parameter-6-37 = if sort-phrase-37 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-39 as character no-undo .
      ...
      parameter-4-39 =
        (
          if (" X_dis-cp-rule.discnt-role = p-discnt-role " + " " + where-phrase-39) <> ""
          then  substitute('X_dis-cp-rule.discnt-role = &1&2&1', chr(34), p-discnt-role ) + " " + where-phrase-39
          else "true"
        )
      parameter-5-39 = (" " + "" + " " + ", FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code")
    ...
    :
      assign
        l-disable-where-39 =
          (" X_dis-cp-rule.discnt-role = p-discnt-role " + " " + where-phrase-39 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-dis-cp-rule:handle
  ...
  if l-filter-open-39 = false then do:
    OPEN QUERY br-dis-cp-rule FOR EACH X_dis-cp-rule
      where  X_dis-cp-rule.discnt-role = p-discnt-role
    , FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code
      indexed-reposition
  .
      assign
  ...
  :
    if QUERY br-dis-cp-rule:handle:get-buffer-handle(1) = (buffer X_dis-cp-rule:handle) then do:
      ...
      parameter-4-39 =
        "where ":u +  substitute('X_dis-cp-rule.discnt-role = &1&2&1', chr(34), p-discnt-role ) + " ":u + where-phrase-39 + " ":u + p-find-condition + " " + ""
      parameter-5-39 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-39 = (if p-find-next then "true":u else "false":u )
      parameter-3-39 =  "FOR EACH X_dis-cp-rule"
      parameter-4-39 =
        (
          if (" X_dis-cp-rule.discnt-role = p-discnt-role " + " " + where-phrase-39) <> ""
          then  substitute('X_dis-cp-rule.discnt-role = &1&2&1', chr(34), p-discnt-role ) + " " + where-phrase-39
      ...
      parameter-5-39 = (" " + "" + " " + ", FIRST X_cash-pay no-lock where X_cash-pay.curr-code = X_dis-cp-rule.curr-code and                                                                      X_cash-pay.cdpay-code = X_dis-cp-rule.cdpay-code" + " " + p-find-condition)
      parameter-6-39 = if sort-phrase-39 = ''
                           then
        (
        " " + "  " +
...
assign
  v-str-recid41 = trim( string( recid( X_dis-cp-rule ) , "->>>>>>>>>>>9":U ) )
...
if v-num-entry41 > 0 then do:
  ...
  loc#log = br-dis-cp-rule:refresh() IN FRAME Dialog-Frame .
...
DO WHILE available X_dis-cp-rule :
  ...
  mark-string(recid(X_dis-cp-rule), v-rid-list) @ v-mark
  X_cash-pay.cdpay-code
  X_cash-pay.curr-code
  X_dis-cp-rule.templ-rl-root
  entry (lookup (X_dis-cp-rule.pos-type, 'IBM,IBM-XML,IPC-Servis+,OMRON-NEW,OMRON,NCR-GM,MAGIA-XML,NCR-AS@R,IBS-TH,IBS-TH-MOB,r-keeper,InfoKiosk,pricecheck-Servis+,Emulator-NKT-IBM,MARIA,-,bo,Autotank':U), 'IBM,IBM-XML,IPC-Servis+,OMRON-NEW,OMRON,NCR-GM,MAGIA-XML,NCR-AS@R,IBS-TH,IBS-TH-MOB,R-KEEPER,InfoKiosk,Прайс-чекер Servis+,Emulator-NKT-IBM,MARIA,Накладная,Бэкофис,Autotank':U) @ v-pos-type
  X_dis-cp-rule.obj-type
  X_dis-cp-rule.obj-code
  entry (lookup (p-discnt-role, 'simple-pay,qnty-pay':u) + 1, ',' + 'Скидка при оплате,Скидка на количество при оплате':u) @ v-d-name
  X_dis-cp-rule.rule-num
  X_dis-cp-rule.rl-root
  with frame List .
