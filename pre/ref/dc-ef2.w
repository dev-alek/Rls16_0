...
field d-card as character
FIELD rfn-code AS character  format "X(16)"  label "Номер RFN"
FIELD limit AS decimal     label "Максимальный!объем"
FIELD status_ AS logical  label "Статус"
...
:
 ...
 FOR EACH temp-dis-card-property where
    ...
    and temp-dis-card-property.dtm-code = 33
    :
...
DO:
  ...
  .
  OPEN QUERY br-ef1 FOR EACH temp-ef1 BY temp-ef1.rfn-code.
...
define variable vss-include-info18 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
  run mainmenu_getcntxt in parparentproc
    ...
    IF NOT AVAILABLE buf_dis-card-type THEN DO:
      ...
      UNDO, RETURN ERROR.
    END.
    IF NOT (buf_Dis-card-type.card-media = integer('6':U)) THEN DO:
      MESSAGE
...
b-quit
B-Help
f-car-reg-number WHEN (p-mode <> 'ПРОСМОТР':U and p-dtm-code = 33)
f-car-brand WHEN (p-mode <> 'ПРОСМОТР':U and p-dtm-code = 33)
