...
if p-open-query then do:
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-5-5 = " use-index obj-type_obj-name "
    .
...
if p-open-query then do:
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-5-7 = " use-index obj-type_obj-name "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query cli-list:handle
...
if p-open-query then do:
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-5-9 = " use-index obj-type_obj-name "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query cli-list:handle
...
if p-open-query then do:
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-5-11 = " use-index obj-type_obj-name "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query cli-list:handle
...
if p-open-query then do:
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-5-13 = " use-index obj-type_obj-name "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query cli-list:handle
...
if p-open-query then do:
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-5-15 = " use-index obj-type_obj-name "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query cli-list:handle
...
if p-open-query then do:
    ...
    define variable  parameter-7-17 as character no-undo .
      ...
      parameter-4-17 =
        (
          ...
          then  (substitute('X_clients.obj-type = &1&2&1                             AND X_clients.stts = 0                             AND X_clients.grp-name begins &1&3&1                             AND ', chr(34), Cli-Types, Curr-Grp-Name) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " " + where-phrase-17
          else "true"
        )
      parameter-5-17 = (" " + "" + " " + "")
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-17 =
        "where ":u +  (substitute('X_clients.obj-type = &1&2&1                             AND X_clients.stts = 0                             AND X_clients.grp-name begins &1&3&1                             AND ', chr(34), Cli-Types, Curr-Grp-Name) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " ":u + where-phrase-17 + " ":u + p-find-condition + " " + ""
      parameter-5-17 = " use-index obj-type_obj-name "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query cli-list:handle
...
if p-open-query then do:
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-5-19 = " use-index obj-type_obj-name "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query cli-list:handle
...
if p-open-query then do:
    ...
    define variable  parameter-7-21 as character no-undo .
      ...
      parameter-4-21 =
        (
          ...
          then  (substitute('X_clients.obj-type = &1&2&1                             AND X_clients.grp-name begins &1&3&1                             AND ', chr(34), Cli-Types, Curr-Grp-Name) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " " + where-phrase-21
          else "true"
        )
      parameter-5-21 = (" " + "" + " " + "")
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-21 =
        "where ":u +  (substitute('X_clients.obj-type = &1&2&1                             AND X_clients.grp-name begins &1&3&1                             AND ', chr(34), Cli-Types, Curr-Grp-Name) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " ":u + where-phrase-21 + " ":u + p-find-condition + " " + ""
      parameter-5-21 = " use-index obj-type_obj-name "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query cli-list:handle
...
if p-open-query then do:
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-5-23 = " use-index obj-type_obj-name "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query cli-list:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-25 as character no-undo .
      ...
      parameter-4-25 =
        (
          if (" X_clients.obj-type = Cli-Types                             AND X_clients.grp-name begins Curr-Grp-Name                             AND X_clients.stts <> 0                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         ) " + " " + where-phrase-25) <> ""
          then  (substitute('X_clients.obj-type = &1&2&1                             AND X_clients.grp-name begins &1&3&1                             AND X_clients.stts <> 0                             AND ', chr(34), Cli-Types, Curr-Grp-Name) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " " + where-phrase-25
          else "true"
        )
      parameter-5-25 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-25 =
          (" X_clients.obj-type = Cli-Types                             AND X_clients.grp-name begins Curr-Grp-Name                             AND X_clients.stts <> 0                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         ) " + " " + where-phrase-25 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-list:handle
  ...
  if l-filter-open-25 = false then do:
    OPEN QUERY CLi-List FOR EACH X_clients no-lock
      where  X_clients.obj-type = Cli-Types                             AND X_clients.grp-name begins Curr-Grp-Name                             AND X_clients.stts <> 0                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         )
       use-index obj-type_obj-name
       BY X_clients.obj-name
      indexed-reposition
  .
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-25 =
        "where ":u +  (substitute('X_clients.obj-type = &1&2&1                             AND X_clients.grp-name begins &1&3&1                             AND X_clients.stts <> 0                             AND ', chr(34), Cli-Types, Curr-Grp-Name) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " ":u + where-phrase-25 + " ":u + p-find-condition + " " + ""
      parameter-5-25 = " use-index obj-type_obj-name "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query cli-list:handle
...
if p-open-query then do:
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-5-27 = " use-index obj-type_obj-name "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query cli-list:handle
