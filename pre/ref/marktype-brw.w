...
ON END-ERROR OF FRAME f-okei2
DO:
    run checkChanges in this-procedure no-error.
    if error-status:error then return no-apply.
END.
ON go OF FRAME f-okei2
do:
    run checkChanges in this-procedure no-error.
    if error-status:error then return no-apply.
end.
ON choose OF b-add IN FRAME f-okei2
do:
   ...
   do:
       ...
       assign
         ...
         vId            = rowid(tt_code)
       .
      OPEN QUERY BROWSE-5 FOR EACH tt_code NO-LOCK     BY tt_code.code INDEXED-REPOSITION.
      reposition BROWSE-5 to rowid vId.
      apply "ENTRY" to BROWSE-5.
   end.
end.
ON choose OF b-del IN FRAME f-okei2
do:
   ...
   find first  buf-goods-attr no-lock where
               buf-goods-attr.attr-code = 'mark-type':U
   ...
   on stop undo, return:
      ...
      OPEN QUERY BROWSE-5 FOR EACH tt_code NO-LOCK     BY tt_code.code INDEXED-REPOSITION.
      apply "ENTRY" to BROWSE-5.
      reposition BROWSE-5 to row 1.
   end.
end.
ON choose OF b-upd IN FRAME f-okei2
do:
   define variable vCode      as character no-undo.
   define variable vCodeValue as character no-undo.
   define variable vCodeName  as character no-undo.
...
ON CHOOSE OF b-xml IN FRAME f-okei2
DO:
   run Exp2Xml in this-procedure.
END.
if valid-handle(active-window) and frame f-okei2:PARENT eq ?
  then frame f-okei2:PARENT = active-window.
define variable vss-include-info7 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
on help of frame f-okei2
do:
  run gbl/app_help.p
...
on choose of b-help in frame f-okei2
do:
  apply "help":u to frame f-okei2 .
end.
...
procedure minbtn-set :
    do
        ...
        do
            ...
            :
            assign
                v-frame-width = frame f-okei2:width - 0.3
                fh            = frame f-okei2:first-child
                hh            = fh:first-child
                ii            = 1
                .
...
procedure diasize_change-height :
  ...
  if p-change-value > 0
  then do:
    if frame f-okei2 :height + p-change-value
        > decimal(session :work-area-height-pixels) / session :pixels-per-row
    then do:
      assign
        p-change-value = decimal(session :work-area-height-pixels) / session :pixels-per-row
                        - (frame f-okei2 :height-chars)
      .
      if p-change-value <= 0
      then do:
  ...
  if p-change-value < 0
  then do:
    if frame f-okei2 :height + p-change-value < v-diasize-orig-frame-height
    then do:
      assign
  ...
  :
    ...
    then do:
      ...
      :
        ...
        then do:
          ...
          assign
            frame f-okei2 :height = v-frame-height
          .
          if frame f-okei2 :scrollable = true
          then do:
            assign
              frame f-okei2 :virtual-height = v-frame-virtual-height
            .
          end.
          run diasize_position-resize-button in this-procedure .
        end.
    ...
    assign
      v-frame-height = frame f-okei2 :height
      v-frame-virtual-height = frame f-okei2 :virtual-height
    ...
    assign
      v-field-group-handle = frame f-okei2 :first-child
    .
    ...
    then do:
      ...
      then do:
        assign
          frame f-okei2 :virtual-height = frame f-okei2 :virtual-height + p-change-value
          no-error .
      ...
      assign
        frame f-okei2 :height = frame f-okei2 :height + p-change-value
        no-error .
      if error-status :error
      or error-status :get-message(1) <> ""
      then do:
    ...
    then do:
      ...
      then do:
        ...
        run gbl/wndsizew.p
          ...
          ,input  'height':u
          ,input  string(frame f-okei2 :height - v-diasize-orig-frame-height)
          ) .
      end.
    end.
  end.
...
procedure diasize_set-height :
  ...
  :
    run diasize_change-height in this-procedure
      (input  (p-new-height - frame f-okei2 :height)
      ,input  p-move-resize
      ) .
  end.
end procedure.
procedure diasize_change-width :
  ...
  if p-change-value > 0
  then do:
    if frame f-okei2 :width + p-change-value >
        session :width-chars
    then do:
      assign
        p-change-value = session :width-chars - frame f-okei2 :width
      .
      if p-change-value <= 0
      then do:
        run diasize_position-resize-button in this-procedure .
  ...
  if p-change-value < 0
  then do:
    if frame f-okei2 :width + p-change-value < v-diasize-orig-frame-width
    then do:
      assign
  ...
  :
    ...
    then do:
      ...
      :
        ...
        then do:
          ...
          assign
            frame f-okei2 :width = v-frame-width
          .
          if frame f-okei2 :scrollable = true
          then do:
            assign
              frame f-okei2 :virtual-width = v-frame-virtual-width
            .
          end.
          run diasize_position-resize-button in this-procedure .
        end.
    ...
    assign
      v-frame-width = frame f-okei2 :width
      v-frame-virtual-width = frame f-okei2 :virtual-width
    ...
    then do:
      ...
      then do:
        assign
          frame f-okei2 :virtual-width = frame f-okei2 :virtual-width + p-change-value
          no-error .
        if error-status :error
        or error-status :get-message(1) <> ""
        then do:
      ...
      assign
        frame f-okei2 :width = v-frame-width + p-change-value
        no-error .
      if error-status :error
      or error-status :get-message(1) <> ""
      then do:
      ...
      assign
        frame f-okei2 :width = frame f-okei2 :width + p-change-value
      no-error .
      if error-status :error
      or error-status :get-message(1) <> ""
      then do:
    ...
    then do:
      ...
      then do:
        ...
        run gbl/wndsizew.p
          ...
          ,input  v-diasize-proc-name
          ,input  'width':u
          ,input  string(frame f-okei2 :width - v-diasize-orig-frame-width)
          ) .
      end.
    end.
  end.
...
procedure diasize_set-width :
  ...
  :
    run diasize_change-width in this-procedure
      (input  (p-new-width - frame f-okei2 :width)
      ,input  p-move-resize
      ) .
  end.
end procedure.
procedure diasize_position-resize-button :
  ...
  :
    hide v-diasize-resize-button .
    assign
      v-diasize-resize-button :row = frame f-okei2 :height - v-diasize-resize-button :height
                  - 1
                  - (frame f-okei2 :border-bottom-pixels / session :pixels-per-row)
      v-diasize-resize-button :col = frame f-okei2 :width - v-diasize-resize-button :width
                  - 1
                  - (frame f-okei2 :border-right-pixels / session :pixels-per-column)
    .
...
procedure diasize_end-move :
  ...
  :
    ...
    .
    assign
      v-row-delta = v-new-row - frame f-okei2 :height
      v-col-delta = v-new-col - frame f-okei2 :width
    .
    run diasize_change-height in this-procedure
      (input v-row-delta
      ,input true
...
procedure diasize_restore-orig-size :
  ...
  :
    assign
      v-diasize-current-frame-width  = frame f-okei2 :width
      v-diasize-current-frame-height = frame f-okei2 :height
    .
...
procedure diasize_init :
  ...
  :
    ...
    :
      assign
        v-diasize-orig-frame-height = frame f-okei2 :height
        v-diasize-orig-frame-width  = frame f-okei2 :width
        v-diasize-browse-handle     = browse BROWSE-5 :handle
      .
      create button v-diasize-resize-button
      assign
        parent        = frame f-okei2 :first-child
        label         = "s"
        height-pixels = 16
        width-pixels  = 16
        visible       = true
...
on window-close of frame f-okei2
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run curdbnum in g#library
  ...
  wait-for go of frame f-okei2 focus BROWSE-5.
end.
...
PROCEDURE Exp2Xml :
    ...
    "        </record-Code>" skip
    "        <record-Code record-delete=~"no~">" skip
    "            <parent>Versions" chr(4) "0</parent>" skip
