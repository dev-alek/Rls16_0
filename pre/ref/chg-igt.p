             ...
             WHEN TRUE THEN DO:
                  ...
                  ELSE DO:
                     ...
                     if (v-num = 0 or v-num = 1 or v-num = 3) THEN DO:
                         RUN gbl/d-askw.w(
                             input "Вопрос по переходу ИЖТ"
                            ,input "Товар " + gds-list.artic + " " + gds-list.gds-name + chr(10)
                                   + "Объект " + obj-list.obj-type + string(obj-list.obj-code) + chr(10)
                                   + "ИЖТ = " + caps( buf_gds-obj-prop.gdop-igt) + chr(10)
                                   + "заданный Старый ИЖТ = " + caps(p-old) + chr(10)
                                   + "Вы действительно хотите изменить " + caps(buf_gds-obj-prop.gdop-igt) + " на " + caps(p-new) + " ?" + chr(10)
                            ,input "|^"
                            ,input "Да|Да для всех^confirm|Нет|Нет для всех^confirm"
                            ,input "Заменить на новый ИЖТ только этот товар|"
