...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-5 as character no-undo .
      ...
      parameter-4-5 =
        (
          if (" X_fin-doc.host-code = p-curr-host-code AND X_fin-doc.contract-code = p-contract-code  " + " " + where-phrase-5) <> ""
          then  substitute('X_fin-doc.host-code = &1 AND X_fin-doc.contract-code = &2  ', p-curr-host-code, p-contract-code) + " " + where-phrase-5
          else "true"
        )
      parameter-5-5 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-5 =
          (" X_fin-doc.host-code = p-curr-host-code AND X_fin-doc.contract-code = p-contract-code  " + " " + where-phrase-5 = "")
      .
  ...
  if l-filter-open-5 = false then do:
    OPEN QUERY br-fin-doc FOR EACH X_fin-doc
      where  X_fin-doc.host-code = p-curr-host-code AND X_fin-doc.contract-code = p-contract-code
       use-index idoc-date
      indexed-reposition
  .
      assign
  ...
  :
    if query br-fin-doc:handle:get-buffer-handle(1) = (buffer X_fin-doc:handle) then do:
      ...
      parameter-4-5 =
        "where ":u +  substitute('X_fin-doc.host-code = &1 AND X_fin-doc.contract-code = &2  ', p-curr-host-code, p-contract-code) + " ":u + where-phrase-5 + " ":u + p-find-condition + " " + ""
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-7 as character no-undo .
      ...
      parameter-4-7 =
        (
          if (" X_fin-doc.host-code = p-curr-host-code AND X_fin-doc.contract-code = p-contract-code                                AND X_fin-doc.cor-acc = p-cor-acc " + " " + where-phrase-7) <> ""
          then  substitute('X_fin-doc.host-code = &1 AND X_fin-doc.contract-code = &2                                AND X_fin-doc.cor-acc = &3 ', p-curr-host-code, p-contract-code, p-cor-acc) + " " + where-phrase-7
          else "true"
        )
      parameter-5-7 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-7 =
          (" X_fin-doc.host-code = p-curr-host-code AND X_fin-doc.contract-code = p-contract-code                                AND X_fin-doc.cor-acc = p-cor-acc " + " " + where-phrase-7 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-fin-doc:handle
                          ,input parameter-3-7
  ...
  if l-filter-open-7 = false then do:
    OPEN QUERY br-fin-doc FOR EACH X_fin-doc
      where  X_fin-doc.host-code = p-curr-host-code AND X_fin-doc.contract-code = p-contract-code                                AND X_fin-doc.cor-acc = p-cor-acc
       use-index idoc-date
      indexed-reposition
  .
      assign
  ...
  :
    if query br-fin-doc:handle:get-buffer-handle(1) = (buffer X_fin-doc:handle) then do:
      ...
      parameter-4-7 =
        "where ":u +  substitute('X_fin-doc.host-code = &1 AND X_fin-doc.contract-code = &2                                AND X_fin-doc.cor-acc = &3 ', p-curr-host-code, p-contract-code, p-cor-acc) + " ":u + where-phrase-7 + " ":u + p-find-condition + " " + ""
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-9 as character no-undo .
      ...
      parameter-4-9 =
        (
          if (" X_fin-doc.host-code = p-curr-host-code AND X_fin-doc.contract-code = p-contract-code                                AND X_fin-doc.cor-acc1 = p-cor-acc1 " + " " + where-phrase-9) <> ""
          then  substitute('X_fin-doc.host-code = &1 AND X_fin-doc.contract-code = &2                                AND X_fin-doc.cor-acc1 = &3 ', p-curr-host-code, p-contract-code, p-cor-acc1) + " " + where-phrase-9
          else "true"
        )
      parameter-5-9 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-9 =
          (" X_fin-doc.host-code = p-curr-host-code AND X_fin-doc.contract-code = p-contract-code                                AND X_fin-doc.cor-acc1 = p-cor-acc1 " + " " + where-phrase-9 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-fin-doc:handle
                          ,input parameter-3-9
  ...
  if l-filter-open-9 = false then do:
    OPEN QUERY br-fin-doc FOR EACH X_fin-doc
      where  X_fin-doc.host-code = p-curr-host-code AND X_fin-doc.contract-code = p-contract-code                                AND X_fin-doc.cor-acc1 = p-cor-acc1
       use-index idoc-date
      indexed-reposition
  .
      assign
  ...
  :
    if query br-fin-doc:handle:get-buffer-handle(1) = (buffer X_fin-doc:handle) then do:
      ...
      parameter-4-9 =
        "where ":u +  substitute('X_fin-doc.host-code = &1 AND X_fin-doc.contract-code = &2                                AND X_fin-doc.cor-acc1 = &3 ', p-curr-host-code, p-contract-code, p-cor-acc1) + " ":u + where-phrase-9 + " ":u + p-find-condition + " " + ""
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-11 as character no-undo .
      ...
      parameter-4-11 =
        (
          if (" X_fin-doc.host-code = p-curr-host-code                               AND X_fin-doc.contract-code = p-contract-code                                AND X_fin-doc.an-uchet-code = p-an-uchet-code " + " " + where-phrase-11) <> ""
          then  substitute('X_fin-doc.host-code = &1                               AND X_fin-doc.contract-code = &2                                AND X_fin-doc.an-uchet-code = &3 ', p-curr-host-code, p-contract-code, p-an-uchet-code) + " " + where-phrase-11
          else "true"
        )
      parameter-5-11 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-11 =
          (" X_fin-doc.host-code = p-curr-host-code                               AND X_fin-doc.contract-code = p-contract-code                                AND X_fin-doc.an-uchet-code = p-an-uchet-code " + " " + where-phrase-11 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-fin-doc:handle
  ...
  if l-filter-open-11 = false then do:
    OPEN QUERY br-fin-doc FOR EACH X_fin-doc
      where  X_fin-doc.host-code = p-curr-host-code                               AND X_fin-doc.contract-code = p-contract-code                                AND X_fin-doc.an-uchet-code = p-an-uchet-code
       use-index idoc-date
      indexed-reposition
  .
      assign
  ...
  :
    if query br-fin-doc:handle:get-buffer-handle(1) = (buffer X_fin-doc:handle) then do:
      ...
      parameter-4-11 =
        "where ":u +  substitute('X_fin-doc.host-code = &1                               AND X_fin-doc.contract-code = &2                                AND X_fin-doc.an-uchet-code = &3 ', p-curr-host-code, p-contract-code, p-an-uchet-code) + " ":u + where-phrase-11 + " ":u + p-find-condition + " " + ""
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-13 as character no-undo .
      ...
      parameter-4-13 =
        (
          if (" X_fin-doc.host-code = p-curr-host-code                             AND X_fin-doc.contract-code = p-contract-code                             AND X_fin-doc.cel-nazn-code = p-cel-nazn-code " + " " + where-phrase-13) <> ""
          then  substitute('X_fin-doc.host-code = &1                             AND X_fin-doc.contract-code = &2                             AND X_fin-doc.cel-nazn-code = &3 ', p-curr-host-code, p-contract-code, p-cel-nazn-code) + " " + where-phrase-13
          else "true"
        )
      parameter-5-13 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-13 =
          (" X_fin-doc.host-code = p-curr-host-code                             AND X_fin-doc.contract-code = p-contract-code                             AND X_fin-doc.cel-nazn-code = p-cel-nazn-code " + " " + where-phrase-13 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-fin-doc:handle
  ...
  if l-filter-open-13 = false then do:
    OPEN QUERY br-fin-doc FOR EACH X_fin-doc
      where  X_fin-doc.host-code = p-curr-host-code                             AND X_fin-doc.contract-code = p-contract-code                             AND X_fin-doc.cel-nazn-code = p-cel-nazn-code
       use-index idoc-date
      indexed-reposition
  .
      assign
  ...
  :
    if query br-fin-doc:handle:get-buffer-handle(1) = (buffer X_fin-doc:handle) then do:
      ...
      parameter-4-13 =
        "where ":u +  substitute('X_fin-doc.host-code = &1                             AND X_fin-doc.contract-code = &2                             AND X_fin-doc.cel-nazn-code = &3 ', p-curr-host-code, p-contract-code, p-cel-nazn-code) + " ":u + where-phrase-13 + " ":u + p-find-condition + " " + ""
