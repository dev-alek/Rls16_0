...
Types = new ibs.th.str.cash.CashDevice().
 do:
   ...
   do v-ii = 1 to Types:mapType:GetItem(v-ii):
      ...
      find first cashobj where cashobj.parent    = cashcode.parent + chr(4) + cashcode.code
                           and cashobj.code      = "1"
      exclusive-lock no-error.
      ...
      then do:
         create cashobj.
         assign
           cashobj.parent    = cashcode.parent + chr(4) + cashcode.code
           cashobj.code      = "1"
         .
      end.
      assign
      ...
      no-lock:
         find first cashgrp where cashgrp.parent    = cashobj.parent + chr(4) + cashobj.code
         ...
         then do:
            create cashgrp.
            assign
               cashgrp.parent    = cashobj.parent + chr(4) + cashobj.code
 ...
 do:
   ...
   for each cash-desk where cash-desk.db-num   eq g#db-num
                        and cash-desk.pos-type eq 'Autotank':U
   exclusive-lock:
