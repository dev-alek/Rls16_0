...
CASE show-as :
  when ('орг':U + "-" + 'все':U + "-" + 'АТР':U + "-" + 'текущие':U) OR
  when ('чел':U + "-" + 'все':U + "-" + 'АТР':U + "-" + 'текущие':U) OR
  when ('скл':U + "-" + 'все':U + "-" + 'АТР':U + "-" + 'текущие':U) OR
  when ('маг':U + "-" + 'все':U + "-" + 'АТР':U + "-" + 'текущие':U) then do:
    CASE JoinType :
      when "Или" then do:
...
if p-open-query then do:
  ...
  then do:
    ...
    :
      assign
        l-disable-where-5 =
          (" X_clients.obj-type = Cli-Types                             AND X_clients.stts = 0                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         ) " + " " + where-phrase-5 = "")
      .
  ...
  if l-filter-open-5 = false then do:
    OPEN QUERY CLi-ListA FOR EACH X_clients no-lock
      where  X_clients.obj-type = Cli-Types                             AND X_clients.stts = 0                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         )
  ...
  :
    if query cli-listA:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-5 =
        "where ":u +  (substitute('X_clients.obj-type = &1&2&1                             AND X_clients.stts = 0                             AND ', chr(34), Cli-Types) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr) ) + " ":u + where-phrase-5 + " ":u + p-find-condition + " " + ""
      parameter-5-5 = "  "
    .
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-7 as character no-undo .
      ...
      parameter-4-7 =
        (
          if (" X_clients.obj-type = Cli-Types                             AND X_clients.stts = 0 " + " " + where-phrase-7) <> ""
          then  substitute('X_clients.obj-type = &1&2&1                             AND X_clients.stts = 0 ', chr(34), Cli-Types) + " " + where-phrase-7
          else "true"
        )
    ...
    :
      assign
        l-disable-where-7 =
          (" X_clients.obj-type = Cli-Types                             AND X_clients.stts = 0 " + " " + where-phrase-7 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-listA:handle
                          ,input parameter-3-7
  ...
  if l-filter-open-7 = false then do:
    OPEN QUERY CLi-ListA FOR EACH X_clients no-lock
      where  X_clients.obj-type = Cli-Types                             AND X_clients.stts = 0
    , FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = attr-option_ AND                                                                    X_clients-attr.attr-value = 'yes':U
       BY X_clients.obj-name
      indexed-reposition
  .
  ...
  :
    if query cli-listA:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-7 =
        "where ":u +  substitute('X_clients.obj-type = &1&2&1                             AND X_clients.stts = 0 ', chr(34), Cli-Types) + " ":u + where-phrase-7 + " ":u + p-find-condition + " " + ""
      parameter-5-7 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
  ...
  when ('орг':U + "-" + 'все':U + "-" + 'АТР':U + "-" + 'все':U) OR
  when ('чел':U + "-" + 'все':U + "-" + 'АТР':U + "-" + 'все':U) OR
  when ('скл':U + "-" + 'все':U + "-" + 'АТР':U + "-" + 'все':U) OR
  when ('маг':U + "-" + 'все':U + "-" + 'АТР':U + "-" + 'все':U) then do:
    CASE JoinType :
      when "Или" then do:
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-9 as character no-undo .
      ...
      parameter-4-9 =
        (
          if (" X_clients.obj-type = Cli-Types                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         ) " + " " + where-phrase-9) <> ""
          then  (substitute('X_clients.obj-type = &1&2&1                            AND ', chr(34), Cli-Types) +  substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " " + where-phrase-9
          else "true"
        )
    ...
    :
      assign
        l-disable-where-9 =
          (" X_clients.obj-type = Cli-Types                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         ) " + " " + where-phrase-9 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-listA:handle
                          ,input parameter-3-9
  ...
  if l-filter-open-9 = false then do:
    OPEN QUERY CLi-ListA FOR EACH X_clients no-lock
      where  X_clients.obj-type = Cli-Types                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         )
    , FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = attr-option_ AND                                                                    X_clients-attr.attr-value = 'yes':U
       BY X_clients.obj-name
      indexed-reposition
  .
  ...
  :
    if query cli-listA:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-9 =
        "where ":u +  (substitute('X_clients.obj-type = &1&2&1                            AND ', chr(34), Cli-Types) +  substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " ":u + where-phrase-9 + " ":u + p-find-condition + " " + ""
      parameter-5-9 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-11 as character no-undo .
      ...
      parameter-4-11 =
        (
          if (" X_clients.obj-type = Cli-Types " + " " + where-phrase-11) <> ""
          then  substitute('X_clients.obj-type = &1&2&1', chr(34), Cli-Types)  + " " + where-phrase-11
          else "true"
        )
    ...
    :
      assign
        l-disable-where-11 =
          (" X_clients.obj-type = Cli-Types " + " " + where-phrase-11 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-listA:handle
  ...
  if l-filter-open-11 = false then do:
    OPEN QUERY CLi-ListA FOR EACH X_clients no-lock
      where  X_clients.obj-type = Cli-Types
    , FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = attr-option_ AND                                                                    X_clients-attr.attr-value = 'yes':U
       BY X_clients.obj-name
      indexed-reposition
  .
  ...
  :
    if query cli-listA:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-11 =
        "where ":u +  substitute('X_clients.obj-type = &1&2&1', chr(34), Cli-Types)  + " ":u + where-phrase-11 + " ":u + p-find-condition + " " + ""
      parameter-5-11 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
  ...
  when ('орг':U + "-" + 'все':U + "-" + 'АТР':U + "-" + 'удаленные':U) OR
  when ('чел':U + "-" + 'все':U + "-" + 'АТР':U + "-" + 'удаленные':U) OR
  when ('скл':U + "-" + 'все':U + "-" + 'АТР':U + "-" + 'удаленные':U) OR
  when ('маг':U + "-" + 'все':U + "-" + 'АТР':U + "-" + 'удаленные':U)   then do:
    CASE JoinType :
      when "Или" then do:
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-15 as character no-undo .
      ...
      parameter-4-15 =
        (
          if (" X_clients.obj-type = Cli-Types                             AND X_clients.stts <> 0 " + " " + where-phrase-15) <> ""
          then  substitute('X_clients.obj-type = &1&2&1                             AND X_clients.stts <> 0', chr(34), Cli-Types ) + " " + where-phrase-15
          else "true"
        )
    ...
    :
      assign
        l-disable-where-15 =
          (" X_clients.obj-type = Cli-Types                             AND X_clients.stts <> 0 " + " " + where-phrase-15 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-listA:handle
  ...
  :
    if query cli-listA:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-15 =
        "where ":u +  substitute('X_clients.obj-type = &1&2&1                             AND X_clients.stts <> 0', chr(34), Cli-Types ) + " ":u + where-phrase-15 + " ":u + p-find-condition + " " + ""
      parameter-5-15 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
  ...
  when ('орг':U + "-" + 'название':U + "-" + 'АТР':U + "-" + 'текущие':U) OR
  when ('чел':U + "-" + 'название':U + "-" + 'АТР':U + "-" + 'текущие':U) OR
  when ('скл':U + "-" + 'название':U + "-" + 'АТР':U + "-" + 'текущие':U) OR
  when ('маг':U + "-" + 'название':U + "-" + 'АТР':U + "-" + 'текущие':U) then do:
    CASE JoinType :
      when "Или" then do:
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-17 as character no-undo .
      ...
      parameter-4-17 =
        (
          if (" X_clients.obj-name contains NameOrCode                             AND X_clients.obj-type = Cli-Types                             AND X_clients.stts = 0                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         ) " + " " + where-phrase-17) <> ""
          then  (substitute('X_clients.obj-name contains &1&2&1                             AND X_clients.obj-type = &1&3&1                             AND X_clients.stts = 0                             AND ', chr(34), NameOrCode, Cli-Types) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " " + where-phrase-17
          else "true"
        )
  ...
  :
    if query cli-listA:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-17 =
        "where ":u +  (substitute('X_clients.obj-name contains &1&2&1                             AND X_clients.obj-type = &1&3&1                             AND X_clients.stts = 0                             AND ', chr(34), NameOrCode, Cli-Types) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " ":u + where-phrase-17 + " ":u + p-find-condition + " " + ""
      parameter-5-17 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-19 as character no-undo .
      ...
      parameter-4-19 =
        (
          if (" X_clients.obj-name contains NameOrCode                             AND X_clients.obj-type = Cli-Types                             AND X_clients.stts = 0 " + " " + where-phrase-19) <> ""
          then  substitute('X_clients.obj-name contains &1&2&1                             AND X_clients.obj-type = &1&3&1                             AND X_clients.stts = 0 ', chr(34), NameOrCode, Cli-Types) + " " + where-phrase-19
          else "true"
        )
    ...
    :
      assign
        l-disable-where-19 =
          (" X_clients.obj-name contains NameOrCode                             AND X_clients.obj-type = Cli-Types                             AND X_clients.stts = 0 " + " " + where-phrase-19 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-listA:handle
  ...
  :
    if query cli-listA:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-19 =
        "where ":u +  substitute('X_clients.obj-name contains &1&2&1                             AND X_clients.obj-type = &1&3&1                             AND X_clients.stts = 0 ', chr(34), NameOrCode, Cli-Types) + " ":u + where-phrase-19 + " ":u + p-find-condition + " " + ""
      parameter-5-19 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
  ...
  when ('орг':U + "-" + 'название':U + "-" + 'АТР':U + "-" + 'все':U) OR
  when ('чел':U + "-" + 'название':U + "-" + 'АТР':U + "-" + 'все':U) OR
  when ('скл':U + "-" + 'название':U + "-" + 'АТР':U + "-" + 'все':U) OR
  when ('маг':U + "-" + 'название':U + "-" + 'АТР':U + "-" + 'все':U) then do:
    CASE JoinType :
      when "Или" then do:
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-21 as character no-undo .
      ...
      parameter-4-21 =
        (
          if (" X_clients.obj-name contains NameOrCode                             AND X_clients.obj-type = Cli-Types                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         ) " + " " + where-phrase-21) <> ""
          then  (substitute('X_clients.obj-name contains &1&2&1                             AND X_clients.obj-type = &1&3&1                             AND ', chr(34), NameOrCode, Cli-Types) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " " + where-phrase-21
          else "true"
        )
  ...
  :
    if query cli-listA:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-21 =
        "where ":u +  (substitute('X_clients.obj-name contains &1&2&1                             AND X_clients.obj-type = &1&3&1                             AND ', chr(34), NameOrCode, Cli-Types) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " ":u + where-phrase-21 + " ":u + p-find-condition + " " + ""
      parameter-5-21 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-23 as character no-undo .
      ...
      parameter-4-23 =
        (
          if (" X_clients.obj-name contains NameOrCode                             AND X_clients.obj-type = Cli-Types " + " " + where-phrase-23) <> ""
          then  substitute('X_clients.obj-name contains &1&2&1                             AND X_clients.obj-type = &1&3&1 ', chr(34), NameOrCode, Cli-Types) + " " + where-phrase-23
          else "true"
        )
    ...
    :
      assign
        l-disable-where-23 =
          (" X_clients.obj-name contains NameOrCode                             AND X_clients.obj-type = Cli-Types " + " " + where-phrase-23 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-listA:handle
  ...
  :
    if query cli-listA:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-23 =
        "where ":u +  substitute('X_clients.obj-name contains &1&2&1                             AND X_clients.obj-type = &1&3&1 ', chr(34), NameOrCode, Cli-Types) + " ":u + where-phrase-23 + " ":u + p-find-condition + " " + ""
      parameter-5-23 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
  ...
  when ('орг':U + "-" + 'название':U + "-" + 'АТР':U + "-" + 'удаленные':U) OR
  when ('чел':U + "-" + 'название':U + "-" + 'АТР':U + "-" + 'удаленные':U) OR
  when ('скл':U + "-" + 'название':U + "-" + 'АТР':U + "-" + 'удаленные':U) OR
  when ('маг':U + "-" + 'название':U + "-" + 'АТР':U + "-" + 'удаленные':U) then do:
    CASE JoinType :
      when "Или" then do:
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-27 as character no-undo .
      ...
      parameter-4-27 =
        (
          if (" X_clients.obj-name contains NameOrCode                             AND X_clients.obj-type = Cli-Types                             AND X_clients.stts <> 0 " + " " + where-phrase-27) <> ""
          then  substitute('X_clients.obj-name contains &1&2&1                             AND X_clients.obj-type = &1&3&1                             AND X_clients.stts <> 0 ', chr(34), NameOrCode, Cli-Types) + " " + where-phrase-27
          else "true"
        )
    ...
    :
      assign
        l-disable-where-27 =
          (" X_clients.obj-name contains NameOrCode                             AND X_clients.obj-type = Cli-Types                             AND X_clients.stts <> 0 " + " " + where-phrase-27 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-listA:handle
  ...
  :
    if query cli-listA:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-27 =
        "where ":u +  substitute('X_clients.obj-name contains &1&2&1                             AND X_clients.obj-type = &1&3&1                             AND X_clients.stts <> 0 ', chr(34), NameOrCode, Cli-Types) + " ":u + where-phrase-27 + " ":u + p-find-condition + " " + ""
      parameter-5-27 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
