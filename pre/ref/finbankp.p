...
:
  ...
  with FRAME TopFrame width 232 down stream-io use-text    .
  Line = fill("-", 195).
  ...
  with frame TopFrame.
  Put Stream PrnLibStream unformatted
  "БИК" chr(32) buf_fin-bank.bik fill(chr(32), 5)
  "ИНН" chr(32) buf_fin-bank.inn fill(chr(32), 5)
  "КПП" chr(32) buf_fin-bank.kpp fill(chr(32), 5)
  skip
  "Корр.счет"  chr(32) buf_fin-bank.cor-acc skip
  "Наим. банка" chr(32) buf_fin-bank.bank-name skip
  "Кратк. назв." chr(32)  buf_fin-bank.short-name  skip
  "Лицензия" chr(32) buf_fin-bank.licenz skip
  "Адрес юрид." chr(32) entry(1, buf_fin-bank.addres, chr(4)) skip
  "Адрес почт." chr(32) buf_fin-bank.addres1 skip
  "Телефон" chr(32) buf_fin-bank.phone fill( chr(32), 5)
  "Факс" chr(32) buf_fin-bank.fax skip
  "E-mail" chr(32) buf_fin-bank.e-mail skip
  "ОКАТО" chr(32) buf_fin-bank.okato  fill ( chr(32), 5)
  "ОКОНХ" chr(32) buf_fin-bank.okonx fill ( chr(32), 5)
  "ОКПО" chr(32)  buf_fin-bank.okpo format "X(10)" skip
  "Примечания" chr(32)   buf_fin-bank.PS
  skip.
