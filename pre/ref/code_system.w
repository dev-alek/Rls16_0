        ...
        repeat i = 1 to num-entries (code_goods) :
            ...
            repeat i = 1 to num-entries (code_goods) :
                ...
                run ref/extclas1.p (
                    ...
                    ,input 0
                    ,input entry (i, code_goods)
                    ,input code_system
                    ,input integer(codeDtSeason)
...
ON CHOOSE OF b-system IN FRAME Dialog-Frame
    DO:
        ...
        code_system:screen-value =  entry(2,v-rid-list,chr(3)) no-error.
    end.
        ...
        for first ub.goods no-lock where recid(ub.goods) =  integer(v-list):
            ...
            do:
              assign
                ...
                name_goods = ""
              .
              enable name_goods b-goods-much with frame Dialog-Frame.
            end.
            else do:
              assign
...
ON CHOOSE OF b-goods-much IN FRAME Dialog-Frame
    DO:
      ...
      display name_goods with frame Dialog-Frame.
    END.
