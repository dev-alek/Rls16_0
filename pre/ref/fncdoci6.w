...
run proc-color-widgets in this-procedure("F-curr-abbr,an-uchet-value,cel-nazn-value,cor-acc1-value,cor-acc-value,doc-date," +                       "naznach-plat,receiver-name,prn-doc-code,payer-name,payer-okpo,receiver-passport,payer-sign1,receiver-sign1,sign3" +                       "str-podr-code,str-podr-name,str-podr-type,sum-doc", no, yes, ?, grey_color).
