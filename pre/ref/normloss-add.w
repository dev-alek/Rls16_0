...
DO:
  ...
  END.
ON VALUE-CHANGED OF f-clim-grp IN FRAME Dialog-Frame
DO:
  assign f-clim-grp .
END.
ON VALUE-CHANGED OF f-oil-grp IN FRAME Dialog-Frame
DO:
  assign
  f-oil-grp
  .
END.
ON VALUE-CHANGED OF f-position IN FRAME Dialog-Frame
DO:
    assign
      f-position
    .
END.
ON VALUE-CHANGED OF f-season IN FRAME Dialog-Frame
DO:
  assign
  f-season
  .
END.
ON LEAVE OF f-sec-vol IN FRAME Dialog-Frame
DO:
      assign f-sec-vol .
  END.
