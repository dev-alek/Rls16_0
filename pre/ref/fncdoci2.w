...
def var vss-description as character no-undo init "Карточка истории расходного ордера".
...
DEFINE FRAME Dialog-Frame
     ...
     tt-c-fin-doc.cel-nazn-value AT ROW 8 COL 16.25 COLON-ALIGNED
          LABEL "Код цел.назн."
          VIEW-AS FILL-IN
          SIZE 14 BY 1
          FGCOLOR 4
     f-cel-nazn-descr AT ROW 8 COL 35.75 COLON-ALIGNED NO-LABEL
     tt-c-fin-doc.cor-acc1-value AT ROW 9 COL 16.25 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN
          SIZE 14 BY 1
          FGCOLOR 4
     f-cor-acc1-descr AT ROW 9 COL 35.75 COLON-ALIGNED NO-LABEL
...
"Item 1", "2":U
     ...
     tt-c-fin-doc.naznach-plat AT ROW 16 COL 1 NO-LABEL
          ...
          FGCOLOR 4
     tt-c-fin-doc.receiver-passport AT ROW 16 COL 50.5 NO-LABEL
          VIEW-AS EDITOR SCROLLBAR-VERTICAL
          SIZE 48 BY 1.5
          FGCOLOR 4
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER
         ...
         DEFAULT-BUTTON B-exit CANCEL-BUTTON b-quit.
DEFINE FRAME Dialog-Frame
     tt-c-fin-doc.enclosure AT ROW 18.5 COL 1 NO-LABEL
          VIEW-AS EDITOR SCROLLBAR-VERTICAL
          SIZE 48 BY 1.5
          FGCOLOR 4
     ...
     tt-c-fin-doc.payer-sign1 AT ROW 20 COL 36.25
          ...
          SIZE 30.88 BY 1
          FGCOLOR 4
     tt-c-fin-doc.payer-sign2 AT ROW 21 COL 6
          LABEL "Гл. бух."
          VIEW-AS FILL-IN
          SIZE 30.88 BY 1
          FGCOLOR 4
     tt-c-fin-doc.payer-sign3 AT ROW 21 COL 50
          LABEL "Кассир"
          VIEW-AS FILL-IN
          SIZE 30.88 BY 1
          FGCOLOR 4
     F-debet AT ROW 6.13 COL 1.88 NO-LABEL
     F-credit AT ROW 9.29 COL 8.88 NO-LABEL
     "Приложение" VIEW-AS TEXT
          SIZE 19.38 BY 1 AT ROW 17.5 COL 1
          FGCOLOR 4
...
CASE p-view:
  when "full":U then do:
    ...
    .
    display
    f-debet                            when (X_sysconf.is-corr-acc or  X_sysconf.is-an-uchet or X_sysconf.is-code-cel-nazn)
    f-credit                           when X_sysconf.is-cassa-acc
...
PROCEDURE enable_UI :
  ...
  DISPLAY RS-view f-cor-acc-descr f-an-uchet-descr f-contract-curr-abbr
          ...
          f-cor-acc1-descr F-curr-abbr F-debet F-credit
      WITH FRAME Dialog-Frame.
  IF AVAILABLE tt-c-fin-doc THEN
    DISPLAY tt-c-fin-doc.user-name-doc tt-c-fin-doc.prn-doc-code
          ...
          tt-c-fin-doc.cor-acc1-value tt-c-fin-doc.sum-doc
          ...
          tt-c-fin-doc.receiver-name tt-c-fin-doc.naznach-plat
          tt-c-fin-doc.receiver-passport tt-c-fin-doc.enclosure tt-c-fin-doc.PS
          tt-c-fin-doc.payer-sign1 tt-c-fin-doc.payer-sign2
          tt-c-fin-doc.payer-sign3
      WITH FRAME Dialog-Frame.
...
tt-c-fin-doc.receiver-type:radio-buttons = "Орг" + chr(44) + 'орг':U + chr(44) +
                                         "Чел" + chr(44) + 'чел':U
...
tt-c-fin-doc.payer-sign1:label  = tt-c-fin-doc.payer-sign1:label  + " - ":U +
                          (if num-entries(tt-c-fin-doc.payer-sign1, chr(4)) > 1
                          then entry(1, tt-c-fin-doc.payer-sign1, chr(4))
                          else "":U)
tt-c-fin-doc.payer-sign1 =   (if num-entries(tt-c-fin-doc.payer-sign1, chr(4)) > 1
                                  then entry(2, tt-c-fin-doc.payer-sign1, chr(4))
                                  else entry(1, tt-c-fin-doc.payer-sign1, chr(4)))
.
