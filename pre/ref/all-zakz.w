...
define buffer t-d-b for ub.ord-doc.
...
DEFINE FRAME d-all-docs
 ...
 hide b-print-rcv in frame d-all-docs .
...
define variable vss-include-info66 as character format "x(65)" no-undo initial "@(#)$Workfile$ Библиотека изменения размеров окна".
...
do:
  ...
  define MENU m-ed-date69
    MENU-ITEM m-ed-date69-1 LABEL "Начало месяца" ACCELERATOR "ALT-1"
    MENU-ITEM m-ed-date69-2 LABEL "Сегодня"       ACCELERATOR "ALT-2"
    MENU-ITEM m-ed-date69-3 LABEL "Конец месяца"  ACCELERATOR "ALT-3"
    MENU-ITEM m-ed-date69-4 LABEL "Календарь"     ACCELERATOR "ALT-4"
    .
  if sch-date :POPUP-MENU in frame d-all-docs = ?
  then do:
    ASSIGN
      sch-date :POPUP-MENU in frame d-all-docs = MENU m-ed-date69 :HANDLE
      sch-date :MENU-MOUSE in frame d-all-docs = 3
    .
  end.
  define variable v-label-handle69 as handle no-undo .
  assign
    v-label-handle69 = sch-date :side-label-handle in frame d-all-docs
  .
  if valid-handle (v-label-handle69)
  then do:
    if v-label-handle69 :tooltip = ""
    or v-label-handle69 :tooltip = ?
    then do:
      assign
        v-label-handle69 :tooltip = "Ctrl-D - текущая, Ctrl-B - начало, Ctrl-E - конец, Ctrl-F - календарь, Прав.Клавиша Мыши - Popup Menu"
      .
    end.
  end.
  ON CHOOSE OF MENU-ITEM m-ed-date69-1 in menu m-ed-date69 DO:
    apply "ctrl-b":U to sch-date in frame d-all-docs .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date69-2 in menu m-ed-date69 DO:
    apply "ctrl-d":U to sch-date in frame d-all-docs .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date69-3 in menu m-ed-date69 DO:
    apply "ctrl-e":U to sch-date in frame d-all-docs .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date69-4 in menu m-ed-date69 DO:
...
do:
  ...
  define MENU m-ed-date71
    MENU-ITEM m-ed-date71-1 LABEL "Начало месяца" ACCELERATOR "ALT-1"
    MENU-ITEM m-ed-date71-2 LABEL "Сегодня"       ACCELERATOR "ALT-2"
    MENU-ITEM m-ed-date71-3 LABEL "Конец месяца"  ACCELERATOR "ALT-3"
    MENU-ITEM m-ed-date71-4 LABEL "Календарь"     ACCELERATOR "ALT-4"
    .
  if sch-fact :POPUP-MENU in frame d-all-docs = ?
  then do:
    ASSIGN
      sch-fact :POPUP-MENU in frame d-all-docs = MENU m-ed-date71 :HANDLE
      sch-fact :MENU-MOUSE in frame d-all-docs = 3
    .
  end.
  define variable v-label-handle71 as handle no-undo .
  assign
    v-label-handle71 = sch-fact :side-label-handle in frame d-all-docs
  .
  if valid-handle (v-label-handle71)
  then do:
    if v-label-handle71 :tooltip = ""
    or v-label-handle71 :tooltip = ?
    then do:
      assign
        v-label-handle71 :tooltip = "Ctrl-D - текущая, Ctrl-B - начало, Ctrl-E - конец, Ctrl-F - календарь, Прав.Клавиша Мыши - Popup Menu"
      .
    end.
  end.
  ON CHOOSE OF MENU-ITEM m-ed-date71-1 in menu m-ed-date71 DO:
    apply "ctrl-b":U to sch-fact in frame d-all-docs .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date71-2 in menu m-ed-date71 DO:
    apply "ctrl-d":U to sch-fact in frame d-all-docs .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date71-3 in menu m-ed-date71 DO:
    apply "ctrl-e":U to sch-fact in frame d-all-docs .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date71-4 in menu m-ed-date71 DO:
...
if Lookup("b-del",p-buttons) <> 0 then
   enable  b-del   WITH FRAME d-all-docs.
   else disable b-del WITH FRAME d-all-docs.
if Lookup("b-lkp",p-buttons) <> 0 then
   enable b-lkp  WITH FRAME d-all-docs.
   else  disable b-lkp WITH FRAME d-all-docs.
if Lookup("b-chg",p-buttons) <> 0 then
   enable b-chg  WITH FRAME d-all-docs.
   else  disable b-chg WITH FRAME d-all-docs.
if Lookup("b-add",p-buttons) <> 0 then
   enable b-add  WITH FRAME d-all-docs.
   else  disable b-add WITH FRAME d-all-docs.
if Lookup("b-close",p-buttons) <> 0 then
   enable b-close WITH FRAME d-all-docs.
   else  disable b-close WITH FRAME d-all-docs.
if Lookup("fin-block",p-buttons) <> 0 then
   disable b-close b-payment  b-copy WITH FRAME d-all-docs.
if g#type = ?  then  do:
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-73 as character no-undo .
      ...
      parameter-4-73 =
        (
          if (" shar-buf_ord-doc.host-code = g#host-code " + " " + where-phrase-73) <> ""
          then  substitute(' shar-buf_ord-doc.host-code =  &1 ' , g#host-code )  + " " + where-phrase-73
          else "true"
        )
      parameter-5-73 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-73 =
          (" shar-buf_ord-doc.host-code = g#host-code " + " " + where-phrase-73 = "")
      .
  ...
  :
    if query br-docs:handle:get-buffer-handle(1) = (buffer shar-buf_ord-doc:handle) then do:
      ...
      parameter-4-73 =
        "where ":u +  substitute(' shar-buf_ord-doc.host-code =  &1 ' , g#host-code )  + " ":u + where-phrase-73 + " ":u + p-find-condition + " " + ""
      parameter-5-73 = " USE-INDEX ByFirm "
    .
      ...
      assign
      parameter-2-73 = (if p-find-next then "true":u else "false":u )
      parameter-3-73 =  "FOR EACH shar-buf_ord-doc"
      parameter-4-73 =
        (
          if (" shar-buf_ord-doc.host-code = g#host-code " + " " + where-phrase-73) <> ""
          then  substitute(' shar-buf_ord-doc.host-code =  &1 ' , g#host-code )  + " " + where-phrase-73
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-75 as character no-undo .
      ...
      parameter-4-75 =
        (
          if (" (shar-buf_ord-doc.host-code = g#host-code or ( shar-buf_ord-doc.cli-code = store-code and  shar-buf_ord-doc.cli-type = store-type)) " + " " + where-phrase-75) <> ""
          then  substitute(' (shar-buf_ord-doc.host-code =  &1         or ( shar-buf_ord-doc.cli-code = &2         and  shar-buf_ord-doc.cli-type = &4&3&4 ))' , g#host-code , store-code, store-type, chr(34) )  + " " + where-phrase-75
          else "true"
        )
      parameter-5-75 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-75 =
          (" (shar-buf_ord-doc.host-code = g#host-code or ( shar-buf_ord-doc.cli-code = store-code and  shar-buf_ord-doc.cli-type = store-type)) " + " " + where-phrase-75 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-docs:handle
  ...
  :
    if query br-docs:handle:get-buffer-handle(1) = (buffer shar-buf_ord-doc:handle) then do:
      ...
      parameter-4-75 =
        "where ":u +  substitute(' (shar-buf_ord-doc.host-code =  &1         or ( shar-buf_ord-doc.cli-code = &2         and  shar-buf_ord-doc.cli-type = &4&3&4 ))' , g#host-code , store-code, store-type, chr(34) )  + " ":u + where-phrase-75 + " ":u + p-find-condition + " " + ""
      parameter-5-75 = ""
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-75 = (if p-find-next then "true":u else "false":u )
      parameter-3-75 =  "FOR EACH shar-buf_ord-doc"
      parameter-4-75 =
        (
          if (" (shar-buf_ord-doc.host-code = g#host-code or ( shar-buf_ord-doc.cli-code = store-code and  shar-buf_ord-doc.cli-type = store-type)) " + " " + where-phrase-75) <> ""
          then  substitute(' (shar-buf_ord-doc.host-code =  &1         or ( shar-buf_ord-doc.cli-code = &2         and  shar-buf_ord-doc.cli-type = &4&3&4 ))' , g#host-code , store-code, store-type, chr(34) )  + " " + where-phrase-75
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-77 as character no-undo .
      ...
      parameter-4-77 =
        (
          if (" shar-buf_ord-doc.host-code = g#host-code and shar-buf_ord-doc.doc-type = g#type" + " " + where-phrase-77) <> ""
          then  substitute(' shar-buf_ord-doc.host-code =  &1 and shar-buf_ord-doc.doc-type = &3&2&3 ' , g#host-code , g#type , chr(34) )  + " " + where-phrase-77
          else "true"
        )
      parameter-5-77 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-77 =
          (" shar-buf_ord-doc.host-code = g#host-code and shar-buf_ord-doc.doc-type = g#type" + " " + where-phrase-77 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-docs:handle
  ...
  :
    if query br-docs:handle:get-buffer-handle(1) = (buffer shar-buf_ord-doc:handle) then do:
      ...
      parameter-4-77 =
        "where ":u +  substitute(' shar-buf_ord-doc.host-code =  &1 and shar-buf_ord-doc.doc-type = &3&2&3 ' , g#host-code , g#type , chr(34) )  + " ":u + where-phrase-77 + " ":u + p-find-condition + " " + ""
      parameter-5-77 = " USE-INDEX ByType "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query br-docs:handle
      ...
      assign
      parameter-2-77 = (if p-find-next then "true":u else "false":u )
      parameter-3-77 =  "FOR EACH shar-buf_ord-doc"
      parameter-4-77 =
        (
          if (" shar-buf_ord-doc.host-code = g#host-code and shar-buf_ord-doc.doc-type = g#type" + " " + where-phrase-77) <> ""
          then  substitute(' shar-buf_ord-doc.host-code =  &1 and shar-buf_ord-doc.doc-type = &3&2&3 ' , g#host-code , g#type , chr(34) )  + " " + where-phrase-77
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-79 as character no-undo .
      ...
      parameter-4-79 =
        (
          if (" shar-buf_ord-doc.host-code = g#host-code and shar-buf_ord-doc.doc-type = g#type and shar-buf_ord-doc.status_ = g#stat" + " " + where-phrase-79) <> ""
          then  substitute(' shar-buf_ord-doc.host-code =  &1 and shar-buf_ord-doc.doc-type = &3&2&3  and shar-buf_ord-doc.status_ = &3&4&3 ' , g#host-code , g#type , chr(34) , g#stat)  + " " + where-phrase-79
          else "true"
        )
      parameter-5-79 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-79 =
          (" shar-buf_ord-doc.host-code = g#host-code and shar-buf_ord-doc.doc-type = g#type and shar-buf_ord-doc.status_ = g#stat" + " " + where-phrase-79 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-docs:handle
  ...
  :
    if query br-docs:handle:get-buffer-handle(1) = (buffer shar-buf_ord-doc:handle) then do:
      ...
      parameter-4-79 =
        "where ":u +  substitute(' shar-buf_ord-doc.host-code =  &1 and shar-buf_ord-doc.doc-type = &3&2&3  and shar-buf_ord-doc.status_ = &3&4&3 ' , g#host-code , g#type , chr(34) , g#stat)  + " ":u + where-phrase-79 + " ":u + p-find-condition + " " + ""
      parameter-5-79 = " USE-INDEX ByType "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query br-docs:handle
...
if p-open-query then do:
  ...
  :
    if query br-docs:handle:get-buffer-handle(1) = (buffer shar-buf_ord-doc:handle) then do:
      ...
      parameter-4-81 =
        "where ":u +  substitute('        ((shar-buf_ord-doc.host-code = &2  and shar-buf_ord-doc.status_ = &1&3&1 and  shar-buf_ord-doc.doc-type = &1&4&1) or        (shar-buf_ord-doc.host-code = &2 and shar-buf_ord-doc.status_ = &1&3&1 and  shar-buf_ord-doc.doc-type = &1&5&1) or           (shar-buf_ord-doc.host-code = &2 and lookup (shar-buf_ord-doc.status_,&1&6&1) > 0 and  shar-buf_ord-doc.doc-type = &1&7&1))        ' , chr(34)         , g#host-code        , g#stat            , 'ФП':U          , 'ОП':U          , v-spis-status        , 'ПО':U         )  + " ":u + where-phrase-81 + " ":u + p-find-condition + " " + ""
      parameter-5-81 = " USE-INDEX bytype "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query br-docs:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-83 as character no-undo .
      ...
      parameter-4-83 =
        (
          if (" ( shar-buf_ord-doc.host-code = g#host-code and shar-buf_ord-doc.need-fo = 1  and  shar-buf_ord-doc.cr-fo = no ) " + " " + where-phrase-83) <> ""
          then  substitute(' shar-buf_ord-doc.host-code =  &1 and and shar-buf_ord-doc.need-fo = 1  and  shar-buf_ord-doc.cr-fo = no ' , g#host-code )  + " " + where-phrase-83
          else "true"
        )
      parameter-5-83 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-83 =
          (" ( shar-buf_ord-doc.host-code = g#host-code and shar-buf_ord-doc.need-fo = 1  and  shar-buf_ord-doc.cr-fo = no ) " + " " + where-phrase-83 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-docs:handle
  ...
  :
    if query br-docs:handle:get-buffer-handle(1) = (buffer shar-buf_ord-doc:handle) then do:
      ...
      parameter-4-83 =
        "where ":u +  substitute(' shar-buf_ord-doc.host-code =  &1 and and shar-buf_ord-doc.need-fo = 1  and  shar-buf_ord-doc.cr-fo = no ' , g#host-code )  + " ":u + where-phrase-83 + " ":u + p-find-condition + " " + ""
      parameter-5-83 = " USE-INDEX By_need-fo "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query br-docs:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-85 as character no-undo .
      ...
      parameter-4-85 =
        (
          if (" shar-buf_ord-doc.host-code = g#host-code and shar-buf_ord-doc.need-fo = 1  and  shar-buf_ord-doc.cr-fo = yes " + " " + where-phrase-85) <> ""
          then  substitute(' shar-buf_ord-doc.host-code =  &1 and shar-buf_ord-doc.need-fo = 1  and  shar-buf_ord-doc.cr-fo = yes  ' , g#host-code )  + " " + where-phrase-85
          else "true"
        )
      parameter-5-85 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-85 =
          (" shar-buf_ord-doc.host-code = g#host-code and shar-buf_ord-doc.need-fo = 1  and  shar-buf_ord-doc.cr-fo = yes " + " " + where-phrase-85 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-docs:handle
  ...
  :
    if query br-docs:handle:get-buffer-handle(1) = (buffer shar-buf_ord-doc:handle) then do:
      ...
      parameter-4-85 =
        "where ":u +  substitute(' shar-buf_ord-doc.host-code =  &1 and shar-buf_ord-doc.need-fo = 1  and  shar-buf_ord-doc.cr-fo = yes  ' , g#host-code )  + " ":u + where-phrase-85 + " ":u + p-find-condition + " " + ""
      parameter-5-85 = " USE-INDEX By_need-fo "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query br-docs:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-87 as character no-undo .
      ...
      parameter-4-87 =
        (
          if (" shar-buf_ord-doc.cli-type  = sch-cli.obj-type and shar-buf_ord-doc.cli-code  = sch-cli.obj-code and shar-buf_ord-doc.host-code = g#host-code " + " " + where-phrase-87) <> ""
          then  substitute(' shar-buf_ord-doc.host-code =  &2 and                             shar-buf_ord-doc.cli-type  = &1&3&1 and                             shar-buf_ord-doc.cli-code  =  &4' , chr(34) , g#host-code , sch-cli.obj-type , sch-cli.obj-code )  + " " + where-phrase-87
          else "true"
        )
      parameter-5-87 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-87 =
          (" shar-buf_ord-doc.cli-type  = sch-cli.obj-type and shar-buf_ord-doc.cli-code  = sch-cli.obj-code and shar-buf_ord-doc.host-code = g#host-code " + " " + where-phrase-87 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-docs:handle
  ...
  :
    if query br-docs:handle:get-buffer-handle(1) = (buffer shar-buf_ord-doc:handle) then do:
      ...
      parameter-4-87 =
        "where ":u +  substitute(' shar-buf_ord-doc.host-code =  &2 and                             shar-buf_ord-doc.cli-type  = &1&3&1 and                             shar-buf_ord-doc.cli-code  =  &4' , chr(34) , g#host-code , sch-cli.obj-type , sch-cli.obj-code )  + " ":u + where-phrase-87 + " ":u + p-find-condition + " " + ""
      parameter-5-87 = " USE-INDEX Bycli "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query br-docs:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-89 as character no-undo .
      ...
      parameter-4-89 =
        (
          if (" shar-buf_ord-doc.obj-code = store-code and shar-buf_ord-doc.obj-type = store-type" + " " + where-phrase-89) <> ""
          then  substitute(' shar-buf_ord-doc.obj-code = &2 and                             shar-buf_ord-doc.obj-type  = &1&3&1                             ' , chr(34) , store-code , store-type )  + " " + where-phrase-89
          else "true"
        )
      parameter-5-89 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-89 =
          (" shar-buf_ord-doc.obj-code = store-code and shar-buf_ord-doc.obj-type = store-type" + " " + where-phrase-89 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-docs:handle
  ...
  :
    if query br-docs:handle:get-buffer-handle(1) = (buffer shar-buf_ord-doc:handle) then do:
      ...
      parameter-4-89 =
        "where ":u +  substitute(' shar-buf_ord-doc.obj-code = &2 and                             shar-buf_ord-doc.obj-type  = &1&3&1                             ' , chr(34) , store-code , store-type )  + " ":u + where-phrase-89 + " ":u + p-find-condition + " " + ""
      parameter-5-89 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-91 as character no-undo .
      ...
      parameter-4-91 =
        (
          if (" shar-buf_ord-doc.obj-code = store-code and shar-buf_ord-doc.obj-type = store-type and shar-buf_ord-doc.doc-type = g#type " + " " + where-phrase-91) <> ""
          then  substitute('                             shar-buf_ord-doc.obj-code =  &3 and                             shar-buf_ord-doc.obj-type = &1&2&1 and                             shar-buf_ord-doc.doc-type = &1&4&1                             ' , chr(34) , store-type , store-code , g#type )  + " " + where-phrase-91
          else "true"
        )
      parameter-5-91 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-91 =
          (" shar-buf_ord-doc.obj-code = store-code and shar-buf_ord-doc.obj-type = store-type and shar-buf_ord-doc.doc-type = g#type " + " " + where-phrase-91 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-docs:handle
  ...
  :
    if query br-docs:handle:get-buffer-handle(1) = (buffer shar-buf_ord-doc:handle) then do:
      ...
      parameter-4-91 =
        "where ":u +  substitute('                             shar-buf_ord-doc.obj-code =  &3 and                             shar-buf_ord-doc.obj-type = &1&2&1 and                             shar-buf_ord-doc.doc-type = &1&4&1                             ' , chr(34) , store-type , store-code , g#type )  + " ":u + where-phrase-91 + " ":u + p-find-condition + " " + ""
      parameter-5-91 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-93 as character no-undo .
      ...
      parameter-4-93 =
        (
          if (" shar-buf_ord-doc.obj-code = store-code and shar-buf_ord-doc.obj-type = store-type and shar-buf_ord-doc.doc-type = g#type and shar-buf_ord-doc.status_  = g#stat " + " " + where-phrase-93) <> ""
          then  substitute('                             shar-buf_ord-doc.obj-code =  &3 and                             shar-buf_ord-doc.obj-type = &1&2&1 and                             shar-buf_ord-doc.doc-type = &1&4&1 and                             shar-buf_ord-doc.status_  = &1&5&1                             ' , chr(34) , store-type , store-code , g#type , g#stat)  + " " + where-phrase-93
          else "true"
        )
      parameter-5-93 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-93 =
          (" shar-buf_ord-doc.obj-code = store-code and shar-buf_ord-doc.obj-type = store-type and shar-buf_ord-doc.doc-type = g#type and shar-buf_ord-doc.status_  = g#stat " + " " + where-phrase-93 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-docs:handle
  ...
  :
    if query br-docs:handle:get-buffer-handle(1) = (buffer shar-buf_ord-doc:handle) then do:
      ...
      parameter-4-93 =
        "where ":u +  substitute('                             shar-buf_ord-doc.obj-code =  &3 and                             shar-buf_ord-doc.obj-type = &1&2&1 and                             shar-buf_ord-doc.doc-type = &1&4&1 and                             shar-buf_ord-doc.status_  = &1&5&1                             ' , chr(34) , store-type , store-code , g#type , g#stat)  + " ":u + where-phrase-93 + " ":u + p-find-condition + " " + ""
      parameter-5-93 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-95 as character no-undo .
      ...
      parameter-4-95 =
        (
          if (" shar-buf_ord-doc.host-code = g#host-code and shar-buf_ord-doc.cons-code = sch-cons.cons-code and shar-buf_ord-doc.doc-type = g#type " + " " + where-phrase-95) <> ""
          then  substitute('                             shar-buf_ord-doc.host-code =  &2 and                             shar-buf_ord-doc.cons-code = &1&3&1 and                             shar-buf_ord-doc.doc-type = &1&4&1                              ' , chr(34) , g#host-code , sch-cons.cons-code , g#type )  + " " + where-phrase-95
          else "true"
        )
      parameter-5-95 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-95 =
          (" shar-buf_ord-doc.host-code = g#host-code and shar-buf_ord-doc.cons-code = sch-cons.cons-code and shar-buf_ord-doc.doc-type = g#type " + " " + where-phrase-95 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-docs:handle
  ...
  :
    if query br-docs:handle:get-buffer-handle(1) = (buffer shar-buf_ord-doc:handle) then do:
      ...
      parameter-4-95 =
        "where ":u +  substitute('                             shar-buf_ord-doc.host-code =  &2 and                             shar-buf_ord-doc.cons-code = &1&3&1 and                             shar-buf_ord-doc.doc-type = &1&4&1                              ' , chr(34) , g#host-code , sch-cons.cons-code , g#type )  + " ":u + where-phrase-95 + " ":u + p-find-condition + " " + ""
      parameter-5-95 = "use-index ByType "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query br-docs:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-97 as character no-undo .
      ...
      parameter-4-97 =
        (
          if (" shar-buf_ord-doc.contract-code = sch-contract.contract-code and shar-buf_ord-doc.host-code = g#host-code " + " " + where-phrase-97) <> ""
          then  substitute('                             shar-buf_ord-doc.host-code =  &2 and                             shar-buf_ord-doc.contract-code = &3                             ' , chr(34) , g#host-code , sch-contract.contract-code )  + " " + where-phrase-97
          else "true"
        )
      parameter-5-97 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-97 =
          (" shar-buf_ord-doc.contract-code = sch-contract.contract-code and shar-buf_ord-doc.host-code = g#host-code " + " " + where-phrase-97 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-docs:handle
  ...
  :
    if query br-docs:handle:get-buffer-handle(1) = (buffer shar-buf_ord-doc:handle) then do:
      ...
      parameter-4-97 =
        "where ":u +  substitute('                             shar-buf_ord-doc.host-code =  &2 and                             shar-buf_ord-doc.contract-code = &3                             ' , chr(34) , g#host-code , sch-contract.contract-code )  + " ":u + where-phrase-97 + " ":u + p-find-condition + " " + ""
      parameter-5-97 = "use-index by_contract "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query br-docs:handle
...
define variable v-str-recid99 as character no-undo .
define variable v-num-entry99 as integer   no-undo .
assign
  v-str-recid99 = trim( string( recid( shar-buf_ord-doc ) , "->>>>>>>>>>>9":U ) )
  v-num-entry99 = lookup( v-str-recid99 , del-list )
.
if v-num-entry99 > 0 then do:
  assign
    entry( v-num-entry99, del-list ) = "":U
    del-list = trim( replace( del-list , chr(44) + chr(44) , chr(44) ) , chr(44) )
  .
end.
else do:
  assign
    del-list = del-list + ( if del-list = "":U then "":U else chr(44) ) + v-str-recid99
  .
end.
