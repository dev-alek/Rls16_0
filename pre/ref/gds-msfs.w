...
assign
  v-str-recid20 = trim( string( recid( X_ext-classif ) , "->>>>>>>>>>>9":U ) )
...
if v-num-entry20 > 0 then do:
  ...
  .
    ...
    if last-event:function <> "MOUSE-SELECT-DBLCLICK" then do:
        ...
        apply "VALUE-CHANGED" to br-msf-codes in frame Dialog-Frame.
    end.
  ...
  apply "entry" to br-msf-codes in frame Dialog-Frame.
END.
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse br-msf-codes :handle
      .
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY br-msf-codes FOR EACH X_ext-classif NO-LOCK,        FIRST X_goods NO-LOCK INDEXED-REPOSITION.
END PROCEDURE.
PROCEDURE fill-tables :
run meatsemi_fill-msf in this-procedure ( input 'ПРОСМОТР':U
...
case p-list-mode:
  when 'все':U then do:
    ...
    frame Dialog-Frame:title = title1
    filter-label = title1
    .
...
run gbl/flt-get.p
  ...
  then do:
    ...
    define variable  parameter-7-33 as character no-undo .
      ...
      parameter-4-33 =
        (
          if (" X_ext-classif.classif-subject = 'goods':U                       and X_ext-classif.classif-name = 'msf-code':U                       AND X_ext-classif.db-num = - 1" + " " + where-phrase-33) <> ""
          then  substitute('X_ext-classif.classif-subject = &1&2&1                       and X_ext-classif.classif-name = &1&3&1                       AND X_ext-classif.db-num = - 1', chr(34), 'goods':U, 'msf-code':U) + " " + where-phrase-33
          else "true"
        )
      parameter-5-33 = (" " + "" + " " + substitute(', FIRST X_goods NO-LOCK WHERE                                   X_goods.gds-code = integer(ENTRY(2, X_eXt-classif.uniq-key-rec, chr(3)))'))
    ...
    :
      assign
        l-disable-where-33 =
          (" X_ext-classif.classif-subject = 'goods':U                       and X_ext-classif.classif-name = 'msf-code':U                       AND X_ext-classif.db-num = - 1" + " " + where-phrase-33 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-msf-codes:handle
  ...
  if l-filter-open-33 = false then do:
    OPEN QUERY br-msf-codes FOR EACH X_ext-classif
      where  X_ext-classif.classif-subject = 'goods':U                       and X_ext-classif.classif-name = 'msf-code':U                       AND X_ext-classif.db-num = - 1
    , FIRST X_goods NO-LOCK WHERE                                   X_goods.gds-code = integer(ENTRY(2, X_eXt-classif.uniq-key-rec, chr(3)))
      INDEXED-REPOSITION
  .
      assign
        l-query-was-opened = true
...
run gbl/flt-get.p
  ...
  then do:
    ...
    define variable  parameter-7-35 as character no-undo .
      ...
      parameter-4-35 =
        (
          if (" X_ext-classif.classif-subject = 'goods':U                       and X_ext-classif.classif-name = 'msf-code':U                       AND X_ext-classif.db-num = - 1                       and X_ext-classif.key#_one = p-node-code " + " " + where-phrase-35) <> ""
          then  substitute('X_ext-classif.classif-subject = &1&2&1                       and X_ext-classif.classif-name = &1&3&1                       AND X_ext-classif.db-num = - 1                       AND X_ext-classif.key#_one = &4 ', chr(34), 'goods':U, 'msf-code':U, p-node-code)  + " " + where-phrase-35
          else "true"
        )
      parameter-5-35 = (" " + "" + " " + substitute(', FIRST X_goods NO-LOCK WHERE                                   X_goods.gds-code = integer(ENTRY(2, X_eXt-classif.uniq-key-rec, chr(3)))'))
    ...
    :
      assign
        l-disable-where-35 =
          (" X_ext-classif.classif-subject = 'goods':U                       and X_ext-classif.classif-name = 'msf-code':U                       AND X_ext-classif.db-num = - 1                       and X_ext-classif.key#_one = p-node-code " + " " + where-phrase-35 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-msf-codes:handle
  ...
  if l-filter-open-35 = false then do:
    OPEN QUERY br-msf-codes FOR EACH X_ext-classif
      where  X_ext-classif.classif-subject = 'goods':U                       and X_ext-classif.classif-name = 'msf-code':U                       AND X_ext-classif.db-num = - 1                       and X_ext-classif.key#_one = p-node-code
    , FIRST X_goods NO-LOCK WHERE                                   X_goods.gds-code = integer(ENTRY(2, X_eXt-classif.uniq-key-rec, chr(3)))
      INDEXED-REPOSITION
  .
      assign
...
run gbl/flt-get.p
  ...
  then do:
    ...
    define variable  parameter-7-37 as character no-undo .
      ...
      parameter-4-37 =
        (
          if (" X_ext-classif.classif-subject = 'goods':U                       and X_ext-classif.classif-name = 'msf-code':U                       AND X_ext-classif.db-num = - 1                       and X_ext-classif.uniq-key-rec = p-uniq-key-rec " + " " + where-phrase-37) <> ""
          then  substitute('X_ext-classif.classif-subject = &1&2&1                       and X_ext-classif.classif-name = &1&3&1                       AND X_ext-classif.db-num = - 1                       AND X_ext-classif.uniq-key-rec = &1&4&1 ', chr(34), 'goods':U, 'msf-code':U, p-uniq-key-rec)  + " " + where-phrase-37
          else "true"
        )
      parameter-5-37 = (" " + "" + " " + substitute(', FIRST X_goods NO-LOCK WHERE                                   X_goods.gds-code = integer(ENTRY(2, X_eXt-classif.uniq-key-rec, chr(3)))'))
    ...
    :
      assign
        l-disable-where-37 =
          (" X_ext-classif.classif-subject = 'goods':U                       and X_ext-classif.classif-name = 'msf-code':U                       AND X_ext-classif.db-num = - 1                       and X_ext-classif.uniq-key-rec = p-uniq-key-rec " + " " + where-phrase-37 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-msf-codes:handle
  ...
  if l-filter-open-37 = false then do:
    OPEN QUERY br-msf-codes FOR EACH X_ext-classif
      where  X_ext-classif.classif-subject = 'goods':U                       and X_ext-classif.classif-name = 'msf-code':U                       AND X_ext-classif.db-num = - 1                       and X_ext-classif.uniq-key-rec = p-uniq-key-rec
    , FIRST X_goods NO-LOCK WHERE                                   X_goods.gds-code = integer(ENTRY(2, X_eXt-classif.uniq-key-rec, chr(3)))
      INDEXED-REPOSITION
  .
      assign
...
APPLY "entry" TO br-msf-codes.
if available X_ext-classif then do:
    APPLY "VALUE-CHANGED":U to br-msf-codes.
END.
END PROCEDURE.
...
do v-ii = 1 to num-entries(v-rid-list):
  ...
  find first buf_ext-classif no-lock where
        ...
        and buf_ext-classif.classif-name = 'msf-code':U
