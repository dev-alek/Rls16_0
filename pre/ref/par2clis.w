...
if v-num-entry14 > 0 then do:
  ...
  .
    ...
    if last-event:function <> "MOUSE-SELECT-DBLCLICK" then do:
        ...
        apply "VALUE-CHANGED" to br-parus-2-cli in frame Dialog-Frame.
    end.
  ...
  apply "entry" to br-parus-2-cli in frame Dialog-Frame.
END.
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse br-parus-2-cli :handle
      .
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY br-parus-2-cli FOR EACH X_ext-classif NO-LOCK,        FIRST X_clients NO-LOCK INDEXED-REPOSITION.
END PROCEDURE.
PROCEDURE MyEnable :
ENABLE
b-quit
...
run gbl/flt-get.p
  ...
  then do:
    ...
    define variable  parameter-7-27 as character no-undo .
      ...
      parameter-4-27 =
        (
          if (" X_ext-classif.classif-subject = 'clients':U                         and X_ext-classif.classif-name = 'exp-parus-2-code':U                         AND X_ext-classif.db-num = - 1" + " " + where-phrase-27) <> ""
          then  substitute('X_ext-classif.classif-subject = &1&2&1                         and X_ext-classif.classif-name = &1&3&1                         AND X_ext-classif.db-num = - 1', chr(34), 'clients':U, 'exp-parus-2-code':U) + " " + where-phrase-27
          else "true"
        )
    ...
    :
      assign
        l-disable-where-27 =
          (" X_ext-classif.classif-subject = 'clients':U                         and X_ext-classif.classif-name = 'exp-parus-2-code':U                         AND X_ext-classif.db-num = - 1" + " " + where-phrase-27 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-parus-2-cli:handle
  ...
  if l-filter-open-27 = false then do:
    OPEN QUERY br-parus-2-cli FOR EACH X_ext-classif
      where  X_ext-classif.classif-subject = 'clients':U                         and X_ext-classif.classif-name = 'exp-parus-2-code':U                         AND X_ext-classif.db-num = - 1
...
APPLY "entry" TO br-parus-2-cli.
if available X_ext-classif then do:
    APPLY "VALUE-CHANGED":U to br-parus-2-cli.
END.
END PROCEDURE.
