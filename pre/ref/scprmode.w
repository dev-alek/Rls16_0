...
DO:
    Pri-mode = "отказ".
END.
ON VALUE-CHANGED OF ByBar IN FRAME Dialog-Frame
DO:
  assign ByBar.
  if ByBar then
    do:
...
END.
ON VALUE-CHANGED OF ByGroup IN FRAME Dialog-Frame
DO:
  assign ByGroup.
  if ByGroup then
    do:
...
END.
ON VALUE-CHANGED OF ByGroup-Name IN FRAME Dialog-Frame
DO:
  assign ByGroup-NAME.
...
END.
ON VALUE-CHANGED OF ByName IN FRAME Dialog-Frame
DO:
  assign ByName.
  if ByName then
    do:
...
END.
ON VALUE-CHANGED OF ByPlu IN FRAME Dialog-Frame
DO:
  assign ByPlu.
  if ByPlu then
    do:
