...
DO:
  ...
  if error-status:error then return no-apply.
END.
ON CHOOSE OF b-show-doc IN FRAME Dialog-Frame
DO:
...
DO:
  run proc-find-gds-code in this-procedure ( input yes, input frame Dialog-Frame sch-gds-code) no-error.
  if error-status:error then return no-apply.
END.
ON RETURN OF sch-gds-code IN FRAME Dialog-Frame
DO:
  run proc-find-gds-code in this-procedure ( input no, input frame Dialog-Frame sch-gds-code) no-error.
  if error-status:error then return no-apply.
END.
ON CTRL-J OF sch-source-ref IN FRAME Dialog-Frame
DO:
  run proc-find-source-ref in this-procedure ( input yes, input frame Dialog-Frame sch-source-ref) no-error.
  if error-status:error then return no-apply.
END.
ON RETURN OF sch-source-ref IN FRAME Dialog-Frame
DO:
  run proc-find-source-ref in this-procedure ( input no, input frame Dialog-Frame sch-source-ref) no-error.
  if error-status:error then return no-apply.
END.
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse BR-cplgdsobj :handle
      .
...
do:
  ...
  then do:
    ASSIGN
      sch-corr-date :POPUP-MENU in frame Dialog-Frame = MENU m-ed-date18 :HANDLE
      sch-corr-date :MENU-MOUSE in frame Dialog-Frame = 3
    .
  end.
  define variable v-label-handle18 as handle no-undo .
  assign
    v-label-handle18 = sch-corr-date :side-label-handle in frame Dialog-Frame
  .
...
do:
   v-doc-rec = recid(X_c-pl-gds-obj).  RUn OpenBR in this-procedure ( input yes, input no, input '':U).  REPOSITION br-cplgdsobj to recid v-doc-rec No-ERROR.                apply 'value-changed' to br-cplgdsobj.
...
PROCEDURE display-record :
  ...
  :
    IF NOT AVAILABLE X_c-pl-gds-obj THEN DO:
        assign
        ub.c-pl-gds-obj.fact-qnty:visible in frame Dialog-Frame = no
        ub.c-pl-gds-obj.old-fact-qnty:visible in frame Dialog-Frame = no
        ub.c-pl-gds-obj.cli-qnty:visible in frame Dialog-Frame = no
        ub.c-pl-gds-obj.old-cli-qnty:visible in frame Dialog-Frame = no
        ub.c-pl-gds-obj.free-qnty:visible in frame Dialog-Frame = no
        ub.c-pl-gds-obj.old-free-qnty:visible in frame Dialog-Frame = no
        .
    END.
    else do:
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run gdscdat in g#library
  (input  X_c-pl-gds-obj.gds-code
...
END PROCEDURE.
PROCEDURE enable_UI :
  OPEN QUERY Dialog-Frame FOR EACH X_c-pl-gds-obj NO-LOCK.
...
title0 = "История остатков по складским местам" + chr(32).
...
CASE p-mode :
  WHEN 'place':U THEN DO:
    ...
    if p-open-query then do:
      ASSIGN
      frame Dialog-Frame:TITLE = title0 + substitute("Объект &1&2 Остатки товаров на складском месте &3"
                                                        ,p-obj-type
                                                        ,p-obj-code
                                                        ,p-pl-code
                                                      ).
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-26 as character no-undo .
      assign
      parameter-3-26 =
                              "FOR EACH X_c-pl-gds-obj"
      parameter-4-26 =
        (
          if ("                           X_c-pl-gds-obj.obj-type = p-obj-type and X_c-pl-gds-obj.obj-code = p-obj-code                             AND X_c-pl-gds-obj.pl-code = p-pl-code " + " " + where-phrase-26) <> ""
          then  substitute(' X_c-pl-gds-obj.obj-type = &1&2&1 and X_c-pl-gds-obj.obj-code = &3                             AND X_c-pl-gds-obj.pl-code = &4 ', chr(34), p-obj-type, p-obj-code, p-pl-code) + " " + where-phrase-26
          else "true"
        )
      parameter-5-26 = (" " + "" + " " + "")
      parameter-6-26 = if sort-phrase-26 = ''
        ...
        " " + " " +
          " " + sort-column-phrase +
        " " + " by X_c-pl-gds-obj.gds-code by X_c-pl-gds-obj.chip-num descending "
        )
                           else
        (
        " " + " " +
    ...
    :
      assign
        l-disable-where-26 =
          ("                           X_c-pl-gds-obj.obj-type = p-obj-type and X_c-pl-gds-obj.obj-code = p-obj-code                             AND X_c-pl-gds-obj.pl-code = p-pl-code " + " " + where-phrase-26 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-cplgdsobj:handle
  ...
  if l-filter-open-26 = false then do:
    OPEN QUERY br-cplgdsobj FOR EACH X_c-pl-gds-obj
      where                            X_c-pl-gds-obj.obj-type = p-obj-type and X_c-pl-gds-obj.obj-code = p-obj-code                             AND X_c-pl-gds-obj.pl-code = p-pl-code
       by X_c-pl-gds-obj.gds-code by X_c-pl-gds-obj.chip-num descending
      indexed-reposition
  .
      assign
  ...
  on error undo, leave
  :
    if query br-cplgdsobj:handle:get-buffer-handle(1) = (buffer X_c-pl-gds-obj:handle) then do:
      assign
      parameter-2-26 = (if p-find-next then "true":u else "false":u )
      parameter-4-26 =
        "where ":u +  substitute(' X_c-pl-gds-obj.obj-type = &1&2&1 and X_c-pl-gds-obj.obj-code = &3                             AND X_c-pl-gds-obj.pl-code = &4 ', chr(34), p-obj-type, p-obj-code, p-pl-code) + " ":u + where-phrase-26 + " ":u + p-find-condition + " " + ""
      parameter-5-26 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query br-cplgdsobj:handle
                          ,input rowid(X_c-pl-gds-obj)
                          ,input logical(parameter-2-26)
                          ,input no-lock
                          ,input (buffer X_c-pl-gds-obj:handle)
                          ,input parameter-4-26
                          ,input parameter-5-26
                          ) no-error.
      .
      ...
      assign
      parameter-2-26 = (if p-find-next then "true":u else "false":u )
      parameter-3-26 =  "FOR EACH X_c-pl-gds-obj"
      parameter-4-26 =
        (
          if ("                           X_c-pl-gds-obj.obj-type = p-obj-type and X_c-pl-gds-obj.obj-code = p-obj-code                             AND X_c-pl-gds-obj.pl-code = p-pl-code " + " " + where-phrase-26) <> ""
          then  substitute(' X_c-pl-gds-obj.obj-type = &1&2&1 and X_c-pl-gds-obj.obj-code = &3                             AND X_c-pl-gds-obj.pl-code = &4 ', chr(34), p-obj-type, p-obj-code, p-pl-code) + " " + where-phrase-26
  ...
  WHEN 'one':U THEN  DO:
    ...
    if p-open-query then do:
      ASSIGN
      frame Dialog-Frame:TITLE = title0 + substitute("Объект &1&2 Остатки товара с кодом &3 на складском месте &4"
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-28 as character no-undo .
      ...
      parameter-4-28 =
        (
          if ("                           X_c-pl-gds-obj.obj-type = p-obj-type and X_c-pl-gds-obj.obj-code = p-obj-code                             AND X_c-pl-gds-obj.pl-code = p-pl-code and X_c-pl-gds-obj.gds-code = p-gds-code " + " " + where-phrase-28) <> ""
          then  substitute(' X_c-pl-gds-obj.obj-type = &1&2&1 and X_c-pl-gds-obj.obj-code = &3                             AND X_c-pl-gds-obj.pl-code = &4 and X_c-pl-gds-obj.gds-code = &5 ', chr(34), p-obj-type, p-obj-code, p-pl-code, p-gds-code) + " " + where-phrase-28
          else "true"
        )
      parameter-5-28 = (" " + "" + " " + "")
      parameter-6-28 = if sort-phrase-28 = ''
        ...
        " " + "  " +
          " " + sort-column-phrase +
        " " + " by X_c-pl-gds-obj.chip-num descending "
        )
                           else
        (
        " " + "  " +
    ...
    :
      assign
        l-disable-where-28 =
          ("                           X_c-pl-gds-obj.obj-type = p-obj-type and X_c-pl-gds-obj.obj-code = p-obj-code                             AND X_c-pl-gds-obj.pl-code = p-pl-code and X_c-pl-gds-obj.gds-code = p-gds-code " + " " + where-phrase-28 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-cplgdsobj:handle
  ...
  if l-filter-open-28 = false then do:
    OPEN QUERY br-cplgdsobj FOR EACH X_c-pl-gds-obj
      where                            X_c-pl-gds-obj.obj-type = p-obj-type and X_c-pl-gds-obj.obj-code = p-obj-code                             AND X_c-pl-gds-obj.pl-code = p-pl-code and X_c-pl-gds-obj.gds-code = p-gds-code
       by X_c-pl-gds-obj.chip-num descending
      indexed-reposition
  .
      assign
  ...
  :
    if query br-cplgdsobj:handle:get-buffer-handle(1) = (buffer X_c-pl-gds-obj:handle) then do:
      ...
      parameter-4-28 =
        "where ":u +  substitute(' X_c-pl-gds-obj.obj-type = &1&2&1 and X_c-pl-gds-obj.obj-code = &3                             AND X_c-pl-gds-obj.pl-code = &4 and X_c-pl-gds-obj.gds-code = &5 ', chr(34), p-obj-type, p-obj-code, p-pl-code, p-gds-code) + " ":u + where-phrase-28 + " ":u + p-find-condition + " " + ""
      parameter-5-28 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-28 = (if p-find-next then "true":u else "false":u )
      parameter-3-28 =  "FOR EACH X_c-pl-gds-obj"
      parameter-4-28 =
        (
          if ("                           X_c-pl-gds-obj.obj-type = p-obj-type and X_c-pl-gds-obj.obj-code = p-obj-code                             AND X_c-pl-gds-obj.pl-code = p-pl-code and X_c-pl-gds-obj.gds-code = p-gds-code " + " " + where-phrase-28) <> ""
          then  substitute(' X_c-pl-gds-obj.obj-type = &1&2&1 and X_c-pl-gds-obj.obj-code = &3                             AND X_c-pl-gds-obj.pl-code = &4 and X_c-pl-gds-obj.gds-code = &5 ', chr(34), p-obj-type, p-obj-code, p-pl-code, p-gds-code) + " " + where-phrase-28
...
run waitfram-hide in this-procedure .
APPLY "VALUE-CHANGED" TO br-cplgdsobj in frame Dialog-Frame.
...
reposition br-cplgdsobj to recid v-doc-rec no-error.
apply "entry" to br-cplgdsobj in frame Dialog-Frame.
END PROCEDURE.
