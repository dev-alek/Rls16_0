  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse BR-cash-counter :handle
      .
...
ASSIGN
f-total:LABEL IN FRAME Dialog-Frame = substitute("Всего (в &1)", (IF v-curr-r-b = 'rubl':U THEN "нац.вал." ELSE "баз.вал. "))
