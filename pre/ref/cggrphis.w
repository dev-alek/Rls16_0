...
DEFINE BROWSE BR-c-gds-grp-hist
  QUERY BR-c-gds-grp-hist DISPLAY
      ...
      X_c-gds-grp-hist.corr-user-db-num COLUMN-LABEL "БД" FORMAT ">>>>9":U
            WIDTH 3
      (if p-mode = 'gds-prt':U then "Узел Шкалы" else entry (lookup (X_c-gds-grp-hist.subject, 'gds-grp,gds-grp-attr,gds-grp-obj,tax-rate-gds-grp,dis-grp-rule':U), 'Группа товаров,Атр-т группы товаров,Группа товаров на объекте,Налоги группы товаров,Скидки по группе':U)) COLUMN-LABEL "Предмет изменений" FORMAT "X(32)":U
      ...
      string(X_c-gds-grp-hist.corr-time, "HH:MM") COLUMN-LABEL "Время!корр" FORMAT "X(5)":U
            WIDTH 6
      if X_c-gds-grp-hist.subject <> 'gds-grp':U and X_c-gds-grp-hist.host-code > 0 then string(X_c-gds-grp-hist.host-code) else '':U COLUMN-LABEL "Фирма" FORMAT "X(5)":U
            WIDTH 6
      if X_c-gds-grp-hist.subject <> 'gds-grp':U and X_c-gds-grp-hist.obj-code > 0 then
...
assign
  v-str-recid14 = trim( string( recid( X_c-gds-grp-hist ) , "->>>>>>>>>>>9":U ) )
...
if v-num-entry14 > 0 then do:
  ...
  g#log = br-c-gds-grp-hist :refresh( )  in frame Dialog-Frame.
  if not can-do ("MOUSE-SELECT-DBLCLICK,Return", last-event:function) then do:
          g#log = br-c-gds-grp-hist:select-next-row () in frame Dialog-Frame.
          apply "value-changed" to br-c-gds-grp-hist in frame Dialog-Frame.
  end.
  ...
  apply "entry" to br-c-gds-grp-hist in frame Dialog-Frame.
END.
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse br-c-gds-grp-hist :handle
      .
...
do:
  v-doc-rec = recid(X_c-gds-grp-hist). run openbr in this-procedure ( input yes, input no, input '':U). reposition br-c-gds-grp-hist to recid v-doc-rec no-error.
              APPLY 'VALUE-CHANGED' to br-c-gds-grp-hist.
    apply "VALUE-CHANGED" to BR-c-gds-grp-hist.
end.
define variable vss-include-info20 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
do:
  BR-c-gds-grp-hist :SET-REPOSITIONED-ROW(5, "CONDITIONAL") .
end.
def var sort-labelbr-c-gds-grp-hist   as character no-undo .
def var sort-clmnbr-c-gds-grp-hist    as handle    no-undo .
def var cur-clmnbr-c-gds-grp-hist     as handle    no-undo .
def var cur-clmn-locbr-c-gds-grp-hist as integer   no-undo .
def var re-querybr-c-gds-grp-hist     as logical   initial no no-undo .
on start-search, ctrl-o of br-c-gds-grp-hist in frame Dialog-Frame do:
   run sort-brbr-c-gds-grp-hist
     (input (if available X_c-gds-grp-hist
             then recid(X_c-gds-grp-hist)
             else ?
            )
     ).
end.
PROCEDURE sort-brbr-c-gds-grp-hist :
  define input parameter p-recid as recid no-undo .
  if re-querybr-c-gds-grp-hist = no then do:
    assign
       cur-clmnbr-c-gds-grp-hist = br-c-gds-grp-hist:current-column in frame Dialog-Frame
    .
    if sort-clmnbr-c-gds-grp-hist <> ? then sort-clmnbr-c-gds-grp-hist:column-fgcolor = 0.
    if cur-clmnbr-c-gds-grp-hist = sort-clmnbr-c-gds-grp-hist then do:
      assign
         sort-labelbr-c-gds-grp-hist = ""
         sort-clmnbr-c-gds-grp-hist = ?
      .
     end.
     else do:
       assign
         sort-labelbr-c-gds-grp-hist = cur-clmnbr-c-gds-grp-hist:label
         sort-clmnbr-c-gds-grp-hist  = cur-clmnbr-c-gds-grp-hist
         sort-clmnbr-c-gds-grp-hist:column-fgcolor = 4
       .
     end.
   end.
  assign
    cur-clmn-locbr-c-gds-grp-hist = 1
  .
  def var column-handle as handle no-undo .
  column-handle = br-c-gds-grp-hist:first-column.
  do while valid-handle(column-handle) :
    if column-handle = cur-clmnbr-c-gds-grp-hist then do:
      leave .
    end.
    column-handle = column-handle:NEXT-COLUMN.
    assign
      cur-clmn-locbr-c-gds-grp-hist = cur-clmn-locbr-c-gds-grp-hist + 1
    .
  end.
  case sort-labelbr-c-gds-grp-hist:
        when X_c-gds-grp-hist.corr-date:label in browse br-c-gds-grp-hist then DO:    assign       sort-column-name = "X_c-gds-grp-hist.corr-date"     .     run OpenBr in this-procedure ( input yes, input no, input '':U).   . END.
        when X_c-gds-grp-hist.corr-user-db-num:label in browse br-c-gds-grp-hist then DO:    assign       sort-column-name = "X_c-gds-grp-hist.corr-user-db-num"     .     run OpenBr in this-procedure ( input yes, input no, input '':U).   . END.
    otherwise do:
      assign
        sort-column-name = ""
      .
      run OpenBr in this-procedure ( input yes, input no, input '':U).
      if sort-labelbr-c-gds-grp-hist <> "" then do:
        assign
          cur-clmnbr-c-gds-grp-hist:column-fgcolor = 0
        .
      end.
      assign
        cur-clmn-locbr-c-gds-grp-hist = ?
      .
    end.
  end case.
  if p-recid <> ? then do:
    reposition br-c-gds-grp-hist to recid p-recid no-error.
    apply "value-changed" to br-c-gds-grp-hist in frame Dialog-Frame.
  end.
  apply "entry" to br-c-gds-grp-hist in frame Dialog-Frame.
END PROCEDURE.
procedure re-open-query-srt-clmnbr-c-gds-grp-hist:
if cur-clmnbr-c-gds-grp-hist = ? then do:
   run OpenBr in this-procedure ( input yes, input no, input '':U).
end.
else do:
   assign re-querybr-c-gds-grp-hist = yes.
   run sort-brbr-c-gds-grp-hist
     (input (if available X_c-gds-grp-hist
             then recid(X_c-gds-grp-hist)
             else ?
   ...
   assign re-querybr-c-gds-grp-hist = no.
end.
end.
MAIN-BLOCK:
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ON END-KEY UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK:
   if LOOKUP(p-mode, ("gds-grp":U  + chr(4) +
                     "gds-prt":U + chr(4) +
                     "gds-grp-attr":U  + chr(4) +
                     "gds-grp-obj":U  + chr(4) +
                     "tax-rate-gds-grp":U  + chr(4) +
                     ("gds-grp-attr":U + chr(44) + 'объект':U) + chr(4) +
                     ("gds-grp-obj":U + chr(44) + 'объект':U)  + chr(4) +
                     ("tax-rate-gds-grp":U + chr(44) + 'объект':U)  + chr(4) +
                     ("gds-grp-attr":U + chr(44) + "host":U) + chr(4) +
                     ("gds-grp-obj":U + chr(44) + "host":U)  + chr(4) +
                     ("tax-rate-gds-grp":U + chr(44) + "host":U)),
                     chr(4)
                     ) > 0
   THEN DO:
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run hostcode in g#library
  ...
  ,output p-host-code
   ...
   if lookup(p-mode, "gds-grp-attr") > 0 then do:
      if lookup(p-attr-code, 'gds-grp-nabor':u) = 0 then do:
          message
          vss-workfile vss-revision vss-description skip
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY BR-c-gds-grp-hist FOR EACH X_c-gds-grp-hist NO-LOCK.
END PROCEDURE.
PROCEDURE MyEnable :
...
CASE p-mode:
    when 'все':U then do:
        ASSIGN frame Dialog-Frame:TITLE = "Справочник истории групп товаров"
...
run gbl/flt-get.p
  ...
  then do:
    ...
    define variable  parameter-7-23 as character no-undo .
      assign
      parameter-3-23 =
                              "FOR EACH X_c-gds-grp-hist"
      parameter-4-23 =
        (
          if (" X_c-gds-grp-hist.node-code > 0 " + " " + where-phrase-23) <> ""
          then " X_c-gds-grp-hist.node-code > 0 " + " " + where-phrase-23
          else "true"
        )
      parameter-5-23 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-23 =
          (" X_c-gds-grp-hist.node-code > 0 " + " " + where-phrase-23 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-c-gds-grp-hist:handle
  ...
  if l-filter-open-23 = false then do:
    OPEN QUERY br-c-gds-grp-hist FOR EACH X_c-gds-grp-hist
      where  X_c-gds-grp-hist.node-code > 0
  .
      assign
        l-query-was-opened = true
      .
  ...
  run waitfram-hide in this-procedure .
    ...
    when "gds-grp":U then do:
        ASSIGN frame Dialog-Frame:TITLE = substitute("Справочник истории групп товаров: вн № группы &1",
                                                       p-node-code)
        filter-point = filter-point0 + p-mode
...
run gbl/flt-get.p
  ...
  then do:
    ...
    define variable  parameter-7-25 as character no-undo .
      ...
      parameter-4-25 =
        (
          if (" X_c-gds-grp-hist.node-code = p-node-code " + " " + where-phrase-25) <> ""
          then  substitute('X_c-gds-grp-hist.node-code = &1', p-node-code)  + " " + where-phrase-25
          else "true"
        )
      parameter-5-25 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-25 =
          (" X_c-gds-grp-hist.node-code = p-node-code " + " " + where-phrase-25 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-c-gds-grp-hist:handle
  ...
  if l-filter-open-25 = false then do:
    OPEN QUERY br-c-gds-grp-hist FOR EACH X_c-gds-grp-hist
      where  X_c-gds-grp-hist.node-code = p-node-code
  .
      assign
        l-query-was-opened = true
      .
  ...
  run waitfram-hide in this-procedure .
    ...
    when "gds-grp-attr":U then do:
        ASSIGN frame Dialog-Frame:TITLE = substitute("Справочник истории групп товаров: вн.№ &1 атрибут &2"
                                                       , p-node-code
                                                       , p-attr-code
                                                       )
        filter-point = filter-point0 + p-mode
...
run gbl/flt-get.p
  ...
  then do:
    ...
    define variable  parameter-7-27 as character no-undo .
      ...
      parameter-4-27 =
        (
          if (" X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.attr-code = p-attr-code AND                             X_c-gds-grp-hist.subject = 'gds-grp-attr':U " + " " + where-phrase-27) <> ""
          then  substitute('X_c-gds-grp-hist.node-code = &1 AND                             X_c-gds-grp-hist.attr-code = &2&3&2 AND                             X_c-gds-grp-hist.subject = &2&4&2 ', p-node-code, chr(34), p-attr-code, 'gds-grp-attr':U)  + " " + where-phrase-27
          else "true"
        )
      parameter-5-27 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-27 =
          (" X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.attr-code = p-attr-code AND                             X_c-gds-grp-hist.subject = 'gds-grp-attr':U " + " " + where-phrase-27 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-c-gds-grp-hist:handle
  ...
  if l-filter-open-27 = false then do:
    OPEN QUERY br-c-gds-grp-hist FOR EACH X_c-gds-grp-hist
      where  X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.attr-code = p-attr-code AND                             X_c-gds-grp-hist.subject = 'gds-grp-attr':U
  .
      assign
        l-query-was-opened = true
      .
  ...
  run waitfram-hide in this-procedure .
    ...
    when ("gds-grp-attr":U + 'объект':U) then do:
        ASSIGN frame Dialog-Frame:TITLE = substitute("Справочник истории групп товаров: вн.№ &1 атрибут &2 объект &3&4"
                                                       , p-node-code
                                                       , p-attr-code
                                                       , p-obj-type
                                                       , p-obj-code
...
run gbl/flt-get.p
  ...
  then do:
    ...
    define variable  parameter-7-29 as character no-undo .
      ...
      parameter-4-29 =
        (
          if (" X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.attr-code = p-attr-code AND                             X_c-gds-grp-hist.obj-type = p-obj-type AND                             X_c-gds-grp-hist.obj-code = p-obj-code AND                             X_c-gds-grp-hist.host-code = p-host-code AND                             X_c-gds-grp-hist.subject = 'gds-grp-attr':U " + " " + where-phrase-29) <> ""
          then  substitute('X_c-gds-grp-hist.node-code = &1 AND                             X_c-gds-grp-hist.attr-code = &2&3&2 AND                             X_c-gds-grp-hist.obj-type = &2&4&2 AND                             X_c-gds-grp-hist.obj-code = &5 AND                             X_c-gds-grp-hist.host-code = &6 AND                             X_c-gds-grp-hist.subject = &2&7&2', p-node-code, chr(34), p-attr-code, p-obj-type, p-obj-code, p-host-code, 'gds-grp-attr':U)  + " " + where-phrase-29
          else "true"
        )
      parameter-5-29 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-29 =
          (" X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.attr-code = p-attr-code AND                             X_c-gds-grp-hist.obj-type = p-obj-type AND                             X_c-gds-grp-hist.obj-code = p-obj-code AND                             X_c-gds-grp-hist.host-code = p-host-code AND                             X_c-gds-grp-hist.subject = 'gds-grp-attr':U " + " " + where-phrase-29 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-c-gds-grp-hist:handle
  ...
  if l-filter-open-29 = false then do:
    OPEN QUERY br-c-gds-grp-hist FOR EACH X_c-gds-grp-hist
      where  X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.attr-code = p-attr-code AND                             X_c-gds-grp-hist.obj-type = p-obj-type AND                             X_c-gds-grp-hist.obj-code = p-obj-code AND                             X_c-gds-grp-hist.host-code = p-host-code AND                             X_c-gds-grp-hist.subject = 'gds-grp-attr':U
  .
      assign
        l-query-was-opened = true
      .
  ...
  run waitfram-hide in this-procedure .
    ...
    when ("gds-grp-attr":U + "host":U) then do:
        ASSIGN frame Dialog-Frame:TITLE = substitute("Справочник истории групп товаров: вн.№ &1 атрибут &2 фирма &3"
                                                       , p-node-code
                                                       , p-attr-code
                                                       , p-host-code
                                                       )
...
run gbl/flt-get.p
  ...
  then do:
    ...
    define variable  parameter-7-31 as character no-undo .
      ...
      parameter-4-31 =
        (
          if (" X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.attr-code = p-attr-code AND                             X_c-gds-grp-hist.host-code = p-host-code AND                             X_c-gds-grp-hist.subject = 'gds-grp-attr':U " + " " + where-phrase-31) <> ""
          then  substitute('X_c-gds-grp-hist.node-code = &1 AND                             X_c-gds-grp-hist.attr-code = &2&3&2 AND                             X_c-gds-grp-hist.host-code = &4 AND                             X_c-gds-grp-hist.subject = &2&5&2', p-node-code, chr(34), p-attr-code, p-host-code, 'gds-grp-attr':U)  + " " + where-phrase-31
          else "true"
        )
      parameter-5-31 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-31 =
          (" X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.attr-code = p-attr-code AND                             X_c-gds-grp-hist.host-code = p-host-code AND                             X_c-gds-grp-hist.subject = 'gds-grp-attr':U " + " " + where-phrase-31 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-c-gds-grp-hist:handle
  ...
  if l-filter-open-31 = false then do:
    OPEN QUERY br-c-gds-grp-hist FOR EACH X_c-gds-grp-hist
      where  X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.attr-code = p-attr-code AND                             X_c-gds-grp-hist.host-code = p-host-code AND                             X_c-gds-grp-hist.subject = 'gds-grp-attr':U
  .
      assign
        l-query-was-opened = true
      .
  ...
  run waitfram-hide in this-procedure .
    ...
    when "gds-grp-obj":U then do:
        ASSIGN frame Dialog-Frame:TITLE = substitute("Справочник истории групп товаров: вн.№ &1 параметры по объектам"
                                                       , p-node-code
                                                       )
        filter-point = filter-point0 + p-mode
...
run gbl/flt-get.p
  ...
  then do:
    ...
    define variable  parameter-7-33 as character no-undo .
      ...
      parameter-4-33 =
        (
          if (" X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.subject = 'gds-grp-obj':U " + " " + where-phrase-33) <> ""
          then  substitute('X_c-gds-grp-hist.node-code = &1 AND                             X_c-gds-grp-hist.subject = &2&3&2', p-node-code, chr(34), 'gds-grp-obj':U)  + " " + where-phrase-33
          else "true"
        )
      parameter-5-33 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-33 =
          (" X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.subject = 'gds-grp-obj':U " + " " + where-phrase-33 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-c-gds-grp-hist:handle
  ...
  if l-filter-open-33 = false then do:
    OPEN QUERY br-c-gds-grp-hist FOR EACH X_c-gds-grp-hist
      where  X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.subject = 'gds-grp-obj':U
  .
      assign
        l-query-was-opened = true
      .
  ...
  run waitfram-hide in this-procedure .
    ...
    when ("gds-grp-obj":U + chr(44) + 'объект':U)then do:
        ASSIGN frame Dialog-Frame:TITLE = substitute("Справочник истории групп товаров: вн.№ &1 параметры для объекта &2&3"
                                                       , p-node-code
                                                       , p-obj-type
                                                       , p-obj-code
                                                       )
...
run gbl/flt-get.p
  ...
  then do:
    ...
    define variable  parameter-7-35 as character no-undo .
      ...
      parameter-4-35 =
        (
          if (" X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.obj-type = p-obj-type AND                             X_c-gds-grp-hist.obj-code = p-obj-code AND                             X_c-gds-grp-hist.host-code = p-host-code AND                             X_c-gds-grp-hist.subject = 'gds-grp-obj':U " + " " + where-phrase-35) <> ""
          then  substitute('X_c-gds-grp-hist.node-code = &1 AND                             X_c-gds-grp-hist.obj-type = &2&3&2 AND                             X_c-gds-grp-hist.obj-code = &4 AND                             X_c-gds-grp-hist.host-code = &5 AND                             X_c-gds-grp-hist.subject = &2&6&2', p-node-code, chr(34), p-obj-type, p-obj-code, p-host-code, 'gds-grp-obj':U)  + " " + where-phrase-35
          else "true"
        )
      parameter-5-35 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-35 =
          (" X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.obj-type = p-obj-type AND                             X_c-gds-grp-hist.obj-code = p-obj-code AND                             X_c-gds-grp-hist.host-code = p-host-code AND                             X_c-gds-grp-hist.subject = 'gds-grp-obj':U " + " " + where-phrase-35 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-c-gds-grp-hist:handle
  ...
  if l-filter-open-35 = false then do:
    OPEN QUERY br-c-gds-grp-hist FOR EACH X_c-gds-grp-hist
      where  X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.obj-type = p-obj-type AND                             X_c-gds-grp-hist.obj-code = p-obj-code AND                             X_c-gds-grp-hist.host-code = p-host-code AND                             X_c-gds-grp-hist.subject = 'gds-grp-obj':U
  .
      assign
        l-query-was-opened = true
      .
  ...
  run waitfram-hide in this-procedure .
    ...
    when ("gds-grp-obj":U + chr(44) + "host":U)then do:
        ASSIGN frame Dialog-Frame:TITLE = substitute("Справочник истории групп товаров: вн.№ &1 параметры по объектам фирмы &2"
                                                       , p-node-code
                                                       , p-host-code
                                                       )
        filter-point = filter-point0 + p-mode
...
run gbl/flt-get.p
  ...
  then do:
    ...
    define variable  parameter-7-37 as character no-undo .
      ...
      parameter-4-37 =
        (
          if (" X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.host-code = p-host-code AND                             X_c-gds-grp-hist.subject = 'gds-grp-obj':U " + " " + where-phrase-37) <> ""
          then  substitute('X_c-gds-grp-hist.node-code = &1 AND                             X_c-gds-grp-hist.host-code = &2 AND                             X_c-gds-grp-hist.subject = &3&4&3', p-node-code, p-host-code, chr(34), 'gds-grp-obj':U)  + " " + where-phrase-37
          else "true"
        )
      parameter-5-37 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-37 =
          (" X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.host-code = p-host-code AND                             X_c-gds-grp-hist.subject = 'gds-grp-obj':U " + " " + where-phrase-37 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-c-gds-grp-hist:handle
  ...
  if l-filter-open-37 = false then do:
    OPEN QUERY br-c-gds-grp-hist FOR EACH X_c-gds-grp-hist
      where  X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.host-code = p-host-code AND                             X_c-gds-grp-hist.subject = 'gds-grp-obj':U
  .
      assign
        l-query-was-opened = true
      .
  ...
  run waitfram-hide in this-procedure .
    ...
    when "tax-rate-gds-grp":U then do:
        ASSIGN frame Dialog-Frame:TITLE = substitute("Справочник истории групп товаров: вн.№ &1 налог &2"
                                                       , p-node-code
                                                       , X_tax.tax-name
                                                       )
        filter-point = filter-point0 + p-mode
...
run gbl/flt-get.p
  ...
  then do:
    ...
    define variable  parameter-7-39 as character no-undo .
      ...
      parameter-4-39 =
        (
          if (" X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.tax-code = p-tax-code AND                             X_c-gds-grp-hist.subject = 'tax-rate-gds-grp':U " + " " + where-phrase-39) <> ""
          then  substitute('X_c-gds-grp-hist.node-code = &1 AND                             X_c-gds-grp-hist.tax-code = &2 AND                             X_c-gds-grp-hist.subject =&3&4&3', p-node-code, p-tax-code, chr(34),  'tax-rate-gds-grp':U)  + " " + where-phrase-39
          else "true"
        )
      parameter-5-39 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-39 =
          (" X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.tax-code = p-tax-code AND                             X_c-gds-grp-hist.subject = 'tax-rate-gds-grp':U " + " " + where-phrase-39 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-c-gds-grp-hist:handle
  ...
  if l-filter-open-39 = false then do:
    OPEN QUERY br-c-gds-grp-hist FOR EACH X_c-gds-grp-hist
      where  X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.tax-code = p-tax-code AND                             X_c-gds-grp-hist.subject = 'tax-rate-gds-grp':U
  .
      assign
        l-query-was-opened = true
      .
  ...
  run waitfram-hide in this-procedure .
    ...
    when ("tax-rate-gds-grp":U + chr(44) + 'объект':U) then do:
        ASSIGN frame Dialog-Frame:TITLE = substitute("Справочник истории групп товаров: вн.№ &1 налог &2 объект &3&4"
                                                       , p-node-code
                                                       , X_tax.tax-name
                                                       , p-obj-type
                                                       , p-obj-code
...
run gbl/flt-get.p
  ...
  then do:
    ...
    define variable  parameter-7-41 as character no-undo .
      ...
      parameter-4-41 =
        (
          if (" X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.tax-code = p-tax-code AND                             X_c-gds-grp-hist.subject = 'tax-rate-gds-grp':U  AND                             X_c-gds-grp-hist.host-code = p-host-code AND                             X_c-gds-grp-hist.obj-type = p-obj-type AND                             X_c-gds-grp-hist.obj-code = p-obj-code  " + " " + where-phrase-41) <> ""
          then  substitute('X_c-gds-grp-hist.node-code = &1 AND                             X_c-gds-grp-hist.tax-code = &2 AND                             X_c-gds-grp-hist.subject = &3&4&3  AND                             X_c-gds-grp-hist.host-code = &5 AND                             X_c-gds-grp-hist.obj-type = &3&6&3 AND                             X_c-gds-grp-hist.obj-code = &7', p-node-code, p-tax-code, 'tax-rate-gds-grp':U, p-host-code, p-obj-type, p-obj-code)   + " " + where-phrase-41
          else "true"
        )
      parameter-5-41 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-41 =
          (" X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.tax-code = p-tax-code AND                             X_c-gds-grp-hist.subject = 'tax-rate-gds-grp':U  AND                             X_c-gds-grp-hist.host-code = p-host-code AND                             X_c-gds-grp-hist.obj-type = p-obj-type AND                             X_c-gds-grp-hist.obj-code = p-obj-code  " + " " + where-phrase-41 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-c-gds-grp-hist:handle
  ...
  if l-filter-open-41 = false then do:
    OPEN QUERY br-c-gds-grp-hist FOR EACH X_c-gds-grp-hist
      where  X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.tax-code = p-tax-code AND                             X_c-gds-grp-hist.subject = 'tax-rate-gds-grp':U  AND                             X_c-gds-grp-hist.host-code = p-host-code AND                             X_c-gds-grp-hist.obj-type = p-obj-type AND                             X_c-gds-grp-hist.obj-code = p-obj-code
  .
      assign
        l-query-was-opened = true
      .
  ...
  run waitfram-hide in this-procedure .
    ...
    when ("tax-rate-gds-grp":U + chr(44) + "host":U) then do:
        ASSIGN frame Dialog-Frame:TITLE = substitute("Справочник истории групп товаров: вн.№ &1 налог &2 фирма &3"
                                                       , p-node-code
                                                       , X_tax.tax-name
                                                       , p-host-code
                                                       )
...
run gbl/flt-get.p
  ...
  then do:
    ...
    define variable  parameter-7-43 as character no-undo .
      ...
      parameter-4-43 =
        (
          if (" X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.tax-code = p-tax-code AND                             X_c-gds-grp-hist.subject = 'tax-rate-gds-grp':U AND                              X_c-gds-grp-hist.host-code = p-host-code " + " " + where-phrase-43) <> ""
          then  substitute('X_c-gds-grp-hist.node-code = &1 AND                             X_c-gds-grp-hist.tax-code = &2 AND                             X_c-gds-grp-hist.subject = &3&4&3 AND                              X_c-gds-grp-hist.host-code = &5', p-node-code, p-tax-code, chr(34), 'tax-rate-gds-grp':U, p-host-code)  + " " + where-phrase-43
          else "true"
        )
      parameter-5-43 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-43 =
          (" X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.tax-code = p-tax-code AND                             X_c-gds-grp-hist.subject = 'tax-rate-gds-grp':U AND                              X_c-gds-grp-hist.host-code = p-host-code " + " " + where-phrase-43 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-c-gds-grp-hist:handle
  ...
  if l-filter-open-43 = false then do:
    OPEN QUERY br-c-gds-grp-hist FOR EACH X_c-gds-grp-hist
      where  X_c-gds-grp-hist.node-code = p-node-code AND                             X_c-gds-grp-hist.tax-code = p-tax-code AND                             X_c-gds-grp-hist.subject = 'tax-rate-gds-grp':U AND                              X_c-gds-grp-hist.host-code = p-host-code
  .
      assign
        l-query-was-opened = true
      .
