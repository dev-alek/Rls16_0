...
DEFINE SHARED QUERY CLi-ListA FOR X_clients
, X_clients-attr
SCROLLING.
...
CASE show-as :
  when ('объект':U + "-" + 'все':U + "-" + 'АТР':U + "-" + 'текущие':U)   then do:
    CASE JoinType :
      when "Или" then do:
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-5 as character no-undo .
      ...
      parameter-4-5 =
        (
          if (" (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U)                             AND X_clients.stts = 0                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         ) " + " " + where-phrase-5) <> ""
          then  (substitute('(X_clients.obj-type = &1&2&1                              or X_clients.obj-type = &1&3&1)                             AND X_clients.stts = 0                             AND ', chr(34), 'маг':U, 'скл':U) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr) ) + " " + where-phrase-5
          else "true"
        )
      parameter-5-5 = (" " + "" + " " + substitute(', FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = &1&2&1 AND                                                                    X_clients-attr.attr-value = &1yes&1', chr(34), attr-option_))
      parameter-6-5 = if sort-phrase-5 = ''
                           then
        (
        " " + "  " +
          " " + sort-column-phrase +
        " " + " BY X_clients.obj-type by X_clients.obj-code  "
        )
                           else
        (
        " " + "  " +
    ...
    :
      assign
        l-disable-where-5 =
          (" (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U)                             AND X_clients.stts = 0                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         ) " + " " + where-phrase-5 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-listA:handle
                          ,input parameter-3-5
                          ,input parameter-4-5
                          ,input parameter-5-5
                          ,input parameter-6-5
  ...
  if l-filter-open-5 = false then do:
    OPEN QUERY CLi-ListA FOR EACH X_clients no-lock
      where  (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U)                             AND X_clients.stts = 0                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         )
    , FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = attr-option_ AND                                                                    X_clients-attr.attr-value = 'yes':U
       BY X_clients.obj-type by X_clients.obj-code
      indexed-reposition
  .
      assign
  ...
  on error undo, leave
  :
    if query cli-listA:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      assign
      parameter-2-5 = (if p-find-next then "true":u else "false":u )
      parameter-4-5 =
        "where ":u +  (substitute('(X_clients.obj-type = &1&2&1                              or X_clients.obj-type = &1&3&1)                             AND X_clients.stts = 0                             AND ', chr(34), 'маг':U, 'скл':U) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr) ) + " ":u + where-phrase-5 + " ":u + p-find-condition + " " + ""
      parameter-5-5 = "  "
    .
      ...
      parameter-5-5 = (" " + "" + " " + substitute(', FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = &1&2&1 AND                                                                    X_clients-attr.attr-value = &1yes&1', chr(34), attr-option_) + " " + p-find-condition)
      parameter-6-5 = if sort-phrase-5 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-7 as character no-undo .
      ...
      parameter-4-7 =
        (
          if (" (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U)                             AND X_clients.stts = 0 " + " " + where-phrase-7) <> ""
          then  substitute( ' (X_clients.obj-type = &1&2&1                              or X_clients.obj-type = &1&3&1)                             AND X_clients.stts = 0 ', chr(34), 'маг':U, 'скл':U) + " " + where-phrase-7
          else "true"
        )
      parameter-5-7 = (" " + "" + " " + substitute(', FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = &1&2&1 AND                                                                    X_clients-attr.attr-value = &1yes&1', chr(34), attr-option_))
    ...
    :
      assign
        l-disable-where-7 =
          (" (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U)                             AND X_clients.stts = 0 " + " " + where-phrase-7 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-listA:handle
                          ,input parameter-3-7
  ...
  if l-filter-open-7 = false then do:
    OPEN QUERY CLi-ListA FOR EACH X_clients no-lock
      where  (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U)                             AND X_clients.stts = 0
    , FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = attr-option_ AND                                                                    X_clients-attr.attr-value = 'yes':U
       BY X_clients.obj-type by X_clients.obj-code
      indexed-reposition
  .
  ...
  :
    if query cli-listA:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-7 =
        "where ":u +  substitute( ' (X_clients.obj-type = &1&2&1                              or X_clients.obj-type = &1&3&1)                             AND X_clients.stts = 0 ', chr(34), 'маг':U, 'скл':U) + " ":u + where-phrase-7 + " ":u + p-find-condition + " " + ""
      parameter-5-7 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      parameter-5-7 = (" " + "" + " " + substitute(', FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = &1&2&1 AND                                                                    X_clients-attr.attr-value = &1yes&1', chr(34), attr-option_) + " " + p-find-condition)
      parameter-6-7 = if sort-phrase-7 = ''
                           then
        (
        " " + "  " +
  ...
  when ('объект':U + "-" + 'все':U + "-" + 'АТР':U + "-" + 'все':U)   then do:
    CASE JoinType :
      when "Или" then do:
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-9 as character no-undo .
      ...
      parameter-4-9 =
        (
          if (" (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U)                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         ) " + " " + where-phrase-9) <> ""
          then  (substitute('(X_clients.obj-type = &1&2&1                              or X_clients.obj-type = &1&3&1)                             AND ', chr(34), 'маг':U, 'скл':U) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " " + where-phrase-9
          else "true"
        )
      parameter-5-9 = (" " + "" + " " + substitute(', FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = &1&2&1 AND                                                                    X_clients-attr.attr-value = &1yes&1', chr(34), attr-option_))
    ...
    :
      assign
        l-disable-where-9 =
          (" (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U)                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         ) " + " " + where-phrase-9 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-listA:handle
                          ,input parameter-3-9
  ...
  if l-filter-open-9 = false then do:
    OPEN QUERY CLi-ListA FOR EACH X_clients no-lock
      where  (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U)                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         )
    , FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = attr-option_ AND                                                                    X_clients-attr.attr-value = 'yes':U
       BY X_clients.obj-type by X_clients.obj-code
      indexed-reposition
  .
  ...
  :
    if query cli-listA:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-9 =
        "where ":u +  (substitute('(X_clients.obj-type = &1&2&1                              or X_clients.obj-type = &1&3&1)                             AND ', chr(34), 'маг':U, 'скл':U) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " ":u + where-phrase-9 + " ":u + p-find-condition + " " + ""
      parameter-5-9 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      parameter-5-9 = (" " + "" + " " + substitute(', FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = &1&2&1 AND                                                                    X_clients-attr.attr-value = &1yes&1', chr(34), attr-option_) + " " + p-find-condition)
      parameter-6-9 = if sort-phrase-9 = ''
                           then
        (
        " " + " " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-11 as character no-undo .
      ...
      parameter-4-11 =
        (
          if (" (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U) " + " " + where-phrase-11) <> ""
          then  substitute('(X_clients.obj-type = &1&2&1                              or X_clients.obj-type = &1&3&1)', chr(34), 'маг':U, 'скл':U) + " " + where-phrase-11
          else "true"
        )
      parameter-5-11 = (" " + "" + " " + substitute(', FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = &1&2&1 AND                                                                    X_clients-attr.attr-value = &1yes&1', chr(34), attr-option_))
    ...
    :
      assign
        l-disable-where-11 =
          (" (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U) " + " " + where-phrase-11 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-listA:handle
  ...
  if l-filter-open-11 = false then do:
    OPEN QUERY CLi-ListA FOR EACH X_clients no-lock
      where  (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U)
    , FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = attr-option_ AND                                                                    X_clients-attr.attr-value = 'yes':U
       BY X_clients.obj-type by X_clients.obj-code
      indexed-reposition
  .
  ...
  :
    if query cli-listA:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-11 =
        "where ":u +  substitute('(X_clients.obj-type = &1&2&1                              or X_clients.obj-type = &1&3&1)', chr(34), 'маг':U, 'скл':U) + " ":u + where-phrase-11 + " ":u + p-find-condition + " " + ""
      parameter-5-11 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      parameter-5-11 = (" " + "" + " " + substitute(', FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = &1&2&1 AND                                                                    X_clients-attr.attr-value = &1yes&1', chr(34), attr-option_) + " " + p-find-condition)
      parameter-6-11 = if sort-phrase-11 = ''
                           then
        (
        " " + "  " +
  ...
  when ('объект':U + "-" + 'все':U + "-" + 'АТР':U + "-" + 'удаленные':U) then do:
    CASE JoinType :
      when "Или" then do:
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-13 as character no-undo .
      ...
      parameter-5-13 = (" " + "" + " " + substitute(', FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = &1&2&1 AND                                                                    X_clients-attr.attr-value = &1yes&1', chr(34), attr-option_))
  ...
  :
    ...
    .
      ...
      parameter-5-13 = (" " + "" + " " + substitute(', FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = &1&2&1 AND                                                                    X_clients-attr.attr-value = &1yes&1', chr(34), attr-option_) + " " + p-find-condition)
      parameter-6-13 = if sort-phrase-13 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-15 as character no-undo .
      ...
      parameter-4-15 =
        (
          if (" (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U)                             AND X_clients.stts <> 0 " + " " + where-phrase-15) <> ""
          then  substitute('(X_clients.obj-type = &1&2&1                              or X_clients.obj-type = &1&3&1)                             AND X_clients.stts <> 0 ', chr(34), 'маг':U, 'скл':U) + " " + where-phrase-15
          else "true"
        )
      parameter-5-15 = (" " + "" + " " + substitute(', FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = &1&2&1 AND                                                                    X_clients-attr.attr-value = &1yes&1', chr(34), attr-option_))
    ...
    :
      assign
        l-disable-where-15 =
          (" (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U)                             AND X_clients.stts <> 0 " + " " + where-phrase-15 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-listA:handle
  ...
  :
    if query cli-listA:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-15 =
        "where ":u +  substitute('(X_clients.obj-type = &1&2&1                              or X_clients.obj-type = &1&3&1)                             AND X_clients.stts <> 0 ', chr(34), 'маг':U, 'скл':U) + " ":u + where-phrase-15 + " ":u + p-find-condition + " " + ""
      parameter-5-15 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      parameter-5-15 = (" " + "" + " " + substitute(', FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = &1&2&1 AND                                                                    X_clients-attr.attr-value = &1yes&1', chr(34), attr-option_) + " " + p-find-condition)
      parameter-6-15 = if sort-phrase-15 = ''
                           then
        (
        " " + "  " +
  ...
  when ('объект':U + "-" + 'название':U + "-" + 'АТР':U + "-" + 'текущие':U) then do:
    CASE JoinType :
      when "Или" then do:
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-17 as character no-undo .
      ...
      parameter-4-17 =
        (
          if (" X_clients.obj-name contains NameOrCode                             and (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U)                             AND X_clients.stts = 0                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         ) " + " " + where-phrase-17) <> ""
          then " X_clients.obj-name contains NameOrCode                             and (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U)                             AND X_clients.stts = 0                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         ) " + " " + where-phrase-17
          else "true"
        )
      parameter-5-17 = (" " + "" + " " + substitute(', FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = &1&2&1 AND                                                                    X_clients-attr.attr-value = &1yes&1', chr(34), attr-option_))
  ...
  :
    if query cli-listA:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-17 =
        "where ":u + " X_clients.obj-name contains NameOrCode                             and (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U)                             AND X_clients.stts = 0                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         ) " + " ":u + where-phrase-17 + " ":u + p-find-condition + " " + ""
      parameter-5-17 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      parameter-5-17 = (" " + "" + " " + substitute(', FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = &1&2&1 AND                                                                    X_clients-attr.attr-value = &1yes&1', chr(34), attr-option_) + " " + p-find-condition)
      parameter-6-17 = if sort-phrase-17 = ''
                           then
        (
        " " + " " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-19 as character no-undo .
      ...
      parameter-4-19 =
        (
          if (" X_clients.obj-name contains NameOrCode                             and (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U)                             AND X_clients.stts = 0 " + " " + where-phrase-19) <> ""
          then  substitute('X_clients.obj-name contains &1&2&1                            and (X_clients.obj-type = &1&3&1                              or X_clients.obj-type = &1&4&1)                             AND X_clients.stts = 0 ', chr(34), NameOrCode, 'маг':U,'скл':U)  + " " + where-phrase-19
          else "true"
        )
      parameter-5-19 = (" " + "" + " " + substitute(', FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = &1&2&1 AND                                                                    X_clients-attr.attr-value = &1yes&1', chr(34), attr-option_))
    ...
    :
      assign
        l-disable-where-19 =
          (" X_clients.obj-name contains NameOrCode                             and (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U)                             AND X_clients.stts = 0 " + " " + where-phrase-19 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-listA:handle
  ...
  if l-filter-open-19 = false then do:
    OPEN QUERY CLi-ListA FOR EACH X_clients no-lock
      where  X_clients.obj-name contains NameOrCode                             and (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U)                             AND X_clients.stts = 0
    , FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = attr-option_ AND                                                                    X_clients-attr.attr-value = 'yes':U
       BY X_clients.obj-name
      indexed-reposition
  .
  ...
  :
    if query cli-listA:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-19 =
        "where ":u +  substitute('X_clients.obj-name contains &1&2&1                            and (X_clients.obj-type = &1&3&1                              or X_clients.obj-type = &1&4&1)                             AND X_clients.stts = 0 ', chr(34), NameOrCode, 'маг':U,'скл':U)  + " ":u + where-phrase-19 + " ":u + p-find-condition + " " + ""
      parameter-5-19 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      parameter-5-19 = (" " + "" + " " + substitute(', FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = &1&2&1 AND                                                                    X_clients-attr.attr-value = &1yes&1', chr(34), attr-option_) + " " + p-find-condition)
      parameter-6-19 = if sort-phrase-19 = ''
                           then
        (
        " " + " " +
  ...
  when ('объект':U + "-" + 'название':U + "-" + 'АТР':U + "-" + 'все':U)  then do:
    CASE JoinType :
      when "Или" then do:
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-21 as character no-undo .
      ...
      parameter-4-21 =
        (
          if (" X_clients.obj-name contains NameOrCode                             and (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U)                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         ) " + " " + where-phrase-21) <> ""
          then " X_clients.obj-name contains NameOrCode                             and (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U)                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         ) " + " " + where-phrase-21
          else "true"
        )
      parameter-5-21 = (" " + "" + " " + substitute(', FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = &1&2&1 AND                                                                    X_clients-attr.attr-value = &1yes&1', chr(34), attr-option_))
  ...
  :
    if query cli-listA:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-21 =
        "where ":u + " X_clients.obj-name contains NameOrCode                             and (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U)                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         ) " + " ":u + where-phrase-21 + " ":u + p-find-condition + " " + ""
      parameter-5-21 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      parameter-5-21 = (" " + "" + " " + substitute(', FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = &1&2&1 AND                                                                    X_clients-attr.attr-value = &1yes&1', chr(34), attr-option_) + " " + p-find-condition)
      parameter-6-21 = if sort-phrase-21 = ''
                           then
        (
        " " + " " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-23 as character no-undo .
      ...
      parameter-4-23 =
        (
          if (" X_clients.obj-name contains NameOrCode                             and (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U) " + " " + where-phrase-23) <> ""
          then  substitute('X_clients.obj-name contains &1&2&1                             and (X_clients.obj-type = &1&3&1                              or X_clients.obj-type = &1&4&1) ', chr(34), NameOrCode, 'маг':U, 'скл':U) + " " + where-phrase-23
          else "true"
        )
      parameter-5-23 = (" " + "" + " " + substitute(', FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = &1&2&1 AND                                                                    X_clients-attr.attr-value = &1yes&1', chr(34), attr-option_))
    ...
    :
      assign
        l-disable-where-23 =
          (" X_clients.obj-name contains NameOrCode                             and (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U) " + " " + where-phrase-23 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-listA:handle
  ...
  if l-filter-open-23 = false then do:
    OPEN QUERY CLi-ListA FOR EACH X_clients no-lock
      where  X_clients.obj-name contains NameOrCode                             and (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U)
    , FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = attr-option_ AND                                                                    X_clients-attr.attr-value = 'yes':U
       BY X_clients.obj-name
      indexed-reposition
  .
  ...
  :
    if query cli-listA:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-23 =
        "where ":u +  substitute('X_clients.obj-name contains &1&2&1                             and (X_clients.obj-type = &1&3&1                              or X_clients.obj-type = &1&4&1) ', chr(34), NameOrCode, 'маг':U, 'скл':U) + " ":u + where-phrase-23 + " ":u + p-find-condition + " " + ""
      parameter-5-23 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      parameter-5-23 = (" " + "" + " " + substitute(', FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = &1&2&1 AND                                                                    X_clients-attr.attr-value = &1yes&1', chr(34), attr-option_) + " " + p-find-condition)
      parameter-6-23 = if sort-phrase-23 = ''
                           then
        (
        " " + " " +
  ...
  when ('объект':U + "-" + 'название':U + "-" + 'АТР':U + "-" + 'удаленные':U)  then do:
    CASE JoinType :
      when "Или" then do:
...
if p-open-query then do:
    ...
    define variable  parameter-7-25 as character no-undo .
      ...
      parameter-4-25 =
        (
          ...
          then  (substitute('X_clients.obj-name contains &1&2&1                             and (X_clients.obj-type = &1&3&1                              or X_clients.obj-type = &1&4&1)                             AND X_clients.stts <> 0                             AND ', chr(34), NameOrCode, 'маг':U, 'скл':U) +  substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " " + where-phrase-25
          else "true"
        )
      parameter-5-25 = (" " + "" + " " + substitute(', FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = &1&2&1 AND                                                                    X_clients-attr.attr-value = &1yes&1', chr(34), attr-option_))
  ...
  :
    if query cli-listA:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-25 =
        "where ":u +  (substitute('X_clients.obj-name contains &1&2&1                             and (X_clients.obj-type = &1&3&1                              or X_clients.obj-type = &1&4&1)                             AND X_clients.stts <> 0                             AND ', chr(34), NameOrCode, 'маг':U, 'скл':U) +  substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " ":u + where-phrase-25 + " ":u + p-find-condition + " " + ""
      parameter-5-25 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      parameter-5-25 = (" " + "" + " " + substitute(', FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = &1&2&1 AND                                                                    X_clients-attr.attr-value = &1yes&1', chr(34), attr-option_) + " " + p-find-condition)
      parameter-6-25 = if sort-phrase-25 = ''
                           then
        (
        " " + " " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-27 as character no-undo .
      ...
      parameter-4-27 =
        (
          if (" X_clients.obj-name contains NameOrCode                             and (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U)                             AND X_clients.stts <> 0 " + " " + where-phrase-27) <> ""
          then  substitute('X_clients.obj-name contains &1&2&1                             and (X_clients.obj-type = &1&3&1                              or X_clients.obj-type = &1&4&1)                             AND X_clients.stts <> 0 ', chr(34), NameOrCode, 'маг':U, 'скл':U) + " " + where-phrase-27
          else "true"
        )
      parameter-5-27 = (" " + "" + " " + substitute(', FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = &1&2&1 AND                                                                    X_clients-attr.attr-value = &1yes&1', chr(34), attr-option_))
    ...
    :
      assign
        l-disable-where-27 =
          (" X_clients.obj-name contains NameOrCode                             and (X_clients.obj-type = 'маг':U                              or X_clients.obj-type = 'скл':U)                             AND X_clients.stts <> 0 " + " " + where-phrase-27 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-listA:handle
  ...
  :
    if query cli-listA:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-27 =
        "where ":u +  substitute('X_clients.obj-name contains &1&2&1                             and (X_clients.obj-type = &1&3&1                              or X_clients.obj-type = &1&4&1)                             AND X_clients.stts <> 0 ', chr(34), NameOrCode, 'маг':U, 'скл':U) + " ":u + where-phrase-27 + " ":u + p-find-condition + " " + ""
      parameter-5-27 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      parameter-5-27 = (" " + "" + " " + substitute(', FIRST X_clients-attr NO-LOCK  WHERE  X_clients-attr.obj-type = X_clients.obj-type AND                                                                     X_clients-attr.obj-code = X_clients.obj-code AND                                                                     X_clients-attr.attr-code = &1&2&1 AND                                                                    X_clients-attr.attr-value = &1yes&1', chr(34), attr-option_) + " " + p-find-condition)
      parameter-6-27 = if sort-phrase-27 = ''
                           then
        (
        " " + " " +
