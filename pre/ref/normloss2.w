...
DO:
  ...
  OPEN QUERY BR-norm-loss FOR EACH tt-norm-loss NO-LOCK by tt-norm-loss.sec-vol by tt-norm-loss.clim-grp by tt-norm-loss.oil-grp by tt-norm-loss.season INDEXED-REPOSITION.
  END.
