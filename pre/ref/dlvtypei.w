...
END PROCEDURE.
PROCEDURE enable_UI :
  OPEN QUERY Dialog-Frame FOR EACH tt-delivery-type SHARE-LOCK.
...
B-Help
tt-delivery-type.deliv-type-name when p-mode <> 'ПРОСМОТР':U
tt-delivery-type.des when p-mode <> 'ПРОСМОТР':U
WITH FRAME Dialog-Frame.
VIEW FRAME Dialog-Frame.
END PROCEDURE.
PROCEDURE Proc-save :
...
assign
tt-delivery-type.deliv-type-code frame Dialog-Frame
tt-delivery-type.deliv-type-name
