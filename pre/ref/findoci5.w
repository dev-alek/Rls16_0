...
define variable vss-workfile    as character no-undo init "$Workfile: findoci5.w $":U .
define variable vss-archive     as character no-undo init "$Archive: ref/findoci5.w $":U .
define variable vss-description as character no-undo init "Карточка редактирования приходного акта погашения задолженности".
...
DEFINE FRAME Dialog-Frame
     ...
     tt-fin-doc.perm-date AT ROW 1.97 COL 71.5 COLON-ALIGNED
          LABEL "Дата разр"
          VIEW-AS FILL-IN
          SIZE 11 BY 1
     ...
     tt-fin-doc.fact-date AT ROW 3 COL 71.4 COLON-ALIGNED
          LABEL "Дата факт"
          VIEW-AS FILL-IN
          SIZE 11 BY 1
     tt-fin-doc.user-name-fact AT ROW 3 COL 82.8 COLON-ALIGNED NO-LABEL FORMAT "X(14)"
          VIEW-AS FILL-IN
          SIZE 14.5 BY 1
     tt-fin-doc.receiver-type AT ROW 4 COL 1.8 NO-LABEL
          VIEW-AS FILL-IN
          SIZE 4 BY 1
     tt-fin-doc.receiver-okpo AT ROW 4 COL 17.3 COLON-ALIGNED
          LABEL "ОКПО" FORMAT "X(10)"
          VIEW-AS FILL-IN
          SIZE 11 BY 1
          FGCOLOR 4
     tt-fin-doc.receiver-name AT ROW 4 COL 28.3 COLON-ALIGNED NO-LABEL FORMAT "X(130)"
          VIEW-AS FILL-IN
          SIZE 50 BY 1
          FGCOLOR 4
     B-receiver-view AT ROW 4 COL 87
     tt-fin-doc.receiver-code AT ROW 4.03 COL 4.3 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN
          SIZE 6 BY 1
     ...
     tt-fin-doc.str-podr-name AT ROW 5 COL 53.9 COLON-ALIGNED
          ...
          SIZE 43 BY 1
          FGCOLOR 4
     tt-fin-doc.cor-acc1-value AT ROW 6 COL 16.3 COLON-ALIGNED
          LABEL "Корсчет"
          VIEW-AS FILL-IN
          SIZE 14 BY 1
          FGCOLOR 4
     B-cor-acc1 AT ROW 6 COL 33.1
     f-cor-acc1-descr AT ROW 6 COL 35.4 COLON-ALIGNED NO-LABEL
     tt-fin-doc.cel-nazn-value AT ROW 7 COL 3.3
          LABEL "Код цел.назн."
          VIEW-AS FILL-IN
          SIZE 14 BY 1
          FGCOLOR 4
     B-cel-nazn AT ROW 7 COL 33.1
     f-cel-nazn-descr AT ROW 7 COL 35.4 COLON-ALIGNED NO-LABEL
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE
         DEFAULT-BUTTON B-exit CANCEL-BUTTON b-quit.
DEFINE FRAME Dialog-Frame
     f-contract-curr-abbr AT ROW 7.47 COL 55.3 COLON-ALIGNED NO-LABEL
     ...
     tt-fin-doc.cor-acc-value AT ROW 8 COL 9.3
          LABEL "Корсчет"
          VIEW-AS FILL-IN
          SIZE 14 BY 1
          FGCOLOR 4
     B-cor-acc AT ROW 8 COL 33.1
     f-cor-acc-descr AT ROW 8 COL 35.4 COLON-ALIGNED NO-LABEL
     tt-fin-doc.an-uchet-value AT ROW 9 COL 5.3
          LABEL "Код ан. уч."
          VIEW-AS FILL-IN
          SIZE 14 BY 1
          FGCOLOR 4
     B-an-uchet AT ROW 9 COL 33.1
     ...
     tt-fin-doc.sum-contr AT ROW 13 COL 72.3 COLON-ALIGNED
          ...
          VIEW-AS FILL-IN
          SIZE 25 BY 1
     B-payer AT ROW 13.93 COL 27
     tt-fin-doc.payer-type AT ROW 14 COL 1.1 NO-LABEL
          VIEW-AS RADIO-SET HORIZONTAL
          RADIO-BUTTONS
                    "Item 1", "1":U,
"Item 1", "2":U
          SIZE 13.5 BY 1.03
     tt-fin-doc.payer-code AT ROW 14 COL 13.5 COLON-ALIGNED NO-LABEL
          VIEW-AS FILL-IN
          SIZE 11 BY 1
     tt-fin-doc.payer-name AT ROW 14 COL 30.3 NO-LABEL FORMAT "X(130)"
          VIEW-AS FILL-IN
          SIZE 53 BY 1
          FGCOLOR 4
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER
...
DEFINE FRAME Dialog-Frame
     ...
     tt-fin-doc.naznach-plat AT ROW 16 COL 1 NO-LABEL
          ...
          FGCOLOR 4
     tt-fin-doc.PS AT ROW 18.5 COL 1 NO-LABEL
          VIEW-AS EDITOR SCROLLBAR-VERTICAL
          SIZE 98 BY 1.5 TOOLTIP "Дополнительная информация, не печатающаяся в АПЗ"
     tt-fin-doc.payer-sign1 AT ROW 20 COL 48
          LABEL "От лица ПЛАТЕЛЬЩИКА"
          VIEW-AS FILL-IN
          SIZE 30.4 BY 1
          FGCOLOR 4
     tt-fin-doc.receiver-sign1 AT ROW 21 COL 67 COLON-ALIGNED
     ...
     SPACE(1.28) SKIP(3.54)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE
         TITLE "Приходный АПЗ - Получатель"
         DEFAULT-BUTTON B-exit CANCEL-BUTTON b-quit.
ASSIGN
...
buffer-compare tt-fin-doc except receiver-sign1
to locked_fin-doc
case-sensitive
save result in v-cmp .
if v-cmp <> "":U
or  entry((if num-entries(locked_fin-doc.receiver-sign1, chr(4)) > 1
           then 2
           else 1)
           , locked_fin-doc.receiver-sign1, chr(4)
...
PROCEDURE disable-enable :
  ...
  CASE rs-view:
    when "full":u then
      do:
        assign
          v-tab-order = "b-exit,b-quit,b-tax,b-cards,b-print,b-hist,b-help," +                            "prn-doc-code,doc-date,obj-type,obj-code,b-obj,b-receiver-view,str-podr-type,str-podr-code,str-podr-name," +                             v-an-uchet-tab-order +  v-sum-curr-tab-order +                            "payer-type,payer-code,b-payer,payer-name,b-payer-view,naznach-plat," +                            "PS,payer-sign1,receiver-sign1"
          .
      end.
    when "brief":u then
      do:
        assign
          v-tab-order = "b-exit,b-quit,b-tax,b-cards,b-print,b-hist,b-help," +                             "prn-doc-code,doc-date,obj-type,obj-code,b-obj,b-receiver-view," +                              v-sum-curr-tab-order +                            "payer-type,payer-code,b-payer,payer-name,b-payer-view,naznach-plat," +                            "PS,payer-sign1,receiver-sign1"
          .
      end.
    when "contract":u then
      do:
        assign
          v-tab-order = "b-exit,b-quit,b-tax,b-cards,b-print,b-hist,b-help," +                               "prn-doc-code,doc-date,obj-type,obj-code,b-obj,b-receiver-view," +                                v-contract-tab-order + v-sum-curr-tab-order +                                "payer-type,payer-code,b-payer,payer-name,b-payer-view,naznach-plat," +                                 "PS,payer-sign1,receiver-sign1"
          .
      end.
  END CASE.
END PROCEDURE.
...
PROCEDURE enable_UI :
  ...
  DISPLAY RS-view f-cor-acc1-descr f-cel-nazn-descr f-contract-curr-abbr
          f-contract-prn-code f-contract-date f-contract-type f-cor-acc-descr
          f-an-uchet-descr f-rest-con-sum F-curr-abbr F-debet F-credit
      WITH FRAME Dialog-Frame.
  IF AVAILABLE tt-fin-doc THEN
    DISPLAY tt-fin-doc.perm-date tt-fin-doc.prn-doc-code tt-fin-doc.fin-doc-code
          ...
          tt-fin-doc.cor-acc1-value tt-fin-doc.cel-nazn-value
          tt-fin-doc.contract-curr tt-fin-doc.cor-acc-value
          tt-fin-doc.an-uchet-value tt-fin-doc.sum-doc tt-fin-doc.curr-code
          ...
          tt-fin-doc.payer-name tt-fin-doc.naznach-plat tt-fin-doc.PS
          tt-fin-doc.payer-sign1 tt-fin-doc.receiver-sign1
      WITH FRAME Dialog-Frame.
  ENABLE B-exit b-quit B-tax B-cards B-print B-hist B-Help RS-view
         tt-fin-doc.prn-doc-code tt-fin-doc.doc-date tt-fin-doc.user-name-doc
         tt-fin-doc.obj-type tt-fin-doc.obj-code B-obj B-receiver-view
         tt-fin-doc.str-podr-type tt-fin-doc.str-podr-code
         tt-fin-doc.str-podr-name tt-fin-doc.cor-acc1-value B-cor-acc1
         tt-fin-doc.cel-nazn-value B-cel-nazn f-contract-curr-abbr
         B-contract-view tt-fin-doc.contract-curr tt-fin-doc.cor-acc-value
         B-cor-acc tt-fin-doc.an-uchet-value B-an-uchet tt-fin-doc.sum-doc
...
tt-fin-doc.obj-type:radio-buttons = "Маг" + chr(44) + 'маг':U + chr(44) +
                                    "Скл" + chr(44) + 'скл':U
rs-view = v-view
v-an-uchet-tab-order = (if X_sysconf.is-cassa-acc then "cor-acc1-value,b-cor-acc1," else "":U) +
                       (if X_sysconf.is-code-cel-nazn then "cel-nazn-value,b-cel-nazn," else "":U) +
                       (if X_sysconf.is-corr-acc then "cor-acc-value,b-cor-acc," else "":U) +
...
if p-mode = 'ДОБАВЛЕНИЕ':U and tt-fin-doc.contract-code = 0 then do:
  assign
  tt-fin-doc.payer-type = (if tt-fin-doc.payer-type = "":U then 'орг':U else tt-fin-doc.payer-type)
  .
end.
assign
v-head-position = (if num-entries(tt-fin-doc.receiver-sign1, chr(4)) > 1
                    then entry(1, tt-fin-doc.receiver-sign1, chr(4))
                    else "":U)
tt-fin-doc.receiver-sign1:label  = tt-fin-doc.receiver-sign1:label  + " - ":U +
                          v-head-position
tt-fin-doc.receiver-sign1 =   (if num-entries(tt-fin-doc.receiver-sign1, chr(4)) > 1
                                  then entry(2, tt-fin-doc.receiver-sign1, chr(4))
                                  else entry(1, tt-fin-doc.receiver-sign1, chr(4)))
.
if p-mode = 'ПРОСМОТР':U then do:
    ...
    run proc-color-widgets in this-procedure("F-curr-abbr,an-uchet-value,cel-nazn-value,cor-acc1-value,cor-acc-value,doc-date," +                       "naznach-plat,payer-name,prn-doc-code,receiver-name,receiver-okpo,payer-sign1,receiver-sign1," +                       "str-podr-code,str-podr-name,str-podr-type,sum-doc", no, yes, ?, ?).
end.
display
tt-fin-doc.exch-rate
tt-fin-doc.exch-scale
...
tt-fin-doc.payer-sign1
tt-fin-doc.receiver-sign1
tt-fin-doc.receiver-sign1  =   v-head-position + chr(4) + tt-fin-doc.receiver-sign1
.
