...
DEFINE BUFFER X_c-obj-hist FOR c-code.
DEFINE BUFFER find_c-obj-hist FOR c-code.
...
PROCEDURE proc-full-temp-changes :
  ...
  .
      run ParentPars (if p-act-create = true then ? else p-hst-handle,
...
DEF VAR cur-clmn-numbr-obj-hist as INT EXTENT 6 no-undo.
...
def var old-session as logical no-undo.
   ...
   IF old-session = YES THEN SESSION:IMMEDIATE-DISPLAY = NO.
       IF  p-mode = 'все':U  THEN DO:
   DO jjbr-obj-hist = NUM-ENTRIES('1,2,3,4,5,6') TO 1 BY -1:
     RUN re-move-clmnbr-obj-hist ( cur-clmn-numbr-obj-hist[INTEGER(ENTRY (jjbr-obj-hist, '1,2,3,4,5,6'))] , 1).
   END.
       END.
       IF  p-mode <> 'все':U  THEN DO:
   DO jjbr-obj-hist = NUM-ENTRIES('1,2,3,5,6') TO 1 BY -1:
     RUN re-move-clmnbr-obj-hist ( cur-clmn-numbr-obj-hist[INTEGER(ENTRY (jjbr-obj-hist, '1,2,3,5,6'))] , 1).
   END.
       END.
   SESSION:IMMEDIATE-DISPLAY = old-session.
END.
ON ctrl-cursor-right OF BROWSE br-obj-hist do:
  RUN re-move-clmnbr-obj-hist ( 1, 6).
END.
ON ctrl-cursor-left OF BROWSE br-obj-hist do:
  RUN re-move-clmnbr-obj-hist (6, 1).
END.
...
define input  parameter p-db-num like c-code.corr-user-db-num no-undo .
...
define input parameter p-next as logical no-undo.
define input parameter p-user like c-code.corr-user-name no-undo.
assign
sch-corr-date = ?.
display
0 @ sch-db-num
...
procedure ParentPars:
   ...
   do vi = 1 to max(num-entries (vparentOld,chr(4)),num-entries (vparentCur,chr(4))):
      create temp-changes.
      assign
        temp-changes.t_name = "code"
        temp-changes.f_name = "Parent_" + string(vi)
      .
      temp-changes.l_name   = getParentLabel(mtype,vi).
      temp-changes.v_old    = entry(vi,vparentOld,chr(4)) no-error.
      temp-changes.v_new    = entry(vi,vparentCur,chr(4)) no-error.
      temp-changes.fNotChange = temp-changes.v_old eq temp-changes.v_new.
   end.
end.
function fLabel returns character :
   return "Записи справочника с родителем " +  if p-mode eq "one"  then  replace(iParent ,chr(4),"->") + " с кодом " + icode else replace(getParentAll() ,chr(4),"->").
end.
function get-subject returns character
...
:
  ...
  define variable vi as integer no-undo.
  v-label-param =
        "code"       + chr(4) + "Код"                                   + chr(4) + "" + chr(8)
      + "Codevalue"  + chr(4) + "Значение"                              + chr(4) + "" + chr(8)
      + "codeName"   + chr(4) + "Наименоваание"                         + chr(4) + "" + chr(8)
      + "export_"    + chr(4) + "Выгружается"                           + chr(4) + "" + chr(8)
      + "nwsgbd"     + chr(4) + "Ходит из ГБД в УБД"                    + chr(4) + "" + chr(8)
      + "nwsubd"     + chr(4) + "Ходит из УБД в ГБД"                    + chr(4) + "" + chr(8)
      + "procdel"    + chr(4) + "Процедура удаеления"                   + chr(4) + "" + chr(8)
      + "procedit"   + chr(4) + "Процедура редактирования"              + chr(4) + "" + chr(8)
      + "procview"   + chr(4) + "Процедура просмотра дочерних записей"  + chr(4) + "" + chr(8).
  do vi = 1 to 10:
      v-label-param = v-label-param + "misc" + string(vi)      + chr(4) + "Доп поле " + string(vi)    + chr(4) + "" + chr(8).
  end.
  v-label-param = v-label-param + "status_"        + chr(4) + "Статус"  + chr(4) + vProcSts .
  run proc-full-temp-changes in this-procedure (
                                               input current_c-code.action = integer('1':U)
                                              ,input current_c-code.action = integer('99':U)
                                              ,input  buffer current_c-code:handle
                                              ,input  'Code':U
                                              ,input  "code,Codevalue,codeName,export_,nwsgbd,nwsubd,procdel,procedit,procview,status_"
                                              ,input  v-label-param).
end.
end procedure.
function local-open-br returns logical
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-31 as character no-undo .
      ...
      parameter-4-31 =
        (
          if (" X_c-obj-hist.Parent = iParent
                      and X_c-obj-hist.code   = iCode
                      and X_c-obj-hist.corr-user-db-num = v-corr-user-db-num " + " " + where-phrase-31) <> ""
          then  substitute('X_c-obj-hist.Parent = &1&2&1  
                      and X_c-obj-hist.code   = &1&3&1
                      and X_c-obj-hist.corr-user-db-num = &4',chr(34),iParent,iCode, v-corr-user-db-num)  + " " + where-phrase-31
          else "true"
        )
      parameter-5-31 = (" " + "" + " " + "")
  ...
  if l-filter-open-31 = false then do:
    OPEN QUERY br-obj-hist FOR EACH X_c-obj-hist
      where  X_c-obj-hist.Parent = iParent
                      and X_c-obj-hist.code   = iCode
  ...
  :
    if query br-obj-hist:handle:get-buffer-handle(1) = (buffer X_c-obj-hist:handle) then do:
      ...
      parameter-4-31 =
        "where ":u +  substitute('X_c-obj-hist.Parent = &1&2&1  
                      and X_c-obj-hist.code   = &1&3&1
                      and X_c-obj-hist.corr-user-db-num = &4',chr(34),iParent,iCode, v-corr-user-db-num)  + " ":u + where-phrase-31 + " ":u + p-find-condition + " " + ""
      parameter-5-31 = ""
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-31 = (if p-find-next then "true":u else "false":u )
      parameter-3-31 =  "FOR EACH X_c-obj-hist"
      parameter-4-31 =
        (
          if (" X_c-obj-hist.Parent = iParent
                      and X_c-obj-hist.code   = iCode
      ...
      parameter-4-33 =
        (
          if (" X_c-obj-hist.Parent = iParent  
                      ...
                      and X_c-obj-hist.chip-num           eq p-chip-num " + " " + where-phrase-33) <> ""
          then  substitute('X_c-obj-hist.Parent = &1&2&1   
                      and X_c-obj-hist.code   = &1&3&1
                      and X_c-obj-hist.corr-user-db-num   eq &4
                      and X_c-obj-hist.chip-num           eq &5',chr(34),iParent,iCode, v-corr-user-db-num, p-chip-num)  + " " + where-phrase-33
          else "true"
        )
      parameter-5-33 = (" " + "" + " " + "")
    ...
    if query br-obj-hist:handle:get-buffer-handle(1) = (buffer X_c-obj-hist:handle) then do:
      ...
      parameter-4-33 =
        "where ":u +  substitute('X_c-obj-hist.Parent = &1&2&1   
                      and X_c-obj-hist.code   = &1&3&1
                      and X_c-obj-hist.corr-user-db-num   eq &4
                      and X_c-obj-hist.chip-num           eq &5',chr(34),iParent,iCode, v-corr-user-db-num, p-chip-num)  + " ":u + where-phrase-33 + " ":u + p-find-condition + " " + ""
      parameter-5-33 = ""
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-33 = (if p-find-next then "true":u else "false":u )
      parameter-3-33 =  "FOR EACH X_c-obj-hist"
      parameter-4-33 =
        (
          if (" X_c-obj-hist.Parent = iParent  
                      and X_c-obj-hist.code   = iCode
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-35 as character no-undo .
      ...
      parameter-4-35 =
        (
          if (" X_c-obj-hist.Parent begins vParent  
                      and X_c-obj-hist.corr-user-db-num = v-corr-user-db-num " + " " + where-phrase-35) <> ""
          then  substitute('X_c-obj-hist.Parent begins &1&2&1  
                                      and X_c-obj-hist.corr-user-db-num = &3', chr(34), vParent,v-corr-user-db-num)  + " " + where-phrase-35
          else "true"
        )
      parameter-5-35 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-35 =
          (" X_c-obj-hist.Parent begins vParent  
                      and X_c-obj-hist.corr-user-db-num = v-corr-user-db-num " + " " + where-phrase-35 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-obj-hist:handle
  ...
  if l-filter-open-35 = false then do:
    OPEN QUERY br-obj-hist FOR EACH X_c-obj-hist
      where  X_c-obj-hist.Parent begins vParent
                      and X_c-obj-hist.corr-user-db-num = v-corr-user-db-num
       by X_c-obj-hist.chip-num
      indexed-reposition
  .
  ...
  :
    if query br-obj-hist:handle:get-buffer-handle(1) = (buffer X_c-obj-hist:handle) then do:
      ...
      parameter-4-35 =
        "where ":u +  substitute('X_c-obj-hist.Parent begins &1&2&1  
                                      and X_c-obj-hist.corr-user-db-num = &3', chr(34), vParent,v-corr-user-db-num)  + " ":u + where-phrase-35 + " ":u + p-find-condition + " " + ""
      parameter-5-35 = ""
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-35 = (if p-find-next then "true":u else "false":u )
      parameter-3-35 =  "FOR EACH X_c-obj-hist"
      parameter-4-35 =
        (
          if (" X_c-obj-hist.Parent begins vParent  
                      and X_c-obj-hist.corr-user-db-num = v-corr-user-db-num " + " " + where-phrase-35) <> ""
    ...
    define variable  parameter-7-37 as character no-undo .
      ...
      parameter-4-37 =
        (
          if (" X_c-obj-hist.Parent begins vParent  
                      and X_c-obj-hist.corr-user-db-num   eq v-corr-user-db-num
                      and X_c-obj-hist.chip-num           eq p-chip-num " + " " + where-phrase-37) <> ""
          then  substitute('X_c-obj-hist.Parent begins &1&2&1
                                      and X_c-obj-hist.corr-user-db-num   eq &3
                                      and X_c-obj-hist.chip-num           eq &4
                                      ',chr(34),vParent, v-corr-user-db-num, p-chip-num)  + " " + where-phrase-37
          else "true"
        )
      parameter-5-37 = (" " + "" + " " + "")
    ...
    if query br-obj-hist:handle:get-buffer-handle(1) = (buffer X_c-obj-hist:handle) then do:
      ...
      parameter-4-37 =
        "where ":u +  substitute('X_c-obj-hist.Parent begins &1&2&1
                                      and X_c-obj-hist.corr-user-db-num   eq &3
                                      and X_c-obj-hist.chip-num           eq &4
                                      ',chr(34),vParent, v-corr-user-db-num, p-chip-num)  + " ":u + where-phrase-37 + " ":u + p-find-condition + " " + ""
      parameter-5-37 = ""
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-37 = (if p-find-next then "true":u else "false":u )
      parameter-3-37 =  "FOR EACH X_c-obj-hist"
      parameter-4-37 =
        (
          if (" X_c-obj-hist.Parent begins vParent  
                      and X_c-obj-hist.corr-user-db-num   eq v-corr-user-db-num
...
procedure getComboList:
   ...
   then assign
      oListVal    = "Удаление,Создание,Изменение"
      oListValRet = "99,1,2"
   .
end.
