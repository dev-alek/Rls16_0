...
DO:
  IF AVAILABLE tt-fdp THEN DO:
     DISPLAY tt-fdp.num @ f-copy-nums WITH FRAME Dialog-Frame.
     ENABLE f-copy-nums WITH FRAME Dialog-Frame.
  END.
  ELSE DO:
     DISPLAY 0 @ f-copy-nums WITH FRAME Dialog-Frame.
     DISABLE f-copy-nums WITH FRAME Dialog-Frame.
  END.
END.
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse BR-fdp :handle
      .
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY BR-fdp FOR EACH tt-fdp NO-LOCK INDEXED-REPOSITION.
END PROCEDURE.
