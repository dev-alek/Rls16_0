...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-26 as character no-undo .
      ...
      parameter-4-26 =
        (
          if ("           X_c-dc-hist.d-card  = p-d-card                          " + " " + where-phrase-26) <> ""
          then  substitute(' X_c-dc-hist.d-card  = &1&2&1', chr(34), p-d-card)   + " " + where-phrase-26
          else "true"
        )
      parameter-5-26 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-26 =
          ("           X_c-dc-hist.d-card  = p-d-card                          " + " " + where-phrase-26 = "")
      .
  ...
  :
    if query br-dc-hist:handle:get-buffer-handle(1) = (buffer X_c-dc-hist:handle) then do:
      ...
      parameter-4-26 =
        "where ":u +  substitute(' X_c-dc-hist.d-card  = &1&2&1', chr(34), p-d-card)   + " ":u + where-phrase-26 + " ":u + p-find-condition + " " + ""
      parameter-5-26 = " "
    .
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-28 as character no-undo .
      ...
      parameter-4-28 =
        (
          if ("           X_c-dc-hist.corr-user-db-num = p-db-num ANd            X_c-dc-hist.d-card  = p-d-card                          " + " " + where-phrase-28) <> ""
          then  substitute(' X_c-dc-hist.corr-user-db-num = &1 ANd            X_c-dc-hist.d-card  = &2&3&2', p-db-num , chr(34), p-d-card)  + " " + where-phrase-28
          else "true"
        )
      parameter-5-28 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-28 =
          ("           X_c-dc-hist.corr-user-db-num = p-db-num ANd            X_c-dc-hist.d-card  = p-d-card                          " + " " + where-phrase-28 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-dc-hist:handle
  ...
  :
    if query br-dc-hist:handle:get-buffer-handle(1) = (buffer X_c-dc-hist:handle) then do:
      ...
      parameter-4-28 =
        "where ":u +  substitute(' X_c-dc-hist.corr-user-db-num = &1 ANd            X_c-dc-hist.d-card  = &2&3&2', p-db-num , chr(34), p-d-card)  + " ":u + where-phrase-28 + " ":u + p-find-condition + " " + ""
      parameter-5-28 = " use-index ishow "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query br-dc-hist:handle
