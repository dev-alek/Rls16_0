...
assign
  v-str-recid10 = trim( string( recid( X_c-PromoAction ) , "->>>>>>>>>>>9":U ) )
...
PROCEDURE sort-brbr-wp :
  ...
  case sort-labelbr-wp:
        when X_c-PromoAction.nameAction:label in browse br-wp then DO:   assign     sort-column-name = "X_c-PromoAction.nameAction"   .   run OpenBr.   . END.
        when X_c-PromoAction.corr-date:label in browse br-wp then DO:   assign     sort-column-name = "X_c-PromoAction.corr-date"   .   run OpenBr.   . END.
    otherwise do:
      assign
        sort-column-name = ""
      .
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY br-wp FOR EACH X_c-PromoAction NO-LOCK INDEXED-REPOSITION.
END PROCEDURE.
PROCEDURE MyEnable :
assign
...
v-label-param =   "id" + chr(4) + "Ид.промо-акции" + chr(4) + ""
 + chr(8) + "beg-date"  + chr(4) + "Дата начала" + chr(4) + ""
 + chr(8) + "end-date"  + chr(4) + "Дата окончания" + chr(4) + ""
 + chr(8) + "nameAction"  + chr(4) + "Наименование" + chr(4) + ""
 + chr(8) + "TypeDiscont"  + chr(4) + "Тип скидки" + chr(4) + ""
 + chr(8) + "methodCalc"  + chr(4) + "Метод расчёта" + chr(4) + ""
 + chr(8) + "typecond"  + chr(4) + "Вид условия" + chr(4) + ""
 + chr(8) + "promosched-id"  + chr(4) + "Ид.расписания" + chr(4) + ""
 + chr(8) + "Status_"  + chr(4) + "Статус" + chr(4) + ""
 + chr(8) + "priority"  + chr(4) + "Приоритет" + chr(4) + ""
 + chr(8) + "comment"  + chr(4) + "Комментарий" + chr(4) + ""
 + chr(8) + "description"  + chr(4) + "Описание" + chr(4) + ""
 + chr(8) + "paymenttype"  + chr(4) + "Коды типов платежей" + chr(4) + ""
 + chr(8) + "changeDate"  + chr(4) + "Дата досрочного завершения" + chr(4) + ""
 + chr(8) + "ext-code"  + chr(4) + "Код промо-акции во внешней системе" + chr(4) + ""
 + chr(8) + "db-num"  + chr(4) + "Номер БД" + chr(4) + ""
.
 run proc-full-temp-changes in this-procedure (
                                             input  buffer X_c-PromoAction:handle
                                            ,input  'PromoAction':U
                                            ,input  "id,beg-date,end-date,nameAction,TypeDiscont,methodCalc,typecond,promosched-id,Status_,priority,comment,description,paymenttype,changeDate,ext-code,db-num"
                                            ,input  v-label-param).
