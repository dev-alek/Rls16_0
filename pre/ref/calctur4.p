...
if string(buf_chk-doc.chk-type) = '1':U
then do:
...
if not ( buf_trn-doc.status_   = 'факт':U and
   ( buf_trn-doc.ext-doc-type = 'es':U or
     buf_trn-doc.ext-doc-type = 'rs':U )) then return .
...
define buffer buf_doc-line for ub.doc-line  .
 for each buf_doc-line no-lock
  ...
  if  buf_trn-doc.ext-doc-type =  'es':U or
      buf_trn-doc.ext-doc-type =  'rs':U
  then do:
      if buf_trn-doc.ext-doc-type =  'rs':U then v-sign = (-1) .
        else v-sign = 1 .
