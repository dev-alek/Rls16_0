...
DEFINE FRAME top-frame
 ...
 DEFINE FRAME CLi-Gds-List
   with width 232 down stream-io use-text NO-BOX.
assign
use-column[1] = if parlist-mode1 <> 'Товар':U then yes else no
use-column[2] = if parlist-mode1 <> 'Товар':U then yes else no
use-column[3] = if parlist-mode1 <> 'Товар':U then yes else no
use-column[4] = if parlist-mode1 <> 'Товар':U then yes else no
use-column[5] = if parlist-mode1 <> 'Товар':U then yes else no
use-column[6] = if parlist-mode1 = 'Контрагент':U then yes else no
use-column[7] = if parlist-mode1 = 'Контрагент':U then yes else no
use-column[8] = if parlist-mode1 <> 'Контрагент':U then yes else no
use-column[9] = if parlist-mode2 = 'Обороты':U then yes else no
use-column[10] = if parlist-mode2 = 'Обороты':U then yes else no
use-column[11] = if parlist-mode2 = 'Обороты':U then yes else no
use-column[12] = if parlist-mode2 = 'Обороты':U then yes else no
use-column[13] = if parlist-mode2 = 'Обороты':U then yes else no
use-column[14] = if parlist-mode2 = 'Обороты':U then yes else no
use-column[15] = if parlist-mode2 = 'Обороты':U then yes else no
use-column[16] = if parlist-mode2 = 'Обороты':U then yes else no
use-column[17] = if parlist-mode2 = 'Обороты':U then yes else no
use-column[18] = if parlist-mode2 = 'Остатки':U then yes else no
use-column[19] = if parlist-mode2 = 'Остатки':U then yes else no
use-column[20] = if parlist-mode2 = 'Остатки':U then yes else no
.
...
Assign l-col-type="CHARACTER" l-col-len=16 l-col-format= "X(16)"     l-col-lable="Артикул основн./ контрагента".
  ...
  if use-column[1] = true then DO:
        ...
        CREATE FILL-IN C-for-artic IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME CLi-Gds-List:HANDLE
            DATA-TYPE = "CHARACTER"
...
Assign l-col-type="CHARACTER" l-col-len=16 l-col-format= "X(16)"     l-col-lable="Артикул основн./ контр.".
  ...
  define variable c-for-cli-artic as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[2] = true then DO:
        ...
        CREATE EDITOR L-2 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 4
        .
        CREATE FILL-IN C-for-cli-artic IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME CLi-Gds-List:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="CHARACTER" l-col-len=7  l-col-format= "X(3)"      l-col-lable="Ед.изм./контр .".
  ...
  define variable c-for-unit-base as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[3] = true then DO:
        ...
        CREATE EDITOR L-3 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 4
        .
        CREATE FILL-IN C-for-unit-base IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME CLi-Gds-List:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="CHARACTER" l-col-len=9  l-col-format= "X(9)"      l-col-lable="Пр-ль".
  ...
  define variable c-producer as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[6] = true then DO:
        ...
        CREATE EDITOR L-6 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 4
        .
        CREATE FILL-IN C-producer IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME CLi-Gds-List:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL" l-col-len=15    l-col-format= "->>,>>>,>>9.<<<"      l-col-lable="Кол-во/приход".
  ...
  define variable c-for-in-qnty as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[9] = true then DO:
        ...
        CREATE EDITOR L-9 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 4
        .
        CREATE FILL-IN C-for-in-qnty IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME CLi-Gds-List:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL" l-col-len=15    l-col-format= "->>,>>>,>>9.<<<"      l-col-lable="Кол-во/расход".
  ...
  define variable c-for-out-qnty as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[10] = true then DO:
        ...
        CREATE EDITOR L-10 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 4
        .
        CREATE FILL-IN C-for-out-qnty IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME CLi-Gds-List:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL" l-col-len=15    l-col-format= "->>,>>>,>>9.<<<"      l-col-lable="Кол-во/возврат".
  ...
  define variable c-for-ret-qnty as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[11] = true then DO:
        ...
        CREATE EDITOR L-11 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 4
        .
        CREATE FILL-IN C-for-ret-qnty IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME CLi-Gds-List:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL" l-col-len=15    l-col-format= "->>>,>>>,>>9.99"      l-col-lable="Учетн.цены баз.вал./приход".
  ...
  define variable c-for-in-base as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[12] = true then DO:
        ...
        CREATE EDITOR L-12 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 4
        .
        CREATE FILL-IN C-for-in-base IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME CLi-Gds-List:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
.
Assign l-col-type="DECIMAL" l-col-len=15    l-col-format= "->>>,>>>,>>9.99"      l-col-lable="Учетн.цены руб./приход".
  define variable ed13 as handle no-undo.
  define variable l-13 as handle no-undo.
  define variable ll-13 as handle no-undo.
  define variable c-for-in-rubl as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[13] = true then DO:
        ...
        CREATE EDITOR L-13 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 4
        .
        CREATE FILL-IN C-for-in-rubl IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME CLi-Gds-List:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL" l-col-len=15    l-col-format= "->>>,>>>,>>9.99"      l-col-lable="Продаж.цены вал.продаж/ расход".
  ...
  define variable c-for-out-sum as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[14] = true then DO:
        ...
        CREATE EDITOR L-14 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 4
        .
        CREATE FILL-IN C-for-out-sum IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME CLi-Gds-List:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL" l-col-len=15    l-col-format= "->>>,>>>,>>9.99"      l-col-lable="Продаж.цены вал.продаж/ возврат".
  ...
  define variable c-for-ret-sum as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[15] = true then DO:
        ...
        CREATE EDITOR L-15 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 4
        .
        CREATE FILL-IN C-for-ret-sum IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME CLi-Gds-List:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL" l-col-len=15    l-col-format= "->>>,>>>,>>9.99"      l-col-lable="Скидки вал.продаж/ расход".
  ...
  define variable c-for-out-discnt as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[16] = true then DO:
        ...
        CREATE EDITOR L-16 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 4
        .
        CREATE FILL-IN C-for-out-discnt IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME CLi-Gds-List:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL" l-col-len=15    l-col-format= "->>>,>>>,>>9.99"      l-col-lable="Скидки вал.продаж/ возврат".
  ...
  define variable c-for-ret-discnt as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[17] = true then DO:
        ...
        CREATE EDITOR L-17 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 4
        .
        CREATE FILL-IN C-for-ret-discnt IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME CLi-Gds-List:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL" l-col-len=15    l-col-format= "->>>,>>>,>>9.99"      l-col-lable="Кол-во/остатки".
  ...
  define variable c-for-supp-qnty as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[18] = true then DO:
        ...
        CREATE EDITOR L-18 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 4
        .
        CREATE FILL-IN C-for-supp-qnty IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME CLi-Gds-List:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL" l-col-len=15    l-col-format= "->>>,>>>,>>9.99"      l-col-lable="Учетн.цены баз.вал./ остатки".
  ...
  define variable c-for-supp-base as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[19] = true then DO:
        ...
        CREATE EDITOR L-19 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 4
        .
        CREATE FILL-IN C-for-supp-base IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME CLi-Gds-List:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
.
Assign l-col-type="DECIMAL" l-col-len=15    l-col-format= "->>>,>>>,>>9.99"      l-col-lable="Учетн.цены руб./ остатки".
  define variable ed20 as handle no-undo.
  define variable l-20 as handle no-undo.
  define variable ll-20 as handle no-undo.
  define variable c-for-supp-rubl as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[20] = true then DO:
        ...
        CREATE EDITOR L-20 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 4
        .
        CREATE FILL-IN C-for-supp-rubl IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME CLi-Gds-List:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
if num-entries (sheetf.colformat, chr(4)) > 1 then  do:
  assign
  entry(2, sheetf.colformat, chr(4)) =  entry(2, sheetf.colformat, chr(4)) +
                                             (if entry(2, sheetf.colformat, chr(4)) = "":U then "":U else ";") +
                                             "1=@;2=@":U
  .
end.
else  do:
  assign
  sheetf.colformat = sheetf.colformat + chr(4) + "1=@;2=@":U
  .
end.
...
DO WHILE available sb-cli-gds :
  ...
  .
  if parlist-mode2 = 'Обороты':U then do:
    assign
  ...
  if parlist-mode2 = 'Остатки':U then do:
    assign
  ...
  if not parlist-mode1 = 'Товар':U then do:
  ...
  if parlist-mode1 = 'Контрагент':U then do:
  ...
  if not parlist-mode1 = 'Контрагент':U then do:
    FIND FIRST ub.clients NO-LOCK WHERE
  ...
  if use-column[1]
  then  C-for-artic:screen-value = string(sb-cli-gds.artic, entry(1, c-for-artic:private-data, chr(4))).
  if use-column[3]
  then  C-for-unit-base:screen-value = string(for-unit-base, entry(1, c-for-unit-base:private-data, chr(4))).
  if use-column[5]
  then  C-for-gds-name:screen-value = string(namebuf1, entry(1, c-for-gds-name:private-data, chr(4))).
  if use-column[6]
  then  C-producer:screen-value = string(producer, entry(1, c-producer:private-data, chr(4))).
  if use-column[7]
  then  C-for-prod-name:screen-value = string(prodbuf1, entry(1, c-for-prod-name:private-data, chr(4))).
  if use-column[8]
  then  C-for-cli-name:screen-value = string(cliname1, entry(1, c-for-cli-name:private-data, chr(4))).
  if use-column[9]
  then  C-for-in-qnty:screen-value = string(sb-cli-gds.in-qnty, entry(1, c-for-in-qnty:private-data, chr(4))).
  if use-column[10]
  then  C-for-out-qnty:screen-value = string(sb-cli-gds.out-qnty, entry(1, c-for-out-qnty:private-data, chr(4))).
  if use-column[11]
  then  C-for-ret-qnty:screen-value = string(sb-cli-gds.ret-qnty, entry(1, c-for-ret-qnty:private-data, chr(4))).
  if use-column[12]
  then  C-for-in-base:screen-value = string(sb-cli-gds.in-base, entry(1, c-for-in-base:private-data, chr(4))).
  if use-column[13]
  then  C-for-in-rubl:screen-value = string(sb-cli-gds.in-rubl, entry(1, c-for-in-rubl:private-data, chr(4))).
  if use-column[14]
  then  C-for-out-sum:screen-value = string(sb-cli-gds.out-sum, entry(1, c-for-out-sum:private-data, chr(4))).
  if use-column[15]
  then  C-for-ret-sum:screen-value = string(sb-cli-gds.ret-sum, entry(1, c-for-ret-sum:private-data, chr(4))).
  if use-column[16]
  then  C-for-out-discnt:screen-value = string(sb-cli-gds.out-discnt, entry(1, c-for-out-discnt:private-data, chr(4))).
  if use-column[17]
  then  C-for-ret-discnt:screen-value = string(sb-cli-gds.ret-discnt, entry(1, c-for-ret-discnt:private-data, chr(4))).
  if use-column[18]
  then  C-for-supp-qnty:screen-value = string(sb-cli-gds.supp-qnty, entry(1, c-for-supp-qnty:private-data, chr(4))).
  if use-column[19]
  then  C-for-supp-base:screen-value = string(sb-cli-gds.supp-base, entry(1, c-for-supp-base:private-data, chr(4))).
  if use-column[20]
  then  C-for-supp-rubl:screen-value = string(sb-cli-gds.supp-rubl, entry(1, c-for-supp-rubl:private-data, chr(4))).
  DISPLAY stream  PrnLibStream with frame CLi-Gds-List.                                      DOWN 1 stream PrnLibStream with frame CLi-Gds-List.
  if use-column[1]
  then  C-for-artic:screen-value = string(sb-cli-gds.cli-art, entry(1, c-for-artic:private-data, chr(4))).
  if use-column[3]
  then  C-for-unit-base:screen-value = string(sb-cli-gds.unit-cli, entry(1, c-for-unit-base:private-data, chr(4))).
  if use-column[5]
  then  C-for-gds-name:screen-value = string(namebuf2, entry(1, c-for-gds-name:private-data, chr(4))).
  if use-column[7]
  then  C-for-prod-name:screen-value = string(prodbuf2, entry(1, c-for-prod-name:private-data, chr(4))).
  if use-column[8]
  then  C-for-cli-name:screen-value = string(cliname2, entry(1, c-for-cli-name:private-data, chr(4))).
  DISPLAY stream  PrnLibStream with frame CLi-Gds-List.                                      DOWN 1 stream PrnLibStream with frame CLi-Gds-List.
    if Make-Excel then  put   stream ForExcel unformatted
  if use-column[1]
  then (reg-output(
                    string(chr(4) + sb-cli-gds.artic, entry(1, c-for-artic:private-data, chr(4)))
  ...
  if use-column[2]
  then (reg-output(
                    string(chr(4) + sb-cli-gds.cli-art, entry(1, c-for-cli-artic:private-data, chr(4)))
                   ,c-for-cli-artic:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[3]
  then (reg-output(
                    string(for-unit-base, entry(1, c-for-unit-base:private-data, chr(4)))
                   ,c-for-unit-base:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[4]
  then (reg-output(
                    string(sb-cli-gds.unit-cli, entry(1, c-for-unit-cli:private-data, chr(4)))
  ...
  if use-column[5]
  then (reg-output(
                    string(for-gds-name, entry(1, c-for-gds-name:private-data, chr(4)))
  ...
  if use-column[6]
  then (reg-output(
                    string(producer, entry(1, c-producer:private-data, chr(4)))
                   ,c-producer:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[7]
  then (reg-output(
                    string(for-prod-name, entry(1, c-for-prod-name:private-data, chr(4)))
  ...
  if use-column[8]
  then (reg-output(
                    string(for-cli-name, entry(1, c-for-cli-name:private-data, chr(4)))
  ...
  if use-column[9]
  then (reg-output(
                    string(sb-cli-gds.in-qnty, entry(1, c-for-in-qnty:private-data, chr(4)))
                   ,c-for-in-qnty:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[10]
  then (reg-output(
                    string(sb-cli-gds.out-qnty, entry(1, c-for-out-qnty:private-data, chr(4)))
                   ,c-for-out-qnty:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[11]
  then (reg-output(
                    string(sb-cli-gds.ret-qnty, entry(1, c-for-ret-qnty:private-data, chr(4)))
                   ,c-for-ret-qnty:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[12]
  then (reg-output(
                    string(sb-cli-gds.in-base, entry(1, c-for-in-base:private-data, chr(4)))
                   ,c-for-in-base:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[13]
  then (reg-output(
                    string(sb-cli-gds.in-rubl, entry(1, c-for-in-rubl:private-data, chr(4)))
                   ,c-for-in-rubl:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[14]
  then (reg-output(
                    string(sb-cli-gds.out-sum, entry(1, c-for-out-sum:private-data, chr(4)))
                   ,c-for-out-sum:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[15]
  then (reg-output(
                    string(sb-cli-gds.ret-sum, entry(1, c-for-ret-sum:private-data, chr(4)))
                   ,c-for-ret-sum:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[16]
  then (reg-output(
                    string(sb-cli-gds.out-discnt, entry(1, c-for-out-discnt:private-data, chr(4)))
                   ,c-for-out-discnt:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[17]
  then (reg-output(
                    string(sb-cli-gds.ret-discnt, entry(1, c-for-ret-discnt:private-data, chr(4)))
                   ,c-for-ret-discnt:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[18]
  then (reg-output(
                    string(sb-cli-gds.supp-qnty, entry(1, c-for-supp-qnty:private-data, chr(4)))
                   ,c-for-supp-qnty:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[19]
  then (reg-output(
                    string(sb-cli-gds.supp-base, entry(1, c-for-supp-base:private-data, chr(4)))
                   ,c-for-supp-base:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[20]
  then (reg-output(
                    string(sb-cli-gds.supp-rubl, entry(1, c-for-supp-rubl:private-data, chr(4)))
                   ,c-for-supp-rubl:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
...
assign
for-gds-name = 'записей' + chr(32) + string(accum-count)
for-artic = 'ИТОГО -'
.
  if use-column[1]
  then  C-for-artic:screen-value = string(for-artic, entry(1, c-for-artic:private-data, chr(4))).
  if use-column[3]
  then  C-for-gds-name:screen-value = string(for-gds-name, entry(1, c-for-gds-name:private-data, chr(4))).
  if use-column[4]
  then  C-for-unit-base:screen-value = string('_', entry(1, c-for-unit-base:private-data, chr(4))).
  if use-column[6]
  then  C-producer:screen-value = string('_', entry(1, c-producer:private-data, chr(4))).
  if use-column[7]
  then  C-for-prod-name:screen-value = string('_', entry(1, c-for-prod-name:private-data, chr(4))).
  if use-column[8]
  then  C-for-cli-name:screen-value = string('_', entry(1, c-for-cli-name:private-data, chr(4))).
  if use-column[9]
  then  C-for-in-qnty:screen-value = string(accum-in-qnty, entry(1, c-for-in-qnty:private-data, chr(4))).
  if use-column[10]
  then  C-for-out-qnty:screen-value = string(accum-out-qnty, entry(1, c-for-out-qnty:private-data, chr(4))).
  if use-column[11]
  then  C-for-ret-qnty:screen-value = string(accum-ret-qnty, entry(1, c-for-ret-qnty:private-data, chr(4))).
  if use-column[12]
  then  C-for-in-base:screen-value = string(accum-in-base, entry(1, c-for-in-base:private-data, chr(4))).
  if use-column[13]
  then  C-for-in-rubl:screen-value = string(accum-in-rubl, entry(1, c-for-in-rubl:private-data, chr(4))).
  if use-column[14]
  then  C-for-out-sum:screen-value = string(accum-out-sum, entry(1, c-for-out-sum:private-data, chr(4))).
  if use-column[15]
  then  C-for-ret-sum:screen-value = string(accum-ret-sum, entry(1, c-for-ret-sum:private-data, chr(4))).
  if use-column[16]
  then  C-for-out-discnt:screen-value = string(accum-out-discnt, entry(1, c-for-out-discnt:private-data, chr(4))).
  if use-column[17]
  then  C-for-ret-discnt:screen-value = string(accum-ret-discnt, entry(1, c-for-ret-discnt:private-data, chr(4))).
  if use-column[18]
  then  C-for-supp-qnty:screen-value = string(accum-supp-qnty, entry(1, c-for-supp-qnty:private-data, chr(4))).
  if use-column[19]
  then  C-for-supp-base:screen-value = string(accum-supp-base, entry(1, c-for-supp-base:private-data, chr(4))).
  if use-column[20]
  then  C-for-supp-rubl:screen-value = string(accum-supp-rubl, entry(1, c-for-supp-rubl:private-data, chr(4))).
DISPLAY stream  PrnLibStream with frame CLi-Gds-List.                                      DOWN 1 stream PrnLibStream with frame CLi-Gds-List.
if Make-Excel then  put   stream ForExcel unformatted
  if use-column[1]
  then (reg-output(
                    string(for-artic, entry(1, c-for-artic:private-data, chr(4)))
                   ,c-for-artic:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
  ...
  if use-column[2]
  then (reg-output(
                    string(for-cli-artic, entry(1, c-for-cli-artic:private-data, chr(4)))
                   ,c-for-cli-artic:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
  ...
  if use-column[3]
  then (reg-output(
                    string('_', entry(1, c-for-unit-base:private-data, chr(4)))
                   ,c-for-unit-base:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
  ...
  if use-column[4]
  then (reg-output(
                    string('_', entry(1, c-for-unit-cli:private-data, chr(4)))
                   ,c-for-unit-cli:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
  ...
  if use-column[6]
  then (reg-output(
                    string('_', entry(1, c-producer:private-data, chr(4)))
                   ,c-producer:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
  ...
  if use-column[7]
  then (reg-output(
                    string('_', entry(1, c-for-prod-name:private-data, chr(4)))
                   ,c-for-prod-name:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
  ...
  if use-column[8]
  then (reg-output(
                    string('_', entry(1, c-for-cli-name:private-data, chr(4)))
                   ,c-for-cli-name:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
...
if Make-Excel then  put   stream ForExcel unformatted
  if use-column[9]
  then (reg-output(
                    string(accum-in-qnty, entry(1, c-for-in-qnty:private-data, chr(4)))
                   ,c-for-in-qnty:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
  ...
  if use-column[10]
  then (reg-output(
                    string(accum-out-qnty, entry(1, c-for-out-qnty:private-data, chr(4)))
                   ,c-for-out-qnty:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
  ...
  if use-column[11]
  then (reg-output(
                    string(accum-ret-qnty, entry(1, c-for-ret-qnty:private-data, chr(4)))
                   ,c-for-ret-qnty:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
  ...
  if use-column[12]
  then (reg-output(
                    string(accum-in-base, entry(1, c-for-in-base:private-data, chr(4)))
                   ,c-for-in-base:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
  ...
  if use-column[13]
  then (reg-output(
                    string(accum-in-rubl, entry(1, c-for-in-rubl:private-data, chr(4)))
                   ,c-for-in-rubl:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
  ...
  if use-column[14]
  then (reg-output(
                    string(accum-out-sum, entry(1, c-for-out-sum:private-data, chr(4)))
                   ,c-for-out-sum:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
  ...
  if use-column[15]
  then (reg-output(
                    string(accum-ret-sum, entry(1, c-for-ret-sum:private-data, chr(4)))
                   ,c-for-ret-sum:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
  ...
  if use-column[16]
  then (reg-output(
                    string(accum-out-discnt, entry(1, c-for-out-discnt:private-data, chr(4)))
                   ,c-for-out-discnt:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
  ...
  if use-column[17]
  then (reg-output(
                    string(accum-ret-discnt, entry(1, c-for-ret-discnt:private-data, chr(4)))
                   ,c-for-ret-discnt:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
  ...
  if use-column[18]
  then (reg-output(
                    string(accum-supp-qnty, entry(1, c-for-supp-qnty:private-data, chr(4)))
                   ,c-for-supp-qnty:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
  ...
  if use-column[19]
  then (reg-output(
                    string(accum-supp-base, entry(1, c-for-supp-base:private-data, chr(4)))
                   ,c-for-supp-base:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
  ...
  if use-column[20]
  then (reg-output(
                    string(accum-supp-rubl, entry(1, c-for-supp-rubl:private-data, chr(4)))
                   ,c-for-supp-rubl:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
...
procedure underline-frame :
  ...
  if use-column[3]
  then  C-for-gds-name:screen-value = string(fill20).
  if use-column[4]
  then  C-for-unit-base:screen-value = string(fill3).
  if use-column[6]
  then  C-producer:screen-value = string(fill9).
  if use-column[7]
  then  C-for-prod-name:screen-value = string(fill20).
  if use-column[8]
  then  C-for-cli-name:screen-value = string(fill20).
  if use-column[9]
  then  C-for-in-qnty:screen-value = string(fill15).
  if use-column[10]
  then  C-for-out-qnty:screen-value = string(fill15).
  if use-column[11]
  then  C-for-ret-qnty:screen-value = string(fill15).
  if use-column[12]
  then  C-for-in-base:screen-value = string(fill15).
  if use-column[13]
  then  C-for-in-rubl:screen-value = string(fill15).
  if use-column[14]
  then  C-for-out-sum:screen-value = string(fill15).
  if use-column[15]
  then  C-for-ret-sum:screen-value = string(fill15).
  if use-column[16]
  then  C-for-out-discnt:screen-value = string(fill15).
  if use-column[17]
  then  C-for-ret-discnt:screen-value = string(fill15).
  if use-column[18]
  then  C-for-supp-qnty:screen-value = string(fill15).
  if use-column[19]
  then  C-for-supp-base:screen-value = string(fill15).
  if use-column[20]
  then  C-for-supp-rubl:screen-value = string(fill15).
...
procedure underline-excel :
  ...
  :
    if Make-Excel then  put   stream ForExcel unformatted
  if use-column[1]
  then (string(fill16) + (if 1 < last-col-num then CHR(9) else ""))
  else ""
  if use-column[2]
  then (string(fill16) + (if 2 < last-col-num then CHR(9) else ""))
  else ""
  if use-column[3]
  then (string(fill20) + (if 3 < last-col-num then CHR(9) else ""))
  else ""
  if use-column[4]
  then (string(fill3) + (if 4 < last-col-num then CHR(9) else ""))
  else ""
  if use-column[5]
  then (string(fill3) + (if 5 < last-col-num then CHR(9) else ""))
  else ""
  if use-column[6]
  then (string(fill9) + (if 6 < last-col-num then CHR(9) else ""))
  else ""
  if use-column[7]
  then (string(fill20) + (if 7 < last-col-num then CHR(9) else ""))
  else ""
  if use-column[8]
  then (string(fill20) + (if 8 < last-col-num then CHR(9) else ""))
  else ""
  if use-column[9]
  then (string(fill15) + (if 9 < last-col-num then CHR(9) else ""))
  else ""
  if use-column[10]
  then (string(fill15) + (if 10 < last-col-num then CHR(9) else ""))
  else ""
  if use-column[11]
  then (string(fill15) + (if 11 < last-col-num then CHR(9) else ""))
  else ""
  if use-column[12]
  then (string(fill15) + (if 12 < last-col-num then CHR(9) else ""))
  else ""
  if use-column[13]
  then (string(fill15) + (if 13 < last-col-num then CHR(9) else ""))
  else ""
  if use-column[14]
  then (string(fill15) + (if 14 < last-col-num then CHR(9) else ""))
  else ""
  if use-column[15]
  then (string(fill15) + (if 15 < last-col-num then CHR(9) else ""))
  else ""
  if use-column[16]
  then (string(fill15) + (if 16 < last-col-num then CHR(9) else ""))
  else ""
  if use-column[17]
  then (string(fill15) + (if 17 < last-col-num then CHR(9) else ""))
  else ""
  if use-column[18]
  then (string(fill15) + (if 18 < last-col-num then CHR(9) else ""))
  else ""
  if use-column[19]
  then (string(fill15) + (if 19 < last-col-num then CHR(9) else ""))
  else ""
  if use-column[20]
  then (string(fill15) + (if 20 < last-col-num then CHR(9) else ""))
  else ""
    skip.
  end.
end procedure.
