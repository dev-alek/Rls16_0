...
assign
  v-str-recid15 = trim( string( recid( X_c-plc-hist ) , "->>>>>>>>>>>9":U ) )
...
if p-open-query then do:
  ...
  :
    ...
    .
      ...
      assign
      parameter-2-28 = (if p-find-next then "true":u else "false":u )
      parameter-3-28 =  "FOR EACH X_c-plc-hist"
      parameter-4-28 =
        (
          if (" TRUE " + " " + where-phrase-28) <> ""
          then " TRUE " + " " + where-phrase-28
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-30 as character no-undo .
      ...
      parameter-4-30 =
        (
          if ("                     X_c-plc-hist.obj-type = p-obj-type and X_c-plc-hist.obj-code = p-obj-code                       " + " " + where-phrase-30) <> ""
          then  substitute(' X_c-plc-hist.obj-type = &1&2&1 and X_c-plc-hist.obj-code = &3 ', chr(34), p-obj-type, p-obj-code )  + " " + where-phrase-30
          else "true"
        )
      parameter-5-30 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-30 =
          ("                     X_c-plc-hist.obj-type = p-obj-type and X_c-plc-hist.obj-code = p-obj-code                       " + " " + where-phrase-30 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-plc-hist:handle
  ...
  :
    if query br-plc-hist:handle:get-buffer-handle(1) = (buffer X_c-plc-hist:handle) then do:
      ...
      parameter-4-30 =
        "where ":u +  substitute(' X_c-plc-hist.obj-type = &1&2&1 and X_c-plc-hist.obj-code = &3 ', chr(34), p-obj-type, p-obj-code )  + " ":u + where-phrase-30 + " ":u + p-find-condition + " " + ""
    ...
    .
      ...
      assign
      parameter-2-30 = (if p-find-next then "true":u else "false":u )
      parameter-3-30 =  "FOR EACH X_c-plc-hist"
      parameter-4-30 =
        (
          if ("                     X_c-plc-hist.obj-type = p-obj-type and X_c-plc-hist.obj-code = p-obj-code                       " + " " + where-phrase-30) <> ""
          then  substitute(' X_c-plc-hist.obj-type = &1&2&1 and X_c-plc-hist.obj-code = &3 ', chr(34), p-obj-type, p-obj-code )  + " " + where-phrase-30
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-32 as character no-undo .
      ...
      parameter-4-32 =
        (
          if (" X_c-plc-hist.obj-type = p-obj-type and X_c-plc-hist.obj-code = p-obj-code AND X_c-plc-hist.pl-code  = p-pl-code " + " " + where-phrase-32) <> ""
          then  substitute('X_c-plc-hist.obj-type = &1&2&1 and X_c-plc-hist.obj-code = &3 AND X_c-plc-hist.pl-code  = &4 '                           , chr(34)                           , p-obj-type                           , p-obj-code                           , p-pl-code) + " " + where-phrase-32
          else "true"
        )
      parameter-5-32 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-32 =
          (" X_c-plc-hist.obj-type = p-obj-type and X_c-plc-hist.obj-code = p-obj-code AND X_c-plc-hist.pl-code  = p-pl-code " + " " + where-phrase-32 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-plc-hist:handle
  ...
  :
    if query br-plc-hist:handle:get-buffer-handle(1) = (buffer X_c-plc-hist:handle) then do:
      ...
      parameter-4-32 =
        "where ":u +  substitute('X_c-plc-hist.obj-type = &1&2&1 and X_c-plc-hist.obj-code = &3 AND X_c-plc-hist.pl-code  = &4 '                           , chr(34)                           , p-obj-type                           , p-obj-code                           , p-pl-code) + " ":u + where-phrase-32 + " ":u + p-find-condition + " " + ""
      parameter-5-32 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-32 = (if p-find-next then "true":u else "false":u )
      parameter-3-32 =  "FOR EACH X_c-plc-hist"
      parameter-4-32 =
        (
          if (" X_c-plc-hist.obj-type = p-obj-type and X_c-plc-hist.obj-code = p-obj-code AND X_c-plc-hist.pl-code  = p-pl-code " + " " + where-phrase-32) <> ""
          then  substitute('X_c-plc-hist.obj-type = &1&2&1 and X_c-plc-hist.obj-code = &3 AND X_c-plc-hist.pl-code  = &4 '                           , chr(34)                           , p-obj-type                           , p-obj-code                           , p-pl-code) + " " + where-phrase-32
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-34 as character no-undo .
      ...
      parameter-4-34 =
        (
          if (" X_c-plc-hist.obj-type = p-obj-type and X_c-plc-hist.obj-code = p-obj-code                            And X_c-plc-hist.pl-code  = p-pl-code  and X_c-plc-hist.subject = p-subject                         " + " " + where-phrase-34) <> ""
          then  substitute('X_c-plc-hist.obj-type = &1&2&1 and X_c-plc-hist.obj-code = &3                            And X_c-plc-hist.pl-code  = &4  and X_c-plc-hist.subject = &1&5&1 ', chr(34), p-obj-type, p-obj-code, p-pl-code, p-subject)  + " " + where-phrase-34
          else "true"
        )
      parameter-5-34 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-34 =
          (" X_c-plc-hist.obj-type = p-obj-type and X_c-plc-hist.obj-code = p-obj-code                            And X_c-plc-hist.pl-code  = p-pl-code  and X_c-plc-hist.subject = p-subject                         " + " " + where-phrase-34 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-plc-hist:handle
  ...
  :
    if query br-plc-hist:handle:get-buffer-handle(1) = (buffer X_c-plc-hist:handle) then do:
      ...
      parameter-4-34 =
        "where ":u +  substitute('X_c-plc-hist.obj-type = &1&2&1 and X_c-plc-hist.obj-code = &3                            And X_c-plc-hist.pl-code  = &4  and X_c-plc-hist.subject = &1&5&1 ', chr(34), p-obj-type, p-obj-code, p-pl-code, p-subject)  + " ":u + where-phrase-34 + " ":u + p-find-condition + " " + ""
    ...
    .
      ...
      assign
      parameter-2-34 = (if p-find-next then "true":u else "false":u )
      parameter-3-34 =  "FOR EACH X_c-plc-hist"
      parameter-4-34 =
        (
          if (" X_c-plc-hist.obj-type = p-obj-type and X_c-plc-hist.obj-code = p-obj-code                            And X_c-plc-hist.pl-code  = p-pl-code  and X_c-plc-hist.subject = p-subject                         " + " " + where-phrase-34) <> ""
          then  substitute('X_c-plc-hist.obj-type = &1&2&1 and X_c-plc-hist.obj-code = &3                            And X_c-plc-hist.pl-code  = &4  and X_c-plc-hist.subject = &1&5&1 ', chr(34), p-obj-type, p-obj-code, p-pl-code, p-subject)  + " " + where-phrase-34
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-36 as character no-undo .
      ...
      parameter-4-36 =
        (
          if (" X_c-plc-hist.obj-type = p-obj-type and X_c-plc-hist.obj-code = p-obj-code                            And X_c-plc-hist.pl-code  = p-pl-code  and X_c-plc-hist.subject = p-subject                           And X_c-plc-hist.gds-code  = p-gds-code                          " + " " + where-phrase-36) <> ""
          then  substitute('X_c-plc-hist.obj-type = &1&2&1 and X_c-plc-hist.obj-code = &3                            And X_c-plc-hist.pl-code  = &4  and X_c-plc-hist.subject = &1&5&1                           And X_c-plc-hist.gds-code  = &6 ', chr(34), p-obj-type, p-obj-code, p-pl-code, p-subject, p-gds-code )  + " " + where-phrase-36
          else "true"
        )
      parameter-5-36 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-36 =
          (" X_c-plc-hist.obj-type = p-obj-type and X_c-plc-hist.obj-code = p-obj-code                            And X_c-plc-hist.pl-code  = p-pl-code  and X_c-plc-hist.subject = p-subject                           And X_c-plc-hist.gds-code  = p-gds-code                          " + " " + where-phrase-36 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-plc-hist:handle
  ...
  :
    if query br-plc-hist:handle:get-buffer-handle(1) = (buffer X_c-plc-hist:handle) then do:
      ...
      parameter-4-36 =
        "where ":u +  substitute('X_c-plc-hist.obj-type = &1&2&1 and X_c-plc-hist.obj-code = &3                            And X_c-plc-hist.pl-code  = &4  and X_c-plc-hist.subject = &1&5&1                           And X_c-plc-hist.gds-code  = &6 ', chr(34), p-obj-type, p-obj-code, p-pl-code, p-subject, p-gds-code )  + " ":u + where-phrase-36 + " ":u + p-find-condition + " " + ""
    ...
    .
      ...
      assign
      parameter-2-36 = (if p-find-next then "true":u else "false":u )
      parameter-3-36 =  "FOR EACH X_c-plc-hist"
      parameter-4-36 =
        (
          if (" X_c-plc-hist.obj-type = p-obj-type and X_c-plc-hist.obj-code = p-obj-code                            And X_c-plc-hist.pl-code  = p-pl-code  and X_c-plc-hist.subject = p-subject                           And X_c-plc-hist.gds-code  = p-gds-code                          " + " " + where-phrase-36) <> ""
          then  substitute('X_c-plc-hist.obj-type = &1&2&1 and X_c-plc-hist.obj-code = &3                            And X_c-plc-hist.pl-code  = &4  and X_c-plc-hist.subject = &1&5&1                           And X_c-plc-hist.gds-code  = &6 ', chr(34), p-obj-type, p-obj-code, p-pl-code, p-subject, p-gds-code )  + " " + where-phrase-36
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-38 as character no-undo .
      ...
      parameter-4-38 =
        (
          if (" X_c-plc-hist.obj-type = p-obj-type and X_c-plc-hist.obj-code = p-obj-code                            And X_c-plc-hist.pl-code  = p-pl-code  and X_c-plc-hist.subject = p-subject                           And X_c-plc-hist.gds-code  = p-gds-code                            And X_c-plc-hist.pump-code  = p-pump-code                          " + " " + where-phrase-38) <> ""
          then  substitute('X_c-plc-hist.obj-type = &1&2&1 and X_c-plc-hist.obj-code = &3                            And X_c-plc-hist.pl-code  = &4  and X_c-plc-hist.subject = &1&5&1                           And X_c-plc-hist.gds-code  = &6                            And X_c-plc-hist.pump-code  = &7 ', chr(34), p-obj-type, p-obj-code, p-pl-code, p-subject, p-gds-code, p-pump-code )  + " " + where-phrase-38
          else "true"
        )
      parameter-5-38 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-38 =
          (" X_c-plc-hist.obj-type = p-obj-type and X_c-plc-hist.obj-code = p-obj-code                            And X_c-plc-hist.pl-code  = p-pl-code  and X_c-plc-hist.subject = p-subject                           And X_c-plc-hist.gds-code  = p-gds-code                            And X_c-plc-hist.pump-code  = p-pump-code                          " + " " + where-phrase-38 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-plc-hist:handle
  ...
  :
    if query br-plc-hist:handle:get-buffer-handle(1) = (buffer X_c-plc-hist:handle) then do:
      ...
      parameter-4-38 =
        "where ":u +  substitute('X_c-plc-hist.obj-type = &1&2&1 and X_c-plc-hist.obj-code = &3                            And X_c-plc-hist.pl-code  = &4  and X_c-plc-hist.subject = &1&5&1                           And X_c-plc-hist.gds-code  = &6                            And X_c-plc-hist.pump-code  = &7 ', chr(34), p-obj-type, p-obj-code, p-pl-code, p-subject, p-gds-code, p-pump-code )  + " ":u + where-phrase-38 + " ":u + p-find-condition + " " + ""
      parameter-5-38 = " use-index idate "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query br-plc-hist:handle
      ...
      assign
      parameter-2-38 = (if p-find-next then "true":u else "false":u )
      parameter-3-38 =  "FOR EACH X_c-plc-hist"
      parameter-4-38 =
        (
          if (" X_c-plc-hist.obj-type = p-obj-type and X_c-plc-hist.obj-code = p-obj-code                            And X_c-plc-hist.pl-code  = p-pl-code  and X_c-plc-hist.subject = p-subject                           And X_c-plc-hist.gds-code  = p-gds-code                            And X_c-plc-hist.pump-code  = p-pump-code                          " + " " + where-phrase-38) <> ""
          then  substitute('X_c-plc-hist.obj-type = &1&2&1 and X_c-plc-hist.obj-code = &3                            And X_c-plc-hist.pl-code  = &4  and X_c-plc-hist.subject = &1&5&1                           And X_c-plc-hist.gds-code  = &6                            And X_c-plc-hist.pump-code  = &7 ', chr(34), p-obj-type, p-obj-code, p-pl-code, p-subject, p-gds-code, p-pump-code )  + " " + where-phrase-38
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-40 as character no-undo .
      ...
      parameter-4-40 =
        (
          if (" X_c-plc-hist.obj-type = p-obj-type and X_c-plc-hist.obj-code = p-obj-code                            And X_c-plc-hist.pl-code  = p-pl-code  and X_c-plc-hist.subject = p-subject                           And X_c-plc-hist.pump-code  = p-pump-code                          " + " " + where-phrase-40) <> ""
          then  substitute('X_c-plc-hist.obj-type = &1&2&1 and X_c-plc-hist.obj-code = &3                            And X_c-plc-hist.pl-code  = &4  and X_c-plc-hist.subject = &1&5&1                           And X_c-plc-hist.pump-code  = &6 ', chr(34), p-obj-type, p-obj-code, p-pl-code, p-subject, p-pump-code)  + " " + where-phrase-40
          else "true"
        )
      parameter-5-40 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-40 =
          (" X_c-plc-hist.obj-type = p-obj-type and X_c-plc-hist.obj-code = p-obj-code                            And X_c-plc-hist.pl-code  = p-pl-code  and X_c-plc-hist.subject = p-subject                           And X_c-plc-hist.pump-code  = p-pump-code                          " + " " + where-phrase-40 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-plc-hist:handle
  ...
  :
    if query br-plc-hist:handle:get-buffer-handle(1) = (buffer X_c-plc-hist:handle) then do:
      ...
      parameter-4-40 =
        "where ":u +  substitute('X_c-plc-hist.obj-type = &1&2&1 and X_c-plc-hist.obj-code = &3                            And X_c-plc-hist.pl-code  = &4  and X_c-plc-hist.subject = &1&5&1                           And X_c-plc-hist.pump-code  = &6 ', chr(34), p-obj-type, p-obj-code, p-pl-code, p-subject, p-pump-code)  + " ":u + where-phrase-40 + " ":u + p-find-condition + " " + ""
      parameter-5-40 = " use-index idate "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query br-plc-hist:handle
      ...
      assign
      parameter-2-40 = (if p-find-next then "true":u else "false":u )
      parameter-3-40 =  "FOR EACH X_c-plc-hist"
      parameter-4-40 =
        (
          if (" X_c-plc-hist.obj-type = p-obj-type and X_c-plc-hist.obj-code = p-obj-code                            And X_c-plc-hist.pl-code  = p-pl-code  and X_c-plc-hist.subject = p-subject                           And X_c-plc-hist.pump-code  = p-pump-code                          " + " " + where-phrase-40) <> ""
          then  substitute('X_c-plc-hist.obj-type = &1&2&1 and X_c-plc-hist.obj-code = &3                            And X_c-plc-hist.pl-code  = &4  and X_c-plc-hist.subject = &1&5&1                           And X_c-plc-hist.pump-code  = &6 ', chr(34), p-obj-type, p-obj-code, p-pl-code, p-subject, p-pump-code)  + " " + where-phrase-40
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-42 as character no-undo .
      ...
      parameter-4-42 =
        (
          if (" X_c-plc-hist.obj-type = p-obj-type and X_c-plc-hist.obj-code = p-obj-code                            And X_c-plc-hist.pl-code  = p-pl-code  and X_c-plc-hist.subject = p-subject                           And X_c-plc-hist.pump-code  = p-pump-code                            And X_c-plc-hist.nozzle-code  = p-nozzle-code                          " + " " + where-phrase-42) <> ""
          then  substitute('X_c-plc-hist.obj-type = &1&2&1 and X_c-plc-hist.obj-code = &3                            And X_c-plc-hist.pl-code  = &4  and X_c-plc-hist.subject = &1&5&1                           And X_c-plc-hist.pump-code  = &6                            And X_c-plc-hist.nozzle-code  = &7 ', chr(34), p-obj-type, p-obj-code, p-pl-code, p-subject, p-pump-code, p-nozzle-code )  + " " + where-phrase-42
          else "true"
        )
      parameter-5-42 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-42 =
          (" X_c-plc-hist.obj-type = p-obj-type and X_c-plc-hist.obj-code = p-obj-code                            And X_c-plc-hist.pl-code  = p-pl-code  and X_c-plc-hist.subject = p-subject                           And X_c-plc-hist.pump-code  = p-pump-code                            And X_c-plc-hist.nozzle-code  = p-nozzle-code                          " + " " + where-phrase-42 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-plc-hist:handle
  ...
  :
    ...
    .
      ...
      assign
      parameter-2-42 = (if p-find-next then "true":u else "false":u )
      parameter-3-42 =  "FOR EACH X_c-plc-hist"
      parameter-4-42 =
        (
          if (" X_c-plc-hist.obj-type = p-obj-type and X_c-plc-hist.obj-code = p-obj-code                            And X_c-plc-hist.pl-code  = p-pl-code  and X_c-plc-hist.subject = p-subject                           And X_c-plc-hist.pump-code  = p-pump-code                            And X_c-plc-hist.nozzle-code  = p-nozzle-code                          " + " " + where-phrase-42) <> ""
          then  substitute('X_c-plc-hist.obj-type = &1&2&1 and X_c-plc-hist.obj-code = &3                            And X_c-plc-hist.pl-code  = &4  and X_c-plc-hist.subject = &1&5&1                           And X_c-plc-hist.pump-code  = &6                            And X_c-plc-hist.nozzle-code  = &7 ', chr(34), p-obj-type, p-obj-code, p-pl-code, p-subject, p-pump-code, p-nozzle-code )  + " " + where-phrase-42
