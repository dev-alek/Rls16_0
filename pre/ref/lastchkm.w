...
on ' ' of f-date in frame Dialog-Frame
do:
...
on delete-character of f-date in frame Dialog-Frame
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-d of f-date in frame Dialog-Frame
do:
...
on ctrl-b of f-date in frame Dialog-Frame
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-e of f-date in frame Dialog-Frame
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-f of f-date in frame Dialog-Frame
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
  ...
  define MENU m-ed-date4
    ...
    .
  if f-date :POPUP-MENU in frame Dialog-Frame = ?
  then do:
    ASSIGN
      f-date :POPUP-MENU in frame Dialog-Frame = MENU m-ed-date4 :HANDLE
      f-date :MENU-MOUSE in frame Dialog-Frame = 3
    .
  end.
  define variable v-label-handle4 as handle no-undo .
  assign
    v-label-handle4 = f-date :side-label-handle in frame Dialog-Frame
  .
  ...
  ON CHOOSE OF MENU-ITEM m-ed-date4-1 in menu m-ed-date4 DO:
    apply "ctrl-b":U to f-date in frame Dialog-Frame .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date4-2 in menu m-ed-date4 DO:
    apply "ctrl-d":U to f-date in frame Dialog-Frame .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date4-3 in menu m-ed-date4 DO:
    apply "ctrl-e":U to f-date in frame Dialog-Frame .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date4-4 in menu m-ed-date4 DO:
    apply "ctrl-f":U to f-date in frame Dialog-Frame .
  END.
define variable vss-include-info5 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
on ' ' of f-p-date in frame Dialog-Frame
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on delete-character of f-p-date in frame Dialog-Frame
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-d of f-p-date in frame Dialog-Frame
do:
  define variable v-curr-sv-date as date no-undo .
  if (can-query (self, "sensitive")
     and
...
on ctrl-b of f-p-date in frame Dialog-Frame
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-e of f-p-date in frame Dialog-Frame
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-f of f-p-date in frame Dialog-Frame
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
  ...
  define MENU m-ed-date6
    ...
    .
  if f-p-date :POPUP-MENU in frame Dialog-Frame = ?
  then do:
    ASSIGN
      f-p-date :POPUP-MENU in frame Dialog-Frame = MENU m-ed-date6 :HANDLE
      f-p-date :MENU-MOUSE in frame Dialog-Frame = 3
    .
  end.
  define variable v-label-handle6 as handle no-undo .
  assign
    v-label-handle6 = f-p-date :side-label-handle in frame Dialog-Frame
  .
  ...
  ON CHOOSE OF MENU-ITEM m-ed-date6-1 in menu m-ed-date6 DO:
    apply "ctrl-b":U to f-p-date in frame Dialog-Frame .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date6-2 in menu m-ed-date6 DO:
    apply "ctrl-d":U to f-p-date in frame Dialog-Frame .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date6-3 in menu m-ed-date6 DO:
    apply "ctrl-e":U to f-p-date in frame Dialog-Frame .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date6-4 in menu m-ed-date6 DO:
    apply "ctrl-f":U to f-p-date in frame Dialog-Frame .
  END.
MAIN-BLOCK:
...
FRAME Dialog-Frame:TITLE = ENTRY(1, p-title, chr(4))
f-date:LABEL IN FRAME Dialog-Frame = (IF NUM-ENTRIES(p-title, chr(4)) > 1
                                         THEN ENTRY(2, p-title, chr(4))
                                         ELSE f-date:LABEL IN FRAME Dialog-Frame)
f-p-date:LABEL IN FRAME Dialog-Frame = (IF NUM-ENTRIES(p-title, chr(4)) > 2
                                        THEN ENTRY(3, p-title, chr(4))
                                        ELSE f-p-date:LABEL IN FRAME Dialog-Frame)
f-z-num:LABEL IN FRAME Dialog-Frame = (IF NUM-ENTRIES(p-title, chr(4)) > 3
                                         THEN ENTRY(4, p-title, chr(4))
                                         ELSE f-z-num:LABEL IN FRAME Dialog-Frame)
f-p-z-num:LABEL IN FRAME Dialog-Frame = (IF NUM-ENTRIES(p-title, chr(4)) > 4
                                        THEN ENTRY(5, p-title, chr(4))
                                        ELSE f-p-z-num:LABEL IN FRAME Dialog-Frame)
.
DISPLAY
f-date
f-p-date
