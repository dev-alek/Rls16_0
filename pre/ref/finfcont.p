...
if p-fin-doc-type = 'пко':U
or  p-fin-doc-type = 'ппп':U
or  p-fin-doc-type = 'апп':U
then assign
  v-t = "Плательщика"
.
else assign
...
:
  ...
  case p-fin-doc-type :
      ...
      then do:
        case v-num :
          when 1 then do:
            ...
            tt-fin-doc.payer-sign1      =  if p-fin-doc-type = 'апп':U
                                           or p-fin-doc-type = 'ппп':U
      ...
      tt-fin-doc.payer-code-schet =  (if p-fin-doc-type = 'ппп':U
      ...
      tt-fin-doc.receiver-code-schet =  (if p-fin-doc-type = 'ппп':U
                                        or p-fin-doc-type = 'рпп':U
                                        then v-code-schet
                                        else 0)
      tt-fin-doc.receiver-c-schet    =  v-c-schet
      tt-fin-doc.receiver-r-schet    =  v-r-schet
      tt-fin-doc.receiver-sign1      =  if p-fin-doc-type = 'апп':U
                                        then  (buf_contract.own-sign-post + chr(4) + buf_contract.own-sign)
    ...
    then do:
      case v-num :
         when 1 then do:
          ...
          tt-fin-doc.receiver-sign1      =  if p-fin-doc-type = 'апр':U
                                            then buf_contract.cli-sign
                                            else tt-fin-doc.receiver-sign1
          .
     end.
   ...
   assign
    ...
    tt-fin-doc.payer-c-schet    =  v-c-schet
    tt-fin-doc.payer-r-schet    =  v-r-schet
    tt-fin-doc.payer-sign1     =  if p-fin-doc-type = 'апр':U or p-fin-doc-type = 'рко':U
                                   then (buf_contract.own-sign-post + chr(4) + buf_contract.own-sign)
                                   else (if p-fin-doc-type = 'рпп':U
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run basecode in g#library
  ...
  ,output v-base-code
     ...
     if error-status:error then undo, return error "exit".
      if v-sel-curr = chr(63) or v-sel-curr = "":U then do:
        message
...
define buffer buf_currency for ub.currency.
  ...
  :
      if p-fin-doc-type <> 'ппп':U
      AND p-fin-doc-type <> 'рпп':U then return.
