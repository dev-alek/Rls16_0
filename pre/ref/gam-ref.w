...
define variable vss-description as character no-undo initial "Справочник товаров - режим товары на объекте по Ассортиментной матрице".
...
DEFINE NEW SHARED QUERY br-gds FOR gob-doc , gam-doc SCROLLING.
...
.
  run ref/gds-refa.p ( input  p-open-query                         ,input  p-find-next                         ,input  p-find-condition                                                  ,input a-n-c                         ,input NameContext                         ,input rs-sort                         ,input g-cond                          ,input g-list                          ,input g-stat                          ,input g-grp                           ,input p-obj-type                         ,input p-obj-code                         ,buffer g-producer                         ,buffer cur-obj                            ,output for-title                                                  ,input filter-point                          ,input filter-point0                         ,input sort-column-name                         ,output v-filter-name                         ,input-output g-rep                         ).
assign
