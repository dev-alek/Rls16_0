...
if v-num-entry15 > 0 then do:
  ...
  .
    ...
    if last-event:function <> "MOUSE-SELECT-DBLCLICK" then do:
        ...
        apply "VALUE-CHANGED" to br-esys-cli in frame Dialog-Frame.
    end.
  ...
  apply "entry" to br-esys-cli in frame Dialog-Frame.
END.
...
END.
ON ENTER OF fill-cli-vn IN FRAME Dialog-Frame
DO:
   find first ub.ext-classif no-lock  where
                                        ...
                                        and  ub.ext-classif.classif-subject = 'clients':U
                                        and  ub.ext-classif.classif-name = 'clients-esys':U no-error.
  ...
  return no-apply.
END.
ON ENTER OF fill-cli-th IN FRAME Dialog-Frame
DO:
  find first ub.ext-classif no-lock   where integer(ENTRY(3, ub.ext-classif.uniq-key-rec, chr(3))) = integer(fill-cli-th:screen-value)
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse br-esys-cli :handle
      .
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY br-esys-cli FOR EACH X_ext-classif NO-LOCK,        FIRST X_clients NO-LOCK INDEXED-REPOSITION.
END PROCEDURE.
PROCEDURE MyEnable :
ENABLE
b-quit
...
run gbl/flt-get.p
  ...
  then do:
    ...
    define variable  parameter-7-28 as character no-undo .
      ...
      parameter-4-28 =
        (
          if (" X_ext-classif.classif-subject = 'clients':U                       and X_ext-classif.classif-name = 'clients-esys':U                       AND X_ext-classif.db-num = 0" + " " + where-phrase-28) <> ""
          then  substitute('X_ext-classif.classif-subject = &1&2&1                       and X_ext-classif.classif-name = &1&3&1                       AND X_ext-classif.db-num = 0', chr(34), 'clients':U, 'clients-esys':U) + " " + where-phrase-28
          else "true"
        )
      parameter-5-28 = (" " + "" + " " + ", FIRST X_clients NO-LOCK WHERE                                   X_clients.obj-type = ENTRY(2, X_eXt-classif.uniq-key-rec, chr(3)) AND                                   X_clients.obj-code = integer(ENTRY(3, X_eXt-classif.uniq-key-rec, chr(3)))")
    ...
    :
      assign
        l-disable-where-28 =
          (" X_ext-classif.classif-subject = 'clients':U                       and X_ext-classif.classif-name = 'clients-esys':U                       AND X_ext-classif.db-num = 0" + " " + where-phrase-28 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-esys-cli:handle
  ...
  if l-filter-open-28 = false then do:
    OPEN QUERY br-esys-cli FOR EACH X_ext-classif
      where  X_ext-classif.classif-subject = 'clients':U                       and X_ext-classif.classif-name = 'clients-esys':U                       AND X_ext-classif.db-num = 0
...
run gbl/flt-get.p
  ...
  then do:
    ...
    define variable  parameter-7-30 as character no-undo .
      ...
      parameter-4-30 =
        (
          if (" X_ext-classif.classif-subject = 'clients':U                       and X_ext-classif.classif-name = 'clients-esys':U                       AND X_ext-classif.db-num = 0                       AND X_ext-classif.key#_one = p-esys-id" + " " + where-phrase-30) <> ""
          then  substitute('X_ext-classif.classif-subject = &1&2&1                       and X_ext-classif.classif-name = &1&3&1                       AND X_ext-classif.db-num = 0                       AND X_ext-classif.key#_one = &4', chr(34), 'clients':U, 'clients-esys':U, p-esys-id) + " " + where-phrase-30
          else "true"
        )
      parameter-5-30 = (" " + "" + " " + ", FIRST X_clients NO-LOCK WHERE                                   X_clients.obj-type = ENTRY(2, X_eXt-classif.uniq-key-rec, chr(3)) AND                                   X_clients.obj-code = integer(ENTRY(3, X_eXt-classif.uniq-key-rec, chr(3)))")
    ...
    :
      assign
        l-disable-where-30 =
          (" X_ext-classif.classif-subject = 'clients':U                       and X_ext-classif.classif-name = 'clients-esys':U                       AND X_ext-classif.db-num = 0                       AND X_ext-classif.key#_one = p-esys-id" + " " + where-phrase-30 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-esys-cli:handle
  ...
  if l-filter-open-30 = false then do:
    OPEN QUERY br-esys-cli FOR EACH X_ext-classif
      where  X_ext-classif.classif-subject = 'clients':U                       and X_ext-classif.classif-name = 'clients-esys':U                       AND X_ext-classif.db-num = 0                       AND X_ext-classif.key#_one = p-esys-id
    , FIRST X_clients NO-LOCK WHERE                                   X_clients.obj-type = ENTRY(2, X_eXt-classif.uniq-key-rec, chr(3)) AND                                   X_clients.obj-code = integer(ENTRY(3, X_eXt-classif.uniq-key-rec, chr(3)))
      INDEXED-REPOSITION
  .
      assign
...
APPLY "entry" TO br-esys-cli.
if available X_ext-classif then do:
    APPLY "VALUE-CHANGED":U to br-esys-cli.
END.
END PROCEDURE.
...
run ref/extclas1.p ( INPUT 'ДОБАВЛЕНИЕ':U
                    ...
                    ,INPUT-OUTPUT v-rid
                    ,INPUT 'clients':U
                    ,INPUT 'clients-esys':U
                    ,input 0
                    ,input buf_ext-system.esys-id
                    ,input 0
                    ,input 0
                    ,input v-value-character
                    ,input v-value-character3
                    ,input v-value-character2
                    ,input 0
...
output stream OutStr-html to value(v-file-name-rep-htm) append convert target 'UTF-8'.
for each  ub.ext-classif where     ub.ext-classif.classif-subject = 'clients':U
    and  ub.ext-classif.classif-name = 'clients-esys':U :
    i = i + 1.
    v-cli-obj-type = ENTRY(2, ub.eXt-classif.uniq-key-rec, chr(3)) no-error.
    v-cli-obj-code =   ENTRY(3, ub.ext-classif.uniq-key-rec, chr(3)) no-error.
