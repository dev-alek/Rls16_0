...
END PROCEDURE.
PROCEDURE enable_UI :
  OPEN QUERY Dialog-Frame FOR EACH ub.c-alc-supp-lic SHARE-LOCK.
  ...
  OPEN QUERY BR-docs FOR EACH buf_c-alc-supp-lic no-lock.
END PROCEDURE.
...
when "alc-supp-lic-code":U then do:     create temp-changes.     assign     temp-changes.f_name = "alc-supp-lic-code":U     temp-changes.l_name = "Код"     temp-changes.v_old = string(buf_c-alc-supp-lic.alc-supp-lic-code)     temp-changes.v_new = (if available new_c-alc-supp-lic                               then string(new_c-alc-supp-lic.alc-supp-lic-code)                               else string(current_alc-supp-lic.alc-supp-lic-code))     .   end.
when "create-user-db-num":U then do:     create temp-changes.     assign     temp-changes.f_name = "create-user-db-num":U     temp-changes.l_name = "БД"     temp-changes.v_old = string(buf_c-alc-supp-lic.create-user-db-num)     temp-changes.v_new = (if available new_c-alc-supp-lic                               then string(new_c-alc-supp-lic.create-user-db-num)                               else string(current_alc-supp-lic.create-user-db-num))     .   end.
END CASE.
end.
Open QUery br-changes for each temp-changes.
END PROCEDURE.
