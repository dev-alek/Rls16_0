...
CASE show-as :
  when ('орг':U + "-" + 'все':U + "-" + 'все':U + "-" + 'текущие':U) OR
  when ('чел':U + "-" + 'все':U + "-" + 'все':U + "-" + 'текущие':U) OR
  when ('скл':U + "-" + 'все':U + "-" + 'все':U + "-" + 'текущие':U) OR
  when ('маг':U + "-" + 'все':U + "-" + 'все':U + "-" + 'текущие':U) then do:
    CASE JoinType :
      when "Или" then do:
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-5 as character no-undo .
      ...
      parameter-4-5 =
        (
          if (" X_clients.stts = 0 and X_clients.obj-type = Cli-Types and (  ( SupGds = no and SupCons = no and BuyGds  = no and BuyCons = no and BuyServ = no and WLim-kr = no ) OR   ( if SupGds = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if SupCons = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if BuyGds = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if BuyCons = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if BuyServ = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if WLim-kr = yes AND X_clients.lim-kr <> 0 then yes else no ) ) " + " " + where-phrase-5) <> ""
          then  (substitute('X_clients.stts = 0 and X_clients.obj-type = &1&2&1 and ', chr(34), Cli-Types) + substitute('(  ( &1 = no and &2 = no and &3  = no and &4 = no and &5 = no and &6 = no ) OR   ( if &1 = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if &2 = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if &3 = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if &4 = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if &5 = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if &6 = yes AND X_clients.lim-kr <> 0 then yes else no ) )',  SupGds,  SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " " + where-phrase-5
          else "true"
        )
    ...
    :
      assign
        l-disable-where-5 =
          (" X_clients.stts = 0 and X_clients.obj-type = Cli-Types and (  ( SupGds = no and SupCons = no and BuyGds  = no and BuyCons = no and BuyServ = no and WLim-kr = no ) OR   ( if SupGds = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if SupCons = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if BuyGds = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if BuyCons = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if BuyServ = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if WLim-kr = yes AND X_clients.lim-kr <> 0 then yes else no ) ) " + " " + where-phrase-5 = "")
      .
  ...
  if l-filter-open-5 = false then do:
    OPEN QUERY CLi-ListB FOR EACH X_clients no-lock
      where  X_clients.stts = 0 and X_clients.obj-type = Cli-Types and (  ( SupGds = no and SupCons = no and BuyGds  = no and BuyCons = no and BuyServ = no and WLim-kr = no ) OR   ( if SupGds = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if SupCons = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if BuyGds = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if BuyCons = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if BuyServ = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if WLim-kr = yes AND X_clients.lim-kr <> 0 then yes else no ) )
  ...
  :
    if query cli-listB:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-5 =
        "where ":u +  (substitute('X_clients.stts = 0 and X_clients.obj-type = &1&2&1 and ', chr(34), Cli-Types) + substitute('(  ( &1 = no and &2 = no and &3  = no and &4 = no and &5 = no and &6 = no ) OR   ( if &1 = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if &2 = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if &3 = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if &4 = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if &5 = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if &6 = yes AND X_clients.lim-kr <> 0 then yes else no ) )',  SupGds,  SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " ":u + where-phrase-5 + " ":u + p-find-condition + " " + ""
      parameter-5-5 = "  "
    .
...
if p-open-query then do:
  ...
  when ('орг':U + "-" + 'все':U + "-" + 'все':U + "-" + 'все':U) OR
  when ('чел':U + "-" + 'все':U + "-" + 'все':U + "-" + 'все':U) OR
  when ('скл':U + "-" + 'все':U + "-" + 'все':U + "-" + 'все':U) OR
  when ('маг':U + "-" + 'все':U + "-" + 'все':U + "-" + 'все':U) then do:
    CASE JoinType :
      when "Или" then  do:
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-9 as character no-undo .
      ...
      parameter-4-9 =
        (
          if (" X_clients.obj-type = Cli-Types                             AND (  ( SupGds = no and SupCons = no and BuyGds  = no and BuyCons = no and BuyServ = no and WLim-kr = no ) OR   ( if SupGds = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if SupCons = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if BuyGds = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if BuyCons = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if BuyServ = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if WLim-kr = yes AND X_clients.lim-kr <> 0 then yes else no ) ) " + " " + where-phrase-9) <> ""
          then  (substitute('X_clients.obj-type = &1&2&1                             AND ', chr(34), Cli-Types) + substitute('(  ( &1 = no and &2 = no and &3  = no and &4 = no and &5 = no and &6 = no ) OR   ( if &1 = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if &2 = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if &3 = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if &4 = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if &5 = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if &6 = yes AND X_clients.lim-kr <> 0 then yes else no ) )',  SupGds,  SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " " + where-phrase-9
          else "true"
        )
    ...
    :
      assign
        l-disable-where-9 =
          (" X_clients.obj-type = Cli-Types                             AND (  ( SupGds = no and SupCons = no and BuyGds  = no and BuyCons = no and BuyServ = no and WLim-kr = no ) OR   ( if SupGds = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if SupCons = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if BuyGds = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if BuyCons = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if BuyServ = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if WLim-kr = yes AND X_clients.lim-kr <> 0 then yes else no ) ) " + " " + where-phrase-9 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-listB:handle
                          ,input parameter-3-9
  ...
  if l-filter-open-9 = false then do:
    OPEN QUERY CLi-ListB FOR EACH X_clients no-lock
      where  X_clients.obj-type = Cli-Types                             AND (  ( SupGds = no and SupCons = no and BuyGds  = no and BuyCons = no and BuyServ = no and WLim-kr = no ) OR   ( if SupGds = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if SupCons = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if BuyGds = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if BuyCons = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if BuyServ = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if WLim-kr = yes AND X_clients.lim-kr <> 0 then yes else no ) )
    , first x_temp-list-buyer NO-LOCK WHERE (v-list-b = NO OR (x_temp-list-buyer.obj-type =   X_clients.obj-type AND              x_temp-list-buyer.obj-code =   X_clients.obj-code))
       BY X_clients.obj-name
      indexed-reposition
  .
  ...
  :
    if query cli-listB:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-9 =
        "where ":u +  (substitute('X_clients.obj-type = &1&2&1                             AND ', chr(34), Cli-Types) + substitute('(  ( &1 = no and &2 = no and &3  = no and &4 = no and &5 = no and &6 = no ) OR   ( if &1 = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if &2 = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if &3 = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if &4 = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if &5 = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if &6 = yes AND X_clients.lim-kr <> 0 then yes else no ) )',  SupGds,  SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " ":u + where-phrase-9 + " ":u + p-find-condition + " " + ""
      parameter-5-9 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  when ('орг':U + "-" + 'все':U + "-" + 'все':U + "-" + 'удаленные':U) OR
  when ('чел':U + "-" + 'все':U + "-" + 'все':U + "-" + 'удаленные':U) OR
  when ('скл':U + "-" + 'все':U + "-" + 'все':U + "-" + 'удаленные':U) OR
  when ('маг':U + "-" + 'все':U + "-" + 'все':U + "-" + 'удаленные':U)   then do:
    CASE JoinType :
      when "Или" then  do:
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-13 as character no-undo .
      ...
      parameter-4-13 =
        (
          if (" X_clients.obj-type = Cli-Types                             AND X_clients.stts <> 0                             AND (  ( SupGds = no and SupCons = no and BuyGds  = no and BuyCons = no and BuyServ = no and WLim-kr = no ) OR   ( if SupGds = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if SupCons = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if BuyGds = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if BuyCons = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if BuyServ = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if WLim-kr = yes AND X_clients.lim-kr <> 0 then yes else no ) ) " + " " + where-phrase-13) <> ""
          then  (substitute('X_clients.obj-type = &1&2&1                             AND X_clients.stts <> 0                             AND ',  chr(34), Cli-Types) + substitute('(  ( &1 = no and &2 = no and &3  = no and &4 = no and &5 = no and &6 = no ) OR   ( if &1 = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if &2 = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if &3 = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if &4 = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if &5 = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if &6 = yes AND X_clients.lim-kr <> 0 then yes else no ) )',  SupGds,  SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " " + where-phrase-13
          else "true"
        )
    ...
    :
      assign
        l-disable-where-13 =
          (" X_clients.obj-type = Cli-Types                             AND X_clients.stts <> 0                             AND (  ( SupGds = no and SupCons = no and BuyGds  = no and BuyCons = no and BuyServ = no and WLim-kr = no ) OR   ( if SupGds = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if SupCons = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if BuyGds = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if BuyCons = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if BuyServ = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if WLim-kr = yes AND X_clients.lim-kr <> 0 then yes else no ) ) " + " " + where-phrase-13 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-listB:handle
  ...
  if l-filter-open-13 = false then do:
    OPEN QUERY CLi-ListB FOR EACH X_clients no-lock
      where  X_clients.obj-type = Cli-Types                             AND X_clients.stts <> 0                             AND (  ( SupGds = no and SupCons = no and BuyGds  = no and BuyCons = no and BuyServ = no and WLim-kr = no ) OR   ( if SupGds = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if SupCons = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if BuyGds = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if BuyCons = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if BuyServ = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if WLim-kr = yes AND X_clients.lim-kr <> 0 then yes else no ) )
    , first x_temp-list-buyer NO-LOCK WHERE (v-list-b = NO OR (x_temp-list-buyer.obj-type =   X_clients.obj-type AND              x_temp-list-buyer.obj-code =   X_clients.obj-code))
       BY X_clients.obj-name
      indexed-reposition
  .
  ...
  :
    if query cli-listB:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-13 =
        "where ":u +  (substitute('X_clients.obj-type = &1&2&1                             AND X_clients.stts <> 0                             AND ',  chr(34), Cli-Types) + substitute('(  ( &1 = no and &2 = no and &3  = no and &4 = no and &5 = no and &6 = no ) OR   ( if &1 = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if &2 = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if &3 = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if &4 = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if &5 = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if &6 = yes AND X_clients.lim-kr <> 0 then yes else no ) )',  SupGds,  SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " ":u + where-phrase-13 + " ":u + p-find-condition + " " + ""
      parameter-5-13 = "   "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  when ('орг':U + "-" + 'все':U + "-" + 'группа':U + "-" + 'текущие':U) OR
  when ('чел':U + "-" + 'все':U + "-" + 'группа':U + "-" + 'текущие':U) OR
  when ('скл':U + "-" + 'все':U + "-" + 'группа':U + "-" + 'текущие':U) OR
  when ('маг':U + "-" + 'все':U + "-" + 'группа':U + "-" + 'текущие':U) then do:
    CASE JoinType :
      when "Или" then  do:
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-17 as character no-undo .
      ...
      parameter-4-17 =
        (
          if (" X_clients.obj-type = Cli-Types                             AND X_clients.stts = 0                             AND X_clients.grp-name begins Curr-Grp-Name
                            AND (  ( SupGds = no and SupCons = no and BuyGds  = no and BuyCons = no and BuyServ = no and WLim-kr = no ) OR   ( if SupGds = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if SupCons = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if BuyGds = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if BuyCons = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if BuyServ = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if WLim-kr = yes AND X_clients.lim-kr <> 0 then yes else no ) ) " + " " + where-phrase-17) <> ""
          then  (substitute('X_clients.obj-type = &1&2&1                             AND X_clients.stts = 0                             AND X_clients.grp-name begins &1&3&1                             AND ',  chr(34), Cli-Types, Curr-Grp-Name) +  substitute('(  ( &1 = no and &2 = no and &3  = no and &4 = no and &5 = no and &6 = no ) OR   ( if &1 = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if &2 = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if &3 = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if &4 = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if &5 = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if &6 = yes AND X_clients.lim-kr <> 0 then yes else no ) )',  SupGds,  SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " " + where-phrase-17
          else "true"
        )
    ...
    :
      assign
        l-disable-where-17 =
          (" X_clients.obj-type = Cli-Types                             AND X_clients.stts = 0                             AND X_clients.grp-name begins Curr-Grp-Name
                            AND (  ( SupGds = no and SupCons = no and BuyGds  = no and BuyCons = no and BuyServ = no and WLim-kr = no ) OR   ( if SupGds = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if SupCons = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if BuyGds = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if BuyCons = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if BuyServ = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if WLim-kr = yes AND X_clients.lim-kr <> 0 then yes else no ) ) " + " " + where-phrase-17 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-listB:handle
  ...
  if l-filter-open-17 = false then do:
    OPEN QUERY CLi-ListB FOR EACH X_clients no-lock
      where  X_clients.obj-type = Cli-Types                             AND X_clients.stts = 0                             AND X_clients.grp-name begins Curr-Grp-Name
                            AND (  ( SupGds = no and SupCons = no and BuyGds  = no and BuyCons = no and BuyServ = no and WLim-kr = no ) OR   ( if SupGds = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if SupCons = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if BuyGds = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if BuyCons = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if BuyServ = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if WLim-kr = yes AND X_clients.lim-kr <> 0 then yes else no ) )
    , first x_temp-list-buyer NO-LOCK WHERE (v-list-b = NO OR (x_temp-list-buyer.obj-type =   X_clients.obj-type AND              x_temp-list-buyer.obj-code =   X_clients.obj-code))
       BY X_clients.obj-name
      indexed-reposition
  ...
  :
    if query cli-listB:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-17 =
        "where ":u +  (substitute('X_clients.obj-type = &1&2&1                             AND X_clients.stts = 0                             AND X_clients.grp-name begins &1&3&1                             AND ',  chr(34), Cli-Types, Curr-Grp-Name) +  substitute('(  ( &1 = no and &2 = no and &3  = no and &4 = no and &5 = no and &6 = no ) OR   ( if &1 = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if &2 = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if &3 = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if &4 = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if &5 = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if &6 = yes AND X_clients.lim-kr <> 0 then yes else no ) )',  SupGds,  SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " ":u + where-phrase-17 + " ":u + p-find-condition + " " + ""
      parameter-5-17 = "   "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-19 as character no-undo .
      ...
      parameter-4-19 =
        (
          if (" X_clients.obj-type = Cli-Types                             AND X_clients.stts = 0                             AND X_clients.grp-name begins Curr-Grp-Name" + " " + where-phrase-19) <> ""
          then  substitute('X_clients.obj-type = &1&2&1                             AND X_clients.stts = 0                             AND X_clients.grp-name begins &1&3&1',  chr(34), Cli-Types,  Curr-Grp-Name) + " " + where-phrase-19
          else "true"
        )
    ...
    :
      assign
        l-disable-where-19 =
          (" X_clients.obj-type = Cli-Types                             AND X_clients.stts = 0                             AND X_clients.grp-name begins Curr-Grp-Name" + " " + where-phrase-19 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-listB:handle
  ...
  :
    if query cli-listB:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-19 =
        "where ":u +  substitute('X_clients.obj-type = &1&2&1                             AND X_clients.stts = 0                             AND X_clients.grp-name begins &1&3&1',  chr(34), Cli-Types,  Curr-Grp-Name) + " ":u + where-phrase-19 + " ":u + p-find-condition + " " + ""
      parameter-5-19 = "   "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
  ...
  when ('орг':U + "-" + 'все':U + "-" + 'группа':U + "-" + 'все':U) OR
  when ('чел':U + "-" + 'все':U + "-" + 'группа':U + "-" + 'все':U) OR
  when ('скл':U + "-" + 'все':U + "-" + 'группа':U + "-" + 'все':U) OR
  when ('маг':U + "-" + 'все':U + "-" + 'группа':U + "-" + 'все':U) then do:
    CASE JoinType :
      when "Или" then do:
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-21 as character no-undo .
      ...
      parameter-4-21 =
        (
          if (" X_clients.obj-type = Cli-Types                             AND X_clients.grp-name begins Curr-Grp-Name
                            AND (  ( SupGds = no and SupCons = no and BuyGds  = no and BuyCons = no and BuyServ = no and WLim-kr = no ) OR   ( if SupGds = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if SupCons = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if BuyGds = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if BuyCons = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if BuyServ = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if WLim-kr = yes AND X_clients.lim-kr <> 0 then yes else no ) ) " + " " + where-phrase-21) <> ""
          then  (substitute('X_clients.obj-type = &1&2&1                             AND X_clients.grp-name begins &1&3&1                             AND ', chr(34), Cli-Types, Curr-Grp-Name) + substitute('(  ( &1 = no and &2 = no and &3  = no and &4 = no and &5 = no and &6 = no ) OR   ( if &1 = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if &2 = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if &3 = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if &4 = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if &5 = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if &6 = yes AND X_clients.lim-kr <> 0 then yes else no ) )',  SupGds,  SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " " + where-phrase-21
          else "true"
        )
    ...
    :
      assign
        l-disable-where-21 =
          (" X_clients.obj-type = Cli-Types                             AND X_clients.grp-name begins Curr-Grp-Name
                            AND (  ( SupGds = no and SupCons = no and BuyGds  = no and BuyCons = no and BuyServ = no and WLim-kr = no ) OR   ( if SupGds = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if SupCons = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if BuyGds = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if BuyCons = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if BuyServ = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if WLim-kr = yes AND X_clients.lim-kr <> 0 then yes else no ) ) " + " " + where-phrase-21 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-listB:handle
  ...
  if l-filter-open-21 = false then do:
    OPEN QUERY CLi-ListB FOR EACH X_clients no-lock
      where  X_clients.obj-type = Cli-Types                             AND X_clients.grp-name begins Curr-Grp-Name
                            AND (  ( SupGds = no and SupCons = no and BuyGds  = no and BuyCons = no and BuyServ = no and WLim-kr = no ) OR   ( if SupGds = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if SupCons = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if BuyGds = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if BuyCons = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if BuyServ = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if WLim-kr = yes AND X_clients.lim-kr <> 0 then yes else no ) )
    , first x_temp-list-buyer NO-LOCK WHERE (v-list-b = NO OR (x_temp-list-buyer.obj-type =   X_clients.obj-type AND              x_temp-list-buyer.obj-code =   X_clients.obj-code))
       BY X_clients.obj-name
      indexed-reposition
  ...
  :
    if query cli-listB:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-21 =
        "where ":u +  (substitute('X_clients.obj-type = &1&2&1                             AND X_clients.grp-name begins &1&3&1                             AND ', chr(34), Cli-Types, Curr-Grp-Name) + substitute('(  ( &1 = no and &2 = no and &3  = no and &4 = no and &5 = no and &6 = no ) OR   ( if &1 = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if &2 = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if &3 = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if &4 = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if &5 = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if &6 = yes AND X_clients.lim-kr <> 0 then yes else no ) )',  SupGds,  SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " ":u + where-phrase-21 + " ":u + p-find-condition + " " + ""
      parameter-5-21 = "   "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-23 as character no-undo .
      ...
      parameter-4-23 =
        (
          if (" X_clients.obj-type = Cli-Types                             AND X_clients.grp-name begins Curr-Grp-Name " + " " + where-phrase-23) <> ""
          then  substitute('X_clients.obj-type = &1&2&1                            AND X_clients.grp-name begins &1&3&1 ',  chr(34), Cli-Types , Curr-Grp-Name) + " " + where-phrase-23
          else "true"
        )
    ...
    :
      assign
        l-disable-where-23 =
          (" X_clients.obj-type = Cli-Types                             AND X_clients.grp-name begins Curr-Grp-Name " + " " + where-phrase-23 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-listB:handle
  ...
  :
    if query cli-listB:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-23 =
        "where ":u +  substitute('X_clients.obj-type = &1&2&1                            AND X_clients.grp-name begins &1&3&1 ',  chr(34), Cli-Types , Curr-Grp-Name) + " ":u + where-phrase-23 + " ":u + p-find-condition + " " + ""
      parameter-5-23 = "   "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
  ...
  when ('орг':U + "-" + 'все':U + "-" + 'группа':U + "-" + 'удаленные':U) OR
  when ('чел':U + "-" + 'все':U + "-" + 'группа':U + "-" + 'удаленные':U) OR
  when ('скл':U + "-" + 'все':U + "-" + 'группа':U + "-" + 'удаленные':U) OR
  when ('маг':U + "-" + 'все':U + "-" + 'группа':U + "-" + 'удаленные':U) then do:
    CASE JoinType :
      when "Или" then do:
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-25 as character no-undo .
      ...
      parameter-4-25 =
        (
          if (" X_clients.obj-type = Cli-Types                             AND X_clients.grp-name begins Curr-Grp-Name                             AND X_clients.stts <> 0                             AND (  ( SupGds = no and SupCons = no and BuyGds  = no and BuyCons = no and BuyServ = no and WLim-kr = no ) OR   ( if SupGds = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if SupCons = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if BuyGds = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if BuyCons = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if BuyServ = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if WLim-kr = yes AND X_clients.lim-kr <> 0 then yes else no ) ) " + " " + where-phrase-25) <> ""
          then  (substitute('X_clients.obj-type = &1&2&1                             AND X_clients.grp-name begins &1&3&1                             AND X_clients.stts <> 0                             AND ', chr(34), Cli-Types, Curr-Grp-Name) + substitute('(  ( &1 = no and &2 = no and &3  = no and &4 = no and &5 = no and &6 = no ) OR   ( if &1 = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if &2 = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if &3 = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if &4 = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if &5 = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if &6 = yes AND X_clients.lim-kr <> 0 then yes else no ) )',  SupGds,  SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " " + where-phrase-25
          else "true"
        )
    ...
    :
      assign
        l-disable-where-25 =
          (" X_clients.obj-type = Cli-Types                             AND X_clients.grp-name begins Curr-Grp-Name                             AND X_clients.stts <> 0                             AND (  ( SupGds = no and SupCons = no and BuyGds  = no and BuyCons = no and BuyServ = no and WLim-kr = no ) OR   ( if SupGds = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if SupCons = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if BuyGds = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if BuyCons = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if BuyServ = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if WLim-kr = yes AND X_clients.lim-kr <> 0 then yes else no ) ) " + " " + where-phrase-25 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-listB:handle
  ...
  if l-filter-open-25 = false then do:
    OPEN QUERY CLi-ListB FOR EACH X_clients no-lock
      where  X_clients.obj-type = Cli-Types                             AND X_clients.grp-name begins Curr-Grp-Name                             AND X_clients.stts <> 0                             AND (  ( SupGds = no and SupCons = no and BuyGds  = no and BuyCons = no and BuyServ = no and WLim-kr = no ) OR   ( if SupGds = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if SupCons = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if BuyGds = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if BuyCons = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if BuyServ = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if WLim-kr = yes AND X_clients.lim-kr <> 0 then yes else no ) )
    , first x_temp-list-buyer NO-LOCK WHERE (v-list-b = NO OR (x_temp-list-buyer.obj-type =   X_clients.obj-type AND              x_temp-list-buyer.obj-code =   X_clients.obj-code))
       BY X_clients.obj-name
      indexed-reposition
  .
  ...
  :
    if query cli-listB:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-25 =
        "where ":u +  (substitute('X_clients.obj-type = &1&2&1                             AND X_clients.grp-name begins &1&3&1                             AND X_clients.stts <> 0                             AND ', chr(34), Cli-Types, Curr-Grp-Name) + substitute('(  ( &1 = no and &2 = no and &3  = no and &4 = no and &5 = no and &6 = no ) OR   ( if &1 = yes AND X_clients.sup-gds = yes then yes else no ) OR     ( if &2 = yes AND X_clients.sup-cons = yes then yes else no ) OR   ( if &3 = yes AND X_clients.buy-gds = yes  then yes else no ) OR     ( if &4 = yes AND X_clients.buy-cons = yes then yes else no ) OR   ( if &5 = yes AND X_clients.buy-serv = yes then yes else no ) OR   ( if &6 = yes AND X_clients.lim-kr <> 0 then yes else no ) )',  SupGds,  SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " ":u + where-phrase-25 + " ":u + p-find-condition + " " + ""
      parameter-5-25 = "   "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-27 as character no-undo .
      ...
      parameter-4-27 =
        (
          if (" X_clients.obj-type = Cli-Types                             AND X_clients.grp-name begins Curr-Grp-Name                             AND X_clients.stts <> 0 " + " " + where-phrase-27) <> ""
          then  substitute('X_clients.obj-type = &1&2&1                             AND X_clients.grp-name begins &1&3&1                             AND X_clients.stts <> 0 ', chr(34), Cli-Types, Curr-Grp-Name) + " " + where-phrase-27
          else "true"
        )
    ...
    :
      assign
        l-disable-where-27 =
          (" X_clients.obj-type = Cli-Types                             AND X_clients.grp-name begins Curr-Grp-Name                             AND X_clients.stts <> 0 " + " " + where-phrase-27 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-listB:handle
  ...
  if l-filter-open-27 = false then do:
    OPEN QUERY CLi-ListB FOR EACH X_clients no-lock
      where  X_clients.obj-type = Cli-Types                             AND X_clients.grp-name begins Curr-Grp-Name                             AND X_clients.stts <> 0
    , first x_temp-list-buyer NO-LOCK WHERE (v-list-b = NO OR (x_temp-list-buyer.obj-type =   X_clients.obj-type AND              x_temp-list-buyer.obj-code =   X_clients.obj-code))
       BY X_clients.obj-name
      indexed-reposition
  .
  ...
  :
    if query cli-listB:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-27 =
        "where ":u +  substitute('X_clients.obj-type = &1&2&1                             AND X_clients.grp-name begins &1&3&1                             AND X_clients.stts <> 0 ', chr(34), Cli-Types, Curr-Grp-Name) + " ":u + where-phrase-27 + " ":u + p-find-condition + " " + ""
      parameter-5-27 = "   "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
