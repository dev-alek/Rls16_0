...
define variable vss-description as character no-undo initial "Справочник товаров - режим товары".
...
DEFINE NEW SHARED QUERY br-gds FOR goo-doc SCROLLING.
DEFINE BROWSE br-gds QUERY br-gds NO-LOCK DISPLAY
  ...
  (IF mphcol THEN "+":U ELSE "-":U) FORMAT "x(1)":U COLUMN-LABEL "Ф"
   ( if goo-doc.gds-type = 'т':U then "-" else "+" ) format "x(1)":U column-label "У"
...
ASSIGN FRAME d-goo-doc-ref :SCROLLABLE = FALSE.
ASSIGN br-gds :NUM-LOCKED-COLUMNS IN FRAME d-goo-doc-ref = 4 .
ASSIGN b-rest  :POPUP-MENU IN FRAME d-goo-doc-ref = MENU m-ostatki :HANDLE.
ASSIGN b-rest  :MENU-MOUSE = 1.
ASSIGN b-card  :POPUP-MENU IN FRAME d-goo-doc-ref = MENU m-oborot  :HANDLE.
ASSIGN b-card  :MENU-MOUSE = 1.
ASSIGN add-inf :POPUP-MENU IN FRAME d-goo-doc-ref = MENU m-dopinf  :HANDLE.
ASSIGN add-inf :MENU-MOUSE = 1.
ASSIGN b-price:POPUP-MENU IN FRAME d-goo-doc-ref = MENU m-price:HANDLE.
ASSIGN b-price:MENU-MOUSE = 1.
define variable vss-include-info24 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
DEF VAR cur-clmn-numbr-gds as INT EXTENT 16 no-undo.
...
ON ctrl-cursor-right OF BROWSE br-gds do:
  RUN re-move-clmnbr-gds ( 6, 16).
END.
ON ctrl-cursor-left OF BROWSE br-gds do:
  RUN re-move-clmnbr-gds (16, 6).
END.
PROCEDURE re-move-clmnbr-gds:
  ...
  END.
  if br-gds:MOVE-COLUMN(source-column, target-column) IN FRAME d-goo-doc-ref then.
...
on value-changed of a-n-c in frame d-goo-doc-ref do:
  run proc-valchg-a-n-c in this-procedure  no-error.
  return no-apply.
end.
on any-printable of br-gds in frame d-goo-doc-ref do:
  run proc-any-printable-br-gds in this-procedure   no-error.
  return no-apply.
end.
on backspace of br-gds in frame d-goo-doc-ref do:
  run proc-backspace-br-gds in this-procedure   no-error.
  return no-apply.
end.
ON return OF loc-code IN FRAME d-goo-doc-ref do:
  run proc-mouse-dbl-click-loc-code in this-procedure   no-error.
  return no-apply.
end.
ON return, Ctrl-J OF loc-name IN FRAME d-goo-doc-ref do:
  run proc-mouse-dbl-click-loc-name in this-procedure   no-error.
  return no-apply.
end.
ON return OF NameContext IN FRAME d-goo-doc-ref do:
  run proc-mouse-dbl-click-namec in this-procedure   no-error.
  return no-apply.
end.
PROCEDURE proc-valchg-a-n-c:
  case input frame d-goo-doc-ref a-n-c :
    when "art" then do:
      apply "entry" to br-gds in frame d-goo-doc-ref.
      hide loc-name loc-code
      in frame d-goo-doc-ref.
      loc-art = "".
        NameContext = "" .
        hide NameContext in frame d-goo-doc-ref.
    ...
    when "name" then do:
      enable loc-name with frame d-goo-doc-ref.
      disp loc-name with frame d-goo-doc-ref.
      ...
      apply "entry" to loc-name in frame d-goo-doc-ref.
    end.
    when "code"
 or when "DataMatrix" then
    do:
      enable loc-code with frame d-goo-doc-ref.
      disp loc-code with frame d-goo-doc-ref.
      ...
      apply "entry" to loc-code in frame d-goo-doc-ref.
    end.
    when "context" then do:
      assign a-n-c .
      enable NameContext with frame d-goo-doc-ref.
      disp NameContext with frame d-goo-doc-ref.
      apply "entry" to NameContext in frame d-goo-doc-ref.
      HIDE loc-art loc-name loc-code in frame d-goo-doc-ref.
    end .
  end CASE.
END PROCEDURE.
PROCEDURE proc-any-printable-br-gds :
  if input frame d-goo-doc-ref a-n-c = "art" then do:
...
find first l-goo-doc where true AND (if g-stat = 'все':U then true else (if g-stat = 'текущие':U then (l-goo-doc.stts = 0) else (l-goo-doc.stts = 1)))
                                  and l-goo-doc.artic begins (loc-art + last-event:label) no-lock no-error.
    end.
    when 'Производитель':U then do:
define variable vss-include-info29 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
find first l-goo-doc where l-goo-doc.prod-type = g-producer.obj-type                                and l-goo-doc.prod-code = g-producer.obj-code AND (if g-stat = 'все':U then true else (if g-stat = 'текущие':U then (l-goo-doc.stts = 0) else (l-goo-doc.stts = 1)))
                                  and l-goo-doc.artic begins (loc-art + last-event:label) no-lock no-error.
    end.
    when 'группа':U then do:
define variable vss-include-info30 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
find first l-goo-doc where l-goo-doc.grp-name begins g-grp AND (if g-stat = 'все':U then true else (if g-stat = 'текущие':U then (l-goo-doc.stts = 0) else (l-goo-doc.stts = 1)))
                                  and l-goo-doc.artic begins (loc-art + last-event:label) no-lock no-error.
    end.
  end.
    if available l-goo-doc then do:
      loc-art = loc-art + last-event:label.
      disp loc-art with frame d-goo-doc-ref.
      line-rec = recid (l-goo-doc).
      reposition br-gds to recid line-rec no-error.
      if error-status:error then do:     run ref/gdsrepos.p (input 1,                    input g-cond,                    input g-list,                    input g-stat,                    input flt-rec,                    output g#log,                    output contin).     if g#log then do:       run full-sch.       return error.     end.   end.   apply "VALUE-changed" to br-gds in frame d-goo-doc-ref.
    end.
  end.
END PROCEDURE.
...
find first l-goo-doc where true AND (if g-stat = 'все':U then true else (if g-stat = 'текущие':U then (l-goo-doc.stts = 0)else (l-goo-doc.stts = 1)))
                                  and l-goo-doc.artic begins loc-art no-lock no-error.
    end.
    when 'Производитель':U then do:
...
,buffer buf_place
     ...
     then
        loc-code:screen-value in frame d-goo-doc-ref = buf_prod-bc.b-str.
  end.
  else do:
...
,buffer buf_place
  ...
  buf_bar-code.gds-code No-LOCK.
        find first l-goo-doc where
                  l-goo-doc.artic = l-goods.artic AND
                  l-goo-doc.prod-type = l-goods.prod-type AND
                  l-goo-doc.prod-code = l-goods.prod-code no-lock no-error.
    if available l-goo-doc then do:
      line-rec = recid (l-goo-doc).
      reposition br-gds to recid line-rec no-error.
      if error-status:error then do:     run ref/gdsrepos.p (input 1,                    input g-cond,                    input g-list,                    input g-stat,                    input flt-rec,                    output g#log,                    output contin).     if g#log then do:       run full-sch.       return error.     end.   end.   apply "VALUE-changed" to br-gds in frame d-goo-doc-ref.
      if b-mark:sensitive then apply "choose" to b-mark in frame d-goo-doc-ref.
    end.
    else do:
...
define variable vss-include-info36 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
  if last-event:label = "Ctrl-J" or contin then do:
    find next l-goo-doc where true
                              and l-goo-doc.gds-name begins loc-name no-lock no-error.
    if avail(l-goo-doc) then contin = no.
  end.
  else do:
    find first l-goo-doc where true
                              and l-goo-doc.gds-name begins loc-name no-lock no-error.
        contin = no.
  end.
    end.
...
define variable vss-include-info37 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
  if last-event:label = "Ctrl-J" or contin then do:
    find next l-goo-doc where l-goo-doc.prod-type = g-producer.obj-type                                and l-goo-doc.prod-code = g-producer.obj-code
                              and l-goo-doc.gds-name begins loc-name no-lock no-error.
    if avail(l-goo-doc) then contin = no.
  end.
  else do:
    find first l-goo-doc where l-goo-doc.prod-type = g-producer.obj-type                                and l-goo-doc.prod-code = g-producer.obj-code
                              and l-goo-doc.gds-name begins loc-name no-lock no-error.
        contin = no.
  end.
    end.
...
define variable vss-include-info38 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
  if last-event:label = "Ctrl-J" or contin then do:
    find next l-goo-doc where l-goo-doc.grp-name begins g-grp
                              and l-goo-doc.gds-name begins loc-name no-lock no-error.
    if avail(l-goo-doc) then contin = no.
  end.
  else do:
    find first l-goo-doc where l-goo-doc.grp-name begins g-grp
                              and l-goo-doc.gds-name begins loc-name no-lock no-error.
        contin = no.
  end.
    end.
    ...
    if available l-goo-doc then do:
      line-rec = recid (l-goo-doc).
      reposition br-gds to recid line-rec no-error.
         if error-status:error then do:     run ref/gdsrepos.p (input 2,                    input g-cond,                    input g-list,                    input g-stat,                    input flt-rec,                    output g#log,                    output contin).     if not contin then do:       run full-sch.       return error.     end.     end.   apply "VALUE-changed" to br-gds in frame d-goo-doc-ref.
    end.
    else do:
      message "Строка не найдена."
              view-as alert-box error.
...
PROCEDURE proc-mouse-dbl-click-namec:
  ...
  with frame d-goo-doc-ref .
  run openbr in this-procedure ( input no, input yes ,input no, input '').
  apply "entry" to NameContext in frame d-goo-doc-ref.
END PROCEDURE.
on value-changed of br-gds in frame d-goo-doc-ref do:
if not available goo-doc or recid (goo-doc) <> line-rec then do:
    hide loc-art in frame d-goo-doc-ref.
    loc-art = "".
end.
    ...
    if vCh <> "" then do:
      ASSIGN
        FI-4:FORMAT in frame d-goo-doc-ref = "X(30)"
        FI-4:WIDTH-CHARS in frame d-goo-doc-ref = 30
        FI-6:FORMAT in frame d-goo-doc-ref = "X(30)"
        FI-6:WIDTH-CHARS in frame d-goo-doc-ref = 30
        FI-8:FORMAT in frame d-goo-doc-ref = "X(30)"
        FI-8:WIDTH-CHARS in frame d-goo-doc-ref = 30
      .
    end.
    else do:
     ASSIGN
        FI-4:FORMAT in frame d-goo-doc-ref = "X(49)"
        FI-4:WIDTH-CHARS in frame d-goo-doc-ref = 45
        FI-6:FORMAT in frame d-goo-doc-ref = "X(49)"
        FI-6:WIDTH-CHARS in frame d-goo-doc-ref = 45
        FI-8:FORMAT in frame d-goo-doc-ref = "X(49)"
        FI-8:WIDTH-CHARS in frame d-goo-doc-ref = 45
      .
    end.
...
ON ROW-DISPLAY OF br-gds  in frame d-goo-doc-ref do:
      run assort-polit in this-procedure (  input  goo-doc.gds-code ,
                                            input  p-obj-type           ,
                                            input  p-obj-code           ,
...
on choose of b-gdsreffi in frame d-goo-doc-ref do:
  run gds-ref-to-description in this-procedure .
end.
on value-changed of rs-list in frame d-goo-doc-ref do:
  run proc-rs-list in this-procedure no-error.
  if error-status :error then do: return no-apply. end.
end.
on value-changed of rs-cond in frame d-goo-doc-ref do:
  run proc-vc-rs-cond in this-procedure ( buffer goo-doc, buffer gob-doc ) no-error.
  if error-status :error then do: return no-apply. end.
end.
ON value-changed OF rs-stat in frame d-goo-doc-ref
DO:
  run proc-rs-stat in this-procedure no-error.
  if error-status :error then do: return no-apply. end.
END.
ON value-changed OF rs-sort in frame d-goo-doc-ref
DO:
  run proc-rs-sort in this-procedure no-error.
  if error-status :error then do: return no-apply. end.
END.
on end-error, stop of frame d-goo-doc-ref do:
  apply "choose":U to b-exit in frame d-goo-doc-ref.
  return no-apply.
end.
on endkey of frame d-goo-doc-ref do:
    run gbl/markqwa.p (
                            input b-mark :sensitive
                          , input rid-list          ) no-error.
  if error-status :error then do: return no-apply. end.
end.
on return, MOUSE-SELECT-DBLCLICK of br-gds in frame d-goo-doc-ref do:
...
on choose of b-exit in frame d-goo-doc-ref do:
  run gbl/markqwa.p (
                            input b-mark :sensitive
                          , input rid-list          ) no-error.
  if error-status :error then do: return no-apply. end.
...
on choose of b-sel in frame d-goo-doc-ref do:
  run proc-b-sel in this-procedure ( buffer goo-doc, buffer gob-doc ) no-error.
  if error-status :error then do: return no-apply. end.
end.
on choose of b-arch in frame d-goo-doc-ref do:
  if available goo-doc then do:
    run local-gds_inf in this-procedure.
  end.
end.
ON CHOOSE OF b-sch in frame d-goo-doc-ref
DO:
  run proc-b-sch in this-procedure no-error.
  if error-status :error then do: return no-apply. end.
END.
on choose of b-recip in frame d-goo-doc-ref do:
  run b-recip-proc in this-procedure ( buffer goo-doc, buffer gob-doc ) no-error.
  if error-status :error then do: return no-apply. end.
end.
on choose of b-rest in frame d-goo-doc-ref do:
...
on choose of b-card in frame d-goo-doc-ref do:
  run gbl/pop-up.p ( input self :handle, input no ) no-error.
  if error-status :error then do: return no-apply. end.
end.
...
on choose of b-chk in frame d-goo-doc-ref do:
  run b-chk-proc in this-procedure ( buffer goo-doc, buffer gob-doc ).
end.
on choose of b-sert in frame d-goo-doc-ref do:
  run proc-b-sert in this-procedure ( buffer goo-doc, buffer gob-doc ) no-error.
  if error-status :error then do: return no-apply. end.
end.
on choose of b-lkp in frame d-goo-doc-ref do:
  run proc-b-lkp in this-procedure ( buffer goo-doc, buffer gob-doc ) no-error.
  if error-status :error then do: return no-apply. end.
end.
on choose of b-prt in frame d-goo-doc-ref do:
  run proc-b-prt in this-procedure ( buffer goo-doc, buffer gob-doc ) no-error.
  if error-status :error then do: return no-apply. end.
end.
on choose of b-parts in frame d-goo-doc-ref do:
  run b-parts-proc in this-procedure ( buffer goo-doc, buffer gob-doc ) no-error.
  if error-status :error then do: return no-apply. end.
end.
define variable vss-include-info39 as character format "X(65)" no-undo initial "@(#)$Workfile$ $Revision$".
on INS of frame d-goo-doc-ref anywhere do:
  if b-mark :sensitive then DO: apply "CHOOSE":U to b-mark in frame d-goo-doc-ref. END.
  return no-apply.
end.
define variable vss-include-info40 as character format "X(65)" no-undo initial "@(#)$Workfile$ $Revision$".
on F3 of frame d-goo-doc-ref anywhere do:
  if b-lkp :sensitive then DO: apply "CHOOSE":U to b-lkp in frame d-goo-doc-ref. END.
  return no-apply.
end.
define variable vss-include-info41 as character format "X(65)" no-undo initial "@(#)$Workfile$ $Revision$".
on CTRL-N, CTRL-Т of frame d-goo-doc-ref anywhere do:
  if b-add :sensitive then DO: apply "CHOOSE":U to b-add in frame d-goo-doc-ref. END.
  return no-apply.
end.
define variable vss-include-info42 as character format "X(65)" no-undo initial "@(#)$Workfile$ $Revision$".
on F4 of frame d-goo-doc-ref anywhere do:
  if b-chg :sensitive then DO: apply "CHOOSE":U to b-chg in frame d-goo-doc-ref. END.
  return no-apply.
end.
define variable vss-include-info43 as character format "X(65)" no-undo initial "@(#)$Workfile$ $Revision$".
on F8 of frame d-goo-doc-ref anywhere do:
  if b-del :sensitive then DO: apply "CHOOSE":U to b-del in frame d-goo-doc-ref. END.
  return no-apply.
end.
define variable vss-include-info44 as character format "X(65)" no-undo initial "@(#)$Workfile$ $Revision$".
on F2 of frame d-goo-doc-ref anywhere do:
  if b-sel :sensitive then DO: apply "CHOOSE":U to b-sel in frame d-goo-doc-ref. END.
  return no-apply.
end.
on choose of b-mark in frame d-goo-doc-ref do:
    run b-mark-proc in this-procedure .
end.
on choose of b-alt-bc in frame d-goo-doc-ref
do:
  run b-alt-bc-proc in this-procedure ( buffer goo-doc, buffer gob-doc ) no-error.
  if error-status :error then do: return no-apply. end.
  apply "entry":U to br-gds in frame d-goo-doc-ref.
end.
on choose of b-copy in frame d-goo-doc-ref
do:
  run b-copy-proc in this-procedure ( buffer goo-doc, buffer gob-doc ) no-error.
  if error-status :error then do: return no-apply. end.
end.
on choose of b-add in frame d-goo-doc-ref
do:
  run proc-b-add in this-procedure ( buffer goo-doc, buffer gob-doc, input yes ) no-error.
  if error-status :error then do: return no-apply. end.
end.
on choose of b-add-office in frame d-goo-doc-ref
do:
  run proc-b-add in this-procedure ( buffer goo-doc, buffer gob-doc, input no ) no-error.
  if error-status :error then do: return no-apply. end.
end.
on choose of b-chg in frame d-goo-doc-ref
do:
  run proc-b-chg in this-procedure ( buffer goo-doc, buffer gob-doc ) no-error.
  if error-status :error then do: return no-apply. end.
end.
on choose of b-grp in frame d-goo-doc-ref do:
  run proc-b-grp in this-procedure ( buffer goo-doc, buffer gob-doc ) no-error.
  if error-status :error then do: return no-apply. end.
end.
on choose of b-del in frame d-goo-doc-ref do:
...
on choose of b-place in frame d-goo-doc-ref do:
  run b-place-proc in this-procedure no-error.
  if error-status :error then do: return no-apply. end.
  APPLY "ENTRY":U TO b-place IN FRAME d-goo-doc-ref.
end.
on choose of b-dinamo in frame d-goo-doc-ref do:
  run b-dinamo-proc in this-procedure no-error.
  if error-status :error then do: return no-apply. end.
  APPLY "ENTRY":U TO b-dinamo IN FRAME d-goo-doc-ref.
end.
on choose of b-hist in frame d-goo-doc-ref do:
  run b-hist-proc in this-procedure no-error.
  if error-status :error then do: return no-apply. end.
  APPLY "ENTRY":U TO b-hist IN FRAME d-goo-doc-ref.
end.
ON CHOOSE OF add-inf IN FRAME d-goo-doc-ref
DO:
...
on choose of b-obj in frame d-goo-doc-ref do:
  run proc-b-obj in this-procedure ( input "change":U ).
end.
on choose of b-extart in frame d-goo-doc-ref do:
  run proc-b-extart in this-procedure ( buffer goo-doc , buffer gob-doc ) no-error .
  if error-status :error then do :
    return no-apply.
  end.
end.
ON ANY-KEY OF loc-code IN FRAME d-goo-doc-ref
DO:
  if a-n-c = "DataMatrix" then
    if lastkey = 308 then
      return no-apply.
END.
ON MOUSE-SELECT-DBLCLICK OF g-image IN FRAME d-goo-doc-ref
DO:
...
END.
IF VALID-HANDLE(ACTIVE-WINDOW) AND FRAME d-goo-doc-ref:PARENT eq ?
THEN FRAME d-goo-doc-ref:PARENT = ACTIVE-WINDOW.
ON WINDOW-CLOSE OF FRAME d-goo-doc-ref APPLY "END-ERROR":U TO SELF.
define variable vss-include-info45 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
on help of frame d-goo-doc-ref
do:
  run gbl/app_help.p
...
on choose of b-help in frame d-goo-doc-ref
do:
  apply "help":u to frame d-goo-doc-ref .
end.
...
procedure minbtn-set :
    do
        ...
        do
            ...
            :
            assign
                v-frame-width = frame d-goo-doc-ref:width - 0.3
                fh            = frame d-goo-doc-ref:first-child
                hh            = fh:first-child
                ii            = 1
                .
...
define variable vss-include-info47 as character format "x(65)" no-undo initial "@(#)$Workfile$ Библиотека изменения размеров окна".
...
procedure diasize_change-height :
  ...
  if p-change-value > 0
  then do:
    if frame d-goo-doc-ref :height + p-change-value
        > decimal(session :work-area-height-pixels) / session :pixels-per-row
    then do:
      assign
        p-change-value = decimal(session :work-area-height-pixels) / session :pixels-per-row
                        - (frame d-goo-doc-ref :height-chars)
      .
      if p-change-value <= 0
      then do:
  ...
  if p-change-value < 0
  then do:
    if frame d-goo-doc-ref :height + p-change-value < v-diasize-orig-frame-height
    then do:
      assign
  ...
  :
    ...
    then do:
      ...
      :
        ...
        then do:
          ...
          assign
            frame d-goo-doc-ref :height = v-frame-height
          .
          if frame d-goo-doc-ref :scrollable = true
          then do:
            assign
              frame d-goo-doc-ref :virtual-height = v-frame-virtual-height
            .
          end.
          run diasize_position-resize-button in this-procedure .
        end.
    ...
    assign
      v-frame-height = frame d-goo-doc-ref :height
      v-frame-virtual-height = frame d-goo-doc-ref :virtual-height
    ...
    assign
      v-field-group-handle = frame d-goo-doc-ref :first-child
    .
    ...
    then do:
      ...
      then do:
        assign
          frame d-goo-doc-ref :virtual-height = frame d-goo-doc-ref :virtual-height + p-change-value
          no-error .
        if error-status :error
      ...
      assign
        frame d-goo-doc-ref :height = frame d-goo-doc-ref :height + p-change-value
        no-error .
      if error-status :error
      or error-status :get-message(1) <> ""
      then do:
    ...
    then do:
      ...
      then do:
        ...
        run gbl/wndsizew.p
          ...
          ,input  'height':u
          ,input  string(frame d-goo-doc-ref :height - v-diasize-orig-frame-height)
          ) .
      end.
    end.
  end.
...
procedure diasize_set-height :
  ...
  :
    run diasize_change-height in this-procedure
      (input  (p-new-height - frame d-goo-doc-ref :height)
      ,input  p-move-resize
      ) .
  end.
end procedure.
procedure diasize_change-width :
  ...
  if p-change-value > 0
  then do:
    if frame d-goo-doc-ref :width + p-change-value >
        session :width-chars
    then do:
      assign
        p-change-value = session :width-chars - frame d-goo-doc-ref :width
      .
      if p-change-value <= 0
      then do:
        run diasize_position-resize-button in this-procedure .
  ...
  if p-change-value < 0
  then do:
    if frame d-goo-doc-ref :width + p-change-value < v-diasize-orig-frame-width
    then do:
      assign
        p-change-value = v-diasize-orig-frame-width
                       - frame d-goo-doc-ref :width
      .
      if p-change-value >= 0
      then do:
        run diasize_position-resize-button in this-procedure .
  ...
  :
    ...
    then do:
      ...
      :
        ...
        then do:
          ...
          assign
            frame d-goo-doc-ref :width = v-frame-width
          .
          if frame d-goo-doc-ref :scrollable = true
          then do:
            assign
              frame d-goo-doc-ref :virtual-width = v-frame-virtual-width
            .
          end.
          run diasize_position-resize-button in this-procedure .
        end.
    ...
    assign
      v-frame-width = frame d-goo-doc-ref :width
      v-frame-virtual-width = frame d-goo-doc-ref :virtual-width
    ...
    then do:
      ...
      then do:
        assign
          frame d-goo-doc-ref :virtual-width = frame d-goo-doc-ref :virtual-width + p-change-value
          no-error .
        if error-status :error
        or error-status :get-message(1) <> ""
        then do:
      ...
      assign
        frame d-goo-doc-ref :width = v-frame-width + p-change-value
        no-error .
      if error-status :error
      or error-status :get-message(1) <> ""
      then do:
      ...
      assign
        frame d-goo-doc-ref :width = frame d-goo-doc-ref :width + p-change-value
      no-error .
      if error-status :error
      or error-status :get-message(1) <> ""
      then do:
    ...
    then do:
      ...
      then do:
        ...
        run gbl/wndsizew.p
          ...
          ,input  v-diasize-proc-name
          ,input  'width':u
          ,input  string(frame d-goo-doc-ref :width - v-diasize-orig-frame-width)
          ) .
      end.
    end.
  end.
...
procedure diasize_set-width :
  ...
  :
    run diasize_change-width in this-procedure
      (input  (p-new-width - frame d-goo-doc-ref :width)
      ,input  p-move-resize
      ) .
  end.
end procedure.
procedure diasize_position-resize-button :
  ...
  :
    hide v-diasize-resize-button .
    assign
      v-diasize-resize-button :row = frame d-goo-doc-ref :height - v-diasize-resize-button :height
                  - 1
                  - (frame d-goo-doc-ref :border-bottom-pixels / session :pixels-per-row)
      v-diasize-resize-button :col = frame d-goo-doc-ref :width - v-diasize-resize-button :width
                  - 1
                  - (frame d-goo-doc-ref :border-right-pixels / session :pixels-per-column)
    .
...
on alt-enter of frame d-goo-doc-ref
do:
...
procedure diasize_end-move :
  ...
  :
    ...
    .
    assign
      v-row-delta = v-new-row - frame d-goo-doc-ref :height
      v-col-delta = v-new-col - frame d-goo-doc-ref :width
    .
    run diasize_change-height in this-procedure
      (input v-row-delta
      ,input true
    ...
    then do:
      ...
      run diasize_change-width in this-procedure
        (input session :width-chars
            - frame d-goo-doc-ref :width-chars
        ,input true
        ) .
      assign
...
procedure diasize_restore-orig-size :
  ...
  :
    assign
      v-diasize-current-frame-width  = frame d-goo-doc-ref :width
      v-diasize-current-frame-height = frame d-goo-doc-ref :height
    .
...
procedure diasize_init :
  ...
  :
    ...
    :
      assign
        v-diasize-orig-frame-height = frame d-goo-doc-ref :height
        v-diasize-orig-frame-width  = frame d-goo-doc-ref :width
        v-diasize-browse-handle     = browse br-gds :handle
      .
      create button v-diasize-resize-button
      assign
        parent        = frame d-goo-doc-ref :first-child
        label         = "s"
        height-pixels = 16
        width-pixels  = 16
        visible       = true
...
on f5 of frame d-goo-doc-ref anywhere
do:
...
define input parameter p-filter-name as character no-undo .
  do with frame d-goo-doc-ref:
    if p-filter-name > "" then do:
      assign
        frame d-goo-doc-ref:title
          = frame d-goo-doc-ref:title + "   ФИЛЬТР: " + p-filter-name.
      .
      assign
...
define variable vss-include-info51 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
  ...
  WAIT-FOR GO OF FRAME d-goo-doc-ref FOCUS br-gds.
END.
assign
p-gds-name-width = gds-n:width in browse br-gds
p-grp-name-width = goo-doc.grp-name:width in browse br-gds
.
RUN disable_UI IN THIS-PROCEDURE.
PROCEDURE disable_UI :
  HIDE FRAME d-goo-doc-ref NO-PAUSE.
END PROCEDURE.
PROCEDURE openbr :
...
ASSIGN
FRAME d-goo-doc-ref rs-sort
.
assign
  filter-point = "goo-doc" + "_" + string( g-stat )
  filter-label = "Все_товары" + "_" + string( g-stat )
.
  run ref/gds-refo.p ( input  p-open-query                         ,input  p-find-next                         ,input  p-find-condition                                                  ,input a-n-c                         ,input NameContext                         ,input rs-sort                         ,input g-cond                          ,input g-list                          ,input g-stat                          ,input g-grp                           ,input p-obj-type                         ,input p-obj-code                         ,buffer g-producer                         ,buffer cur-obj                            ,output for-title                                                  ,input filter-point                          ,input filter-point0                         ,input sort-column-name                         ,output v-filter-name                         ,input-output g-rep                         ).
assign
frame d-goo-doc-ref :title = for-title
.
if g-list = "ptrl"
or g-list = "lgas"
or g-list = "ptrlsug"
...
apply "value-changed":U to br-gds in frame d-goo-doc-ref.
...
if a-n-c = "art" then do:
  ...
  hide loc-art loc-name loc-code NameContext in frame d-goo-doc-ref.
end.
CASE g-cond :
  when 'все':U then do:
    assign
...
PROCEDURE b-mark-proc:
    if not available goo-doc then do:   message     "Неправильно выбран товар."   view-as alert-box error.   return no-apply. end. assign   gds-rec = recid( goo-doc ) .
    ...
    assign
      g#log = br-gds :refresh( ) in frame d-goo-doc-ref
    .
    if num-entries( rid-list ) = 0 then do:
        hide
          mark-num in frame d-goo-doc-ref.
    end.
    else do:
        display
    ...
    if lookup( last-event :function, "MOUSE-SELECT-DBLCLICK,Return" ) = 0 then
        do:
            assign
              g#log = br-gds :select-next-row () in frame d-goo-doc-ref
            .
            apply "value-changed":U to br-gds in frame d-goo-doc-ref.
        end.
    apply "entry":U to br-gds in frame d-goo-doc-ref.
...
PROCEDURE b-del-proc:
  ...
  define buffer loc_gds-obj for ub.gds-obj.
    if not available loc-goo-doc then do:   message     "Неправильно выбран товар."   view-as alert-box error.   return no-apply. end. assign   gds-rec = recid( loc-goo-doc ) .
    assign
      g#log = FALSE
    .
...
PROCEDURE proc-m-ostatki-1:
  DEFINE PARAMETER BUFFER loc-goo-doc FOR ub.goods.
  DEFINE PARAMETER BUFFER loc-gob-doc FOR ub.gds-obj.
    if not available loc-goo-doc then do:   message     "Неправильно выбран товар."   view-as alert-box error.   return error. end. assign   gds-rec = recid( loc-goo-doc ) .
    FIND FIRST ub.gds-prt NO-LOCK WHERE
               ub.gds-prt.upper-code = loc-goo-doc.prt-root .
    run rep/gds-objs.w (
                     INPUT parparentproc,
...
PROCEDURE proc-rs-list:
  ...
  define variable ref-rec   as   recid   no-undo .
    assign
        i-rs-list = input frame d-goo-doc-ref rs-list
    .
    CASE i-rs-list :
        when 'Производитель':U then do:
          assign
    ...
    END CASE .
    assign
      g-list = input frame d-goo-doc-ref rs-list
      a-n-c :screen-value = "art"
    .
    apply "value-changed":U to a-n-c in frame d-goo-doc-ref .
    RUN enable_UI IN THIS-PROCEDURE.
END PROCEDURE.
FUNCTION Get-good RETURNS CHARACTER
    ...
    ,output loc#log
      ...
      WHEN "Msf":U then do:
        ...
        run ref/gds-msfs.w ( INPUT parparentproc
                            ,INPUT (if b-add:sensitive in frame d-goo-doc-ref then 'b-add' else '')
                            ,INPUT "uniq-key-rec"
                            ,INPUT 0
...
PROCEDURE b-copy-proc:
  ...
  DEFINE PARAMETER BUFFER loc-gob-doc FOR ub.gds-obj.
    ...
    CASE loc-goo-doc.gds-type:
      when 'т':U then do:
        apply "choose":U to b-add in frame d-goo-doc-ref.
      end.
      when  'у':U then do:
        apply "choose":U to b-add-office in frame d-goo-doc-ref.
      end.
    END CASE.
    assign
      copymode = no
...
PROCEDURE proc-vc-rs-cond:
  DEFINE PARAMETER BUFFER loc-goo-doc FOR ub.goods.
  DEFINE PARAMETER BUFFER loc-gob-doc FOR ub.gds-obj.
    if rs-cond :screen-value in frame d-goo-doc-ref = 'все':U
    ...
    DISPLAY
      a-n-c
    WITH FRAME d-goo-doc-ref .
    if input frame d-goo-doc-ref rs-cond = 'все':U or g-cond = 'все':U then do:
            assign
              g-cond = input frame d-goo-doc-ref rs-cond
            .
                ...
                .
            a-n-c = "".
            apply "go":U to frame d-goo-doc-ref.
            return error.
        end.
    assign
        g-cond = input frame d-goo-doc-ref rs-cond
        a-n-c :screen-value in frame d-goo-doc-ref = "art"
    .
    apply "value-changed":U to a-n-c in frame d-goo-doc-ref .
    RUN enable_UI IN THIS-PROCEDURE.
END PROCEDURE.
...
if session :set-wait-state( "compiler" ) then.
  ...
  hide mark-num in frame d-goo-doc-ref.
  RUN openbr IN THIS-PROCEDURE ( INPUT YES, input yes, input no, input '':U ).
END PROCEDURE.
...
if rs-sort :screen-value <> 'Артикул':U then do:
  ...
  if g#log = yes then do:
    ...
    assign
      rs-sort :screen-value in frame d-goo-doc-ref = 'Артикул':U
    .
  end.
end.
else do:
...
PROCEDURE proc-br-gds:
  if b-sel :sensitive in frame d-goo-doc-ref then do:
      apply "choose":U to b-sel in frame d-goo-doc-ref.
  end.
  else do:
    if b-lkp :sensitive then do:
      apply "choose":U to b-lkp in frame d-goo-doc-ref.
    end.
  end.
END PROCEDURE.
...
PROCEDURE proc-b-SErt:
  ...
  if not available loc-goo-doc then do:   message     "Неправильно выбран товар."   view-as alert-box error.   return no-apply. end. assign   gds-rec = recid( loc-goo-doc ) .
   run ref/gds-sert.w (   input parparentproc
                    , input p-obj-type
                    , input p-obj-code
                    , input ( if NOT b-add :sensitive in frame d-goo-doc-ref then 'ПРОСМОТР':U else 'ИЗМЕНЕНИЕ':U )
                    , input "gds"
                    , input loc-goo-doc.gds-code
                    , input ?
                    , input ?
...
assign
fi-1 :tooltip in frame d-goo-doc-ref = myto[1]
fi-2 :tooltip      = myto[2]
fi-3 :tooltip      = myto[3]
fi-4 :tooltip      = myto[4]
fi-5 :tooltip      = myto[5]
...
goo-doc.grp-name:resizable in browse br-gds = true
goo-doc.grp-name:width in browse br-gds = p-grp-name-width
v-indicator-life-gds:resizable in browse br-gds = true .
v-indicator-life-gds:width in browse br-gds = 8 .
.
RUN enable_UI IN THIS-PROCEDURE.
RUN buttons   IN THIS-PROCEDURE.
g#log = ( if rs-cond :screen-value in frame d-goo-doc-ref = 'все':U
          and dbtype("ub") = 'PROGRESS'
...
define output parameter p-recid as recid no-undo .
  case p-direction :
    ...
    then do:
      get prev br-gds.
      if not available goo-doc then do:
        message
