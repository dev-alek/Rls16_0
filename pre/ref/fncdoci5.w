...
run proc-color-widgets in this-procedure("F-curr-abbr,an-uchet-value,cel-nazn-value,cor-acc1-value,cor-acc-value,doc-date," +                       "including,naznach-plat,payer-name,prn-doc-code,receiver-name,receiver-okpo,payer-sign1,receiver-sign1," +                       "str-podr-code,str-podr-name,str-podr-type,sum-doc", no, yes, ?, grey_color).
