...
DEF VAR cur-clmn-numbr-thbj-attr as INT EXTENT 9 no-undo.
...
def var old-session as logical no-undo.
   ...
   IF old-session = YES THEN SESSION:IMMEDIATE-DISPLAY = NO.
       IF  p-mode = 'все':U  THEN DO:
   DO jjbr-thbj-attr = NUM-ENTRIES('1,2,3,4,5,6,7,8,9') TO 1 BY -1:
     RUN re-move-clmnbr-thbj-attr ( cur-clmn-numbr-thbj-attr[INTEGER(ENTRY (jjbr-thbj-attr, '1,2,3,4,5,6,7,8,9'))] , 1).
   END.
       END.
       IF  p-mode <> 'все':U  THEN DO:
   DO jjbr-thbj-attr = NUM-ENTRIES('1,2,3,5,6,7,8,4,9') TO 1 BY -1:
     RUN re-move-clmnbr-thbj-attr ( cur-clmn-numbr-thbj-attr[INTEGER(ENTRY (jjbr-thbj-attr, '1,2,3,5,6,7,8,4,9'))] , 1).
   END.
       END.
   SESSION:IMMEDIATE-DISPLAY = old-session.
END.
ON ctrl-cursor-right OF BROWSE br-thbj-attr do:
  RUN re-move-clmnbr-thbj-attr ( 1, 9).
END.
ON ctrl-cursor-left OF BROWSE br-thbj-attr do:
  RUN re-move-clmnbr-thbj-attr (9, 1).
END.
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-37 as character no-undo .
      ...
      parameter-4-37 =
        (
          if ("           X_c-thbj-attr.corr-user-db-num = p-db-num ANd            X_c-thbj-attr.obj-type  = p-obj-type AND            X_c-thbj-attr.obj-code  = p-obj-code AND            X_c-thbj-attr.upper-prop-code  = p-upper-prop-code AND            X_c-thbj-attr.prop-code  = p-prop-code  " + " " + where-phrase-37) <> ""
          then  substitute(' X_c-thbj-attr.corr-user-db-num = &1 ANd            X_c-thbj-attr.obj-type  = &2&3&2 AND  X_c-thbj-attr.obj-code  = &4 AND           X_c-thbj-attr.upper-prop-code  = &2&5&2 AND   X_c-thbj-attr.prop-code  = &2&6&2 '           , p-db-num, chr(34), p-obj-type, p-obj-code, p-upper-prop-code, p-prop-code)   + " " + where-phrase-37
          else "true"
        )
      parameter-5-37 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-37 =
          ("           X_c-thbj-attr.corr-user-db-num = p-db-num ANd            X_c-thbj-attr.obj-type  = p-obj-type AND            X_c-thbj-attr.obj-code  = p-obj-code AND            X_c-thbj-attr.upper-prop-code  = p-upper-prop-code AND            X_c-thbj-attr.prop-code  = p-prop-code  " + " " + where-phrase-37 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-thbj-attr:handle
  ...
  :
    if query br-thbj-attr:handle:get-buffer-handle(1) = (buffer X_c-thbj-attr:handle) then do:
      ...
      parameter-4-37 =
        "where ":u +  substitute(' X_c-thbj-attr.corr-user-db-num = &1 ANd            X_c-thbj-attr.obj-type  = &2&3&2 AND  X_c-thbj-attr.obj-code  = &4 AND           X_c-thbj-attr.upper-prop-code  = &2&5&2 AND   X_c-thbj-attr.prop-code  = &2&6&2 '           , p-db-num, chr(34), p-obj-type, p-obj-code, p-upper-prop-code, p-prop-code)   + " ":u + where-phrase-37 + " ":u + p-find-condition + " " + ""
      parameter-5-37 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-39 as character no-undo .
      ...
      parameter-4-39 =
        (
          if ("           X_c-thbj-attr.corr-user-db-num = p-db-num ANd            X_c-thbj-attr.obj-type  = p-obj-type AND            X_c-thbj-attr.obj-code  = p-obj-code AND            X_c-thbj-attr.upper-prop-code  = p-upper-prop-code AND            X_c-thbj-attr.prop-code  > '' " + " " + where-phrase-39) <> ""
          then  substitute(' X_c-thbj-attr.corr-user-db-num = &1 ANd            X_c-thbj-attr.obj-type  = &2&3&2 AND  X_c-thbj-attr.obj-code  = &4 AND           X_c-thbj-attr.upper-prop-code  = &2&5&2 AND   X_c-thbj-attr.prop-code  > &2&2 '           , p-db-num, chr(34), p-obj-type, p-obj-code, p-upper-prop-code, p-prop-code)   + " " + where-phrase-39
          else "true"
        )
      parameter-5-39 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-39 =
          ("           X_c-thbj-attr.corr-user-db-num = p-db-num ANd            X_c-thbj-attr.obj-type  = p-obj-type AND            X_c-thbj-attr.obj-code  = p-obj-code AND            X_c-thbj-attr.upper-prop-code  = p-upper-prop-code AND            X_c-thbj-attr.prop-code  > '' " + " " + where-phrase-39 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-thbj-attr:handle
  ...
  :
    if query br-thbj-attr:handle:get-buffer-handle(1) = (buffer X_c-thbj-attr:handle) then do:
      ...
      parameter-4-39 =
        "where ":u +  substitute(' X_c-thbj-attr.corr-user-db-num = &1 ANd            X_c-thbj-attr.obj-type  = &2&3&2 AND  X_c-thbj-attr.obj-code  = &4 AND           X_c-thbj-attr.upper-prop-code  = &2&5&2 AND   X_c-thbj-attr.prop-code  > &2&2 '           , p-db-num, chr(34), p-obj-type, p-obj-code, p-upper-prop-code, p-prop-code)   + " ":u + where-phrase-39 + " ":u + p-find-condition + " " + ""
      parameter-5-39 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
