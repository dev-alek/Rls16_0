...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-5 as character no-undo .
      ...
      parameter-4-5 =
        (
          if (" X_fin-doc.host-code  = p-curr-host-code                          AND X_fin-doc.fin-doc-type  = p-fin-doc-type                " + " " + where-phrase-5) <> ""
          then  substitute('X_fin-doc.host-code  = &1                          AND X_fin-doc.fin-doc-type  = &2 ', p-curr-host-code, p-fin-doc-type ) + " " + where-phrase-5
          else "true"
        )
      parameter-5-5 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-5 =
          (" X_fin-doc.host-code  = p-curr-host-code                          AND X_fin-doc.fin-doc-type  = p-fin-doc-type                " + " " + where-phrase-5 = "")
      .
  ...
  if l-filter-open-5 = false then do:
    OPEN QUERY br-fin-doc FOR EACH X_fin-doc
      where  X_fin-doc.host-code  = p-curr-host-code                          AND X_fin-doc.fin-doc-type  = p-fin-doc-type
       use-index itype
      indexed-reposition
  .
      assign
  ...
  :
    if query br-fin-doc:handle:get-buffer-handle(1) = (buffer X_fin-doc:handle) then do:
      ...
      parameter-4-5 =
        "where ":u +  substitute('X_fin-doc.host-code  = &1                          AND X_fin-doc.fin-doc-type  = &2 ', p-curr-host-code, p-fin-doc-type ) + " ":u + where-phrase-5 + " ":u + p-find-condition + " " + ""
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-7 as character no-undo .
      ...
      parameter-4-7 =
        (
          if (" X_fin-doc.host-code = p-curr-host-code               AND X_fin-doc.fin-doc-type  = p-fin-doc-type                AND X_fin-doc.cor-acc = p-cor-acc " + " " + where-phrase-7) <> ""
          then  substitute('X_fin-doc.host-code = &1               AND X_fin-doc.fin-doc-type  = &2&3&2                AND X_fin-doc.cor-acc = &4 ', p-curr-host-code, chr(34), p-fin-doc-type, p-cor-acc) + " " + where-phrase-7
          else "true"
        )
      parameter-5-7 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-7 =
          (" X_fin-doc.host-code = p-curr-host-code               AND X_fin-doc.fin-doc-type  = p-fin-doc-type                AND X_fin-doc.cor-acc = p-cor-acc " + " " + where-phrase-7 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-fin-doc:handle
                          ,input parameter-3-7
  ...
  if l-filter-open-7 = false then do:
    OPEN QUERY br-fin-doc FOR EACH X_fin-doc
      where  X_fin-doc.host-code = p-curr-host-code               AND X_fin-doc.fin-doc-type  = p-fin-doc-type                AND X_fin-doc.cor-acc = p-cor-acc
       use-index itype
      indexed-reposition
  .
      assign
  ...
  :
    if query br-fin-doc:handle:get-buffer-handle(1) = (buffer X_fin-doc:handle) then do:
      ...
      parameter-4-7 =
        "where ":u +  substitute('X_fin-doc.host-code = &1               AND X_fin-doc.fin-doc-type  = &2&3&2                AND X_fin-doc.cor-acc = &4 ', p-curr-host-code, chr(34), p-fin-doc-type, p-cor-acc) + " ":u + where-phrase-7 + " ":u + p-find-condition + " " + ""
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-9 as character no-undo .
      ...
      parameter-4-9 =
        (
          if (" X_fin-doc.host-code = p-curr-host-code               AND X_fin-doc.fin-doc-type  = p-fin-doc-type                AND X_fin-doc.cor-acc1 = p-cor-acc1 " + " " + where-phrase-9) <> ""
          then  substitute('X_fin-doc.host-code = &1               AND X_fin-doc.fin-doc-type  = &2&3&2                AND X_fin-doc.cor-acc1 = &4 ', p-curr-host-code, chr(34), p-fin-doc-type, p-cor-acc1) + " " + where-phrase-9
          else "true"
        )
      parameter-5-9 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-9 =
          (" X_fin-doc.host-code = p-curr-host-code               AND X_fin-doc.fin-doc-type  = p-fin-doc-type                AND X_fin-doc.cor-acc1 = p-cor-acc1 " + " " + where-phrase-9 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-fin-doc:handle
                          ,input parameter-3-9
  ...
  if l-filter-open-9 = false then do:
    OPEN QUERY br-fin-doc FOR EACH X_fin-doc
      where  X_fin-doc.host-code = p-curr-host-code               AND X_fin-doc.fin-doc-type  = p-fin-doc-type                AND X_fin-doc.cor-acc1 = p-cor-acc1
       use-index itype
      indexed-reposition
  .
      assign
  ...
  :
    if query br-fin-doc:handle:get-buffer-handle(1) = (buffer X_fin-doc:handle) then do:
      ...
      parameter-4-9 =
        "where ":u +  substitute('X_fin-doc.host-code = &1               AND X_fin-doc.fin-doc-type  = &2&3&2                AND X_fin-doc.cor-acc1 = &4 ', p-curr-host-code, chr(34), p-fin-doc-type, p-cor-acc1) + " ":u + where-phrase-9 + " ":u + p-find-condition + " " + ""
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-11 as character no-undo .
      ...
      parameter-4-11 =
        (
          if (" X_fin-doc.host-code = p-curr-host-code               AND X_fin-doc.fin-doc-type  = p-fin-doc-type                AND X_fin-doc.an-uchet-code = p-an-uchet-code " + " " + where-phrase-11) <> ""
          then  substitute('X_fin-doc.host-code = &1               AND X_fin-doc.fin-doc-type  = &2&3&2                AND X_fin-doc.an-uchet-code = &4 ', p-curr-host-code, chr(34), p-fin-doc-type, p-an-uchet-code) + " " + where-phrase-11
          else "true"
        )
      parameter-5-11 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-11 =
          (" X_fin-doc.host-code = p-curr-host-code               AND X_fin-doc.fin-doc-type  = p-fin-doc-type                AND X_fin-doc.an-uchet-code = p-an-uchet-code " + " " + where-phrase-11 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-fin-doc:handle
  ...
  if l-filter-open-11 = false then do:
    OPEN QUERY br-fin-doc FOR EACH X_fin-doc
      where  X_fin-doc.host-code = p-curr-host-code               AND X_fin-doc.fin-doc-type  = p-fin-doc-type                AND X_fin-doc.an-uchet-code = p-an-uchet-code
       use-index itype
      indexed-reposition
  .
      assign
  ...
  :
    if query br-fin-doc:handle:get-buffer-handle(1) = (buffer X_fin-doc:handle) then do:
      ...
      parameter-4-11 =
        "where ":u +  substitute('X_fin-doc.host-code = &1               AND X_fin-doc.fin-doc-type  = &2&3&2                AND X_fin-doc.an-uchet-code = &4 ', p-curr-host-code, chr(34), p-fin-doc-type, p-an-uchet-code) + " ":u + where-phrase-11 + " ":u + p-find-condition + " " + ""
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-13 as character no-undo .
      ...
      parameter-4-13 =
        (
          if (" X_fin-doc.host-code = p-curr-host-code               AND X_fin-doc.fin-doc-type  = p-fin-doc-type                AND X_fin-doc.cel-nazn-code = p-cel-nazn-code " + " " + where-phrase-13) <> ""
          then  substitute('X_fin-doc.host-code = &1               AND X_fin-doc.fin-doc-type  = &2&3&2                AND X_fin-doc.cel-nazn-code = &4 ', p-curr-host-code, chr(34), p-fin-doc-type, p-cel-nazn-code) + " " + where-phrase-13
          else "true"
        )
      parameter-5-13 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-13 =
          (" X_fin-doc.host-code = p-curr-host-code               AND X_fin-doc.fin-doc-type  = p-fin-doc-type                AND X_fin-doc.cel-nazn-code = p-cel-nazn-code " + " " + where-phrase-13 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-fin-doc:handle
  ...
  if l-filter-open-13 = false then do:
    OPEN QUERY br-fin-doc FOR EACH X_fin-doc
      where  X_fin-doc.host-code = p-curr-host-code               AND X_fin-doc.fin-doc-type  = p-fin-doc-type                AND X_fin-doc.cel-nazn-code = p-cel-nazn-code
       use-index itype
      indexed-reposition
  .
      assign
  ...
  :
    if query br-fin-doc:handle:get-buffer-handle(1) = (buffer X_fin-doc:handle) then do:
      ...
      parameter-4-13 =
        "where ":u +  substitute('X_fin-doc.host-code = &1               AND X_fin-doc.fin-doc-type  = &2&3&2                AND X_fin-doc.cel-nazn-code = &4 ', p-curr-host-code, chr(34), p-fin-doc-type, p-cel-nazn-code) + " ":u + where-phrase-13 + " ":u + p-find-condition + " " + ""
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-15 as character no-undo .
      ...
      parameter-4-15 =
        (
          if (" X_fin-doc.host-code  = p-curr-host-code                          AND (X_fin-doc.fin-doc-type = 'пко':U or X_fin-doc.fin-doc-type = 'рко':U)               " + " " + where-phrase-15) <> ""
          then  substitute('X_fin-doc.host-code  = &1                          AND (X_fin-doc.fin-doc-type = &2&3&2 or X_fin-doc.fin-doc-type = &2&4&2)'                         , p-curr-host-code, chr(34), 'пко':U, 'рко':U) + " " + where-phrase-15
          else "true"
        )
      parameter-5-15 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-15 =
          (" X_fin-doc.host-code  = p-curr-host-code                          AND (X_fin-doc.fin-doc-type = 'пко':U or X_fin-doc.fin-doc-type = 'рко':U)               " + " " + where-phrase-15 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-fin-doc:handle
  ...
  if l-filter-open-15 = false then do:
    OPEN QUERY br-fin-doc FOR EACH X_fin-doc
      where  X_fin-doc.host-code  = p-curr-host-code                          AND (X_fin-doc.fin-doc-type = 'пко':U or X_fin-doc.fin-doc-type = 'рко':U)
       use-index itype
      indexed-reposition
  .
      assign
  ...
  :
    if query br-fin-doc:handle:get-buffer-handle(1) = (buffer X_fin-doc:handle) then do:
      ...
      parameter-4-15 =
        "where ":u +  substitute('X_fin-doc.host-code  = &1                          AND (X_fin-doc.fin-doc-type = &2&3&2 or X_fin-doc.fin-doc-type = &2&4&2)'                         , p-curr-host-code, chr(34), 'пко':U, 'рко':U) + " ":u + where-phrase-15 + " ":u + p-find-condition + " " + ""
      parameter-5-15 = " use-index itype "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query br-fin-doc:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-17 as character no-undo .
      ...
      parameter-4-17 =
        (
          if (" X_fin-doc.host-code = p-curr-host-code               AND (X_fin-doc.fin-doc-type = 'пко':U or X_fin-doc.fin-doc-type = 'рко':U)               AND X_fin-doc.cor-acc = p-cor-acc " + " " + where-phrase-17) <> ""
          then  substitute('X_fin-doc.host-code = &1                AND (X_fin-doc.fin-doc-type = &2&3&2 or X_fin-doc.fin-doc-type = &2&4&2)                AND X_fin-doc.cor-acc = &5 ', p-curr-host-code, chr(34), 'пко':U, 'рко':U, p-cor-acc) + " " + where-phrase-17
          else "true"
        )
      parameter-5-17 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-17 =
          (" X_fin-doc.host-code = p-curr-host-code               AND (X_fin-doc.fin-doc-type = 'пко':U or X_fin-doc.fin-doc-type = 'рко':U)               AND X_fin-doc.cor-acc = p-cor-acc " + " " + where-phrase-17 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-fin-doc:handle
  ...
  if l-filter-open-17 = false then do:
    OPEN QUERY br-fin-doc FOR EACH X_fin-doc
      where  X_fin-doc.host-code = p-curr-host-code               AND (X_fin-doc.fin-doc-type = 'пко':U or X_fin-doc.fin-doc-type = 'рко':U)               AND X_fin-doc.cor-acc = p-cor-acc
       use-index itype
      indexed-reposition
  .
      assign
  ...
  :
    if query br-fin-doc:handle:get-buffer-handle(1) = (buffer X_fin-doc:handle) then do:
      ...
      parameter-4-17 =
        "where ":u +  substitute('X_fin-doc.host-code = &1                AND (X_fin-doc.fin-doc-type = &2&3&2 or X_fin-doc.fin-doc-type = &2&4&2)                AND X_fin-doc.cor-acc = &5 ', p-curr-host-code, chr(34), 'пко':U, 'рко':U, p-cor-acc) + " ":u + where-phrase-17 + " ":u + p-find-condition + " " + ""
      parameter-5-17 = " use-index itype "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query br-fin-doc:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-19 as character no-undo .
      ...
      parameter-4-19 =
        (
          if (" X_fin-doc.host-code = p-curr-host-code               AND (X_fin-doc.fin-doc-type = 'пко':U or X_fin-doc.fin-doc-type = 'рко':U)               AND X_fin-doc.cor-acc1 = p-cor-acc1 " + " " + where-phrase-19) <> ""
          then  substitute('X_fin-doc.host-code = &1               AND (X_fin-doc.fin-doc-type = &2&3&2 or X_fin-doc.fin-doc-type = &2&4&2)               AND X_fin-doc.cor-acc1 = &5 ', p-curr-host-code, chr(34), 'пко':U, 'рко':U, p-cor-acc1) + " " + where-phrase-19
          else "true"
        )
      parameter-5-19 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-19 =
          (" X_fin-doc.host-code = p-curr-host-code               AND (X_fin-doc.fin-doc-type = 'пко':U or X_fin-doc.fin-doc-type = 'рко':U)               AND X_fin-doc.cor-acc1 = p-cor-acc1 " + " " + where-phrase-19 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-fin-doc:handle
  ...
  if l-filter-open-19 = false then do:
    OPEN QUERY br-fin-doc FOR EACH X_fin-doc
      where  X_fin-doc.host-code = p-curr-host-code               AND (X_fin-doc.fin-doc-type = 'пко':U or X_fin-doc.fin-doc-type = 'рко':U)               AND X_fin-doc.cor-acc1 = p-cor-acc1
       use-index itype
      indexed-reposition
  .
      assign
  ...
  :
    if query br-fin-doc:handle:get-buffer-handle(1) = (buffer X_fin-doc:handle) then do:
      ...
      parameter-4-19 =
        "where ":u +  substitute('X_fin-doc.host-code = &1               AND (X_fin-doc.fin-doc-type = &2&3&2 or X_fin-doc.fin-doc-type = &2&4&2)               AND X_fin-doc.cor-acc1 = &5 ', p-curr-host-code, chr(34), 'пко':U, 'рко':U, p-cor-acc1) + " ":u + where-phrase-19 + " ":u + p-find-condition + " " + ""
      parameter-5-19 = " use-index itype "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query br-fin-doc:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-21 as character no-undo .
      ...
      parameter-4-21 =
        (
          if (" X_fin-doc.host-code = p-curr-host-code               AND (X_fin-doc.fin-doc-type = 'пко':U or X_fin-doc.fin-doc-type = 'рко':U)               AND X_fin-doc.an-uchet-code = p-an-uchet-code " + " " + where-phrase-21) <> ""
          then  substitute('X_fin-doc.host-code = &1               AND (X_fin-doc.fin-doc-type = &2&3&2 or X_fin-doc.fin-doc-type = &2&4&2)               AND X_fin-doc.an-uchet-code = &5 ', p-curr-host-code, chr(34), 'пко':U, 'рко':U, p-an-uchet-code) + " " + where-phrase-21
          else "true"
        )
      parameter-5-21 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-21 =
          (" X_fin-doc.host-code = p-curr-host-code               AND (X_fin-doc.fin-doc-type = 'пко':U or X_fin-doc.fin-doc-type = 'рко':U)               AND X_fin-doc.an-uchet-code = p-an-uchet-code " + " " + where-phrase-21 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-fin-doc:handle
  ...
  if l-filter-open-21 = false then do:
    OPEN QUERY br-fin-doc FOR EACH X_fin-doc
      where  X_fin-doc.host-code = p-curr-host-code               AND (X_fin-doc.fin-doc-type = 'пко':U or X_fin-doc.fin-doc-type = 'рко':U)               AND X_fin-doc.an-uchet-code = p-an-uchet-code
       use-index itype
      indexed-reposition
  .
      assign
  ...
  :
    if query br-fin-doc:handle:get-buffer-handle(1) = (buffer X_fin-doc:handle) then do:
      ...
      parameter-4-21 =
        "where ":u +  substitute('X_fin-doc.host-code = &1               AND (X_fin-doc.fin-doc-type = &2&3&2 or X_fin-doc.fin-doc-type = &2&4&2)               AND X_fin-doc.an-uchet-code = &5 ', p-curr-host-code, chr(34), 'пко':U, 'рко':U, p-an-uchet-code) + " ":u + where-phrase-21 + " ":u + p-find-condition + " " + ""
      parameter-5-21 = " use-index itype "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query br-fin-doc:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-23 as character no-undo .
      ...
      parameter-4-23 =
        (
          if (" X_fin-doc.host-code = p-curr-host-code               AND (X_fin-doc.fin-doc-type = 'пко':U or X_fin-doc.fin-doc-type = 'рко':U)               AND X_fin-doc.cel-nazn-code = p-cel-nazn-code " + " " + where-phrase-23) <> ""
          then  substitute('X_fin-doc.host-code = &1               AND (X_fin-doc.fin-doc-type = &2&3&2 or X_fin-doc.fin-doc-type = &2&4&2)               AND X_fin-doc.cel-nazn-code = &5 ', p-curr-host-code, chr(34), 'пко':U, 'рко':U, p-cel-nazn-code) + " " + where-phrase-23
          else "true"
        )
      parameter-5-23 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-23 =
          (" X_fin-doc.host-code = p-curr-host-code               AND (X_fin-doc.fin-doc-type = 'пко':U or X_fin-doc.fin-doc-type = 'рко':U)               AND X_fin-doc.cel-nazn-code = p-cel-nazn-code " + " " + where-phrase-23 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-fin-doc:handle
  ...
  if l-filter-open-23 = false then do:
    OPEN QUERY br-fin-doc FOR EACH X_fin-doc
      where  X_fin-doc.host-code = p-curr-host-code               AND (X_fin-doc.fin-doc-type = 'пко':U or X_fin-doc.fin-doc-type = 'рко':U)               AND X_fin-doc.cel-nazn-code = p-cel-nazn-code
       use-index itype
      indexed-reposition
  .
      assign
  ...
  :
    if query br-fin-doc:handle:get-buffer-handle(1) = (buffer X_fin-doc:handle) then do:
      ...
      parameter-4-23 =
        "where ":u +  substitute('X_fin-doc.host-code = &1               AND (X_fin-doc.fin-doc-type = &2&3&2 or X_fin-doc.fin-doc-type = &2&4&2)               AND X_fin-doc.cel-nazn-code = &5 ', p-curr-host-code, chr(34), 'пко':U, 'рко':U, p-cel-nazn-code) + " ":u + where-phrase-23 + " ":u + p-find-condition + " " + ""
      parameter-5-23 = " use-index itype "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query br-fin-doc:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-25 as character no-undo .
      ...
      parameter-4-25 =
        (
          if (" X_fin-doc.host-code  = p-curr-host-code                          AND X_fin-doc.fin-doc-type  = p-fin-doc-type                          AND X_fin-doc.status_  = p-status_               " + " " + where-phrase-25) <> ""
          then  substitute('X_fin-doc.host-code  = &1                          AND X_fin-doc.fin-doc-type  = &2&3&2                          AND X_fin-doc.status_  = &4 ', p-curr-host-code, chr(34), p-fin-doc-type, p-status_)  + " " + where-phrase-25
          else "true"
        )
      parameter-5-25 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-25 =
          (" X_fin-doc.host-code  = p-curr-host-code                          AND X_fin-doc.fin-doc-type  = p-fin-doc-type                          AND X_fin-doc.status_  = p-status_               " + " " + where-phrase-25 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-fin-doc:handle
  ...
  if l-filter-open-25 = false then do:
    OPEN QUERY br-fin-doc FOR EACH X_fin-doc
      where  X_fin-doc.host-code  = p-curr-host-code                          AND X_fin-doc.fin-doc-type  = p-fin-doc-type                          AND X_fin-doc.status_  = p-status_
       use-index itype-stat
      indexed-reposition
  .
      assign
  ...
  :
    if query br-fin-doc:handle:get-buffer-handle(1) = (buffer X_fin-doc:handle) then do:
      ...
      parameter-4-25 =
        "where ":u +  substitute('X_fin-doc.host-code  = &1                          AND X_fin-doc.fin-doc-type  = &2&3&2                          AND X_fin-doc.status_  = &4 ', p-curr-host-code, chr(34), p-fin-doc-type, p-status_)  + " ":u + where-phrase-25 + " ":u + p-find-condition + " " + ""
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-27 as character no-undo .
      ...
      parameter-4-27 =
        (
          if (" X_fin-doc.host-code = p-curr-host-code               AND X_fin-doc.fin-doc-type  = p-fin-doc-type                AND X_fin-doc.status_  = p-status_               AND X_fin-doc.cor-acc = p-cor-acc " + " " + where-phrase-27) <> ""
          then  substitute('X_fin-doc.host-code = &1               AND X_fin-doc.fin-doc-type  = &2&3&2                AND X_fin-doc.status_  = &2&4&2               AND X_fin-doc.cor-acc = &5 ', p-curr-host-code, chr(34), p-fin-doc-type, p-status_, p-cor-acc) + " " + where-phrase-27
          else "true"
        )
      parameter-5-27 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-27 =
          (" X_fin-doc.host-code = p-curr-host-code               AND X_fin-doc.fin-doc-type  = p-fin-doc-type                AND X_fin-doc.status_  = p-status_               AND X_fin-doc.cor-acc = p-cor-acc " + " " + where-phrase-27 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-fin-doc:handle
  ...
  if l-filter-open-27 = false then do:
    OPEN QUERY br-fin-doc FOR EACH X_fin-doc
      where  X_fin-doc.host-code = p-curr-host-code               AND X_fin-doc.fin-doc-type  = p-fin-doc-type                AND X_fin-doc.status_  = p-status_               AND X_fin-doc.cor-acc = p-cor-acc
       use-index itype-stat
      indexed-reposition
  .
      assign
  ...
  :
    if query br-fin-doc:handle:get-buffer-handle(1) = (buffer X_fin-doc:handle) then do:
      ...
      parameter-4-27 =
        "where ":u +  substitute('X_fin-doc.host-code = &1               AND X_fin-doc.fin-doc-type  = &2&3&2                AND X_fin-doc.status_  = &2&4&2               AND X_fin-doc.cor-acc = &5 ', p-curr-host-code, chr(34), p-fin-doc-type, p-status_, p-cor-acc) + " ":u + where-phrase-27 + " ":u + p-find-condition + " " + ""
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-29 as character no-undo .
      ...
      parameter-4-29 =
        (
          if (" X_fin-doc.host-code = p-curr-host-code               AND X_fin-doc.fin-doc-type  = p-fin-doc-type                AND X_fin-doc.status_  = p-status_               AND X_fin-doc.cor-acc1 = p-cor-acc1 " + " " + where-phrase-29) <> ""
          then  substitute('X_fin-doc.host-code = &1               AND X_fin-doc.fin-doc-type  = &2&3&2                AND X_fin-doc.status_  = &2&4&2               AND X_fin-doc.cor-acc1 = &5 ', p-curr-host-code, chr(34), p-fin-doc-type, p-status_, p-cor-acc1) + " " + where-phrase-29
          else "true"
        )
      parameter-5-29 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-29 =
          (" X_fin-doc.host-code = p-curr-host-code               AND X_fin-doc.fin-doc-type  = p-fin-doc-type                AND X_fin-doc.status_  = p-status_               AND X_fin-doc.cor-acc1 = p-cor-acc1 " + " " + where-phrase-29 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-fin-doc:handle
  ...
  if l-filter-open-29 = false then do:
    OPEN QUERY br-fin-doc FOR EACH X_fin-doc
      where  X_fin-doc.host-code = p-curr-host-code               AND X_fin-doc.fin-doc-type  = p-fin-doc-type                AND X_fin-doc.status_  = p-status_               AND X_fin-doc.cor-acc1 = p-cor-acc1
       use-index itype-stat
      indexed-reposition
  .
      assign
  ...
  :
    if query br-fin-doc:handle:get-buffer-handle(1) = (buffer X_fin-doc:handle) then do:
      ...
      parameter-4-29 =
        "where ":u +  substitute('X_fin-doc.host-code = &1               AND X_fin-doc.fin-doc-type  = &2&3&2                AND X_fin-doc.status_  = &2&4&2               AND X_fin-doc.cor-acc1 = &5 ', p-curr-host-code, chr(34), p-fin-doc-type, p-status_, p-cor-acc1) + " ":u + where-phrase-29 + " ":u + p-find-condition + " " + ""
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-31 as character no-undo .
      ...
      parameter-4-31 =
        (
          if (" X_fin-doc.host-code = p-curr-host-code               AND X_fin-doc.fin-doc-type  = p-fin-doc-type                AND X_fin-doc.status_  = p-status_               AND X_fin-doc.an-uchet-code = p-an-uchet-code " + " " + where-phrase-31) <> ""
          then  substitute('X_fin-doc.host-code = &1               AND X_fin-doc.fin-doc-type  = &2&3&2                AND X_fin-doc.status_  = &2&4&2               AND X_fin-doc.an-uchet-code = &5 ', p-curr-host-code, chr(34), p-fin-doc-type, p-status_, p-an-uchet-code) + " " + where-phrase-31
          else "true"
        )
      parameter-5-31 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-31 =
          (" X_fin-doc.host-code = p-curr-host-code               AND X_fin-doc.fin-doc-type  = p-fin-doc-type                AND X_fin-doc.status_  = p-status_               AND X_fin-doc.an-uchet-code = p-an-uchet-code " + " " + where-phrase-31 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-fin-doc:handle
  ...
  if l-filter-open-31 = false then do:
    OPEN QUERY br-fin-doc FOR EACH X_fin-doc
      where  X_fin-doc.host-code = p-curr-host-code               AND X_fin-doc.fin-doc-type  = p-fin-doc-type                AND X_fin-doc.status_  = p-status_               AND X_fin-doc.an-uchet-code = p-an-uchet-code
       use-index itype-stat
      indexed-reposition
  .
      assign
  ...
  :
    if query br-fin-doc:handle:get-buffer-handle(1) = (buffer X_fin-doc:handle) then do:
      ...
      parameter-4-31 =
        "where ":u +  substitute('X_fin-doc.host-code = &1               AND X_fin-doc.fin-doc-type  = &2&3&2                AND X_fin-doc.status_  = &2&4&2               AND X_fin-doc.an-uchet-code = &5 ', p-curr-host-code, chr(34), p-fin-doc-type, p-status_, p-an-uchet-code) + " ":u + where-phrase-31 + " ":u + p-find-condition + " " + ""
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-33 as character no-undo .
      ...
      parameter-4-33 =
        (
          if (" X_fin-doc.host-code = p-curr-host-code               AND X_fin-doc.fin-doc-type  = p-fin-doc-type                AND X_fin-doc.status_  = p-status_               AND X_fin-doc.cel-nazn-code = p-cel-nazn-code " + " " + where-phrase-33) <> ""
          then  substitute('X_fin-doc.host-code = &1               AND X_fin-doc.fin-doc-type  = &2&3&2                AND X_fin-doc.status_  = &2&4&2               AND X_fin-doc.cel-nazn-code = &5 ', p-curr-host-code, p-fin-doc-type, p-status_, p-cel-nazn-code) + " " + where-phrase-33
          else "true"
        )
      parameter-5-33 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-33 =
          (" X_fin-doc.host-code = p-curr-host-code               AND X_fin-doc.fin-doc-type  = p-fin-doc-type                AND X_fin-doc.status_  = p-status_               AND X_fin-doc.cel-nazn-code = p-cel-nazn-code " + " " + where-phrase-33 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-fin-doc:handle
  ...
  if l-filter-open-33 = false then do:
    OPEN QUERY br-fin-doc FOR EACH X_fin-doc
      where  X_fin-doc.host-code = p-curr-host-code               AND X_fin-doc.fin-doc-type  = p-fin-doc-type                AND X_fin-doc.status_  = p-status_               AND X_fin-doc.cel-nazn-code = p-cel-nazn-code
       use-index itype-stat
      indexed-reposition
  .
      assign
  ...
  :
    if query br-fin-doc:handle:get-buffer-handle(1) = (buffer X_fin-doc:handle) then do:
      ...
      parameter-4-33 =
        "where ":u +  substitute('X_fin-doc.host-code = &1               AND X_fin-doc.fin-doc-type  = &2&3&2                AND X_fin-doc.status_  = &2&4&2               AND X_fin-doc.cel-nazn-code = &5 ', p-curr-host-code, p-fin-doc-type, p-status_, p-cel-nazn-code) + " ":u + where-phrase-33 + " ":u + p-find-condition + " " + ""
