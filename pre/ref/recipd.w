        ...
        then do:
            ...
            then do:
                ...
                then do:
                    ...
                    OPEN QUERY br-ingr-cost FOR EACH recipe-gds       WHERE recipe-gds.recipe-code = p-recipe-code NO-LOCK INDEXED-REPOSITION.
                end.
            end.
        end.
    end.
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse br-ingr-cost :handle
      .
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  :
    ...
    then do:
        ...
        .
        assign
            ed-recipe-quality :read-only in frame Dialog-Frame = yes
            ed-recipe-design  :read-only in frame Dialog-Frame = yes
        .
    end.
  end case.
