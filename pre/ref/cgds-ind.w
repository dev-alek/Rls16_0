...
PROCEDURE enable_UI :
  ...
  OPEN QUERY br-gdsind FOR EACH X_c-gds-hist NO-LOCK  INDEXED-REPOSITION.
END PROCEDURE.
PROCEDURE MyEnable :
ASSIGN
...
FOR EACH X_c-gds-hist NO-LOCK WHERE X_c-gds-hist.gds-code = p-gds-code
   AND (X_c-gds-hist.subject = 'gds-obj-prop':U
        OR
        X_c-gds-hist.subject = 'gds-obj-prop-attr':U
        )
...
.
        .
APPLY "VALUE-CHANGED" TO br-gdsind in frame Dialog-Frame.
