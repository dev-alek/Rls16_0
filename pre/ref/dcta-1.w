   ...
   DO v-ii = 1 TO 3:
     ...
     THEN do:
      ...
      END.
        ...
        buf_tt0-hist-nws-option.smart-nws-is-on = entry (lookup (string(buf_tt0-hist-nws-option.smart-nws), '0,-1,1,10,-10':U) + 1, ',' + 'Да,Нет,Смарт2,Всегда,Никогда':U)
        buf_tt0-hist-nws-option.get-hist-from-nws-is-on = (buf_tt0-hist-nws-option.get-hist-from-nws >= 0)
        buf_tt0-hist-nws-option.hist-to-nws-can = NOT ((buf_tt0-hist-nws-option.hist-to-nws = INTEGER('10':U)) OR
                                                  (buf_tt0-hist-nws-option.hist-to-nws = INTEGER('-10':U)))
        buf_tt0-hist-nws-option.nws-to-hist-can = NOT ((buf_tt0-hist-nws-option.nws-to-hist = INTEGER('10':U)) OR
                                                  (buf_tt0-hist-nws-option.nws-to-hist = INTEGER('-10':U)))
        buf_tt0-hist-nws-option.hist-from-prim-can = NOT ((buf_tt0-hist-nws-option.hist-from-prim = INTEGER('10':U)) OR
                                                                (buf_tt0-hist-nws-option.hist-from-prim = INTEGER('-10':U)))
        buf_tt0-hist-nws-option.nws-to-cd-can = NOT ((buf_tt0-hist-nws-option.nws-to-cd = INTEGER('10':U)) OR
                                                      (buf_tt0-hist-nws-option.nws-to-cd = INTEGER('-10':U)))
        buf_tt0-hist-nws-option.smart-nws-can = NOT ((buf_tt0-hist-nws-option.smart-nws = INTEGER('10':U)) OR
                                                          (buf_tt0-hist-nws-option.smart-nws = INTEGER('-10':U)))
        buf_tt0-hist-nws-option.get-hist-from-nws-can = NOT ((buf_tt0-hist-nws-option.get-hist-from-nws = INTEGER('10':U)) OR
                                                        (buf_tt0-hist-nws-option.get-hist-from-nws = INTEGER('-10':U)))
        .
                if buf_tt0-hist-nws-option.smart-nws = integer('-10':U) then do:
          buf_tt0-hist-nws-option.smart-nws-is-on = entry (lookup ('-1':U, '0,-1,1,10,-10':U) + 1, ',' + 'Да,Нет,Смарт2,Всегда,Никогда':U).
        end.
                if buf_tt0-hist-nws-option.smart-nws = integer('10':U) then do:
          buf_tt0-hist-nws-option.smart-nws-is-on = entry (lookup ('0':U, '0,-1,1,10,-10':U) + 1, ',' + 'Да,Нет,Смарт2,Всегда,Никогда':U).
        end.
    end.
    IF v-table-name > '':U and LOOKUP(v-table-name, v-done) > 0
    THEN do:
...
get-hn-label(tt0-hist-nws-option.hist-from-prim) FORMAT "X(15)" COLUMN-LABEL "Создание ист.!при изменении"
tt0-hist-nws-option.hist-from-prim-is-on COLUMN-LABEL "Вкл/!выкл" VIEW-AS TOGGLE-BOX
get-hn-label(tt0-hist-nws-option.hist-to-nws) FORMAT "X(15)" COLUMN-LABEL "Пересылка ист.!в другие БД"
tt0-hist-nws-option.hist-to-nws-is-on COLUMN-LABEL "Вкл/!выкл" VIEW-AS TOGGLE-BOX
get-hn-label(tt0-hist-nws-option.nws-to-hist) FORMAT "X(15)" COLUMN-LABEL "Создание ист.!при приеме!по СПН"
tt0-hist-nws-option.nws-to-hist-is-on COLUMN-LABEL "Вкл/!выкл" VIEW-AS TOGGLE-BOX
get-hn-label(tt0-hist-nws-option.get-hist-from-nws) FORMAT "X(15)" COLUMN-LABEL "Прием истории!из другой!УБД"
tt0-hist-nws-option.get-hist-from-nws-is-on COLUMN-LABEL "Вкл/!выкл" VIEW-AS TOGGLE-BOX
get-hn-label(tt0-hist-nws-option.smart-nws) FORMAT "X(15)" COLUMN-LABEL "Смарт-!передача!по СПН"
tt0-hist-nws-option.smart-nws-is-on COLUMN-LABEL "Вкл/!выкл" VIEW-AS COMBO-BOX
get-hn-label(tt0-hist-nws-option.nws-to-cd) FORMAT "X(15)" COLUMN-LABEL "Активация пер-чи!на кассы!из СПН"
...
DO:
   ...
   THEN DO:
    BELL.
    assign
    tt0-hist-nws-option.hist-to-nws-is-on = (IF tt0-hist-nws-option.hist-to-Nws = integer('10':U)
                                            THEN YES
                                            ELSE NO).
    display
    tt0-hist-nws-option.hist-to-nws-is-on
...
DO:
   ...
   THEN DO:
    BELL.
    assign
    tt0-hist-nws-option.nws-to-hist-is-on = (IF tt0-hist-nws-option.nws-to-hist = integer('10':U)
                                            THEN YES
                                            ELSE NO).
    display
    tt0-hist-nws-option.nws-to-hist-is-on
...
DO:
   ...
   THEN DO:
    BELL.
    assign
    tt0-hist-nws-option.get-hist-from-nws-is-on = (IF tt0-hist-nws-option.get-hist-from-nws = integer('10':U)
                                            THEN YES
                                            ELSE NO).
    DISPLAY
    tt0-hist-nws-option.get-hist-from-nws-is-on
...
DO:
   ...
   THEN DO:
    BELL.
    assign
    tt0-hist-nws-option.hist-from-prim-is-on = (IF tt0-hist-nws-option.hist-from-prim = integer('10':U)
                                            THEN YES
                                            ELSE NO).
    display
    tt0-hist-nws-option.hist-from-prim-is-on
...
DO:
   ...
   THEN DO:
    BELL.
    assign
    tt0-hist-nws-option.nws-to-cd-is-on = (IF tt0-hist-nws-option.nws-to-cd = integer('10':U)
                                            THEN YES
                                            ELSE NO).
    display
    tt0-hist-nws-option.nws-to-cd-is-on
...
DO:
   ...
   THEN DO:
    BELL.
    assign
    tt0-hist-nws-option.smart-nws-is-on = entry (lookup (string(tt0-hist-nws-option.smart-nws), '0,-1,1,10,-10':U) + 1, ',' + 'Да,Нет,Смарт2,Всегда,Никогда':U)
    .
    message
    tt0-hist-nws-option.smart-nws-is-on
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse BR-hn :handle
      .
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY BR-hn FOR EACH tt0-hist-nws-option NO-LOCK INDEXED-REPOSITION.
END PROCEDURE.
PROCEDURE fill-tt0 :
...
tt0-hist-nws-option.hist-to-nws-is-on:READ-ONLY in BROWSE br-hn = (p-mode = 'ПРОСМОТР':U)
tt0-hist-nws-option.nws-to-hist-is-on:READ-ONLY in BROWSE br-hn = (p-mode = 'ПРОСМОТР':U)
tt0-hist-nws-option.hist-from-prim-is-on:READ-ONLY in BROWSE br-hn = (p-mode = 'ПРОСМОТР':U)
tt0-hist-nws-option.get-hist-from-nws-is-on:READ-ONLY in BROWSE br-hn = (p-mode = 'ПРОСМОТР':U)
tt0-hist-nws-option.nws-to-cd-is-on:READ-ONLY in BROWSE br-hn = (p-mode = 'ПРОСМОТР':U)
tt0-hist-nws-option.smart-nws-is-on:READ-ONLY in BROWSE br-hn = (p-mode = 'ПРОСМОТР':U)
.
ENABLE
...
VIEW FRAME Dialog-Frame.
assign
tt0-hist-nws-option.smart-nws-is-on:LIST-ITEMs  = 'Да,Нет,Смарт2':U
tt0-hist-nws-option.smart-nws-is-on:INNER-LINES in BROWSE br-hn = 5
.
frame Dialog-Frame:title = substitute("&1: тип ДК &2, эмитент &3"
...
FUNCTION get-hn-value RETURNS integer
  ...
  RETURN integer(entry (lookup (p-hn-label, 'Да,Нет,Смарт2,Всегда,Никогда':U) + 1, ',' + '0,-1,1,10,-10':U)).
END FUNCTION.
FUNCTION get-prop-head-label RETURNS CHARACTER
...
IF NOT AVAILABLE buf_prop-head THEN  RETURN chr(63).
