...
assign
  v-str-recid10 = trim( string( recid( X_c-sr-izmerenia ) , "->>>>>>>>>>>9":U ) )
...
PROCEDURE sort-brbr-wp :
  ...
  case sort-labelbr-wp:
        when X_c-sr-izmerenia.sr-model:label in browse br-wp then DO:   assign     sort-column-name = "X_c-sr-izmerenia.sr-model"   .   run OpenBr.   . END.
        when X_c-sr-izmerenia.corr-date:label in browse br-wp then DO:   assign     sort-column-name = "X_c-sr-izmerenia.corr-date"   .   run OpenBr.   . END.
    otherwise do:
      assign
        sort-column-name = ""
      .
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
 ...
 if LOOKUP(p-mode, 'one':U, chr(4)) = 0 then dO:
    message
    vss-workfile vss-revision vss-description skip
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY br-wp FOR EACH X_c-sr-izmerenia NO-LOCK INDEXED-REPOSITION.
END PROCEDURE.
PROCEDURE MyEnable :
assign
...
v-label-param =   "node-code" + chr(4) + "Код средства измерения" + chr(4) + ""
 + chr(8) + "sr-model"  + chr(4) + "Модель" + chr(4) + ""
 + chr(8) + "sr-type-id"  + chr(4) + "Тип" + chr(4) + ""
 + chr(8) + "sr-temp-line"  + chr(4) + "Температурный коэффициент линейного расширения материала средства измерения уровня" + chr(4) + ""
 + chr(8) + "sr-abs-err-neft-water"  + chr(4) + "Абсолютная погрешность измерений уровня нефтепродукта и подтоварной воды" + chr(4) + ""
 + chr(8) + "sr-abs-err-water"  + chr(4) + "Абсолютная погрешность измерений уровня подтоварной воды" + chr(4) + ""
 + chr(8) + "sr-abs-err-dens"  + chr(4) + "Абсолютная погрешность измерений плотности нефтепродукта ареометром" + chr(4) + ""
 + chr(8) + "sr-abs-err-temp-vol"  + chr(4) + "Абсолютная погрешность измерений температуры нефтепродукта при измерении его объема" + chr(4) + ""
 + chr(8) + "sr-abs-err-temp-dens"  + chr(4) + "Абсолютная погрешность измерений температуры нефтепродукта при измерении его плотности" + chr(4) + ""
 + chr(8) + "sr-otnos"  + chr(4) + "Предел допускаемой относительной погрешности средства обработки результатов измерений" + chr(4) + ""
.
 run proc-full-temp-changes in this-procedure (
                                             input  buffer X_c-sr-izmerenia:handle
                                            ,input  'sr-izmerenia':U
                                            ,input  "node-code,sr-model,sr-type-id,sr-temp-line,sr-abs-err-neft-water,sr-abs-err-water,sr-abs-err-dens,sr-abs-err-temp-vol,sr-abs-err-temp-dens,sr-otnos"
                                            ,input  v-label-param).
