...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-17 as character no-undo .
      ...
      parameter-4-17 =
        (
          if (" X_clients.obj-name contains NameOrCode                             AND X_clients.obj-type = Cli-Types                             AND X_clients.grp-name begins Curr-Grp-Name                             AND X_clients.stts = 0                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         ) " + " " + where-phrase-17) <> ""
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-21 as character no-undo .
      ...
      parameter-4-21 =
        (
          if (" X_clients.obj-name contains NameOrCode                             AND X_clients.obj-type = Cli-Types                             AND X_clients.grp-name begins Curr-Grp-Name                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         ) " + " " + where-phrase-21) <> ""
          then  (substitute('X_clients.obj-name contains &1&2&1                             AND X_clients.obj-type = &1&3&1                             AND X_clients.grp-name begins &1&4&1                             AND ', chr(34), NameOrCode, Cli-Types, Curr-Grp-Name) +  substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " " + where-phrase-21
          else "true"
        )
      parameter-5-21 = (" " + "" + " " + "")
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-21 =
        "where ":u +  (substitute('X_clients.obj-name contains &1&2&1                             AND X_clients.obj-type = &1&3&1                             AND X_clients.grp-name begins &1&4&1                             AND ', chr(34), NameOrCode, Cli-Types, Curr-Grp-Name) +  substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " ":u + where-phrase-21 + " ":u + p-find-condition + " " + ""
      parameter-5-21 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
    ...
    define variable  parameter-7-23 as character no-undo .
      ...
      parameter-4-23 =
        (
          ...
          then  substitute('X_clients.obj-name contains &1&2&1                             AND X_clients.obj-type = &1&3&1                             AND X_clients.grp-name begins Curr-Grp-Name ', chr(34), NameOrCode, Cli-Types) + " " + where-phrase-23
          else "true"
        )
      parameter-5-23 = (" " + "" + " " + "")
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-23 =
        "where ":u +  substitute('X_clients.obj-name contains &1&2&1                             AND X_clients.obj-type = &1&3&1                             AND X_clients.grp-name begins Curr-Grp-Name ', chr(34), NameOrCode, Cli-Types) + " ":u + where-phrase-23 + " ":u + p-find-condition + " " + ""
      parameter-5-23 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
    ...
    define variable  parameter-7-25 as character no-undo .
      ...
      parameter-4-25 =
        (
          ...
          then  (substitute('X_clients.obj-name contains &1&2&1                             AND X_clients.obj-type = &1&3&1                             AND X_clients.grp-name begins &1&4&1                             AND X_clients.stts <> 0                             AND ', chr(34), NameOrCode, Cli-Types, Curr-Grp-Name) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " " + where-phrase-25
          else "true"
        )
      parameter-5-25 = (" " + "" + " " + "")
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-25 =
        "where ":u +  (substitute('X_clients.obj-name contains &1&2&1                             AND X_clients.obj-type = &1&3&1                             AND X_clients.grp-name begins &1&4&1                             AND X_clients.stts <> 0                             AND ', chr(34), NameOrCode, Cli-Types, Curr-Grp-Name) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " ":u + where-phrase-25 + " ":u + p-find-condition + " " + ""
      parameter-5-25 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
