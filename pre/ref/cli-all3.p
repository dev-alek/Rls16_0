...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-17 as character no-undo .
      ...
      parameter-4-17 =
        (
          if (" X_clients.grp-name begins Curr-Grp-Name                              AND X_clients.stts = 0                              AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         ) " + " " + where-phrase-17) <> ""
          then  (substitute('X_clients.grp-name begins &1&2&1                              AND X_clients.stts = 0                              AND ', chr(34), Curr-Grp-Name) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr)) + " " + where-phrase-17
          else "true"
        )
      parameter-5-17 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-17 =
          (" X_clients.grp-name begins Curr-Grp-Name                              AND X_clients.stts = 0                              AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         ) " + " " + where-phrase-17 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-list:handle
  ...
  if l-filter-open-17 = false then do:
    OPEN QUERY CLi-List FOR EACH X_clients no-lock
      where  X_clients.grp-name begins Curr-Grp-Name                              AND X_clients.stts = 0                              AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         )
       BY X_clients.obj-name
      indexed-reposition
  .
      assign
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-17 =
        "where ":u +  (substitute('X_clients.grp-name begins &1&2&1                              AND X_clients.stts = 0                              AND ', chr(34), Curr-Grp-Name) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr)) + " ":u + where-phrase-17 + " ":u + p-find-condition + " " + ""
      parameter-5-17 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-19 as character no-undo .
      ...
      parameter-4-19 =
        (
          if (" X_clients.grp-name begins Curr-Grp-Name                              AND X_clients.stts = 0  " + " " + where-phrase-19) <> ""
          then  substitute('X_clients.grp-name begins &1&2&1                              AND X_clients.stts = 0 ', chr(34), Curr-Grp-Name )  + " " + where-phrase-19
          else "true"
        )
      parameter-5-19 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-19 =
          (" X_clients.grp-name begins Curr-Grp-Name                              AND X_clients.stts = 0  " + " " + where-phrase-19 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-list:handle
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-19 =
        "where ":u +  substitute('X_clients.grp-name begins &1&2&1                              AND X_clients.stts = 0 ', chr(34), Curr-Grp-Name )  + " ":u + where-phrase-19 + " ":u + p-find-condition + " " + ""
      parameter-5-19 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-21 as character no-undo .
      ...
      parameter-4-21 =
        (
          if (" X_clients.grp-name begins Curr-Grp-Name                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         ) " + " " + where-phrase-21) <> ""
          then  (substitute('X_clients.grp-name begins &1&2&1                             AND ', chr(34), Curr-Grp-Name) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr)) + " " + where-phrase-21
          else "true"
        )
      parameter-5-21 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-21 =
          (" X_clients.grp-name begins Curr-Grp-Name                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         ) " + " " + where-phrase-21 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-list:handle
  ...
  if l-filter-open-21 = false then do:
    OPEN QUERY CLi-List FOR EACH X_clients no-lock
      where  X_clients.grp-name begins Curr-Grp-Name                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         )
       BY X_clients.obj-name
      indexed-reposition
  .
      assign
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-21 =
        "where ":u +  (substitute('X_clients.grp-name begins &1&2&1                             AND ', chr(34), Curr-Grp-Name) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr)) + " ":u + where-phrase-21 + " ":u + p-find-condition + " " + ""
      parameter-5-21 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-23 as character no-undo .
      ...
      parameter-4-23 =
        (
          if (" X_clients.grp-name begins Curr-Grp-Name " + " " + where-phrase-23) <> ""
          then  substitute('X_clients.grp-name begins &1&2&1', chr(34), Curr-Grp-Name)  + " " + where-phrase-23
          else "true"
        )
      parameter-5-23 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-23 =
          (" X_clients.grp-name begins Curr-Grp-Name " + " " + where-phrase-23 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-list:handle
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-23 =
        "where ":u +  substitute('X_clients.grp-name begins &1&2&1', chr(34), Curr-Grp-Name)  + " ":u + where-phrase-23 + " ":u + p-find-condition + " " + ""
      parameter-5-23 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
