...
:
  ...
  with frame TopFrame.
  Put Stream PrnLibStream unformatted
  "Держатель счета" chr(32) buf_fin-schet.cli-type buf_fin-schet.cli-code chr(32)
   buf_schet-clients.obj-name skip
  "Код банка" chr(32) buf_fin-schet.code-bank fill(chr(32), 5)
  buf_fin-bank.bank-name skip
  "БИК" chr(32) buf_fin-bank.bik  skip
  "Валюта счета" chr(32) buf_fin-schet.curr-code chr(32) buf_currency.curr-abbr skip
  "Расч. счет" chr(32) buf_fin-schet.r-schet fill(chr(32), 5)
  "Корр. счет" chr(32) buf_fin-schet.c-schet
  "Примечания" chr(32)   buf_fin-schet.PS
  skip.
