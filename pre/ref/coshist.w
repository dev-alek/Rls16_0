...
DEFINE BUFFER X_c-obj-hist FOR c-operserv.
DEFINE BUFFER find_c-obj-hist FOR c-operserv.
...
define input  parameter p-db-num like c-operserv.corr-user-db-num no-undo .
...
define input parameter p-next as logical no-undo.
define input parameter p-user like c-operserv.corr-user-name no-undo.
assign
sch-corr-date = ?.
display
0 @ sch-db-num
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-31 as character no-undo .
      ...
      parameter-4-31 =
        (
          if ("           X_c-obj-hist.id         = pid  " + " " + where-phrase-31) <> ""
          then  substitute('  X_c-obj-hist.id  = &1 ', pid)   + " " + where-phrase-31
          else "true"
        )
      parameter-5-31 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-31 =
          ("           X_c-obj-hist.id         = pid  " + " " + where-phrase-31 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-obj-hist:handle
  ...
  :
    if query br-obj-hist:handle:get-buffer-handle(1) = (buffer X_c-obj-hist:handle) then do:
      ...
      parameter-4-31 =
        "where ":u +  substitute('  X_c-obj-hist.id  = &1 ', pid)   + " ":u + where-phrase-31 + " ":u + p-find-condition + " " + ""
      parameter-5-31 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
define variable v-label-param as character no-undo .
  v-label-param =
   "OSname"          + chr(4) + "Наименование оператора"                + chr(4) + "" + chr(8)
 + "OsNameAbbr"      + chr(4) + "Аббр. оператора"                       + chr(4) + "" + chr(8)
 + "QuantMin"        + chr(4) + "Мин.кол.цифр"                          + chr(4) + "" + chr(8)
 + "QuantMax"        + chr(4) + "Макс.кол.цифр"                         + chr(4) + "" + chr(8)
 + "SummMin"         + chr(4) + "Мин.сумма"                             + chr(4) + "" + chr(8)
 + "SummMax"         + chr(4) + "Макс.сумма"                            + chr(4) + "" + chr(8)
 + "SummAtent"       + chr(4) + "Порог сумм.для предупр."               + chr(4) + "" + chr(8)
 + "CommType"        + chr(4) + "Тип ввода комиссии"                    + chr(4) + "" + chr(8)
 + "CommSumm"        + chr(4) + "Сумма комиссии"                        + chr(4) + "" + chr(8)
 + "CommPerc"        + chr(4) + "Процент комиссии"                      + chr(4) + "" + chr(8)
 + "PreAAvt"         + chr(4) + "Необх.автор."                          + chr(4) + "" + chr(8)
 + "PreSlip"         + chr(4) + "Необх. Печ. слипа"                     + chr(4) + "" + chr(8)
 + "SlipName"        + chr(4) + "Имя файла конеч.слипа"                 + chr(4) + "" + chr(8)
 + "CalcType"        + chr(4) + "Тип расчета с опер.пополн."            + chr(4) + "" + chr(8)
 + "ext-code"        + chr(4) + "ext-code"                              + chr(4) + "" + chr(8)
 + "OsType"          + chr(4) + "Тип"                                   + chr(4) + "" + chr(8)
 + "OperAddr"        + chr(4) + "Адрес оператора перевода"              + chr(4) + "" + chr(8)
 + "OperInn"         + chr(4) + "ИНН оператора перевода"                + chr(4) + "" + chr(8)
 + "OperName"        + chr(4) + "Наименование оператора перевода"       + chr(4) + "" + chr(8)
 + "AgentTel"        + chr(4) + "Телефон платежного агента"             + chr(4) + "" + chr(8)
 + "OperTel"         + chr(4) + "Телефон оператора по приему платежей"  + chr(4) + "" + chr(8)
 + "AgentFlagRasch"  + chr(4) + "Признак агента по предмету расчета"    + chr(4) + "" + chr(8)
 + "InnSupp"         + chr(4) + "ИНН поставщика"                        + chr(4) + "" + chr(8)
 + "OperTelTran"     + chr(4) + "Телефон оператора перевода"            + chr(4) + "" + chr(8)
 + "AgentOpere"      + chr(4) + "Операция платежного агента"            + chr(4) + "" + chr(8)
 + "SuppTel"         + chr(4) + "Телефон поставщика"                    + chr(4) + "" + chr(8)
 + "SuppName"        + chr(4) + "Наименование поставщика"               + chr(4) + "" + chr(8)
 + "Status_"         + chr(4) + "Статус"                                + chr(4) + "" + chr(8)
 + "AgentFlag"       + chr(4) + "Признак агента"                        + chr(4) + "" .
  run proc-full-temp-changes in this-procedure (
                                               input X_c-obj-hist.action = integer('1':U)
                                              ,input X_c-obj-hist.action = integer('99':U)
                                              ,input  buffer X_c-obj-hist:handle
                                              ,input  'OperServ':U
                                              ,input  "OSname,OsNameAbbr,QuantMin,QuantMax,SummMin,SummMax,SummAtent,CommType,CommSumm,CommPerc,PreAAvt,PreSlip,SlipName,CalcType,ext-code,OsType,OperAddr,OperInn,OperName,AgentTel,OperTel,AgentFlagRasch,InnSupp,OperTelTran,AgentOpere,SuppTel,SuppName,Status_,AgentFlag"
                                              ,input  v-label-param).
end.
end procedure.
