...
CASE show-as :
  when ('объект':U + "-" + 'название':U + "-" + 'все':U + "-" + 'текущие':U) then do:
    CASE JoinType :
      when "Или" then do:
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-7 as character no-undo .
      ...
      parameter-4-7 =
        (
          if (" X_clients.obj-name contains NameOrCode                             AND (X_clients.obj-type = 'маг':U                             or X_clients.obj-type = 'скл':U)                             AND X_clients.stts = 0 " + " " + where-phrase-7) <> ""
          then  substitute('X_clients.obj-name contains &1&2&1                             AND (X_clients.obj-type = &1&3&1                             or X_clients.obj-type = &1&4&1)                             AND X_clients.stts = 0 ', chr(34), NameOrCode, 'маг':U, 'скл':U) + " " + where-phrase-7
          else "true"
        )
      parameter-5-7 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-7 =
          (" X_clients.obj-name contains NameOrCode                             AND (X_clients.obj-type = 'маг':U                             or X_clients.obj-type = 'скл':U)                             AND X_clients.stts = 0 " + " " + where-phrase-7 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-list:handle
                          ,input parameter-3-7
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-7 =
        "where ":u +  substitute('X_clients.obj-name contains &1&2&1                             AND (X_clients.obj-type = &1&3&1                             or X_clients.obj-type = &1&4&1)                             AND X_clients.stts = 0 ', chr(34), NameOrCode, 'маг':U, 'скл':U) + " ":u + where-phrase-7 + " ":u + p-find-condition + " " + ""
      parameter-5-7 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
  ...
  when ('объект':U + "-" + 'название':U + "-" + 'все':U + "-" + 'все':U)  then do:
    CASE JoinType :
      when "Или" then do:
...
if p-open-query then do:
    ...
    define variable  parameter-7-9 as character no-undo .
      ...
      parameter-4-9 =
        (
          ...
          then  (substitute('X_clients.obj-name contains &1&2&1                             AND (X_clients.obj-type = &1&3&1                             or X_clients.obj-type = &1&4&1)                             AND ', chr(34), NameOrCode, 'маг':U, 'скл':U) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " " + where-phrase-9
          else "true"
        )
      parameter-5-9 = (" " + "" + " " + "")
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-9 =
        "where ":u +  (substitute('X_clients.obj-name contains &1&2&1                             AND (X_clients.obj-type = &1&3&1                             or X_clients.obj-type = &1&4&1)                             AND ', chr(34), NameOrCode, 'маг':U, 'скл':U) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " ":u + where-phrase-9 + " ":u + p-find-condition + " " + ""
      parameter-5-9 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-11 as character no-undo .
      ...
      parameter-4-11 =
        (
          if (" X_clients.obj-name contains NameOrCode                             AND (X_clients.obj-type = 'маг':U                             or X_clients.obj-type = 'скл':U) " + " " + where-phrase-11) <> ""
          then  substitute('X_clients.obj-name contains &1&2&1                             AND (X_clients.obj-type = &1&3&1                             or X_clients.obj-type = &1&4&1)', chr(34), NameOrCode, 'маг':U, 'скл':U)  + " " + where-phrase-11
          else "true"
        )
      parameter-5-11 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-11 =
          (" X_clients.obj-name contains NameOrCode                             AND (X_clients.obj-type = 'маг':U                             or X_clients.obj-type = 'скл':U) " + " " + where-phrase-11 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-list:handle
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-11 =
        "where ":u +  substitute('X_clients.obj-name contains &1&2&1                             AND (X_clients.obj-type = &1&3&1                             or X_clients.obj-type = &1&4&1)', chr(34), NameOrCode, 'маг':U, 'скл':U)  + " ":u + where-phrase-11 + " ":u + p-find-condition + " " + ""
      parameter-5-11 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
  ...
  when ('объект':U + "-" + 'название':U + "-" + 'все':U + "-" + 'удаленные':U)  then do:
    CASE JoinType :
      when "Или" then  do:
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-15 as character no-undo .
      ...
      parameter-4-15 =
        (
          if (" X_clients.obj-name contains NameOrCode                             AND (X_clients.obj-type = 'маг':U                             or X_clients.obj-type = 'скл':U)                             AND X_clients.stts <> 0 " + " " + where-phrase-15) <> ""
          then  substitute('X_clients.obj-name contains &1&2&1                             AND (X_clients.obj-type = &1&3&1                             or X_clients.obj-type = &1&4&1)                             AND X_clients.stts <> 0 ', chr(34), NameOrCode, 'маг':U, 'скл':U) + " " + where-phrase-15
          else "true"
        )
      parameter-5-15 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-15 =
          (" X_clients.obj-name contains NameOrCode                             AND (X_clients.obj-type = 'маг':U                             or X_clients.obj-type = 'скл':U)                             AND X_clients.stts <> 0 " + " " + where-phrase-15 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-list:handle
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-15 =
        "where ":u +  substitute('X_clients.obj-name contains &1&2&1                             AND (X_clients.obj-type = &1&3&1                             or X_clients.obj-type = &1&4&1)                             AND X_clients.stts <> 0 ', chr(34), NameOrCode, 'маг':U, 'скл':U) + " ":u + where-phrase-15 + " ":u + p-find-condition + " " + ""
      parameter-5-15 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
  ...
  when ('объект':U + "-" + 'название':U + "-" + 'группа':U + "-" + 'текущие':U)  then do:
    CASE JoinType :
      when "Или" then do:
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-17 as character no-undo .
      ...
      parameter-4-17 =
        (
          if (" X_clients.obj-name contains NameOrCode                             AND (X_clients.obj-type = 'маг':U                             or X_clients.obj-type = 'скл':U)                             AND X_clients.grp-name begins Curr-Grp-Name                             AND X_clients.stts = 0                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         ) " + " " + where-phrase-17) <> ""
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-19 as character no-undo .
      ...
      parameter-4-19 =
        (
          if (" X_clients.obj-name contains NameOrCode                             AND (X_clients.obj-type = 'маг':U                             or X_clients.obj-type = 'скл':U)                             AND X_clients.grp-name begins Curr-Grp-Name                             AND X_clients.stts = 0 " + " " + where-phrase-19) <> ""
          then " X_clients.obj-name contains NameOrCode                             AND (X_clients.obj-type = 'маг':U                             or X_clients.obj-type = 'скл':U)                             AND X_clients.grp-name begins Curr-Grp-Name                             AND X_clients.stts = 0 " + " " + where-phrase-19
          else "true"
        )
      parameter-5-19 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-19 =
          (" X_clients.obj-name contains NameOrCode                             AND (X_clients.obj-type = 'маг':U                             or X_clients.obj-type = 'скл':U)                             AND X_clients.grp-name begins Curr-Grp-Name                             AND X_clients.stts = 0 " + " " + where-phrase-19 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-list:handle
  ...
  if l-filter-open-19 = false then do:
    OPEN QUERY CLi-List FOR EACH X_clients no-lock
      where  X_clients.obj-name contains NameOrCode                             AND (X_clients.obj-type = 'маг':U                             or X_clients.obj-type = 'скл':U)                             AND X_clients.grp-name begins Curr-Grp-Name                             AND X_clients.stts = 0
       BY X_clients.obj-name
      indexed-reposition
  .
      assign
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-19 =
        "where ":u + " X_clients.obj-name contains NameOrCode                             AND (X_clients.obj-type = 'маг':U                             or X_clients.obj-type = 'скл':U)                             AND X_clients.grp-name begins Curr-Grp-Name                             AND X_clients.stts = 0 " + " ":u + where-phrase-19 + " ":u + p-find-condition + " " + ""
      parameter-5-19 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
  ...
  when ('объект':U + "-" + 'название':U + "-" + 'группа':U + "-" + 'все':U) then do:
    CASE JoinType :
      when "Или" then do:
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-21 as character no-undo .
      ...
      parameter-4-21 =
        (
          if (" X_clients.obj-name contains NameOrCode                             AND (X_clients.obj-type = 'маг':U                             or X_clients.obj-type = 'скл':U)                             AND X_clients.grp-name begins Curr-Grp-Name                             AND (   ( if SupGds = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if SupCons = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if BuyGds = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if BuyCons = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if BuyServ = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if WLim-kr = yes AND X_clients.lim-kr <> 0    then yes else no )         ) " + " " + where-phrase-21) <> ""
          then  (substitute('X_clients.obj-name contains &1&2&1                             AND (X_clients.obj-type = &1&3&1                             or X_clients.obj-type = &1&4&1)                             AND X_clients.grp-name begins &1&5&1                             AND ', chr(34), NameOrCode, 'маг':U, 'скл':U, Curr-Grp-Name) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr)) + " " + where-phrase-21
          else "true"
        )
      parameter-5-21 = (" " + "" + " " + "")
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-21 =
        "where ":u +  (substitute('X_clients.obj-name contains &1&2&1                             AND (X_clients.obj-type = &1&3&1                             or X_clients.obj-type = &1&4&1)                             AND X_clients.grp-name begins &1&5&1                             AND ', chr(34), NameOrCode, 'маг':U, 'скл':U, Curr-Grp-Name) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr)) + " ":u + where-phrase-21 + " ":u + p-find-condition + " " + ""
      parameter-5-21 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
    ...
    define variable  parameter-7-23 as character no-undo .
      ...
      parameter-4-23 =
        (
          ...
          then  substitute('X_clients.obj-name contains &1&2&1                             AND X_clients.obj-type = &1&3&1                             AND X_clients.grp-name begins &1&4&1 ', NameOrCode, Cli-Types, Curr-Grp-Name) + " " + where-phrase-23
          else "true"
        )
      parameter-5-23 = (" " + "" + " " + "")
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-23 =
        "where ":u +  substitute('X_clients.obj-name contains &1&2&1                             AND X_clients.obj-type = &1&3&1                             AND X_clients.grp-name begins &1&4&1 ', NameOrCode, Cli-Types, Curr-Grp-Name) + " ":u + where-phrase-23 + " ":u + p-find-condition + " " + ""
      parameter-5-23 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
  ...
  when ('объект':U + "-" + 'название':U + "-" + 'группа':U + "-" + 'удаленные':U) then do:
    CASE JoinType :
      when "Или" then do:
...
if p-open-query then do:
    ...
    define variable  parameter-7-25 as character no-undo .
      ...
      parameter-4-25 =
        (
          ...
          then  (substitute('X_clients.obj-name contains &1&2&1                             AND (X_clients.obj-type = &1&3&1                             or X_clients.obj-type = &1&4&1)                             AND X_clients.grp-name begins &1&5&1                             AND X_clients.stts <> 0                             AND ', chr(34), NameOrCode, 'маг':U, 'скл':U, Curr-Grp-Name) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " " + where-phrase-25
          else "true"
        )
      parameter-5-25 = (" " + "" + " " + "")
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-25 =
        "where ":u +  (substitute('X_clients.obj-name contains &1&2&1                             AND (X_clients.obj-type = &1&3&1                             or X_clients.obj-type = &1&4&1)                             AND X_clients.grp-name begins &1&5&1                             AND X_clients.stts <> 0                             AND ', chr(34), NameOrCode, 'маг':U, 'скл':U, Curr-Grp-Name) + substitute('(   ( if &1 = yes AND X_clients.sup-gds = yes     then yes else no ) OR      ( if &2 = yes AND X_clients.sup-cons = yes     then yes else no ) OR    ( if &3 = yes AND X_clients.buy-gds = yes     then yes else no ) OR      ( if &4 = yes AND X_clients.buy-cons = yes     then yes else no ) OR    ( if &5 = yes AND X_clients.buy-serv = yes     then yes else no ) OR    ( if &6 = yes AND X_clients.lim-kr <> 0    then yes else no )         )',  SupGds, SupCons, BuyGds, BuyCons, BuyServ, WLim-kr))  + " ":u + where-phrase-25 + " ":u + p-find-condition + " " + ""
      parameter-5-25 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-27 as character no-undo .
      ...
      parameter-4-27 =
        (
          if (" X_clients.obj-name contains NameOrCode                             AND (X_clients.obj-type = 'маг':U                             or X_clients.obj-type = 'скл':U)                             AND X_clients.grp-name begins Curr-Grp-Name                             AND X_clients.stts <> 0 " + " " + where-phrase-27) <> ""
          then  substitute('X_clients.obj-name contains &1&2&1                             AND (X_clients.obj-type = &1&3&1                            or X_clients.obj-type = &1&4&1)                             AND X_clients.grp-name begins &1&5&1                             AND X_clients.stts <> 0 ', NameOrCode, 'маг':U, 'скл':U, Curr-Grp-Name)  + " " + where-phrase-27
          else "true"
        )
      parameter-5-27 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-27 =
          (" X_clients.obj-name contains NameOrCode                             AND (X_clients.obj-type = 'маг':U                             or X_clients.obj-type = 'скл':U)                             AND X_clients.grp-name begins Curr-Grp-Name                             AND X_clients.stts <> 0 " + " " + where-phrase-27 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query cli-list:handle
  ...
  :
    if query cli-list:handle:get-buffer-handle(1) = (buffer X_clients:handle) then do:
      ...
      parameter-4-27 =
        "where ":u +  substitute('X_clients.obj-name contains &1&2&1                             AND (X_clients.obj-type = &1&3&1                            or X_clients.obj-type = &1&4&1)                             AND X_clients.grp-name begins &1&5&1                             AND X_clients.stts <> 0 ', NameOrCode, 'маг':U, 'скл':U, Curr-Grp-Name)  + " ":u + where-phrase-27 + " ":u + p-find-condition + " " + ""
      parameter-5-27 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
