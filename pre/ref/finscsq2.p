...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-5 as character no-undo .
      ...
      parameter-4-5 =
        (
          if (" X_fin-statement.host-code  = p-curr-host-code                      AND X_fin-statement.fins-doc-type  = p-fins-doc-type            " + " " + where-phrase-5) <> ""
          then  substitute('X_fin-statement.host-code  = &1                      AND X_fin-statement.fins-doc-type  = &2&3&2 ', p-curr-host-code, chr(34), p-fins-doc-type ) + " " + where-phrase-5
          else "true"
        )
      parameter-5-5 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-5 =
          (" X_fin-statement.host-code  = p-curr-host-code                      AND X_fin-statement.fins-doc-type  = p-fins-doc-type            " + " " + where-phrase-5 = "")
      .
  ...
  if l-filter-open-5 = false then do:
    OPEN QUERY br-fin-statement FOR EACH X_fin-statement
      where  X_fin-statement.host-code  = p-curr-host-code                      AND X_fin-statement.fins-doc-type  = p-fins-doc-type
       use-index itype
      indexed-reposition
  .
      assign
  ...
  :
    if QUERY br-fin-statement:handle:get-buffer-handle(1) = (buffer X_fin-statement:handle) then do:
      ...
      parameter-4-5 =
        "where ":u +  substitute('X_fin-statement.host-code  = &1                      AND X_fin-statement.fins-doc-type  = &2&3&2 ', p-curr-host-code, chr(34), p-fins-doc-type ) + " ":u + where-phrase-5 + " ":u + p-find-condition + " " + ""
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-7 as character no-undo .
      ...
      parameter-4-7 =
        (
          if (" X_fin-statement.host-code  = p-curr-host-code                        AND X_fin-statement.fins-doc-type  = p-fins-doc-type                        AND X_fin-statement.status_  = p-status_             " + " " + where-phrase-7) <> ""
          then  substitute('X_fin-statement.host-code  = &1                        AND X_fin-statement.fins-doc-type  = &2&3&2                        AND X_fin-statement.status_  = &2&4&2', p-curr-host-code, chr(34), p-fins-doc-type, p-status_ ) + " " + where-phrase-7
          else "true"
        )
      parameter-5-7 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-7 =
          (" X_fin-statement.host-code  = p-curr-host-code                        AND X_fin-statement.fins-doc-type  = p-fins-doc-type                        AND X_fin-statement.status_  = p-status_             " + " " + where-phrase-7 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-fin-statement:handle
                          ,input parameter-3-7
  ...
  if l-filter-open-7 = false then do:
    OPEN QUERY br-fin-statement FOR EACH X_fin-statement
      where  X_fin-statement.host-code  = p-curr-host-code                        AND X_fin-statement.fins-doc-type  = p-fins-doc-type                        AND X_fin-statement.status_  = p-status_
       use-index itype-stat
      indexed-reposition
  .
      assign
  ...
  :
    if QUERY br-fin-statement:handle:get-buffer-handle(1) = (buffer X_fin-statement:handle) then do:
      ...
      parameter-4-7 =
        "where ":u +  substitute('X_fin-statement.host-code  = &1                        AND X_fin-statement.fins-doc-type  = &2&3&2                        AND X_fin-statement.status_  = &2&4&2', p-curr-host-code, chr(34), p-fins-doc-type, p-status_ ) + " ":u + where-phrase-7 + " ":u + p-find-condition + " " + ""
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-9 as character no-undo .
      ...
      parameter-4-9 =
        (
          if (" X_fin-statement.host-code  = p-curr-host-code                      AND X_fin-statement.fins-doc-type  = p-fins-doc-type                      AND X_fin-statement.status_  = p-status_       AND (X_fin-statement.doc-date  >= p-start-date  AND       X_fin-statement.doc-date  <= p-end-date)            " + " " + where-phrase-9) <> ""
          then  substitute('X_fin-statement.host-code  = &1                      AND X_fin-statement.fins-doc-type  = &2&3&2                      AND X_fin-statement.status_  = &2&4&2       AND (X_fin-statement.doc-date  >= &5  AND       X_fin-statement.doc-date  <= &6) ', p-curr-host-code, chr(34), p-fins-doc-type, p-status_, p-start-date, p-end-date)  + " " + where-phrase-9
          else "true"
        )
      parameter-5-9 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-9 =
          (" X_fin-statement.host-code  = p-curr-host-code                      AND X_fin-statement.fins-doc-type  = p-fins-doc-type                      AND X_fin-statement.status_  = p-status_       AND (X_fin-statement.doc-date  >= p-start-date  AND       X_fin-statement.doc-date  <= p-end-date)            " + " " + where-phrase-9 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-fin-statement:handle
                          ,input parameter-3-9
  ...
  if l-filter-open-9 = false then do:
    OPEN QUERY br-fin-statement FOR EACH X_fin-statement
      where  X_fin-statement.host-code  = p-curr-host-code                      AND X_fin-statement.fins-doc-type  = p-fins-doc-type                      AND X_fin-statement.status_  = p-status_       AND (X_fin-statement.doc-date  >= p-start-date  AND       X_fin-statement.doc-date  <= p-end-date)
       use-index itype-stat
      indexed-reposition
  .
      assign
  ...
  :
    if QUERY br-fin-statement:handle:get-buffer-handle(1) = (buffer X_fin-statement:handle) then do:
      ...
      parameter-4-9 =
        "where ":u +  substitute('X_fin-statement.host-code  = &1                      AND X_fin-statement.fins-doc-type  = &2&3&2                      AND X_fin-statement.status_  = &2&4&2       AND (X_fin-statement.doc-date  >= &5  AND       X_fin-statement.doc-date  <= &6) ', p-curr-host-code, chr(34), p-fins-doc-type, p-status_, p-start-date, p-end-date)  + " ":u + where-phrase-9 + " ":u + p-find-condition + " " + ""
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-11 as character no-undo .
      ...
      parameter-4-11 =
        (
          if (" X_fin-statement.host-code  = p-curr-host-code                      AND X_fin-statement.fins-doc-type  = p-fins-doc-type        AND (X_fin-statement.doc-date  >= p-start-date  AND       X_fin-statement.doc-date  <= p-end-date)            " + " " + where-phrase-11) <> ""
          then  substitute('X_fin-statement.host-code  = &1                      AND X_fin-statement.fins-doc-type  = &2&3&2        AND (X_fin-statement.doc-date  >= &4  AND       X_fin-statement.doc-date  <= &5)', p-curr-host-code, chr(34), p-fins-doc-type, p-start-date, p-end-date) + " " + where-phrase-11
          else "true"
        )
      parameter-5-11 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-11 =
          (" X_fin-statement.host-code  = p-curr-host-code                      AND X_fin-statement.fins-doc-type  = p-fins-doc-type        AND (X_fin-statement.doc-date  >= p-start-date  AND       X_fin-statement.doc-date  <= p-end-date)            " + " " + where-phrase-11 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-fin-statement:handle
  ...
  if l-filter-open-11 = false then do:
    OPEN QUERY br-fin-statement FOR EACH X_fin-statement
      where  X_fin-statement.host-code  = p-curr-host-code                      AND X_fin-statement.fins-doc-type  = p-fins-doc-type        AND (X_fin-statement.doc-date  >= p-start-date  AND       X_fin-statement.doc-date  <= p-end-date)
       use-index itype
      indexed-reposition
  .
      assign
  ...
  :
    if QUERY br-fin-statement:handle:get-buffer-handle(1) = (buffer X_fin-statement:handle) then do:
      ...
      parameter-4-11 =
        "where ":u +  substitute('X_fin-statement.host-code  = &1                      AND X_fin-statement.fins-doc-type  = &2&3&2        AND (X_fin-statement.doc-date  >= &4  AND       X_fin-statement.doc-date  <= &5)', p-curr-host-code, chr(34), p-fins-doc-type, p-start-date, p-end-date) + " ":u + where-phrase-11 + " ":u + p-find-condition + " " + ""
