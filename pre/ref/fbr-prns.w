  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse BR-prn :handle
      .
...
do:
  BR-prn :SET-REPOSITIONED-ROW(5, "CONDITIONAL") .
end.
define variable vss-include-info8 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
on f5 of frame Dialog-Frame anywhere
do:
  v-doc-rec = recid(buf_fbr-prn). run openbr in this-procedure. reposition br-prn to recid(v-doc-rec). v-doc-rec = ? .
    apply "VALUE-CHANGED" to BR-prn.
end.
MAIN-BLOCK:
...
APPLY "ENTRY" to br-prn in frame Dialog-Frame.
END PROCEDURE.
FUNCTION get-object-name RETURNS CHARACTER
