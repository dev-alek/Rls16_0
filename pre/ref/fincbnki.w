...
END PROCEDURE.
PROCEDURE enable_UI :
  OPEN QUERY Dialog-Frame FOR EACH tt-c-fin-bank SHARE-LOCK.
...
END PROCEDURE.
PROCEDURE MyEnable :
tt-c-fin-bank.okonx:label in frame Dialog-Frame = "ОКОНХ".
tt-c-fin-bank.inn:label in frame Dialog-Frame = "ИНН".
tt-c-fin-bank.kpp:label in frame Dialog-Frame = "КПП".
