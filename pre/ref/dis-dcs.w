...
DEFINE BROWSE BR-dis-dc-rule
  QUERY BR-dis-dc-rule NO-LOCK DISPLAY
      mark-string(recid(X_dis-dc-rule), v-rid-list) COLUMN-LABEL '*' FORMAT "X(1)"
X_dis-dc-rule.d-card COLUMN-LABEL '№ карты'
X_dis-card.emitent-host-code COLUMN-LABEL 'Эмитент' format ">>>>9"
X_dis-card.type COLUMN-LABEL 'Тип'
(X_dis-card.cli-type + string(X_dis-card.cli-code)) COLUMN-LABEL 'Держатель' FORMAT "X(12)"
X_clients.obj-name COLUMN-LABEL 'Держатель' FORMAT "X(40)" WIDTH 20
X_dis-dc-rule.templ-rl-root COLUMN-LABEL 'Тип правила' FORMAT ">>>>>>>>9"
entry (lookup (X_dis-dc-rule.pos-type, 'IBM,IBM-XML,IPC-Servis+,OMRON-NEW,OMRON,NCR-GM,MAGIA-XML,NCR-AS@R,IBS-TH,IBS-TH-MOB,r-keeper,InfoKiosk,pricecheck-Servis+,Emulator-NKT-IBM,MARIA,-,bo,Autotank':U), 'IBM,IBM-XML,IPC-Servis+,OMRON-NEW,OMRON,NCR-GM,MAGIA-XML,NCR-AS@R,IBS-TH,IBS-TH-MOB,R-KEEPER,InfoKiosk,Прайс-чекер Servis+,Emulator-NKT-IBM,MARIA,Накладная,Бэкофис,Autotank':U) COLUMN-LABEL 'Место использ.' FORMAT "X(20)"
X_dis-dc-rule.obj-type COLUMN-LABEL 'Тип объ' FORMAT "X(3)"
X_dis-dc-rule.obj-code COLUMN-LABEL 'Код объ' FORMAT ">>>>>>>>9"
entry (lookup (X_dis-dc-rule.discnt-role, 'debet-pay-pcnt-disc,debet-pay-abs-disc,debet-pay-qnty-disc,debet-pay-sum-disc,debet-pay-free-disc,dc-d-pcnt,dc-cash-d-pcnt,credit-pay-pcnt-disc,credit-pay-abs-disc,credit-pay-qnty-disc,credit-pay-sum-disc,credit-pay-free-disc':u) + 1, ',' + '% Скидка при оплате топлива по дебет.ведомости,ABS Скидка при оплате топлива по дебет.ведомости,Скидка на кол-во при оплате топлива по дебет.ведомости,Скидка на сумму при оплате топлива по дебет.ведомости,Своб скидка при оплате топлива по дебет.ведомости,% скидка на товар по ДК,% скидка на итог чека по ДК,% Скидка при оплате топлива по кредит.ведомости,Abs Скидка при оплате топлива по кредит.ведомости,Скидка на кол-во при оплате топлива по кредит.ведомости,Скидка на сумму при оплате топлива по кредит.ведомости,Своб Скидка на сумму при оплате топлива по кредит.ведомости':u) COLUMN-LABEL 'Тип скидки' FORMAT "X(70)" WIDTH 40
X_dis-dc-rule.rule-num COLUMN-LABEL '№ правила' FORMAT ">>>>>>>>9"
X_dis-dc-rule.rl-root COLUMN-LABEL '№ корн.!правила' FORMAT ">>>>>>>>9"
...
END.
ON CHOOSE OF B-d-card IN FRAME Dialog-Frame
DO:
...
apply "entry" to br-dis-dc-rule in frame Dialog-Frame.
END.
...
run ref/cdchist.w (
                ...
                , input X_dis-dc-rule.obj-type
                , input X_dis-dc-rule.obj-code
                , input X_dis-dc-rule.host-code
                , input ?
                , input "":U
                , input 'dis-dc-rule':U
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse br-dis-dc-rule :handle
      .
...
do:
   v-doc-rec = recid(X_dis-dc-rule).  Run OpenBR in this-procedure ( input yes, input no, input '':U).  REPOSITION br-dis-dc-rule to recid v-doc-rec No-ERROR.               apply 'value-changed' to br-dis-dc-rule.
...
def var sort-labelbr-dis-dc-rule   as character no-undo .
def var sort-clmnbr-dis-dc-rule    as handle    no-undo .
def var cur-clmnbr-dis-dc-rule     as handle    no-undo .
def var cur-clmn-locbr-dis-dc-rule as integer   no-undo .
def var re-querybr-dis-dc-rule     as logical   initial no no-undo .
on start-search, ctrl-o of br-dis-dc-rule in frame Dialog-Frame do:
   run sort-brbr-dis-dc-rule
     (input (if available X_dis-dc-rule
             then recid(X_dis-dc-rule)
             else ?
            )
     ).
end.
PROCEDURE sort-brbr-dis-dc-rule :
  define input parameter p-recid as recid no-undo .
  if re-querybr-dis-dc-rule = no then do:
    assign
       cur-clmnbr-dis-dc-rule = br-dis-dc-rule:current-column in frame Dialog-Frame
    .
    if sort-clmnbr-dis-dc-rule <> ? then sort-clmnbr-dis-dc-rule:column-fgcolor = 0.
    if cur-clmnbr-dis-dc-rule = sort-clmnbr-dis-dc-rule then do:
      assign
         sort-labelbr-dis-dc-rule = ""
         sort-clmnbr-dis-dc-rule = ?
      .
     end.
     else do:
       assign
         sort-labelbr-dis-dc-rule = cur-clmnbr-dis-dc-rule:label
         sort-clmnbr-dis-dc-rule  = cur-clmnbr-dis-dc-rule
         sort-clmnbr-dis-dc-rule:column-fgcolor = 4
       .
     end.
   end.
  assign
    cur-clmn-locbr-dis-dc-rule = 1
  .
  def var column-handle as handle no-undo .
  column-handle = br-dis-dc-rule:first-column.
  do while valid-handle(column-handle) :
    if column-handle = cur-clmnbr-dis-dc-rule then do:
      leave .
    end.
    column-handle = column-handle:NEXT-COLUMN.
    assign
      cur-clmn-locbr-dis-dc-rule = cur-clmn-locbr-dis-dc-rule + 1
    .
  end.
  case sort-labelbr-dis-dc-rule:
        when '*'  then DO:    assign       sort-column-name = "mark-string(recid(X_dis-dc-rule), v-rid-list)"     .     run OpenBr in this-procedure ( input yes, input no, input no).   . END.
        when '№ карты'  then DO:    assign       sort-column-name = "X_dis-dc-rule.d-card"     .     run OpenBr in this-procedure ( input yes, input no, input no).   . END.
        when 'Эмитент'  then DO:    assign       sort-column-name = "X_dis-card.emitent-host-code"     .     run OpenBr in this-procedure ( input yes, input no, input no).   . END.
        when 'Тип'  then DO:    assign       sort-column-name = "X_dis-card.type"     .     run OpenBr in this-procedure ( input yes, input no, input no).   . END.
        when 'Держатель'  then DO:    assign       sort-column-name = "(X_dis-card.cli-type + string(X_dis-card.cli-code))"     .     run OpenBr in this-procedure ( input yes, input no, input no).   . END.
        when 'Держатель'  then DO:    assign       sort-column-name = "X_clients.obj-name"     .     run OpenBr in this-procedure ( input yes, input no, input no).   . END.
        when 'Тип правила'  then DO:    assign       sort-column-name = "X_dis-dc-rule.templ-rl-root"     .     run OpenBr in this-procedure ( input yes, input no, input no).   . END.
        when 'Место использ.'  then DO:    assign       sort-column-name = "entry (lookup (X_dis-dc-rule.pos-type, 'IBM,IBM-XML,IPC-Servis+,OMRON-NEW,OMRON,NCR-GM,MAGIA-XML,NCR-AS@R,IBS-TH,IBS-TH-MOB,r-keeper,InfoKiosk,pricecheck-Servis+,Emulator-NKT-IBM,MARIA,-,bo,Autotank':U), 'IBM,IBM-XML,IPC-Servis+,OMRON-NEW,OMRON,NCR-GM,MAGIA-XML,NCR-AS@R,IBS-TH,IBS-TH-MOB,R-KEEPER,InfoKiosk,Прайс-чекер Servis+,Emulator-NKT-IBM,MARIA,Накладная,Бэкофис,Autotank':U)"     .     run OpenBr in this-procedure ( input yes, input no, input no).   . END.
        when 'Тип объ'  then DO:    assign       sort-column-name = "X_dis-dc-rule.obj-type"     .     run OpenBr in this-procedure ( input yes, input no, input no).   . END.
        when 'Код объ'  then DO:    assign       sort-column-name = "X_dis-dc-rule.obj-code"     .     run OpenBr in this-procedure ( input yes, input no, input no).   . END.
        when 'Тип скидки'  then DO:    assign       sort-column-name = "entry (lookup (X_dis-dc-rule.discnt-role, 'debet-pay-pcnt-disc,debet-pay-abs-disc,debet-pay-qnty-disc,debet-pay-sum-disc,debet-pay-free-disc,dc-d-pcnt,dc-cash-d-pcnt,credit-pay-pcnt-disc,credit-pay-abs-disc,credit-pay-qnty-disc,credit-pay-sum-disc,credit-pay-free-disc':u) + 1, ',' + '% Скидка при оплате топлива по дебет.ведомости,ABS Скидка при оплате топлива по дебет.ведомости,Скидка на кол-во при оплате топлива по дебет.ведомости,Скидка на сумму при оплате топлива по дебет.ведомости,Своб скидка при оплате топлива по дебет.ведомости,% скидка на товар по ДК,% скидка на итог чека по ДК,% Скидка при оплате топлива по кредит.ведомости,Abs Скидка при оплате топлива по кредит.ведомости,Скидка на кол-во при оплате топлива по кредит.ведомости,Скидка на сумму при оплате топлива по кредит.ведомости,Своб Скидка на сумму при оплате топлива по кредит.ведомости':u)"     .     run OpenBr in this-procedure ( input yes, input no, input no).   . END.
        when '№ правила'  then DO:    assign       sort-column-name = "X_dis-dc-rule.rule-num"     .     run OpenBr in this-procedure ( input yes, input no, input no).   . END.
        when '№ корн.!правила'  then DO:    assign       sort-column-name = "X_dis-dc-rule.rl-root"     .     run OpenBr in this-procedure ( input yes, input no, input no).   . END.
    otherwise do:
      assign
        sort-column-name = ""
      .
      run OpenBr in this-procedure ( input yes, input no, input no).
      if sort-labelbr-dis-dc-rule <> "" then do:
        assign
          cur-clmnbr-dis-dc-rule:column-fgcolor = 0
        .
      end.
      assign
        cur-clmn-locbr-dis-dc-rule = ?
      .
    end.
  end case.
  if p-recid <> ? then do:
    reposition br-dis-dc-rule to recid p-recid no-error.
    apply "value-changed" to br-dis-dc-rule in frame Dialog-Frame.
  end.
  apply "entry" to br-dis-dc-rule in frame Dialog-Frame.
END PROCEDURE.
procedure re-open-query-srt-clmnbr-dis-dc-rule:
if cur-clmnbr-dis-dc-rule = ? then do:
   run OpenBr in this-procedure ( input yes, input no, input no).
end.
else do:
   assign re-querybr-dis-dc-rule = yes.
   run sort-brbr-dis-dc-rule
     (input (if available X_dis-dc-rule
             then recid(X_dis-dc-rule)
             else ?
   ...
   assign re-querybr-dis-dc-rule = no.
end.
end.
define variable vss-include-info17 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
do:
  BR-dis-dc-rule :SET-REPOSITIONED-ROW(5, "CONDITIONAL") .
end.
MAIN-BLOCK:
...
define variable vss-include-info18 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
  ...
  IF LOOKUP( "discnt-role", p-list-mode) > 0 THEN DO:
    FIND FIRST par_dis-cfg-rule NO-LOCK WHERE
          ...
          AND par_dis-cfg-rule.TABLE-name = 'dis-dc-rule':U NO-ERROR.
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY BR-dis-dc-rule FOR EACH X_dis-dc-rule NO-LOCK ,            FIRST X_dis-card NO-LOCK WHERE           X_dis-card.d-card = X_dis-dc-rule.d-card,            FIRST X_clients NO-LOCK where           X_clients.obj-type = X_dis-card.cli-type       AND X_clients.obj-code = X_dis-card.cli-code INDEXED-REPOSITION.
END PROCEDURE.
PROCEDURE MyEnable :
define variable v-h as handle no-undo .
define variable v-ii as integer no-undo .
v-h = BR-dis-dc-rule:FIRST-COLUMN IN FRAME Dialog-Frame.
DO while valid-handle(v-h)
and  v-ii < br-dis-dc-rule:num-COLUMNs IN FRAME Dialog-Frame:
  v-ii = v-ii + 1.
  if v-h:LABEL = 'Держатель'
  or v-h:LABEL = 'Место использ.'
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-21 as character no-undo .
      ...
      parameter-5-21 = (" " + "" + " " + ", FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code")
    ...
    :
      ...
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-dis-dc-rule:handle
  ...
  if l-filter-open-21 = false then do:
    OPEN QUERY br-dis-dc-rule FOR EACH X_dis-dc-rule
      where  TRUE
    , FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code
      indexed-reposition
  .
      assign
        l-query-was-opened = true
  ...
  assign
    v-doc-rec = recid( X_dis-dc-rule )
  .
  do
  on stop undo, leave
  on error undo, leave
  :
    if QUERY br-dis-dc-rule:handle:get-buffer-handle(1) = (buffer X_dis-dc-rule:handle) then do:
      assign
    ...
    .
      run fltopend_fltfindd in this-procedure  (
                          ...
                          ,input QUERY br-dis-dc-rule:handle
                          ,input rowid(X_dis-dc-rule)
                          ,input logical(parameter-2-21)
                          ,input no-lock
                          ,input (buffer X_dis-dc-rule:handle)
                          ,input parameter-4-21
                          ,input parameter-5-21
                          ) no-error.
      .
      ...
      assign
      parameter-2-21 = (if p-find-next then "true":u else "false":u )
      parameter-3-21 =  "FOR EACH X_dis-dc-rule"
      parameter-4-21 =
        (
          if (" TRUE " + " " + where-phrase-21) <> ""
          then " TRUE " + " " + where-phrase-21
      ...
      parameter-5-21 = (" " + "" + " " + ", FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code" + " " + p-find-condition)
      parameter-6-21 = if sort-phrase-21 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-23 as character no-undo .
      ...
      parameter-4-23 =
        (
          if (" X_dis-dc-rule.obj-type = p-curr-obj-type and X_dis-dc-rule.obj-code = p-curr-obj-code " + " " + where-phrase-23) <> ""
          then  substitute('X_dis-dc-rule.obj-type = &1&2&1 and X_dis-dc-rule.obj-code = &3 ', chr(34), p-curr-obj-type, p-curr-obj-code) + " " + where-phrase-23
          else "true"
        )
      parameter-5-23 = (" " + "" + " " + ", FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code")
    ...
    :
      assign
        l-disable-where-23 =
          (" X_dis-dc-rule.obj-type = p-curr-obj-type and X_dis-dc-rule.obj-code = p-curr-obj-code " + " " + where-phrase-23 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-dis-dc-rule:handle
  ...
  if l-filter-open-23 = false then do:
    OPEN QUERY br-dis-dc-rule FOR EACH X_dis-dc-rule
      where  X_dis-dc-rule.obj-type = p-curr-obj-type and X_dis-dc-rule.obj-code = p-curr-obj-code
    , FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code
      indexed-reposition
  .
      assign
  ...
  :
    if QUERY br-dis-dc-rule:handle:get-buffer-handle(1) = (buffer X_dis-dc-rule:handle) then do:
      ...
      parameter-4-23 =
        "where ":u +  substitute('X_dis-dc-rule.obj-type = &1&2&1 and X_dis-dc-rule.obj-code = &3 ', chr(34), p-curr-obj-type, p-curr-obj-code) + " ":u + where-phrase-23 + " ":u + p-find-condition + " " + ""
      parameter-5-23 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-23 = (if p-find-next then "true":u else "false":u )
      parameter-3-23 =  "FOR EACH X_dis-dc-rule"
      parameter-4-23 =
        (
          if (" X_dis-dc-rule.obj-type = p-curr-obj-type and X_dis-dc-rule.obj-code = p-curr-obj-code " + " " + where-phrase-23) <> ""
          then  substitute('X_dis-dc-rule.obj-type = &1&2&1 and X_dis-dc-rule.obj-code = &3 ', chr(34), p-curr-obj-type, p-curr-obj-code) + " " + where-phrase-23
      ...
      parameter-5-23 = (" " + "" + " " + ", FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code" + " " + p-find-condition)
      parameter-6-23 = if sort-phrase-23 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-25 as character no-undo .
      ...
      parameter-4-25 =
        (
          if (" X_dis-dc-rule.obj-type = p-curr-obj-type and X_dis-dc-rule.obj-code = p-curr-obj-code                       AND X_dis-dc-rule.pos-type = p-pos-type " + " " + where-phrase-25) <> ""
          then  substitute('X_dis-dc-rule.obj-type = &1&2&1 and X_dis-dc-rule.obj-code = &3                       AND X_dis-dc-rule.pos-type = &1&4&1 ', chr(34), p-curr-obj-type, p-curr-obj-code, p-pos-type) + " " + where-phrase-25
          else "true"
        )
      parameter-5-25 = (" " + "" + " " + ", FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code")
    ...
    :
      assign
        l-disable-where-25 =
          (" X_dis-dc-rule.obj-type = p-curr-obj-type and X_dis-dc-rule.obj-code = p-curr-obj-code                       AND X_dis-dc-rule.pos-type = p-pos-type " + " " + where-phrase-25 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-dis-dc-rule:handle
  ...
  if l-filter-open-25 = false then do:
    OPEN QUERY br-dis-dc-rule FOR EACH X_dis-dc-rule
      where  X_dis-dc-rule.obj-type = p-curr-obj-type and X_dis-dc-rule.obj-code = p-curr-obj-code                       AND X_dis-dc-rule.pos-type = p-pos-type
    , FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code
      indexed-reposition
  .
      assign
  ...
  :
    if QUERY br-dis-dc-rule:handle:get-buffer-handle(1) = (buffer X_dis-dc-rule:handle) then do:
      ...
      parameter-4-25 =
        "where ":u +  substitute('X_dis-dc-rule.obj-type = &1&2&1 and X_dis-dc-rule.obj-code = &3                       AND X_dis-dc-rule.pos-type = &1&4&1 ', chr(34), p-curr-obj-type, p-curr-obj-code, p-pos-type) + " ":u + where-phrase-25 + " ":u + p-find-condition + " " + ""
      parameter-5-25 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-25 = (if p-find-next then "true":u else "false":u )
      parameter-3-25 =  "FOR EACH X_dis-dc-rule"
      parameter-4-25 =
        (
          if (" X_dis-dc-rule.obj-type = p-curr-obj-type and X_dis-dc-rule.obj-code = p-curr-obj-code                       AND X_dis-dc-rule.pos-type = p-pos-type " + " " + where-phrase-25) <> ""
          then  substitute('X_dis-dc-rule.obj-type = &1&2&1 and X_dis-dc-rule.obj-code = &3                       AND X_dis-dc-rule.pos-type = &1&4&1 ', chr(34), p-curr-obj-type, p-curr-obj-code, p-pos-type) + " " + where-phrase-25
      ...
      parameter-5-25 = (" " + "" + " " + ", FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code" + " " + p-find-condition)
      parameter-6-25 = if sort-phrase-25 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-27 as character no-undo .
      ...
      parameter-4-27 =
        (
          if (" X_dis-dc-rule.obj-type = p-curr-obj-type and X_dis-dc-rule.obj-code = p-curr-obj-code                       AND X_dis-dc-rule.templ-rl-root = p-templ-rl-root " + " " + where-phrase-27) <> ""
          then  substitute('X_dis-dc-rule.obj-type = &1&2&1 and X_dis-dc-rule.obj-code = &3                       AND X_dis-dc-rule.templ-rl-root = &4 ', chr(34), p-curr-obj-type, p-curr-obj-code, p-templ-rl-root) + " " + where-phrase-27
          else "true"
        )
      parameter-5-27 = (" " + "" + " " + ", FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code")
    ...
    :
      assign
        l-disable-where-27 =
          (" X_dis-dc-rule.obj-type = p-curr-obj-type and X_dis-dc-rule.obj-code = p-curr-obj-code                       AND X_dis-dc-rule.templ-rl-root = p-templ-rl-root " + " " + where-phrase-27 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-dis-dc-rule:handle
  ...
  if l-filter-open-27 = false then do:
    OPEN QUERY br-dis-dc-rule FOR EACH X_dis-dc-rule
      where  X_dis-dc-rule.obj-type = p-curr-obj-type and X_dis-dc-rule.obj-code = p-curr-obj-code                       AND X_dis-dc-rule.templ-rl-root = p-templ-rl-root
    , FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code
      indexed-reposition
  .
      assign
  ...
  :
    if QUERY br-dis-dc-rule:handle:get-buffer-handle(1) = (buffer X_dis-dc-rule:handle) then do:
      ...
      parameter-4-27 =
        "where ":u +  substitute('X_dis-dc-rule.obj-type = &1&2&1 and X_dis-dc-rule.obj-code = &3                       AND X_dis-dc-rule.templ-rl-root = &4 ', chr(34), p-curr-obj-type, p-curr-obj-code, p-templ-rl-root) + " ":u + where-phrase-27 + " ":u + p-find-condition + " " + ""
      parameter-5-27 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-27 = (if p-find-next then "true":u else "false":u )
      parameter-3-27 =  "FOR EACH X_dis-dc-rule"
      parameter-4-27 =
        (
          if (" X_dis-dc-rule.obj-type = p-curr-obj-type and X_dis-dc-rule.obj-code = p-curr-obj-code                       AND X_dis-dc-rule.templ-rl-root = p-templ-rl-root " + " " + where-phrase-27) <> ""
          then  substitute('X_dis-dc-rule.obj-type = &1&2&1 and X_dis-dc-rule.obj-code = &3                       AND X_dis-dc-rule.templ-rl-root = &4 ', chr(34), p-curr-obj-type, p-curr-obj-code, p-templ-rl-root) + " " + where-phrase-27
      ...
      parameter-5-27 = (" " + "" + " " + ", FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code" + " " + p-find-condition)
      parameter-6-27 = if sort-phrase-27 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-29 as character no-undo .
      ...
      parameter-4-29 =
        (
          if (" X_dis-dc-rule.obj-type = p-curr-obj-type and X_dis-dc-rule.obj-code = p-curr-obj-code                       AND X_dis-dc-rule.discnt-role = p-discnt-role " + " " + where-phrase-29) <> ""
          then  substitute('X_dis-dc-rule.obj-type = &1&2&1 and X_dis-dc-rule.obj-code = &3                       AND X_dis-dc-rule.discnt-role = &1&4&1 ', chr(34), p-curr-obj-type, p-curr-obj-code, p-discnt-role) + " " + where-phrase-29
          else "true"
        )
      parameter-5-29 = (" " + "" + " " + ", FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code")
    ...
    :
      assign
        l-disable-where-29 =
          (" X_dis-dc-rule.obj-type = p-curr-obj-type and X_dis-dc-rule.obj-code = p-curr-obj-code                       AND X_dis-dc-rule.discnt-role = p-discnt-role " + " " + where-phrase-29 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-dis-dc-rule:handle
  ...
  if l-filter-open-29 = false then do:
    OPEN QUERY br-dis-dc-rule FOR EACH X_dis-dc-rule
      where  X_dis-dc-rule.obj-type = p-curr-obj-type and X_dis-dc-rule.obj-code = p-curr-obj-code                       AND X_dis-dc-rule.discnt-role = p-discnt-role
    , FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code
      indexed-reposition
  .
      assign
  ...
  :
    if QUERY br-dis-dc-rule:handle:get-buffer-handle(1) = (buffer X_dis-dc-rule:handle) then do:
      ...
      parameter-4-29 =
        "where ":u +  substitute('X_dis-dc-rule.obj-type = &1&2&1 and X_dis-dc-rule.obj-code = &3                       AND X_dis-dc-rule.discnt-role = &1&4&1 ', chr(34), p-curr-obj-type, p-curr-obj-code, p-discnt-role) + " ":u + where-phrase-29 + " ":u + p-find-condition + " " + ""
      parameter-5-29 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-29 = (if p-find-next then "true":u else "false":u )
      parameter-3-29 =  "FOR EACH X_dis-dc-rule"
      parameter-4-29 =
        (
          if (" X_dis-dc-rule.obj-type = p-curr-obj-type and X_dis-dc-rule.obj-code = p-curr-obj-code                       AND X_dis-dc-rule.discnt-role = p-discnt-role " + " " + where-phrase-29) <> ""
          then  substitute('X_dis-dc-rule.obj-type = &1&2&1 and X_dis-dc-rule.obj-code = &3                       AND X_dis-dc-rule.discnt-role = &1&4&1 ', chr(34), p-curr-obj-type, p-curr-obj-code, p-discnt-role) + " " + where-phrase-29
      ...
      parameter-5-29 = (" " + "" + " " + ", FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code" + " " + p-find-condition)
      parameter-6-29 = if sort-phrase-29 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-31 as character no-undo .
      ...
      parameter-4-31 =
        (
          if (" X_dis-dc-rule.templ-rl-root = p-templ-rl-root " + " " + where-phrase-31) <> ""
          then  substitute('X_dis-dc-rule.templ-rl-root = &1', p-templ-rl-root)  + " " + where-phrase-31
          else "true"
        )
      parameter-5-31 = (" " + "" + " " + ", FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code")
    ...
    :
      assign
        l-disable-where-31 =
          (" X_dis-dc-rule.templ-rl-root = p-templ-rl-root " + " " + where-phrase-31 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-dis-dc-rule:handle
  ...
  if l-filter-open-31 = false then do:
    OPEN QUERY br-dis-dc-rule FOR EACH X_dis-dc-rule
      where  X_dis-dc-rule.templ-rl-root = p-templ-rl-root
    , FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code
      indexed-reposition
  .
      assign
  ...
  :
    if QUERY br-dis-dc-rule:handle:get-buffer-handle(1) = (buffer X_dis-dc-rule:handle) then do:
      ...
      parameter-4-31 =
        "where ":u +  substitute('X_dis-dc-rule.templ-rl-root = &1', p-templ-rl-root)  + " ":u + where-phrase-31 + " ":u + p-find-condition + " " + ""
      parameter-5-31 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-31 = (if p-find-next then "true":u else "false":u )
      parameter-3-31 =  "FOR EACH X_dis-dc-rule"
      parameter-4-31 =
        (
          if (" X_dis-dc-rule.templ-rl-root = p-templ-rl-root " + " " + where-phrase-31) <> ""
          then  substitute('X_dis-dc-rule.templ-rl-root = &1', p-templ-rl-root)  + " " + where-phrase-31
      ...
      parameter-5-31 = (" " + "" + " " + ", FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code" + " " + p-find-condition)
      parameter-6-31 = if sort-phrase-31 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-33 as character no-undo .
      ...
      parameter-4-33 =
        (
          if (" X_dis-dc-rule.rule-num = p-rule-num " + " " + where-phrase-33) <> ""
          then  substitute('X_dis-dc-rule.rule-num = 71', p-rule-num ) + " " + where-phrase-33
          else "true"
        )
      parameter-5-33 = (" " + "" + " " + ", FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code")
    ...
    :
      assign
        l-disable-where-33 =
          (" X_dis-dc-rule.rule-num = p-rule-num " + " " + where-phrase-33 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-dis-dc-rule:handle
  ...
  if l-filter-open-33 = false then do:
    OPEN QUERY br-dis-dc-rule FOR EACH X_dis-dc-rule
      where  X_dis-dc-rule.rule-num = p-rule-num
    , FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code
      indexed-reposition
  .
      assign
  ...
  :
    if QUERY br-dis-dc-rule:handle:get-buffer-handle(1) = (buffer X_dis-dc-rule:handle) then do:
      ...
      parameter-4-33 =
        "where ":u +  substitute('X_dis-dc-rule.rule-num = 71', p-rule-num ) + " ":u + where-phrase-33 + " ":u + p-find-condition + " " + ""
      parameter-5-33 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-33 = (if p-find-next then "true":u else "false":u )
      parameter-3-33 =  "FOR EACH X_dis-dc-rule"
      parameter-4-33 =
        (
          if (" X_dis-dc-rule.rule-num = p-rule-num " + " " + where-phrase-33) <> ""
          then  substitute('X_dis-dc-rule.rule-num = 71', p-rule-num ) + " " + where-phrase-33
      ...
      parameter-5-33 = (" " + "" + " " + ", FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code" + " " + p-find-condition)
      parameter-6-33 = if sort-phrase-33 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-35 as character no-undo .
      ...
      parameter-4-35 =
        (
          if (" X_dis-dc-rule.rl-root = p-rule-num " + " " + where-phrase-35) <> ""
          then  substitute('X_dis-dc-rule.rl-root = &1', p-rule-num ) + " " + where-phrase-35
          else "true"
        )
      parameter-5-35 = (" " + "" + " " + ", FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code")
    ...
    :
      assign
        l-disable-where-35 =
          (" X_dis-dc-rule.rl-root = p-rule-num " + " " + where-phrase-35 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-dis-dc-rule:handle
  ...
  if l-filter-open-35 = false then do:
    OPEN QUERY br-dis-dc-rule FOR EACH X_dis-dc-rule
      where  X_dis-dc-rule.rl-root = p-rule-num
    , FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code
      indexed-reposition
  .
      assign
  ...
  :
    if QUERY br-dis-dc-rule:handle:get-buffer-handle(1) = (buffer X_dis-dc-rule:handle) then do:
      ...
      parameter-4-35 =
        "where ":u +  substitute('X_dis-dc-rule.rl-root = &1', p-rule-num ) + " ":u + where-phrase-35 + " ":u + p-find-condition + " " + ""
      parameter-5-35 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-35 = (if p-find-next then "true":u else "false":u )
      parameter-3-35 =  "FOR EACH X_dis-dc-rule"
      parameter-4-35 =
        (
          if (" X_dis-dc-rule.rl-root = p-rule-num " + " " + where-phrase-35) <> ""
          then  substitute('X_dis-dc-rule.rl-root = &1', p-rule-num ) + " " + where-phrase-35
      ...
      parameter-5-35 = (" " + "" + " " + ", FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code" + " " + p-find-condition)
      parameter-6-35 = if sort-phrase-35 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-37 as character no-undo .
      ...
      parameter-4-37 =
        (
          if (" X_dis-dc-rule.pos-type = p-pos-type " + " " + where-phrase-37) <> ""
          then  substitute('X_dis-dc-rule.pos-type = &1&2&1', chr(34), p-pos-type ) + " " + where-phrase-37
          else "true"
        )
      parameter-5-37 = (" " + "" + " " + ", FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code")
    ...
    :
      assign
        l-disable-where-37 =
          (" X_dis-dc-rule.pos-type = p-pos-type " + " " + where-phrase-37 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-dis-dc-rule:handle
  ...
  if l-filter-open-37 = false then do:
    OPEN QUERY br-dis-dc-rule FOR EACH X_dis-dc-rule
      where  X_dis-dc-rule.pos-type = p-pos-type
    , FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code
      indexed-reposition
  .
      assign
  ...
  :
    if QUERY br-dis-dc-rule:handle:get-buffer-handle(1) = (buffer X_dis-dc-rule:handle) then do:
      ...
      parameter-4-37 =
        "where ":u +  substitute('X_dis-dc-rule.pos-type = &1&2&1', chr(34), p-pos-type ) + " ":u + where-phrase-37 + " ":u + p-find-condition + " " + ""
      parameter-5-37 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-37 = (if p-find-next then "true":u else "false":u )
      parameter-3-37 =  "FOR EACH X_dis-dc-rule"
      parameter-4-37 =
        (
          if (" X_dis-dc-rule.pos-type = p-pos-type " + " " + where-phrase-37) <> ""
          then  substitute('X_dis-dc-rule.pos-type = &1&2&1', chr(34), p-pos-type ) + " " + where-phrase-37
      ...
      parameter-5-37 = (" " + "" + " " + ", FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code" + " " + p-find-condition)
      parameter-6-37 = if sort-phrase-37 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-39 as character no-undo .
      ...
      parameter-4-39 =
        (
          if (" X_dis-dc-rule.discnt-role = p-discnt-role " + " " + where-phrase-39) <> ""
          then  substitute('X_dis-dc-rule.discnt-role = &1&2&1', chr(34), p-discnt-role)  + " " + where-phrase-39
          else "true"
        )
      parameter-5-39 = (" " + "" + " " + ", FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code")
    ...
    :
      assign
        l-disable-where-39 =
          (" X_dis-dc-rule.discnt-role = p-discnt-role " + " " + where-phrase-39 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-dis-dc-rule:handle
  ...
  if l-filter-open-39 = false then do:
    OPEN QUERY br-dis-dc-rule FOR EACH X_dis-dc-rule
      where  X_dis-dc-rule.discnt-role = p-discnt-role
    , FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code
      indexed-reposition
  .
      assign
  ...
  :
    if QUERY br-dis-dc-rule:handle:get-buffer-handle(1) = (buffer X_dis-dc-rule:handle) then do:
      ...
      parameter-4-39 =
        "where ":u +  substitute('X_dis-dc-rule.discnt-role = &1&2&1', chr(34), p-discnt-role)  + " ":u + where-phrase-39 + " ":u + p-find-condition + " " + ""
      parameter-5-39 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-39 = (if p-find-next then "true":u else "false":u )
      parameter-3-39 =  "FOR EACH X_dis-dc-rule"
      parameter-4-39 =
        (
          if (" X_dis-dc-rule.discnt-role = p-discnt-role " + " " + where-phrase-39) <> ""
          then  substitute('X_dis-dc-rule.discnt-role = &1&2&1', chr(34), p-discnt-role)  + " " + where-phrase-39
      ...
      parameter-5-39 = (" " + "" + " " + ", FIRST X_dis-card no-lock where X_dis-card.d-card = X_dis-dc-rule.d-card,                                  FIRST X_clients no-lock where X_clients.obj-type = X_Dis-card.cli-type and                                                                X_clients.obj-code = X_dis-card.cli-code" + " " + p-find-condition)
      parameter-6-39 = if sort-phrase-39 = ''
                           then
        (
        " " + "  " +
...
define variable v-str-recid41 as character no-undo .
define variable v-num-entry41 as integer   no-undo .
assign
  v-str-recid41 = trim( string( recid( X_dis-dc-rule ) , "->>>>>>>>>>>9":U ) )
  v-num-entry41 = lookup( v-str-recid41 , v-rid-list )
.
if v-num-entry41 > 0 then do:
  assign
    entry( v-num-entry41, v-rid-list ) = "":U
    v-rid-list = trim( replace( v-rid-list , chr(44) + chr(44) , chr(44) ) , chr(44) )
  .
end.
else do:
  assign
    v-rid-list = v-rid-list + ( if v-rid-list = "":U then "":U else chr(44) ) + v-str-recid41
  .
end.
  loc#log = br-dis-dc-rule:refresh() IN FRAME Dialog-Frame .
...
X_dis-card.emitent-host-code COLUMN-LABEL 'Эмитент' FORMAT ">>>>9"
X_dis-card.type COLUMN-LABEL 'Тип'
v-prod COLUMN-LABEL 'Держатель' FORMAT "X(12)"
X_clients.obj-name COLUMN-LABEL 'Держатель' FORMAT "X(40)"
X_dis-dc-rule.templ-rl-root COLUMN-LABEL 'Тип правила' FORMAT ">>>>>>>>9"
v-pos-type COLUMN-LABEL 'Место использ.' format "X(20)"
X_dis-dc-rule.obj-type COLUMN-LABEL 'Тип объ' FORMAT "X(3)"
X_dis-dc-rule.obj-code COLUMN-LABEL 'Код объ' FORMAT ">>>>>>>>9"
v-d-name COLUMN-LABEL 'Тип скидки' FORMAT "X(40)"
X_dis-dc-rule.rule-num COLUMN-LABEL '№ правила' FORMAT ">>>>>>>>9"
X_dis-dc-rule.rl-root COLUMN-LABEL '№ корн.!правила' FORMAT ">>>>>>>>9"
HEADER
...
DO WHILE available X_dis-dc-rule :
  ...
  mark-string(recid(X_dis-dc-rule), v-rid-list) @ v-mark
  X_dis-dc-rule.d-card
  X_dis-card.emitent-host-code
  X_dis-card.type
  (X_dis-card.cli-type + string(X_dis-card.cli-code)) @ v-prod
  X_clients.obj-name
  X_dis-dc-rule.templ-rl-root
  entry (lookup (X_dis-dc-rule.pos-type, 'IBM,IBM-XML,IPC-Servis+,OMRON-NEW,OMRON,NCR-GM,MAGIA-XML,NCR-AS@R,IBS-TH,IBS-TH-MOB,r-keeper,InfoKiosk,pricecheck-Servis+,Emulator-NKT-IBM,MARIA,-,bo,Autotank':U), 'IBM,IBM-XML,IPC-Servis+,OMRON-NEW,OMRON,NCR-GM,MAGIA-XML,NCR-AS@R,IBS-TH,IBS-TH-MOB,R-KEEPER,InfoKiosk,Прайс-чекер Servis+,Emulator-NKT-IBM,MARIA,Накладная,Бэкофис,Autotank':U) @ v-pos-type
  X_dis-dc-rule.obj-type
  X_dis-dc-rule.obj-code
  entry (lookup (p-discnt-role, 'debet-pay-pcnt-disc,debet-pay-abs-disc,debet-pay-qnty-disc,debet-pay-sum-disc,debet-pay-free-disc,dc-d-pcnt,dc-cash-d-pcnt,credit-pay-pcnt-disc,credit-pay-abs-disc,credit-pay-qnty-disc,credit-pay-sum-disc,credit-pay-free-disc':u) + 1, ',' + '% Скидка при оплате топлива по дебет.ведомости,ABS Скидка при оплате топлива по дебет.ведомости,Скидка на кол-во при оплате топлива по дебет.ведомости,Скидка на сумму при оплате топлива по дебет.ведомости,Своб скидка при оплате топлива по дебет.ведомости,% скидка на товар по ДК,% скидка на итог чека по ДК,% Скидка при оплате топлива по кредит.ведомости,Abs Скидка при оплате топлива по кредит.ведомости,Скидка на кол-во при оплате топлива по кредит.ведомости,Скидка на сумму при оплате топлива по кредит.ведомости,Своб Скидка на сумму при оплате топлива по кредит.ведомости':u) @ v-d-name
  X_dis-dc-rule.rule-num
  X_dis-dc-rule.rl-root
  with frame List .
