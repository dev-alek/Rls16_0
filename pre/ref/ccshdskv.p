...
v-label-param =
  "addr-path" + chr(4) + "Адрес/путь к кассе" + chr(4) + "" + chr(8)
 + "autonomy" + chr(4) + "Автономность" + chr(4) + "" + chr(8)
 + "cash-num" + chr(4) + "Номер кассы" + chr(4) + "" + chr(8)
 + "cash-on" + chr(4) + "Вкл/выкл" + chr(4) + "" + chr(8)
 + "cash-os" + chr(4) + "ОС" + chr(4) + "" + chr(8)
 + "db-num" + chr(4) + "БД" + chr(4) + "" + chr(8)
 + "is-del" + chr(4) + "Касса удалена" + chr(4) + "" + chr(8)
 + "obj-code" + chr(4) + "Магазин" + chr(4) + "" + chr(8)
 + "pos-type" + chr(4) + "Тип" + chr(4) + "" + chr(8)
 + "remote" + chr(4) + "Удаленная" + chr(4) + "" + chr(8)
 + "version" + chr(4) + "Версия ПО" + chr(4) + "" + chr(8)
 + "registration-code" + chr(4) + "Регистр.№" + chr(4) + "" + chr(8)
 + "serial-code" + chr(4) + "Сер.№" + chr(4) + ""  .
 run proc-full-temp-changes in this-procedure (
                                             input  (buf_c-cash-desk.action = integer('1':U))
                                            ,input  (buf_c-cash-desk.action = integer('99':U))
                                            ,input  buffer current_c-cash-desk:handle
                                            ,input  'cash-desk':U
                                            ,input  "addr-path,autonomy,cash-num,cash-on,cash-os,db-num,is-del,obj-code,pos-type,remote,version,registration-code,serial-code"
                                            ,input  v-label-param).
 end.
end procedure.
...
v-label-param =
 ...
 + "upper-attr-code" + chr(4) + "Секция" + chr(4) + "" + chr(8)
 ...
 run proc-full-temp-changes in this-procedure (
                                            ...
                                            ,input  "cash-num,db-num,obj-code,pos-type,attr-code,upper-attr-code,attr-value"
                                            ,input  v-label-param).
end.
end procedure.
PROCEDURE err-mess:
