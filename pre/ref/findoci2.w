...
DO:
END.
ON CHOOSE OF B-pre-vedom IN FRAME Dialog-Frame
DO:
  define buffer bf_fin-doc-attr for ub.fin-doc-attr .
  ...
  run ref/cover_sheet.p (input parParentProc, input p-host-code, input tt-fin-doc.fin-doc-code, input tt-fin-doc.CashBookId, input tt-fin-doc.sum-doc, input p-mode) no-error .
    display tt-fin-doc.enclosure with frame Dialog-Frame .
  end.
END.
...
PROCEDURE disable-enable :
  ...
  CASE rs-view:
    when "full":u then
      do:
        assign
          v-tab-order = "b-exit,b-quit,b-tax,b-print,b-hist,b-help," +  "prn-doc-code,doc-date,obj-type,obj-code,b-obj,b-payer-view,str-podr-type,str-podr-code,str-podr-name," +                             v-an-uchet-tab-order +  v-sum-curr-tab-order +                             "receiver-type,receiver-code,b-receiver,receiver-name,naznach-plat,receiver-passport,enclosure," +                              "PS,payer-sign1,payer-sign2"
          .
      end.
    when "brief":u then
      do:
        assign
          v-tab-order = "b-exit,b-quit,b-tax,b-print,b-hist,b-help," +                            "prn-doc-code,doc-date,obj-type,obj-code,b-obj,b-payer-view," +                            v-sum-curr-tab-order +                            "receiver-type,receiver-code,b-receiver,receiver-name,naznach-plat,receiver-passport,enclosure," +                            "PS,payer-sign1,payer-sign2,payer-sign3"
          .
      end.
    when "contract":u then
      do:
        assign
          v-tab-order = "b-exit,b-quit,b-tax,b-print,b-hist,b-help," +                               "prn-doc-code,doc-date,obj-type,obj-code,b-obj,b-payer-view," +                                v-contract-tab-order + v-sum-curr-tab-order +                                 "receiver-type,receiver-code,b-receiver,receiver-name,naznach-plat,receiver-passport,enclosure," +                                 "PS,payer-sign1,payer-sign2"
          .
      end.
  END CASE.
END PROCEDURE.
...
if p-mode = 'ПРОСМОТР':U then do:
    ...
    run proc-color-widgets in this-procedure("F-curr-abbr,an-uchet-value,cel-nazn-value,cor-acc1-value,cor-acc-value,doc-date,enclosure," +                       "naznach-plat,receiver-name,prn-doc-code,payer-name,payer-okpo,receiver-passport,payer-sign1,payer-sign2,payer-sign3" +                       "str-podr-code,str-podr-name,str-podr-type,sum-doc", no, yes, ?, ?).
end.
display
tt-fin-doc.exch-rate
tt-fin-doc.exch-scale
...
if error-status:error then return error.
   find first buf_clients-attr no-lock where buf_clients-attr.attr-code = 'is-inkassator':U and
