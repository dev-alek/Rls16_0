...
trigger procedure for write of ub.chk-slip-head
  new buffer new-chk-slip-head
  old buffer old-chk-slip-head
.
...
define variable vss-description as character no-undo init "Тригер изменение chk-slip-head".
