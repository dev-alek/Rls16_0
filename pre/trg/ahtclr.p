...
procedure clear-aht-ot-line :
  ...
  :
    ...
    :
      ...
      if v-export-archive = true
      then do:
        export stream slog 'aht-ot-line':U .
...
procedure clear-aht-ot-tot :
  ...
  :
    ...
    :
      ...
      if v-export-archive = true
      then do:
        export stream slog 'aht-ot-tot':U .
...
procedure clear-aht-stk-line :
  ...
  :
    ...
    :
      ...
      if v-export-archive = true
      then do:
        export stream slog 'aht-stk-line':U .
...
procedure clear-aht-stk-tot :
  ...
  :
    ...
    :
      ...
      if v-export-archive = true
      then do:
        export stream slog 'aht-stk-tot':U .
