...
trigger procedure for delete of ub.utd.
define variable vss-revision    as character no-undo initial "$Revision$":U .
define variable vss-author      as character no-undo initial "$Author$":U .
define variable vss-date        as character no-undo initial "$Date$":U .
define variable vss-workfile    as character no-undo initial "$Workfile$":U .
define variable vss-archive     as character no-undo initial "$Archive$":U .
define variable vss-description as character no-undo init "Тригер удаления utd".
...
define buffer buf_c-utd-head for ub.c-utd-head .
    ...
    if vFlagseq
    then do:
 for first buf_c-utd where buf_c-utd.db-num eq utd.db-num
and buf_c-utd.doc-id eq utd.doc-id
  and buf_c-utd.corr-user-db-num   = g#db-num and buf_c-utd.chip-num = v-Seq exclusive-lock: leave. end.
    end.
    if not available buf_c-utd
    then do:
       create buf_c-utd.
       buffer-copy ub.utd to buf_c-utd
       assign
      ...
      if vFlagSeq
      then do:
 for first buf_c-utd-head where buf_c-utd-head.db-num eq utd.db-num
and buf_c-utd-head.doc-id eq utd.doc-id
...
then do:
  ...
  if utd.db-num ne g#db-num and not g#esys and not g#auto
  then do:
  ...
  if g#db-num = 0
  then do:
    find first ub.clients no-lock where ub.clients.obj-type = utd.obj-type and ub.clients.obj-code = utd.obj-code no-error.
     if     avail  ub.clients
...
UnLockUTDMarkbuf(buffer utd,yes).
