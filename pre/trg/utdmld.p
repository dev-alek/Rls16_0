...
trigger procedure for delete of ub.utd-marking-lines.
define buffer buf_marking for ub.marking.
define buffer buf-utd-marking-lines for ub.utd-marking-lines.
define variable vss-revision    as character no-undo initial "$Revision$":U .
define variable vss-author      as character no-undo initial "$Author$":U .
define variable vss-date        as character no-undo initial "$Date$":U .
define variable vss-workfile    as character no-undo initial "$Workfile$":U .
define variable vss-archive     as character no-undo initial "$Archive$":U .
define variable vss-description as character no-undo init "Тригер удаления utd-marking-lines".
...
define buffer buf_c-utd-head for ub.c-utd-head .
    ...
    if vFlagseq
    then do:
 for first buf_c-utd-marking-lines where buf_c-utd-marking-lines.db-num eq utd-marking-lines.db-num
and buf_c-utd-marking-lines.doc-id eq utd-marking-lines.doc-id
and buf_c-utd-marking-lines.LineNum eq utd-marking-lines.LineNum
and buf_c-utd-marking-lines.mark eq utd-marking-lines.mark
  and buf_c-utd-marking-lines.corr-user-db-num   = g#db-num and buf_c-utd-marking-lines.chip-num = v-Seq exclusive-lock: leave. end.
    ...
    then do:
       ...
       buffer-copy ub.utd-marking-lines to buf_c-utd-marking-lines
       assign
         ...
         buf_c-utd-marking-lines.action             = 99
         buf_c-utd-marking-lines.is-del             = true
       .
    end.
    else
       buf_c-utd-marking-lines.action             = 99.
      if vFlagSeq
      then do:
 for first buf_c-utd-head where buf_c-utd-head.db-num eq utd-marking-lines.db-num
and buf_c-utd-head.doc-id eq utd-marking-lines.doc-id
...
for each utd-marking-lines-attr where utd-marking-lines-attr.db-num eq  utd-marking-lines.db-num
...
for each buf_marking no-lock where buf_marking.mark-parent = utd-marking-lines.mark :
    find first buf-utd-marking-lines where buf-utd-marking-lines.db-num eq  utd-marking-lines.db-num
                            and buf-utd-marking-lines.doc-id eq  utd-marking-lines.doc-id
                            and buf-utd-marking-lines.linenum eq  utd-marking-lines.linenum
                            and buf-utd-marking-lines.mark eq buf_marking.mark
    exclusive-lock no-error.
    if avail buf-utd-marking-lines
    then
       delete buf-utd-marking-lines.
end.
