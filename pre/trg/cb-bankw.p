...
DO ON ERROR   UNDO Main-Block, LEAVE Main-Block
  ...
  IF g#news <> YES THEN DO:
    ...
    ASSIGN ub.c-cbr-bank.action           = INTEGER( IF NEW( Buf-New )            THEN '1':U ELSE
                                                   ( IF Buf-New.bic = Buf-Old.bic THEN '2':U ELSE
                                                                                       '9':U ) )
           ...
           ub.c-cbr-bank.chip-num         = NEXT-VALUE( s-corr-chip, ub ) NO-ERROR.
