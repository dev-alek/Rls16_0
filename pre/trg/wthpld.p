...
define buffer buf_c-wth-place for ub.c-wth-place.
  ...
  :
    ...
    buffer-copy ub.wth-place to buf_c-wth-place
    assign
    buf_c-wth-place.host-code           = (if p-new-record then ub.wth-place.host-code else ub.wth-place.host-code)
    buf_c-wth-place.obj-type           = (if p-new-record then ub.wth-place.obj-type else ub.wth-place.obj-type)
    buf_c-wth-place.obj-code           = (if p-new-record then ub.wth-place.obj-code else ub.wth-place.obj-code)
    buf_c-wth-place.w-p-code           = (if p-new-record then ub.wth-place.w-p-code else ub.wth-place.w-p-code)
