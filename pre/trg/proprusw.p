...
:
  ...
  or g#db-num <> 0 then do:
    ...
    buf_c-prop-ruleset.chip-num           = next-value (s-ref-corr-chip, ub)
    ...
    buf_c-prop-head
    assign
    buf_c-prop-head.action             = integer(if new(ub.prop-ruleset) then '1':U else '2':U)
    buf_C-prop-head.subject            = 'prop-ruleset':U
    .
  end.
  if not g#news
  and g#db-num = 0
