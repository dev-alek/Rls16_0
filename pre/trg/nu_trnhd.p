...
define variable vss-description as character no-undo init "—оздать запись о том, что шапку документа необходимо пересчитать".
...
:
  ...
  if not available ub.BatchProcess then do:
    ...
    assign
      ub.BatchProcess.BP_Type       = 'trnhd':U
