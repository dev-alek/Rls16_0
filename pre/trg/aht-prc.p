    ...
    :
      ...
      then do:
        ...
        export stream ahtlog
          vss-include-info26 buf_temp-aht-ot-tot.doc-code .
...
procedure process-price-doc :
  ...
  :
    ...
    then do:
      message
        vss-workfile vss-revision vss-description skip
        "Нельзя рассчитать складской архив по типам приобретения для документа переоценки не закрытого до статуса" 'акт':U skip
        "Переоценка" p-doc-code skip
        view-as alert-box error .
      undo, return error .
    end.
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run gds-code in g#library
  ...
  ,output v-gds-code
      ...
      run process-price-list in this-procedure
        ...
        ,input buf_price-doc.fact-date
        ,input v-ext-doc-type
        ,input buf_price-list.vat-pc
        ,input v-cons-vat-pc
        ,input buf_price-list.slt-pc
        ,input v-curr-r-b
        ,input v-base-rate
        ,input v-base-scale
        ) no-error .
    ...
    then do:
      ...
      :
        ...
        and (
          ...
          or
                                                  buf_aht-stk-line.cost-sum-base       <> 0 or    buf_aht-stk-line.cost-sum-rubl       <> 0 or    buf_aht-stk-line.cost-vat-base       <> 0 or    buf_aht-stk-line.cost-vat-rubl       <> 0 or    buf_aht-stk-line.cost-slt-base       <> 0 or    buf_aht-stk-line.cost-slt-rubl       <> 0 or    buf_aht-stk-line.cost-road-tax-base  <> 0 or    buf_aht-stk-line.cost-road-tax-rubl  <> 0 or    buf_aht-stk-line.cost-excise-base    <> 0 or    buf_aht-stk-line.cost-excise-rubl    <> 0 or    buf_aht-stk-line.cost-transport-base <> 0 or    buf_aht-stk-line.cost-transport-rubl <> 0 or    buf_aht-stk-line.cost-other-base     <> 0 or    buf_aht-stk-line.cost-other-rubl     <> 0 or    buf_aht-stk-line.cost-discnt-base    <> 0 or    buf_aht-stk-line.cost-discnt-rubl    <> 0
          or
                                                  buf_aht-stk-line.crsa-sum-base       <> 0 or    buf_aht-stk-line.crsa-sum-rubl       <> 0 or    buf_aht-stk-line.crsa-vat-base       <> 0 or    buf_aht-stk-line.crsa-vat-rubl       <> 0 or    buf_aht-stk-line.crsa-slt-base       <> 0 or    buf_aht-stk-line.crsa-slt-rubl       <> 0 or    buf_aht-stk-line.crsa-road-tax-base  <> 0 or    buf_aht-stk-line.crsa-road-tax-rubl  <> 0 or    buf_aht-stk-line.crsa-excise-base    <> 0 or    buf_aht-stk-line.crsa-excise-rubl    <> 0 or    buf_aht-stk-line.crsa-transport-base <> 0 or    buf_aht-stk-line.crsa-transport-rubl <> 0 or    buf_aht-stk-line.crsa-other-base     <> 0 or    buf_aht-stk-line.crsa-other-rubl     <> 0 or    buf_aht-stk-line.crsa-discnt-base    <> 0 or    buf_aht-stk-line.crsa-discnt-rubl    <> 0
          or
                                                  buf_aht-stk-line.sale-sum-base       <> 0 or    buf_aht-stk-line.sale-sum-rubl       <> 0 or    buf_aht-stk-line.sale-vat-base       <> 0 or    buf_aht-stk-line.sale-vat-rubl       <> 0 or    buf_aht-stk-line.sale-slt-base       <> 0 or    buf_aht-stk-line.sale-slt-rubl       <> 0 or    buf_aht-stk-line.sale-road-tax-base  <> 0 or    buf_aht-stk-line.sale-road-tax-rubl  <> 0 or    buf_aht-stk-line.sale-excise-base    <> 0 or    buf_aht-stk-line.sale-excise-rubl    <> 0 or    buf_aht-stk-line.sale-transport-base <> 0 or    buf_aht-stk-line.sale-transport-rubl <> 0 or    buf_aht-stk-line.sale-other-base     <> 0 or    buf_aht-stk-line.sale-other-rubl     <> 0 or    buf_aht-stk-line.sale-discnt-base    <> 0 or    buf_aht-stk-line.sale-discnt-rubl    <> 0
            )
        then do:
          assign
        ...
        then do:
          assign
            v-fact-qnty = v-fact-qnty - buf_aht-stk-line.fact-qnty
                                                                                                            v-cost-sum-base       = v-cost-sum-base       - buf_aht-stk-line.cost-sum-base            v-cost-sum-rubl       = v-cost-sum-rubl       - buf_aht-stk-line.cost-sum-rubl            v-cost-vat-base       = v-cost-vat-base       - buf_aht-stk-line.cost-vat-base            v-cost-vat-rubl       = v-cost-vat-rubl       - buf_aht-stk-line.cost-vat-rubl            v-cost-slt-base       = v-cost-slt-base       - buf_aht-stk-line.cost-slt-base            v-cost-slt-rubl       = v-cost-slt-rubl       - buf_aht-stk-line.cost-slt-rubl            v-cost-road-tax-base  = v-cost-road-tax-base  - buf_aht-stk-line.cost-road-tax-base       v-cost-road-tax-rubl  = v-cost-road-tax-rubl  - buf_aht-stk-line.cost-road-tax-rubl       v-cost-excise-base    = v-cost-excise-base    - buf_aht-stk-line.cost-excise-base         v-cost-excise-rubl    = v-cost-excise-rubl    - buf_aht-stk-line.cost-excise-rubl         v-cost-transport-base = v-cost-transport-base - buf_aht-stk-line.cost-transport-base      v-cost-transport-rubl = v-cost-transport-rubl - buf_aht-stk-line.cost-transport-rubl      v-cost-other-base     = v-cost-other-base     - buf_aht-stk-line.cost-other-base          v-cost-other-rubl     = v-cost-other-rubl     - buf_aht-stk-line.cost-other-rubl          v-cost-discnt-base    = v-cost-discnt-base    - buf_aht-stk-line.cost-discnt-base          v-cost-discnt-rubl    = v-cost-discnt-rubl    - buf_aht-stk-line.cost-discnt-rubl
                                                                                                            v-crsa-sum-base       = v-crsa-sum-base       - buf_aht-stk-line.crsa-sum-base            v-crsa-sum-rubl       = v-crsa-sum-rubl       - buf_aht-stk-line.crsa-sum-rubl            v-crsa-vat-base       = v-crsa-vat-base       - buf_aht-stk-line.crsa-vat-base            v-crsa-vat-rubl       = v-crsa-vat-rubl       - buf_aht-stk-line.crsa-vat-rubl            v-crsa-slt-base       = v-crsa-slt-base       - buf_aht-stk-line.crsa-slt-base            v-crsa-slt-rubl       = v-crsa-slt-rubl       - buf_aht-stk-line.crsa-slt-rubl            v-crsa-road-tax-base  = v-crsa-road-tax-base  - buf_aht-stk-line.crsa-road-tax-base       v-crsa-road-tax-rubl  = v-crsa-road-tax-rubl  - buf_aht-stk-line.crsa-road-tax-rubl       v-crsa-excise-base    = v-crsa-excise-base    - buf_aht-stk-line.crsa-excise-base         v-crsa-excise-rubl    = v-crsa-excise-rubl    - buf_aht-stk-line.crsa-excise-rubl         v-crsa-transport-base = v-crsa-transport-base - buf_aht-stk-line.crsa-transport-base      v-crsa-transport-rubl = v-crsa-transport-rubl - buf_aht-stk-line.crsa-transport-rubl      v-crsa-other-base     = v-crsa-other-base     - buf_aht-stk-line.crsa-other-base          v-crsa-other-rubl     = v-crsa-other-rubl     - buf_aht-stk-line.crsa-other-rubl          v-crsa-discnt-base    = v-crsa-discnt-base    - buf_aht-stk-line.crsa-discnt-base          v-crsa-discnt-rubl    = v-crsa-discnt-rubl    - buf_aht-stk-line.crsa-discnt-rubl
                                                                                                            v-sale-sum-base       = v-sale-sum-base       - buf_aht-stk-line.sale-sum-base            v-sale-sum-rubl       = v-sale-sum-rubl       - buf_aht-stk-line.sale-sum-rubl            v-sale-vat-base       = v-sale-vat-base       - buf_aht-stk-line.sale-vat-base            v-sale-vat-rubl       = v-sale-vat-rubl       - buf_aht-stk-line.sale-vat-rubl            v-sale-slt-base       = v-sale-slt-base       - buf_aht-stk-line.sale-slt-base            v-sale-slt-rubl       = v-sale-slt-rubl       - buf_aht-stk-line.sale-slt-rubl            v-sale-road-tax-base  = v-sale-road-tax-base  - buf_aht-stk-line.sale-road-tax-base       v-sale-road-tax-rubl  = v-sale-road-tax-rubl  - buf_aht-stk-line.sale-road-tax-rubl       v-sale-excise-base    = v-sale-excise-base    - buf_aht-stk-line.sale-excise-base         v-sale-excise-rubl    = v-sale-excise-rubl    - buf_aht-stk-line.sale-excise-rubl         v-sale-transport-base = v-sale-transport-base - buf_aht-stk-line.sale-transport-base      v-sale-transport-rubl = v-sale-transport-rubl - buf_aht-stk-line.sale-transport-rubl      v-sale-other-base     = v-sale-other-base     - buf_aht-stk-line.sale-other-base          v-sale-other-rubl     = v-sale-other-rubl     - buf_aht-stk-line.sale-other-rubl          v-sale-discnt-base    = v-sale-discnt-base    - buf_aht-stk-line.sale-discnt-base          v-sale-discnt-rubl    = v-sale-discnt-rubl    - buf_aht-stk-line.sale-discnt-rubl
          .
        end.
        ...
        then do:
          if
                                                  abs(v-cost-sum-base)       > 0.0000000005 or    abs(v-cost-sum-rubl)       > 0.0000000005 or    abs(v-cost-vat-base)       > 0.0000000005 or    abs(v-cost-vat-rubl)       > 0.0000000005 or    abs(v-cost-slt-base)       > 0.0000000005 or    abs(v-cost-slt-rubl)       > 0.0000000005 or    abs(v-cost-road-tax-base)  > 0.0000000005 or    abs(v-cost-road-tax-rubl)  > 0.0000000005 or    abs(v-cost-excise-base)    > 0.0000000005 or    abs(v-cost-excise-rubl)    > 0.0000000005 or    abs(v-cost-transport-base) > 0.0000000005 or    abs(v-cost-transport-rubl) > 0.0000000005 or    abs(v-cost-other-base)     > 0.0000000005 or    abs(v-cost-other-rubl)     > 0.0000000005 or    abs(v-cost-discnt-base)    > 0.0000000005 or    abs(v-cost-discnt-rubl)    > 0.0000000005
          then do:
            assign
              v-log-error = true
            .
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run file-wr in g#library
  (input v-err-file-name
  ,input substitute('&1,&2,&3,&4,&5,&6,&7,&8,&9':u,'cost':u,p-doc-code,p-artic,p-prod-type,p-prod-code,p-gds-code,p-obj-type,p-obj-code,v-fact-qnty)
  )  .
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run file-wr in g#library
  (input v-err-file-name
  ,input substitute('&1,&2,&3,&4,&5,&6,&7,&8,&9':u,'base':u,v-cost-sum-base,v-cost-vat-base,v-cost-slt-base,v-cost-road-tax-base,v-cost-excise-base,v-cost-transport-base,v-cost-other-base,v-cost-discnt-base)
  )  .
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run file-wr in g#library
  (input v-err-file-name
  ,input substitute('&1,&2,&3,&4,&5,&6,&7,&8,&9':u,'rubl':u,v-cost-sum-rubl,v-cost-vat-rubl,v-cost-slt-rubl,v-cost-road-tax-rubl,v-cost-excise-rubl,v-cost-transport-rubl,v-cost-other-rubl,v-cost-discnt-rubl)
  )  .
