...
define buffer buf_c-wth-par for ub.c-wth-par.
  ...
  :
    ...
    buffer-copy ub.wth-par to buf_c-wth-par
    assign
    buf_c-wth-par.wth-code           = (if p-new-record then ub.wth-par.wth-code else ub.wth-par.wth-code)
    buf_c-wth-par.par-code           = (if p-new-record then ub.wth-par.par-code else ub.wth-par.par-code)
