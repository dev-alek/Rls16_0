...
run trg/userhisto.p (
    input integer('99':U)
    ,input 'user-account-attr':U + "." +  ub.user-account-attr.attr-code
  ...
  run trg/userlog.p (
                      input if user-account-attr.attr-code eq "superadm" then 'delete':U else 'delete':U
                    , input 'user-account':U + if user-account-attr.attr-code eq "superadm" then chr(3) + "SuperAdm" else ""
