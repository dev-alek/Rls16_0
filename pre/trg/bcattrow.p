...
procedure vss-get-parameters :
  define output parameter p-vss-parameters as character no-undo .
    assign
      p-vss-parameters = substitute('&1|&2|&3|&4':u                              ,ub.bar-code-obj-attr.obj-type                              ,ub.bar-code-obj-attr.obj-code                              ,ub.bar-code-obj-attr.b-code                              ,ub.bar-code-obj-attr.attr-code                              )
    .
end procedure.
...
if (valid-handle(g#lib-nws) <> true) then do:   run nws/lib-nws.p persistent no-error .   if error-status :error or (valid-handle(g#lib-nws) <> true) then do:     message       "Error starting nws/lib-nws.p" skip       g#lib-nws skip       g#lib-nws :type skip       g#lib-nws :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run lib-nws_get-hn-option in g#lib-nws
  ...
  ,output v-send
    ...
    if ub.bar-code-obj-attr.obj-type = 'маг':U
    or ub.bar-code-obj-attr.obj-type = 'скл':U then do:
define variable vss-include-info6 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run hostcode in g#library
  (input  ub.bar-code-obj-attr.obj-type
  ,input  ub.bar-code-obj-attr.obj-code
  ,output v-host-code
  )  .
    end.
    create buf_c-bar-code-obj-attr.
    buffer-copy ub.bar-code-obj-attr to buf_c-bar-code-obj-attr
    assign
    buf_c-bar-code-obj-attr.gds-code           = (if p-new-record then ub.bar-code-obj-attr.gds-code else ub.bar-code-obj-attr.gds-code)
    buf_c-bar-code-obj-attr.b-code             = (if p-new-record then ub.bar-code-obj-attr.b-code else ub.bar-code-obj-attr.b-code)
    buf_c-bar-code-obj-attr.attr-code          = (if p-new-record then ub.bar-code-obj-attr.attr-code else ub.bar-code-obj-attr.attr-code)
    buf_c-bar-code-obj-attr.obj-type           = (if p-new-record then ub.bar-code-obj-attr.obj-type else ub.bar-code-obj-attr.obj-type)
    buf_c-bar-code-obj-attr.obj-code           = (if p-new-record then ub.bar-code-obj-attr.obj-code else ub.bar-code-obj-attr.obj-code)
    buf_c-bar-code-obj-attr.chip-num           = next-value (s-gds-chip, ub)
    ...
    buf_c-gds-hist.action = (if p-new-record
                              then integer('1':U)
                              else (if ub.bar-code-obj-attr.gds-code = ub.bar-code-obj-attr.gds-code
                                    and ub.bar-code-obj-attr.b-code  = ub.bar-code-obj-attr.b-code
                                    then p-action
                                    else integer('9':U))
                            )
    buf_c-gds-hist.b-code             = (if buf_c-gds-hist.action = integer('9':U)
                                        and ub.bar-code-obj-attr.b-code  <>  ub.bar-code-obj-attr.b-code
                                        then ub.bar-code-obj-attr.b-code
                                        else ub.bar-code-obj-attr.b-code)
    buf_c-gds-hist.subject = 'bar-code-obj-attr':U
    ...
    if p-action = integer('99':U) then do:
      ...
      OR (g#news
          and not ( g#db-num > 0 )
          and buf_c-bar-code-obj-attr.corr-user-name <> (chr(4) +  'СПН':U)
          )
      or (g#news
          and ( g#db-num > 0 )
          and buf_c-bar-code-obj-attr.corr-user-name = (chr(4) +  'СПН':U)
...
:
  ...
  and not g#db-num = 0 then do:
    ...
    if attr-range = integer('2':U) then do:
