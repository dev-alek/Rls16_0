...
define buffer buf_c-fin-statement-attr for ub.c-fin-statement-attr.
  ...
  :
    ...
    create buf_c-fin-statement-attr.
    buffer-copy oldb to buf_c-fin-statement-attr
    assign
    buf_c-fin-statement-attr.host-code          = (if p-new-record then ub.fin-statement-attr.host-code else oldb.host-code)
    buf_c-fin-statement-attr.sttm-code          = (if p-new-record then ub.fin-statement-attr.sttm-code else oldb.sttm-code)
    buf_c-fin-statement-attr.attr-code          = (if p-new-record then ub.fin-statement-attr.attr-code else oldb.attr-code)
