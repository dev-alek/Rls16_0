...
:
  ...
  or g#db-num <> 0 then do:
    ...
    buf_c-dis-cfg-rule.chip-num           = next-value (s-ref-corr-chip, ub)
    ...
    buf_c-dis-cfg-rule.action = integer(if new(ub.dis-cfg-rule) then '1':U else '2':U)
    .
  end.
  if not g#news
  and g#db-num = 0
