...
define buffer buf_c-gds-grp-attr for ub.c-gds-grp-attr.
  ...
  :
    ...
    buffer-copy oldgds-grp-attr to buf_c-gds-grp-attr
    assign
    buf_c-gds-grp-attr.node-code          = (if p-new-record then ub.gds-grp-attr.node-code else oldgds-grp-attr.node-code)
    buf_c-gds-grp-attr.attr-code          = (if p-new-record then ub.gds-grp-attr.attr-code else  oldgds-grp-attr.attr-code)
    buf_c-gds-grp-attr.host-code          = (if p-new-record then ub.gds-grp-attr.host-code else  oldgds-grp-attr.host-code)
    buf_c-gds-grp-attr.obj-type           = (if p-new-record then ub.gds-grp-attr.obj-type  else  oldgds-grp-attr.obj-type)
    buf_c-gds-grp-attr.obj-code           = (if p-new-record then ub.gds-grp-attr.obj-code  else  oldgds-grp-attr.obj-code)
    ...
    buf_c-gds-grp-hist.is-del = (p-action = integer('99':U))
    .
  end.
end procedure.
