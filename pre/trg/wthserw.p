...
define variable vss-description as character no-undo init "“риггер на запись серий мат.ценностей ".
...
:
  ...
  if not g#news then do:
    ...
    buf_c-wth-ser.chip-num           = next-value (s-wth-chip, ub)
    ...
    buf_c-wth-hist.subject = 'wth-ser':U
