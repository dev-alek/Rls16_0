...
procedure vss-get-parameters :
  define output parameter p-vss-parameters as character no-undo .
    assign
      p-vss-parameters = substitute('&1|&2', ub.fin-code-an-uchet.fin-code, ub.fin-code-an-uchet.host-code)
    .
end procedure.
...
:
  ...
  if not g#news then do:
    ...
    assign
      buf_c-fin-code-an-uchet.chip-num           = next-value (s-corr-chip, ub)
