...
trigger procedure for write of ub.utd-err-attr
  new buffer new-utd-err-attr
  old buffer old-utd-err-attr
.
...
define variable vss-description as character no-undo init "Тригер изменение utd-err-attr".
...
define buffer buf_c-utd-err-attr  for ub.c-utd-err-attr .
define variable v-date      as date      no-undo .
define variable v-time      as integer   no-undo .
...
define buffer buf_c-utd-head for ub.c-utd-head .
      buffer-compare new-utd-err-attr to old-utd-err-attr case-sensitive save result in v-field-chg.
      if v-field-chg > "":U then . else return .
      run cur-time in this-procedure (output v-date, output v-time).
    publish "getNextseq" ("utd-err-attr","s-c-utd-chip-num", "ub", output v-Seq ).
    if v-Seq = ?
    then
    ...
    if vFlagSeq
    then do:
                     if new(new-utd-err-attr)
       then do:
 for first buf_c-utd-err-attr where buf_c-utd-err-attr.db-num eq new-utd-err-attr.db-num
and buf_c-utd-err-attr.doc-id eq new-utd-err-attr.doc-id
and buf_c-utd-err-attr.CheckType eq new-utd-err-attr.CheckType
and buf_c-utd-err-attr.CodeErr eq new-utd-err-attr.CodeErr
and buf_c-utd-err-attr.CheckObj eq new-utd-err-attr.CheckObj
and buf_c-utd-err-attr.reckey eq new-utd-err-attr.reckey
and buf_c-utd-err-attr.attr-code eq new-utd-err-attr.attr-code
  and buf_c-utd-err-attr.corr-user-db-num   = g#db-num and buf_c-utd-err-attr.chip-num = v-Seq exclusive-lock: leave. end.
       end.
       else do:
 for first buf_c-utd-err-attr where buf_c-utd-err-attr.db-num eq old-utd-err-attr.db-num
and buf_c-utd-err-attr.doc-id eq old-utd-err-attr.doc-id
and buf_c-utd-err-attr.CheckType eq old-utd-err-attr.CheckType
and buf_c-utd-err-attr.CodeErr eq old-utd-err-attr.CodeErr
and buf_c-utd-err-attr.CheckObj eq old-utd-err-attr.CheckObj
and buf_c-utd-err-attr.reckey eq old-utd-err-attr.reckey
and buf_c-utd-err-attr.attr-code eq old-utd-err-attr.attr-code
  and buf_c-utd-err-attr.corr-user-db-num   = g#db-num and buf_c-utd-err-attr.chip-num = v-Seq exclusive-lock: leave. end.
       end.
    end.
   if new(new-utd-err-attr)
   then do:
      if not available buf_c-utd-err-attr
      then do:
         create buf_c-utd-err-attr.
      buffer-copy new-utd-err-attr to buf_c-utd-err-attr
      assign
         buf_c-utd-err-attr.chip-num           = v-Seq
         buf_c-utd-err-attr.corr-date          = v-date
         buf_c-utd-err-attr.corr-time          = v-time
         buf_c-utd-err-attr.corr-user-db-num   = g#db-num
         buf_c-utd-err-attr.corr-user-name     = (if g#news then (chr(4) +  'СПН':U) + " " else "") + g#userid
         buf_c-utd-err-attr.action             = 1
         buf_c-utd-err-attr.is-del             = false
      .
      end.
      else
         if buf_c-utd-err-attr.action eq 99
         then
            buf_c-utd-err-attr.action = 2.
   end.
   else do:
      if not available buf_c-utd-err-attr
      then do:
         create buf_c-utd-err-attr.
         buffer-copy old-utd-err-attr to buf_c-utd-err-attr
         assign
            buf_c-utd-err-attr.chip-num           = v-Seq
            buf_c-utd-err-attr.corr-date          = v-date
            buf_c-utd-err-attr.corr-time          = v-time
            buf_c-utd-err-attr.corr-user-db-num   = g#db-num
            buf_c-utd-err-attr.corr-user-name     = (if g#news then (chr(4) +  'СПН':U) + " " else "") + g#userid
            buf_c-utd-err-attr.action             = 2 when buf_c-utd-err-attr.action ne 1
            buf_c-utd-err-attr.is-del             = false
         .
      end.
   end.
      ...
      then do:
         if new(new-utd-err-attr)
         then do:
 for first buf_c-utd-head where buf_c-utd-head.db-num eq new-utd-err-attr.db-num
and buf_c-utd-head.doc-id eq new-utd-err-attr.doc-id
  and buf_c-utd-head.corr-user-db-num   = g#db-num and buf_c-utd-head.chip-num = v-Seq exclusive-lock: leave. end.
         end.
         else do:
 for first buf_c-utd-head where buf_c-utd-head.db-num eq old-utd-err-attr.db-num
and buf_c-utd-head.doc-id eq old-utd-err-attr.doc-id
  and buf_c-utd-head.corr-user-db-num   = g#db-num and buf_c-utd-head.chip-num = v-Seq exclusive-lock: leave. end.
         end.
      end.
      ...
      then do:
         ...
         buffer-copy  buf_c-utd-err-attr to buf_c-utd-head
         assign
            buf_c-utd-head.subject = "utd-err-attr"
  ...
  if not g#news then do :
       ...
       if     available old-utd-err-attr
          and not new(new-utd-err-attr)
       then do:
          buffer-compare new-utd-err-attr
                using db-num doc-id CheckType CodeErr CheckObj reckey attr-code
                to old-utd-err-attr
                case-sensitive
          ...
          then do:
             run nws/cmd-del.p
                 ( input 'utd-err-attr':U
                  ,input (buffer old-utd-err-attr:handle)
                  ,input "":U
                 ) no-error .
             if error-status :error then do:
                message
                   vss-workfile vss-revision vss-description skip
                   "Невозможно маршрутизировать удаление utd-err-attr для отправки в новости" skip
     ...
     run str/callnews.p
      (input 'utd-err-attr':U
      ,input (buffer ub.new-utd-err-attr:handle)
      ) no-error.
    if error-status :error then do:
      message
        vss-workfile vss-revision vss-description skip
        "Невозможно маршрутизировать utd-err-attr для отправки в новости" skip
        error-status :get-message(1) skip
        return-value skip
        view-as alert-box error .
      undo , return error return-value .
