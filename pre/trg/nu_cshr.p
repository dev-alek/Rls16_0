...
procedure vss-get-parameters :
  define output parameter p-vss-parameters as character no-undo .
    assign
      p-vss-parameters = substitute('&1|&2|&3|&4|&5|&6',p-cashier,p-psn-code,p-host-code,p-obj-type,p-obj-code,p-action)
    .
end procedure.
...
:
  find first ub.batchprocess no-lock
    where ub.batchprocess.bp_type   = 'cshr':U
      ...
      and ub.batchprocess.charkey_one = string(p-cashier)
      and ub.batchprocess.charkey_two = p-obj-type
      and ub.batchprocess.charkey_three = p-c-password
  no-error .
  if not available ub.BatchProcess then do:
    ...
    assign
      ub.BatchProcess.BP_Type       = 'cshr':U
    ...
    assign
      ...
      ub.BatchProcess.CharKey_One   = string(p-cashier)
      ub.BatchProcess.CharKey_Two   = p-obj-type
      ub.BatchProcess.CharKey_Three = p-c-password
    .
  end.
