...
define buffer buf_c-tax-rate-gds-grp for ub.c-tax-rate-gds-grp.
  ...
  :
    ...
    buffer-copy old-tax-rate-gds-grp to buf_c-tax-rate-gds-grp
    assign
    buf_c-tax-rate-gds-grp.node-code          = (if p-new-record then ub.tax-rate-gds-grp.node-code else old-tax-rate-gds-grp.node-code)
    buf_c-tax-rate-gds-grp.tax-code           = (if p-new-record then ub.tax-rate-gds-grp.tax-code else old-tax-rate-gds-grp.tax-code)
    buf_c-tax-rate-gds-grp.host-code          = (if p-new-record then ub.tax-rate-gds-grp.host-code else  old-tax-rate-gds-grp.host-code)
    buf_c-tax-rate-gds-grp.obj-type           = (if p-new-record then ub.tax-rate-gds-grp.obj-type  else  old-tax-rate-gds-grp.obj-type)
    buf_c-tax-rate-gds-grp.obj-code           = (if p-new-record then ub.tax-rate-gds-grp.obj-code  else  old-tax-rate-gds-grp.obj-code)
