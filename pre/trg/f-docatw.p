...
procedure vss-get-parameters :
  define output parameter p-vss-parameters as character no-undo .
    assign
      p-vss-parameters = substitute('&1|&2|&3', ub.fin-doc-attr.host-code, ub.fin-doc-attr.fin-doc-code, ub.fin-doc-attr.attr-code)
    .
end procedure.
...
define buffer buf_c-fin-doc-attr for ub.c-fin-doc-attr.
  ...
  :
    ...
    create buf_c-fin-doc-attr.
    buffer-copy oldb to buf_c-fin-doc-attr
    assign
    buf_c-fin-doc-attr.host-code          = (if p-new-record then ub.fin-doc-attr.host-code else oldb.host-code)
    buf_c-fin-doc-attr.fin-doc-code       = (if p-new-record then ub.fin-doc-attr.fin-doc-code else oldb.fin-doc-code)
    buf_c-fin-doc-attr.attr-code          = (if p-new-record then ub.fin-doc-attr.attr-code else oldb.attr-code)
