...
:
  ...
  if not g#news then do:
    ...
    buf_c-wth-gds.chip-num           = next-value (s-wth-chip, ub)
    ...
    buf_c-wth-hist.subject = 'wth-gds':U
    buf_c-wth-hist.is-news = g#news
    buf_c-wth-hist.source-type = (if g#news then 'db':U else "":U)
    ...
    to buf_c-gds-hist
    assign
    buf_c-gds-hist.action = (if new wth-gds then integer('1':U) else integer('2':U))
    buf_c-gds-hist.subject = 'wth-gds':U
    ...
    buf_c-table-bind.tbl-name-src   = 'c-wth-hist':U
    buf_c-table-bind.is-news         = g#news
    buf_c-table-bind.corr-user-name  = g#userid
    buf_c-table-bind.subject         = 'wth-gds':U
    .
  end.
end.
