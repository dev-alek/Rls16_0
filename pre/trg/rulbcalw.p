       ...
       if ub.rule-by-call.call#_id = 0 then do:
         case entry(1, ub.rule-by-call.call_Id, chr(3)):
           when 'dis-card-type':U then do:
             v-call-id-type = 'dis-card-type':U.
           end.
         end case.
         run rul/g-callid.p (
      ...
      if entry(1, ub.rule-by-call.call_id, chr(3)) <> 'layout-elem-rule':U then do:
        ...
        case entry(1, ub.rule-by-call.call_id, chr(3)):
          when 'dis-card-type':U then do:
            ...
            buf_c-dis-card-type.action = (if new ub.rule-by-call then integer('1':U) else integer('2':U))
          ...
          when 'thbj-attr':U then do:
            ...
            buf_c-thbj-attr.action = (if new ub.rule-by-call then integer('1':U) else integer('2':U))
