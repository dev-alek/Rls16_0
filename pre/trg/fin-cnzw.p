...
procedure vss-get-parameters :
  define output parameter p-vss-parameters as character no-undo .
    assign
      p-vss-parameters = substitute('&1|&2', ub.fin-code-cel-nazn.fin-code, ub.fin-code-cel-nazn.host-code)
    .
end procedure.
...
:
  ...
  if not g#news then do:
    ...
    assign
      buf_c-fin-code-cel-nazn.chip-num           = next-value (s-corr-chip, ub)
