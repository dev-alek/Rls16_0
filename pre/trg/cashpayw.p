...
do
    ...
    buffer-copy oldb to buf_c-cash-pay
        ...
        buf_c-cash-pay.chip-num           = next-value (s-corr-chip, ub)
        ...
        buf_c-cash-pay.action = (if new ub.cash-pay then integer('1':U) else integer('2':U))
        buf_c-cash-pay.subject = 'cash-pay':U
        .
