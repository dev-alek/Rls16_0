...
trigger procedure for delete of ub.order-line-attr.
define variable vss-revision    as character no-undo initial "$Revision$":U.
define variable vss-author      as character no-undo initial "$Author$":U.
define variable vss-date        as character no-undo initial "$Date$":U.
define variable vss-workfile    as character no-undo initial "$Workfile$":U.
define variable vss-archive     as character no-undo initial "$Archive$":U.
define variable vss-description as character no-undo init "Триггер на delete order-line-attr".
...
define buffer buf_c-order-head for ub.c-order-head .
    ...
    if vFlagseq
    then do:
 for first buf_c-order-line-attr where buf_c-order-line-attr.db-num eq order-line-attr.db-num
and buf_c-order-line-attr.doc-code eq order-line-attr.doc-code
and buf_c-order-line-attr.line-num eq order-line-attr.line-num
and buf_c-order-line-attr.attr-code eq order-line-attr.attr-code
  and buf_c-order-line-attr.corr-user-db-num   = g#db-num and buf_c-order-line-attr.chip-num = v-Seq exclusive-lock: leave. end.
    ...
    then do:
       ...
       buffer-copy ub.order-line-attr to buf_c-order-line-attr
       assign
         ...
         buf_c-order-line-attr.action             = 99
         buf_c-order-line-attr.is-del             = true
       .
    end.
    else
       buf_c-order-line-attr.action             = 99.
      if vFlagSeq
      then do:
 for first buf_c-order-head where buf_c-order-head.db-num eq order-line-attr.db-num
and buf_c-order-head.doc-code eq order-line-attr.doc-code
