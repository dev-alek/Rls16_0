...
trigger procedure for delete of ub.utd-lines.
define variable vss-revision    as character no-undo initial "$Revision$":U .
define variable vss-author      as character no-undo initial "$Author$":U .
define variable vss-date        as character no-undo initial "$Date$":U .
define variable vss-workfile    as character no-undo initial "$Workfile$":U .
define variable vss-archive     as character no-undo initial "$Archive$":U .
define variable vss-description as character no-undo init "Тригер удаления utd-lines".
...
define buffer buf_c-utd-head for ub.c-utd-head .
    ...
    if vFlagseq
    then do:
 for first buf_c-utd-lines where buf_c-utd-lines.db-num eq utd-lines.db-num
and buf_c-utd-lines.doc-id eq utd-lines.doc-id
and buf_c-utd-lines.LineNum eq utd-lines.LineNum
  and buf_c-utd-lines.corr-user-db-num   = g#db-num and buf_c-utd-lines.chip-num = v-Seq exclusive-lock: leave. end.
    ...
    then do:
       ...
       buffer-copy ub.utd-lines to buf_c-utd-lines
       assign
         ...
         buf_c-utd-lines.action             = 99
         buf_c-utd-lines.is-del             = true
       .
    end.
    else
       buf_c-utd-lines.action             = 99.
      if vFlagSeq
      then do:
 for first buf_c-utd-head where buf_c-utd-head.db-num eq utd-lines.db-num
and buf_c-utd-head.doc-id eq utd-lines.doc-id
...
for each utd-lines-attr where utd-lines-attr.db-num eq  utd-lines.db-num
                            and utd-lines-attr.doc-id eq  utd-lines.doc-id
                            and utd-lines-attr.linenum eq  utd-lines.linenum
exclusive-lock:
