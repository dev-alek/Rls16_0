...
procedure vss-get-parameters :
  define output parameter p-vss-parameters as character no-undo .
    assign
      p-vss-parameters = substitute('&1|&2|&3|&4',p-obj-type,p-obj-code,p-source-db-num,p-target-db-num)
    .
end procedure.
...
:
  find first ub.batchprocess no-lock
    where ub.batchprocess.bp_type   = 'mvob':U
      and ub.batchprocess.bp_status = 'N':U
      and  ub.batchprocess.key#_one  = p-obj-code
      and ub.batchprocess.key#_two = p-source-db-num
      and ub.batchprocess.key#_three = p-target-db-num
  ...
  if not available ub.BatchProcess then do:
    ...
    assign
      ub.BatchProcess.BP_Type       = 'mvob':U
    ...
    assign
      ...
      ub.BatchProcess.Key#_Two      = p-source-db-num
      ub.BatchProcess.Key#_Three    = p-target-db-num
