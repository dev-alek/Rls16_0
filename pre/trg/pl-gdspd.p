...
do
    ...
    if not g#news then
    do:
        run nws/cmd-del.p ( input 'pl-gds-pump':U
        ...
        do:
            ...
            do jj = 1 to error-status :num-messages :
                assign
                    str1 = str1 + chr(10) + error-status :get-message ( jj ).
            end.
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run hostcode in g#library
  (input  ub.pl-gds-pump.obj-type
  ,input  ub.pl-gds-pump.obj-code
  ,output v-host-code
  )  .
        run gen-key-rec in this-procedure ( input 'pl-gds-pump':U
            ,input buffer ub.pl-gds-pump:handle
        ...
        buffer-copy buf_c-pl-gds-pump
            ...
            buf_c-pmp-hist.action = integer('99':U)
