...
trigger procedure for delete of ub.utd-err-attr.
define variable vss-revision    as character no-undo initial "$Revision$":U .
define variable vss-author      as character no-undo initial "$Author$":U .
define variable vss-date        as character no-undo initial "$Date$":U .
define variable vss-workfile    as character no-undo initial "$Workfile$":U .
define variable vss-archive     as character no-undo initial "$Archive$":U .
define variable vss-description as character no-undo init "Тригер удаления utd-err-attr".
...
define buffer buf_c-utd-head for ub.c-utd-head .
    ...
    if vFlagseq
    then do:
 for first buf_c-utd-err-attr where buf_c-utd-err-attr.db-num eq utd-err-attr.db-num
and buf_c-utd-err-attr.doc-id eq utd-err-attr.doc-id
and buf_c-utd-err-attr.CheckType eq utd-err-attr.CheckType
and buf_c-utd-err-attr.CodeErr eq utd-err-attr.CodeErr
and buf_c-utd-err-attr.CheckObj eq utd-err-attr.CheckObj
and buf_c-utd-err-attr.reckey eq utd-err-attr.reckey
and buf_c-utd-err-attr.attr-code eq utd-err-attr.attr-code
  and buf_c-utd-err-attr.corr-user-db-num   = g#db-num and buf_c-utd-err-attr.chip-num = v-Seq exclusive-lock: leave. end.
    ...
    then do:
       ...
       buffer-copy ub.utd-err-attr to buf_c-utd-err-attr
       assign
         ...
         buf_c-utd-err-attr.action             = 99
         buf_c-utd-err-attr.is-del             = true
       .
    end.
    else
       buf_c-utd-err-attr.action             = 99.
      if vFlagSeq
      then do:
 for first buf_c-utd-head where buf_c-utd-head.db-num eq utd-err-attr.db-num
and buf_c-utd-head.doc-id eq utd-err-attr.doc-id
  ...
  if not g#news then do :
    run nws/cmd-del.p
      ( input 'utd-err-attr':U
       ,input (buffer ub.utd-err-attr:handle)
       ,input "":U
      ) no-error .
