...
procedure vss-get-parameters :
  define output parameter p-vss-parameters as character no-undo .
    assign
      p-vss-parameters = substitute('&1|&2|&3',newb.obj-type,newb.obj-code,newb.pl-code)
    .
end procedure.
  ...
  if g#news <> yes then do:
    ...
    buffer-copy oldb except obj-type obj-code pl-code
         ...
         assign buf_c-pl-level.obj-type         = newb.obj-type
                ...
                buf_c-pl-level.chip-num         = next-value( s-corr-chip, ub )
                ...
                buf_c-pl-level.action           = ( if new newb then integer( '1':U ) else integer( '2':U ) ).
  end.
    if g#oxml = yes
    then do:
    run str/calloxml.p (
