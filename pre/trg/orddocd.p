...
trigger procedure for delete of ub.order-doc.
define variable vss-revision    as character no-undo initial "$Revision$":U .
define variable vss-author      as character no-undo initial "$Author$":U .
define variable vss-date        as character no-undo initial "$Date$":U .
define variable vss-workfile    as character no-undo initial "$Workfile$":U .
define variable vss-archive     as character no-undo initial "$Archive$":U .
define variable vss-description as character no-undo init "Тригер удаления order-doc".
define buffer buf_order-doc-attr for ub.order-doc-attr.
define buffer buf_order-line for ub.order-line.
for each buf_order-doc-attr where
         buf_order-doc-attr.db-num   = order-doc.db-num
     and buf_order-doc-attr.doc-code = order-doc.doc-code
    exclusive-lock:
  delete buf_order-doc-attr.
end.
for each buf_order-line where
         buf_order-line.db-num   = order-doc.db-num
     and buf_order-line.doc-code = order-doc.doc-code
    exclusive-lock:
...
define buffer buf_c-order-head for ub.c-order-head .
    ...
    if vFlagseq
    then do:
 for first buf_c-order-doc where buf_c-order-doc.db-num eq order-doc.db-num
and buf_c-order-doc.doc-code eq order-doc.doc-code
  and buf_c-order-doc.corr-user-db-num   = g#db-num and buf_c-order-doc.chip-num = v-Seq exclusive-lock: leave. end.
    ...
    then do:
       ...
       buffer-copy ub.order-doc to buf_c-order-doc
       assign
         ...
         buf_c-order-doc.action             = 99
         buf_c-order-doc.is-del             = true
       .
    end.
    else
       buf_c-order-doc.action             = 99.
      if vFlagSeq
      then do:
 for first buf_c-order-head where buf_c-order-head.db-num eq order-doc.db-num
and buf_c-order-head.doc-code eq order-doc.doc-code
