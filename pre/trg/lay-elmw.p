...
:
  ...
  if not g#news then do:
    ...
    buf_c-layout-elem.chip-num           = next-value (s-ref-corr-chip, ub)
    ...
    buf_c-layout-elem.action = integer(if new(ub.layout-elem) then '1':U else '2':U)
    buf_c-layout-elem.subject = 'layout-elem':U
    .
  end.
  if not g#news
  then do:
