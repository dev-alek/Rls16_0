...
procedure vss-get-parameters :
  define output parameter p-vss-parameters as character no-undo .
    assign
      p-vss-parameters = substitute('&1|&2|&3|&4|&5':u,p-handle-callback,p-obj-type,p-obj-code,p-new-start-date,p-current-start-date)
    .
end procedure.
    ...
    :
      ...
      then do:
        ...
        export stream ahtlog
          vss-include-info1 buf_temp-aht-ot-tot.doc-code .
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run curr-r-b in g#library
  ...
  run factord-cut-archive in this-procedure
    (input  p-obj-type
    ,input  p-obj-code
    ,input  p-current-start-date
    ,output v-old-shift-on
    ,output v-old-shift-date
    ,output v-old-shift-num
    ,output v-old-day-end-fact-order
    ,output v-old-shift-end-fact-order
    ) .
  run doclslib-clear-doc-list in this-procedure .
  run doclslib-init-trn-doc in this-procedure
    (input p-obj-type
    ,input p-obj-code
    ,input p-new-start-date + 1
    ) no-error .
  if error-status :error
  then do:
    message
    ...
    :
      ...
      :
        ...
        or (v-need-copy-crsa-cost = false
            and lookup(v-sum-type , 'r':U + chr(44) + 'c':U
                    + chr(44) + 'b':U + chr(44) + 's':U
                    + chr(44) + 'v':U + chr(44) + 'o':U
                      ) = 0
           )
        then do:
          assign
            buf_temp-aht-stk-line.fact-qnty  = buf_aht-stk-line.fact-qnty
                                                                                    buf_temp-aht-stk-line.cost-sum-base       = buf_aht-stk-line.cost-sum-base             buf_temp-aht-stk-line.cost-sum-rubl       = buf_aht-stk-line.cost-sum-rubl             buf_temp-aht-stk-line.cost-vat-base       = buf_aht-stk-line.cost-vat-base             buf_temp-aht-stk-line.cost-vat-rubl       = buf_aht-stk-line.cost-vat-rubl             buf_temp-aht-stk-line.cost-slt-base       = buf_aht-stk-line.cost-slt-base             buf_temp-aht-stk-line.cost-slt-rubl       = buf_aht-stk-line.cost-slt-rubl             buf_temp-aht-stk-line.cost-road-tax-base  = buf_aht-stk-line.cost-road-tax-base        buf_temp-aht-stk-line.cost-road-tax-rubl  = buf_aht-stk-line.cost-road-tax-rubl        buf_temp-aht-stk-line.cost-excise-base    = buf_aht-stk-line.cost-excise-base          buf_temp-aht-stk-line.cost-excise-rubl    = buf_aht-stk-line.cost-excise-rubl          buf_temp-aht-stk-line.cost-transport-base = buf_aht-stk-line.cost-transport-base       buf_temp-aht-stk-line.cost-transport-rubl = buf_aht-stk-line.cost-transport-rubl       buf_temp-aht-stk-line.cost-other-base     = buf_aht-stk-line.cost-other-base           buf_temp-aht-stk-line.cost-other-rubl     = buf_aht-stk-line.cost-other-rubl           buf_temp-aht-stk-line.cost-discnt-base    = buf_aht-stk-line.cost-discnt-base          buf_temp-aht-stk-line.cost-discnt-rubl    = buf_aht-stk-line.cost-discnt-rubl
                                                                                    buf_temp-aht-stk-line.crsa-sum-base       = buf_aht-stk-line.crsa-sum-base             buf_temp-aht-stk-line.crsa-sum-rubl       = buf_aht-stk-line.crsa-sum-rubl             buf_temp-aht-stk-line.crsa-vat-base       = buf_aht-stk-line.crsa-vat-base             buf_temp-aht-stk-line.crsa-vat-rubl       = buf_aht-stk-line.crsa-vat-rubl             buf_temp-aht-stk-line.crsa-slt-base       = buf_aht-stk-line.crsa-slt-base             buf_temp-aht-stk-line.crsa-slt-rubl       = buf_aht-stk-line.crsa-slt-rubl             buf_temp-aht-stk-line.crsa-road-tax-base  = buf_aht-stk-line.crsa-road-tax-base        buf_temp-aht-stk-line.crsa-road-tax-rubl  = buf_aht-stk-line.crsa-road-tax-rubl        buf_temp-aht-stk-line.crsa-excise-base    = buf_aht-stk-line.crsa-excise-base          buf_temp-aht-stk-line.crsa-excise-rubl    = buf_aht-stk-line.crsa-excise-rubl          buf_temp-aht-stk-line.crsa-transport-base = buf_aht-stk-line.crsa-transport-base       buf_temp-aht-stk-line.crsa-transport-rubl = buf_aht-stk-line.crsa-transport-rubl       buf_temp-aht-stk-line.crsa-other-base     = buf_aht-stk-line.crsa-other-base           buf_temp-aht-stk-line.crsa-other-rubl     = buf_aht-stk-line.crsa-other-rubl           buf_temp-aht-stk-line.crsa-discnt-base    = buf_aht-stk-line.crsa-discnt-base          buf_temp-aht-stk-line.crsa-discnt-rubl    = buf_aht-stk-line.crsa-discnt-rubl
          .
        end.
        assign
                                                                      buf_temp-aht-stk-line.sale-sum-base       = buf_aht-stk-line.sale-sum-base             buf_temp-aht-stk-line.sale-sum-rubl       = buf_aht-stk-line.sale-sum-rubl             buf_temp-aht-stk-line.sale-vat-base       = buf_aht-stk-line.sale-vat-base             buf_temp-aht-stk-line.sale-vat-rubl       = buf_aht-stk-line.sale-vat-rubl             buf_temp-aht-stk-line.sale-slt-base       = buf_aht-stk-line.sale-slt-base             buf_temp-aht-stk-line.sale-slt-rubl       = buf_aht-stk-line.sale-slt-rubl             buf_temp-aht-stk-line.sale-road-tax-base  = buf_aht-stk-line.sale-road-tax-base        buf_temp-aht-stk-line.sale-road-tax-rubl  = buf_aht-stk-line.sale-road-tax-rubl        buf_temp-aht-stk-line.sale-excise-base    = buf_aht-stk-line.sale-excise-base          buf_temp-aht-stk-line.sale-excise-rubl    = buf_aht-stk-line.sale-excise-rubl          buf_temp-aht-stk-line.sale-transport-base = buf_aht-stk-line.sale-transport-base       buf_temp-aht-stk-line.sale-transport-rubl = buf_aht-stk-line.sale-transport-rubl       buf_temp-aht-stk-line.sale-other-base     = buf_aht-stk-line.sale-other-base           buf_temp-aht-stk-line.sale-other-rubl     = buf_aht-stk-line.sale-other-rubl           buf_temp-aht-stk-line.sale-discnt-base    = buf_aht-stk-line.sale-discnt-base          buf_temp-aht-stk-line.sale-discnt-rubl    = buf_aht-stk-line.sale-discnt-rubl
        .
      end.
    end.
...
procedure process-gds-obj :
  ...
  define variable v-aht-type-list   as character extent 6 no-undo
    initial ['r':U, 'c':U, 'b':U, 's':U, 'o':U, 'v':U] .
  ...
  define variable v-fact-qnty as decimal   no-undo .
          define variable v-cost-sum-base       as decimal   no-undo .     define variable v-cost-sum-rubl       as decimal   no-undo .     define variable v-cost-vat-base       as decimal   no-undo .     define variable v-cost-vat-rubl       as decimal   no-undo .     define variable v-cost-slt-base       as decimal   no-undo .     define variable v-cost-slt-rubl       as decimal   no-undo .     define variable v-cost-road-tax-base  as decimal   no-undo .     define variable v-cost-road-tax-rubl  as decimal   no-undo .     define variable v-cost-excise-base    as decimal   no-undo .     define variable v-cost-excise-rubl    as decimal   no-undo .     define variable v-cost-transport-base as decimal   no-undo .     define variable v-cost-transport-rubl as decimal   no-undo .     define variable v-cost-other-base     as decimal   no-undo .     define variable v-cost-other-rubl     as decimal   no-undo .     define variable v-cost-discnt-base    as decimal   no-undo .     define variable v-cost-discnt-rubl    as decimal   no-undo .
          define variable v-crsa-sum-base       as decimal   no-undo .     define variable v-crsa-sum-rubl       as decimal   no-undo .     define variable v-crsa-vat-base       as decimal   no-undo .     define variable v-crsa-vat-rubl       as decimal   no-undo .     define variable v-crsa-slt-base       as decimal   no-undo .     define variable v-crsa-slt-rubl       as decimal   no-undo .     define variable v-crsa-road-tax-base  as decimal   no-undo .     define variable v-crsa-road-tax-rubl  as decimal   no-undo .     define variable v-crsa-excise-base    as decimal   no-undo .     define variable v-crsa-excise-rubl    as decimal   no-undo .     define variable v-crsa-transport-base as decimal   no-undo .     define variable v-crsa-transport-rubl as decimal   no-undo .     define variable v-crsa-other-base     as decimal   no-undo .     define variable v-crsa-other-rubl     as decimal   no-undo .     define variable v-crsa-discnt-base    as decimal   no-undo .     define variable v-crsa-discnt-rubl    as decimal   no-undo .
          define variable v-sale-sum-base       as decimal   no-undo .     define variable v-sale-sum-rubl       as decimal   no-undo .     define variable v-sale-vat-base       as decimal   no-undo .     define variable v-sale-vat-rubl       as decimal   no-undo .     define variable v-sale-slt-base       as decimal   no-undo .     define variable v-sale-slt-rubl       as decimal   no-undo .     define variable v-sale-road-tax-base  as decimal   no-undo .     define variable v-sale-road-tax-rubl  as decimal   no-undo .     define variable v-sale-excise-base    as decimal   no-undo .     define variable v-sale-excise-rubl    as decimal   no-undo .     define variable v-sale-transport-base as decimal   no-undo .     define variable v-sale-transport-rubl as decimal   no-undo .     define variable v-sale-other-base     as decimal   no-undo .     define variable v-sale-other-rubl     as decimal   no-undo .     define variable v-sale-discnt-base    as decimal   no-undo .     define variable v-sale-discnt-rubl    as decimal   no-undo .
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run consvtpc in g#library
  ...
  ,output v-cons-vat-pc
      ...
      :
        ...
        if
                                        v-cost-sum-base       = ? or    v-cost-sum-rubl       = ? or    v-cost-vat-base       = ? or    v-cost-vat-rubl       = ? or    v-cost-slt-base       = ? or    v-cost-slt-rubl       = ? or    v-cost-road-tax-base  = ? or    v-cost-road-tax-rubl  = ? or    v-cost-excise-base    = ? or    v-cost-excise-rubl    = ? or    v-cost-transport-base = ? or    v-cost-transport-rubl = ? or    v-cost-other-base     = ? or    v-cost-other-rubl     = ? or    v-cost-discnt-base    = ? or    v-cost-discnt-rubl    = ?
        then do:
          message
            vss-workfile vss-revision vss-description skip
            ...
            "Тип суммы" v-allsum-sum-type skip
                                                                                    "cost-sum-base"       v-cost-sum-base        skip     "cost-sum-rubl"       v-cost-sum-rubl        skip     "cost-vat-base"       v-cost-vat-base        skip     "cost-vat-rubl"       v-cost-vat-rubl        skip     "cost-slt-base"       v-cost-slt-base        skip     "cost-slt-rubl"       v-cost-slt-rubl        skip     "cost-road-tax-base"  v-cost-road-tax-base   skip     "cost-road-tax-rubl"  v-cost-road-tax-rubl   skip     "cost-excise-base"    v-cost-excise-base     skip     "cost-excise-rubl"    v-cost-excise-rubl     skip     "cost-transport-base" v-cost-transport-base  skip     "cost-transport-rubl" v-cost-transport-rubl  skip     "cost-other-base"     v-cost-other-base      skip     "cost-other-rubl"     v-cost-other-rubl      skip     "cost-discnt-base"    v-cost-discnt-base     skip     "cost-discnt-rubl"    v-cost-discnt-rubl     skip
            view-as alert-box error .
          undo, return error return-value .
        end.
        if
                                        v-crsa-sum-base       = ? or    v-crsa-sum-rubl       = ? or    v-crsa-vat-base       = ? or    v-crsa-vat-rubl       = ? or    v-crsa-slt-base       = ? or    v-crsa-slt-rubl       = ? or    v-crsa-road-tax-base  = ? or    v-crsa-road-tax-rubl  = ? or    v-crsa-excise-base    = ? or    v-crsa-excise-rubl    = ? or    v-crsa-transport-base = ? or    v-crsa-transport-rubl = ? or    v-crsa-other-base     = ? or    v-crsa-other-rubl     = ? or    v-crsa-discnt-base    = ? or    v-crsa-discnt-rubl    = ?
        then do:
          message
            vss-workfile vss-revision vss-description skip
            "Программа clcprtsl.i вернула неопределенные значения" skip
            "Объект" p-obj-type p-obj-code skip
            "Код товара" p-gds-code skip
                                                                                    "v-crsa-sum-base"       v-crsa-sum-base        skip     "v-crsa-sum-rubl"       v-crsa-sum-rubl        skip     "v-crsa-vat-base"       v-crsa-vat-base        skip     "v-crsa-vat-rubl"       v-crsa-vat-rubl        skip     "v-crsa-slt-base"       v-crsa-slt-base        skip     "v-crsa-slt-rubl"       v-crsa-slt-rubl        skip     "v-crsa-road-tax-base"  v-crsa-road-tax-base   skip     "v-crsa-road-tax-rubl"  v-crsa-road-tax-rubl   skip     "v-crsa-excise-base"    v-crsa-excise-base     skip     "v-crsa-excise-rubl"    v-crsa-excise-rubl     skip     "v-crsa-transport-base" v-crsa-transport-base  skip     "v-crsa-transport-rubl" v-crsa-transport-rubl  skip     "v-crsa-other-base"     v-crsa-other-base      skip     "v-crsa-other-rubl"     v-crsa-other-rubl      skip     "v-crsa-discnt-base"    v-crsa-discnt-base     skip     "v-crsa-discnt-rubl"    v-crsa-discnt-rubl     skip
            view-as alert-box error .
          undo, return error return-value .
        end.
        assign
        ...
        if v-fact-qnty <> 0
        or
                                        v-cost-sum-base       <> 0 or    v-cost-sum-rubl       <> 0 or    v-cost-vat-base       <> 0 or    v-cost-vat-rubl       <> 0 or    v-cost-slt-base       <> 0 or    v-cost-slt-rubl       <> 0 or    v-cost-road-tax-base  <> 0 or    v-cost-road-tax-rubl  <> 0 or    v-cost-excise-base    <> 0 or    v-cost-excise-rubl    <> 0 or    v-cost-transport-base <> 0 or    v-cost-transport-rubl <> 0 or    v-cost-other-base     <> 0 or    v-cost-other-rubl     <> 0 or    v-cost-discnt-base    <> 0 or    v-cost-discnt-rubl    <> 0
        or
                                        v-crsa-sum-base       <> 0 or    v-crsa-sum-rubl       <> 0 or    v-crsa-vat-base       <> 0 or    v-crsa-vat-rubl       <> 0 or    v-crsa-slt-base       <> 0 or    v-crsa-slt-rubl       <> 0 or    v-crsa-road-tax-base  <> 0 or    v-crsa-road-tax-rubl  <> 0 or    v-crsa-excise-base    <> 0 or    v-crsa-excise-rubl    <> 0 or    v-crsa-transport-base <> 0 or    v-crsa-transport-rubl <> 0 or    v-crsa-other-base     <> 0 or    v-crsa-other-rubl     <> 0 or    v-crsa-discnt-base    <> 0 or    v-crsa-discnt-rubl    <> 0
        or
                                        v-sale-sum-base       <> 0 or    v-sale-sum-rubl       <> 0 or    v-sale-vat-base       <> 0 or    v-sale-vat-rubl       <> 0 or    v-sale-slt-base       <> 0 or    v-sale-slt-rubl       <> 0 or    v-sale-road-tax-base  <> 0 or    v-sale-road-tax-rubl  <> 0 or    v-sale-excise-base    <> 0 or    v-sale-excise-rubl    <> 0 or    v-sale-transport-base <> 0 or    v-sale-transport-rubl <> 0 or    v-sale-other-base     <> 0 or    v-sale-other-rubl     <> 0 or    v-sale-discnt-base    <> 0 or    v-sale-discnt-rubl    <> 0
        then do:
          run store-stk-line in this-procedure
            ...
            ,input v-aht-type
            ,input v-fact-qnty
                                                            ,input v-cost-sum-base            ,input v-cost-sum-rubl            ,input v-cost-vat-base            ,input v-cost-vat-rubl            ,input v-cost-slt-base            ,input v-cost-slt-rubl            ,input v-cost-road-tax-base       ,input v-cost-road-tax-rubl       ,input v-cost-excise-base         ,input v-cost-excise-rubl         ,input v-cost-transport-base      ,input v-cost-transport-rubl      ,input v-cost-other-base          ,input v-cost-other-rubl          ,input v-cost-discnt-base         ,input v-cost-discnt-rubl
                                                            ,input v-crsa-sum-base            ,input v-crsa-sum-rubl            ,input v-crsa-vat-base            ,input v-crsa-vat-rubl            ,input v-crsa-slt-base            ,input v-crsa-slt-rubl            ,input v-crsa-road-tax-base       ,input v-crsa-road-tax-rubl       ,input v-crsa-excise-base         ,input v-crsa-excise-rubl         ,input v-crsa-transport-base      ,input v-crsa-transport-rubl      ,input v-crsa-other-base          ,input v-crsa-other-rubl          ,input v-crsa-discnt-base         ,input v-crsa-discnt-rubl
                                                            ,input v-sale-sum-base            ,input v-sale-sum-rubl            ,input v-sale-vat-base            ,input v-sale-vat-rubl            ,input v-sale-slt-base            ,input v-sale-slt-rubl            ,input v-sale-road-tax-base       ,input v-sale-road-tax-rubl       ,input v-sale-excise-base         ,input v-sale-excise-rubl         ,input v-sale-transport-base      ,input v-sale-transport-rubl      ,input v-sale-other-base          ,input v-sale-other-rubl          ,input v-sale-discnt-base         ,input v-sale-discnt-rubl
            ) no-error .
        end.
      end.
    end.
  ...
  :
    ...
    assign
      buf_aht-stk-line.fact-qnty = buf_aht-stk-line.fact-qnty + p-fact-qnty
                                                      buf_aht-stk-line.cost-sum-base       = buf_aht-stk-line.cost-sum-base       + p-cost-sum-base            buf_aht-stk-line.cost-sum-rubl       = buf_aht-stk-line.cost-sum-rubl       + p-cost-sum-rubl            buf_aht-stk-line.cost-vat-base       = buf_aht-stk-line.cost-vat-base       + p-cost-vat-base            buf_aht-stk-line.cost-vat-rubl       = buf_aht-stk-line.cost-vat-rubl       + p-cost-vat-rubl            buf_aht-stk-line.cost-slt-base       = buf_aht-stk-line.cost-slt-base       + p-cost-slt-base            buf_aht-stk-line.cost-slt-rubl       = buf_aht-stk-line.cost-slt-rubl       + p-cost-slt-rubl            buf_aht-stk-line.cost-road-tax-base  = buf_aht-stk-line.cost-road-tax-base  + p-cost-road-tax-base       buf_aht-stk-line.cost-road-tax-rubl  = buf_aht-stk-line.cost-road-tax-rubl  + p-cost-road-tax-rubl       buf_aht-stk-line.cost-excise-base    = buf_aht-stk-line.cost-excise-base    + p-cost-excise-base         buf_aht-stk-line.cost-excise-rubl    = buf_aht-stk-line.cost-excise-rubl    + p-cost-excise-rubl         buf_aht-stk-line.cost-transport-base = buf_aht-stk-line.cost-transport-base + p-cost-transport-base      buf_aht-stk-line.cost-transport-rubl = buf_aht-stk-line.cost-transport-rubl + p-cost-transport-rubl      buf_aht-stk-line.cost-other-base     = buf_aht-stk-line.cost-other-base     + p-cost-other-base          buf_aht-stk-line.cost-other-rubl     = buf_aht-stk-line.cost-other-rubl     + p-cost-other-rubl          buf_aht-stk-line.cost-discnt-base    = buf_aht-stk-line.cost-discnt-base    + p-cost-discnt-base          buf_aht-stk-line.cost-discnt-rubl    = buf_aht-stk-line.cost-discnt-rubl    + p-cost-discnt-rubl
                                                      buf_aht-stk-line.crsa-sum-base       = buf_aht-stk-line.crsa-sum-base       + p-crsa-sum-base            buf_aht-stk-line.crsa-sum-rubl       = buf_aht-stk-line.crsa-sum-rubl       + p-crsa-sum-rubl            buf_aht-stk-line.crsa-vat-base       = buf_aht-stk-line.crsa-vat-base       + p-crsa-vat-base            buf_aht-stk-line.crsa-vat-rubl       = buf_aht-stk-line.crsa-vat-rubl       + p-crsa-vat-rubl            buf_aht-stk-line.crsa-slt-base       = buf_aht-stk-line.crsa-slt-base       + p-crsa-slt-base            buf_aht-stk-line.crsa-slt-rubl       = buf_aht-stk-line.crsa-slt-rubl       + p-crsa-slt-rubl            buf_aht-stk-line.crsa-road-tax-base  = buf_aht-stk-line.crsa-road-tax-base  + p-crsa-road-tax-base       buf_aht-stk-line.crsa-road-tax-rubl  = buf_aht-stk-line.crsa-road-tax-rubl  + p-crsa-road-tax-rubl       buf_aht-stk-line.crsa-excise-base    = buf_aht-stk-line.crsa-excise-base    + p-crsa-excise-base         buf_aht-stk-line.crsa-excise-rubl    = buf_aht-stk-line.crsa-excise-rubl    + p-crsa-excise-rubl         buf_aht-stk-line.crsa-transport-base = buf_aht-stk-line.crsa-transport-base + p-crsa-transport-base      buf_aht-stk-line.crsa-transport-rubl = buf_aht-stk-line.crsa-transport-rubl + p-crsa-transport-rubl      buf_aht-stk-line.crsa-other-base     = buf_aht-stk-line.crsa-other-base     + p-crsa-other-base          buf_aht-stk-line.crsa-other-rubl     = buf_aht-stk-line.crsa-other-rubl     + p-crsa-other-rubl          buf_aht-stk-line.crsa-discnt-base    = buf_aht-stk-line.crsa-discnt-base    + p-crsa-discnt-base          buf_aht-stk-line.crsa-discnt-rubl    = buf_aht-stk-line.crsa-discnt-rubl    + p-crsa-discnt-rubl
                                                      buf_aht-stk-line.sale-sum-base       = buf_aht-stk-line.sale-sum-base       + p-sale-sum-base            buf_aht-stk-line.sale-sum-rubl       = buf_aht-stk-line.sale-sum-rubl       + p-sale-sum-rubl            buf_aht-stk-line.sale-vat-base       = buf_aht-stk-line.sale-vat-base       + p-sale-vat-base            buf_aht-stk-line.sale-vat-rubl       = buf_aht-stk-line.sale-vat-rubl       + p-sale-vat-rubl            buf_aht-stk-line.sale-slt-base       = buf_aht-stk-line.sale-slt-base       + p-sale-slt-base            buf_aht-stk-line.sale-slt-rubl       = buf_aht-stk-line.sale-slt-rubl       + p-sale-slt-rubl            buf_aht-stk-line.sale-road-tax-base  = buf_aht-stk-line.sale-road-tax-base  + p-sale-road-tax-base       buf_aht-stk-line.sale-road-tax-rubl  = buf_aht-stk-line.sale-road-tax-rubl  + p-sale-road-tax-rubl       buf_aht-stk-line.sale-excise-base    = buf_aht-stk-line.sale-excise-base    + p-sale-excise-base         buf_aht-stk-line.sale-excise-rubl    = buf_aht-stk-line.sale-excise-rubl    + p-sale-excise-rubl         buf_aht-stk-line.sale-transport-base = buf_aht-stk-line.sale-transport-base + p-sale-transport-base      buf_aht-stk-line.sale-transport-rubl = buf_aht-stk-line.sale-transport-rubl + p-sale-transport-rubl      buf_aht-stk-line.sale-other-base     = buf_aht-stk-line.sale-other-base     + p-sale-other-base          buf_aht-stk-line.sale-other-rubl     = buf_aht-stk-line.sale-other-rubl     + p-sale-other-rubl          buf_aht-stk-line.sale-discnt-base    = buf_aht-stk-line.sale-discnt-base    + p-sale-discnt-base          buf_aht-stk-line.sale-discnt-rubl    = buf_aht-stk-line.sale-discnt-rubl    + p-sale-discnt-rubl
    .
  end.
end procedure.
procedure clear-tot :
...
procedure update-tot :
  ...
  do on error undo, return error return-value :
    for each buf_temp-aht-stk-line on error undo, return error return-value :
      ...
      assign
                                                                        buf_temp-aht-stk-tot.cost-sum-base       = buf_temp-aht-stk-tot.cost-sum-base       + buf_temp-aht-stk-line.cost-sum-base            buf_temp-aht-stk-tot.cost-sum-rubl       = buf_temp-aht-stk-tot.cost-sum-rubl       + buf_temp-aht-stk-line.cost-sum-rubl            buf_temp-aht-stk-tot.cost-vat-base       = buf_temp-aht-stk-tot.cost-vat-base       + buf_temp-aht-stk-line.cost-vat-base            buf_temp-aht-stk-tot.cost-vat-rubl       = buf_temp-aht-stk-tot.cost-vat-rubl       + buf_temp-aht-stk-line.cost-vat-rubl            buf_temp-aht-stk-tot.cost-slt-base       = buf_temp-aht-stk-tot.cost-slt-base       + buf_temp-aht-stk-line.cost-slt-base            buf_temp-aht-stk-tot.cost-slt-rubl       = buf_temp-aht-stk-tot.cost-slt-rubl       + buf_temp-aht-stk-line.cost-slt-rubl            buf_temp-aht-stk-tot.cost-road-tax-base  = buf_temp-aht-stk-tot.cost-road-tax-base  + buf_temp-aht-stk-line.cost-road-tax-base       buf_temp-aht-stk-tot.cost-road-tax-rubl  = buf_temp-aht-stk-tot.cost-road-tax-rubl  + buf_temp-aht-stk-line.cost-road-tax-rubl       buf_temp-aht-stk-tot.cost-excise-base    = buf_temp-aht-stk-tot.cost-excise-base    + buf_temp-aht-stk-line.cost-excise-base         buf_temp-aht-stk-tot.cost-excise-rubl    = buf_temp-aht-stk-tot.cost-excise-rubl    + buf_temp-aht-stk-line.cost-excise-rubl         buf_temp-aht-stk-tot.cost-transport-base = buf_temp-aht-stk-tot.cost-transport-base + buf_temp-aht-stk-line.cost-transport-base      buf_temp-aht-stk-tot.cost-transport-rubl = buf_temp-aht-stk-tot.cost-transport-rubl + buf_temp-aht-stk-line.cost-transport-rubl      buf_temp-aht-stk-tot.cost-other-base     = buf_temp-aht-stk-tot.cost-other-base     + buf_temp-aht-stk-line.cost-other-base          buf_temp-aht-stk-tot.cost-other-rubl     = buf_temp-aht-stk-tot.cost-other-rubl     + buf_temp-aht-stk-line.cost-other-rubl          buf_temp-aht-stk-tot.cost-discnt-base    = buf_temp-aht-stk-tot.cost-discnt-base    + buf_temp-aht-stk-line.cost-discnt-base          buf_temp-aht-stk-tot.cost-discnt-rubl    = buf_temp-aht-stk-tot.cost-discnt-rubl    + buf_temp-aht-stk-line.cost-discnt-rubl
                                                                        buf_temp-aht-stk-tot.crsa-sum-base       = buf_temp-aht-stk-tot.crsa-sum-base       + buf_temp-aht-stk-line.crsa-sum-base            buf_temp-aht-stk-tot.crsa-sum-rubl       = buf_temp-aht-stk-tot.crsa-sum-rubl       + buf_temp-aht-stk-line.crsa-sum-rubl            buf_temp-aht-stk-tot.crsa-vat-base       = buf_temp-aht-stk-tot.crsa-vat-base       + buf_temp-aht-stk-line.crsa-vat-base            buf_temp-aht-stk-tot.crsa-vat-rubl       = buf_temp-aht-stk-tot.crsa-vat-rubl       + buf_temp-aht-stk-line.crsa-vat-rubl            buf_temp-aht-stk-tot.crsa-slt-base       = buf_temp-aht-stk-tot.crsa-slt-base       + buf_temp-aht-stk-line.crsa-slt-base            buf_temp-aht-stk-tot.crsa-slt-rubl       = buf_temp-aht-stk-tot.crsa-slt-rubl       + buf_temp-aht-stk-line.crsa-slt-rubl            buf_temp-aht-stk-tot.crsa-road-tax-base  = buf_temp-aht-stk-tot.crsa-road-tax-base  + buf_temp-aht-stk-line.crsa-road-tax-base       buf_temp-aht-stk-tot.crsa-road-tax-rubl  = buf_temp-aht-stk-tot.crsa-road-tax-rubl  + buf_temp-aht-stk-line.crsa-road-tax-rubl       buf_temp-aht-stk-tot.crsa-excise-base    = buf_temp-aht-stk-tot.crsa-excise-base    + buf_temp-aht-stk-line.crsa-excise-base         buf_temp-aht-stk-tot.crsa-excise-rubl    = buf_temp-aht-stk-tot.crsa-excise-rubl    + buf_temp-aht-stk-line.crsa-excise-rubl         buf_temp-aht-stk-tot.crsa-transport-base = buf_temp-aht-stk-tot.crsa-transport-base + buf_temp-aht-stk-line.crsa-transport-base      buf_temp-aht-stk-tot.crsa-transport-rubl = buf_temp-aht-stk-tot.crsa-transport-rubl + buf_temp-aht-stk-line.crsa-transport-rubl      buf_temp-aht-stk-tot.crsa-other-base     = buf_temp-aht-stk-tot.crsa-other-base     + buf_temp-aht-stk-line.crsa-other-base          buf_temp-aht-stk-tot.crsa-other-rubl     = buf_temp-aht-stk-tot.crsa-other-rubl     + buf_temp-aht-stk-line.crsa-other-rubl          buf_temp-aht-stk-tot.crsa-discnt-base    = buf_temp-aht-stk-tot.crsa-discnt-base    + buf_temp-aht-stk-line.crsa-discnt-base          buf_temp-aht-stk-tot.crsa-discnt-rubl    = buf_temp-aht-stk-tot.crsa-discnt-rubl    + buf_temp-aht-stk-line.crsa-discnt-rubl
                                                                        buf_temp-aht-stk-tot.sale-sum-base       = buf_temp-aht-stk-tot.sale-sum-base       + buf_temp-aht-stk-line.sale-sum-base            buf_temp-aht-stk-tot.sale-sum-rubl       = buf_temp-aht-stk-tot.sale-sum-rubl       + buf_temp-aht-stk-line.sale-sum-rubl            buf_temp-aht-stk-tot.sale-vat-base       = buf_temp-aht-stk-tot.sale-vat-base       + buf_temp-aht-stk-line.sale-vat-base            buf_temp-aht-stk-tot.sale-vat-rubl       = buf_temp-aht-stk-tot.sale-vat-rubl       + buf_temp-aht-stk-line.sale-vat-rubl            buf_temp-aht-stk-tot.sale-slt-base       = buf_temp-aht-stk-tot.sale-slt-base       + buf_temp-aht-stk-line.sale-slt-base            buf_temp-aht-stk-tot.sale-slt-rubl       = buf_temp-aht-stk-tot.sale-slt-rubl       + buf_temp-aht-stk-line.sale-slt-rubl            buf_temp-aht-stk-tot.sale-road-tax-base  = buf_temp-aht-stk-tot.sale-road-tax-base  + buf_temp-aht-stk-line.sale-road-tax-base       buf_temp-aht-stk-tot.sale-road-tax-rubl  = buf_temp-aht-stk-tot.sale-road-tax-rubl  + buf_temp-aht-stk-line.sale-road-tax-rubl       buf_temp-aht-stk-tot.sale-excise-base    = buf_temp-aht-stk-tot.sale-excise-base    + buf_temp-aht-stk-line.sale-excise-base         buf_temp-aht-stk-tot.sale-excise-rubl    = buf_temp-aht-stk-tot.sale-excise-rubl    + buf_temp-aht-stk-line.sale-excise-rubl         buf_temp-aht-stk-tot.sale-transport-base = buf_temp-aht-stk-tot.sale-transport-base + buf_temp-aht-stk-line.sale-transport-base      buf_temp-aht-stk-tot.sale-transport-rubl = buf_temp-aht-stk-tot.sale-transport-rubl + buf_temp-aht-stk-line.sale-transport-rubl      buf_temp-aht-stk-tot.sale-other-base     = buf_temp-aht-stk-tot.sale-other-base     + buf_temp-aht-stk-line.sale-other-base          buf_temp-aht-stk-tot.sale-other-rubl     = buf_temp-aht-stk-tot.sale-other-rubl     + buf_temp-aht-stk-line.sale-other-rubl          buf_temp-aht-stk-tot.sale-discnt-base    = buf_temp-aht-stk-tot.sale-discnt-base    + buf_temp-aht-stk-line.sale-discnt-base          buf_temp-aht-stk-tot.sale-discnt-rubl    = buf_temp-aht-stk-tot.sale-discnt-rubl    + buf_temp-aht-stk-line.sale-discnt-rubl
      .
    end.
  end.
end procedure.
