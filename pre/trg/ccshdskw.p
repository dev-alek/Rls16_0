...
procedure vss-get-parameters :
  define output parameter p-vss-parameters as character no-undo .
    assign
      p-vss-parameters = substitute('&1|&2|&3|&4|&5', ub.c-cash-desk.db-num, ub.c-cash-desk.obj-code, ub.c-cash-desk.pos-type, ub.c-cash-desk.cash-num, ub.c-cash-desk.chip-num)
    .
end procedure.
