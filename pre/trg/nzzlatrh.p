...
define parameter buffer oldb for ub.nozzle-attr.
define parameter buffer newb for ub.nozzle-attr.
define variable vss-revision    as character no-undo init "$Revision$":U .
define variable vss-author      as character no-undo init "$Author$":U .
define variable vss-date        as character no-undo init "$Date$":U .
define variable vss-workfile    as character no-undo init "$Workfile$":U .
define variable vss-archive     as character no-undo init "$Archive$":U .
define variable vss-description as character no-undo init "История атрибута пистолета".
...
:
  if g#news <> yes then do:
    ...
    obj-code
    attr-code
    to buf_c-nozzle-attr
    .
    assign
    buf_c-nozzle-attr.obj-type           = newb.obj-type
    buf_c-nozzle-attr.obj-code           = newb.obj-code
    buf_c-nozzle-attr.nozzle-code            = newb.nozzle-code
    buf_c-nozzle-attr.attr-code          = newb.attr-code
    buf_c-nozzle-attr.chip-num           = next-value (s-nzl-chip, ub)
    ...
    assign
    buf_c-nzl-hist.action             = integer( if new( newb )
                                              then '1':U
                                              else '2':U)
    buf_c-nzl-hist.subject = 'nozzle-attr':U
