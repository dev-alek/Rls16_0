...
procedure vss-get-parameters :
  define output parameter p-vss-parameters as character no-undo .
    assign
      p-vss-parameters = substitute('&1|&2|&3',ub.fbr-gds-grp.node-code,ub.fbr-gds-grp.upper-code,ub.fbr-gds-grp.node-name)
    .
end procedure.
...
define buffer buf_c-fbr-gds-grp for ub.c-fbr-gds-grp.
  ...
  :
    ...
    buffer-copy ub.fbr-gds-grp to buf_c-fbr-gds-grp
    assign
    buf_c-fbr-gds-grp.obj-type           = (if p-new-record then ub.fbr-gds-grp.obj-type else ub.fbr-gds-grp.obj-type)
    buf_c-fbr-gds-grp.obj-code           = (if p-new-record then ub.fbr-gds-grp.obj-code else ub.fbr-gds-grp.obj-code)
    buf_c-fbr-gds-grp.node-code           = (if p-new-record then ub.fbr-gds-grp.node-code else ub.fbr-gds-grp.node-code)
