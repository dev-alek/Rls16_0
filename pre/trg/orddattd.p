...
trigger procedure for delete of ub.order-doc-attr.
define variable vss-revision    as character no-undo initial "$Revision$":U.
define variable vss-author      as character no-undo initial "$Author$":U.
define variable vss-date        as character no-undo initial "$Date$":U.
define variable vss-workfile    as character no-undo initial "$Workfile$":U.
define variable vss-archive     as character no-undo initial "$Archive$":U.
define variable vss-description as character no-undo init "Триггер на delete order-doc-attr".
...
define buffer buf_c-order-head for ub.c-order-head .
    ...
    if vFlagseq
    then do:
 for first buf_c-order-doc-attr where buf_c-order-doc-attr.db-num eq order-doc-attr.db-num
and buf_c-order-doc-attr.doc-code eq order-doc-attr.doc-code
and buf_c-order-doc-attr.attr-code eq order-doc-attr.attr-code
  and buf_c-order-doc-attr.corr-user-db-num   = g#db-num and buf_c-order-doc-attr.chip-num = v-Seq exclusive-lock: leave. end.
    ...
    then do:
       ...
       buffer-copy ub.order-doc-attr to buf_c-order-doc-attr
       assign
         ...
         buf_c-order-doc-attr.action             = 99
         buf_c-order-doc-attr.is-del             = true
       .
    end.
    else
       buf_c-order-doc-attr.action             = 99.
      if vFlagSeq
      then do:
 for first buf_c-order-head where buf_c-order-head.db-num eq order-doc-attr.db-num
and buf_c-order-head.doc-code eq order-doc-attr.doc-code
