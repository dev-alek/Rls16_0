...
define variable vss-description as character no-undo init "—оздать запись о том, что необходимо пересчитать складской архив по товарам".
