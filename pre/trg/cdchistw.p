...
:
  if lookup(ub.c-dc-hist.subject, 'dis-card,dis-card-property,dis-obj,dis-host,dis-dc-rule':U) > 0 then do:
    if ub.c-dc-hist.subject <> 'dis-host':U
    and ub.c-dc-hist.subject <> 'dis-obj':U
    and ub.c-dc-hist.subject <> 'dis-card-property':U
