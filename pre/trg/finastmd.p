...
define buffer buf_c-fin-statement-attr for ub.c-fin-statement-attr.
  ...
  :
    ...
    assign
    buf_c-fin-statement-attr.host-code          = (if p-new-record then ub.fin-statement-attr.host-code else ub.fin-statement-attr.host-code)
    buf_c-fin-statement-attr.sttm-code          = (if p-new-record then ub.fin-statement-attr.sttm-code else ub.fin-statement-attr.sttm-code)
    buf_c-fin-statement-attr.attr-code          = (if p-new-record then ub.fin-statement-attr.attr-code else ub.fin-statement-attr.attr-code)
    buf_c-fin-statement-attr.chip-num           = next-value (s-fin-corr-chip, ub)
