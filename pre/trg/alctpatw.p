...
procedure vss-get-parameters :
  define output parameter p-vss-parameters as character no-undo .
    assign
      p-vss-parameters = substitute('&1|&2|&3':u, ub.alc-type-attr.alc-type-inner-code, ub.alc-type-attr.create-user-db-num, ub.alc-type-attr.attr-code )
    .
end procedure.
...
:
   ...
   then do:
      ...
      assign
         bf_c-alc-type-attr.chip-num         = next-value (s-alc-type-chip, ub)
   ...
   then do:
      undo main-block, return error substitute("&1. Невозможно маршрутизировать alc-type-attr для отправки в новости &2&3&2&4", vss-workfile, chr(10), return-value, error-status :get-message ( 1 ) ).
   end.
   if g#oxml = yes
   then do:
   run str/calloxml.p (
