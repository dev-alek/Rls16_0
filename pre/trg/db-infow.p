...
:
  ...
  if error-status :error then do:
    assign
      v-message = substitute( "&1. Невозможно маршрутизировать информацию по БД (db-info) для отправки в новости. &2&3&2&4", vss-workfile, chr(10), return-value, error-status :get-message ( error-status :num-messages ) )
    .
