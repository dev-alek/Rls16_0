...
procedure vss-get-parameters :
  define output parameter p-vss-parameters as character no-undo .
    assign
      p-vss-parameters = substitute('&1|&2|&3|&4|&5|&6',  ub.cash-pay-attr.cdpay-code
...
:
  if not g#news then do:
    ...
    buf_c-cash-pay-attr.chip-num           = next-value (s-corr-chip, ub)
    ...
    assign
    buf_c-cash-pay.subject            = 'cash-pay-attr':U
    buf_c-cash-pay.action             = integer(if new(ub.cash-pay-attr) then '1':U else '2':U)
    .
  end.
  run str/callnews.p
