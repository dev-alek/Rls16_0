...
do
    ...
    do:
        ...
        buffer-copy oldb
            ...
            buf_c-pl-pump.chip-num           = next-value (s-plc-chip, ub)
        ...
        buffer-copy buf_c-pl-pump to buf_c-plc-hist
            assign
            buf_c-plc-hist.action = (if new ub.pl-pump then integer('1':U) else integer('2':U))
            buf_c-plc-hist.subject = 'pl-pump':U
        ...
        buffer-copy buf_c-pl-pump to buf_c-pmp-hist
            ...
            buf_c-pmp-hist.action = (if new ub.pl-pump then integer('1':U) else integer('2':U))
            buf_c-pmp-hist.subject = 'pl-pump':U
        ...
        assign
            ...
            buf_c-table-bind.subject          = 'pl-pump':U
            .
    end.
    if g#oxml = yes
        then
