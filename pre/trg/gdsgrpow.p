...
define buffer buf_c-gds-grp-obj for ub.c-gds-grp-obj.
  ...
  :
    ...
    buffer-copy oldgds-grp-obj to buf_c-gds-grp-obj
    assign
    buf_c-gds-grp-obj.node-code          = (if p-new-record then ub.gds-grp-obj.node-code else oldgds-grp-obj.node-code)
    buf_c-gds-grp-obj.host-code          = (if p-new-record then ub.gds-grp-obj.host-code else  oldgds-grp-obj.host-code)
    buf_c-gds-grp-obj.obj-type           = (if p-new-record then ub.gds-grp-obj.obj-type  else  oldgds-grp-obj.obj-type)
    buf_c-gds-grp-obj.obj-code           = (if p-new-record then ub.gds-grp-obj.obj-code  else  oldgds-grp-obj.obj-code)
