...
define buffer buf_c-fin-doc-attr for ub.c-fin-doc-attr.
  ...
  :
    ...
    assign
    buf_c-fin-doc-attr.host-code          = (if p-new-record then ub.fin-doc-attr.host-code else ub.fin-doc-attr.host-code)
    buf_c-fin-doc-attr.fin-doc-code       = (if p-new-record then ub.fin-doc-attr.fin-doc-code else ub.fin-doc-attr.fin-doc-code)
    buf_c-fin-doc-attr.attr-code          = (if p-new-record then ub.fin-doc-attr.attr-code else ub.fin-doc-attr.attr-code)
