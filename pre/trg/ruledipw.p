...
:
  ...
  or g#db-num <> 0 then do:
    ...
    buf_c-ruledict-param.chip-num           = next-value (s-ref-corr-chip, ub)
    ...
    to buf_c-ruledict
    assign
    buf_c-ruledict.action             = integer(if new(ub.ruledict-param) then '1':U else '2':U)
    buf_C-ruledict.subject            = 'ruledict-param':U
    .
  end.
  if not g#news
  and g#db-num = 0
