...
procedure vss-get-parameters :
  define output parameter p-vss-parameters as character no-undo .
    assign
      p-vss-parameters = substitute('&1|&2|&3':u, ub.alc-sale-lic-attr.alc-sale-lic-code, ub.alc-sale-lic-attr.create-user-db-num, ub.alc-sale-lic-attr.attr-code )
    .
end procedure.
...
:
   ...
   then do:
      ...
      assign
         bf_c-alc-sale-lic-attr.chip-num         = next-value (s-alc-sale-lic-chip, ub)
   ...
   then do:
      undo main-block, return error substitute("&1. Невозможно маршрутизировать alc-sale-lic-attr для отправки в новости &2&3&2&4", vss-workfile, chr(10), return-value, error-status :get-message ( 1 ) ).
   end.
   if g#oxml = yes
   then do:
   run str/calloxml.p (
