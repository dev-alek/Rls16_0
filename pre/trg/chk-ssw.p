...
trigger procedure for write of ub.chk-slip-string
  new buffer new-chk-slip-string
  old buffer old-chk-slip-string
.
...
define variable vss-description as character no-undo init "Тригер изменение chk-slip-string".
