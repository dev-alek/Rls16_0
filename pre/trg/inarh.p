  ...
  ,output v-gds-goods
    ...
    :
      ...
      or (v-need-copy-crsa-cost = false
          and not v-sum-type begins 'crsa':U
          and not v-sum-type begins 'cost':U
          )
      then do:
...
procedure update-tot :
  ...
  :
    ...
    :
      ...
      assign
                                                                        buf_temp-stk-tot.new-fact-qnty      = buf_temp-stk-tot.new-fact-qnty      + buf_temp-stk-line.new-fact-qnty           buf_temp-stk-tot.new-sum-base       = buf_temp-stk-tot.new-sum-base       + buf_temp-stk-line.new-sum-base            buf_temp-stk-tot.new-sum-rubl       = buf_temp-stk-tot.new-sum-rubl       + buf_temp-stk-line.new-sum-rubl            buf_temp-stk-tot.new-vat-base       = buf_temp-stk-tot.new-vat-base       + buf_temp-stk-line.new-vat-base            buf_temp-stk-tot.new-vat-rubl       = buf_temp-stk-tot.new-vat-rubl       + buf_temp-stk-line.new-vat-rubl            buf_temp-stk-tot.new-slt-base       = buf_temp-stk-tot.new-slt-base       + buf_temp-stk-line.new-slt-base            buf_temp-stk-tot.new-slt-rubl       = buf_temp-stk-tot.new-slt-rubl       + buf_temp-stk-line.new-slt-rubl            buf_temp-stk-tot.new-road-tax-base  = buf_temp-stk-tot.new-road-tax-base  + buf_temp-stk-line.new-road-tax-base       buf_temp-stk-tot.new-road-tax-rubl  = buf_temp-stk-tot.new-road-tax-rubl  + buf_temp-stk-line.new-road-tax-rubl       buf_temp-stk-tot.new-excise-base    = buf_temp-stk-tot.new-excise-base    + buf_temp-stk-line.new-excise-base         buf_temp-stk-tot.new-excise-rubl    = buf_temp-stk-tot.new-excise-rubl    + buf_temp-stk-line.new-excise-rubl         buf_temp-stk-tot.new-transport-base = buf_temp-stk-tot.new-transport-base + buf_temp-stk-line.new-transport-base      buf_temp-stk-tot.new-transport-rubl = buf_temp-stk-tot.new-transport-rubl + buf_temp-stk-line.new-transport-rubl      buf_temp-stk-tot.new-other-base     = buf_temp-stk-tot.new-other-base     + buf_temp-stk-line.new-other-base          buf_temp-stk-tot.new-other-rubl     = buf_temp-stk-tot.new-other-rubl     + buf_temp-stk-line.new-other-rubl
      .
      if v-shift-on = true
      then do:
        find first buf_temp-stk-tot
      ...
      if buf_temp-stk-line.sum-type = 'crsa':U
      then do:
        define variable v-sum-type as character no-undo .
        define variable v-cat-id   as character no-undo .
        assign
          v-sum-type = 'crsa':U + 'v':U
          v-cat-id   = trim(string(v-crsa-vat-pc, ">99")) + "," + '##':U
        .
        if v-cat-id = ?
        then do:
          message
        ...
        assign
          v-sum-type = 'crsa':U + 's':U
          v-cat-id   = '##':U + "," + trim(string(v-crsa-slt-pc, ">99"))
        .
        if v-cat-id = ?
        then do:
          message
