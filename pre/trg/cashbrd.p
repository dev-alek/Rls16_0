...
trigger procedure for delete of ub.cashbookRule.
define variable vss-revision    as character no-undo initial "$Revision$":U .
define variable vss-author      as character no-undo initial "$Author$":U .
define variable vss-date        as character no-undo initial "$Date$":U .
define variable vss-workfile    as character no-undo initial "$Workfile$":U .
define variable vss-archive     as character no-undo initial "$Archive$":U .
define variable vss-description as character no-undo init "Тригер удаления cashbookRule".
...
define buffer buf_c-cashbook-head for ub.c-cashbook-head .
    ...
    if vFlagseq
    then do:
 for first buf_c-cashbookRule where buf_c-cashbookRule.CashBookID eq cashbookRule.CashBookID
and buf_c-cashbookRule.Obj-type eq cashbookRule.Obj-type
and buf_c-cashbookRule.Obj-code eq cashbookRule.Obj-code
and buf_c-cashbookRule.Code eq cashbookRule.Code
  and buf_c-cashbookRule.corr-user-db-num   = g#db-num and buf_c-cashbookRule.chip-num = v-Seq exclusive-lock: leave. end.
    ...
    then do:
       ...
       buffer-copy ub.cashbookRule to buf_c-cashbookRule
       assign
         ...
         buf_c-cashbookRule.action             = 99
         buf_c-cashbookRule.is-del             = true
       .
    end.
    else
       buf_c-cashbookRule.action             = 99.
...
for each cashbookruleattr where CashBookruleAttr.cashbookid  eq cashbookRule.cashbookid
                            and CashBookruleAttr.obj-type    eq cashbookRule.obj-type
                            and CashBookruleAttr.obj-code    eq cashbookRule.obj-code
exclusive-lock:
