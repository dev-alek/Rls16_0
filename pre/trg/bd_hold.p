...
procedure vss-get-parameters :
  define output parameter p-vss-parameters as character no-undo .
    assign
      p-vss-parameters = substitute('&1|&2|&3',p-doc-code,p-fact-date,p-action)
    .
end procedure.
...
define variable v-need-stop-hold as logical   no-undo .
  ...
  then do:
    ...
    :
      ...
      assign
        stop-hold-news-lock_btpr.bp_type       = 'lock':U + 'hold'
        stop-hold-news-lock_btpr.bp_status     = 'N':U
  ...
  find first ub.batchprocess exclusive-lock
    where ub.batchprocess.bp_type   = p-btpr-type-code
