...
trigger procedure for write of ub.order-doc-attr
  new buffer new-order-doc-attr
  old buffer old-order-doc-attr
.
...
define variable vss-description as character no-undo init "Триггер на write order-doc-attr".
...
define buffer buf_c-order-head for ub.c-order-head .
      buffer-compare new-order-doc-attr to old-order-doc-attr case-sensitive save result in v-field-chg.
      if v-field-chg > "":U then . else return .
      run cur-time in this-procedure (output v-date, output v-time).
    publish "getNextseq" ("order-doc-attr","s-c-order-chip-num", "ub", output v-Seq ).
    if v-Seq = ?
    then
    ...
    if vFlagSeq
    then do:
                     if new(new-order-doc-attr)
       then do:
 for first buf_c-order-doc-attr where buf_c-order-doc-attr.db-num eq new-order-doc-attr.db-num
and buf_c-order-doc-attr.doc-code eq new-order-doc-attr.doc-code
and buf_c-order-doc-attr.attr-code eq new-order-doc-attr.attr-code
  and buf_c-order-doc-attr.corr-user-db-num   = g#db-num and buf_c-order-doc-attr.chip-num = v-Seq exclusive-lock: leave. end.
       end.
       else do:
 for first buf_c-order-doc-attr where buf_c-order-doc-attr.db-num eq old-order-doc-attr.db-num
and buf_c-order-doc-attr.doc-code eq old-order-doc-attr.doc-code
and buf_c-order-doc-attr.attr-code eq old-order-doc-attr.attr-code
  and buf_c-order-doc-attr.corr-user-db-num   = g#db-num and buf_c-order-doc-attr.chip-num = v-Seq exclusive-lock: leave. end.
       end.
    end.
   if new(new-order-doc-attr)
   then do:
      if not available buf_c-order-doc-attr
      then do:
         create buf_c-order-doc-attr.
      buffer-copy new-order-doc-attr to buf_c-order-doc-attr
      assign
         buf_c-order-doc-attr.chip-num           = v-Seq
         buf_c-order-doc-attr.corr-date          = v-date
         buf_c-order-doc-attr.corr-time          = v-time
         buf_c-order-doc-attr.corr-user-db-num   = g#db-num
         buf_c-order-doc-attr.corr-user-name     = (if g#news then (chr(4) +  'СПН':U) + " " else "") + g#userid
         buf_c-order-doc-attr.action             = 1
         buf_c-order-doc-attr.is-del             = false
      .
      end.
      else
         if buf_c-order-doc-attr.action eq 99
         then
            buf_c-order-doc-attr.action = 2.
   end.
   else do:
      if not available buf_c-order-doc-attr
      then do:
         create buf_c-order-doc-attr.
         buffer-copy old-order-doc-attr to buf_c-order-doc-attr
         assign
            buf_c-order-doc-attr.chip-num           = v-Seq
            buf_c-order-doc-attr.corr-date          = v-date
            buf_c-order-doc-attr.corr-time          = v-time
            buf_c-order-doc-attr.corr-user-db-num   = g#db-num
            buf_c-order-doc-attr.corr-user-name     = (if g#news then (chr(4) +  'СПН':U) + " " else "") + g#userid
            buf_c-order-doc-attr.action             = 2 when buf_c-order-doc-attr.action ne 1
            buf_c-order-doc-attr.is-del             = false
         .
      end.
   end.
      ...
      then do:
         if new(new-order-doc-attr)
         then do:
 for first buf_c-order-head where buf_c-order-head.db-num eq new-order-doc-attr.db-num
and buf_c-order-head.doc-code eq new-order-doc-attr.doc-code
  and buf_c-order-head.corr-user-db-num   = g#db-num and buf_c-order-head.chip-num = v-Seq exclusive-lock: leave. end.
         end.
         else do:
 for first buf_c-order-head where buf_c-order-head.db-num eq old-order-doc-attr.db-num
and buf_c-order-head.doc-code eq old-order-doc-attr.doc-code
  and buf_c-order-head.corr-user-db-num   = g#db-num and buf_c-order-head.chip-num = v-Seq exclusive-lock: leave. end.
         end.
      end.
      ...
      then do:
         ...
         buffer-copy  buf_c-order-doc-attr to buf_c-order-head
         assign
            buf_c-order-head.subject = "order-doc-attr"
