...
define buffer buf_c-fbr-gds-grp-attr for ub.c-fbr-gds-grp-attr.
  ...
  :
    ...
    buffer-copy ub.fbr-gds-grp-attr to buf_c-fbr-gds-grp-attr
    assign
    buf_c-fbr-gds-grp-attr.obj-type           = (if p-new-record then ub.fbr-gds-grp-attr.obj-type  else ub.fbr-gds-grp-attr.obj-type)
    buf_c-fbr-gds-grp-attr.obj-code           = (if p-new-record then ub.fbr-gds-grp-attr.node-code else ub.fbr-gds-grp-attr.obj-code)
    buf_c-fbr-gds-grp-attr.node-code          = (if p-new-record then ub.fbr-gds-grp-attr.node-code else ub.fbr-gds-grp-attr.node-code)
    buf_c-fbr-gds-grp-attr.attr-code          = (if p-new-record then ub.fbr-gds-grp-attr.attr-code else  ub.fbr-gds-grp-attr.attr-code)
