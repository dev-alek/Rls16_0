...
define variable vss-description as character no-undo init "“риггер на удаление дл€ таблицы атрибуты типов дисконтных карт".
...
:
  ...
  assign
  buf_c-dis-card-type-attr.chip-num           = next-value (s-dc-chip, ub)
  ...
  buf_c-dis-card-type.subject = 'dis-card-type-attr':U
  .
end.
