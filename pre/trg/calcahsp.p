...
:
  ...
  then do:
    ...
    run doclslib-check-ahsp-exist in this-procedure
      (input  p-obj-type
      ,input  p-obj-code
      ,input  v-ahsp-detail-fact-order
    ...
    then do:
      ...
      then do:
        ...
        run gbl/d-askw.w
          (input "Вопрос"
          ,input "На объекте уже есть рассчитанный складской архив по поставщикам" + chr(10)
          ...
          ,input "Пересчитать складской архив по поставщикам начиная с даты " +
              ...
              + "Удалить складской архив по поставщикам и рассчитать их на основе документов" + chr(10)
              + (if v-ahsp-detail-date <> ?
