...
trigger procedure for write of ub.xstatus
  new buffer new-xstatus
  old buffer old-xstatus
.
...
define variable vss-description as character no-undo init "Тригер изменение xstatus".
