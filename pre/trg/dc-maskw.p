...
procedure vss-get-parameters :
  define output parameter p-vss-parameters as character no-undo .
    assign
      p-vss-parameters = substitute('&1', ub.dis-card-mask.mask-num)
    .
end procedure.
...
:
  ...
  buf_c-dis-card-mask.chip-num           = next-value (s-dc-chip, ub)
  ...
  buf_c-dis-card-mask.action             = (if new ub.dis-card-mask then integer('1':U) else integer('2':U))
  .
  create buf_c-dis-card-type.
  buffer-copy buf_c-dis-card-mask to buf_c-dis-card-type
  assign
  buf_c-dis-card-type.action = (if new ub.dis-card-mask then integer('1':U) else integer('2':U))
  buf_c-dis-card-type.subject = 'dis-card-mask':U
  .
  run str/callnews.p
