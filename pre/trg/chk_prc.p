...
:
  ...
  assign
    ...
    exec_batchprocess.bp_execsysdate    = v-btpr_upd-today-1
    exec_batchprocess.bp_execsystime    = string(v-btpr_upd-time-1, 'hh:mm')
    exec_batchprocess.bp_execsystimeint = v-btpr_upd-time-1
  .
      run str/pr-oldd.p
