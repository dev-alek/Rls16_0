      ...
      if g#news <> yes then do:
        ...
        buffer-copy old-ext-artic-attr
          ...
          assign
            ...
            buf_c-ext-artic-attr.chip-num = next-value( s-gds-chip , ub )
            ...
            buf_c-ext-artic-attr.action = ( if new new-ext-artic-attr then integer( '1':U ) else integer( '2':U ) )
          .
      end.
    if g#oxml = yes
    then do:
