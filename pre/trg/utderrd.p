...
trigger procedure for delete of ub.utd-err.
define variable vss-revision    as character no-undo initial "$Revision$":U .
define variable vss-author      as character no-undo initial "$Author$":U .
define variable vss-date        as character no-undo initial "$Date$":U .
define variable vss-workfile    as character no-undo initial "$Workfile$":U .
define variable vss-archive     as character no-undo initial "$Archive$":U .
define variable vss-description as character no-undo init "Тригер удаления utd-err".
...
define buffer buf_c-utd-head for ub.c-utd-head .
    ...
    if vFlagseq
    then do:
 for first buf_c-utd-err where buf_c-utd-err.db-num eq utd-err.db-num
and buf_c-utd-err.doc-id eq utd-err.doc-id
and buf_c-utd-err.CheckType eq utd-err.CheckType
and buf_c-utd-err.CodeErr eq utd-err.CodeErr
and buf_c-utd-err.CheckObj eq utd-err.CheckObj
and buf_c-utd-err.reckey eq utd-err.reckey
  and buf_c-utd-err.corr-user-db-num   = g#db-num and buf_c-utd-err.chip-num = v-Seq exclusive-lock: leave. end.
    ...
    then do:
       ...
       buffer-copy ub.utd-err to buf_c-utd-err
       assign
         ...
         buf_c-utd-err.action             = 99
         buf_c-utd-err.is-del             = true
       .
    end.
    else
       buf_c-utd-err.action             = 99.
      if vFlagSeq
      then do:
 for first buf_c-utd-head where buf_c-utd-head.db-num eq utd-err.db-num
and buf_c-utd-head.doc-id eq utd-err.doc-id
