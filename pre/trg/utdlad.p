...
trigger procedure for delete of ub.utd-lines-attr.
define variable vss-revision    as character no-undo initial "$Revision$":U .
define variable vss-author      as character no-undo initial "$Author$":U .
define variable vss-date        as character no-undo initial "$Date$":U .
define variable vss-workfile    as character no-undo initial "$Workfile$":U .
define variable vss-archive     as character no-undo initial "$Archive$":U .
define variable vss-description as character no-undo init "Тригер удаления utd-lines-attr".
...
define buffer buf_c-utd-head for ub.c-utd-head .
    ...
    if vFlagseq
    then do:
 for first buf_c-utd-lines-attr where buf_c-utd-lines-attr.db-num eq utd-lines-attr.db-num
and buf_c-utd-lines-attr.doc-id eq utd-lines-attr.doc-id
and buf_c-utd-lines-attr.LineNum eq utd-lines-attr.LineNum
and buf_c-utd-lines-attr.attr-code eq utd-lines-attr.attr-code
  and buf_c-utd-lines-attr.corr-user-db-num   = g#db-num and buf_c-utd-lines-attr.chip-num = v-Seq exclusive-lock: leave. end.
    ...
    then do:
       ...
       buffer-copy ub.utd-lines-attr to buf_c-utd-lines-attr
       assign
         ...
         buf_c-utd-lines-attr.action             = 99
         buf_c-utd-lines-attr.is-del             = true
       .
    end.
    else
       buf_c-utd-lines-attr.action             = 99.
      if vFlagSeq
      then do:
 for first buf_c-utd-head where buf_c-utd-head.db-num eq utd-lines-attr.db-num
and buf_c-utd-head.doc-id eq utd-lines-attr.doc-id
