...
define variable vss-description as character no-undo init "—оздать запись о том, что необходимо пересчитать складской архив по типам приобретени€".
...
procedure vss-get-parameters :
  define output parameter p-vss-parameters as character no-undo .
    assign
      p-vss-parameters = substitute('&1|&2|&3|&4',p-doc-code,p-table-name,p-obj-type,p-obj-code)
    .
end procedure.
...
:
  ...
  if not available ub.BatchProcess then do:
    ...
    assign
      ...
      ub.BatchProcess.CharKey_Two   = p-table-name
      ub.BatchProcess.CharKey_Three = p-obj-type
    .
  end.
end.
