...
do transaction
  ...
  do:
    ...
    v-chip-num = next-value (s-action-role-chip, ub) .
    ...
    assign
      ...
      buf_c-action-role-item.subject        = 'action-role-item':U
      buf_c-action-role-item.action         = integer(if new(ub.action-role-item) then '1':U else '2':U)
      .
    ...
    assign
      buf_c-action-role.subject = 'action-role-item':U
      buf_c-action-role.action  = integer(if new(ub.action-role-item) then '1':U else '2':U)
      .
