...
do transaction
    ...
    do:
        ...
        buffer-copy ub.action-role-item to buf_c-action-role-item
            assign
            buf_c-action-role-item.chip-num           = next-value (s-action-role-chip, ub)
            ...
            buf_c-action-role-item.is-del             = yes
            buf_c-action-role-item.subject            = 'action-role-item':U
            buf_c-action-role-item.action             = integer('99':U)
            .
        ...
        buffer-copy buf_c-action-role-item to buf_c-action-role
            ...
            buf_c-action-role.action             = integer('99':U)
            .
        run trg/userlog.p (
            input 'delete':U
