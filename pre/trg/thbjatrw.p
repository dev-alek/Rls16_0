...
:
 if not g#news then do:
   if (ub.thbj-attr.obj-type = 'орг':U
   or ub.thbj-attr.obj-type = '':U
   or (ub.thbj-attr.obj-type = 'БД':U and  g#db-num <>  ub.thbj-attr.obj-code)
   )
...
if (valid-handle(g#lib-nws) <> true) then do:   run nws/lib-nws.p persistent no-error .   if error-status :error or (valid-handle(g#lib-nws) <> true) then do:     message       "Error starting nws/lib-nws.p" skip       g#lib-nws skip       g#lib-nws :type skip       g#lib-nws :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run lib-nws_get-hn-option in g#lib-nws
  ...
  or v-send >= 0 then do:
    ...
    buf_c-thbj-attr.subject = 'thbj-attr':U
    .
    if ub.thbj-attr.obj-type = 'маг':U
    or ub.thbj-attr.obj-type = 'скл':U then do:
define variable vss-include-info3 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run hostcode in g#library
  (input  ub.thbj-attr.obj-type
  ,input  ub.thbj-attr.obj-code
  ,output v-host-code
  )  .
    end.
    ...
    .
    if ub.thbj-attr.upper-prop-code = 'marking':U and
       ub.thbj-attr.prop-code = 'ban-recipes':U and
       ub.thbj-attr.property-value-logical = true then do:
          if buf_c-thbj-attr.property-value-logical <> ub.thbj-attr.property-value-logical then
...
for each buf_PromoGift no-lock:
   if can-find (first buf_goods-attr no-lock where buf_goods-attr.gds-code = buf_PromoGift.gds-code and
      buf_goods-attr.attr-code = 'mark-type':U and buf_goods-attr.attr-value <> "not-type" and
   ...
   do:
    ...
    if available (buf_clients) then do:
      ...
      , input this-procedure
      , input "str/promosendoxml.p":U  + chr(4) +
                "1":U  + chr(4) +
                "1":U + chr(4) +
                "1":U
      , input ('IBM-XML':U + chr(4) + buf_clients.obj-type + chr(4) + string(buf_clients.obj-code) + chr(4) + "U":U + chr(4) + string(buf_clients.db-num) + chr(4) + string(buf_PromoAction.id))
      , input yes
      , input "":U
