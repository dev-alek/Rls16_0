...
do transaction
    ...
    if ub.price-doc-forming.stts = integer('3':U) then
    do:
        ...
        do:
            ...
            assign
                ...
                ub.c-price-doc-forming.chip-num         = next-value ( s-corr-chip, ub)
    ...
    if ub.price-doc-forming.stts = integer('1':U) then
    do:
    ...
    if g#news = false and  (
        ub.price-doc-forming.stts = integer('4':U)  or
        ub.price-doc-forming.stts = integer('3':U)   or
        ub.price-doc-forming.stts = integer('1':U) )   then
    do:
        run str/callnews.p
    ...
    if ( g#news = false or (g#news = true  and g#db-num = 0 )) and
        ( ub.price-doc-forming.stts = integer('1':U) and
        old_price-doc-forming.stts <> integer('1':U)
        ) then
    do:
    ...
    do
        ...
        do:
            for each ub.db no-lock where
                ub.db.db-num <> 0
                :
                db-list = db-list + string(ub.db.db-num)  +  chr(1).
            end.
            db-list = trim(db-list , chr(1)) .
        end.
        run trg/cmd-pdf.p (
