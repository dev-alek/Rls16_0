...
procedure vss-get-parameters :
  define output parameter p-vss-parameters as character no-undo .
    assign
      p-vss-parameters = substitute('&1|&2', ub.fin-statement.host-code, ub.fin-statement.sttm-code)
    .
end procedure.
...
:
  ...
  if (ub.fin-statement.status_ = 'факт':U
  OR ub.fin-statement.status_ = 'банк':U)
  ...
  if not g#news
  and ub.fin-statement.status_ <> 'новый':U
  and ub.fin-statement.status_ <> 'факт':U then do:
