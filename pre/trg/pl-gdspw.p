...
do
    ...
    do:
        ...
        buffer-copy old_pl-gds-pump
            ...
            buf_c-pl-gds-pump.chip-num           = next-value (s-plc-chip, ub)
        ...
        buffer-copy buf_c-pl-gds-pump to buf_c-plc-hist
            assign
            buf_c-plc-hist.action = (if new new_pl-gds-pump then integer('1':U) else integer('2':U))
            buf_c-plc-hist.subject = 'pl-gds-pump':U
...
case true:
  ...
  otherwise v-initiator = "User".
            ...
            v-vid-param =
                ...
                "SHOP_NUM=" + string(buf_c-plc-hist.obj-code) + chr(4) +
                "pl-code=" + string(buf_c-plc-hist.pl-code) + chr(4) +
                "old-status_=" + buf_c-pl-gds-pump.status_  + chr(4) +
                "status_=" + new_pl-gds-pump.status_ + chr(4) +
                "gds-code=" + string(buf_c-plc-hist.gds-code) + chr(4) +
                "gds-name=" + v-gds-name.
            run trg/userlog.p (
                input 'update':U
                , input 'c-plc-hist':U
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run hostcode in g#library
  (input  new_pl-gds-pump.obj-type
  ,input  new_pl-gds-pump.obj-code
  ,output v-host-code
  )  .
        ...
        buffer-copy buf_c-pl-gds-pump
            ...
            to buf_c-gds-hist
            assign
            buf_c-gds-hist.action = (if new new_pl-gds-pump then integer('1':U) else integer('2':U))
            buf_c-gds-hist.subject = 'pl-gds-pump':U
        ...
        assign
            ...
            buf_c-table-bind.subject          = 'pl-gds-pump':U
            .
        ...
        buffer-copy buf_c-pl-gds-pump
            ...
            to buf_c-pmp-hist
            assign
            buf_c-pmp-hist.action = (if new new_pl-gds-pump then integer('1':U) else integer('2':U))
            buf_c-pmp-hist.chip-num = next-value (s-pmp-chip, ub)
            buf_c-pmp-hist.subject = 'pl-gds-pump':U
        ...
        assign
            ...
            buf_c-table-bind.chip-num-src     = buf_c-pl-gds-pump.chip-num
            buf_c-table-bind.corr-user-db-num = buf_c-pl-gds-pump.corr-user-db-num
            buf_c-table-bind.tbl-name-rec     = 'c-pmp-hist':U
            buf_c-table-bind.tbl-name-src     = 'c-plc-hist':U
            buf_c-table-bind.is-news          = g#news
            buf_c-table-bind.corr-user-name   = g#userid
            buf_c-table-bind.subject          = 'pl-gds-pump':U
