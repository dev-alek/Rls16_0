...
procedure vss-get-parameters :
  define output parameter p-vss-parameters as character no-undo .
    assign
      p-vss-parameters = substitute('&1|&2|&3|&4|&5',p-d-card,p-host-code,p-obj-type,p-obj-code,p-action)
    .
end procedure.
...
:
  find first ub.batchprocess no-lock
    where ub.batchprocess.bp_type   = 'dcard':U
      ...
      and  ub.batchprocess.key#_one  = p-host-code
      and ub.batchprocess.key#_two = p-obj-code
      and ub.batchprocess.charkey_one = p-d-card
  ...
  if not available ub.BatchProcess then do:
    ...
    assign
      ub.BatchProcess.BP_Type       = 'dcard':U
    ...
    .
    assign
      ub.BatchProcess.Key#_One      = p-host-code
      ub.BatchProcess.Key#_Two      = p-obj-code
      ub.BatchProcess.CharKey_One   = p-d-card
