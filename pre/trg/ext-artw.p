      ...
      if g#news <> yes then do:
        ...
        buffer-copy old-ext-artic
          ...
          assign
             ...
             buf_c-ext-artic.chip-num = next-value( s-gds-chip , ub )
             ...
             buf_c-ext-artic.action = ( if new new-ext-artic then integer( '1':U ) else integer( '2':U ) )
          .
      create buf_c-gds-hist.
      buffer-copy buf_c-ext-artic to buf_c-gds-hist
      assign
        buf_c-gds-hist.action       = (if new new-ext-artic then integer('1':U) else integer('2':U))
        buf_c-gds-hist.subject      = 'ext-artic':U
