...
define variable v-fact-qnty      like ub.ot-supp-tot.fact-qnty       no-undo .     define variable v-sum-base       like ub.ot-supp-tot.sum-base        no-undo .     define variable v-sum-rubl       like ub.ot-supp-tot.sum-rubl        no-undo .     define variable v-vat-base       like ub.ot-supp-tot.vat-base        no-undo .     define variable v-vat-rubl       like ub.ot-supp-tot.vat-rubl        no-undo .     define variable v-slt-base       like ub.ot-supp-tot.slt-base        no-undo .     define variable v-slt-rubl       like ub.ot-supp-tot.slt-rubl        no-undo .     define variable v-road-tax-base  like ub.ot-supp-tot.road-tax-base   no-undo .     define variable v-road-tax-rubl  like ub.ot-supp-tot.road-tax-rubl   no-undo .     define variable v-excise-base    like ub.ot-supp-tot.excise-base     no-undo .     define variable v-excise-rubl    like ub.ot-supp-tot.excise-rubl     no-undo .     define variable v-transport-base like ub.ot-supp-tot.transport-base  no-undo .     define variable v-transport-rubl like ub.ot-supp-tot.transport-rubl  no-undo .     define variable v-other-base     like ub.ot-supp-tot.other-base      no-undo .     define variable v-other-rubl     like ub.ot-supp-tot.other-rubl      no-undo .
    ...
    :
      ...
      :
        ...
        :
          ...
          assign
                                                                                                            buf_temp-stk-supp-line.new-fact-qnty      = buf_temp-stk-supp-line.new-fact-qnty      + v-fact-qnty           buf_temp-stk-supp-line.new-sum-base       = buf_temp-stk-supp-line.new-sum-base       + v-sum-base            buf_temp-stk-supp-line.new-sum-rubl       = buf_temp-stk-supp-line.new-sum-rubl       + v-sum-rubl            buf_temp-stk-supp-line.new-vat-base       = buf_temp-stk-supp-line.new-vat-base       + v-vat-base            buf_temp-stk-supp-line.new-vat-rubl       = buf_temp-stk-supp-line.new-vat-rubl       + v-vat-rubl            buf_temp-stk-supp-line.new-slt-base       = buf_temp-stk-supp-line.new-slt-base       + v-slt-base            buf_temp-stk-supp-line.new-slt-rubl       = buf_temp-stk-supp-line.new-slt-rubl       + v-slt-rubl            buf_temp-stk-supp-line.new-road-tax-base  = buf_temp-stk-supp-line.new-road-tax-base  + v-road-tax-base       buf_temp-stk-supp-line.new-road-tax-rubl  = buf_temp-stk-supp-line.new-road-tax-rubl  + v-road-tax-rubl       buf_temp-stk-supp-line.new-excise-base    = buf_temp-stk-supp-line.new-excise-base    + v-excise-base         buf_temp-stk-supp-line.new-excise-rubl    = buf_temp-stk-supp-line.new-excise-rubl    + v-excise-rubl         buf_temp-stk-supp-line.new-transport-base = buf_temp-stk-supp-line.new-transport-base + v-transport-base      buf_temp-stk-supp-line.new-transport-rubl = buf_temp-stk-supp-line.new-transport-rubl + v-transport-rubl      buf_temp-stk-supp-line.new-other-base     = buf_temp-stk-supp-line.new-other-base     + v-other-base          buf_temp-stk-supp-line.new-other-rubl     = buf_temp-stk-supp-line.new-other-rubl     + v-other-rubl
          .
          if v-shift-on = true
          then do:
            find first buf_temp-stk-supp-line
...
procedure update-tot :
  ...
  :
    ...
    :
      ...
      assign
                                                                        buf_temp-stk-supp-tot.new-fact-qnty      = buf_temp-stk-supp-tot.new-fact-qnty      + buf_temp-stk-supp-line.new-fact-qnty           buf_temp-stk-supp-tot.new-sum-base       = buf_temp-stk-supp-tot.new-sum-base       + buf_temp-stk-supp-line.new-sum-base            buf_temp-stk-supp-tot.new-sum-rubl       = buf_temp-stk-supp-tot.new-sum-rubl       + buf_temp-stk-supp-line.new-sum-rubl            buf_temp-stk-supp-tot.new-vat-base       = buf_temp-stk-supp-tot.new-vat-base       + buf_temp-stk-supp-line.new-vat-base            buf_temp-stk-supp-tot.new-vat-rubl       = buf_temp-stk-supp-tot.new-vat-rubl       + buf_temp-stk-supp-line.new-vat-rubl            buf_temp-stk-supp-tot.new-slt-base       = buf_temp-stk-supp-tot.new-slt-base       + buf_temp-stk-supp-line.new-slt-base            buf_temp-stk-supp-tot.new-slt-rubl       = buf_temp-stk-supp-tot.new-slt-rubl       + buf_temp-stk-supp-line.new-slt-rubl            buf_temp-stk-supp-tot.new-road-tax-base  = buf_temp-stk-supp-tot.new-road-tax-base  + buf_temp-stk-supp-line.new-road-tax-base       buf_temp-stk-supp-tot.new-road-tax-rubl  = buf_temp-stk-supp-tot.new-road-tax-rubl  + buf_temp-stk-supp-line.new-road-tax-rubl       buf_temp-stk-supp-tot.new-excise-base    = buf_temp-stk-supp-tot.new-excise-base    + buf_temp-stk-supp-line.new-excise-base         buf_temp-stk-supp-tot.new-excise-rubl    = buf_temp-stk-supp-tot.new-excise-rubl    + buf_temp-stk-supp-line.new-excise-rubl         buf_temp-stk-supp-tot.new-transport-base = buf_temp-stk-supp-tot.new-transport-base + buf_temp-stk-supp-line.new-transport-base      buf_temp-stk-supp-tot.new-transport-rubl = buf_temp-stk-supp-tot.new-transport-rubl + buf_temp-stk-supp-line.new-transport-rubl      buf_temp-stk-supp-tot.new-other-base     = buf_temp-stk-supp-tot.new-other-base     + buf_temp-stk-supp-line.new-other-base          buf_temp-stk-supp-tot.new-other-rubl     = buf_temp-stk-supp-tot.new-other-rubl     + buf_temp-stk-supp-line.new-other-rubl
      .
      if v-shift-on = true
      then do:
        find first buf_temp-stk-supp-tot
