...
trigger procedure for delete of ub.cashbookruleattr.
define variable vss-revision    as character no-undo initial "$Revision$":U .
define variable vss-author      as character no-undo initial "$Author$":U .
define variable vss-date        as character no-undo initial "$Date$":U .
define variable vss-workfile    as character no-undo initial "$Workfile$":U .
define variable vss-archive     as character no-undo initial "$Archive$":U .
define variable vss-description as character no-undo init "Тригер удаления cashbookruleattr".
...
define buffer buf_c-cashbook-head for ub.c-cashbook-head .
    ...
    if vFlagseq
    then do:
 for first buf_c-cashbookruleattr where buf_c-cashbookruleattr.cashbookid eq cashbookruleattr.cashbookid
and buf_c-cashbookruleattr.obj-type eq cashbookruleattr.obj-type
and buf_c-cashbookruleattr.obj-code eq cashbookruleattr.obj-code
and buf_c-cashbookruleattr.code eq cashbookruleattr.code
and buf_c-cashbookruleattr.attr-code eq cashbookruleattr.attr-code
  and buf_c-cashbookruleattr.corr-user-db-num   = g#db-num and buf_c-cashbookruleattr.chip-num = v-Seq exclusive-lock: leave. end.
    ...
    then do:
       ...
       buffer-copy ub.cashbookruleattr to buf_c-cashbookruleattr
       assign
         ...
         buf_c-cashbookruleattr.action             = 99
         buf_c-cashbookruleattr.is-del             = true
       .
    end.
    else
       buf_c-cashbookruleattr.action             = 99.
      ...
      then do:
         if vuniq-key-rec eq ""
            or vuniq-key-rec eq ?
         then do:
            run gen-key-rec in this-procedure ( input "c-cashbookruleattr"
                                               ,input (buffer buf_c-cashbookruleattr:handle)
      ...
      then do:
         ...
         buffer-copy  buf_c-cashbookruleattr to buf_c-cashbook-head
         assign
            buf_c-cashbook-head.subject = "cashbookruleattr"
  ...
  if not g#news then do :
    run nws/cmd-del.p
      ( input 'CashBookRuleAttr':U
       ,input (buffer ub.cashbookruleattr:handle)
       ,input "":U
      ) no-error .
