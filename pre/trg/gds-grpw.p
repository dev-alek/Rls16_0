...
:
  ...
  if g#db-num = 0 then do:
    if ub.gds-grp-obj-attr.attr-code = 'LimAssMat':U
    then do:
      ...
      if  ub.gds-grp-obj-attr.attr-code  <> 'QntyAssMat':U and ub.gds-grp-obj-attr.obj-code > 0 then do:
          find first buf_clients no-lock
        ...
        else if  ub.gds-grp-obj-attr.attr-code  <> 'QntyAssMat':U then do:
            assign
                v-list-db-for-send = ""
                v-need-send        = true
              .
