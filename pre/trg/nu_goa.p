...
procedure vss-get-parameters :
  define output parameter p-vss-parameters as character no-undo .
    assign
      p-vss-parameters = substitute('&1|&2|&3|&4|&5',p-gds-code,p-host-code,p-obj-type,p-obj-code,p-attr-code,p-action)
    .
end procedure.
...
:
  find first ub.batchprocess no-lock
    where ub.batchprocess.bp_type   = 'goa':U
      and ub.batchprocess.bp_status = 'N':U
      and  ub.batchprocess.key#_one  = p-gds-code
      ...
      and ub.batchprocess.charkey_two = p-attr-code
  no-error .
