...
procedure vss-get-parameters :
  define output parameter p-vss-parameters as character no-undo .
    assign
      p-vss-parameters = substitute('&1|&2|&3',ub.pump.obj-type,ub.pump.obj-code,ub.pump.pump-code)
    .
end procedure.
