...
procedure vss-get-parameters :
  define output parameter p-vss-parameters as character no-undo .
    assign
      p-vss-parameters = substitute('&1|&2|&3', ub.gds-season.sea-code, ub.gds-season.db-num, ub.gds-season.gds-code)
    .
end procedure.
...
if (valid-handle(g#lib-nws) <> true) then do:   run nws/lib-nws.p persistent no-error .   if error-status :error or (valid-handle(g#lib-nws) <> true) then do:     message       "Error starting nws/lib-nws.p" skip       g#lib-nws skip       g#lib-nws :type skip       g#lib-nws :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run lib-nws_get-hn-option in g#lib-nws
  ...
  or v-send >= 0 then do:
    ...
    assign
      buf_c-gds-season.chip-num           = next-value (s-corr-chip, ub)
    ...
    .
      ...
      assign
      buf_c-gds-hist.action       = (if new ub.gds-season then integer('1':U) else integer('2':U))
      buf_c-gds-hist.subject      = 'gds-season':U
  ...
  if g#news then do:
    ...
    find first buf_season-attr no-lock where buf_season-attr.sea-code = ub.gds-season.sea-code
      ...
      and buf_season-attr.attr-code = 'sea-obj':U no-error.
