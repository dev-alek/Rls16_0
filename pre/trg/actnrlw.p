...
:
  if not g#news then do:
        ...
        create buf_c-action-role.
            ...
            buf_c-action-role.chip-num           = next-value (s-action-role-chip, ub)
            ...
            buf_c-action-role.subject            = 'action-role':U
            buf_c-action-role.action             = integer(if new(ub.action-role) then '1':U else '2':U)
            .
