...
define output parameter pc-err-msg      as   character                   no-undo .
  ...
  :
    ...
    if v-tbl-name <> 'clob-data':U then do:
...
define output parameter pe-err-msg      as   character                   no-undo .
  ...
  :
    ...
    assign
    v-db-num = integer(entry(1, pe-parameters, chr(4)))
    v-int64-id = int64(entry(2, pe-parameters, chr(4)))
    v-old-crc-field = entry(3, pe-parameters, chr(4))
    .
...
define output parameter pr-err-msg      as   character                   no-undo .
  ...
  :
    ...
    assign
    v-db-num = integer(entry(1, pr-parameters, chr(4)))
    v-int64-id = int64(entry(2, pr-parameters, chr(4)))
    v-old-crc-field = entry(3, pr-parameters, chr(4))
    .
    find first buf_clob-data exclusive-lock where
