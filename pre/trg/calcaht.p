...
:
  ...
  then do:
    ...
    run day-begin-fact-order in this-procedure
      ...
      ,output v-aht-detail-fact-order
      ).
    run doclslib-check-aht-exist in this-procedure
      (input  p-obj-type
      ,input  p-obj-code
      ,input  v-aht-detail-fact-order
    ...
    then do:
      ...
      then do:
        ...
        run gbl/d-askw.w
          (input "Вопрос"
          ,input "На объекте уже есть рассчитанный складской архив по типам приобретения" + chr(10)
          ...
          ,input "Пересчитать архив по типам приобретения начиная с даты " +
              ...
              + "Удалить весь складской архив по типам приобретения и рассчитать их на основе документов" + chr(10)
              + (if v-aht-detail-date <> ?
