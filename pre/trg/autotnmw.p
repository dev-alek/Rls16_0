  ...
  then do:
    ...
    then do:
      ...
      assign
        ...
        ub.c-auto-tank.action           = integer('1':U)
        ub.c-auto-tank.is-add           = true
        ub.c-auto-tank.is-del           = false
        ub.c-auto-tank.chip-num         = next-value (s-ref-corr-chip, ub)
        ...
        ub.c-auto-tank.subject          = 'auto-tank-meas':U
      .
    end.
    else do:
      create ub.c-auto-tank .
      ...
      assign
        ub.c-auto-tank.auto-num         = ub.auto-tank-meas.auto-num
        ub.c-auto-tank.meas-label       = ub.auto-tank-meas.meas-label
        ub.c-auto-tank.action           = integer('2':U)
