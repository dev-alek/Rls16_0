...
run str/wthpartp.p  ( INPUT 'ДОБАВЛЕНИЕ':U,
                  ...
                  INPUT  tres-wth-parts.contract-code   ,
                  INPUT  tres-wth-parts.price-rubl    ,
                  INPUT  tres-wth-parts.price-base    ,
                  INPUT  tres-wth-parts.supp-type,
                  INPUT  tres-wth-parts.supp-code,
                  INPUT  tres-wth-parts.in-obj-type      ,
                  INPUT  tres-wth-parts.in-obj-code      ,
                  INPUT  tres-wth-parts.ext-doc-type,
                  INPUT  tres-wth-parts.gds-code,
                  INPUT  0           ,
                  INPUT  tres-wth-parts.beg-dt        ,
                  INPUT  tres-wth-parts.end-dt        ,
                  INPUT  tres-wth-parts.vat-pc      ,
                  INPUT  tres-wth-parts.cli-code,
                  INPUT  tres-wth-parts.cli-type,
                  INPUT  tres-wth-parts.out-obj-code,
                  INPUT  tres-wth-parts.out-obj-type,
                  INPUT  tres-wth-parts.sale-obj-code,
                  INPUT  tres-wth-parts.sale-obj-type,
