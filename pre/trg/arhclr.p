...
procedure vss-get-parameters :
  define output parameter p-vss-parameters as character no-undo .
    assign
      p-vss-parameters = substitute('&1|&2|&3|&4|&5':u,p-obj-type,p-obj-code,p-last-fact-order,p-cut-fact-order,v-export-file-name)
    .
end procedure.
