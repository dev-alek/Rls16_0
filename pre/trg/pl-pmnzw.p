...
do
    ...
    do:
        ...
        buffer-copy oldb_pl-pump-nozzle
            ...
            buf_c-pl-pump-nozzle.chip-num           = next-value (s-plc-chip, ub)
        ...
        buffer-copy buf_c-pl-pump-nozzle to buf_c-plc-hist
            assign
            buf_c-plc-hist.action = (if new newb_pl-pump-nozzle then integer('1':U) else integer('2':U))
            buf_c-plc-hist.subject = 'pl-pump-nozzle':U
        ...
        buffer-copy buf_c-pl-pump-nozzle
            ...
            buf_c-pmp-hist.action = (if new newb_pl-pump-nozzle then integer('1':U) else integer('2':U))
            buf_c-pmp-hist.subject = 'pl-pump-nozzle':U
        ...
        assign
            ...
            buf_c-table-bind.subject          = 'pl-pump-nozzle':U
            .
        ...
        buffer-copy buf_c-pl-pump-nozzle
            ...
            to buf_c-nzl-hist
            assign
            buf_c-nzl-hist.chip-num           = next-value (s-nzl-chip, ub)
            buf_c-nzl-hist.action = (if new newb_pl-pump-nozzle then integer('1':U) else integer('2':U))
            buf_c-nzl-hist.subject = 'pl-pump-nozzle':U
        ...
        assign
            ...
            buf_c-table-bind.chip-num-src     = buf_c-pl-pump-nozzle.chip-num
            buf_c-table-bind.corr-user-db-num = buf_c-pl-pump-nozzle.corr-user-db-num
            buf_c-table-bind.tbl-name-rec     = 'c-nzl-hist':U
            buf_c-table-bind.tbl-name-src     = 'c-plc-hist':U
            buf_c-table-bind.is-news          = g#news
            buf_c-table-bind.corr-user-name   = g#userid
            buf_c-table-bind.subject          = 'pl-pump-nozzle':U
