...
:
  ...
  if ub.dis-grp-rule.obj-type = 'маг':U
  or ub.dis-grp-rule.obj-type = 'скл':U then do:
define variable vss-include-info2 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run objdbnum in g#library
  (input  ub.dis-grp-rule.obj-type
  ,input  ub.dis-grp-rule.obj-code
  ,output v-obj-db-num
  )  .
  ...
  or v-send >= 0 then do:
    ...
    CASE buf_c-dis-grp-rule.classif-type:
      when 'cli-grp':U then do:
        assign
        buf_c-dis-grp-rule.chip-num           = next-value (s-cli-grp-chip, ub)
        .
        create buf_c-cli-grp.
        buffer-copy buf_c-dis-grp-rule to buf_c-cli-grp
        assign
        buf_c-cli-grp.action = integer('99':U)
        buf_c-cli-grp.subject = 'dis-grp-rule':U
      ...
      when 'gds-grp':U then do:
        assign
        buf_c-dis-grp-rule.chip-num           = next-value (s-gds-grp-chip, ub)
        .
        ...
        buf_c-gds-grp-hist.action = integer('99':U)
        buf_c-gds-grp-hist.subject = 'dis-grp-rule':U
      ...
      when 'sum-grp':U then do:
        assign
        buf_c-dis-grp-rule.chip-num           = next-value (s-ref-corr-chip, ub)
        .
        create buf_c-sum-grp.
        buffer-copy buf_c-dis-grp-rule to buf_c-sum-grp
        assign
        buf_c-sum-grp.grp-code    = ub.dis-grp-rule.node-code
        buf_c-sum-grp.action = integer('99':U)
        buf_c-sum-grp.subject = 'dis-grp-rule':U
        .
      end.
      when 'sum-grp-obj':U then do:
        assign
        buf_c-dis-grp-rule.chip-num           = next-value (s-ref-obj-corr-chip, ub)
        .
        ...
        buf_c-sum-grp-obj.action = integer('99':U)
        buf_c-sum-grp-obj.subject = 'dis-grp-rule':U
        .
      end.
    END CASE.
  end.
