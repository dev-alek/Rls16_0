...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run hostcode in g#library
  ...
  IF p-mode = 'ИЗМЕНЕНИЕ':U THEN DO:
    FIND FIRST LOCKED_thbj-attr EXCLUSIVE-LOCK WHERE
        ...
        AND   LOCKED_thbj-attr.upper-prop-code = 'cd-type-autotank':U
...
DO ii = 1 TO  NUM-ENTRIES(v-cash-pay-list, ";"):
  ...
  v-cdpay-code-autotank = integer(entry(1, entry(1, v-entry, chr(47)), chr(44)))
  v-autotank-obj-name = entry(2, entry(1, v-entry, chr(47)), chr(44))
...
FOR EACH tt-cash-pay-autotank BY tt-cash-pay-autotank.autotank-cdpay-code:
  ...
  v-cash-pay-list = v-cash-pay-list + (IF v-cash-pay-list = "":U THEN "":U ELSE ";") +
                    STRING(tt-cash-pay-autotank.autotank-cdpay-code) + chr(44) +
                    STRING(tt-cash-pay-autotank.autotank-obj-name) +
                    chr(47) +
                    STRING(tt-cash-pay-autotank.cdpay-code) + chr(44) +
...
find first thbjattr_thbj-attr where thbjattr_thbj-attr.prop-code = 'ibmgroup':U.
assign
