...
define variable vss-workfile    as character no-undo init "$Workfile: l-i-free.w $":U .
define variable vss-archive     as character no-undo init "$Archive: adm/l-i-free.w $":U .
define variable vss-description as character no-undo init "Окно входа в СВПЗ".
...
DEFINE FRAME FRAME-A
     name AT ROW 4.71 COL 10 COLON-ALIGNED
