...
do:
  BROWSE-1 :SET-REPOSITIONED-ROW(6, "CONDITIONAL") .
end.
...
PROCEDURE local-open-query :
  ...
  :
    ...
    open query BROWSE-1 for each temp-user-account .
    ...
    then do:
      ...
      then do:
        reposition BROWSE-1 to rowid rowid(buf_repos_temp-user-account) .
      end.
    end.
  end.
END PROCEDURE.
