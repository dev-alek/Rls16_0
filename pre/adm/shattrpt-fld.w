...
PROCEDURE adm-disable :
    DISABLE B-exit b-quit B-Help WITH FRAME D-Dialog.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN B-exit b-quit B-Help WITH FRAME D-Dialog.
        ...
        do:
          ...
          do:
            v-change-param = "IDParam="  + "otkl-fact-volume" + chr(4) +
              ...
              "ParamBefore=" + string(thbjattr_thbj-attr.property-value-decimal) + chr(4) +
        ...
        do:
          ...
          do:
            v-change-param = "IDParam="  + "otkl-density" + chr(4) +
              ...
              "ParamBefore=" + string(thbjattr_thbj-attr.property-value-character) + chr(4) +
