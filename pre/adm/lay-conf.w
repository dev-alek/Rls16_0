  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse br-laytables :handle
      .
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run currsysk in g#library
  ...
  assign
  v-layout-tables = v-layout-tables + chr(44) + 'layout':U +
                                chr(44) + 'layout-elem':U +
                                chr(44) + 'wi-mode':U +
                                chr(44) + 'rule':U +
                                chr(44) + 'ruleset':U
                                .
  assign
  v-layout-table-names = v-layout-table-names + chr(44) + 'Раскладка интерфе/клавиатуры':U +
                                chr(44) + 'Элементы раскладки':U +
                                chr(44) + 'Режимы работы':U +
                                chr(44) + "Правила (функции)" +
                                chr(44) + "Наборы правил (для органичения по режимам)"
                                .
  assign
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY br-laytables FOR EACH buf_file NO-LOCK WHERE lookup(buf_file._file-name,        v-layout-tables) > 0.
END PROCEDURE.
PROCEDURE MyEnable :
ASSIGN
