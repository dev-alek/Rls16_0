...
DO:
   MESSAGE "Help for File: c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\adm\shattr35.w" VIEW-AS ALERT-BOX INFORMATION.
END.
...
:
   ...
   :
      find first locked_thbj-attr
            where locked_thbj-attr.upper-prop-code = 'wnd-size':U
            exclusive-lock
            no-wait
            no-error
            .
    ...
    case v-entry:
      when 'max':U then do:
        assign
          ...
          tb-wndmax :private-data in frame Dialog-Frame = "recid=" + string(recid(thbjattr_thbj-attr))
        .
      end.
      when 'store':U then do:
        assign
          tb-wndstore = thbjattr_thbj-attr.property-value-logical
          tb-wndstore :private-data in frame Dialog-Frame = "recid=" + string(recid(thbjattr_thbj-attr))
        .
      end.
    end case.
