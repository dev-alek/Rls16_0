...
define variable vss-workfile    as character no-undo init "$Workfile: l-i-aupg.w $":U .
define variable vss-archive     as character no-undo init "$Archive: adm/l-i-aupg.w $":U .
define variable vss-description as character no-undo init "Окно входа в Upgarde".
