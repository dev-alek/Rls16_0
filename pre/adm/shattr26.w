...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run hostcode in g#library
  ...
  OPEN QUERY BR-thbj-attr FOR EACH buf_temp-thbj-attr WHERE     buf_temp-thbj-attr.obj-type = p-obj-type AND buf_temp-thbj-attr.obj-code = p-obj-code                                                     .
...
DO:
  ...
  run ref/cthbjatr.w (
                      ...
                      ,input ''
                      ,input "one"
                      ,input buf_temp-thbj-attr.obj-type
                      ,input buf_temp-thbj-attr.obj-code
      ...
      if buf_rule-profile.profile-type = 'cmb':U then do:
        do v-ii = 1 to num-entries('dis-card-type,goods,clients,gds-grp,cli-grp,chk-doc_IBS-TH,chk-doc_IBS-TH-MOB,edoc,thref,pdf,rep,ord,cmb,fdoc':U):
         ...
         vv-call-id = X_rp-by-call.call_id.
          entry(lookup('cmb':U, X_rp-by-call.call_id, chr(3)), vv-call-id, chr(3)) = entry(v-ii, 'dis-card-type,goods,clients,gds-grp,cli-grp,chk-doc_IBS-TH,chk-doc_IBS-TH-MOB,edoc,thref,pdf,rep,ord,cmb,fdoc':U).
...
DO:
  ASSIGN
  rs-algo-types.
  OPEN QUERY br-rule-by-call FOR EACH X_rule-by-call       WHERE X_rule-by-call.call_id = v-uniq-key-rec,            FIRST X_rule-profile NO-LOCK WHERE          X_rule-profile.profile_id = X_rule-by-call.profile_id      AND (rs-algo-types = 1 OR          X_rule-profile.is_dynamic = yes)     AND ((NOT v-is-obj) OR  LOOKUP( "obj",        X_rule-profile.short-name) > 0) BY X_rule-by-call.codex_id BY X_rule-by-call.ruleset_id BY X_rule-by-call.order_id INDEXED-REPOSITION.
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run hostcode in g#library
  ...
  ,output v-host-code
    ...
    v-current-upper-prop-code = 'rum_obj':U.
  end.
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run hostcode in g#library
  ...
  if p-obj-type = '':U then do:
    ...
    v-current-upper-prop-code = 'rum':U.
  end.
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY br-profile FOR EACH X_rp-by-call NO-LOCK WHERE          X_rp-by-call.call_id = v-uniq-key-rec ,        FIRST X2_rule-profile WHERE     X2_rule-profile.profile_id = X_rp-by-call.profile_id     AND ((NOT v-is-obj) OR LOOKUP('obj',        X2_rule-profile.short-name) > 0) INDEXED-REPOSITION.    OPEN QUERY br-rule-by-call FOR EACH X_rule-by-call       WHERE X_rule-by-call.call_id = v-uniq-key-rec,            FIRST X_rule-profile NO-LOCK WHERE          X_rule-profile.profile_id = X_rule-by-call.profile_id      AND (rs-algo-types = 1 OR          X_rule-profile.is_dynamic = yes)     AND ((NOT v-is-obj) OR  LOOKUP( "obj",        X_rule-profile.short-name) > 0) BY X_rule-by-call.codex_id BY X_rule-by-call.ruleset_id BY X_rule-by-call.order_id INDEXED-REPOSITION.    OPEN QUERY BR-thbj-attr FOR EACH buf_temp-thbj-attr WHERE     buf_temp-thbj-attr.obj-type = p-obj-type AND buf_temp-thbj-attr.obj-code = p-obj-code                                                     .
END PROCEDURE.
...
find first thbjattr_thbj-attr where thbjattr_thbj-attr.prop-code = 'edoc':U.
assign
thbjattr_thbj-attr.property-value-character = v-edoc
.
find first thbjattr_thbj-attr where thbjattr_thbj-attr.prop-code = 'goods':U.
assign
thbjattr_thbj-attr.property-value-character = v-goods
.
find first thbjattr_thbj-attr where thbjattr_thbj-attr.prop-code = 'clients':U.
assign
thbjattr_thbj-attr.property-value-character = v-clients
.
find first thbjattr_thbj-attr where thbjattr_thbj-attr.prop-code = 'gds-grp':U.
assign
thbjattr_thbj-attr.property-value-character = v-gds-grp
.
find first thbjattr_thbj-attr where thbjattr_thbj-attr.prop-code = 'cli-grp':U.
assign
thbjattr_thbj-attr.property-value-character = v-cli-grp
.
find first thbjattr_thbj-attr where thbjattr_thbj-attr.prop-code = 'rep':U.
assign
thbjattr_thbj-attr.property-value-character = v-rep
.
find first thbjattr_thbj-attr where thbjattr_thbj-attr.prop-code = 'fdoc':U.
assign
thbjattr_thbj-attr.property-value-character = v-fdoc
.
find first thbjattr_thbj-attr where thbjattr_thbj-attr.prop-code = 'thref':U.
assign
thbjattr_thbj-attr.property-value-character = v-thref
.
find first thbjattr_thbj-attr where thbjattr_thbj-attr.prop-code = 'cmb':U.
assign
thbjattr_thbj-attr.property-value-character = v-cmb
.
find first thbjattr_thbj-attr where thbjattr_thbj-attr.prop-code = 'ord':U.
assign
thbjattr_thbj-attr.property-value-character = v-ord
.
find first thbjattr_thbj-attr where thbjattr_thbj-attr.prop-code = 'chk-doc_ibs-th':U.
assign
thbjattr_thbj-attr.property-value-character = v-chk-doc-ibs-th
.
find first thbjattr_thbj-attr where thbjattr_thbj-attr.prop-code = 'chk-doc_ibs-th-mob':U.
assign
...
OPEN QUERY br-rule-by-call FOR EACH X_rule-by-call       WHERE X_rule-by-call.call_id = v-uniq-key-rec,            FIRST X_rule-profile NO-LOCK WHERE          X_rule-profile.profile_id = X_rule-by-call.profile_id      AND (rs-algo-types = 1 OR          X_rule-profile.is_dynamic = yes)     AND ((NOT v-is-obj) OR  LOOKUP( "obj",        X_rule-profile.short-name) > 0) BY X_rule-by-call.codex_id BY X_rule-by-call.ruleset_id BY X_rule-by-call.order_id INDEXED-REPOSITION.
OPEN QUERY br-profile FOR EACH X_rp-by-call NO-LOCK WHERE          X_rp-by-call.call_id = v-uniq-key-rec ,        FIRST X2_rule-profile WHERE     X2_rule-profile.profile_id = X_rp-by-call.profile_id     AND ((NOT v-is-obj) OR LOOKUP('obj',        X2_rule-profile.short-name) > 0) INDEXED-REPOSITION.
