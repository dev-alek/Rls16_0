...
def var vss-workfile    as character no-undo init "$Workfile: l-i-diadoc.w $":U .
def var vss-archive     as character no-undo init "$Archive: adm/l-i-diadoc.w $":U .
def var vss-description as character no-undo init "Окно входа в ИС Диадок".
