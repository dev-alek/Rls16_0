...
END.
ON CHOOSE OF B-dfltggrp IN FRAME Dialog-Frame
DO:
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse BR-gdsscrvw :handle
      .
...
:
  ...
  IF p-mode = 'ИЗМЕНЕНИЕ':U THEN DO:
    FIND FIRST LOCKED_thbj-attr EXCLUSIVE-LOCK WHERE
        ...
        AND   LOCKED_thbj-attr.upper-prop-code = 'gds-ref':U
...
FOR EACH thbjattr_thbj-attr:
  ...
  IF v-entry = 'dif-nam1':U THEN DO:
    ASSIGN
    t-dif-nam1 = thbjattr_thbj-attr.property-value-logical
    t-dif-nam1:private-data in frame Dialog-Frame = "recid=" + string(recid(thbjattr_thbj-attr))
    .
  END.
  IF v-entry = 'dif-nam2':U THEN DO:
    ASSIGN
    t-dif-nam2 = thbjattr_thbj-attr.property-value-logical
    t-dif-nam2:private-data in frame Dialog-Frame = "recid=" + string(recid(thbjattr_thbj-attr))
    .
  END.
  IF v-entry = 'dpl-off':U THEN DO:
    ASSIGN
    t-dpl-off = thbjattr_thbj-attr.property-value-logical
    t-dpl-off:private-data in frame Dialog-Frame = "recid=" + string(recid(thbjattr_thbj-attr))
    .
  END.
  IF v-entry = 'dif-pdbc':U THEN DO:
    ASSIGN
    t-dif-pdbc = thbjattr_thbj-attr.property-value-logical
    t-dif-pdbc:private-data in frame Dialog-Frame = "recid=" + string(recid(thbjattr_thbj-attr))
    .
  END.
  IF v-entry = 'pbc-veto':U THEN DO:
    ASSIGN
    t-pbc-veto = thbjattr_thbj-attr.property-value-logical
    t-pbc-veto:private-data in frame Dialog-Frame = "recid=" + string(recid(thbjattr_thbj-attr))
    .
  END.
  IF v-entry = 'tnvedimp':U THEN DO:
    ASSIGN
    t-tnvedimp = thbjattr_thbj-attr.property-value-logical
    t-tnvedimp:private-data in frame Dialog-Frame = "recid=" + string(recid(thbjattr_thbj-attr))
    .
  END.
  IF v-entry = 'shema-foto':U THEN DO:
    ASSIGN
    f-shema-foto = thbjattr_thbj-attr.property-value-integer
    f-shema-foto:private-data = "recid=" + string(recid(thbjattr_thbj-attr))
    .
  end.
  IF v-entry = 'unq-artc':U THEN DO:
    ASSIGN
    t-unq-artc = thbjattr_thbj-attr.property-value-logical
    t-unq-artc:private-data in frame Dialog-Frame = "recid=" + string(recid(thbjattr_thbj-attr))
    .
  END.
  IF v-entry = 'is-scgb':U THEN DO:
    ASSIGN
    t-is-scgb = thbjattr_thbj-attr.property-value-logical
    t-is-scgb:private-data in frame Dialog-Frame = "recid=" + string(recid(thbjattr_thbj-attr))
    .
  END.
  IF v-entry = 'dfltggrp':U THEN DO:
    ASSIGN
...
END.
ASSIGN
rs-gdsoattr:RADIO-BUTTONS IN FRAME Dialog-Frame =
"Не копировать" + chr(44) + STRING(0) + chr(44) +
"По текущему объекту" + chr(44) + STRING(1) + chr(44) +
"Объекта той же фирмы в тек. БД" + chr(44) + STRING(2) + chr(44) +
"Все объекты тек. БД" + chr(44) + STRING(3)
rs-gdshattr:RADIO-BUTTONS IN FRAME Dialog-Frame =
   "Не копировать" + chr(44) + STRING(0) + chr(44) +
    "По текущей фирме" + chr(44) + STRING(1) + chr(44) +
    "Все фирмы" + chr(44) + STRING(2)
rs-fgdsobj:RADIO-BUTTONS IN FRAME Dialog-Frame =
    "Не копировать" + chr(44) + STRING(0) + chr(44) +
    "По текущему объекту" + chr(44) + STRING(1) + chr(44) +
    "Объекта той же фирмы в тек. БД" + chr(44) + STRING(2) + chr(44) +
    "Все объекты тек. БД" + chr(44) + STRING(3)
rs-s-coeff:RADIO-BUTTONS IN FRAME Dialog-Frame =
        "Не копировать" + chr(44) + STRING(0) + chr(44) +
        "По текущему объекту и глобальные" + chr(44) + STRING(1) + chr(44) +
        "Объекта той же фирмы в тек. БД и глобальные" + chr(44) + STRING(2) + chr(44) +
        "Все объекты тек. БД и глобальные" + chr(44) + STRING(3)
rs-gds-prop:RADIO-BUTTONS IN FRAME Dialog-Frame =
        "Не копировать" + chr(44) + STRING(0) + chr(44) +
        "По текущему объекту" + chr(44) + STRING(1) + chr(44) +
        "Объекта той же фирмы в тек. БД" + chr(44) + STRING(2) + chr(44) +
        "Все объекты тек. БД" + chr(44) + STRING(3)
rs-gds-attr:RADIO-BUTTONS IN FRAME Dialog-Frame =
            "Не копировать" + chr(44) + STRING(0) + chr(44) +
             "Копировать" + chr(44) + STRING(1)
rs-add-prop:RADIO-BUTTONS IN FRAME Dialog-Frame =
                "Не копировать" + chr(44) + STRING(0) + chr(44) +
                 "Копировать" + chr(44) + STRING(1)
.
if p-obj-type = 'маг':U
...
ASSIGN
temp-gdsscrvw.is-on:read-only IN BROWSE br-gdsscrvw = (p-mode = 'ПРОСМОТР':U).
DISPLAY
l-add-prop
l-fbr-gds-obj
l-gds-host-attr
...
b-quit
B-Help
t-dif-nam1 WHEN p-mode = 'ИЗМЕНЕНИЕ':U
t-dif-nam2 WHEN p-mode = 'ИЗМЕНЕНИЕ':U
t-dpl-off WHEN p-mode = 'ИЗМЕНЕНИЕ':U
t-dif-pdbc WHEN p-mode = 'ИЗМЕНЕНИЕ':U
t-pbc-veto WHEN p-mode = 'ИЗМЕНЕНИЕ':U
t-tnvedimp WHEN p-mode = 'ИЗМЕНЕНИЕ':U
f-shema-foto WHEN p-mode = 'ИЗМЕНЕНИЕ':U
t-unq-artc WHEN p-mode = 'ИЗМЕНЕНИЕ':U
t-is-scgb  WHEN p-mode = 'ИЗМЕНЕНИЕ':U
b-dfltggrp WHEN p-mode = 'ИЗМЕНЕНИЕ':U
rs-add-prop  WHEN p-mode = 'ИЗМЕНЕНИЕ':U
rs-fgdsobj WHEN p-mode = 'ИЗМЕНЕНИЕ':U
rs-s-coeff WHEN p-mode = 'ИЗМЕНЕНИЕ':U
rs-gds-attr WHEN p-mode = 'ИЗМЕНЕНИЕ':U
rs-gdshattr WHEN p-mode = 'ИЗМЕНЕНИЕ':U
rs-gdsoattr WHEN p-mode = 'ИЗМЕНЕНИЕ':U
rs-gds-prop WHEN p-mode = 'ИЗМЕНЕНИЕ':U
br-gdsscrvw
WITH FRAME Dialog-Frame.
VIEW FRAME Dialog-Frame.
...
END.
ASSIGN
v-gdsscrvw = TRIM(v-gdsscrvw, chr(44)).
ASSIGN
FRAME Dialog-Frame
t-dif-nam1
t-dif-nam2
...
find first thbjattr_thbj-attr where thbjattr_thbj-attr.prop-code = 'gds-copy':U.
assign
thbjattr_thbj-attr.property-value-character = v-gds-copy-list
.
release thbjattr_thbj-attr.
find first thbjattr_thbj-attr where thbjattr_thbj-attr.prop-code = 'gdsscrvw':U.
assign
