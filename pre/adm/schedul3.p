...
define variable vss-include-info4 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
  ...
  run trg/userlog.p (
        ...
        , input ("Удаление расписания автозаданий на объекте " +
                ...
                tt-sched.task-type + ";" +
                (if tt-sched.task-type = 'autofree':U then v-free-id else "0") + ";" +
                ...
                tt-sched.task-type + chr(6) +
                (if tt-sched.task-type = 'autofree':U then v-free-id else "0") + chr(6) +
                string(tt-sched.task-num) + chr(6) +
                (if tt-sched.active then "1" else "0") + chr(6) +
                tt-sched.task-year + chr(6) +
                tt-sched.task-month + chr(6) +
                tt-sched.task-day + chr(6) +
                tt-sched.task-weekday + chr(6) +
                tt-sched.task-hour + chr(6) +
                tt-sched.task-minute + chr(6) +
                "del" + chr(6) +
