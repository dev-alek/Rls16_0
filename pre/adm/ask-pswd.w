...
procedure vss-get-parameters :
  define output parameter p-vss-parameters as character no-undo .
    assign
      p-vss-parameters = substitute('&1':u,ittl)
    .
end procedure.
...
ON WINDOW-CLOSE OF FRAME d-ask-pswd
DO:
  APPLY "END-ERROR":U TO SELF.
END.
ON CHOOSE OF b-exit IN FRAME d-ask-pswd
DO:
   en-pswd = encode (input pswd).
END.
ON CHOOSE OF b-quit IN FRAME d-ask-pswd
DO:
   en-pswd = ?.
END.
ON LEAVE OF pswd IN FRAME d-ask-pswd
DO:
END.
IF VALID-HANDLE(ACTIVE-WINDOW) AND FRAME d-ask-pswd:PARENT eq ?
THEN FRAME d-ask-pswd:PARENT = ACTIVE-WINDOW.
define variable vss-include-info0 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
on help of frame d-ask-pswd
do:
  run gbl/app_help.p
...
on choose of b-help in frame d-ask-pswd
do:
  apply "help":u to frame d-ask-pswd .
end.
...
procedure minbtn-set :
    do
        ...
        do
            ...
            :
            assign
                v-frame-width = frame d-ask-pswd:width - 0.3
                fh            = frame d-ask-pswd:first-child
                hh            = fh:first-child
                ii            = 1
                .
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  WAIT-FOR GO OF FRAME d-ask-pswd.
END.
RUN disable_UI.
