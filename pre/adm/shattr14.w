...
FIND last buf_temp-xtd WHERE
 ...
 RELEASE buf_temp-xtd.
 OPEN QUERY BR-xtd FOR EACH temp-xtd.
END.
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse BR-xtd :handle
      .
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run hostcode in g#library
  ...
  IF p-mode = 'ИЗМЕНЕНИЕ':U THEN DO:
    FIND FIRST LOCKED_thbj-attr EXCLUSIVE-LOCK WHERE
        ...
        AND   LOCKED_thbj-attr.upper-prop-code = 'cd-type-NCR-AS-R':U
...
B-Help
br-xtd
RS-ncrscpfx WHEN p-mode = 'ИЗМЕНЕНИЕ':U
RS-ncrpgpfx WHEN p-mode = 'ИЗМЕНЕНИЕ':U
b-up   WHEN p-mode = 'ИЗМЕНЕНИЕ':U
b-down   WHEN p-mode = 'ИЗМЕНЕНИЕ':U
rs-save-param WHEN p-mode = 'ИЗМЕНЕНИЕ':U
e-save-param WHEN p-mode = 'ИЗМЕНЕНИЕ':U
WITH FRAME Dialog-Frame.
VIEW FRAME Dialog-Frame.
...
find first thbjattr_thbj-attr where thbjattr_thbj-attr.prop-code = 'ncrscpfx':U.
assign
thbjattr_thbj-attr.property-value-integer = RS-ncrscpfx.
find first thbjattr_thbj-attr where thbjattr_thbj-attr.prop-code = 'ncrpgpfx':U.
assign
thbjattr_thbj-attr.property-value-integer = RS-ncrpgpfx.
find first thbjattr_thbj-attr where thbjattr_thbj-attr.prop-code = 'ncrdrank':U.
assign
thbjattr_thbj-attr.property-value-character = v-ncrdrank.
find first thbjattr_thbj-attr where thbjattr_thbj-attr.prop-code = 'save-param':U.
assign
