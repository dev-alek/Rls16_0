...
PROCEDURE adm-disable :
    DISABLE RECT-8 t-autopump-izm t-autopump t-avtinvpm t-olddens t-trnscanqr t-rvd-own-nb qr-scan-time t-autopump-skip-time t-block-nozzle timeout-block-nozzle rvs-wt-email WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-8 t-autopump-izm t-autopump t-avtinvpm t-olddens t-trnscanqr t-rvd-own-nb qr-scan-time t-autopump-skip-time t-block-nozzle timeout-block-nozzle rvs-wt-email WITH FRAME F-Main.
...
ON VALUE-CHANGED OF t-block-nozzle IN FRAME F-Main
DO:
...
PROCEDURE PartTwo-Init :
    ...
    case v-entry:
      when 'autopump':U then do:
        assign
          ...
          t-autopump :private-data in frame F-Main = "recid=" + string(recid(temp-thbj-attr))
        .
      end.
        when 'autopump-izm':U then do:
          assign t-autopump-izm =  temp-thbj-attr.property-value-logical
                 t-autopump-izm :private-data in frame F-Main = "recid=" + string(recid(temp-thbj-attr))
        .
          end.
      when 'autopump-skip-time':U then do:
          assign t-autopump-skip-time =  temp-thbj-attr.property-value-integer
             t-autopump-skip-time :private-data in frame F-Main = "recid=" + string(recid(temp-thbj-attr))
        .
      end.
      when 'avtinvpm':U then do:
        assign
          t-avtinvpm = temp-thbj-attr.property-value-logical
          t-avtinvpm :private-data in frame F-Main = "recid=" + string(recid(temp-thbj-attr))
        .
      end.
      when 'olddens':U then do:
        assign
          t-olddens = temp-thbj-attr.property-value-logical
          t-olddens :private-data in frame F-Main = "recid=" + string(recid(temp-thbj-attr))
        .
      end.
      when 'rvs-wt-email':U then do:
        assign
          rvs-wt-email = temp-thbj-attr.property-value-character
          rvs-wt-email :private-data in frame F-Main = "recid=" + string(recid(temp-thbj-attr))
        .
      end.
      when 'block-nozzle':U then
          do:
            assign
              ...
              t-block-nozzle :private-data in frame F-Main = "recid=" + string(recid(temp-thbj-attr))
            .
          end.
      when 'timeout-block-nozzle':U then
          do:
            assign
              ...
              timeout-block-nozzle :private-data in frame F-Main = "recid=" + string(recid(temp-thbj-attr))
            .
          end.
        when 'rvd-own-nb':U then
          do:
            assign
              ...
              t-rvd-own-nb :private-data in frame F-Main = "recid=" + string(recid(temp-thbj-attr))
            .
          end.
        when 'qr-scan-time':U then
          do:
            assign
              ...
              qr-scan-time :private-data in frame F-Main = "recid=" + string(recid(temp-thbj-attr))
            .
        end.
        when 'trnscanqr':U then
          do:
            assign
              ...
              t-trnscanqr :private-data in frame F-Main = "recid=" + string(recid(temp-thbj-attr))
            .
          end.
        otherwise do:
  ...
  DISPLAY t-autopump-izm t-autopump t-avtinvpm t-olddens t-trnscanqr t-rvd-own-nb qr-scan-time t-autopump-skip-time t-block-nozzle timeout-block-nozzle rvs-wt-email
      WITH FRAME F-Main.
END PROCEDURE.
...
PROCEDURE PartTwo-Get :
   ...
   ASSIGN FRAME F-Main t-autopump-izm t-autopump t-avtinvpm t-olddens t-trnscanqr t-rvd-own-nb qr-scan-time t-autopump-skip-time t-block-nozzle timeout-block-nozzle rvs-wt-email.
  assign
