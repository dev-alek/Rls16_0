  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse BR-imgorder :handle
      .
...
:
  ...
  IF p-mode = 'ИЗМЕНЕНИЕ':U THEN DO:
    ...
    FIND FIRST LOCKED_thbj-attr EXCLUSIVE-LOCK WHERE
        ...
        AND   LOCKED_thbj-attr.upper-prop-code = 'images':U
...
END.
ASSIGN
v-imgorder = TRIM(v-imgorder, chr(44)).
assign
fh = frame Dialog-Frame:first-child
wh = fh:first-child
.
...
find first thbjattr_thbj-attr where thbjattr_thbj-attr.prop-code = 'imgorder':U.
assign
