...
END.
ON VALUE-CHANGED OF T-lst IN FRAME DIALOG-1
DO:
    assign T-lst.
    IF T-lst then do:
        ENABLE B-lst with frame DIALOG-1.
        DISPLAY B-lst with frame DIALOG-1.
    end.
    else do:
        HIDE B-lst in frame DIALOG-1.
    end.
END.
