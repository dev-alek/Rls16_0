    ...
    :
      ...
      :
        if v-full-db-list <> "":U then do:
          assign
            v-full-db-list = v-full-db-list + chr(44)
          .
        end.
        assign
        ...
        if error-status:error then do:
          if v-unlock-db-list <> "":U then do:
            assign
              v-unlock-db-list = v-unlock-db-list + chr(44)
            .
          end.
          assign
          ...
          if v-lock-db-list <> "":U then do:
            assign
              v-lock-db-list = v-lock-db-list + chr(44)
            .
          end.
          assign
      ...
      :
        ...
        if p-message = "":U then do:
          ...
          assign
            p-message = p-message + chr(10) + v-temp-char
          .
        end.
      end.
      ...
      then do:
        ...
        return error substitute( "&1. Ошибка backup:&2&3", vss-workfile, chr(10), p-message ) .
      end.
    end.
  end.
  hide frame inf.
