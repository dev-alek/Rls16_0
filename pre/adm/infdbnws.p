  ...
  :
    ...
    :
        ...
        find first ub.db-info exclusive-lock
          where ub.db-info.db-num     = buf_sys-ctrl.db-num
            and ub.db-info.date-info  = v-today
            and ub.db-info.area-ID    = ub._areastatus._AreaStatus-Id
            and ub.db-info.volume-num = ub._AreaStatus._AreaStatus-Areanum
          no-error.
        if not available ub.db-info then do:
           create ub.db-info.
           assign
             ub.db-info.db-num      = buf_sys-ctrl.db-num
             ub.db-info.date-info   = v-today
             ub.db-info.area-id     = ub._areastatus._areastatus-id
             ub.db-info.area-name   = ub._areastatus._areastatus-areaname
             ub.db-info.volume-num  = ub._areastatus._areastatus-areanum
             ub.db-info.volume-name = ub._filelist._filelist-name
           .
        end.
        assign
          ub.db-info.time-info               = v-time
          ub.db-info.volume-size             = ub._FileList._FileList-Size
          ub.db-info.volume-hiwater          = sizetom
          ub.db-info.volume-percent-hiwater  = percenttom
          ub.db-info.volume-name = ub._filelist._filelist-name
        .
    end.
  end.
