...
DO:
   ...
   display ed-grp-obj WITH frame Dialog-Frame.
END.
ON CHOOSE OF b-help IN FRAME Dialog-Frame
OR HELP OF FRAME Dialog-Frame
DO:
  MESSAGE "Help for File: c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\adm\shattr27.w" VIEW-AS ALERT-BOX INFORMATION.
END.
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ...
   if p-mode =  'ИЗМЕНЕНИЕ':U then do:
      if v-cntxt-db-num = 0 then p-mode = 'ИЗМЕНЕНИЕ':U.
...
:
   ...
   FOR EACH thbjattr_thbj-attr-fin:
      IF thbjattr_thbj-attr-fin.prop-code = 'cligrplist':U THEN DO:
         v-cli-grp-code-list = thbjattr_thbj-attr-fin.property-value-character.
      END.
      IF thbjattr_thbj-attr-fin.prop-code = 'docdstnws':U THEN DO:
   ...
   :
      ...
      where buf_cli-grp.node-code = integer( entry( v-i, v-cli-grp-code-list, chr(44) ) )
      no-error .
...
:
   ...
   :
      find first buf_cli-grp
           where RECID(buf_cli-grp) = INTEGER(ENTRY(v-count, v-cli-grp-recid-list, chr(44)))
           no-lock
           no-error
           .
      IF AVAILABLE buf_cli-grp
      THEN DO:
         assign
            v-cli-grp-code-list = IF v-cli-grp-code-list = "":U THEN STRING(buf_cli-grp.node-code)
                                                                ELSE v-cli-grp-code-list + chr(44) + STRING(buf_cli-grp.node-code)
            ed-grp-obj = ed-grp-obj + buf_cli-grp.node-name + chr(10)
         .
      END.
   END.
  ...
  if (valid-handle(g#library2) <> true) then do:   run gbl/library2.p persistent no-error .   if error-status :error or (valid-handle(g#library2) <> true) then do:     message       "Error starting library2.p" skip       g#library2 skip       g#library2 :type skip       g#library2 :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run chk-actg in g#library2
    ...
    ,output v-ok
      ...
      find  first buf_thbj-attr
            ...
            and   buf_thbj-attr.upper-prop-code = 'attr-wthrep':U
      ...
      find  first buf_thbj-attr
            ...
            no-error
            .
      DISABLE b-quit WITH FRAME Dialog-Frame.
      b-exit:LABEL = "Вы&ход"  .
   ...
   then DO:
      undo, return error.
   END.
   apply "value-changed":u to b-cli-grp in frame Dialog-Frame.
   IF p-mode <> 'ИЗМЕНЕНИЕ':U
   THEN DO:
      DISABLE b-cli-grp WITH frame Dialog-Frame.
   END.
   display ed-grp-obj tg-docdstnws WITH frame Dialog-Frame.
end.
END PROCEDURE.
PROCEDURE save-proc :
define variable v-value-character as character no-undo .
...
on error undo, return error
:
   assign frame Dialog-Frame  tg-docdstnws.
   FOR EACH thbjattr_thbj-attr-fin:
      IF thbjattr_thbj-attr-fin.prop-code = 'cligrplist':U THEN DO:
         assign
