...
:
  ...
  log-file-name = entry(1 , p-parameter, chr(4)).
    run write-log-and-file in p-log-handle (                             input 1                                                           , input log-file-name                                               , input 1                                                           , input substitute("!!!Проверка отсутствия сессий, работающих в автоматическом режиме&1(по расписанию) займет менее 2 мин&1" +                             "Пожалуйста, ждите......"                             , chr(10))).
