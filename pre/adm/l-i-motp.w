...
def var vss-workfile    as character no-undo init "$Workfile: l-i-motp.w $":U .
def var vss-archive     as character no-undo init "$Archive: adm/l-i-motp.w $":U .
def var vss-description as character no-undo init "Окно входа в ИС МОТП".
...
END PROCEDURE.
PROCEDURE enable_UI :
  ENABLE IMAGE-1 name password_display b-OK b-quit
