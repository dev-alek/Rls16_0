...
def var vss-workfile    as character no-undo init "$Workfile: l-igetcd.w $":U .
def var vss-archive     as character no-undo init "$Archive: adm/l-igetcd.w $":U .
def var vss-description as character no-undo init "Окно входа в САПИК".
