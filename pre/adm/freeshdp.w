  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse BR-free-tasks :handle
      .
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY BR-free-tasks FOR EACH buf_temp-schedule-free.
END PROCEDURE.
PROCEDURE MyEnable :
assign
frame Dialog-Frame:title = "Произвольные задания"
