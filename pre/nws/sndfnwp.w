...
DEFINE BROWSE Br-params
  QUERY Br-params NO-LOCK DISPLAY
    ...
    WIDTH 10
calldscr(tt-ext-file-par.param-name) COLUMN-LABEL "Касса" FORMAT "X(255)":U
    WIDTH 40
tt-ext-file-par.param-value COLUMN-LABEL "Значение!симв. пар-ра" FORMAT "X(255)":U
    WIDTH 20
calldscr(tt-ext-file-par.param-value) COLUMN-LABEL "Файл" FORMAT "X(255)":U
    WIDTH 40
...
DO:
  CASE tt-ext-file-par.param-type:
    WHEN 'C':U THEN DO:
      ASSIGN
      tt-ext-file-par.param-name :bgcolor in browse Br-params = white_COLOR
      tt-ext-file-par.param-value :bgcolor in browse Br-params = white_COLOR
      tt-ext-file-par.param-date-name :bgcolor in browse Br-params = GREY_COLOR
      tt-ext-file-par.param-date-value :bgcolor in browse Br-params = GREY_COLOR
      tt-ext-file-par.param-int-name :bgcolor in browse Br-params = GREY_COLOR
      tt-ext-file-par.param-int-value :bgcolor in browse Br-params = GREY_COLOR
      tt-ext-file-par.param-log-name :bgcolor in browse Br-params = GREY_COLOR
      tt-ext-file-par.param-log-value:bgcolor in browse Br-params = GREY_COLOR
      tt-ext-file-par.param-date-name :fgcolor in browse Br-params = GREY_COLOR
      tt-ext-file-par.param-date-value :fgcolor in browse Br-params = GREY_COLOR
      tt-ext-file-par.param-int-name :fgcolor in browse Br-params = GREY_COLOR
      tt-ext-file-par.param-int-value :fgcolor in browse Br-params = GREY_COLOR
      tt-ext-file-par.param-log-name :fgcolor in browse Br-params = GREY_COLOR
      tt-ext-file-par.param-log-value:fgcolor in browse Br-params = GREY_COLOR
      .
    END.
    WHEN 'T':U THEN DO:
        ASSIGN
        tt-ext-file-par.param-name :bgcolor in browse Br-params = GREY_COLOR
        tt-ext-file-par.param-value :bgcolor in browse Br-params = GREY_COLOR
        tt-ext-file-par.param-date-name :bgcolor in browse Br-params = white_COLOR
        tt-ext-file-par.param-date-value :bgcolor in browse Br-params = white_COLOR
        tt-ext-file-par.param-int-name :bgcolor in browse Br-params = GREY_COLOR
        tt-ext-file-par.param-int-value :bgcolor in browse Br-params = GREY_COLOR
        tt-ext-file-par.param-log-name :bgcolor in browse Br-params = GREY_COLOR
        tt-ext-file-par.param-log-value:bgcolor in browse Br-params = GREY_COLOR
        tt-ext-file-par.param-name :fgcolor in browse Br-params = GREY_COLOR
        tt-ext-file-par.param-value :fgcolor in browse Br-params = GREY_COLOR
        tt-ext-file-par.param-int-name :fgcolor in browse Br-params = GREY_COLOR
        tt-ext-file-par.param-int-value :fgcolor in browse Br-params = GREY_COLOR
        tt-ext-file-par.param-log-name :fgcolor in browse Br-params = GREY_COLOR
        tt-ext-file-par.param-log-value:fgcolor in browse Br-params = GREY_COLOR
      ...
      WHEN 'I':U THEN DO:
        ...
        tt-ext-file-par.param-date-name :bgcolor in browse Br-params = GREY_COLOR
        tt-ext-file-par.param-date-value :bgcolor in browse Br-params = GREY_COLOR
        tt-ext-file-par.param-int-name :bgcolor in browse Br-params = white_COLOR
        tt-ext-file-par.param-int-value :bgcolor in browse Br-params = white_COLOR
        tt-ext-file-par.param-log-name :bgcolor in browse Br-params = GREY_COLOR
        tt-ext-file-par.param-log-value:bgcolor in browse Br-params = GREY_COLOR
        tt-ext-file-par.param-name :fgcolor in browse Br-params = GREY_COLOR
        tt-ext-file-par.param-value :fgcolor in browse Br-params = GREY_COLOR
      ...
      WHEN 'L':U THEN DO:
        ...
        tt-ext-file-par.param-int-name :bgcolor in browse Br-params = GREY_COLOR
        tt-ext-file-par.param-int-value :bgcolor in browse Br-params = GREY_COLOR
        tt-ext-file-par.param-log-name :bgcolor in browse Br-params = white_COLOR
        tt-ext-file-par.param-log-value:bgcolor in browse Br-params = white_COLOR
        tt-ext-file-par.param-name :fgcolor in browse Br-params = GREY_COLOR
        tt-ext-file-par.param-value :fgcolor in browse Br-params = GREY_COLOR
        tt-ext-file-par.param-date-name :fgcolor in browse Br-params = GREY_COLOR
        tt-ext-file-par.param-date-value :fgcolor in browse Br-params = GREY_COLOR
...
OR VALUE-CHANGED OF br-params DO:
  IF p-mode = 'ИЗМЕНЕНИЕ':U THEN DO:
   CASE tt-ext-file-par.param-type:
    WHEN 'C':U THEN DO:
      assign
      tt-ext-file-par.param-value :read-only in browse Br-params = no
      tt-ext-file-par.param-date-value :read-only  in browse Br-params = yes
      tt-ext-file-par.param-int-value :read-only  in browse Br-params = yes
      tt-ext-file-par.param-log-value:read-only  in browse Br-params = yes
      .
    END.
    WHEN 'T':U THEN DO:
      assign
      tt-ext-file-par.param-value :read-only in browse Br-params = yes
      tt-ext-file-par.param-date-value :read-only  in browse Br-params = no
      tt-ext-file-par.param-int-value :read-only  in browse Br-params = yes
      tt-ext-file-par.param-log-value:read-only  in browse Br-params = yes
      .
    END.
    WHEN 'I':U THEN DO:
      ...
      tt-ext-file-par.param-value :read-only in browse Br-params = yes
      tt-ext-file-par.param-date-value :read-only  in browse Br-params = yes
      tt-ext-file-par.param-int-value :read-only  in browse Br-params = no
      tt-ext-file-par.param-log-value:read-only  in browse Br-params = yes
      .
    end.
    WHEN 'L':U THEN DO:
      ...
      tt-ext-file-par.param-date-value :read-only  in browse Br-params = yes
      tt-ext-file-par.param-int-value :read-only  in browse Br-params = yes
      tt-ext-file-par.param-log-value:read-only  in browse Br-params = no
      .
    END.
  END CASE.
  END.
...
DO:
 ...
 CASE tt-ext-file-par.param-type:
  ...
  END.
END.
ON CHOOSE OF MENU-ITEM m_character
DO:
define variable vss-include-info12 as character format "X(65)" no-undo initial "@(#)$Workfile$ $Revision$".
if lookup(b-add :type in frame Dialog-Frame
         ,'BROWSE,FILL-IN,FRAME,BUTTON,RADIO-SET,COMBO-BOX,SELECTION-LIST,CONTROL-FRAME,SLIDER,DIALOG-BOX,TOGGLE-BOX,EDITOR,WINDOW'
         ) = 0
then do:
  message
  ...
  if focus :handle <> b-add :handle in frame Dialog-Frame then do:
    return no-apply .
  end.
end.
  ASSIGN
...
then do:
  ...
  APPLY "CHOOSE" TO b-add in frame Dialog-Frame .
END.
ON CHOOSE OF MENU-ITEM m_integer
DO:
...
then do:
  ...
  APPLY "CHOOSE" TO b-add in frame Dialog-Frame .
END.
ON CHOOSE OF MENU-ITEM m_logical
DO:
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse Br-params :handle
      .
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  if p-mode = 'ПРОСМОТР':U then do:
    ...
    v-run-name = ENTRY(NUM-ENTRIES(v-run-name, chr(47)) ,v-run-name, chr(47)).
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY Br-params FOR EACH tt-ext-file-par  INDEXED-REPOSITION.
END PROCEDURE.
...
and buf_ext-file.FILE-TYPE BEGINS ('cash-desk':U + chr(3) )
AND p-mode = 'ПРОСМОТР':U    THEN DO:
  v-ibm-xml-mode = YES.
END.
ASSIGN
v-ch0 = br-params:FIRST-COLUMN IN FRAME Dialog-Frame.
REPEAT WHILE valid-handle(v-ch0):
   IF v-ch0:LABEL = "Касса" THEN DO:
     v-ch-cd = v-ch0.
     v-ch-cd:resizable = yes.
   END.
   IF v-ch0:LABEL = "Файл" THEN DO:
      v-ch-file = v-ch0.
...
CASE p-mode:
  WHEN 'ПРОСМОТР':U THEN DO:
    IF p-list-mode = "Input" THEN DO:
      FRAME Dialog-Frame:TITLE = substitute("Входные параметры для файла &1 (БД &2, № файла &3): ПРОСМОТР"
                                            , v-run-name
                                            , p-db-num
                                            , p-file-num).
    END.
    IF p-list-mode = "output" THEN DO:
      FRAME Dialog-Frame:TITLE = substitute("Результаты работы файла &1 (№ &2) на БД &3: ПРОСМОТР"
                                            , v-run-name
                                            , p-file-num
                                            , p-db-num).
    END.
  ...
  WHEN 'ИЗМЕНЕНИЕ':U THEN DO:
      FRAME Dialog-Frame:TITLE = substitute("Входные параметры для запуска файла: РЕДАКТИРОВАНИЕ").
  END.
END CASE.
VIEW FRAME Dialog-Frame .
run OpenBr IN THIS-PROCEDURE.
...
run gen-row-keyr in this-procedure (
   input  tt-ext-file-par.param-value
  ,input  ?
  ,input  "ub"
  ,input  ?
  ,input  no-lock
