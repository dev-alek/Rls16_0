  ...
  case p-action :
    when "get":U then do:
      assign
        ...
        p-temp-dir   = nws-exch-dir + chr(92) + v-work-dir + ".":U + nws-db-format( g#db-num )
        p-source-dir = nws-exch-dir + chr(92) + v-work-dir
        p-target-dir = nws-heap-dir + chr(92) + v-work-dir
      .
    end.
    when "put":U then do:
      assign
        ...
        p-temp-dir   = nws-exch-dir + chr(92) + v-work-dir + ".":U + nws-db-format( g#db-num )
        p-source-dir = nws-heap-dir + chr(92) + v-work-dir
        p-target-dir = nws-exch-dir + chr(92) + v-work-dir
      .
    end.
    otherwise do:
      message
