...
:
    ...
    CASE v-rec-name :
      ...
      then do:
        ...
        if v-action = "+delete" then do:
          ...
          buf_temp-dis-card-type.action = integer('99':U).
        end.
      end.
      when 'dis-card-type-attr':U
      then do:
        run proc-load-standart in p-imp-handle
        ...
        if v-action = "+delete" then do:
          ...
          buf_temp-dis-card-type-attr.action = integer('99':U).
        end.
      end.
      when 'hist-nws-option':U
      then do:
        run proc-load-standart in p-imp-handle
        ...
        if v-action = "+delete" then do:
          ...
          buf_temp-hist-nws-option.action = integer('99':U).
        end.
      end.
      ...
      then do:
        ...
        if  v-action = "+delete" then do:
          ...
          buf_temp-dis-dct-rule.action = integer('99':U).
        end.
      end.
      otherwise do:
  ...
  :
    ...
    and buf_temp-dis-card-type.obj-code = 0 then do:
      ...
      if buf_temp-dis-card-type.action = integer('99':U) then do:
        if not available buf_dis-card-type then do:
        end.
        else do:
  ...
  :
    find first buf_dis-card-type-attr where
          ...
          no-error .
    if buf_temp-dis-card-type-attr.action = integer('99':U) then do:
  ...
  :
    find first buf_hist-nws-option where
          ...
          no-error .
    if buf_temp-hist-nws-option.action = integer('99':U) then do:
  ...
  :
    find first buf_dis-dct-rule where
          ...
          no-error .
    if buf_temp-dis-dct-rule.action = integer('99':U) then do:
  ...
  and buf_temp-dis-card-type.action = integer('99':U) then do:
