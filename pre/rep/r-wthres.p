...
:
      put stream excel-line unformatted
            ...
            CHR(9)   "DTA":U
            CHR(9)   p-wth-name
            CHR(9)   p-wth-par-name
            CHR(9)   p-wth-qnty-free
            CHR(9)   p-wth-qnty-put
            chr(10)
      .
end.
end procedure.
...
:
   ...
   THEN DO:
      FOR EACH  buf_wth-place
          ...
          run wthres-sheet1-write-line-style in this-procedure  ( INPUT "FM_1":U
                                                                ) .
            IF p-wth-all
            THEN DO:
               FOR EACH buf_wealth
   ...
   FOR EACH  buf_wth-par
       ...
       FIND  LAST buf_arh-wth-w-p
            WHERE buf_arh-wth-w-p.obj-type   = p-obj-type
              ...
              AND buf_arh-wth-w-p.out-code   = 'free-zone':U
       ...
       FIND  LAST buf_arh-wth-w-p
            WHERE buf_arh-wth-w-p.obj-type = p-obj-type
              ...
              and buf_arh-wth-w-p.wth-code = p-wth-code
              AND buf_arh-wth-w-p.par-code = buf_wth-par.par-code
              AND buf_arh-wth-w-p.out-code = 'put-zone':U
              AND buf_arh-wth-w-p.fact-order <= v-fact-order
            NO-LOCK
            NO-ERROR
            .
