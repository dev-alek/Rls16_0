...
define variable vss-description as character no-undo init "Œ·˘ËÈ ÓÚ˜ÂÚ ÔÓ ˜ÂÍ‡Ï ÍÓÂÍˆËË".
...
if x-TOG-Shift = yes then do:
      ...
      and (buf_chk-doc.chk-type = integer('43':U) or buf_chk-doc.chk-type = integer('44':U)):
      ...
      if buf_chk-doc.chk-type = integer('43':U) then
      do:
        assign
...
procedure pr-header:
  ...
  put stream OutStr-html unformatted
    '<tr>' skip
    '<td colspan="6" style="text-align: center;">Œ·˘ËÈ ÓÚ˜ÂÚ Ó ÍÓÎË˜ÂÒÚ‚Â Í‡ÒÒÓ‚˚ı ˜ÂÍÓ‚ ÍÓÂÍˆËË Á‡ ÔÂËÓ‰ Ò ' + string(x-Date-Start,"99.99.99") + ' ÔÓ ' + string(x-Date-End,"99.99.99") + ' </td>' skip
    '</tr>' skip
    '</thead>' skip .
end.
procedure pr-line:
  put stream OutStr-html unformatted
    '<tbody>' skip
    '<TR>' skip
    '<TD text_wrap="true" rowspan="2" style="text-align: center; font-weight:bold; background-color: silver;">π</TD>' skip
    '<TD text_wrap="true" rowspan="2" style="text-align: center; font-weight:bold; background-color: silver;"> Œƒ ¿«—</TD>' skip
    '<TD text_wrap="true" rowspan="2" style="text-align: center; font-weight:bold; background-color: silver;">Õ¿»Ã≈ÕŒ¬¿Õ»≈</TD>' skip
    '<TD text_wrap="true" colspan="3" style="text-align: center; font-weight:bold; background-color: silver;"> ŒÀ»◊≈—“¬Œ  ¿——Œ¬€’ ◊≈ Œ¬  Œ––≈ ÷»»</TD>' skip
    '</TR>'skip
    '<TR>' skip
    '<TD text_wrap="true" style="text-align: center; font-weight:bold; background-color: silver;">œ–»’Œƒ</TD>' skip
    '<TD text_wrap="true" style="text-align: center; font-weight:bold; background-color: silver;">–¿—’Œƒ</TD>' skip
    '<TD text_wrap="true" style="text-align: center; font-weight:bold; background-color: silver;">¬—≈√Œ</TD>' skip
    '</TR>'skip
    .
...
find first ub.clients no-lock where ub.clients.obj-code = p-obj-code and ub.clients.obj-type = 'Ï‡„':U no-error .
