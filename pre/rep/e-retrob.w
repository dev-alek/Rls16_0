...
PROCEDURE adm-disable :
    DISABLE RECT-8 tog-det-tov tog-itog-prod WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-8 tog-det-tov tog-itog-prod WITH FRAME F-Main.
...
define variable l        as integer   no-undo.
  Assign frame F-Main tog-itog-prod tog-det-tov .
