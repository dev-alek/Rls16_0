...
:
    ...
    put stream excel-line unformatted
        ...
        chr(9)   buf_temp_line-data.PlaceAmountSupp
        chr(9)   buf_temp_line-data.SumSupp
        chr(9)   buf_temp_line-data.PlaceAmountFact
        ...
        chr(9)   buf_temp_line-data.PlaceAmountDelt
        chr(9)   buf_temp_line-data.SumDelt
        chr(10)
    .
end.
end procedure.
    ...
    :
        ...
        :
            ...
            run tg84xl-write-line-data in this-procedure (
                ...
                , input v-price-NoVAT
                , input v-qnty-supp
                , input v-qnty-supp * v-price-NoVAT
                , input v-qnty-fact
                , input v-qnty-fact * v-price-NoVAT
                , input v-qnty-fact * v-price
                , input itog-vat.VAT-pc
                , input itog-vat.VAT-pc / 100 * v-qnty-fact * v-price-NoVAT
                , input v-qnty-fact - v-qnty-supp
                , input ( v-qnty-fact - v-qnty-supp ) * v-price-NoVAT
            ).
        end.
    end.
    run tg84xl-write-cell-data in this-procedure (
          input "it_PlaceAmountSupp":U
