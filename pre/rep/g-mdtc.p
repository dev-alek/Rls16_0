...
define variable vss-workfile    as character no-undo init "$Workfile: g-mdtc.p $":U .
define variable vss-archive     as character no-undo init "$Archive: rep/g-mdtc.p $":U .
