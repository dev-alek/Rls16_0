...
PROCEDURE adm-disable :
    DISABLE RECT-1 CB-Month b-prev-month b-next-month FI-Year b-prev-year b-next-year RECT-2 b-all-petrol b-select-goods b-print b-help b-quit fi-month-name fi-goods-count WITH FRAME D-Dialog.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-1 CB-Month b-prev-month b-next-month FI-Year b-prev-year b-next-year RECT-2 b-all-petrol b-select-goods b-print b-help b-quit fi-month-name fi-goods-count WITH FRAME D-Dialog.
...
END.
ON CHOOSE OF b-all-petrol IN FRAME D-Dialog
DO:
...
END.
ON CHOOSE OF b-select-goods IN FRAME D-Dialog
DO:
...
then do:
  ...
  :
    ...
    if not can-do(buf_units.type, 'топ':U) then do:
      assign
        v-remove-count = v-remove-count + 1
      .
      delete gds-list .
