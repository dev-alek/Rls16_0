...
PROCEDURE adm-disable :
    DISABLE RECT-5 RADIO-SET-1 dat WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-5 RADIO-SET-1 dat WITH FRAME F-Main.
...
DO:
  ...
  if RADIO-SET-1 = 2 Then do:
    enable  dat-2   with frame F-Main .
  end.
  Else do:
    disable  dat-2  with frame F-Main .
  end.
END.
...
PROCEDURE local-initialize :
  ...
  assign
    ...
    dat-2 :screen-value in frame F-Main = string(month(x-Date-Start))
  .
END PROCEDURE.
PROCEDURE my-report :
...
END PROCEDURE.
PROCEDURE my-var :
  assign frame F-Main RADIO-SET-1 dat dat-2 .
  if RADIO-SET-1 = 2 then do:
