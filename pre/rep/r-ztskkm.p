...
DEFINE TEMP-TABLE tt-peresmen NO-UNDO
        ...
        FIELD ob-code               like  chk-doc.obj-code
    ...
    FIELD peresm-date           like  chk-doc.chk-date
    FIELD sver-date             like  chk-doc.chk-date
    FIELD shift-time-beg        like  chk-doc.chk-time
    FIELD shift-time-end        like  chk-doc.chk-time
    FIELD time-p                AS INT
        FIELD npp                   AS INT
...
DEFINE VARIABLE itog-time-prev AS int NO-UNDO init 0.
DEFINE VARIABLE itog-prev-all AS int NO-UNDO init 0.
...
DEFINE VARIABLE num_sver AS CHARACTER NO-UNDO.
DEFINE VARIABLE date_sver AS CHARACTER NO-UNDO.
...
DEFINE VARIABLE kol-peresm AS int NO-UNDO init 0.
