...
PROCEDURE adm-disable :
    DISABLE RECT-detail RECT-method RECT-3 RS-by RS-method RS-cass WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-detail RECT-method RECT-3 RS-by RS-method RS-cass WITH FRAME F-Main.
...
if error-status:error then do:
  v-err-message = substitute("&2&1&3&1всего ошибок &4",
                             chr(10), return-value, error-status:get-message(1), error-status:num-messages) .
...
if Show-Crsa or Show-Cost or Show-Sale then do:
 ...
 .
  ...
  ( input 'rs-method'                             ,
   input ''                                    ,
   input 'character'                           ,
   input rs-method:screen-value in frame F-Main   ,
   input 'метод формирования' )
 .
  run create-param-to-export  in this-procedure
  ( input 'rs-by'                             ,
   input ''                                    ,
 ...
 .
  ...
  ( input 'rs-cass'                             ,
   input ''                                    ,
   input 'character'                           ,
   input lc(Rs-cass:screen-value in frame F-Main)   ,
   input 'выбор касс' )
 .
  run create-param-to-export  in this-procedure
  ( input 'cas-num'                             ,
