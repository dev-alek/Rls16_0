...
define input parameter p-store-code like ub.clients.obj-code no-undo .
 find last  ub.aht-stk-line where
        ...
        if available ub.aht-stk-line then do:
            if  tprintrubl  then
                  assign
                        ostatok-start[1]  =ostatok-start[1] +  (if ub.aht-stk-line.sum-type <> "b"
                        ...
                        ostatok-start[5]  =ostatok-start[5]  + round( ub.aht-stk-line.crsa-sum-rubl ,2)
                        ostatok-start[6]  =ostatok-start[6]  + round( ub.aht-stk-line.crsa-vat-rubl ,2)
                        ostatok-start[7]  =ostatok-start[7]  + round( ub.aht-stk-line.sale-discnt-rubl ,2)
                        ostatok-start[8]  =ostatok-start[8]  + round( ub.aht-stk-line.crsa-sum-rubl ,2)
                        ostatok-start[9]  =ostatok-start[9]  + round( ub.aht-stk-line.crsa-vat-rubl ,2)
                        ostatok-start[10] =ostatok-start[10] + round( ub.aht-stk-line.crsa-slt-rubl ,2)
                        .
              else
                  assign
                        ostatok-start[1]  = ostatok-start[1] + (if ub.aht-stk-line.sum-type <> "b"
                        ...
                        ostatok-start[4]  = ostatok-start[4] +  0
                        ostatok-start[5]  = ostatok-start[5]  + round( ub.aht-stk-line.crsa-sum-base ,2)
                        ostatok-start[6]  = ostatok-start[6]  + round( ub.aht-stk-line.crsa-vat-base ,2)
                        ostatok-start[7]  = ostatok-start[7]  + round( ub.aht-stk-line.sale-discnt-base ,2)
                        ostatok-start[8]  = ostatok-start[8]  + round( ub.aht-stk-line.crsa-sum-base ,2)
                        ostatok-start[9]  = ostatok-start[9]  + round( ub.aht-stk-line.crsa-vat-base ,2)
                        ostatok-start[10] = ostatok-start[10] + round( ub.aht-stk-line.crsa-slt-base ,2)
                  .
             end.
 find last  ub.aht-stk-line where
                        ub.aht-stk-line.gds-code   = gds-zap-b-code
        ...
        if available ub.aht-stk-line then do:
            if  tprintrubl  then
                  assign
                        ostatok-end[1]  = ostatok-end[1] + (if ub.aht-stk-line.sum-type <> "b"
                                                               then round( ub.aht-stk-line.fact-qnty,3) else 0 )
                        ...
                        ostatok-end[5]  = ostatok-end[5] + round( ub.aht-stk-line.crsa-sum-rubl ,2)
                        ostatok-end[6]  = ostatok-end[6] + round( ub.aht-stk-line.crsa-vat-rubl ,2)
                        ostatok-end[7]  = ostatok-end[7] + round( ub.aht-stk-line.sale-discnt-rubl ,2)
                        ostatok-end[8]  = ostatok-end[8] + round( ub.aht-stk-line.crsa-sum-rubl ,2)
                        ostatok-end[9]  = ostatok-end[9] + round( ub.aht-stk-line.crsa-vat-rubl ,2)
                        ostatok-end[10] = ostatok-end[10] + round( ub.aht-stk-line.crsa-slt-rubl ,2)
                        .
              else
                  assign
                        ostatok-end[1]  = ostatok-end[1] +  (if ub.aht-stk-line.sum-type <> "b"
                        ...
                        ostatok-end[4]  = ostatok-end[4] +  0
                        ostatok-end[5]  = ostatok-end[5] +  round( ub.aht-stk-line.crsa-sum-base ,2)
                        ostatok-end[6]  = ostatok-end[6] +  round( ub.aht-stk-line.crsa-vat-base ,2)
                        ostatok-end[7]  = ostatok-end[7] +  round( ub.aht-stk-line.sale-discnt-base ,2)
                        ostatok-end[8]  = ostatok-end[8] +  round( ub.aht-stk-line.crsa-sum-base ,2)
                        ostatok-end[9]  = ostatok-end[9] +  round( ub.aht-stk-line.crsa-vat-base ,2)
                        ostatok-end[10] = ostatok-end[10] + round( ub.aht-stk-line.crsa-slt-base ,2)
                  .
             end.
end.
end procedure.
