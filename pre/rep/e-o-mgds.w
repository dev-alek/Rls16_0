...
PROCEDURE adm-disable :
    DISABLE RECT-10 RECT-11 RECT-9 Classify SortType COMBO-node TOG-inv TOG-tow WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-10 RECT-11 RECT-9 Classify SortType COMBO-node TOG-inv TOG-tow WITH FRAME F-Main.
...
PROCEDURE local-initialize :
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .
    ...
    tog-tow:screen-value in frame F-Main = "yes".
...
END PROCEDURE.
PROCEDURE my-var :
assign frame F-Main COMBO-node tog-inv Classify  SumsOnly tog-tow .
