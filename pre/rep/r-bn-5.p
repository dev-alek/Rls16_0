...
For each tmp-itog no-lock
  on error undo , next
  break
  By ((tmp-itog.tmp-cli-type + string(tmp-itog.tmp-cli-code)))
  By tmp-itog.tmp-gds-name
  By ((tmp-itog.tmp-artic + tmp-itog.tmp-prod-type + string(tmp-itog.tmp-prod-code)))
  :
  assign
...
For each tmp-itog no-lock
  on error undo , next
  break
  BY tmp-itog.tmp-goods-grp-name
  By ((tmp-itog.tmp-cli-type + string(tmp-itog.tmp-cli-code)))
  By tmp-itog.tmp-gds-name
  By ((tmp-itog.tmp-artic + tmp-itog.tmp-prod-type + string(tmp-itog.tmp-prod-code)))
  :
  if first-of( tmp-itog.tmp-goods-grp-name )         Then DO : run print-header (1, tmp-itog.tmp-goods-grp-name ). end.
  assign
    v-bonus       [2] = tmp-itog.bonus
    s-kassa       [2] = tmp-itog.sum-kassa
    s-bonus-dohod [2] = tmp-itog.sum-bonus-dohod
    ...
    .
    run display-str.
  if last-of( tmp-itog.tmp-goods-grp-name )         Then DO : run print-footer ( 1, tmp-itog.tmp-goods-grp-name). end.
End.
  End.
  when "prod":U then  DO:
For each tmp-itog no-lock
  on error undo , next
  break
  BY (tmp-itog.tmp-prod-cli-obj-name + ' ('+ tmp-itog.tmp-prod-cli-obj-type + ' ' + string(tmp-itog.tmp-prod-cli-obj-code) + ')')
  By ((tmp-itog.tmp-cli-type + string(tmp-itog.tmp-cli-code)))
  By tmp-itog.tmp-gds-name
  By ((tmp-itog.tmp-artic + tmp-itog.tmp-prod-type + string(tmp-itog.tmp-prod-code)))
  :
  if first-of( (tmp-itog.tmp-prod-cli-obj-name + ' ('+ tmp-itog.tmp-prod-cli-obj-type + ' ' + string(tmp-itog.tmp-prod-cli-obj-code) + ')') )         Then DO : run print-header (1, (tmp-itog.tmp-prod-cli-obj-name + ' ('+ tmp-itog.tmp-prod-cli-obj-type + ' ' + string(tmp-itog.tmp-prod-cli-obj-code) + ')') ). end.
  assign
    v-bonus       [2] = tmp-itog.bonus
    s-kassa       [2] = tmp-itog.sum-kassa
    s-bonus-dohod [2] = tmp-itog.sum-bonus-dohod
    ...
    .
    run display-str.
  if last-of( (tmp-itog.tmp-prod-cli-obj-name + ' ('+ tmp-itog.tmp-prod-cli-obj-type + ' ' + string(tmp-itog.tmp-prod-cli-obj-code) + ')') )         Then DO : run print-footer ( 1, (tmp-itog.tmp-prod-cli-obj-name + ' ('+ tmp-itog.tmp-prod-cli-obj-type + ' ' + string(tmp-itog.tmp-prod-cli-obj-code) + ')')). end.
End.
  End.
  when "post":U  then       DO:
For each tmp-itog no-lock
  on error undo , next
  break
  BY tmp-itog.tmp-clients-grp-name
  By ((tmp-itog.tmp-cli-type + string(tmp-itog.tmp-cli-code)))
  By tmp-itog.tmp-gds-name
  By ((tmp-itog.tmp-artic + tmp-itog.tmp-prod-type + string(tmp-itog.tmp-prod-code)))
  :
  if first-of( tmp-itog.tmp-clients-grp-name )         Then DO : run print-header (1, tmp-itog.tmp-clients-grp-name ). end.
  assign
    v-bonus       [2] = tmp-itog.bonus
    s-kassa       [2] = tmp-itog.sum-kassa
    s-bonus-dohod [2] = tmp-itog.sum-bonus-dohod
    ...
    .
    run display-str.
  if last-of( tmp-itog.tmp-clients-grp-name )         Then DO : run print-footer ( 1, tmp-itog.tmp-clients-grp-name). end.
End.
  End.
...
For each tmp-itog no-lock
  ...
  :
  if first-of( tmp-itog.tmp-clients-grp-name )         Then DO : run print-header (1, tmp-itog.tmp-clients-grp-name ). end.
  if first-of( tmp-itog.tmp-goods-grp-name )         Then DO : run print-header (2, tmp-itog.tmp-goods-grp-name ). end.
  assign
    v-bonus       [2] = tmp-itog.bonus
    s-kassa       [2] = tmp-itog.sum-kassa
    s-bonus-dohod [2] = tmp-itog.sum-bonus-dohod
    ...
    .
    run display-str.
  if last-of( tmp-itog.tmp-goods-grp-name )         Then DO : run print-footer ( 2 ,tmp-itog.tmp-goods-grp-name). end.
  if last-of( tmp-itog.tmp-clients-grp-name )         Then DO : run print-footer ( 1, tmp-itog.tmp-clients-grp-name). end.
End.
  .
  End.
...
For each tmp-itog no-lock
  ...
  :
  if first-of( tmp-itog.tmp-goods-grp-name )         Then DO : run print-header (1, tmp-itog.tmp-goods-grp-name ). end.
  if first-of( tmp-itog.tmp-clients-grp-name )         Then DO : run print-header (2, tmp-itog.tmp-clients-grp-name ). end.
  assign
    v-bonus       [2] = tmp-itog.bonus
    s-kassa       [2] = tmp-itog.sum-kassa
    s-bonus-dohod [2] = tmp-itog.sum-bonus-dohod
    ...
    .
    run display-str.
  if last-of( tmp-itog.tmp-clients-grp-name )         Then DO : run print-footer ( 2 ,tmp-itog.tmp-clients-grp-name). end.
  if last-of( tmp-itog.tmp-goods-grp-name )         Then DO : run print-footer ( 1, tmp-itog.tmp-goods-grp-name). end.
End.
  .
  End.
...
For each tmp-itog no-lock
  ...
  :
  if first-of( tmp-itog.tmp-goods-grp-name )         Then DO : run print-header (1, tmp-itog.tmp-goods-grp-name ). end.
  if first-of( (tmp-itog.tmp-prod-cli-obj-name + ' ('+ tmp-itog.tmp-prod-cli-obj-type + ' ' + string(tmp-itog.tmp-prod-cli-obj-code) + ')') )         Then DO : run print-header (2, (tmp-itog.tmp-prod-cli-obj-name + ' ('+ tmp-itog.tmp-prod-cli-obj-type + ' ' + string(tmp-itog.tmp-prod-cli-obj-code) + ')') ). end.
  assign
    v-bonus       [2] = tmp-itog.bonus
    s-kassa       [2] = tmp-itog.sum-kassa
    s-bonus-dohod [2] = tmp-itog.sum-bonus-dohod
    ...
    .
    run display-str.
  if last-of( (tmp-itog.tmp-prod-cli-obj-name + ' ('+ tmp-itog.tmp-prod-cli-obj-type + ' ' + string(tmp-itog.tmp-prod-cli-obj-code) + ')') )         Then DO : run print-footer ( 2 ,(tmp-itog.tmp-prod-cli-obj-name + ' ('+ tmp-itog.tmp-prod-cli-obj-type + ' ' + string(tmp-itog.tmp-prod-cli-obj-code) + ')')). end.
  if last-of( tmp-itog.tmp-goods-grp-name )         Then DO : run print-footer ( 1, tmp-itog.tmp-goods-grp-name). end.
End.
  .
  End.
...
For each tmp-itog no-lock
  ...
  By ((tmp-itog.tmp-artic + tmp-itog.tmp-prod-type + string(tmp-itog.tmp-prod-code)))
  :
  if first-of( (tmp-itog.tmp-cli-type + string(tmp-itog.tmp-cli-code)) )         Then DO : run print-header (1, (tmp-itog.tmp-cli-type + string(tmp-itog.tmp-cli-code)) ). end.
  assign
    v-bonus       [2] = tmp-itog.bonus
    s-kassa       [2] = tmp-itog.sum-kassa
    s-bonus-dohod [2] = tmp-itog.sum-bonus-dohod
    ...
    .
    run display-str.
  if last-of( (tmp-itog.tmp-cli-type + string(tmp-itog.tmp-cli-code)) )         Then DO : run print-footer ( 1, (tmp-itog.tmp-cli-type + string(tmp-itog.tmp-cli-code))). end.
End.
  .
  End.
  when "post/grp-goods":U then DO:
...
For each tmp-itog no-lock
  ...
  :
  if first-of( tmp-itog.tmp-goods-grp-name )         Then DO : run print-header (1, tmp-itog.tmp-goods-grp-name ). end.
  if first-of( (tmp-itog.tmp-cli-type + string(tmp-itog.tmp-cli-code)) )         Then DO : run print-header (2, (tmp-itog.tmp-cli-type + string(tmp-itog.tmp-cli-code)) ). end.
  assign
    v-bonus       [2] = tmp-itog.bonus
    s-kassa       [2] = tmp-itog.sum-kassa
    s-bonus-dohod [2] = tmp-itog.sum-bonus-dohod
    ...
    .
    run display-str.
  if last-of( (tmp-itog.tmp-cli-type + string(tmp-itog.tmp-cli-code)) )         Then DO : run print-footer ( 2 ,(tmp-itog.tmp-cli-type + string(tmp-itog.tmp-cli-code))). end.
  if last-of( tmp-itog.tmp-goods-grp-name )         Then DO : run print-footer ( 1, tmp-itog.tmp-goods-grp-name). end.
End.
  .
  End.
