...
PROCEDURE adm-disable :
    DISABLE RECT-7 RECT-6 RECT-5 RECT-9 RECT-8 RADPost PostName SortType Tog-obj Classify serv Show-discnt ShowZero WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-7 RECT-6 RECT-5 RECT-9 RECT-8 RADPost PostName SortType Tog-obj Classify serv Show-discnt ShowZero WITH FRAME F-Main.
...
PROCEDURE local-initialize :
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .
   Tog-obj:screen-value in frame F-Main = 'yes':U.
    ...
    show-discnt:screen-value in frame F-Main = 'yes'.
