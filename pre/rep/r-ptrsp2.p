...
END PROCEDURE.
form header
  Centering( Sparse( "Почас. статистика продаж ТРК с детал. по пистолетам" )
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run basecode in g#library
  ...
  run rep/rpychk0.p ( input "r-ptrsp2"
    ...
    for each ub.chk-doc no-lock
      where ub.chk-doc.obj-type    = bf_shift-obj.obj-type
        and ub.chk-doc.obj-code    = bf_shift-obj.obj-code
        and ub.chk-doc.shift-date  = bf_shift-obj.shift-date
        and ub.chk-doc.shift-num   = bf_shift-obj.shift-num
      ...
      find first bf_goods no-lock where
                bf_goods.gds-code = buf_bar-code.gds-code .
if (valid-handle(ibs.th.gbl.gbl-hndllib:g#lib-trn) <> true) then do:   run str/lib-trn.p persistent no-error .   if error-status :error or (valid-handle(ibs.th.gbl.gbl-hndllib:g#lib-trn) <> true) then do:     message       "Error starting lib-trn.p" skip       ibs.th.gbl.gbl-hndllib:g#lib-trn skip       ibs.th.gbl.gbl-hndllib:g#lib-trn :type skip       ibs.th.gbl.gbl-hndllib:g#lib-trn :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run lib-trn_is-petrl in g#lib-trn
  ...
  , output is-pieces
      ...
      find first bf_chk-gds no-lock where
                bf_chk-gds.doc-code = ub.chk-doc.doc-code
            and bf_chk-gds.line-num = buf_Chk-gds-pay.line-num.
      assign
        j_pump-code = bf_chk-gds.pump
      no-error .
      if j_pump-code  = ?    or
        j_pump-code  = 0
      then do:
...
if varnozzle-code = ? then varnozzle-code = 0.
      ...
      find first tt_line where
            ...
            and tt_line.pay-code    = buf_chk-gds-pay.pay-code
            and tt_line.curr-code   = buf_chk-gds-pay.curr-code
            and tt_line.chk-date    = chk-doc.chk-date
            and tt_line.chk-time    = chk-doc.chk-time
            and tt_line.gds-code    = buf_bar-code.gds-code
            no-error .
      ...
      then do:
        ...
        assign
          ...
          tt_line.pay-code    = buf_cash-pay.cdpay-code
          tt_line.pay-name    = buf_cash-pay.obj-name
          tt_line.curr-code   = buf_cash-pay.curr-code
      ...
      assign
        tt_line.sum-sale = tt_line.sum-sale   +  (if v-curr-r-b = 'rubl':U
                                                  or v-base-code = 0
                                                  then buf_chk-gds-pay.tot-r-b
                                                  else (buf_chk-gds-pay.tot-r-b * buf_chk-gds-pay.eff-base-rate))
        tt_line.base-qnty = tt_line.base-qnty + buf_chk-gds-pay.eff-doc-qnty
      .
    end.
  end.
  assign
          ...
          case j_length :
            ...
            then do:
              assign
                ...
                p-excel-line = p-excel-line         + string( bf_print-line.gds-code, "99999999999":U ) + CHR(9)
              .
            end.
          end case.
        end.
              ...
              case jj :
                ...
                then do:
                  assign
                    ...
                    p-excel-line = p-excel-line + string( bf_print-line.pay-name, "x(16)":U ) + CHR(9)
                  .
                end.
              end case.
            end.
                  ...
                  then
                    do:
                      assign
                        ...
                        p-excel-line = p-excel-line          + string( bf_print-line.doc-num2, "x(9)":U ) + CHR(9)
                        .
                    end.
              end case.
            end.
             ...
             then
                do:
                   assign
                      ...
                      p-excel-line = p-excel-line          + string( bf_print-line.desk-num, ">>>9":U ) + CHR(9)
                      .
                end.
          end case.
        end.
