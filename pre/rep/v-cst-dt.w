...
DEFINE  SHARED TEMP-TABLE gds-brutto NO-UNDO
    ...
    .
DEFINE  SHARED TEMP-TABLE parts-brutto    NO-UNDO
...
DEFINE  SHARED TEMP-TABLE prt-parts-brutto    NO-UNDO
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse br-parts-brutto :handle
      .
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  RUN enable_UI.
  FRAME v-suppl:TITLE = string( "Сводный отчет(склад МБТ- МБТ): " + string(from-date,"99/99/9999") +
                                                                    " по: " + string(to-date,"99/99/9999")).
  apply "entry" to br-parts-brutto in frame v-suppl.
...
PROCEDURE enable_UI :
  ENABLE b-help b-quit br-parts-brutto
      WITH FRAME v-suppl.
  VIEW FRAME v-suppl.
  OPEN QUERY br-parts-brutto FOR EACH parts-brutto WHERE  parts-brutto.artic     = parartic AND  parts-brutto.cst-code  = parcst-code USE-INDEX fact-num.
END PROCEDURE.
