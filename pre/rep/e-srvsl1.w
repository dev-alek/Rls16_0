...
PROCEDURE adm-disable :
    DISABLE RECT-5 RECT-detail RS-by Tot_Objects WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-5 RECT-detail RS-by Tot_Objects WITH FRAME F-Main.
