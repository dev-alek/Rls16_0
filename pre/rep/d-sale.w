...
DO:
  ...
  OPEN QUERY BROWSE-2 FOR EACH Tmp#List NO-LOCK where     Tmp#List.view_ <> 0     BY Tmp#List.id.
END.
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  Tmp#List.blank-name:resizable in browse browse-2 = yes.
    ASSIGN frame Dialog-Frame:TITLE =  "Работа с отчетом о продаже (печать и не только)"
    + " Статус: " + buf_inkas.status_
    + "  № "  + buf_inkas.inkas-code.
    if sys-key = 'ExpertekIBS':U
    then do:
...
define variable vss-include-info13 as character format "x(65)" no-undo initial "@(#)$Workfile:currsysk.i $ $Revision: $".
...
define variable v-value-character15 as character no-undo .
...
initial "@(#)$Workfile$ $Revision$".
        run menu-doc-create-menu-item in this-procedure
          ( input xtype
           ...
           , input ''
           , input 'str/sjbysale.p'
           , input substitute('&1,&2', ptwounit, cas-shft)
           , input '------'
           , input ''
           , input 'output'
           , input ''
...
initial "@(#)$Workfile$ $Revision$".
        run menu-doc-create-menu-item in this-procedure
          ( input xtype
           ...
           , input '*'
           , input '*'
           , input 'Акт по продаже (скидки)'
           , input ''
           , input 'str/saledsca.p'
           , input ''
           , input '------'
           , input 'Basis'
           , input 'A4port'
...
initial "@(#)$Workfile$ $Revision$".
        run menu-doc-create-menu-item in this-procedure
          ( input xtype
           ...
           , input '*'
           , input '*'
           , input 'Акт по продаже (скидки) потоварно'
           , input ''
           , input 'str/saldsca1.p'
           , input ''
           , input '------'
           , input 'Basis'
           , input 'self'
...
initial "@(#)$Workfile$ $Revision$".
        run menu-doc-create-menu-item in this-procedure
          ( input xtype
           ...
           , input '*'
           , input '*'
           , input 'Отчет по зарезерв. партиям по вариантам закупки'
           , input ''
           , input 'str/salevzak.p'
           , input 'print'
           , input '------'
           , input 'IBS'
           , input 'A4lans'
...
initial "@(#)$Workfile$ $Revision$".
        run menu-doc-create-menu-item in this-procedure
          ( input xtype
           ...
           , input '*'
           , input '*'
           , input 'Резервирование партий по вариантам закупки'
           , input ''
           , input 'str/salevzak.p'
           , input 'work'
           , input '------'
...
initial "@(#)$Workfile$ $Revision$".
        run menu-doc-create-menu-item in this-procedure
          ( input xtype
           ...
           , input '*'
           , input '*'
           , input 'Экспорт по варианту закупки 2'
           , input ''
           , input 'str/salevzak.p'
           , input 'export'
           , input '------'
