    ...
    for each temp-ord-rcv
      ...
      :
        if p-det-rcv then do:
          ...
          temp-ord-rcv.post-code  CHR(9)
          temp-ord-rcv.post-name  CHR(9)
          temp-ord-rcv.rcv-code   CHR(9)
          temp-ord-rcv.rcv-status CHR(9)
          temp-ord-rcv.ship-date  chr(10)
          .
        end.
        else do:
          if Make-Excel then  put   stream ForExcel unformatted
