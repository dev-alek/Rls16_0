...
put
    ...
    skip(1)
.
if lookup( buf_trn-doc.doc-type, 'при,возврат':U ) <> 0
then do:
  if v-sys-key begins "Repin" then do:
    define buffer b_host for ub.clients .
    find first b_host no-lock where b_host.obj-type = 'орг':U and b_host.obj-code = buf_trn-doc.host-code .
...
:
    ...
    .
    if ( not buf_trn-doc.doc-type = 'инв':U
  ...
  ,output v-b-code
            ...
            :
                ...
                assign
                    ...
                    Sub_Qnty    = ( if buf_trn-doc.doc-type = 'инв':U
                ...
                repeat :
                    ...
                    assign
                        v-gds-name   = v-gds-name + chr(47) + ub.gds-prt.node-name
...
then do:
    ...
    put
        space(5)
        "( Рублевый эквивалент :  " + trim( caps(s1) ) + " )" format "X(128)"
        skip(1)
    .
end.
if v-sys-key = "WORLD"
then do:
    put
        skip  "" ( if buf_trn-doc.status_ = 'факт':U
