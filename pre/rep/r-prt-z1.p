...
Assign
    ...
    c-f-rez-qnty:DATA-TYPE = "CHARACTER"
    c-f-rez-qnty:FORMAT    = "x(" + string(C-f-rez-qnty:WIDTH-CHARS) + ")"
    c-f-rez-qnty:screen-value = string('')  .
End.
if c-f-rez-cost <>  ?  then do :
Assign
    l1f-rez-cost  = c-f-rez-cost:DATA-TYPE
    ...
    c-f-rez-cost:DATA-TYPE = "CHARACTER"
    c-f-rez-cost:FORMAT    = "x(" + string(C-f-rez-cost:WIDTH-CHARS) + ")"
    c-f-rez-cost:screen-value = string('')  .
End.
if c-f-rez-sale <>  ?  then do :
Assign
    l1f-rez-sale  = c-f-rez-sale:DATA-TYPE
    ...
    c-f-rez-sale:DATA-TYPE = "CHARACTER"
    c-f-rez-sale:FORMAT    = "x(" + string(C-f-rez-sale:WIDTH-CHARS) + ")"
    c-f-rez-sale:screen-value = string('')  .
End.
if c-f-rez-cost-pr <>  ?  then do :
Assign
    l1f-rez-cost-pr  = c-f-rez-cost-pr:DATA-TYPE
    ...
    c-f-rez-cost-pr:DATA-TYPE = "CHARACTER"
    c-f-rez-cost-pr:FORMAT    = "x(" + string(C-f-rez-cost-pr:WIDTH-CHARS) + ")"
    c-f-rez-cost-pr:screen-value = string('')  .
End.
     ...
     if v-prizn <> "" and goods.prt-root <> Prtroot then do:
        pr-cursor = 0.
         ...
         do while pr-cursor < num-entries(v-prizn,","):
             ...
             if entry(pr-cursor,v-prizn,",") <> "" then do:
                 ...
                 assign
                    ...
                    f-cost-sum   = f-cost-sum + if gds-obj.fact-qnty = 0 then 0 else prt-obj.fact-qnty * determined(gds-obj.fact-rubl) / gds-obj.fact-qnty
                    ...
                    f-cost-pr   = if prt-obj.fact-qnty  = 0 then 0 else determined(gds-obj.fact-rubl) / gds-obj.fact-qnty
         ...
         Assign
            ...
            f-cost-sum   = determined(gds-obj.fact-rubl)
                 ...
                 empty temp-table temp_gds-dtl .
                      for each buf_parts no-lock where
                        ...
                        first bufi_trn-doc no-lock where
                              ...
                              and
                            ( bufi_trn-doc.doc-type = 'рас':U or
                              bufi_trn-doc.doc-type = 'спи':U )
                              :
                              ...
                              for each  bufd_gds-dtl no-lock where
                                  ...
                                  first buff_doc-line no-lock where
                                        ...
                                        assign
                                          ...
                                          f-rez-cost = f-rez-cost  + ( bufd_gds-dtl.doc-qnty * buff_doc-line.price-rubl )
                                          f-rez-sale = f-rez-sale  + ( bufd_gds-dtl.doc-qnty * bufd_gds-dtl.price-rubl )
                                          f-rez-cost-pr = ( if f-rez-qnty = 0 then 0 else f-rez-cost / f-rez-qnty )
                                        .
                                        create temp_gds-dtl.
                                        buffer-copy bufd_gds-dtl to temp_gds-dtl
                                        assign
                                           temp_gds-dtl.cost-sum = bufd_gds-dtl.doc-qnty * buff_doc-line.price-rubl
                                           temp_gds-dtl.sale-sum = bufd_gds-dtl.doc-qnty * bufd_gds-dtl.price-rubl
                                        .
                              end.
                         end.
              end.
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run gdsbcode in g#library
  ...
  End.
  if c-f-rez-qnty <>  ?  then do :
    c-f-rez-qnty:screen-value = string(f-rez-qnty) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-rez-cost <>  ?  then do :
    c-f-rez-cost:screen-value = string(f-rez-cost) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-rez-sale <>  ?  then do :
    c-f-rez-sale:screen-value = string(f-rez-sale) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-rez-cost-pr <>  ?  then do :
    c-f-rez-cost-pr:screen-value = string(f-rez-cost-pr) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
                    ...
                    if Make-Excel then  put   stream ForExcel unformatted
                     ...
                     excel-sum (f-rez-qnty    )        CHR(9)
                     excel-sum (f-rez-cost    )        CHR(9)
                     excel-sum (f-rez-sale    )        CHR(9)
                     excel-sum (f-rez-cost-pr )        CHR(9)
                     chr(10) .
 ...
 run u-line in this-procedure.
  ...
  End.
  if c-f-rez-qnty <>  ?  then do :
    c-f-rez-qnty:screen-value = string(accum TOTAL f-rez-qnty) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-rez-cost <>  ?  then do :
    c-f-rez-cost:screen-value = string(accum TOTAL f-rez-cost) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-rez-sale <>  ?  then do :
    c-f-rez-sale:screen-value = string(accum TOTAL f-rez-sale) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  ...
  if Make-Excel then  put   stream ForExcel unformatted
          ...
          excel-qnty(accum TOTAL f-qnty           )  CHR(9)
                                                     CHR(9)
          excel-sum (tot-v-cost-sum       )  CHR(9)
                                                     CHR(9)
          excel-sum (tot-v-sale-sum       )  CHR(9)
          excel-sum (accum TOTAL f-sale-other    )   CHR(9)
          excel-sum (accum TOTAL f-free-qnty     )   CHR(9)
          excel-sum (accum TOTAL f-wait-qnty     )   CHR(9)
    excel-sum (accum TOTAL  f-rez-qnty  ) CHR(9)
    excel-sum (accum TOTAL  f-rez-cost  ) CHR(9)
    excel-sum (accum TOTAL  f-rez-sale  ) CHR(9)
    CHR(9)
          chr(10) .
End.
   if n-no > 1 then do:
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run gdsbcode in g#library
  ...
  End.
             ...
             End.
              ...
              accumulate f-free-qnty      (TOTAL  by gds-obj.prod-code ) .
              accumulate f-wait-qnty      (TOTAL  by gds-obj.prod-code ) .
              accumulate f-rez-qnty   (TOTAL  by gds-obj.prod-code ) .
              accumulate f-rez-cost   (TOTAL  by gds-obj.prod-code ) .
              accumulate f-rez-sale   (TOTAL  by gds-obj.prod-code ) .
                Assign
                  f-qnty          = 0
                  f-cost-sum      = 0
                  f-sale-sum      = 0
  ...
  End.
  if c-f-free-qnty <>  ?  then do :
    c-f-free-qnty:screen-value = string(accum TOTAL by gds-obj.prod-code f-free-qnty ) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-wait-qnty <>  ?  then do :
    c-f-wait-qnty:screen-value = string(accum TOTAL by gds-obj.prod-code f-wait-qnty ) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-rez-qnty <>  ?  then do :
    c-f-rez-qnty:screen-value = string(accum TOTAL by gds-obj.prod-code f-rez-qnty  ) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-rez-cost <>  ?  then do :
    c-f-rez-cost:screen-value = string(accum TOTAL by gds-obj.prod-code f-rez-cost  ) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-rez-sale <>  ?  then do :
    c-f-rez-sale:screen-value = string(accum TOTAL by gds-obj.prod-code f-rez-sale  ) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
              ...
              excel-sum (accum TOTAL by gds-obj.prod-code  f-free-qnty      )   CHR(9)
              excel-sum (accum TOTAL by gds-obj.prod-code  f-wait-qnty      )   CHR(9)
              excel-sum (accum TOTAL by gds-obj.prod-code f-rez-qnty  ) CHR(9)
              excel-sum (accum TOTAL by gds-obj.prod-code f-rez-cost  ) CHR(9)
              excel-sum (accum TOTAL by gds-obj.prod-code f-rez-sale  ) CHR(9)
              CHR(9)
              chr(10) .
          End.
end.
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run gdsbcode in g#library
  ...
  End.
             ...
             End.
              ...
              accumulate f-free-qnty      (TOTAL  by goods.grp-name ) .
              accumulate f-wait-qnty      (TOTAL  by goods.grp-name ) .
              accumulate f-rez-qnty   (TOTAL  by goods.grp-name ) .
              accumulate f-rez-cost   (TOTAL  by goods.grp-name ) .
              accumulate f-rez-sale   (TOTAL  by goods.grp-name ) .
                Assign
                  f-qnty          = 0
                  f-cost-sum      = 0
                  f-sale-sum      = 0
  ...
  End.
  if c-f-free-qnty <>  ?  then do :
    c-f-free-qnty:screen-value = string(accum TOTAL by goods.grp-name f-free-qnty ) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-wait-qnty <>  ?  then do :
    c-f-wait-qnty:screen-value = string(accum TOTAL by goods.grp-name f-wait-qnty ) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-rez-qnty <>  ?  then do :
    c-f-rez-qnty:screen-value = string(accum TOTAL by goods.grp-name f-rez-qnty  ) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-rez-cost <>  ?  then do :
    c-f-rez-cost:screen-value = string(accum TOTAL by goods.grp-name f-rez-cost  ) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-rez-sale <>  ?  then do :
    c-f-rez-sale:screen-value = string(accum TOTAL by goods.grp-name f-rez-sale  ) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
              ...
              excel-sum (accum TOTAL by goods.grp-name  f-free-qnty      )   CHR(9)
              excel-sum (accum TOTAL by goods.grp-name  f-wait-qnty      )   CHR(9)
              excel-sum (accum TOTAL by goods.grp-name f-rez-qnty  ) CHR(9)
              excel-sum (accum TOTAL by goods.grp-name f-rez-cost  ) CHR(9)
              excel-sum (accum TOTAL by goods.grp-name f-rez-sale  ) CHR(9)
              CHR(9)
              chr(10) .
          End.
end.
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run gdsbcode in g#library
  ...
  End.
             ...
             End.
              ...
              accumulate f-free-qnty      (TOTAL  by gds-list.qnty ) .
              accumulate f-wait-qnty      (TOTAL  by gds-list.qnty ) .
              accumulate f-rez-qnty   (TOTAL  by gds-list.qnty ) .
              accumulate f-rez-cost   (TOTAL  by gds-list.qnty ) .
              accumulate f-rez-sale   (TOTAL  by gds-list.qnty ) .
                Assign
                  f-qnty          = 0
                  f-cost-sum      = 0
                  f-sale-sum      = 0
  ...
  End.
  if c-f-free-qnty <>  ?  then do :
    c-f-free-qnty:screen-value = string(accum TOTAL by gds-list.qnty f-free-qnty ) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-wait-qnty <>  ?  then do :
    c-f-wait-qnty:screen-value = string(accum TOTAL by gds-list.qnty f-wait-qnty ) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-rez-qnty <>  ?  then do :
    c-f-rez-qnty:screen-value = string(accum TOTAL by gds-list.qnty f-rez-qnty  ) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-rez-cost <>  ?  then do :
    c-f-rez-cost:screen-value = string(accum TOTAL by gds-list.qnty f-rez-cost  ) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-rez-sale <>  ?  then do :
    c-f-rez-sale:screen-value = string(accum TOTAL by gds-list.qnty f-rez-sale  ) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
              ...
              excel-sum (accum TOTAL by gds-list.qnty  f-free-qnty      )   CHR(9)
              excel-sum (accum TOTAL by gds-list.qnty  f-wait-qnty      )   CHR(9)
              excel-sum (accum TOTAL by gds-list.qnty f-rez-qnty  ) CHR(9)
              excel-sum (accum TOTAL by gds-list.qnty f-rez-cost  ) CHR(9)
              excel-sum (accum TOTAL by gds-list.qnty f-rez-sale  ) CHR(9)
              CHR(9)
              chr(10) .
          End.
end.
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run bcodepls in g#library
  ...
  assign
    v-cur-base = price-rubl-with-tax-sale-prl
  .
end procedure.
