     ...
     do while pr-cursor < num-entries(v-prizn,","):
         ...
         if entry(pr-cursor,v-prizn,",") <> "" then do:
             ...
             buf_gds-obj.obj-code =  sl-obj-list.obj-code :
                 ...
                 assign
                    ...
                    f-cost-sum   = f-cost-sum + if buf_gds-obj.fact-qnty = 0 then 0 else prt-obj.fact-qnty * determined(buf_gds-obj.fact-base) / buf_gds-obj.fact-qnty
                    ...
                    f-cost-pr   = if prt-obj.fact-qnty  = 0 then 0 else determined(buf_gds-obj.fact-base) / buf_gds-obj.fact-qnty
       ...
       for each sl-obj-list,
           ...
           assign
            ...
            f-cost-sum   = f-cost-sum  + determined(buf_gds-obj.fact-base)
          ...
          for each  bufd_gds-dtl no-lock where
              ...
              first buff_doc-line no-lock where
                    ...
                    assign
                      ...
                      f-rez-cost = f-rez-cost  + ( bufd_gds-dtl.doc-qnty * buff_doc-line.price-base )
                      f-rez-sale = f-rez-sale  + ( bufd_gds-dtl.doc-qnty * bufd_gds-dtl.price-base )
                      f-rez-cost-pr = ( if f-rez-qnty = 0 then 0 else f-rez-cost / f-rez-qnty )
                    .
                    create temp_gds-dtl.
                    buffer-copy bufd_gds-dtl to temp_gds-dtl
                    assign
                        temp_gds-dtl.cost-sum = bufd_gds-dtl.doc-qnty * buff_doc-line.price-base
                        temp_gds-dtl.sale-sum = bufd_gds-dtl.doc-qnty * bufd_gds-dtl.price-base
                    .
          end.
   end.
end.
