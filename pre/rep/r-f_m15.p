...
HEADER
  ...
  ":    щий счет    :                                                 :  измерения :                     : руб. коп.:     учета НДС,    : руб.         коп. :    учетом НДС,    :            :   номер  :" SKIP
  ":----------------:-------------------------------------------------:------------:---------------------:          : руб.         коп. :                   : руб.         коп. :------------: записи по:" SKIP
...
PROCEDURE get-vars :
  ...
  DO ON ERROR UNDO, RETURN :
    ...
    ASSIGN p-quantity-fact = tt-allsum-line.fact-qnty
           p-cost-rubl     = ( ( tt-allsum-line.sum-dsc-rubl-doc - tt-allsum-line.vat-rubl-doc ) / tt-allsum-line.fact-qnty )
           p-no-VAT-rubl   = ( tt-allsum-line.sum-dsc-rubl-doc - tt-allsum-line.vat-rubl-doc )
           p-VAT-rubl      = tt-allsum-line.vat-rubl-doc
           p-to-pay-rubl   = tt-allsum-line.sum-dsc-rubl-doc
           p-inventory     = "":U
           p-passport      = "":U
           p-order         = "":U.
  END.
