...
PROCEDURE adm-disable :
    DISABLE RECT-7 RECT-8 RECT-6 Classify SortType tog-razd-obj WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-7 RECT-8 RECT-6 Classify SortType tog-razd-obj WITH FRAME F-Main.
...
END PROCEDURE.
PROCEDURE my-var :
  Assign frame F-Main  SortType Classify tog-razd-obj .
  Assign
    STR-obj-type = ''
    STR-obj-code = ''
    STR-obj-name = ''
