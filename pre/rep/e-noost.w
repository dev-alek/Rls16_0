...
PROCEDURE adm-disable :
    DISABLE Itog Classify ie ee ep es re rs we vt iv ev rv em wm im RECT-10 RECT-12 WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN Itog Classify ie ee ep es re rs we vt iv ev rv em wm im RECT-10 RECT-12 WITH FRAME F-Main.
