  ...
  do:
   ...
   v-button-stop = false .
    ...
    assign
        ...
        v-r-sroki-single-line   = fill( "-", 195 )
...
output stream out-stream to value( string( session:temp-directory +
        ...
        form header
            space(2) v-r-sroki-single-line format "X(195)"
...
:
    ...
    :
        ...
        then do:
            ...
            .
IF ( v-r-sroki-line-counter modulo v-account = 0 )  then DO:
 Assign
    ...
    .
          ...
          then DO:
           ...
           then do:
            DISPLAY
              v-r-sroki-line-counter @ RecordsDone
...
do l-ii = 1 to num-entries( reportheader , "chr(10)"  )    :        l-len = length (entry( l-ii , reportheader  , "chr(10)")) .                       l-m = integer( l-len / 220 ) + 1 .                                                      do l-jj = 1 to  l-m  :                                                                      num#str# = num#str# + 1 .                                                               run macr_excel_char_with_format (                                                           substring(entry( l-ii , reportheader  , "chr(10)") , (( 220 * l-jj ) - 219 )  , 220 )  , num#str# , num#col# ) .      end.                                                                                                         end.
  ...
  num#col# = 1.
    put stream out-stream
        skip(1)
        space(2)
            v-r-sroki-single-line   format "X(195)"
        skip space(2)  "|"
            "БарКод"                at center-field(2 + 1, 2 + 11, 3)
            "|"                     at 2 + 11
            ...
            "|"                     at 2 + 82
            "Поставщик"             at center-field(2 + 82, 2 + 96, 9)
            "|"                     at 2 + 96
            "Имя поставщика"        at 2 + 96 + 2
            "|"                     at 2 + 121
            "Партия"                at center-field(2 + 121, 2 + 142, 6)
            "|"                     at 2 + 142
            "Количество"            at center-field(2 + 142, 2 + 154, 10)
            "|"                     at 2 + 154
            "Объект и Место хранения"        at 2 + 154 + 2
            "|"                     at 2 + 184
            "Дата"                  at center-field(2 + 184, 2 + 195, 4)
            "|"                     at 2 + 195
        skip space(2)
            "|" v-r-sroki-single-line format "X(193)" "|"
    .
...
:
    put stream out-stream
        skip space(2)
            v-r-sroki-single-line   format "X(195)" skip
    .
