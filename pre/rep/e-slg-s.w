...
IF NOT THIS-PROCEDURE:PERSISTENT THEN DO:
  MESSAGE "c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\rep\e-slg-s.w should only be RUN PERSISTENT.":U
...
PROCEDURE adm-disable :
    DISABLE RECT-6 RECT-5 FILL-IN-1 FILL-IN-2 RADIO-sel SumObj ShowNull TOGGLE-3 TOGGLE-1 WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-6 RECT-5 FILL-IN-1 FILL-IN-2 RADIO-sel SumObj ShowNull TOGGLE-3 TOGGLE-1 WITH FRAME F-Main.
...
then do:
  ...
  assign
    FILL-IN-1 :screen-value in frame F-Main = string(TODAY,"99/99/9999")
    FILL-IN-2 :screen-value in frame F-Main = string(TODAY,"99/99/9999")
  .
...
END PROCEDURE.
PROCEDURE my-report :
Assign frame F-Main FILL-IN-1 FILL-IN-2 FILL-IN-3 TOGGLE-1 TOGGLE-2 SumObj ShowNull RADIO-sel .
...
END PROCEDURE.
PROCEDURE my-var :
  Assign frame F-Main FILL-IN-1 FILL-IN-2 FILL-IN-3 TOGGLE-1 TOGGLE-2  TOGGLE-3 .
  Assign
    STR-obj-type = ''
    STR-obj-code = ''
    STR-obj-name = ''
