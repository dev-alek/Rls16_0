...
assign v-account = ( if integer( 30 ) = 0 then 100 else integer( 30 ) ).
  if  log-manager:logfile-name ne ?
  then DO:
...
define variable v-s# as character no-undo .
 if (x-sum-type = 'sale':U ) then assign tt# = 6 v-s# = 'sadt':U .
 if (x-sum-type = 'crsa':U ) then assign tt# = 3 v-s# = 'cgdt':U .
 if (x-sum-type = 'cost':U ) then assign tt# = 0 v-s# = 'csdt':U .
 if (x-sum-type = 'sasr':U) then assign tt# = 6 v-s# = 'adsr':U .
 if (x-sum-type = 'cgsr':U) then assign tt# = 3 v-s# = 'gdsr':U .
 if (x-sum-type = 'cssr':U) then assign tt# = 0 v-s# = 'sdsr':U .
define variable v-i as integer no-undo .
repeat v-i = 1 to  extent(m-prih) :
 run oborot-stk in this-procedure (input  x-store-code , input  x-store-type , input  x-artic ,input  x-prod-code  ,input  x-prod-type  ,input  x-tog-shift  ,input  fact-order-1 ,input  fact-order-2 , input v-s# + m-prih[v-i] , input l-cat-id , input xtog-obj     ,    output quantity#1   ,    output coast_r#1    ,    output coast_v#1    ,    output vat_r#1      ,    output vat_v#1      ,    output slt_r#1      ,    output slt_v#1      ,    output other_r#1    ,    output other_v#1    ) .
...
repeat v-i = 1 to  extent(m-rash) :
 run oborot-stk in this-procedure (input  x-store-code , input  x-store-type , input  x-artic ,input  x-prod-code  ,input  x-prod-type  ,input  x-tog-shift  ,input  fact-order-1 ,input  fact-order-2 , input  v-s# + m-rash[v-i] , input l-cat-id , input xtog-obj     ,    output quantity#1   ,    output coast_r#1    ,    output coast_v#1    ,    output vat_r#1      ,    output vat_v#1      ,    output slt_r#1      ,    output slt_v#1      ,    output other_r#1    ,    output other_v#1    ) .
...
repeat v-i = 1 to  extent(m-kassa) :
 run oborot-stk in this-procedure (input  x-store-code , input  x-store-type , input  x-artic ,input  x-prod-code  ,input  x-prod-type  ,input  x-tog-shift  ,input  fact-order-1 ,input  fact-order-2 , input  v-s# + m-kassa[v-i] , input l-cat-id , input xtog-obj     ,    output quantity#1   ,    output coast_r#1    ,    output coast_v#1    ,    output vat_r#1      ,    output vat_v#1      ,    output slt_r#1      ,    output slt_v#1      ,    output other_r#1    ,    output other_v#1    ) .
...
repeat v-i = 1 to  extent(m-inv) :
 run oborot-stk in this-procedure (input  x-store-code , input  x-store-type , input  x-artic ,input  x-prod-code  ,input  x-prod-type  ,input  x-tog-shift  ,input  fact-order-1 ,input  fact-order-2 , input  v-s# + m-inv[v-i] , input l-cat-id , input xtog-obj     ,    output quantity#1   ,    output coast_r#1    ,    output coast_v#1    ,    output vat_r#1      ,    output vat_v#1      ,    output slt_r#1      ,    output slt_v#1      ,    output other_r#1    ,    output other_v#1    ) .
...
repeat v-i = 1 to  extent(m-overturn) :
 run oborot-stk in this-procedure (input  x-store-code , input  x-store-type , input  x-artic ,input  x-prod-code  ,input  x-prod-type  ,input  x-tog-shift  ,input  fact-order-1 ,input  fact-order-2 , input  v-s# + m-overturn[v-i] , input l-cat-id , input xtog-obj     ,    output quantity#1   ,    output coast_r#1    ,    output coast_v#1    ,    output vat_r#1      ,    output vat_v#1      ,    output slt_r#1      ,    output slt_v#1      ,    output other_r#1    ,    output other_v#1    ) .
...
IF ( i modulo v-account = 0 )  then DO:
 Assign
    v-kol-spice = (50 - LENGTH(clients.obj-name)) / 2
    RecordsString = fill(' ',v-kol-spice) + string(clients.obj-name)
    .
          if  log-manager:logfile-name ne ?
          then DO:
              log-manager:write-message("DISP mFrameView=" + string(mFrameView), "frameRepError").
