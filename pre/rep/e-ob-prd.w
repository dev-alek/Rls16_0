...
PROCEDURE adm-disable :
    DISABLE RECT-6 RECT-5 RECT-7 TOGGLE-1 RADIO-Sort TOGGLE-2 SumsOnly RADIO-boss SelectOrg Classify SortType B-columns FILL-IN-33 FILL-IN-30 FILL-IN-31 FILL-IN-35 FILL-IN-34 FILL-IN-36 WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-6 RECT-5 RECT-7 TOGGLE-1 RADIO-Sort TOGGLE-2 SumsOnly RADIO-boss SelectOrg Classify SortType B-columns FILL-IN-33 FILL-IN-30 FILL-IN-31 FILL-IN-35 FILL-IN-34 FILL-IN-36 WITH FRAME F-Main.
  ...
  if RADIO-boss = 2 then  do:
    ...
    if ref-list <> "" then do:
      ...
      assign
        ...
        MngrCodes = ""
      .
      DISPLAY RADIO-boss with frame F-Main .
    end.
  end.
END.
...
DO:
  ...
  if SelectOrg = 2 then do:
    ...
    if org-list = "" then do:
      SelectOrg = 1 .
      disp SelectOrg with frame F-Main.
    end.
  end .
END.
ON VALUE-CHANGED OF SumsOnly IN FRAME F-Main
DO:
  Assign SumsOnly.
  if SumsOnly = no then enable  RECT-6 Classify SortType with frame F-Main .
  else                  disable RECT-6 Classify SortType with frame F-Main .
END.
...
def var  l-ind as integer no-undo .
 ...
 disable RECT-6 Classify SortType with frame F-Main .
 display FILL-IN-30 FILL-IN-31  FILL-IN-33  FILL-IN-34  FILL-IN-35 FILL-IN-36 TOGGLE-1 SumsOnly with frame F-Main .
END PROCEDURE.
PROCEDURE my-report :
...
END PROCEDURE.
PROCEDURE my-var :
 Assign frame F-Main SumsOnly Classify SortType SelectOrg TOGGLE-1 TOGGLE-2 RADIO-boss RADIO-Sort .
 Assign
   STR-obj-type = ''
   STR-obj-code = ''
   STR-obj-name = ''
