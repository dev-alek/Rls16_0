...
PROCEDURE adm-disable :
    DISABLE RECT-1 rs-select fi-last-date fi-last-date-offset b-choose-last-date fi-description WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-1 rs-select fi-last-date fi-last-date-offset b-choose-last-date fi-description WITH FRAME F-Main.
...
ON CHOOSE OF b-choose-last-date IN FRAME F-Main
DO:
...
DO:
  ...
  run godendo-offset-to-date in this-procedure
    (input  v-today
    ,input  (input frame F-Main fi-last-date-offset)
    ,output v-last-date
    ) .
  assign
...
on ' ' of fi-last-date in frame F-Main
do:
...
on delete-character of fi-last-date in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-d of fi-last-date in frame F-Main
do:
  define variable v-curr-sv-date as date no-undo .
  if (can-query (self, "sensitive")
     and
...
on ctrl-b of fi-last-date in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-e of fi-last-date in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-f of fi-last-date in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
  ...
  define MENU m-ed-date13
    ...
    .
  if fi-last-date :POPUP-MENU in frame F-Main = ?
  then do:
    ASSIGN
      fi-last-date :POPUP-MENU in frame F-Main = MENU m-ed-date13 :HANDLE
      fi-last-date :MENU-MOUSE in frame F-Main = 3
    .
  end.
  define variable v-label-handle13 as handle no-undo .
  assign
    v-label-handle13 = fi-last-date :side-label-handle in frame F-Main
  .
  ...
  ON CHOOSE OF MENU-ITEM m-ed-date13-1 in menu m-ed-date13 DO:
    apply "ctrl-b":U to fi-last-date in frame F-Main .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date13-2 in menu m-ed-date13 DO:
    apply "ctrl-d":U to fi-last-date in frame F-Main .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date13-3 in menu m-ed-date13 DO:
    apply "ctrl-e":U to fi-last-date in frame F-Main .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date13-4 in menu m-ed-date13 DO:
    apply "ctrl-f":U to fi-last-date in frame F-Main .
  END.
...
PROCEDURE update-last-date-offset :
  ...
  :
    ...
    run godendo-date-to-offset in this-procedure
      (input  v-today
      ,input  (input frame F-Main fi-last-date)
