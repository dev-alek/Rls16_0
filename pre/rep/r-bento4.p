...
define variable vss-workfile    as character no-undo init "$Workfile: r-bento4.p $":U .
define variable vss-archive     as character no-undo init "$Archive: rep/r-bento4.p $":U .
