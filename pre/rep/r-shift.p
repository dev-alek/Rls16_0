...
:
  ...
  FOR EACH ub.shift-staff No-LOCK WHERE
    ...
    if lookup( chr(32) + ub.shift-staff.name, for-opers ) = 0 then do:
      assign
        for-opers = for-opers + (if NOT first-oper then chr(44) else "") + chr(32) + ub.shift-staff.name
  ...
  FOR EACH ub.shift-staff No-LOCK WHERE
          ...
          ub.shift-staff.psn-num    >= 0 :
    if lookup( chr(32) + ub.shift-staff.name, for-mng ) = 0 then do:
      assign
        for-mng = for-mng + (if NOT first-mngr then chr(44) else "") + chr(32) + ub.shift-staff.name
...
if not available temp-shift-obj Then DO:
    if p-batch > 0 then do:      run write-log-and-file in p-log-handle (                 input 1                                          , input p-log-file-name                              , input 1                                          , input substitute("На объекте &1 нет смены &2 с датой начала &3&4" +                               "Исправьте запрашиваемые данные!"                               , store-name                               , X-shift-start                               ,string(X-date-start,"99/99/9999")                               , chr(10) )).    end.    else do:       run write-to-log in p-log-handle ( input substitute("На объекте &1 нет смены &2 с датой начала &3&4" +                               "Исправьте запрашиваемые данные!"                               , store-name                               , X-shift-start                               ,string(X-date-start,"99/99/9999")                               , chr(10) )).    end.
  if v-write-xml-error then do:
    run cb_write-report-error in p-parent-handle ( input p-rebh
                                                  ,input p-report-id
                                                  ,input ?
                                                  ,input '3':U
                                                  ,input substitute("На объекте &1 нет смены &2 с датой начала &3&4" +                               "Исправьте запрашиваемые данные!"                               , store-name                               , X-shift-start                               ,string(X-date-start,"99/99/9999")                               , chr(10) )).
  end.
  RETURN.
End.
assign
...
FORM HEADER
    ...
    skip
    with FRAME Bottom2Frame width 232 PAGE-BOTTOM NO-LABELS NO-BOX .
...
if tog-1 = true then do:
  ...
  assign
    pol2 = substitute( "&1 &2"
                       ...
                       , (if p-weight = true then "кг" else "л")
                      )
    ...
    Sheetf.Excel-Column-Lable = "НАИМЕНОВАНИЕ ПРОДУКТА"                          + chr(44) +
                                pol2                                             + chr(44) +
                                substitute( "ПОСТУПИЛ за смену &1", (if p-weight = true then "кг" else "л") )    + chr(44) +
                                "ПОКАЗАТЕЛИ СЧЕТНЫХ МЕХАНИЗМОВ"                  + chr(44) +
                                                                                   chr(44) +
                                                                                   chr(44) +
                                                                                   chr(44) +
                                                                                   chr(44) +
                                                                                   chr(44) +
                                "ОСТАТОК НА КОНЕЦ СМЕНЫ"                         + chr(44) +
                                                                                   chr(44) +
                                                                                   chr(44) +
                                                                                   chr(44) +
                                                                                   chr(44) +
                                ...
                                chr(10)   +
                                                                                   ...
                                                                                   chr(44) +
                                "N ТРК"                                          + chr(44) +
                                "На конец смены л"                               + chr(44) +
                                "На начало смены л"                              + chr(44) +
                                "РАСХОД л"                                       + chr(44) +
                                "N РЕЗ"                                          + chr(44) +
                                "ОБЩИЙ уровень включая воду см"                  + chr(44) +
                                "ВОДЫ уровень см"                                + chr(44) +
                                "ОБЩИЙ объем включая воду л"                     + chr(44) +
                                "ВОДЫ объем л"                                   + chr(44) +
                                "ФАКТ ОБЪЕМ в трубопроводе л"                    + chr(44) +
                                "ФАКТ ОБЪЕМ в резервуаре л"                      + chr(44) +
                                "ФАКТ ОБЪЕМ всего л"                             + chr(44) +
                                "ФАКТ ОБЪЕМ всего кг"                            + chr(44) +
                                "ФАКТ ПЛ-ТЬ  кг/л"                               + chr(44) +
                                "ФАКТ ТЕМП.  С"                                  + chr(44) +
                                pol16                                            + chr(44) +
                                substitute( "ИЗЛИШКИ &1", (if p-weight = true then "кг" else "л") )              + chr(44) +
                                substitute( "НЕДОСТАЧА &1", (if p-weight = true then "кг" else "л") )            +
                  chr(10) +
                                '="1.1"'                                         + chr(44) +
                                '="1.2"'                                         + chr(44) +
                                '="1.3"'                                         + chr(44) +
...
if tog-2 or tog-3 or tog-4 or tog-8 then do:
 ...
 if tog-2 = yes and v-run-2-3-4 = yes then do:
    ...
    Sheetf.Excel-Column-Lable = "ИНФОРМАЦИЯ О ПРОДУКТЕ" + chr(44) +
                         chr(44) +
                         chr(44) +
                         chr(44) +
                         chr(44) +
                         "РАСШИФРОВКА ПОСТУПЛЕНИЯ" + chr(44) +
                         chr(44) +
                         chr(44) +
                         chr(44) +
                         chr(44) +
                         chr(44) +
                         chr(44) +
                         "РАСШИФРОВКА РЕАЛИЗАЦИИ" + chr(44) +
                         chr(44) +
                         chr(44) +
                         chr(44) +
                         "ОСТАТОК НА КОНЕЦ" + chr(44) +
                          chr(10) +
                         "НАИМЕНОВАНИЕ продукта" + chr(44) +
                         "КОД товара" + chr(44) +
                         "ЦЕНА розничная на конец смены" + chr(44) +
                         "ОСТАТОК НА НАЧАЛО" + chr(44) +
                         chr(44) +
                         "ПОСТАВЩИК" +  chr(44) +
                         chr(44) +
                         "НОМЕР документа прихода (ТТН)" + chr(44) +
                         "КОЛИЧЕСТВО" + chr(44) +
                         chr(44) +
                         chr(44) +
                         "ТЕМПЕРАТУРА в цистерне в гр. С" + chr(44) +
                         "ТИП РАСХОДА (тип платежа)" + chr(44) +
                         "КОЛ-ВО в литрах" + chr(44) +
                         "КОЛ-ВО в килогр кг" + chr(44) +
                         "СУММА" + chr(44) +
                         "КОЛ-ВО в литрах л" + chr(44) +
                         "КОЛ-ВО в килогр кг" +
                         chr(10) +
                         chr(44) +
                         chr(44) +
...
if tog-3 = yes and v-run-2-3-4 = yes then do:
  ...
  PUT STREAM PrnLibstream UNFORMATTED
    string( p-z-number-list, "x(198)":U ) format "x(198)":U skip "-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" skip "                    ИНФОРМАЦИЯ О ТОВАРЕ                :                         РАСШИФРОВКА ПОСТУПЛЕНИЯ                    :             РАСШИФРОВКА РЕАЛИЗАЦИИ        :         ОСТАТОК      " skip "-------------------------------------------------------:--------------------------------------------------------------------:-------------------------------------------:         на конец     " skip "           НАИМЕНОВАНИЕ         :   ОСТАТОК НА НАЧАЛО  :            ПОСТАВЩИК         :      НОМЕР     :     ПОСТУПИЛО      :    ТИП РАСХОДА     : КОЛ-ВО  :    СУММА   :----------------------" skip "          группы товаров        :----------------------:------------------------------:    документа   :--------------------:   (тип платежа)    :         : цены док-та: КОЛ-ВО  :    СУММА   " skip "                                : КОЛ-ВО  :   СУММА    :    Наименование    :   Код   :     прихода    : КОЛ-ВО :   СУММА   :                    :         :            :         : прод. цены " skip "                                :         : прод. цены :                    :         :      (ТТН)     :        : учет.цены :                    :         :            :         :            " skip "                                :         :            :                    :         :                :        :           :                    :         :            :         :            " skip "-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------"
  .
  ...
  Sheetf.Excel-Column-lable =
                         ...
                         "ОСТАТОК НА КОНЕЦ" + chr(44) +
                         chr(10) +
                         "НАИМЕНОВАНИЕ группы товаров" + chr(44) +
                         "ОСТАТОК НА НАЧАЛО" + chr(44) +
                         chr(44) +
                         "ПОСТАВЩИК" + chr(44) +
                         chr(44) +
                         ...
                         "ТИП РАСХОДА (тип платежа)" + chr(44) +
                         "КОЛ-ВО" + chr(44) +
                         "СУММА (цены док-та)" + chr(44) +
                         "КОЛ-ВО" + chr(44) +
                         "СУММА (прод. цены)" + chr(10) +
                         chr(44) +
                         "КОЛ-ВО" + chr(44) +
                         "СУММА (прод.цены)" +  chr(44) +
                         "Наименование" +  chr(44) +
                         "Код" +  chr(44) +
                         chr(44) +
                         "КОЛ-ВО" + chr(44) +
                         "СУММА (учет. цены)" +  chr(44) +
                         chr(44) +
                         chr(44) +
                         chr(44) +
                         chr(44) +
...
if tog-4 = yes and v-run-2-3-4 = yes then do:
  ...
  PUT STREAM PrnLibstream UNFORMATTED
    string( p-z-number-list, "x(198)":U ) format "x(198)":U skip "-------------------------------------------------------------------------------------------------"  skip "              ИНФОРМАЦИЯ ОБ УСЛУГЕ                 :        РАСШИФРОВКА РЕАЛИЗАЦИИ УСЛУГ         "  skip "---------------------------------------------------:---------------------------------------------"  skip "           НАИМЕНОВАНИЕ         :   КОД   :ЦЕНА    :    ТИП РАСХОДА    :  КОЛ-ВО :     СУММА     "  skip "              услуги            :  услуги :розничн :   (тип платежа)   :         :               "  skip "                                :         :на конец:                   :         :               "  skip "                                :         :смены   :                   :         :               "  skip "-------------------------------------------------------------------------------------------------"
  .
  ...
  if not available sheetf then do:
   ...
   assign
     ...
     Sheetf.EXCEl-COLUMn-LABLE =
                      "ИНФОРМАЦИЯ ОБ УСЛУГЕ" + chr(44) +
                      chr(44) +
                      chr(44) +
                      "РАСШИРОВКА РЕАЛИЗАЦИИ УСЛУГ" + chr(44) +
                      chr(44) +
                      chr(10) +
                      "НАИМЕНОВАНИЕ услуги" + chr(44) +
                      "КОД услуги  " + chr(44) +
                      "ЦЕНА рознич. на конец смены" + chr(44) +
                      "ТИП РАСХОДА (тип платежа)" + chr(44) +
                      "КОЛ-ВО" + chr(44) +
                      "СУММА" +
                      chr(10) +
...
End.
  ...
  if tog-5 = yes then do:
    ...
    PUT STREAM PrnLibstream UNFORMATTED
      "----------------------------------------------------------------------------------------------------------------------------"  skip "                                                ДВИЖЕНИЕ МАТЕРИАЛЬНЫХ ЦЕННОСТЕЙ                                             "  skip "----------------------------------------------------------------------------------------------------------------------------"  skip "          НАИМЕНОВАНИЕ          :   ОСТАТОК НА  :          ПОЛУЧЕНО           :        ИНКАССИРОВАНО        :   ОСТАТОК НА  "  skip "          материальных          :  НАЧАЛО СМЕНЫ :-----------------------------:-----------------------------:   КОНЕЦ СМЕНЫ "  skip "            ценностей           :               :    Выручка   :    Прочие    :       в      :   Прочие     :               "  skip "                                :               :   за смену   :   источники  :     банк     : контрагенты  :               "  skip "----------------------------------------------------------------------------------------------------------------------------"
    .
 ...
 Sheetf.EXCEl-COLUMn-LABLE =
                      "ДВИЖЕНИЕ МАТЕРИАЛЬНЫХ ЦЕННОСТЕЙ" + chr(44) +
                      chr(44) +
                      chr(44) +
                      chr(44) +
                      chr(44) +
                      chr(44) +
                      chr(10) +
                      "НАИМЕНОВАНИЕ материальных ценностей" + chr(44) +
                      "ОСТАТОК НА НАЧАЛО СМЕНЫ" + chr(44) +
                      "ПОЛУЧЕНО" + chr(44) +
                      chr(44) +
                      "ИНКАССИРОВАНО" + chr(44) +
                      chr(44) +
                      "ОСТАТОК НА КОНЕЦ СМЕНЫ" +
                      chr(10) +
                      chr(44) +
                      chr(44) +
                      "Выручка за смену" + chr(44) +
                      "Прочие источники" + chr(44) +
                      "в банк " + chr(44) +
                      "Прочие контрагенты" + chr(44) +
                      chr(10) +
                      '="5.1"' + chr(44) +
                      '="5.2"' + chr(44) +
                      '="5.3"' + chr(44) +
   ...
   for each temp-shift-obj :
     ...
     :
       if buf_rvs-doc.PS <> '@' then do:
         ...
         if Make-Excel then  put   stream ForExcel unformatted sstr2 chr(10) .
       end.
     end.
   end.
End.
...
if tog-7 = yes then DO:
    ...
    PUT STREAM PrnLibStream UNFORMATTED
      '-----------------------------------------------------------------------------------------'  skip '               :               :                              : ВЕЛИЧИНА погрешности ТРК '  skip '               :               :                              : "+" недолив, "-" перелив '  skip '     № ТРК     :  № ПИСТОЛЕТА  :     НАИМЕНОВАНИЕ топлива     :--------------------------'  skip '               :               :                              :      мл      :     %     '  skip '-----------------------------------------------------------------------------------------'
    .
...
if tog-8 then DO:
    ...
    assign
      ...
      Sheetf.EXCEl-COLUMn-LABLE = "Тип оплаты" + chr(44)
      Sheetf.SIzes = "15"
    .
    for each treal-8 no-lock where
      ...
      Sheetf.MergeCellsH = SHeetf.mergeCellsh + substitute("&1&2:&3"
                                                           ...
                                                           ,v-ii * 2
                                                           ,v-ii * 2 + 1)
      Sheetf.EXCEl-COLUMn-LABLE = Sheetf.EXCEl-COLUMn-LABLE + buf_goods.chk-name + chr(44) + chr(44)
      v-str2 = v-str2 + "Литры" + chr(44) + "рубли" + chr(44)
      Sheetf.SIzes = Sheetf.SIzes +  chr(44) + "7,7":U
      .
    end.
    assign
    sheetf.MergeCellsH = SHeetf.mergeCellsh + (if SHeetf.mergeCellsh = '':U
                                              ...
                                              ,(v-ii + 1) * 2
                                              ,(v-ii + 1) * 2 + 1)
    Sheetf.EXCEl-COLUMn-LABLE = Sheetf.EXCEl-COLUMn-LABLE +  "ИТОГО" + chr(44) +
                                chr(10) +
                                chr(44) + v-str2 + "Литры" + chr(44) + "рубли"
    Sheetf.SIzes = Sheetf.SIzes +  chr(44) + "7,7":U
  .
  run rep/extitle.p
    ( input 8
...
if tog-9 then DO:
   ...
   PUT STREAM PrnLibstream UNFORMATTED '------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------'  skip '                            : № :  №  :  Счетчик на   :  Счетчик на   :               :               :               :               :     Сброс     :     Сброс     :               :    Перевод    '  skip '    НАИМЕНОВАНИЕ топлива    :ТРК:ПИСТ.:     начало    :    конец      :    Оборот     :      Касса    :   Техпролив   :    Разница    :  (Не пролито) :   (Пролито)   :    Перелив    :   транзакции  '  skip '------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------'  skip '              9.1           :9.2: 9.3 :      9.4      :      9.5      :      9.6      :      9.7      :      9.8      :      9.9      :      9.10     :      9.11     :      9.12     :      9.13     '  skip '------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------'.
   find first Sheetf
   ...
   assign
      Sheetf.EXCEl-COLUMN-LABLE =
                     ...
                     "№ ТРК"                + chr(44) +
                     "№ ПИСТОЛЕТА"          + chr(44) +
                     "Счетчик на начало"    + chr(44) +
                     "Счетчик на конец"     + chr(44) +
                     "Оборот"               + chr(44) +
                     "Касса"                + chr(44) +
                     "Техпролив"            + chr(44) +
                     "Разница"              + chr(44) +
                     "Сброс (не пролито)"   + chr(44) +
                     "Сброс (пролито)"      + chr(44) +
                     "Перелив"              + chr(44) +
                     "Перевод  транзакции"  + chr(44) +
                     chr(10) +
                     '="9.1"'  + chr(44) +
                     '="9.2"'  + chr(44) +
                     '="9.3"'  + chr(44) +
...
if tog-10 then DO:
   ...
   PUT STREAM PrnLibstream UNFORMATTED '-----------------------------------------------------------------------------------------------------------------------------------------------'  skip '                              :             :      ТИП        :      ТИП      :  КОЛИЧЕСТВО,  :    СУММА      :    СКИДКА    :    СУММА        '  skip '     НАИМЕНОВАНИЕ топлива     :     КОД     :     ОПЛАТЫ      :     СКИДКИ    :      лт       :    БРУТТО     :              :    НЕТТО        '  skip '-----------------------------------------------------------------------------------------------------------------------------------------------'.
   find first Sheetf
...
if p-batch = integer('0':U) then do:
  ...
  if p-report-id  <> "53/2040" then do:
    run reprumpr_print-printer in this-procedure ( input 7
                                                  ,input 2
                                                  ) no-error.
    if error-status:error then do:
...
procedure last-line-XL :
   if Make-Excel then  put   stream ForExcel unformatted
      skip(2)
      "Смену сдал" CHR(9)   fill("_":U, 21) CHR(9) CHR(9) "Смену принял"  CHR(9)  fill("_":U, 21)  skip
      .
End procedure.
