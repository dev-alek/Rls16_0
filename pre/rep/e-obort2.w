...
PROCEDURE adm-disable :
    DISABLE RECT-5 RECT-7 RECT-8 RECT-6 SortType Tog-obj Classify RADIO-Nomenkl ShowZero-2 RADIO-SET-1 RADIO-AltObj SumsOnly-2 B-columns TOGGLE-1 FILL-IN-31 FILL-IN-30 FILL-IN-33 FILL-IN-32 WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-5 RECT-7 RECT-8 RECT-6 SortType Tog-obj Classify RADIO-Nomenkl ShowZero-2 RADIO-SET-1 RADIO-AltObj SumsOnly-2 B-columns TOGGLE-1 FILL-IN-31 FILL-IN-30 FILL-IN-33 FILL-IN-32 WITH FRAME F-Main.
...
run userobjs_select-many in this-procedure
  ...
  ,output v-user-select
    ...
    if v-user-select <> true then do:
      ...
      display RADIO-AltObj with frame F-Main .
    end.
    else do:
      define buffer buf_userobjs_temp-user-obj for userobjs_temp-user-obj .
      for each buf_userobjs_temp-user-obj :
...
define variable glog as logical no-undo .
 ...
 End.
 display FILL-IN-30 FILL-IN-31 FILL-IN-32 FILL-IN-33 RADIO-SET-1 with frame F-Main .
END PROCEDURE.
PROCEDURE my-report :
...
END PROCEDURE.
PROCEDURE my-var :
Assign frame F-Main SumsOnly ShowZero tog-obj Classify SortType RADIO-SET-1 TOGGLE-1
...
ReportHeader = ReportHeader  + "Выбор цен: " + (if x-SET_val_TYPE = 1 then "рублевые" else "валютные" ) + chr(10).
 assign
   str3 = ""
   str1 = "Показать : " +
