...
IF NOT THIS-PROCEDURE:PERSISTENT THEN DO:
  MESSAGE "c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\rep\e-yandex-rep.w should only be RUN PERSISTENT.":U
...
PROCEDURE adm-disable :
    DISABLE b-cd-pay b-file v-rep-type WITH FRAME fMain.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN b-cd-pay b-file v-rep-type WITH FRAME fMain.
...
DO:
    ...
    display v-file with frame fMain.
END.
...
DO:
  ...
  .
  display v-cp-code v-cp-name with frame fMain.
END.
