...
:
    ...
    put stream excel-line unformatted
        ...
        chr(9)   buf_temp_line-data.count
        chr(9)   buf_temp_line-data.Name
        chr(9)   buf_temp_line-data.EI
        chr(9)   buf_temp_line-data.docqnty
        chr(9)   buf_temp_line-data.docprice
        chr(9)   buf_temp_line-data.docsum
        chr(9)   buf_temp_line-data.factqnty
        chr(9)   buf_temp_line-data.factprice
        chr(9)   buf_temp_line-data.factsum
        chr(9)   buf_temp_line-data.qntyi
        chr(9)   buf_temp_line-data.sumi
        chr(9)   buf_temp_line-data.qntyn
        chr(9)   buf_temp_line-data.sumn
        chr(10)
    .
end.
end procedure.
