...
PROCEDURE get-vars :
  ...
  DO ON ERROR UNDO, RETURN :
    ...
    ASSIGN p-quantity    = tt-allsum-line.fact-qnty
           p-price-rubl  = ( ( tt-allsum-line.sum-dsc-rubl-acc - tt-allsum-line.vat-rubl-acc ) / tt-allsum-line.fact-qnty )
           p-sum-rubl    = ( tt-allsum-line.sum-dsc-rubl-acc - tt-allsum-line.vat-rubl-acc )
