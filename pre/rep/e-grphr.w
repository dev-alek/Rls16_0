...
PROCEDURE adm-disable :
    DISABLE T-dis-card BR-dis-card-type WithGoods T-scale RS-OPTION WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN T-dis-card BR-dis-card-type WithGoods T-scale RS-OPTION WITH FRAME F-Main.
...
DO:
    ...
    IF RS-OPTION = 3 then do:
        WithGoods = no.
        t-scale = no.
        Display WithGoods t-scale With frame F-Main.
        Disable WithGoods t-scale with frame F-Main.
        hide t-scale
        in frame F-Main .
    end.
    else do:
        ENABLE WithGoods with frame F-Main.
    end.
END.
