...
PROCEDURE adm-disable :
    DISABLE RECT-5 Classify WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-5 Classify WITH FRAME F-Main.
  ...
  CASE Classify:
    ...
    do:
      assign
        Classify =  "Все"
      .
      DISPLAY Classify WITH FRAME F-Main.
    end.
END.
