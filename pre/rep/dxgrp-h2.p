...
define variable vss-workfile    as character no-undo init "$Workfile: dxgrp-h2.p $":U .
define variable vss-archive     as character no-undo init "$Archive: rep/dxgrp-h2.p $":U .
