...
FOR EACH obj-list:
    ...
    THEN
        NEXT Block-vsd.
    IF    trn-doc.doc-date < x-date-start
       OR trn-doc.doc-date > x-date-end
    THEN
        NEXT Block-vsd.
    ...
    DO:
        ...
        ASSIGN
            ...
            ttVSD.NomAZS      = STRING(obj-list.obj-code)
            ...
            ttVSD.prod-code   = IF AVAIL clients
                                ...
                                ELSE ""
            ttVSD.unit-cli    = goods.unit-cli
            ttVSD.ojd        = string (vOjd )
            .
            RUN gbl/trdcat-v.p
...
DO:
    ...
    PUT STREAM OutStr-html UNFORMATTED
        ...
        '  </tr>'                               SKIP
        '  <tr>'                                                            SKIP
        '     <td colspan="13">Отчет с детализацией по накладным c ' + STRING (x-date-start, "99/99/9999")
