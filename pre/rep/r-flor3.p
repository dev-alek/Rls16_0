...
for each ready_trn-doc no-lock where
                      ...
                      ( ready_trn-doc.status_ = 'готов':U or
                      ready_trn-doc.status_ = 'отказ':U or
                      ready_trn-doc.status_ = 'запрос':U )
                      and
                      ready_trn-doc.doc-type = 'рас':U and
                      ready_trn-doc.internal = false   and
                      ready_trn-doc.ext-doc-type = 'ee':U and
                      ((
  ...
  if ready_trn-doc.status_ = 'запрос':U then do:
...
v-ord_date = "" . run trn-doc-attr_value in this-procedure (  input ready_trn-doc.doc-code                                           ,  input '0rsrv-date':U                                             , output v-ord_date                                             , output v-type ).
v-befpay = "" . run trn-doc-attr_value in this-procedure (  input ready_trn-doc.doc-code                                           ,  input '2befpay':U                                             , output v-befpay                                             , output v-type ).
v-deliv = "" . run trn-doc-attr_value in this-procedure (  input ready_trn-doc.doc-code                                           ,  input '5deliv':U                                             , output v-deliv                                             , output v-type ).
v-postpay-date0 = "" . run trn-doc-attr_value in this-procedure (  input ready_trn-doc.doc-code                                           ,  input '3postdchek':U                                             , output v-postpay-date0                                             , output v-type ).
v-before-date0 = "" . run trn-doc-attr_value in this-procedure (  input ready_trn-doc.doc-code                                           ,  input '4dchek':U                                             , output v-before-date0                                             , output v-type ).
...
v-itogo = "".
v-before-date = "" .
if ready_trn-doc.status_ = 'отказ':U  then  v-status_ = ready_trn-doc.status_ .
if ready_trn-doc.status_ = 'запрос':U and ready_trn-doc.flag_ = false  then  v-status_ = "Новый" .
if ready_trn-doc.status_ = 'запрос':U and ready_trn-doc.flag_ = true   then  v-status_ = "Создан" .
...
if available  nakl_trn-doc then do:
            v-postpay-date = "" .     run trn-doc-attr_value in this-procedure (  input nakl_trn-doc.doc-code                                               ,  input '3postdchek':U                                                 , output v-postpay-date                                                 , output v-type ).
            v-before-date = "" .     run trn-doc-attr_value in this-procedure (  input nakl_trn-doc.doc-code                                               ,  input '4dchek':U                                                 , output v-before-date                                                 , output v-type ).
            v-postpay = "" .     run trn-doc-attr_value in this-procedure (  input nakl_trn-doc.doc-code                                               ,  input '1postpay':U                                                 , output v-postpay                                                 , output v-type ).
            v-itogo = "" .     run trn-doc-attr_value in this-procedure (  input nakl_trn-doc.doc-code                                               ,  input 'discnt-stop':U                                                 , output v-itogo                                                 , output v-type ).
