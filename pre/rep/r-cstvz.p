...
assign
  ...
  for each tt-gds-parts use-index print-order:
    ...
    tt-gds-parts.doc-code    CHR(9)
    string ( tt-gds-parts.date-trn , "99/99/9999") CHR(9)
    ...
    string(tt-gds-parts.price,">>>>>>>>>>9.99" )       CHR(9)
    string(tt-gds-parts.sum-brutto,">>>>>>>>>>9.99" )  CHR(9)
  ...
  varsum-qnty    CHR(9)
  ""             CHR(9)
  string(varsum-brutto,">>>>>>>>>>9.99" )  CHR(9)
  ""             CHR(9)
  ""             CHR(9)
  skip.
...
for each obj-list :
  ...
  _trn-doc:
    for each bf_trn-doc where
        ...
        bf_trn-doc.ext-doc-type = 'ep':U and
       ...
       find first bf_clients  where bf_clients.obj-type = bf_goods.prod-type and
        ...
        for each bf-exp_parts where
          ...
          assign
           ...
           tt-gds-parts.price      = if x-SET_val_TYPE = 1 then bf-exp_parts.price-rubl else bf-exp_parts.price-base
