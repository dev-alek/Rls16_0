...
v-ed_date-param = 'ED_DATE-REF=' +
                  'X-DATE-START' + chr(3) +
                  ("С начала банковской выписки" + chr(4) +
                  "finsttms" + chr(4) +
                  'ext-type-stat-start' + chr(4) +
                  '':U) +
                   ';' +
                  ('X-DATE-END' + chr(3) + "По конец банковской выписки" + chr(4) +
                  "finsttms" + chr(4) +
                  'ext-type-stat-end' + chr(4) +
                  '':U)
.
run rep/d-report.w
    (  input parParentProc
      ,input 'rep/e-ob-sal.w'
      ...
      ,input ""
      ,input "1,2"
      ,input "13,23,x-customer-name=Выбор поставщика" + chr(44) + v-ed_date-param
      ,no).
