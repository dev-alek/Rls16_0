...
define temp-table tmp-gds-tree no-undo
  ...
  field ie       as decimal extent 13 format "->>>>>>>>>>>9.<<<"
  field ee       as decimal extent 13 format "->>>>>>>>>>>9.<<<"
  field ep       as decimal extent 13 format "->>>>>>>>>>>9.<<<"
  field es       as decimal extent 13 format "->>>>>>>>>>>9.<<<"
  field re       as decimal extent 13 format "->>>>>>>>>>>9.<<<"
  field rs  as decimal extent 13 format "->>>>>>>>>>>9.<<<"
  field we   as decimal extent 13 format "->>>>>>>>>>>9.<<<"
  field vt    as decimal extent 13 format "->>>>>>>>>>>9.<<<"
  field iv     as decimal extent 13 format "->>>>>>>>>>>9.<<<"
  field ev     as decimal extent 13 format "->>>>>>>>>>>9.<<<"
  field rv     as decimal extent 13 format "->>>>>>>>>>>9.<<<"
  field em     as decimal extent 13 format "->>>>>>>>>>>9.<<<"
  field wm     as decimal extent 13 format "->>>>>>>>>>>9.<<<"
  field im     as decimal extent 13 format "->>>>>>>>>>>9.<<<"
  field ot     as decimal extent 13 format "->>>>>>>>>>>9.<<<"
  field pc     as decimal extent 13 format "->>>>>>>>>>>9.<<<"
  field ap     as decimal extent 13 format "->>>>>>>>>>>9.<<<"
  field disc                             as decimal extent 13 format "->>>>>>>>>>>9.<<<"
  field eff                              as decimal extent 13 format "->>>>>>>>>>>9.<<<"
  field prc                              as decimal extent 13 format "->>>>>>>>>>>9.<<<"
  field ostatok-start                    as decimal extent 13 format "->>>>>>>>>>>9.<<<"
  field ostatok-end                      as decimal extent 13 format "->>>>>>>>>>>9.<<<"
  field oborot-sum-sale                  as decimal extent 13 format "->>>>>>>>>>>9.<<<"
  field oborot-sum-cost                  as decimal extent 13 format "->>>>>>>>>>>9.<<<"
 index pi id
 index i-name f-name
...
v-nn = num-entries ( str1 , "chr(10)"  ) .  do l-ii = 1 to v-nn :        l-len = length (entry( l-ii , str1  , "chr(10)")) .                       l-m = integer( l-len / 220 ) + 1 .                                                      do l-jj = 1 to  l-m  :                                                                      num#str# = num#str# + 1 .                                                               run macr_excel_char (                                                                        substring (entry ( l-ii , str1  , "chr(10)") , (( 220 * l-jj ) - 219 )  , 220 )  , num#str# , num#col# ) .      end.                                                                                                         end.
v-nn = num-entries ( str2 , "chr(10)"  ) .  do l-ii = 1 to v-nn :        l-len = length (entry( l-ii , str2  , "chr(10)")) .                       l-m = integer( l-len / 220 ) + 1 .                                                      do l-jj = 1 to  l-m  :                                                                      num#str# = num#str# + 1 .                                                               run macr_excel_char (                                                                        substring (entry ( l-ii , str2  , "chr(10)") , (( 220 * l-jj ) - 219 )  , 220 )  , num#str# , num#col# ) .      end.                                                                                                         end.
v-nn = num-entries ( str3 , "chr(10)"  ) .  do l-ii = 1 to v-nn :        l-len = length (entry( l-ii , str3  , "chr(10)")) .                       l-m = integer( l-len / 220 ) + 1 .                                                      do l-jj = 1 to  l-m  :                                                                      num#str# = num#str# + 1 .                                                               run macr_excel_char (                                                                        substring (entry ( l-ii , str3  , "chr(10)") , (( 220 * l-jj ) - 219 )  , 220 )  , num#str# , num#col# ) .      end.                                                                                                         end.
v-nn = num-entries ( str4 , "chr(10)"  ) .  do l-ii = 1 to v-nn :        l-len = length (entry( l-ii , str4  , "chr(10)")) .                       l-m = integer( l-len / 220 ) + 1 .                                                      do l-jj = 1 to  l-m  :                                                                      num#str# = num#str# + 1 .                                                               run macr_excel_char (                                                                        substring (entry ( l-ii , str4  , "chr(10)") , (( 220 * l-jj ) - 219 )  , 220 )  , num#str# , num#col# ) .      end.                                                                                                         end.
v-nn = num-entries ( reportheader , "chr(10)"  ) .  do l-ii = 1 to v-nn :        l-len = length (entry( l-ii , reportheader  , "chr(10)")) .                       l-m = integer( l-len / 220 ) + 1 .                                                      do l-jj = 1 to  l-m  :                                                                      num#str# = num#str# + 1 .                                                               run macr_excel_char (                                                                        substring (entry ( l-ii , reportheader  , "chr(10)") , (( 220 * l-jj ) - 219 )  , 220 )  , num#str# , num#col# ) .      end.                                                                                                         end.
  num#str# = num#str# + 1.
  num#col# = 1.
  run macr_excel_char (
       cur-time-print()  +
      ...
      for  each b_gds-obj  no-lock  where
        ...
        find first  b_gds-grp no-lock where b_gds-grp.node-code  = b_goods.grp-code  no-error .
          if available b_goods  and available b_gds-grp then do:
            n = n + 1 .                                                                      find first tmp-gds-tree where  tmp-gds-tree.node-code  = b_gds-grp.node-code no-error .               if not available tmp-gds-tree then do:                                                                create tmp-gds-tree.                                                                                  end.                                                                                                  assign                                                                                                tmp-gds-tree.id  = n                                                                                  tmp-gds-tree.f-name     = b_goods.grp-name                                                            tmp-gds-tree.node-code  = b_gds-grp.node-code                                                         tmp-gds-tree.lvl        = b_gds-grp.lvl-num                                                           tmp-gds-tree.upper-cod  = b_gds-grp.upper-code                                                        .                                                                                                                                                                                     assign                                                                                                gds-zap-artic      = b_goods.artic                                                                    gds-zap-prod-type  = b_goods.prod-type                                                                gds-zap-prod-code  = b_goods.prod-code                                                                gds-zap-type       = b_goods.gds-type                                                                 .                                                                                                     run foreach  in this-procedure .                                                                      do n-1 = 1 to 13 :                                                                             assign                                                                                                tmp-gds-tree.ie        [n-1]  = tmp-gds-tree.ie        [n-1]  + oborot-ie        [n-1]tmp-gds-tree.ee       [n-1]  = tmp-gds-tree.ee       [n-1]  + oborot-ee       [n-1]tmp-gds-tree.ep     [n-1]  = tmp-gds-tree.ep     [n-1]  + oborot-ep     [n-1]tmp-gds-tree.es    [n-1]  = tmp-gds-tree.es    [n-1]  + oborot-es    [n-1]tmp-gds-tree.re    [n-1]  = tmp-gds-tree.re    [n-1]  + oborot-re    [n-1]tmp-gds-tree.rs[n-1] = tmp-gds-tree.rs [n-1]  + oborot-rs[n-1]tmp-gds-tree.we[n-1]  = tmp-gds-tree.we[n-1]  + oborot-we[n-1]tmp-gds-tree.vt [n-1]  = tmp-gds-tree.vt [n-1]  + oborot-vt [n-1]tmp-gds-tree.iv  [n-1]  = tmp-gds-tree.iv  [n-1]  + oborot-iv  [n-1]tmp-gds-tree.ev  [n-1]  = tmp-gds-tree.ev  [n-1]  + oborot-ev  [n-1]tmp-gds-tree.rv  [n-1]  = tmp-gds-tree.rv  [n-1]  + oborot-rv  [n-1]tmp-gds-tree.em  [n-1]  = tmp-gds-tree.em  [n-1]  + oborot-em  [n-1]tmp-gds-tree.wm  [n-1]  = tmp-gds-tree.wm  [n-1]  + oborot-wm  [n-1]tmp-gds-tree.im  [n-1]  = tmp-gds-tree.im  [n-1]  + oborot-im  [n-1]tmp-gds-tree.ot  [n-1]  = tmp-gds-tree.ot  [n-1]  + oborot-ot  [n-1]tmp-gds-tree.pc  [n-1]  = tmp-gds-tree.pc  [n-1]  + oborot-pc  [n-1]tmp-gds-tree.ap  [n-1]  = tmp-gds-tree.ap  [n-1]  + oborot-ap  [n-1]tmp-gds-tree.disc                           [n-1]  = tmp-gds-tree.disc                           [n-1]  + oborot-disc                           [n-1]   tmp-gds-tree.ostatok-start                  [n-1]  = tmp-gds-tree.ostatok-start                  [n-1]  + ostatok-start                         [n-1]   tmp-gds-tree.ostatok-end                    [n-1]  = tmp-gds-tree.ostatok-end                    [n-1]  + ostatok-end                           [n-1]   tmp-gds-tree.oborot-sum-sale                [n-1]  = tmp-gds-tree.oborot-sum-sale                [n-1]  + oborot-sum-sale                        [1]    tmp-gds-tree.oborot-sum-cost                [n-1]  = tmp-gds-tree.oborot-sum-cost               [n-1]  + oborot-sum-cost                        [1]    .              end.
          end.
      end.
   end.
assign
