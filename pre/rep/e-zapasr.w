...
PROCEDURE adm-disable :
    DISABLE RECT-5 RECT-6 Tog-obj SortType Classify ShowZero WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-5 RECT-6 Tog-obj SortType Classify ShowZero WITH FRAME F-Main.
...
DO:
    Assign Classify.
    if Classify <>  "no-classify":U then enable SumsOnly with frame F-Main .
    else  do:
      SumsOnly = FALSE .
...
END PROCEDURE.
PROCEDURE my-var :
assign frame F-Main SumsOnly ShowZero  Classify SortType Tog-obj.
