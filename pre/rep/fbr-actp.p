...
output stream out-stream to value( string( session:temp-directory +
    ...
    put stream Out-Stream
        ...
        skip(1) space(3)
            ...
            "Акт производства промежуточных ингредиентов"                                   at 3 + 10 + 40
    .
...
define input parameter p-is-base as logical      no-undo.
    ...
    put stream Out-Stream
        skip
            ...
            "|"                                                     at 3  + 5
            buf_temp_fbrrep-goods.gds-code     format "999999999"
            "|"                                                     at 3  + 15
            buf_temp_fbrrep-goods.artic        format "X(16)"
            "|"                                                     at 3  + 32
            buf_temp_fbrrep-goods.gds-name     format "X(48)"
            "|"                                                     at 3  + 83
            buf_temp_fbrrep-goods.unit-base    format "X(4)"
            "|"                                                     at 3  + 88
