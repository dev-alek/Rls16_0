...
DEFINE NEW GLOBAL SHARED VAR adm-broker-hdl    AS HANDLE  NO-UNDO.
    ASSIGN adm-object-hdl = FRAME t-title:HANDLE.
RUN ensure-broker.
...
PROCEDURE adm-disable :
    DISABLE b-exit b-help Report-preview WITH FRAME t-title.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN b-exit b-help Report-preview WITH FRAME t-title.
...
PROCEDURE view-page :
  ...
  RUN broker-view-page IN adm-broker-hdl (INPUT THIS-PROCEDURE,
      INPUT p-page#).
  END PROCEDURE.
ON WINDOW-CLOSE OF FRAME t-title
DO:
  APPLY "END-ERROR":U TO SELF.
END.
define variable vss-include-info7 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
on help of frame t-title
do:
  run gbl/app_help.p
...
on choose of b-help in frame t-title
do:
  apply "help":u to frame t-title .
end.
...
procedure minbtn-set :
    do
        ...
        do
            ...
            :
            assign
                v-frame-width = frame t-title:width - 0.3
                fh            = frame t-title:first-child
                hh            = fh:first-child
                ii            = 1
                .
...
IF VALID-HANDLE(ACTIVE-WINDOW) AND FRAME t-title:PARENT eq ?
THEN FRAME t-title:PARENT = ACTIVE-WINDOW.
MAIN-BLOCK:
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ON END-KEY UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK:
  RUN dispatch IN THIS-PROCEDURE ('initialize':U).
  WAIT-FOR GO OF FRAME t-title.
END.
...
Report-preview = reportNAme + chr(10)
                ...
                + str4 + chr(10)
                + ReportHeader.
display Report-preview with frame t-title.
END PROCEDURE.
