...
def   shared  var F-sm        as   char  no-undo.
...
def   shared  var Sm                as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
...
def    shared  var B1-sm               as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
...
def    shared  var B2-sm               as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
...
def    shared  var Bi-sm               as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
...
def    shared  var o-sm               as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
...
def    shared  var p-sm               as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
 ...
 CASE CAPS ( p7) :
   WHEN "P":U  Then DO :
    ...
    if Make-Excel then  put   stream ForExcel unformatted p3 CHR(9)
                ...
                gds-zap-type CHR(9)
                p-Prih[1]  CHR(9)
if Showcost       then (     excel-sum(p-Prih [2]) + CHR(9)   ) else ("")
if Show-cost-vat  then (     excel-sum  (   p-Prih [3]) + CHR(9)   ) else ("")
if Showsale       then (     excel-sum  (   p-Prih [5]) + CHR(9)   ) else ("")
if Show-sale-vat  then (     excel-sum  (   p-Prih [6]) + CHR(9)   ) else ("")
                  p-RAsh         [1] FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
...
.
if Make-Excel then  put   stream ForExcel unformatted     p-Inv            [1] FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
...
if Show-sale-vat  then (     excel-sum  (   p-vzvr-post[6] ) + CHR(9)     ) else ("")
   ...
   WHEN "O":U  Then DO :
    ...
    if Make-Excel then  put   stream ForExcel unformatted p3 CHR(9)
                ...
                gds-zap-type CHR(9)
                o-Prih[1]  CHR(9)
if Showcost       then (     excel-sum(o-Prih [2]) + CHR(9)   ) else ("")
if Show-cost-vat  then (     excel-sum  (   o-Prih [3]) + CHR(9)   ) else ("")
if Showsale       then (     excel-sum  (   o-Prih [5]) + CHR(9)   ) else ("")
if Show-sale-vat  then (     excel-sum  (   o-Prih [6]) + CHR(9)   ) else ("")
                  o-RAsh         [1] FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
...
.
if Make-Excel then  put   stream ForExcel unformatted     o-Inv            [1] FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
...
if Show-sale-vat  then (     excel-sum  (   o-vzvr-post[6] ) + CHR(9)     ) else ("")
   ...
   WHEN "B1":U  Then DO :
    ...
    if Make-Excel then  put   stream ForExcel unformatted p3 CHR(9)
                ...
                gds-zap-type CHR(9)
                b1-Prih[1]  CHR(9)
if Showcost       then (     excel-sum(b1-Prih [2]) + CHR(9)   ) else ("")
if Show-cost-vat  then (     excel-sum  (   b1-Prih [3]) + CHR(9)   ) else ("")
if Showsale       then (     excel-sum  (   b1-Prih [5]) + CHR(9)   ) else ("")
if Show-sale-vat  then (     excel-sum  (   b1-Prih [6]) + CHR(9)   ) else ("")
                  b1-RAsh         [1] FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
...
.
if Make-Excel then  put   stream ForExcel unformatted     b1-Inv            [1] FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
...
if Show-sale-vat  then (     excel-sum  (   b1-vzvr-post[6] ) + CHR(9)     ) else ("")
   ...
   WHEN "B2":U  Then DO :
    ...
    if Make-Excel then  put   stream ForExcel unformatted p3 CHR(9)
                ...
                gds-zap-type CHR(9)
                b2-Prih[1]  CHR(9)
if Showcost       then (     excel-sum(b2-Prih [2]) + CHR(9)   ) else ("")
if Show-cost-vat  then (     excel-sum  (   b2-Prih [3]) + CHR(9)   ) else ("")
if Showsale       then (     excel-sum  (   b2-Prih [5]) + CHR(9)   ) else ("")
if Show-sale-vat  then (     excel-sum  (   b2-Prih [6]) + CHR(9)   ) else ("")
                  b2-RAsh         [1] FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
...
.
if Make-Excel then  put   stream ForExcel unformatted     b2-Inv            [1] FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
...
if Show-sale-vat  then (     excel-sum  (   b2-vzvr-post[6] ) + CHR(9)     ) else ("")
   ...
   WHEN "BI":U Then  DO :
    ...
    if Make-Excel then  put   stream ForExcel unformatted p3 CHR(9)
                ...
                gds-zap-type CHR(9)
                bi-Prih[1]  CHR(9)
if Showcost       then (     excel-sum(bi-Prih [2]) + CHR(9)   ) else ("")
if Show-cost-vat  then (     excel-sum  (   bi-Prih [3]) + CHR(9)   ) else ("")
if Showsale       then (     excel-sum  (   bi-Prih [5]) + CHR(9)   ) else ("")
if Show-sale-vat  then (     excel-sum  (   bi-Prih [6]) + CHR(9)   ) else ("")
                  bi-RAsh         [1] FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
...
.
if Make-Excel then  put   stream ForExcel unformatted     bi-Inv            [1] FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
...
if Show-sale-vat  then (     excel-sum  (   bi-vzvr-post[6] ) + CHR(9)     ) else ("")
   ...
   WHEN ""  Then     DO :
    ...
    if Make-Excel then  put   stream ForExcel unformatted p3 CHR(9)
                ...
                gds-zap-type CHR(9)
                Prih[1]  CHR(9)
if Showcost       then (     excel-sum(Prih [2]) + CHR(9)   ) else ("")
if Show-cost-vat  then (     excel-sum  (   Prih [3]) + CHR(9)   ) else ("")
if Showsale       then (     excel-sum  (   Prih [5]) + CHR(9)   ) else ("")
if Show-sale-vat  then (     excel-sum  (   Prih [6]) + CHR(9)   ) else ("")
                  RAsh         [1] FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
...
.
if Make-Excel then  put   stream ForExcel unformatted     Inv            [1] FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
...
define buffer buf_parts-attr for ub.parts-attr .
 ...
 if x-sum-type = 'sale':U   then tt# = 3.
 if x-sum-type = 'crsa':U   then tt# = 6.
     FOR each post-ot-line where
        ...
        and   post-ot-line.ext-doc-type  =  'ie':U
        no-lock :
     ...
     FOR each post-ot-line where
       ...
       first a-supp no-lock  where
            ...
            a-supp.cat-id       = x-cat-id      and
             (  a-supp.ext-doc-type = 'ie':U  or
                a-supp.ext-doc-type = 'vt':U        or
                a-supp.ext-doc-type = 'vp':U      )                 :
              if tt# = 0  then DO:  end.
              if tt# = 3  then DO:  end.
              if tt# = 6  then DO:  end.
