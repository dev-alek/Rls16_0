...
ON VALUE-CHANGED OF t-1 IN FRAME pri-lst
DO:
    run rep/r-gdslst.w (
                     input parparentproc
    ...
    apply "GO" to FRAME pri-lst.
END.
ON VALUE-CHANGED OF t-2 IN FRAME pri-lst
DO:
  CASE table-name :
  ...
  END CASE.
    apply "GO" to FRAME pri-lst.
END.
IF VALID-HANDLE(ACTIVE-WINDOW) AND FRAME pri-lst:PARENT eq ?
THEN FRAME pri-lst:PARENT = ACTIVE-WINDOW.
ON WINDOW-CLOSE OF FRAME pri-lst APPLY "END-ERROR":U TO SELF.
MAIN-BLOCK:
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ON END-KEY UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK:
define variable vss-include-info1 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
on help of frame pri-lst
do:
  run gbl/app_help.p
...
on choose of b-help in frame pri-lst
do:
  apply "help":u to frame pri-lst .
end.
...
procedure minbtn-set :
    do
        ...
        do
            ...
            :
            assign
                v-frame-width = frame pri-lst:width - 0.3
                fh            = frame pri-lst:first-child
                hh            = fh:first-child
                ii            = 1
                .
