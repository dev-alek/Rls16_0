...
do cycle = 1 to 0 by -1:
  ...
  then  C-sym2:screen-value = string(sym2, entry(1, c-sym2:private-data, chr(4))).
  if use-column[4]
  then  C-num-chk1:screen-value = string((if available grp-h then grp-h.num-chk[1] else 0), entry(1, c-num-chk1:private-data, chr(4))).
  if use-column[5]
  then  C-num-chk2:screen-value = string((if available grp-h then grp-h.num-chk[2] else 0), entry(1, c-num-chk2:private-data, chr(4))).
  if use-column[6]
  then  C-num-chk3:screen-value = string((if available grp-h then grp-h.num-chk[3] else 0), entry(1, c-num-chk3:private-data, chr(4))).
  if use-column[7]
  then  C-num-chk4:screen-value = string((if available grp-h then grp-h.num-chk[4] else 0), entry(1, c-num-chk4:private-data, chr(4))).
  if use-column[8]
  then  C-num-chk5:screen-value = string((if available grp-h then grp-h.num-chk[5] else 0), entry(1, c-num-chk5:private-data, chr(4))).
  if use-column[9]
  then  C-num-chk6:screen-value = string((if available grp-h then grp-h.num-chk[6] else 0), entry(1, c-num-chk6:private-data, chr(4))).
  if use-column[10]
  then  C-num-chk7:screen-value = string((if available grp-h then grp-h.num-chk[7] else 0), entry(1, c-num-chk7:private-data, chr(4))).
  if use-column[11]
  then  C-num-chk8:screen-value = string((if available grp-h then grp-h.num-chk[8] else 0), entry(1, c-num-chk8:private-data, chr(4))).
  if use-column[12]
  then  C-num-chk9:screen-value = string((if available grp-h then grp-h.num-chk[9] else 0), entry(1, c-num-chk9:private-data, chr(4))).
  if use-column[13]
  then  C-num-chk10:screen-value = string((if available grp-h then grp-h.num-chk[10] else 0), entry(1, c-num-chk10:private-data, chr(4))).
  if use-column[14]
  then  C-num-chk11:screen-value = string((if available grp-h then grp-h.num-chk[11] else 0), entry(1, c-num-chk11:private-data, chr(4))).
  if use-column[15]
  then  C-num-chk12:screen-value = string((if available grp-h then grp-h.num-chk[12] else 0), entry(1, c-num-chk12:private-data, chr(4))).
  if use-column[16]
  then  C-num-chk13:screen-value = string((if available grp-h then grp-h.num-chk[13] else 0), entry(1, c-num-chk13:private-data, chr(4))).
  if use-column[17]
  then  C-num-chk14:screen-value = string((if available grp-h then grp-h.num-chk[14] else 0), entry(1, c-num-chk14:private-data, chr(4))).
  if use-column[18]
  then  C-num-chk15:screen-value = string((if available grp-h then grp-h.num-chk[15] else 0), entry(1, c-num-chk15:private-data, chr(4))).
  if use-column[19]
  then  C-num-chk16:screen-value = string((if available grp-h then grp-h.num-chk[16] else 0), entry(1, c-num-chk16:private-data, chr(4))).
  if use-column[20]
  then  C-num-chk17:screen-value = string((if available grp-h then grp-h.num-chk[17] else 0), entry(1, c-num-chk17:private-data, chr(4))).
  if use-column[21]
  then  C-num-chk18:screen-value = string((if available grp-h then grp-h.num-chk[18] else 0), entry(1, c-num-chk18:private-data, chr(4))).
  if use-column[22]
  then  C-num-chk19:screen-value = string((if available grp-h then grp-h.num-chk[19] else 0), entry(1, c-num-chk19:private-data, chr(4))).
  if use-column[23]
  then  C-num-chk20:screen-value = string((if available grp-h then grp-h.num-chk[20] else 0), entry(1, c-num-chk20:private-data, chr(4))).
  if use-column[24]
  then  C-num-chk21:screen-value = string((if available grp-h then grp-h.num-chk[21] else 0), entry(1, c-num-chk21:private-data, chr(4))).
  if use-column[25]
  then  C-num-chk22:screen-value = string((if available grp-h then grp-h.num-chk[22] else 0), entry(1, c-num-chk22:private-data, chr(4))).
  if use-column[26]
  then  C-num-chk23:screen-value = string((if available grp-h then grp-h.num-chk[23] else 0), entry(1, c-num-chk23:private-data, chr(4))).
  if use-column[27]
  then  C-num-chk24:screen-value = string((if available grp-h then grp-h.num-chk[24] else 0), entry(1, c-num-chk24:private-data, chr(4))).
  if use-column[28]
  then  C-tot-nc:screen-value = string((if available grp-h then tot-nc else 0), entry(1, c-tot-nc:private-data, chr(4))).
  if use-column[29]
