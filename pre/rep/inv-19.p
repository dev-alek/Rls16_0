...
:
    ...
    assign
        ...
        buf_temp_sheet1_line-data.sheet-name    = "ИНВ19":U
    ...
    then
      put stream excel-line unformatted
          ...
          chr(9)   "DTA":U
          chr(9)   string( buf_temp_sheet1_line-data.num          )
          chr(9)   string( buf_temp_sheet1_line-data.gdsname      )
          chr(9)   string( buf_temp_sheet1_line-data.gdscode      )
          chr(9)   string( buf_temp_sheet1_line-data.OKEI         )
          chr(9)   string( buf_temp_sheet1_line-data.EI           )
          chr(9)   string( buf_temp_sheet1_line-data.OKDP         )
          chr(9)   string( buf_temp_sheet1_line-data.rezIzlQnty   )
          chr(9)   string( buf_temp_sheet1_line-data.rezIzlSum    )
          chr(9)   string( buf_temp_sheet1_line-data.rezNedQnty   )
          chr(9)   string( buf_temp_sheet1_line-data.rezNedSum    )
          chr(9)   string( buf_temp_sheet1_line-data.num2         )
          chr(9)   string( buf_temp_sheet1_line-data.utochIzlQnty )
          chr(9)   string( buf_temp_sheet1_line-data.utochIzlSum  )
          chr(9)   string( buf_temp_sheet1_line-data.utochNedQnty )
          chr(9)   string( buf_temp_sheet1_line-data.utochNedSum  )
          chr(9)   string( buf_temp_sheet1_line-data.peresIzlQnty )
          chr(9)   string( buf_temp_sheet1_line-data.peresIzlSum  )
          chr(9)   string( buf_temp_sheet1_line-data.peresNedQnty )
          chr(9)   string( buf_temp_sheet1_line-data.peresNedSum  )
          chr(9)   string( buf_temp_sheet1_line-data.endIzlQnty   )
          chr(9)   string( buf_temp_sheet1_line-data.endIzlSum    )
          chr(9)   string( buf_temp_sheet1_line-data.endNedQnty1  )
          chr(9)   string( buf_temp_sheet1_line-data.endNedSum1   )
          chr(9)   string( buf_temp_sheet1_line-data.endNedQnty2  )
          chr(9)   string( buf_temp_sheet1_line-data.endNedSum2   )
          chr(9)   string( buf_temp_sheet1_line-data.endNedQnty3  )
          chr(9)   string( buf_temp_sheet1_line-data.endNedSum3   )
          chr(10)
      .
    else
    put stream excel-line unformatted
...
define variable vss-include-info16 as character format "x(65)" no-undo initial "@(#)$Workfile:currsysk.i $ $Revision: $".
...
output stream out-stream to value( string( session:temp-directory +
    ...
    run inv19xl-write-cell-data in this-procedure ( input "organization":U  , input v-torgconf-self-host-name                             ).
    run inv19xl-write-cell-data in this-procedure ( input "organization":U  , input v-torgconf-self-host-name                             ).
    run inv19xl-write-cell-data in this-procedure ( input "object":U        , input v-obj-str                                             ).
    if lookup( 'L-Rus' , v-sys-key) = 0
    then do:
      run inv19xl-write-cell-data in this-procedure ( input "docinvcode":U    , input buf_trn-doc.doc-code                                  ).
      run inv19xl-write-cell-data in this-procedure ( input "docdate":U       , input string( buf_trn-doc.doc-date , "99/99/9999" )         ).
      run inv19xl-write-cell-data in this-procedure ( input "startdate":U     , input string( buf_trn-doc.doc-date , "99/99/9999" )         ).
      run inv19xl-write-cell-data in this-procedure ( input "enddate":U       , input string( buf_trn-doc.fact-date, "99/99/9999" )         ).
    end.
    run inv19xl-write-cell-data in this-procedure ( input "doccode":U       , input buf_trn-doc.doc-code                                  ).
    run inv19xl-write-cell-data in this-procedure ( input "factdate":U      , input string( buf_trn-doc.fact-date, "99/99/9999" )         ).
    ...
    run inv19xl-write-cell-data in this-procedure ( input "ИНВ19_it_rezIzlSum":U    , input string( v-tot-izl-sum  ) ).
    run inv19xl-write-cell-data in this-procedure ( input "ИНВ19_it_rezNedSum":U    , input string( v-tot-ned-sum  ) ).
    run inv19xl-write-cell-data in this-procedure ( input "ИНВ19_it_rezIzlQnty":U   , input string( v-tot-izl-Qnty ) ).
    run inv19xl-write-cell-data in this-procedure ( input "ИНВ19_it_rezNedQnty":U   , input string( v-tot-ned-Qnty ) ).
    if lookup( 'L-Rus' , v-sys-key) > 0
    then do:
      run inv19xl-write-cell-data in this-procedure ( input "ИНВ19_it_utochIzlSum":U  , input string( 0                  ) ).
      run inv19xl-write-cell-data in this-procedure ( input "ИНВ19_it_utochNedSum":U  , input string( 0                  ) ).
      run inv19xl-write-cell-data in this-procedure ( input "ИНВ19_it_peresIzlSum":U  , input string( v-tot-per-izl-sum  ) ).
      run inv19xl-write-cell-data in this-procedure ( input "ИНВ19_it_peresNedSum":U  , input string( v-tot-per-ned-sum  ) ).
      run inv19xl-write-cell-data in this-procedure ( input "ИНВ19_it_endIzlSum":U    , input string( v-tot-izl-sum      ) ).
      run inv19xl-write-cell-data in this-procedure ( input "ИНВ19_it_endNedSum1":U   , input string( v-tot-ned-sum      ) ).
      run inv19xl-write-cell-data in this-procedure ( input "ИНВ19_it_endNedSum2":U   , input string( 0                  ) ).
      run inv19xl-write-cell-data in this-procedure ( input "ИНВ19_it_endNedSum3":U   , input string( 0                  ) ).
      run inv19xl-write-cell-data in this-procedure ( input "ИНВ19_it_utochIzlQnty":U , input string( 0                  ) ).
      run inv19xl-write-cell-data in this-procedure ( input "ИНВ19_it_utochNedQnty":U , input string( 0                  ) ).
      run inv19xl-write-cell-data in this-procedure ( input "ИНВ19_it_peresIzlQnty":U , input string( v-tot-per-izl-Qnty ) ).
      run inv19xl-write-cell-data in this-procedure ( input "ИНВ19_it_peresNedQnty":U , input string( v-tot-per-ned-Qnty ) ).
      run inv19xl-write-cell-data in this-procedure ( input "ИНВ19_it_endIzlQnty":U   , input string( v-tot-izl-Qnty     ) ).
      run inv19xl-write-cell-data in this-procedure ( input "ИНВ19_it_endNedQnty1":U  , input string( v-tot-ned-Qnty     ) ).
      run inv19xl-write-cell-data in this-procedure ( input "ИНВ19_it_endNedQnty2":U  , input string( 0                  ) ).
      run inv19xl-write-cell-data in this-procedure ( input "ИНВ19_it_endNedQnty3":U  , input string( 0                  ) ).
    end.
...
:
    ...
    find first buf_doc-line-sum no-lock
         where buf_doc-line-sum.doc-code = buf_doc-line.doc-code
           ...
           and buf_doc-line-sum.sum-type = 'gen':U
    no-error.
    ...
    then do:
      run inv19xl-sheet1-write-line-data in this-procedure (
            input string( v-inv19-line-counter    )
          , input v-gds-name
          , input string( buf_goods.gds-code      )
          , input string( buf_units.OKEI          )
          , input string( buf_goods.unit-base     )
          , input string( buf_goods.OKDP          )
          , input string( p-izl-qnty              )
          , input string( p-izl-sum               )
          , input string( p-ned-qnty              )
          , input string( p-ned-sum               )
          , input string( v-inv19-line-counter    )
          , input "":U
          , input "":U
          , input "":U
          , input "":U
          , input string( p-per-izl-qnty           )
          , input string( p-per-izl-sum            )
          , input string( p-per-ned-qnty           )
          , input string( p-per-ned-sum            )
          , input string( p-izl-qnty               )
          , input string( p-izl-sum                )
          , input string( p-ned-qnty               )
          , input string( p-ned-sum                )
      ...
      run inv19xl-sheet1-write-line-data in this-procedure (
          ...
          , input string( buf_goods.unit-base     )
          , input string( buf_goods.OKDP          )
          , input trim(string( p-izl-qnty , '->>>,>>>,>>>,>>9.999' ))
          , input string( p-izl-sum               )
          , input trim(string( p-ned-qnty , '->>>,>>>,>>>,>>9.999' ))
          , input string( p-ned-sum               )
          , input string( v-inv19-line-counter    )
          , input "":U
          , input "":U
