...
define variable vss-workfile    as character no-undo init "$Workfile: r-abcgds.p $":U .
define variable vss-archive     as character no-undo init "$Archive: rep/r-abcgds.p $":U .
...
run macr_excel_char ( temp-str.grp-code  , num#str# , num#col#   ) . assign    num#col# = num#col# + 1 .
...
procedure PrintTitul :
  ...
  define variable tt as integer no-undo .
    ...
    num#col# = 4.
    run macr_excel_char ( "Код группы"   , num#str# , num#col#   ) .
    run macr_cell_size ( 10 , ? , num#str# , num#col# , ?, ? ) .
    num#col# = 5.
