...
assign frame Dialog-Frame  date-1 date-2 tog-inv .
...
ReportNAme = "О Т Ч Е Т   О   С О С Т О Я Н И И   З А П А С А   И   П Р О Д А Ж А Х   ( по одному товару)".
 ReportHeader = ReportHeader  + chr(10) + goods1.gds-name .
 Assign
  x-SET_val_TYPE = 1
  x-Date-Start = date-1
  x-Date-end   = date-2   .
...
do:
  ...
  then do:
    ASSIGN
      date-1 :POPUP-MENU in frame Dialog-Frame = MENU m-ed-date15 :HANDLE
      date-1 :MENU-MOUSE in frame Dialog-Frame = 3
    .
  end.
  define variable v-label-handle15 as handle no-undo .
  assign
    v-label-handle15 = date-1 :side-label-handle in frame Dialog-Frame
  .
...
do:
  ...
  then do:
    ASSIGN
      date-2 :POPUP-MENU in frame Dialog-Frame = MENU m-ed-date17 :HANDLE
      date-2 :MENU-MOUSE in frame Dialog-Frame = 3
    .
  end.
  define variable v-label-handle17 as handle no-undo .
  assign
    v-label-handle17 = date-2 :side-label-handle in frame Dialog-Frame
  .
