...
run adm/shattri.p (
    ...
    :
      ...
      :
        ...
        assign
          ...
          gds-cell.doc-date  = ( if bf_trn-doc.status_ = 'факт':U then bf_trn-doc.fact-date else bf_trn-doc.doc-date )
  ...
  assign v-autoent-obj-code-dec = decimal( v-autoent-obj-code ) no-error.
  if error-status :error then do:
    message vss-workfile skip( 0 ) vss-date skip( 0 ) vss-revision skip( 1 ) vss-description skip( 1 )
            'Ошибка преобразования параметра "autoent-obj-code" в число.'
    view-as alert-box error.
  end.
        assign
    ...
    :
      ...
      assign
        jj               = jj + 1
        ext-column-label = ext-column-label + chr(44) + replace( gds-ptrl.gds-name, chr(44), chr(32) )
        SheetF.ColFormat = SheetF.ColFormat + ";" +
    ...
    :
      ...
      then do:
        ...
        if Make-Excel then  put   stream ForExcel unformatted
          string(         gds-cell.doc-date,     "99.99.9999":U ) CHR(9)
          string(         gds-cell.doc-code,     "x(14)":U      ) CHR(9)
          string(         gds-cell.supp-name,    "x(30)":U      ) CHR(9)
          string(         gds-cell.auto-name,    "x(30)":U      ) CHR(9)
          fill(           " ":U,                    12          ) CHR(9)
          string( OutQty( gds-cell.total-qnty ), "x(12)":U      ) CHR(9)
        .
        do jj = 1 to j_columns-total :
          ...
          if available bf_gds-cell then do:
            ...
            .
            if Make-Excel then  put   stream ForExcel unformatted
              string( OutQty( bf_gds-cell.qnty  ), "x(12)":U ) CHR(9)
              string( OutSum( bf_gds-cell.price ), "x(12)":U ) CHR(9)
            .
          end.
          else do:
            put stream text_out unformatted
      ...
      if last-of( gds-cell.doc-code ) then do:
        do jj = 1 to j_columns-total :
          ...
          if available bf_gds-cell then do:
            ...
            .
            if Make-Excel then  put   stream ForExcel unformatted
              string( OutSum( d_summa ), "x(12)":U ) CHR(9)
            .
          end.
          else do:
            put stream text_out unformatted
    ...
    then do:
      ...
      .
      if Make-Excel then  put   stream ForExcel unformatted
        string( "Итого:    ":U,             "x(10)":U ) CHR(9)
        string( "":U,                       "x(14)":U ) CHR(9)
        string( "":U,                       "x(30)":U ) CHR(9)
        string( "":U,                       "x(30)":U ) CHR(9)
        string( "":U,                       "x(12)":U ) CHR(9)
        string( OutQty( d_total-doc-qnty ), "x(12)":U ) CHR(9)
      .
      assign
        d_total-doc-qnty = 0.00
      .
      ...
      :
        do jj = 1 to j_columns-total :
          ...
          then do:
            ...
            .
            if Make-Excel then  put   stream ForExcel unformatted
              string( OutQty( gds-total.total-qnty ), "x(12)":U ) CHR(9)
              string( "":U,                           "x(12)":U ) CHR(9)
            .
          end.
        end.
      ...
      :
        do jj = 1 to j_columns-total :
          ...
          then do:
            ...
            .
            if Make-Excel then  put   stream ForExcel unformatted
              string( OutSum( gds-total.total-sum  ), "x(12)":U ) CHR(9)
            .
          end.
        end.
      end.
      ...
      then do:
        ...
        :
          ...
          if Make-Excel then  put   stream ForExcel unformatted
            ...
            string(         gds-cell.doc-code,  "x(14)":U      ) CHR(9)
            string(         gds-cell.supp-name, "x(30)":U      ) CHR(9)
            string( OutQty( gds-cell.qnty  ),   "x(12)":U      ) CHR(9)
            string( OutSum( gds-cell.price ),   "x(12)":U      ) CHR(9)
            string( OutSum( d_summa ),          "x(12)":U      )
            skip
          .
          assign
        ...
        if Make-Excel then  put   stream ForExcel unformatted
          ...
          string( "":U,                   "x(14)":U ) CHR(9)
          string( "":U,                   "x(30)":U ) CHR(9)
          string( OutQty( d_total-qnty ), "x(12)":U ) CHR(9)
          string( "":U,                   "x(12)":U ) CHR(9)
          string( OutSum( d_total-sum  ), "x(12)":U )
          skip
        .
