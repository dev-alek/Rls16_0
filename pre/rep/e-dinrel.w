...
PROCEDURE adm-disable :
    DISABLE RECT-13 RECT-12 RECT-14 RECT-11 RECT-7 RECT-8 RECT-6 SortType Classify num-col sum-only null-obort TOGGLE-1 WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-13 RECT-12 RECT-14 RECT-11 RECT-7 RECT-8 RECT-6 SortType Classify num-col sum-only null-obort TOGGLE-1 WITH FRAME F-Main.
...
display num-col WITH FRAME F-Main.
...
END PROCEDURE.
PROCEDURE my-var :
  Assign frame F-Main  SortType Classify sum-only num-col null-obort TOGGLE-1 .
  Assign
    STR-obj-type = ''
    STR-obj-code = ''
    STR-obj-name = ''
