...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run gdsbcode in g#library
  ...
  PUT stream Out-Stream Line  FORMAT "X(165)"  skip  .
...
procedure print-grp :
  do  on error undo, return error return-value  :
    ...
    PUT stream Out-Stream UNFORMATTED String("_______________Группа : " + TRIM(CAPS(temp-str.grp-name)) + Line)  FORMAT "X(165)"  skip  .
  end.
end procedure.
procedure print-prod :
  do  on error undo, return error return-value  :
    ...
    .
    DOWN stream Out-Stream 1 with FRAME invent .
    PUT stream Out-Stream UNFORMATTED String("________Производитель : " + TRIM(CAPS(buf_clients.obj-name)) + Line)  FORMAT "X(165)"  skip  .
  end.
end procedure.
procedure print-line :
  ...
  DOWN stream Out-Stream 1 with FRAME invent .
  if print-graft = false THEN  Put stream Out-Stream Line format "X(165)" SKIP.
  end.
end procedure.
