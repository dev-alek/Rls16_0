...
IF NOT THIS-PROCEDURE:PERSISTENT THEN DO:
  MESSAGE "c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\rep\e-chk_anul.w should only be RUN PERSISTENT.":U
...
PROCEDURE adm-disable :
    DISABLE T-cash WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN T-cash WITH FRAME F-Main.
...
ON VALUE-CHANGED OF T-cash IN FRAME F-Main
DO:
  assign T-cash .
END.
