...
define variable vss-description as character no-undo init "ќборотна€ ведомость по товарам с учетом признаков".
...
input parParentProc ,
input 'rep/e-o-prt.w',
input "ќборотна€ ведомость по товарам с учетом признаков",
input 2,
input "4,5,7":U,
input "*":U,
input "",
