...
PROCEDURE adm-disable :
    DISABLE RECT-5 RECT-6 FILL-IN-1 NullStr WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-5 RECT-6 FILL-IN-1 NullStr WITH FRAME F-Main.
...
then do:
  ...
  assign FILL-IN-1 :screen-value in frame F-Main = string(TODAY,"99/99/9999") .
