...
define variable vss-description as character no-undo initial "—ÏÂÌÌ˚È ÓÚ˜ÂÚ (œÒÍÓ‚ÌÂÙÚÂÔÓ‰ÛÍÚ)":U .
...
custom-par = "all,2,8,3,1" + chr(44) + "TOG-Shift-2 = yes" + chr(44) + custom-par + chr(44) + "CALL='new-rep'" .
run rep/d-report.w (
                input parparentproc ,
                input 'rep/e-shift.w',
                " —Ã≈ÕÕ€… Œ“◊≈“ ",
