...
PROCEDURE adm-disable :
    DISABLE RECT-6 IMAGE-1 IMAGE-2 f-name f-dostavka SortType f-orderinfo f-action btn-grp EDITOR-grp f-skidki f-skidki-2 f-skidki-3 t-minpart T-ost f-skidki-4 v-colsize f-skidki-5 f-skidki-6 f-telefon-1 f-skidki-7 f-telefon-2 f-skidki-8 f-hot f-info WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-6 IMAGE-1 IMAGE-2 f-name f-dostavka SortType f-orderinfo f-action btn-grp EDITOR-grp f-skidki f-skidki-2 f-skidki-3 t-minpart T-ost f-skidki-4 v-colsize f-skidki-5 f-skidki-6 f-telefon-1 f-skidki-7 f-telefon-2 f-skidki-8 f-hot f-info WITH FRAME F-Main.
...
DO:
  ...
  for first buf_buyer-group where recid(buf_buyer-group) = int(s-ref-rec):
    ...
    assign
      EDITOR-grp = EDITOR-grp + buf_buyer-group.name + chr(10).
    .
  end.
  display
    EDITOR-grp
...
define variable v-list    as character    no-undo.
 ...
 if num-entries(v-list, chr(4))  >= 10  then do:
   assign
     f-name        = entry(1,v-list, chr(4))
     f-dostavka    = entry(2,v-list, chr(4))
     f-telefon-1   = entry(3,v-list, chr(4))
     f-telefon-2   = entry(4,v-list, chr(4))
     f-info        = entry(5,v-list, chr(4))
     f-orderinfo   = entry(6,v-list, chr(4))
     f-action      = entry(7,v-list, chr(4))
     f-skidki      = entry(8,v-list, chr(4))
     f-skidki-2    = entry(9,v-list, chr(4))
     f-skidki-3    = entry(10,v-list, chr(4))
     f-skidki-4    = entry(11,v-list, chr(4))
     f-skidki-5    = entry(12,v-list, chr(4))
     f-skidki-6    = entry(13,v-list, chr(4))
     f-skidki-7    = entry(14,v-list, chr(4))
     f-skidki-8    = entry(15,v-list, chr(4))
     v-colsize     = integer(entry(16,v-list, chr(4)))
     f-hot         = entry(17,v-list, chr(4))
   .
    assign
    t-minpart = logical(entry(18,v-list, chr(4)))
    T-ost = logical(entry(19,v-list, chr(4)))
    s-ref-rec = entry(20,v-list, chr(4))
    no-error.
    for first buf_buyer-group where recid (buf_buyer-group) = int(s-ref-rec):
...
define variable v-list    as character    no-undo.
 v-List =
    ...
    f-skidki-7  + chr(4) +
    f-skidki-8  + chr(4) +
    string(v-colsize) + chr(4) +
    f-hot + chr(4) +
    string(t-minpart) + chr(4) +
    string(t-ost) + chr(4) +
    s-ref-rec.
