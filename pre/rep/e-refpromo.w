...
PROCEDURE adm-disable :
    DISABLE rect-3 rect-4 RADIO-SET-1 RADIO-SET-2 editor-promo WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN rect-3 rect-4 RADIO-SET-1 RADIO-SET-2 editor-promo WITH FRAME F-Main.
    ...
    CASE RADIO-SET-1:
      ...
      THEN
        DO:
          ...
          apply "choose" to r-gop-1 in frame F-Main.
        END.
      WHEN 1 THEN
        DO:
          EDITOR-promo = "Все":U.
