...
PROCEDURE adm-disable :
    DISABLE RECT-8 RECT-9 RECT-5 RECT-7 RECT-6 PostName RADPost SortType Tog-obj type-stor Classify SumsOnly ShowZero WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-8 RECT-9 RECT-5 RECT-7 RECT-6 PostName RADPost SortType Tog-obj type-stor Classify SumsOnly ShowZero WITH FRAME F-Main.
...
END PROCEDURE.
PROCEDURE my-var :
assign frame F-Main PostName  RADPost type-stor ShowZero Classify
...
ReportHeader = ReportHeader  + chr(10) +
               ...
               "Цены указаны в " + (if x-SET_val_TYPE = 1 then "РУБ" else base-type )
 .
