...
PROCEDURE adm-disable :
    DISABLE im em wm ie ep ee es iv re rs we ev rv WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN im em wm ie ep ee es iv re rs we ev rv WITH FRAME F-Main.
...
PROCEDURE calc-rest :
assign FRAME F-Main im em wm ie ep ee es iv re rs we ev rv vt ot ap pc    .
END PROCEDURE.
