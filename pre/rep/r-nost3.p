...
End.
 ...
 For Each ub.ot-line where
          ...
          accumulate ub.ot-line.sum-rubl    (TOTAL BY ub.ot-line.sum-type ).
          accumulate ub.ot-line.vat-rubl   (TOTAL BY ub.ot-line.sum-type ).
          accumulate ub.ot-line.slt-rubl   (TOTAL BY ub.ot-line.sum-type ).
          accumulate ub.ot-line.other-rubl (TOTAL BY ub.ot-line.sum-type ).
          if last-of(ub.ot-line.sum-type) then DO :
          Case  ub.ot-line.sum-type :
              when 'cost':U then do:
                f-cost-sum = accum TOTAL BY ub.ot-line.sum-type ub.ot-line.sum-rubl .
                f-cost-vat = accum TOTAL BY ub.ot-line.sum-type ub.ot-line.vat-rubl .
              end.
              when 'sale':U then do:
                 f-sale-sum = accum TOTAL BY ub.ot-line.sum-type ub.ot-line.sum-rubl .
                 f-sale-other = accum TOTAL BY ub.ot-line.sum-type ub.ot-line.other-rubl .
                 f-sale-vat = accum TOTAL BY ub.ot-line.sum-type ub.ot-line.vat-rubl .
                 f-sale-slt = accum TOTAL BY ub.ot-line.sum-type ub.ot-line.slt-rubl .
              end.
              when  'crsa':U then do:
                f-crsa-sum1 = accum TOTAL BY ub.ot-line.sum-type ub.ot-line.sum-rubl .
              ...
              when 'cgsr':U then do:
                f-crsa-sum2 = accum TOTAL BY ub.ot-line.sum-type ub.ot-line.sum-rubl .
...
End.
 ...
 For Each ub.ot-line where
          ...
          , First gds-list where  ub.ot-line.prod-type = gds-list.prod-type and
            ...
            accumulate ub.ot-line.sum-rubl       (TOTAL by  ub.ot-line.artic ) .
            accumulate ub.ot-line.vat-rubl       (TOTAL by  ub.ot-line.artic ) .
            accumulate ub.ot-line.slt-rubl       (TOTAL by  ub.ot-line.artic ) .
            accumulate ub.ot-line.other-rubl     (TOTAL by  ub.ot-line.artic ) .
...
End.
   if v-button-stop then  DO:
         ...
         End.
               ...
               f-cost-sum   = accum  TOTAL by  ub.ot-line.artic ub.ot-line.sum-rubl   .
               f-cost-vat   = accum  TOTAL by  ub.ot-line.artic ub.ot-line.vat-rubl   .
                f-crsa-sum = 0.
                For each crsa-ot-line where
                    ...
                    no-lock :
                  f-crsa-sum   = f-crsa-sum + crsa-ot-line.sum-rubl   .
                End.
                f-sale-sum   = 0 .
                f-sale-vat   = 0 .
                f-sale-slt   = 0 .
                ...
                For each alt-ot-line where
                    ...
                    no-lock :
                      f-sale-sum   = f-sale-sum    + alt-ot-line.sum-rubl   .
                      f-sale-vat   = f-sale-vat    + alt-ot-line.vat-rubl   .
                      f-sale-slt   = f-sale-slt    + alt-ot-line.slt-rubl   .
                      f-sale-other = f-sale-other  + alt-ot-line.other-rubl .
                    End.
                f-cost-sum-novat = f-cost-sum - f-cost-vat .
                f-disc = f-sale-sum - f-sale-vat - f-sale-slt - f-cost-sum-novat.
                f-disc-prc = (f-disc / f-cost-sum-novat * 100)  .
   ...
   if v-button-stop then  DO:
         ...
         End.
                ...
                find first goods where  ub.ot-line.prod-type = goods.prod-type and
                                        ...
                                        ub.ot-line.artic     = goods.artic no-lock no-error .
               f-qnty       = accum  TOTAL by  ub.ot-line.artic ub.ot-line.fact-qnty  .
               f-sale-sum   = accum  TOTAL by  ub.ot-line.artic ub.ot-line.sum-rubl   .
               f-sale-vat   = accum  TOTAL by  ub.ot-line.artic ub.ot-line.vat-rubl   .
               f-sale-slt   = accum  TOTAL by  ub.ot-line.artic ub.ot-line.slt-rubl   .
               f-sale-other = accum  TOTAL by  ub.ot-line.artic ub.ot-line.other-rubl .
                f-crsa-sum = 0.
                For each crsa-ot-line where
                    crsa-ot-line.fact-order >= fact-order-1 and
                    crsa-ot-line.fact-order <= fact-order-2 and
                ...
                For each alt-ot-line where
                    ...
                    no-lock ,
                       ...
                       first wt where wt.doc-code = alt-ot-line.doc-code
                    no-lock :
                      f-cost-sum   = f-cost-sum + alt-ot-line.sum-rubl   .
                      f-cost-vat   = f-cost-vat + alt-ot-line.vat-rubl   .
                    End.
                f-cost-sum-novat = f-cost-sum - f-cost-vat .
                f-disc = f-sale-sum - f-sale-vat - f-sale-slt - f-cost-sum-novat.
                f-disc-prc = (f-disc / f-cost-sum-novat * 100)  .
