...
PROCEDURE adm-disable :
    DISABLE RECT-6 RECT-5 RECT-8 RECT-7 BUTTON-post cod-post Postname SortType BUTTON-cont cont-num  Classify Cli-art WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-6 RECT-5 RECT-8 RECT-7 BUTTON-post cod-post Postname SortType BUTTON-cont cont-num  Classify Cli-art WITH FRAME F-Main.
...
ON CHOOSE OF BUTTON-cont IN FRAME F-Main
DO:
...
END.
ON CHOOSE OF BUTTON-post IN FRAME F-Main
DO:
...
ReportHeader = "Поставщик: " + NamePost + chr(10).
ReportHeader = ReportHeader + "Классификация : " + t-Class.
ReportHeader = ReportHeader  + chr(10).
ReportHeader = ReportHeader + "Сортировка " + t-Sort + chr(10).
ReportHeader = ReportHeader  + chr(10).
ReportHeader = ReportHeader + "Отчет сформирован : " + string(today) + chr(10).
ReportHeader = ReportHeader  + chr(10).
END PROCEDURE.
