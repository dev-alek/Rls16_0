            ...
            WHEN yes then do:
                    FOR EACH ub.trn-doc WHERE ub.trn-doc.obj-type = obj-list.obj-type AND
                           ...
                           IF Period-type = 4 AND
                            ...
                            IF NOT (trn-doc.doc-type = 'рас':U OR
                                         trn-doc.doc-type = 'спи':U) THEN  NEXT.
                            if trn-doc.ext-doc-type =  'es':U or
                            trn-doc.office
                            then NEXT.
                            if trn-doc.ext-doc-type =  'ep':U then dt = 'возврат пост.':U.
                            else dt = "".
...
if NOT can-find(first tops) then do:
    message "Не было расхода топлива на выбранных объектах в течение заданного Вами периода времени."
    view-as alert-box.
