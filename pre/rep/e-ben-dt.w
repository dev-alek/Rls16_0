...
PROCEDURE adm-disable :
    DISABLE RECT-5 RECT-9 RECT-6 SortType1 Classify month-3 month-4 DetalWeek month-1 month-2 week-1 week-12 week-2 week-22 week-3 week-32 week-4 week-42 week-5 week-52 BUTTON-1 WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-5 RECT-9 RECT-6 SortType1 Classify month-3 month-4 DetalWeek month-1 month-2 week-1 week-12 week-2 week-22 week-3 week-32 week-4 week-42 week-5 week-52 BUTTON-1 WITH FRAME F-Main.
...
DO:
   ...
   if Classify = "grp-goods":U
         Then do:
            display Itog   with frame F-Main .
            enable  Itog   with frame F-Main .
        end.
         Else do:
            Itog = false.
            display  Itog  with frame F-Main .
            disable  Itog  with frame F-Main .
        end.
END.
...
Assign DetalWeek.
  if DetalWeek = 1 then do:
    enable  week-1 week-2 week-3 week-4 week-5 week-12 week-22 week-32 week-42 week-52 with frame F-Main .
  end.
  else do:
    disable week-1 week-2 week-3 week-4 week-5 week-12 week-22 week-32 week-42 week-52 with frame F-Main .
  end.
END.
...
on ' ' of month-1, month-2, month-3, month-4, week-1, week-12, week-2, week-22, week-3, week-32, week-4, week-42, week-5, week-52 in frame F-Main
do:
...
on delete-character of month-1, month-2, month-3, month-4, week-1, week-12, week-2, week-22, week-3, week-32, week-4, week-42, week-5, week-52 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-d of month-1, month-2, month-3, month-4, week-1, week-12, week-2, week-22, week-3, week-32, week-4, week-42, week-5, week-52 in frame F-Main
do:
...
on ctrl-b of month-1, month-2, month-3, month-4, week-1, week-12, week-2, week-22, week-3, week-32, week-4, week-42, week-5, week-52 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-e of month-1, month-2, month-3, month-4, week-1, week-12, week-2, week-22, week-3, week-32, week-4, week-42, week-5, week-52 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-f of month-1, month-2, month-3, month-4, week-1, week-12, week-2, week-22, week-3, week-32, week-4, week-42, week-5, week-52 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
PROCEDURE local-initialize :
  ...
  disable  Itog  with frame F-Main .
  assign
    month-3 :screen-value in frame F-Main = string(x-Date-Start,"99/99/9999")
    month-4 :screen-value in frame F-Main = string(x-Date-End,"99/99/9999")
  .
...
assign frame F-Main Itog DetalWeek Classify SortType1 month-1 month-2 month-3 month-4 week-1 week-12 week-2 week-22
...
if x-SET_val_TYPE = 1 then ReportHeader = ReportHeader + "Цены указаны в: рублях" + chr(10).
