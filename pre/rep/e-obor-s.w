...
IF NOT THIS-PROCEDURE:PERSISTENT THEN DO:
  MESSAGE "c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\rep\e-obor-s.w should only be RUN PERSISTENT.":U
...
PROCEDURE adm-disable :
    DISABLE RECT-6 RECT-8 RECT-9 RECT-5 SortType Tog-obj Classify ShowZero-2 VAT-Cost VAT-CRSA ShowZero VAT-sale T-txt WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-6 RECT-8 RECT-9 RECT-5 SortType Tog-obj Classify ShowZero-2 VAT-Cost VAT-CRSA ShowZero VAT-sale T-txt WITH FRAME F-Main.
...
if Show-Crsa or Show-Cost or Show-Sale then do:
 ...
 .
  ...
  ( input 'sorttype '                             ,
   input ''                               ,
   input 'character'                        ,
   input string(sorttype )              ,
   input 'тип сортировки' )
 .
  run create-param-to-export  in this-procedure
  ( input 'sumsonly'                             ,
   input ''                               ,
   input 'logical'                        ,
   input string(sumsonly,'yes/no')              ,
   input sumsonly:label in frame F-Main )
 .
  run create-param-to-export  in this-procedure
  ( input 'showzero'                             ,
   input ''                               ,
   input 'logical'                        ,
   input string(showzero,'yes/no')              ,
   input showzero:label in frame F-Main )
 .
  run create-param-to-export  in this-procedure
  ( input 'showzero-2'                             ,
   input ''                               ,
   input 'logical'                        ,
   input string(showzero-2,'yes/no')              ,
   input showzero-2:label in frame F-Main )
 .
  run create-param-to-export  in this-procedure
  ( input 'tog-obj'                             ,
   input ''                               ,
   input 'logical'                        ,
   input string(tog-obj,'yes/no')              ,
   input tog-obj:label in frame F-Main )
 .
  run create-param-to-export  in this-procedure
  ( input 'tog-lavel'                             ,
   input ''                               ,
   input 'logical'                        ,
   input string(tog-lavel,'yes/no')              ,
   input tog-lavel:label in frame F-Main )
 .
  run create-param-to-export  in this-procedure
  ( input 'var-lavel'                             ,
   input ''                               ,
   input 'logical'                        ,
   input string(var-lavel)              ,
   input 'номер уровеня' )
 .
  run create-param-to-export  in this-procedure
  ( input 'vat-cost'                             ,
   input ''                               ,
   input 'logical'                        ,
   input string(vat-cost,'yes/no')              ,
   input vat-cost:label in frame F-Main )
 .
  run create-param-to-export  in this-procedure
  ( input 'vat-crsa'                             ,
   input ''                               ,
   input 'logical'                        ,
   input string(vat-crsa,'yes/no')              ,
   input vat-crsa:label in frame F-Main )
 .
  run create-param-to-export  in this-procedure
  ( input 'vat-sale '                             ,
   input ''                               ,
   input 'logical'                        ,
   input string(vat-sale ,'yes/no')              ,
   input vat-sale :label in frame F-Main )
 .
 ...
 case Classify :
  when "no-classify" then do:
     if tog-obj = true then
        run rep/r-obr-1y.p
           ( input t-txt      , input v-cntxt-obj-code ,                     input v-cntxt-obj-type , input buf_currency.curr-abbr  , input v-base-code  , input Classify , input SortType ,                    input SumsOnly   , input ShowZero   , input ShowZero-2 , input tog-obj  , input tog-lavel,                    input var-lavel  , input vat-cost   , input vat-crsa   , input vat-sale   ) .
      else
        run rep/r-obr-1n.p
            ( input t-txt      , input v-cntxt-obj-code ,                     input v-cntxt-obj-type , input buf_currency.curr-abbr  , input v-base-code  , input Classify , input SortType ,                    input SumsOnly   , input ShowZero   , input ShowZero-2 , input tog-obj  , input tog-lavel,                    input var-lavel  , input vat-cost   , input vat-crsa   , input vat-sale   ) .
  end.
