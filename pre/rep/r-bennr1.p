...
define variable vss-workfile    as character no-undo init "$Workfile: r-bennr1.p $":U .
define variable vss-archive     as character no-undo init "$Archive: rep/r-bennr1.p $":U .
