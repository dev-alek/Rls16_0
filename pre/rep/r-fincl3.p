...
:
    ...
    assign
        ...
        buf_temp_sheet1_line-data.sheet-name = "Template":U
    ...
    put stream excel-line unformatted
        ...
        CHR(9)   "DTA":U
        CHR(9)   buf_temp_sheet1_line-data.opName
        CHR(9)   buf_temp_sheet1_line-data.opDate
        CHR(9)   buf_temp_sheet1_line-data.docCode
        CHR(9)   buf_temp_sheet1_line-data.debetSum
        CHR(9)   buf_temp_sheet1_line-data.creditSum
        chr(10)
    .
    .
end.
...
with width 160 down no-box stream-io .
form header
...
output stream out-stream to value( string( session:temp-directory +
  ...
  run fincl3xl-write-cell-data in this-procedure ( input "h_header":U
...
define variable vss-include-info18 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
    ...
    :
      ...
      assign
        v-repfrm-str  = "Расчет для: " + buf_clients.obj-name
        v-saldo-start = 0
        v-saldo-end   = 0
      .
      run waitfram-show in this-procedure ( input v-repfrm-str ).
      run calc-cli-saldo in this-procedure ( input  buf_clients.obj-type
      ...
      run calc-talon-oborot in this-procedure ( input  buf_clients.obj-type
                                              , input  buf_clients.obj-code
                                              , input  v-cntxt-host-code-obj
                                              ) .
      run calc-fin-pri in this-procedure ( input  buf_clients.obj-type
                                         , input  buf_clients.obj-code
                                         , input  v-cntxt-host-code-obj
                                         ) .
      create tt-report-head.
      assign
        tt-report-head.obj-type = buf_clients.obj-type
        tt-report-head.obj-code = buf_clients.obj-code
        tt-report-head.obj-name = buf_clients.obj-name
      .
    end.
  end.
  else do:
define variable vss-include-info19 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
    ...
    :
      ...
      run calc-talon-oborot in this-procedure ( input  g#post-f.obj-type
                                              , input  g#post-f.obj-code
                                              , input  v-cntxt-host-code-obj
                                              ) .
      run calc-fin-pri in this-procedure ( input  g#post-f.obj-type
                                         , input  g#post-f.obj-code
                                         , input  v-cntxt-host-code-obj
                                         ) .
      create tt-report-head.
      assign
        tt-report-head.obj-type = g#post-f.obj-type
        tt-report-head.obj-code = g#post-f.obj-code
        tt-report-head.obj-name = g#post-f.obj-name
      .
    end.
  end.
...
:
  ...
  :
    case buf_wth-doc.ext-doc-type :
      ...
      when 'pc':U or when 'ps':U then do:
      end.
      when 'pz':U then do:
        create tt-report.
        assign
