...
IF NOT THIS-PROCEDURE:PERSISTENT THEN DO:
  MESSAGE "c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\rep\e-p-pp.w should only be RUN PERSISTENT."
...
PROCEDURE adm-disable :
    DISABLE T-crsa R-all T-nacenka T-det-obj WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN T-crsa R-all T-nacenka T-det-obj WITH FRAME F-Main.
...
R-all = 1 .
T-crsa = true .
display R-all T-crsa with frame F-Main .
END PROCEDURE.
PROCEDURE my-report :
 run rep/r-p-pp.p
    ( T-crsa ,
