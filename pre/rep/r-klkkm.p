...
put stream OutStr-html unformatted
   '<body>' skip
   '<table orientation="landscape" name = "Количество работающих ККМ" fit_to_page="true">' skip
   '<thead>' skip
...
DEFINE TEMP-TABLE tt-chk NO-UNDO
   ...
   FIELD smena    LIKE chk-doc.src-shift-name
   FIELD chk-date LIKE chk-doc.chk-date
...
DEFINE TEMP-TABLE tt-period NO-UNDO
   ...
   FIELD ob-code    LIKE chk-doc.obj-code
   FIELD kassa      LIKE chk-doc.pay-desk
   FIELD smena      as integer
   FIELD date-beg   LIKE chk-doc.chk-date
   FIELD date-end   LIKE chk-doc.chk-date
      ...
      do:
         ...
         do:
            ...
            ASSIGN
               ...
               tt-tr.obj-type  = tt-period.ob-type
               .
            if kol-kass2 <= tt-period.qnty-kassa then kol-kass2 = tt-period.qnty-kassa .
            kol-kass = tt-period.qnty-kassa .
            end-p-date = tt-period.date-end .
            end-p-time = tt-period.time-end .
         end.
