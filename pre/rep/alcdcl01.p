...
:
  ...
  define variable v-str-ost-qnty                  as character  format "X(15)" no-undo .
  define variable v-str-total-qnty                as character  format "X(15)" no-undo .
  define variable v-str-total-local-producer-qnty as character  format "X(15)" no-undo .
  define variable v-str-total-local-rus-qnty      as character  format "X(15)" no-undo .
  define variable v-str-total-local-imp-qnty      as character  format "X(15)" no-undo .
  define variable v-str-total-not-local-rus-qnty  as character  format "X(15)" no-undo .
  define variable v-str-total-not-local-imp-qnty  as character  format "X(15)" no-undo .
  define variable v-str-ras-qnty                  as character  format "X(15)" no-undo .
  define variable v-str-spis-qnty                 as character  format "X(15)" no-undo .
  define variable v-str-ost-end-qnty              as character  format "X(15)" no-undo .
  define variable v-str-dal                       as character  format "X(15)" no-undo .
  ...
  define frame f-decl
    ...
    tt-gds.alc-type-name column-label "Наименование видов!и коды!алкогольной продукции!" format "X(30)" space(0)
  ...
  header
    ...
    v-line format "X(196)" at 1
  with width 198 down stream-io.
  define frame f-in
    sym1 column-label ":!:!:" format "X(1)" space(0)
    v-sea-num column-label "№!п/п!" space(0)
    sym2 column-label ":!:!:" format "X(1)" space(0)
    tt-gds.alc-type-name column-label "Наименование видов!алкогольной продукции!" format "X(26)" space(0)
    sym3 column-label ":!:!:" format "X(1)" space(0)
    v-fmtcli-name column-label "Наименование поставщика! !" format "X(30)" space(0)
    sym4 column-label ":!:!:" format "X(1)" space(0)
    v-fmtcli-inn column-label "ИНН! !" format "X(15)" space(0)
    sym5 column-label ":!:!:" format "X(1)" space(0)
    v-addres column-label "Место нахождения!(юридический адрес)!" format "X(35)" space(0)
    sym6 column-label ":!:!:" format "X(1)" space(0)
    v-sert column-label "Серия, номер,!дата выдачи!" format "X(15)" space(0)
    sym7 column-label ":!:!:" format "X(1)" space(0)
    v-sert-give column-label "Кем выдана! !" format "X(20)" space(0)
    sym8 column-label ":!:!:" format "X(1)" space(0)
    v-doc-num-date column-label "Дата и номер!товарно-транспартной!накладной" format "X(25)" space(0)
    sym9 column-label ":!:!:" format "X(1)" space(0)
    v-str-dal column-label "Объем!продукции!(дал)" space(0)
    sym10 column-label ":!:!:" format "X(1)" space(0)
  header
    v-line format "X(194)" at 1
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run hostcode in g#library
  ...
  put stream out-stream
    ...
    v-line format "X(170)" at 10 skip
    ": ИНН" at 10 ":" at 91 v-fmtcli-inn format "X(87)" ":" at 179
    v-line format "X(170)" at 10 skip
  ...
  if Make-Excel then  put   stream ForExcel unformatted
    CHR(9) "Приложение №1":U  skip
    CHR(9) "к Порядку представления":u skip
    CHR(9) "деклараций о":U  skip
    CHR(9) "розничной продаже алкогольной":U skip
    CHR(9) "продукции на":U  skip
    CHR(9) "территории Приморского края,":U skip
    CHR(9) "утвержденному":U skip
    CHR(9) "постановлением Администрации":U skip
    CHR(9) "Приморского края от":U skip
    CHR(9) "19 июня 2006 г. № 148-па":U skip(2)
     "Данные об организации":U CHR(9) skip (1)
    "Наименование организации"  CHR(9)
    v-fmtcli-name               CHR(9)
  skip
    "ИНН"                       CHR(9)
    v-fmtcli-inn                CHR(9)
  skip
    "Дата внесения в Единый государственный реестр юридических лиц, номер"  CHR(9)
    v-host-egrip               CHR(9)
  skip
    "Место нахождения организации (адрес государственной регистрации), телефон"  CHR(9)
    v-str               CHR(9)
  skip.
  do while v-str <> ""
  :
  ...
  .
  if Make-Excel then  put   stream ForExcel unformatted
    "Номер, регистрационный номер, дата, срок действия лицензии"  CHR(9)
    v-sertificate               CHR(9)
  skip.
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run curr-r-b in g#library
  ...
  assign
      ...
      "№ п/п" + chr(44) +
      "Наименование видов и коды алкогольной продукции" + chr(44) +
      "Остаток на начало года" + chr(44) +
      "Поступления (закупки)"  + chr(44) +
       chr(44) +
       chr(44) +
       chr(44) +
       chr(44) +
       chr(44) +
       "Розничная продажа" + chr(44) +
       "Списание возврат поставщику" + chr(44) +
       "Остаток на конец отчетного периода" + chr(44) +
       chr(10)   +
       chr(44) +
       chr(44) +
       chr(44) +
       "Всего" + chr(44) +
       "От производителей края" + chr(44) +
       "От организации оптовой торговли края" + chr(44) +
       chr(44) +
       "От поставщиков из-за пределов края" + chr(44) +
       chr(44) +
       chr(44) +
       chr(44) +
       chr(44) +
...
if gp-price-sale-parts <> 0 and gp-price-sale-parts <> ? then do:
    gp-price-sale = gp-price-sale-parts.
          ...
          assign
            v-ot-line-sum-r = abs( gp-price-sale * buf_ot-line.fact-qnty ) / 1000
          .
        end.
        else do:
          assign
            v-ot-line-sum-r = abs(buf_ot-line.sum-rubl  / 1000)
          .
        end.
        assign
        ...
        case buf_ot-line.ext-doc-type:
          ...
          when 'iv':U then do:
            ...
            :
              ...
              then do:
                  assign
                      v-part-sum-r =  if x-SET_PAY_TYPE = 1 then tt-allsum-line.sum-dsc-rubl-doc / 1000
                                      else tt-allsum-line.sum-dsc-rubl-acc / 1000
                  .
              end.
              else do:
                message
          ...
          when 'ee':U  then do:
            assign
              v-ras       = v-ras + abs(buf_ot-line.sum-rubl  / 1000)
          ...
          when 'ep':U then do:
            assign
              v-spis       = v-spis + abs(buf_ot-line.sum-rubl  / 1000)
      ...
      if last-of(tt-alc-type.alc-type-code) then do:
          assign
            ...
            v-carret                        = no
            v-alc-type-name                 = substring(tt-alc-type.alc-type-name, 1, 30)
          .
          ...
          display stream out-stream
            ...
            put stream out-stream  v-line format "X(196)" at 1 skip.
            if length( tt-alc-type.alc-type-name ) > 30 then do:
              assign
                v-carret = yes
              .
            end.
            assign
              v-str-ost-qnty                  = str-format( v-ost-qnty                  , ">>>>>>>>>9.9999" , 15 )
              v-str-total-qnty                = str-format( v-total-qnty                , ">>>>>>>>>9.9999" , 15 )
              v-str-total-local-producer-qnty = str-format( v-total-local-producer-qnty , ">>>>>>>>>9.9999" , 15 )
              v-str-total-local-rus-qnty      = str-format( v-total-local-rus-qnty      , ">>>>>>>>>9.9999" , 15 )
              v-str-total-local-imp-qnty      = str-format( v-total-local-imp-qnty      , ">>>>>>>>>9.9999" , 15 )
              v-str-total-not-local-rus-qnty  = str-format( v-total-not-local-rus-qnty  , ">>>>>>>>>9.9999" , 15 )
              v-str-total-not-local-imp-qnty  = str-format( v-total-not-local-imp-qnty  , ">>>>>>>>>9.9999" , 15 )
              v-str-ras-qnty                  = str-format( v-ras-qnty                  , ">>>>>>>>>9.9999" , 15 )
              v-str-spis-qnty                 = str-format( v-spis-qnty                 , ">>>>>>>>>9.9999" , 15 )
              v-str-ost-end-qnty              = str-format( v-ost-end-qnty              , ">>>>>>>>>9.9999" , 15 )
            .
            display stream out-stream
              v-sea-num
            ...
            down stream out-stream with frame f-decl.
            assign
              v-str-ost-qnty                  = str-format( v-ost-qnty                  , ">>>>>>>>>9.9999" , 0  )
              v-str-total-qnty                = str-format( v-total-qnty                , ">>>>>>>>>9.9999" , 0  )
              v-str-total-local-producer-qnty = str-format( v-total-local-producer-qnty , ">>>>>>>>>9.9999" , 0  )
              v-str-total-local-rus-qnty      = str-format( v-total-local-rus-qnty      , ">>>>>>>>>9.9999" , 0  )
              v-str-total-local-imp-qnty      = str-format( v-total-local-imp-qnty      , ">>>>>>>>>9.9999" , 0  )
              v-str-total-not-local-rus-qnty  = str-format( v-total-not-local-rus-qnty  , ">>>>>>>>>9.9999" , 0  )
              v-str-total-not-local-imp-qnty  = str-format( v-total-not-local-imp-qnty  , ">>>>>>>>>9.9999" , 0  )
              v-str-ras-qnty                  = str-format( v-ras-qnty                  , ">>>>>>>>>9.9999" , 0  )
              v-str-spis-qnty                 = str-format( v-spis-qnty                 , ">>>>>>>>>9.9999" , 0  )
              v-str-ost-end-qnty              = str-format( v-ost-end-qnty              , ">>>>>>>>>9.9999" , 0  )
            .
            if Make-Excel then  put   stream ForExcel unformatted
              v-sea-num                       CHR(9)
              tt-alc-type.alc-type-name              CHR(9)
              v-str-ost-qnty                  CHR(9)
              v-str-total-qnty                CHR(9)
              v-str-total-local-producer-qnty CHR(9)
              v-str-total-local-rus-qnty      CHR(9)
              v-str-total-local-imp-qnty      CHR(9)
              v-str-total-not-local-rus-qnty  CHR(9)
              v-str-total-not-local-imp-qnty  CHR(9)
              v-str-ras-qnty                  CHR(9)
              v-str-spis-qnty                 CHR(9)
              v-str-ost-end-qnty              CHR(9)
            skip.
            assign
              v-str-ost-qnty                  = str-format( v-ost                  , ">>>>>>>>>>9.999" , 15 )
              v-str-total-qnty                = str-format( v-total                , ">>>>>>>>>>9.999" , 15 )
              v-str-total-local-producer-qnty = str-format( v-total-local-producer , ">>>>>>>>>>9.999" , 15 )
              v-str-total-local-rus-qnty      = str-format( v-total-local-rus      , ">>>>>>>>>>9.999" , 15 )
              v-str-total-local-imp-qnty      = str-format( v-total-local-imp      , ">>>>>>>>>>9.999" , 15 )
              v-str-total-not-local-rus-qnty  = str-format( v-total-not-local-rus  , ">>>>>>>>>>9.999" , 15 )
              v-str-total-not-local-imp-qnty  = str-format( v-total-not-local-imp  , ">>>>>>>>>>9.999" , 15 )
              v-str-ras-qnty                  = str-format( v-ras                  , ">>>>>>>>>>9.999" , 15 )
              v-str-spis-qnty                 = str-format( v-spis                 , ">>>>>>>>>>9.999" , 15 )
              v-str-ost-end-qnty              = str-format( v-ost-end              , ">>>>>>>>>>9.999" , 15 )
            .
            display stream out-stream
              " " @ v-sea-num
              substring(tt-alc-type.alc-type-name, 30, length(tt-alc-type.alc-type-name)) when v-carret @ tt-gds.alc-type-name
              v-str-ost-qnty
              v-str-total-qnty
              v-str-total-local-producer-qnty
              v-str-total-local-rus-qnty
            ...
            put stream out-stream v-line format "X(196)" at 1 SKIP.
            assign
              v-str-ost-qnty                  = str-format( v-ost                  , ">>>>>>>>>>9.999" , 0 )
              v-str-total-qnty                = str-format( v-total                , ">>>>>>>>>>9.999" , 0 )
              v-str-total-local-producer-qnty = str-format( v-total-local-producer , ">>>>>>>>>>9.999" , 0 )
              v-str-total-local-rus-qnty      = str-format( v-total-local-rus      , ">>>>>>>>>>9.999" , 0 )
              v-str-total-local-imp-qnty      = str-format( v-total-local-imp      , ">>>>>>>>>>9.999" , 0 )
              v-str-total-not-local-rus-qnty  = str-format( v-total-not-local-rus  , ">>>>>>>>>>9.999" , 0 )
              v-str-total-not-local-imp-qnty  = str-format( v-total-not-local-imp  , ">>>>>>>>>>9.999" , 0 )
              v-str-ras-qnty                  = str-format( v-ras                  , ">>>>>>>>>>9.999" , 0 )
              v-str-spis-qnty                 = str-format( v-spis                 , ">>>>>>>>>>9.999" , 0 )
              v-str-ost-end-qnty              = str-format( v-ost-end              , ">>>>>>>>>>9.999" , 0 )
            .
            if Make-Excel then  put   stream ForExcel unformatted
              " "                             CHR(9)
              " "                             CHR(9)
  ...
  assign
    v-str-ost-qnty                  = str-format( v-gt-ost-qnty                  , ">>>>>>>>>9.9999" , 15 )
    v-str-total-qnty                = str-format( v-gt-total-qnty                , ">>>>>>>>>9.9999" , 15 )
    v-str-total-local-producer-qnty = str-format( v-gt-total-local-producer-qnty , ">>>>>>>>>9.9999" , 15 )
    v-str-total-local-rus-qnty      = str-format( v-gt-total-local-rus-qnty      , ">>>>>>>>>9.9999" , 15 )
    v-str-total-local-imp-qnty      = str-format( v-gt-total-local-imp-qnty      , ">>>>>>>>>9.9999" , 15 )
    v-str-total-not-local-rus-qnty  = str-format( v-gt-total-not-local-rus-qnty  , ">>>>>>>>>9.9999" , 15 )
    v-str-total-not-local-imp-qnty  = str-format( v-gt-total-not-local-imp-qnty  , ">>>>>>>>>9.9999" , 15 )
    v-str-ras-qnty                  = str-format( v-gt-ras-qnty                  , ">>>>>>>>>9.9999" , 15 )
    v-str-spis-qnty                 = str-format( v-gt-spis-qnty                 , ">>>>>>>>>9.9999" , 15 )
    v-str-ost-end-qnty              = str-format( v-gt-ost-end-qnty              , ">>>>>>>>>9.9999" , 15 )
  .
  display stream out-stream
    " "                             @ v-sea-num
  ...
  down stream out-stream with frame f-decl.
  assign
    v-str-ost-qnty                  = str-format( v-gt-ost-qnty                  , ">>>>>>>>>9.9999" , 0 )
    v-str-total-qnty                = str-format( v-gt-total-qnty                , ">>>>>>>>>9.9999" , 0 )
    v-str-total-local-producer-qnty = str-format( v-gt-total-local-producer-qnty , ">>>>>>>>>9.9999" , 0 )
    v-str-total-local-rus-qnty      = str-format( v-gt-total-local-rus-qnty      , ">>>>>>>>>9.9999" , 0 )
    v-str-total-local-imp-qnty      = str-format( v-gt-total-local-imp-qnty      , ">>>>>>>>>9.9999" , 0 )
    v-str-total-not-local-rus-qnty  = str-format( v-gt-total-not-local-rus-qnty  , ">>>>>>>>>9.9999" , 0 )
    v-str-total-not-local-imp-qnty  = str-format( v-gt-total-not-local-imp-qnty  , ">>>>>>>>>9.9999" , 0 )
    v-str-ras-qnty                  = str-format( v-gt-ras-qnty                  , ">>>>>>>>>9.9999" , 0 )
    v-str-spis-qnty                 = str-format( v-gt-spis-qnty                 , ">>>>>>>>>9.9999" , 0 )
    v-str-ost-end-qnty              = str-format( v-gt-ost-end-qnty              , ">>>>>>>>>9.9999" , 0 )
  .
  if Make-Excel then  put   stream ForExcel unformatted
    ""                              CHR(9)
    "ИТОГО:"                        CHR(9)
  ...
  skip.
  assign
    v-str-ost-qnty                  = str-format( v-gt-ost                  , ">>>>>>>>>>9.999" , 15 )
    v-str-total-qnty                = str-format( v-gt-total                , ">>>>>>>>>>9.999" , 15 )
    v-str-total-local-producer-qnty = str-format( v-gt-total-local-producer , ">>>>>>>>>>9.999" , 15 )
    v-str-total-local-rus-qnty      = str-format( v-gt-total-local-rus      , ">>>>>>>>>>9.999" , 15 )
    v-str-total-local-imp-qnty      = str-format( v-gt-total-local-imp      , ">>>>>>>>>>9.999" , 15 )
    v-str-total-not-local-rus-qnty  = str-format( v-gt-total-not-local-rus  , ">>>>>>>>>>9.999" , 15 )
    v-str-total-not-local-imp-qnty  = str-format( v-gt-total-not-local-imp  , ">>>>>>>>>>9.999" , 15 )
    v-str-ras-qnty                  = str-format( v-gt-ras                  , ">>>>>>>>>>9.999" , 15 )
    v-str-spis-qnty                 = str-format( v-gt-spis                 , ">>>>>>>>>>9.999" , 15 )
    v-str-ost-end-qnty              = str-format( v-gt-ost-end              , ">>>>>>>>>>9.999" , 15 )
  .
  display stream out-stream
    " "                                               @ v-sea-num
  ...
  page stream out-stream.
  assign
    v-str-ost-qnty                  = str-format( v-gt-ost                  , ">>>>>>>>>>9.999" , 0  )
    v-str-total-qnty                = str-format( v-gt-total                , ">>>>>>>>>>9.999" , 0  )
    v-str-total-local-producer-qnty = str-format( v-gt-total-local-producer , ">>>>>>>>>>9.999" , 0  )
    v-str-total-local-rus-qnty      = str-format( v-gt-total-local-rus      , ">>>>>>>>>>9.999" , 0  )
    v-str-total-local-imp-qnty      = str-format( v-gt-total-local-imp      , ">>>>>>>>>>9.999" , 0  )
    v-str-total-not-local-rus-qnty  = str-format( v-gt-total-not-local-rus  , ">>>>>>>>>>9.999" , 0  )
    v-str-total-not-local-imp-qnty  = str-format( v-gt-total-not-local-imp  , ">>>>>>>>>>9.999" , 0  )
    v-str-ras-qnty                  = str-format( v-gt-ras                  , ">>>>>>>>>>9.999" , 0  )
    v-str-spis-qnty                 = str-format( v-gt-spis                 , ">>>>>>>>>>9.999" , 0  )
    v-str-ost-end-qnty              = str-format( v-gt-ost-end              , ">>>>>>>>>>9.999" , 0  )
  .
  if Make-Excel then  put   stream ForExcel unformatted
    ""                              CHR(9)
    ""                              CHR(9)
...
:
  ...
  assign
      ...
      sheetf.Excel-Column-Lable =
      "№ п/п"                                         + chr(44) +
      "Наименование видов алкогольной продукции"      + chr(44) +
      "Поставщик"                                     + chr(44) +
                                                        chr(44) +
                                                        chr(44) +
                                                        chr(44) +
                                                        chr(44) +
       "Дата и номер товарно-транспортной накладной"  + chr(44) +
       "Объем закупленой продукции"                   + chr(44) +
       chr(10)   +
                                                        chr(44) +
                                                        chr(44) +
       "наименование поставщика"                      + chr(44) +
       "ИНН"                         + chr(44) +
       "место нахождения (юридический адрес)"         + chr(44) +
       "лицензия"                                     + chr(44) +
                                                        chr(44) +
       chr(10)   +
                                                        chr(44) +
                                                        ...
                                                        chr(44) +
                                                        chr(44) +
       "серия номер дата выдачи"                      + chr(44) +
       "кем выдана"                                   + chr(44) +
                                                        chr(44) +
                                                        chr(44) +
       chr(10)   +
  ...
  for each tt-alc-type no-lock
    ...
    :
      display stream out-stream
        ...
        substring(v-alc-type-name, 1, 26) @ tt-gds.alc-type-name
        " ------------- ":U @ v-fmtcli-name
        " ------------- ":U @ v-fmtcli-inn
        " ------------- ":U @ v-addres
        " ------------- ":U @ v-sert
      ...
      assign
        v-alc-type-name = substring(v-alc-type-name, 26 + 1 , length(v-alc-type-name))
    ...
    :
      if last-of( tt-alc-pri.doc-code ) then do:
        ...
        assign
          ...
          v-str-dal       = str-format(v-dal, ">>>>>>>>>9.9999", 15)
          v-fmtcli-name   = if v-fmtcli-name = "" or v-fmtcli-name = ? then " ------------- ":U else v-fmtcli-name
          v-fmtcli-inn    = if v-fmtcli-inn = "" or v-fmtcli-inn = ? then " ------------- ":U else v-fmtcli-inn
        .
        display stream out-stream
          v-fmtcli-name
          v-fmtcli-inn
        ...
        down stream out-stream with frame f-in.
        assign
          v-str-dal       = str-format(v-dal, ">>>>>>>>>9.9999", 0 )
        .
        if Make-Excel then  put   stream ForExcel unformatted
          if v-is-null-rec then string(v-sea-num)  else "" CHR(9)
          if v-is-null-rec then v-alc-type-name else "" CHR(9)
          v-fmtcli-name   CHR(9)
          v-fmtcli-inn    CHR(9)
          v-addres        CHR(9)
          v-sert          CHR(9)
          v-sert-give     CHR(9)
          v-doc-num-date  CHR(9)
          v-str-dal       CHR(9)
        skip.
        assign
          v-dal           = 0
    ...
    put stream out-stream v-line format "X(194)" at 1 SKIP.
  end.
