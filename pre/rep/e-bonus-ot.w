...
IF NOT THIS-PROCEDURE:PERSISTENT THEN DO:
  MESSAGE "c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\rep\e-bonus-ot.w should only be RUN PERSISTENT.":U
...
DEFINE NEW GLOBAL SHARED VAR adm-broker-hdl    AS HANDLE  NO-UNDO.
    ASSIGN adm-object-hdl = FRAME fMain:HANDLE.
RUN ensure-broker.
...
PROCEDURE adm-disable :
    DISABLE RECT-1 RECT-2 selectcard T-obj-detal WITH FRAME fMain.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-1 RECT-2 selectcard T-obj-detal WITH FRAME fMain.
...
DO:
 ...
 END CASE.
 display selectcard with frame fMain.
END.
ON VALUE-CHANGED OF T-obj-detal IN FRAME FMain
DO:
    assign T-obj-detal.
    end.
