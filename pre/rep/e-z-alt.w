...
IF NOT THIS-PROCEDURE:PERSISTENT THEN DO:
  MESSAGE "c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\rep\e-z-alt.w should only be RUN PERSISTENT.":U
...
PROCEDURE adm-disable :
    DISABLE RECT-12 RECT-3 Classify SelectObject BUTTON-obj Itog show-zero show-qnty Rs-qnty-type SortType TEXT-3-alt Obj-count WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-12 RECT-3 Classify SelectObject BUTTON-obj Itog show-zero show-qnty Rs-qnty-type SortType TEXT-3-alt Obj-count WITH FRAME F-Main.
...
:
  assign
    selectobject :radio-buttons =
            "Нет" + chr(44) + "not":U + chr(44) +
  "Все" + chr(44) + 'все':U + chr(44) +
  "Выборочно" + chr(44) + "choice":U
  .
end.
...
x-date-end   = v-today.
     ReportHeader = "Альтернативные объекты : " + chr(10).
     for each alt-obj-list no-lock :
        ReportHeader = ReportHeader + Fill(" ",5) + alt-obj-list.obj-name  + chr(10).
     End.
...
if not show-zero then do:
  ReportHeader = ReportHeader +  chr(10) + "Не показывать нулевые строки".
end.
else do:
  ReportHeader = ReportHeader +  chr(10) + "Показывать нулевые строки".
end.
     IF show-qnty THEN DO:
        ReportHeader = ReportHeader +  chr(10) + "Товары , у которых есть положительные остатки по первому объекту".
     END.
                  ...
                  do:
                      ...
                      if buf_sysconf.base-code = base-code or v-all-object = true
                          then do:
                              create alt-obj-list.
                              assign
                                  alt-obj-list.obj-name = buf_clients.obj-name
                                  alt-obj-list.obj-type = buf_userobjs_temp-user-obj.obj-type
                                  alt-obj-list.obj-code = buf_userobjs_temp-user-obj.obj-code.
                          end.
                          else do:
                            str-obj# = str-obj#  +  " " +  buf_clients.obj-name + "," .
                          end.
