...
define variable qnt-vcchk-num-all      as int       no-undo.
...
define variable itog-o-qnt-chk         as int       no-undo.
define variable itog-o-qnt-pchk        as int       no-undo.
define variable itog-o-qnt-vchk        as int       no-undo.
define variable itog-o-sum-ob          as DECIMAL   no-undo.
define variable itog-o-sum-it          as DECIMAL   no-undo.
define variable itog-qnt-chk           as int       no-undo.
define variable itog-qnt-pchk          as int       no-undo.
define variable itog-qnt-vchk          as int       no-undo.
define variable itog-qnt-vschk-all     as int       no-undo.
define variable itog-qnt-vcchk-all     as int       no-undo.
define variable itog-qnt-vcchk-num-all as int       no-undo.
define variable itog-qnt-vnchk-all     as int       no-undo.
define variable itog-qnt-vpchk-all     as int       no-undo.
define variable itog-o-qnt-vschk-all   as int       no-undo.
define variable itog-o-qnt-vcchk-all   as int       no-undo.
define variable itog-o-qnt-vnchk-all   as int       no-undo.
define variable itog-o-qnt-vpchk-all   as int       no-undo.
define variable itog-pr-qnt-vp         as int       no-undo.
define variable itog-pr-qnt-co         as int       no-undo.
define variable itog-pr-qnt-pvov       as int       no-undo.
define variable itog-pr-qnt-suhob      as int       no-undo.
define variable itog-pr-qnt-ostv       as int       no-undo.
define variable itog-pr-qnt-ostp       as int       no-undo.
...
FOR EACH obj-list  NO-LOCK:
   ...
   for each tt-chk-doc where tt-chk-doc.obj-code = obj-list.obj-code and tt-chk-doc.obj-type = obj-list.obj-type:
      if tt-chk-doc.vozvrat then o-qnt-chk = o-qnt-chk + 1 .
      if tt-chk-doc.vozvrat_part then qnt-vcchk-all = qnt-vcchk-all + 1 .
      if tt-chk-doc.vozvrat_part_num then qnt-vcchk-num-all = qnt-vcchk-num-all + 1 .
      if tt-chk-doc.vozvrat_full_num then qnt-vnchk-all = qnt-vnchk-all + 1 .
      if tt-chk-doc.vozvrat_dry then qnt-vchk = qnt-vchk + 1 .
      if tt-chk-doc.vozvrat_full then qnt-vpchk-all = qnt-vpchk-all + 1 .
   end.
...
procedure proc-report:
   FOR EACH chk-gds where chk-gds.doc-code = chk-doc.doc-code AND chk-doc.chk-type = 6 NO-LOCK:
      ...
      DO:
         ...
         vozvrtrn = '+' .
      END.
      time-chk-chr = string(chk-gds.time-oper, "HH:MM").
      ...
      no-lock :
         ...
         put stream OutStr-html unformatted
            ...
            '<td text_wrap="true" style="text-align:center;">' chk-doc.pay-desk   '</td>' skip
            '<td text_wrap="true" style="text-align:center;">' chk-doc.shift-name '</td>' skip
            '<td text_wrap="true" style="text-align:center;">' chk-doc.shift-date '</td>' skip
            '<td text_wrap="true" style="text-align:center;">' chk-doc.chk-num ': ' chk-doc.z-number '</td>' skip
            '<td text_wrap="true" style="text-align:center;">' chk-gds.chk-date '</td>' skip
            '<td text_wrap="true" style="text-align:center;">' string(chk-doc.chk-time, "HH:MM") '</td>' skip
            '<td text_wrap="true">' SUBSTRING(produkt,1,50)   '</td>' skip
            '<td text_wrap="true">' kd-tv   '</td>' skip
            '<td text_wrap="true" style="text-align:center;">' string(ABSOLUTE(chk-gds.doc-qnty),"->>>>>>>>9.99") '</td>' skip
            '<td text_wrap="true" style="text-align:center;">' string(ABSOLUTE(chk-gds.src-sum),"->>>>>>>>9.99")  '</td>' skip
            '<td text_wrap="true" style="text-align:center;">' + string(ABSOLUTE(chk-gds-pay.tot-r-b),"->>>>>>>>9.99") + '</td>' skip
            '<td text_wrap="true">'                            opl-chr    '</td>' skip
            '<td text_wrap="true" style="text-align:center;">' trnz-chr   '</td>' skip
            '<td text_wrap="true" style="text-align:center;">' vozvrtrn   '</td>' skip
            '<td text_wrap="true" style="text-align:center;">' chk-doc.doc-num2   '</td>' skip
            '<td text_wrap="true" style="text-align:center;">' suhoi      '</td>' skip
            '<td text_wrap="true" style="text-align:center;">' vCHMgrKey  '</td>' skip
