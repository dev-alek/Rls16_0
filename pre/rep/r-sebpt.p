  ...
  define variable tt as integer no-undo .
    ...
    tt = num#str#  .
     put  stream macr_excel unformatted
       substitute('select("r&1c&2:r&3c&4 ")' , tt , 4 , tt , 5 ) + chr(10)  +
       'ALIGNMENT(7,,4,4,)'  + chr(10)
       'BORDER( 2,0,0,0,0,,0,0,0,0,0) '  + chr(10)
       substitute('select("r&1c&2:r&3c&4 ")' , tt , 6 , tt , 9 ) + chr(10)  +
       'ALIGNMENT(7,,4,4,)'  + chr(10)
       'BORDER(2,0,0,0,0,,0,0,0,0,0) '  + chr(10)
       substitute('select("r&1c&2:r&3c&4 ")' , tt , 10 , tt , 12 ) + chr(10)  +
       'ALIGNMENT(7,,4,4,)'  + chr(10)
       'BORDER(2,0,0,0,0,,0,0,0,0,0) '  + chr(10)
       substitute('select("r&1c&2:r&3c&4 ")' , tt , 13 , tt , 14 ) + chr(10)  +
       'ALIGNMENT(7,,4,4,)'  + chr(10)
       'BORDER(2,0,0,0,0,,0,0,0,0,0) '  + chr(10)
       .
    num#col# = 4.
    ...
    run macr_cell_size ( 15 , ? , num#str# , num#col# , ?, ? ) .
    num#col# = 5.
    run macr_excel_char ( "Себестоимость, руб/л"   , num#str# , num#col#   ) .
    run macr_cell_size ( 15 , ? , num#str# , num#col# , ?, ? ) .
    num#col# = 6.
    run macr_excel_char ( "Кол-во,л"   , num#str# , num#col#   ) .
    run macr_cell_size ( 15 , ? , num#str# , num#col# , ?, ? ) .
    ...
    run macr_cell_size ( 15 , ? , num#str# , num#col# , ?, ? ) .
    num#col# = 8.
    run macr_excel_char ( " К1, руб/л"   , num#str# , num#col#   ) .
    run macr_cell_size ( 15 , ? , num#str# , num#col# , ?, ? ) .
    num#col# = 9.
    run macr_excel_char ( "Себестоимость, руб/л"   , num#str# , num#col#   ) .
    run macr_cell_size ( 15 , ? , num#str# , num#col# , ?, ? ) .
    ...
    run macr_cell_size ( 15 , ? , num#str# , num#col# , ?, ? ) .
    num#col# = 11.
    run macr_excel_char ( " К2, руб/л"   , num#str# , num#col#   ) .
    run macr_cell_size ( 15 , ? , num#str# , num#col# , ?, ? ) .
    num#col# = 12.
    run macr_excel_char ( "Себестоимость, руб/л"   , num#str# , num#col#   ) .
    run macr_cell_size ( 15 , ? , num#str# , num#col# , ?, ? ) .
    ...
    ( 12    ,
      ...
      14 ) .
     put  stream macr_excel unformatted
       substitute('select("r&1c&2:r&3c&4 ")' , tt , 1 , num#str# ,  3 ) + chr(10)  +
       'BORDER( 2 , 2 , 0 , 0 , 0 , ,0,0,0,0,0) '  + chr(10) +
       'ALIGNMENT(3 , , 4 , 4 ,)'  + chr(10)
       .
     put  stream macr_excel unformatted
       substitute('select("r&1c&2:r&3c&4 ")' , tt + 1 , 4 , num#str# ,  num#col# ) + chr(10)  +
...
procedure make-tt :
  ...
  for each buf_shift-obj no-lock where
         ...
         fact-order-2 = buf_shift-obj.fact-order.
        if fact-order-2 = 0 and buf_shift-obj.status_   <> 'зкр':U   then do:
