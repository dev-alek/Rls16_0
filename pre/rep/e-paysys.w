...
IF NOT THIS-PROCEDURE:PERSISTENT THEN DO:
  MESSAGE "c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\rep\e-paysys.w should only be RUN PERSISTENT.":U
...
PROCEDURE adm-disable :
    DISABLE RECT-7 EDITOR-3 RADIO-SET-3 f-sum WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-7 EDITOR-3 RADIO-SET-3 f-sum WITH FRAME F-Main.
...
ON LEAVE OF f-sum IN FRAME F-Main
DO:
    assign f-sum .
  END.
      ...
      DO ii = 1 to vSubs:iCounter:
        ...
        do:
          ...
          buffer-copy ub.PromoAction to tt-promo .
              ASSIGN
                v-text-promo = v-text-promo + chr(10) + ub.PromoAction.nameAction.
              .
            END.
            ASSIGN
              v-text-promo = TRIM(v-text-promo, chr(10))
...
DISPLAY
      EDITOR-3
      WITH FRAME F-Main.
disable f-sum with frame F-Main .
END PROCEDURE.
