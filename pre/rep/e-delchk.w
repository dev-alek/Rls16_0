...
PROCEDURE adm-disable :
    DISABLE rect-3 bt-date-to bt-date-from F-date-to F-date-from flagOnlyDel WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN rect-3 bt-date-to bt-date-from F-date-to F-date-from flagOnlyDel WITH FRAME F-Main.
...
DO:
  ...
  END.
ON LEAVE OF F-date-to IN FRAME F-Main
DO:
    assign F-date-to .
    if F-date-from < F-date-to then
    do:
  ...
  END.
ON RETURN OF F-date-to IN FRAME F-Main
DO:
    apply "TAB":U to self .
    return no-apply .
  END.
ON TAB OF F-date-to IN FRAME F-Main
DO:
    if string(F-date-from) <> F-date-from:screen-value then
    do:
      assign F-date-to .
  ...
  END.
ON VALUE-CHANGED OF flagOnlyDel IN FRAME F-Main
DO:
  assign flagOnlyDel .
...
on ' ' of f-date-from in frame F-Main
do:
...
on delete-character of f-date-from in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-d of f-date-from in frame F-Main
do:
  define variable v-curr-sv-date as date no-undo .
  if (can-query (self, "sensitive")
     and
...
on ctrl-b of f-date-from in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-e of f-date-from in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-f of f-date-from in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
  ...
  define MENU m-ed-date16
    ...
    .
  if f-date-from :POPUP-MENU in frame F-Main = ?
  then do:
    ASSIGN
      f-date-from :POPUP-MENU in frame F-Main = MENU m-ed-date16 :HANDLE
      f-date-from :MENU-MOUSE in frame F-Main = 3
    .
  end.
  define variable v-label-handle16 as handle no-undo .
  assign
    v-label-handle16 = f-date-from :side-label-handle in frame F-Main
  .
  ...
  ON CHOOSE OF MENU-ITEM m-ed-date16-1 in menu m-ed-date16 DO:
    apply "ctrl-b":U to f-date-from in frame F-Main .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date16-2 in menu m-ed-date16 DO:
    apply "ctrl-d":U to f-date-from in frame F-Main .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date16-3 in menu m-ed-date16 DO:
    apply "ctrl-e":U to f-date-from in frame F-Main .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date16-4 in menu m-ed-date16 DO:
    apply "ctrl-f":U to f-date-from in frame F-Main .
  END.
define variable vss-include-info17 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
on ' ' of f-date-to in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on delete-character of f-date-to in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-d of f-date-to in frame F-Main
do:
  define variable v-curr-sv-date as date no-undo .
  if (can-query (self, "sensitive")
     and
...
on ctrl-b of f-date-to in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-e of f-date-to in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-f of f-date-to in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
  ...
  define MENU m-ed-date18
    ...
    .
  if f-date-to :POPUP-MENU in frame F-Main = ?
  then do:
    ASSIGN
      f-date-to :POPUP-MENU in frame F-Main = MENU m-ed-date18 :HANDLE
      f-date-to :MENU-MOUSE in frame F-Main = 3
    .
  end.
  define variable v-label-handle18 as handle no-undo .
  assign
    v-label-handle18 = f-date-to :side-label-handle in frame F-Main
  .
