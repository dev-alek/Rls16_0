...
IF NOT THIS-PROCEDURE:PERSISTENT THEN DO:
  MESSAGE "c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\rep\e-gdsinv.w should only be RUN PERSISTENT.":U
...
PROCEDURE adm-disable :
    DISABLE RECT-7 RADIO-sort det_obj gds_grp WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-7 RADIO-sort det_obj gds_grp WITH FRAME F-Main.
...
ON VALUE-CHANGED OF det_obj IN FRAME F-Main
DO:
  assign det_obj.
END.
ON VALUE-CHANGED OF gds_grp IN FRAME F-Main
DO:
  assign gds_grp.
END.
