...
End.
   if v-button-stop then  DO:
        ...
        run CalcOstatTov(input 'ie':U         , output v-sum-e, output v-sum-i) .
        assign  temp-doc.sum1 = temp-doc.sum1 + v-sum-i    .
        run CalcOstatTov(input 'ep':U      , output v-sum-e, output v-sum-i) .
        assign  temp-doc.sum1 = temp-doc.sum1 - v-sum-e .
        run CalcOstatTov(input 'ap':U    , output v-sum-e, output v-sum-i) .
...
End.
   if v-button-stop then  DO:
        ...
        run CalcOstatTov(input 'ee':U         , output v-sum-e, output v-sum-i) .
        assign  temp-doc.sum2 = temp-doc.sum2 + v-sum-e .
        run CalcOstatTov(input 'es':U    , output v-sum-e, output v-sum-i) .
        assign  temp-doc.sum2 = temp-doc.sum2 + v-sum-e .
        run CalcOstatTov(input 're':U     , output v-sum-e, output v-sum-i) .
        assign  temp-doc.sum2 = temp-doc.sum2 - v-sum-i .
        run CalcOstatTov(input 'rs':U, output v-sum-e, output v-sum-i) .
        assign  temp-doc.sum2 = temp-doc.sum2 - v-sum-i .
        run CalcOstatTov(input 'we':U         , output v-sum-e, output v-sum-i) .
        assign  temp-doc.sum2 = temp-doc.sum2 + v-sum-e .
        run CalcOstatTov(input 'wm':U          , output v-sum-e, output v-sum-i) .
        assign  temp-doc.sum2 = temp-doc.sum2 + v-sum-e .
        run CalcOstatTov(input 'vt':U               , output v-sum-e, output v-sum-i) .
        assign  temp-doc.sum2 = temp-doc.sum2 + v-sum-i - v-sum-e .
        run CalcOstatTov(input 'vp':U          , output v-sum-e, output v-sum-i) .
        assign  temp-doc.sum2 = temp-doc.sum2 + v-sum-i - v-sum-e .
        run CalcOstatTov(input 'mp':U  , output v-sum-e, output v-sum-i) .
        assign  temp-doc.sum2 = temp-doc.sum2 - v-sum-e .
      end.
      for each buf_arh-trn-doc-contract no-lock
        where buf_arh-trn-doc-contract.host-code      = v-cntxt-host-code-obj
          ...
          and ( buf_arh-trn-doc-contract.ext-doc-type = 'ie':U
           or  buf_arh-trn-doc-contract.ext-doc-type = 'ee':U
           or  buf_arh-trn-doc-contract.ext-doc-type = 'ep':U
           or  buf_arh-trn-doc-contract.ext-doc-type = 'es':U
           or  buf_arh-trn-doc-contract.ext-doc-type = 're':U
           or  buf_arh-trn-doc-contract.ext-doc-type = 'rs':U
           or  buf_arh-trn-doc-contract.ext-doc-type = 'we':U
           or  buf_arh-trn-doc-contract.ext-doc-type = 'vt':U
           or  buf_arh-trn-doc-contract.ext-doc-type = 'vp':U
           or  buf_arh-trn-doc-contract.ext-doc-type = 'wm':U
           or  buf_arh-trn-doc-contract.ext-doc-type = 'mp':U
           or  buf_arh-trn-doc-contract.ext-doc-type = 'ap':U )
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run docextnm in g#library
  ...
  ,output temp-sum.styp
        ...
        case buf_arh-trn-doc-contract.ext-doc-type :
          when 'ie':U          then assign temp-sum.type = 1     temp-sum.sum = v-sum-i .
          when 'ap':U     then assign temp-sum.type = 1     temp-sum.sum = v-sum-i - v-sum-e .
          when 'ep':U       then assign temp-sum.type = 1     temp-sum.sum = - v-sum-e .
          when 'ee':U          then assign temp-sum.type = 2     temp-sum.sum = v-sum-e .
          when 'es':U     then assign temp-sum.type = 2     temp-sum.sum = v-sum-e .
          when 're':U      then assign temp-sum.type = 2     temp-sum.sum = - v-sum-i .
          when 'rs':U then assign temp-sum.type = 2     temp-sum.sum = - v-sum-i .
          when 'we':U          then assign temp-sum.type = 2     temp-sum.sum = v-sum-e .
          when 'wm':U           then assign temp-sum.type = 2     temp-sum.sum = v-sum-e .
          when 'mp':U   then assign temp-sum.type = 2     temp-sum.sum = - v-sum-e .
          when 'vt':U                or
          when 'vp':U           then do:
  ...
  if is-fo then do:
    find last buf_arh-fin-ob-contr no-lock
      where buf_arh-fin-ob-contr.host-code      = v-cntxt-host-code-obj
        ...
        and buf_arh-fin-ob-contr.fin-ext-doc-type   = 'рас':U
      ...
      if temp-doc.sum1 = 0 and temp-doc.sum2 = 0 and temp-doc.sum3 = 0 and temp-doc.sum4 = 0 and
        ...
        for each buf_contract no-lock
          where buf_contract.host-code = v-cntxt-host-code-obj
            ...
            and buf_contract.doc-type  = 'при':U
          :
          assign v-contract-code = buf_contract.contract-code .
...
if session :set-wait-state( "compiler" ) then.
  ...
  if p-contr-code = 0 then do:
    ...
    put stream PrnLibStream  "|" at 1 "ИТОГО ОСТАТКИ:" format "X(20)" .
    ...
    put stream PrnLibStream  Line format string("X(" + string( num-col * 45 + 18) + ")") .
  end.
...
procedure PrintTitul :
  ...
  :
    ...
    assign ii = 0 .
    if is-post then do:
      put stream PrnLibStream  "|" at (1 + ii * 45) "Поставки"  at (22 + ii * 45)   format "X(20)" .
      assign ii = ii + 1 .
    end.
    if is-real then do:
...
procedure PrnSumCli :
  do on error undo, return error return-value :
    ...
    assign ii = 0 .
    if is-post then do:
      put stream PrnLibStream "|" at (26 + ii * 45)  p-sm1   format "->>>,>>>,>>>,>>9.99"  "|" at (46 + ii * 45) .
