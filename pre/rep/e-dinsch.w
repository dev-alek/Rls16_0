...
PROCEDURE adm-disable :
    DISABLE RECT-6 sort-1 sort-2 sort-3 sort-4 WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-6 sort-1 sort-2 sort-3 sort-4 WITH FRAME F-Main.
...
then do:
  ...
  display sort-1  with frame F-Main .
...
END PROCEDURE.
PROCEDURE my-var :
 assign frame F-Main sort-1 sort-2 sort-3 sort-4 .
END PROCEDURE.
