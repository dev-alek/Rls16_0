...
output stream sout to value( string( session:temp-directory +
  ...
  :
    run kfsalexl-write-cell-data in this-procedure ( input "h_date":U , input tt-obj-list.shift-date-str ).
    run kfsalexl-write-cell-data in this-procedure ( input "h_obj":U  , input tt-obj-list.obj-name       ).
    for each tt-gds
    , each tt-report
