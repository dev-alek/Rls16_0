...
PROCEDURE adm-disable :
    DISABLE RECT-detail RECT-method RECT-3 RECT-4 RS-by RS-method RS-cass T-time WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-detail RECT-method RECT-3 RECT-4 RS-by RS-method RS-cass T-time WITH FRAME F-Main.
...
ReportHeader =  "Метод формирования: " +
                            ...
                            then  (IF T-time then string(chr(10) + "Выборочно по времени") else "")
                            else "")
                            .
END PROCEDURE.
