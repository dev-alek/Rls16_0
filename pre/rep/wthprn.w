...
initial "@(#)$Workfile$ $Revision$".
        run menu-doc-create-menu-item in this-procedure
          ( input xtype
           ...
           , input xinternal
           , input xflag
           , input 'рас,при,возврат,спи':U
           , input '*'
           , input '*'
           , input '*'
           , input 'Движение материальных ценностей'
...
initial "@(#)$Workfile$ $Revision$".
        run menu-doc-create-menu-item in this-procedure
          ( input xtype
           ...
           , input '*'
           , input 'ee,pz'
           , input 'Счет-фактура обратная'
           , input 'cost,sale,rubl,base'
           , input 'rep/wthfct.p'
           , input 'no,all,no-round,yes'
           , input '--+---'
           , input ''
           , input ''
           , input ''
...
initial "@(#)$Workfile$ $Revision$".
        run menu-doc-create-menu-item in this-procedure
          ( input xtype
           ...
           , input '*'
           , input '*'
           , input 'Документ инвентаризации материальных ценностей'
           , input 'cost,sale,rubl,base'
           , input 'rep/r-w-inv.p'
           , input ''
           , input '------'
...
:
    ...
    .
define variable vss-include-info23 as character format "x(65)" no-undo initial "@(#)$Workfile:currsysk.i $ $Revision: $".
