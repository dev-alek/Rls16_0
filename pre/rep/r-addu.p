...
assign
    tdoc-date = (if ub.add-doc.status_ <> 'факт':U then ub.add-doc.doc-date else ub.add-doc.fact-date)
...
for each ub.add-line where ub.add-line.doc-code = ub.add-doc.doc-code no-lock ,
        first ub.goods where ub.goods.gds-code = ub.add-line.gds-code no-lock break by (if sort-gr then  ub.goods.grp-name else ub.goods.artic) by ub.goods.artic :
