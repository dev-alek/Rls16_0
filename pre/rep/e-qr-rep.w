...
IF NOT THIS-PROCEDURE:PERSISTENT THEN DO:
  MESSAGE "c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\rep\e-qr-rep.w should only be RUN PERSISTENT.":U
...
PROCEDURE adm-disable :
    DISABLE b-cd-pay b-file WITH FRAME fMain.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN b-cd-pay b-file WITH FRAME fMain.
