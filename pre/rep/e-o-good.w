...
PROCEDURE adm-disable :
    DISABLE RECT-9 COMBO-node TOG-inv WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-9 COMBO-node TOG-inv WITH FRAME F-Main.
...
PROCEDURE local-initialize :
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .
    Combo-node:list-items In frame F-Main = Combo-node:list-items + ',' + 'все':U      .
    Combo-node:list-items In frame F-Main = Combo-node:list-items + ',' + 'касса продажа':U      .
    Combo-node:list-items = Combo-node:list-items + ',' + 'касса возврат':U  .
    Combo-node:list-items = Combo-node:list-items + ',' + 'приход внешний':U           .
    Combo-node:list-items = Combo-node:list-items + ',' + 'приход внутренний':U           .
    Combo-node:list-items = Combo-node:list-items + ',' + 'возврат внешний':U       .
    Combo-node:list-items = Combo-node:list-items + ',' + 'возврат внутренний':U       .
    Combo-node:list-items = Combo-node:list-items + ',' + 'приход  произв.':U            .
    Combo-node:list-items = Combo-node:list-items + ',' + 'расход внешний':U           .
    Combo-node:list-items = Combo-node:list-items + ',' + 'возврат пост.':U        .
    Combo-node:list-items = Combo-node:list-items + ',' + 'списание':U           .
    Combo-node:list-items = Combo-node:list-items + ',' + 'расход внутренний':U           .
    Combo-node:list-items = Combo-node:list-items + ',' + 'расход  произв.':U            .
    Combo-node:list-items = Combo-node:list-items + ',' + 'списан. произв.':U            .
    Combo-node:list-items = Combo-node:list-items + ',' + 'инвентаризация':U                 .
    Combo-node:list-items = Combo-node:list-items + ',' + 'переоценка':U            .
    Combo-node:list-items = Combo-node:list-items + ',' +  'коррекция учетных цен':U         .
    Combo-node:list-items = Combo-node:list-items + ',' +  'смена типа приобретения':U         .
    Combo-node:list-items = Combo-node:list-items + ',' +  'пересортица':U         .
    Combo-node:screen-value in frame F-Main = 'все':U.
    display Combo-node  with frame F-Main .
END PROCEDURE.
PROCEDURE my-report :
 run rep/r-o-good.p
  ( input v-cntxt-obj-code ,
...
END PROCEDURE.
PROCEDURE my-var :
assign frame F-Main COMBO-node tog-inv .
Assign
 STR-obj-type = ''
 STR-obj-code = ''
 STR-obj-name = ''
...
ReportHeader = ReportHeader  + chr(10) + " с момента последней инвентаризации ".
            Case COMBO-node:
                when  'приход внешний':U             then   COMBO-node = 'ie':U          .
                when  'расход внешний':U             then   COMBO-node = 'ee':U          .
                when  'возврат пост.':U          then   COMBO-node = 'ep':U       .
                when  'касса продажа':U        then   COMBO-node = 'es':U     .
                when  'возврат внешний':U         then   COMBO-node = 're':U      .
                when  'касса возврат':U    then   COMBO-node = 'rs':U .
                when  'списание':U             then   COMBO-node = 'we':U          .
                when  'инвентаризация':U                   then   COMBO-node = 'vt':U                .
                when  'приход внутренний':U             then   COMBO-node = 'iv':U          .
                when  'расход внутренний':U             then   COMBO-node = 'ev':U          .
                when  'возврат внутренний':U         then   COMBO-node = 'rv':U       .
                when  'расход  произв.':U              then   COMBO-node = 'em':U            .
                when  'списан. произв.':U              then   COMBO-node = 'wm':U            .
                when  'приход  произв.':U              then   COMBO-node = 'im':U            .
                when  'пересортица':U              then   COMBO-node = 'vp':U            .
                when  'переоценка':U              then   COMBO-node = 'ot':U            .
                when  'касса'                             then   COMBO-node = 'rs':U + ',' + 'es':U.
                 when  'все':U                             then   COMBO-node = 'все':U.
            End case.
