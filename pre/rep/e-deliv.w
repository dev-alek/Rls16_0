...
PROCEDURE adm-disable :
    DISABLE rect-3 f-start-hour f-start-min f-end-hour f-end-min WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN rect-3 f-start-hour f-start-min f-end-hour f-end-min WITH FRAME F-Main.
