...
do:
    for each fin-doc where fin-doc.doc-date  >= X-date-Start and fin-doc.doc-date <= X-date-End and fin-doc.obj-code = v-obj-list-code and fin-doc.obj-type = v-obj-list-type and (fin-doc.fin-doc-type = 'рко':U or fin-doc.fin-doc-type = 'пко':U) :
...
do:
    ...
    for each fin-doc where fin-doc.doc-date  >= shift-obj.shift-date and fin-doc.obj-code = v-obj-list-code and fin-doc.obj-type = v-obj-list-type and (fin-doc.fin-doc-type = 'рко':U or fin-doc.fin-doc-type = 'пко':U) :
...
do:
    find first buf_income where buf_income.obj-code  = v-obj-list-code and buf_income.obj-type = v-obj-list-type and buf_income.fin-ext-doc-type = 'пко':U    no-lock no-error.
    find first buf_expense where buf_expense.obj-code  = v-obj-list-code and buf_expense.obj-type = v-obj-list-type and buf_expense.fin-ext-doc-type =  'рко':U  no-lock  no-error .
    do while available buf_income or available buf_expense  :
        do:
            put stream macr_excel unformatted
                ...
                '</tr>' skip
                .
            find next   buf_income   where buf_income.obj-code  = v-obj-list-code and buf_income.obj-type = v-obj-list-type and buf_income.fin-ext-doc-type = 'пко':U no-lock  no-error .
            find next  buf_expense   where buf_expense.obj-code  = v-obj-list-code and buf_expense.obj-type = v-obj-list-type and buf_expense.fin-ext-doc-type =  'рко':U no-lock no-error .
        end.
    end.
end.
do:
...
procedure define-full-path-Report-2:
    define input parameter p-rep-num as integer no-undo.
    define output parameter p-file-name-rep-htm as character no-undo.
