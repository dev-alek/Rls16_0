...
PROCEDURE adm-disable :
    DISABLE RECT-5 RECT-6 RECT-8 RECT-9 Tog-obj Classify ShowZero-2 VAT-Cost ShowZero VAT-CRSA VAT-sale SortType WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-5 RECT-6 RECT-8 RECT-9 Tog-obj Classify ShowZero-2 VAT-Cost ShowZero VAT-CRSA VAT-sale SortType WITH FRAME F-Main.
 ...
 case Classify :
  when "no-classify" then do:
     if tog-obj = true then
        run rep/tpoba-1y.p
            ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale , input no , input 1 ) .
      else
        run rep/tpoba-1n.p
            ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale , input no , input 1 ) .
  end.
