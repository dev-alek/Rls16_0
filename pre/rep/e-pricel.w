...
DEFINE VARIABLE SortType AS CHARACTER
     VIEW-AS RADIO-SET VERTICAL
     RADIO-BUTTONS
          "По группам товаров ( и артикулу )", "По группам товаров ( и артикулу )",
"Только по артикулу", "Только по артикулу"
...
PROCEDURE adm-disable :
    DISABLE RECT-1 RECT-3 RECT-4 MainTypes SET_PAY_TYPE SortType No-Prt WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-1 RECT-3 RECT-4 MainTypes SET_PAY_TYPE SortType No-Prt WITH FRAME F-Main.
