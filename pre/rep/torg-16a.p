...
initial "@(#)$Workfile$ $Revision$".
    define frame f-doc
            ...
            v-gds-name          column-label "                   3" format "X(39)"  space(0)
        ...
        with width 235 down stream-io use-text no-box no-labels.
if v-torgconf-outnum = yes
then do:
    assign
        v-doc-code = fill( " ", 10 )
...
.
    ...
    then do:
            ...
            then do:
                ...
                then do:
                    put stream out-stream
                        skip ":" v-line-string format "X(196)" ":"
                        skip
                    .
                end.
...
define input parameter p-print-line-after   as logical      no-undo.
    put stream out-stream
        skip v-line-string format "X(198)"
        skip ": N"
            ": Артикул"                          at 8
            ": Наименование "                    at 26
            ":Ед."                               at 66
