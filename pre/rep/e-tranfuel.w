...
PROCEDURE adm-disable :
    DISABLE RECT-5 RECT-8 RECT-6 RECT-9 RECT-7 RECT-10 mGds mTRK mGds-list mTRKList mTranTimeMax mCashPay mCashPay-list mChkType mChkType-list mGrpChk mGrpTran WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-5 RECT-8 RECT-6 RECT-9 RECT-7 RECT-10 mGds mTRK mGds-list mTRKList mTranTimeMax mCashPay mCashPay-list mChkType mChkType-list mGrpChk mGrpTran WITH FRAME F-Main.
...
DO:
   apply "VALUE-CHANGED" to mCashPay in frame F-Main.
END.
...
DO:
   apply "VALUE-CHANGED" to mChkType in frame F-Main.
END.
...
PROCEDURE select-cash-pays :
   ...
   mCashPay-list:screen-value in frame F-Main = vCashPay-list.
END PROCEDURE.
PROCEDURE select-chk-type :
   ...
   assign
      ...
      .
   mChkType-list:screen-value in frame F-Main = vChkType-list.
END PROCEDURE.
