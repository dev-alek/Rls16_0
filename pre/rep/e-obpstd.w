...
PROCEDURE adm-disable :
    DISABLE RECT-5 RECT-7 RECT-8 RECT-9 RADPost PostName Showcost Showgoods type-stor Tog-obj Classify ShowZero RADIO-SET-1 t-in Cli-art WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-5 RECT-7 RECT-8 RECT-9 RADPost PostName Showcost Showgoods type-stor Tog-obj Classify ShowZero RADIO-SET-1 t-in Cli-art WITH FRAME F-Main.
...
END PROCEDURE.
PROCEDURE my-var :
assign frame F-Main type-stor Cli-art.
assign frame F-Main PostName  RADPost   showcost showgoods .
assign frame F-Main ShowZero  Classify  Tog-obj  .
assign frame F-Main RADIO-SET-1 t-in.
assign frame F-Main Tog-lavel  var-lavel Tog-lavel-2  Var-lavel-2    .
Show-cost = showcost.
