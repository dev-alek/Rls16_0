...
def new  shared   var     Show-cost-vat  as logical no-undo .
def new  shared   var     Show-sale-vat  as logical no-undo .
def new  shared   var F-prih            as   char  no-undo.
def new  shared   var F-rash            as   char  no-undo.
def new  shared   var F-kassa           as   char  no-undo.
def new  shared   var F-Inv             as   char  no-undo.
def new  shared   var F-Spis            as   char  no-undo.
def new  shared  var F-vzvr   as   char  no-undo.
def new  shared  var F-vzvr-post     as   char  no-undo.
def new  shared  var F-sm        as   char  no-undo.
def new  shared  var vzvr              as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def new  shared  var vzvr-post         as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def new  shared  var prih              as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def new  shared  var rash              as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def new  shared  var kassa             as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def new  shared  var Inv               as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def new  shared  var Spis              as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def new  shared  var Sm                as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var B1-prih             as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var B1-rash             as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var B1-kassa            as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var B1-Inv              as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var B1-spis             as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var B1-vzvr             as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var B1-vzvr-post        as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var B1-sm               as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var B2-prih             as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var B2-rash             as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var B2-kassa            as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var B2-Inv              as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var B2-spis             as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var B2-vzvr             as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var B2-vzvr-post        as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var B2-sm               as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var Bi-prih             as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var Bi-rash             as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var Bi-kassa            as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var Bi-Inv              as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var Bi-spis             as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var Bi-vzvr             as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var Bi-vzvr-post        as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var Bi-sm               as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var o-prih             as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var o-rash             as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var o-kassa            as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var o-Inv              as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var o-spis             as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var o-vzvr             as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var o-vzvr-post        as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var o-sm               as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var p-prih             as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var p-rash             as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var p-kassa            as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var p-Inv              as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var p-spis             as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var p-vzvr             as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var p-vzvr-post        as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
def  new  shared  var p-sm               as   decimal EXTENT 10 Format "->>>>>>>>>>>9.<<<" no-undo.
