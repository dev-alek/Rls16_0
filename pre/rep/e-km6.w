...
define variable vss-description as character no-undo init "вызов второй страницы параметров отчета КМ-6".
...
IF NOT THIS-PROCEDURE:PERSISTENT THEN DO:
  MESSAGE "c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\rep\e-km6.w should only be RUN PERSISTENT.":U
...
PROCEDURE adm-disable :
    DISABLE RECT-7 BUTTON-cash-desk f-list-kkm BR-cash-desk t-excel t-TEXT f-sel-kkm WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-7 BUTTON-cash-desk f-list-kkm BR-cash-desk t-excel t-TEXT f-sel-kkm WITH FRAME F-Main.
...
OPEN QUERY BR-cash-desk FOR EACH tt-cash-desk NO-LOCK INDEXED-REPOSITION.
END.
...
PROCEDURE my-var :
assign
ReportHeader = "Выбор касс: " + chr(10) + v-cash-num
.
END PROCEDURE.
