...
view stream outstream frame bottomframe .
 ...
 Else do:
    CAse classify :
      when 1 then do:
        Run Foreach1_1 in this-procedure.
      end.
      when 2 then do:
        Run Foreach2_1 in this-procedure.
      end.
      when 3 then do:
        Run Foreach3_1 in this-procedure.
      end.
      when 4 then do:
        Run Foreach4_1 in this-procedure.
      end.
    End case.
 End.
       ...
       first gds-list where  gds-list.prod-type  = ub.ot-line.prod-type and
        ...
        if can-find( first tdedt where  ub.ot-line.ext-doc-type = tdedt.id no-lock ) then do:
            case  ub.ot-line.sum-type :
                when 'cost':U then do:
                    f-cost-sum = f-cost-sum + ub.ot-line.sum-rubl .
                end.
                when 'sale':U then do:
                    f-sale-sum   = f-sale-sum   +  ub.ot-line.sum-rubl .
                    f-sale-other = f-sale-other + ub.ot-line.other-rubl .
                end.
                when  'crsa':U then do:
                    f-crsa-sum = f-crsa-sum + ub.ot-line.sum-rubl  .
                    ...
                    if itog = false then do:
                        ...
                        assign
                            ...
                            temp-doc-code.si2 = if  ub.ot-line.other-rubl < 0 then -1 else 1
                            .
                    end.
                end.
            end case.
            ...
            case  ub.ot-line.sum-type :
                when 'cost':U then do:
                  f-cost-sum-all = f-cost-sum-all + ub.ot-line.sum-rubl .
                end.
                when  'crsa':U then do:
                  f-crsa-sum-all = f-crsa-sum-all + ub.ot-line.sum-rubl  .
            ...
            assign
                ...
                temp-doc-code-all.si2 = if  ub.ot-line.other-rubl < 0 then -1 else 1
                .
        ...
        if avail gds-obj then do:
          ...
          assign
            ...
            assign
              ...
              f-cost-sum-o = gds-obj.fact-rubl
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run gdsbcode in g#library
  ...
  ,output v-bar-code
          ...
          accumulate f-qnty-all       (total  by ub.ot-line.prod-code ) .
          accumulate f-cost-sum-all   (total  by ub.ot-line.prod-code ) .
          accumulate f-crsa-sum-all   (total  by ub.ot-line.prod-code ) .
          accumulate f-qnty-o         (total  by ub.ot-line.prod-code ) .
          accumulate f-cost-sum-o     (total  by ub.ot-line.prod-code ) .
          accumulate f-crsa-sum-o     (total  by ub.ot-line.prod-code ) .
            assign
              f-qnty          = 0
              f-crsa-sum      = 0
              f-qnty          = 0
      ...
      if last-of(ub.ot-line.prod-code)  then do :
        f-artic = 'по произв.' .
  if c-nn <>  ?  then do :
    c-nn:screen-value = string('Итого') .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
  ...
  End.
  if c-f-qnty-all <>  ?  then do :
    c-f-qnty-all:screen-value = string(accum total by  ub.ot-line.prod-code  f-qnty-all) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-cost-sum-all <>  ?  then do :
    c-f-cost-sum-all:screen-value = string(accum total by  ub.ot-line.prod-code  f-cost-sum-all) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-crsa-sum-all <>  ?  then do :
    c-f-crsa-sum-all:screen-value = string(accum total by  ub.ot-line.prod-code  f-crsa-sum-all) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-qnty-o <>  ?  then do :
    c-f-qnty-o:screen-value = string(accum total by  ub.ot-line.prod-code  f-qnty-o) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-cost-sum-o <>  ?  then do :
    c-f-cost-sum-o:screen-value = string(accum total by  ub.ot-line.prod-code  f-cost-sum-o) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-crsa-sum-o <>  ?  then do :
    c-f-crsa-sum-o:screen-value = string(accum total by  ub.ot-line.prod-code  f-crsa-sum-o) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
          ...
          excel-sum (accum total by ub.ot-line.prod-code  f-crsa-sum       )   CHR(9)
          excel-sum (accum total by ub.ot-line.prod-code  f-qnty-all       )   CHR(9)
          excel-sum (accum total by ub.ot-line.prod-code  f-cost-sum-all   )   CHR(9)
          excel-sum (accum total by ub.ot-line.prod-code  f-crsa-sum-all   )   CHR(9)
          excel-sum (accum total by ub.ot-line.prod-code  f-qnty-o         )   CHR(9)
          excel-sum (accum total by ub.ot-line.prod-code  f-cost-sum-o     )   CHR(9)
          excel-sum (accum total by ub.ot-line.prod-code  f-crsa-sum-o     )   chr(10) .
      end.
end.
run u-line.
  if c-nn <>  ?  then do :
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run gdsbcode in g#library
  ...
  ,output v-bar-code
          ...
          accumulate f-crsa-sum       (total  by gds-list.qnty ) .
          accumulate f-qnty-all       (total  by gds-list.qnty ) .
          accumulate f-cost-sum-all   (total  by gds-list.qnty ) .
          accumulate f-crsa-sum-all   (total  by gds-list.qnty ) .
          accumulate f-qnty-o         (total  by gds-list.qnty ) .
          accumulate f-cost-sum-o     (total  by gds-list.qnty ) .
          accumulate f-crsa-sum-o     (total  by gds-list.qnty ) .
            assign
              f-qnty          = 0
              f-crsa-sum      = 0
              f-qnty          = 0
  ...
  End.
  if c-f-crsa-sum <>  ?  then do :
    c-f-crsa-sum:screen-value = string(accum total by  gds-list.qnty  f-crsa-sum) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-qnty-all <>  ?  then do :
    c-f-qnty-all:screen-value = string(accum total by  gds-list.qnty  f-qnty-all) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-cost-sum-all <>  ?  then do :
    c-f-cost-sum-all:screen-value = string(accum total by  gds-list.qnty  f-cost-sum-all) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-crsa-sum-all <>  ?  then do :
    c-f-crsa-sum-all:screen-value = string(accum total by  gds-list.qnty  f-crsa-sum-all) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-qnty-o <>  ?  then do :
    c-f-qnty-o:screen-value = string(accum total by  gds-list.qnty  f-qnty-o) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-cost-sum-o <>  ?  then do :
    c-f-cost-sum-o:screen-value = string(accum total by  gds-list.qnty  f-cost-sum-o) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-crsa-sum-o <>  ?  then do :
    c-f-crsa-sum-o:screen-value = string(accum total by  gds-list.qnty  f-crsa-sum-o) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
          ...
          excel-sum (accum total by gds-list.qnty  f-crsa-sum       )   CHR(9)
          excel-sum (accum total by gds-list.qnty  f-qnty-all       )   CHR(9)
          excel-sum (accum total by gds-list.qnty  f-cost-sum-all   )   CHR(9)
          excel-sum (accum total by gds-list.qnty  f-crsa-sum-all   )   CHR(9)
          excel-sum (accum total by gds-list.qnty  f-qnty-o         )   CHR(9)
          excel-sum (accum total by gds-list.qnty  f-cost-sum-o     )   CHR(9)
          excel-sum (accum total by gds-list.qnty  f-crsa-sum-o     )   chr(10) .
      end.
end.
run u-line.
  if c-nn <>  ?  then do :
...
if Make-Excel then  put   stream ForExcel unformatted  obj-list.obj-name chr(10).
 ...
 For Each gds-obj where
          ...
          , First gds-list where   gds-list.prod-type = gds-obj.prod-type and
            ...
            break
             ...
             IF first-of(gds-obj.artic) then DO:
              ...
              End.
            End.
          if first-of(gds-obj.prod-code) then DO:
  ...
  End.
          ...
          if last-of(gds-obj.artic) then DO:
          run last-of-artic.
              accumulate f-qnty           (TOTAL  by gds-obj.prod-code ) .
              accumulate f-cost-sum       (TOTAL  by gds-obj.prod-code ) .
              accumulate f-sale-sum       (TOTAL  by gds-obj.prod-code ) .
              accumulate f-sale-other     (TOTAL  by gds-obj.prod-code ) .
              accumulate f-crsa-sum       (TOTAL  by gds-obj.prod-code ) .
              accumulate f-qnty-all       (TOTAL  by gds-obj.prod-code ) .
              accumulate f-cost-sum-all   (TOTAL  by gds-obj.prod-code ) .
              accumulate f-crsa-sum-all   (TOTAL  by gds-obj.prod-code ) .
              accumulate f-qnty-o         (TOTAL  by gds-obj.prod-code ) .
              accumulate f-cost-sum-o     (TOTAL  by gds-obj.prod-code ) .
              accumulate f-crsa-sum-o     (TOTAL  by gds-obj.prod-code ) .
                Assign
                  f-qnty          = 0
                  f-crsa-sum      = 0
                  f-qnty          = 0
                 ...
                 .
          End.
          if last-of(gds-obj.prod-code)  then do :
            f-artic = 'по произв.' .
  if c-nn <>  ?  then do :
    c-nn:screen-value = string('Итого') .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
  ...
  End.
  if c-f-qnty <>  ?  then do :
    c-f-qnty:screen-value = string(accum TOTAL by gds-obj.prod-code f-qnty    ) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-cost-sum <>  ?  then do :
    c-f-cost-sum:screen-value = string(accum TOTAL by gds-obj.prod-code f-cost-sum ) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-sale-sum <>  ?  then do :
    c-f-sale-sum:screen-value = string(accum TOTAL  by gds-obj.prod-code  f-sale-sum) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-sale-other <>  ?  then do :
    c-f-sale-other:screen-value = string(accum TOTAL by  gds-obj.prod-code  f-sale-other) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-crsa-sum <>  ?  then do :
    c-f-crsa-sum:screen-value = string(accum TOTAL by  gds-obj.prod-code  f-crsa-sum) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-qnty-all <>  ?  then do :
    c-f-qnty-all:screen-value = string(accum TOTAL by  gds-obj.prod-code  f-qnty-all) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-cost-sum-all <>  ?  then do :
    c-f-cost-sum-all:screen-value = string(accum TOTAL by  gds-obj.prod-code  f-cost-sum-all) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-crsa-sum-all <>  ?  then do :
    c-f-crsa-sum-all:screen-value = string(accum TOTAL by  gds-obj.prod-code  f-crsa-sum-all) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-qnty-o <>  ?  then do :
    c-f-qnty-o:screen-value = string(accum TOTAL by  gds-obj.prod-code  f-qnty-o) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-cost-sum-o <>  ?  then do :
    c-f-cost-sum-o:screen-value = string(accum TOTAL by  gds-obj.prod-code  f-cost-sum-o) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
  if c-f-crsa-sum-o <>  ?  then do :
    c-f-crsa-sum-o:screen-value = string(accum TOTAL by  gds-obj.prod-code  f-crsa-sum-o) .
    IF ( line-counter( OutStream )  modulo page-size( OutStream ) = 0 ) AND
        ( line-counter( OutStream ) >= page-size( OutStream ) )          then DO:
        display STREAM OutStream    with frame top-frame .
    End.
  End.
              ...
              'по произв.'
              var-client                                           CHR(9) CHR(9)
              excel-qnty(accum TOTAL by gds-obj.prod-code  f-qnty           )    CHR(9)
              excel-sum (accum TOTAL by gds-obj.prod-code  f-cost-sum       )   CHR(9)
              excel-sum (accum TOTAL by gds-obj.prod-code  f-sale-sum       )   CHR(9)
              excel-sum (accum TOTAL by gds-obj.prod-code  f-sale-other     )   CHR(9)
              excel-sum (accum TOTAL by gds-obj.prod-code  f-crsa-sum       )   CHR(9)
              excel-sum (accum TOTAL by gds-obj.prod-code  f-qnty-all       )   CHR(9)
              excel-sum (accum TOTAL by gds-obj.prod-code  f-cost-sum-all   )   CHR(9)
              excel-sum (accum TOTAL by gds-obj.prod-code  f-crsa-sum-all   )   CHR(9)
              excel-sum (accum TOTAL by gds-obj.prod-code  f-qnty-o         )   CHR(9)
              excel-sum (accum TOTAL by gds-obj.prod-code  f-cost-sum-o     )   CHR(9)
              excel-sum (accum TOTAL by gds-obj.prod-code  f-crsa-sum-o     )   chr(10) .
          End.
End.
 run u-line.
  if c-nn <>  ?  then do :
        ...
        ub.gds-dtl.obj-type   = obj-list.obj-type :
            find first temp-doc-code where temp-doc-code.doc-code = ub.gds-dtl.doc-code no-lock no-error .
              ...
              Assign
                  ...
                  p-sale-sum   = p-sale-sum   + (gds-dtl.price-rubl * t-qnty)
                  p-sale-other = p-sale-other + (gds-dtl.discnt-rubl * temp-doc-code.si2)
