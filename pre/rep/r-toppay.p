...
procedure Proc-b-code-excel:
  ...
  CASE my-set_val_type :
    when 2 then
      do:
        Report:table-columns("60,60,150,30,30,120,70,70").
        Report:table-types = "String,String,String,String,String,String,Qnty,Number".
        Report:table-header("Дата|Код|Вид топлива|Вид опл.|Вал|Метод платежа|Литры|Сумма","40","9").
      end.
    when 3 then
      do:
        Report:table-columns("60,60,125,30,30,120,70,70,70,70").
        Report:table-types = "String,String,String,String,String,String,Qnty,String,Number,Number".
        Report:table-header("Дата|Код|Вид топлива|Вид опл.|Вал|Метод платежа|Литры|Сумма в валюте|Сумма в Баз. валюте|Сумма в рублях","40","9").
      end.
  END CASE .
