   ...
   for each buf_tt-line
      ...
      :
            put stream excel-line unformatted
                                 "Лист1":U
                  CHR(9)   "DTA":U
                  CHR(9)   buf_tt-line.trans-id
                  CHR(9)   buf_tt-line.obj-code
                  CHR(9)   buf_tt-line.pos-type
                  CHR(9)   buf_tt-line.cash-num
                  CHR(9)   buf_tt-line.db-num
                  CHR(9)   buf_tt-line.shift-num
                  CHR(9)   buf_tt-line.shift-date
                  CHR(9)   buf_tt-line.shift-name
                  CHR(9)   buf_tt-line.user-id
                  CHR(9)   string(buf_tt-line.event-date, "99/99/9999")
                  CHR(9)   STRING(buf_tt-line.event-time, "HH:MM:SS")
                  CHR(9)   buf_tt-line.event-name
                  CHR(9)   buf_tt-line.event-type
                  CHR(9)   buf_tt-line.cd-mode
                  CHR(9)   buf_tt-line.doc-code
                  CHR(9)   buf_tt-line.chk-type
                  CHR(9)   buf_tt-line.src-code
                  CHR(9)   buf_tt-line.gds-code
                  CHR(9)   buf_tt-line.doc-qnty
                  CHR(9)   buf_tt-line.d-card
                  CHR(9)   buf_tt-line.tot-sum
                  CHR(9)   buf_tt-line.pay-card
                  CHR(9)   buf_tt-line.discnt
                  CHR(9)   buf_tt-line.description
                  CHR(9)   buf_tt-line.action-item-id
                  CHR(9)   buf_tt-line.price
                  chr(10)
            .
   end.
end.
   ...
   FOR EACH  buf_cd-event-log
       WHERE
         ...
         AND
            (     p-event-list = "All":U
              OR  p-event-list = "":U
              OR  LOOKUP(string(buf_cd-event-log.event-id), v-events-list, chr(44) ) > 0
            )
         AND
            (     p-cd-list = "All":U
              OR  p-cd-list = "":U
              OR  LOOKUP(string(buf_cd-event-log.cash-num), v-cash-list, chr(44) ) > 0
            )
         AND
            (     p-event-type = "All":U
              OR  p-event-type = "":U
