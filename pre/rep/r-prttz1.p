...
view stream outstream frame bottomframe .
  ...
  if p-tog-obj = true then do:
    ...
    case classify :
      when 1 then do:
        Run Foreach1t in this-procedure.
      end.
      when 2 then do:
        Run Foreach2t in this-procedure.
      end.
      when 3 then do:
        Run Foreach3t in this-procedure.
      end.
      when 4 then do:
        Run Foreach4t in this-procedure.
      end.
      end case.
 end.
     ...
     do while pr-cursor < num-entries(v-prizn,","):
         ...
         if entry(pr-cursor,v-prizn,",") <> "" then do:
             ...
             buf_gds-obj.obj-code =  sl-obj-list.obj-code :
                 ...
                 assign
                    ...
                    f-cost-sum   = f-cost-sum + if buf_gds-obj.fact-qnty = 0 then 0 else prt-obj.fact-qnty * determined(buf_gds-obj.fact-rubl) / buf_gds-obj.fact-qnty
                    ...
                    f-cost-pr   = if prt-obj.fact-qnty  = 0 then 0 else determined(buf_gds-obj.fact-rubl) / buf_gds-obj.fact-qnty
       ...
       for each sl-obj-list,
           ...
           assign
            ...
            f-cost-sum   = f-cost-sum  + determined(buf_gds-obj.fact-rubl)
