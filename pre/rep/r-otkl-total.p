...
for each thbjattr_thbj-attr :
  if thbjattr_thbj-attr.prop-code = 'otkl-fact-volue':U then assign v-otkl-fact-volue = thbjattr_thbj-attr.property-value-decimal .
end.
for each thbjattr_thbj-attr :
  if thbjattr_thbj-attr.prop-code = 'otkl-water':U then assign v-otkl-water = thbjattr_thbj-attr.property-value-decimal .
end.
for each thbjattr_thbj-attr :
  if thbjattr_thbj-attr.prop-code = 'otkl-temp':U then assign v-otkl-temp = thbjattr_thbj-attr.property-value-decimal .
end.
for each thbjattr_thbj-attr :
  if thbjattr_thbj-attr.prop-code = 'otkl-density':U then assign v-otkl-density = decimal(thbjattr_thbj-attr.property-value-character) .
end.
...
case true:
  ...
  v-vid-param =
    ...
    "NumShop=" + string(pobj-code) + chr(4) +
    "PlCode=" + string (buf_temp-rvs.pl-code) + chr(4) +
    "VolumeStart=" + string(buf_temp-rvs.qnty1) + chr(4) +
    "DensityStart=" + string(buf_temp-rvs.density1) + chr(4) +
    "TemperatureStart=" + string(buf_temp-rvs.temp1) + chr(4) +
    "LevelWaterStart=" + string(buf_temp-rvs.water1) + chr(4) +
    "CurrentVolume=" + string(buf_temp-rvs.qnty4) + chr(4) +
    "CurrentDensity=" + string(buf_temp-rvs.density2) + chr(4) +
    "CurrentTemperature=" + string(buf_temp-rvs.temp2) + chr(4) +
    "CurrentLevelWater=" + string(buf_temp-rvs.water2) + chr(4) +
    "DivergenceVolume=" + string(buf_temp-rvs.delta-qnty) + chr(4) +
    "DivergenceDensity=" + string(buf_temp-rvs.delta-density) + chr(4) +
    "DivergenceTemperature=" + string(buf_temp-rvs.delta-temp) + chr(4) +
    "DivergenceLevelWater=" + string(buf_temp-rvs.delta-water) + chr(4) +
