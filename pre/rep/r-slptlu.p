...
run adm/shattri.p (
  ...
  :
    ...
    assign
      ...
      SheetF.Excel-Column-Lable = "Дата"              + chr(44) +
                                  "Покупатель"        + chr(44) +
                                  "Итого"             + chr(44) +
                                  "":U
    ...
    :
      ...
      .
      assign
        SheetF.Excel-Column-Lable = SheetF.Excel-Column-Lable + chr(44) +
                                    replace( gds-ptrl.gds-name, chr(44), chr(32) )
                                                              + chr(44)
                                                              + chr(44)
        ext-column-label          = ext-column-label          + chr(44) +
                                    "Кол-во (л)"              + chr(44) +
                                    "Цена реализ"             + chr(44) +
                                    "Сумма реализ"
        ...
        SheetF.Sizes              = SheetF.Sizes + chr(44) + "12" +
                                                   chr(44) + "12" +
                                                   chr(44) + "12"
        SheetF.MergeCellsH        = SheetF.MergeCellsH                + chr(44) +
                                    string( j_columns-total * 3 + 2 ) + ":"           +
                                    string( j_columns-total * 3 + 4 )
      .
    end.
    assign
      SheetF.Excel-Column-Lable = SheetF.Excel-Column-Lable + chr(10) + ext-column-label
    .
    ...
    then do:
      ...
      for each bf_shift-obj no-lock where
               ...
               bf_shift-obj.status_     = 'зкр':U      and
        ...
        then do:
          assign
            ...
            v-green-row  = v-green-row  +
                           ( if v-green-row = "":U then "":U else chr(44) ) +
      ...
      assign
        ...
        Sheetf.Bas-Params    = "Petrol"                               + chr(4) +
                               string(              j_total-rows    ) + chr(4) +
                               string(              j_columns-total ) + chr(4) +
                                                                        chr(4) +
                               string( num-entries( v-green-row   ) ) + chr(4) +
                               v-green-row
      ...
      :
        ...
        case j_line-counter :
          when 1
          then do:
            if gds-line.shift-name = "И Т О Г О"
            then do:
              put stream text_out unformatted
                ":" + fill( " ":U, 10 )
              .
              if Make-Excel then  put   stream ForExcel unformatted
                string( gds-line.shift-name, "x(10)":U      ) CHR(9)
              .
            end.
            else do:
              put stream text_out unformatted
        ...
        .
        if Make-Excel then  put   stream ForExcel unformatted
          string(         gds-line.pay-name,   "x(17)":U ) CHR(9)
          string( OutDec( gds-line.all-qnty ), "x(12)":U ) CHR(9)
        .
        if gds-line.is-cash = no
        then do:
          put stream text_out unformatted
          ...
          .
          if Make-Excel then  put   stream ForExcel unformatted
            string( OutDec( gds-line.all-sum ), "x(12)":U ) CHR(9)
          .
        end.
        ...
        :
          ...
          then do:
            ...
            .
            if Make-Excel then  put   stream ForExcel unformatted
              string( OutDec( gds-cell.gds-qnty  ), "x(12)":U ) CHR(9)
            .
            if gds-cell.is-cash = no
            then do:
              put stream text_out unformatted
              ...
              then do:
                ...
                .
                if Make-Excel then  put   stream ForExcel unformatted
                  string( OutDec( gds-cell.gds-price ), "x(12)":U ) CHR(9)
                .
              end.
              else do:
                put stream text_out unformatted
              ...
              .
              if Make-Excel then  put   stream ForExcel unformatted
                string( OutDec( gds-cell.gds-sum ), "x(12)":U ) CHR(9)
              .
            end.
          end.
          else do:
      ...
      then do:
        ...
        assign
          ...
          SheetF.Excel-Column-Lable = "Дата"              + chr(44) +
                                      ...
                                      "ИТОГО:"            + chr(44) +
                                                            chr(44) +
                             replace( tt_object.obj-name,   chr(44) , chr(32) )
                                                          + chr(44)
                                                          + chr(44)
                                                          + chr(44) + chr(10)
                                                          + chr(44)
        ...
        :
          ...
          .
          if Make-Excel then  put   stream ForExcel unformatted
            string( OutDec( d_total-qnty ), "x(12)":U ) CHR(9)
          .
          if gds-line.is-cash <> no
          then do:
            if gds-line.is-cash = yes
            then do:
              ...
              .
              if Make-Excel then  put   stream ForExcel unformatted
                string( OutDec( d_gas-price ), "x(12)":U ) CHR(9)
              .
            end.
            else do:
              put stream text_out unformatted
            ...
            .
            if Make-Excel then  put   stream ForExcel unformatted
              string( OutDec( d_total-sum ), "x(12)":U ) CHR(9)
            .
          end.
          else do:
            put stream text_out unformatted
  ...
  assign
    ...
    SheetF.ColFormat   = "":U
    SheetF.Sizes       = "9,20"
    v-column-label-1   = "На ........ Месяца" + chr(44) +
                         "Вид н.п."
    v-column-label-2   = "":U                 + chr(44) +
                         "":U
    v-column-label-3   = "":U                 + chr(44) +
                         "":U
    v-column-label-4   = "":U                 + chr(44) +
                         "":U
    v-merge-cells-h1   = "":U
    v-merge-cells-h2   = "":U
    v-merge-cells-h3   = "":U
  ...
  :
    assign
      v-column-label-1 = v-column-label-1                                            + chr(44) +
                         replace( tt_object.obj-name, chr(44), chr(32) ) + chr(44)
                                                                                     + chr(44)
                                                                                     + chr(44)
                                                                                     + chr(44)
                                                                                     + chr(44)
                                                                                     + chr(44)
      v-column-label-2 = v-column-label-2 + chr(44) +
                         "Приход"         + chr(44) +
                         "Расход"         + chr(44)
                                          + chr(44)
                                          + chr(44)
                                          + chr(44)
                                          + chr(44)
      v-column-label-3 = v-column-label-3 + chr(44) +
                         "":U             + chr(44) +
                         "нал"            + chr(44) +
                         "грн."           + chr(44)
                                          + chr(44)
                                          + chr(44)
                                          + chr(44)
      v-column-label-4 = v-column-label-4 + chr(44) +
                         "":U             + chr(44) +
                         "":U
    .
    assign
  ...
  do jj = 1 to j_excel-col :
    ...
    assign
      ...
      SheetF.Sizes       = SheetF.Sizes       + chr(44) + "12"
                                              + chr(44) + "12"
                                              + fill( chr(44) + "12", tt_obj-pay.pay-num )
      SheetF.ColFormat   = SheetF.ColFormat   + ";"           + string( j_excel-pay + 1 ) + "=" + "0" + v-delim + "00"
                                              + ";"           + string( j_excel-pay + 2 ) + "=" + "0" + v-delim + "00"
      v-merge-cells-h1   = v-merge-cells-h1   + chr(44) + string( j_excel-pay + 1 ) + ":"
                                                              + string( j_excel-pay + tt_obj-pay.pay-num + 2 )
      v-merge-cells-h2   = v-merge-cells-h2   + chr(44) + string( j_excel-pay + 2 ) + ":"
                                                              + string( j_excel-pay + tt_obj-pay.pay-num + 2 )
      v-merge-cells-h3   = v-merge-cells-h3   + chr(44) + string( j_excel-pay + 3 ) + ":"
                                                              + string( j_excel-pay + tt_obj-pay.pay-num + 2 )
    .
    ...
    assign
      ...
      v-params-adding = v-params-adding
                      + ( if v-params-adding = "":U then "":U else chr(44) )
                      + string( j_excel-pay )
    .
  end.
  assign
    num-monthes     = CalcMonthes( x-Date-Start, x-Date-End )
    v-params-adding = v-params-adding       + chr(4) +
                      string( num-monthes ) + chr(4) +
                      "9"
  .
  do jj = 1 to num-monthes - 1 :
    assign
      v-params-adding = v-params-adding + chr(44) + string( j_excel-row * jj + 9 )
    .
  end.
  assign
    SheetF.Excel-Column-Lable = v-column-label-1 + chr(10) +
                                v-column-label-2 + chr(10) +
                                v-column-label-3 + chr(10) +
                                v-column-label-4
    ...
    Sheetf.Bas-File           = "slptrluk.bas"
    Sheetf.Bas-Param-Add      = yes
    Sheetf.Bas-Params         = "Info"                + chr(4) +
                                string( j_excel-row ) + chr(4) +
                                string( j_excel-col ) + chr(4) +
                                v-params-adding
    SheetF.ColFormat          = SheetF.ColFormat      + chr(4) +
                                                        chr(4) +
                               "Справочно Цены"
...
if (valid-handle(ibs.th.gbl.gbl-hndllib:g#lib-trn) <> true) then do:   run str/lib-trn.p persistent no-error .   if error-status :error or (valid-handle(ibs.th.gbl.gbl-hndllib:g#lib-trn) <> true) then do:     message       "Error starting lib-trn.p" skip       ibs.th.gbl.gbl-hndllib:g#lib-trn skip       ibs.th.gbl.gbl-hndllib:g#lib-trn :type skip       ibs.th.gbl.gbl-hndllib:g#lib-trn :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run lib-trn_is-petrl in g#lib-trn
  ...
  , output is-pieces
      ...
      find first bf_doc-line no-lock where
                 ...
                 bf_doc-line.ext-doc-type  = 'es':U and
