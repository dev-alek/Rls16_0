...
do:
  ...
  run rep/d-report.w ( input parparentproc
                  ...
                  ,input ('Динамика движения товара' + chr(32) + "код товара:" + chr(32) +
                          string(buf_goods.gds-code) + chr(32) + "артикул:" + chr(32) +
                          buf_goods.artic + chr(32) +
                          buf_goods.prod-type + string(buf_goods.prod-code) + chr(32) +
                          buf_goods.gds-name)
                  ,input 0
                  ,input "":U
                  ,input "*"
