...
def var vss-description as character no-undo init "Отчет по межфирменным операциям - динамика продаж  (закладка № 2)".
...
PROCEDURE my-report :
 ...
 run rep/r-hold1.p  ( input dat ) .
END PROCEDURE.
PROCEDURE my-var :
  assign frame F-Main dat .
  ReportNAme = "Динамика продаж за "  + String(dat) + " год." .
  if x-SET_val_TYPE = 1 then ReportHeader = "Цены указаны в: рублях".
