...
PROCEDURE adm-disable :
    DISABLE RECT-5 RECT-6 RECT-8 Tog-obj SortType Classify RADIO-SET-1 tog-kass tog-ras tog-voz Tog-1 week-1 week-12 week-2 week-22 week-3 week-32 week-4 week-42 week-5 week-52 WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-5 RECT-6 RECT-8 Tog-obj SortType Classify RADIO-SET-1 tog-kass tog-ras tog-voz Tog-1 week-1 week-12 week-2 week-22 week-3 week-32 week-4 week-42 week-5 week-52 WITH FRAME F-Main.
...
if tog-obj = true  then do:
      run cus/r-benet4.p (input v-cntxt-obj-code,input v-cntxt-obj-type,input base-type, input base-code, input Classify, input SortType, input false, input false, input Tog-obj, input tog-lavel, input var-lavel, input radio-set-1,input max-amount, input max-amount-2,input min-sum, input tog-kass,input tog-ras, input tog-voz, input fo1,input fo12, input fo2,input fo22,input fo3,input fo32,input fo4,input fo42,input fo5,input fo52,input tog-1 ). .
end.
Else do:
        run cus/r-bene4n.p (input v-cntxt-obj-code,input v-cntxt-obj-type,input base-type, input base-code, input Classify, input SortType, input false, input false, input Tog-obj, input tog-lavel, input var-lavel, input radio-set-1,input max-amount, input max-amount-2,input min-sum, input tog-kass,input tog-ras, input tog-voz, input fo1,input fo12, input fo2,input fo22,input fo3,input fo32,input fo4,input fo42,input fo5,input fo52,input tog-1 ). .
End.
END PROCEDURE.
PROCEDURE my-var :
