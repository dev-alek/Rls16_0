...
PROCEDURE adm-disable :
    DISABLE RECT-7 no-null WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-7 no-null WITH FRAME F-Main.
...
display no-null WITH FRAME F-Main.
