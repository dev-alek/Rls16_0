...
define temp-table alc-sale-licenses
...
define temp-table part-1
    ...
    field remain-21         as   decimal decimals 5
...
define temp-table alc-supp-licenses
    field id             as   integer
...
PROCEDURE adm-disable :
    DISABLE RECT-13 RADIO-SET-ver FILL-IN-kor RADIO-SET-form FILL-IN-exp-date RADIO-ALC-PRODUCER EDITOR-ALC-PRODUCER RADIO-SUPPLIER EDITOR-SUPPLIER RADIO-ALC-TYPE EDITOR-ALC-TYPE TOGGLE-Excel TOGGLE-XML TOGGLE-KPP WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-13 RADIO-SET-ver FILL-IN-kor RADIO-SET-form FILL-IN-exp-date RADIO-ALC-PRODUCER EDITOR-ALC-PRODUCER RADIO-SUPPLIER EDITOR-SUPPLIER RADIO-ALC-TYPE EDITOR-ALC-TYPE TOGGLE-Excel TOGGLE-XML TOGGLE-KPP WITH FRAME F-Main.
...
for each buf_alc-sale-lic no-lock where buf_alc-sale-lic.cli-code = v-cntxt-host-code-obj
                                  and   buf_alc-sale-lic.cli-type = 'орг':U
                                  and   buf_alc-sale-lic.date-to >= x-date-start
                                  and   buf_alc-sale-lic.date-from <= x-date-end:
...
output stream logStr to value("alc-dec_errors.txt") .
v-inn-err = false.
...
procedure print-info :
    ...
    v-act-file  = session:temp-directory + "rpt" +  "alc-dec_parts-info.html".
        ...
        '<!doctype html>
              ...
              <style>
                ...
                .class2 ~{font-family: Arial;~}
                  ...
                  <tr>
                        <td colspan="28" style="front-weight: bold; text-align: center;">Информация по партиям для алкогольной декларации</td>
                  </tr>
        </thead>
            <tbody>
                <tr>
...
PROCEDURE local-initialize :
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .
    ...
    display EDITOR-ALC-PRODUCER EDITOR-SUPPLIER EDITOR-ALC-TYPE TOGGLE-Excel TOGGLE-XML TOGGLE-KPP FILL-IN-exp-date with frame F-Main.
    assign FILL-IN-kor:hidden in frame F-Main = true.
END PROCEDURE.
PROCEDURE my-params :
END PROCEDURE.
