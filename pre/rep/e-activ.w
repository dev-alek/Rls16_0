...
PROCEDURE adm-disable :
    DISABLE rect-3 rect-5 rect-7 SelectDC chk-obj chk-dc chk-dc-num chk-dc-cli fill-days WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN rect-3 rect-5 rect-7 SelectDC chk-obj chk-dc chk-dc-num chk-dc-cli fill-days WITH FRAME F-Main.
...
PROCEDURE view-page :
  ...
  RUN broker-view-page IN adm-broker-hdl (INPUT THIS-PROCEDURE,
      INPUT p-page#).
  END PROCEDURE.
ON VALUE-CHANGED OF chk-dc IN FRAME F-Main
DO:
  assign chk-dc-cli.
  assign chk-dc-num.
  assign chk-dc.
...
ON VALUE-CHANGED OF chk-dc-cli IN FRAME F-Main
DO:
  assign chk-dc-cli.
  assign chk-dc-num.
  assign chk-dc.
...
END.
ON VALUE-CHANGED OF chk-dc-num IN FRAME F-Main
DO:
  assign chk-dc-cli.
  assign chk-dc-num.
  assign chk-dc.
...
END.
ON VALUE-CHANGED OF chk-obj IN FRAME F-Main
DO:
  assign chk-obj.
END.
