...
IF NOT THIS-PROCEDURE:PERSISTENT THEN DO:
  MESSAGE "c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\rep\e-tobacco-marks.w should only be RUN PERSISTENT.":U
...
PROCEDURE adm-disable :
    DISABLE v-group-pack WITH FRAME fMain.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN v-group-pack WITH FRAME fMain.
...
DO:
  assign v-group-pack .
  display v-group-pack with frame fMain.
END.
