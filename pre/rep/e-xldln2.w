...
DEFINE FRAME F-Main
     ...
     RECT-5 AT ROW 1 COL 1 WIDGET-ID 4
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY
         SIDE-LABELS NO-UNDERLINE THREE-D
         AT COL 1 ROW 1 SCROLLABLE .
IF NOT THIS-PROCEDURE:PERSISTENT THEN DO:
  MESSAGE "c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\rep\e-xldln2.w should only be RUN PERSISTENT.":U
...
PROCEDURE adm-disable :
    DISABLE RECT-5 cb-disType WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-5 cb-disType WITH FRAME F-Main.
...
define variable v-list as character no-undo.
    ...
    cb-disType:screen-value in frame F-Main = '1'.
END PROCEDURE.
PROCEDURE my-report :
    run rep/r-xldln2.p(input parParentProc, input cb-disType).
end procedure.
PROCEDURE my-var :
    assign frame F-Main
        cb-disType
