...
:
  ...
  if available tt-goods then do :
    find first buy-data no-lock
      where buy-data.obj-type  = buf_clients.obj-type
        and buy-data.obj-code  = buf_clients.obj-code
        and buy-data.gds-code  = tt-goods.gds-code
      no-error .
    if NOT available buy-data then do:
      create buy-data .
      assign
        buy-data.obj-type    =  buf_clients.obj-type
        buy-data.obj-code    =  buf_clients.obj-code
        buy-data.obj-name    =  buf_clients.obj-name
    ...
    for each buf_ot-line no-lock
      where buf_ot-line.doc-code     = buf_trn-doc.doc-code
        ...
        and buf_trn-doc.ext-doc-type = 'ee':U
    :
      if buf_ot-line.sum-type = 'cost':U
        or buf_ot-line.sum-type = 'cssr':U
      then do:
        assign
      ...
      if buf_ot-line.sum-type = 'sale':U
        or buf_ot-line.sum-type = 'sasr':U
      then do:
        assign
...
:
  ...
  if available tt-goods then do :
    find first buy-data no-lock
      where buy-data.obj-type  = G#CUSTOMER.obj-type
        and buy-data.obj-code  = G#CUSTOMER.obj-code
        and buy-data.gds-code  = tt-goods.gds-code
      no-error .
    if NOT available buy-data then do:
      create buy-data .
      assign
        buy-data.obj-type    =  G#CUSTOMER.obj-type
        buy-data.obj-code    =  G#CUSTOMER.obj-code
        buy-data.obj-name    =  G#CUSTOMER.obj-name
        buy-data.gds-code    =  tt-goods.gds-code
        buy-data.artic       =  tt-goods.artic
      .
      find first buf_goods no-lock
...
procedure print-text :
  ...
  DEFINE FRAME obcntr-det
    ...
    with width 235  down stream-io use-text NO-BOX.
      ...
      with FRAME Outstream width 235  PAGE-BOTTOM NO-LABELS no-box.
...
put  stream macr_excel unformatted
       substitute('select("r&1c&2:r&3c&4 ")' , 7 , 1 , num#str# ,  9 ) + chr(10)  +
       'BORDER( 2, 2, 2, 2, , , , , , , ) '  + chr(10) .
end.
else do :
put  stream macr_excel unformatted
       substitute('select("r&1c&2:r&3c&4 ")' , 7 , 1 , num#str# ,  5 ) + chr(10)  +
       'BORDER( 2, 2, 2, 2, , , , , , , ) '  + chr(10) .
end.
num#str# = num#str# + 1 .
for each itog by itog.obj-name :
...
if v-print-rubl = true then do:
    if show-cost = true then do:
                run macr_excel_dec in this-procedure (input buy-data.ras-qnty, input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input false
                  ,input false
                ...
                num#col# = num#col# + 1.
                run macr_excel_dec in this-procedure (input string(buy-data.cost-sum-rubl-ras, "->>>>>>>>9.99"), input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input false
                  ,input false
                ...
                num#col# = num#col# + 1.
                run macr_excel_dec in this-procedure (input buy-data.ret-qnty, input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input false
                  ,input false
                ...
                num#col# = num#col# + 1.
                run macr_excel_dec in this-procedure (input string(buy-data.cost-sum-rubl-ret, "->>>>>>>>9.99"), input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input false
                  ,input false
                ...
                num#col# = num#col# + 1.
                run macr_excel_dec in this-procedure (input string(buy-data.sale-sum-rubl-ras, "->>>>>>>>9.99"), input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input false
                  ,input false
                ...
                num#col# = num#col# + 1.
                run macr_excel_dec in this-procedure (input string(buy-data.sale-sum-rubl-ret, "->>>>>>>>9.99"), input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input false
                  ,input false
    ...
    if show-cost = true then do:
                ...
                num#col# = num#col# + 1.
                run macr_excel_dec in this-procedure (input string(buy-data.cost-sum-base-ras, "->>>>>>>>9.99"), input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input false
                  ,input false
                ...
                num#col# = num#col# + 1.
                run macr_excel_dec in this-procedure (input string(buy-data.cost-sum-base-ret, "->>>>>>>>9.99"), input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input false
                  ,input false
                ...
                num#col# = num#col# + 1.
                run macr_excel_dec in this-procedure (input string(buy-data.sale-sum-base-ras, "->>>>>>>>9.99"), input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input false
                  ,input false
                ...
                num#col# = num#col# + 1.
                run macr_excel_char in this-procedure (input buy-data.ret-qnty, input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input false
                  ,input false
                ...
                num#col# = num#col# + 1.
                run macr_excel_char in this-procedure (input string(buy-data.sale-sum-base-ret, "->>>>>>>>9.99"), input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input false
                  ,input false
...
if v-print-rubl = true then do:
    if show-cost = true then do:
                run macr_excel_dec in this-procedure (input buy-data.all-qnty, input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input false
                  ,input false
                ...
                num#col# = num#col# + 1.
                run macr_excel_dec in this-procedure (input string(buy-data.cost-sum-rubl-all, "->>>>>>>>9.99"), input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input false
                  ,input false
                ...
                num#col# = num#col# + 1.
                run macr_excel_dec in this-procedure (input string(buy-data.sale-sum-rubl-all, "->>>>>>>>9.99"), input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input false
                  ,input false
    ...
    if show-cost = true then do:
                ...
                num#col# = num#col# + 1.
                run macr_excel_dec in this-procedure (input string(buy-data.cost-sum-base-all, "->>>>>>>>9.99"), input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input false
                  ,input false
                ...
                num#col# = num#col# + 1.
                run macr_excel_dec in this-procedure (input string(buy-data.sale-sum-base-all, "->>>>>>>>9.99"), input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input false
                  ,input false
...
if v-print-rubl = true then do:
    if show-cost = true then do:
                run macr_excel_dec in this-procedure (input itog.ras-qnty, input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input true
                  ,input false
                ...
                num#col# = num#col# + 1.
                run macr_excel_dec in this-procedure (input string(itog.cost-sum-rubl-ras, "->>>>>>>>9.99"), input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input true
                  ,input false
                ...
                num#col# = num#col# + 1.
                run macr_excel_dec in this-procedure (input itog.ret-qnty, input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input true
                  ,input false
                ...
                num#col# = num#col# + 1.
                run macr_excel_dec in this-procedure (input string(itog.cost-sum-rubl-ret, "->>>>>>>>9.99"), input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input true
                  ,input false
                ...
                num#col# = num#col# + 1.
                run macr_excel_dec in this-procedure (input string(itog.sale-sum-rubl-ras, "->>>>>>>>9.99"), input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input true
                  ,input false
                ...
                num#col# = num#col# + 1.
                run macr_excel_dec in this-procedure (input string(itog.sale-sum-rubl-ret, "->>>>>>>>9.99"), input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input true
                  ,input false
    ...
    if show-cost = true then do:
                ...
                num#col# = num#col# + 1.
                run macr_excel_dec in this-procedure (input string(itog.cost-sum-base-ras, "->>>>>>>>9.99"), input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input true
                  ,input false
                ...
                num#col# = num#col# + 1.
                run macr_excel_dec in this-procedure (input string(itog.cost-sum-base-ret, "->>>>>>>>9.99"), input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input true
                  ,input false
                ...
                num#col# = num#col# + 1.
                run macr_excel_dec in this-procedure (input string(itog.sale-sum-base-ras, "->>>>>>>>9.99"), input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input true
                  ,input false
                ...
                num#col# = num#col# + 1.
                run macr_excel_char in this-procedure (input itog.ret-qnty, input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input true
                  ,input false
                ...
                num#col# = num#col# + 1.
                run macr_excel_char in this-procedure (input string(itog.sale-sum-base-ret, "->>>>>>>>9.99"), input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input true
                  ,input false
...
if v-print-rubl = true then do:
    if show-cost = true then do:
                run macr_excel_dec in this-procedure (input itog.all-qnty, input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input true
                  ,input false
                ...
                num#col# = num#col# + 1.
                run macr_excel_dec in this-procedure (input string(itog.cost-sum-rubl-all, "->>>>>>>>9.99"), input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input true
                  ,input false
                ...
                num#col# = num#col# + 1.
                run macr_excel_dec in this-procedure (input string(itog.sale-sum-rubl-all, "->>>>>>>>9.99"), input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input true
                  ,input false
    ...
    if show-cost = true then do:
                ...
                num#col# = num#col# + 1.
                run macr_excel_dec in this-procedure (input string(itog.cost-sum-base-all, "->>>>>>>>9.99"), input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input true
                  ,input false
                ...
                num#col# = num#col# + 1.
                run macr_excel_dec in this-procedure (input string(itog.sale-sum-base-all, "->>>>>>>>9.99"), input num#str#, input num#col# ) .
                run macr_cell_format in this-procedure
                  (input 10
                  ,input true
                  ,input false
