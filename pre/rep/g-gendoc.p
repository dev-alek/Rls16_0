...
define variable vss-description as character no-undo init "Œ¡Ÿ»≈  ŒÀ»◊≈—“¬¿ » —”ÃÃ€ œŒ “Œ¬¿–¿Ã —œ»— ¿ ƒŒ ”Ã≈Õ“Œ¬ - Á‡ÔÛÒÍ".
...
run rep/d-report.w (
                    ...
                    ,input ('Œ·˘ËÂ ÍÓÎË˜ÂÒÚ‚‡ Ë ÒÛÏÏ˚ ÔÓ ÚÓ‚‡‡Ï ÒÔËÒÍ‡ ‰ÓÍÛÏÂÌÚÓ‚')
                    ,input 5
                    ,input "1,4"
                    ,input if objects < 2 then "*" else "2"
                    ,input ""
                    ,input ""
                    ,input "all"
                    ,input no).
