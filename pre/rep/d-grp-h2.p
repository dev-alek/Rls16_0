...
Assign l-col-type="DECIMAL"   l-col-len=11  l-col-format= "->>>,>>9.<<<"  l-col-lable=" 0.00-0.59 ".
  ...
  define variable c-hour1 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[4] = true then DO:
        ...
        CREATE EDITOR L-4 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-hour1 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL"   l-col-len=11  l-col-format= "->>>,>>9.<<<"  l-col-lable=" 1.00-1.59 ".
  ...
  define variable c-hour2 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[5] = true then DO:
        ...
        CREATE EDITOR L-5 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-hour2 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL"   l-col-len=11  l-col-format= "->>>,>>9.<<<"  l-col-lable=" 2.00-2.59 ".
  ...
  define variable c-hour3 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[6] = true then DO:
        ...
        CREATE EDITOR L-6 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-hour3 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL"   l-col-len=11  l-col-format= "->>>,>>9.<<<"  l-col-lable=" 3.00-3.59 ".
  ...
  define variable c-hour4 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[7] = true then DO:
        ...
        CREATE EDITOR L-7 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-hour4 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL"   l-col-len=11  l-col-format= "->>>,>>9.<<<"  l-col-lable=" 4.00-4.59 ".
  ...
  define variable c-hour5 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[8] = true then DO:
        ...
        CREATE EDITOR L-8 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-hour5 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL"   l-col-len=11  l-col-format= "->>>,>>9.<<<"  l-col-lable=" 5.00-5.59 ".
  ...
  define variable c-hour6 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[9] = true then DO:
        ...
        CREATE EDITOR L-9 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-hour6 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL"   l-col-len=11  l-col-format= "->>>,>>9.<<<"  l-col-lable=" 6.00-6.59 ".
  ...
  define variable c-hour7 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[10] = true then DO:
        ...
        CREATE EDITOR L-10 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-hour7 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL"   l-col-len=11  l-col-format= "->>>,>>9.<<<"  l-col-lable=" 7.00-7.59 ".
  ...
  define variable c-hour8 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[11] = true then DO:
        ...
        CREATE EDITOR L-11 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-hour8 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL"   l-col-len=11  l-col-format= "->>>,>>9.<<<"  l-col-lable=" 8.00-8.59 ".
  ...
  define variable c-hour9 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[12] = true then DO:
        ...
        CREATE EDITOR L-12 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-hour9 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL"   l-col-len=11  l-col-format= "->>>,>>9.<<<"  l-col-lable=" 9.00-9.59 ".
  ...
  define variable c-hour10 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[13] = true then DO:
        ...
        CREATE EDITOR L-13 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-hour10 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL"   l-col-len=11  l-col-format= "->>>,>>9.<<<"  l-col-lable="10.00-10.59".
  ...
  define variable c-hour11 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[14] = true then DO:
        ...
        CREATE EDITOR L-14 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-hour11 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL"   l-col-len=11  l-col-format= "->>>,>>9.<<<"  l-col-lable="11.00-11.59".
  ...
  define variable c-hour12 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[15] = true then DO:
        ...
        CREATE EDITOR L-15 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-hour12 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL"   l-col-len=11  l-col-format= "->>>,>>9.<<<"  l-col-lable="12.00-12.59".
  ...
  define variable c-hour13 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[16] = true then DO:
        ...
        CREATE EDITOR L-16 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-hour13 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL"   l-col-len=11  l-col-format= "->>>,>>9.<<<"  l-col-lable="13.00-13.59".
  ...
  define variable c-hour14 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[17] = true then DO:
        ...
        CREATE EDITOR L-17 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-hour14 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL"   l-col-len=11  l-col-format= "->>>,>>9.<<<"  l-col-lable="14.00-14.59".
  ...
  define variable c-hour15 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[18] = true then DO:
        ...
        CREATE EDITOR L-18 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-hour15 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL"   l-col-len=11  l-col-format= "->>>,>>9.<<<"  l-col-lable="15.00-15.59".
  ...
  define variable c-hour16 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[19] = true then DO:
        ...
        CREATE EDITOR L-19 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-hour16 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL"   l-col-len=11  l-col-format= "->>>,>>9.<<<"  l-col-lable="16.00-16.59".
  ...
  define variable c-hour17 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[20] = true then DO:
        ...
        CREATE EDITOR L-20 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-hour17 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL"   l-col-len=11  l-col-format= "->>>,>>9.<<<"  l-col-lable="17.00-17.59".
  ...
  define variable c-hour18 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[21] = true then DO:
        ...
        CREATE EDITOR L-21 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-hour18 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL"   l-col-len=11  l-col-format= "->>>,>>9.<<<"  l-col-lable="18.00-18.59".
  ...
  define variable c-hour19 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[22] = true then DO:
        ...
        CREATE EDITOR L-22 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-hour19 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL"   l-col-len=11  l-col-format= "->>>,>>9.<<<"  l-col-lable="19.00-19.59".
  ...
  define variable c-hour20 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[23] = true then DO:
        ...
        CREATE EDITOR L-23 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-hour20 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL"   l-col-len=11  l-col-format= "->>>,>>9.<<<"  l-col-lable="20.00-20.59".
  ...
  define variable c-hour21 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[24] = true then DO:
        ...
        CREATE EDITOR L-24 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-hour21 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL"   l-col-len=11  l-col-format= "->>>,>>9.<<<"  l-col-lable="21.00-21.59".
  ...
  define variable c-hour22 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[25] = true then DO:
        ...
        CREATE EDITOR L-25 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-hour22 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL"   l-col-len=11  l-col-format= "->>>,>>9.<<<"  l-col-lable="22.00-22.59".
  ...
  define variable c-hour23 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[26] = true then DO:
        ...
        CREATE EDITOR L-26 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-hour23 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL"   l-col-len=11  l-col-format= "->>>,>>9.<<<"  l-col-lable="23.00-23.59".
  ...
  define variable c-hour24 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[27] = true then DO:
        ...
        CREATE EDITOR L-27 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-hour24 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
do cycle = 1 to 0 by -1:
  ...
  if use-column[4]
  then  C-hour1:screen-value = string(fill12).
  if use-column[5]
  then  C-hour2:screen-value = string(fill12).
  if use-column[6]
  then  C-hour3:screen-value = string(fill12).
  if use-column[7]
  then  C-hour4:screen-value = string(fill12).
  if use-column[8]
  then  C-hour5:screen-value = string(fill12).
  if use-column[9]
  then  C-hour6:screen-value = string(fill12).
  if use-column[10]
  then  C-hour7:screen-value = string(fill12).
  if use-column[11]
  then  C-hour8:screen-value = string(fill12).
  if use-column[12]
  then  C-hour9:screen-value = string(fill12).
  if use-column[13]
  then  C-hour10:screen-value = string(fill12).
  if use-column[14]
  then  C-hour11:screen-value = string(fill12).
  if use-column[15]
  then  C-hour12:screen-value = string(fill12).
  if use-column[16]
  then  C-hour13:screen-value = string(fill12).
  if use-column[17]
  then  C-hour14:screen-value = string(fill12).
  if use-column[18]
  then  C-hour15:screen-value = string(fill12).
  if use-column[19]
  then  C-hour16:screen-value = string(fill12).
  if use-column[20]
  then  C-hour17:screen-value = string(fill12).
  if use-column[21]
  then  C-hour18:screen-value = string(fill12).
  if use-column[22]
  then  C-hour19:screen-value = string(fill12).
  if use-column[23]
  then  C-hour20:screen-value = string(fill12).
  if use-column[24]
  then  C-hour21:screen-value = string(fill12).
  if use-column[25]
  then  C-hour22:screen-value = string(fill12).
  if use-column[26]
  then  C-hour23:screen-value = string(fill12).
  if use-column[27]
  then  C-hour24:screen-value = string(fill12).
  if use-column[28]
  then  C-qnty:screen-value = string(fill15).
        DISPLAY stream  PrnLibStream with frame HOUR.       DOWN 1 stream PrnLibStream with frame HOUR.
    end.
    assign
    accum-hour[1]  = 0
  ...
  then  C-sym1:screen-value = string(sym1, entry(1, c-sym1:private-data, chr(4))).
  if use-column[2]
  then  C-full-name:screen-value = string(full-name, entry(1, c-full-name:private-data, chr(4))).
  if use-column[3]
  then  C-sym2:screen-value = string(sym2, entry(1, c-sym2:private-data, chr(4))).
  if use-column[4]
  then  C-hour1:screen-value = string(grp-h.hour[1], entry(1, c-hour1:private-data, chr(4))).
  if use-column[5]
  then  C-hour2:screen-value = string(grp-h.hour[2], entry(1, c-hour2:private-data, chr(4))).
  if use-column[6]
  then  C-hour3:screen-value = string(grp-h.hour[3], entry(1, c-hour3:private-data, chr(4))).
  if use-column[7]
  then  C-hour4:screen-value = string(grp-h.hour[4], entry(1, c-hour4:private-data, chr(4))).
  if use-column[8]
  then  C-hour5:screen-value = string(grp-h.hour[5], entry(1, c-hour5:private-data, chr(4))).
  if use-column[9]
  then  C-hour6:screen-value = string(grp-h.hour[6], entry(1, c-hour6:private-data, chr(4))).
  if use-column[10]
  then  C-hour7:screen-value = string(grp-h.hour[7], entry(1, c-hour7:private-data, chr(4))).
  if use-column[11]
  then  C-hour8:screen-value = string(grp-h.hour[8], entry(1, c-hour8:private-data, chr(4))).
  if use-column[12]
  then  C-hour9:screen-value = string(grp-h.hour[9], entry(1, c-hour9:private-data, chr(4))).
  if use-column[13]
  then  C-hour10:screen-value = string(grp-h.hour[10], entry(1, c-hour10:private-data, chr(4))).
  if use-column[14]
  then  C-hour11:screen-value = string(grp-h.hour[11], entry(1, c-hour11:private-data, chr(4))).
  if use-column[15]
  then  C-hour12:screen-value = string(grp-h.hour[12], entry(1, c-hour12:private-data, chr(4))).
  if use-column[16]
  then  C-hour13:screen-value = string(grp-h.hour[13], entry(1, c-hour13:private-data, chr(4))).
  if use-column[17]
  then  C-hour14:screen-value = string(grp-h.hour[14], entry(1, c-hour14:private-data, chr(4))).
  if use-column[18]
  then  C-hour15:screen-value = string(grp-h.hour[15], entry(1, c-hour15:private-data, chr(4))).
  if use-column[19]
  then  C-hour16:screen-value = string(grp-h.hour[16], entry(1, c-hour16:private-data, chr(4))).
  if use-column[20]
  then  C-hour17:screen-value = string(grp-h.hour[17], entry(1, c-hour17:private-data, chr(4))).
  if use-column[21]
  then  C-hour18:screen-value = string(grp-h.hour[18], entry(1, c-hour18:private-data, chr(4))).
  if use-column[22]
  then  C-hour19:screen-value = string(grp-h.hour[19], entry(1, c-hour19:private-data, chr(4))).
  if use-column[23]
  then  C-hour20:screen-value = string(grp-h.hour[20], entry(1, c-hour20:private-data, chr(4))).
  if use-column[24]
  then  C-hour21:screen-value = string(grp-h.hour[21], entry(1, c-hour21:private-data, chr(4))).
  if use-column[25]
  then  C-hour22:screen-value = string(grp-h.hour[22], entry(1, c-hour22:private-data, chr(4))).
  if use-column[26]
  then  C-hour23:screen-value = string(grp-h.hour[23], entry(1, c-hour23:private-data, chr(4))).
  if use-column[27]
  then  C-hour24:screen-value = string(grp-h.hour[24], entry(1, c-hour24:private-data, chr(4))).
  if use-column[28]
  then  C-qnty:screen-value = string(grp-h.qnty, entry(1, c-qnty:private-data, chr(4))).
  if use-column[29]
  then  C-sym3:screen-value = string(sym3, entry(1, c-sym3:private-data, chr(4))).
            DISPLAY stream  PrnLibStream with frame HOUR.                                      DOWN 1 stream PrnLibStream with frame HOUR.
          end.
  ...
  then  C-sym2:screen-value = string(sym2, entry(1, c-sym2:private-data, chr(4))).
  if use-column[4]
  then  C-hour1:screen-value = string(gds-h.hour[1], entry(1, c-hour1:private-data, chr(4))).
  if use-column[5]
  then  C-hour2:screen-value = string(gds-h.hour[2], entry(1, c-hour2:private-data, chr(4))).
  if use-column[6]
  then  C-hour3:screen-value = string(gds-h.hour[3], entry(1, c-hour3:private-data, chr(4))).
  if use-column[7]
  then  C-hour4:screen-value = string(gds-h.hour[4], entry(1, c-hour4:private-data, chr(4))).
  if use-column[8]
  then  C-hour5:screen-value = string(gds-h.hour[5], entry(1, c-hour5:private-data, chr(4))).
  if use-column[9]
  then  C-hour6:screen-value = string(gds-h.hour[6], entry(1, c-hour6:private-data, chr(4))).
  if use-column[10]
  then  C-hour7:screen-value = string(gds-h.hour[7], entry(1, c-hour7:private-data, chr(4))).
  if use-column[11]
  then  C-hour8:screen-value = string(gds-h.hour[8], entry(1, c-hour8:private-data, chr(4))).
  if use-column[12]
  then  C-hour9:screen-value = string(gds-h.hour[9], entry(1, c-hour9:private-data, chr(4))).
  if use-column[13]
  then  C-hour10:screen-value = string(gds-h.hour[10], entry(1, c-hour10:private-data, chr(4))).
  if use-column[14]
  then  C-hour11:screen-value = string(gds-h.hour[11], entry(1, c-hour11:private-data, chr(4))).
  if use-column[15]
  then  C-hour12:screen-value = string(gds-h.hour[12], entry(1, c-hour12:private-data, chr(4))).
  if use-column[16]
  then  C-hour13:screen-value = string(gds-h.hour[13], entry(1, c-hour13:private-data, chr(4))).
  if use-column[17]
  then  C-hour14:screen-value = string(gds-h.hour[14], entry(1, c-hour14:private-data, chr(4))).
  if use-column[18]
  then  C-hour15:screen-value = string(gds-h.hour[15], entry(1, c-hour15:private-data, chr(4))).
  if use-column[19]
  then  C-hour16:screen-value = string(gds-h.hour[16], entry(1, c-hour16:private-data, chr(4))).
  if use-column[20]
  then  C-hour17:screen-value = string(gds-h.hour[17], entry(1, c-hour17:private-data, chr(4))).
  if use-column[21]
  then  C-hour18:screen-value = string(gds-h.hour[18], entry(1, c-hour18:private-data, chr(4))).
  if use-column[22]
  then  C-hour19:screen-value = string(gds-h.hour[19], entry(1, c-hour19:private-data, chr(4))).
  if use-column[23]
  then  C-hour20:screen-value = string(gds-h.hour[20], entry(1, c-hour20:private-data, chr(4))).
  if use-column[24]
  then  C-hour21:screen-value = string(gds-h.hour[21], entry(1, c-hour21:private-data, chr(4))).
  if use-column[25]
  then  C-hour22:screen-value = string(gds-h.hour[22], entry(1, c-hour22:private-data, chr(4))).
  if use-column[26]
  then  C-hour23:screen-value = string(gds-h.hour[23], entry(1, c-hour23:private-data, chr(4))).
  if use-column[27]
  then  C-hour24:screen-value = string(gds-h.hour[24], entry(1, c-hour24:private-data, chr(4))).
  if use-column[28]
  then  C-qnty:screen-value = string(gds-h.qnty, entry(1, c-qnty:private-data, chr(4))).
  if use-column[29]
  then  C-sym3:screen-value = string(sym3, entry(1, c-sym3:private-data, chr(4))).
                DISPLAY stream  PrnLibStream with frame HOUR.                                      DOWN 1 stream PrnLibStream with frame HOUR.
              end.
  ...
  then  C-sym2:screen-value = string(sym2, entry(1, c-sym2:private-data, chr(4))).
  if use-column[4]
  then  C-hour1:screen-value = string(acc-gds-hour[1], entry(1, c-hour1:private-data, chr(4))).
  if use-column[5]
  then  C-hour2:screen-value = string(acc-gds-hour[2], entry(1, c-hour2:private-data, chr(4))).
  if use-column[6]
  then  C-hour3:screen-value = string(acc-gds-hour[3], entry(1, c-hour3:private-data, chr(4))).
  if use-column[7]
  then  C-hour4:screen-value = string(acc-gds-hour[4], entry(1, c-hour4:private-data, chr(4))).
  if use-column[8]
  then  C-hour5:screen-value = string(acc-gds-hour[5], entry(1, c-hour5:private-data, chr(4))).
  if use-column[9]
  then  C-hour6:screen-value = string(acc-gds-hour[6], entry(1, c-hour6:private-data, chr(4))).
  if use-column[10]
  then  C-hour7:screen-value = string(acc-gds-hour[7], entry(1, c-hour7:private-data, chr(4))).
  if use-column[11]
  then  C-hour8:screen-value = string(acc-gds-hour[8], entry(1, c-hour8:private-data, chr(4))).
  if use-column[12]
  then  C-hour9:screen-value = string(acc-gds-hour[9], entry(1, c-hour9:private-data, chr(4))).
  if use-column[13]
  then  C-hour10:screen-value = string(acc-gds-hour[10], entry(1, c-hour10:private-data, chr(4))).
  if use-column[14]
  then  C-hour11:screen-value = string(acc-gds-hour[11], entry(1, c-hour11:private-data, chr(4))).
  if use-column[15]
  then  C-hour12:screen-value = string(acc-gds-hour[12], entry(1, c-hour12:private-data, chr(4))).
  if use-column[16]
  then  C-hour13:screen-value = string(acc-gds-hour[13], entry(1, c-hour13:private-data, chr(4))).
  if use-column[17]
  then  C-hour14:screen-value = string(acc-gds-hour[14], entry(1, c-hour14:private-data, chr(4))).
  if use-column[18]
  then  C-hour15:screen-value = string(acc-gds-hour[15], entry(1, c-hour15:private-data, chr(4))).
  if use-column[19]
  then  C-hour16:screen-value = string(acc-gds-hour[16], entry(1, c-hour16:private-data, chr(4))).
  if use-column[20]
  then  C-hour17:screen-value = string(acc-gds-hour[17], entry(1, c-hour17:private-data, chr(4))).
  if use-column[21]
  then  C-hour18:screen-value = string(acc-gds-hour[18], entry(1, c-hour18:private-data, chr(4))).
  if use-column[22]
  then  C-hour19:screen-value = string(acc-gds-hour[19], entry(1, c-hour19:private-data, chr(4))).
  if use-column[23]
  then  C-hour20:screen-value = string(acc-gds-hour[20], entry(1, c-hour20:private-data, chr(4))).
  if use-column[24]
  then  C-hour21:screen-value = string(acc-gds-hour[21], entry(1, c-hour21:private-data, chr(4))).
  if use-column[25]
  then  C-hour22:screen-value = string(acc-gds-hour[22], entry(1, c-hour22:private-data, chr(4))).
  if use-column[26]
  then  C-hour23:screen-value = string(acc-gds-hour[23], entry(1, c-hour23:private-data, chr(4))).
  if use-column[27]
  then  C-hour24:screen-value = string(acc-gds-hour[24], entry(1, c-hour24:private-data, chr(4))).
  if use-column[28]
  then  C-qnty:screen-value = string(acc-gds-qnty, entry(1, c-qnty:private-data, chr(4))).
  if use-column[29]
  then  C-sym3:screen-value = string(sym3, entry(1, c-sym3:private-data, chr(4))).
                  DISPLAY stream  PrnLibStream with frame HOUR.                                      DOWN 1 stream PrnLibStream with frame HOUR.
                end.
  ...
  then  C-sym1:screen-value = string(sym1, entry(1, c-sym1:private-data, chr(4))).
  if use-column[2]
  then  C-full-name:screen-value = string(string( fill( chr(32), 6 ) + string( gds-h.b-code) + chr(32) + gds-h.f-name ), entry(1, c-full-name:private-data, chr(4))).
  if use-column[3]
  then  C-sym2:screen-value = string(sym2, entry(1, c-sym2:private-data, chr(4))).
  if use-column[4]
  then  C-hour1:screen-value = string(gds-h.hour[1], entry(1, c-hour1:private-data, chr(4))).
  ...
  then  C-sym2:screen-value = string(sym2, entry(1, c-sym2:private-data, chr(4))).
  if use-column[4]
  then  C-hour1:screen-value = string(accum-hour[1], entry(1, c-hour1:private-data, chr(4))).
  if use-column[5]
  then  C-hour2:screen-value = string(accum-hour[2], entry(1, c-hour2:private-data, chr(4))).
  if use-column[6]
  then  C-hour3:screen-value = string(accum-hour[3], entry(1, c-hour3:private-data, chr(4))).
  if use-column[7]
  then  C-hour4:screen-value = string(accum-hour[4], entry(1, c-hour4:private-data, chr(4))).
  if use-column[8]
  then  C-hour5:screen-value = string(accum-hour[5], entry(1, c-hour5:private-data, chr(4))).
  if use-column[9]
  then  C-hour6:screen-value = string(accum-hour[6], entry(1, c-hour6:private-data, chr(4))).
  if use-column[10]
  then  C-hour7:screen-value = string(accum-hour[7], entry(1, c-hour7:private-data, chr(4))).
  if use-column[11]
  then  C-hour8:screen-value = string(accum-hour[8], entry(1, c-hour8:private-data, chr(4))).
  if use-column[12]
  then  C-hour9:screen-value = string(accum-hour[9], entry(1, c-hour9:private-data, chr(4))).
  if use-column[13]
  then  C-hour10:screen-value = string(accum-hour[10], entry(1, c-hour10:private-data, chr(4))).
  if use-column[14]
  then  C-hour11:screen-value = string(accum-hour[11], entry(1, c-hour11:private-data, chr(4))).
  if use-column[15]
  then  C-hour12:screen-value = string(accum-hour[12], entry(1, c-hour12:private-data, chr(4))).
  if use-column[16]
  then  C-hour13:screen-value = string(accum-hour[13], entry(1, c-hour13:private-data, chr(4))).
  if use-column[17]
  then  C-hour14:screen-value = string(accum-hour[14], entry(1, c-hour14:private-data, chr(4))).
  if use-column[18]
  then  C-hour15:screen-value = string(accum-hour[15], entry(1, c-hour15:private-data, chr(4))).
  if use-column[19]
  then  C-hour16:screen-value = string(accum-hour[16], entry(1, c-hour16:private-data, chr(4))).
  if use-column[20]
  then  C-hour17:screen-value = string(accum-hour[17], entry(1, c-hour17:private-data, chr(4))).
  if use-column[21]
  then  C-hour18:screen-value = string(accum-hour[18], entry(1, c-hour18:private-data, chr(4))).
  if use-column[22]
  then  C-hour19:screen-value = string(accum-hour[19], entry(1, c-hour19:private-data, chr(4))).
  if use-column[23]
  then  C-hour20:screen-value = string(accum-hour[20], entry(1, c-hour20:private-data, chr(4))).
  if use-column[24]
  then  C-hour21:screen-value = string(accum-hour[21], entry(1, c-hour21:private-data, chr(4))).
  if use-column[25]
  then  C-hour22:screen-value = string(accum-hour[22], entry(1, c-hour22:private-data, chr(4))).
  if use-column[26]
  then  C-hour23:screen-value = string(accum-hour[23], entry(1, c-hour23:private-data, chr(4))).
  if use-column[27]
  then  C-hour24:screen-value = string(accum-hour[24], entry(1, c-hour24:private-data, chr(4))).
  if use-column[28]
  then  C-qnty:screen-value = string(accum-qnty, entry(1, c-qnty:private-data, chr(4))).
  if use-column[29]
  then  C-sym3:screen-value = string(sym3, entry(1, c-sym3:private-data, chr(4))).
    DISPLAY stream  PrnLibStream with frame HOUR.                                      DOWN 1 stream PrnLibStream with frame HOUR.
    if rs-option <> 3 then do:
