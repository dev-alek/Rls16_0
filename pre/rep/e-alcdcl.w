...
IF NOT THIS-PROCEDURE:PERSISTENT THEN DO:
  MESSAGE "c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\rep\e-alcdcl.w should only be RUN PERSISTENT.":U
...
PROCEDURE adm-disable :
    DISABLE RECT-7 RADIO-doc  Pri_Perem WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-7 RADIO-doc  Pri_Perem WITH FRAME F-Main.
...
PROCEDURE local-initialize :
  ...
  Pri_Perem:screen-value in frame F-Main = string(True).
  display Pri_Perem with frame F-Main .
END PROCEDURE.
PROCEDURE my-report :
...
END PROCEDURE.
PROCEDURE my-var :
assign frame F-Main  RADIO-doc Pri_Perem .
END PROCEDURE.
