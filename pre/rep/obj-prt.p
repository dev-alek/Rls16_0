...
define variable vss-workfile    as character no-undo init "$Workfile: obj-prt.p $":U .
define variable vss-archive     as character no-undo init "$Archive: rep/obj-prt.p $":U .
...
PUT STREAM PrnLibStream SPACE(4) "С П И С О К    О Б Ъ Е К Т О В" FORMAT "X(122)" SKIP.
