...
def new  shared  var ostatok-End       as   decimal EXTENT 9 Format "->>>>>>>>>>>9.<<<" no-undo.
def new shared  var Tot-0-1 as decimal no-undo init 0.
def new shared  var Tot-0-2 as decimal no-undo init 0.
def new shared  var Tot-0-3 as decimal no-undo init 0.
def new shared  var Tot-0-4 as decimal no-undo init 0.
def new shared  var Tot-0-5 as decimal no-undo init 0.
def new shared  var Tot-1 as decimal no-undo init 0.
def new shared  var Tot-2 as decimal no-undo init 0.
def new shared  var Tot-3 as decimal no-undo init 0.
def new shared  var Tot-4 as decimal no-undo init 0.
def new shared  var Tot-5 as decimal no-undo init 0.
def new shared  var Tot-1-1 as decimal no-undo init 0.
def new shared  var Tot-1-2 as decimal no-undo init 0.
def new shared  var Tot-1-3 as decimal no-undo init 0.
def new shared  var Tot-1-4 as decimal no-undo init 0.
def new shared  var Tot-1-5 as decimal no-undo init 0.
def new shared  var Tot-2-1 as decimal no-undo init 0.
def new shared  var Tot-2-2 as decimal no-undo  init 0.
def new shared  var Tot-2-3 as decimal no-undo  init 0.
def new shared  var Tot-2-4 as decimal no-undo init 0.
def new shared  var Tot-2-5 as decimal no-undo init 0.
def new shared  var Tot-3-1 as decimal no-undo init 0.
def new shared  var Tot-3-2 as decimal no-undo  init 0.
def new shared  var Tot-3-3 as decimal no-undo  init 0.
def new shared  var Tot-3-4 as decimal no-undo init 0.
def new shared  var Tot-3-5 as decimal no-undo init 0.
def  new  shared  var tot_tqnty as decimal  no-undo.
...
PROCEDURE Print-Footer :
      ...
      if Make-Excel then  put   stream ForExcel unformatted
          " ИТОГО" CHR(9) CHR(9) CHR(9)  CHR(9)  CHR(9)
            excel-qnty(Tot-1)  CHR(9) CHR(9)
            excel-sum(Tot-2)  CHR(9)
            excel-sum(Tot-4)  CHR(9)
            excel-sum(Tot-5)  CHR(9)
      ...
      Put stream  OutStream UNFORMATTED
        ...
        trim( string(tot-2,"->>>>>>>>>>>>9.99"))
         "(" + (if tPrintRubl then "РУБ" else x-base-type ) + ")" skip.
       END PROCEDURE.
PROCEDURE U-LINE :
