...
Make-Excel = yes
reportname = titl
str3 = "Цены и суммы указаны в " + (if PrintRubl then "руб" else buf_currency.curr-abbr)
.
...
DO WHILE available s-parts :
    ...
    s-parts.artic                                                               CHR(9)
    s-goods.gds-name                                                            CHR(9)
    (s-parts.obj-type + " " + STRING (s-parts.obj-code))                        CHR(9)
    s-parts.fact-qnty                                                           CHR(9)
    get-parts-out-code (buffer s-parts)                                         CHR(9)
    (if s-parts.part-code = "" then "------" else s-parts.part-code)            CHR(9)
    price                                                                       CHR(9)
    stoim
    skip.
    assign
