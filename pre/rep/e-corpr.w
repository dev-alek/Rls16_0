...
PROCEDURE adm-disable :
    DISABLE RECT-8 RECT-5 RECT-6 RECT-7 r-cli FILL-cli-code COMBO-cli-type FILL-num sort-name RADIO-SET-1 sort-gr WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-8 RECT-5 RECT-6 RECT-7 r-cli FILL-cli-code COMBO-cli-type FILL-num sort-name RADIO-SET-1 sort-gr WITH FRAME F-Main.
...
DO:
  ...
  DISP   FILL-cli-name WITH FRAME F-Main.
END.
...
DO:
  ...
  DISP   FILL-cli-name WITH FRAME F-Main.
END.
ON LEAVE OF FILL-cli-code IN FRAME F-Main
DO:
  ...
  DISP   FILL-cli-name WITH FRAME F-Main.
END.
ON CHOOSE OF r-cli IN FRAME F-Main
DO:
  ...
  END.              ELSE DO:
    ASSIGN FILL-cli-name  = "":U
           FILL-cli-code  = 0
           COMBO-cli-type = 'орг':U.
  END.
  DISP COMBO-cli-type FILL-cli-code FILL-cli-name WITH FRAME F-Main.
END.
...
ASSIGN COMBO-cli-type = 'орг':U.
DISP   COMBO-cli-type WITH FRAME F-Main.
...
END PROCEDURE.
PROCEDURE my-var :
  Assign frame F-Main COMBO-cli-type FILL-cli-code FILL-num RADIO-SET-1 sort-name sort-gr .
END PROCEDURE.
