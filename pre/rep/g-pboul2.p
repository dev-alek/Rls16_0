...
define variable vss-workfile    as character no-undo init "$Workfile: g-pboul2.p $":U .
define variable vss-archive     as character no-undo init "$Archive: rep/g-pboul2.p $":U .
define variable vss-description as character no-undo init "”чет доходов и расходов за мес€ц".
...
input                       '”чет доходов и расходов за мес€ц',
input                        2,
input                        "",
input                        "2",
input                        "",
