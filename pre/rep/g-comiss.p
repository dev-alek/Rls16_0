...
define variable vss-description as character no-undo init "ќборотна€ ведомость по товарам, прин€тым на комиссию".
...
(   input parParentProc ,
    ...
    input "ќборотна€ ведомость по товарам, прин€тым на комиссию",
    input 2,
    input "1,2,3,4,5,7":u,
    input "*":u,
    input "",
    input "1,2",
    input "all,12,1,7,5,6,10,name-sale= омисси€",
    input false ).
