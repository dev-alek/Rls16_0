...
PROCEDURE adm-disable :
    DISABLE RECT-11 RECT-12 DetGoods Detdoctip WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-11 RECT-12 DetGoods Detdoctip WITH FRAME F-Main.
...
ON VALUE-CHANGED OF Detdoctip IN FRAME F-Main
DO:
  assign DetDocTip.
assign
...
.
END.
ON VALUE-CHANGED OF Detgoods IN FRAME F-Main
DO:
  assign Detgoods.
 assign
  v-detgoods = DetGoods
...
END PROCEDURE.
PROCEDURE my-var :
assign frame F-Main DetGoods Detdoctip
.
