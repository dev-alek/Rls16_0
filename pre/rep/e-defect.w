...
PROCEDURE adm-disable :
    DISABLE RECT-6 RECT-5 rs-classificator rs-sort-type WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-6 RECT-5 rs-classificator rs-sort-type WITH FRAME F-Main.
