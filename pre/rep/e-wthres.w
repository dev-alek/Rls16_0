...
IF NOT THIS-PROCEDURE:PERSISTENT THEN DO:
  MESSAGE "c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\rep\e-wthres.w should only be RUN PERSISTENT.":U
...
PROCEDURE adm-disable :
    DISABLE RECT-7 ed-wth-pl rs-wth-pl bt-wth-pl ed-wth rs-wth bt-wth WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-7 ed-wth-pl rs-wth-pl bt-wth-pl ed-wth rs-wth bt-wth WITH FRAME F-Main.
        ...
        .
         ...
         :
            find first buf_wth-place
               where RECID(buf_wth-place) = integer( entry( v-i, v-wth-pl-lst, chr(44) ) )
               no-lock
               no-error
               .
            ...
            then do:
               ...
               v-wth-pl-list = IF v-wth-pl-list = "":U THEN entry( v-i, v-wth-pl-lst, chr(44) )
                                                         ELSE v-wth-pl-list + chr(44) + entry( v-i, v-wth-pl-lst, chr(44) )
               .
            end.
         end.
         end.
...
PROCEDURE my-var :
  assign
    ReportHeader =  ReportHeader + "Группы объектов: " + chr(10) + ed-wth-pl + chr(10) + chr(10) +
