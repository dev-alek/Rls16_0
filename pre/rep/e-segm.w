...
define variable     clients_found       as logical      no-undo.
...
PROCEDURE adm-disable :
    DISABLE rect-3 rect-5 rect-6 SelectDC chk-obj chk-dk chk-sex chk-age WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN rect-3 rect-5 rect-6 SelectDC chk-obj chk-dk chk-sex chk-age WITH FRAME F-Main.
...
DO:
  ...
  assign period-list.
END.
ON VALUE-CHANGED OF chk-age IN FRAME F-Main
DO:
  assign chk-age.
