...
END.
ON VALUE-CHANGED OF NDS-Rubl IN FRAME DLGOKCAN
DO:
    assign
        NDS-Rubl
        Rubl-CostSum
...
END.
ON VALUE-CHANGED OF NDS-Val IN FRAME DLGOKCAN
DO:
    assign
        NDS-Val
        Val-CostSum
...
END.
ON VALUE-CHANGED OF Rubl-CostSum IN FRAME DLGOKCAN
DO:
    assign
        NDS-Rubl
        Rubl-CostSum
...
END.
ON VALUE-CHANGED OF Val-CostSum IN FRAME DLGOKCAN
DO:
    assign
        NDS-Val
        Val-CostSum
...
:
    ...
    then do:
        ...
        then do:
            assign
                tg-vat-rubl :sensitive in frame DLGOKCAN = yes
            .
        end.
        else do:
            assign
                tg-vat-rubl :sensitive in frame DLGOKCAN = no
            .
        end.
    end.
    else do:
        ...
        then do:
            assign
                tg-vat-base :sensitive in frame DLGOKCAN = yes
            .
        end.
        else do:
            assign
                tg-vat-base :sensitive in frame DLGOKCAN = no
            .
        end.
    end.
end.
