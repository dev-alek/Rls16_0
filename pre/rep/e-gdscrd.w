...
PROCEDURE adm-disable :
    DISABLE RECT-9 TOG-inv R-type-dog tog-ov WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-9 TOG-inv R-type-dog tog-ov WITH FRAME F-Main.
...
if X-SET_PAY_TYPE = 2 then
    disable tog-ov with frame F-Main.
  else
    enable  tog-ov with frame F-Main.
END PROCEDURE.
PROCEDURE local-initialize :
  tog-ov:screen-value in frame F-Main = "yes".
...
END PROCEDURE.
PROCEDURE my-var :
assign frame F-Main R-type-dog TOG-inv tog-ov.
Assign
 STR-obj-type = ''
 STR-obj-code = ''
 STR-obj-name = ''
