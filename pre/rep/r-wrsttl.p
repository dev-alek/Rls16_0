...
define temp-table tt-report no-undo
  field grp-code      as integer
  field sale-grp-code as integer
  field wth-code      as integer
  field par-code      as integer
  field grp-name      as character
  field sale-grp-name as character
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run hostcode in g#library
  (input  buf_tt-cli-grp-out-clients.obj-type
  ,input  buf_tt-cli-grp-out-clients.obj-code
  ,output v-host-code
  )  .
    for each buf_wth-doc no-lock
      where buf_wth-doc.host-code     = v-host-code
        ...
        and buf_wth-doc.ext-doc-type  = 'pc':U
    :
    ...
    for each buf_wth-doc no-lock
      where buf_wth-doc.host-code     = v-host-code
        ...
        and buf_wth-doc.fact-order   >= v-fo-start
        and buf_wth-doc.fact-order   <= v-fo-end
        and buf_wth-doc.ext-doc-type  = 'ps':U
    :
      for each buf_tt-wealth ,
          each buf_wth-par no-lock
            where buf_wth-par.wth-code = buf_tt-wealth.wth-code
...
:
  assign
    v-clmn-label-3 = "1" + chr(44) + "2" + chr(44) + "3" + chr(44) + "4" + chr(44)
    v-i = 5
  .
  for each tt-cli-grp
  ...
  :
    assign
      v-clmn-label-1 = v-clmn-label-1 + tt-cli-grp.grp-name + chr(44) + chr(44)
      v-clmn-label-2 = v-clmn-label-2 + "Кол-во" + chr(44) + "Сумма" + chr(44)
      v-clmn-label-3 = v-clmn-label-3 + string(v-i) + chr(44) + string(v-i + 1) + chr(44)
      v-clmn-format  = v-clmn-format  + substitute("&1=@;&2=@", v-i , (v-i + 1) )
      v-clmn-sizes   = v-clmn-sizes   + "12" + chr(44) + "12" + chr(44)
  ...
  .
  assign
    v-clmn-label-3  = trim(v-clmn-label-3 , chr(44) )
    v-clmn-format   = trim(v-clmn-format , ";")
    v-clmn-sizes    = trim(v-clmn-sizes  , chr(44) )
  ...
  assign
    ...
    sheetf.Excel-Column-Lable = "№ п/п"  + chr(44) + "Наименование" + chr(44) + "Номинал" + chr(44) + "Цена" + chr(44) + v-clmn-label-1 + "Итого" + chr(44) + chr(44)
                                + chr(10)
                                         + chr(44)                  + chr(44)             + chr(44)          + chr(44) + v-clmn-label-2
                                + chr(10)
                                                                                                                                               + v-clmn-label-3
    sheetf.colformat          = "1=@;2=@;3=@;4=@;" + v-clmn-format
    sheetf.Sizes              = "5" + chr(44) + "32" + chr(44) + "10" + chr(44) + "10" + chr(44)
                                + v-clmn-sizes
  .
  run rep/extitle.p (1).
  assign
  ...
  :
    ...
    then do:
      if Make-Excel then  put   stream ForExcel unformatted
        " "                     CHR(9)
        tt-report-price.sale-grp-name CHR(9)
        " "                     CHR(9)
      .
      for each tt-cli-grp
      :
    ...
    then do:
      if Make-Excel then  put   stream ForExcel unformatted
        string(v-row-count, ">9")             CHR(9)
        tt-report-price.wth-name              CHR(9)
        tt-report-price.par-name              CHR(9)
        to-string(tt-report-price.price-rubl,"D":u) CHR(9)
      .
      assign
    ...
    if Make-Excel then  put   stream ForExcel unformatted
      to-string(tt-report-price.qnty,"I":u) CHR(9)
      to-string(tt-report-price.sum,"D":u) CHR(9)
    .
    ...
    then do:
      ...
      if Make-Excel then  put   stream ForExcel unformatted
        to-string(v-tot-qnty,"I":u) CHR(9)
        to-string(v-tot-sum,"D":u)  CHR(9)
      skip.
    end.
    ...
    then do:
      ...
      :
        ...
        then do:
          if Make-Excel then  put   stream ForExcel unformatted
            to-string(v-price-qnty,"I":u) CHR(9)
            to-string(v-price-sum,"D":u)  CHR(9)
          .
          assign
            v-price-qnty = 0
            v-price-sum  = 0
    ...
    then do:
      if Make-Excel then  put   stream ForExcel unformatted
        " "                                                     CHR(9)
        substitute( "Итого по &1 " , tt-report-price.wth-name)  CHR(9)
        " "                                                     CHR(9)
        " "                                                     CHR(9)
      .
      for each buf_tt-report-price
      ...
      :
        ...
        then do:
          if Make-Excel then  put   stream ForExcel unformatted
            to-string(v-wth-qnty,"I":u) CHR(9)
            to-string(v-wth-sum,"D":u)  CHR(9)
          .
          assign
            v-wth-qnty = 0
            v-wth-sum  = 0
  ...
  if Make-Excel then  put   stream ForExcel unformatted
    to-string(v-all-qnty,"I":u) CHR(9)
    to-string(v-all-sum,"D":u)  CHR(9)
  skip.
end.
end procedure.
...
:
  ...
  define variable v-all-sum         as decimal   no-undo .
  assign
    v-clmn-label-3 = "1" + chr(44) + "2" + chr(44) + "3" + chr(44)
    v-i = 4
  .
  for each tt-cli-grp
    by tt-cli-grp.grp-code
  ...
  assign
    ...
    sheetf.MergeCellsH        = v-line-1
    sheetf.MergeCellsV        = "1=1:2/2=1:2/3=1:2"
    sheetf.Excel-Column-Lable = "№ п/п"  + chr(44) + "Наименование" + chr(44) + "Номинал" + chr(44) + v-clmn-label-1 + "Итого" + chr(44) + chr(44)
                                + chr(10)
                                         + chr(44)                  + chr(44)             + chr(44) + v-clmn-label-2
                                + chr(10)
                                                                                                                      + v-clmn-label-3
    sheetf.colformat          = "1=@;2=@;3=@;" + v-clmn-format
    sheetf.Sizes              = "5" + chr(44) + "32" + chr(44) + "10" + chr(44)
                                + v-clmn-sizes
  .
  run rep/extitle.p (1).
  assign
  ...
  :
    ...
    then do:
      if Make-Excel then  put   stream ForExcel unformatted
        string(v-row-count, ">9") CHR(9)
        tt-report.wth-name        CHR(9)
        tt-report.par-name        CHR(9)
      .
      assign
        v-row-count = v-row-count + 1
      .
    ...
    if Make-Excel then  put   stream ForExcel unformatted
      to-string(tt-report.qnty,"I":u) CHR(9)
      to-string(tt-report.sum,"D":u) CHR(9)
    .
