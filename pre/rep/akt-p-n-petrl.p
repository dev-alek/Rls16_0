...
define variable vss-include-info16 as character format "x(65)" no-undo initial "@(#)$Workfile: sr-izm.i $ $Revision: 0425b3e124f6, 2861, rls $".
define temp-table sr-izmerenia no-undo
...
node-code
.
define dataset sr-izmerenia-ds for sr-izmerenia.
define variable vss-include-info17 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
define variable vss-include-info18 as character format "x(65)" no-undo initial "@(#)$Workfile: sr-izm.i $ $Revision: 0425b3e124f6, 2861, rls $".
...
if valid-handle( g#trdcalib ) <> yes then do:       run str/trdcalib.p persistent no-error.       if error-status :error or valid-handle( g#trdcalib ) <> yes then do:         message "Error starting trdcalib.p"    skip( 0 )                 g#trdcalib                     skip( 0 )                 g#trdcalib   :type             skip( 0 )                 g#trdcalib   :file-name        skip( 0 )                 error-status :get-message( 1 ) skip( 0 )                 return-value                   skip( 0 )         view-as alert-box error.         stop.       end.      end.     run trdcalib_tdat-val in g#trdcalib (  input buf_trn-doc.doc-code ,
  ...
  run sr-izmerenia_fill-sr-izm in this-procedure ( input 'ПРОСМОТР':U
  ...
  :
    ...
    if p-mode-attr = "get-attr":U then do:
      ...
      no-error.
        ...
        find first buf_doc-attr     where buf_doc-attr.doc-code  = v-doc-code       and buf_doc-attr.attr-code = "doc-not"     no-error.
    if p-mode-attr = "get-attr":U then do:
            assign
        v-doc-not = logical(buf_doc-attr.attr-value)
      no-error.
    end.
    else do:
    end.
        find first buf_doc-attr     where buf_doc-attr.doc-code  = v-doc-code       and buf_doc-attr.attr-code = "spisok-not-doc"     no-error.
    if p-mode-attr = "get-attr":U then do:
            assign
        v-spisok-not-doc = buf_doc-attr.attr-value
      no-error.
    end.
    else do:
    end.
        ...
        do:
            _trpomi:
                do on error undo, return no-apply:
                    run sr-izmerenia_fill-sr-izm in this-procedure (input 'ПРОСМОТР':U, buffer buf_clob-bind).
