...
IF NOT THIS-PROCEDURE:PERSISTENT THEN DO:
  MESSAGE "c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\rep\e-vbbr-viza.w should only be RUN PERSISTENT.":U
...
PROCEDURE adm-disable :
    DISABLE RECT-7 EDITOR-3 RADIO-SET-3 t-1 WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-7 EDITOR-3 RADIO-SET-3 t-1 WITH FRAME F-Main.
...
DO:
    ...
    DISPLAY
      ...
      WITH FRAME F-Main.
  END.
ON VALUE-CHANGED OF t-1 IN FRAME F-Main
DO:
  assign t-1 .
END.
...
END PROCEDURE.
PROCEDURE my-var :
  assign frame F-Main RADIO-SET-3 .
END PROCEDURE.
