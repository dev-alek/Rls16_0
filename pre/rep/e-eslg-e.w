...
PROCEDURE adm-disable :
    DISABLE RECT-6 RECT-7 NullStr fi-days-absence fi-critical-balance tg-absence-period fi-absence-period-from fi-absence-period-to WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-6 RECT-7 NullStr fi-days-absence fi-critical-balance tg-absence-period fi-absence-period-from fi-absence-period-to WITH FRAME F-Main.
...
ON VALUE-CHANGED OF tg-absence-period IN FRAME F-Main
DO:
...
on ' ' of fi-absence-period-from in frame F-Main
do:
...
on delete-character of fi-absence-period-from in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-d of fi-absence-period-from in frame F-Main
do:
...
on ctrl-b of fi-absence-period-from in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-e of fi-absence-period-from in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-f of fi-absence-period-from in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
  ...
  define MENU m-ed-date15
    ...
    .
  if fi-absence-period-from :POPUP-MENU in frame F-Main = ?
  then do:
    ASSIGN
      fi-absence-period-from :POPUP-MENU in frame F-Main = MENU m-ed-date15 :HANDLE
      fi-absence-period-from :MENU-MOUSE in frame F-Main = 3
    .
  end.
  define variable v-label-handle15 as handle no-undo .
  assign
    v-label-handle15 = fi-absence-period-from :side-label-handle in frame F-Main
  .
  ...
  ON CHOOSE OF MENU-ITEM m-ed-date15-1 in menu m-ed-date15 DO:
    apply "ctrl-b":U to fi-absence-period-from in frame F-Main .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date15-2 in menu m-ed-date15 DO:
    apply "ctrl-d":U to fi-absence-period-from in frame F-Main .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date15-3 in menu m-ed-date15 DO:
    apply "ctrl-e":U to fi-absence-period-from in frame F-Main .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date15-4 in menu m-ed-date15 DO:
    apply "ctrl-f":U to fi-absence-period-from in frame F-Main .
  END.
define variable vss-include-info16 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
on ' ' of fi-absence-period-to in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on delete-character of fi-absence-period-to in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-d of fi-absence-period-to in frame F-Main
do:
  define variable v-curr-sv-date as date no-undo .
  if (can-query (self, "sensitive")
     and
...
on ctrl-b of fi-absence-period-to in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-e of fi-absence-period-to in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-f of fi-absence-period-to in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
  ...
  define MENU m-ed-date17
    ...
    .
  if fi-absence-period-to :POPUP-MENU in frame F-Main = ?
  then do:
    ASSIGN
      fi-absence-period-to :POPUP-MENU in frame F-Main = MENU m-ed-date17 :HANDLE
      fi-absence-period-to :MENU-MOUSE in frame F-Main = 3
    .
  end.
  define variable v-label-handle17 as handle no-undo .
  assign
    v-label-handle17 = fi-absence-period-to :side-label-handle in frame F-Main
  .
  ...
  ON CHOOSE OF MENU-ITEM m-ed-date17-1 in menu m-ed-date17 DO:
    apply "ctrl-b":U to fi-absence-period-to in frame F-Main .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date17-2 in menu m-ed-date17 DO:
    apply "ctrl-d":U to fi-absence-period-to in frame F-Main .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date17-3 in menu m-ed-date17 DO:
    apply "ctrl-e":U to fi-absence-period-to in frame F-Main .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date17-4 in menu m-ed-date17 DO:
    apply "ctrl-f":U to fi-absence-period-to in frame F-Main .
  END.
...
PROCEDURE local-apply-layout :
  ...
  if num-entries(v-list , chr(4)) = 6
  then do:
    assign
      NullStr                 = logical(entry(1 , v-list , chr(4)))
      fi-days-absence         = integer(entry(2 , v-list , chr(4)))
      fi-critical-balance     = integer(entry(3 , v-list , chr(4)))
      tg-absence-period       = logical(entry(4 , v-list , chr(4)))
      fi-absence-period-from  = date(entry(5 , v-list , chr(4)))
      fi-absence-period-to    = date(entry(6 , v-list , chr(4)))
    no-error .
    display
      NullStr
      fi-days-absence
