...
IF NOT THIS-PROCEDURE:PERSISTENT THEN DO:
  MESSAGE "c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\rep\e-reesto.w should only be RUN PERSISTENT.":U
...
PROCEDURE adm-disable :
    DISABLE RECT-14 RECT-15 RECT-16 RECT-12 ie ee CostSum ep DispUpFact es re Serv rs NullPer we vt iv CalcRest ev rv em wm im ot ap pc WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-14 RECT-15 RECT-16 RECT-12 ie ee CostSum ep DispUpFact es re Serv rs NullPer we vt iv CalcRest ev rv em wm im ot ap pc WITH FRAME F-Main.
...
PROCEDURE calc-rest :
assign FRAME F-Main ie ee ep es re rs we vt iv ev rv em wm im ot ap pc    .
if  ie
AND ee
AND  ep
AND  es
