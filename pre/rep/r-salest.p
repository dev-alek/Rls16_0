...
DEFINE TEMP-TABLE tt-line NO-UNDO
   ...
   field prod-summ-cost     as decimal
...
DEFINE TEMP-TABLE tt-total NO-UNDO
   ...
   field grp-summ-cost      as decimal
index pu as primary unique
      grp-code
.
   ...
   for each buf_tt-line
      ...
      THEN DO:
            put stream excel-line unformatted
                  ...
                  CHR(9)   " "
               CHR(9)   v-grp-name
                  CHR(9)   buf_tt-line.supp-name
               CHR(9)   STRING(buf_tt-line.prod-summ-sale, "->>>,>>>,>>9")
               CHR(9)   IF (buf_tt-line.prod-summ-sale / tt-total.grp-summ-sale * 100) <> ? THEN buf_tt-line.prod-summ-sale / tt-total.grp-summ-sale * 100 ELSE 0
               CHR(9)   " "
               CHR(9)   " "
               CHR(9)   " "
               chr(10)
      ...
      THEN DO:
         ...
         put stream excel-line unformatted
               ...
               CHR(9)   " "
                  ...
                  CHR(9)   " "
                  CHR(9)   STRING(buf_tt-line.prod-summ-sale, "->>>,>>>,>>9")
                  CHR(9)   IF (v-total-supp / tt-total.grp-summ-sale * 100) <> ? THEN v-total-supp / tt-total.grp-summ-sale * 100 ELSE 0
               CHR(9)   " "
               CHR(9)   " "
               CHR(9)   " "
                  chr(10)
         ...
         put stream excel-line unformatted
               ...
               CHR(9)   " "
               CHR(9)   " "
               CHR(9)   STRING(tt-total.grp-summ-sale, "->>>,>>>,>>9")
               CHR(9)   IF (tt-total.grp-summ-sale / v-total-sale * 100) <> ? THEN tt-total.grp-summ-sale / v-total-sale * 100 ELSE 0
               CHR(9)   IF ((tt-total.grp-summ-sale - tt-total.grp-summ-cost) / tt-total.grp-summ-sale * 100) <> ? THEN (tt-total.grp-summ-sale - tt-total.grp-summ-cost) / tt-total.grp-summ-sale * 100 ELSE 0
               chr(10)
         .
         put stream excel-line unformatted
                           "Template":U
         ...
         :
            ...
            END.
               ...
               where   buf_ot-supp-line.artic        = buf_gds-obj.artic
                  ...
                  and  (  buf_ot-supp-line.ext-doc-type = 'es':U
                        OR buf_ot-supp-line.ext-doc-type = 'ee':U
                        )
                     NO-LOCK
                         :
  ...
  ,output v-dexcise
               ...
               where   buf_ot-supp-line.artic        = buf_gds-obj.artic
                  ...
                  and  buf_ot-supp-line.prod-type    = buf_gds-obj.prod-type
                        ...
                        and  buf_ot-supp-line.obj-type     = obj-list.obj-type
                        and  buf_ot-supp-line.sum-type     = 'cost':U
                  and  (  buf_ot-supp-line.ext-doc-type = 'rs':U
                        OR buf_ot-supp-line.ext-doc-type = 're':U
                        )
                     NO-LOCK
                         :
