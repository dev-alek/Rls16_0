...
PROCEDURE adm-disable :
    DISABLE RECT-13 print-form t-excel t-TEXT WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-13 print-form t-excel t-TEXT WITH FRAME F-Main.
...
DO:
  assign print-form.
  if not (place-call = 'schedule':U
          or
          place-call = 'rp-by-call':U
          ) then do:
  find first ubflt.usr-flt share-lock
   where ubflt.usr-flt.user-name  = v-cntxt-userid
     ...
     End.
        ...
        assign frame F-Main print-form.
