...
define variable vss-workfile    as character no-undo init "$Workfile: r-bener1.p $":U .
define variable vss-archive     as character no-undo init "$Archive: rep/r-bener1.p $":U .
