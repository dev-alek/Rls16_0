...
define frame fincl1
        ...
        tt-report.pay-sum         column-label "Оплачено,!руб"          format "->,>>>,>>>,>>9.99" space(0)
        sym3                      column-label ":!:"                            format "X(1)"              space(0)
        tt-report.talon-give-sum  column-label "Выдано талонов,!руб"    format "->,>>>,>>>,>>9.99" space(0)
        sym4                      column-label ":!:"                            format "X(1)"              space(0)
        tt-report.fuel-sell-sum   column-label "Отпущено топлива,!руб"  format "->,>>>,>>>,>>9.99" space(0)
...
:
      ...
      :
          find last buf_arh-wth-cli-tot no-lock
            where buf_arh-wth-cli-tot.cli-type     = ub.clients.obj-type
              and buf_arh-wth-cli-tot.cli-code     = ub.clients.obj-code
              and buf_arh-wth-cli-tot.obj-type     = buf_clients.obj-type
              and buf_arh-wth-cli-tot.obj-code     = buf_clients.obj-code
              and buf_arh-wth-cli-tot.ext-doc-type = 'pc':U
              and buf_arh-wth-cli-tot.sum-type     = 'при':U
          ...
          find last buf_arh-wth-cli-tot no-lock
            where buf_arh-wth-cli-tot.cli-type     = ub.clients.obj-type
              ...
              and buf_arh-wth-cli-tot.obj-type     = buf_clients.obj-type
              and buf_arh-wth-cli-tot.obj-code     = buf_clients.obj-code
              and buf_arh-wth-cli-tot.ext-doc-type = 'ee':U
              and buf_arh-wth-cli-tot.sum-type     = 'рас':U
              and buf_arh-wth-cli-tot.fact-order  <= v-fact-order-start
          no-error .
          if available buf_arh-wth-cli-tot then do:
            assign
          ...
          find last buf_arh-wth-cli-tot no-lock
            where buf_arh-wth-cli-tot.cli-type     = ub.clients.obj-type
              ...
              and buf_arh-wth-cli-tot.obj-type     = buf_clients.obj-type
              and buf_arh-wth-cli-tot.obj-code     = buf_clients.obj-code
              and buf_arh-wth-cli-tot.ext-doc-type = 'xc':U
              and buf_arh-wth-cli-tot.sum-type     = 'при':U
              and buf_arh-wth-cli-tot.fact-order  <= v-fact-order-start
          no-error .
          if available buf_arh-wth-cli-tot then do:
      ...
      assign
        ...
        tt-report.obj-name        = ub.clients.obj-name
...
:
      ...
      :
          find last buf_arh-wth-cli-tot no-lock
            where buf_arh-wth-cli-tot.cli-type     = g#post-f.obj-type
              and buf_arh-wth-cli-tot.cli-code     = g#post-f.obj-code
              and buf_arh-wth-cli-tot.obj-type     = buf_clients.obj-type
              and buf_arh-wth-cli-tot.obj-code     = buf_clients.obj-code
              and buf_arh-wth-cli-tot.ext-doc-type = 'pc':U
              and buf_arh-wth-cli-tot.sum-type     = 'при':U
      ...
      assign
        ...
        tt-report.obj-name        = g#post-f.obj-name
        tt-report.pay-sum         = v-saldo-2 - v-saldo-1
        tt-report.talon-give-sum  = v-talon-give-sum-2 - v-talon-give-sum-1
        tt-report.fuel-sell-sum   = v-fuel-sell-sum-2 - v-fuel-sell-sum-1
      .
...
:
  ...
  assign
    ...
    "Клиент"                      + chr(44) +
    "Оплачено руб."       + chr(44) +
    "Выдано талонов руб." + chr(44) +
    "Отпущено топлива руб."
    sheetf.sizes =
    "40"  + chr(44) +
    "20"  + chr(44) +
    "20"  + chr(44) +
...
:
  ...
  :
    ...
    if Make-Excel then  put   stream ForExcel unformatted
      tt-report.obj-name        CHR(9)
      tt-report.pay-sum         CHR(9)
      tt-report.talon-give-sum  CHR(9)
      tt-report.fuel-sell-sum   CHR(9)
    skip.
  end.
  ...
  if Make-Excel then  put   stream ForExcel unformatted
    "Итого"              CHR(9)
    v-pay-sum-tot        CHR(9)
    v-talon-give-sum-tot CHR(9)
    v-fuel-sell-sum-tot  CHR(9)
  skip.
end.
end procedure.
