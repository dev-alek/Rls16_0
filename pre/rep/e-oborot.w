...
define variable tog-dens as logical init no no-undo .
...
PROCEDURE adm-disable :
    DISABLE RECT-8 RECT-9 RECT-5 RECT-6 RECT-10 SortType Tog-obj Classify tog-wt tog-ms ShowZero-2 ShowCostNDS ShowCost EDITOR-1 ShowCost-2 ShowSaleNDS ShowSale ShowSaleNDS-2 ShowSale-2 ShowSaleSLT ShowMediator Tog-Excel B-columns WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-8 RECT-9 RECT-5 RECT-6 RECT-10 SortType Tog-obj Classify tog-wt tog-ms ShowZero-2 ShowCostNDS ShowCost EDITOR-1 ShowCost-2 ShowSaleNDS ShowSale ShowSaleNDS-2 ShowSale-2 ShowSaleSLT ShowMediator Tog-Excel B-columns WITH FRAME F-Main.
...
DO:
  Assign Classify.
   ...
   if Classify = "grp-goods":U
         ...
         Else do:
            display  TOG-lavel  var-Lavel tog-tree with frame F-Main .
            disable  TOG-lavel  var-Lavel tog-tree with frame F-Main .
        end.
END.
...
DO:
  if tog-lavel:screen-value = string(TRUE)
        Then do:
            display  var-Lavel tog-tree with frame F-Main .
            enable   var-Lavel tog-tree with frame F-Main .
        end.
         Else do:
            display    var-Lavel tog-tree with frame F-Main .
            disable    var-Lavel tog-tree with frame F-Main .
        end.
END.
