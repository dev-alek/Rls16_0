            ...
            do:
                ...
                :
                    ...
                    assign
                        ...
                        v-dcard_qnty-bonus = v-dcard_qnty-bonus + buf-obj_dcards.qnty-bonus
                    .
                    assign
                         v-obj_doc-qnty = v-obj_doc-qnty + buf-obj_dcards.doc-qnty
                        v-obj_sum-withdisc = v-obj_sum-withdisc + buf-obj_dcards.sum-withdisc
                       v-obj_qnty-bonus = v-obj_qnty-bonus + buf-obj_dcards.qnty-bonus
                    .
                ...
                do:
                    assign
                        ...
                        buf-obj1_dcards.doc-qnty = v-obj_doc-qnty
  ...
  v-obj_qnty-bonus = 0.
            ...
            :
                ...
                assign
                    ...
                    v-dcard_qnty-bonus = v-dcard_qnty-bonus + buf-obj3_dcards.qnty-bonus
                .
                assign
                    v-obj_sum-withdisc = v-obj_sum-withdisc + buf-obj3_dcards.sum-withdisc
                    v-obj_qnty-bonus = v-obj_qnty-bonus + buf-obj3_dcards.qnty-bonus
                .
        ...
        do:
            case X-selectgood:
                ...
                do:
                    ...
                    tt-selectgood.collection-name = "Выбор товара: По производителям:".
                end.
                when 2 then
                do:
                    do:
        ...
        :
            ...
            do:
                ...
                assign
                    ...
                    buf2_dcards.doc-qnty = buf2_dcards.doc-qnty + v-doc-qnty
                    buf2_dcards.sum-withdisc = buf2_dcards.sum-withdisc + v-sum-withdisc
                    buf2_dcards.discount = buf2_dcards.discount + v-discount
    ...
    for each  bufhl_dcards where  bufhl_dcards.grp-code <> 0  and
        ...
        for each buf2_dcards where buf2_dcards.grp-code =  bufhl_dcards.grp-code and buf2_dcards.grp-lvl <>  bufhl_dcards.grp-lvl and     buf2_dcards.d-card = p-d-card and buf2_dcards.gds-code = 0 :
            ...
            bufhl_dcards.counter = buf2_dcards.counter + bufhl_dcards.counter
                            bufhl_dcards.doc-qnty = buf2_dcards.doc-qnty +  bufhl_dcards.doc-qnty
                    bufhl_dcards.sum-withdisc = buf2_dcards.sum-withdisc +  bufhl_dcards.sum-withdisc
                    bufhl_dcards.discount = buf2_dcards.discount +  bufhl_dcards.discount
