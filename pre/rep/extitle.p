...
IF Make-Excel THEN DO:
  IF NOT Make-Excel-com THEN DO:
    ...
    C-str= ReportNAme + chr(10) + str1
                       + chr(10) + str2
                       + chr(10) + str3
                       + chr(10) + str4
                       + chr(10) + ReportHeader .
    C-str = replace(c-str, (chr(10) + chr(10)), chr(10)).
    ...
    Repeat C-c = 1 to sheetf.Excel-Row-Title :
      Repeat C-i = 1 to NUM-ENTRIES(Entry(c-c,sheetf.Excel-Column-Lable,chr(10)), chr(44)) :
...
IF Make-Excel THEN DO:
  IF Make-Excel-com THEN DO:
     C-str= ReportNAme + chr(10) + str1
                       ...
                       + chr(10) + str4
                       + chr(10) + ReportHeader .
    sheetf.Excel-Row-Heder =  NUM-ENTRIES(C-str ,chr(10) ).
    sheetf.Excel-Row-Title =  NUM-ENTRIES(sheetf.Excel-Column-Lable ,chr(10) ).
If Make-Excel-com THEN DO:
Num#str# = Num#str# + 1. ch#workSheet:Range(COL-name[1] + string(Num#str#)):Value = ReportNAme .
End.
If Make-Excel-com THEN DO:
Num#str# = Num#str# + 1. ch#workSheet:Range(COL-name[1] + string(Num#str#)):Value = str1 .
End.
If Make-Excel-com THEN DO:
Num#str# = Num#str# + 1. ch#workSheet:Range(COL-name[1] + string(Num#str#)):Value = str2 .
End.
If Make-Excel-com THEN DO:
Num#str# = Num#str# + 1. ch#workSheet:Range(COL-name[1] + string(Num#str#)):Value = str3 .
End.
If Make-Excel-com THEN DO:
Num#str# = Num#str# + 1. ch#workSheet:Range(COL-name[1] + string(Num#str#)):Value = str4 .
End.
     Repeat C-c = 1 to sheetf.Excel-Row-Title :
        Repeat C-i = 1 to NUM-ENTRIES(Entry(c-c,sheetf.Excel-Column-Lable,chr(10)), chr(44)) :
            str--1 = Entry( C-i ,Entry(c-c,sheetf.Excel-Column-Lable,chr(10)), chr(44)).
If Make-Excel-com THEN DO:
if c-i = 1 THEN  Num#str# = Num#str# + 1. ch#workSheet:Range(COL-name[C-i] + string(Num#str#)):Value = Trim(Str--1) .
End.
        End.
        C-i = 0.
     End.
  ...
  iF  AllCol > 1 THEN DO :
   ...
   REPEAT L = 1 TO  sheetf.Excel-Row-Heder - 1  :
       cRange = "A" + String(L) + chr(58) + Col-name[AllCol + 1] + string(L) no-error.
       ...
       if L > 1 Then DO:
          ...
          ch#WorkSheet:Range (cRange):HorizontalAlignment = -4131  no-error.
          ch#WorkSheet:Range (cRange):VerticalAlignment = -4160     no-error.
       End.
   End.
    repeat M = sheetf.Excel-Row-Heder TO sheetf.Excel-Row-Heder + sheetf.Excel-Row-Title - 2 :
        repeat l = 2 TO ALLCOL :
           IF  ch#workSheet:Range (Col-name[L] + STRING(M)):value = "" THEN DO:
               ...
               ch#workSheet:Range (Col-name[L - 1] + STRING(M) + chr(58) + Col-name[L] + STRING(M)):MergeCells = True no-error.
           End.
        END.
    End.
     If Excel-Row-Title > 1 Then DO:
        repeat M = Excel-Row-Heder + 1 TO Excel-Row-Heder + Excel-Row-Title - 1 :
          repeat l = 1 TO ALLCOL :
            ...
            ch#workSheet:Range (Col-name[L] + STRING(M) + chr(58) + Col-name[L] + STRING(M - 1)):MergeCells = True no-error.
            End.
          End.
        End.
     End.
   ASSIGN
   cRange = "A" + STRING(Excel-Row-Heder) + chr(58) + Col-name[AllCol + 1] + STRING(Excel-Row-Heder + Excel-Row-Title - 1)
   ch#workSheet:Range (cRange):Font:Bold = TRUE
   ch#workSheet:Range (cRange):Interior:ColorIndex = 35
   ch#workSheet:Range (cRange):HorizontalAlignment = -4108
   ch#workSheet:Range (cRange):VerticalAlignment   = -4160
   ch#workSheet:Range (cRange):WrapText = true
   ch#workSheet:Range (cRange):Orientation = 0 no-error.
   Assign
   ch#workSheet:Range (cRange):Borders(5):LineStyle = -4142
   ch#workSheet:Range (cRange):Borders(6):LineStyle   = -4142
   ch#workSheet:Range (cRange):Borders(7):LineStyle  = 1
   ch#workSheet:Range (cRange):Borders(7):Weight     = 2
   ch#workSheet:Range (cRange):Borders(7):ColorIndex = -4105
   ch#workSheet:Range (cRange):Borders(8):LineStyle  = 1
   ch#workSheet:Range (cRange):Borders(8):Weight     = 2
   ch#workSheet:Range (cRange):Borders(8):ColorIndex = -4105
   ch#workSheet:Range (cRange):Borders(9):LineStyle  = 1
   ch#workSheet:Range (cRange):Borders(9):Weight     = 2
   ch#workSheet:Range (cRange):Borders(9):ColorIndex = -4105
   ch#workSheet:Range (cRange):Borders(10):LineStyle  = 1
   ch#workSheet:Range (cRange):Borders(10):Weight     = 2
   ch#workSheet:Range (cRange):Borders(10):ColorIndex = -4105
   ch#workSheet:Range (cRange):Borders(11):LineStyle  = 1
   ch#workSheet:Range (cRange):Borders(11):Weight     = 2
   ch#workSheet:Range (cRange):Borders(11):ColorIndex = -4105 no-error.
   IF Excel-Row-Title > 1 THEN
   Assign
   ch#workSheet:Range (cRange):Borders(12):LineStyle  = 1
   ch#workSheet:Range (cRange):Borders(12):Weight     = 2
   ch#workSheet:Range (cRange):Borders(12):ColorIndex = -4105
