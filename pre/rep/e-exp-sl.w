...
IF NOT THIS-PROCEDURE:PERSISTENT THEN DO:
  MESSAGE "c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\rep\e-exp-sl.w should only be RUN PERSISTENT.":U
...
PROCEDURE adm-disable :
    DISABLE RECT-7 RADIO-doc v-login v-password v-name WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-7 RADIO-doc v-login v-password v-name WITH FRAME F-Main.
...
END PROCEDURE.
PROCEDURE my-var :
assign frame F-Main  RADIO-doc v-ftp-address v-login v-password .
END PROCEDURE.
...
sToWrite = p-log-string + chr(10).
define variable v-text    as character    no-undo.
 DO WITH frame F-Main:
      ASSIGN
         v-text = editor-log + chr(10) + p-log-string
        editor-log = v-text.
      DISPLAY editor-log.
   END.
