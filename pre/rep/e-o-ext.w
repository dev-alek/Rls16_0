...
PROCEDURE adm-disable :
    DISABLE RECT-9 RECT-6 RECT-5 RECT-8 SortType Tog-obj Classify COMBO-node ShowZero WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-9 RECT-6 RECT-5 RECT-8 SortType Tog-obj Classify COMBO-node ShowZero WITH FRAME F-Main.
...
PROCEDURE local-initialize :
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .
   ...
   var-lavel:screen-value in frame F-Main = '1'.
    Combo-node:list-items = Combo-node:list-items + ',' + 'касса продажа':U      .
    ...
    Combo-node:list-items = Combo-node:list-items + ',' + 'корректировка отрицательных партий':U            .
    Combo-node:list-items = Combo-node:list-items + ',' + 'пересортица':U            .
    Combo-node:screen-value in frame F-Main = 'касса'.
...
END PROCEDURE.
PROCEDURE my-var :
assign frame F-Main SumsOnly ShowZero tog-obj
...
ReportHeader = ReportHeader +
            ...
            Case COMBO-node:
                ...
                when  'корректировка отрицательных партий':U              then   COMBO-node = 'mp':U            .
   ...
   if lookup (classify,"no-classify,prod,grp-goods":u) > 0 then do:
      run rep/r-o-ex1y.p
                ( input v-cntxt-obj-code ,
                  ...
                  input base-type  ,
                  input base-code  ,
                  input classify:screen-value in frame F-Main ,
                  input sorttype                                      ,
                  input sumsonly  ,
                  input showzero  ,
                  input combo-node ,
      ...
      run rep/r-o-ex2y.p
                ( input v-cntxt-obj-code ,
                  ...
                  input base-code  ,
                  input classify:screen-value in frame F-Main ,
                  input sorttype:screen-value in frame F-Main ,
                  input sumsonly  ,
                  input showzero  ,
                  input combo-node ,
                  input tog-obj      ,
