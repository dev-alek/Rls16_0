...
define variable vss-workfile    as character no-undo init "$Workfile: r-beneb4.p $":U .
define variable vss-archive     as character no-undo init "$Archive: rep/r-beneb4.p $":U .
   ...
   FOR EACH ub.inkas WHERE
    ...
    BY ub.inkas-pay-desk.curr-code :
      if first-of( ub.inkas-pay-desk.pay-desk ) then  do:
        ...
        Day-Tot-R-b  = (if v-curr-r-b = 'base':U
                        then Day-Tot-Base
                        else Day-Tot-rubl)
        .
      end.
