...
define variable vss-description as character no-undo init "Çàïóñê îò÷åòà ÏÎ×ÀÑÎÂÀß ÑÒÀÒÈÑÒÈÊÀ ÏÎ ÊÎË-ÂÓ ÒÎÂÀÐÎÂ".
...
run rep/d-report.w ( input parparentproc
                    ,input 'rep/e-grphr.w'
                    ,input 'Ïî÷àñîâàÿ ñòàòèñòèêà ðîçíè÷íûõ ïðîäàæ ïî ÊÎËÈ×ÅÑÒÂÓ ÒÎÂÀÐÎÂ'
                    ,input 2
                    ,input "1,2,3,4"
                    ,input '*'
                    ,input ''
