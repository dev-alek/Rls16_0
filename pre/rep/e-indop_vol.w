...
PROCEDURE adm-disable :
    DISABLE f-pl btn-add WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN f-pl btn-add WITH FRAME F-Main.
...
ON CHOOSE OF btn-add IN FRAME F-Main
   DO:
      ...
      display f-pl with frame F-Main.
   END.
