...
PROCEDURE adm-disable :
    DISABLE tg-price-doc WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN tg-price-doc WITH FRAME F-Main.
...
PROCEDURE my-var :
  ...
  .
  assign
    ReportHeader = chr(10) + (if(tg-price-doc) then "В" else "Не в" ) + "ыводить дополнительные е.и. при отсутствии переоценки".
  .
END PROCEDURE.
