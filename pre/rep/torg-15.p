...
define variable v-reason-code   like trn-reason.reason-code         no-undo.
...
run get-report-num in p-mainmenu-handle (
  ...
  v-report-name-html = session:temp-directory + "rpt" + string(g#report-num) + ".html".
...
find first b-trn-doc no-lock
     where b-trn-doc.doc-code = t-doc.doc-code no-error.
      ...
      ,
        string( "ИНН " + t-inn + " " + caps( clients.obj-name ) + " (" + string(clients.obj-code) + ")" + t-addres + t-phone),
        t-okpo,
