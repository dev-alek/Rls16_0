...
DEFINE NEW SHARED temp-table gds-h no-undo
   field obj-code like ub.clients.obj-code
    field grp-code like ub.goods.grp-code
...
PROCEDURE adm-disable :
    DISABLE T-dis-card BR-dis-card-type Tree RS-OPTION t-byobject WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN T-dis-card BR-dis-card-type Tree RS-OPTION t-byobject WITH FRAME F-Main.
...
DO:
  ...
  END.
END.
ON VALUE-CHANGED OF t-byobject IN FRAME F-Main
DO:
  ASSIGN
  t-byobject.
END.
...
then do:
  ...
  do ii = 1 to 24:
    for-h-str =
     string( vH-0 ) + chr(44) + string( vH-1 ) + chr(44) +
     string( vH-2 ) + chr(44) + string( vH-3 ) +  chr(44) +
     string( vH-4 ) + chr(44) + string( vH-5 ) + chr(44) +
     string( vH-6 ) + chr(44) + string( vH-7 ) + chr(44) +
     string( vH-8 ) + chr(44) + string( vH-9 ) +  chr(44) +
     string( vH-10 ) + chr(44) + string( vH-11 ) + chr(44) +
     string( vH-12 ) + chr(44) + string( vH-13 ) + chr(44) +
     string( vH-14 ) + chr(44) + string( vH-15 ) + chr(44) +
     string( vH-16 ) + chr(44) + string( vH-17 ) + chr(44) +
     string( vH-18 ) + chr(44) + string( vH-19 ) + chr(44) +
     string( vH-20 ) + chr(44) + string( vH-21 ) + chr(44) +
     string( vH-22 ) + chr(44) + string( vH-23 ).
  end.
  run rep/r-sumhr.p (
                 input for-h-str
                ,input yes
