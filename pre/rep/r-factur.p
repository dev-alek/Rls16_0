...
define frame factur
 ...
 v-unit-code      column-label "    !   и!----! !код ! ! ":C4 format "X(4)" space(0)
 ...
 v-qnty           column-label "Количество! (объем)  ! ! ! ":C11 format ">>>>>>9.<<<" space(0)
 ...
 v-GTD            column-label "Регистра-!ционный!номер!таможенной!декларации":C22 format "X(22)" space(0)
...
define frame corr-factur
 ...
 v-uaes-code      column-label "!Код!вида!товара":C6 format "x(6)" space(0)
         sym16            column-label ":!:!:!:!:!:" format "X(1)" space(0)
 v-unit-code      column-label "   Е!  из!----! !код ! " format "X(4)" space(0)
...
THEN DO:
  form header
      ...
      with frame Bottomframe-corr width 235 page-bottom no-labels no-box .
...
:
    ...
    do while trim(v-start-string) <> "" :
        ...
        display stream Out-stream
            ...
            sym9  sym11 sym12 sym13 sym14 sym15 sym16
            with frame factur .
    ...
    then do:
        ...
        then do:
          ...
          if is-printed = no then do:
            ...
            down stream Out-stream 1 with frame factur .
            run facturxl-write-line-data in this-procedure (
                  input (if rep-artic then (string(ub.goods.artic,"x(16)") +  " ") else "") + ub.goods.gds-name
                , input "":U
                , input "":U
                , input "":U
                , input "":U
            ...
            then do:
                ...
                if lookup ( "corr" , p-mode ) <> 0 then do :
                      ...
                      assign v-start-str = gds-str2
                            gds-str = v-start-str
                            v-add-str = breakstr(gds-str, 42, input-output v-add-str, input-output v-start-str).
                      display stream Out-stream
                          sym1
                      ...
                      run facturxl-write-line-data-corr in this-procedure (
                            input v-prt-name
                          , input "А (до изменения)"
                          , input v-uaes-code
                          , input v-unit-code
                          , input ub.goods.unit-base
                          , input string( v-prt-doc-qnty )
                          , input string( v-price-no-VAT )
                          , input string( v-prt-doc-sum-no-VAT )
                          , input "без акциза":U
                          , input string( doc-line.Vat-pc )
                          , input string( v-prt-doc-VAT )
                          , input string( v-prt-doc-sum )
                      ).
                      run facturxl-write-line-data-corr in this-procedure (
                            input ""
                          , input "Б (после изменения)"
                          , input v-uaes-code
                          , input v-unit-code
                          , input ub.goods.unit-base
                      ...
                      run facturxl-write-line-data-corr in this-procedure (
                          ...
                          , input ""
                          , input ""
                          , input (if v-diff-sum-no-VAT > 0 then string(v-diff-sum-no-VAT) else "")
                          , input "без акциза":U
                          , input ""
                          , input (if v-diff-VAT > 0 then string(v-diff-VAT) else "")
                          , input (if v-diff-sum > 0 then string(v-diff-sum) else "")
                      ).
                      run facturxl-write-line-data-corr in this-procedure (
                            input ""
                          , input "Г (уменьшение)"
                          ...
                          , input ""
                          , input ""
                          , input (if v-diff-sum-no-VAT < 0 then string(abs(v-diff-sum-no-VAT)) else "")
                          , input "без акциза":U
                          , input ""
                          , input (if v-diff-VAT < 0 then string(abs(v-diff-VAT)) else "")
                          , input (if v-diff-sum < 0 then string(abs(v-diff-sum)) else "")
                      ).
                end.
                else do :
                display stream out-stream
            ...
            :
                    ...
                    if lookup ( "corr" , p-mode) <> 0 then do :
                        ...
                        run facturxl-write-line-data-corr in this-procedure (
                          ...
                          , input v-unit-code
                          , input ub.goods.unit-base
                          , input string( ub.parts.qnty )
                          , input string( v-price-no-VAT )
                          , input (if v-doc-qnty <> 0 then v-sum-no-VAT * ub.parts.qnty / v-doc-qnty else 0 )
                          , input "без акциза":U
                          , input string( ub.doc-line.Vat-pc )
                          , input ( if v-doc-qnty = 0 then "":U else string( v-doc-VAT * ub.parts.qnty / v-doc-qnty ) )
                          , input string( if v-doc-qnty <> 0 then v-doc-sum * ub.parts.qnty / v-doc-qnty else 0 )
                        ).
                        run facturxl-write-line-data-corr in this-procedure (
                              input ""
                            , input "Б (после изменения)"
        ...
        then do:
          if lookup ( "corr" , p-mode ) <> 0 then do :
                        ...
                        run facturxl-write-line-data-corr in this-procedure (
                          ...
                          , input string( v-doc-qnty          )
                          , input string( v-price-no-VAT )
                          , input string( v-doc-sum-no-VAT    )
                          , input "без акциза":U
                          , input string( ub.doc-line.Vat-pc )
                          , input string( v-doc-VAT       )
                          , input string( v-doc-sum       )
                        ).
                        run facturxl-write-line-data-corr in this-procedure (
                              input ""
                            , input "Б (после изменения)"
...
.
                    ...
                    if lookup ( "corr" , p-mode ) <> 0 then do :
                        ...
                        run facturxl-write-line-data-corr in this-procedure (
                            ...
                            , input v-uaes-code
                            , input v-unit-code
                            , input ( if invers then doc-line.unit-cli else goods.unit-base )
                            , input string( v-prt-doc-qnty                        )
                            , input string( v-parts-price-no-VAT              )
                            , input string( v-parts-price-no-VAT * v-prt-doc-qnty )
                            , input "без акциза":U
                            , input string( ub.doc-line.Vat-pc          )
                            , input ( if v-qnty = 0 then "":U else string( v-parts-VAT * v-prt-doc-qnty ) )
                            , input string( (v-parts-price-no-VAT + v-parts-VAT) * v-prt-doc-qnty )
                        ).
                        run facturxl-write-line-data-corr in this-procedure (
                              input ""
                            , input "Б (после изменения)"
                  ...
                  if lookup ( "corr" , p-mode ) <> 0 then do:
                      ...
                      run facturxl-write-line-data-corr in this-procedure (
                          ...
                          , input string( v-prt-doc-qnty              )
                          , input string( v-price-no-VAT              )
                          , input string( v-price-no-VAT * v-prt-doc-qnty )
                          , input "без акциза":U
                          , input string( ub.doc-line.Vat-pc          )
                          , input ( if v-qnty = 0 then "":U else string(v-doc-VAT / v-doc-qnty * v-prt-doc-qnty) )
                          , input ( if v-qnty = 0 then "":U else string(( v-price-no-VAT + v-doc-VAT / v-doc-qnty ) * v-prt-doc-qnty ) )
                      ).
                      run facturxl-write-line-data-corr in this-procedure (
                            input ""
                          , input "Б (после изменения)"
  ...
  ,output v-base-code
    ...
    if lookup ("corr" , p-mode) <> 0 then do :
      put stream Out-stream
          ...
          skip    space(5) string( "ИНН/КПП продавца" + ( if p-round = 'round':U then ":" else " " ) + t-inn ) format "X(190)"
      .
    end.
    else do :
    put stream Out-stream
          ...
          skip    space(5) string( "ИНН/КПП продавца" + fill( " ", 23 ) + ( if p-round = 'round':U then ":" else " " ) + t-inn ) format "X(190)" "(2б)" at 196
        .
    end.
...
if valid-handle( g#trdcalib ) <> yes then do:       run str/trdcalib.p persistent no-error.       if error-status :error or valid-handle( g#trdcalib ) <> yes then do:         message "Error starting trdcalib.p"    skip( 0 )                 g#trdcalib                     skip( 0 )                 g#trdcalib   :type             skip( 0 )                 g#trdcalib   :file-name        skip( 0 )                 error-status :get-message( 1 ) skip( 0 )                 return-value                   skip( 0 )         view-as alert-box error.         stop.       end.      end.     run trdcalib_tdat-val in g#trdcalib (  input p-doc-code ,
  ...
  if lookup ("corr" , p-mode) = 0 then do :
        ...
        skip    space(5) string( "ИНН/КПП покупателя" + fill( " ", 21 ) + ( if p-round = 'round':U then ": " else " " ) + t-inn ) format "X(190)" "(6б)" at 196
        skip
    .
    run facturxl-write-cell-data in this-procedure (
          input "h_platDoc":U
    ...
    then do:
        ...
        space(5)
            string( "Валюта:  " +
            trim( ( if invers and buf_trn-doc.doc-type <> 'при':U then v-curr-name else ( if PrintRubl then v-rubl-name else v-base-name  ) ) ) ) format "X(120)" "(7)" at 196 skip(0)
        .
    end.
    put stream Out-stream
        space(5)
    ...
    if lookup("TopAukc", p-mode) <> 0 then do :
      find first buf_ext-classif where buf_ext-classif.classif-subject  = 'clients':U                    and
                                       buf_ext-classif.classif-name     = 'code_firm_ext':U and
                                       ...
                                       buf_ext-classif.nonunique        = ((if buf_trn-doc.cli-type = 'орг':U then 1000000000 else 0) + buf_trn-doc.cli-code)
                                        no-lock no-error.
      v-suppNUM = (if available buf_ext-classif then buf_ext-classif.CharKey_Three else '').
if valid-handle( g#trdcalib ) <> yes then do:       run str/trdcalib.p persistent no-error.       if error-status :error or valid-handle( g#trdcalib ) <> yes then do:         message "Error starting trdcalib.p"    skip( 0 )                 g#trdcalib                     skip( 0 )                 g#trdcalib   :type             skip( 0 )                 g#trdcalib   :file-name        skip( 0 )                 error-status :get-message( 1 ) skip( 0 )                 return-value                   skip( 0 )         view-as alert-box error.         stop.       end.      end.     run trdcalib_tdat-val in g#trdcalib (  input p-doc-code ,
                        input 'zakaz-number':U ,
                       output v-ordNUM ,
                       output v-attr-type ) no-error .
      run facturxl-write-cell-data in this-procedure (
            input "h_suppNUM":U
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run basecode in g#library
  ...
  if lookup ( "corr" , p-mode ) <> 0 then do :
    ...
    then do:
        ...
        put stream Out-stream
            skip ":" + v-tax-name  format "X(20)" ":" at 44
