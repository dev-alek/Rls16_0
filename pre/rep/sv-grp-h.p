...
Assign l-col-type="INTEGER"   l-col-len=11  l-col-format= "->,>>>,>>9"  l-col-lable=" 0.00-0.59 ".
  ...
  define variable c-num-chk1 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[4] = true then DO:
        ...
        CREATE EDITOR L-4 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-num-chk1 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER"   l-col-len=11  l-col-format= "->,>>>,>>9"  l-col-lable=" 1.00-1.59 ".
  ...
  define variable c-num-chk2 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[5] = true then DO:
        ...
        CREATE EDITOR L-5 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-num-chk2 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER"   l-col-len=11  l-col-format= "->,>>>,>>9"  l-col-lable=" 2.00-2.59 ".
  ...
  define variable c-num-chk3 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[6] = true then DO:
        ...
        CREATE EDITOR L-6 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-num-chk3 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER"   l-col-len=11  l-col-format= "->,>>>,>>9"  l-col-lable=" 3.00-3.59 ".
  ...
  define variable c-num-chk4 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[7] = true then DO:
        ...
        CREATE EDITOR L-7 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-num-chk4 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER"   l-col-len=11  l-col-format= "->,>>>,>>9"  l-col-lable=" 4.00-4.59 ".
  ...
  define variable c-num-chk5 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[8] = true then DO:
        ...
        CREATE EDITOR L-8 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-num-chk5 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER"   l-col-len=11  l-col-format= "->,>>>,>>9"  l-col-lable=" 5.00-5.59 ".
  ...
  define variable c-num-chk6 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[9] = true then DO:
        ...
        CREATE EDITOR L-9 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-num-chk6 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER"   l-col-len=11  l-col-format= "->,>>>,>>9"  l-col-lable=" 6.00-6.59 ".
  ...
  define variable c-num-chk7 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[10] = true then DO:
        ...
        CREATE EDITOR L-10 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-num-chk7 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER"   l-col-len=11  l-col-format= "->,>>>,>>9"  l-col-lable=" 7.00-7.59 ".
  ...
  define variable c-num-chk8 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[11] = true then DO:
        ...
        CREATE EDITOR L-11 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-num-chk8 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER"   l-col-len=11  l-col-format= "->,>>>,>>9"  l-col-lable=" 8.00-8.59 ".
  ...
  define variable c-num-chk9 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[12] = true then DO:
        ...
        CREATE EDITOR L-12 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-num-chk9 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER"   l-col-len=11  l-col-format= "->,>>>,>>9"  l-col-lable=" 9.00-9.59 ".
  ...
  define variable c-num-chk10 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[13] = true then DO:
        ...
        CREATE EDITOR L-13 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-num-chk10 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER"   l-col-len=11  l-col-format= "->,>>>,>>9"  l-col-lable="10.00-10.59".
  ...
  define variable c-num-chk11 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[14] = true then DO:
        ...
        CREATE EDITOR L-14 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-num-chk11 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER"   l-col-len=11  l-col-format= "->,>>>,>>9"  l-col-lable="11.00-11.59".
  ...
  define variable c-num-chk12 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[15] = true then DO:
        ...
        CREATE EDITOR L-15 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-num-chk12 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER"   l-col-len=11  l-col-format= "->,>>>,>>9"  l-col-lable="12.00-12.59".
  ...
  define variable c-num-chk13 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[16] = true then DO:
        ...
        CREATE EDITOR L-16 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-num-chk13 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER"   l-col-len=11  l-col-format= "->,>>>,>>9"  l-col-lable="13.00-13.59".
  ...
  define variable c-num-chk14 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[17] = true then DO:
        ...
        CREATE EDITOR L-17 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-num-chk14 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER"   l-col-len=11  l-col-format= "->,>>>,>>9"  l-col-lable="14.00-14.59".
  ...
  define variable c-num-chk15 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[18] = true then DO:
        ...
        CREATE EDITOR L-18 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-num-chk15 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER"   l-col-len=11  l-col-format= "->,>>>,>>9"  l-col-lable="15.00-15.59".
  ...
  define variable c-num-chk16 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[19] = true then DO:
        ...
        CREATE EDITOR L-19 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-num-chk16 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER"   l-col-len=11  l-col-format= "->,>>>,>>9"  l-col-lable="16.00-16.59".
  ...
  define variable c-num-chk17 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[20] = true then DO:
        ...
        CREATE EDITOR L-20 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-num-chk17 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER"   l-col-len=11  l-col-format= "->,>>>,>>9"  l-col-lable="17.00-17.59".
  ...
  define variable c-num-chk18 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[21] = true then DO:
        ...
        CREATE EDITOR L-21 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-num-chk18 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER"   l-col-len=11  l-col-format= "->,>>>,>>9"  l-col-lable="18.00-18.59".
  ...
  define variable c-num-chk19 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[22] = true then DO:
        ...
        CREATE EDITOR L-22 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-num-chk19 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER"   l-col-len=11  l-col-format= "->,>>>,>>9"  l-col-lable="19.00-19.59".
  ...
  define variable c-num-chk20 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[23] = true then DO:
        ...
        CREATE EDITOR L-23 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-num-chk20 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER"   l-col-len=11  l-col-format= "->,>>>,>>9"  l-col-lable="20.00-20.59".
  ...
  define variable c-num-chk21 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[24] = true then DO:
        ...
        CREATE EDITOR L-24 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-num-chk21 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER"   l-col-len=11  l-col-format= "->,>>>,>>9"  l-col-lable="21.00-21.59".
  ...
  define variable c-num-chk22 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[25] = true then DO:
        ...
        CREATE EDITOR L-25 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-num-chk22 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER"   l-col-len=11  l-col-format= "->,>>>,>>9"  l-col-lable="22.00-22.59".
  ...
  define variable c-num-chk23 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[26] = true then DO:
        ...
        CREATE EDITOR L-26 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-num-chk23 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER"   l-col-len=11  l-col-format= "->,>>>,>>9"  l-col-lable="23.00-23.59".
  ...
  define variable c-num-chk24 as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[27] = true then DO:
        ...
        CREATE EDITOR L-27 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-num-chk24 IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER"   l-col-len=11 l-col-format= "->>,>>>,>>9"  l-col-lable="Итого по строке".
  ...
  define variable c-tot-nc as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[28] = true then DO:
        ...
        CREATE EDITOR L-28 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-tot-nc IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME hour:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
do cycle = 1 to 0 by -1:
  ...
  if use-column[2]
  then  C-full-name:screen-value = string(fill44).
  if use-column[4]
  then  C-num-chk1:screen-value = string(fill11).
  if use-column[5]
  then  C-num-chk2:screen-value = string(fill11).
  if use-column[6]
  then  C-num-chk3:screen-value = string(fill11).
  if use-column[7]
  then  C-num-chk4:screen-value = string(fill11).
  if use-column[8]
  then  C-num-chk5:screen-value = string(fill11).
  if use-column[9]
  then  C-num-chk6:screen-value = string(fill11).
  if use-column[10]
  then  C-num-chk7:screen-value = string(fill11).
  if use-column[11]
  then  C-num-chk8:screen-value = string(fill11).
  if use-column[12]
  then  C-num-chk9:screen-value = string(fill11).
  if use-column[13]
  then  C-num-chk10:screen-value = string(fill11).
  if use-column[14]
  then  C-num-chk11:screen-value = string(fill11).
  if use-column[15]
  then  C-num-chk12:screen-value = string(fill11).
  if use-column[16]
  then  C-num-chk13:screen-value = string(fill11).
  if use-column[17]
  then  C-num-chk14:screen-value = string(fill11).
  if use-column[18]
  then  C-num-chk15:screen-value = string(fill11).
  if use-column[19]
  then  C-num-chk16:screen-value = string(fill11).
  if use-column[20]
  then  C-num-chk17:screen-value = string(fill11).
  if use-column[21]
  then  C-num-chk18:screen-value = string(fill11).
  if use-column[22]
  then  C-num-chk19:screen-value = string(fill11).
  if use-column[23]
  then  C-num-chk20:screen-value = string(fill11).
  if use-column[24]
  then  C-num-chk21:screen-value = string(fill11).
  if use-column[25]
  then  C-num-chk22:screen-value = string(fill11).
  if use-column[26]
  then  C-num-chk23:screen-value = string(fill11).
  if use-column[27]
  then  C-num-chk24:screen-value = string(fill11).
  if use-column[28]
  then  C-tot-nc:screen-value = string(fill11).
        DISPLAY stream  PrnLibStream with frame HOUR.       DOWN 1 stream PrnLibStream with frame HOUR.
    assign
    accum-count = 0
    tot-nc = 0
  ...
  then  C-sym2:screen-value = string(sym2, entry(1, c-sym2:private-data, chr(4))).
        DISPLAY stream  PrnLibStream with frame HOUR.                                      DOWN 1 stream PrnLibStream with frame HOUR.
  if use-column[1]
  then  C-sym1:screen-value = string(fill1).
  if use-column[3]
  then  C-sym2:screen-value = string(fill1).
  if use-column[29]
  then  C-sym3:screen-value = string('-').
  if use-column[2]
  then  C-full-name:screen-value = string(fill44).
  if use-column[4]
  then  C-num-chk1:screen-value = string(fill11).
  ...
  then  C-sym1:screen-value = string(sym1, entry(1, c-sym1:private-data, chr(4))).
  if use-column[2]
  then  C-full-name:screen-value = string((string(sum-vals.sum1) + '-' + string(sum-vals.sum2) ), entry(1, c-full-name:private-data, chr(4))).
  if use-column[3]
  then  C-sym2:screen-value = string(sym2, entry(1, c-sym2:private-data, chr(4))).
  if use-column[4]
  then  C-num-chk1:screen-value = string(grp-h.num-chk[1], entry(1, c-num-chk1:private-data, chr(4))).
  if use-column[5]
  then  C-num-chk2:screen-value = string(grp-h.num-chk[2], entry(1, c-num-chk2:private-data, chr(4))).
  if use-column[6]
  then  C-num-chk3:screen-value = string(grp-h.num-chk[3], entry(1, c-num-chk3:private-data, chr(4))).
  if use-column[7]
  then  C-num-chk4:screen-value = string(grp-h.num-chk[4], entry(1, c-num-chk4:private-data, chr(4))).
  if use-column[8]
  then  C-num-chk5:screen-value = string(grp-h.num-chk[5], entry(1, c-num-chk5:private-data, chr(4))).
  if use-column[9]
  then  C-num-chk6:screen-value = string(grp-h.num-chk[6], entry(1, c-num-chk6:private-data, chr(4))).
  if use-column[10]
  then  C-num-chk7:screen-value = string(grp-h.num-chk[7], entry(1, c-num-chk7:private-data, chr(4))).
  if use-column[11]
  then  C-num-chk8:screen-value = string(grp-h.num-chk[8], entry(1, c-num-chk8:private-data, chr(4))).
  if use-column[12]
  then  C-num-chk9:screen-value = string(grp-h.num-chk[9], entry(1, c-num-chk9:private-data, chr(4))).
  if use-column[13]
  then  C-num-chk10:screen-value = string(grp-h.num-chk[10], entry(1, c-num-chk10:private-data, chr(4))).
  if use-column[14]
  then  C-num-chk11:screen-value = string(grp-h.num-chk[11], entry(1, c-num-chk11:private-data, chr(4))).
  if use-column[15]
  then  C-num-chk12:screen-value = string(grp-h.num-chk[12], entry(1, c-num-chk12:private-data, chr(4))).
  if use-column[16]
  then  C-num-chk13:screen-value = string(grp-h.num-chk[13], entry(1, c-num-chk13:private-data, chr(4))).
  if use-column[17]
  then  C-num-chk14:screen-value = string(grp-h.num-chk[14], entry(1, c-num-chk14:private-data, chr(4))).
  if use-column[18]
  then  C-num-chk15:screen-value = string(grp-h.num-chk[15], entry(1, c-num-chk15:private-data, chr(4))).
  if use-column[19]
  then  C-num-chk16:screen-value = string(grp-h.num-chk[16], entry(1, c-num-chk16:private-data, chr(4))).
  if use-column[20]
  then  C-num-chk17:screen-value = string(grp-h.num-chk[17], entry(1, c-num-chk17:private-data, chr(4))).
  if use-column[21]
  then  C-num-chk18:screen-value = string(grp-h.num-chk[18], entry(1, c-num-chk18:private-data, chr(4))).
  if use-column[22]
  then  C-num-chk19:screen-value = string(grp-h.num-chk[19], entry(1, c-num-chk19:private-data, chr(4))).
  if use-column[23]
  then  C-num-chk20:screen-value = string(grp-h.num-chk[20], entry(1, c-num-chk20:private-data, chr(4))).
  if use-column[24]
  then  C-num-chk21:screen-value = string(grp-h.num-chk[21], entry(1, c-num-chk21:private-data, chr(4))).
  if use-column[25]
  then  C-num-chk22:screen-value = string(grp-h.num-chk[22], entry(1, c-num-chk22:private-data, chr(4))).
  if use-column[26]
  then  C-num-chk23:screen-value = string(grp-h.num-chk[23], entry(1, c-num-chk23:private-data, chr(4))).
  if use-column[27]
  then  C-num-chk24:screen-value = string(grp-h.num-chk[24], entry(1, c-num-chk24:private-data, chr(4))).
  if use-column[28]
  then  C-tot-nc:screen-value = string(tot-nc, entry(1, c-tot-nc:private-data, chr(4))).
  if use-column[29]
  ...
  if use-column[2]
  then  C-full-name:screen-value = string(substitute('Итого &1 по виду платежа', v-obj-name), entry(1, c-full-name:private-data, chr(4))).
        end.
        if method = "LINE" then do:
  if use-column[2]
  then  C-full-name:screen-value = string(substitute('Итого &1 по группе', v-obj-name), entry(1, c-full-name:private-data, chr(4))).
        end.
  if use-column[4]
  then  C-num-chk1:screen-value = string(accum-num-chk-grp[1], entry(1, c-num-chk1:private-data, chr(4))).
  if use-column[5]
  then  C-num-chk2:screen-value = string(accum-num-chk-grp[2], entry(1, c-num-chk2:private-data, chr(4))).
  if use-column[6]
  then  C-num-chk3:screen-value = string(accum-num-chk-grp[3], entry(1, c-num-chk3:private-data, chr(4))).
  if use-column[7]
  then  C-num-chk4:screen-value = string(accum-num-chk-grp[4], entry(1, c-num-chk4:private-data, chr(4))).
  if use-column[8]
  then  C-num-chk5:screen-value = string(accum-num-chk-grp[5], entry(1, c-num-chk5:private-data, chr(4))).
  if use-column[9]
  then  C-num-chk6:screen-value = string(accum-num-chk-grp[6], entry(1, c-num-chk6:private-data, chr(4))).
  if use-column[10]
  then  C-num-chk7:screen-value = string(accum-num-chk-grp[7], entry(1, c-num-chk7:private-data, chr(4))).
  if use-column[11]
  then  C-num-chk8:screen-value = string(accum-num-chk-grp[8], entry(1, c-num-chk8:private-data, chr(4))).
  if use-column[12]
  then  C-num-chk9:screen-value = string(accum-num-chk-grp[9], entry(1, c-num-chk9:private-data, chr(4))).
  if use-column[13]
  then  C-num-chk10:screen-value = string(accum-num-chk-grp[10], entry(1, c-num-chk10:private-data, chr(4))).
  if use-column[14]
  then  C-num-chk11:screen-value = string(accum-num-chk-grp[11], entry(1, c-num-chk11:private-data, chr(4))).
  if use-column[15]
  then  C-num-chk12:screen-value = string(accum-num-chk-grp[12], entry(1, c-num-chk12:private-data, chr(4))).
  if use-column[16]
  then  C-num-chk13:screen-value = string(accum-num-chk-grp[13], entry(1, c-num-chk13:private-data, chr(4))).
  if use-column[17]
  then  C-num-chk14:screen-value = string(accum-num-chk-grp[14], entry(1, c-num-chk14:private-data, chr(4))).
  if use-column[18]
  then  C-num-chk15:screen-value = string(accum-num-chk-grp[15], entry(1, c-num-chk15:private-data, chr(4))).
  if use-column[19]
  then  C-num-chk16:screen-value = string(accum-num-chk-grp[16], entry(1, c-num-chk16:private-data, chr(4))).
  if use-column[20]
  then  C-num-chk17:screen-value = string(accum-num-chk-grp[17], entry(1, c-num-chk17:private-data, chr(4))).
  if use-column[21]
  then  C-num-chk18:screen-value = string(accum-num-chk-grp[18], entry(1, c-num-chk18:private-data, chr(4))).
  if use-column[22]
  then  C-num-chk19:screen-value = string(accum-num-chk-grp[19], entry(1, c-num-chk19:private-data, chr(4))).
  if use-column[23]
  then  C-num-chk20:screen-value = string(accum-num-chk-grp[20], entry(1, c-num-chk20:private-data, chr(4))).
  if use-column[24]
  then  C-num-chk21:screen-value = string(accum-num-chk-grp[21], entry(1, c-num-chk21:private-data, chr(4))).
  if use-column[25]
  then  C-num-chk22:screen-value = string(accum-num-chk-grp[22], entry(1, c-num-chk22:private-data, chr(4))).
  if use-column[26]
  then  C-num-chk23:screen-value = string(accum-num-chk-grp[23], entry(1, c-num-chk23:private-data, chr(4))).
  if use-column[27]
  then  C-num-chk24:screen-value = string(accum-num-chk-grp[24], entry(1, c-num-chk24:private-data, chr(4))).
  if use-column[28]
  then  C-tot-nc:screen-value = string(ACCUM-tot-nc-grp, entry(1, c-tot-nc:private-data, chr(4))).
        DISPLAY stream  PrnLibStream with frame HOUR.                                      DOWN 1 stream PrnLibStream with frame HOUR.
  ...
  if use-column[2]
  then  C-full-name:screen-value = string( substitute('&1 по ВСЕМ ПЛАТЕЖАМ', v-obj-name), entry(1, c-full-name:private-data, chr(4))).
      end.
      else do:
  if use-column[2]
  then  C-full-name:screen-value = string(substitute('&1 по ВСЕМ ГРУППАМ', v-obj-name) , entry(1, c-full-name:private-data, chr(4))).
      end.
      DISPLAY stream  PrnLibStream with frame HOUR.                                      DOWN 1 stream PrnLibStream with frame HOUR.
  if use-column[2]
  then  C-full-name:screen-value = string(fill44).
  ...
  then  C-sym2:screen-value = string(sym2, entry(1, c-sym2:private-data, chr(4))).
  if use-column[4]
  then  C-num-chk1:screen-value = string(sum-vals.num-chk[1], entry(1, c-num-chk1:private-data, chr(4))).
  if use-column[5]
  then  C-num-chk2:screen-value = string(sum-vals.num-chk[2], entry(1, c-num-chk2:private-data, chr(4))).
  if use-column[6]
  then  C-num-chk3:screen-value = string(sum-vals.num-chk[3], entry(1, c-num-chk3:private-data, chr(4))).
  if use-column[7]
  then  C-num-chk4:screen-value = string(sum-vals.num-chk[4], entry(1, c-num-chk4:private-data, chr(4))).
  if use-column[8]
  then  C-num-chk5:screen-value = string(sum-vals.num-chk[5], entry(1, c-num-chk5:private-data, chr(4))).
  if use-column[9]
  then  C-num-chk6:screen-value = string(sum-vals.num-chk[6], entry(1, c-num-chk6:private-data, chr(4))).
  if use-column[10]
  then  C-num-chk7:screen-value = string(sum-vals.num-chk[7], entry(1, c-num-chk7:private-data, chr(4))).
  if use-column[11]
  then  C-num-chk8:screen-value = string(sum-vals.num-chk[8], entry(1, c-num-chk8:private-data, chr(4))).
  if use-column[12]
  then  C-num-chk9:screen-value = string(sum-vals.num-chk[9], entry(1, c-num-chk9:private-data, chr(4))).
  if use-column[13]
  then  C-num-chk10:screen-value = string(sum-vals.num-chk[10], entry(1, c-num-chk10:private-data, chr(4))).
  if use-column[14]
  then  C-num-chk11:screen-value = string(sum-vals.num-chk[11], entry(1, c-num-chk11:private-data, chr(4))).
  if use-column[15]
  then  C-num-chk12:screen-value = string(sum-vals.num-chk[12], entry(1, c-num-chk12:private-data, chr(4))).
  if use-column[16]
  then  C-num-chk13:screen-value = string(sum-vals.num-chk[13], entry(1, c-num-chk13:private-data, chr(4))).
  if use-column[17]
  then  C-num-chk14:screen-value = string(sum-vals.num-chk[14], entry(1, c-num-chk14:private-data, chr(4))).
  if use-column[18]
  then  C-num-chk15:screen-value = string(sum-vals.num-chk[15], entry(1, c-num-chk15:private-data, chr(4))).
  if use-column[19]
  then  C-num-chk16:screen-value = string(sum-vals.num-chk[16], entry(1, c-num-chk16:private-data, chr(4))).
  if use-column[20]
  then  C-num-chk17:screen-value = string(sum-vals.num-chk[17], entry(1, c-num-chk17:private-data, chr(4))).
  if use-column[21]
  then  C-num-chk18:screen-value = string(sum-vals.num-chk[18], entry(1, c-num-chk18:private-data, chr(4))).
  if use-column[22]
  then  C-num-chk19:screen-value = string(sum-vals.num-chk[19], entry(1, c-num-chk19:private-data, chr(4))).
  if use-column[23]
  then  C-num-chk20:screen-value = string(sum-vals.num-chk[20], entry(1, c-num-chk20:private-data, chr(4))).
  if use-column[24]
  then  C-num-chk21:screen-value = string(sum-vals.num-chk[21], entry(1, c-num-chk21:private-data, chr(4))).
  if use-column[25]
  then  C-num-chk22:screen-value = string(sum-vals.num-chk[22], entry(1, c-num-chk22:private-data, chr(4))).
  if use-column[26]
  then  C-num-chk23:screen-value = string(sum-vals.num-chk[23], entry(1, c-num-chk23:private-data, chr(4))).
  if use-column[27]
  then  C-num-chk24:screen-value = string(sum-vals.num-chk[24], entry(1, c-num-chk24:private-data, chr(4))).
  if use-column[28]
  then  C-tot-nc:screen-value = string(SUM-VALS.TOT, entry(1, c-tot-nc:private-data, chr(4))).
  if use-column[29]
  then  C-sym3:screen-value = string(sym3, entry(1, c-sym3:private-data, chr(4))).
        DISPLAY stream  PrnLibStream with frame HOUR.                                      DOWN 1 stream PrnLibStream with frame HOUR.
      END.
  ...
  if use-column[4]
  then  C-num-chk1:screen-value = string(accum-num-chk[1], entry(1, c-num-chk1:private-data, chr(4))).
  if use-column[5]
  then  C-num-chk2:screen-value = string(accum-num-chk[2], entry(1, c-num-chk2:private-data, chr(4))).
  if use-column[6]
  then  C-num-chk3:screen-value = string(accum-num-chk[3], entry(1, c-num-chk3:private-data, chr(4))).
  if use-column[7]
  then  C-num-chk4:screen-value = string(accum-num-chk[4], entry(1, c-num-chk4:private-data, chr(4))).
  if use-column[8]
  then  C-num-chk5:screen-value = string(accum-num-chk[5], entry(1, c-num-chk5:private-data, chr(4))).
  if use-column[9]
  then  C-num-chk6:screen-value = string(accum-num-chk[6], entry(1, c-num-chk6:private-data, chr(4))).
  if use-column[10]
  then  C-num-chk7:screen-value = string(accum-num-chk[7], entry(1, c-num-chk7:private-data, chr(4))).
  if use-column[11]
  then  C-num-chk8:screen-value = string(accum-num-chk[8], entry(1, c-num-chk8:private-data, chr(4))).
  if use-column[12]
  then  C-num-chk9:screen-value = string(accum-num-chk[9], entry(1, c-num-chk9:private-data, chr(4))).
  if use-column[13]
  then  C-num-chk10:screen-value = string(accum-num-chk[10], entry(1, c-num-chk10:private-data, chr(4))).
  if use-column[14]
  then  C-num-chk11:screen-value = string(accum-num-chk[11], entry(1, c-num-chk11:private-data, chr(4))).
  if use-column[15]
  then  C-num-chk12:screen-value = string(accum-num-chk[12], entry(1, c-num-chk12:private-data, chr(4))).
  if use-column[16]
  then  C-num-chk13:screen-value = string(accum-num-chk[13], entry(1, c-num-chk13:private-data, chr(4))).
  if use-column[17]
  then  C-num-chk14:screen-value = string(accum-num-chk[14], entry(1, c-num-chk14:private-data, chr(4))).
  if use-column[18]
  then  C-num-chk15:screen-value = string(accum-num-chk[15], entry(1, c-num-chk15:private-data, chr(4))).
  if use-column[19]
  then  C-num-chk16:screen-value = string(accum-num-chk[16], entry(1, c-num-chk16:private-data, chr(4))).
  if use-column[20]
  then  C-num-chk17:screen-value = string(accum-num-chk[17], entry(1, c-num-chk17:private-data, chr(4))).
  if use-column[21]
  then  C-num-chk18:screen-value = string(accum-num-chk[18], entry(1, c-num-chk18:private-data, chr(4))).
  if use-column[22]
  then  C-num-chk19:screen-value = string(accum-num-chk[19], entry(1, c-num-chk19:private-data, chr(4))).
  if use-column[23]
  then  C-num-chk20:screen-value = string(accum-num-chk[20], entry(1, c-num-chk20:private-data, chr(4))).
  if use-column[24]
  then  C-num-chk21:screen-value = string(accum-num-chk[21], entry(1, c-num-chk21:private-data, chr(4))).
  if use-column[25]
  then  C-num-chk22:screen-value = string(accum-num-chk[22], entry(1, c-num-chk22:private-data, chr(4))).
  if use-column[26]
  then  C-num-chk23:screen-value = string(accum-num-chk[23], entry(1, c-num-chk23:private-data, chr(4))).
  if use-column[27]
  then  C-num-chk24:screen-value = string(accum-num-chk[24], entry(1, c-num-chk24:private-data, chr(4))).
  if use-column[28]
  then  C-tot-nc:screen-value = string(ACCUM-tot-nc, entry(1, c-tot-nc:private-data, chr(4))).
    DISPLAY stream  PrnLibStream with frame HOUR.                                      DOWN 1 stream PrnLibStream with frame HOUR.
  if use-column[2]
  then  C-full-name:screen-value = string(fill44).
  if use-column[4]
