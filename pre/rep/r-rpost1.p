...
def   shared   var     Show-cost-vat  as logical no-undo .
def   shared   var     Show-sale-vat  as logical no-undo .
 ...
 CASE CAPS(p7) :
   WHEN "O":U  Then DO :
    ...
    if Make-Excel then  put   stream ForExcel unformatted p3 CHR(9)
                ...
                p6 CHR(9)
                gds-zap-type CHR(9)
                 excel-qnty(o-RAsh         [1]  ) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   o-RAsh[2] )  + CHR(9)   ) else ("")
if Show-cost-vat  then (     excel-sum  (   o-RAsh[3] )  + CHR(9)   ) else ("")
if Showsale       then (     excel-sum  (   o-RAsh[5] )  + CHR(9)   ) else ("")
if Show-sale-vat  then (     excel-sum  (   o-RAsh[6] )  + CHR(9)   ) else ("")
                 excel-qnty(o-KAssa        [1]) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   o-KAssa[2])  + CHR(9)    ) else ("")
if Show-cost-vat  then (     excel-sum  (   o-KAssa[3])  + CHR(9)    ) else ("")
if Showsale       then (     excel-sum  (   o-KAssa[5])  + CHR(9)    ) else ("")
if Show-sale-vat  then (     excel-sum  (   o-KAssa[6])  + CHR(9)    ) else ("")
.
if Make-Excel then  put   stream ForExcel unformatted     excel-qnty( o-Inv            [1] ) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   o-Inv [2] ) + CHR(9)    ) else ("")
if Show-cost-vat  then (     excel-sum  (   o-Inv [3] ) + CHR(9)    ) else ("")
if Showsale       then (     excel-sum  (   o-Inv [5] ) + CHR(9)    ) else ("")
if Show-sale-vat  then (     excel-sum  (   o-Inv [6] ) + CHR(9)    ) else ("")
                 excel-qnty(o-vzvr         [1]) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   o-vzvr [2] ) + CHR(9)    ) else ("")
if Show-cost-vat  then (     excel-sum  (   o-vzvr [3] ) + CHR(9)    ) else ("")
if Showsale       then (     excel-sum  (   o-vzvr [5] ) + CHR(9)    ) else ("")
if Show-sale-vat  then (     excel-sum  (   o-vzvr [6] ) + CHR(9)    ) else ("")
                excel-qnty(o-vzvr-post    [1]) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   o-vzvr-post[2] ) + CHR(9)     ) else ("")
if Show-cost-vat  then (     excel-sum  (   o-vzvr-post[3] ) + CHR(9)     ) else ("")
if Showsale       then (     excel-sum  (   o-vzvr-post[5] ) + CHR(9)     ) else ("")
if Show-sale-vat  then (     excel-sum  (   o-vzvr-post[6] ) + CHR(9)     ) else ("")
                excel-qnty(o-spis    [1] ) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   o-spis[2] ) + CHR(9)     ) else ("")
if Show-cost-vat  then (     excel-sum  (   o-spis[3] ) + CHR(9)     ) else ("")
if Showsale       then (     excel-sum  (   o-spis[5] ) + CHR(9)     ) else ("")
if Show-sale-vat  then (     excel-sum  (   o-spis[6] ) + CHR(9)     ) else ("")
         chr(10).
                End.
   WHEN "P":U  Then DO :
             DISPLAY stream  OutStream sym1 sym2 sym3 sym4 sym5 sym6 sym7 sym8 sym9 sym10 sym11 sym12
    ...
    if Make-Excel then  put   stream ForExcel unformatted p3 CHR(9)
                ...
                p6 CHR(9)
                gds-zap-type CHR(9)
                 excel-qnty(p-RAsh         [1]  ) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   p-RAsh[2] )  + CHR(9)   ) else ("")
if Show-cost-vat  then (     excel-sum  (   p-RAsh[3] )  + CHR(9)   ) else ("")
if Showsale       then (     excel-sum  (   p-RAsh[5] )  + CHR(9)   ) else ("")
if Show-sale-vat  then (     excel-sum  (   p-RAsh[6] )  + CHR(9)   ) else ("")
                 excel-qnty(p-KAssa        [1]) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   p-KAssa[2])  + CHR(9)    ) else ("")
if Show-cost-vat  then (     excel-sum  (   p-KAssa[3])  + CHR(9)    ) else ("")
if Showsale       then (     excel-sum  (   p-KAssa[5])  + CHR(9)    ) else ("")
if Show-sale-vat  then (     excel-sum  (   p-KAssa[6])  + CHR(9)    ) else ("")
.
if Make-Excel then  put   stream ForExcel unformatted     excel-qnty( p-Inv            [1] ) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   p-Inv [2] ) + CHR(9)    ) else ("")
if Show-cost-vat  then (     excel-sum  (   p-Inv [3] ) + CHR(9)    ) else ("")
if Showsale       then (     excel-sum  (   p-Inv [5] ) + CHR(9)    ) else ("")
if Show-sale-vat  then (     excel-sum  (   p-Inv [6] ) + CHR(9)    ) else ("")
                 excel-qnty(p-vzvr         [1]) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   p-vzvr [2] ) + CHR(9)    ) else ("")
if Show-cost-vat  then (     excel-sum  (   p-vzvr [3] ) + CHR(9)    ) else ("")
if Showsale       then (     excel-sum  (   p-vzvr [5] ) + CHR(9)    ) else ("")
if Show-sale-vat  then (     excel-sum  (   p-vzvr [6] ) + CHR(9)    ) else ("")
                excel-qnty(p-vzvr-post    [1]) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   p-vzvr-post[2] ) + CHR(9)     ) else ("")
if Show-cost-vat  then (     excel-sum  (   p-vzvr-post[3] ) + CHR(9)     ) else ("")
if Showsale       then (     excel-sum  (   p-vzvr-post[5] ) + CHR(9)     ) else ("")
if Show-sale-vat  then (     excel-sum  (   p-vzvr-post[6] ) + CHR(9)     ) else ("")
                excel-qnty(p-spis    [1] ) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   p-spis[2] ) + CHR(9)     ) else ("")
if Show-cost-vat  then (     excel-sum  (   p-spis[3] ) + CHR(9)     ) else ("")
if Showsale       then (     excel-sum  (   p-spis[5] ) + CHR(9)     ) else ("")
if Show-sale-vat  then (     excel-sum  (   p-spis[6] ) + CHR(9)     ) else ("")
         chr(10).
             End.
   WHEN "B1":U  Then DO :
             DISPLAY stream  OutStream sym1 sym2 sym3 sym4 sym5 sym6 sym7 sym8 sym9 sym10 sym11 sym12
    ...
    if Make-Excel then  put   stream ForExcel unformatted p3 CHR(9)
                ...
                p6 CHR(9)
                gds-zap-type CHR(9)
                 excel-qnty(b1-RAsh         [1]  ) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   b1-RAsh[2] )  + CHR(9)   ) else ("")
if Show-cost-vat  then (     excel-sum  (   b1-RAsh[3] )  + CHR(9)   ) else ("")
if Showsale       then (     excel-sum  (   b1-RAsh[5] )  + CHR(9)   ) else ("")
if Show-sale-vat  then (     excel-sum  (   b1-RAsh[6] )  + CHR(9)   ) else ("")
                 excel-qnty(b1-KAssa        [1]) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   b1-KAssa[2])  + CHR(9)    ) else ("")
if Show-cost-vat  then (     excel-sum  (   b1-KAssa[3])  + CHR(9)    ) else ("")
if Showsale       then (     excel-sum  (   b1-KAssa[5])  + CHR(9)    ) else ("")
if Show-sale-vat  then (     excel-sum  (   b1-KAssa[6])  + CHR(9)    ) else ("")
.
if Make-Excel then  put   stream ForExcel unformatted     excel-qnty( b1-Inv            [1] ) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   b1-Inv [2] ) + CHR(9)    ) else ("")
if Show-cost-vat  then (     excel-sum  (   b1-Inv [3] ) + CHR(9)    ) else ("")
if Showsale       then (     excel-sum  (   b1-Inv [5] ) + CHR(9)    ) else ("")
if Show-sale-vat  then (     excel-sum  (   b1-Inv [6] ) + CHR(9)    ) else ("")
                 excel-qnty(b1-vzvr         [1]) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   b1-vzvr [2] ) + CHR(9)    ) else ("")
if Show-cost-vat  then (     excel-sum  (   b1-vzvr [3] ) + CHR(9)    ) else ("")
if Showsale       then (     excel-sum  (   b1-vzvr [5] ) + CHR(9)    ) else ("")
if Show-sale-vat  then (     excel-sum  (   b1-vzvr [6] ) + CHR(9)    ) else ("")
                excel-qnty(b1-vzvr-post    [1]) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   b1-vzvr-post[2] ) + CHR(9)     ) else ("")
if Show-cost-vat  then (     excel-sum  (   b1-vzvr-post[3] ) + CHR(9)     ) else ("")
if Showsale       then (     excel-sum  (   b1-vzvr-post[5] ) + CHR(9)     ) else ("")
if Show-sale-vat  then (     excel-sum  (   b1-vzvr-post[6] ) + CHR(9)     ) else ("")
                excel-qnty(b1-spis    [1] ) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   b1-spis[2] ) + CHR(9)     ) else ("")
if Show-cost-vat  then (     excel-sum  (   b1-spis[3] ) + CHR(9)     ) else ("")
if Showsale       then (     excel-sum  (   b1-spis[5] ) + CHR(9)     ) else ("")
if Show-sale-vat  then (     excel-sum  (   b1-spis[6] ) + CHR(9)     ) else ("")
         chr(10).
                End.
   WHEN "B2":U  Then DO :
             DISPLAY stream  OutStream sym1 sym2 sym3 sym4 sym5 sym6 sym7 sym8 sym9 sym10 sym11 sym12
    ...
    if Make-Excel then  put   stream ForExcel unformatted p3 CHR(9)
                ...
                p6 CHR(9)
                gds-zap-type CHR(9)
                 excel-qnty(b2-RAsh         [1]  ) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   b2-RAsh[2] )  + CHR(9)   ) else ("")
if Show-cost-vat  then (     excel-sum  (   b2-RAsh[3] )  + CHR(9)   ) else ("")
if Showsale       then (     excel-sum  (   b2-RAsh[5] )  + CHR(9)   ) else ("")
if Show-sale-vat  then (     excel-sum  (   b2-RAsh[6] )  + CHR(9)   ) else ("")
                 excel-qnty(b2-KAssa        [1]) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   b2-KAssa[2])  + CHR(9)    ) else ("")
if Show-cost-vat  then (     excel-sum  (   b2-KAssa[3])  + CHR(9)    ) else ("")
if Showsale       then (     excel-sum  (   b2-KAssa[5])  + CHR(9)    ) else ("")
if Show-sale-vat  then (     excel-sum  (   b2-KAssa[6])  + CHR(9)    ) else ("")
.
if Make-Excel then  put   stream ForExcel unformatted     excel-qnty( b2-Inv            [1] ) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   b2-Inv [2] ) + CHR(9)    ) else ("")
if Show-cost-vat  then (     excel-sum  (   b2-Inv [3] ) + CHR(9)    ) else ("")
if Showsale       then (     excel-sum  (   b2-Inv [5] ) + CHR(9)    ) else ("")
if Show-sale-vat  then (     excel-sum  (   b2-Inv [6] ) + CHR(9)    ) else ("")
                 excel-qnty(b2-vzvr         [1]) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   b2-vzvr [2] ) + CHR(9)    ) else ("")
if Show-cost-vat  then (     excel-sum  (   b2-vzvr [3] ) + CHR(9)    ) else ("")
if Showsale       then (     excel-sum  (   b2-vzvr [5] ) + CHR(9)    ) else ("")
if Show-sale-vat  then (     excel-sum  (   b2-vzvr [6] ) + CHR(9)    ) else ("")
                excel-qnty(b2-vzvr-post    [1]) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   b2-vzvr-post[2] ) + CHR(9)     ) else ("")
if Show-cost-vat  then (     excel-sum  (   b2-vzvr-post[3] ) + CHR(9)     ) else ("")
if Showsale       then (     excel-sum  (   b2-vzvr-post[5] ) + CHR(9)     ) else ("")
if Show-sale-vat  then (     excel-sum  (   b2-vzvr-post[6] ) + CHR(9)     ) else ("")
                excel-qnty(b2-spis    [1] ) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   b2-spis[2] ) + CHR(9)     ) else ("")
if Show-cost-vat  then (     excel-sum  (   b2-spis[3] ) + CHR(9)     ) else ("")
if Showsale       then (     excel-sum  (   b2-spis[5] ) + CHR(9)     ) else ("")
if Show-sale-vat  then (     excel-sum  (   b2-spis[6] ) + CHR(9)     ) else ("")
         chr(10).
             End.
   WHEN "BI":U Then  DO :
             DISPLAY stream  OutStream sym1 sym2 sym3 sym4 sym5 sym6 sym7 sym8 sym9 sym10 sym11 sym12
    ...
    if Make-Excel then  put   stream ForExcel unformatted p3 CHR(9)
                ...
                p6 CHR(9)
                gds-zap-type CHR(9)
                 excel-qnty(bi-RAsh         [1]  ) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   bi-RAsh[2] )  + CHR(9)   ) else ("")
if Show-cost-vat  then (     excel-sum  (   bi-RAsh[3] )  + CHR(9)   ) else ("")
if Showsale       then (     excel-sum  (   bi-RAsh[5] )  + CHR(9)   ) else ("")
if Show-sale-vat  then (     excel-sum  (   bi-RAsh[6] )  + CHR(9)   ) else ("")
                 excel-qnty(bi-KAssa        [1]) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   bi-KAssa[2])  + CHR(9)    ) else ("")
if Show-cost-vat  then (     excel-sum  (   bi-KAssa[3])  + CHR(9)    ) else ("")
if Showsale       then (     excel-sum  (   bi-KAssa[5])  + CHR(9)    ) else ("")
if Show-sale-vat  then (     excel-sum  (   bi-KAssa[6])  + CHR(9)    ) else ("")
.
if Make-Excel then  put   stream ForExcel unformatted     excel-qnty( bi-Inv            [1] ) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   bi-Inv [2] ) + CHR(9)    ) else ("")
if Show-cost-vat  then (     excel-sum  (   bi-Inv [3] ) + CHR(9)    ) else ("")
if Showsale       then (     excel-sum  (   bi-Inv [5] ) + CHR(9)    ) else ("")
if Show-sale-vat  then (     excel-sum  (   bi-Inv [6] ) + CHR(9)    ) else ("")
                 excel-qnty(bi-vzvr         [1]) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   bi-vzvr [2] ) + CHR(9)    ) else ("")
if Show-cost-vat  then (     excel-sum  (   bi-vzvr [3] ) + CHR(9)    ) else ("")
if Showsale       then (     excel-sum  (   bi-vzvr [5] ) + CHR(9)    ) else ("")
if Show-sale-vat  then (     excel-sum  (   bi-vzvr [6] ) + CHR(9)    ) else ("")
                excel-qnty(bi-vzvr-post    [1]) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   bi-vzvr-post[2] ) + CHR(9)     ) else ("")
if Show-cost-vat  then (     excel-sum  (   bi-vzvr-post[3] ) + CHR(9)     ) else ("")
if Showsale       then (     excel-sum  (   bi-vzvr-post[5] ) + CHR(9)     ) else ("")
if Show-sale-vat  then (     excel-sum  (   bi-vzvr-post[6] ) + CHR(9)     ) else ("")
                excel-qnty(bi-spis    [1] ) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   bi-spis[2] ) + CHR(9)     ) else ("")
if Show-cost-vat  then (     excel-sum  (   bi-spis[3] ) + CHR(9)     ) else ("")
if Showsale       then (     excel-sum  (   bi-spis[5] ) + CHR(9)     ) else ("")
if Show-sale-vat  then (     excel-sum  (   bi-spis[6] ) + CHR(9)     ) else ("")
         chr(10).
             End.
   WHEN ""  Then     DO :
             DISPLAY stream  OutStream sym1 sym2 sym3 sym4 sym5 sym6 sym7 sym8 sym9 sym10 sym11 sym12
    ...
    if Make-Excel then  put   stream ForExcel unformatted p3 CHR(9)
                ...
                p6 CHR(9)
                gds-zap-type CHR(9)
                 excel-qnty(RAsh         [1]  ) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   RAsh[2] )  + CHR(9)   ) else ("")
if Show-cost-vat  then (     excel-sum  (   RAsh[3] )  + CHR(9)   ) else ("")
if Showsale       then (     excel-sum  (   RAsh[5] )  + CHR(9)   ) else ("")
if Show-sale-vat  then (     excel-sum  (   RAsh[6] )  + CHR(9)   ) else ("")
                 excel-qnty(KAssa        [1]) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   KAssa[2])  + CHR(9)    ) else ("")
if Show-cost-vat  then (     excel-sum  (   KAssa[3])  + CHR(9)    ) else ("")
if Showsale       then (     excel-sum  (   KAssa[5])  + CHR(9)    ) else ("")
if Show-sale-vat  then (     excel-sum  (   KAssa[6])  + CHR(9)    ) else ("")
.
if Make-Excel then  put   stream ForExcel unformatted     excel-qnty( Inv            [1] ) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   Inv [2] ) + CHR(9)    ) else ("")
if Show-cost-vat  then (     excel-sum  (   Inv [3] ) + CHR(9)    ) else ("")
if Showsale       then (     excel-sum  (   Inv [5] ) + CHR(9)    ) else ("")
if Show-sale-vat  then (     excel-sum  (   Inv [6] ) + CHR(9)    ) else ("")
                 excel-qnty(vzvr         [1]) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   vzvr [2] ) + CHR(9)    ) else ("")
if Show-cost-vat  then (     excel-sum  (   vzvr [3] ) + CHR(9)    ) else ("")
if Showsale       then (     excel-sum  (   vzvr [5] ) + CHR(9)    ) else ("")
if Show-sale-vat  then (     excel-sum  (   vzvr [6] ) + CHR(9)    ) else ("")
                excel-qnty(vzvr-post    [1]) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   vzvr-post[2] ) + CHR(9)     ) else ("")
if Show-cost-vat  then (     excel-sum  (   vzvr-post[3] ) + CHR(9)     ) else ("")
if Showsale       then (     excel-sum  (   vzvr-post[5] ) + CHR(9)     ) else ("")
if Show-sale-vat  then (     excel-sum  (   vzvr-post[6] ) + CHR(9)     ) else ("")
                excel-qnty(spis    [1] ) FORMAT "->>>>>>>>>>>9.<<<"  CHR(9)
if Showcost       then (     excel-sum  (   spis[2] ) + CHR(9)     ) else ("")
if Show-cost-vat  then (     excel-sum  (   spis[3] ) + CHR(9)     ) else ("")
if Showsale       then (     excel-sum  (   spis[5] ) + CHR(9)     ) else ("")
if Show-sale-vat  then (     excel-sum  (   spis[6] ) + CHR(9)     ) else ("")
         chr(10).
              End.
   End case.
               DOWN stream   OutStream 1 with FRAME ZAPAS.
...
def var tt-sale like  ub.gds-dtl.price-rubl no-undo .
 ...
 if (x-sum-type = 'crsa':U  or x-sum-type = 'cgsr':U) then tt# = 6.
     FOR each post-ot-line where
              post-ot-line.artic        = x-artic
        AND   post-ot-line.fact-order  <= fact-order-2  AND   post-ot-line.fact-order  >= fact-order-1
        ...
        For each ub.parts no-lock where
                    post-ot-line.artic        = ub.parts.artic
              AND   post-ot-line.prod-code    = ub.parts.prod-code
              AND   post-ot-line.prod-type    = ub.parts.prod-type
              AND   post-ot-line.cli-code     = ub.parts.supp-code
              AND   post-ot-line.cli-type     = ub.parts.supp-type
              AND   post-ot-line.obj-code     = ub.parts.obj-code
              AND   post-ot-line.obj-type     = ub.parts.obj-type
              AND   post-ot-line.doc-code     = ub.parts.out-code
              AND   ub.parts.fact-date >= x-date-start
              AND   ub.parts.fact-date <= x-date-end  :
        CASE post-ot-line.ext-doc-type:
           ...
           ASSIGN kassa[1 + tt#]   = kassa[1 + tt#]   +  ub.parts.fact-qnty
             ...
             WHEN       'rs':U THEN  DO:
           ASSIGN kassa[1 + tt#]   = kassa[1 + tt#]   -  ub.parts.fact-qnty
                  kassa[2 + tt#]   = kassa[2 + tt#]   +  if tprintrubl then  ( ( -1 ) * ub.parts.fact-qnty / post-ot-line.fact-qnty) * post-ot-line.sum-rubl else ( ( -1 ) * ub.parts.fact-qnty / post-ot-line.fact-qnty) *  post-ot-line.sum-base
                  kassa[3 + tt#]   = kassa[3 + tt#]   +  if tprintrubl then  ( ( -1 ) * ub.parts.fact-qnty / post-ot-line.fact-qnty) * post-ot-line.vat-rubl else ( ( -1 ) * ub.parts.fact-qnty / post-ot-line.fact-qnty) *  post-ot-line.vat-base .
                 End.
             when 'vt':U  or
             when 'vp':U   or
             when 'ap':U   or
