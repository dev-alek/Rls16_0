...
PROCEDURE adm-disable :
    DISABLE RECT-6 RECT-5 RECT-7 Date-out-type SortType Classify WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-6 RECT-5 RECT-7 Date-out-type SortType Classify WITH FRAME F-Main.
