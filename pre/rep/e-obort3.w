...
PROCEDURE adm-disable :
    DISABLE RECT-7 RECT-5 RECT-8 RECT-6 SortType Tog-obj Classify RADIO-Nomenkl ShowZero-2 RADIO-SET-1 B-columns B-columns-2 FILL-IN-31 FILL-IN-33 FILL-IN-32 WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-7 RECT-5 RECT-8 RECT-6 SortType Tog-obj Classify RADIO-Nomenkl ShowZero-2 RADIO-SET-1 B-columns B-columns-2 FILL-IN-31 FILL-IN-33 FILL-IN-32 WITH FRAME F-Main.
...
END.
ON CHOOSE OF B-columns-2 IN FRAME F-Main
DO:
...
repeat l-ind = 1 to 118 :
 ...
 if not avail ubflt.usr-flt then do:
   ...
   ShowZero-2 = true .
 display ShowZero-2 FILL-IN-31 FILL-IN-32 FILL-IN-33 RADIO-SET-1 with frame F-Main .
END PROCEDURE.
PROCEDURE my-report :
