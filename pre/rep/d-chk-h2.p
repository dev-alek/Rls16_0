...
do cycle = 1 to 0 by -1:
  ...
  if use-column[2]
  then  C-hour1:screen-value = string(fill11).
  if use-column[3]
  then  C-hour2:screen-value = string(fill11).
  if use-column[4]
  then  C-hour3:screen-value = string(fill11).
  if use-column[5]
  then  C-hour4:screen-value = string(fill11).
  if use-column[6]
  then  C-hour5:screen-value = string(fill11).
  if use-column[7]
  then  C-hour6:screen-value = string(fill11).
  if use-column[8]
  then  C-hour7:screen-value = string(fill11).
  if use-column[9]
  then  C-hour8:screen-value = string(fill11).
  if use-column[10]
  then  C-hour9:screen-value = string(fill11).
  if use-column[11]
  then  C-hour10:screen-value = string(fill11).
  if use-column[12]
  then  C-hour11:screen-value = string(fill11).
  if use-column[13]
  then  C-hour12:screen-value = string(fill11).
  if use-column[14]
  then  C-hour13:screen-value = string(fill11).
  if use-column[15]
  then  C-hour14:screen-value = string(fill11).
  if use-column[16]
  then  C-hour15:screen-value = string(fill11).
  if use-column[17]
  then  C-hour16:screen-value = string(fill11).
  if use-column[18]
  then  C-hour17:screen-value = string(fill11).
  if use-column[19]
  then  C-hour18:screen-value = string(fill11).
  if use-column[20]
  then  C-hour19:screen-value = string(fill11).
  if use-column[21]
  then  C-hour20:screen-value = string(fill11).
  if use-column[22]
  then  C-hour21:screen-value = string(fill11).
  if use-column[23]
  then  C-hour22:screen-value = string(fill11).
  if use-column[24]
  then  C-hour23:screen-value = string(fill11).
  if use-column[25]
  then  C-hour24:screen-value = string(fill11).
  if use-column[26]
  ...
  if use-column[2]
  then  C-hour1:screen-value = string(chk-h.hour[1], entry(1, c-hour1:private-data, chr(4))).
  if use-column[3]
  then  C-hour2:screen-value = string(chk-h.hour[2], entry(1, c-hour2:private-data, chr(4))).
  if use-column[4]
  then  C-hour3:screen-value = string(chk-h.hour[3], entry(1, c-hour3:private-data, chr(4))).
  if use-column[5]
  then  C-hour4:screen-value = string(chk-h.hour[4], entry(1, c-hour4:private-data, chr(4))).
  if use-column[6]
  then  C-hour5:screen-value = string(chk-h.hour[5], entry(1, c-hour5:private-data, chr(4))).
  if use-column[7]
  then  C-hour6:screen-value = string(chk-h.hour[6], entry(1, c-hour6:private-data, chr(4))).
  if use-column[8]
  then  C-hour7:screen-value = string(chk-h.hour[7], entry(1, c-hour7:private-data, chr(4))).
  if use-column[9]
  then  C-hour8:screen-value = string(chk-h.hour[8], entry(1, c-hour8:private-data, chr(4))).
  if use-column[10]
  then  C-hour9:screen-value = string(chk-h.hour[9], entry(1, c-hour9:private-data, chr(4))).
  if use-column[11]
  then  C-hour10:screen-value = string(chk-h.hour[10], entry(1, c-hour10:private-data, chr(4))).
  if use-column[12]
  then  C-hour11:screen-value = string(chk-h.hour[11], entry(1, c-hour11:private-data, chr(4))).
  if use-column[13]
  then  C-hour12:screen-value = string(chk-h.hour[12], entry(1, c-hour12:private-data, chr(4))).
  if use-column[14]
  then  C-hour13:screen-value = string(chk-h.hour[13], entry(1, c-hour13:private-data, chr(4))).
  if use-column[15]
  then  C-hour14:screen-value = string(chk-h.hour[14], entry(1, c-hour14:private-data, chr(4))).
  if use-column[16]
  then  C-hour15:screen-value = string(chk-h.hour[15], entry(1, c-hour15:private-data, chr(4))).
  if use-column[17]
  then  C-hour16:screen-value = string(chk-h.hour[16], entry(1, c-hour16:private-data, chr(4))).
  if use-column[18]
  then  C-hour17:screen-value = string(chk-h.hour[17], entry(1, c-hour17:private-data, chr(4))).
  if use-column[19]
  then  C-hour18:screen-value = string(chk-h.hour[18], entry(1, c-hour18:private-data, chr(4))).
  if use-column[20]
  then  C-hour19:screen-value = string(chk-h.hour[19], entry(1, c-hour19:private-data, chr(4))).
  if use-column[21]
  then  C-hour20:screen-value = string(chk-h.hour[20], entry(1, c-hour20:private-data, chr(4))).
  if use-column[22]
  then  C-hour21:screen-value = string(chk-h.hour[21], entry(1, c-hour21:private-data, chr(4))).
  if use-column[23]
  then  C-hour22:screen-value = string(chk-h.hour[22], entry(1, c-hour22:private-data, chr(4))).
  if use-column[24]
  then  C-hour23:screen-value = string(chk-h.hour[23], entry(1, c-hour23:private-data, chr(4))).
  if use-column[25]
  then  C-hour24:screen-value = string(chk-h.hour[24], entry(1, c-hour24:private-data, chr(4))).
  if use-column[26]
  then  C-qnty:screen-value = string(chk-h.qnty, entry(1, c-qnty:private-data, chr(4))).
              DISPLAY stream  PrnLibStream with frame HOUR.                                      DOWN 1 stream PrnLibStream with frame HOUR.
            end.
          end.
        end.
  ...
  then  C-full-name:screen-value = string(v-title, entry(1, c-full-name:private-data, chr(4))).
  if use-column[2]
  then  C-hour1:screen-value = string(num-h.hour[1], entry(1, c-hour1:private-data, chr(4))).
  if use-column[3]
  then  C-hour2:screen-value = string(num-h.hour[2], entry(1, c-hour2:private-data, chr(4))).
  if use-column[4]
  then  C-hour3:screen-value = string(num-h.hour[3], entry(1, c-hour3:private-data, chr(4))).
  if use-column[5]
  then  C-hour4:screen-value = string(num-h.hour[4], entry(1, c-hour4:private-data, chr(4))).
  if use-column[6]
  then  C-hour5:screen-value = string(num-h.hour[5], entry(1, c-hour5:private-data, chr(4))).
  if use-column[7]
  then  C-hour6:screen-value = string(num-h.hour[6], entry(1, c-hour6:private-data, chr(4))).
  if use-column[8]
  then  C-hour7:screen-value = string(num-h.hour[7], entry(1, c-hour7:private-data, chr(4))).
  if use-column[9]
  then  C-hour8:screen-value = string(num-h.hour[8], entry(1, c-hour8:private-data, chr(4))).
  if use-column[10]
  then  C-hour9:screen-value = string(num-h.hour[9], entry(1, c-hour9:private-data, chr(4))).
  if use-column[11]
  then  C-hour10:screen-value = string(num-h.hour[10], entry(1, c-hour10:private-data, chr(4))).
  if use-column[12]
  then  C-hour11:screen-value = string(num-h.hour[11], entry(1, c-hour11:private-data, chr(4))).
  if use-column[13]
  then  C-hour12:screen-value = string(num-h.hour[12], entry(1, c-hour12:private-data, chr(4))).
  if use-column[14]
  then  C-hour13:screen-value = string(num-h.hour[13], entry(1, c-hour13:private-data, chr(4))).
  if use-column[15]
  then  C-hour14:screen-value = string(num-h.hour[14], entry(1, c-hour14:private-data, chr(4))).
  if use-column[16]
  then  C-hour15:screen-value = string(num-h.hour[15], entry(1, c-hour15:private-data, chr(4))).
  if use-column[17]
  then  C-hour16:screen-value = string(num-h.hour[16], entry(1, c-hour16:private-data, chr(4))).
  if use-column[18]
  then  C-hour17:screen-value = string(num-h.hour[17], entry(1, c-hour17:private-data, chr(4))).
  if use-column[19]
  then  C-hour18:screen-value = string(num-h.hour[18], entry(1, c-hour18:private-data, chr(4))).
  if use-column[20]
  then  C-hour19:screen-value = string(num-h.hour[19], entry(1, c-hour19:private-data, chr(4))).
  if use-column[21]
  then  C-hour20:screen-value = string(num-h.hour[20], entry(1, c-hour20:private-data, chr(4))).
  if use-column[22]
  then  C-hour21:screen-value = string(num-h.hour[21], entry(1, c-hour21:private-data, chr(4))).
  if use-column[23]
  then  C-hour22:screen-value = string(num-h.hour[22], entry(1, c-hour22:private-data, chr(4))).
  if use-column[24]
  then  C-hour23:screen-value = string(num-h.hour[23], entry(1, c-hour23:private-data, chr(4))).
  if use-column[25]
  then  C-hour24:screen-value = string(num-h.hour[24], entry(1, c-hour24:private-data, chr(4))).
  if use-column[26]
  then  C-qnty:screen-value = string(num-h.qnty, entry(1, c-qnty:private-data, chr(4))).
      DISPLAY stream  PrnLibStream with frame HOUR.                                      DOWN 1 stream PrnLibStream with frame HOUR.
    end.
  if use-column[1]
  then  C-full-name:screen-value = string(fill56).
