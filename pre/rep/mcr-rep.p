...
define variable vss-description as character no-undo init "Á‡ÔÛÒÍ‡ ‚ÌÂ¯ÌÂÈ ÒÂÒÒËË —Œ—“ŒﬂÕ»≈ «¿œ¿—¿".
...
def var vss-include-info0 as character format "x(65)" no-undo initial "@(#)$Workfile: mcr-rep.p $ $Revision: aea5316774be, 0, rls $".
