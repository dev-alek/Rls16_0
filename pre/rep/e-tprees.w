...
PROCEDURE adm-disable :
    DISABLE RECT-10 RECT-12 RECT-16 RECT-15 ie CostSum ee DispUpFact ep es re rs NullPer we vt iv CalcRest ev rv em wm im ot ap pc WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-10 RECT-12 RECT-16 RECT-15 ie CostSum ee DispUpFact ep es re rs NullPer we vt iv CalcRest ev rv em wm im ot ap pc WITH FRAME F-Main.
