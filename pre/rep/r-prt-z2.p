         ...
         do while pr-cursor < num-entries(v-prizn,","):
             ...
             if entry(pr-cursor,v-prizn,",") <> "" then do:
                 ...
                 assign
                    ...
                    f-cost-sum   = f-cost-sum + if gds-obj.fact-qnty = 0 then 0 else prt-obj.fact-qnty * determined(gds-obj.fact-base) / gds-obj.fact-qnty
                    ...
                    f-cost-pr   = if prt-obj.fact-qnty  = 0 then 0 else determined(gds-obj.fact-base) / gds-obj.fact-qnty
