...
IF NOT THIS-PROCEDURE:PERSISTENT THEN DO:
  MESSAGE "c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\rep\e-tap.w should only be RUN PERSISTENT.":U
...
PROCEDURE adm-disable :
    DISABLE RECT-7 SortType v-print-null-qnty WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-7 SortType v-print-null-qnty WITH FRAME F-Main.
...
ON VALUE-CHANGED OF v-print-null-qnty IN FRAME F-Main
DO:
     ASSIGN
      v-print-null-qnty
.
...
END PROCEDURE.
PROCEDURE my-var :
assign frame F-Main SortType  v-print-null-qnty .
