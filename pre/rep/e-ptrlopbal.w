...
define variable vss-description as character no-undo init "Контрольно-накопительная ведомость учета излишек и недостач НП ".
...
PROCEDURE adm-disable :
    DISABLE tog-with-tot-day WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN tog-with-tot-day WITH FRAME F-Main.
