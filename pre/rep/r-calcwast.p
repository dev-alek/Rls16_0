...
field deficit       like ub.doc-line.fact-qnty
field wastage       as decimal
field price         like ub.doc-line.price-rubl
field oborot        like ub.doc-line.doc-qnty
field allowed-wast  as decimal
field over-wast     as decimal
field all-wast-rubl as decimal
field deficit-rubl  as decimal
...
with width 232 down stream-io no-label.
do:
      ...
      for each gds-list no-lock :
          for each buf_ot-line
              where buf_ot-line.obj-type   = x-store-type
                ...
                and (buf_ot-line.ext-doc-type = 'vt':U
                 or buf_ot-line.ext-doc-type = 'ev':U
                 or buf_ot-line.ext-doc-type = 'ee':U
                 or buf_ot-line.ext-doc-type = 'es':U) no-lock :
            if buf_ot-line.ext-doc-type = 'vt':U then do :
                assign
      ...
      for each gds-list no-lock :
        find last  buf_doc-line no-lock
             where buf_doc-line.obj-type = x-store-type
               ...
               and buf_doc-line.ext-doc-type = 'vt':U
               and buf_doc-line.status_ = 'факт':U no-error.
...
then do:
        ...
        for each tt-calcwast break by tt-calcwast.prod-code by tt-calcwast.artic :
          ...
          if first-of (tt-calcwast.prod-code) then do :
            if Make-Excel then  put   stream ForExcel unformatted
                CHR(9) "Производитель - " + tt-calcwast.prod-type + string(tt-calcwast.prod-code) + " " + tt-calcwast.prod-name
            skip.
          ...
          if last-of (tt-calcwast.prod-code) then do :
            if Make-Excel then  put   stream ForExcel unformatted
                CHR(9) "Итоги по производителю" CHR(9) (accum sub-total by tt-calcwast.prod-code tt-calcwast.deficit)
                                                       CHR(9)
                                                       CHR(9)
                                                       CHR(9) (accum sub-total by tt-calcwast.prod-code tt-calcwast.oborot )
                                                       CHR(9) (accum sub-total by tt-calcwast.prod-code tt-calcwast.allowed-wast)
                                                       CHR(9) (accum sub-total by tt-calcwast.prod-code tt-calcwast.over-wast)
                                                       CHR(9) (accum sub-total by tt-calcwast.prod-code tt-calcwast.all-wast-rubl)
                                                       CHR(9) (accum sub-total by tt-calcwast.prod-code tt-calcwast.deficit-rubl)
            skip.
      ...
      if xsorttype = "sort-article" then do :
        for each tt-calcwast break by tt-calcwast.grp-code by tt-calcwast.artic :
          ...
          if first-of (tt-calcwast.grp-code) then do :
            if Make-Excel then  put   stream ForExcel unformatted
                CHR(9) "Группа товаров - " + tt-calcwast.grp-name
            skip.
          ...
          if last-of (tt-calcwast.grp-code) then do :
            if Make-Excel then  put   stream ForExcel unformatted
                CHR(9) "Итоги по группе "       CHR(9) (accum sub-total by tt-calcwast.grp-code tt-calcwast.deficit)
                                                       CHR(9)
                                                       CHR(9)
                                                       CHR(9) (accum sub-total by tt-calcwast.grp-code tt-calcwast.oborot )
                                                       CHR(9) (accum sub-total by tt-calcwast.grp-code tt-calcwast.allowed-wast)
                                                       CHR(9) (accum sub-total by tt-calcwast.grp-code tt-calcwast.over-wast)
                                                       CHR(9) (accum sub-total by tt-calcwast.grp-code tt-calcwast.all-wast-rubl)
                                                       CHR(9) (accum sub-total by tt-calcwast.grp-code tt-calcwast.deficit-rubl)
            skip.
  ...
  if Make-Excel then  put   stream ForExcel unformatted
      CHR(9) "ИТОГО "       CHR(9) (accum total tt-calcwast.deficit)
                                   CHR(9)
                                   CHR(9)
                                   CHR(9) (accum total tt-calcwast.oborot )
                                   CHR(9) (accum total tt-calcwast.allowed-wast)
                                   CHR(9) (accum total tt-calcwast.over-wast)
                                   CHR(9) (accum total tt-calcwast.all-wast-rubl)
                                   CHR(9) (accum total tt-calcwast.deficit-rubl)
  skip.
  ...
  if Make-Excel then  put   stream ForExcel unformatted
     CHR(9) CHR(9) CHR(9) CHR(9) CHR(9) CHR(9) CHR(9) "Недостача,руб"
     CHR(9) CHR(9) (accum total tt-calcwast.deficit-rubl) skip.
   if Make-Excel then  put   stream ForExcel unformatted
     CHR(9) CHR(9) CHR(9) CHR(9) CHR(9) CHR(9) CHR(9) "Допустимая ест.убыль"
     CHR(9) CHR(9) (accum total tt-calcwast.all-wast-rubl) skip.
   if Make-Excel then  put   stream ForExcel unformatted
     CHR(9) CHR(9) CHR(9) CHR(9) CHR(9) CHR(9) CHR(9) "Недостача с кор.учетом ест.убыли"
     CHR(9) CHR(9) ((accum total tt-calcwast.deficit-rubl) - (accum total tt-calcwast.all-wast-rubl)) skip.
...
for tt-calcwast field ( artic
    ...
    if Make-Excel then  put   stream ForExcel unformatted
              tt-calcwast.artic              CHR(9)
              tt-calcwast.gds-name           CHR(9)
              tt-calcwast.deficit            CHR(9)
              tt-calcwast.wastage            CHR(9)
              tt-calcwast.price              CHR(9)
              tt-calcwast.oborot             CHR(9)
              tt-calcwast.allowed-wast       CHR(9)
              tt-calcwast.over-wast          CHR(9)
              tt-calcwast.all-wast-rubl      CHR(9)
              tt-calcwast.deficit-rubl  CHR(9)
    skip.
    display stream PrnLibStream sym1  tt-calcwast.artic
                                ...
                                sym11 skip
    with frame calcwastage .
    down stream PrnLibStream with frame calcwastage .
end.
end.
procedure print-grp.
  define input parameter p-grp as character.
  form with frame calcwastage.
  display stream PrnLibStream sym1 "Группа товаров - " + p-grp @ tt-calcwast.gds-name sym11 with frame calcwastage.
  down stream PrnLibStream with frame calcwastage .
...
procedure print-prod.
  ...
  form with frame calcwastage.
  display stream PrnLibStream sym1 "Производитель - " + p-prod-type + string(p-prod-code) + "" + p-prod-name @ tt-calcwast.gds-name sym11 with frame calcwastage.
  down stream PrnLibStream with frame calcwastage .
  put stream PrnLibStream unformatted "          ------------------------------------------------------------------- " .
end.
procedure print-sub-total.
  ...
  display stream PrnLibStream sym1 p-str @ tt-calcwast.gds-name
                              ...
                              sym11  skip with frame calcwastage.
  down stream PrnLibStream with frame calcwastage .
  put stream PrnLibStream unformatted "---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" .
end.
...
find first sheetf where sheet-num = 1 .
    ...
    Sheetf.Excel-Column-Lable = "Артикул" + chr(44) +
                         "Название товара" + chr(44) +
                         "Недостача кг" + chr(44) +
                         "% ест.убыли" + chr(44) +
                         "Учетная цена" + chr(44) +
                         "Оборот кг" + chr(44) +
                         "Допустимая ест.убыль кг" + chr(44) +
                         "Превышение допустимой ест.убыль кг" + chr(44) +
                         "Допустимая ест.убыль руб" + chr(44) +
                         "Недостача руб"
