...
DO:
    MESSAGE "c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\rep\alc-rees.w should only be RUN PERSISTENT.":U
...
DEFINE NEW GLOBAL SHARED VAR adm-broker-hdl    AS HANDLE  NO-UNDO.
      adm-object-hdl = FRAME fMain:HANDLE.
RUN ensure-broker.
...
PROCEDURE adm-disable :
    DISABLE list-column p-izm-column WITH FRAME fMain.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN list-column p-izm-column WITH FRAME fMain.
...
PROCEDURE set-editors :
    ...
    ASSIGN curr-widget = FRAME fMain:CURRENT-ITERATION.
...
ON CHOOSE OF p-izm-column IN FRAME fMain
    DO:
...
PROCEDURE izm-col :
    ...
    v-column-list = "".
    do v-counter = 1 to list-column :num-items in frame fMain
        on error undo, return error
        :
        assign
...
PROCEDURE proc-get :
    ...
    do:
        ...
        do:
            assign
                list-column :list-items in frame fMain = v-uf-Naim.
        end.
    end.
end procedure.
