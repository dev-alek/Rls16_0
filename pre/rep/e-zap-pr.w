...
PROCEDURE adm-disable :
    DISABLE RECT-5 RECT-8 Classify ShowZero-2 RADIO-SET-1 ShowZero B-columns WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-5 RECT-8 Classify ShowZero-2 RADIO-SET-1 ShowZero B-columns WITH FRAME F-Main.
...
END PROCEDURE.
PROCEDURE my-var :
Assign frame F-Main ShowZero Classify ShowZero-2 RADIO-SET-1 .
Assign
 STR-obj-type = ''
 STR-obj-code = ''
 STR-obj-name = ''
...
ReportHeader = ReportHeader +
               ...
               (if x-SET_val_TYPE = 1 then "в рублях, "  else "в валюте, " ) +
