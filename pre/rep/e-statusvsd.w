...
IF NOT THIS-PROCEDURE:PERSISTENT THEN DO:
  MESSAGE "c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\rep\e-statusvsd.w should only be RUN PERSISTENT.":U
...
PROCEDURE adm-disable :
    DISABLE vTime vReqVerif vFalVerif vToExtin vFalExting vRep vSent WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN vTime vReqVerif vFalVerif vToExtin vFalExting vRep vSent WITH FRAME F-Main.
