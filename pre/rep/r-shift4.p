...
DEF VAR vss-description AS CHAR NO-UNDO INIT "$œÂ˜‡Ú¸ ÒÏÂÌÌÓ„Ó ÓÚ˜ÂÚ‡ - ÎËÒÚ 4 $":U.
...
FORM HEADER
string( p-z-number-list, "x(198)":U ) format "x(198)":U skip "-------------------------------------------------------------------------------------------------"  skip "              »Õ‘Œ–Ã¿÷»ﬂ Œ¡ ”—À”√≈                 :        –¿—ÿ»‘–Œ¬ ¿ –≈¿À»«¿÷»» ”—À”√         "  skip "---------------------------------------------------:---------------------------------------------"  skip "           Õ¿»Ã≈ÕŒ¬¿Õ»≈         :    Œƒ   :÷≈Õ¿    :    “»œ –¿—’Œƒ¿    :   ŒÀ-¬Œ :     —”ÃÃ¿     "  skip "              ÛÒÎÛ„Ë            :  ÛÒÎÛ„Ë :ÓÁÌË˜Ì :   (ÚËÔ ÔÎ‡ÚÂÊ‡)   :         :               "  skip "                                :         :Ì‡ ÍÓÌÂˆ:                   :         :               "  skip "                                :         :ÒÏÂÌ˚   :                   :         :               "  skip "-------------------------------------------------------------------------------------------------"
