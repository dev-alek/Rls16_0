...
PROCEDURE adm-disable :
    DISABLE RECT-8 RECT-5 RECT-6 Tog-obj Classify ShowZero-2 VAT-Cost ShowZero VAT-CRSA VAT-sale SortType WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-8 RECT-5 RECT-6 Tog-obj Classify ShowZero-2 VAT-Cost ShowZero VAT-CRSA VAT-sale SortType WITH FRAME F-Main.
...
if v_r-b = "base" then do:
  if base-code <> 0 then do:
    if x-SET_val_TYPE = 1 then do:
        message  "Выполнить отчет в рублях нельзя ! " view-as alert-box information .
        return no-apply.
    end.
  end.
end.
...
tog-lavel var-lavel Classify SortType VAT-Cost VAT-CRSA VAT-sale  .
 ...
 case Classify :
  when "no-classify" then do:
     if tog-obj = true then
        run rep/tcmsr-1y.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
      else
        run rep/tcmsr-1n.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
  end.
  when "prod" then do:
     if tog-obj = true then
        run rep/tcmsr-3y.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
      else
        run rep/tcmsr-3n.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
  end.
  when "grp-goods" then do:
     if tog-obj = true then
        run rep/tcmsr-2y.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
      else
        run rep/tcmsr-2n.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
  end.
  when "prod/grp-goods" then do:
     if tog-obj = true then
        run rep/tcmsr-4y.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
      else
        run rep/tcmsr-4n.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
  end.
  when "grp-goods/prod" then do:
     if tog-obj = true then
        run rep/tcmsr-5y.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
      else
        run rep/tcmsr-5n.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
  end.
  when "vat-ps" then do:
     if tog-obj = true then
        run rep/tcmsr-6y.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
      else
        run rep/tcmsr-6n.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
  end.
end case.
END PROCEDURE.
PROCEDURE proc-c :
 case Classify :
  when "no-classify" then do:
     if tog-obj = true then
        run rep/tcmsc-1y.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
      else
        run rep/tcmsc-1n.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
  end.
  when "prod" then do:
     if tog-obj = true then
        run rep/tcmsc-3y.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
      else
        run rep/tcmsc-3n.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
  end.
  when "grp-goods" then do:
     if tog-obj = true then
        run rep/tcmsc-2y.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
      else
        run rep/tcmsc-2n.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
  end.
  when "prod/grp-goods" then do:
     if tog-obj = true then
        run rep/tcmsc-4y.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
      else
        run rep/tcmsc-4n.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
  end.
  when "grp-goods/prod" then do:
     if tog-obj = true then
        run rep/tcmsc-5y.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
      else
        run rep/tcmsc-5n.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
  end.
  when "vat-ps" then do:
     if tog-obj = true then
        run rep/tcmsc-6y.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
      else
        run rep/tcmsc-6n.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
  end.
end case.
END PROCEDURE.
PROCEDURE proc-n :
 case Classify :
  when "no-classify" then do:
     if tog-obj = true then
        run rep/tcmsn-1y.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
      else
        run rep/tcmsn-1n.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
  end.
  when "prod" then do:
     if tog-obj = true then
        run rep/tcmsn-3y.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
      else
        run rep/tcmsn-3n.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
  end.
  when "grp-goods" then do:
     if tog-obj = true then
        run rep/tcmsn-2y.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
      else
        run rep/tcmsn-2n.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
  end.
  when "prod/grp-goods" then do:
     if tog-obj = true then
        run rep/tcmsn-4y.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
      else
        run rep/tcmsn-4n.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
  end.
  when "grp-goods/prod" then do:
     if tog-obj = true then
        run rep/tcmsn-5y.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
      else
        run rep/tcmsn-5n.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
  end.
  when "vat-ps" then do:
     if tog-obj = true then
        run rep/tcmsn-6y.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
      else
        run rep/tcmsn-6n.p ( input type-pr:screen-value , input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
  end.
end case.
END PROCEDURE.
