...
run write-log-and-file in p-log-handle (
    ...
    , input log-file-name
    , input 1
    , input substitute( ("'Пересылка справочника оснований чеков коррекций '" + " &1")
...
then do:
  ...
  then do:
    run str/post-xml.p
      ...
      ,input 30
      ,input   ( if action = 'U'
                  then ('Ждите - ' + 'добавление/изменение справочника оснований чеков коррекций ')
                  else ('Ждите - ' + 'удаление справочника оснований чеков коррекций ') ) +
