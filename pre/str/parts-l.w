...
define variable vss-include-info46 as character format "x(65)" no-undo initial "@(#)$Workfile$ Библиотека изменения размеров окна".
...
if num-entries(p-call-point, chr(4)) = 2
then do :
  if entry(2, p-call-point, chr(4)) = "return"
  then do :
    v-is-return = yes .
  end .
  p-call-point = entry(1, p-call-point, chr(4)) .
end .
assign
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run gdscdat in g#library
  ...
  ,output v-alcohol-prod
    ...
    or p-doc-code = ""
    or v-expense-return
    or (buf_trn-doc.ext-doc-type = 'ie':U or  buf_trn-doc.ext-doc-type = 'iv':U  or  buf_trn-doc.ext-doc-type = 'rv':U)
    then do:
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run conf-rd in g#library
  (input  'mercuri':u
  ,input  '':u
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run pargocod in g#library
  ...
  ,output v-gds-code
      ...
      then do :
        if parts.out-code = 'free-zone':U
        then do :
          disable b-vsd with frame Dialog-Frame.
        end .
        else do :
          enable b-vsd with frame Dialog-Frame.
        end .
      end .
    end.
  end.
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run gdscheck in g#library
  ...
  ,input ''
    ...
    ENABLE
      ...
      b-sel when (p-call-point = 'выбор':U or v-is-return)
      ed-notes
      rs-one-all
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-68 as character no-undo .
      ...
      parameter-4-68 =
        (
          if ("parts.artic = buf_goods.artic               and parts.prod-type = buf_goods.prod-type               and parts.prod-code = buf_goods.prod-code               and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )              " + " " + where-phrase-68) <> ""
          then                substitute (               ' parts.artic = &1&2&1                and parts.prod-type = &1&3&1               and parts.prod-code = &4               and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code )                + " " + where-phrase-68
          else "true"
        )
      parameter-5-68 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-68 =
          ("parts.artic = buf_goods.artic               and parts.prod-type = buf_goods.prod-type               and parts.prod-code = buf_goods.prod-code               and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )              " + " " + where-phrase-68 = "")
      .
  ...
  :
    if query br-parts:handle:get-buffer-handle(1) = (buffer parts:handle) then do:
      ...
      parameter-4-68 =
        "where ":u +                substitute (               ' parts.artic = &1&2&1                and parts.prod-type = &1&3&1               and parts.prod-code = &4               and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code )                + " ":u + where-phrase-68 + " ":u + p-find-condition + " " + ""
      parameter-5-68 = "use-index artic"
    .
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-70 as character no-undo .
      ...
      parameter-4-70 =
        (
          if ("parts.artic = buf_goods.artic             and parts.prod-type = buf_goods.prod-type             and parts.prod-code = buf_goods.prod-code             and parts.rsrv-free = yes             and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )             " + " " + where-phrase-70) <> ""
          then                substitute (               ' parts.artic = &1&2&1                and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.rsrv-free = yes               and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code )                + " " + where-phrase-70
          else "true"
        )
      parameter-5-70 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-70 =
          ("parts.artic = buf_goods.artic             and parts.prod-type = buf_goods.prod-type             and parts.prod-code = buf_goods.prod-code             and parts.rsrv-free = yes             and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )             " + " " + where-phrase-70 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-parts:handle
  ...
  :
    if query br-parts:handle:get-buffer-handle(1) = (buffer parts:handle) then do:
      ...
      parameter-4-70 =
        "where ":u +                substitute (               ' parts.artic = &1&2&1                and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.rsrv-free = yes               and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code )                + " ":u + where-phrase-70 + " ":u + p-find-condition + " " + ""
      parameter-5-70 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-72 as character no-undo .
      ...
      parameter-4-72 =
        (
          if ("parts.artic = buf_goods.artic             and parts.prod-type = buf_goods.prod-type             and parts.prod-code = buf_goods.prod-code             and parts.out-code = 'free-zone':U             and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )             " + " " + where-phrase-72) <> ""
          then                substitute (               ' parts.artic = &1&2&1                and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.out-code = &1&7&1                and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              '              , chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , 'free-zone':U)                + " " + where-phrase-72
          else "true"
        )
      parameter-5-72 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-72 =
          ("parts.artic = buf_goods.artic             and parts.prod-type = buf_goods.prod-type             and parts.prod-code = buf_goods.prod-code             and parts.out-code = 'free-zone':U             and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )             " + " " + where-phrase-72 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-parts:handle
  ...
  :
    if query br-parts:handle:get-buffer-handle(1) = (buffer parts:handle) then do:
      ...
      parameter-4-72 =
        "where ":u +                substitute (               ' parts.artic = &1&2&1                and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.out-code = &1&7&1                and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              '              , chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , 'free-zone':U)                + " ":u + where-phrase-72 + " ":u + p-find-condition + " " + ""
      parameter-5-72 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-74 as character no-undo .
      ...
      parameter-4-74 =
        (
          if ("parts.artic = buf_goods.artic               and parts.prod-type = buf_goods.prod-type               and parts.prod-code = buf_goods.prod-code               and parts.out-code = buf_trn-doc.doc-code               and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )               " + " " + where-phrase-74) <> ""
          then                substitute (               ' parts.artic = &1&2&1                and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.out-code  = &1&7&1               and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , buf_trn-doc.doc-code )                + " " + where-phrase-74
          else "true"
        )
      parameter-5-74 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-74 =
          ("parts.artic = buf_goods.artic               and parts.prod-type = buf_goods.prod-type               and parts.prod-code = buf_goods.prod-code               and parts.out-code = buf_trn-doc.doc-code               and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )               " + " " + where-phrase-74 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-parts:handle
  ...
  :
    if query br-parts:handle:get-buffer-handle(1) = (buffer parts:handle) then do:
      ...
      parameter-4-74 =
        "where ":u +                substitute (               ' parts.artic = &1&2&1                and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.out-code  = &1&7&1               and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , buf_trn-doc.doc-code )                + " ":u + where-phrase-74 + " ":u + p-find-condition + " " + ""
      parameter-5-74 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-76 as character no-undo .
      ...
      parameter-4-76 =
        (
          if ("parts.artic = buf_goods.artic             and parts.prod-type = buf_goods.prod-type             and parts.prod-code = buf_goods.prod-code             and parts.obj-type = v-obj-type             and parts.obj-code = v-obj-code             and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )             " + " " + where-phrase-76) <> ""
          then                substitute (               ' parts.artic = &1&2&1                and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.obj-type  = &1&7&1               and parts.obj-code  = &8               and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code )                + " " + where-phrase-76
          else "true"
        )
      parameter-5-76 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-76 =
          ("parts.artic = buf_goods.artic             and parts.prod-type = buf_goods.prod-type             and parts.prod-code = buf_goods.prod-code             and parts.obj-type = v-obj-type             and parts.obj-code = v-obj-code             and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )             " + " " + where-phrase-76 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-parts:handle
  ...
  :
    if query br-parts:handle:get-buffer-handle(1) = (buffer parts:handle) then do:
      ...
      parameter-4-76 =
        "where ":u +                substitute (               ' parts.artic = &1&2&1                and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.obj-type  = &1&7&1               and parts.obj-code  = &8               and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code )                + " ":u + where-phrase-76 + " ":u + p-find-condition + " " + ""
      parameter-5-76 = "use-index fifo"
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query br-parts:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-78 as character no-undo .
      ...
      parameter-4-78 =
        (
          if ("parts.artic = buf_goods.artic             and parts.prod-type = buf_goods.prod-type             and parts.prod-code = buf_goods.prod-code             and parts.obj-type = v-obj-type             and parts.obj-code = v-obj-code             and parts.rsrv-free = yes             and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )             " + " " + where-phrase-78) <> ""
          then                substitute (               ' parts.artic = &1&2&1                and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.obj-type  = &1&7&1               and parts.obj-code  = &8               and parts.rsrv-free = yes               and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code )                + " " + where-phrase-78
          else "true"
        )
      parameter-5-78 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-78 =
          ("parts.artic = buf_goods.artic             and parts.prod-type = buf_goods.prod-type             and parts.prod-code = buf_goods.prod-code             and parts.obj-type = v-obj-type             and parts.obj-code = v-obj-code             and parts.rsrv-free = yes             and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )             " + " " + where-phrase-78 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-parts:handle
  ...
  :
    if query br-parts:handle:get-buffer-handle(1) = (buffer parts:handle) then do:
      ...
      parameter-4-78 =
        "where ":u +                substitute (               ' parts.artic = &1&2&1                and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.obj-type  = &1&7&1               and parts.obj-code  = &8               and parts.rsrv-free = yes               and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code )                + " ":u + where-phrase-78 + " ":u + p-find-condition + " " + ""
      parameter-5-78 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-80 as character no-undo .
      ...
      parameter-4-80 =
        (
          if ("parts.artic = buf_goods.artic             and parts.prod-type = buf_goods.prod-type             and parts.prod-code = buf_goods.prod-code             and parts.obj-type = v-obj-type             and parts.obj-code = v-obj-code             and parts.out-code = 'free-zone':U             and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )             " + " " + where-phrase-80) <> ""
          then                substitute (               ' parts.artic = &1&2&1                and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.obj-type  = &1&7&1               and parts.obj-code  = &8               and parts.out-code = &1&9&1                 and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code , 'free-zone':U)                + " " + where-phrase-80
          else "true"
        )
      parameter-5-80 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-80 =
          ("parts.artic = buf_goods.artic             and parts.prod-type = buf_goods.prod-type             and parts.prod-code = buf_goods.prod-code             and parts.obj-type = v-obj-type             and parts.obj-code = v-obj-code             and parts.out-code = 'free-zone':U             and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )             " + " " + where-phrase-80 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-parts:handle
  ...
  :
    if query br-parts:handle:get-buffer-handle(1) = (buffer parts:handle) then do:
      ...
      parameter-4-80 =
        "where ":u +                substitute (               ' parts.artic = &1&2&1                and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.obj-type  = &1&7&1               and parts.obj-code  = &8               and parts.out-code = &1&9&1                 and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code , 'free-zone':U)                + " ":u + where-phrase-80 + " ":u + p-find-condition + " " + ""
      parameter-5-80 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-82 as character no-undo .
      ...
      parameter-4-82 =
        (
          if ("parts.artic = buf_goods.artic               and parts.prod-type = buf_goods.prod-type               and parts.prod-code = buf_goods.prod-code               and parts.obj-type = v-obj-type               and parts.obj-code = v-obj-code               and parts.out-code = buf_trn-doc.doc-code               and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )               " + " " + where-phrase-82) <> ""
          then                substitute (               ' parts.artic = &1&2&1                and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.obj-type  = &1&7&1               and parts.obj-code  = &8               and parts.out-code =  &1&9&1
              and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code ,buf_trn-doc.doc-code )                + " " + where-phrase-82
          else "true"
        )
      parameter-5-82 = (" " + "" + " " + "")
  ...
  if l-filter-open-82 = false then do:
    open query br-parts for each parts no-lock
      where parts.artic = buf_goods.artic               and parts.prod-type = buf_goods.prod-type               and parts.prod-code = buf_goods.prod-code               and parts.obj-type = v-obj-type               and parts.obj-code = v-obj-code               and parts.out-code = buf_trn-doc.doc-code               and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )
      indexed-reposition
  .
      assign
        v-query-was-opened = true
  ...
  :
    if query br-parts:handle:get-buffer-handle(1) = (buffer parts:handle) then do:
      ...
      parameter-4-82 =
        "where ":u +                substitute (               ' parts.artic = &1&2&1                and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.obj-type  = &1&7&1               and parts.obj-code  = &8               and parts.out-code =  &1&9&1
              and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code ,buf_trn-doc.doc-code )                + " ":u + where-phrase-82 + " ":u + p-find-condition + " " + ""
      parameter-5-82 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-84 as character no-undo .
      ...
      parameter-4-84 =
        (
          if ("parts.artic = buf_goods.artic                 and parts.prod-type = buf_goods.prod-type                 and parts.prod-code = buf_goods.prod-code                 and parts.obj-type = v-obj-type                 and parts.obj-code = v-obj-code                 and ( parts.out-code = 'free-zone':U                       or parts.out-code = 'out-zone':U                       or parts.out-code = buf_trn-doc.doc-code                     )                 and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )                 " + " " + where-phrase-84) <> ""
          then                substitute (               ' parts.artic = &1&2&1                and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.obj-type  = &1&7&1               and parts.obj-code  = &8               and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code  ) +               substitute ( '                 and ( parts.out-code = &1&2&1                       or parts.out-code = &1&3&1                       or parts.out-code = &1&4&1 )              ', chr(34) , 'free-zone':U , 'out-zone':U , buf_trn-doc.doc-code )                 + " " + where-phrase-84
          else "true"
        )
      parameter-5-84 = (" " + "" + " " + "")
  ...
  if l-filter-open-84 = false then do:
    open query br-parts for each parts no-lock
      where parts.artic = buf_goods.artic                 and parts.prod-type = buf_goods.prod-type                 and parts.prod-code = buf_goods.prod-code                 and parts.obj-type = v-obj-type                 and parts.obj-code = v-obj-code                 and ( parts.out-code = 'free-zone':U                       or parts.out-code = 'out-zone':U                       or parts.out-code = buf_trn-doc.doc-code                     )                 and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )
      use-index pi
      indexed-reposition
  .
      assign
  ...
  :
    if query br-parts:handle:get-buffer-handle(1) = (buffer parts:handle) then do:
      ...
      parameter-4-84 =
        "where ":u +                substitute (               ' parts.artic = &1&2&1                and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.obj-type  = &1&7&1               and parts.obj-code  = &8               and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code  ) +               substitute ( '                 and ( parts.out-code = &1&2&1                       or parts.out-code = &1&3&1                       or parts.out-code = &1&4&1 )              ', chr(34) , 'free-zone':U , 'out-zone':U , buf_trn-doc.doc-code )                 + " ":u + where-phrase-84 + " ":u + p-find-condition + " " + ""
      parameter-5-84 = "use-index pi"
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query br-parts:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-86 as character no-undo .
      ...
      parameter-4-86 =
        (
          if ("parts.artic = buf_goods.artic                   and parts.prod-type = buf_goods.prod-type                   and parts.prod-code = buf_goods.prod-code                   and parts.obj-type = v-obj-type                   and parts.obj-code = v-obj-code                   and ( ( parts.out-code = 'free-zone':U                           and (( parts.supp-type = buf_trn-doc.cli-type and parts.supp-code = buf_trn-doc.cli-code) )                         )
                        or parts.out-code = buf_trn-doc.doc-code                       )                   and parts.contract-code = buf_trn-doc.contract-code                   and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )                   " + " " + where-phrase-86) <> ""
          then                substitute (               ' parts.artic = &1&2&1                and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.obj-type  = &1&7&1               and parts.obj-code  = &8               and parts.contract-code =  &9               and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ' , chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code ,buf_trn-doc.contract-code  ) +               substitute ( '                   and ( ( parts.out-code = &1&5&1                           and ( parts.supp-type = &1&2&1 and parts.supp-code = &3 )                         )                         or parts.out-code = &1&4&1                       )               ', chr(34) , buf_trn-doc.cli-type , buf_trn-doc.cli-code , buf_trn-doc.doc-code , 'free-zone':U )  + " " + where-phrase-86
          else "true"
        )
      parameter-5-86 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-86 =
          ("parts.artic = buf_goods.artic                   and parts.prod-type = buf_goods.prod-type                   and parts.prod-code = buf_goods.prod-code                   and parts.obj-type = v-obj-type                   and parts.obj-code = v-obj-code                   and ( ( parts.out-code = 'free-zone':U                           and (( parts.supp-type = buf_trn-doc.cli-type and parts.supp-code = buf_trn-doc.cli-code) )                         )
                        or parts.out-code = buf_trn-doc.doc-code                       )                   and parts.contract-code = buf_trn-doc.contract-code                   and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )                   " + " " + where-phrase-86 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-parts:handle
  ...
  if l-filter-open-86 = false then do:
    open query br-parts for each parts no-lock
      where parts.artic = buf_goods.artic                   and parts.prod-type = buf_goods.prod-type                   and parts.prod-code = buf_goods.prod-code                   and parts.obj-type = v-obj-type                   and parts.obj-code = v-obj-code                   and ( ( parts.out-code = 'free-zone':U                           and (( parts.supp-type = buf_trn-doc.cli-type and parts.supp-code = buf_trn-doc.cli-code) )                         )
                        or parts.out-code = buf_trn-doc.doc-code                       )                   and parts.contract-code = buf_trn-doc.contract-code                   and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )
      use-index pi
      indexed-reposition
  .
      assign
  ...
  :
    if query br-parts:handle:get-buffer-handle(1) = (buffer parts:handle) then do:
      ...
      parameter-4-86 =
        "where ":u +                substitute (               ' parts.artic = &1&2&1                and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.obj-type  = &1&7&1               and parts.obj-code  = &8               and parts.contract-code =  &9               and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ' , chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code ,buf_trn-doc.contract-code  ) +               substitute ( '                   and ( ( parts.out-code = &1&5&1                           and ( parts.supp-type = &1&2&1 and parts.supp-code = &3 )                         )                         or parts.out-code = &1&4&1                       )               ', chr(34) , buf_trn-doc.cli-type , buf_trn-doc.cli-code , buf_trn-doc.doc-code , 'free-zone':U )  + " ":u + where-phrase-86 + " ":u + p-find-condition + " " + ""
      parameter-5-86 = "use-index pi"
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query br-parts:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-88 as character no-undo .
      ...
      parameter-4-88 =
        (
          if ("parts.artic = buf_goods.artic                   and parts.prod-type = buf_goods.prod-type                   and parts.prod-code = buf_goods.prod-code                   and parts.obj-type = v-obj-type                   and parts.obj-code = v-obj-code                   and ( parts.out-code = 'free-zone':U                         or parts.out-code = buf_trn-doc.doc-code                       )                   and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )                   " + " " + where-phrase-88) <> ""
          then                substitute ( '                   parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.obj-type  = &1&7&1               and parts.obj-code  = &8               and  ( parts.out-code = &1&2&1                      or parts.out-code = &1&9&1                   )               and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) ,  'free-zone':U  , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code ,buf_trn-doc.doc-code   )  +               substitute (               ' and parts.artic = &1&2&1 ', chr(34) , buf_goods.artic )                + " " + where-phrase-88
          else "true"
        )
      parameter-5-88 = (" " + "" + " " + "")
  ...
  if l-filter-open-88 = false then do:
    open query br-parts for each parts no-lock
      where parts.artic = buf_goods.artic                   and parts.prod-type = buf_goods.prod-type                   and parts.prod-code = buf_goods.prod-code                   and parts.obj-type = v-obj-type                   and parts.obj-code = v-obj-code                   and ( parts.out-code = 'free-zone':U                         or parts.out-code = buf_trn-doc.doc-code                       )                   and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )
      use-index pi
      indexed-reposition
  .
      assign
  ...
  :
    if query br-parts:handle:get-buffer-handle(1) = (buffer parts:handle) then do:
      ...
      parameter-4-88 =
        "where ":u +                substitute ( '                   parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.obj-type  = &1&7&1               and parts.obj-code  = &8               and  ( parts.out-code = &1&2&1                      or parts.out-code = &1&9&1                   )               and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) ,  'free-zone':U  , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code ,buf_trn-doc.doc-code   )  +               substitute (               ' and parts.artic = &1&2&1 ', chr(34) , buf_goods.artic )                + " ":u + where-phrase-88 + " ":u + p-find-condition + " " + ""
      parameter-5-88 = "use-index pi"
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query br-parts:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-90 as character no-undo .
      ...
      parameter-4-90 =
        (
          if ("parts.artic = buf_goods.artic                     and parts.prod-type = buf_goods.prod-type                     and parts.prod-code = buf_goods.prod-code                     and parts.obj-type = v-obj-type                     and parts.obj-code = v-obj-code                     and (parts.out-code = 'free-zone':U or parts.out-code = buf_trn-doc.doc-code)                     and (( parts.supp-type = buf_trn-doc.cli-type and parts.supp-code = buf_trn-doc.cli-code) or                         (parts.is-supp = no and not ( parts.supp-type = 'орг':U and parts.supp-code = buf_trn-doc.host-code)))                     and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )                     and parts.contract-code = buf_trn-doc.contract-code                     " + " " + where-phrase-90) <> ""
          then                  substitute (                 ' parts.artic = &1&2&1                  and parts.prod-code = &4                 and parts.obj-type  = &1&7&1                 and parts.obj-code  = &8                 and ( parts.out-code = &1&3&1 or parts.out-code = &1&9&1 )                 and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )               ', chr(34) , buf_goods.artic , 'free-zone':U , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code , buf_trn-doc.doc-code ) +                 substitute ( '                     and parts.prod-type = &1&5&1                     and (( parts.supp-type = &1&2&1 and parts.supp-code = &3 ) or                           (parts.is-supp = no and not ( parts.supp-type = &1&6&1  and parts.supp-code = &4 )))                     and parts.contract-code = &7                         ', chr(34) , buf_trn-doc.cli-type , buf_trn-doc.cli-code , buf_trn-doc.host-code , buf_goods.prod-type , 'орг':U , buf_trn-doc.contract-code )                  + " " + where-phrase-90
          else "true"
        )
      parameter-5-90 = (" " + "" + " " + "")
  ...
  :
    if query br-parts:handle:get-buffer-handle(1) = (buffer parts:handle) then do:
      ...
      parameter-4-90 =
        "where ":u +                  substitute (                 ' parts.artic = &1&2&1                  and parts.prod-code = &4                 and parts.obj-type  = &1&7&1                 and parts.obj-code  = &8                 and ( parts.out-code = &1&3&1 or parts.out-code = &1&9&1 )                 and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )               ', chr(34) , buf_goods.artic , 'free-zone':U , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code , buf_trn-doc.doc-code ) +                 substitute ( '                     and parts.prod-type = &1&5&1                     and (( parts.supp-type = &1&2&1 and parts.supp-code = &3 ) or                           (parts.is-supp = no and not ( parts.supp-type = &1&6&1  and parts.supp-code = &4 )))                     and parts.contract-code = &7                         ', chr(34) , buf_trn-doc.cli-type , buf_trn-doc.cli-code , buf_trn-doc.host-code , buf_goods.prod-type , 'орг':U , buf_trn-doc.contract-code )                  + " ":u + where-phrase-90 + " ":u + p-find-condition + " " + ""
      parameter-5-90 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-92 as character no-undo .
      ...
      parameter-4-92 =
        (
          if ("parts.artic = buf_goods.artic                     and parts.prod-type = buf_goods.prod-type                     and parts.prod-code = buf_goods.prod-code                     and parts.obj-type = v-obj-type                     and parts.obj-code = v-obj-code                     and (parts.out-code = 'free-zone':U or parts.out-code = buf_trn-doc.doc-code)                     and (( parts.supp-type = buf_trn-doc.cli-type and parts.supp-code = buf_trn-doc.cli-code) or                         (parts.is-supp = no and not ( parts.supp-type = 'орг':U and parts.supp-code = buf_trn-doc.host-code)))                     and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )                     " + " " + where-phrase-92) <> ""
          then                  substitute (                 ' parts.artic = &1&2&1                  and parts.prod-code = &4                 and parts.obj-type  = &1&7&1                 and parts.obj-code  = &8                 and ( parts.out-code = &1&3&1 or parts.out-code = &1&9&1 )                 and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )               ', chr(34) , buf_goods.artic , 'free-zone':U , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code , buf_trn-doc.doc-code ) +                 substitute ( '                     and parts.prod-type = &1&5&1                     and (( parts.supp-type = &1&2&1 and parts.supp-code = &3 ) or                           (parts.is-supp = no and not ( parts.supp-type = &1&6&1  and parts.supp-code = &4 )))                         ', chr(34) , buf_trn-doc.cli-type , buf_trn-doc.cli-code , buf_trn-doc.host-code , buf_goods.prod-type , 'орг':U )                  + " " + where-phrase-92
          else "true"
        )
      parameter-5-92 = (" " + "" + " " + "")
  ...
  :
    if query br-parts:handle:get-buffer-handle(1) = (buffer parts:handle) then do:
      ...
      parameter-4-92 =
        "where ":u +                  substitute (                 ' parts.artic = &1&2&1                  and parts.prod-code = &4                 and parts.obj-type  = &1&7&1                 and parts.obj-code  = &8                 and ( parts.out-code = &1&3&1 or parts.out-code = &1&9&1 )                 and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )               ', chr(34) , buf_goods.artic , 'free-zone':U , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code , buf_trn-doc.doc-code ) +                 substitute ( '                     and parts.prod-type = &1&5&1                     and (( parts.supp-type = &1&2&1 and parts.supp-code = &3 ) or                           (parts.is-supp = no and not ( parts.supp-type = &1&6&1  and parts.supp-code = &4 )))                         ', chr(34) , buf_trn-doc.cli-type , buf_trn-doc.cli-code , buf_trn-doc.host-code , buf_goods.prod-type , 'орг':U )                  + " ":u + where-phrase-92 + " ":u + p-find-condition + " " + ""
      parameter-5-92 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-94 as character no-undo .
      ...
      parameter-4-94 =
        (
          if ("parts.artic = buf_goods.artic                   and parts.prod-type = buf_goods.prod-type                   and parts.prod-code = buf_goods.prod-code                   and parts.obj-type = v-obj-type                   and parts.obj-code = v-obj-code                   and (parts.out-code = 'free-zone':U or parts.out-code = buf_trn-doc.doc-code)                   and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )                   " + " " + where-phrase-94) <> ""
          then                substitute (               '  parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.obj-type  = &1&7&1               and parts.obj-code  = &8               and ( parts.out-code = &1&2&1 or parts.out-code = &1&9&1 )               and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , 'free-zone':U  , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code ,buf_trn-doc.doc-code ) +               substitute (               ' and parts.artic = &1&2&1 ', chr(34) , buf_goods.artic )                + " " + where-phrase-94
          else "true"
        )
      parameter-5-94 = (" " + "" + " " + "")
  ...
  :
    if query br-parts:handle:get-buffer-handle(1) = (buffer parts:handle) then do:
      ...
      parameter-4-94 =
        "where ":u +                substitute (               '  parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.obj-type  = &1&7&1               and parts.obj-code  = &8               and ( parts.out-code = &1&2&1 or parts.out-code = &1&9&1 )               and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , 'free-zone':U  , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code ,buf_trn-doc.doc-code ) +               substitute (               ' and parts.artic = &1&2&1 ', chr(34) , buf_goods.artic )                + " ":u + where-phrase-94 + " ":u + p-find-condition + " " + ""
      parameter-5-94 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-96 as character no-undo .
      ...
      parameter-4-96 =
        (
          if ("parts.artic = buf_goods.artic                     and parts.prod-type = buf_goods.prod-type                     and parts.prod-code = buf_goods.prod-code                     and parts.obj-type = v-obj-type                     and parts.obj-code = v-obj-code                     and parts.out-code = buf_trn-doc.doc-code                     and (( parts.supp-type = buf_trn-doc.cli-type and parts.supp-code = buf_trn-doc.cli-code) or parts.is-supp = no)                     and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )                     and parts.contract-code = buf_trn-doc.contract-code                     " + " " + where-phrase-96) <> ""
          then                  substitute (                 ' parts.artic = &1&2&1                  and parts.prod-type = &1&3&1                 and parts.prod-code = &4                 and parts.obj-type  = &1&7&1                 and parts.obj-code  = &8                 and  parts.out-code = &1&9&1                 and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )               ', chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code ,buf_trn-doc.doc-code ) +                 substitute ( '                     and (( parts.supp-type = &1&2&1 and parts.supp-code = &3 ) or parts.is-supp = no )                     and parts.contract-code = &4                         ', chr(34) , buf_trn-doc.cli-type , buf_trn-doc.cli-code , buf_trn-doc.contract-code )                  + " " + where-phrase-96
          else "true"
        )
      parameter-5-96 = (" " + "" + " " + "")
  ...
  :
    if query br-parts:handle:get-buffer-handle(1) = (buffer parts:handle) then do:
      ...
      parameter-4-96 =
        "where ":u +                  substitute (                 ' parts.artic = &1&2&1                  and parts.prod-type = &1&3&1                 and parts.prod-code = &4                 and parts.obj-type  = &1&7&1                 and parts.obj-code  = &8                 and  parts.out-code = &1&9&1                 and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )               ', chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code ,buf_trn-doc.doc-code ) +                 substitute ( '                     and (( parts.supp-type = &1&2&1 and parts.supp-code = &3 ) or parts.is-supp = no )                     and parts.contract-code = &4                         ', chr(34) , buf_trn-doc.cli-type , buf_trn-doc.cli-code , buf_trn-doc.contract-code )                  + " ":u + where-phrase-96 + " ":u + p-find-condition + " " + ""
      parameter-5-96 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-98 as character no-undo .
      ...
      parameter-4-98 =
        (
          if ("parts.artic = buf_goods.artic                     and parts.prod-type = buf_goods.prod-type                     and parts.prod-code = buf_goods.prod-code                     and parts.obj-type = v-obj-type                     and parts.obj-code = v-obj-code                     and parts.out-code = buf_trn-doc.doc-code                     and (( parts.supp-type = buf_trn-doc.cli-type and parts.supp-code = buf_trn-doc.cli-code) or parts.is-supp = no)                     and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )                     " + " " + where-phrase-98) <> ""
          then                  substitute (                 ' parts.artic = &1&2&1                  and parts.prod-type = &1&3&1                 and parts.prod-code = &4                 and parts.obj-type  = &1&7&1                 and parts.obj-code  = &8                 and  parts.out-code = &1&9&1                 and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )               ', chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code ,buf_trn-doc.doc-code ) +                 substitute ( '                     and (( parts.supp-type = &1&2&1 and parts.supp-code = &3 ) or parts.is-supp = no )                         ', chr(34) , buf_trn-doc.cli-type , buf_trn-doc.cli-code  )                  + " " + where-phrase-98
          else "true"
        )
      parameter-5-98 = (" " + "" + " " + "")
  ...
  if l-filter-open-98 = false then do:
    open query br-parts for each parts no-lock
      where parts.artic = buf_goods.artic                     and parts.prod-type = buf_goods.prod-type                     and parts.prod-code = buf_goods.prod-code                     and parts.obj-type = v-obj-type                     and parts.obj-code = v-obj-code                     and parts.out-code = buf_trn-doc.doc-code                     and (( parts.supp-type = buf_trn-doc.cli-type and parts.supp-code = buf_trn-doc.cli-code) or parts.is-supp = no)                     and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )
      indexed-reposition
  .
      assign
        v-query-was-opened = true
  ...
  :
    if query br-parts:handle:get-buffer-handle(1) = (buffer parts:handle) then do:
      ...
      parameter-4-98 =
        "where ":u +                  substitute (                 ' parts.artic = &1&2&1                  and parts.prod-type = &1&3&1                 and parts.prod-code = &4                 and parts.obj-type  = &1&7&1                 and parts.obj-code  = &8                 and  parts.out-code = &1&9&1                 and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )               ', chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code ,buf_trn-doc.doc-code ) +                 substitute ( '                     and (( parts.supp-type = &1&2&1 and parts.supp-code = &3 ) or parts.is-supp = no )                         ', chr(34) , buf_trn-doc.cli-type , buf_trn-doc.cli-code  )                  + " ":u + where-phrase-98 + " ":u + p-find-condition + " " + ""
      parameter-5-98 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-100 as character no-undo .
      ...
      parameter-4-100 =
        (
          if ("parts.artic = buf_goods.artic                   and parts.prod-type = buf_goods.prod-type                   and parts.prod-code = buf_goods.prod-code                   and parts.obj-type = v-obj-type                   and parts.obj-code = v-obj-code                   and parts.out-code = buf_trn-doc.doc-code                   and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )                   " + " " + where-phrase-100) <> ""
          then                substitute (               ' parts.artic = &1&2&1                and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.obj-type  = &1&7&1               and parts.obj-code  = &8               and  parts.out-code = &1&9&1               and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code ,buf_trn-doc.doc-code )                 + " " + where-phrase-100
          else "true"
        )
      parameter-5-100 = (" " + "" + " " + "")
  ...
  :
    if query br-parts:handle:get-buffer-handle(1) = (buffer parts:handle) then do:
      ...
      parameter-4-100 =
        "where ":u +                substitute (               ' parts.artic = &1&2&1                and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.obj-type  = &1&7&1               and parts.obj-code  = &8               and  parts.out-code = &1&9&1               and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code ,buf_trn-doc.doc-code )                 + " ":u + where-phrase-100 + " ":u + p-find-condition + " " + ""
      parameter-5-100 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-100 = (if p-find-next then "true":u else "false":u )
      parameter-3-100 =  "FOR EACH parts"
      parameter-4-100 =
        (
          if ("parts.artic = buf_goods.artic                   and parts.prod-type = buf_goods.prod-type                   and parts.prod-code = buf_goods.prod-code                   and parts.obj-type = v-obj-type                   and parts.obj-code = v-obj-code                   and parts.out-code = buf_trn-doc.doc-code                   and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )                   " + " " + where-phrase-100) <> ""
          then                substitute (               ' parts.artic = &1&2&1                and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.obj-type  = &1&7&1               and parts.obj-code  = &8               and  parts.out-code = &1&9&1               and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code ,buf_trn-doc.doc-code )                 + " " + where-phrase-100
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-102 as character no-undo .
      ...
      parameter-4-102 =
        (
          if ("parts.artic = buf_goods.artic                 and parts.prod-type = buf_goods.prod-type                 and parts.prod-code = buf_goods.prod-code                 and parts.obj-type = v-obj-type                 and parts.obj-code = v-obj-code                 and (parts.out-code = 'out-zone':U or parts.out-code = buf_trn-doc.doc-code)                 and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )                 " + " " + where-phrase-102) <> ""
          then                substitute (               ' parts.artic = &1&2&1 ', chr(34) , buf_goods.artic  ) +                substitute (               ' and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.obj-type  = &1&7&1               and parts.obj-code  = &8               and (parts.out-code =  &1&2&1 or  parts.out-code = &1&9&1 )               and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , 'out-zone':U , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code ,buf_trn-doc.doc-code )                 + " " + where-phrase-102
          else "true"
        )
      parameter-5-102 = (" " + "" + " " + "")
  ...
  if l-filter-open-102 = false then do:
    open query br-parts for each parts no-lock
      where parts.artic = buf_goods.artic                 and parts.prod-type = buf_goods.prod-type                 and parts.prod-code = buf_goods.prod-code                 and parts.obj-type = v-obj-type                 and parts.obj-code = v-obj-code                 and (parts.out-code = 'out-zone':U or parts.out-code = buf_trn-doc.doc-code)                 and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )
      indexed-reposition
  .
      assign
        v-query-was-opened = true
  ...
  :
    if query br-parts:handle:get-buffer-handle(1) = (buffer parts:handle) then do:
      ...
      parameter-4-102 =
        "where ":u +                substitute (               ' parts.artic = &1&2&1 ', chr(34) , buf_goods.artic  ) +                substitute (               ' and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.obj-type  = &1&7&1               and parts.obj-code  = &8               and (parts.out-code =  &1&2&1 or  parts.out-code = &1&9&1 )               and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , 'out-zone':U , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code ,buf_trn-doc.doc-code )                 + " ":u + where-phrase-102 + " ":u + p-find-condition + " " + ""
      parameter-5-102 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-102 = (if p-find-next then "true":u else "false":u )
      parameter-3-102 =  "FOR EACH parts"
      parameter-4-102 =
        (
          if ("parts.artic = buf_goods.artic                 and parts.prod-type = buf_goods.prod-type                 and parts.prod-code = buf_goods.prod-code                 and parts.obj-type = v-obj-type                 and parts.obj-code = v-obj-code                 and (parts.out-code = 'out-zone':U or parts.out-code = buf_trn-doc.doc-code)                 and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )                 " + " " + where-phrase-102) <> ""
          then                substitute (               ' parts.artic = &1&2&1 ', chr(34) , buf_goods.artic  ) +                substitute (               ' and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.obj-type  = &1&7&1               and parts.obj-code  = &8               and (parts.out-code =  &1&2&1 or  parts.out-code = &1&9&1 )               and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , 'out-zone':U , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code ,buf_trn-doc.doc-code )                 + " " + where-phrase-102
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-104 as character no-undo .
      ...
      parameter-4-104 =
        (
          if ("parts.artic = buf_goods.artic                 and parts.prod-type = buf_goods.prod-type                 and parts.prod-code = buf_goods.prod-code                 and parts.obj-type = v-obj-type                 and parts.obj-code = v-obj-code                 and parts.out-code = buf_trn-doc.doc-code                 and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )                 " + " " + where-phrase-104) <> ""
          then                substitute (               ' parts.artic = &1&2&1                and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.obj-type  = &1&7&1               and parts.obj-code  = &8               and parts.out-code = &1&9&1                and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code ,buf_trn-doc.doc-code )                 + " " + where-phrase-104
          else "true"
        )
      parameter-5-104 = (" " + "" + " " + "")
  ...
  :
    if query br-parts:handle:get-buffer-handle(1) = (buffer parts:handle) then do:
      ...
      parameter-4-104 =
        "where ":u +                substitute (               ' parts.artic = &1&2&1                and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.obj-type  = &1&7&1               and parts.obj-code  = &8               and parts.out-code = &1&9&1                and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code ,buf_trn-doc.doc-code )                 + " ":u + where-phrase-104 + " ":u + p-find-condition + " " + ""
      parameter-5-104 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-104 = (if p-find-next then "true":u else "false":u )
      parameter-3-104 =  "FOR EACH parts"
      parameter-4-104 =
        (
          if ("parts.artic = buf_goods.artic                 and parts.prod-type = buf_goods.prod-type                 and parts.prod-code = buf_goods.prod-code                 and parts.obj-type = v-obj-type                 and parts.obj-code = v-obj-code                 and parts.out-code = buf_trn-doc.doc-code                 and (v-reserv-pl-code <> true or (v-reserv-pl-code = true and parts.pl-code = v-pl-code ) )                 " + " " + where-phrase-104) <> ""
          then                substitute (               ' parts.artic = &1&2&1                and parts.prod-type = &1&3&1               and parts.prod-code = &4               and parts.obj-type  = &1&7&1               and parts.obj-code  = &8               and parts.out-code = &1&9&1                and ( &5 <> true or ( &5 = true and parts.pl-code = &6 ) )              ', chr(34) , buf_goods.artic , buf_goods.prod-type , buf_goods.prod-code , v-reserv-pl-code , v-pl-code , v-obj-type , v-obj-code ,buf_trn-doc.doc-code )                 + " " + where-phrase-104
      ...
      parameter-5-104 = (" " + "" + " " + "" + " " + p-find-condition)
      parameter-6-104 = if sort-phrase-104 = ''
                           then
        (
        " " + " " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-106 as character no-undo .
      ...
      parameter-4-106 =
        (
          if ("parts.artic = ''                     and parts.prod-type = ''                     and parts.prod-code = 0                     and parts.obj-type = ''                     and parts.obj-code = 0" + " " + where-phrase-106) <> ""
          then                substitute (               ' parts.artic = &1&&1                and parts.prod-type = &1&&1               and parts.prod-code = 0               and parts.obj-type  = &1&&1               and parts.obj-code  = 0              ', chr(34)  )                 + " " + where-phrase-106
          else "true"
        )
      parameter-5-106 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-106 =
          ("parts.artic = ''                     and parts.prod-type = ''                     and parts.prod-code = 0                     and parts.obj-type = ''                     and parts.obj-code = 0" + " " + where-phrase-106 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-parts:handle
  ...
  :
    if query br-parts:handle:get-buffer-handle(1) = (buffer parts:handle) then do:
      ...
      parameter-4-106 =
        "where ":u +                substitute (               ' parts.artic = &1&&1                and parts.prod-type = &1&&1               and parts.prod-code = 0               and parts.obj-type  = &1&&1               and parts.obj-code  = 0              ', chr(34)  )                 + " ":u + where-phrase-106 + " ":u + p-find-condition + " " + ""
      parameter-5-106 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-106 = (if p-find-next then "true":u else "false":u )
      parameter-3-106 =  "FOR EACH parts"
      parameter-4-106 =
        (
          if ("parts.artic = ''                     and parts.prod-type = ''                     and parts.prod-code = 0                     and parts.obj-type = ''                     and parts.obj-code = 0" + " " + where-phrase-106) <> ""
          then                substitute (               ' parts.artic = &1&&1                and parts.prod-type = &1&&1               and parts.prod-code = 0               and parts.obj-type  = &1&&1               and parts.obj-code  = 0              ', chr(34)  )                 + " " + where-phrase-106
      ...
      parameter-5-106 = (" " + "" + " " + "" + " " + p-find-condition)
      parameter-6-106 = if sort-phrase-106 = ''
                           then
        (
        " " + " " +
