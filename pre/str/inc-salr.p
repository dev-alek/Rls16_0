...
define variable vss-include-info12 as character format "x(65)" no-undo initial "@(#)$Workfile: inc-salr.i $ $Revision: 5b89e89c1f45, 2641, rls $".
...
:
  ...
  then do:
    MESSAGE substitute("Продажа &1 уже закрыта:&2Докачка чеков не может быть произведена"                                , ink-doc.inkas-code                                        , chr(10)                                                ) view-as alert-box ERROR .
     UNDO, return error.
  end.
...
:
    ...
    and not (KIND-TO-RESERV = 'es':U
      ...
      do dtrg = 1 to docs-to-reserv:
        ...
        if not available buf_sale-doc then do:
          ...
          if error-status:error then do:
            MESSAGE substitute("&1 &2 &3&4&5&4&6"                                    , vss-workfile                                                     , vss-revision                                                     , vss-description                                                  , chr(10)                                                    , error-status:get-message(1)                                      , return-value) view-as alert-box ERROR .
            undo c-d, next c-d.
          end.
        end.
      end.
    ...
    :
      ...
      :
        ...
        if buf_chk-gds.doc-qnty = 0 then do:
         ...
         do:
            MESSAGE substitute("Чек &1 не имеет тип чека. Чек не будет закачан в продажу&2&3"                                    , X_chk-doc.doc-code                                               , chr(10)                                                    , return-value                                                     ) view-as alert-box ERROR .
        ...
        MESSAGE substitute("&1 &2 &3&4Чек &5 строка &6,&4отсутствует в БД бар-код &7&4Чек не будет закачан в продажу"                                      , vss-workfile                                                       , vss-revision                                                       , vss-description                                                    , chr(10)                                                      , X_chk-doc.doc-code                                                 , buf_chk-gds.line-num                                               , buf_chk-gds.b-code) view-as alert-box ERROR .
            undo _one-check, leave _one-check.
          end.
  ...
  MESSAGE substitute("Чек &1 Бар-код &2 ТРК &3&4Не удается определить танк&4Чек не будет закачан в продажу&4&5"                                , X_chk-doc.doc-code                                           , buf_chk-gds.b-code                                                 , buf_chk-gds.pump                                                   , chr(10)                                                , return-value                                                 ) view-as alert-box ERROR .
            UNDO _one-check, leave _one-check.
          end.
          find first buf_place no-lock where buf_place.pl-code = plcode no-error .
          if not available buf_place then do:
  MESSAGE substitute("Чек &1 Бар-код &2 ТРК &3&4Не удается определить резервуар&4Чек не будет закачан в продажу&4&5"                                , X_chk-doc.doc-code                                           , buf_chk-gds.b-code                                                 , buf_chk-gds.pump                                                   , chr(10)                                                , return-value                                                 ) view-as alert-box ERROR .
            UNDO _one-check, leave _one-check.
          end.
          assign
            v-pl-code           = plcode
...
if (valid-handle(ibs.th.gbl.gbl-hndllib:g#lib-trn3) <> true) then do:   run str/lib-trn3.p persistent no-error .   if error-status :error or (valid-handle(ibs.th.gbl.gbl-hndllib:g#lib-trn3) <> true) then do:     message       "Error starting lib-trn3.p" skip       ibs.th.gbl.gbl-hndllib:g#lib-trn3 skip       ibs.th.gbl.gbl-hndllib:g#lib-trn3 :type skip       ibs.th.gbl.gbl-hndllib:g#lib-trn3 :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run lib-trn3_vollosan in g#lib-trn3
  ...
  , output  v-pl-code
              ...
              if error-status:error then do:
                MESSAGE substitute("Чек &1 Бар-код &2 ТРК &3&4Не удается определить резервуар среди сообщающихся &4&5&4Чек не будет закачан в продажу"                                    , X_chk-doc.doc-code                                               , t-gds.b-code                                                     , t-gds.pump                                                       , chr(10)                                                    , v-pl-list                                                     ) view-as alert-box ERROR .
                UNDO _one-check, leave _one-check.
              end.
              if v-pl-code = 0
              or v-pl-code = ?
...
if (valid-handle(ibs.th.gbl.gbl-hndllib:g#lib-trn3) <> true) then do:   run str/lib-trn3.p persistent no-error .   if error-status :error or (valid-handle(ibs.th.gbl.gbl-hndllib:g#lib-trn3) <> true) then do:     message       "Error starting lib-trn3.p" skip       ibs.th.gbl.gbl-hndllib:g#lib-trn3 skip       ibs.th.gbl.gbl-hndllib:g#lib-trn3 :type skip       ibs.th.gbl.gbl-hndllib:g#lib-trn3 :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run lib-trn3_avrgdens in g#lib-trn3
  ...
  , output v-Reconc-tank-attr
            ...
            if error-status:error then do:
              MESSAGE substitute("Чек &1 Бар-код &2 ТРК &3&4Не удается определить плотность топлива в танке&4&5&4Чек не будет закачан в продажу"                                  , X_chk-doc.doc-code                                             , t-gds.b-code                                                   , t-gds.pump                                                     , chr(10)                                                  , return-value                                                   ) view-as alert-box ERROR .
              UNDO _one-check, leave _one-check.
            end.
     ...
     WHERE t-gds.doc-code    = buf_sale-doc.doc-code
       ...
       AND t-gds.pl-code     = buf_chk-gds.pl-code NO-ERROR.
        ...
        MESSAGE substitute("&1 &2 &3&4Чек &5 строка &6,&4отсутствует в БД бар-код &7&4Чек не будет закачан в продажу"                                      , vss-workfile                                                       , vss-revision                                                       , vss-description                                                    , chr(10)                                                      , X_chk-doc.doc-code                                                 , buf_chk-gds.line-num                                               , buf_chk-gds.b-code) view-as alert-box ERROR .
                ...
                MESSAGE substitute("&1 &2 &3&4Чек &5 строка &6, цена товара-услуги с бар-кодом &7=0&4Чек не будет закачан в продажу"                                      , vss-workfile                                                       , vss-revision                                                       , vss-description                                                    , chr(10)                                                      , X_chk-doc.doc-code                                                 , buf_chk-gds.line-num                                               , buf_chk-gds.b-code) view-as alert-box ERROR .
                    undo _one-check, leave _one-check.
                  end.
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run bcodeprc in g#library
  ...
  ,output for-excise
                    ...
                    then DO:
      MESSAGE substitute("Чек &1 Строка &2&3Бар-код &4 Артикул &5 &6&3Нет продажной цены&3Чек не будет закачан в продажу"                                    , X_chk-doc.doc-code                                               , Buf_chk-gds.line-num                                             , chr(10)                                                    , ub.bar-code.b-code                                                  , ub.goods.artic                                                      , ub.goods.gds-name) view-as alert-box ERROR .
                      undo _one-check, leave _one-check.
                    END.
                    assign
...
.
            if error-status:error then do:
  MESSAGE substitute("Чек &1 Бар-код &2 скл.место &3&4Не удается создать строку документа для скл.места&4&5&4Чек не будет закачан в продажу"                              , X_chk-doc.doc-code                                         , t-gds.b-code                                               , t-gds.pl-code                                              , chr(10)                                              , return-value                                               ) view-as alert-box ERROR .
              UNDO _one-check, leave _one-check.
            end.
...
if (valid-handle(ibs.th.gbl.gbl-hndllib:g#lib-trn) <> true) then do:   run str/lib-trn.p persistent no-error .   if error-status :error or (valid-handle(ibs.th.gbl.gbl-hndllib:g#lib-trn) <> true) then do:     message       "Error starting lib-trn.p" skip       ibs.th.gbl.gbl-hndllib:g#lib-trn skip       ibs.th.gbl.gbl-hndllib:g#lib-trn :type skip       ibs.th.gbl.gbl-hndllib:g#lib-trn :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run lib-trn_crgdsdtl in g#lib-trn
  ( input buf_doc-line.obj-code
   ...
   ,input no
            ...
            if error-status:error then do:
  MESSAGE substitute("Чек &1 Бар-код &2&3Ошибка при создании признака для товара с кодом &4:&3&5&6&3Чек не будет закачан в продажу"                                , X_chk-doc.doc-code                                           , t-gds.b-code                                                 , chr(10)                                                , t-gds.gds-code                                               , error-status:get-message(1)                                  , return-value                                                 ) view-as alert-box ERROR.
              UNDO _one-check, leave _one-check.
            end.
            assign
            v-created-dtl = yes
     ...
     then do:
      ...
      if pay-gds-algo <> '' then do:
        if lookup(string(X_chk-doc.chk-type), '14,15,16,36,17,8,11,12,13,40,101,106,108,169,196,114,115,116,117,111,112,136,113,201,206,208,301,306,2,3,4,5,7,43,44':U) > 0 then do:
          ...
          if error-status:error then do:
              MESSAGE substitute("Чек &1 возникла ошибка при формировании распределения платежей. Чек не будет закачан в продажу&2&3"                                    , X_chk-doc.doc-code                                               , chr(10)                                                    , return-value                                                     ) view-as alert-box ERROR .
              undo _one-check, leave _one-check.
          end.
        end.
      end.
