...
:
  ...
  if first-of(chk-list.doc-code) then do:
  if use-column[1]
  ...
  if use-column[12]
  then  C-for-src-code:screen-value = string(chk-list.d-card, entry(1, c-for-src-code:private-data, chr(4))).
  ...
  if use-column[12]
  then (reg-output(
                    string(chk-list.d-card, entry(1, c-for-src-code:private-data, chr(4)))
  ...
  for each buf_chk-pay no-lock where
          buf_chk-pay.doc-code = chk-list.doc-code:
  ...
  if use-column[6]
  then  C-for-line-num:screen-value = string(buf_chk-pay.line-num, entry(1, c-for-line-num:private-data, chr(4))).
  if use-column[7]
  then  C-for-b-code:screen-value = string(buf_chk-pay.pay-code, entry(1, c-for-b-code:private-data, chr(4))).
  if use-column[8]
  then  C-for-artic:screen-value = string(f-paycardv(buf_chk-pay.pay-card,buf_chk-pay.pay-code,buf_chk-pay.curr-code), entry(1, c-for-artic:private-data, chr(4))).
  if use-column[9]
  then  C-for-gds-name:screen-value = string((if available buf_cash-pay then buf_cash-pay.obj-name else '':U), entry(1, c-for-gds-name:private-data, chr(4))).
  if use-column[17]
  then  C-for-price-base:screen-value = string(buf_chk-pay.tot-sum, entry(1, c-for-price-base:private-data, chr(4))).
    DISPLAY stream  PrnLibStream with frame Doc.                                      DOWN 1 stream PrnLibStream with frame Doc.
    if Make-Excel then  put   stream ForExcel unformatted
  if use-column[6]
  then (reg-output(
                    string(buf_chk-pay.line-num, entry(1, c-for-line-num:private-data, chr(4)))
  ...
  if use-column[7]
  then (reg-output(
                    string(buf_chk-pay.pay-code, entry(1, c-for-b-code:private-data, chr(4)))
  ...
  if use-column[8]
  then (reg-output(
                    string((if available buf_cash-pay then buf_cash-pay.obj-name else '':U), entry(1, c-for-artic:private-data, chr(4)))
  ...
  if use-column[9]
  then (reg-output(
                    string(f-paycardv(buf_chk-pay.pay-card,buf_chk-pay.pay-code,buf_chk-pay.curr-code), entry(1, c-for-gds-name:private-data, chr(4)))
  ...
  if use-column[17]
  then (reg-output(
                    string(buf_chk-pay.tot-sum, entry(1, c-for-price-base:private-data, chr(4)))
