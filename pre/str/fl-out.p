...
define input  parameter trn-code       like ub.trn-doc.doc-code no-undo.
...
define buffer n-d for trn-doc.
define buffer n-l for doc-line.
define buffer n-l-attr for doc-line-attr.
define buffer n-g for gds-dtl.
