...
DO:
  ...
  OPEN QUERY BR-goods FOR EACH tt-goods NO-LOCK,              EACH ub.clients WHERE            ub.clients.obj-code = tt-goods.prod-code AND            ub.clients.obj-type = tt-goods.prod-type            OUTER-JOIN NO-LOCK.    OPEN QUERY BR-parts FOR EACH ub.fin-gds-part       WHERE ub.fin-gds-part.fin-ob-code = p-fin-doc-code and ub.fin-gds-part.host-code   = p-host-code and ub.fin-gds-part.gds-code    = tt-goods.gds-code NO-LOCK.
END.
...
DO:
  OPEN QUERY BR-parts FOR EACH ub.fin-gds-part       WHERE ub.fin-gds-part.fin-ob-code = p-fin-doc-code and ub.fin-gds-part.host-code   = p-host-code and ub.fin-gds-part.gds-code    = tt-goods.gds-code NO-LOCK.
END.
...
for each buf_fin-gds-part no-lock where
  ...
  ub.fin-gds-part.part-code :read-only in browse br-parts = true .
END PROCEDURE.
...
DEFINE FRAME prt-frame
      ...
      fin-gds-part.sum-rubl  COLUMN-LABEL "Сумма(руб)" FORMAT "->,>>>,>>>,>>>,>>9.99":U
