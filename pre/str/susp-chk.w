...
PROCEDURE enable_UI :
    ...
    OPEN QUERY br-docs FOR EACH c-doc where c-doc.obj-code = parobj-code and c-doc.obj-type = parobj-type and c-doc.shift-date = parshift-date and c-doc.shift-num = parshift-num and c-doc.shift-name = parshift-name NO-LOCK INDEXED-REPOSITION.
END PROCEDURE.
PROCEDURE PrintProc :
END PROCEDURE.
