...
c-doc-line.price-rubl column-label "Уч цена(руб)"
sum-rubl (buffer c-doc-line) column-label "Сумма уч (руб)" format "->>>>>>>>>>>>>9.99"
...
c-doc-line.transport-rubl column-label "Трансп. расходы (руб)"
c-doc-line.other-base column-label "Прочие расходы (вал)"
c-doc-line.other-rubl column-label "Прочие расходы (руб)"
...
sum-sale-rubl (buffer c-gds-dtl) column-label "Сумма (руб)"
sum-dsc-rubl (buffer c-gds-dtl) column-label "Скидка (руб)"
itogo-rubl (buffer c-gds-dtl) column-label "Итого (руб)"
...
ub.c-parts.price-rubl column-label "Цена (руб)"
...
ub.c-parts.road-tax-rubl column-label "Доп. комп. (руб)"
ub.c-parts.transport-base column-label "Транспортные расходы (вал)"
ub.c-parts.transport-rubl column-label "Транспортные расходы (руб)"
ub.c-parts.other-base column-label "Прочие расходы (вал)"
ub.c-parts.other-rubl column-label "Прочие расходы (руб)"
...
END.
ON VALUE-CHANGED OF b-doc-line IN FRAME Dialog-Frame
DO:
  OPEN QUERY b-gds-dtl FOR EACH c-gds-dtl where c-gds-dtl.doc-code = c-doc-line.doc-code and c-gds-dtl.chip-num = c-doc-line.chip-num and c-gds-dtl.artic        = c-doc-line.artic        and c-gds-dtl.prod-type = c-doc-line.prod-type and c-gds-dtl.prod-code = c-doc-line.prod-code NO-LOCK ,        first gds-prt where gds-prt.node-code = c-gds-dtl.prt-code no-lock,        first bar-code where bar-code.gds-code = goods.gds-code                           and bar-code.node-code = ub.c-gds-dtl.prt-code                           and bar-code.part-code = ''                           and bar-code.in-code = ''                           and bar-code.unit-cli = goods.unit-base no-lock.
  OPEN QUERY b-parts FOR EACH c-parts where c-parts.obj-type = c-doc-line.obj-type   AND c-parts.obj-code = c-doc-line.obj-code   AND c-parts.out-code = c-doc-line.doc-code   and c-parts.chip-num = c-doc-line.chip-num   AND c-parts.artic = c-doc-line.artic   AND c-parts.prod-type = c-doc-line.prod-type   AND c-parts.prod-code = c-doc-line.prod-code NO-LOCK.
END.
ON CHOOSE OF b-Lines IN FRAME Dialog-Frame
DO:
  ...
  run str/docclins.w ( input        ParParentProc,
                   ...
                   input-output v-list              ).
END.
ON CHOOSE OF b-Petrol IN FRAME Dialog-Frame
DO:
  define variable v-list as character no-undo.
  run str/invcline.w ( input        ParParentProc,
                   ...
                   input-output v-list              ).
END.
ON CHOOSE OF b-suppcnt IN FRAME Dialog-Frame
DO:
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse b-doc-line :handle
      .
...
define variable vss-include-info7 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
  ...
  RUN enable_UI.
  assign frame Dialog-Frame:title = if ub.c-trn-doc.is-del then  "Удаленный документ: " + pardoc-code + " " + string(parchip-num)
  else "Документ: " + pardoc-code + "  :(" + string(parchip-num) + ")" .
  if not can-find (first ub.c-inv-line no-lock where ub.c-inv-line.doc-code = c-trn-doc.doc-code ) then disable b-Petrol with frame Dialog-Frame .
  if ub.c-trn-doc.ext-doc-type <> 'ie':U then do:
  ...
  if can-do ('рас,спи,возврат':U, ub.c-trn-doc.doc-type) then do:
    assign
  ...
  if ub.c-trn-doc.doc-type = 'при':U and
  ...
  display varfact-sum vardiscnt with frame Dialog-Frame.
...
END PROCEDURE.
PROCEDURE enable_UI :
  OPEN QUERY Dialog-Frame FOR EACH ub.c-trn-doc       WHERE c-trn-doc.doc-code = pardoc-code  AND c-trn-doc.chip-num = parchip-num SHARE-LOCK,       EACH ub.currency WHERE currency.curr-code = c-trn-doc.exch-code SHARE-LOCK.
  ...
  OPEN QUERY b-doc-line FOR EACH c-doc-line where c-doc-line.doc-code = pardoc-code and c-doc-line.chip-num = parchip-num NO-LOCK,        first goods where goods.artic = c-doc-line.artic and goods.prod-type = c-doc-line.prod-type and goods.prod-code = c-doc-line.prod-code no-lock.    OPEN QUERY b-gds-dtl FOR EACH c-gds-dtl where c-gds-dtl.doc-code = c-doc-line.doc-code and c-gds-dtl.chip-num = c-doc-line.chip-num and c-gds-dtl.artic        = c-doc-line.artic        and c-gds-dtl.prod-type = c-doc-line.prod-type and c-gds-dtl.prod-code = c-doc-line.prod-code NO-LOCK ,        first gds-prt where gds-prt.node-code = c-gds-dtl.prt-code no-lock,        first bar-code where bar-code.gds-code = goods.gds-code                           and bar-code.node-code = ub.c-gds-dtl.prt-code                           and bar-code.part-code = ''                           and bar-code.in-code = ''                           and bar-code.unit-cli = goods.unit-base no-lock.    OPEN QUERY b-parts FOR EACH c-parts where c-parts.obj-type = c-doc-line.obj-type   AND c-parts.obj-code = c-doc-line.obj-code   AND c-parts.out-code = c-doc-line.doc-code   and c-parts.chip-num = c-doc-line.chip-num   AND c-parts.artic = c-doc-line.artic   AND c-parts.prod-type = c-doc-line.prod-type   AND c-parts.prod-code = c-doc-line.prod-code NO-LOCK.
END PROCEDURE.
FUNCTION itogo-base RETURNS DECIMAL
...
return entry (lookup (string(local-c-parts.purch-code), '1,2,3,4':U), 'выкуп,консигнация,ответственное хранение,старая консигнация':U).
END FUNCTION.
FUNCTION priznak RETURNS character
  ( buffer local-gds-prt for gds-prt,
    buffer local-goods   for goods ) :
  RETURN (if local-gds-prt.node-name = '_Пустая шкала':U then '-' else if local-gds-prt.upper-code = local-goods.prt-root then '-------------------' else local-gds-prt.f-name).
END FUNCTION.
FUNCTION sum-base RETURNS DECIMAL
  ( buffer  local-c-doc-line for c-doc-line) :
  RETURN local-c-doc-line.price-base * local-c-doc-line.fact-qnty.
END FUNCTION.
FUNCTION sum-cli RETURNS DECIMAL
 ( buffer  local-c-doc-line for c-doc-line) :
  RETURN local-c-doc-line.price-cli * local-c-doc-line.fact-qnty.
END FUNCTION.
FUNCTION sum-dsc-base RETURNS DECIMAL
  ( buffer local-c-gds-dtl for c-gds-dtl ) :
...
FUNCTION sum-rubl RETURNS DECIMAL
 ( buffer  local-c-doc-line for c-doc-line) :
  RETURN local-c-doc-line.price-rubl * local-c-doc-line.fact-qnty.
END FUNCTION.
FUNCTION sum-sale-base RETURNS DECIMAL
  ( buffer local-c-gds-dtl for c-gds-dtl ) :
