...
then do:
  ...
  apply "value-changed" to loc-t-doc-pl.pl-code2 in frame f-doc-pl.
END.
...
DO:
  ...
  if input frame f-doc-pl loc-t-doc-pl.pl-code = ?
    or input frame f-doc-pl loc-t-doc-pl.pl-code = 0
  then do:
    message
...
END.
ON VALUE-CHANGED OF loc-t-doc-pl.pl-code2 IN FRAME f-doc-pl
DO:
...
if (valid-handle(ibs.th.gbl.gbl-hndllib:g#lib-trn) <> true) then do:   run str/lib-trn.p persistent no-error .   if error-status :error or (valid-handle(ibs.th.gbl.gbl-hndllib:g#lib-trn) <> true) then do:     message       "Error starting lib-trn.p" skip       ibs.th.gbl.gbl-hndllib:g#lib-trn skip       ibs.th.gbl.gbl-hndllib:g#lib-trn :type skip       ibs.th.gbl.gbl-hndllib:g#lib-trn :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run lib-trn_is-petrl in g#lib-trn
  ...
  if available buf-upd_tt-doc-pl then do:
    ...
    if buf_trn-doc.ext-doc-type = 'io':U then
    assign
...
def var vss-include-info23 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
  ...
  then do:
    ...
    then do:
      ...
      if buf_trn-doc.ext-doc-type = 'eo':U and buf_trn-doc.flag_ then do :
        disable
          loc-t-doc-pl.pl-code
          b-place
          loc-t-doc-pl.pl-code2
