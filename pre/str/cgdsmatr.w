...
PROCEDURE enable_UI :
  ...
  OPEN QUERY br-condkeep FOR EACH x_c-assortment-matrix-goods NO-LOCK INDEXED-REPOSITION.
END PROCEDURE.
PROCEDURE MyEnable :
ENABLE
b-quit
...
when "asmg-date-update":U then do:     create temp-changes.     assign     temp-changes.f_name = "asmg-date-update":U     temp-changes.l_name = "Дата изменения"     temp-changes.v_old = string(X_c-assortment-matrix-goods.asmg-date-update)     temp-changes.v_new = (if available new_c-assortment-matrix-goods                               then string(new_c-assortment-matrix-goods.asmg-date-update)                               else string(current_assortment-matrix-goods.asmg-date-update))     .   end.
when "asmg-db-num-update":U then do:     create temp-changes.     assign     temp-changes.f_name = "asmg-db-num-update":U     temp-changes.l_name = "БД изм"     temp-changes.v_old = string(X_c-assortment-matrix-goods.asmg-db-num-update)     temp-changes.v_new = (if available new_c-assortment-matrix-goods                               then string(new_c-assortment-matrix-goods.asmg-db-num-update)                               else string(current_assortment-matrix-goods.asmg-db-num-update))     .   end.
when "asmg-time-update":U then do:     create temp-changes.     assign     temp-changes.f_name = "asmg-time-update":U     temp-changes.l_name = "Время изменения"     temp-changes.v_old = string(X_c-assortment-matrix-goods.asmg-time-update)     temp-changes.v_new = (if available new_c-assortment-matrix-goods                               then string(new_c-assortment-matrix-goods.asmg-time-update)                               else string(current_assortment-matrix-goods.asmg-time-update))     .   end.
when "asmg-who-update":U then do:     create temp-changes.     assign     temp-changes.f_name = "asmg-who-update":U     temp-changes.l_name = "Кто"     temp-changes.v_old = string(X_c-assortment-matrix-goods.asmg-who-update)     temp-changes.v_new = (if available new_c-assortment-matrix-goods                               then string(new_c-assortment-matrix-goods.asmg-who-update)                               else string(current_assortment-matrix-goods.asmg-who-update))     .   end.
when "gds-code":U then do:     create temp-changes.     assign     temp-changes.f_name = "gds-code":U     temp-changes.l_name = "Код товара"     temp-changes.v_old = string(X_c-assortment-matrix-goods.gds-code)     temp-changes.v_new = (if available new_c-assortment-matrix-goods                               then string(new_c-assortment-matrix-goods.gds-code)                               else string(current_assortment-matrix-goods.gds-code))     .   end.
when "asmg-status":U then do:     create temp-changes.     assign     temp-changes.f_name = "asmg-status":U     temp-changes.l_name = "Статус"     temp-changes.v_old = string(X_c-assortment-matrix-goods.asmg-status)     temp-changes.v_new = (if available new_c-assortment-matrix-goods                               then string(new_c-assortment-matrix-goods.asmg-status)                               else string(current_assortment-matrix-goods.asmg-status))     .   end.
when "asmg-des":U then do:     create temp-changes.     assign     temp-changes.f_name = "asmg-des":U     temp-changes.l_name = "Описание"     temp-changes.v_old = string(X_c-assortment-matrix-goods.asmg-des)     temp-changes.v_new = (if available new_c-assortment-matrix-goods                               then string(new_c-assortment-matrix-goods.asmg-des)                               else string(current_assortment-matrix-goods.asmg-des))     .   end.
END CASE.
end.
Open QUery br-changes for each temp-changes.
END PROCEDURE.
