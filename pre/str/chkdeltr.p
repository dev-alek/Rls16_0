...
define variable vss-description as character no-undo init "Проверка возможности удаления документа, закрытого до статуса ".
...
:
  ...
  run trg/lock-gds.p
    ...
    ,input  true
    ,input  true
    ,input (if del_trn-doc.is-back-date = yes
            then 0
