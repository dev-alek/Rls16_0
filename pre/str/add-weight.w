...
define output parameter p-weight as decimal   no-undo .
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ON END-KEY UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK:
    ...
    WAIT-FOR GO OF FRAME Dialog-Frame FOCUS v-weight.
END.
RUN disable_UI.
...
PROCEDURE proc-calc :
   ...
   if available (buf_goods) then v-gds-unit:screen-value in frame Dialog-Frame = buf_goods.unit-base .
END PROCEDURE.
PROCEDURE save-proc :
