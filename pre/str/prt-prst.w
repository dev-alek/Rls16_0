...
DEFINE BROWSE b-gds-dtl
  QUERY b-gds-dtl NO-LOCK DISPLAY
      ...
      tt-gds-prt.fact-qnty + (if parmode = 'ДОБАВЛЕНИЕ':U then - tt-gds-prt.write-off-doc-qnty + tt-gds-prt.income-doc-qnty - tt-gds-prt.write-off-qnty + tt-gds-prt.income-qnty else - tt-gds-prt.write-off-qnty + tt-gds-prt.income-qnty)  @ varfree-brw-qnty FORMAT "->>,>>>,>>9.<<<" COLUMN-LABEL "Стало"
...
ASSIGN
  ...
  DISPLAY (if parmode = 'ДОБАВЛЕНИЕ':U then tt-gds-prt.fact-qnty - tt-gds-prt.write-off-doc-qnty + tt-gds-prt.income-doc-qnty - tt-gds-prt.write-off-qnty + tt-gds-prt.income-qnty else tt-gds-prt.fact-qnty - tt-gds-prt.write-off-qnty + tt-gds-prt.income-qnty) @ varfree-brw-qnty WITH browse b-gds-dtl.
END.
...
DO:
  IF AVAILABLE tt-gds-prt THEN DO:
    ...
    DISPLAY varbrw-f-name WITH FRAME Dialog-Frame.
  END.
END.
...
DO:
END.
ON return OF tt-gds-prt.write-off-qnty IN BROWSE b-gds-dtl
DO:
  APPLY "value-changed" TO BROWSE b-gds-dtl.
  RETURN NO-APPLY.
END.
ON return OF tt-gds-prt.income-qnty IN BROWSE b-gds-dtl
DO:
  APPLY "value-changed" TO BROWSE b-gds-dtl.
  RETURN NO-APPLY.
END.
ON GO OF tt-gds-prt.write-off-qnty IN BROWSE b-gds-dtl
DO:
  RETURN NO-APPLY.
END.
ON GO OF tt-gds-prt.income-qnty IN BROWSE b-gds-dtl
DO:
  RETURN NO-APPLY.
END.
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse b-gds-dtl :handle
      .
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
 ...
 ASSIGN
    frame Dialog-Frame:TITLE = "Редактирование признаков для документа пересортица " + pardoc-code + " для товара " + bf_goods.artic + " " + bf_goods.prod-type + " " + string(bf_goods.prod-code) + " " + bf_goods.gds-name.
  ...
  DISPLAY varfact-qnty WITH FRAME Dialog-Frame.
  ...
  END.
  apply "VALUE-CHANGED" to b-gds-dtl IN FRAME Dialog-Frame.
  WAIT-FOR GO OF FRAME Dialog-Frame FOCUS b-gds-dtl.
END.
RUN disable_UI.
...
DEFINE BUFFER bf_tt-gds-prt FOR tt-gds-prt.
  ...
  FOR EACH bf_tt-gds-prt ON ERROR UNDO, RETURN ERROR RETURN-VALUE :
    ASSIGN
      varwork-qnty = varwork-qnty + (if parmode = 'ДОБАВЛЕНИЕ':U then - bf_tt-gds-prt.write-off-doc-qnty + bf_tt-gds-prt.income-doc-qnty - bf_tt-gds-prt.write-off-qnty + bf_tt-gds-prt.income-qnty else - bf_tt-gds-prt.write-off-qnty + bf_tt-gds-prt.income-qnty).
  END.
  ASSIGN
    varfree-qnty = varfact-qnty + varwork-qnty.
  DISPLAY varwork-qnty varfree-qnty WITH FRAME Dialog-Frame.
END PROCEDURE.
PROCEDURE enable_UI :
  ...
  OPEN QUERY b-gds-dtl FOR EACH TT-gds-prt NO-LOCK INDEXED-REPOSITION.
END PROCEDURE.
...
IF parwrite-off THEN DO:
 FOR EACH bf_prt-obj WHERE bf_prt-obj.obj-type  = parobj-type        AND
    ...
    ASSIGN
      ...
      tt-gds-prt.write-off-qnty        = (if parmode = 'ДОБАВЛЕНИЕ':U then 0 else tt-gds-prt.write-off-doc-qnty )
      tt-gds-prt.income-qnty           = (if parmode = 'ДОБАВЛЕНИЕ':U then 0 else tt-gds-prt.income-doc-qnty    )
    .
  END.
END.
ELSE DO:
