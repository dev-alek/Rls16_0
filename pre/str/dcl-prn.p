...
CASE pReportOption:
  ...
  when "extended":U then do:
    ...
    v-labels =  "Магазин выдачи" + chr(44) +
               "Дата выдачи" + chr(44) +
               "Скидка" + chr(44) +
               "Статус" + chr(44) +
               "Эмитент" + chr(44) +
               "К карте" + chr(44) +
               "Скидка на объекте" + chr(32) + parobj-type + string(parobj-code) + chr(44) +
               "Действует по" + chr(44) +
               "Тип" + chr(44) +
               "Кредитная" + chr(44) +
               "Лимит кредита" + chr(44) +
               "Скидка на итог"
    .
...
Assign l-col-type="CHARACTER" l-col-len=16 l-col-format= "X(16)"     l-col-lable="N карты".
  ...
  define variable c-for-d-card as widget-handle no-undo.
  ...
  if use-column[1] = true then DO:
        ...
        CREATE EDITOR L-1 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-for-d-card IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME dc:HANDLE
            DATA-TYPE = "CHARACTER"
...
Assign l-col-type="CHARACTER" l-col-len=6 l-col-format= "X(3)"       l-col-lable="Клиент".
  ...
  define variable c-for-cli-type as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[2] = true then DO:
        ...
        CREATE EDITOR L-2 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-for-cli-type IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME dc:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER" l-col-len=9 l-col-format= ">>>>>>>>9"       l-col-lable="Код клиента".
  ...
  define variable c-for-cli-code as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[3] = true then DO:
        ...
        CREATE EDITOR L-3 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-for-cli-code IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME dc:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="integer"   l-col-len=5  l-col-format= "99999"  l-col-lable="Выдал магаз".
  ...
  define variable c-for-issue-code as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[5] = true then DO:
        ...
        CREATE EDITOR L-5 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-for-issue-code IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME dc:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DATE"   l-col-len=10  l-col-format= "99/99/9999"  l-col-lable="Дата выдачи".
  ...
  define variable c-for-issue-date as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[6] = true then DO:
        ...
        CREATE EDITOR L-6 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-for-issue-date IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME dc:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL"   l-col-len=7  l-col-format= "->9.99%"  l-col-lable="% Скидки".
  ...
  define variable c-for-d-pcnt as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[7] = true then DO:
        ...
        CREATE EDITOR L-7 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-for-d-pcnt IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME dc:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="CHARACTER"   l-col-len=4  l-col-format= "X(4)"  l-col-lable="Статус".
  ...
  define variable c-for-status_ as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[8] = true then DO:
        ...
        CREATE EDITOR L-8 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-for-status_ IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME dc:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER"   l-col-len=9  l-col-format= ">>>>>>>>9"  l-col-lable="Эмитент".
  ...
  define variable c-for-emitent-host-code as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[9] = true then DO:
        ...
        CREATE EDITOR L-9 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-for-emitent-host-code IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME dc:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="CHARACTER"   l-col-len=16  l-col-format= "X(16)"  l-col-lable="К карте".
  ...
  define variable c-for-sourced-card as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[10] = true then DO:
        ...
        CREATE EDITOR L-10 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-for-sourced-card IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME dc:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
.
Assign l-col-type="CHARACTER"   l-col-len=8  l-col-format= "X(8)"  l-col-lable="Скидка" + chr(32) + parobj-type + string(parobj-code).
  define variable ed11 as handle no-undo.
  define variable l-11 as handle no-undo.
  define variable ll-11 as handle no-undo.
  define variable c-for-obj-d-pcnt as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[11] = true then DO:
        ...
        CREATE EDITOR L-11 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-for-obj-d-pcnt IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME dc:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DATE"   l-col-len=10  l-col-format= "99/99/9999"  l-col-lable="Действует по".
  ...
  define variable c-for-valid-date as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[12] = true then DO:
        ...
        CREATE EDITOR L-12 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-for-valid-date IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME dc:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="CHARACTER"   l-col-len=8  l-col-format= "X(8)"  l-col-lable="Тип".
  ...
  define variable c-for-type as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[13] = true then DO:
        ...
        CREATE EDITOR L-13 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-for-type IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME dc:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="LOGICAL"   l-col-len=9  l-col-format= "+/"  l-col-lable="Кред-ная".
  ...
  define variable c-for-credit-card as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[14] = true then DO:
        ...
        CREATE EDITOR L-14 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-for-credit-card IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME dc:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL"   l-col-len=18  l-col-format= ">>>,>>>,>>>,>>9.99"  l-col-lable="Лимит кредита".
  ...
  define variable c-for-lim-kr as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[15] = true then DO:
        ...
        CREATE EDITOR L-15 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-for-lim-kr IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME dc:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="DECIMAL"   l-col-len=7  l-col-format= "->9.99%"  l-col-lable="% Ск.итог".
  ...
  define variable c-for-cash-d-pcnt as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[16] = true then DO:
        ...
        CREATE EDITOR L-16 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-for-cash-d-pcnt IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME dc:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
FOR EACH dc-list No-LOCK
  ...
  .
  for-status_ = dc-list.status_.
  FIND FIRST  ub.clients No-LOCK WHERE
        ub.clients.obj-type = dc-list.cli-type AND
        ub.clients.obj-code = dc-list.cli-code No-ERROR.
  ...
  if use-column[1]
  then  C-for-d-card:screen-value = string(dc-list.d-card, entry(1, c-for-d-card:private-data, chr(4))).
  if use-column[2]
  then  C-for-cli-type:screen-value = string(dc-list.cli-type, entry(1, c-for-cli-type:private-data, chr(4))).
  if use-column[3]
  then  C-for-cli-code:screen-value = string(dc-list.cli-code, entry(1, c-for-cli-code:private-data, chr(4))).
  if use-column[4]
  then  C-for-cli-name:screen-value = string(for-cli-name, entry(1, c-for-cli-name:private-data, chr(4))).
  if use-column[5]
  then  C-for-issue-code:screen-value = string(dc-list.issue-code, entry(1, c-for-issue-code:private-data, chr(4))).
  if use-column[6]
  then  C-for-issue-date:screen-value = string(dc-list.issue-date, entry(1, c-for-issue-date:private-data, chr(4))).
  if use-column[7]
  then  C-for-d-pcnt:screen-value = string(dc-list.d-pcnt, entry(1, c-for-d-pcnt:private-data, chr(4))).
  if use-column[8]
  then  C-for-status_:screen-value = string(for-status_, entry(1, c-for-status_:private-data, chr(4))).
  if use-column[9]
  then  C-for-emitent-host-code:screen-value = string(dc-list.emitent-host-code, entry(1, c-for-emitent-host-code:private-data, chr(4))).
  if use-column[10]
  then  C-for-sourced-card:screen-value = string(dc-list.sourced-card, entry(1, c-for-sourced-card:private-data, chr(4))).
  if use-column[11]
  then  C-for-obj-d-pcnt:screen-value = string(for-obj-d-pcnt, entry(1, c-for-obj-d-pcnt:private-data, chr(4))).
  if use-column[12]
  then  C-for-valid-date:screen-value = string(dc-list.valid-date, entry(1, c-for-valid-date:private-data, chr(4))).
  if use-column[13]
  then  C-for-type:screen-value = string(dc-list.type, entry(1, c-for-type:private-data, chr(4))).
  if use-column[14]
  then  C-for-credit-card:screen-value = string(dc-list.credit-card, entry(1, c-for-credit-card:private-data, chr(4))).
  if use-column[15]
  then  C-for-lim-kr:screen-value = string(dc-list.lim-kr, entry(1, c-for-lim-kr:private-data, chr(4))).
  if use-column[16]
  then  C-for-cash-d-pcnt:screen-value = string(dc-list.cash-d-pcnt, entry(1, c-for-cash-d-pcnt:private-data, chr(4))).
  DISPLAY stream  PrnLibStream with frame dc.                                      DOWN 1 stream PrnLibStream with frame dc.
  if Make-Excel then  put   stream ForExcel unformatted
  if use-column[1]
  then (reg-output(
                    string(dc-list.d-card, entry(1, c-for-d-card:private-data, chr(4)))
                   ,c-for-d-card:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[2]
  then (reg-output(
                    string(dc-list.cli-type, entry(1, c-for-cli-type:private-data, chr(4)))
                   ,c-for-cli-type:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[3]
  then (reg-output(
                    string(dc-list.cli-code, entry(1, c-for-cli-code:private-data, chr(4)))
                   ,c-for-cli-code:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[5]
  then (reg-output(
                    string(dc-list.issue-code, entry(1, c-for-issue-code:private-data, chr(4)))
                   ,c-for-issue-code:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[6]
  then (reg-output(
                    string(dc-list.issue-date, entry(1, c-for-issue-date:private-data, chr(4)))
                   ,c-for-issue-date:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[7]
  then (reg-output(
                    string(dc-list.d-pcnt, entry(1, c-for-d-pcnt:private-data, chr(4)))
                   ,c-for-d-pcnt:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[8]
  then (reg-output(
                    string(for-status_, entry(1, c-for-status_:private-data, chr(4)))
                   ,c-for-status_:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[9]
  then (reg-output(
                    string(dc-list.emitent-host-code, entry(1, c-for-emitent-host-code:private-data, chr(4)))
                   ,c-for-emitent-host-code:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[10]
  then (reg-output(
                    string(dc-list.sourced-card, entry(1, c-for-sourced-card:private-data, chr(4)))
                   ,c-for-sourced-card:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[11]
  then (reg-output(
                    string(for-obj-d-pcnt, entry(1, c-for-obj-d-pcnt:private-data, chr(4)))
                   ,c-for-obj-d-pcnt:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[12]
  then (reg-output(
                    string(dc-list.valid-date, entry(1, c-for-valid-date:private-data, chr(4)))
                   ,c-for-valid-date:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[13]
  then (reg-output(
                    string(dc-list.type, entry(1, c-for-type:private-data, chr(4)))
                   ,c-for-type:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[14]
  then (reg-output(
                    string(dc-list.credit-card, entry(1, c-for-credit-card:private-data, chr(4)))
                   ,c-for-credit-card:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[15]
  then (reg-output(
                    string(dc-list.lim-kr, entry(1, c-for-lim-kr:private-data, chr(4)))
                   ,c-for-lim-kr:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[16]
  then (reg-output(
                    string(dc-list.cash-d-pcnt, entry(1, c-for-cash-d-pcnt:private-data, chr(4)))
                   ,c-for-cash-d-pcnt:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  skip.
  IF LAST(dc-list.d-card) then do:
  if use-column[1]
  then  C-FOR-d-card:screen-value = string(fill16).
  if use-column[2]
  then  C-for-cli-type:screen-value = string(fill3).
  if use-column[3]
  then  C-for-cli-code:screen-value = string(fill9).
  if use-column[4]
  then  C-for-cli-name:screen-value = string(fill45).
  if use-column[5]
  then  C-for-issue-CODE:screen-value = string(fill5).
  if use-column[6]
  then  C-for-issue-date:screen-value = string(fill10).
  if use-column[7]
  then  C-for-d-pcnt:screen-value = string(fill12).
  if use-column[8]
  then  C-for-status_:screen-value = string(fill4).
  if use-column[9]
  then  C-for-emitent-host-code:screen-value = string(fill9).
  if use-column[10]
  then  C-for-sourced-card:screen-value = string(fill16).
  if use-column[11]
  then  C-for-obj-d-pcnt:screen-value = string(fill8).
  if use-column[12]
  then  C-for-valid-date:screen-value = string(fill10).
  if use-column[13]
  then  C-for-type:screen-value = string(fill8).
  if use-column[14]
  then  C-for-credit-card:screen-value = string(fill19).
  if use-column[15]
  then  C-for-lim-kr:screen-value = string(fill18).
  if use-column[16]
  then  C-for-cash-d-pcnt:screen-value = string(fill12).
        DISPLAY stream  PrnLibStream with frame dc.       DOWN 1 stream PrnLibStream with frame dc.
  if use-column[1]
  then  C-for-d-card:screen-value = string( string(accum-count) + chr(32) + 'карт в спискe', entry(1, c-for-d-card:private-data, chr(4))).
    DISPLAY stream  PrnLibStream with frame dc.                                      DOWN 1 stream PrnLibStream with frame dc.
  end.
END.
