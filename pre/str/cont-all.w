...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-37 as character no-undo .
      assign
      parameter-3-37 =
                              "FOR EACH buf_contract"
      parameter-4-37 =
        (
          if (" buf_contract.host-code  = p-host-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-37) <> ""
          then  substitute(' buf_contract.host-code = &1 and ( &3&2&3 = chr(1) or buf_contract.contract-type = &3&2&3)', p-host-code, p-contr-type, chr(34)) + " " + where-phrase-37
          else "true"
        )
      parameter-5-37 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ))
      parameter-6-37 = if sort-phrase-37 = ''
                           then
        (
        " " + "  " +
          " " + sort-column-phrase +
        " " +  substitute(' by &1 descending', buf_contract.contract-date)
        )
                           else
        (
        " " + "  " +
    ...
    :
      assign
        l-disable-where-37 =
          (" buf_contract.host-code  = p-host-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-37 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query Contr-List:handle
    ...
    output to c:\cont1.txt .
    put unformatted
      "glog = query Contr-List:handle:query-prepare (" skip
      parameter-3-37
      "where"            skip
      parameter-4-37 skip
      parameter-5-37 skip
  ...
  if l-filter-open-37 = false then do:
    OPEN QUERY Contr-List FOR EACH buf_contract
      where  buf_contract.host-code  = p-host-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)
    and ( p-mode <> "firm-curr" or ( buf_contract.contract-date-end = ? or buf_contract.contract-date-end >= today ))
       by buf_contract.contract-date descending
      indexed-reposition
  .
      assign
        l-query-was-opened = true
  ...
  on error undo, leave
  :
    if query Contr-List:handle:get-buffer-handle(1) = (buffer buf_contract:handle) then do:
      assign
      parameter-2-37 = (if p-find-next then "true":u else "false":u )
      parameter-4-37 =
        "where ":u +  substitute(' buf_contract.host-code = &1 and ( &3&2&3 = chr(1) or buf_contract.contract-type = &3&2&3)', p-host-code, p-contr-type, chr(34)) + " ":u + where-phrase-37 + " ":u + p-find-condition + " " + ""
      parameter-5-37 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query Contr-List:handle
                          ,input rowid(buf_contract)
                          ,input logical(parameter-2-37)
                          ,input no-lock
                          ,input (buffer buf_contract:handle)
                          ,input parameter-4-37
                          ,input parameter-5-37
                          ) no-error.
      .
      ...
      assign
      parameter-2-37 = (if p-find-next then "true":u else "false":u )
      parameter-3-37 =  "FOR EACH buf_contract"
      parameter-4-37 =
        (
          if (" buf_contract.host-code  = p-host-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-37) <> ""
          then  substitute(' buf_contract.host-code = &1 and ( &3&2&3 = chr(1) or buf_contract.contract-type = &3&2&3)', p-host-code, p-contr-type, chr(34)) + " " + where-phrase-37
      ...
      parameter-5-37 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ) + " " + p-find-condition)
      parameter-6-37 = if sort-phrase-37 = ''
                           then
        (
        " " + "  " +
    ...
    .
      ...
      if Agnt-Types = "sel" and Cli-Types = "all" then do:
        ...
        ASSIGN  frame Dialog-Frame:TITLE = title0 + " Исполнитель: (" + p-mngr-type + " " + string(p-mngr-code) + ")":U + chr(32) + ub.clients.obj-name .
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-39 as character no-undo .
      ...
      parameter-4-39 =
        (
          if (" buf_contract.host-code  = p-host-code and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type) " + " " + where-phrase-39) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.mngr-code = &2 and ( &4&3&4 = chr(1) or buf_contract.contract-type = &4&3&4)', p-host-code, p-mngr-code, p-contr-type, chr(34)) + " " + where-phrase-39
          else "true"
        )
      parameter-5-39 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ))
    ...
    :
      assign
        l-disable-where-39 =
          (" buf_contract.host-code  = p-host-code and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type) " + " " + where-phrase-39 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query Contr-List:handle
  ...
  if l-filter-open-39 = false then do:
    OPEN QUERY Contr-List FOR EACH buf_contract
      where  buf_contract.host-code  = p-host-code and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)
    and ( p-mode <> "firm-curr" or ( buf_contract.contract-date-end = ? or buf_contract.contract-date-end >= today ))
       by buf_contract.contract-date descending
      indexed-reposition
  .
  ...
  :
    if query Contr-List:handle:get-buffer-handle(1) = (buffer buf_contract:handle) then do:
      ...
      parameter-4-39 =
        "where ":u +  substitute(' buf_contract.host-code = &1 and buf_contract.mngr-code = &2 and ( &4&3&4 = chr(1) or buf_contract.contract-type = &4&3&4)', p-host-code, p-mngr-code, p-contr-type, chr(34)) + " ":u + where-phrase-39 + " ":u + p-find-condition + " " + ""
      parameter-5-39 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-39 = (if p-find-next then "true":u else "false":u )
      parameter-3-39 =  "FOR EACH buf_contract"
      parameter-4-39 =
        (
          if (" buf_contract.host-code  = p-host-code and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type) " + " " + where-phrase-39) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.mngr-code = &2 and ( &4&3&4 = chr(1) or buf_contract.contract-type = &4&3&4)', p-host-code, p-mngr-code, p-contr-type, chr(34)) + " " + where-phrase-39
      ...
      parameter-5-39 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ) + " " + p-find-condition)
      parameter-6-39 = if sort-phrase-39 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-41 as character no-undo .
      ...
      parameter-4-41 =
        (
          if (" buf_contract.host-code  = p-host-code and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-41) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.cli-type = &5&2&5 and buf_contract.cli-code = &3 and ( &5&4&5 = chr(1) or buf_contract.contract-type = &5&4&5)', p-host-code, p-cli-type, p-cli-code, p-contr-type, chr(34)) + " " + where-phrase-41
          else "true"
        )
      parameter-5-41 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ))
    ...
    :
      assign
        l-disable-where-41 =
          (" buf_contract.host-code  = p-host-code and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-41 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query Contr-List:handle
  ...
  if l-filter-open-41 = false then do:
    OPEN QUERY Contr-List FOR EACH buf_contract
      where  buf_contract.host-code  = p-host-code and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)
    and ( p-mode <> "firm-curr" or ( buf_contract.contract-date-end = ? or buf_contract.contract-date-end >= today ))
       by buf_contract.contract-date descending
      indexed-reposition
  .
  ...
  :
    if query Contr-List:handle:get-buffer-handle(1) = (buffer buf_contract:handle) then do:
      ...
      parameter-4-41 =
        "where ":u +  substitute(' buf_contract.host-code = &1 and buf_contract.cli-type = &5&2&5 and buf_contract.cli-code = &3 and ( &5&4&5 = chr(1) or buf_contract.contract-type = &5&4&5)', p-host-code, p-cli-type, p-cli-code, p-contr-type, chr(34)) + " ":u + where-phrase-41 + " ":u + p-find-condition + " " + ""
      parameter-5-41 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-41 = (if p-find-next then "true":u else "false":u )
      parameter-3-41 =  "FOR EACH buf_contract"
      parameter-4-41 =
        (
          if (" buf_contract.host-code  = p-host-code and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-41) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.cli-type = &5&2&5 and buf_contract.cli-code = &3 and ( &5&4&5 = chr(1) or buf_contract.contract-type = &5&4&5)', p-host-code, p-cli-type, p-cli-code, p-contr-type, chr(34)) + " " + where-phrase-41
      ...
      parameter-5-41 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ) + " " + p-find-condition)
      parameter-6-41 = if sort-phrase-41 = ''
                           then
        (
        " " + "  " +
    ...
    .
      ...
      if Agnt-Types = "sel" and Cli-Types = "sel" then do:
        find first ub.clients no-lock where ub.clients.obj-type = p-cli-type and ub.clients.obj-code = p-cli-code .
        ASSIGN  title0 = title0 + " Контрагент: (" + p-cli-type + " " + string(p-cli-code) + ")":U + chr(32) + ub.clients.obj-name .
        find first ub.clients no-lock where ub.clients.obj-type = p-mngr-type and ub.clients.obj-code = p-mngr-code .
        ASSIGN  frame Dialog-Frame:TITLE = title0 + " Исполнитель: (" + p-mngr-type + " " + string(p-mngr-code) + ")":U + chr(32) + ub.clients.obj-name .
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-43 as character no-undo .
      ...
      parameter-4-43 =
        (
          if (" buf_contract.host-code = p-host-code and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type) " + " " + where-phrase-43) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.cli-type = &6&2&6 and buf_contract.cli-code = &3 and buf_contract.mngr-code = &4 and ( &6&5&6 = chr(1) or buf_contract.contract-type = &6&5&6)', p-host-code, p-cli-type, p-cli-code, p-mngr-code, p-contr-type, chr(34)) + " " + where-phrase-43
          else "true"
        )
      parameter-5-43 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ))
    ...
    :
      assign
        l-disable-where-43 =
          (" buf_contract.host-code = p-host-code and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type) " + " " + where-phrase-43 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query Contr-List:handle
  ...
  if l-filter-open-43 = false then do:
    OPEN QUERY Contr-List FOR EACH buf_contract
      where  buf_contract.host-code = p-host-code and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)
    and ( p-mode <> "firm-curr" or ( buf_contract.contract-date-end = ? or buf_contract.contract-date-end >= today ))
       by buf_contract.contract-date descending
      indexed-reposition
  .
  ...
  :
    if query Contr-List:handle:get-buffer-handle(1) = (buffer buf_contract:handle) then do:
      ...
      parameter-4-43 =
        "where ":u +  substitute(' buf_contract.host-code = &1 and buf_contract.cli-type = &6&2&6 and buf_contract.cli-code = &3 and buf_contract.mngr-code = &4 and ( &6&5&6 = chr(1) or buf_contract.contract-type = &6&5&6)', p-host-code, p-cli-type, p-cli-code, p-mngr-code, p-contr-type, chr(34)) + " ":u + where-phrase-43 + " ":u + p-find-condition + " " + ""
      parameter-5-43 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-43 = (if p-find-next then "true":u else "false":u )
      parameter-3-43 =  "FOR EACH buf_contract"
      parameter-4-43 =
        (
          if (" buf_contract.host-code = p-host-code and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type) " + " " + where-phrase-43) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.cli-type = &6&2&6 and buf_contract.cli-code = &3 and buf_contract.mngr-code = &4 and ( &6&5&6 = chr(1) or buf_contract.contract-type = &6&5&6)', p-host-code, p-cli-type, p-cli-code, p-mngr-code, p-contr-type, chr(34)) + " " + where-phrase-43
      ...
      parameter-5-43 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ) + " " + p-find-condition)
      parameter-6-43 = if sort-phrase-43 = ''
                           then
        (
        " " + "  " +
    ...
    when "current" or when "deleted" then do:
      if Agnt-Types = "all" and Cli-Types = "all" then do:
        ASSIGN  frame Dialog-Frame:TITLE = title0 .
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-45 as character no-undo .
      ...
      parameter-4-45 =
        (
          if (" buf_contract.host-code = p-host-code and buf_contract.status_ = p-status and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-45) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.status_ = &4&2&4 and ( &4&3&4 = chr(1) or buf_contract.contract-type = &4&3&4)', p-host-code, p-status, p-contr-type, chr(34)) + " " + where-phrase-45
          else "true"
        )
      parameter-5-45 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ))
    ...
    :
      assign
        l-disable-where-45 =
          (" buf_contract.host-code = p-host-code and buf_contract.status_ = p-status and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-45 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query Contr-List:handle
  ...
  if l-filter-open-45 = false then do:
    OPEN QUERY Contr-List FOR EACH buf_contract
      where  buf_contract.host-code = p-host-code and buf_contract.status_ = p-status and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)
    and ( p-mode <> "firm-curr" or ( buf_contract.contract-date-end = ? or buf_contract.contract-date-end >= today ))
      indexed-reposition
  .
      assign
  ...
  :
    if query Contr-List:handle:get-buffer-handle(1) = (buffer buf_contract:handle) then do:
      ...
      parameter-4-45 =
        "where ":u +  substitute(' buf_contract.host-code = &1 and buf_contract.status_ = &4&2&4 and ( &4&3&4 = chr(1) or buf_contract.contract-type = &4&3&4)', p-host-code, p-status, p-contr-type, chr(34)) + " ":u + where-phrase-45 + " ":u + p-find-condition + " " + ""
      parameter-5-45 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-45 = (if p-find-next then "true":u else "false":u )
      parameter-3-45 =  "FOR EACH buf_contract"
      parameter-4-45 =
        (
          if (" buf_contract.host-code = p-host-code and buf_contract.status_ = p-status and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-45) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.status_ = &4&2&4 and ( &4&3&4 = chr(1) or buf_contract.contract-type = &4&3&4)', p-host-code, p-status, p-contr-type, chr(34)) + " " + where-phrase-45
      ...
      parameter-5-45 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ) + " " + p-find-condition)
      parameter-6-45 = if sort-phrase-45 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-47 as character no-undo .
      ...
      parameter-4-47 =
        (
          if (" buf_contract.host-code  = p-host-code and buf_contract.status_ = p-status  and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-47) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.status_ = &5&2&5 and buf_contract.mngr-code = &3 and ( &5&4&5 = chr(1) or buf_contract.contract-type = &5&4&5)', p-host-code, p-status, p-mngr-code, p-contr-type, chr(34)) + " " + where-phrase-47
          else "true"
        )
      parameter-5-47 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ))
    ...
    :
      assign
        l-disable-where-47 =
          (" buf_contract.host-code  = p-host-code and buf_contract.status_ = p-status  and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-47 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query Contr-List:handle
  ...
  if l-filter-open-47 = false then do:
    OPEN QUERY Contr-List FOR EACH buf_contract
      where  buf_contract.host-code  = p-host-code and buf_contract.status_ = p-status  and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)
    and ( p-mode <> "firm-curr" or ( buf_contract.contract-date-end = ? or buf_contract.contract-date-end >= today ))
      indexed-reposition
  .
      assign
  ...
  :
    if query Contr-List:handle:get-buffer-handle(1) = (buffer buf_contract:handle) then do:
      ...
      parameter-4-47 =
        "where ":u +  substitute(' buf_contract.host-code = &1 and buf_contract.status_ = &5&2&5 and buf_contract.mngr-code = &3 and ( &5&4&5 = chr(1) or buf_contract.contract-type = &5&4&5)', p-host-code, p-status, p-mngr-code, p-contr-type, chr(34)) + " ":u + where-phrase-47 + " ":u + p-find-condition + " " + ""
      parameter-5-47 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-47 = (if p-find-next then "true":u else "false":u )
      parameter-3-47 =  "FOR EACH buf_contract"
      parameter-4-47 =
        (
          if (" buf_contract.host-code  = p-host-code and buf_contract.status_ = p-status  and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-47) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.status_ = &5&2&5 and buf_contract.mngr-code = &3 and ( &5&4&5 = chr(1) or buf_contract.contract-type = &5&4&5)', p-host-code, p-status, p-mngr-code, p-contr-type, chr(34)) + " " + where-phrase-47
      ...
      parameter-5-47 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ) + " " + p-find-condition)
      parameter-6-47 = if sort-phrase-47 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-49 as character no-undo .
      ...
      parameter-4-49 =
        (
          if (" buf_contract.host-code  = p-host-code and buf_contract.status_ = p-status  and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-49) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.status_ = &6&2&6 and buf_contract.cli-type = &6&3&6 and buf_contract.cli-code = &4 and ( &6&5&6 = chr(1) or buf_contract.contract-type = &6&5&6)', p-host-code, p-status, p-cli-type, p-cli-code, p-contr-type, chr(34)) + " " + where-phrase-49
          else "true"
        )
      parameter-5-49 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ))
    ...
    :
      assign
        l-disable-where-49 =
          (" buf_contract.host-code  = p-host-code and buf_contract.status_ = p-status  and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-49 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query Contr-List:handle
  ...
  if l-filter-open-49 = false then do:
    OPEN QUERY Contr-List FOR EACH buf_contract
      where  buf_contract.host-code  = p-host-code and buf_contract.status_ = p-status  and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)
    and ( p-mode <> "firm-curr" or ( buf_contract.contract-date-end = ? or buf_contract.contract-date-end >= today ))
      indexed-reposition
  .
      assign
  ...
  :
    if query Contr-List:handle:get-buffer-handle(1) = (buffer buf_contract:handle) then do:
      ...
      parameter-4-49 =
        "where ":u +  substitute(' buf_contract.host-code = &1 and buf_contract.status_ = &6&2&6 and buf_contract.cli-type = &6&3&6 and buf_contract.cli-code = &4 and ( &6&5&6 = chr(1) or buf_contract.contract-type = &6&5&6)', p-host-code, p-status, p-cli-type, p-cli-code, p-contr-type, chr(34)) + " ":u + where-phrase-49 + " ":u + p-find-condition + " " + ""
      parameter-5-49 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-49 = (if p-find-next then "true":u else "false":u )
      parameter-3-49 =  "FOR EACH buf_contract"
      parameter-4-49 =
        (
          if (" buf_contract.host-code  = p-host-code and buf_contract.status_ = p-status  and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-49) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.status_ = &6&2&6 and buf_contract.cli-type = &6&3&6 and buf_contract.cli-code = &4 and ( &6&5&6 = chr(1) or buf_contract.contract-type = &6&5&6)', p-host-code, p-status, p-cli-type, p-cli-code, p-contr-type, chr(34)) + " " + where-phrase-49
      ...
      parameter-5-49 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ) + " " + p-find-condition)
      parameter-6-49 = if sort-phrase-49 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-51 as character no-undo .
      ...
      parameter-4-51 =
        (
          if (" buf_contract.host-code = p-host-code and buf_contract.status_ = p-status  and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-51) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.status_ = &7&2&7 and buf_contract.cli-type = &7&3&7 and buf_contract.cli-code = &4 and buf_contract.mngr-code = &5 and ( &7&6&7 = chr(1) or buf_contract.contract-type = &7&6&7)', p-host-code, p-status, p-cli-type, p-cli-code, p-mngr-code, p-contr-type, chr(34)) + " " + where-phrase-51
          else "true"
        )
      parameter-5-51 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ))
    ...
    :
      assign
        l-disable-where-51 =
          (" buf_contract.host-code = p-host-code and buf_contract.status_ = p-status  and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-51 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query Contr-List:handle
  ...
  if l-filter-open-51 = false then do:
    OPEN QUERY Contr-List FOR EACH buf_contract
      where  buf_contract.host-code = p-host-code and buf_contract.status_ = p-status  and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)
    and ( p-mode <> "firm-curr" or ( buf_contract.contract-date-end = ? or buf_contract.contract-date-end >= today ))
      indexed-reposition
  .
      assign
  ...
  :
    if query Contr-List:handle:get-buffer-handle(1) = (buffer buf_contract:handle) then do:
      ...
      parameter-4-51 =
        "where ":u +  substitute(' buf_contract.host-code = &1 and buf_contract.status_ = &7&2&7 and buf_contract.cli-type = &7&3&7 and buf_contract.cli-code = &4 and buf_contract.mngr-code = &5 and ( &7&6&7 = chr(1) or buf_contract.contract-type = &7&6&7)', p-host-code, p-status, p-cli-type, p-cli-code, p-mngr-code, p-contr-type, chr(34)) + " ":u + where-phrase-51 + " ":u + p-find-condition + " " + ""
      parameter-5-51 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-51 = (if p-find-next then "true":u else "false":u )
      parameter-3-51 =  "FOR EACH buf_contract"
      parameter-4-51 =
        (
          if (" buf_contract.host-code = p-host-code and buf_contract.status_ = p-status  and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-51) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.status_ = &7&2&7 and buf_contract.cli-type = &7&3&7 and buf_contract.cli-code = &4 and buf_contract.mngr-code = &5 and ( &7&6&7 = chr(1) or buf_contract.contract-type = &7&6&7)', p-host-code, p-status, p-cli-type, p-cli-code, p-mngr-code, p-contr-type, chr(34)) + " " + where-phrase-51
      ...
      parameter-5-51 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ) + " " + p-find-condition)
      parameter-6-51 = if sort-phrase-51 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-55 as character no-undo .
      ...
      parameter-4-55 =
        (
          if (" buf_contract.host-code = p-host-code and buf_contract.doc-type = p-doc-type and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-55) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.doc-type = &4&2&4 and ( &4&3&4 = chr(1) or buf_contract.contract-type = &4&3&4)', p-host-code, p-doc-type, p-contr-type, chr(34)) + " " + where-phrase-55
          else "true"
        )
      parameter-5-55 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ))
    ...
    :
      assign
        l-disable-where-55 =
          (" buf_contract.host-code = p-host-code and buf_contract.doc-type = p-doc-type and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-55 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query Contr-List:handle
  ...
  if l-filter-open-55 = false then do:
    OPEN QUERY Contr-List FOR EACH buf_contract
      where  buf_contract.host-code = p-host-code and buf_contract.doc-type = p-doc-type and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)
    and ( p-mode <> "firm-curr" or ( buf_contract.contract-date-end = ? or buf_contract.contract-date-end >= today ))
       by buf_contract.contract-date descending
      indexed-reposition
  .
  ...
  :
    if query Contr-List:handle:get-buffer-handle(1) = (buffer buf_contract:handle) then do:
      ...
      parameter-4-55 =
        "where ":u +  substitute(' buf_contract.host-code = &1 and buf_contract.doc-type = &4&2&4 and ( &4&3&4 = chr(1) or buf_contract.contract-type = &4&3&4)', p-host-code, p-doc-type, p-contr-type, chr(34)) + " ":u + where-phrase-55 + " ":u + p-find-condition + " " + ""
      parameter-5-55 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-55 = (if p-find-next then "true":u else "false":u )
      parameter-3-55 =  "FOR EACH buf_contract"
      parameter-4-55 =
        (
          if (" buf_contract.host-code = p-host-code and buf_contract.doc-type = p-doc-type and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-55) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.doc-type = &4&2&4 and ( &4&3&4 = chr(1) or buf_contract.contract-type = &4&3&4)', p-host-code, p-doc-type, p-contr-type, chr(34)) + " " + where-phrase-55
      ...
      parameter-5-55 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ) + " " + p-find-condition)
      parameter-6-55 = if sort-phrase-55 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-57 as character no-undo .
      ...
      parameter-4-57 =
        (
          if (" buf_contract.host-code = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-57) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.doc-type = &5&2&5 and buf_contract.mngr-code = &3 and ( &5&4&5 = chr(1) or buf_contract.contract-type = &5&4&5)', p-host-code, p-doc-type, p-mngr-code, p-contr-type, chr(34)) + " " + where-phrase-57
          else "true"
        )
      parameter-5-57 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ))
    ...
    :
      assign
        l-disable-where-57 =
          (" buf_contract.host-code = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-57 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query Contr-List:handle
  ...
  if l-filter-open-57 = false then do:
    OPEN QUERY Contr-List FOR EACH buf_contract
      where  buf_contract.host-code = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)
    and ( p-mode <> "firm-curr" or ( buf_contract.contract-date-end = ? or buf_contract.contract-date-end >= today ))
       by buf_contract.contract-date descending
      indexed-reposition
  .
  ...
  :
    if query Contr-List:handle:get-buffer-handle(1) = (buffer buf_contract:handle) then do:
      ...
      parameter-4-57 =
        "where ":u +  substitute(' buf_contract.host-code = &1 and buf_contract.doc-type = &5&2&5 and buf_contract.mngr-code = &3 and ( &5&4&5 = chr(1) or buf_contract.contract-type = &5&4&5)', p-host-code, p-doc-type, p-mngr-code, p-contr-type, chr(34)) + " ":u + where-phrase-57 + " ":u + p-find-condition + " " + ""
      parameter-5-57 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-57 = (if p-find-next then "true":u else "false":u )
      parameter-3-57 =  "FOR EACH buf_contract"
      parameter-4-57 =
        (
          if (" buf_contract.host-code = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-57) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.doc-type = &5&2&5 and buf_contract.mngr-code = &3 and ( &5&4&5 = chr(1) or buf_contract.contract-type = &5&4&5)', p-host-code, p-doc-type, p-mngr-code, p-contr-type, chr(34)) + " " + where-phrase-57
      ...
      parameter-5-57 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ) + " " + p-find-condition)
      parameter-6-57 = if sort-phrase-57 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-59 as character no-undo .
      ...
      parameter-4-59 =
        (
          if (" buf_contract.host-code = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-59) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.doc-type = &6&2&6 and buf_contract.cli-type = &6&3&6 and buf_contract.cli-code = &4 and ( &6&5&6 = chr(1) or buf_contract.contract-type = &6&5&6)', p-host-code, p-doc-type, p-cli-type, p-cli-code, p-contr-type, chr(34)) + " " + where-phrase-59
          else "true"
        )
      parameter-5-59 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ))
    ...
    :
      assign
        l-disable-where-59 =
          (" buf_contract.host-code = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-59 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query Contr-List:handle
  ...
  if l-filter-open-59 = false then do:
    OPEN QUERY Contr-List FOR EACH buf_contract
      where  buf_contract.host-code = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)
    and ( p-mode <> "firm-curr" or ( buf_contract.contract-date-end = ? or buf_contract.contract-date-end >= today ))
       by buf_contract.contract-date descending
      indexed-reposition
  .
  ...
  :
    if query Contr-List:handle:get-buffer-handle(1) = (buffer buf_contract:handle) then do:
      ...
      parameter-4-59 =
        "where ":u +  substitute(' buf_contract.host-code = &1 and buf_contract.doc-type = &6&2&6 and buf_contract.cli-type = &6&3&6 and buf_contract.cli-code = &4 and ( &6&5&6 = chr(1) or buf_contract.contract-type = &6&5&6)', p-host-code, p-doc-type, p-cli-type, p-cli-code, p-contr-type, chr(34)) + " ":u + where-phrase-59 + " ":u + p-find-condition + " " + ""
      parameter-5-59 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-59 = (if p-find-next then "true":u else "false":u )
      parameter-3-59 =  "FOR EACH buf_contract"
      parameter-4-59 =
        (
          if (" buf_contract.host-code = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-59) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.doc-type = &6&2&6 and buf_contract.cli-type = &6&3&6 and buf_contract.cli-code = &4 and ( &6&5&6 = chr(1) or buf_contract.contract-type = &6&5&6)', p-host-code, p-doc-type, p-cli-type, p-cli-code, p-contr-type, chr(34)) + " " + where-phrase-59
      ...
      parameter-5-59 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ) + " " + p-find-condition)
      parameter-6-59 = if sort-phrase-59 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-61 as character no-undo .
      ...
      parameter-4-61 =
        (
          if (" buf_contract.host-code = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-61) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.doc-type = &7&2&7 and buf_contract.cli-type = &7&3&7 and buf_contract.cli-code = &4 and buf_contract.mngr-code = &5 and ( &7&6&7 = chr(1) or buf_contract.contract-type = &7&6&7)', p-host-code, p-doc-type, p-cli-type, p-cli-code, p-mngr-code, p-contr-type, chr(34)) + " " + where-phrase-61
          else "true"
        )
      parameter-5-61 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ))
    ...
    :
      assign
        l-disable-where-61 =
          (" buf_contract.host-code = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-61 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query Contr-List:handle
  ...
  if l-filter-open-61 = false then do:
    OPEN QUERY Contr-List FOR EACH buf_contract
      where  buf_contract.host-code = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)
    and ( p-mode <> "firm-curr" or ( buf_contract.contract-date-end = ? or buf_contract.contract-date-end >= today ))
       by buf_contract.contract-date descending
      indexed-reposition
  .
  ...
  :
    if query Contr-List:handle:get-buffer-handle(1) = (buffer buf_contract:handle) then do:
      ...
      parameter-4-61 =
        "where ":u +  substitute(' buf_contract.host-code = &1 and buf_contract.doc-type = &7&2&7 and buf_contract.cli-type = &7&3&7 and buf_contract.cli-code = &4 and buf_contract.mngr-code = &5 and ( &7&6&7 = chr(1) or buf_contract.contract-type = &7&6&7)', p-host-code, p-doc-type, p-cli-type, p-cli-code, p-mngr-code, p-contr-type, chr(34)) + " ":u + where-phrase-61 + " ":u + p-find-condition + " " + ""
      parameter-5-61 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-61 = (if p-find-next then "true":u else "false":u )
      parameter-3-61 =  "FOR EACH buf_contract"
      parameter-4-61 =
        (
          if (" buf_contract.host-code = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-61) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.doc-type = &7&2&7 and buf_contract.cli-type = &7&3&7 and buf_contract.cli-code = &4 and buf_contract.mngr-code = &5 and ( &7&6&7 = chr(1) or buf_contract.contract-type = &7&6&7)', p-host-code, p-doc-type, p-cli-type, p-cli-code, p-mngr-code, p-contr-type, chr(34)) + " " + where-phrase-61
      ...
      parameter-5-61 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ) + " " + p-find-condition)
      parameter-6-61 = if sort-phrase-61 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-63 as character no-undo .
      ...
      parameter-4-63 =
        (
          if (" buf_contract.host-code = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.status_ = p-status and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-63) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.doc-type = &5&2&5 and buf_contract.status_ = &5&3&5 and ( &5&4&5 = chr(1) or buf_contract.contract-type = &5&4&5)', p-host-code, p-doc-type, p-status, p-contr-type , chr(34) ) + " " + where-phrase-63
          else "true"
        )
      parameter-5-63 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ))
    ...
    :
      assign
        l-disable-where-63 =
          (" buf_contract.host-code = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.status_ = p-status and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-63 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query Contr-List:handle
  ...
  if l-filter-open-63 = false then do:
    OPEN QUERY Contr-List FOR EACH buf_contract
      where  buf_contract.host-code = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.status_ = p-status and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)
    and ( p-mode <> "firm-curr" or ( buf_contract.contract-date-end = ? or buf_contract.contract-date-end >= today ))
      indexed-reposition
  .
      assign
  ...
  :
    if query Contr-List:handle:get-buffer-handle(1) = (buffer buf_contract:handle) then do:
      ...
      parameter-4-63 =
        "where ":u +  substitute(' buf_contract.host-code = &1 and buf_contract.doc-type = &5&2&5 and buf_contract.status_ = &5&3&5 and ( &5&4&5 = chr(1) or buf_contract.contract-type = &5&4&5)', p-host-code, p-doc-type, p-status, p-contr-type , chr(34) ) + " ":u + where-phrase-63 + " ":u + p-find-condition + " " + ""
      parameter-5-63 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-63 = (if p-find-next then "true":u else "false":u )
      parameter-3-63 =  "FOR EACH buf_contract"
      parameter-4-63 =
        (
          if (" buf_contract.host-code = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.status_ = p-status and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-63) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.doc-type = &5&2&5 and buf_contract.status_ = &5&3&5 and ( &5&4&5 = chr(1) or buf_contract.contract-type = &5&4&5)', p-host-code, p-doc-type, p-status, p-contr-type , chr(34) ) + " " + where-phrase-63
      ...
      parameter-5-63 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ) + " " + p-find-condition)
      parameter-6-63 = if sort-phrase-63 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-65 as character no-undo .
      ...
      parameter-4-65 =
        (
          if (" buf_contract.host-code  = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.status_ = p-status  and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-65) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.doc-type = &6&2&6 and buf_contract.status_ = &6&3&6 and buf_contract.mngr-code = &4 and ( &6&5&6 = chr(1) or buf_contract.contract-type = &6&5&6)', p-host-code, p-doc-type, p-status, p-mngr-code, p-contr-type, chr(34)) + " " + where-phrase-65
          else "true"
        )
      parameter-5-65 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ))
    ...
    :
      assign
        l-disable-where-65 =
          (" buf_contract.host-code  = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.status_ = p-status  and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-65 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query Contr-List:handle
  ...
  if l-filter-open-65 = false then do:
    OPEN QUERY Contr-List FOR EACH buf_contract
      where  buf_contract.host-code  = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.status_ = p-status  and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)
    and ( p-mode <> "firm-curr" or ( buf_contract.contract-date-end = ? or buf_contract.contract-date-end >= today ))
      indexed-reposition
  .
      assign
  ...
  :
    if query Contr-List:handle:get-buffer-handle(1) = (buffer buf_contract:handle) then do:
      ...
      parameter-4-65 =
        "where ":u +  substitute(' buf_contract.host-code = &1 and buf_contract.doc-type = &6&2&6 and buf_contract.status_ = &6&3&6 and buf_contract.mngr-code = &4 and ( &6&5&6 = chr(1) or buf_contract.contract-type = &6&5&6)', p-host-code, p-doc-type, p-status, p-mngr-code, p-contr-type, chr(34)) + " ":u + where-phrase-65 + " ":u + p-find-condition + " " + ""
      parameter-5-65 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-65 = (if p-find-next then "true":u else "false":u )
      parameter-3-65 =  "FOR EACH buf_contract"
      parameter-4-65 =
        (
          if (" buf_contract.host-code  = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.status_ = p-status  and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-65) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.doc-type = &6&2&6 and buf_contract.status_ = &6&3&6 and buf_contract.mngr-code = &4 and ( &6&5&6 = chr(1) or buf_contract.contract-type = &6&5&6)', p-host-code, p-doc-type, p-status, p-mngr-code, p-contr-type, chr(34)) + " " + where-phrase-65
      ...
      parameter-5-65 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ) + " " + p-find-condition)
      parameter-6-65 = if sort-phrase-65 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-67 as character no-undo .
      ...
      parameter-4-67 =
        (
          if (" buf_contract.host-code  = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.status_ = p-status  and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-67) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.doc-type = &7&2&7 and buf_contract.status_ = &7&3&7 and buf_contract.cli-type = &7&4&7 and buf_contract.cli-code = &5 and ( &7&6&7 = chr(1) or buf_contract.contract-type = &7&6&7)', p-host-code, p-doc-type, p-status, p-cli-type, p-cli-code, p-contr-type, chr(34)) + " " + where-phrase-67
          else "true"
        )
      parameter-5-67 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ))
    ...
    :
      assign
        l-disable-where-67 =
          (" buf_contract.host-code  = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.status_ = p-status  and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-67 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query Contr-List:handle
  ...
  if l-filter-open-67 = false then do:
    OPEN QUERY Contr-List FOR EACH buf_contract
      where  buf_contract.host-code  = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.status_ = p-status  and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)
    and ( p-mode <> "firm-curr" or ( buf_contract.contract-date-end = ? or buf_contract.contract-date-end >= today ))
      indexed-reposition
  .
      assign
  ...
  :
    if query Contr-List:handle:get-buffer-handle(1) = (buffer buf_contract:handle) then do:
      ...
      parameter-4-67 =
        "where ":u +  substitute(' buf_contract.host-code = &1 and buf_contract.doc-type = &7&2&7 and buf_contract.status_ = &7&3&7 and buf_contract.cli-type = &7&4&7 and buf_contract.cli-code = &5 and ( &7&6&7 = chr(1) or buf_contract.contract-type = &7&6&7)', p-host-code, p-doc-type, p-status, p-cli-type, p-cli-code, p-contr-type, chr(34)) + " ":u + where-phrase-67 + " ":u + p-find-condition + " " + ""
      parameter-5-67 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-67 = (if p-find-next then "true":u else "false":u )
      parameter-3-67 =  "FOR EACH buf_contract"
      parameter-4-67 =
        (
          if (" buf_contract.host-code  = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.status_ = p-status  and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-67) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.doc-type = &7&2&7 and buf_contract.status_ = &7&3&7 and buf_contract.cli-type = &7&4&7 and buf_contract.cli-code = &5 and ( &7&6&7 = chr(1) or buf_contract.contract-type = &7&6&7)', p-host-code, p-doc-type, p-status, p-cli-type, p-cli-code, p-contr-type, chr(34)) + " " + where-phrase-67
      ...
      parameter-5-67 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ) + " " + p-find-condition)
      parameter-6-67 = if sort-phrase-67 = ''
                           then
        (
        " " + "  " +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-69 as character no-undo .
      ...
      parameter-4-69 =
        (
          if (" buf_contract.host-code = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.status_ = p-status  and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-69) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.doc-type = &8&2&8 and buf_contract.status_ = &8&3&8 and buf_contract.cli-type = &8&4&8 and buf_contract.cli-code = &5 and buf_contract.mngr-code = &6 and ( &8&7&8 = chr(1) or buf_contract.contract-type = &8&7&8)', p-host-code, p-doc-type, p-status, p-cli-type, p-cli-code, p-mngr-code, p-contr-type, chr(34)) + " " + where-phrase-69
          else "true"
        )
      parameter-5-69 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ))
    ...
    :
      assign
        l-disable-where-69 =
          (" buf_contract.host-code = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.status_ = p-status  and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-69 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query Contr-List:handle
  ...
  if l-filter-open-69 = false then do:
    OPEN QUERY Contr-List FOR EACH buf_contract
      where  buf_contract.host-code = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.status_ = p-status  and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)
    and ( p-mode <> "firm-curr" or ( buf_contract.contract-date-end = ? or buf_contract.contract-date-end >= today ))
      indexed-reposition
  .
      assign
  ...
  :
    if query Contr-List:handle:get-buffer-handle(1) = (buffer buf_contract:handle) then do:
      ...
      parameter-4-69 =
        "where ":u +  substitute(' buf_contract.host-code = &1 and buf_contract.doc-type = &8&2&8 and buf_contract.status_ = &8&3&8 and buf_contract.cli-type = &8&4&8 and buf_contract.cli-code = &5 and buf_contract.mngr-code = &6 and ( &8&7&8 = chr(1) or buf_contract.contract-type = &8&7&8)', p-host-code, p-doc-type, p-status, p-cli-type, p-cli-code, p-mngr-code, p-contr-type, chr(34)) + " ":u + where-phrase-69 + " ":u + p-find-condition + " " + ""
      parameter-5-69 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-69 = (if p-find-next then "true":u else "false":u )
      parameter-3-69 =  "FOR EACH buf_contract"
      parameter-4-69 =
        (
          if (" buf_contract.host-code = p-host-code and buf_contract.doc-type = p-doc-type and buf_contract.status_ = p-status  and buf_contract.cli-type = p-cli-type and buf_contract.cli-code = p-cli-code and buf_contract.mngr-code = p-mngr-code and ( p-contr-type = chr(1) or buf_contract.contract-type = p-contr-type)" + " " + where-phrase-69) <> ""
          then  substitute(' buf_contract.host-code = &1 and buf_contract.doc-type = &8&2&8 and buf_contract.status_ = &8&3&8 and buf_contract.cli-type = &8&4&8 and buf_contract.cli-code = &5 and buf_contract.mngr-code = &6 and ( &8&7&8 = chr(1) or buf_contract.contract-type = &8&7&8)', p-host-code, p-doc-type, p-status, p-cli-type, p-cli-code, p-mngr-code, p-contr-type, chr(34)) + " " + where-phrase-69
      ...
      parameter-5-69 = (" " + "" + " " + substitute(' and ( &1&2&1 <> &1firm-curr&1 or ( buf_contract.contract-date-end = date(&1&1) or buf_contract.contract-date-end >= today )) ' , chr(34) , p-mode  ) + " " + p-find-condition)
      parameter-6-69 = if sort-phrase-69 = ''
                           then
        (
        " " + "  " +
...
define variable vss-include-info81 as character format "x(65)" no-undo initial "@(#)$Workfile:currsysk.i $ $Revision: $".
