...
define variable v-str-recid34 as character no-undo .
define variable v-num-entry34 as integer   no-undo .
assign
  v-str-recid34 = trim( string( recid( buf_price-doc-forming ) , "->>>>>>>>>>>9":U ) )
  v-num-entry34 = lookup( v-str-recid34 , p-rec-list )
.
if v-num-entry34 > 0 then do:
  assign
    entry( v-num-entry34, p-rec-list ) = "":U
    p-rec-list = trim( replace( p-rec-list , chr(44) + chr(44) , chr(44) ) , chr(44) )
  .
end.
else do:
  assign
    p-rec-list = p-rec-list + ( if p-rec-list = "":U then "":U else chr(44) ) + v-str-recid34
  .
end.
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-41 as character no-undo .
      ...
      parameter-4-41 =
        (
          if ("( r-status = 2 OR buf_price-doc-forming.stts =  r-status ) AND                    ( p-mode = 'all' OR                    ( buf_price-doc-forming.plt-id = p-plt-id AND buf_price-doc-forming.plt-db-num = p-plt-db-num )) " + " " + where-phrase-41) <> ""
          then  substitute('( &1 = 2 OR buf_price-doc-forming.stts =  &1 ) AND                          ( &5&2&5 = &5all&5 OR                       ( buf_price-doc-forming.plt-id = &3 AND                          buf_price-doc-forming.plt-db-num = &4 )) ' ,                         r-status, p-mode, p-plt-id, p-plt-db-num , chr(34)                         )  + " " + where-phrase-41
          else "true"
        )
      parameter-5-41 = (" " + " " + " " + substitute(' ,     FIRST buf_price-list-type  WHERE            buf_price-list-type.plt-id = buf_price-doc-forming.plt-id AND           buf_price-list-type.plt-db-num = buf_price-doc-forming.plt-db-num &5 AND            ( &4 = 2 OR  ( buf_price-list-type.gop-id     = &2 AND                             buf_price-list-type.gop-db-num = &3 )) &6 ', chr(34) , loc_gop-id , loc_gop-db-num , r-obj  ,v-where-phrase , v-sort-phrase))
    ...
    :
      assign
        l-disable-where-41 =
          ("( r-status = 2 OR buf_price-doc-forming.stts =  r-status ) AND                    ( p-mode = 'all' OR                    ( buf_price-doc-forming.plt-id = p-plt-id AND buf_price-doc-forming.plt-db-num = p-plt-db-num )) " + " " + where-phrase-41 = "")
      .
  ...
  if l-filter-open-41 = false then do:
    OPEN QUERY BROWSE-1grp FOR EACH buf_price-doc-forming no-lock
      where ( r-status = 2 OR buf_price-doc-forming.stts =  r-status ) AND                    ( p-mode = 'all' OR                    ( buf_price-doc-forming.plt-id = p-plt-id AND buf_price-doc-forming.plt-db-num = p-plt-db-num ))
  ...
  :
    if query BROWSE-1grp:handle:get-buffer-handle(1) = (buffer buf_price-doc-forming:handle) then do:
      ...
      parameter-4-41 =
        "where ":u +  substitute('( &1 = 2 OR buf_price-doc-forming.stts =  &1 ) AND                          ( &5&2&5 = &5all&5 OR                       ( buf_price-doc-forming.plt-id = &3 AND                          buf_price-doc-forming.plt-db-num = &4 )) ' ,                         r-status, p-mode, p-plt-id, p-plt-db-num , chr(34)                         )  + " ":u + where-phrase-41 + " ":u + p-find-condition + " " + " "
      parameter-5-41 = ""
    .
      ...
      assign
      parameter-2-41 = (if p-find-next then "true":u else "false":u )
      parameter-3-41 =  "FOR EACH buf_price-doc-forming"
      parameter-4-41 =
        (
          if ("( r-status = 2 OR buf_price-doc-forming.stts =  r-status ) AND                    ( p-mode = 'all' OR                    ( buf_price-doc-forming.plt-id = p-plt-id AND buf_price-doc-forming.plt-db-num = p-plt-db-num )) " + " " + where-phrase-41) <> ""
          then  substitute('( &1 = 2 OR buf_price-doc-forming.stts =  &1 ) AND                          ( &5&2&5 = &5all&5 OR                       ( buf_price-doc-forming.plt-id = &3 AND                          buf_price-doc-forming.plt-db-num = &4 )) ' ,                         r-status, p-mode, p-plt-id, p-plt-db-num , chr(34)                         )  + " " + where-phrase-41
