...
define frame fr-D-pump-8
  ub.c-pump.pump-code at row  1.25 col 11.00 colon-aligned view-as fill-in size-chars  3.50 by 1.00                   fgcolor  4
  ub.c-pump.obj-type  at row  2.50 col 11.00 colon-aligned view-as fill-in size-chars  4.50 by 1.00    label "Объект"
  ub.c-pump.obj-code  at row  2.50 col 18.00          view-as fill-in size-chars 10.50 by 1.00 no-label
  buf_cli.obj-name   at row  2.50 col 29.00          view-as fill-in size-chars 70.00 by 1.00 no-label          fgcolor  4
  ub.c-pump.status_   at row  3.75 col 11.00 colon-aligned view-as fill-in size-chars  9.50 by 1.00
  ub.c-pump.PS        at row  5.25 col  1.50          view-as editor no-word-wrap scrollbar-horizontal scrollbar-vertical size-chars  98.25 by 3.50 no-label          bgcolor 15
...
do on error   undo Main-Block, leave Main-Block
  ...
  find ub.c-pump no-lock where recid( ub.c-pump ) = p-rec-id no-error.
  if not available ub.c-pump then do:
    message "Карточка истории ТРК не найдена!" view-as alert-box error.
    undo Main-Block, leave Main-Block.
  end.
  find buf_cli no-lock where
       buf_cli.obj-type = ub.c-pump.obj-type and
       buf_cli.obj-code = ub.c-pump.obj-code no-error.
  assign frame fr-D-pump-8 :title = "Карточка изменения ТРК " +
    substitute( '"&1" (объект &2 &3 "&4") -- &5',
                ub.c-pump.pump-code, ub.c-pump.obj-type, ub.c-pump.obj-code, buf_cli.obj-name, p-mode ).
  display ub.c-pump.pump-code
          ub.c-pump.obj-type
          ub.c-pump.obj-code
          buf_cli.obj-name
          ub.c-pump.status_
  ...
  enable ub.c-pump.PS Btn_Exit b-help with frame fr-D-pump-8.
  assign ub.c-pump.PS :read-only in frame fr-D-pump-8 = yes.
