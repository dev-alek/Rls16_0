...
DO:
  ...
  assign
    ...
    p-full-name  = ""
  .
    display cargo-name pack-type with frame Dialog-Frame .
END.
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  frame Dialog-Frame:title = "Описание груза" .
  RUN enable_UI.
  if v-mode <> 'ИЗМЕНЕНИЕ':U then do:
     disable cargo-name pack-type  b-clear  with frame Dialog-Frame.
     B-ok:label = "Вы&ход"  .
