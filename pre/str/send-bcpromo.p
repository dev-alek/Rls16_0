...
assign
  v-version-dec = decimal(p-pos-version)
    no-error .
for each ub.PromoGoods no-lock where ub.PromoGoods.db-num = integer(entry(2,ub.PromoAttr.p-key,chr(3))) and
  ub.PromoGoods.idAction = int64(entry(1,ub.PromoAttr.p-key,chr(3))) and
  ub.PromoGoods.gds-code = integer(entry(3,ub.PromoAttr.p-key,chr(3))):
