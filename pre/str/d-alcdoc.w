...
DO:
  ...
  if last-event:function <> "MOUSE-SELECT-DBLCLICK" then do:
    ...
    apply "value-changed" to br-alcdoc in frame Dialog-Frame.
  end.
  apply "entry" to br-alcdoc .
END.
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse br-alcdoc :handle
      .
...
do:
  br-alcdoc :SET-REPOSITIONED-ROW(5, "CONDITIONAL") .
end.
define variable vss-include-info4 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
on f5 of frame Dialog-Frame anywhere
do:
  if available tt_alcdoc then     v-cur-recid = recid(tt_alcdoc).   run OpenBR in this-procedure.   reposition br-alcdoc to recid v-cur-recid no-error.   apply 'entry' to br-alcdoc in frame Dialog-Frame.
    apply "VALUE-CHANGED" to br-alcdoc.
end.
MAIN-BLOCK:
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  run OpenBr.
  RUN enable_UI.
  apply "entry" to br-alcdoc in frame Dialog-Frame.
