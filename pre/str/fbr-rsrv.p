...
define variable vss-include-info44 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
    ...
    define buffer buf_out_fbr-line  for ub.fbr-line.
    define buffer buf_in_fbr-line   for ub.fbr-line.
    define buffer buf_fbr-doc       for ub.fbr-doc.
    define buffer buf_goods         for ub.goods.
do
    ...
    then do:
        ...
        then do:
          if p-silent then do:
            ...
            message
                ...
                + chr(10) + "Документ не может быть переведен в статус РАЗРЕШЕН."
            view-as alert-box.
        end.
        end.
    end.
        ...
        :
            ...
            where buf_out_fbr-line.doc-code = buf_fbr-doc.doc-code
                and buf_out_fbr-line.trn-type = 'спи':U
            on error undo, return error
            :
                find first buf_goods no-lock
