...
END.
ON VALUE-CHANGED OF b-ob IN FRAME Dialog-Frame
DO:
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse b-ob :handle
      .
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  ASSIGN FRAME
  Dialog-Frame:TITLE = "Финансовые обязательства по складскому документу " + pardoc-code.
  assign
  bf_fin-connect.sum-rubl:label in browse b-fin-doc = "Сумма связи (руб)"
  bf_fin-doc.sum-rubl:label in browse   b-fin-doc   = "Сумма платежа (руб)"
  tt-fo.sum-rubl:label in browse b-ob               = "Общая сумма (руб)"
  tt-fo.sum-rubl-trn:label in browse b-ob           = "Сумма по док. (руб)"
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY b-ob FOR EACH tt-fo.
END PROCEDURE.
...
IF AVAILABLE tt-fo THEN DO:
    ...
    DISPLAY b-fin-doc WITH FRAME Dialog-Frame.
END.
END PROCEDURE.
