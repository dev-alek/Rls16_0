...
define input parameter parrecalc-doc  as logical no-undo.
...
:
  ...
  :
   ...
   if  (not g#news
       or (g#news and  g#db-num  = 0))
       and bf_wth-doc.ext-doc-type <> 'dc':U
   then do:
define variable vss-include-info19 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run wthobjcr in g#library
  (input  bf_wth-doc.obj-type
  ,input  bf_wth-doc.obj-code
  ,input  bf_wth-line.wth-code
  ,buffer bf_wth-obj
  )  .
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run wthpobjc in g#library
  ...
  ,input  bf_wth-doc.obj-code
  ,input  bf_wth-line.wth-code
  ,input bf_wth-line.w-p-code
  ,buffer bf_wth-pobj
  )  .
      find current bf_wth-pobj exclusive.
      if parrecalc-doc = yes then do:
         if lookup (bf_wth-doc.ext-doc-type, 'ij,pj,fj,jj,oj,ej':U) = 0 and
         bf_wth-doc.ext-doc-type <> 'de':U
         then do:
define variable vss-include-info21 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
if lookup (bf_wth-doc.ext-doc-type, 'ie,ii,ij,fj,pj,ip,ff,pc,ps,pz,ci':U) > 0   OR
   (bf_wth-doc.ext-doc-type = 'iy':U AND temp-wth-line.fact-sum > 0) or
   lookup (bf_wth-doc.ext-doc-type, 'rj,rf,rp':U) > 0   or
   (bf_wth-doc.ext-doc-type = 'xc':U ) then do:
       if bf_wth-doc.ext-doc-type = 'iy':U and bf_wth-doc.doc-code begins '1-' then do:
            assign
              bf_wth-line.income       = bf_wth-obj.income +  temp-wth-line.aft-sum
              bf_wth-line.income-other = bf_wth-obj.income-other + temp-wth-line.aft-sum
              bf_wth-line.income-cassa = 0.
              end.
       else do:
           assign
           bf_wth-line.income       = bf_wth-obj.income + temp-wth-line.fact-sum.
           if bf_wth-doc.ext-doc-type = 'ci':U then
           assign
              bf_wth-line.income-cassa = bf_wth-obj.income-cassa + temp-wth-line.fact-sum
              bf_wth-line.income-other = bf_wth-obj.income-other.
           else
           assign
              bf_wth-line.income-other = bf_wth-obj.income-other + temp-wth-line.fact-sum
              bf_wth-line.income-cassa = bf_wth-obj.income-cassa.
      end.
   assign bf_wth-line.incass       = bf_wth-obj.incass
    ...
    if lookup (bf_wth-doc.ext-doc-type, 'ee,ei,ej,jj,oj,ce,ef,ep':U) > 0 OR  lookup (bf_wth-doc.ext-doc-type,'we,dc,dp,df':U) > 0
        or (bf_wth-doc.ext-doc-type = 'iy':U AND temp-wth-line.fact-sum <= 0)
        and bf_wth-doc.ext-doc-type <> 'dc':U then do:
        if bf_wth-doc.ext-doc-type = 'iy':U then do:
            if bf_wth-doc.doc-code begins '1-' then do:
            assign
              bf_wth-line.incass       = bf_wth-obj.incass       - temp-wth-line.aft-sum
              bf_wth-line.incass-other = bf_wth-obj.incass-other - temp-wth-line.aft-sum
              bf_wth-line.incass-cassa = 0
              bf_wth-line.incass-bank  = 0.
              end.
         else
             assign
              bf_wth-line.incass       = bf_wth-obj.incass       - temp-wth-line.fact-sum
              bf_wth-line.incass-other = bf_wth-obj.incass-other - temp-wth-line.fact-sum
              bf_wth-line.incass-cassa = bf_wth-obj.incass-cassa
              bf_wth-line.incass-bank  = bf_wth-obj.incass-bank.
        end.
        else do:
           assign
              bf_wth-line.incass       = bf_wth-obj.incass + temp-wth-line.fact-sum.
           if bf_wth-doc.ext-doc-type = 'ce':U then do:
              assign bf_wth-line.incass-other = bf_wth-obj.incass-other
                     bf_wth-line.incass-bank  = bf_wth-obj.incass-bank
                     bf_wth-line.incass-cassa = bf_wth-obj.incass-cassa + temp-wth-line.fact-sum
                     .
           end.
           else do:
            ...
            if varattr-value = "yes":U then do:
                assign bf_wth-line.incass-bank  = bf_wth-obj.incass-bank + temp-wth-line.fact-sum
                      bf_wth-line.incass-other = bf_wth-obj.incass-other
                      bf_wth-line.incass-cassa = bf_wth-obj.incass-cassa
                      .
            end.
            else do:
                assign bf_wth-line.incass-other = bf_wth-obj.incass-other + temp-wth-line.fact-sum
                      bf_wth-line.incass-bank  = bf_wth-obj.incass-bank
                      bf_wth-line.incass-cassa  = bf_wth-obj.incass-cassa
                      .
            end.
        ...
        assign bf_wth-line.income       = bf_wth-obj.income
               bf_wth-line.income-cassa = bf_wth-obj.income-cassa
               bf_wth-line.income-other = bf_wth-obj.income-other
               .
    end.
    else if bf_wth-doc.ext-doc-type = 'dc':U then.
         ...
         if bf_wth-doc.ext-doc-type = 'de':U then do:
            assign
...
if lookup (bf_wth-doc.ext-doc-type, 'ie,ii,ij,fj,pj,ip,ff,pc,ps,pz,ci':U) > 0   OR
   (bf_wth-doc.ext-doc-type = 'iy':U AND bf_wth-line.fact-sum > 0) or
   lookup (bf_wth-doc.ext-doc-type, 'rj,rf,rp':U) > 0   or
   (bf_wth-doc.ext-doc-type = 'xc':U ) then do:
       if bf_wth-doc.ext-doc-type = 'iy':U and bf_wth-doc.doc-code begins '1-' then do:
            assign
              bf_wth-line.income-pl       = bf_wth-pobj.income-pl +  bf_wth-line.aft-sum
              bf_wth-line.income-other-pl = bf_wth-pobj.income-other-pl + bf_wth-line.aft-sum
              bf_wth-line.income-cassa-pl = 0.
              end.
       else do:
           assign
           bf_wth-line.income-pl       = bf_wth-pobj.income-pl + bf_wth-line.fact-sum.
           if bf_wth-doc.ext-doc-type = 'ci':U then
           assign
              bf_wth-line.income-cassa-pl = bf_wth-pobj.income-cassa-pl + bf_wth-line.fact-sum
              bf_wth-line.income-other-pl = bf_wth-pobj.income-other-pl.
           else
           assign
              bf_wth-line.income-other-pl = bf_wth-pobj.income-other-pl + bf_wth-line.fact-sum
              bf_wth-line.income-cassa-pl = bf_wth-pobj.income-cassa-pl.
      end.
   assign bf_wth-line.incass-pl       = bf_wth-pobj.incass-pl
          bf_wth-line.incass-bank-pl  = bf_wth-pobj.incass-bank-pl
          bf_wth-line.incass-other-pl = bf_wth-pobj.incass-other-pl
          bf_wth-line.incass-cassa-pl = bf_wth-pobj.incass-cassa-pl.
end.
    ...
    if lookup (bf_wth-doc.ext-doc-type, 'ee,ei,ej,jj,oj,ce,ef,ep':U) > 0 OR  lookup (bf_wth-doc.ext-doc-type,'we,dc,dp,df':U) > 0
        or (bf_wth-doc.ext-doc-type = 'iy':U AND bf_wth-line.fact-sum <= 0)
        and bf_wth-doc.ext-doc-type <> 'dc':U then do:
        if bf_wth-doc.ext-doc-type = 'iy':U then do:
            if bf_wth-doc.doc-code begins '1-' then do:
            assign
              bf_wth-line.incass-pl       = bf_wth-pobj.incass-pl       - bf_wth-line.aft-sum
              bf_wth-line.incass-other-pl = bf_wth-pobj.incass-other-pl - bf_wth-line.aft-sum
              bf_wth-line.incass-cassa-pl = 0
              bf_wth-line.incass-bank-pl  = 0.
              end.
         else
             assign
              bf_wth-line.incass-pl       = bf_wth-pobj.incass-pl       - bf_wth-line.fact-sum
              bf_wth-line.incass-other-pl = bf_wth-pobj.incass-other-pl - bf_wth-line.fact-sum
              bf_wth-line.incass-cassa-pl = bf_wth-pobj.incass-cassa-pl
              bf_wth-line.incass-bank-pl  = bf_wth-pobj.incass-bank-pl.
        end.
        else do:
           assign
              bf_wth-line.incass-pl       = bf_wth-pobj.incass-pl + bf_wth-line.fact-sum.
           if bf_wth-doc.ext-doc-type = 'ce':U then do:
              assign bf_wth-line.incass-other-pl = bf_wth-pobj.incass-other-pl
                     bf_wth-line.incass-bank-pl  = bf_wth-pobj.incass-bank-pl
                     bf_wth-line.incass-cassa-pl = bf_wth-pobj.incass-cassa-pl + bf_wth-line.fact-sum
                     .
           end.
           else do:
            find first bf_clients where bf_clients.obj-type = bf_wth-doc.cli-type and
            ...
            run  clntattr-value(input bf_clients.obj-type,
                                ...
                                output varattr-type) no-error.
            if varattr-value = "yes":U then do:
                assign bf_wth-line.incass-bank-pl  = bf_wth-pobj.incass-bank-pl + bf_wth-line.fact-sum
                      bf_wth-line.incass-other-pl = bf_wth-pobj.incass-other-pl
                      bf_wth-line.incass-cassa-pl = bf_wth-pobj.incass-cassa-pl
                      .
            end.
            else do:
                assign bf_wth-line.incass-other-pl = bf_wth-pobj.incass-other-pl + bf_wth-line.fact-sum
                      bf_wth-line.incass-bank-pl  = bf_wth-pobj.incass-bank-pl
                      bf_wth-line.incass-cassa-pl  = bf_wth-pobj.incass-cassa-pl
                      .
            end.
        ...
        assign bf_wth-line.income-pl       = bf_wth-pobj.income-pl
               bf_wth-line.income-cassa-pl = bf_wth-pobj.income-cassa-pl
               bf_wth-line.income-other-pl = bf_wth-pobj.income-other-pl
               .
    end.
   ...
   if p-wth-doc-close = true then do :
        for each bf_wth-parts exclusive-lock where
          ...
          break by bf_wth-parts.wth-code  by bf_wth-parts.par-code by bf_wth-parts.gds-code
            on error undo tr, return error substitute( "&1. &2&3&4", 'Ошибка при обработке партий', return-value, chr(10), error-status :get-message (1))
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run baserate in g#library
  (input  bf_wth-doc.host-code
  ,input  bf_wth-doc.DOC-DATE
  ,output v-base-rate
  ,output v-base-scale
  ) no-error .
