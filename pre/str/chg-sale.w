...
ON CHOOSE OF b-lkp IN FRAME DIALOG-1
DO:
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse br-pr :handle
      .
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  frame DIALOG-1:title = "Цены на объекте : " + p-curr-obj-type + " "  + string (p-curr-obj-code) +
...
PROCEDURE enable_UI :
  ENABLE b-quit b-lkp b-help br-pr
      WITH FRAME DIALOG-1.
  OPEN QUERY br-pr FOR EACH price-list       WHERE price-list.obj-type = p-curr-obj-type and price-list.obj-code = p-curr-obj-code and price-list.b-code = bar-code.b-code and price-list.fact-order <> 0 and price-list.main-price = yes NO-LOCK,       EACH price-doc WHERE price-doc.doc-num = price-list.doc-num NO-LOCK     BY price-list.fact-order DESCENDING.
END PROCEDURE.
