...
do:
  br-no-mark :SET-REPOSITIONED-ROW(5, "CONDITIONAL") .
end.
  run init-temp in this-procedure .
  run enable_UI in this-procedure .
  WAIT-FOR GO OF FRAME d-mark focus br-no-mark.
END.
...
PROCEDURE enable_UI :
  ENABLE
    ...
    if p-mode <> 'ПРОСМОТР':U then do:
      enable br-no-mark with frame d-mark .
    end.
    else do:
      disable br-no-mark with frame d-mark .
    end.
END PROCEDURE.
PROCEDURE init-temp :
  OPEN QUERY br-no-mark FOR EACH X_marking exclusive-LOCK INDEXED-REPOSITION.
END PROCEDURE.
