...
define variable mTitle-add as character no-undo.
define variable mTitle-del as character no-undo.
...
define variable dflt-cd14 as character no-undo .
...
mObj-type      =         entry(1, p-parameter, chr(4))
mObj-code      = integer(entry(2, p-parameter, chr(4)))
