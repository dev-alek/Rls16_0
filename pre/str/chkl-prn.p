...
Assign l-col-type="CHARACTER" l-col-len=10 l-col-format= "X(10)"     l-col-lable="Тип чека".
  ...
  define variable c-for-chk-type as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[2] = true then DO:
        ...
        CREATE EDITOR L-2 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-for-chk-type IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME Doc:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="CHARACTER" l-col-len=10 l-col-format= "X(10)"       l-col-lable="Дата чека".
  ...
  define variable c-for-chk-date as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[5] = true then DO:
        ...
        CREATE EDITOR L-5 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-for-chk-date IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME Doc:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="CHARACTER" l-col-len=8 l-col-format= "X(8)"       l-col-lable="Время чека".
  ...
  define variable c-for-chk-time as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[6] = true then DO:
        ...
        CREATE EDITOR L-6 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-for-chk-time IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME Doc:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="CHARACTER" l-col-len=8 l-col-format= ">>>>>>9"       l-col-lable="№ чека на кассе".
  ...
  define variable c-for-chk-num as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[7] = true then DO:
        ...
        CREATE EDITOR L-7 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-for-chk-num IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME Doc:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="INTEGER" l-col-len=4 l-col-format= ">>>9"       l-col-lable="Касса".
  ...
  define variable c-for-pay-desk as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[8] = true then DO:
        ...
        CREATE EDITOR L-8 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-for-pay-desk IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME Doc:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="CHARACTER" l-col-len=14 l-col-format= "X(14)"       l-col-lable="Номер РН".
  ...
  define variable c-for-out-code as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[10] = true then DO:
        ...
        CREATE EDITOR L-10 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-for-out-code IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME Doc:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="CHARACTER" l-col-len=10 l-col-format= "X(10)"       l-col-lable="№ док-та".
  ...
  define variable c-for-doc-num as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[12] = true then DO:
        ...
        CREATE EDITOR L-12 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-for-doc-num IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME Doc:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="decimal" l-col-len=13 l-col-format= "->,>>>,>>9.99"       l-col-lable="Нетто".
  ...
  define variable c-for-netto as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[13] = true then DO:
        ...
        CREATE EDITOR L-13 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-for-netto IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME Doc:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="decimal" l-col-len=13 l-col-format= "->,>>>,>>9.99"       l-col-lable="Скидка".
  ...
  define variable c-for-discnt as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[14] = true then DO:
        ...
        CREATE EDITOR L-14 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-for-discnt IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME Doc:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
Assign l-col-type="decimal" l-col-len=13 l-col-format= "->,>>>,>>9.99"       l-col-lable="Брутто".
  ...
  define variable c-for-tot-doc as widget-handle no-undo.
   if l-col-pos > 320 then l-col-pos = 320 .
  if use-column[15] = true then DO:
        ...
        CREATE EDITOR L-15 IN WIDGET-POOL "My-pool"
          ASSIGN
            ...
            HEIGHT-CHARS = 3
        .
        CREATE FILL-IN C-for-tot-doc IN WIDGET-POOL "My-pool"
          ASSIGN
            FRAME = FRAME Doc:HANDLE
            DATA-TYPE = "CHARACTER"
            FORMAT = "X(":U + string(l-col-len) + ")":U
...
FOR EACH chk-list No-LOCK
    ...
    for-chk-type = get-chk-type(chk-list.doc-code, chk-list.chk-type, chk-list.is-wth).
  assign
  accum-count = accum-count + 1
  .
  if use-column[1]
  then  C-for-doc-code:screen-value = string(chk-list.doc-code, entry(1, c-for-doc-code:private-data, chr(4))).
  if use-column[2]
  then  C-for-chk-type:screen-value = string(get-chk-type(chk-list.doc-code, chk-list.chk-type, chk-list.is-wth ), entry(1, c-for-chk-type:private-data, chr(4))).
  if use-column[3]
  then  C-for-obj-code:screen-value = string(chk-list.obj-code, entry(1, c-for-obj-code:private-data, chr(4))).
  if use-column[4]
  then  C-for-obj-type:screen-value = string(chk-list.obj-type, entry(1, c-for-obj-type:private-data, chr(4))).
  if use-column[5]
  then  C-for-chk-date:screen-value = string(string(chk-list.chk-date, '99/99/9999'), entry(1, c-for-chk-date:private-data, chr(4))).
  if use-column[6]
  then  C-for-chk-time:screen-value = string(string(chk-list.chk-time, 'hh:mm:ss'), entry(1, c-for-chk-time:private-data, chr(4))).
  if use-column[7]
  then  C-for-chk-num:screen-value = string(chk-list.chk-num, entry(1, c-for-chk-num:private-data, chr(4))).
  if use-column[8]
  then  C-for-pay-desk:screen-value = string(chk-list.pay-desk, entry(1, c-for-pay-desk:private-data, chr(4))).
  if use-column[9]
  then  C-for-cashier:screen-value = string(chk-list.cashier, entry(1, c-for-cashier:private-data, chr(4))).
  if use-column[10]
  then  C-for-out-code:screen-value = string(chk-list.out-code, entry(1, c-for-out-code:private-data, chr(4))).
  if use-column[11]
  then  C-for-d-card:screen-value = string(chk-list.d-card, entry(1, c-for-d-card:private-data, chr(4))).
  if use-column[12]
  then  C-for-doc-num:screen-value = string(chk-list.doc-num, entry(1, c-for-doc-num:private-data, chr(4))).
  if use-column[13]
  then  C-for-netto:screen-value = string(chk-list.netto, entry(1, c-for-netto:private-data, chr(4))).
  if use-column[14]
  then  C-for-discnt:screen-value = string(chk-list.discnt, entry(1, c-for-discnt:private-data, chr(4))).
  if use-column[15]
  then  C-for-tot-doc:screen-value = string(chk-list.tot-doc, entry(1, c-for-tot-doc:private-data, chr(4))).
  ...
  if use-column[1]
  then (reg-output(
                    string(chk-list.doc-code, entry(1, c-for-doc-code:private-data, chr(4)))
  ...
  if use-column[2]
  then (reg-output(
                    string(get-chk-type(chk-list.doc-code, chk-list.chk-type, chk-list.is-wth ), entry(1, c-for-chk-type:private-data, chr(4)))
                   ,c-for-chk-type:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[3]
  then (reg-output(
                    string(chk-list.obj-type, entry(1, c-for-obj-type:private-data, chr(4)))
  ...
  if use-column[4]
  then (reg-output(
                    string(chk-list.obj-code, entry(1, c-for-obj-code:private-data, chr(4)))
  ...
  if use-column[5]
  then (reg-output(
                    string(string(chk-list.chk-date, '99/99/9999'), entry(1, c-for-chk-date:private-data, chr(4)))
                   ,c-for-chk-date:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[6]
  then (reg-output(
                    string(string(chk-list.chk-time, 'hh:mm:ss'), entry(1, c-for-chk-time:private-data, chr(4)))
                   ,c-for-chk-time:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[7]
  then (reg-output(
                    string(chk-list.chk-num, entry(1, c-for-chk-num:private-data, chr(4)))
                   ,c-for-chk-num:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[8]
  then (reg-output(
                    string(chk-list.pay-desk, entry(1, c-for-pay-desk:private-data, chr(4)))
                   ,c-for-pay-desk:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[9]
  then (reg-output(
                    string(chk-list.cashier, entry(1, c-for-cashier:private-data, chr(4)))
  ...
  if use-column[10]
  then (reg-output(
                    string(chk-list.out-code, entry(1, c-for-out-code:private-data, chr(4)))
                   ,c-for-out-code:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[11]
  then (reg-output(
                    string(chk-list.d-card, entry(1, c-for-d-card:private-data, chr(4)))
  ...
  if use-column[12]
  then (reg-output(
                    string(chk-list.doc-num, entry(1, c-for-doc-num:private-data, chr(4)))
                   ,c-for-doc-num:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[13]
  then (reg-output(
                    string(chk-list.netto, entry(1, c-for-netto:private-data, chr(4)))
                   ,c-for-netto:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[14]
  then (reg-output(
                    string(chk-list.discnt, entry(1, c-for-discnt:private-data, chr(4)))
                   ,c-for-discnt:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[15]
  then (reg-output(
                    string(chk-list.tot-doc, entry(1, c-for-tot-doc:private-data, chr(4)))
                   ,c-for-tot-doc:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
                   ,v-th-sep)  +
  ...
  if use-column[1]
  then  C-FOR-doc-code:screen-value = string(fill14).
  if use-column[2]
  then  C-for-chk-type:screen-value = string(fill10).
  if use-column[3]
  then  C-for-obj-type:screen-value = string(fill3).
  if use-column[4]
  then  C-for-obj-code:screen-value = string(fill5).
  if use-column[5]
  then  C-for-chk-date:screen-value = string(fill10).
  if use-column[6]
  then  C-for-chk-time:screen-value = string(fill8).
  if use-column[7]
  then  C-for-chk-num:screen-value = string(fill7).
  if use-column[8]
  then  C-for-pay-desk:screen-value = string(fill4).
  if use-column[9]
  then  C-for-cashier:screen-value = string(fill4).
  if use-column[10]
  then  C-for-out-code:screen-value = string(fill14).
  if use-column[11]
  then  C-for-d-card:screen-value = string(fill16).
  if use-column[12]
  then  C-for-doc-num:screen-value = string(fill10).
  if use-column[13]
  then  C-for-netto:screen-value = string(fill13).
  if use-column[14]
  then  C-for-discnt:screen-value = string(fill13).
  if use-column[15]
  then  C-for-tot-doc:screen-value = string(fill13).
        DISPLAY stream  PrnLibStream with frame Doc.       DOWN 1 stream PrnLibStream with frame Doc.
  if use-column[1]
  then  C-for-doc-code:screen-value = string(string(accum-count), entry(1, c-for-doc-code:private-data, chr(4))).
  if use-column[2]
  then  C-for-chk-type:screen-value = string( 'чеков' , entry(1, c-for-chk-type:private-data, chr(4))).
    DISPLAY stream  PrnLibStream with frame Doc.                                      DOWN 1 stream PrnLibStream with frame Doc.
  end.
END.
...
.
run rep/extitle.p (2).
do ii = 1 to num-entries (p-Notes, chr(10)):
  assign
  dopstr = substring (entry (ii, p-notes, chr(10)), 1, 1)
  dopstr1 = substring (entry (ii, p-notes, chr(10)), 3)
  .
  if Make-Excel then  put   stream ForExcel unformatted
  if use-column[1]
  then (reg-output(
                    string(string(ii), entry(1, c-for-doc-code:private-data, chr(4)))
                   ,c-for-doc-code:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
  ...
  if use-column[2]
  then (reg-output(
                    string(dopstr, entry(1, c-for-chk-type:private-data, chr(4)))
                   ,c-for-chk-type:private-data
                   ,v-reg-replace
                   ,no
                   ,v-dec-sep
