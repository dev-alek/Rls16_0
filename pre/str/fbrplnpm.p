...
define variable vss-include-info54 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
  run mainmenu_getcntxt in parparentproc
    ...
    :
        ...
        then do:
            if buf_fbr-pln-line.fbr-obj-type <> 'маг':U
            then do:
                find first buf_goods no-lock
    ...
    :
        ...
        then do:
            message
                ...
                skip(1)
                skip "Объект:" 'маг':U temp_fbr-objects.obj-code
            view-as alert-box error.
            undo, return error.
        end.
    end.
    ...
    :
        ...
        :
            ...
            :
                ...
                assign
                    buf_fbr-pln-line.status_ = 'разрешен':U
                .
                if valid-handle( p-fbrhist-handle )
                then do:
                    run fbrhist-write in p-fbrhist-handle (
            ...
            .
            assign
                buf_fbr-doc.status_ = 'нередакт':U
            .
            run write-counter in p-log-handle (
                input ""
            ).
        ...
        assign
            buf_fbr-pln.status_ = 'разрешен':U
        .
    end.
    run write-log in p-log-handle (
          input 3
