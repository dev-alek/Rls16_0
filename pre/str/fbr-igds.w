...
ON WINDOW-CLOSE OF FRAME d-fbr-gds
DO:
  APPLY "END-ERROR":U TO SELF.
END.
ON CHOOSE OF b-sel IN FRAME d-fbr-gds
DO:
p-goods-recid = recid (goods).
END.
ON MOUSE-SELECT-DBLCLICK OF br-fbr-gds IN FRAME d-fbr-gds
DO:
apply "choose" to b-sel in frame d-fbr-gds.
END.
...
on F9 of frame d-fbr-gds anywhere do:
  run get-current-goods-recid.
  if gds-rec = ? then
    return no-apply.
  run ref/gds-form.w ( input p-mainmenu-handle
                      ,input 'ПРОСМОТР':U
                      ,input ?
                      ,input ?
                      ,input ?
                      ,input-output gds-rec).
  apply "entry" to br-fbr-gds in frame d-fbr-gds.
  return no-apply.
end.
IF VALID-HANDLE(ACTIVE-WINDOW) AND FRAME d-fbr-gds:PARENT eq ?
THEN FRAME d-fbr-gds:PARENT = ACTIVE-WINDOW.
define variable vss-include-info3 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
on help of frame d-fbr-gds
do:
  run gbl/app_help.p
...
on choose of b-help in frame d-fbr-gds
do:
  apply "help":u to frame d-fbr-gds .
end.
...
procedure minbtn-set :
    do
        ...
        do
            ...
            :
            assign
                v-frame-width = frame d-fbr-gds:width - 0.3
                fh            = frame d-fbr-gds:first-child
                hh            = fh:first-child
                ii            = 1
                .
...
procedure diasize_change-height :
  ...
  if p-change-value > 0
  then do:
    if frame d-fbr-gds :height + p-change-value
        > decimal(session :work-area-height-pixels) / session :pixels-per-row
    then do:
      assign
        p-change-value = decimal(session :work-area-height-pixels) / session :pixels-per-row
                        - (frame d-fbr-gds :height-chars)
      .
      if p-change-value <= 0
      then do:
  ...
  if p-change-value < 0
  then do:
    if frame d-fbr-gds :height + p-change-value < v-diasize-orig-frame-height
    then do:
      assign
  ...
  :
    ...
    then do:
      ...
      :
        ...
        then do:
          ...
          assign
            frame d-fbr-gds :height = v-frame-height
          .
          if frame d-fbr-gds :scrollable = true
          then do:
            assign
              frame d-fbr-gds :virtual-height = v-frame-virtual-height
            .
          end.
          run diasize_position-resize-button in this-procedure .
        end.
    ...
    assign
      v-frame-height = frame d-fbr-gds :height
      v-frame-virtual-height = frame d-fbr-gds :virtual-height
    ...
    assign
      v-field-group-handle = frame d-fbr-gds :first-child
    .
    ...
    then do:
      ...
      then do:
        assign
          frame d-fbr-gds :virtual-height = frame d-fbr-gds :virtual-height + p-change-value
          no-error .
      ...
      assign
        frame d-fbr-gds :height = frame d-fbr-gds :height + p-change-value
        no-error .
      if error-status :error
      or error-status :get-message(1) <> ""
      then do:
    ...
    then do:
      ...
      then do:
        ...
        run gbl/wndsizew.p
          ...
          ,input  'height':u
          ,input  string(frame d-fbr-gds :height - v-diasize-orig-frame-height)
          ) .
      end.
    end.
  end.
...
procedure diasize_set-height :
  ...
  :
    run diasize_change-height in this-procedure
      (input  (p-new-height - frame d-fbr-gds :height)
      ,input  p-move-resize
      ) .
  end.
end procedure.
procedure diasize_change-width :
  ...
  if p-change-value > 0
  then do:
    if frame d-fbr-gds :width + p-change-value >
        session :width-chars
    then do:
      assign
        p-change-value = session :width-chars - frame d-fbr-gds :width
      .
      if p-change-value <= 0
      then do:
        run diasize_position-resize-button in this-procedure .
  ...
  if p-change-value < 0
  then do:
    if frame d-fbr-gds :width + p-change-value < v-diasize-orig-frame-width
    then do:
      assign
        p-change-value = v-diasize-orig-frame-width
                       - frame d-fbr-gds :width
      .
      if p-change-value >= 0
      then do:
        run diasize_position-resize-button in this-procedure .
  ...
  :
    ...
    then do:
      ...
      :
        ...
        then do:
          ...
          assign
            frame d-fbr-gds :width = v-frame-width
          .
          if frame d-fbr-gds :scrollable = true
          then do:
            assign
              frame d-fbr-gds :virtual-width = v-frame-virtual-width
            .
          end.
          run diasize_position-resize-button in this-procedure .
        end.
    ...
    assign
      v-frame-width = frame d-fbr-gds :width
      v-frame-virtual-width = frame d-fbr-gds :virtual-width
    ...
    then do:
      ...
      then do:
        assign
          frame d-fbr-gds :virtual-width = frame d-fbr-gds :virtual-width + p-change-value
          no-error .
        if error-status :error
        or error-status :get-message(1) <> ""
        then do:
      ...
      assign
        frame d-fbr-gds :width = v-frame-width + p-change-value
        no-error .
      if error-status :error
      or error-status :get-message(1) <> ""
      then do:
      ...
      assign
        frame d-fbr-gds :width = frame d-fbr-gds :width + p-change-value
      no-error .
      if error-status :error
      or error-status :get-message(1) <> ""
      then do:
    ...
    then do:
      ...
      then do:
        ...
        run gbl/wndsizew.p
          ...
          ,input  v-diasize-proc-name
          ,input  'width':u
          ,input  string(frame d-fbr-gds :width - v-diasize-orig-frame-width)
          ) .
      end.
    end.
  end.
...
procedure diasize_set-width :
  ...
  :
    run diasize_change-width in this-procedure
      (input  (p-new-width - frame d-fbr-gds :width)
      ,input  p-move-resize
      ) .
  end.
end procedure.
procedure diasize_position-resize-button :
  ...
  :
    hide v-diasize-resize-button .
    assign
      v-diasize-resize-button :row = frame d-fbr-gds :height - v-diasize-resize-button :height
                  - 1
                  - (frame d-fbr-gds :border-bottom-pixels / session :pixels-per-row)
      v-diasize-resize-button :col = frame d-fbr-gds :width - v-diasize-resize-button :width
                  - 1
                  - (frame d-fbr-gds :border-right-pixels / session :pixels-per-column)
    .
...
on alt-enter of frame d-fbr-gds
do:
...
procedure diasize_end-move :
  ...
  :
    ...
    .
    assign
      v-row-delta = v-new-row - frame d-fbr-gds :height
      v-col-delta = v-new-col - frame d-fbr-gds :width
    .
    run diasize_change-height in this-procedure
      (input v-row-delta
      ,input true
...
procedure diasize_restore-orig-size :
  ...
  :
    assign
      v-diasize-current-frame-width  = frame d-fbr-gds :width
      v-diasize-current-frame-height = frame d-fbr-gds :height
    .
...
procedure diasize_init :
  ...
  :
    ...
    :
      assign
        v-diasize-orig-frame-height = frame d-fbr-gds :height
        v-diasize-orig-frame-width  = frame d-fbr-gds :width
        v-diasize-browse-handle     = browse br-fbr-gds :handle
      .
      create button v-diasize-resize-button
      assign
        parent        = frame d-fbr-gds :first-child
        label         = "s"
        height-pixels = 16
        width-pixels  = 16
        visible       = true
...
RUN enable_UI.
frame d-fbr-gds:title = "Информация по товарам. Документ № " + v-doc-code.
...
WAIT-FOR GO OF FRAME d-fbr-gds.
END.
RUN disable_UI.
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY br-fbr-gds FOR EACH temp_fbr-gds no-lock,                                    each goods of temp_fbr-gds no-lock                             by temp_fbr-gds.order-num by temp_fbr-gds.artic.
END PROCEDURE.
...
define output parameter p-doc-code      as character    no-undo .
    ...
    define variable par-fbr-ooff as char no-undo .
    define variable par-type     as char no-undo .
    define variable list-marks   as char init ">>,<<,.,=,>,<" no-undo .
    define variable list-orders  as char init "5,4,6,3,2,1"   no-undo .
...
:
    ...
    :
        ...
        if buf_fbr-line.trn-type = 'при':U
        then do:
            assign
