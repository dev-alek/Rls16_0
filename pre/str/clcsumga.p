...
for each thbjattr_thbj-attr :
  ...
  if ub.trn-doc.ext-doc-type <> 'vt':U              and
     ub.trn-doc.ext-doc-type <> 'vp':U         and
     ub.trn-doc.ext-doc-type <> 'mp':U and
     ub.trn-doc.ext-doc-type <> 'pc':U   and
     ub.trn-doc.ext-doc-type <> 'ap':U   then do:
  ...
  if ub.trn-doc.status_ <> 'факт':U      and
     ub.trn-doc.status_ <> 'разрешен':U then do:
    assign
      varneed-calc = no.
  end.
  else do:
...
if valid-handle( g#trdcalib ) <> yes then do:       run str/trdcalib.p persistent no-error.       if error-status :error or valid-handle( g#trdcalib ) <> yes then do:         message "Error starting trdcalib.p"    skip( 0 )                 g#trdcalib                     skip( 0 )                 g#trdcalib   :type             skip( 0 )                 g#trdcalib   :file-name        skip( 0 )                 error-status :get-message( 1 ) skip( 0 )                 return-value                   skip( 0 )         view-as alert-box error.         stop.       end.      end.     run trdcalib_tdat-val in g#trdcalib (  input ub.trn-doc.doc-code ,
      ...
      if lookup( 'gen':U, varcalcasstring ) <> 0 then do:
        if lookup( 'ext':U, varcalcasstring ) = 0 then do:
          return error substitute( 'Критическая ошибка. По документу "&1" есть рассчитаная сумма "&2" и нет суммы "&3".'
                                 , ub.trn-doc.doc-code
                                 , 'gen':U
                                 , 'ext':U ).
        end.
        if lookup( 'mis':U, varcalcasstring ) = 0 then do:
          return error substitute( 'Критическая ошибка. По документу "&1" есть рассчитаная сумма "&2" и нет суммы "&3".'
                                 , ub.trn-doc.doc-code
                                 , 'gen':U
                                 , 'mis':U ).
        end.
        if lookup( 'ad':U, varcalcasstring ) = 0 then do:
          return error substitute( 'Критическая ошибка. По документу "&1" есть рассчитаная сумма "&2" и нет суммы "&3".'
                                 , ub.trn-doc.doc-code
                                 , 'gen':U
                                 , 'ad':U ).
        ...
        if varinvclcspvalue = "yes" then do:
          if lookup( 'genc':U, varcalcasstring ) = 0 then do:
            return error substitute( 'Критическая ошибка. По документу "&1" есть рассчитаная сумма "&2" и нет суммы "&3".'
                                   , ub.trn-doc.doc-code
                                   , 'gen':U
                                   , 'genc':U ).
          end.
          if lookup( 'extc':U, varcalcasstring ) = 0 then do:
            return error substitute( 'Критическая ошибка. По документу "&1" есть рассчитаная сумма "&2" и нет суммы "&3".'
                                   , ub.trn-doc.doc-code
                                   , 'gen':U
                                   , 'extc':U ).
          end.
          if lookup( 'misc':U, varcalcasstring ) = 0 then do:
            return error substitute( 'Критическая ошибка. По документу "&1" есть рассчитаная сумма "&2" и нет суммы "&3".'
                                   , ub.trn-doc.doc-code
                                   , 'gen':U
                                   , 'misc':U ).
          end.
          if lookup( 'acd':U, varcalcasstring ) = 0 then do:
            return error substitute( 'Критическая ошибка. По документу "&1" есть рассчитаная сумма "&2" и нет суммы "&3".'
                                   , ub.trn-doc.doc-code
                                   , 'gen':U
                                   , 'acd':U ).
