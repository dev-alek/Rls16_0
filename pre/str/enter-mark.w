...
on return of f-mark in frame Dialog-Frame
do :
  assign frame Dialog-Frame f-mark .
  apply "choose" to b-ok in frame Dialog-Frame .
end .
on entry of f-mark in frame Dialog-Frame
do :
...
on leave of f-mark in frame Dialog-Frame
do :
  assign frame Dialog-Frame f-mark .
end .
