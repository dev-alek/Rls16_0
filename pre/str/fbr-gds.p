    ...
    then do:
        ...
        then do:
            ...
            :
                assign
                    v-parts-found     = yes
                    v-parts-parameter = 'reserv':U
                                + ",":U + 'no-message':U
                                + ",":U + 'rsrv-single-part':U
                                + ",":U + 'rsrv-in-code':U   + "=":U + str-encode ( buf_parts.in-code  ,  "", ",=":U )
                                + ",":U + 'rsrv-part-code':U + "=":U + str-encode ( buf_parts.part-code,  "", ",=":U )
                .
                assign
...
on error undo, return error
:
    define variable v-required-qnty     like doc-line.doc-qnty  no-undo.
    define variable v-reserved-qnty     like doc-line.doc-qnty  no-undo.
    define variable v-store-qnty                 as decimal      no-undo.
    define variable v-fbr-line-factor           as decimal      no-undo.
    define variable v-is-rsrv                   as logical      no-undo.
    define variable v-price-sale        like gds-dtl.price-rubl no-undo.
    ...
    run writelog in this-procedure (
        ...
        , input substitute( "Вычислены суммы: "
            + chr(10) + "                       fact-qnty           : &1"
            + chr(10) + "                       write-off-rsrv-qnty : &2"
            + chr(10) + "                       write-off-qnty      : &3"
            + chr(10) + "                       income-qnty         : &4"
            + chr(10) + "                       income-rsrv-qnty    : &5"
            + chr(10) + "                       cost-rubl           : &6"
            + chr(10) + "                       cost-base           : &7"
            + chr(10) + "                       sum-cost-rubl       : &8"
            + chr(10) + "                       sum-cost-base       : &9"
    ...
    run writelog in this-procedure (
        ...
        , input substitute(
                            "                       vat-cost-rubl       : &1"
            + chr(10) + "                       vat-cost-base       : &2"
            + chr(10) + "                       sum-vat-cost-rubl   : &3"
            + chr(10) + "                       sum-vat-cost-base   : &4"
            + chr(10) + "                       price-sale          : &5"
            + chr(10) + "                       deleted             : &6"
    ...
    then do:
        ...
        then do:
            undo, return error substitute("&1 &2 &3&4Ошибка резервирования товара &5.&4Количество &6 продажная цена &7:&4&8&4&9"
                                          ...
                                          ,vss-description
                                          ,chr(10)
                                          ,buf_goods.artic  + chr(32) + buf_goods.gds-name
                                          ,v-required-qnty
                                          ,v-price-sale
        ...
        run writelog in this-procedure (
            ...
            , input substitute( "Зарезервировано:"
                + chr(10) + "                       v-reserved-qnty    : &1"
                + chr(10) + "                       v-store-qnty        : &2"
                + chr(10) + "                       v-store-sum-base    : &3"
                + chr(10) + "                       v-store-sum-rubl    : &4"
                + chr(10) + "                       v-store-sum-vat-base: &5"
                + chr(10) + "                       v-store-sum-vat-rubl: &6"
                        , v-reserved-qnty
                        , v-store-qnty
                        , v-store-sum-base
                        , v-store-sum-rubl
        ...
        assign
            v-store-qnty            = buf_temp_fbrrep-goods.write-off-qnty - buf_temp_fbrrep-goods.write-off-rsrv-qnty
    ...
    run writelog in this-procedure (
        ...
        , input substitute( "Вычислены цены списания:"
            + chr(10) + "                       v-store-qnty          : &1"
            + chr(10) + "                       v-cost-price-rubl     : &2"
            + chr(10) + "                       v-cost-price-base     : &3"
            + chr(10) + "                       v-cost-price-vat-rubl : &4"
            + chr(10) + "                       v-cost-price-vat-base : &5"
                    , v-store-qnty
                    , v-cost-price-rubl
                    , v-cost-price-base
    ...
    :
        ...
        then do:
            ...
            then do:
                ...
                and ( buf_fbr-recipe.recipe-type <> 'комплектация':U
