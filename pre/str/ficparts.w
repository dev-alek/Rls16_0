...
DEFINE BROWSE BR-parts
  QUERY BR-parts NO-LOCK DISPLAY
      ...
      c-fin-gds-part.sum-rubl COLUMN-LABEL "Сумма(руб)" FORMAT "->,>>>,>>>,>>>,>>9.99":U
...
DO:
  ...
  OPEN QUERY BR-goods FOR EACH tt-goods NO-LOCK,       EACH clients WHERE clients.obj-code = tt-goods.prod-code   AND clients.obj-type = tt-goods.prod-type NO-LOCK.    OPEN QUERY BR-parts FOR EACH c-fin-gds-part       WHERE c-fin-gds-part.fin-ob-code = p-fin-doc-code and ub.c-fin-gds-part.host-code   = p-host-code and ub.c-fin-gds-part.gds-code    = tt-goods.gds-code NO-LOCK.
END.
...
DO:
  OPEN QUERY BR-parts FOR EACH c-fin-gds-part       WHERE c-fin-gds-part.fin-ob-code = p-fin-doc-code and ub.c-fin-gds-part.host-code   = p-host-code and ub.c-fin-gds-part.gds-code    = tt-goods.gds-code NO-LOCK.
END.
...
tt-goods.gds-name:resizable in browse BR-goods   = true .
clients.obj-name:resizable in browse BR-goods   = true .
tt-goods.grp-name:resizable in browse BR-goods   = true .
...
for each buf_c-fin-gds-part no-lock where
  ...
  tt-goods.gds-type :read-only in browse br-goods = true .
  c-fin-gds-part.part-code :read-only in browse br-parts = true .
END PROCEDURE.
