  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse b-supp-cnt :handle
      .
...
do on error   undo main-block, leave main-block
 ...
 .
 assign frame
   Dialog-Frame:TITLE = "Разбивка документа " + pardoc-code + " по договорам поставщиков".
  ...
  IF parfin-db THEN DO:
    ENABLE b-fin-pob b-fin-ob b-fin-doc WITH FRAME Dialog-Frame.
  END.
  ELSE DO:
    HIDE b-fin-pob b-fin-ob b-fin-doc IN FRAME Dialog-Frame.
  END.
  run open-query-parts in this-procedure.
