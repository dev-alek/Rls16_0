...
define variable vss-include-info0 as character format "x(65)" no-undo initial "@(#)$Workfile: prirasiq.p $ $Revision: aea5316774be, 0, rls $".
...
:
 ...
 run waitfram-show ("Создание ЗАПРОСА " + caps('рас':U)  + " " +  new_trn-doc.doc-code ) .
