...
assign
p-obj-code = abs(integer(entry(1, p-parameter, chr(4))))
p-necessary = (if num-entries(p-parameter, chr(4)) > 1
...
find first buf_cash-desk no-lock where
      ...
      AND buf_cash-desk.pos-type = 'InfoKiosk':U no-error .
...
find last buf_c-gds-grp-hist where
  ...
  AND buf_c-gds-grp-hist.subject = 'gds-grp':U no-error.
run cd-attr-value in this-procedure (
                                            input g#db-num
                                          ,input p-obj-code
                                          ,input buf_cash-desk.pos-type
                                          ,input buf_cash-desk.cash-num
                                          ,input 'INFOKIOSK_operative':U
                                          ,input 'last-grp-change':U
                                          ,output v-character
                                          ,output v-date
                                          ,output v-decimal
                                          ,output v-integer
...
or integer(entry(3, v-character, chr(32) )) < buf_c-gds-grp-hist.chip-num then do:
  ...
  v-character-new =  (if available buf_c-gds-grp-hist
                        then
                        (string(buf_c-gds-grp-hist.corr-date, "99/99/9999") + chr(32) +
                        string(buf_c-gds-grp-hist.corr-time, "hh:mm:ss") + chr(32) +
                        string(buf_c-gds-grp-hist.chip-num)
                        )
                        else
                        (string(v-today, "99/99/9999") + chr(32) +
                        string(v-time, "hh:mm:ss") + chr(32) +
                        string(current-value (s-gds-grp-chip, ub))
                        )
                        )
  .
...
and integer(entry(3, v-character-new, chr(32) )) < buf_c-gds-grp-hist.chip-num)
or v-first-time
or (not available buf_c-gds-grp-hist
    and
    (date(entry(1, v-character-new, chr(32) )) < v-today
    or
    (date(entry(1, v-character-new, chr(32) )) = v-today
    and
    integer(entry(2, v-character-new, chr(32) )) < v-time
    )
    )
  )
then do:
  ...
  run str/sendgrup.p (
                  ...
                  ,input p-log-handle
                  ,input (string(p-obj-code) + chr(4) + 'A':U + chr(4) + 'group-BO')
                  ) no-error .
end.
assign
v-character = '':U
...
or integer(entry(3, v-character, chr(32) )) < buf_c-gds-prt.chip-num
then do:
  ...
  v-character-new =  (if available buf_c-gds-prt
                        then
                        (string(buf_c-gds-prt.corr-date, "99/99/9999") + chr(32) +
                        string(buf_c-gds-prt.corr-time, "hh:mm:ss") + chr(32) +
...
and integer(entry(3, v-character-new, chr(32) )) < buf_c-gds-prt.chip-num)
or v-first-time
or (not available buf_c-gds-prt
    and
    (date(entry(1, v-character-new, chr(32) )) < v-today
...
then do:
  ...
  run str/sendgrup.p (
                  ...
                  ,input p-parent-handle
                  ,input p-log-handle
                  ,input (string(p-obj-code) + chr(4) + 'A':U + chr(4) + 'gds-prt')
                  ) no-error .
end.
finally :
    run write-log-and-file in p-log-handle (
