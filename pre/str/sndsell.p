...
define variable vss-workfile    as character no-undo init "$Workfile: sndsell.p $":U .
define variable vss-archive     as character no-undo init "$Archive: str/sndsell.p $":U .
...
define NEW SHARED temp-table stf-list no-undo like ub.staff
