    ...
    then do:
        ...
        then do:
            ...
            run write-to-log in this-procedure (
                input vss-workfile + chr(32) + " Не удалось определить код фирмы для приема информации с касс объектов фирмы."
            ).
        end.
    end.
    if v-range = 2
    ...
    :
        ...
        then do:
            ...
            :
                ...
                then do:
                    run write-to-log( vss-workfile + chr(32)
                                    + substitute( " Ошибка приема информации с касс по расписанию: Не найден заданный объект &1 &2" + chr(10)
