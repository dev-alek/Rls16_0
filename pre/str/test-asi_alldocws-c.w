...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-28 as character no-undo .
      ...
      X_c-rvs-doc.is-del = yes ', v-cntxt-host-code-obj, chr(34), v-cntxt-obj-type, v-cntxt-obj-code, vartest-asi )   + " " + where-phrase-28
          else "true"
        )
      parameter-5-28 = (" " + "" + " " + "")
  ...
  :
    if QUERY br-docs:handle:get-buffer-handle(1) = (buffer X_c-rvs-doc:handle) then do:
      ...
      X_c-rvs-doc.is-del = yes ', v-cntxt-host-code-obj, chr(34), v-cntxt-obj-type, v-cntxt-obj-code, vartest-asi )   + " ":u + where-phrase-28 + " ":u + p-find-condition + " " + ""
      parameter-5-28 = " USE-INDEX stat-fact "
    .
      ...
      assign
      parameter-2-28 = (if p-find-next then "true":u else "false":u )
      parameter-3-28 =  "FOR EACH X_c-rvs-doc"
      parameter-4-28 =
        (
          if ("       X_c-rvs-doc.host-code = v-cntxt-host-code-obj AND       X_c-rvs-doc.obj-type  = v-cntxt-obj-type  AND       X_c-rvs-doc.obj-code  = v-cntxt-obj-code  AND       X_c-rvs-doc.rvs-type  = vartest-asi       AND       X_c-rvs-doc.is-del = yes and      x_c-rvs-doc.action = integer('99':U)
       " + " " + where-phrase-28) <> ""
