...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run basecode in g#library
  ...
  if buf_contract.pay-nal = no  then do:
    ...
    if buf_contract.doc-type = 'при':U then do:
      if tt-fin-doc.sum-contr > 0 then assign tt-fin-doc.fin-doc-type = 'рпп':U .
      else                           assign tt-fin-doc.fin-doc-type = 'ппп':U .
    end.
    else do:
      if tt-fin-doc.sum-contr > 0 then assign tt-fin-doc.fin-doc-type = 'ппп':U .
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run exchrate in g#library
  ...
  ,output curr-rc
    ...
    if buf_contract.pay-nal = yes then do:
      if buf_contract.doc-type = 'при':U then do:
        if tt-fin-doc.sum-contr > 0 then assign tt-fin-doc.fin-doc-type = 'рко':U .
        else                           assign tt-fin-doc.fin-doc-type = 'пко':U .
      end.
      else do:
        if tt-fin-doc.sum-contr > 0 then assign tt-fin-doc.fin-doc-type = 'пко':U .
        else                           assign tt-fin-doc.fin-doc-type = 'рко':U .
      end.
    end.
    else do:
      if buf_contract.doc-type = 'при':U then do:
        if tt-fin-doc.sum-contr > 0 then assign tt-fin-doc.fin-doc-type = 'апр':U .
        else                           assign tt-fin-doc.fin-doc-type = 'апп':U .
      end.
      else do:
        if tt-fin-doc.sum-contr > 0 then assign tt-fin-doc.fin-doc-type = 'апп':U .
