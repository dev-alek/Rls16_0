...
END.
    ...
    do vari = 1 to num-entries (p-rid-list):
      ...
      if buf_contract.status_ <> 'тек':U then do:
        message "Договор " buf_contract.contract-prn-code " статус " buf_contract.status_ " не в статусе " 'тек':U " . Пропускаем." view-as alert-box.
        next .
      end.
...
END.
  ...
  p-res = p-res  + chr(10)   +  chr(10)   +
       ...
       if p-type-date > 0 then string("за период до " + string( p-date-end,"99/99/9999")  + chr(10)) else "" +
    ...
    buf_contract-specif
     ...
     :
      ...
      assign
        ...
        temp_fin-gds-part.status_dop         = 'авто':U
        ...
        temp_fin-gds-part.vat-type           = 'в т. ч.':U
        ...
        .
      assign
        temp_fin-gds-part.vat-contract       = if temp_fin-gds-part.vat-type = 'в т. ч.':U then temp_fin-gds-part.vat-PC * ( temp_fin-gds-part.sum-contract  / ( 100 + temp_fin-gds-part.vat-PC))  else temp_fin-gds-part.sum-contract * temp_fin-gds-part.vat-pc / 100
        temp_fin-gds-part.vat-rubl           = if temp_fin-gds-part.vat-type = 'в т. ч.':U then temp_fin-gds-part.vat-PC * ( temp_fin-gds-part.sum-rubl      / ( 100 + temp_fin-gds-part.vat-PC))  else temp_fin-gds-part.sum-rubl     * temp_fin-gds-part.vat-pc / 100
        temp_fin-gds-part.vat-base           = if temp_fin-gds-part.vat-type = 'в т. ч.':U then temp_fin-gds-part.vat-PC * ( temp_fin-gds-part.sum-base      / ( 100 + temp_fin-gds-part.vat-PC))  else temp_fin-gds-part.sum-base     * temp_fin-gds-part.vat-pc / 100
...
procedure make-fo :
 ...
 :
  ...
  if buf_contract.usl-opl = 'По спецификации':U then v-date-pay = today  .
 ...
 .
  ...
  run create-fin-liab (
    ...
    if error-status :error then  p-res = p-res + chr(10) + " Ошибка при закрытии на факт ФО " + return-value  + error-status :get-message(1) .
  end.
end procedure.
