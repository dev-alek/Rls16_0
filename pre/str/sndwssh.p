...
run write-log-and-file in p-log-handle (
        ...
        , input log-file-name
        , input 1
        , input substitute("Пересылка на кассы &1&2 масок МЦ", 'маг':U, i-obj-code)
                                              ).
    ...
    if v-version-dec >= 1.05 then do:
      run bgelib-tag-open in this-procedure ( input 2, input "MaskPayMeans"
                                            , input substitute("ctrl='&1' tms='&2' code='&3'"
                                                              ...
                                                              , buf_wth-ser.db-num * 10000000 + buf_wth-ser.ser-code
                                                              )).
...
then do:
  ...
  then do:
    run str/post-xml.p
      ...
      ,input 30
      ,input   ( if action = 'U'
                  then ('Ждите - ' + 'добавление маски МЦ ')
                  else ('Ждите - ' + 'удаление маски МЦ ') ) +
