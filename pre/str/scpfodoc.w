...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  ASSIGN FRAME
  Dialog-Frame:TITLE = "Предфинобязательства по удаленному складскому документу " + pardoc-code.
  assign
  tt-fo-before.sum-rubl:label in browse b-ob       = "Общая сумма (руб)"
  tt-fo-before.sum-rubl-trn:label in browse b-ob   = "Сумма по док. (руб)"
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY b-ob FOR EACH tt-fo-before.
END PROCEDURE.
