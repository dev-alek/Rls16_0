...
find first tt-doc-line-attr where
      ...
      tt-doc-line-attr.attr-code  = 'fl_gds-code':U  + chr(44) + string(p-prt-code)  + chr(44) + string(v-buket-gds-code ) no-error .
...
if v-buket-gds-code = 0 or v-buket-gds-code = ? then return .
      ...
      tt-doc-line-attr.attr-code  = 'fl_gds-code':U  + chr(44) + string(p-prt-code)  + chr(44) + string(v-buket-gds-code )
      .
     OPEN QUERY BROWSE-1 FOR EACH tt-doc-line-attr NO-LOCK,       EACH ub.goods WHERE ub.goods.gds-code = tt-doc-line-attr.bk-gds-code NO-LOCK INDEXED-REPOSITION.
end.
END.
...
define variable ll as decimal   no-undo .
 ll = DEC(tt-doc-line-attr.attr-value:screen-value in browse BROWSE-1 ) no-error .
