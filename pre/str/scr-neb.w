...
define variable PrintCopiesCounter  as integer  INIT 1 no-undo.
...
END.
ON CHOOSE OF b-re IN FRAME Dialog-Frame
DO:
  for each tt-bar-code-ne:
...
if tt-bar-code-ne.mark = "f" then do:
    assign tt-bar-code-ne.b-c:fgcolor in browse BROWSE-1 = red_color tt-bar-code-ne.artic:fgcolor in browse BROWSE-1 = red_color tt-bar-code-ne.scn-qnty-file:fgcolor in browse BROWSE-1 = red_color tt-bar-code-ne.scn-qnty-doc:fgcolor in browse BROWSE-1 = red_color varqnty:fgcolor in browse BROWSE-1 = red_color tt-bar-code-ne.gds-name:fgcolor in browse BROWSE-1 = red_color tt-bar-code-ne.node-name:fgcolor in browse BROWSE-1 = red_color tt-bar-code-ne.prod-type:fgcolor in browse BROWSE-1 = red_color tt-bar-code-ne.prod-code:fgcolor in browse BROWSE-1 = red_color tt-bar-code-ne.in-code:fgcolor in browse BROWSE-1 = red_color tt-bar-code-ne.part-code:fgcolor in browse BROWSE-1 = red_color .
end.
if tt-bar-code-ne.mark = "d" then do:
    assign tt-bar-code-ne.b-c:fgcolor in browse BROWSE-1 = dark_green_color tt-bar-code-ne.artic:fgcolor in browse BROWSE-1 = dark_green_color tt-bar-code-ne.scn-qnty-file:fgcolor in browse BROWSE-1 = dark_green_color tt-bar-code-ne.scn-qnty-doc:fgcolor in browse BROWSE-1 = dark_green_color varqnty:fgcolor in browse BROWSE-1 = dark_green_color tt-bar-code-ne.gds-name:fgcolor in browse BROWSE-1 = dark_green_color tt-bar-code-ne.node-name:fgcolor in browse BROWSE-1 = dark_green_color tt-bar-code-ne.prod-type:fgcolor in browse BROWSE-1 = dark_green_color tt-bar-code-ne.prod-code:fgcolor in browse BROWSE-1 = dark_green_color tt-bar-code-ne.in-code:fgcolor in browse BROWSE-1 = dark_green_color tt-bar-code-ne.part-code:fgcolor in browse BROWSE-1 = dark_green_color .
end.
if tt-bar-code-ne.mark = ">" then do:
    assign tt-bar-code-ne.b-c:fgcolor in browse BROWSE-1 = blue_color tt-bar-code-ne.artic:fgcolor in browse BROWSE-1 = blue_color tt-bar-code-ne.scn-qnty-file:fgcolor in browse BROWSE-1 = blue_color tt-bar-code-ne.scn-qnty-doc:fgcolor in browse BROWSE-1 = blue_color varqnty:fgcolor in browse BROWSE-1 = blue_color tt-bar-code-ne.gds-name:fgcolor in browse BROWSE-1 = blue_color tt-bar-code-ne.node-name:fgcolor in browse BROWSE-1 = blue_color tt-bar-code-ne.prod-type:fgcolor in browse BROWSE-1 = blue_color tt-bar-code-ne.prod-code:fgcolor in browse BROWSE-1 = blue_color tt-bar-code-ne.in-code:fgcolor in browse BROWSE-1 = blue_color tt-bar-code-ne.part-code:fgcolor in browse BROWSE-1 = blue_color .
end.
if tt-bar-code-ne.mark = "<" then do:
    assign tt-bar-code-ne.b-c:fgcolor in browse BROWSE-1 = brown_color tt-bar-code-ne.artic:fgcolor in browse BROWSE-1 = brown_color tt-bar-code-ne.scn-qnty-file:fgcolor in browse BROWSE-1 = brown_color tt-bar-code-ne.scn-qnty-doc:fgcolor in browse BROWSE-1 = brown_color varqnty:fgcolor in browse BROWSE-1 = brown_color tt-bar-code-ne.gds-name:fgcolor in browse BROWSE-1 = brown_color tt-bar-code-ne.node-name:fgcolor in browse BROWSE-1 = brown_color tt-bar-code-ne.prod-type:fgcolor in browse BROWSE-1 = brown_color tt-bar-code-ne.prod-code:fgcolor in browse BROWSE-1 = brown_color tt-bar-code-ne.in-code:fgcolor in browse BROWSE-1 = brown_color tt-bar-code-ne.part-code:fgcolor in browse BROWSE-1 = brown_color .
end.
END.
ON CHOOSE OF MENU-ITEM m_f
DO:
...
assign frame Dialog-Frame varstr.
...
do:
  ...
  do:
    varstr = "".
    disp varstr with frame Dialog-Frame.
    return no-apply.
  end.
end.
...
if error-status:error then do:
  ...
  display "" @ varstr with frame Dialog-Frame.
  return no-apply.
end.
...
if not available bf_tt-bar-code-ne then do:
  ...
  assign
    ...
    bf_tt-bar-code-ne.node-name      = (if bf_gds-prt.node-name = '_Пустая шкала':U then "--------------------" else bf_gds-prt.node-name)
    bf_tt-bar-code-ne.part-code      = ''
    bf_tt-bar-code-ne.in-code        = ''.
  display "" @ varstr with frame Dialog-Frame.
  OPEN QUERY BROWSE-1 FOR EACH tt-bar-code-ne.
end.
assign
...
reposition BROWSE-1 to recid recid(bf_tt-bar-code-ne).
apply "ROW-DISPLAY" to BROWSE-1 IN FRAME Dialog-Frame.
display "" @ varstr with frame Dialog-Frame.
END.
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  RUN enable_UI.
  assign
    editor-1 = "d  - товар присутствует только в документе" + chr(10) +
               "f  - товар присутствует только по факту"     + chr(10) +
               "<> - кол-во в документе не равно кол-ву по факту"  + chr(10) +
