...
do:
  ...
  then do:
    ASSIGN
      fi-date-from :POPUP-MENU in frame Dialog-Frame = MENU m-ed-date4 :HANDLE
      fi-date-from :MENU-MOUSE in frame Dialog-Frame = 3
    .
  end.
  define variable v-label-handle4 as handle no-undo .
  assign
    v-label-handle4 = fi-date-from :side-label-handle in frame Dialog-Frame
  .
...
do:
  ...
  then do:
    ASSIGN
      fi-date-to :POPUP-MENU in frame Dialog-Frame = MENU m-ed-date6 :HANDLE
      fi-date-to :MENU-MOUSE in frame Dialog-Frame = 3
    .
  end.
  define variable v-label-handle6 as handle no-undo .
  assign
    v-label-handle6 = fi-date-to :side-label-handle in frame Dialog-Frame
  .
