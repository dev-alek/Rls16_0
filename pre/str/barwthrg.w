...
DO:
  assign frame  Dialog-Frame bar-strFrom bar-strTo.
...
DO:
  MESSAGE "Help for File: c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\str\barwthrg.w" VIEW-AS ALERT-BOX INFORMATION.
END.
ON LEAVE OF bar-strFrom IN FRAME Dialog-Frame
DO:
  bar-strFrom = SELF:SCREEN-VALUE.
END.
ON RETURN OF bar-strFrom IN FRAME Dialog-Frame
DO:
  APPLY 'tab' TO SELF.
  RETURN NO-APPLY.
END.
ON RETURN OF bar-strTo IN FRAME Dialog-Frame
DO:
...
do transaction on error undo, return error return-value
               on stop  undo, return
               on quit  undo, return:
run str/wthidnt.p ( input bar-strFrom
...
OUTPUT CLOSE.
run str/wthidnt.p ( input bar-strTo
