...
END.
ON CHOOSE OF b-view IN FRAME Dialog-Frame
DO:
  if available tt-auto-tank then do:
     for first ub.auto-tank no-lock where ub.auto-tank.auto-num = tt-auto-tank.auto-num :
    assign
    ...
    run str/auto-tnc.w (input parparentproc,input 'ПРОСМОТР':U, input-output varauto-tank-rec) no-error.
  end.
  else do:
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse brw-auto-tank :handle
      .
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY brw-auto-tank FOR EACH tt-auto-tank       where index(tt-auto-tank.auto-num, "#") = 0 EXCLUSIVE-LOCK.
END PROCEDURE.
PROCEDURE local-enable_UI :
  ...
  if lookup ("b-del", parbuttons) > 0 then do:
    enable b-del with frame Dialog-Frame.
  end.
  apply "value-changed" to brw-auto-tank in frame dialog-frame.
  display brw-auto-tank WITH FRAME Dialog-Frame.
...
if yes then do:
  ...
  then do:
    ...
    define variable  parameter-7-9 as character no-undo .
      assign
      parameter-3-9 =
                              "FOR EACH tt-auto-tank"
      parameter-4-9 =
        (
          if (" tt-auto-tank.auto-num begins f-search and index(tt-auto-tank.auto-num, v-num) = 0 " + " " + where-phrase-9) <> ""
          then " tt-auto-tank.auto-num begins f-search and index(tt-auto-tank.auto-num, v-num) = 0 " + " " + where-phrase-9
          else "true"
        )
      parameter-5-9 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-9 =
          (" tt-auto-tank.auto-num begins f-search and index(tt-auto-tank.auto-num, v-num) = 0 " + " " + where-phrase-9 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY brw-auto-tank:handle
                          ,input parameter-3-9
                          ,input parameter-4-9
                          ,input parameter-5-9
                          ,input parameter-6-9
  ...
  if l-filter-open-9 = false then do:
    OPEN QUERY brw-auto-tank FOR EACH tt-auto-tank
      where  tt-auto-tank.auto-num begins f-search and index(tt-auto-tank.auto-num, v-num) = 0
      indexed-reposition
  .
      assign
        l-query-was-opened = true
  ...
  assign
    varauto-tank-rec = recid( tt-auto-tank )
  .
  do
  on stop undo, leave
  on error undo, leave
  :
    if QUERY brw-auto-tank:handle:get-buffer-handle(1) = (buffer tt-auto-tank:handle) then do:
      assign
      parameter-2-9 = (if no then "true":u else "false":u )
      parameter-4-9 =
        "where ":u + " tt-auto-tank.auto-num begins f-search and index(tt-auto-tank.auto-num, v-num) = 0 " + " ":u + where-phrase-9 + " ":u + "" + " " + ""
      parameter-5-9 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input QUERY brw-auto-tank:handle
                          ,input rowid(tt-auto-tank)
                          ,input logical(parameter-2-9)
                          ,input no-lock
                          ,input (buffer tt-auto-tank:handle)
                          ,input parameter-4-9
                          ,input parameter-5-9
                          ) no-error.
      .
      assign
        varauto-tank-rec = integer(return-value)
        v-fltopend-rowid[1] = ?
      .
    end.
    else do:
      assign
      parameter-2-9 = (if no then "true":u else "false":u )
      parameter-3-9 =  "FOR EACH tt-auto-tank"
      parameter-4-9 =
        (
          if (" tt-auto-tank.auto-num begins f-search and index(tt-auto-tank.auto-num, v-num) = 0 " + " " + where-phrase-9) <> ""
          then " tt-auto-tank.auto-num begins f-search and index(tt-auto-tank.auto-num, v-num) = 0 " + " " + where-phrase-9
...
if yes then do:
  ...
  then do:
    ...
    define variable  parameter-7-11 as character no-undo .
      ...
      parameter-4-11 =
        (
          if (" tt-auto-tank.auto-num begins f-search and tt-auto-tank.status_ = v-status_ and index(tt-auto-tank.auto-num, v-num) = 0 " + " " + where-phrase-11) <> ""
          then  substitute('tt-auto-tank.auto-num begins &1&4&1 and tt-auto-tank.status_ = &1&2&1 and index(tt-auto-tank.auto-num, &1&3&1) = 0', chr(34), v-status_, v-num, f-search)  + " " + where-phrase-11
          else "true"
        )
      parameter-5-11 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-11 =
          (" tt-auto-tank.auto-num begins f-search and tt-auto-tank.status_ = v-status_ and index(tt-auto-tank.auto-num, v-num) = 0 " + " " + where-phrase-11 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY brw-auto-tank:handle
  ...
  if l-filter-open-11 = false then do:
    OPEN QUERY brw-auto-tank FOR EACH tt-auto-tank
      where  tt-auto-tank.auto-num begins f-search and tt-auto-tank.status_ = v-status_ and index(tt-auto-tank.auto-num, v-num) = 0
      indexed-reposition
  .
      assign
        l-query-was-opened = true
  ...
  :
    if QUERY brw-auto-tank:handle:get-buffer-handle(1) = (buffer tt-auto-tank:handle) then do:
      assign
      parameter-2-11 = (if no then "true":u else "false":u )
      parameter-4-11 =
        "where ":u +  substitute('tt-auto-tank.auto-num begins &1&4&1 and tt-auto-tank.status_ = &1&2&1 and index(tt-auto-tank.auto-num, &1&3&1) = 0', chr(34), v-status_, v-num, f-search)  + " ":u + where-phrase-11 + " ":u + "" + " " + ""
      parameter-5-11 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-11 = (if no then "true":u else "false":u )
      parameter-3-11 =  "FOR EACH tt-auto-tank"
      parameter-4-11 =
        (
          if (" tt-auto-tank.auto-num begins f-search and tt-auto-tank.status_ = v-status_ and index(tt-auto-tank.auto-num, v-num) = 0 " + " " + where-phrase-11) <> ""
          then  substitute('tt-auto-tank.auto-num begins &1&4&1 and tt-auto-tank.status_ = &1&2&1 and index(tt-auto-tank.auto-num, &1&3&1) = 0', chr(34), v-status_, v-num, f-search)  + " " + where-phrase-11
