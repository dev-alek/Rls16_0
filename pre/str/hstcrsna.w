...
define frame fr-D-pump-8
  ub.c-trn-reason-host.host-code   at row 1.25 col  3.00 view-as fill-in    size-chars 10.00 by 1.00    label "Фирма"   format ">>>>>>>>>":U
  buf_cli.obj-name     at row 1.25 col 20.25 view-as fill-in    size-chars 79.50 by 1.00 no-label fgcolor 4 format "x(256)":U
  v-ext-doc-name       at row 2.50 col  3.00 view-as fill-in    size-chars 69.75 by 1.00          fgcolor 4
  ub.c-trn-reason-host.hold-doc    at row 3.75 col  3.00 view-as toggle-box size-chars  96.50 by 1.00
  ub.c-trn-reason-host.reason-code at row 5.00 col  3.00 view-as fill-in    size-chars 11.50 by 1.00    label "Причина" format ">>>>>>>>>>":U
  buf_rsn.reason-name  at row 5.00 col 24.25 view-as fill-in    size-chars 75.50 by 1.00 no-label fgcolor 4 format "x(256)":U
...
do on error   undo Main-Block, leave Main-Block
  ...
  enable Btn_Exit b-help with frame fr-D-pump-8.
