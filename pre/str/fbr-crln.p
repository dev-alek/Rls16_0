...
define input parameter p-recipe-code        like fbr-line.recipe-code   no-undo.
define input parameter p-trn-type           like fbr-line.trn-type      no-undo.
define input parameter p-is-comp            like fbr-line.is-comp       no-undo.
define input parameter p-is-recursive       as logical                  no-undo.
define input parameter p-price-obj-type     like clients.obj-type       no-undo.
define input parameter p-price-obj-code     like clients.obj-code       no-undo.
define output parameter p-fbr-line-recid    as recid                no-undo.
...
:
    ...
    :
        ...
        then do:
            ...
            else if buf_fbr-line.trn-type     = 'при':U then  buf_fbr-line.price-sale = 0.
        end.
    end.
    assign
