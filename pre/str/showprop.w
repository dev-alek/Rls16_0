...
PROCEDURE enable_UI :
  ...
  OPEN QUERY BROWSE-level FOR EACH ub.lvl-name no-lock where ub.lvl-name.upper-code = v-upper-code by ub.lvl-name.level .    run open-query-gds-prt in this-procedure .
END PROCEDURE.
