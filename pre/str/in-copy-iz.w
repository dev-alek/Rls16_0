...
END.
ON CHOOSE OF b_help IN FRAME Dialog-Frame
OR HELP OF FRAME Dialog-Frame
DO:
  MESSAGE "Help for File: c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\str\in-copy-iz.w" VIEW-AS ALERT-BOX INFORMATION.
END.
ON CHOOSE OF b_save IN FRAME Dialog-Frame
DO:
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY br-copy-iz FOR EACH tt-doc-iz.
END PROCEDURE.
