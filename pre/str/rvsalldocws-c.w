...
do:
  if (valid-handle(g#library2) <> true) then do:   run gbl/library2.p persistent no-error .   if error-status :error or (valid-handle(g#library2) <> true) then do:     message       "Error starting library2.p" skip       g#library2 skip       g#library2 :type skip       g#library2 :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run chk-actg in g#library2
    ...
    ,input  'object':U
    ,input  x_c-rvs-doc.host-code
    ,input  x_c-rvs-doc.obj-type
    ,input  x_c-rvs-doc.obj-code
    ,input  0
    ,input  0
    ,input  0
    ,input  true
...
do:
  ...
  .
    ...
    reposition BR-docs  to recid rvs-rec no-error.
...
do:
   v-doc-rec = recid(X_c-rvs-doc). run openbr in this-procedure ( input yes, input no, input '':U).                reposition br-docS to recid v-doc-rec no-error.                APPLY 'ENTRY' to br-docs. APPLY 'VALUE-CHANGED' to br-docS.
...
define variable vss-include-info28 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
  ...
  FIND FIRST buf_obj No-LOCK WHERE
    ...
    if parlist-mode =  'объект':U then dO:
...
assign vartest-asi = 'проверка':U .
CASE parlist-mode :
WHEN 'объект':U THEN DO:
  if p-open-query then do:
    ASSIGN
    frame Dialog-Frame:TITLE = title0 + " Удаленные документы: Объект: " + v-cntxt-obj-type + string(v-cntxt-obj-code).
  end.
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-31 as character no-undo .
      assign
      parameter-3-31 =
                              "FOR EACH X_c-rvs-doc"
      parameter-4-31 =
        (
          if ("       X_c-rvs-doc.host-code = v-cntxt-host-code-obj AND       X_c-rvs-doc.obj-type  = v-cntxt-obj-type  AND       X_c-rvs-doc.obj-code  = v-cntxt-obj-code  AND       X_c-rvs-doc.rvs-type <> vartest-asi       AND       X_c-rvs-doc.is-del = yes and      x_c-rvs-doc.action = integer('99':U)
       " + " " + where-phrase-31) <> ""
          then  substitute(' X_c-rvs-doc.host-code = &1 AND       X_c-rvs-doc.obj-type  = &2&3&2  AND       X_c-rvs-doc.obj-code  = &4  AND        X_c-rvs-doc.rvs-type <> &2&5&2
      X_c-rvs-doc.is-del = yes ', v-cntxt-host-code-obj, chr(34), v-cntxt-obj-type, v-cntxt-obj-code, vartest-asi )   + " " + where-phrase-31
          else "true"
        )
      parameter-5-31 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-31 =
          ("       X_c-rvs-doc.host-code = v-cntxt-host-code-obj AND       X_c-rvs-doc.obj-type  = v-cntxt-obj-type  AND       X_c-rvs-doc.obj-code  = v-cntxt-obj-code  AND       X_c-rvs-doc.rvs-type <> vartest-asi       AND       X_c-rvs-doc.is-del = yes and      x_c-rvs-doc.action = integer('99':U)
       " + " " + where-phrase-31 = "")
      .
  ...
  if l-filter-open-31 = false then do:
    OPEN QUERY br-docs FOR EACH X_c-rvs-doc
      where        X_c-rvs-doc.host-code = v-cntxt-host-code-obj AND       X_c-rvs-doc.obj-type  = v-cntxt-obj-type  AND       X_c-rvs-doc.obj-code  = v-cntxt-obj-code  AND       X_c-rvs-doc.rvs-type <> vartest-asi       AND       X_c-rvs-doc.is-del = yes and      x_c-rvs-doc.action = integer('99':U)
       USE-INDEX stat-fact
      indexed-reposition
  .
      assign
  ...
  assign
    v-doc-rec = recid( X_c-rvs-doc )
  .
  do
  on stop undo, leave
  on error undo, leave
  :
    if QUERY br-docs:handle:get-buffer-handle(1) = (buffer X_c-rvs-doc:handle) then do:
      assign
      parameter-2-31 = (if p-find-next then "true":u else "false":u )
      parameter-4-31 =
        "where ":u +  substitute(' X_c-rvs-doc.host-code = &1 AND       X_c-rvs-doc.obj-type  = &2&3&2  AND       X_c-rvs-doc.obj-code  = &4  AND        X_c-rvs-doc.rvs-type <> &2&5&2
      X_c-rvs-doc.is-del = yes ', v-cntxt-host-code-obj, chr(34), v-cntxt-obj-type, v-cntxt-obj-code, vartest-asi )   + " ":u + where-phrase-31 + " ":u + p-find-condition + " " + ""
      parameter-5-31 = " USE-INDEX stat-fact "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input QUERY br-docs:handle
                          ,input rowid(X_c-rvs-doc)
                          ,input logical(parameter-2-31)
                          ,input no-lock
                          ,input (buffer X_c-rvs-doc:handle)
                          ,input parameter-4-31
                          ,input parameter-5-31
                          ) no-error.
      .
      ...
      assign
      parameter-2-31 = (if p-find-next then "true":u else "false":u )
      parameter-3-31 =  "FOR EACH X_c-rvs-doc"
      parameter-4-31 =
        (
          if ("       X_c-rvs-doc.host-code = v-cntxt-host-code-obj AND       X_c-rvs-doc.obj-type  = v-cntxt-obj-type  AND       X_c-rvs-doc.obj-code  = v-cntxt-obj-code  AND       X_c-rvs-doc.rvs-type <> vartest-asi       AND       X_c-rvs-doc.is-del = yes and      x_c-rvs-doc.action = integer('99':U)
       " + " " + where-phrase-31) <> ""
