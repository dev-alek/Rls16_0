...
define variable filter-point     as character no-undo initial 'История изменения строк документов':U.
define variable filter-point0    as character no-undo initial 'История изменения строк документов':U.
...
define new shared query br-doc-lines for buf_history scrolling.
define new shared query   br-changes   for buf_changes scrolling.
define browse br-doc-lines query br-doc-lines display
  mark-string( buffer buf_history )  column-label '*'  format 'x(1)':U
  buf_history.doc-code  column-label 'Накладная'  format "x(16)":U
  buf_history.line-num  column-label 'П/П'  format "->>>9":U
  buf_history.prt-OK  column-label 'Ш'  format "+/-":U
  buf_history.artic  column-label 'Артикул'  format "x(16)":U
  gds-name( buffer buf_history )  column-label 'Наименование товара'  format "x(30)":U
  buf_history.cli-qnty  column-label 'По ТТН'  format "->>,>>>,>>9.<<<":U
  buf_history.unit-cli  column-label 'Изм'  format "x(3)":U
  buf_history.price-cli  column-label 'Цена поставщ. (вал)'  format "->>,>>>,>>>,>>9.999":U
  ( buf_history.cli-qnty * buf_history.price-cli ) column-label 'Сумма пост.' format "->>,>>>,>>>,>>>,>>9.99":U
  buf_history.doc-qnty column-label 'По документу (заявл.)' format "->,>>>,>>>,>>>,>>9.999":U
  buf_history.fact-qnty column-label 'Фактически' format "->,>>>,>>>,>>>,>>9.999":U
  unit-base( buffer buf_history ) column-label 'Изм' format "x(3)":U
  ( if varr-b = 'rubl':U then buf_history.price-rubl else buf_history.price-base ) column-label 'Цена учет(прод.)' format "->,>>>,>>>,>>>,>>9.99":U
  sale-price( buffer buf_history ) column-label 'Цена продажи' format "->,>>>,>>>,>>>,>>9.99":U
  per-cent( buffer buf_history ) column-label '%' format "->>>,>>9.<<":U
  scala( buffer buf_history ) column-label 'Шкала' format "x(10)":U
  buf_history.VAT-pc column-label 'НДС' format "->9.9<%":U
  eng-name( buffer buf_history ) column-label 'Наименование англ.' format "x(40)":U
  buf_history.num-place column-label 'Кол-во мест' format "->>>,>>9.99":U
  buf_history.wt-brutto column-label 'Вес брутто' format "->>>,>>9.999":U
  ...
  buf_history.SLT-pc column-label 'НП' format "->9.9<%":U
  buf_history.cons-vat-pc column-label 'НДС конс' format "->9.9<%":U
  buf_history.cons-slt-pc column-label 'НП конс' format "->9.9<%":U
  buf_history.prt-root column-label 'Корень' format "->>>>>>>>9":U
  buf_history.cli-base-rate column-label 'Коэффициент' format "->>,>>9.<<<<":U
  buf_history.status_ column-label 'Статус' format "x(8)":U
  buf_history.excise column-label 'Акциз' format "->,>>>,>>>,>>9.99":U
  buf_history.road-tax column-label 'Дорожный налог' format "->,>>>,>>>,>>9.99":U
  buf_history.transport-base column-label 'Трансп.расх.(б.в)' format "->,>>>,>>9.99":U
  buf_history.transport-rubl column-label 'Трансп.расх.(руб)' format "->,>>>,>>9.99":U
  buf_history.other-base column-label 'Прочие (б.в)' format "->,>>>,>>9.99":U
  buf_history.other-rubl column-label 'Прочие (руб)' format "->,>>>,>>9.99":U
  buf_history.temperature column-label 'Температура' format "->>,>>9.99":U
  buf_history.doc-density column-label 'Плотность' format ">>9.9999999999":U
...
define frame fr-D-doc-line-0
    ...
    br-doc-lines at row  3.00 col  1.50
...
with view-as dialog-box keep-tab-order side-labels no-underline three-d scrollable
     title 'История изменения строк документов':U
     default-button b-quit cancel-button b-quit.
assign frame fr-D-doc-line-0 :scrollable = no.
assign br-doc-lines         :num-locked-columns in frame  fr-D-doc-line-0  = 1
       buf_history.chip-num :read-only          in browse br-doc-lines = yes
       buf_changes.l_name :read-only          in browse   br-changes   = yes.
assign b-mark    :tooltip in frame fr-D-doc-line-0 = "Поставить/снять отметку записи"
         b-quit     :tooltip in frame fr-D-doc-line-0 = "Вернуться в окно вызова"
         b-sch  :tooltip in frame fr-D-doc-line-0 = "Установить/снять фильтр"
         b-help    :tooltip in frame fr-D-doc-line-0 = "Интерактивная помощь в формате *.html"
         b-Dtls     :tooltip in frame fr-D-doc-line-0 = "Признаки текущего товара"
       b-sel  :tooltip in frame fr-D-doc-line-0 = "Выбрать текущую(ие) запись(и)"
       br-doc-lines :tooltip in frame fr-D-doc-line-0 = "Список действий над строками накладных"
         br-changes   :tooltip in frame fr-D-doc-line-0 = "Список изменений строки накладной"
         sch-doc      :tooltip in frame fr-D-doc-line-0 = "Номер накладной" + " для поиска. Поиск первой записи - <ВВОД>; поиск следующей - <CTRL-J>"
         sch-gds      :tooltip in frame fr-D-doc-line-0 = "Артикул товара" + " для поиска. Поиск первой записи - <ВВОД>; поиск следующей - <CTRL-J>"
         sch-num      :tooltip in frame fr-D-doc-line-0 = "Количество найденных записей"
         mark-num     :tooltip in frame fr-D-doc-line-0 = "Отмеченные записи".
on delete-character of br-doc-lines in frame fr-D-doc-line-0 do:
  if b-mark :sensitive in frame fr-D-doc-line-0 then do: apply "CHOOSE":U to b-mark in frame fr-D-doc-line-0. end.
end.
on insert-mode of br-doc-lines in frame fr-D-doc-line-0 do:
  if           b-mark   :sensitive in frame fr-D-doc-line-0 then do:
    apply "CHOOSE":U to b-mark     in frame fr-D-doc-line-0.
  end. else if b-sel :sensitive in frame fr-D-doc-line-0 then do:
    apply "CHOOSE":U to b-sel   in frame fr-D-doc-line-0.
  end.
end.
on choose of b-mark in frame fr-D-doc-line-0 do:
...
assign
  v-str-recid7 = trim( string( recid( buf_history ) , "->>>>>>>>>>>9":U ) )
  v-num-entry7 = lookup( v-str-recid7 , p-rid-list )
.
if v-num-entry7 > 0 then do:
  assign
    entry( v-num-entry7, p-rid-list ) = "":U
    p-rid-list = trim( replace( p-rid-list , chr(44) + chr(44) , chr(44) ) , chr(44) )
  .
end.
else do:
  assign
    p-rid-list = p-rid-list + ( if p-rid-list = "":U then "":U else chr(44) ) + v-str-recid7
  .
end.
    br-doc-lines :refresh( ) in frame fr-D-doc-line-0.
    if last-event :function <> "MOUSE-SELECT-DBLCLICK" then do:
      br-doc-lines :select-next-row( ) in frame fr-D-doc-line-0.
    end.
    apply "VALUE-CHANGED":U to br-doc-lines in frame fr-D-doc-line-0.
    if num-entries( p-rid-list ) = 0 then do: hide                                mark-num   in frame fr-D-doc-line-0. end.
                                     else do: display num-entries( p-rid-list ) @ mark-num with frame fr-D-doc-line-0. end.
  END.
  apply "ENTRY":U to br-doc-lines in frame fr-D-doc-line-0.
end.
on choose of b-quit in frame fr-D-doc-line-0 do:
  run gbl/markqwa.p ( input b-mark :sensitive, input p-rid-list ) no-error.
  if error-status :error then do: return no-apply. end.
end.
on choose of b-sch in frame fr-D-doc-line-0 do:
  run proc-filter in this-procedure no-error.
  if error-status :error then do: return no-apply. end.
end.
on choose of b-sel in frame fr-D-doc-line-0 do:
...
on choose of b-petrol in frame fr-D-doc-line-0 do:
...
then do:
  ...
  ( input ParParentProc,
    input '':U,
    input 'gds':U,
    input buf_history.obj-type ,
    input buf_history.obj-code ,
...
on choose of b-Dtls in frame fr-D-doc-line-0 do:
  define variable v-list as character no-undo.
...
on return                of br-doc-lines in frame fr-D-doc-line-0 or
   mouse-select-dblclick of br-doc-lines in frame fr-D-doc-line-0 do:
  if           b-mark   :sensitive in frame fr-D-doc-line-0 then do:
      apply "CHOOSE":U to b-mark   in frame fr-D-doc-line-0.
  end. else IF b-sel :sensitive in frame fr-D-doc-line-0 then do:
      apply "CHOOSE":U to b-sel in frame fr-D-doc-line-0.
...
on value-changed of br-doc-lines in frame fr-D-doc-line-0 do:
  run proc-view-changes in this-procedure no-error.
end.
on entry of sch-doc in frame fr-D-doc-line-0 do:
  if sch-field <> self :name then do:
    assign sch-num   = 0
           sch-field = self :name
           FoundRec  = ?.
  end.
  assign  sch-gds :screen-value in frame fr-D-doc-line-0 = "":U.
  display sch-doc with frame fr-D-doc-line-0.
end.
on entry of sch-gds in frame fr-D-doc-line-0 do:
  if sch-field <> self :name then do:
    assign sch-num   = 0
           sch-field = self :name
           FoundRec  = ?.
  end.
  assign  sch-doc :screen-value in frame fr-D-doc-line-0 = "":U.
  display sch-gds with frame fr-D-doc-line-0.
end.
on leave of sch-doc in frame fr-D-doc-line-0 do:
  if lookup( last-event :function, "MOUSE-SELECT-DBLCLICK,RETURN" ) = 0 and last-event :label <> "CTRL-J" then do:
    assign FoundRec = ?
           sch-num  = 0.
  end.
  hide sch-num in frame fr-D-doc-line-0.
end.
on leave of sch-gds in frame fr-D-doc-line-0 do:
  if lookup( last-event :function, "MOUSE-SELECT-DBLCLICK,RETURN" ) = 0 and last-event :label <> "CTRL-J" then do:
    assign FoundRec = ?
           sch-num  = 0.
  end.
...
on CTRL-J of sch-doc in frame fr-D-doc-line-0 do:
  if input frame fr-D-doc-line-0 sch-doc <> sch-doc then do:
    assign sch-doc.
    assign FoundRec = ?
           sch-num  = 0.
    hide   sch-num  in frame fr-D-doc-line-0.
...
on return of sch-doc in frame fr-D-doc-line-0 do:
  assign sch-doc.
  assign FoundRec = ?
         sch-num  = 0.
  hide   sch-num  in frame fr-D-doc-line-0.
...
on mouse-select-dblclick of sch-doc in frame fr-D-doc-line-0 do:
  if input frame fr-D-doc-line-0 sch-doc <> sch-doc then do:
    assign sch-doc.
    assign FoundRec = ?
           sch-num  = 0.
...
on CTRL-J of sch-gds in frame fr-D-doc-line-0 do:
  if input frame fr-D-doc-line-0 sch-gds <> sch-gds then do:
    assign sch-gds.
    assign FoundRec = ?
           sch-num  = 0.
    hide   sch-num  in frame fr-D-doc-line-0.
...
on return of sch-gds in frame fr-D-doc-line-0 do:
  assign sch-gds.
  assign FoundRec = ?
         sch-num  = 0.
  hide   sch-num  in frame fr-D-doc-line-0.
...
on mouse-select-dblclick of sch-gds in frame fr-D-doc-line-0 do:
  if input frame fr-D-doc-line-0 sch-gds <> sch-gds then do:
    assign sch-gds.
    assign FoundRec = ?
           sch-num  = 0.
...
on F1 of frame fr-D-doc-line-0 anywhere do:
  if b-help :sensitive then DO: apply "CHOOSE":U to b-help in frame fr-D-doc-line-0. END.
  return no-apply.
end.
define variable vss-include-info11 as character format "X(65)" no-undo initial "@(#)$Workfile$ $Revision$".
on INS of frame fr-D-doc-line-0 anywhere do:
  if b-mark :sensitive then DO: apply "CHOOSE":U to b-mark in frame fr-D-doc-line-0. END.
  return no-apply.
end.
define variable vss-include-info12 as character format "X(65)" no-undo initial "@(#)$Workfile$ $Revision$".
on F2 of frame fr-D-doc-line-0 anywhere do:
  if b-sel :sensitive then DO: apply "CHOOSE":U to b-sel in frame fr-D-doc-line-0. END.
  return no-apply.
end.
if valid-handle( active-window ) and frame fr-D-doc-line-0 :parent = ? then frame fr-D-doc-line-0 :parent = active-window.
if current-window :window-state = window-minimized then do: current-window :window-state = window-normal. end.
on window-close of frame fr-D-doc-line-0 do: apply "END-ERROR":U to self. end.
define variable vss-include-info13 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
on help of frame fr-D-doc-line-0
do:
  run gbl/app_help.p
...
on choose of b-help in frame fr-D-doc-line-0
do:
  apply "help":u to frame fr-D-doc-line-0 .
end.
...
procedure minbtn-set :
    do
        ...
        do
            ...
            :
            assign
                v-frame-width = frame fr-D-doc-line-0:width - 0.3
                fh            = frame fr-D-doc-line-0:first-child
                hh            = fh:first-child
                ii            = 1
                .
...
procedure diasize_change-height :
  ...
  if p-change-value > 0
  then do:
    if frame fr-D-doc-line-0 :height + p-change-value
        > decimal(session :work-area-height-pixels) / session :pixels-per-row
    then do:
      assign
        p-change-value = decimal(session :work-area-height-pixels) / session :pixels-per-row
                        - (frame fr-D-doc-line-0 :height-chars)
      .
      if p-change-value <= 0
      then do:
  ...
  if p-change-value < 0
  then do:
    if frame fr-D-doc-line-0 :height + p-change-value < v-diasize-orig-frame-height
    then do:
      assign
  ...
  :
    ...
    then do:
      ...
      :
        ...
        then do:
          ...
          assign
            frame fr-D-doc-line-0 :height = v-frame-height
          .
          if frame fr-D-doc-line-0 :scrollable = true
          then do:
            assign
              frame fr-D-doc-line-0 :virtual-height = v-frame-virtual-height
            .
          end.
          run diasize_position-resize-button in this-procedure .
        end.
    ...
    assign
      v-frame-height = frame fr-D-doc-line-0 :height
      v-frame-virtual-height = frame fr-D-doc-line-0 :virtual-height
    ...
    assign
      v-field-group-handle = frame fr-D-doc-line-0 :first-child
    .
    ...
    then do:
      ...
      then do:
        assign
          frame fr-D-doc-line-0 :virtual-height = frame fr-D-doc-line-0 :virtual-height + p-change-value
          no-error .
      ...
      assign
        frame fr-D-doc-line-0 :height = frame fr-D-doc-line-0 :height + p-change-value
        no-error .
      if error-status :error
      or error-status :get-message(1) <> ""
      then do:
    ...
    then do:
      ...
      then do:
        ...
        run gbl/wndsizew.p
          ...
          ,input  'height':u
          ,input  string(frame fr-D-doc-line-0 :height - v-diasize-orig-frame-height)
          ) .
      end.
    end.
  end.
...
procedure diasize_set-height :
  ...
  :
    run diasize_change-height in this-procedure
      (input  (p-new-height - frame fr-D-doc-line-0 :height)
      ,input  p-move-resize
      ) .
  end.
end procedure.
procedure diasize_change-width :
  ...
  if p-change-value > 0
  then do:
    if frame fr-D-doc-line-0 :width + p-change-value >
        session :width-chars
    then do:
      assign
        p-change-value = session :width-chars - frame fr-D-doc-line-0 :width
      .
      if p-change-value <= 0
      then do:
        run diasize_position-resize-button in this-procedure .
  ...
  if p-change-value < 0
  then do:
    if frame fr-D-doc-line-0 :width + p-change-value < v-diasize-orig-frame-width
    then do:
      assign
        p-change-value = v-diasize-orig-frame-width
                       - frame fr-D-doc-line-0 :width
      .
      if p-change-value >= 0
      then do:
        run diasize_position-resize-button in this-procedure .
  ...
  :
    ...
    then do:
      ...
      :
        ...
        then do:
          ...
          assign
            frame fr-D-doc-line-0 :width = v-frame-width
          .
          if frame fr-D-doc-line-0 :scrollable = true
          then do:
            assign
              frame fr-D-doc-line-0 :virtual-width = v-frame-virtual-width
            .
          end.
          run diasize_position-resize-button in this-procedure .
        end.
    ...
    assign
      v-frame-width = frame fr-D-doc-line-0 :width
      v-frame-virtual-width = frame fr-D-doc-line-0 :virtual-width
    ...
    then do:
      ...
      then do:
        assign
          frame fr-D-doc-line-0 :virtual-width = frame fr-D-doc-line-0 :virtual-width + p-change-value
          no-error .
        if error-status :error
        or error-status :get-message(1) <> ""
        then do:
      ...
      assign
        frame fr-D-doc-line-0 :width = v-frame-width + p-change-value
        no-error .
      if error-status :error
      or error-status :get-message(1) <> ""
      then do:
      ...
      assign
        frame fr-D-doc-line-0 :width = frame fr-D-doc-line-0 :width + p-change-value
      no-error .
      if error-status :error
      or error-status :get-message(1) <> ""
      then do:
    ...
    then do:
      ...
      then do:
        ...
        run gbl/wndsizew.p
          ...
          ,input  v-diasize-proc-name
          ,input  'width':u
          ,input  string(frame fr-D-doc-line-0 :width - v-diasize-orig-frame-width)
          ) .
      end.
    end.
  end.
...
procedure diasize_set-width :
  ...
  :
    run diasize_change-width in this-procedure
      (input  (p-new-width - frame fr-D-doc-line-0 :width)
      ,input  p-move-resize
      ) .
  end.
end procedure.
procedure diasize_position-resize-button :
  ...
  :
    hide v-diasize-resize-button .
    assign
      v-diasize-resize-button :row = frame fr-D-doc-line-0 :height - v-diasize-resize-button :height
                  - 1
                  - (frame fr-D-doc-line-0 :border-bottom-pixels / session :pixels-per-row)
      v-diasize-resize-button :col = frame fr-D-doc-line-0 :width - v-diasize-resize-button :width
                  - 1
                  - (frame fr-D-doc-line-0 :border-right-pixels / session :pixels-per-column)
    .
...
on alt-enter of frame fr-D-doc-line-0
do:
...
procedure diasize_end-move :
  ...
  :
    ...
    .
    assign
      v-row-delta = v-new-row - frame fr-D-doc-line-0 :height
      v-col-delta = v-new-col - frame fr-D-doc-line-0 :width
    .
    run diasize_change-height in this-procedure
      (input v-row-delta
      ,input true
    ...
    then do:
      ...
      run diasize_change-width in this-procedure
        (input session :width-chars
            - frame fr-D-doc-line-0 :width-chars
        ,input true
        ) .
      assign
...
procedure diasize_restore-orig-size :
  ...
  :
    assign
      v-diasize-current-frame-width  = frame fr-D-doc-line-0 :width
      v-diasize-current-frame-height = frame fr-D-doc-line-0 :height
    .
...
procedure diasize_init :
  ...
  :
    ...
    :
      assign
        v-diasize-orig-frame-height = frame fr-D-doc-line-0 :height
        v-diasize-orig-frame-width  = frame fr-D-doc-line-0 :width
        v-diasize-browse-handle     = browse br-doc-lines :handle
      .
      create button v-diasize-resize-button
      assign
        parent        = frame fr-D-doc-line-0 :first-child
        label         = "s"
        height-pixels = 16
        width-pixels  = 16
        visible       = true
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run curr-r-b in g#library
  ...
  if lookup( p-mode, 'все,obj,gds,doc,one':U ) = 0 then do:
  ...
  enable  b-mark when lookup( "b-mark":U, p-bttns ) > 0 or p-bttns = "*"
          ...
          b-Dtls br-doc-lines br-changes
          b-petrol
  with frame fr-D-doc-line-0.
      if not can-find ( first ub.c-gds-dtl no-lock where
                              ub.c-gds-dtl.doc-code  = p-doc-code
                              ) then
         disable b-Dtls with frame fr-D-doc-line-0 .
      if not can-find ( first ub.c-inv-line no-lock where
                              ub.c-inv-line.doc-code  = p-doc-code
                              ) then
         disable b-Petrol with frame fr-D-doc-line-0 .
  run OpenBr in this-procedure ( input yes, input no, input '':U ).
  hide mark-num in frame fr-D-doc-line-0.
  hide  sch-num in frame fr-D-doc-line-0.
  if p-rid-list <> "":U then do: reposition br-doc-lines to recid doc-rec no-error. end.
  br-doc-lines :set-repositioned-row( 5, "CONDITIONAL" ).
  wait-for go of frame fr-D-doc-line-0.
end.
hide frame fr-D-doc-line-0 no-pause.
procedure OpenBr :
  ...
  case p-mode :
    when 'все':U  then do:
      assign frame fr-D-doc-line-0 :title = title0 + "строк документов".
...
if p-open-query then do:
  ...
  then do:
    ...
    :
      ...
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-doc-lines:handle
  ...
  if l-filter-open-18 = false then do:
    open query br-doc-lines for each buf_history
      where  true
      indexed-reposition
  .
      assign
  ...
  on error undo, leave
  :
    if query br-doc-lines:handle:get-buffer-handle(1) = (buffer buf_history:handle) then do:
      assign
    ...
    .
      ...
      assign
      parameter-2-18 = (if p-find-next then "true":u else "false":u )
      parameter-3-18 =  "FOR EACH buf_history"
      parameter-4-18 =
        (
          if (" true " + " " + where-phrase-18) <> ""
          then  'true'  + " " + where-phrase-18
  ...
  run waitfram-hide in this-procedure .
    ...
    when 'obj':U then do:
      assign frame fr-D-doc-line-0 :title = title0 +
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-20 as character no-undo .
      ...
      parameter-4-20 =
        (
          if ("                           buf_history.obj-type = p-obj-type and                           buf_history.obj-code = p-obj-code                         " + " " + where-phrase-20) <> ""
          then                            substitute( '                            buf_history.obj-type = &1&2&1 and                           buf_history.obj-code = &3 '                           , chr(34)                           , p-obj-type                              , p-obj-code )                           + " " + where-phrase-20
          else "true"
        )
      parameter-5-20 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-20 =
          ("                           buf_history.obj-type = p-obj-type and                           buf_history.obj-code = p-obj-code                         " + " " + where-phrase-20 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-doc-lines:handle
  ...
  :
    if query br-doc-lines:handle:get-buffer-handle(1) = (buffer buf_history:handle) then do:
      ...
      parameter-4-20 =
        "where ":u +                            substitute( '                            buf_history.obj-type = &1&2&1 and                           buf_history.obj-code = &3 '                           , chr(34)                           , p-obj-type                              , p-obj-code )                           + " ":u + where-phrase-20 + " ":u + p-find-condition + " " + ""
      parameter-5-20 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-20 = (if p-find-next then "true":u else "false":u )
      parameter-3-20 =  "FOR EACH buf_history"
      parameter-4-20 =
        (
          if ("                           buf_history.obj-type = p-obj-type and                           buf_history.obj-code = p-obj-code                         " + " " + where-phrase-20) <> ""
          then                            substitute( '                            buf_history.obj-type = &1&2&1 and                           buf_history.obj-code = &3 '                           , chr(34)                           , p-obj-type                              , p-obj-code )                           + " " + where-phrase-20
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-22 as character no-undo .
      ...
      parameter-4-22 =
        (
          if ("                           buf_history.obj-type  = p-obj-type  and                           buf_history.obj-code  = p-obj-code  and                           buf_history.artic     = p-artic     and                           buf_history.prod-type = p-prod-type and                           buf_history.prod-code = p-prod-code                         " + " " + where-phrase-22) <> ""
          then                            substitute( '                            buf_history.obj-type = &1&2&1 and                           buf_history.obj-code = &3                            buf_history.artic     = &1&4&1 and                           buf_history.prod-type = &1&5&1 and                           buf_history.prod-code = &6 '                           , chr(34)                           , p-obj-type                              , p-obj-code                            , p-artic                               , p-prod-type                           , p-prod-code                           )                           + " " + where-phrase-22
          else "true"
        )
      parameter-5-22 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-22 =
          ("                           buf_history.obj-type  = p-obj-type  and                           buf_history.obj-code  = p-obj-code  and                           buf_history.artic     = p-artic     and                           buf_history.prod-type = p-prod-type and                           buf_history.prod-code = p-prod-code                         " + " " + where-phrase-22 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-doc-lines:handle
  ...
  :
    if query br-doc-lines:handle:get-buffer-handle(1) = (buffer buf_history:handle) then do:
      ...
      parameter-4-22 =
        "where ":u +                            substitute( '                            buf_history.obj-type = &1&2&1 and                           buf_history.obj-code = &3                            buf_history.artic     = &1&4&1 and                           buf_history.prod-type = &1&5&1 and                           buf_history.prod-code = &6 '                           , chr(34)                           , p-obj-type                              , p-obj-code                            , p-artic                               , p-prod-type                           , p-prod-code                           )                           + " ":u + where-phrase-22 + " ":u + p-find-condition + " " + ""
      parameter-5-22 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-22 = (if p-find-next then "true":u else "false":u )
      parameter-3-22 =  "FOR EACH buf_history"
      parameter-4-22 =
        (
          if ("                           buf_history.obj-type  = p-obj-type  and                           buf_history.obj-code  = p-obj-code  and                           buf_history.artic     = p-artic     and                           buf_history.prod-type = p-prod-type and                           buf_history.prod-code = p-prod-code                         " + " " + where-phrase-22) <> ""
          then                            substitute( '                            buf_history.obj-type = &1&2&1 and                           buf_history.obj-code = &3                            buf_history.artic     = &1&4&1 and                           buf_history.prod-type = &1&5&1 and                           buf_history.prod-code = &6 '                           , chr(34)                           , p-obj-type                              , p-obj-code                            , p-artic                               , p-prod-type                           , p-prod-code                           )                           + " " + where-phrase-22
  ...
  run waitfram-hide in this-procedure .
    ...
    when 'doc':U then do:
      assign frame fr-D-doc-line-0 :title = title0 + substitute( 'строк документа "&1"', p-doc-code ).
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-24 as character no-undo .
      ...
      parameter-4-24 =
        (
          if ("                           buf_history.doc-code = p-doc-code                         " + " " + where-phrase-24) <> ""
          then                            substitute( '  uf_history.doc-code = &1&2&1 '                           , chr(34)                           , p-doc-code                              )                           + " " + where-phrase-24
          else "true"
        )
      parameter-5-24 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-24 =
          ("                           buf_history.doc-code = p-doc-code                         " + " " + where-phrase-24 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-doc-lines:handle
  ...
  :
    if query br-doc-lines:handle:get-buffer-handle(1) = (buffer buf_history:handle) then do:
      ...
      parameter-4-24 =
        "where ":u +                            substitute( '  uf_history.doc-code = &1&2&1 '                           , chr(34)                           , p-doc-code                              )                           + " ":u + where-phrase-24 + " ":u + p-find-condition + " " + ""
      parameter-5-24 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-24 = (if p-find-next then "true":u else "false":u )
      parameter-3-24 =  "FOR EACH buf_history"
      parameter-4-24 =
        (
          if ("                           buf_history.doc-code = p-doc-code                         " + " " + where-phrase-24) <> ""
          then                            substitute( '  uf_history.doc-code = &1&2&1 '                           , chr(34)                           , p-doc-code                              )                           + " " + where-phrase-24
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-26 as character no-undo .
      ...
      parameter-4-26 =
        (
          if ("                           buf_history.doc-code  = p-doc-code  and                           buf_history.artic     = p-artic     and                           buf_history.prod-type = p-prod-type and                           buf_history.prod-code = p-prod-code                         " + " " + where-phrase-26) <> ""
          then                            substitute( '                           buf_history.doc-code  = &1&2&1 and                           buf_history.artic     = &1&3&1 and                           buf_history.prod-type = &1&4&1 and                           buf_history.prod-code = &5 '                           , chr(34)                           , p-doc-code                            , p-artic                               , p-prod-type                           , p-prod-code                           )                           + " " + where-phrase-26
          else "true"
        )
      parameter-5-26 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-26 =
          ("                           buf_history.doc-code  = p-doc-code  and                           buf_history.artic     = p-artic     and                           buf_history.prod-type = p-prod-type and                           buf_history.prod-code = p-prod-code                         " + " " + where-phrase-26 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-doc-lines:handle
  ...
  :
    if query br-doc-lines:handle:get-buffer-handle(1) = (buffer buf_history:handle) then do:
      ...
      parameter-4-26 =
        "where ":u +                            substitute( '                           buf_history.doc-code  = &1&2&1 and                           buf_history.artic     = &1&3&1 and                           buf_history.prod-type = &1&4&1 and                           buf_history.prod-code = &5 '                           , chr(34)                           , p-doc-code                            , p-artic                               , p-prod-type                           , p-prod-code                           )                           + " ":u + where-phrase-26 + " ":u + p-find-condition + " " + ""
      parameter-5-26 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-26 = (if p-find-next then "true":u else "false":u )
      parameter-3-26 =  "FOR EACH buf_history"
      parameter-4-26 =
        (
          if ("                           buf_history.doc-code  = p-doc-code  and                           buf_history.artic     = p-artic     and                           buf_history.prod-type = p-prod-type and                           buf_history.prod-code = p-prod-code                         " + " " + where-phrase-26) <> ""
          then                            substitute( '                           buf_history.doc-code  = &1&2&1 and                           buf_history.artic     = &1&3&1 and                           buf_history.prod-type = &1&4&1 and                           buf_history.prod-code = &5 '                           , chr(34)                           , p-doc-code                            , p-artic                               , p-prod-type                           , p-prod-code                           )                           + " " + where-phrase-26
  ...
  if p-open-query <> yes then do: reposition br-doc-lines to recid doc-rec no-error. end.
  run WaitFram-Hide in this-procedure.
  apply "VALUE-CHANGED":U to br-doc-lines in frame fr-D-doc-line-0.
  apply "ENTRY":U         to br-doc-lines in frame fr-D-doc-line-0.
end procedure.
procedure proc-filter :
  assign tbl      = 'c-doc-line'
         ...
         spr      = '':U
         dim      = '0'.
  run fltfield-add in this-procedure ( input 'fact-qnty',      input 'Факт кол-во',          input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  ...
  run fltfield-add in this-procedure ( input 'price-base',     input 'Цена (баз.вал)',       input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  run fltfield-add in this-procedure ( input 'price-cli',      input 'Цена пост. (вал)',     input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  run fltfield-add in this-procedure ( input 'unit-cli',       input 'Ед.изм.пост-ка',       input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  run fltfield-add in this-procedure ( input 'cli-qnty',       input 'По ТТН',               input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  run fltfield-add in this-procedure ( input 'doc-qnty',       input 'Кол-во по док-ту',     input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  ...
  run fltfield-add in this-procedure ( input 'obj-code',       input 'Код объекта учета',    input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  ...
  run fltfield-add in this-procedure ( input 'doc-code',       input 'Номер',                input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  run fltfield-add in this-procedure ( input 'cli-base-rate',  input 'Коэффициент',          input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  run fltfield-add in this-procedure ( input 'prt-root',       input 'root',                 input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  run fltfield-add in this-procedure ( input 'prt-OK',         input 'Шкала',                input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  run fltfield-add in this-procedure ( input 'VAT-pc',         input 'НДС',                  input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  ...
  run fltfield-add in this-procedure ( input 'SLT-pc',         input 'Налог с продаж',       input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  run fltfield-add in this-procedure ( input 'line-num',       input 'Номер',                input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  run fltfield-add in this-procedure ( input 'wt-brutto',      input 'Вес брутто',           input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  run fltfield-add in this-procedure ( input 'num-place',      input 'Количество мест',      input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  run fltfield-add in this-procedure ( input 'road-tax',       input 'Дорожный налог',       input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  run fltfield-add in this-procedure ( input 'excise',         input 'Акциз',                input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  run fltfield-add in this-procedure ( input 'doc-density',    input 'Плотность',            input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  run fltfield-add in this-procedure ( input 'temperature',    input 'Температура',          input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  run fltfield-add in this-procedure ( input 'transport-base', input 'Трансп.(б.в.)',        input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  run fltfield-add in this-procedure ( input 'transport-rubl', input 'Трансп.(руб)', input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  run fltfield-add in this-procedure ( input 'other-base',     input 'Прочие (б.в.)',        input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  run fltfield-add in this-procedure ( input 'other-rubl',     input 'Прочие (руб)', input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  run fltfield-add in this-procedure ( input 'ext-doc-type',   input 'Расш.тип',             input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  ...
  run fltfield-add in this-procedure ( input 'cons-vat-pc',    input 'НДС конс',             input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  run fltfield-add in this-procedure ( input 'cons-slt-pc',    input 'НП конс',              input '':U,    input-output fld, input-output lab, input-output spr, input-output dim ) no-error.
  ...
  do on error   undo Filter-Block, leave Filter-Block
    ...
    if return-value = 'undo':U then do:
      apply "ENTRY":U to browse br-doc-lines.
      return no-apply.
    end.
    assign mark-num = 0
           sch-num  = 0.
    ...
    hide   sch-num  in frame fr-D-doc-line-0.
    run OpenBr in this-procedure ( input yes, input no, input '':U ).
    assign b-sch :tooltip in frame fr-D-doc-line-0 = "Установить/снять фильтр".
  end.
end procedure.
procedure proc-view-changes :
  ...
  do jj = 1 to num-entries( v-chg-fields ) :
    case entry( jj, v-chg-fields ) :
                  ...
                  when "cli-qnty":U then do:     create temp-changes.     assign temp-changes.f_name = "cli-qnty":U            temp-changes.l_name = "По ТТН"            temp-changes.v_old  = string( buf_history.cli-qnty )            temp-changes.v_new  = ( if available new_hist then string( new_hist.cli-qnty )                                                          else string( buf_srch.cli-qnty ) ).   end.
                  ...
                  when "price-cli":U then do:     create temp-changes.     assign temp-changes.f_name = "price-cli":U            temp-changes.l_name = "Цена пост.(б.в)"            temp-changes.v_old  = string( buf_history.price-cli )            temp-changes.v_new  = ( if available new_hist then string( new_hist.price-cli )                                                          else string( buf_srch.price-cli ) ).   end.
                  when "unit-cli":U then do:     create temp-changes.     assign temp-changes.f_name = "unit-cli":U            temp-changes.l_name = "Ед.изм.пост-ка"            temp-changes.v_old  = string( buf_history.unit-cli )            temp-changes.v_new  = ( if available new_hist then string( new_hist.unit-cli )                                                          else string( buf_srch.unit-cli ) ).   end.
                  when "cli-base-rate":U then do:     create temp-changes.     assign temp-changes.f_name = "cli-base-rate":U            temp-changes.l_name = "Коэффициент"            temp-changes.v_old  = string( buf_history.cli-base-rate )            temp-changes.v_new  = ( if available new_hist then string( new_hist.cli-base-rate )                                                          else string( buf_srch.cli-base-rate ) ).   end.
                  when "prt-root":U then do:     create temp-changes.     assign temp-changes.f_name = "prt-root":U            temp-changes.l_name = "Корень"            temp-changes.v_old  = string( buf_history.prt-root )            temp-changes.v_new  = ( if available new_hist then string( new_hist.prt-root )                                                          else string( buf_srch.prt-root ) ).   end.
                  when "prt-OK":U then do:     create temp-changes.     assign temp-changes.f_name = "prt-OK":U            temp-changes.l_name = "Шкала"            temp-changes.v_old  = string( buf_history.prt-OK )            temp-changes.v_new  = ( if available new_hist then string( new_hist.prt-OK )                                                          else string( buf_srch.prt-OK ) ).   end.
                  when "VAT-pc":U then do:     create temp-changes.     assign temp-changes.f_name = "VAT-pc":U            temp-changes.l_name = "НДС"            temp-changes.v_old  = string( buf_history.VAT-pc )            temp-changes.v_new  = ( if available new_hist then string( new_hist.VAT-pc )                                                          else string( buf_srch.VAT-pc ) ).   end.
                  ...
                  when "SLT-pc":U then do:     create temp-changes.     assign temp-changes.f_name = "SLT-pc":U            temp-changes.l_name = "Налог с продаж"            temp-changes.v_old  = string( buf_history.SLT-pc )            temp-changes.v_new  = ( if available new_hist then string( new_hist.SLT-pc )                                                          else string( buf_srch.SLT-pc ) ).   end.
                  when "line-num":U then do:     create temp-changes.     assign temp-changes.f_name = "line-num":U            temp-changes.l_name = "Номер"            temp-changes.v_old  = string( buf_history.line-num )            temp-changes.v_new  = ( if available new_hist then string( new_hist.line-num )                                                          else string( buf_srch.line-num ) ).   end.
                  when "wt-brutto":U then do:     create temp-changes.     assign temp-changes.f_name = "wt-brutto":U            temp-changes.l_name = "Вес брутто"            temp-changes.v_old  = string( buf_history.wt-brutto )            temp-changes.v_new  = ( if available new_hist then string( new_hist.wt-brutto )                                                          else string( buf_srch.wt-brutto ) ).   end.
                  when "num-place":U then do:     create temp-changes.     assign temp-changes.f_name = "num-place":U            temp-changes.l_name = "Кол-во мест"            temp-changes.v_old  = string( buf_history.num-place )            temp-changes.v_new  = ( if available new_hist then string( new_hist.num-place )                                                          else string( buf_srch.num-place ) ).   end.
                  when "road-tax":U then do:     create temp-changes.     assign temp-changes.f_name = "road-tax":U            temp-changes.l_name = "Дор. налог"            temp-changes.v_old  = string( buf_history.road-tax )            temp-changes.v_new  = ( if available new_hist then string( new_hist.road-tax )                                                          else string( buf_srch.road-tax ) ).   end.
                  when "excise":U then do:     create temp-changes.     assign temp-changes.f_name = "excise":U            temp-changes.l_name = "Акциз"            temp-changes.v_old  = string( buf_history.excise )            temp-changes.v_new  = ( if available new_hist then string( new_hist.excise )                                                          else string( buf_srch.excise ) ).   end.
                  when "doc-density":U then do:     create temp-changes.     assign temp-changes.f_name = "doc-density":U            temp-changes.l_name = "Плотность"            temp-changes.v_old  = string( buf_history.doc-density )            temp-changes.v_new  = ( if available new_hist then string( new_hist.doc-density )                                                          else string( buf_srch.doc-density ) ).   end.
                  when "temperature":U then do:     create temp-changes.     assign temp-changes.f_name = "temperature":U            temp-changes.l_name = "Температура"            temp-changes.v_old  = string( buf_history.temperature )            temp-changes.v_new  = ( if available new_hist then string( new_hist.temperature )                                                          else string( buf_srch.temperature ) ).   end.
                  when "transport-base":U then do:     create temp-changes.     assign temp-changes.f_name = "transport-base":U            temp-changes.l_name = "Трансп.(б.в.)"            temp-changes.v_old  = string( buf_history.transport-base )            temp-changes.v_new  = ( if available new_hist then string( new_hist.transport-base )                                                          else string( buf_srch.transport-base ) ).   end.
                  when "transport-rubl":U then do:     create temp-changes.     assign temp-changes.f_name = "transport-rubl":U            temp-changes.l_name = "Трансп.(руб)"            temp-changes.v_old  = string( buf_history.transport-rubl )            temp-changes.v_new  = ( if available new_hist then string( new_hist.transport-rubl )                                                          else string( buf_srch.transport-rubl ) ).   end.
                  when "other-base":U then do:     create temp-changes.     assign temp-changes.f_name = "other-base":U            temp-changes.l_name = "Прочие (б.в.)"            temp-changes.v_old  = string( buf_history.other-base )            temp-changes.v_new  = ( if available new_hist then string( new_hist.other-base )                                                          else string( buf_srch.other-base ) ).   end.
                  when "other-rubl":U then do:     create temp-changes.     assign temp-changes.f_name = "other-rubl":U            temp-changes.l_name = "Прочие (руб)"            temp-changes.v_old  = string( buf_history.other-rubl )            temp-changes.v_new  = ( if available new_hist then string( new_hist.other-rubl )                                                          else string( buf_srch.other-rubl ) ).   end.
                  when "ext-doc-type":U then do:     create temp-changes.     assign temp-changes.f_name = "ext-doc-type":U            temp-changes.l_name = "Расш.тип"            temp-changes.v_old  = string( buf_history.ext-doc-type )            temp-changes.v_new  = ( if available new_hist then string( new_hist.ext-doc-type )                                                          else string( buf_srch.ext-doc-type ) ).   end.
                  ...
                  when "cons-vat-pc":U then do:     create temp-changes.     assign temp-changes.f_name = "cons-vat-pc":U            temp-changes.l_name = "НДС конс"            temp-changes.v_old  = string( buf_history.cons-vat-pc )            temp-changes.v_new  = ( if available new_hist then string( new_hist.cons-vat-pc )                                                          else string( buf_srch.cons-vat-pc ) ).   end.
                  when "cons-slt-pc":U then do:     create temp-changes.     assign temp-changes.f_name = "cons-slt-pc":U            temp-changes.l_name = "НП конс"            temp-changes.v_old  = string( buf_history.cons-slt-pc )            temp-changes.v_new  = ( if available new_hist then string( new_hist.cons-slt-pc )                                                          else string( buf_srch.cons-slt-pc ) ).   end.
    end case.
  end.
  run OpenChanges in this-procedure ( input yes, input no, input '':U ).
end procedure.
...
define input parameter p-filter-name as character no-undo .
  do with frame fr-D-doc-line-0:
    if p-filter-name > "" then do:
      assign
        frame fr-D-doc-line-0:title
          = frame fr-D-doc-line-0:title + "   ФИЛЬТР: " + p-filter-name.
      .
      assign
...
procedure proc-find-doc :
  ...
  if doc-rec <> ? then do:
    ...
    display sch-num with frame fr-D-doc-line-0.
  end.
  else do:
    assign  sch-num = 0.
    hide    sch-num in frame fr-D-doc-line-0.
  end.
  apply "ENTRY":U to sch-doc in frame fr-D-doc-line-0.
end procedure.
procedure proc-find-gds :
  ...
  apply "ENTRY":U to sch-gds in frame fr-D-doc-line-0.
end procedure.
...
procedure get-gds-scale :
  ...
  if available buf_goods then do:
    ...
    if available buf_gds-prt then do:
      assign p-scale = ( if buf_gds-prt.node-name = '_Пустая шкала':U then '-' else
