...
run str/diallog.w (  input parparentproc
              ...
              , input (p-obj-type + chr(4) + string(p-obj-code) + chr(4) +
                ...
                string(p-shift-num) + chr(4) + replace(string(p-shift-date, "99/99/9999"), chr(47) , "":U)
                )
...
FOR EACH buf_cash-desk No-LOCK WHERE
  ...
  if buf_cash-desk.autonomy = integer('2':U) then next _cashdesk.
