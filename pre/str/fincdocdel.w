...
DO:
  ...
  return no-apply.
END.
ON CTRL-J OF FILL-IN-data IN FRAME Dialog-Frame
DO:
...
END.
ON RETURN OF FILL-IN-data IN FRAME Dialog-Frame
DO:
    ...
    reposition BR-c-fin-doc to rowid rowid(buf_c-fin-doc).
END.
ON CTRL-J OF FILL-IN-doc-code IN FRAME Dialog-Frame
DO:
    ...
    reposition BR-c-fin-doc to rowid rowid(buf_c-fin-doc).
END.
ON RETURN OF FILL-IN-doc-code IN FRAME Dialog-Frame
DO:
...
do:
  v-doc-rec = recid(buf_c-fin-doc). run OpenBr in this-procedure ( input yes, input no, input '':U). reposition br-c-fin-doc to recid v-doc-rec no-error. v-doc-rec = ?.
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY BR-c-fin-doc FOR EACH buf_c-fin-doc where (buf_c-fin-doc.host-code = p-curr-host-code) and (buf_c-fin-doc.is-del = yes) by buf_c-fin-doc.corr-date descending.
END PROCEDURE.
PROCEDURE OpenBr :
...
if p-open-query then do:
   for first buf_clients where buf_clients.obj-type = "орг" and buf_clients.obj-code = p-host-code :
    frame Dialog-Frame:TITLE  = "Удаленные финансовые документы" + chr(32) + substitute(" Фирма: (&1) &2", p-host-code, buf_clients.obj-name).
  end.
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-20 as character no-undo .
      assign
      parameter-3-20 =
                              "FOR EACH buf_c-fin-doc"
      parameter-4-20 =
        (
          if (" buf_c-fin-doc.host-code = p-host-code AND buf_c-fin-doc.is-del = yes " + " " + where-phrase-20) <> ""
          then  substitute('buf_c-fin-doc.host-code = &1 AND buf_c-fin-doc.is-del = yes ', p-host-code) + " " + where-phrase-20
          else "true"
        )
      parameter-5-20 = (" " + "" + " " + "")
      parameter-6-20 = if sort-phrase-20 = ''
        ...
        " " + "  " +
          " " + sort-column-phrase +
        " " + " by buf_c-fin-doc.corr-date descending "
        )
                           else
        (
        " " + "  " +
    ...
    :
      assign
        l-disable-where-20 =
          (" buf_c-fin-doc.host-code = p-host-code AND buf_c-fin-doc.is-del = yes " + " " + where-phrase-20 = "")
      .
  ...
  if l-filter-open-20 = false then do:
    OPEN QUERY br-c-fin-doc FOR EACH buf_c-fin-doc
      where  buf_c-fin-doc.host-code = p-host-code AND buf_c-fin-doc.is-del = yes
       by buf_c-fin-doc.corr-date descending
      indexed-reposition
  .
      assign
  ...
  on error undo, leave
  :
    if QUERY br-c-fin-doc:handle:get-buffer-handle(1) = (buffer buf_c-fin-doc:handle) then do:
      assign
      parameter-2-20 = (if p-find-next then "true":u else "false":u )
      parameter-4-20 =
        "where ":u +  substitute('buf_c-fin-doc.host-code = &1 AND buf_c-fin-doc.is-del = yes ', p-host-code) + " ":u + where-phrase-20 + " ":u + p-find-condition + " " + ""
      parameter-5-20 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input QUERY br-c-fin-doc:handle
                          ,input rowid(buf_c-fin-doc)
                          ,input logical(parameter-2-20)
                          ,input no-lock
                          ,input (buffer buf_c-fin-doc:handle)
                          ,input parameter-4-20
                          ,input parameter-5-20
                          ) no-error.
      .
      ...
      assign
      parameter-2-20 = (if p-find-next then "true":u else "false":u )
      parameter-3-20 =  "FOR EACH buf_c-fin-doc"
      parameter-4-20 =
        (
          if (" buf_c-fin-doc.host-code = p-host-code AND buf_c-fin-doc.is-del = yes " + " " + where-phrase-20) <> ""
          then  substitute('buf_c-fin-doc.host-code = &1 AND buf_c-fin-doc.is-del = yes ', p-host-code) + " " + where-phrase-20
...
define variable c-receiver       as character no-undo .
define variable c-payer          as character no-undo .
