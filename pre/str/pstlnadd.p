...
if (valid-handle(ibs.th.gbl.gbl-hndllib:g#lib-trn) <> true) then do:   run str/lib-trn.p persistent no-error .   if error-status :error or (valid-handle(ibs.th.gbl.gbl-hndllib:g#lib-trn) <> true) then do:     message       "Error starting lib-trn.p" skip       ibs.th.gbl.gbl-hndllib:g#lib-trn skip       ibs.th.gbl.gbl-hndllib:g#lib-trn :type skip       ibs.th.gbl.gbl-hndllib:g#lib-trn :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run lib-trn_is-petrl in g#lib-trn
  (
     input bf-add_goods.artic
  ,  input bf-add_goods.prod-type
  ,  input bf-add_goods.prod-code
  , output varis-petrol
  , output varis-pieces
  ) .
if (valid-handle(ibs.th.gbl.gbl-hndllib:g#lib-trn) <> true) then do:   run str/lib-trn.p persistent no-error .   if error-status :error or (valid-handle(ibs.th.gbl.gbl-hndllib:g#lib-trn) <> true) then do:     message       "Error starting lib-trn.p" skip       ibs.th.gbl.gbl-hndllib:g#lib-trn skip       ibs.th.gbl.gbl-hndllib:g#lib-trn :type skip       ibs.th.gbl.gbl-hndllib:g#lib-trn :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run lib-trn_is-petrl in g#lib-trn
  (
     input bf-add-plus_goods.artic
  ,  input bf-add-plus_goods.prod-type
  ,  input bf-add-plus_goods.prod-code
  , output varis-petrol-plus
  , output varis-pieces-plus
  ) .
  if varis-petrol     and
     not varis-pieces then do:
    if not (varoutqnty-kg > 0)  then do:
  ...
  if varis-petrol-plus     and
    ...
    if not (varoutqnty-kg-plus > 0)  then do:
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run objat in g#library
  ...
  ,output varshift-on
        ...
        run factord in parcallback (  input bf_trn-doc.fact-date,
                                      ...
                                      input current-value( s-trn-fact, ub ),
        ...
        for first bf-inv_doc-line where bf-inv_doc-line.obj-type     = bf_trn-doc.obj-type       and
                                        ...
                                        bf-inv_doc-line.ext-doc-type = 'vt':U              and
                                        bf-inv_doc-line.status_      = 'факт':U                   and
                                        ...
                                        bf-inv_doc-line.prod-code    = bf-add_goods.prod-code    and
                                        bf-inv_doc-line.artic        = bf-add_goods.artic        and
                                        bf-inv_doc-line.ext-doc-type = 'vp':U         and
                                        bf-inv_doc-line.status_      = 'факт':U                   and
                                        bf-inv_doc-line.fact-order   > varfact-order             or
                                        bf-inv_doc-line.obj-type     = bf_trn-doc.obj-type       and
                                        bf-inv_doc-line.obj-code     = bf_trn-doc.obj-code       and
                                        ...
                                        bf-inv_doc-line.prod-code    = bf-add_goods.prod-code    and
                                        bf-inv_doc-line.artic        = bf-add_goods.artic        and
                                        bf-inv_doc-line.ext-doc-type = 'ap':U   and
                                        bf-inv_doc-line.status_      = 'факт':U                   and
                                        bf-inv_doc-line.fact-order   > varfact-order             or
                                        bf-inv_doc-line.obj-type     = bf_trn-doc.obj-type       and
                                        bf-inv_doc-line.obj-code     = bf_trn-doc.obj-code       and
                                        ...
                                        bf-inv_doc-line.prod-code    = bf-add_goods.prod-code    and
                                        bf-inv_doc-line.artic        = bf-add_goods.artic        and
                                        bf-inv_doc-line.ext-doc-type = 'pc':U   and
                                        bf-inv_doc-line.status_      = 'факт':U                   and
                                        bf-inv_doc-line.fact-order   > varfact-order             or
                                        bf-inv_doc-line.obj-type     = bf_trn-doc.obj-type       and
                                        bf-inv_doc-line.obj-code     = bf_trn-doc.obj-code       and
                                        ...
                                        bf-inv_doc-line.prod-code    = bf-add_goods.prod-code    and
                                        bf-inv_doc-line.artic        = bf-add_goods.artic        and
                                        bf-inv_doc-line.ext-doc-type = 'mp':U and
                                        bf-inv_doc-line.status_      = 'факт':U                   and
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run pftxvalg in g#library
  (input  bf-add-plus_goods.gds-code
  ,input  '1':U
  ,input  vartax-date
  ,input  bf_trn-doc.host-code
  ,input  bf_trn-doc.obj-type
  ,input  bf_trn-doc.obj-code
  ,output varvat-pc-plus
  ) no-error .
      if error-status:error then do:
...
,input bf_trn-doc.status_
,input bf_trn-doc.ext-doc-type
,input bf-add-plus_goods.prt-root
,input varvat-pc-plus
,input 0
,input bf_sysconf.cons-vat-pc
) no-error
.
    ...
    if varis-petrol     and
      ...
      for each tt-pl-qty on error undo, return error return-value :
        ...
        run trg/rsrv-dtl.p (input parparentproc,
                        'reserv':U + ',' + 'negative-check':U + "=2" + "," + 'plcode':U + "=" + string(tt-pl-qty.pl-code),
...
if (valid-handle(ibs.th.gbl.gbl-hndllib:g#lib-trn) <> true) then do:   run str/lib-trn.p persistent no-error .   if error-status :error or (valid-handle(ibs.th.gbl.gbl-hndllib:g#lib-trn) <> true) then do:     message       "Error starting lib-trn.p" skip       ibs.th.gbl.gbl-hndllib:g#lib-trn skip       ibs.th.gbl.gbl-hndllib:g#lib-trn :type skip       ibs.th.gbl.gbl-hndllib:g#lib-trn :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run lib-trn_crgdsdtl in g#lib-trn
  ( input bf_trn-doc.obj-code
   ...
   ,input bf-add-plus_goods.prod-code
   ,input bf-add-plus_goods.prod-type
   ,input tt-gds-dtl-plus.prt-code
   ,input yes
  ) no-error .
    if error-status:error then do:
...
if (valid-handle(ibs.th.gbl.gbl-hndllib:g#lib-trn3) <> true) then do:   run str/lib-trn3.p persistent no-error .   if error-status :error or (valid-handle(ibs.th.gbl.gbl-hndllib:g#lib-trn3) <> true) then do:     message       "Error starting lib-trn3.p" skip       ibs.th.gbl.gbl-hndllib:g#lib-trn3 skip       ibs.th.gbl.gbl-hndllib:g#lib-trn3 :type skip       ibs.th.gbl.gbl-hndllib:g#lib-trn3 :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run lib-trn3_set-pr in g#lib-trn3
  ( input recid(bf-add-plus_gds-dtl)
  , input no
  , input ?
  ) no-error.
    if error-status:error then do:
