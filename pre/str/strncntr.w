...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  assign
  sum-rubl:label in browse BROWSE-1 = "Сумма (руб)"
  .
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY BROWSE-1 FOR EACH tt-trn-contract BY fact-order.
END PROCEDURE.
