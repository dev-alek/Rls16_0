...
DO:
  ...
  then do:
    ...
    then do:
      assign
        tt-upd-attr.label-attr :fgcolor in browse b-attr = black_color
        tt-upd-attr.hot-key    :fgcolor in browse b-attr = black_color
      .
    end.
    else do:
      assign
        tt-upd-attr.label-attr :fgcolor in browse b-attr = grey_color
        tt-upd-attr.hot-key    :fgcolor in browse b-attr = grey_color
      .
    end.
  end.
END.
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse b-attr :handle
      .
...
do:
  OPEN QUERY b-attr FOR EACH tt-upd-attr where tt-upd-attr.output-display = yes  by tt-upd-attr.sort .
    apply "VALUE-CHANGED" to b-attr.
end.
...
on 'F3':U
  ...
  , 'ALT-F11':U
  , 'ALT-F12':U
of frame Dialog-Frame anywhere
do:
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  RUN enable_UI.
  apply 'entry':u to browse b-attr .
...
PROCEDURE assign-hot-key :
  ...
  :
    ...
    assign
      v-key-number = 0
      v-max-number = num-entries(v-hot-key-list, chr(44))
    .
    ...
    :
      ...
      assign
        buf_tt-upd-attr.hot-key = entry(v-key-number, v-hot-key-list, chr(44))
      .
    end.
  end.
END PROCEDURE.
...
PROCEDURE select-by-hot-key :
  ...
  :
    ...
    then do:
      reposition b-attr to rowid rowid(buf_tt-upd-attr) .
