...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ...
   if tt-table.f1 = "" then  tt-table.f1:visible  in browse BROWSE-4 = false .
   if tt-table.f2 = "" then  tt-table.f2:visible  in browse BROWSE-4 = false .
   if tt-table.f3 = "" then  tt-table.f3:visible  in browse BROWSE-4 = false .
   if tt-table.f4 = "" then  tt-table.f4:visible  in browse BROWSE-4 = false .
   frame Dialog-Frame:TITLE  = entry(1 , p-title , chr(4) ).
   if tt-table.f1 <> "" then tt-table.f1 :label  = entry( 2 , p-title , chr(4) ).
   if tt-table.f2 <> "" then tt-table.f2 :label  = entry( 3 , p-title , chr(4) ).
   if tt-table.f3 <> "" then tt-table.f3 :label  = entry( 4 , p-title , chr(4) ).
   if tt-table.f4 <> "" then tt-table.f4 :label  = entry( 5 , p-title , chr(4) ).
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY BROWSE-4 FOR EACH tt-table .
END PROCEDURE.
