...
CASE pos-type:
  when 'IBM':U then do:
    FOR EACH cash-cash NO-LOCK use-index islr:
      if cash-cash.slr-code > 999 then do:                            run write-log-and-file in p-log-handle (                                                     input 1                                                                              , input log-file-name                                                                  , input 1                                                                              , input substitute("!!!Ошибка: код продавца больше &1: продавец &2 код &3"                                , 999                                                                    , cash-cash.slr-code                                                                   , cash-cash.cash-name)                                                                                  ).                                             assign                                                                                 v-view-log = yes                                                                       .                                                                                      NEXT.                                                                                end.
        PUT stream IBMstream unformatted
        '3 "'
  ...
  when 'IBM-XML':U then do:
    FOR EACH cash-cash NO-LOCK use-index islr:
      if cash-cash.slr-code > 999999999 then do:                            run write-log-and-file in p-log-handle (                                                     input 1                                                                              , input log-file-name                                                                  , input 1                                                                              , input substitute("!!!Ошибка: код продавца больше &1: продавец &2 код &3"                                , 999999999                                                                    , cash-cash.slr-code                                                                   , cash-cash.cash-name)                                                                                  ).                                             assign                                                                                 v-view-log = yes                                                                       .                                                                                      NEXT.                                                                                end.
...
then do:
  ...
  then do:
    run str/post-xml.p
      ...
      ,input 30
      ,input   ( if action = 'U'
                  then ('Ждите - ' + 'добавление продавцов')
                  else ('Ждите - ' + 'удаление продавцов') ) +
...
run write-log-and-file in p-log-handle (
    ...
    , input log-file-name
    , input 1
    , input substitute("Пересылка на кассы &1&2 информации о продавцах", 'маг':U, i-obj-code)
                                          ).
