...
assign
  v-str-recid5 = trim( string( recid( X_c-auto-tank ) , "->>>>>>>>>>>9":U ) )
  v-num-entry5 = lookup( v-str-recid5 , p-rid-list )
.
if v-num-entry5 > 0 then do:
  assign
    entry( v-num-entry5, p-rid-list ) = "":U
    p-rid-list = trim( replace( p-rid-list , chr(44) + chr(44) , chr(44) ) , chr(44) )
  .
end.
else do:
  assign
    p-rid-list = p-rid-list + ( if p-rid-list = "":U then "":U else chr(44) ) + v-str-recid5
  .
end.
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY br-wp FOR EACH X_c-auto-tank NO-LOCK INDEXED-REPOSITION.
END PROCEDURE.
PROCEDURE MyEnable :
assign
...
OPEN QUERY br-wp FOR EACH X_c-auto-tank NO-LOCK
        where X_c-auto-tank.auto-num begins p-auto-num
         and ( X_c-auto-tank.auto-num = p-auto-num or
               X_c-auto-tank.auto-num begins (p-auto-num + "#") )
 by X_c-auto-tank.chip-num descending
                              INDEXED-REPOSITION.
APPLY "VALUE-CHANGED" TO br-wp in frame Dialog-Frame.
...
v-label-param =   "auto-num" + chr(4) + "Номер машины" + chr(4) + ""
 + chr(8) + "brutto-qnty"  + chr(4) + "Вместимость" + chr(4) + ""
 + chr(8) + "name" + chr(4) + "Название" + chr(4) + ""
 + chr(8) + "status_"  + chr(4) + "Статус" + chr(4) + ""
 + chr(8) + "PS" + chr(4) + "Примечание" + chr(4) + ""
 + chr(8) + "tank-type" + chr(4) + "Тип автотранспорта" + chr(4) + ""
 + chr(8) + "plomb-type" + chr(4) + "Тип пломбировки" + chr(4) + ""
 + chr(8) + "cli-type" + chr(4) + "тип поставщика" + chr(4) + ""
 + chr(8) + "cli-code" + chr(4) + "Код поставщика" + chr(4) + ""
.
 run proc-full-temp-changes in this-procedure (
                                             input  buffer X_c-auto-tank:handle
                                            ,input  'auto-tank':U
                                            ,input  "auto-num,brutto-qnty,name,status_,PS,tank-type,plomb-type,cli-type,cli-code"
                                            ,input  v-label-param).
    if can-find (first temp-changes) and ( index(X_c-auto-tank.auto-num, "#") > 0 ) then do:
      ...
      if available buf_temp-changes then do :
        assign
          v-s-old = ENTRY(1, buf_temp-changes.v_old, chr(4))
          v-s-new = ENTRY(1, buf_temp-changes.v_new, chr(4))
        .
        if (v-s-old > "") or (v-s-new > "") then do:
          create temp-changes.
          assign
            temp-changes.t_name = 'auto-tank':U
        ...
        assign
          v-n-old = num-entries(buf_temp-changes.v_old, chr(4))
          v-n-new = num-entries(buf_temp-changes.v_new, chr(4))
        .
        assign
          v-s-old = if v-n-old > 1 then ENTRY(2, buf_temp-changes.v_old, chr(4)) else ""
          v-s-new = if v-n-new > 1 then ENTRY(2, buf_temp-changes.v_new, chr(4)) else ""
        .
        if (v-s-old > "") or (v-s-new > "") then do:
          create temp-changes.
          assign
        ...
        assign
          v-s-old = if v-n-old > 2 then ENTRY(3, buf_temp-changes.v_old, chr(4)) else ""
          v-s-new = if v-n-new > 2 then ENTRY(3, buf_temp-changes.v_new, chr(4)) else ""
        .
        if (v-s-old > "") or (v-s-new > "") then do:
          create temp-changes.
          assign
