...
def var vss-description as character no-undo init "Процедура определения средней учетной цены товара по различным схемам".
