...
DEFINE BROWSE br-docs
  QUERY br-docs NO-LOCK DISPLAY
      mark-string(recid(buf_add-doc),rid-list) COLUMN-LABEL '*' FORMAT "X(1)"
      buf_add-doc.status_ COLUMN-LABEL 'Статус' Format "X(6)"
      buf_add-doc.doc-code COLUMN-LABEL '№ док-та'
      buf_add-doc.doc-date COLUMN-LABEL 'Создан' FORMAT "99/99/99"
      buf_add-doc.fact-date COLUMN-LABEL 'Факт' FORMAT "99/99/99"
      buf_add-doc.obj-code COLUMN-LABEL 'Объект' format ">>>>9"
      buf_add-doc.obj-type COLUMN-LABEL 'Тип' format "x(3)"
      buf_add-doc.sum-rubl COLUMN-LABEL 'Сумма (руб)' format ">>>>>>>>>9.99"
      fo-postavka(recid(buf_add-doc))  @ pp  COLUMN-LABEL 'ФО'  format "X(11)"
      sfactur(recid(buf_add-doc)) @ ff COLUMN-LABEL 'Счет-фактура' format "X(11)"
  ENABLE
       buf_add-doc.status_
...
DEFINE BROWSE br-nakl
  QUERY br-nakl NO-LOCK DISPLAY
      ...
      buf_trn-doc.tot-rubl  COLUMN-LABEL "Сумма (руб)" FORMAT ">>>>>>>>>9.99"
...
do:
  ...
  if not g-log then  return .
   if not ( buf_add-doc.status_ = 'новый':U  ) then do:
      message "Нельзя корректировать документ ДопРасх! " view-as alert-box  .
      return.
  end.
  if   buf_add-doc.status_ = 'новый':U  and
...
DO:
 ...
 message "Закрыть накладную ?"
  ...
  OPEN QUERY br-nakl FOR EACH buf_add-trn WHERE                   buf_add-trn.doc-code = buf_add-doc.doc-code NO-LOCK,              EACH buf_trn-doc  where                  buf_trn-doc.doc-code =  buf_add-trn.trn-doc-code NO-LOCK.
END.
ON CHOOSE OF B-close-trn-all IN FRAME Dialog-Frame
DO:
 define variable rr as recid no-undo .
 if not available buf_add-doc then return.
...
if not available buf_add-doc then return.
do on stop undo, return no-apply :
  find current buf_add-doc exclusive-lock .
end.
...
assign
  v-str-recid17 = trim( string( recid( buf_add-doc ) , "->>>>>>>>>>>9":U ) )
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run usrfulnm in g#library
  (input  buf_add-doc.creid
  ,output loc-creid
  )  .
  display loc-creid with frame Dialog-Frame .
  OPEN QUERY br-nakl FOR EACH buf_add-trn WHERE                   buf_add-trn.doc-code = buf_add-doc.doc-code NO-LOCK,              EACH buf_trn-doc  where                  buf_trn-doc.doc-code =  buf_add-trn.trn-doc-code NO-LOCK.
END.
...
OPEN QUERY br-nakl FOR EACH buf_add-trn WHERE                   buf_add-trn.doc-code = buf_add-doc.doc-code NO-LOCK,              EACH buf_trn-doc  where                  buf_trn-doc.doc-code =  buf_add-trn.trn-doc-code NO-LOCK.
END.
ON CHOOSE OF MENU-ITEM m_gen-10
DO:
define variable rr as recid no-undo .
 if not available buf_add-doc then return.
 if buf_add-doc.status_ <> 'факт':U then do:
...
DO:
   run gen-4 .
END.
ON CHOOSE OF MENU-ITEM m_gen-20
DO:
   run gen-20 .
END.
ON CHOOSE OF MENU-ITEM m_gen-30
DO:
   run gen-30 .
END.
ON CHOOSE OF MENU-ITEM m_gen-40
DO:
   run gen-40 .
END.
ON CHOOSE OF MENU-ITEM m_lookupFO
DO:
 if not available buf_add-doc then return.
    run str/fi-trns.w (
        input parparentproc,
...
assign b-fo :popup-menu in frame Dialog-Frame = menu m-fo :handle.
assign b-fo :menu-mouse = 1.
assign b-fo :menu-key   = "return":u.
assign b-sf :popup-menu in frame Dialog-Frame = menu m-sf :handle.
...
on start-search, ctrl-o of br-docs in frame Dialog-Frame do:
   run sort-brbr-docs
     (input (if available buf_add-doc
             then recid(buf_add-doc)
             else ?
            )
     ).
end.
PROCEDURE sort-brbr-docs :
  ...
  case sort-labelbr-docs:
        when '*'  then DO:   assign       sort-column-name = substitute('dynamic-function(&1mark-string&1, recid(buf_add-doc), &1&2&1)', chr(34), rid-list)     .     run OpenBr(yes, no, '':U).   . END.
        when 'Статус'  then DO:    assign       sort-column-name = "buf_add-doc.status_"     .     run OpenBr(yes, no, '':U).   . END.
        when 'ФО'  then DO:   assign       sort-column-name = substitute('dynamic-function(&1fo-postavka&1,recid(buf_add-doc))',chr(34))     .     run OpenBr(yes, no, '':U).   . END.
        when '№ док-та'  then DO:    assign       sort-column-name = "buf_add-doc.doc-code"     .     run OpenBr(yes, no, '':U).   . END.
        when 'Создан'  then DO:    assign       sort-column-name = "buf_add-doc.doc-date"     .     run OpenBr(yes, no, '':U).   . END.
        when 'Факт'  then DO:    assign       sort-column-name = "buf_add-doc.fact-date"     .     run OpenBr(yes, no, '':U).   . END.
        when 'Объект'  then DO:    assign       sort-column-name = "buf_add-doc.obj-code"     .     run OpenBr(yes, no, '':U).   . END.
        when 'Тип'  then DO:    assign       sort-column-name = "buf_add-doc.obj-type"     .     run OpenBr(yes, no, '':U).   . END.
        when 'Сумма (руб)'  then DO:    assign       sort-column-name = "buf_add-doc.sum-rubl"     .     run OpenBr(yes, no, '':U).   . END.
        when 'Счет-фактура'  then DO:   assign       sort-column-name = substitute('dynamic-function(&1sfactur&1, recid(buf_add-doc))', chr(34))     .     run OpenBr(yes, no, '':U).   . END.
    otherwise do:
      assign
        sort-column-name = ""
      .
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ...
   buf_add-doc.status_:read-only in browse br-docs = true .
   disable  b-rep with frame Dialog-Frame .
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY br-docs FOR EACH buf_add-doc NO-LOCK by buf_add-doc.doc-date desc                                                      by buf_add-doc.doc-code desc .    OPEN QUERY br-nakl FOR EACH buf_add-trn WHERE                   buf_add-trn.doc-code = buf_add-doc.doc-code NO-LOCK,              EACH buf_trn-doc  where                  buf_trn-doc.doc-code =  buf_add-trn.trn-doc-code NO-LOCK.
END PROCEDURE.
...
define variable vss-include-info30 as character format "x(65)" no-undo initial "@(#)$Workfile:currsysk.i $ $Revision: $".
...
do vari = 1 to num-entries (rid-list):
  ...
  if bf_add-doc.status_ <> 'факт':U then do:
    message "Документ " bf_add-doc.status_ " не в статусе " 'факт':U " . Пропускаем."
    view-as alert-box.
    next vari-cycle.
  end.
  ...
  if bf_add-doc.cr-incfo = yes then do:
    ...
    reposition br-docs to recid recid(bf_add-doc) no-error.
    if not error-status:error then do:
      display fo-postavka(recid( bf_add-doc)) @ pp with browse br-docs.
    end.
  end.
end.
assign
...
do vari = 1 to num-entries (rid-list):
  ...
  if bf_add-doc.cr-factur = yes then do:
    ...
    reposition br-docs to recid recid(bf_add-doc) no-error.
    if not error-status:error then do:
      display sfactur (recid( bf_add-doc)) @ ff with browse br-docs.
    end.
  end.
end.
assign
    ...
    for each bf_add-line where bf_add-line.doc-code = bf_add-doc.doc-code on error undo, return error return-value :
      if bf_add-line.contract-code <> 0 then do:
        ...
        if available bf_contract then do:
          if lookup (bf_contract.usl-opl, 'По факту поставки,Отсрочка платежа (по поставке)') > 0 then do:
            assign
              varneed-incfo = yes.
          end.
        end.
...
hide B-close-trn-all in frame Dialog-Frame .
  end.
END PROCEDURE.
PROCEDURE OpenBr :
 do
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-32 as character no-undo .
      assign
      parameter-3-32 =
                              "FOR EACH buf_add-doc"
      parameter-4-32 =
        (
          if (" buf_add-doc.host-code = par-host-code and buf_add-doc.obj-code = p-obj-code and buf_add-doc.obj-type = p-obj-type and buf_add-doc.doc-type = p-doc-type " + " " + where-phrase-32) <> ""
          then substitute(' buf_add-doc.host-code = &2 and buf_add-doc.obj-code = &3 and buf_add-doc.obj-type = &1&4&1  and buf_add-doc.doc-type = &1&5&1 ', chr(34), par-host-code, p-obj-code, p-obj-type, p-doc-type) + " " + where-phrase-32
          else "true"
        )
      parameter-5-32 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-32 =
          (" buf_add-doc.host-code = par-host-code and buf_add-doc.obj-code = p-obj-code and buf_add-doc.obj-type = p-obj-type and buf_add-doc.doc-type = p-doc-type " + " " + where-phrase-32 = "")
      .
  ...
  if l-filter-open-32 = false then do:
    OPEN QUERY br-docs FOR EACH buf_add-doc
      where  buf_add-doc.host-code = par-host-code and buf_add-doc.obj-code = p-obj-code and buf_add-doc.obj-type = p-obj-type and buf_add-doc.doc-type = p-doc-type
  .
      assign
        l-query-was-opened = true
      .
  ...
  assign
    doc-rec = recid( buf_add-doc )
  .
  do
  on stop undo, leave
  on error undo, leave
  :
    if query br-docs:handle:get-buffer-handle(1) = (buffer buf_add-doc:handle) then do:
      assign
      parameter-2-32 = (if p-find-next then "true":u else "false":u )
      parameter-4-32 =
        "where ":u + substitute(' buf_add-doc.host-code = &2 and buf_add-doc.obj-code = &3 and buf_add-doc.obj-type = &1&4&1  and buf_add-doc.doc-type = &1&5&1 ', chr(34), par-host-code, p-obj-code, p-obj-type, p-doc-type) + " ":u + where-phrase-32 + " ":u + p-find-condition + " " + ""
      parameter-5-32 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query br-docs:handle
                          ,input rowid(buf_add-doc)
      ...
      assign
      parameter-2-32 = (if p-find-next then "true":u else "false":u )
      parameter-3-32 =  "FOR EACH buf_add-doc"
      parameter-4-32 =
        (
          if (" buf_add-doc.host-code = par-host-code and buf_add-doc.obj-code = p-obj-code and buf_add-doc.obj-type = p-obj-type and buf_add-doc.doc-type = p-doc-type " + " " + where-phrase-32) <> ""
          then substitute(' buf_add-doc.host-code = &2 and buf_add-doc.obj-code = &3 and buf_add-doc.obj-type = &1&4&1  and buf_add-doc.doc-type = &1&5&1 ', chr(34), par-host-code, p-obj-code, p-obj-type, p-doc-type) + " " + where-phrase-32
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-34 as character no-undo .
      ...
      parameter-4-34 =
        (
          if (" buf_add-doc.host-code = par-host-code and buf_add-doc.obj-code = p-obj-code and buf_add-doc.obj-type = p-obj-type and buf_add-doc.doc-type = p-doc-type  and buf_add-doc.status_= p-status_ " + " " + where-phrase-34) <> ""
          then  substitute(' buf_add-doc.host-code = &2 and buf_add-doc.obj-code = &3 and buf_add-doc.obj-type = &1&4&1  and buf_add-doc.doc-type = &1&5&1 and buf_add-doc.status_ = &1&6&1 ', chr(34), par-host-code, p-obj-code, p-obj-type, p-doc-type, p-status_) + " " + where-phrase-34
          else "true"
        )
      parameter-5-34 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-34 =
          (" buf_add-doc.host-code = par-host-code and buf_add-doc.obj-code = p-obj-code and buf_add-doc.obj-type = p-obj-type and buf_add-doc.doc-type = p-doc-type  and buf_add-doc.status_= p-status_ " + " " + where-phrase-34 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-docs:handle
  ...
  if l-filter-open-34 = false then do:
    OPEN QUERY br-docs FOR EACH buf_add-doc
      where  buf_add-doc.host-code = par-host-code and buf_add-doc.obj-code = p-obj-code and buf_add-doc.obj-type = p-obj-type and buf_add-doc.doc-type = p-doc-type  and buf_add-doc.status_= p-status_
  .
      assign
        l-query-was-opened = true
      .
  ...
  :
    if query br-docs:handle:get-buffer-handle(1) = (buffer buf_add-doc:handle) then do:
      ...
      parameter-4-34 =
        "where ":u +  substitute(' buf_add-doc.host-code = &2 and buf_add-doc.obj-code = &3 and buf_add-doc.obj-type = &1&4&1  and buf_add-doc.doc-type = &1&5&1 and buf_add-doc.status_ = &1&6&1 ', chr(34), par-host-code, p-obj-code, p-obj-type, p-doc-type, p-status_) + " ":u + where-phrase-34 + " ":u + p-find-condition + " " + ""
      parameter-5-34 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-34 = (if p-find-next then "true":u else "false":u )
      parameter-3-34 =  "FOR EACH buf_add-doc"
      parameter-4-34 =
        (
          if (" buf_add-doc.host-code = par-host-code and buf_add-doc.obj-code = p-obj-code and buf_add-doc.obj-type = p-obj-type and buf_add-doc.doc-type = p-doc-type  and buf_add-doc.status_= p-status_ " + " " + where-phrase-34) <> ""
          then  substitute(' buf_add-doc.host-code = &2 and buf_add-doc.obj-code = &3 and buf_add-doc.obj-type = &1&4&1  and buf_add-doc.doc-type = &1&5&1 and buf_add-doc.status_ = &1&6&1 ', chr(34), par-host-code, p-obj-code, p-obj-type, p-doc-type, p-status_) + " " + where-phrase-34
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-36 as character no-undo .
      ...
      parameter-4-36 =
        (
          if (" buf_add-doc.host-code = par-host-code and buf_add-doc.doc-type = p-doc-type " + " " + where-phrase-36) <> ""
          then  substitute(' buf_add-doc.host-code = &2 and buf_add-doc.doc-type = &1&3&1 ', chr(34), par-host-code, p-doc-type) + " " + where-phrase-36
          else "true"
        )
      parameter-5-36 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-36 =
          (" buf_add-doc.host-code = par-host-code and buf_add-doc.doc-type = p-doc-type " + " " + where-phrase-36 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-docs:handle
  ...
  if l-filter-open-36 = false then do:
    OPEN QUERY br-docs FOR EACH buf_add-doc
      where  buf_add-doc.host-code = par-host-code and buf_add-doc.doc-type = p-doc-type
  .
      assign
        l-query-was-opened = true
      .
  ...
  :
    if query br-docs:handle:get-buffer-handle(1) = (buffer buf_add-doc:handle) then do:
      ...
      parameter-4-36 =
        "where ":u +  substitute(' buf_add-doc.host-code = &2 and buf_add-doc.doc-type = &1&3&1 ', chr(34), par-host-code, p-doc-type) + " ":u + where-phrase-36 + " ":u + p-find-condition + " " + ""
      parameter-5-36 = " "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-36 = (if p-find-next then "true":u else "false":u )
      parameter-3-36 =  "FOR EACH buf_add-doc"
      parameter-4-36 =
        (
          if (" buf_add-doc.host-code = par-host-code and buf_add-doc.doc-type = p-doc-type " + " " + where-phrase-36) <> ""
          then  substitute(' buf_add-doc.host-code = &2 and buf_add-doc.doc-type = &1&3&1 ', chr(34), par-host-code, p-doc-type) + " " + where-phrase-36
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-38 as character no-undo .
      ...
      parameter-4-38 =
        (
          if (" buf_add-doc.host-code = par-host-code and buf_add-doc.doc-type = p-doc-type  and buf_add-doc.status_= p-status_ " + " " + where-phrase-38) <> ""
          then  substitute(' buf_add-doc.host-code = &2 and buf_add-doc.doc-type = &1&3&1 and buf_add-doc.status_= &1&4&1 ', chr(34), par-host-code, p-doc-type, p-status_) + " " + where-phrase-38
          else "true"
        )
      parameter-5-38 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-38 =
          (" buf_add-doc.host-code = par-host-code and buf_add-doc.doc-type = p-doc-type  and buf_add-doc.status_= p-status_ " + " " + where-phrase-38 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-docs:handle
  ...
  if l-filter-open-38 = false then do:
    OPEN QUERY br-docs FOR EACH buf_add-doc
      where  buf_add-doc.host-code = par-host-code and buf_add-doc.doc-type = p-doc-type  and buf_add-doc.status_= p-status_
  .
      assign
        l-query-was-opened = true
      .
  ...
  :
    if query br-docs:handle:get-buffer-handle(1) = (buffer buf_add-doc:handle) then do:
      ...
      parameter-4-38 =
        "where ":u +  substitute(' buf_add-doc.host-code = &2 and buf_add-doc.doc-type = &1&3&1 and buf_add-doc.status_= &1&4&1 ', chr(34), par-host-code, p-doc-type, p-status_) + " ":u + where-phrase-38 + " ":u + p-find-condition + " " + ""
      parameter-5-38 = "  "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
      ...
      assign
      parameter-2-38 = (if p-find-next then "true":u else "false":u )
      parameter-3-38 =  "FOR EACH buf_add-doc"
      parameter-4-38 =
        (
          if (" buf_add-doc.host-code = par-host-code and buf_add-doc.doc-type = p-doc-type  and buf_add-doc.status_= p-status_ " + " " + where-phrase-38) <> ""
          then  substitute(' buf_add-doc.host-code = &2 and buf_add-doc.doc-type = &1&3&1 and buf_add-doc.status_= &1&4&1 ', chr(34), par-host-code, p-doc-type, p-status_) + " " + where-phrase-38
...
if g-log = false then return no-apply.
if not available buf_add-doc then return.
if buf_add-doc.status_ = 'новый':U then do:
...
if buf_add-doc.status_ = 'закрыт':U then do:
  g-log = true .
  message
...
DEFINE FRAME prt-frame
 ...
 HEADER  date_string AT 5 format "X(35)"
     ...
     DO WHILE available buf_add-doc :
       v-kol    = v-kol   + 1 .
        Display STREAM PrnLibStream
             buf_add-doc.status_
             buf_add-doc.doc-code
             buf_add-doc.doc-date
             buf_add-doc.fact-date
             buf_add-doc.obj-code
             buf_add-doc.obj-type
             buf_add-doc.sum-rubl
    ...
    with FRAME prt-frame .
        Display STREAM PrnLibStream
        "Итого"    @  buf_add-doc.status_
        "док.шт."  @  buf_add-doc.doc-code
         v-kol     @  buf_add-doc.doc-date
        with FRAME prt-frame .
      DOWN STREAM PrnLibStream 1 with FRAME prt-frame  .
      UNDERLINE  STREAM PrnLibStream
        buf_add-doc.status_
