...
DO:
  assign
    ...
    parobj-code = ?.
END.
ON CHOOSE OF b-choice IN FRAME Dialog-Frame
DO:
 define buffer buf_clients for ub.clients.
 assign
   frame Dialog-Frame varobj-type varobj-code.
...
run userobjs_select-one in this-procedure
  ...
  then do:
    ...
    disp buf_clients.obj-code @ varobj-code
        ...
        buf_clients.obj-name  @ varobj-name with frame Dialog-Frame.
  end.
END.
