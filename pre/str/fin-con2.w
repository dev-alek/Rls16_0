...
DO:
  if available temp_fin-doc then do:
    run str/finconn.w ( input parParentProc, input p-host-code, input 'при':U, input "fin-doc", input string(temp_fin-doc.fin-doc-code)) .
    br-doc:refresh() .
  end.
END.
...
DO:
  if available ub.fin-ob then do:
    run str/finconn.w ( input parParentProc, input p-host-code, input 'при':U, input "fin-ob", input ub.fin-ob.doc-code) .
    br-doc:refresh() .
  end.
END.
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse Br-doc :handle
      .
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY Br-doc FOR EACH temp_fin-doc WHERE TRUE  NO-LOCK INDEXED-REPOSITION.
END PROCEDURE.
PROCEDURE StartProc :
  ...
  DO ii = 1 TO NUM-ENTRIES(p-list) :
    ...
    if ub.contract.doc-type = 'при':U then do:
      if   ub.fin-doc.fin-doc-type = 'ппп':U or ub.fin-doc.fin-doc-type = 'пко':U or ub.fin-doc.fin-doc-type = 'апп':U then
        assign
      ...
      if   ub.fin-doc.fin-doc-type = 'рпп':U or ub.fin-doc.fin-doc-type = 'рко':U or ub.fin-doc.fin-doc-type = 'апр':U then
        assign
          temp_fin-doc.is-plus      = no
          temp_fin-doc.sum-contr     = - temp_fin-doc.sum-contr
          temp_fin-doc.con-sum-contr = - temp_fin-doc.con-sum-contr
