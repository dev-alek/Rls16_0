...
run write-log  in p-log-handle (
                                 input 0
                               , "&DLine").
  run write-log-and-file in p-log-handle (                 input 1                                          , input log-file-name                              , input 1                                          , input substitute(".............Импорт данных по Инвентаризации из ВС")).
    run write-log-and-file in p-log-handle (                 input 1                                          , input log-file-name                              , input 1                                          , input substitute("Импорт данных по инвентаризации из файла &1", file-name)).
...
ImpData1:Route-data_dump ( ) .
  ...
  if error-status:error then do:
    if return-value <> '' then do:
            run write-log-and-file in p-log-handle (                 input 1                                          , input log-file-name                              , input 1                                          , input substitute("Ошибка при сохранении данных по инвентаризации из ВС:&1&2&1&3", chr(10), return-value , error-status :get-message(1)  )).
    end.
