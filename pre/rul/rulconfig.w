...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run currsysk in g#library
  ...
  assign
  v-rum-tables = v-rum-tables + chr(44) + 'ruleset':U +
                                chr(44) + 'prop-head':U +
                                chr(44) + 'rule-profile':U +
                                chr(44) + 'ruledict':U +
                                chr(44) + 'rule':U +
                                chr(44) + 'prop-script':U +
                                chr(44) + 'rule-process':U
                                .
  assign
  v-rum-table-names = v-rum-table-names + chr(44) + 'Кодексы и наборы правил':U +
                                chr(44) + 'Объекты-операнды машины правил':U +
                                chr(44) + 'Профайлы правил':U +
                                chr(44) + 'Словарь RULE-машины':U +
                                chr(44) + 'Правила RULE-машины':U +
                                chr(44) + 'Скрипты RULE-машины':U +
                                chr(44) + 'Звено процесса':U
                                .
  assign
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY br-vrmtables FOR EACH buf_file NO-LOCK WHERE lookup(buf_file._file-name,        v-rum-tables) > 0.
END PROCEDURE.
PROCEDURE MyEnable :
ASSIGN
