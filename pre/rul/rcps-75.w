...
DEFINE BUFFER buf2_conf-export FOR conf-export.
  ...
  DO TRANSACTION:
    ...
    release buf1_conf-export.
  END.
  OPEN QUERY br-fields FOR EACH conf-export WHERE true         .
...
CREATE conf-export.                                               ASSIGN                                                            conf-export.table-name = 'prod-bc':U                          conf-export.field-name = "b-str"                          conf-export.full-field-name = 'prod-bc':U + "." + "b-str"    conf-export.field-label = "ДопБК"                       conf-export.is-mandatory = no                      conf-export.to-export = (IF conf-export.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-export.POSITION_ = v-position + 1                            v-position =  v-position + 1.
CREATE conf-export.                                               ASSIGN                                                            conf-export.table-name = 'contract-specif':U                          conf-export.field-name = "artic"                          conf-export.full-field-name = 'contract-specif':U + "." + "artic"    conf-export.field-label = "Артикул в IBS TH"                       conf-export.is-mandatory = no                      conf-export.to-export = (IF conf-export.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-export.POSITION_ = v-position + 1                            v-position =  v-position + 1.
CREATE conf-export.                                               ASSIGN                                                            conf-export.table-name = 'contract-specif':U                          conf-export.field-name = "prod-type"                          conf-export.full-field-name = 'contract-specif':U + "." + "prod-type"    conf-export.field-label = "Тип производителя в IBS TH"                       conf-export.is-mandatory = no                      conf-export.to-export = (IF conf-export.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-export.POSITION_ = v-position + 1                            v-position =  v-position + 1.
CREATE conf-export.                                               ASSIGN                                                            conf-export.table-name = 'contract-specif':U                          conf-export.field-name = "prod-code"                          conf-export.full-field-name = 'contract-specif':U + "." + "prod-code"    conf-export.field-label = "Код производителя в IBS TH"                       conf-export.is-mandatory = no                      conf-export.to-export = (IF conf-export.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-export.POSITION_ = v-position + 1                            v-position =  v-position + 1.
CREATE conf-export.                                               ASSIGN                                                            conf-export.table-name = 'contract-specif':U                          conf-export.field-name = "price-cli"                          conf-export.full-field-name = 'contract-specif':U + "." + "price-cli"    conf-export.field-label = "Цена поставщика"                       conf-export.is-mandatory = no                      conf-export.to-export = (IF conf-export.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-export.POSITION_ = v-position + 1                            v-position =  v-position + 1.
CREATE conf-export.                                               ASSIGN                                                            conf-export.table-name = 'contract-specif':U                          conf-export.field-name = "prc"                          conf-export.full-field-name = 'contract-specif':U + "." + "prc"    conf-export.field-label = "% отклонения в большую сторону"                       conf-export.is-mandatory = no                      conf-export.to-export = (IF conf-export.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-export.POSITION_ = v-position + 1                            v-position =  v-position + 1.
CREATE conf-export.                                               ASSIGN                                                            conf-export.table-name = 'contract-specif':U                          conf-export.field-name = "qnty"                          conf-export.full-field-name = 'contract-specif':U + "." + "qnty"    conf-export.field-label = "Количество"                       conf-export.is-mandatory = no                      conf-export.to-export = (IF conf-export.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-export.POSITION_ = v-position + 1                            v-position =  v-position + 1.
CREATE conf-export.                                               ASSIGN                                                            conf-export.table-name = 'contract-specif':U                          conf-export.field-name = "cli-base-rate"                          conf-export.full-field-name = 'contract-specif':U + "." + "cli-base-rate"    conf-export.field-label = "коэфф.ед.изм"                       conf-export.is-mandatory = no                      conf-export.to-export = (IF conf-export.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-export.POSITION_ = v-position + 1                            v-position =  v-position + 1.
CREATE conf-export.                                               ASSIGN                                                            conf-export.table-name = 'contract-specif':U                          conf-export.field-name = "vat-type"                          conf-export.full-field-name = 'contract-specif':U + "." + "vat-type"    conf-export.field-label = "Тип НДС"                       conf-export.is-mandatory = no                      conf-export.to-export = (IF conf-export.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-export.POSITION_ = v-position + 1                            v-position =  v-position + 1.
CREATE conf-export.                                               ASSIGN                                                            conf-export.table-name = 'contract-specif':U                          conf-export.field-name = "vat-pc"                          conf-export.full-field-name = 'contract-specif':U + "." + "vat-pc"    conf-export.field-label = "НДС"                       conf-export.is-mandatory = no                      conf-export.to-export = (IF conf-export.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-export.POSITION_ = v-position + 1                            v-position =  v-position + 1.
CREATE conf-export.                                               ASSIGN                                                            conf-export.table-name = 'contract-specif':U                          conf-export.field-name = "bonus"                          conf-export.full-field-name = 'contract-specif':U + "." + "bonus"    conf-export.field-label = "Бонус"                       conf-export.is-mandatory = no                      conf-export.to-export = (IF conf-export.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-export.POSITION_ = v-position + 1                            v-position =  v-position + 1.
CREATE conf-export.                                               ASSIGN                                                            conf-export.table-name = 'goods':U                          conf-export.field-name = "gds-name"                          conf-export.full-field-name = 'goods':U + "." + "gds-name"    conf-export.field-label = "Наименование в IBS TH"                       conf-export.is-mandatory = no                      conf-export.to-export = (IF conf-export.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-export.POSITION_ = v-position + 1                            v-position =  v-position + 1.
CREATE conf-export.                                               ASSIGN                                                            conf-export.table-name = 'goods':U                          conf-export.field-name = "qnty-cart"                          conf-export.full-field-name = 'goods':U + "." + "qnty-cart"    conf-export.field-label = "Кол-во в упаковке"                       conf-export.is-mandatory = no                      conf-export.to-export = (IF conf-export.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-export.POSITION_ = v-position + 1                            v-position =  v-position + 1.
CREATE conf-export.                                               ASSIGN                                                            conf-export.table-name = 'ext-artic':U                          conf-export.field-name = "ext-artic"                          conf-export.full-field-name = 'ext-artic':U + "." + "ext-artic"    conf-export.field-label = "Артикул поставщика"                       conf-export.is-mandatory = no                      conf-export.to-export = (IF conf-export.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-export.POSITION_ = v-position + 1                            v-position =  v-position + 1.
CREATE conf-export.                                               ASSIGN                                                            conf-export.table-name = 'gds-obj':U                          conf-export.field-name = "price-sale"                          conf-export.full-field-name = 'gds-obj':U + "." + "price-sale"    conf-export.field-label = "Текущая цена в IBS TH"                       conf-export.is-mandatory = no                      conf-export.to-export = (IF conf-export.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-export.POSITION_ = v-position + 1                            v-position =  v-position + 1.
CREATE conf-export.                                               ASSIGN                                                            conf-export.table-name = 'goods':U                          conf-export.field-name = "DeadLine"                          conf-export.full-field-name = 'goods':U + "." + "DeadLine"    conf-export.field-label = "Срок хранения (дней)"                       conf-export.is-mandatory = no                      conf-export.to-export = (IF conf-export.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-export.POSITION_ = v-position + 1                            v-position =  v-position + 1.
CREATE conf-export.                                               ASSIGN                                                            conf-export.table-name = 'clients':U                          conf-export.field-name = "Obj-name"                          conf-export.full-field-name = 'clients':U + "." + "Obj-name"    conf-export.field-label = "Наименование производителя"                       conf-export.is-mandatory = no                      conf-export.to-export = (IF conf-export.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-export.POSITION_ = v-position + 1                            v-position =  v-position + 1.
CREATE conf-export.                                               ASSIGN                                                            conf-export.table-name = 'clients':U                          conf-export.field-name = "prc-min"                          conf-export.full-field-name = 'clients':U + "." + "prc-min"    conf-export.field-label = "% отклонения в меньшую сторону"                       conf-export.is-mandatory = no                      conf-export.to-export = (IF conf-export.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-export.POSITION_ = v-position + 1                            v-position =  v-position + 1.
END PROCEDURE.
...
ASSIGN
FRAME Dialog-Frame:TITLE = substitute("Параметры экспорта спецификацией по профайлу &1", p-profile-id).
assign
