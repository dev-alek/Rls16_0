...
Tot-period-obj1 = new Dis-tot_obj( input parparentproc, input p-parent-handle, input p-log-handle, input this-procedure:handle, input p-cont-handle, input v-current-lock, input v-current-wait, input v-save, input 5) .
...
Tot-period-obj1:Dis-tot_objrelease_ ( ) .
