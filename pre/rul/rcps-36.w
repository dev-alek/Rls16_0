...
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = 'clients':U                          conf-import.field-name = "OBJ-TYPE"                          conf-import.full-field-name = 'clients':U + "." + "OBJ-TYPE"    conf-import.field-label = "Тип клиента"                       conf-import.is-mandatory = YES                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'clients':U                          conf-import.field-name = "OBJ-TYPE"                          conf-import.full-field-name = 'clients':U + "." + "OBJ-TYPE"    conf-import.field-label = "Тип клиента"                       conf-import.is-mandatory = YES                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = 'clients':U                          conf-import.field-name = "OBJ-code"                          conf-import.full-field-name = 'clients':U + "." + "OBJ-code"    conf-import.field-label = "Код клиента"                       conf-import.is-mandatory = YES                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'clients':U                          conf-import.field-name = "OBJ-code"                          conf-import.full-field-name = 'clients':U + "." + "OBJ-code"    conf-import.field-label = "Код клиента"                       conf-import.is-mandatory = YES                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = 'clients':U                          conf-import.field-name = "OBJ-name"                          conf-import.full-field-name = 'clients':U + "." + "OBJ-name"    conf-import.field-label = "Название"                       conf-import.is-mandatory = YES                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'clients':U                          conf-import.field-name = "OBJ-name"                          conf-import.full-field-name = 'clients':U + "." + "OBJ-name"    conf-import.field-label = "Название"                       conf-import.is-mandatory = YES                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = 'firm':U                          conf-import.field-name = "inn"                          conf-import.full-field-name = 'firm':U + "." + "inn"    conf-import.field-label = "ИНН"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = 'firm':U                          conf-import.field-name = "okpo"                          conf-import.full-field-name = 'firm':U + "." + "okpo"    conf-import.field-label = "ОКПО"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = 'firm':U                          conf-import.field-name = "okonh"                          conf-import.full-field-name = 'firm':U + "." + "okonh"    conf-import.field-label = "ОКОНХ"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = 'firm':U                          conf-import.field-name = "kpp"                          conf-import.full-field-name = 'firm':U + "." + "kpp"    conf-import.field-label = "КПП"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = 'firm':U                          conf-import.field-name = "phone"                          conf-import.full-field-name = 'firm':U + "." + "phone"    conf-import.field-label = "№ телефона"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = 'firm':U                          conf-import.field-name = "phone-note"                          conf-import.full-field-name = 'firm':U + "." + "phone-note"    conf-import.field-label = "Примеч. к № телефона"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = 'firm':U                          conf-import.field-name = "fax"                          conf-import.full-field-name = 'firm':U + "." + "fax"    conf-import.field-label = "№ факса"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = 'firm':U                          conf-import.field-name = "e-mail"                          conf-import.full-field-name = 'firm':U + "." + "e-mail"    conf-import.field-label = "E-mail"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = 'firm':U                          conf-import.field-name = "city"                          conf-import.full-field-name = 'firm':U + "." + "city"    conf-import.field-label = "Город"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = 'firm':U                          conf-import.field-name = "ind"                          conf-import.full-field-name = 'firm':U + "." + "ind"    conf-import.field-label = "Почтовый индекс"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = 'firm':U                          conf-import.field-name = "addres1"                          conf-import.full-field-name = 'firm':U + "." + "addres1"    conf-import.field-label = "Юридический адрес 1"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = 'firm':U                          conf-import.field-name = "addres2"                          conf-import.full-field-name = 'firm':U + "." + "addres2"    conf-import.field-label = "Юридический адрес 2"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = 'firm':U                          conf-import.field-name = "post-addr1"                          conf-import.full-field-name = 'firm':U + "." + "post-addr1"    conf-import.field-label = "Почтовый адрес 1"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = 'firm':U                          conf-import.field-name = "post-addr2"                          conf-import.full-field-name = 'firm':U + "." + "post-addr2"    conf-import.field-label = "Почтовый адрес 2"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = 'firm':U                          conf-import.field-name = "post-city"                          conf-import.full-field-name = 'firm':U + "." + "post-city"    conf-import.field-label = "Город (для почтового адреса)"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = 'firm':U                          conf-import.field-name = "post-ind"                          conf-import.full-field-name = 'firm':U + "." + "post-ind"    conf-import.field-label = "Индекс (для почтового адреса"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = 'firm':U                          conf-import.field-name = "telex"                          conf-import.full-field-name = 'firm':U + "." + "telex"    conf-import.field-label = "Телекс"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = 'firm':U                          conf-import.field-name = "engl-name"                          conf-import.full-field-name = 'firm':U + "." + "engl-name"    conf-import.field-label = "Английское название"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = 'firm':U                          conf-import.field-name = "director"                          conf-import.full-field-name = 'firm':U + "." + "director"    conf-import.field-label = "Руководитель"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = 'firm':U                          conf-import.field-name = "contact-psn"                          conf-import.full-field-name = 'firm':U + "." + "contact-psn"    conf-import.field-label = "Контактное лицо"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = 'firm':U                          conf-import.field-name = "is-pboul"                          conf-import.full-field-name = 'firm':U + "." + "is-pboul"    conf-import.field-label = "ПБОЮЛ"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = 'firm':U                          conf-import.field-name = "tobj-code"                          conf-import.full-field-name = 'firm':U + "." + "tobj-code"    conf-import.field-label = "Код торгового представителя"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = 'clients':U                          conf-import.field-name = "reg-code"                          conf-import.full-field-name = 'clients':U + "." + "reg-code"    conf-import.field-label = "Код региона"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'firm':U                                conf-import.table-name = ''                          conf-import.field-name = "parus-2-code"                          conf-import.full-field-name = '' + "." + "parus-2-code"    conf-import.field-label = "Код во классиф.ПАРУС-2"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'person':U                          conf-import.field-name = "inn"                          conf-import.full-field-name = 'person':U + "." + "inn"    conf-import.field-label = "ИНН"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'person':U                          conf-import.field-name = "okpo"                          conf-import.full-field-name = 'person':U + "." + "okpo"    conf-import.field-label = "ОКПО"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'person':U                          conf-import.field-name = "okonh"                          conf-import.full-field-name = 'person':U + "." + "okonh"    conf-import.field-label = "ОКОНХ"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'person':U                          conf-import.field-name = "kpp"                          conf-import.full-field-name = 'person':U + "." + "kpp"    conf-import.field-label = "КПП"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'person':U                          conf-import.field-name = "phone1"                          conf-import.full-field-name = 'person':U + "." + "phone1"    conf-import.field-label = "№ телефона"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'person':U                          conf-import.field-name = "phone1-note"                          conf-import.full-field-name = 'person':U + "." + "phone1-note"    conf-import.field-label = "Примеч. к № телефона"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'person':U                          conf-import.field-name = "fax"                          conf-import.full-field-name = 'person':U + "." + "fax"    conf-import.field-label = "№ факса"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'person':U                          conf-import.field-name = "e-mail"                          conf-import.full-field-name = 'person':U + "." + "e-mail"    conf-import.field-label = "E-mail"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'person':U                          conf-import.field-name = "city"                          conf-import.full-field-name = 'person':U + "." + "city"    conf-import.field-label = "Город по месту рег."                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'person':U                          conf-import.field-name = "ind"                          conf-import.full-field-name = 'person':U + "." + "ind"    conf-import.field-label = "Индекс по месту рег."                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'person':U                          conf-import.field-name = "address"                          conf-import.full-field-name = 'person':U + "." + "address"    conf-import.field-label = "Адрес по месту рег."                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'person':U                          conf-import.field-name = "post-city"                          conf-import.full-field-name = 'person':U + "." + "post-city"    conf-import.field-label = "Город для почт.адреса"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'person':U                          conf-import.field-name = "post-ind"                          conf-import.full-field-name = 'person':U + "." + "post-ind"    conf-import.field-label = "Индекс для почт.адреса"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'person':U                          conf-import.field-name = "post-address"                          conf-import.full-field-name = 'person':U + "." + "post-address"    conf-import.field-label = "Почтовый адрес"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'person':U                          conf-import.field-name = "name1"                          conf-import.full-field-name = 'person':U + "." + "name1"    conf-import.field-label = "Имя"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'person':U                          conf-import.field-name = "name2"                          conf-import.full-field-name = 'person':U + "." + "name2"    conf-import.field-label = "Отчество"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'person':U                          conf-import.field-name = "passp-ser"                          conf-import.full-field-name = 'person':U + "." + "passp-ser"    conf-import.field-label = "Серия паспорта"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'person':U                          conf-import.field-name = "passp-num"                          conf-import.full-field-name = 'person':U + "." + "passp-num"    conf-import.field-label = "№ паспорта"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'person':U                          conf-import.field-name = "given-by"                          conf-import.full-field-name = 'person':U + "." + "given-by"    conf-import.field-label = "Паспорт выдан"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'person':U                          conf-import.field-name = "position"                          conf-import.full-field-name = 'person':U + "." + "position"    conf-import.field-label = "Должность"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'person':U                          conf-import.field-name = "firm-name"                          conf-import.full-field-name = 'person':U + "." + "firm-name"    conf-import.field-label = "Организация"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'person':U                          conf-import.field-name = "firm-code"                          conf-import.full-field-name = 'person':U + "." + "firm-code"    conf-import.field-label = "Код организации"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'person':U                          conf-import.field-name = "post-box"                          conf-import.full-field-name = 'person':U + "." + "post-box"    conf-import.field-label = "Абонентский п/я"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'person':U                          conf-import.field-name = "is-pboul"                          conf-import.full-field-name = 'person':U + "." + "is-pboul"    conf-import.field-label = "ПБОЮЛ"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = 'clients':U                          conf-import.field-name = "reg-code"                          conf-import.full-field-name = 'clients':U + "." + "reg-code"    conf-import.field-label = "Код региона"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
CREATE conf-import.                                               ASSIGN                                                            conf-import.subject = 'person':U                                conf-import.table-name = '.'                          conf-import.field-name = "parus-2-code"                          conf-import.full-field-name = '.' + "." + "parus-2-code"    conf-import.field-label = "Код во классиф.ПАРУС-2"                       conf-import.is-mandatory = NO                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = (IF conf-import.subject = 'firm':U                           THEN v-position-firm + 1                                           ELSE v-position-person + 1)                   v-position-firm =  (IF conf-import.subject = 'firm':U               THEN v-position-firm + 1                                             ELSE v-position-firm)                                   v-position-person =  (IF conf-import.subject = 'person':U             THEN v-position-person + 1                                           ELSE v-position-person).
END PROCEDURE.
...
v-index-id = 0.
for each buf_conf-import where buf_conf-import.subject = 'firm':U
...
v-index-id = 0.
for each buf_conf-import where buf_conf-import.subject = 'person':U
and buf_conf-import.to-import = no
and buf_conf-import.position_ < 1000
:
 v-index-id = v-index-id + 1.
...
ASSIGN
FRAME Dialog-Frame:TITLE = substitute("Параметры импорта клиентов по профайлу &1", p-profile-id).
assign
...
WITH FRAME Dialog-Frame.
RUN rcps_OpenBr in THIS-PROCEDURE.
HIDE br-rcp IN FRAME Dialog-Frame.
