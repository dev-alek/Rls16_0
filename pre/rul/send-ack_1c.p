...
v-target-dir = oxml-exch-dir + chr(92) + v-work-dir .
assign
...
v-filename = v-target-dir + chr(92) + v-file-no-ext + ".xml" .
    ...
    if valid-object (p-pkcs) then do on error undo, throw :
      ...
      COPY-LOB FROM OBJECT v-signdata TO FILE v-sign-file NO-CONVERT .
        ...
        if v-err-msg > "" then . else do :
          ...
          if v-err-msg > "" then . else v-err-msg = "AppError в модуле c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\rul\send-ack_1c.p" .
        end .
      end catch .
      catch exProErrors as class Progress.Lang.ProError :
        v-err-msg = exProErrors:GetMessage(1) .
        if v-err-msg > "" then . else v-err-msg = "ProError в модуле c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\rul\send-ack_1c.p" .
      end catch .
      catch exAnyErrors as class Progress.Lang.Error:
        v-err-msg = "Unexpected error в модуле c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\rul\send-ack_1c.p " + exAnyErrors:GetMessage(1).
      end catch .
      finally:
