...
define variable glog23 as logical no-undo .
...
if not available buf_temp-call-param then do:
  ...
  for each buf_drt-prop no-lock where
    ...
    on error  undo , return error substitute( "&1. &2&3&4", vss-include-info23,  return-value, chr(10), error-status :get-message (1))
    on stop   undo , return error substitute( "&1. stop", vss-include-info23 )
    on endkey undo , return error substitute( "&1. endkey", vss-include-info23 ):
    if integer(buf_drt-prop.prop-code) = 0 then do:
      ...
      .
      glog23 = p-dr-flddf:find-first( substitute(' where fld-df = &1&2&1', chr(34), buf_temp-call-param.fld-df, chr(34))) no-error.
      ...
      .
      glog23 = p-dr-flddf:find-first( substitute(' where fld-df = &1&2&1', chr(34), buf2_temp-call-param.fld-df, chr(34))) no-error.
      if p-dr-flddf:available = no then do:
        message
        substitute("Не определен регистр &1 параметра &2 для расчета скидок/бонусов по правилу с шаблоном &3"
...
define variable vss-include-info25 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
  define variable glog25 as logical   no-undo .
  define variable v-dt-tp25  as character no-undo .
  ...
  on error  undo , return error substitute( "&1. &2&3&4", vss-include-info25,  return-value, chr(10), error-status :get-message (1))
  ...
  on endkey undo , return error substitute( "&1. endkey", vss-include-info25 ):
      ...
      do:
         case buf2_temp-call-param.param-datatype_:
            ...
            do:
    glog25 = buf_temp-call-param.call-handle_:set-parameter( buf2_temp-call-param.param-num
  ...
  buf_temp-call-param.call-handle_:invoke.
    ...
    do:
       v-dt-tp25 = v-bh[buf_temp-call-param.table-no]:buffer-field(buf_temp-call-param.field-name_):data-type .
       if v-dt-tp25 = "decimal" or v-dt-tp25 = "integer" then
       do:
...
define variable glog27 as logical no-undo .
find first buf_temp-call-param where
        buf_temp-call-param.call-name_ = substitute("dis-rule_rf_&1&2", string(v-templ-rl-root, "99999"), v-inversed-chr)
    and buf_temp-call-param.param-num = 0 no-error .
if not available buf_temp-call-param then do:
  ...
  for each buf_drt-prop no-lock where
          buf_drt-prop.templ-rl-root = v-templ-rl-root
      and buf_drt-prop.upper-prop-code = "Run-params" + v-inversed-chr
    on error  undo , return error substitute( "&1. &2&3&4", vss-include-info27,  return-value, chr(10), error-status :get-message (1))
    ...
    if integer(buf_drt-prop.prop-code) = 0 then do:
      ...
      buf_temp-call-param.fld-df = entry(5, buf_drt-prop.property-value)
      .
      glog27 = p-dr-flddf:find-first( substitute(' where fld-df = &1&2&1', chr(34), buf_temp-call-param.fld-df, chr(34))) no-error.
      if p-dr-flddf:available = no then do:
        message
        substitute("Не определен регистр &1 параметра &2 для расчета скидок/бонусов по правилу с шаблоном &3"
                                      ,buf_temp-call-param.fld-df
      ...
      buf2_temp-call-param.fld-df = entry(5, buf_drt-prop.property-value)
      .
      glog27 = p-dr-flddf:find-first( substitute(' where fld-df = &1&2&1', chr(34), buf2_temp-call-param.fld-df, chr(34))) no-error.
      if p-dr-flddf:available = no then do:
        message
        substitute("Не определен регистр &1 параметра &2 для расчета скидок/бонусов по правилу с шаблоном &3"
                                      ,buf2_temp-call-param.fld-df
...
define variable vss-include-info29 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
  define variable glog29 as logical   no-undo .
  define variable v-dt-tp29  as character no-undo .
  for each buf2_temp-call-param where
          buf2_temp-call-param.param-num > 0
      and buf2_temp-call-param.call-name_ = substitute("dis-rule_rf_&1&2", string(v-templ-rl-root, "99999"), v-inversed-chr)
  on error  undo , return error substitute( "&1. &2&3&4", vss-include-info29,  return-value, chr(10), error-status :get-message (1))
  on stop   undo , return error substitute( "&1. stop", vss-include-info29 )
  on endkey undo , return error substitute( "&1. endkey", vss-include-info29 ):
      if v-bh[buf2_temp-call-param.table-no]:buffer-field(buf2_temp-call-param.field-name_):buffer-value = ? then
      do:
         case buf2_temp-call-param.param-datatype_:
            when "decimal"  or when "integer" then
            do:
    glog29 = buf_temp-call-param.call-handle_:set-parameter( buf2_temp-call-param.param-num
                                                    ,buf2_temp-call-param.param-datatype_
                                                    ,buf2_temp-call-param.io-mode
                                                    ,0
                                                    ).
  ...
  buf_temp-call-param.call-handle_:invoke.
    if buf_temp-call-param.call-handle_:return-value = ? then
    do:
       v-dt-tp29 = v-bh[buf_temp-call-param.table-no]:buffer-field(buf_temp-call-param.field-name_):data-type .
       if v-dt-tp29 = "decimal" or v-dt-tp29 = "integer" then
       do:
v-bh[buf_temp-call-param.table-no]:buffer-field(buf_temp-call-param.field-name_):buffer-value = 0 .
       end.
    end.
...
define variable glog31 as logical no-undo .
find first buf_temp-call-param where
        buf_temp-call-param.call-name_ = substitute("dis-rule_rf_&1&2", string(v-templ-rl-root, "99999"), v-inversed-chr)
    and buf_temp-call-param.param-num = 0 no-error .
if not available buf_temp-call-param then do:
  ...
  for each buf_drt-prop no-lock where
    ...
    on stop   undo , return error substitute( "&1. stop", vss-include-info31 )
    on endkey undo , return error substitute( "&1. endkey", vss-include-info31 ):
    if integer(buf_drt-prop.prop-code) = 0 then do:
      assign
      buf_temp-call-param.call-name_ = substitute("dis-rule_rf_&1&2", string(v-templ-rl-root, "99999"), v-inversed-chr)
      buf_temp-call-param.param-number_ = integer(buf_drt-prop.prop-code)
      ...
      buf_temp-call-param.fld-df = entry(5, buf_drt-prop.property-value)
      .
      glog31 = p-dr-flddf:find-first( substitute(' where fld-df = &1&2&1', chr(34), buf_temp-call-param.fld-df, chr(34))) no-error.
      if p-dr-flddf:available = no then do:
        message
        substitute("Не определен регистр &1 параметра &2 для расчета скидок/бонусов по правилу с шаблоном &3"
                                      ,buf_temp-call-param.fld-df
      ...
      buf2_temp-call-param.fld-df = entry(5, buf_drt-prop.property-value)
      .
      glog31 = p-dr-flddf:find-first( substitute(' where fld-df = &1&2&1', chr(34), buf2_temp-call-param.fld-df, chr(34))) no-error.
      if p-dr-flddf:available = no then do:
        message
        substitute("Не определен регистр &1 параметра &2 для расчета скидок/бонусов по правилу с шаблоном &3"
                                      ,buf2_temp-call-param.fld-df
...
define variable vss-include-info33 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
  define variable glog33 as logical   no-undo .
  define variable v-dt-tp33  as character no-undo .
  for each buf2_temp-call-param where
          buf2_temp-call-param.param-num > 0
      and buf2_temp-call-param.call-name_ = substitute("dis-rule_rf_&1&2", string(v-templ-rl-root, "99999"), v-inversed-chr)
  on error  undo , return error substitute( "&1. &2&3&4", vss-include-info33,  return-value, chr(10), error-status :get-message (1))
  on stop   undo , return error substitute( "&1. stop", vss-include-info33 )
  on endkey undo , return error substitute( "&1. endkey", vss-include-info33 ):
      if v-bh[buf2_temp-call-param.table-no]:buffer-field(buf2_temp-call-param.field-name_):buffer-value = ? then
      do:
         case buf2_temp-call-param.param-datatype_:
            when "decimal"  or when "integer" then
            do:
    glog33 = buf_temp-call-param.call-handle_:set-parameter( buf2_temp-call-param.param-num
                                                    ,buf2_temp-call-param.param-datatype_
                                                    ,buf2_temp-call-param.io-mode
                                                    ,0
                                                    ).
  ...
  buf_temp-call-param.call-handle_:invoke.
    if buf_temp-call-param.call-handle_:return-value = ? then
    do:
       v-dt-tp33 = v-bh[buf_temp-call-param.table-no]:buffer-field(buf_temp-call-param.field-name_):data-type .
       if v-dt-tp33 = "decimal" or v-dt-tp33 = "integer" then
       do:
v-bh[buf_temp-call-param.table-no]:buffer-field(buf_temp-call-param.field-name_):buffer-value = 0 .
       end.
    end.
...
define variable glog35 as logical no-undo .
find first buf_temp-call-param where
        buf_temp-call-param.call-name_ = substitute("dis-rule_rf_&1&2", string(v-templ-rl-root, "99999"), v-inversed-chr)
    and buf_temp-call-param.param-num = 0 no-error .
if not available buf_temp-call-param then do:
  ...
  for each buf_drt-prop no-lock where
          buf_drt-prop.templ-rl-root = v-templ-rl-root
      and buf_drt-prop.upper-prop-code = "Run-params" + v-inversed-chr
    on error  undo , return error substitute( "&1. &2&3&4", vss-include-info35,  return-value, chr(10), error-status :get-message (1))
    ...
    if integer(buf_drt-prop.prop-code) = 0 then do:
      ...
      buf_temp-call-param.fld-df = entry(5, buf_drt-prop.property-value)
      .
      glog35 = p-dr-flddf:find-first( substitute(' where fld-df = &1&2&1', chr(34), buf_temp-call-param.fld-df, chr(34))) no-error.
      if p-dr-flddf:available = no then do:
        message
        substitute("Не определен регистр &1 параметра &2 для расчета скидок/бонусов по правилу с шаблоном &3"
                                      ,buf_temp-call-param.fld-df
      ...
      buf2_temp-call-param.fld-df = entry(5, buf_drt-prop.property-value)
      .
      glog35 = p-dr-flddf:find-first( substitute(' where fld-df = &1&2&1', chr(34), buf2_temp-call-param.fld-df, chr(34))) no-error.
      if p-dr-flddf:available = no then do:
        message
        substitute("Не определен регистр &1 параметра &2 для расчета скидок/бонусов по правилу с шаблоном &3"
                                      ,buf2_temp-call-param.fld-df
...
define variable vss-include-info37 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
  define variable glog37 as logical   no-undo .
  define variable v-dt-tp37  as character no-undo .
  for each buf2_temp-call-param where
          buf2_temp-call-param.param-num > 0
      and buf2_temp-call-param.call-name_ = substitute("dis-rule_rf_&1&2", string(v-templ-rl-root, "99999"), v-inversed-chr)
  on error  undo , return error substitute( "&1. &2&3&4", vss-include-info37,  return-value, chr(10), error-status :get-message (1))
  on stop   undo , return error substitute( "&1. stop", vss-include-info37 )
  on endkey undo , return error substitute( "&1. endkey", vss-include-info37 ):
      if v-bh[buf2_temp-call-param.table-no]:buffer-field(buf2_temp-call-param.field-name_):buffer-value = ? then
      do:
         case buf2_temp-call-param.param-datatype_:
            when "decimal"  or when "integer" then
            do:
    glog37 = buf_temp-call-param.call-handle_:set-parameter( buf2_temp-call-param.param-num
                                                    ,buf2_temp-call-param.param-datatype_
                                                    ,buf2_temp-call-param.io-mode
                                                    ,0
                                                    ).
  ...
  buf_temp-call-param.call-handle_:invoke.
    if buf_temp-call-param.call-handle_:return-value = ? then
    do:
       v-dt-tp37 = v-bh[buf_temp-call-param.table-no]:buffer-field(buf_temp-call-param.field-name_):data-type .
       if v-dt-tp37 = "decimal" or v-dt-tp37 = "integer" then
       do:
v-bh[buf_temp-call-param.table-no]:buffer-field(buf_temp-call-param.field-name_):buffer-value = 0 .
       end.
    end.
...
define variable glog41 as logical no-undo .
find first buf_temp-call-param where
        buf_temp-call-param.call-name_ = substitute("dis-rule_rf_&1&2", string(v-templ-rl-root, "99999"), v-inversed-chr)
    and buf_temp-call-param.param-num = 0 no-error .
if not available buf_temp-call-param then do:
  ...
  for each buf_drt-prop no-lock where
          buf_drt-prop.templ-rl-root = v-templ-rl-root
      and buf_drt-prop.upper-prop-code = "Run-params" + v-inversed-chr
    on error  undo , return error substitute( "&1. &2&3&4", vss-include-info41,  return-value, chr(10), error-status :get-message (1))
    on stop   undo , return error substitute( "&1. stop", vss-include-info41 )
    on endkey undo , return error substitute( "&1. endkey", vss-include-info41 ):
    if integer(buf_drt-prop.prop-code) = 0 then do:
      assign
      buf_temp-call-param.call-name_ = substitute("dis-rule_rf_&1&2", string(v-templ-rl-root, "99999"), v-inversed-chr)
      buf_temp-call-param.param-number_ = integer(buf_drt-prop.prop-code)
      ...
      buf_temp-call-param.fld-df = entry(5, buf_drt-prop.property-value)
      .
      glog41 = p-dr-flddf:find-first( substitute(' where fld-df = &1&2&1', chr(34), buf_temp-call-param.fld-df, chr(34))) no-error.
      if p-dr-flddf:available = no then do:
        message
        substitute("Не определен регистр &1 параметра &2 для расчета скидок/бонусов по правилу с шаблоном &3"
                                      ,buf_temp-call-param.fld-df
      ...
      buf2_temp-call-param.fld-df = entry(5, buf_drt-prop.property-value)
      .
      glog41 = p-dr-flddf:find-first( substitute(' where fld-df = &1&2&1', chr(34), buf2_temp-call-param.fld-df, chr(34))) no-error.
      if p-dr-flddf:available = no then do:
        message
        substitute("Не определен регистр &1 параметра &2 для расчета скидок/бонусов по правилу с шаблоном &3"
                                      ,buf2_temp-call-param.fld-df
...
define variable vss-include-info43 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
  define variable glog43 as logical   no-undo .
  define variable v-dt-tp43  as character no-undo .
  for each buf2_temp-call-param where
          buf2_temp-call-param.param-num > 0
      and buf2_temp-call-param.call-name_ = substitute("dis-rule_rf_&1&2", string(v-templ-rl-root, "99999"), v-inversed-chr)
  on error  undo , return error substitute( "&1. &2&3&4", vss-include-info43,  return-value, chr(10), error-status :get-message (1))
  on stop   undo , return error substitute( "&1. stop", vss-include-info43 )
  on endkey undo , return error substitute( "&1. endkey", vss-include-info43 ):
      if v-bh[buf2_temp-call-param.table-no]:buffer-field(buf2_temp-call-param.field-name_):buffer-value = ? then
      do:
         case buf2_temp-call-param.param-datatype_:
            when "decimal"  or when "integer" then
            do:
    glog43 = buf_temp-call-param.call-handle_:set-parameter( buf2_temp-call-param.param-num
                                                    ,buf2_temp-call-param.param-datatype_
                                                    ,buf2_temp-call-param.io-mode
                                                    ,0
                                                    ).
  ...
  buf_temp-call-param.call-handle_:invoke.
    if buf_temp-call-param.call-handle_:return-value = ? then
    do:
       v-dt-tp43 = v-bh[buf_temp-call-param.table-no]:buffer-field(buf_temp-call-param.field-name_):data-type .
       if v-dt-tp43 = "decimal" or v-dt-tp43 = "integer" then
       do:
v-bh[buf_temp-call-param.table-no]:buffer-field(buf_temp-call-param.field-name_):buffer-value = 0 .
       end.
    end.
...
define variable glog45 as logical no-undo .
find first buf_temp-call-param where
        buf_temp-call-param.call-name_ = substitute("dis-rule_rf_&1&2", string(v-templ-rl-root, "99999"), v-inversed-chr)
    and buf_temp-call-param.param-num = 0 no-error .
if not available buf_temp-call-param then do:
  ...
  for each buf_drt-prop no-lock where
          buf_drt-prop.templ-rl-root = v-templ-rl-root
      and buf_drt-prop.upper-prop-code = "Run-params" + v-inversed-chr
    on error  undo , return error substitute( "&1. &2&3&4", vss-include-info45,  return-value, chr(10), error-status :get-message (1))
    on stop   undo , return error substitute( "&1. stop", vss-include-info45 )
    on endkey undo , return error substitute( "&1. endkey", vss-include-info45 ):
    if integer(buf_drt-prop.prop-code) = 0 then do:
      assign
      buf_temp-call-param.call-name_ = substitute("dis-rule_rf_&1&2", string(v-templ-rl-root, "99999"), v-inversed-chr)
      buf_temp-call-param.param-number_ = integer(buf_drt-prop.prop-code)
      ...
      buf_temp-call-param.fld-df = entry(5, buf_drt-prop.property-value)
      .
      glog45 = p-dr-flddf:find-first( substitute(' where fld-df = &1&2&1', chr(34), buf_temp-call-param.fld-df, chr(34))) no-error.
      if p-dr-flddf:available = no then do:
        message
        substitute("Не определен регистр &1 параметра &2 для расчета скидок/бонусов по правилу с шаблоном &3"
                                      ,buf_temp-call-param.fld-df
      ...
      buf2_temp-call-param.fld-df = entry(5, buf_drt-prop.property-value)
      .
      glog45 = p-dr-flddf:find-first( substitute(' where fld-df = &1&2&1', chr(34), buf2_temp-call-param.fld-df, chr(34))) no-error.
      if p-dr-flddf:available = no then do:
        message
        substitute("Не определен регистр &1 параметра &2 для расчета скидок/бонусов по правилу с шаблоном &3"
                                      ,buf2_temp-call-param.fld-df
...
define variable vss-include-info47 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
  define variable glog47 as logical   no-undo .
  define variable v-dt-tp47  as character no-undo .
  for each buf2_temp-call-param where
          buf2_temp-call-param.param-num > 0
      and buf2_temp-call-param.call-name_ = substitute("dis-rule_rf_&1&2", string(v-templ-rl-root, "99999"), v-inversed-chr)
  on error  undo , return error substitute( "&1. &2&3&4", vss-include-info47,  return-value, chr(10), error-status :get-message (1))
  on stop   undo , return error substitute( "&1. stop", vss-include-info47 )
  on endkey undo , return error substitute( "&1. endkey", vss-include-info47 ):
      if v-bh[buf2_temp-call-param.table-no]:buffer-field(buf2_temp-call-param.field-name_):buffer-value = ? then
      do:
         case buf2_temp-call-param.param-datatype_:
            when "decimal"  or when "integer" then
            do:
    glog47 = buf_temp-call-param.call-handle_:set-parameter( buf2_temp-call-param.param-num
                                                    ,buf2_temp-call-param.param-datatype_
                                                    ,buf2_temp-call-param.io-mode
                                                    ,0
                                                    ).
  ...
  buf_temp-call-param.call-handle_:invoke.
    if buf_temp-call-param.call-handle_:return-value = ? then
    do:
       v-dt-tp47 = v-bh[buf_temp-call-param.table-no]:buffer-field(buf_temp-call-param.field-name_):data-type .
       if v-dt-tp47 = "decimal" or v-dt-tp47 = "integer" then
       do:
v-bh[buf_temp-call-param.table-no]:buffer-field(buf_temp-call-param.field-name_):buffer-value = 0 .
       end.
    end.
...
define variable glog49 as logical no-undo .
find first buf_temp-call-param where
        buf_temp-call-param.call-name_ = substitute("dis-rule_rf_&1&2", string(v-templ-rl-root, "99999"), v-inversed-chr)
    and buf_temp-call-param.param-num = 0 no-error .
if not available buf_temp-call-param then do:
  ...
  for each buf_drt-prop no-lock where
          buf_drt-prop.templ-rl-root = v-templ-rl-root
      and buf_drt-prop.upper-prop-code = "Run-params" + v-inversed-chr
    on error  undo , return error substitute( "&1. &2&3&4", vss-include-info49,  return-value, chr(10), error-status :get-message (1))
    on stop   undo , return error substitute( "&1. stop", vss-include-info49 )
    on endkey undo , return error substitute( "&1. endkey", vss-include-info49 ):
    if integer(buf_drt-prop.prop-code) = 0 then do:
      assign
      buf_temp-call-param.call-name_ = substitute("dis-rule_rf_&1&2", string(v-templ-rl-root, "99999"), v-inversed-chr)
      buf_temp-call-param.param-number_ = integer(buf_drt-prop.prop-code)
      ...
      buf_temp-call-param.fld-df = entry(5, buf_drt-prop.property-value)
      .
      glog49 = p-dr-flddf:find-first( substitute(' where fld-df = &1&2&1', chr(34), buf_temp-call-param.fld-df, chr(34))) no-error.
      if p-dr-flddf:available = no then do:
        message
        substitute("Не определен регистр &1 параметра &2 для расчета скидок/бонусов по правилу с шаблоном &3"
                                      ,buf_temp-call-param.fld-df
      ...
      buf2_temp-call-param.fld-df = entry(5, buf_drt-prop.property-value)
      .
      glog49 = p-dr-flddf:find-first( substitute(' where fld-df = &1&2&1', chr(34), buf2_temp-call-param.fld-df, chr(34))) no-error.
      if p-dr-flddf:available = no then do:
        message
        substitute("Не определен регистр &1 параметра &2 для расчета скидок/бонусов по правилу с шаблоном &3"
                                      ,buf2_temp-call-param.fld-df
...
define variable vss-include-info51 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
  define variable glog51 as logical   no-undo .
  define variable v-dt-tp51  as character no-undo .
  for each buf2_temp-call-param where
          buf2_temp-call-param.param-num > 0
      and buf2_temp-call-param.call-name_ = substitute("dis-rule_rf_&1&2", string(v-templ-rl-root, "99999"), v-inversed-chr)
  on error  undo , return error substitute( "&1. &2&3&4", vss-include-info51,  return-value, chr(10), error-status :get-message (1))
  on stop   undo , return error substitute( "&1. stop", vss-include-info51 )
  on endkey undo , return error substitute( "&1. endkey", vss-include-info51 ):
      if v-bh[buf2_temp-call-param.table-no]:buffer-field(buf2_temp-call-param.field-name_):buffer-value = ? then
      do:
         case buf2_temp-call-param.param-datatype_:
            when "decimal"  or when "integer" then
            do:
    glog51 = buf_temp-call-param.call-handle_:set-parameter( buf2_temp-call-param.param-num
                                                    ,buf2_temp-call-param.param-datatype_
                                                    ,buf2_temp-call-param.io-mode
                                                    ,0
                                                    ).
  ...
  buf_temp-call-param.call-handle_:invoke.
    if buf_temp-call-param.call-handle_:return-value = ? then
    do:
       v-dt-tp51 = v-bh[buf_temp-call-param.table-no]:buffer-field(buf_temp-call-param.field-name_):data-type .
       if v-dt-tp51 = "decimal" or v-dt-tp51 = "integer" then
       do:
v-bh[buf_temp-call-param.table-no]:buffer-field(buf_temp-call-param.field-name_):buffer-value = 0 .
       end.
    end.
...
define variable glog55 as logical no-undo .
find first buf_temp-call-param where
        buf_temp-call-param.call-name_ = substitute("dis-rule_rf_&1&2", string(v-templ-rl-root, "99999"), v-inversed-chr)
    and buf_temp-call-param.param-num = 0 no-error .
if not available buf_temp-call-param then do:
  ...
  for each buf_drt-prop no-lock where
          buf_drt-prop.templ-rl-root = v-templ-rl-root
      and buf_drt-prop.upper-prop-code = "Run-params" + v-inversed-chr
    on error  undo , return error substitute( "&1. &2&3&4", vss-include-info55,  return-value, chr(10), error-status :get-message (1))
    on stop   undo , return error substitute( "&1. stop", vss-include-info55 )
    on endkey undo , return error substitute( "&1. endkey", vss-include-info55 ):
    if integer(buf_drt-prop.prop-code) = 0 then do:
      assign
      buf_temp-call-param.call-name_ = substitute("dis-rule_rf_&1&2", string(v-templ-rl-root, "99999"), v-inversed-chr)
      buf_temp-call-param.param-number_ = integer(buf_drt-prop.prop-code)
      ...
      buf_temp-call-param.fld-df = entry(5, buf_drt-prop.property-value)
      .
      glog55 = p-dr-flddf:find-first( substitute(' where fld-df = &1&2&1', chr(34), buf_temp-call-param.fld-df, chr(34))) no-error.
      if p-dr-flddf:available = no then do:
        message
        substitute("Не определен регистр &1 параметра &2 для расчета скидок/бонусов по правилу с шаблоном &3"
                                      ,buf_temp-call-param.fld-df
      ...
      buf2_temp-call-param.fld-df = entry(5, buf_drt-prop.property-value)
      .
      glog55 = p-dr-flddf:find-first( substitute(' where fld-df = &1&2&1', chr(34), buf2_temp-call-param.fld-df, chr(34))) no-error.
      if p-dr-flddf:available = no then do:
        message
        substitute("Не определен регистр &1 параметра &2 для расчета скидок/бонусов по правилу с шаблоном &3"
                                      ,buf2_temp-call-param.fld-df
...
define variable vss-include-info57 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
  define variable glog57 as logical   no-undo .
  define variable v-dt-tp57  as character no-undo .
  for each buf2_temp-call-param where
          buf2_temp-call-param.param-num > 0
      and buf2_temp-call-param.call-name_ = substitute("dis-rule_rf_&1&2", string(v-templ-rl-root, "99999"), v-inversed-chr)
  on error  undo , return error substitute( "&1. &2&3&4", vss-include-info57,  return-value, chr(10), error-status :get-message (1))
  on stop   undo , return error substitute( "&1. stop", vss-include-info57 )
  on endkey undo , return error substitute( "&1. endkey", vss-include-info57 ):
      if v-bh[buf2_temp-call-param.table-no]:buffer-field(buf2_temp-call-param.field-name_):buffer-value = ? then
      do:
         case buf2_temp-call-param.param-datatype_:
            when "decimal"  or when "integer" then
            do:
    glog57 = buf_temp-call-param.call-handle_:set-parameter( buf2_temp-call-param.param-num
                                                    ,buf2_temp-call-param.param-datatype_
                                                    ,buf2_temp-call-param.io-mode
                                                    ,0
                                                    ).
  ...
  buf_temp-call-param.call-handle_:invoke.
    if buf_temp-call-param.call-handle_:return-value = ? then
    do:
       v-dt-tp57 = v-bh[buf_temp-call-param.table-no]:buffer-field(buf_temp-call-param.field-name_):data-type .
       if v-dt-tp57 = "decimal" or v-dt-tp57 = "integer" then
       do:
v-bh[buf_temp-call-param.table-no]:buffer-field(buf_temp-call-param.field-name_):buffer-value = 0 .
       end.
    end.
...
define variable glog59 as logical no-undo .
find first buf_temp-call-param where
        buf_temp-call-param.call-name_ = substitute("dis-rule_rf_&1&2", string(v-templ-rl-root, "99999"), v-inversed-chr)
    and buf_temp-call-param.param-num = 0 no-error .
if not available buf_temp-call-param then do:
  ...
  for each buf_drt-prop no-lock where
          buf_drt-prop.templ-rl-root = v-templ-rl-root
      and buf_drt-prop.upper-prop-code = "Run-params" + v-inversed-chr
    on error  undo , return error substitute( "&1. &2&3&4", vss-include-info59,  return-value, chr(10), error-status :get-message (1))
    on stop   undo , return error substitute( "&1. stop", vss-include-info59 )
    on endkey undo , return error substitute( "&1. endkey", vss-include-info59 ):
    if integer(buf_drt-prop.prop-code) = 0 then do:
      assign
      buf_temp-call-param.call-name_ = substitute("dis-rule_rf_&1&2", string(v-templ-rl-root, "99999"), v-inversed-chr)
      buf_temp-call-param.param-number_ = integer(buf_drt-prop.prop-code)
      ...
      buf_temp-call-param.fld-df = entry(5, buf_drt-prop.property-value)
      .
      glog59 = p-dr-flddf:find-first( substitute(' where fld-df = &1&2&1', chr(34), buf_temp-call-param.fld-df, chr(34))) no-error.
      if p-dr-flddf:available = no then do:
        message
        substitute("Не определен регистр &1 параметра &2 для расчета скидок/бонусов по правилу с шаблоном &3"
                                      ,buf_temp-call-param.fld-df
      ...
      buf2_temp-call-param.fld-df = entry(5, buf_drt-prop.property-value)
      .
      glog59 = p-dr-flddf:find-first( substitute(' where fld-df = &1&2&1', chr(34), buf2_temp-call-param.fld-df, chr(34))) no-error.
      if p-dr-flddf:available = no then do:
        message
        substitute("Не определен регистр &1 параметра &2 для расчета скидок/бонусов по правилу с шаблоном &3"
                                      ,buf2_temp-call-param.fld-df
...
define variable vss-include-info61 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
  define variable glog61 as logical   no-undo .
  define variable v-dt-tp61  as character no-undo .
  for each buf2_temp-call-param where
          buf2_temp-call-param.param-num > 0
      and buf2_temp-call-param.call-name_ = substitute("dis-rule_rf_&1&2", string(v-templ-rl-root, "99999"), v-inversed-chr)
  on error  undo , return error substitute( "&1. &2&3&4", vss-include-info61,  return-value, chr(10), error-status :get-message (1))
  on stop   undo , return error substitute( "&1. stop", vss-include-info61 )
  on endkey undo , return error substitute( "&1. endkey", vss-include-info61 ):
      if v-bh[buf2_temp-call-param.table-no]:buffer-field(buf2_temp-call-param.field-name_):buffer-value = ? then
      do:
         case buf2_temp-call-param.param-datatype_:
            when "decimal"  or when "integer" then
            do:
    glog61 = buf_temp-call-param.call-handle_:set-parameter( buf2_temp-call-param.param-num
                                                    ,buf2_temp-call-param.param-datatype_
                                                    ,buf2_temp-call-param.io-mode
                                                    ,0
                                                    ).
  ...
  buf_temp-call-param.call-handle_:invoke.
    if buf_temp-call-param.call-handle_:return-value = ? then
    do:
       v-dt-tp61 = v-bh[buf_temp-call-param.table-no]:buffer-field(buf_temp-call-param.field-name_):data-type .
       if v-dt-tp61 = "decimal" or v-dt-tp61 = "integer" then
       do:
v-bh[buf_temp-call-param.table-no]:buffer-field(buf_temp-call-param.field-name_):buffer-value = 0 .
       end.
    end.
