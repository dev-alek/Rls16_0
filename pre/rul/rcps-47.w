...
define variable vss-description as character no-undo init "Задание и просмотр параметров вызова правил - профайл 47".
...
run gbl/onewin.w (
      input parparentproc
    , input 1
    , input "Список внешних систем для маршрутизации накладных, переоценок, заказов, документов продажи"
    , input "":U
    , input "&Тест"
