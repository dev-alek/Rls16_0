...
Gds-line1 = new Dis-chk-gds_obj( input parparentproc, input p-parent-handle, input p-log-handle, input this-procedure:handle, input p-cont-handle, input v-current-lock, input v-current-wait, input v-save) .
...
Tot-obj-sel-goods1 = new Dis-tot_obj( input parparentproc, input p-parent-handle, input p-log-handle, input this-procedure:handle, input p-cont-handle, input v-current-lock, input v-current-wait, input v-save, input 9) .
...
IF  Card1:find_dis-card_( INPUT v-current-d-card) = true  THEN do:
  ...
  DO WHILE  Gds-line1:get_dis-chk-gds_obj( INPUT "next") = true :
    ...
    DO WHILE  context_get-next-rule-call-param( input "p-rule-nums", input-output v-index-rule-nums) = true :
      ...
      IF  Gds-line1:run_dis-rule( INPUT v-rule-num, INPUT 'dis-tot-flag':U, INPUT 'bo':U) = true AND Gds-line1:get_dis-rule-value_logical( INPUT "") = true  THEN do:
        _1739:
        do:
...
Tot-obj-sel-goods1:Dis-tot_objrelease_ ( ) .
Gds-line1:Dis-chk-gds_objrelease_ ( ) .
  end.
end.
end procedure.
