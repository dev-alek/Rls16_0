...
main-block:
do
on error  undo main-block, return error substitute( "&1. &2&3&4", vss-include-info11, return-value, chr(10), error-status :get-message (1))
on stop   undo main-block, return error substitute( "&1. stop", vss-include-info11 )
on endkey undo main-block, return error substitute( "&1. endkey", vss-include-info11 )
:
...
if (valid-handle(g#lib-nws) <> true) then do:   run nws/lib-nws.p persistent no-error .   if error-status :error or (valid-handle(g#lib-nws) <> true) then do:     message       "Error starting nws/lib-nws.p" skip       g#lib-nws skip       g#lib-nws :type skip       g#lib-nws :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run lib-nws_get-hn-option-record in g#lib-nws
  ...
  then do:
    run add-dump in p-cmd-proc-handle                                                                           (input p-cmd-code                                                                                         ,input 'c-dis-obj':U                                                                                          ,input '+update'                                                                                         ,input buffer buf_c-dis-obj:handle                                                                                    ,input ''                                                                                         ,output v-rec-ord2                                                                                         ) no-error .                                                                                               if error-status :error                                                                                       then do:                                                                                                     delete procedure p-cmd-proc-handle .                                                                        undo , return error substitute("&1 &2 &3&4Ошибка при добавлении записи &5 в команду с кодом &6&4&8&4&9&4"                                       ,vss-workfile                                                                                                ,vss-revision                                                                                                ,vss-description                                                                                             ,chr(10)                                                                                               ,'c-dis-obj':U                                                                                                ,p-cmd-code                                                                                               ,error-status:get-message(1)                                                                                 ,return-value                                                                                                ) .                                                                    end.
...
if (valid-handle(g#lib-nws) <> true) then do:   run nws/lib-nws.p persistent no-error .   if error-status :error or (valid-handle(g#lib-nws) <> true) then do:     message       "Error starting nws/lib-nws.p" skip       g#lib-nws skip       g#lib-nws :type skip       g#lib-nws :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run lib-nws_get-hn-option-record in g#lib-nws
  ...
  run add-dump in p-cmd-proc-handle                                                                           (input p-cmd-code                                                                                         ,input 'dis-obj':U                                                                                          ,input '+update'                                                                                         ,input buffer buf_dis-obj:handle                                                                                    ,input ''                                                                                         ,output v-rec-ord1                                                                                         ) no-error .                                                                                               if error-status :error                                                                                       then do:                                                                                                     delete procedure p-cmd-proc-handle .                                                                        undo , return error substitute("&1 &2 &3&4Ошибка при добавлении записи &5 в команду с кодом &6&4&8&4&9&4"                                       ,vss-workfile                                                                                                ,vss-revision                                                                                                ,vss-description                                                                                             ,chr(10)                                                                                               ,'dis-obj':U                                                                                                ,p-cmd-code                                                                                               ,error-status:get-message(1)                                                                                 ,return-value                                                                                                ) .                                                                    end.
  if g#db-num = 0 then do:
   case buf_temp-hist-nws-option.smart-nws:
      when integer('0':U)
      or
...
sale-sums = new Dis-card-sale_obj( input parparentproc, input p-parent-handle, input p-log-handle, input this-procedure:handle, input vh_dis-card-sale_obj, input p-codex-id, input p-ruleset-id) .
 define variable tot-obj1 as class dis-tot_obj no-undo .
tot-obj1 = new Dis-tot_obj( input parparentproc, input p-parent-handle, input p-log-handle, input this-procedure:handle, input p-cont-handle, input v-current-lock, input v-current-wait, input v-save) .
...
IF  Card1:find_dis-card_( INPUT v-current-d-card) = true  THEN do:
  _1305:
  do:
  IF  tot-obj1:find_dis-tot_obj( INPUT v-current-d-card, INPUT v-current-obj-type, INPUT v-current-obj-code) = false  THEN do:
    _1304:
    do:
    IF  tot-obj1:create_dis-tot_obj( INPUT v-current-d-card, INPUT v-current-obj-type, INPUT v-current-obj-code) = false  THEN do:
      _1307:
      do:
   ...
   tot-obj1:gds-tot-b0 = tot-obj1:gds-tot-b0 + sale-sums:gds-tot-b0 .
   tot-obj1:gds-tot-r0 = tot-obj1:gds-tot-r0 + sale-sums:gds-tot-r0 .
   tot-obj1:gds-tot-base = tot-obj1:gds-tot-base + sale-sums:gds-tot-base .
   tot-obj1:gds-tot-rubl = tot-obj1:gds-tot-rubl + sale-sums:gds-tot-rubl .
   tot-obj1:gds-dis-base = tot-obj1:gds-dis-base + sale-sums:gds-dis-base .
   tot-obj1:gds-dis-rubl = tot-obj1:gds-dis-rubl + sale-sums:gds-dis-rubl .
   tot-obj1:pay-tot-base = tot-obj1:pay-tot-base + sale-sums:pay-tot-base .
   tot-obj1:pay-tot-rubl = tot-obj1:pay-tot-rubl + sale-sums:pay-tot-rubl .
   tot-obj1:num-chk = tot-obj1:num-chk + sale-sums:num-chk .
  IF  tot-obj1:dis-tot_objsave( ) = false  THEN do:
    _1306:
    do:
     undo _main, return error v-last-error-message .
    end.
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run hostcode in g#library
  ...
  ,output v-payment-host-code
            ...
            run ref/payment1.p (
                          ...
                          ,input 'факт':U
                          ,input chr(10) + substitute( 'obj-type=&1,obj-code=&2', vchk-pay.obj-type, string( vchk-pay.obj-code ) )
                          ,input g#userid
                          ,input g#userid
                          )
                          no-error.
          ...
          if not g#news then do:
            run add-dump in p-cmd-proc-handle                                                                           (input p-cmd-code                                                                                         ,input 'vchk-pay'                                                                                          ,input '+update'                                                                                         ,input buffer vchk-pay:handle                                                                                    ,input v-gate-rec                                                                                         ,output v-vchk-pay-rec-ord                                                                                         ) no-error .                                                                                               if error-status :error                                                                                       then do:                                                                                                     delete procedure p-cmd-proc-handle .                                                                        undo , return error substitute("&1 &2 &3&4Ошибка при добавлении записи &5 в команду с кодом &6&4&8&4&9&4"                                       ,vss-workfile                                                                                                ,vss-revision                                                                                                ,vss-description                                                                                             ,chr(10)                                                                                               ,'vchk-pay'                                                                                                ,p-cmd-code                                                                                               ,error-status:get-message(1)                                                                                 ,return-value                                                                                                ) .                                                                    end.
          end.
          delete vchk-pay.
        end.
      if temp-d-card.exp-imp = no then do:
  run add-dump in p-cmd-proc-handle                                                                           (input p-cmd-code                                                                                         ,input 'temp-d-card'                                                                                          ,input '+update'                                                                                         ,input buffer temp-d-card:handle                                                                                    ,input v-gate-rec                                                                                         ,output v-temp-d-card-rec-ord                                                                                         ) no-error .                                                                                               if error-status :error                                                                                       then do:                                                                                                     delete procedure p-cmd-proc-handle .                                                                        undo , return error substitute("&1 &2 &3&4Ошибка при добавлении записи &5 в команду с кодом &6&4&8&4&9&4"                                       ,vss-workfile                                                                                                ,vss-revision                                                                                                ,vss-description                                                                                             ,chr(10)                                                                                               ,'temp-d-card'                                                                                                ,p-cmd-code                                                                                               ,error-status:get-message(1)                                                                                 ,return-value                                                                                                ) .                                                                    end.
        temp-d-card.exp-imp = yes.
      end.
    end.
Card1:Dis-card_release_ ( ) .
tot-obj1:Dis-tot_objrelease_ ( ) .
