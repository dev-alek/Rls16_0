...
run write-log  in p-log-handle (
                                 input 0
                               , "&DLine").
  run write-log-and-file in p-log-handle (                 input 1                                          , input log-file-name                              , input 1                                          , input substitute(".............Импорт данных по группам товаров из ВС")).
            ...
            :
              ...
              and v-upper-subclass-code = 0 then do:
                ...
                find first upper_ext-classif no-lock where
                          upper_ext-classif.classif-subject = 'gds-grp':U
                      and upper_ext-classif.classif-name = 'rpm_gds-grp':U
              ...
              v-increase-pc = 0.
              v-round-method = 'Отключено':U.
              v-base = 0.
              case v-line-status_:
                when 'U' then do:
                  v-mode = 'ИЗМЕНЕНИЕ':U.
                  if not available buf_ext-classif then do:
                                        run write-log-and-file in p-log-handle (                 input 1                                          , input log-file-name                              , input 1                                          , input substitute("Запись &1: Не найден изменяемый узел товарного классификатора RPM &2/&3/&4/&6"                                                   ,v-line-num                                                   ,v-current-group-code                                                      ,v-current-depart-code                                                     ,v-current-class-code                                                      ,v-current-subclass-code)).
                  ...
                  then do:
                                        run write-log-and-file in p-log-handle (                 input 1                                          , input log-file-name                              , input 1                                          , input substitute("Запись &1: Не найден вышестоящий узел изменяемого узла товарного классификатора RPM &2/&3/&4/&5"                                                   ,v-line-num                                                   ,v-upper-group-code                                                      ,v-upper-depart-code                                                     ,v-upper-class-code                                                      ,v-upper-subclass-code)).
                      run set-err-type in p-cont-handle
                        ( input 'SYNCHRONIZATION'
                        ) no-error.
                    undo _rule, retry _rule .
                ...
                when 'N' then do:
                  v-mode = 'ДОБАВЛЕНИЕ':U.
                  if available buf_ext-classif then do:
                                        run write-log-and-file in p-log-handle (                 input 1                                          , input log-file-name                              , input 1                                          , input substitute("Запись &1: Уже есть добавляемый узел товарного классификатора RPM &2/&3/&4/&6"                                                   ,v-line-num                                                   ,v-current-group-code                                                      ,v-current-depart-code                                                     ,v-current-class-code                                                      ,v-current-subclass-code)).
                      run set-err-type in p-cont-handle
                        ( input 'SYNCHRONIZATION'
                        ) no-error.
                    undo _rule, retry _rule .
                  ...
                  and v-current-upper-node-code = 0
                  then do:
                                        run write-log-and-file in p-log-handle (                 input 1                                          , input log-file-name                              , input 1                                          , input substitute("Запись &1: Не найден вышестоящий узел добавляемого узла товарного классификатора RPM &2/&3/&4/&5"                                                   ,v-line-num                                                   ,v-upper-group-code                                                      ,v-upper-depart-code                                                     ,v-upper-class-code                                                      ,v-upper-subclass-code)).
                      run set-err-type in p-cont-handle
                        ( input 'SYNCHRONIZATION'
                        ) no-error.
                    undo _rule, retry _rule .
                ...
                when 'D' then do:
                  v-mode = 'удаление':U.
                  if not available buf_ext-classif then do:
                                        run write-log-and-file in p-log-handle (                 input 1                                          , input log-file-name                              , input 1                                          , input substitute("Запиь &1: Не найден удаляемый узел товарного классификатора RPM &2/&3/&4/&5"                                                   ,v-line-num                                                   ,v-current-group-code                                                      ,v-current-depart-code                                                     ,v-current-class-code                                                      ,v-current-subclass-code)).
                      run set-err-type in p-cont-handle
                        ( input 'SYNCHRONIZATION'
                        ) no-error.
                    undo _rule, retry _rule .
              ...
              if v-mode = 'удаление':U then do:
                ...
                run ref/gdsgrp01.p ( input v-mode
                                      ,input yes
                                      ,input no
                                      ,input (if v-mode = 'ДОБАВЛЕНИЕ':U then yes else no)
              ...
              if error-status:error then do:
                ...
                if valid-handle(v_qh) then do:
                  delete object v_qh no-error.
                                ...
                                run write-log-and-file in p-log-handle (                 input 1                                          , input log-file-name                              , input 1                                          , input substitute("Запись &1: &2&3&4"                                              , v-line-num                                             , error-status:get-message(1)                                             , chr(10)                                             , return-value)).
                undo _rule, retry _rule .
              end.
              ...
              if v-mode = 'удаление':U
              or (v-mode = 'ИЗМЕНЕНИЕ':U
              ...
              then do:
                ...
                if error-status :error then do:
                  run write-log-and-file in p-log-handle (                 input 1                                          , input log-file-name                              , input 1                                          , input substitute("Запись &1: Ошибка при удалении узла товарного классификатора RPM &2/&3/&4/&5"                                                   , v-line-num                                                   ,v-current-group-code                                                      ,v-current-depart-code                                                     ,v-current-class-code                                                      ,v-current-subclass-code)).
                  undo _rule, retry _rule .
                end.
              end.
              if ((v-mode = 'ИЗМЕНЕНИЕ':U
              ...
              then do:
                if v-mode = 'ДОБАВЛЕНИЕ':U then do:
                  ...
                  if available buf_gds-grp then do:
                     run gen-key-rec in this-procedure ( input 'gds-grp':U
                                                        ,input (buffer buf_gds-grp:handle)
                                                        ,output v-uniq-key-rec) .
                  end.
                  else do:
                                        run write-log-and-file in p-log-handle (                 input 1                                          , input log-file-name                              , input 1                                          , input substitute("Запись &1: Не найдена вновь созданная группа товара с rid &2"                                                  , v-line-num                                                 , v-rid                                                 )).
                    undo _rule, retry _rule .
                  end.
                end.
                v-rec = ?.
                run ref/extclas1.p (
                                    ...
                                    ,input 'rpm_gds-grp':U
                                    ,input -1
                                    ,input v-current-depart-code
                                    ,input v-current-class-code
                                    ,input v-current-subclass-code
                                    ,input v-current-group-code
                                    ,input v-current-node-name
                                    ,input ''
                                    ,input ''
