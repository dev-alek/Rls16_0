...
custom-par = "all,2,8" + chr(44) + "TOG-Shift-2 = yes" + chr(44) + custom-par.
if entry(1, p-call-id, chr(3)) = 'thbj-attr':U
and p-mode <> 'ПРОСМОТР':U
then do:
  assign
  v-keys = buffer ub.thbj-attr:handle:keys.
  assign
  v-obj-type = entry(lookup("obj-type", v-keys, chr(44)) + 1, p-call-id, chr(3))
  .
