...
for each buf_temp-obj :
  assign
  v-parameter =
                  buf_temp-obj.obj-type         + chr(4) +
                  string(buf_temp-obj.obj-code) + chr(4) +
                  string(0)          + chr(4) +
                  string(1).
  run str/get-chkf.p (
                  input parparentproc
  ...
  if error-status:error then do:
        run write-log-and-file in p-log-handle (                 input 1                                          , input log-file-name                              , input 1                                          , input substitute( "!!!Ошибка при приеме информации с касс &1&2&3" +                             "&4 &5"                           , buf_temp-obj.obj-type                           , buf_temp-obj.obj-code                            , chr(10)                           , error-status:get-message(1)                           , return-value)).
  end.
    run write-log-and-file in p-log-handle (                 input 1                                          , input log-file-name                              , input 1                                          , input substitute( "Обработка спул-файлов по &1&2 завершена"                           , buf_temp-obj.obj-type                           , buf_temp-obj.obj-code)).
end.
end procedure.
