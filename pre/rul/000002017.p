...
run write-log  in p-log-handle (
                                 input 0
                               , "&DLine").
  run write-log-and-file in p-log-handle (                 input 1                                          , input log-file-name                              , input 1                                          , input substitute(".............Импорт данных по Складским документам из ВС")).
    run write-log-and-file in p-log-handle (                 input 1                                          , input log-file-name                              , input 1                                          , input substitute("Импорт данных по складским документам из файла &1", file-name)).
    ...
    or not (buf_ext-system.esys-type  = integer('3':U)) then do:
           run write-log-and-file in p-log-handle (                 input 1                                          , input log-file-name                              , input 1                                          , input substitute("Не найдена ВС &1 или она не имеет типа ORACLE RETAIL", v-esys-id)).
...
ImpData1:Route-data_dump ( ) .
    ...
    _rule:
      do on error undo _rule, retry _rule:
        ...
        IF v_qh:query-off-end then leave _stroka.
          IF  ImpData1:current-tbl-name( ) = "trn-doc"  THEN do:
            create temp_trn-doc.
              temp_trn-doc.line-num = ImpData1:route-data_get-field-integer    ( input "trn-doc", input "line-num")  .
              temp_trn-doc.doc-date = ImpData1:route-data_get-field-date       ( input "trn-doc", input "doc-date")  .
              temp_trn-doc.doc-code = ImpData1:route-data_get-field-character  ( input "trn-doc", input "doc-code")  .
              temp_trn-doc.obj-type = ImpData1:route-data_get-field-character  ( input "trn-doc", input "obj-type")  .
              temp_trn-doc.obj-code = ImpData1:route-data_get-field-integer    ( input "trn-doc", input "obj-code")  .
              temp_trn-doc.cli-code = ImpData1:route-data_get-field-integer    ( input "trn-doc", input "cli-code")  .
              temp_trn-doc.ext-doc-type = ImpData1:route-data_get-field-character ( input "trn-doc", input "ext-doc-type") .
              temp_trn-doc.ps           = ImpData1:route-data_get-field-character ( input "trn-doc", input "ps"        ) .
              temp_trn-doc.exch-code    = ImpData1:route-data_get-field-integer   ( input "trn-doc", input "exch-code" ) .
              temp_trn-doc.exch-rate    = ImpData1:route-data_get-field-decimal   ( input "trn-doc", input "exch-rate" ) .
              temp_trn-doc.exch-scale   = ImpData1:route-data_get-field-integer   ( input "trn-doc", input "exch-scale") .
              temp_trn-doc.price-type   = ImpData1:route-data_get-field-character   ( input "trn-doc", input "price-type") .
              release temp_trn-doc.
          end.
          IF  ImpData1:current-tbl-name( ) = "doc-line"  THEN do:
            create temp_doc-line.
              temp_doc-line.line-num    = ImpData1:route-data_get-field-integer   ( input "doc-line", input "line-num"   )  .
              temp_doc-line.doc-code    = ImpData1:route-data_get-field-character ( input "doc-line", input "doc-code"   )  .
              temp_doc-line.gds-code    = ImpData1:route-data_get-field-integer   ( input "doc-line", input "gds-code"   )  .
              temp_doc-line.price-rubl  = ImpData1:route-data_get-field-decimal   ( input "doc-line", input "price-rubl" )  .
              temp_doc-line.price-cli   = ImpData1:route-data_get-field-decimal   ( input "doc-line", input "price-cli"  )  .
              temp_doc-line.fact-qnty   = ImpData1:route-data_get-field-decimal   ( input "doc-line", input "fact-qnty"  )  .
              temp_doc-line.vat-pc      = ImpData1:route-data_get-field-decimal   ( input "doc-line", input "vat-pc"     )  .
  ...
  if error-status:error then do:
    if return-value <> '' then do:
            run write-log-and-file in p-log-handle (                 input 1                                          , input log-file-name                              , input 1                                          , input substitute("Ошибка при сохранении данных по накладным из ВС:&1&2&1&3", chr(10), return-value , error-status :get-message(1)  )).
    end.
    ...
    run write-log-and-file in p-log-handle (                 input 1                                          , input log-file-name                              , input 1                                          , input substitute("Прочитано записей: &1, из них удачно обработано: &2", num-rec, num-rec-ok2)).
end.
end procedure.
