...
Tot-host-sel-goods1 = new Dis-tot_host( input parparentproc, input p-parent-handle, input p-log-handle, input this-procedure:handle, input p-cont-handle, input v-current-lock, input v-current-wait, input v-save, input 9) .
 define variable Tot-sel-goods1 as class Dis-tot_ no-undo .
Tot-sel-goods1 = new Dis-tot_( input parparentproc, input p-parent-handle, input p-log-handle, input this-procedure:handle, input p-cont-handle, input v-current-lock, input v-current-wait, input v-save, input 9) .
...
Tot-host-sel-goods1:Dis-tot_hostrelease_ ( ) .
Tot-sel-goods1:Dis-tot_release_ ( ) .
