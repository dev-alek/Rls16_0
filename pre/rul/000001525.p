...
do v-jj = 1 to 2:
  ...
  and (v-jj = 2 or (buf_dis-rule.sts = integer('0':U)
...
Tot-sum-current = new Dis-tot_( input parparentproc, input p-parent-handle, input p-log-handle, input this-procedure:handle, input p-cont-handle, input v-current-lock, input v-current-wait, input v-save, input 5) .
 define variable Tot-sum-host-current as class Dis-tot_host no-undo .
Tot-sum-host-current = new Dis-tot_host( input parparentproc, input p-parent-handle, input p-log-handle, input this-procedure:handle, input p-cont-handle, input v-current-lock, input v-current-wait, input v-save, input 5) .
 define variable Tot-sum-host-prev as class Dis-tot_host no-undo .
Tot-sum-host-prev = new Dis-tot_host( input parparentproc, input p-parent-handle, input p-log-handle, input this-procedure:handle, input p-cont-handle, input v-current-lock, input v-current-wait, input v-save, input 5) .
 define variable Tot-sum-prev as class Dis-tot_ no-undo .
Tot-sum-prev = new Dis-tot_( input parparentproc, input p-parent-handle, input p-log-handle, input this-procedure:handle, input p-cont-handle, input v-current-lock, input v-current-wait, input v-save, input 5) .
...
Tot-sum-current:Dis-tot_release_ ( ) .
Tot-sum-prev:Dis-tot_release_ ( ) .
Tot-sum-host-current:Dis-tot_hostrelease_ ( ) .
Tot-sum-host-prev:Dis-tot_hostrelease_ ( ) .
