...
Payment-sums = new Dis-card-payment_host( input parparentproc, input p-parent-handle, input p-log-handle, input this-procedure:handle, input vh_dis-card-sale_obj, input p-codex-id, input p-ruleset-id) .
 define variable Tot-firm1 as class Dis-tot_host no-undo .
Tot-firm1 = new Dis-tot_host( input parparentproc, input p-parent-handle, input p-log-handle, input this-procedure:handle, input p-cont-handle, input v-current-lock, input v-current-wait, input v-save) .
 define variable Tot1 as class Dis-tot_ no-undo .
Tot1 = new Dis-tot_( input parparentproc, input p-parent-handle, input p-log-handle, input this-procedure:handle, input p-cont-handle, input v-current-lock, input v-current-wait, input v-save) .
...
Tot1:Dis-tot_release_ ( ) .
Tot-firm1:Dis-tot_hostrelease_ ( ) .
Payment-sums:Dis-card-payment_hostrelease_ ( ) .
