...
DEFINE BUFFER buf2_conf-import FOR conf-import.
  ...
  DO TRANSACTION:
    ...
    END.
     ...
     release buf1_conf-import.
  END.
  OPEN QUERY br-fields FOR EACH conf-import WHERE true                                                                      .
...
DEFINE BUFFER buf2_conf-import FOR conf-import.
  ...
  REPOSITION br-fields TO RECID v-rec NO-ERROR.
END.
ON VALUE-CHANGED OF br-fields IN FRAME Dialog-Frame
DO:
...
DO:
  ...
  END.
END.
ON ROW-DISPLAY OF br-fields IN frame Dialog-Frame
DO:
...
do:
  br-fields :SET-REPOSITIONED-ROW(5, "CONDITIONAL") .
end.
MAIN-BLOCK:
...
CREATE conf-import.                                               ASSIGN                                                            conf-import.table-name = 'prod-bc':U                          conf-import.field-name = "b-str"                          conf-import.full-field-name = 'prod-bc':U + "." + "b-str"    conf-import.field-label = "ДопБК"                       conf-import.is-mandatory = no                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = v-position + 1                            conf-import.actually-import = yes                 v-position =  v-position + 1.
CREATE conf-import.                                               ASSIGN                                                            conf-import.table-name = 'contract-specif':U                          conf-import.field-name = "artic"                          conf-import.full-field-name = 'contract-specif':U + "." + "artic"    conf-import.field-label = "Артикул в IBS TH"                       conf-import.is-mandatory = no                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = v-position + 1                            conf-import.actually-import = yes                 v-position =  v-position + 1.
CREATE conf-import.                                               ASSIGN                                                            conf-import.table-name = 'contract-specif':U                          conf-import.field-name = "prod-type"                          conf-import.full-field-name = 'contract-specif':U + "." + "prod-type"    conf-import.field-label = "Тип производителя в IBS TH"                       conf-import.is-mandatory = no                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = v-position + 1                            conf-import.actually-import = yes                 v-position =  v-position + 1.
CREATE conf-import.                                               ASSIGN                                                            conf-import.table-name = 'contract-specif':U                          conf-import.field-name = "prod-code"                          conf-import.full-field-name = 'contract-specif':U + "." + "prod-code"    conf-import.field-label = "Код производителя в IBS TH"                       conf-import.is-mandatory = no                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = v-position + 1                            conf-import.actually-import = yes                 v-position =  v-position + 1.
CREATE conf-import.                                               ASSIGN                                                            conf-import.table-name = 'contract-specif':U                          conf-import.field-name = "price-cli"                          conf-import.full-field-name = 'contract-specif':U + "." + "price-cli"    conf-import.field-label = "Цена поставщика"                       conf-import.is-mandatory = no                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = v-position + 1                            conf-import.actually-import = yes                 v-position =  v-position + 1.
CREATE conf-import.                                               ASSIGN                                                            conf-import.table-name = 'contract-specif':U                          conf-import.field-name = "prc"                          conf-import.full-field-name = 'contract-specif':U + "." + "prc"    conf-import.field-label = "% отклонения в большую сторону"                       conf-import.is-mandatory = no                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = v-position + 1                            conf-import.actually-import = yes                 v-position =  v-position + 1.
CREATE conf-import.                                               ASSIGN                                                            conf-import.table-name = 'contract-specif':U                          conf-import.field-name = "qnty"                          conf-import.full-field-name = 'contract-specif':U + "." + "qnty"    conf-import.field-label = "Количество"                       conf-import.is-mandatory = no                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = v-position + 1                            conf-import.actually-import = yes                 v-position =  v-position + 1.
CREATE conf-import.                                               ASSIGN                                                            conf-import.table-name = 'contract-specif':U                          conf-import.field-name = "cli-base-rate"                          conf-import.full-field-name = 'contract-specif':U + "." + "cli-base-rate"    conf-import.field-label = "коэфф.ед.изм"                       conf-import.is-mandatory = no                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = v-position + 1                            conf-import.actually-import = no                 v-position =  v-position + 1.
CREATE conf-import.                                               ASSIGN                                                            conf-import.table-name = 'contract-specif':U                          conf-import.field-name = "vat-type"                          conf-import.full-field-name = 'contract-specif':U + "." + "vat-type"    conf-import.field-label = "Тип НДС"                       conf-import.is-mandatory = no                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = v-position + 1                            conf-import.actually-import = yes                 v-position =  v-position + 1.
CREATE conf-import.                                               ASSIGN                                                            conf-import.table-name = 'contract-specif':U                          conf-import.field-name = "vat-pc"                          conf-import.full-field-name = 'contract-specif':U + "." + "vat-pc"    conf-import.field-label = "НДС"                       conf-import.is-mandatory = no                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = v-position + 1                            conf-import.actually-import = yes                 v-position =  v-position + 1.
CREATE conf-import.                                               ASSIGN                                                            conf-import.table-name = 'contract-specif':U                          conf-import.field-name = "bonus"                          conf-import.full-field-name = 'contract-specif':U + "." + "bonus"    conf-import.field-label = "Бонус"                       conf-import.is-mandatory = no                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = v-position + 1                            conf-import.actually-import = yes                 v-position =  v-position + 1.
CREATE conf-import.                                               ASSIGN                                                            conf-import.table-name = 'goods':U                          conf-import.field-name = "gds-name"                          conf-import.full-field-name = 'goods':U + "." + "gds-name"    conf-import.field-label = "Наименование в IBS TH"                       conf-import.is-mandatory = no                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = v-position + 1                            conf-import.actually-import = no                 v-position =  v-position + 1.
CREATE conf-import.                                               ASSIGN                                                            conf-import.table-name = 'goods':U                          conf-import.field-name = "qnty-cart"                          conf-import.full-field-name = 'goods':U + "." + "qnty-cart"    conf-import.field-label = "Кол-во в упаковке"                       conf-import.is-mandatory = no                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = v-position + 1                            conf-import.actually-import = no                 v-position =  v-position + 1.
CREATE conf-import.                                               ASSIGN                                                            conf-import.table-name = 'ext-artic':U                          conf-import.field-name = "ext-artic"                          conf-import.full-field-name = 'ext-artic':U + "." + "ext-artic"    conf-import.field-label = "Артикул поставщика"                       conf-import.is-mandatory = no                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = v-position + 1                            conf-import.actually-import = no                 v-position =  v-position + 1.
CREATE conf-import.                                               ASSIGN                                                            conf-import.table-name = 'gds-obj':U                          conf-import.field-name = "price-sale"                          conf-import.full-field-name = 'gds-obj':U + "." + "price-sale"    conf-import.field-label = "Текущая цена в IBS TH"                       conf-import.is-mandatory = no                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = v-position + 1                            conf-import.actually-import = no                 v-position =  v-position + 1.
CREATE conf-import.                                               ASSIGN                                                            conf-import.table-name = 'goods':U                          conf-import.field-name = "DeadLine"                          conf-import.full-field-name = 'goods':U + "." + "DeadLine"    conf-import.field-label = "Срок хранения (дней)"                       conf-import.is-mandatory = no                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = v-position + 1                            conf-import.actually-import = no                 v-position =  v-position + 1.
CREATE conf-import.                                               ASSIGN                                                            conf-import.table-name = 'clients':U                          conf-import.field-name = "Obj-name"                          conf-import.full-field-name = 'clients':U + "." + "Obj-name"    conf-import.field-label = "Наименование производителя"                       conf-import.is-mandatory = no                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = v-position + 1                            conf-import.actually-import = no                 v-position =  v-position + 1.
CREATE conf-import.                                               ASSIGN                                                            conf-import.table-name = 'contract-specif-attr':U                          conf-import.field-name = "prc-min"                          conf-import.full-field-name = 'contract-specif-attr':U + "." + "prc-min"    conf-import.field-label = "% отклонения в меньшую сторону"                       conf-import.is-mandatory = no                      conf-import.to-import = (IF conf-import.is-mandatory = YES                                 THEN  YES                                                         ELSE NO)                                 conf-import.POSITION_ = v-position + 1                            conf-import.actually-import = yes                 v-position =  v-position + 1.
END PROCEDURE.
...
ASSIGN
FRAME Dialog-Frame:TITLE = substitute("Параметры импорта в спецификацию по профайлу &1", p-profile-id).
assign
delim:LIST-ITEM-PAIRS IN FRAME Dialog-Frame = "Точка с запятой (;)" + chr(44) + ";" + chr(44) +
                         "Тильда (~)" + chr(44) + "~~" + chr(44) +
                          "Табулятор" + chr(44) + "~t" + chr(44) +
                          "Пробел" + chr(44) + "_"
.
ASSIGN
conf-import.to-import:READ-ONLY IN BROWSE br-fields = YES
...
WITH FRAME Dialog-Frame.
ENABLE
b-up   WHEN p-mode <> 'ПРОСМОТР':U
b-down WHEN p-mode <> 'ПРОСМОТР':U
...
EDITOR-ps
EDITOR-delim-ps
delim  WHEN p-mode <> 'ПРОСМОТР':U
f-start-row WHEN p-mode <> 'ПРОСМОТР':U
WITH FRAME Dialog-Frame.
case p-ruleset-id:
  when 224 then do:
    hide
...
if delim:visible in frame Dialog-Frame then do:
