...
Sel-goods-discnt1 = new Sel-goods-discount_(  input parparentproc, input p-parent-handle, input p-log-handle, input this-procedure:handle, input p-cont-handle, input v-current-lock, input v-current-wait, input v-save, input 17) .
 define variable Tot-sel-goods-host1 as class Dis-tot_host no-undo .
Tot-sel-goods-host1 = new Dis-tot_host( input parparentproc, input p-parent-handle, input p-log-handle, input this-procedure:handle, input p-cont-handle, input v-current-lock, input v-current-wait, input v-save, input 9) .
...
Tot-sel-goods-host1:Dis-tot_hostrelease_ ( ) .
Sel-goods-discnt1:Sel-goods-discount_release_ ( ) .
    end.
