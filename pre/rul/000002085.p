...
Tot-sum-host1 = new Dis-tot_host( input parparentproc, input p-parent-handle, input p-log-handle, input this-procedure:handle, input p-cont-handle, input v-current-lock, input v-current-wait, input v-save) .
 define variable Discount-host1 as class Discount_host no-undo .
Discount-host1 = new Discount_host( input parparentproc, input p-parent-handle, input p-log-handle, input this-procedure:handle, input p-cont-handle, input v-current-lock, input v-current-wait, input v-save, input 26) .
 define variable Tot-sum-obj1 as class Dis-tot_obj no-undo .
Tot-sum-obj1 = new Dis-tot_obj( input parparentproc, input p-parent-handle, input p-log-handle, input this-procedure:handle, input p-cont-handle, input v-current-lock, input v-current-wait, input v-save) .
 define variable Discount-obj1 as class Discount_obj no-undo .
Discount-obj1 = new Discount_obj( input parparentproc, input p-parent-handle, input p-log-handle, input this-procedure:handle, input p-cont-handle, input v-current-lock, input v-current-wait, input v-save, input 26) .
    ...
    IF  Card1:find_dis-card_( INPUT v-current-d-card) = true  THEN do:
      ...
      :
        ...
        and temp-dis-rule.obj-code = 0 then do:
          ...
          Discount-host1:category = dis-rule_00059( INPUT temp-dis-rule.rule-num, INPUT v-current-doc-date, INPUT v-current-doc-time, INPUT v-netto-sum1) .
          IF  Discount-host1:Discount_hostsave( ) = false  THEN do:
            undo _main, return error v-last-error-message .
          end.
                    Tot-sum-host1:Dis-tot_hostrelease_ ( ) .
                    Discount-host1:Discount_hostrelease_ ( ) .
        end.
        else do:
          v-netto-sum1 = 0.
          v-current-host-code = temp-dis-rule.host-code.
          ...
          IF  Tot-sum-obj1:find_Dis-tot_obj( INPUT v-current-d-card, INPUT temp-dis-rule.obj-type, temp-dis-rule.obj-code) = true  THEN do:
            ...
            Discount-obj1:category = dis-rule_00059( INPUT temp-dis-rule.rule-num, INPUT v-current-doc-date, INPUT v-current-doc-time, INPUT v-netto-sum1) .
            IF  Discount-obj1:Discount_objsave( ) = false  THEN do:
              undo _main, return error v-last-error-message .
            end.
          end.
                    Tot-sum-obj1:Dis-tot_objrelease_ ( ) .
                    Discount-obj1:Discount_objrelease_ ( ) .
        end.
