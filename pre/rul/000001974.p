...
define buffer buf_tt-staff for temp-staff.
...
run write-log  in p-log-handle (
                                 input 0
                               , "&DLine").
run write-log-and-file in p-log-handle (                 input 1                                          , input log-file-name                              , input 1                                          , input substitute("Импорт данных по клиентам из файла &1", file-name)).
          ...
          case v-current-tbl-name :
            when "clients-01"  THEN do:
              ...
              if available buf_clients then do:
                                run write-log-and-file in p-log-handle (                 input 1                                          , input log-file-name                              , input 1                                          , input substitute("Уже есть клиент &1&2. Пропускаем ...", v-current-cli-type, v-current-cli-code)).
                next _stroka.
              end.
              ...
              or error-status:error then do:
                                run write-log-and-file in p-log-handle (                 input 1                                          , input log-file-name                              , input 1                                          , input substitute("Не удалось получить данные записи <clients-01>: &1&2&3"                                               , error-status:get-message(1)                                               , chr(10)                                               , return-value)).
                next _stroka.
              end.
              _rel:
              for each buf_temp-rel-handle where
              ...
              case v-current-cli-type:
                when 'орг':U then do:
                  ...
                  run ref/firm1.p (
                      ...
                      ,input "cli-all":U
                      ,input yes
                      ,input - abs(buf_temp-clients_.obj-code)
                      ,input 0
