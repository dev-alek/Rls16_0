...
Tot-period-firm1 = new Dis-tot_host( input parparentproc, input p-parent-handle, input p-log-handle, input this-procedure:handle, input p-cont-handle, input v-current-lock, input v-current-wait, input v-save, input 5) .
 define variable Tot-period1 as class Dis-tot_ no-undo .
Tot-period1 = new Dis-tot_( input parparentproc, input p-parent-handle, input p-log-handle, input this-procedure:handle, input p-cont-handle, input v-current-lock, input v-current-wait, input v-save, input 5) .
...
Tot-period-firm1:Dis-tot_hostrelease_ ( ) .
Sale-sums:Dis-card-sale_objrelease_ ( ) .
Tot-period1:Dis-tot_release_ ( ) .
