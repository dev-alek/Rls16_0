...
PROCEDURE enable_UI :
  ...
  OPEN QUERY BROWSE-level FOR EACH X_lvl-name no-lock where X_lvl-name.upper-code = v-upper-code by X_lvl-name.level .    run open-query-gds-prt in this-procedure .
END PROCEDURE.
