...
define variable vss-workfile    as character no-undo init "$Workfile: gds-fill.p $":U .
define variable vss-archive     as character no-undo init "$Archive: gbl/gds-fill.p $":U .
