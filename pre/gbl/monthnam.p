...
def var vss-description as character no-undo init "Èìÿ ìåñÿöà".
...
:
  case p-month :
    ...
    when 9  then do:
      assign
        p-month-name = "ÑÅÍÒßÁĞÜ"
      .
    end.
    when 10 then do:
      assign
        p-month-name = "ÎÊÒßÁĞÜ"
      .
    end.
    when 11 then do:
      assign
    ...
    when 12 then do:
      assign
        p-month-name = "ÄÅÊÀÁĞÜ"
      .
    end.
    otherwise do:
      message
        vss-workfile vss-revision vss-description skip
        "Íåèçâåñòíîå çíà÷åíèå ïàğàìåòğà p-month" skip
