...
define input-output parameter f-date    as date      no-undo .
define input-output parameter f-time    as integer   no-undo .
...
procedure vss-get-parameters :
  define output parameter p-vss-parameters as character no-undo .
    assign
      p-vss-parameters = substitute('&1|&2':u,o-type,o-code)
    .
end procedure.
