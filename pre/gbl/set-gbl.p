...
:
  ...
  then do:
    assign
      v-msg = substitute( "&1. Неправильное значение параметра &2&3Должно быть &4 или &5", vss-workfile, "language":U, chr(10), 'eng':U, 'rus':U )
    .
  ...
  then do:
    assign
      v-msg = substitute( "&1. Incorrect version of str-glbl.i or incorrect value of &2 paramater&3Check str-glbl.i &2&3 Check language parameter &4":U, vss-workfile, "language":U, chr(10), g#language )
    .
    if g#news <> true then do:
      message
        vss-workfile vss-revision vss-description skip
