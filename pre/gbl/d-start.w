...
END.
ON CHOOSE OF b-config IN FRAME Dialog-Frame
DO:
  define variable v-help-str as character no-undo .
  assign
    v-help-str = "Для конфигурации списка внешних программ" + chr(10)
               + "обратитесь к администратору вашей системы" + chr(10)
               + chr(10)
               + "В случае, если какая-либо из программ не запускается" + chr(10)
               + "обратитесь к администратору вашей системы" + chr(10)
               + chr(10)
               + "Список программ задается в файле " + v-readconf-filename + chr(10)
               + "Текущая конфигурация прочитана из файла " + dtm-char(v-read-file) + chr(10)
               + "Для каждой внешней программы необходимо задать" + chr(10)
               + "следующие строки в указанном порядке" + chr(10)
               + v-conf-name    + "Имя файла" + chr(10)
               + v-conf-path    + "Командная строка" + chr(10)
               + v-conf-comment + "Комментарий" + chr(10)
               + chr(10)
               + "Пример:" + chr(10)
               + v-conf-name    + "IBS" + chr(10)
               + v-conf-path    + "http://www.ibs.ru/" + chr(10)
               + v-conf-comment + "IBS" + chr(10)
               + v-conf-name    + "IBS Retail" + chr(10)
               + v-conf-path    + "http://retail.ibs.ru/" + chr(10)
               + v-conf-comment + "Торговые решения IBS" + chr(10)
               + v-conf-name    + "IBS Trade House" + chr(10)
               + v-conf-path    + "http://www.google.ru/search?q=%22IBS+Trade+House%22" + chr(10)
               + v-conf-comment + "Поиск информации об IBS Trade House" + chr(10)
               + v-conf-name    + "Гугл" + chr(10)
               + v-conf-path    + "http://www.google.ru/" + chr(10)
               + v-conf-comment + "Поисковая система Google" + chr(10)
               + v-conf-name    + "Яндекс" + chr(10)
               + v-conf-path    + "http://www.yandex.ru/" + chr(10)
               + v-conf-comment + "Поисковая система Яндекс" + chr(10)
               + v-conf-name    + "name=Калькулятор" + chr(10)
               + v-conf-path    + "calc.exe" + chr(10)
               + v-conf-comment + "Калькулятор" + chr(10)
               + v-conf-name    + "Word" + chr(10)
               + v-conf-path    + "winword.exe" + chr(10)
               + v-conf-comment + "Microsoft Word" + chr(10)
               + v-conf-name    + "Excel" + chr(10)
               + v-conf-path    + "excel.exe" + chr(10)
               + v-conf-comment + "Microsoft Excel" + chr(10)
               + chr(10)
               + "Обратите внимание, что последняя строка должна завершаться символом конец строки" + chr(10)
               + chr(10)
  .
  run gbl/d-prompt.w
    (input
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  RUN enable_UI.
  if num-results( "BROWSE-1" ) = ?
  or num-results( "BROWSE-1" ) = 0
  then do:
    assign
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY BROWSE-1 FOR EACH temp-program NO-LOCK.
END PROCEDURE.
