...
define variable vss-description as character no-undo init "–адиотерминал. «арегистрировать количество по строке документа".
  ...
  :
    ...
    then do:
      ...
      then do:
        ...
        assign
          buf_batchprocess.bp_type        = 'rt-line':U
