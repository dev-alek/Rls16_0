...
def var vss-description as character no-undo init "¬ычисление последней даты мес€ца дл€ указанной даты".
...
procedure vss-get-parameters :
  define output parameter p-vss-parameters as character no-undo .
    assign
      p-vss-parameters = substitute('&1':u,in-date)
    .
end procedure.
...
if error-status :error then do:
  message
    ...
    "ќшибка при определении последнего дн€ мес€ца"
