...
for each ttUpd by ttUpd.fName:
      ...
      if mtxt eq encode(v-md5-signature + "updck" ) + string(index(encode(string(v-md5-signature)), "k"))
      then do:
...
define variable v-err-msg as character no-undo .
    ...
    if v-err-msg > "" then . else do :
      ...
      if v-err-msg > ""
      then v-err-msg = "AppError в модуле c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\gbl\code-updck.p" + v-err-msg.
      else v-err-msg = "AppError в модуле c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\gbl\code-updck.p" .
    end .
  end catch .
  catch exProErrors as class Progress.Lang.ProError :
    v-err-msg = exProErrors:GetMessage(1) .
    if v-err-msg > ""
    then v-err-msg = "ProError в модуле c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\gbl\code-updck.p" + v-err-msg.
    else v-err-msg = "ProError в модуле c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\gbl\code-updck.p" .
    return error v-err-msg.
  end catch .
  catch exAnyErrors as class Progress.Lang.Error:
    v-err-msg = "Unexpected error в модуле c:\tester\Rls_16_0\rc_160_rus\cmpdir\src\gbl\code-updck.p " + exAnyErrors:GetMessage(1).
    return error v-err-msg.
end catch .
finally:
