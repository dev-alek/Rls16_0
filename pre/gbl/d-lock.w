...
DO:
  RUN make-temp-table.
  OPEN QUERY BROWSE-1 FOR EACH temp-Lock NO-LOCK.
END.
...
DEF VAR sTableName AS CHARACTER NO-UNDO.
  ...
  PUT UNFORMATTED "procedure findrec : ":u + chr(10).
  PUT UNFORMATTED "DEF INPUT PARAMETER pRECID AS RECID NO-UNDO.":u + chr(10).
  ...
  :
    ...
    then do:
      ...
      .
      PUT UNFORMATTED
          "  run " + v-proc-name + " in this-procedure (input pRECID) .":U + chr(10).
      PUT UNFORMATTED
          " RETURN return-value .":u + chr(10).
      PUT UNFORMATTED "end procedure.":u + chr(10).
      PUT UNFORMATTED "procedure " + v-proc-name + " : ":u + chr(10).
      PUT UNFORMATTED "DEF INPUT PARAMETER pRECID AS RECID NO-UNDO.":u + chr(10).
    end.
    PUT UNFORMATTED
  ...
  PUT UNFORMATTED
      "DEFINE TEMP-TABLE temp-Lock NO-UNDO                                        ":u + chr(10)
    + "  FIELD Lock_RecID     AS RECID     LABEL 'RecId'                          ":u + chr(10)
    + "  FIELD Lock_TableName AS CHARACTER LABEL 'Table Name' FORMAT 'x(30)'      ":u + chr(10)
    + "  FIELD Lock_UserName  AS CHARACTER LABEL 'User Name'                      ":u + chr(10)
    + "  FIELD Lock_Flags     AS CHARACTER LABEL 'Flags'                          ":u + chr(10)
    + "  FIELD Lock_Type      as character LABEL 'Type'                           ":u + chr(10)
    + ".                                                                          ":u + chr(10)
    + "                                                                           ":u + chr(10)
    + "procedure fill-lock :                                                      ":u + chr(10)
    + "  define output parameter table for temp-lock .                            ":u + chr(10)
    + "                                                                           ":u + chr(10)
    + "  def var ind as integer no-undo .                                         ":u + chr(10)
    + "                                                                           ":u + chr(10)
    + "  FOR EACH _UserLock NO-LOCK                                               ":u + chr(10)
    + "    WHERE _UserLock._UserLock-Usr <> ?                                     ":u + chr(10)
    + "  :                                                                        ":u + chr(10)
    + "    do ind = 1 to extent(_UserLock._UserLock-Recid)                        ":u + chr(10)
    + "    :                                                                      ":u + chr(10)
    + "      if _UserLock._UserLock-Recid[ind] <> ? then do:                      ":u + chr(10)
    + "        create temp-lock.                                                  ":u + chr(10)
    + "        assign                                                             ":u + chr(10)
    + "          temp-lock.lock_recid    = _UserLock._UserLock-Recid[ind]         ":u + chr(10)
    + "          temp-lock.lock_username = string(_UserLock._UserLock-Usr) + ' '  ":u + chr(10)
    + "                                  + _UserLock._UserLock-Name               ":u + chr(10)
    + "          temp-lock.lock_flags    = _UserLock._UserLock-Flags[ind]         ":u + chr(10)
    + "          temp-lock.Lock_Type     = _UserLock._UserLock-Type[ind]          ":u + chr(10)
    + "        .                                                                  ":u + chr(10)
    + "      end.                                                                 ":u + chr(10)
    + "    end.                                                                   ":u + chr(10)
    + "  END.                                                                     ":u + chr(10)
    + "end procedure .                                                            ":u + chr(10)
  .
  output close .
