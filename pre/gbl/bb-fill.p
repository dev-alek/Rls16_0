...
define variable vss-workfile    as character no-undo init "$Workfile: bb-fill.p $":U .
define variable vss-archive     as character no-undo init "$Archive: gbl/bb-fill.p $":U .
