...
:
  ...
  :
      ...
      :
        ...
        if v-cell-type <> 0 then do:
          ...
          if v-cell-type = 1 then do:
            put stream slog unformatted 'format.font(,10,true)' + chr(10) .
          end.
          else do:
            put stream slog unformatted 'format.font(,12,,true)' + chr(10) .
            put stream slog unformatted 'patterns(1,,40,true)' + chr(10) .
          end.
        end.
      end.
    end.
    put stream slog unformatted 'select("r5c5")' + chr(10) .
    put stream slog unformatted 'format.number("@")' + chr(10) .
    put stream slog unformatted substitute('formula(&3,"r&1c&2")'
      ,5
      ,5
      ,'"12.02"'
    ...
    put stream slog unformatted 'select("r1c1")' + chr(10) .
