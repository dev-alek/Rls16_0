...
DO:
  ASSIGN
  rs-period-type.
  IF lookup(rs-period-type, 'day,week,month,year,hour,hour-last,shift,shift-last,yesterday,week-last,month-last,year-last,halfyear,halfyear-last,quarter,quarter-last':U) = 0
  THEN DO:
     MESSAGE
...
CASE p-mode:
  ...
  THEN DO:
    ASSIGN
    rs-period-type:radio-buttons IN FRAME Dialog-Frame =
    'Вчера':U + chr(44) + 'yesterday':U + chr(44) +
    'Неделя (прошлая)':U + chr(44) + 'week-last':U + chr(44) +
    'Месяц (прошлый)':U + chr(44) + 'month-last':U + chr(44) +
    'Год (прошлый)':U + chr(44) + 'year-last':U.
  END.
  WHEN "DWM" THEN DO:
    ASSIGN
    rs-period-type:radio-buttons IN FRAME Dialog-Frame =
    'Вчера':U + chr(44) + 'yesterday':U + chr(44) +
    'Неделя (прошлая)':U + chr(44) + 'week-last':U + chr(44) +
    'Месяц (прошлый)':U + chr(44) + 'month-last':U.
  END.
  otherwise do:
    message
    "Неверно задана мода "
