...
PROCEDURE adm-disable :
    DISABLE CB-Month b-prev-month b-next-month FI-Year b-prev-year b-next-year b-exit b-quit b-help fi-month-name WITH FRAME D-Dialog.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN CB-Month b-prev-month b-next-month FI-Year b-prev-year b-next-year b-exit b-quit b-help fi-month-name WITH FRAME D-Dialog.
