...
run thbjattr_tooltip in this-procedure (
 ...
 frame Dialog-Frame:title = entry( 2 ,v-label, ":" ) no-error .
 if error-status :error then frame Dialog-Frame:title = v-label .
 v-info =  REPLACE ( v-tooltip-code , "`" , "," ) .
 display v-info with frame Dialog-Frame .
...
for each buf_thbj-attr no-lock where
   ...
   find first x_thbj-attr where
       ...
       if buf_thbj-attr.obj-type  = 'орг':U then
        ...
        .
       if buf_thbj-attr.obj-type  <> 'орг':U and buf_thbj-attr.obj-type  <> ""
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run hostcode in g#library
  ...
  ,output v-host-code
       ...
       if buf_thbj-attr.obj-type = 'БД':U then do:
        assign
          x_thbj-attr.p1 = " БД"
          x_thbj-attr.ind1 = "0" + string( buf_thbj-attr.obj-code,":999999999") + "   " + string( 0 ,"999999999" ).
       end.
