...
for each ub.trn-doc exclusive-lock :
    if  ( ub.trn-doc.ext-doc-type = 'ie':U
          or ub.trn-doc.ext-doc-type = 'ee':U
          or ub.trn-doc.ext-doc-type = 'ep':U
          or ub.trn-doc.ext-doc-type = 're':U
        )
    ...
    then do:
     ...
     if   ub.trn-doc.internal = true  then do:
         ...
         if error-status :error then do:
            assign
              ub.trn-doc.cli-type = 'орг':U
              ub.trn-doc.cli-code = p-cli-code
              ub.trn-doc.internal = false
             .
            case ub.trn-doc.ext-doc-type :
              when  'iv':U     then  ub.trn-doc.ext-doc-type = 'ie':U .
              when  'ev':U     then  ub.trn-doc.ext-doc-type = 'ee':U .
              when  'rv':U then  ub.trn-doc.ext-doc-type = 're':U .
            end case.
