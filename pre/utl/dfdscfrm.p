...
:
  ...
  put stream slog unformatted
    '# Файл прав доступа, описаний и форматов полей для пакета upgrade' + chr(10)
  ...
  :
    ...
    put stream slog unformatted
      'UPDATE TABLE "' + _File._File-Name + '"' + chr(10)
      + '  CAN-READ "!,*"' + chr(10)
  ...
  put stream slog unformatted
    '.' + chr(10)
    'PSC' + chr(10)
    'codepage=' + session :stream chr(10)
    '.' + chr(10)
    STRING(v-file-length, "9999999999") + chr(10)
  .
  output stream slog close .
  message
