...
do:
  ...
  for each buf_clob-bind no-lock where buf_clob-bind.resource-type = 'egais-wb':U:
    ...
    for each tt-wb-gds-EG:
      ...
      then do:
        do trans:
          ...
          then do:
            put stream out unformatted substitute ("Создана запись: &1/&2 на основе накладной &3 от &4", tt-wb-gds-EG.refA, tt-wb-gds-EG.alc-code, tt-wb-header.num, tt-wb-header.wb-date) chr(10).
            ii = ii + 1.
          end.
        end.
      end.
