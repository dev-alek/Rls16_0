...
define variable vss-description as character no-undo initial "ѕолна€ очистка складского архива по товарам".
  ...
  then do:
    ...
    then do:
      message
        ...
        "Ќевозможно произвести очистку складского архива по товарам" skip
        view-as alert-box error .
    end.
    undo, return error "¬ данный момент рассчитываетс€ складской архив по товарам" .
  end.
