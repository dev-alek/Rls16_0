...
function waitfram-join-function returns character
  ...
  for each ub.alc-type-gds:
   ...
   if error-status :error
   then do:
      return error substitute("&1. Невозможно маршрутизировать alc-type-gds для отправки в новости &2&3&2&4", vss-workfile, chr(10), return-value, error-status :get-message ( 1 ) ).
   end.
end.
