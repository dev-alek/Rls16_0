...
procedure process-object :
  ...
  :
    ...
    assign
      v-delete-attr-list  = 'arh-detail':U
          + chr(44) + 'arh-start':U
          + chr(44) + 'arh-del':U
    ...
    run doclslib-export-doc-list in this-procedure
      ...
      ,input "Инициализация складского архива по товарам"
      ) .
  ...
  ,output v-cons-vat-pc
      ...
      find first buf_temp-stk-line
        where buf_temp-stk-line.obj-type   = p-obj-type
          ...
          and buf_temp-stk-line.sum-type   = 'crsa':U
      ...
      then do:
        ...
        assign
          ...
          buf_temp-stk-line.sum-type   = 'crsa':U
      ...
      assign
                                                                        buf_temp-stk-line.new-fact-qnty      = buf_temp-stk-line.new-fact-qnty      + v-fact-qnty           buf_temp-stk-line.new-sum-base       = buf_temp-stk-line.new-sum-base       + v-sum-base            buf_temp-stk-line.new-sum-rubl       = buf_temp-stk-line.new-sum-rubl       + v-sum-rubl            buf_temp-stk-line.new-vat-base       = buf_temp-stk-line.new-vat-base       + v-vat-base            buf_temp-stk-line.new-vat-rubl       = buf_temp-stk-line.new-vat-rubl       + v-vat-rubl            buf_temp-stk-line.new-slt-base       = buf_temp-stk-line.new-slt-base       + v-slt-base            buf_temp-stk-line.new-slt-rubl       = buf_temp-stk-line.new-slt-rubl       + v-slt-rubl            buf_temp-stk-line.new-road-tax-base  = buf_temp-stk-line.new-road-tax-base  + v-road-tax-base       buf_temp-stk-line.new-road-tax-rubl  = buf_temp-stk-line.new-road-tax-rubl  + v-road-tax-rubl       buf_temp-stk-line.new-excise-base    = buf_temp-stk-line.new-excise-base    + v-excise-base         buf_temp-stk-line.new-excise-rubl    = buf_temp-stk-line.new-excise-rubl    + v-excise-rubl         buf_temp-stk-line.new-transport-base = buf_temp-stk-line.new-transport-base + v-transport-base      buf_temp-stk-line.new-transport-rubl = buf_temp-stk-line.new-transport-rubl + v-transport-rubl      buf_temp-stk-line.new-other-base     = buf_temp-stk-line.new-other-base     + v-other-base          buf_temp-stk-line.new-other-rubl     = buf_temp-stk-line.new-other-rubl     + v-other-rubl
      .
      ...
      assign
        v-sum-type[1] = 'crsa':U
        v-cat-id[1]   = '##,##':U
        v-sum-type[2] = 'crsa':U + 'v':U
        v-cat-id[2]   = trim(string(v-crsa-vat-pc, ">99")) + "," + '##':U
        v-sum-type[3] = 'crsa':U + 's':U
        v-cat-id[3]   = '##':U + "," + trim(string(v-crsa-slt-pc, ">99"))
        v-sum-type[4] = 'crsa':U + 'x':U
      ...
      :
        ...
        assign
                                                                                          buf_temp-stk-tot.new-fact-qnty      = buf_temp-stk-tot.new-fact-qnty      + v-fact-qnty           buf_temp-stk-tot.new-sum-base       = buf_temp-stk-tot.new-sum-base       + v-sum-base            buf_temp-stk-tot.new-sum-rubl       = buf_temp-stk-tot.new-sum-rubl       + v-sum-rubl            buf_temp-stk-tot.new-vat-base       = buf_temp-stk-tot.new-vat-base       + v-vat-base            buf_temp-stk-tot.new-vat-rubl       = buf_temp-stk-tot.new-vat-rubl       + v-vat-rubl            buf_temp-stk-tot.new-slt-base       = buf_temp-stk-tot.new-slt-base       + v-slt-base            buf_temp-stk-tot.new-slt-rubl       = buf_temp-stk-tot.new-slt-rubl       + v-slt-rubl            buf_temp-stk-tot.new-road-tax-base  = buf_temp-stk-tot.new-road-tax-base  + v-road-tax-base       buf_temp-stk-tot.new-road-tax-rubl  = buf_temp-stk-tot.new-road-tax-rubl  + v-road-tax-rubl       buf_temp-stk-tot.new-excise-base    = buf_temp-stk-tot.new-excise-base    + v-excise-base         buf_temp-stk-tot.new-excise-rubl    = buf_temp-stk-tot.new-excise-rubl    + v-excise-rubl         buf_temp-stk-tot.new-transport-base = buf_temp-stk-tot.new-transport-base + v-transport-base      buf_temp-stk-tot.new-transport-rubl = buf_temp-stk-tot.new-transport-rubl + v-transport-rubl      buf_temp-stk-tot.new-other-base     = buf_temp-stk-tot.new-other-base     + v-other-base          buf_temp-stk-tot.new-other-rubl     = buf_temp-stk-tot.new-other-rubl     + v-other-rubl
        .
      end.
      for each buf_temp-parts
      on error undo, return error return-value
      :
        ...
        then do:
          message
            ...
            "Объект" p-obj-type p-obj-code skip
            "Артикул" p-artic p-prod-type p-prod-code skip
            "Тип суммы" 'основная_сумма_со_знаком':U skip
                                                                                    "v-fact-qnty"      v-fact-qnty        skip    "v-sum-base"       v-sum-base         skip    "v-sum-rubl"       v-sum-rubl         skip    "v-vat-base"       v-vat-base         skip    "v-vat-rubl"       v-vat-rubl         skip    "v-slt-base"       v-slt-base         skip    "v-slt-rubl"       v-slt-rubl         skip    "v-road-tax-base"  v-road-tax-base    skip    "v-road-tax-rubl"  v-road-tax-rubl    skip    "v-excise-base"    v-excise-base      skip    "v-excise-rubl"    v-excise-rubl      skip    "v-transport-base" v-transport-base   skip    "v-transport-rubl" v-transport-rubl   skip    "v-other-base"     v-other-base       skip    "v-other-rubl"     v-other-rubl
            view-as alert-box error .
          undo, return error return-value .
        end.
...
procedure store-line :
  ...
  :
    ...
    :
      ...
      or ( buf_temp-stk-line.cat-id = '##,##':U )
      then do:
        assign
          l-need-create-record =
                                                                                                                                                                          buf_temp-stk-line.new-fact-qnty      <> 0 or    buf_temp-stk-line.new-sum-base       <> 0 or    buf_temp-stk-line.new-sum-rubl       <> 0 or    buf_temp-stk-line.new-vat-base       <> 0 or    buf_temp-stk-line.new-vat-rubl       <> 0 or    buf_temp-stk-line.new-slt-base       <> 0 or    buf_temp-stk-line.new-slt-rubl       <> 0 or    buf_temp-stk-line.new-road-tax-base  <> 0 or    buf_temp-stk-line.new-road-tax-rubl  <> 0 or    buf_temp-stk-line.new-excise-base    <> 0 or    buf_temp-stk-line.new-excise-rubl    <> 0 or    buf_temp-stk-line.new-transport-base <> 0 or    buf_temp-stk-line.new-transport-rubl <> 0 or    buf_temp-stk-line.new-other-base     <> 0 or    buf_temp-stk-line.new-other-rubl     <> 0
                              or ( buf_temp-stk-line.cat-id = '##,##':U )
        .
        ...
        then do:
          ...
          assign
                                                                                    buf_stk-line.fact-qnty      = buf_temp-stk-line.new-fact-qnty            buf_stk-line.sum-base       = buf_temp-stk-line.new-sum-base             buf_stk-line.sum-rubl       = buf_temp-stk-line.new-sum-rubl             buf_stk-line.vat-base       = buf_temp-stk-line.new-vat-base             buf_stk-line.vat-rubl       = buf_temp-stk-line.new-vat-rubl             buf_stk-line.slt-base       = buf_temp-stk-line.new-slt-base             buf_stk-line.slt-rubl       = buf_temp-stk-line.new-slt-rubl             buf_stk-line.road-tax-base  = buf_temp-stk-line.new-road-tax-base        buf_stk-line.road-tax-rubl  = buf_temp-stk-line.new-road-tax-rubl        buf_stk-line.excise-base    = buf_temp-stk-line.new-excise-base          buf_stk-line.excise-rubl    = buf_temp-stk-line.new-excise-rubl          buf_stk-line.transport-base = buf_temp-stk-line.new-transport-base       buf_stk-line.transport-rubl = buf_temp-stk-line.new-transport-rubl       buf_stk-line.other-base     = buf_temp-stk-line.new-other-base           buf_stk-line.other-rubl     = buf_temp-stk-line.new-other-rubl
          .
        end.
        else do:
...
procedure store-tot :
  ...
  :
    ...
    :
      ...
      or ( buf_temp-stk-tot.cat-id = '##,##':U )
      then do:
        assign
          l-need-create-record =
                                                                                                                                                                          buf_temp-stk-tot.new-fact-qnty      <> 0 or    buf_temp-stk-tot.new-sum-base       <> 0 or    buf_temp-stk-tot.new-sum-rubl       <> 0 or    buf_temp-stk-tot.new-vat-base       <> 0 or    buf_temp-stk-tot.new-vat-rubl       <> 0 or    buf_temp-stk-tot.new-slt-base       <> 0 or    buf_temp-stk-tot.new-slt-rubl       <> 0 or    buf_temp-stk-tot.new-road-tax-base  <> 0 or    buf_temp-stk-tot.new-road-tax-rubl  <> 0 or    buf_temp-stk-tot.new-excise-base    <> 0 or    buf_temp-stk-tot.new-excise-rubl    <> 0 or    buf_temp-stk-tot.new-transport-base <> 0 or    buf_temp-stk-tot.new-transport-rubl <> 0 or    buf_temp-stk-tot.new-other-base     <> 0 or    buf_temp-stk-tot.new-other-rubl     <> 0
                              or ( buf_temp-stk-tot.cat-id = '##,##':U )
        .
        ...
        then do:
          ...
          assign
                                                                                    buf_stk-tot.fact-qnty      = buf_temp-stk-tot.new-fact-qnty            buf_stk-tot.sum-base       = buf_temp-stk-tot.new-sum-base             buf_stk-tot.sum-rubl       = buf_temp-stk-tot.new-sum-rubl             buf_stk-tot.vat-base       = buf_temp-stk-tot.new-vat-base             buf_stk-tot.vat-rubl       = buf_temp-stk-tot.new-vat-rubl             buf_stk-tot.slt-base       = buf_temp-stk-tot.new-slt-base             buf_stk-tot.slt-rubl       = buf_temp-stk-tot.new-slt-rubl             buf_stk-tot.road-tax-base  = buf_temp-stk-tot.new-road-tax-base        buf_stk-tot.road-tax-rubl  = buf_temp-stk-tot.new-road-tax-rubl        buf_stk-tot.excise-base    = buf_temp-stk-tot.new-excise-base          buf_stk-tot.excise-rubl    = buf_temp-stk-tot.new-excise-rubl          buf_stk-tot.transport-base = buf_temp-stk-tot.new-transport-base       buf_stk-tot.transport-rubl = buf_temp-stk-tot.new-transport-rubl       buf_stk-tot.other-base     = buf_temp-stk-tot.new-other-base           buf_stk-tot.other-rubl     = buf_temp-stk-tot.new-other-rubl
          .
        end.
        else do:
...
procedure clear-batch-arh :
  ...
  :
    ...
    for each buf_batchprocess no-lock where
             buf_batchprocess.bp_type  = 'prc':U
    on error undo, return error return-value
    :
          find first buf_price-doc no-lock
    ...
    for each buf_batchprocess no-lock
      where buf_batchprocess.bp_type = 'arh':U
    on error undo, return error return-value
    :
