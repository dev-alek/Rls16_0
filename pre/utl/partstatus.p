...
define variable vss-description as character no-undo init "¬ыравнивание статусов в партиии документа и строк после закрыти ".
...
if not available ub.trn-doc then do:
   message "Ќет документа закрытого на факт" p-doc-code view-as alert-box information .
   return.
end.
...
message '¬се по документу' p-doc-code view-as alert-box information  .
