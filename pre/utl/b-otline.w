...
PROCEDURE adm-display-fields :
      IF AVAILABLE ot-line THEN
          DISPLAY ot-line.sum-type ot-line.cat-id ot-line.fact-qnty ot-line.sum-base ot-line.sum-rubl ot-line.VAT-base ot-line.VAT-rubl ot-line.SLT-base ot-line.SLT-rubl ot-line.road-tax-base ot-line.road-tax-rubl ot-line.transport-base ot-line.transport-rubl ot-line.other-base ot-line.other-rubl ot-line.excise-base ot-line.excise-rubl ot-line.fact-order ot-line.obj-type ot-line.obj-code ot-line.doc-code ot-line.artic ot-line.prod-type ot-line.prod-code ot-line.ext-doc-type WITH BROWSE br_table
            NO-ERROR.
...
PROCEDURE adm-open-query :
    IF AVAILABLE(doc-line) THEN DO:
            OPEN QUERY br_table FOR EACH ot-line OF doc-line WHERE TRUE NO-LOCK     .
...
PROCEDURE send-records :
  ...
  DO i = 1 TO NUM-ENTRIES(p-tbl-list):
    ...
    WHEN "doc-line":U THEN p-rowid-list = p-rowid-list +
        ...
        ELSE "?":U.
    WHEN "ot-line":U THEN p-rowid-list = p-rowid-list +
        IF AVAILABLE ot-line THEN STRING(ROWID(ot-line))
        ELSE "?":U.
        OTHERWISE
        DO:
