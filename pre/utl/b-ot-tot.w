...
PROCEDURE adm-display-fields :
      IF AVAILABLE ot-tot THEN
          DISPLAY ot-tot.doc-code ot-tot.sum-type ot-tot.cat-id ot-tot.ext-doc-type ot-tot.fact-qnty ot-tot.sum-base ot-tot.sum-rubl ot-tot.VAT-base ot-tot.VAT-rubl ot-tot.SLT-base ot-tot.SLT-rubl ot-tot.road-tax-base ot-tot.road-tax-rubl ot-tot.transport-base ot-tot.transport-rubl ot-tot.other-base ot-tot.other-rubl ot-tot.excise-base ot-tot.excise-rubl ot-tot.fact-order ot-tot.obj-type ot-tot.obj-code WITH BROWSE br_table
            NO-ERROR.
...
PROCEDURE adm-open-query :
    IF AVAILABLE(trn-doc) THEN DO:
            OPEN QUERY br_table FOR EACH ot-tot OF trn-doc WHERE TRUE NO-LOCK     .
...
PROCEDURE send-records :
  ...
  DO i = 1 TO NUM-ENTRIES(p-tbl-list):
    ...
    WHEN "trn-doc":U THEN p-rowid-list = p-rowid-list +
        ...
        ELSE "?":U.
    WHEN "ot-tot":U THEN p-rowid-list = p-rowid-list +
        IF AVAILABLE ot-tot THEN STRING(ROWID(ot-tot))
        ELSE "?":U.
        OTHERWISE
        DO:
