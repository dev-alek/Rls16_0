...
procedure process-object :
  ...
  :
    ...
    assign
      v-delete-attr-list  = 'aht-detail':U
          + chr(44) + 'aht-start':U
          + chr(44) + 'aht-del':U
          ...
          + chr(44) + 'aht-recalc':U
    .
    do v-delete-ind = 1 to num-entries(v-delete-attr-list, chr(44))
    :
      run gbl/clntat-d.p
        (input p-obj-type
        ,input p-obj-code
        ,input entry(v-delete-ind, v-delete-attr-list, chr(44))
    ...
    run log-information in this-procedure
      (input p-obj-type
      ,input p-obj-code
      ,input "Удаление заданий на обработку складских документов"
      ) .
    run utl/aht-btcl.p
      (input p-obj-type
      ,input p-obj-code
    ...
    run doclslib-export-doc-list in this-procedure
      ...
      ,input "Инициализация складского архива по типам приобретения"
      ) .
    define variable v-total-ind as integer   no-undo .
    run log-information in this-procedure
      (input p-obj-type
      ,input p-obj-code
      ,input "Очистка архива"
      ) .
    run trg/aht-clr.p
      (input p-obj-type
      ,input p-obj-code
  ...
  ,output v-base-scale
    ...
    then do:
      run log-information in this-procedure
        (input p-obj-type
        ,input p-obj-code
        ,input "### ВНИМАНИЕ !!! ### Были обнаружены ошибки в товарных количествах. Всего ошибочных товаров " + string(v-total-err)
        ) .
    end.
    run log-information in this-procedure
      (input p-obj-type
      ,input p-obj-code
      ,input "Инициализация завершена. Обработано товаров " + string(v-ind)
      ) .
    run utl/arhiscr.p
      (input  p-obj-type
      ,input  p-obj-code
  ...
  :
    ...
    assign
      buf_temp-aht-stk-tot.fact-qnty = buf_temp-aht-stk-tot.fact-qnty + p-fact-qnty
                                                      buf_temp-aht-stk-tot.cost-sum-base       = buf_temp-aht-stk-tot.cost-sum-base       + p-cost-sum-base            buf_temp-aht-stk-tot.cost-sum-rubl       = buf_temp-aht-stk-tot.cost-sum-rubl       + p-cost-sum-rubl            buf_temp-aht-stk-tot.cost-vat-base       = buf_temp-aht-stk-tot.cost-vat-base       + p-cost-vat-base            buf_temp-aht-stk-tot.cost-vat-rubl       = buf_temp-aht-stk-tot.cost-vat-rubl       + p-cost-vat-rubl            buf_temp-aht-stk-tot.cost-slt-base       = buf_temp-aht-stk-tot.cost-slt-base       + p-cost-slt-base            buf_temp-aht-stk-tot.cost-slt-rubl       = buf_temp-aht-stk-tot.cost-slt-rubl       + p-cost-slt-rubl            buf_temp-aht-stk-tot.cost-road-tax-base  = buf_temp-aht-stk-tot.cost-road-tax-base  + p-cost-road-tax-base       buf_temp-aht-stk-tot.cost-road-tax-rubl  = buf_temp-aht-stk-tot.cost-road-tax-rubl  + p-cost-road-tax-rubl       buf_temp-aht-stk-tot.cost-excise-base    = buf_temp-aht-stk-tot.cost-excise-base    + p-cost-excise-base         buf_temp-aht-stk-tot.cost-excise-rubl    = buf_temp-aht-stk-tot.cost-excise-rubl    + p-cost-excise-rubl         buf_temp-aht-stk-tot.cost-transport-base = buf_temp-aht-stk-tot.cost-transport-base + p-cost-transport-base      buf_temp-aht-stk-tot.cost-transport-rubl = buf_temp-aht-stk-tot.cost-transport-rubl + p-cost-transport-rubl      buf_temp-aht-stk-tot.cost-other-base     = buf_temp-aht-stk-tot.cost-other-base     + p-cost-other-base          buf_temp-aht-stk-tot.cost-other-rubl     = buf_temp-aht-stk-tot.cost-other-rubl     + p-cost-other-rubl          buf_temp-aht-stk-tot.cost-discnt-base    = buf_temp-aht-stk-tot.cost-discnt-base    + p-cost-discnt-base          buf_temp-aht-stk-tot.cost-discnt-rubl    = buf_temp-aht-stk-tot.cost-discnt-rubl    + p-cost-discnt-rubl
                                                      buf_temp-aht-stk-tot.crsa-sum-base       = buf_temp-aht-stk-tot.crsa-sum-base       + p-crsa-sum-base            buf_temp-aht-stk-tot.crsa-sum-rubl       = buf_temp-aht-stk-tot.crsa-sum-rubl       + p-crsa-sum-rubl            buf_temp-aht-stk-tot.crsa-vat-base       = buf_temp-aht-stk-tot.crsa-vat-base       + p-crsa-vat-base            buf_temp-aht-stk-tot.crsa-vat-rubl       = buf_temp-aht-stk-tot.crsa-vat-rubl       + p-crsa-vat-rubl            buf_temp-aht-stk-tot.crsa-slt-base       = buf_temp-aht-stk-tot.crsa-slt-base       + p-crsa-slt-base            buf_temp-aht-stk-tot.crsa-slt-rubl       = buf_temp-aht-stk-tot.crsa-slt-rubl       + p-crsa-slt-rubl            buf_temp-aht-stk-tot.crsa-road-tax-base  = buf_temp-aht-stk-tot.crsa-road-tax-base  + p-crsa-road-tax-base       buf_temp-aht-stk-tot.crsa-road-tax-rubl  = buf_temp-aht-stk-tot.crsa-road-tax-rubl  + p-crsa-road-tax-rubl       buf_temp-aht-stk-tot.crsa-excise-base    = buf_temp-aht-stk-tot.crsa-excise-base    + p-crsa-excise-base         buf_temp-aht-stk-tot.crsa-excise-rubl    = buf_temp-aht-stk-tot.crsa-excise-rubl    + p-crsa-excise-rubl         buf_temp-aht-stk-tot.crsa-transport-base = buf_temp-aht-stk-tot.crsa-transport-base + p-crsa-transport-base      buf_temp-aht-stk-tot.crsa-transport-rubl = buf_temp-aht-stk-tot.crsa-transport-rubl + p-crsa-transport-rubl      buf_temp-aht-stk-tot.crsa-other-base     = buf_temp-aht-stk-tot.crsa-other-base     + p-crsa-other-base          buf_temp-aht-stk-tot.crsa-other-rubl     = buf_temp-aht-stk-tot.crsa-other-rubl     + p-crsa-other-rubl          buf_temp-aht-stk-tot.crsa-discnt-base    = buf_temp-aht-stk-tot.crsa-discnt-base    + p-crsa-discnt-base          buf_temp-aht-stk-tot.crsa-discnt-rubl    = buf_temp-aht-stk-tot.crsa-discnt-rubl    + p-crsa-discnt-rubl
                                                      buf_temp-aht-stk-tot.sale-sum-base       = buf_temp-aht-stk-tot.sale-sum-base       + p-sale-sum-base            buf_temp-aht-stk-tot.sale-sum-rubl       = buf_temp-aht-stk-tot.sale-sum-rubl       + p-sale-sum-rubl            buf_temp-aht-stk-tot.sale-vat-base       = buf_temp-aht-stk-tot.sale-vat-base       + p-sale-vat-base            buf_temp-aht-stk-tot.sale-vat-rubl       = buf_temp-aht-stk-tot.sale-vat-rubl       + p-sale-vat-rubl            buf_temp-aht-stk-tot.sale-slt-base       = buf_temp-aht-stk-tot.sale-slt-base       + p-sale-slt-base            buf_temp-aht-stk-tot.sale-slt-rubl       = buf_temp-aht-stk-tot.sale-slt-rubl       + p-sale-slt-rubl            buf_temp-aht-stk-tot.sale-road-tax-base  = buf_temp-aht-stk-tot.sale-road-tax-base  + p-sale-road-tax-base       buf_temp-aht-stk-tot.sale-road-tax-rubl  = buf_temp-aht-stk-tot.sale-road-tax-rubl  + p-sale-road-tax-rubl       buf_temp-aht-stk-tot.sale-excise-base    = buf_temp-aht-stk-tot.sale-excise-base    + p-sale-excise-base         buf_temp-aht-stk-tot.sale-excise-rubl    = buf_temp-aht-stk-tot.sale-excise-rubl    + p-sale-excise-rubl         buf_temp-aht-stk-tot.sale-transport-base = buf_temp-aht-stk-tot.sale-transport-base + p-sale-transport-base      buf_temp-aht-stk-tot.sale-transport-rubl = buf_temp-aht-stk-tot.sale-transport-rubl + p-sale-transport-rubl      buf_temp-aht-stk-tot.sale-other-base     = buf_temp-aht-stk-tot.sale-other-base     + p-sale-other-base          buf_temp-aht-stk-tot.sale-other-rubl     = buf_temp-aht-stk-tot.sale-other-rubl     + p-sale-other-rubl          buf_temp-aht-stk-tot.sale-discnt-base    = buf_temp-aht-stk-tot.sale-discnt-base    + p-sale-discnt-base          buf_temp-aht-stk-tot.sale-discnt-rubl    = buf_temp-aht-stk-tot.sale-discnt-rubl    + p-sale-discnt-rubl
    .
    define buffer buf_aht-stk-line for ub.aht-stk-line .
