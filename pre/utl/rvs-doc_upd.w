...
define query br-pump for ub.rvs-line-pump                scrolling.
define browse br-line query br-line no-lock display
      ...
      ub.rvs-line.pl-code  column-label 'Скл.место'
      place.loc1  column-label 'Номер резервуара'
      ub.rvs-line.state-measure-qnty  column-label 'Факт остаток'
      ub.rvs-line.measure-qnty  column-label 'Измер. остаток'
      ub.rvs-line.system-qnty  column-label 'Учет'
      ub.rvs-line.orig-system-qnty  column-label 'Первонач.учет'
      ub.rvs-line.state-add-qnty column-label 'Факт в!трубопроводе' format "->>,>>>,>>>.<<<"
      deviation-fact(buffer ub.rvs-line) column-label 'Отклонение(факт)' format "->>,>>>,>>>.<<<"
      deviation-measure(buffer ub.rvs-line) column-label 'Отклонение(измер)'
      ub.rvs-line.tolerance column-label 'Допустимое!отклонение'
      ub.rvs-line.state-brutto-qnty column-label 'Факт брутто'
      ub.rvs-line.brutto-qnty
      ub.rvs-line.state-density
      ub.rvs-line.density
      ub.rvs-line.state-measure-cli-qnty
      ub.rvs-line.measure-cli-qnty
      ub.rvs-line.system-cli-qnty
      ub.rvs-line.orig-system-cli-qnty
      ub.rvs-line.state-brutto-cli-qnty
      ub.rvs-line.brutto-cli-qnty
      ub.rvs-line.state-mh-qnty
      ub.rvs-line.meas-mh-qnty
      ub.rvs-line.state-am-qnty
      ub.rvs-line.meas-am-qnty
      ub.rvs-line.state-cf-qnty
      ub.rvs-line.meas-cf-qnty
      ub.rvs-line.state-level-total
      ub.rvs-line.level-total
      ub.rvs-line.state-level-petrol format "->>,>>>,>>>.<<<"
      ub.rvs-line.level-petrol
      ub.rvs-line.state-level-water
      ub.rvs-line.level-water
      ub.rvs-line.state-temperature
      ub.rvs-line.temperature
      enable ub.rvs-line.temperature
    with size 98.75 by 6 separators.
define browse br-pump query br-pump no-lock display
      ub.rvs-line-pump.pump-code column-label 'ТРК'
      ub.rvs-line-pump.nozzle-code column-label 'П'
      ub.rvs-line-pump.state-mh-qnty
      ub.rvs-line-pump.meas-mh-qnty
      ub.rvs-line-pump.state-am-qnty
      ub.rvs-line-pump.meas-am-qnty
      ub.rvs-line-pump.state-cf-qnty
      ub.rvs-line-pump.meas-cf-qnty
      ub.rvs-line-pump.state-mh-cnt
      ub.rvs-line-pump.meas-mh-cnt
      ub.rvs-line-pump.state-el-cnt
      ub.rvs-line-pump.meas-el-cnt
      ub.rvs-line-pump.state-am-cnt
      ub.rvs-line-pump.meas-am-cnt
      ub.rvs-line-pump.state-cf-cnt
      ub.rvs-line-pump.meas-cf-cnt
      ub.rvs-line-pump.icnt-code
      ub.rvs-line-pump.rvs-prev-code
      enable ub.rvs-line-pump.rvs-prev-code
...
assign
  ...
  br-line     :num-locked-columns in frame d-rvs = 5
  br-pump:num-locked-columns in frame d-rvs = 2
  b-add              :popup-menu in frame d-rvs         = menu m-add:handle
  b-add              :menu-mouse                                = 1
...
do:
  if pardoc-mode = 'ИЗМЕНЕНИЕ':U  or
     pardoc-mode = 'ДОБАВЛЕНИЕ':U then do:
...
on return, mouse-select-dblclick of br-pump in frame d-rvs
do:
  if b-chg-pump :sensitive then do: apply "choose" to b-chg-pump in frame d-rvs. end.
                           else do: apply "choose" to b-lkp-pump in frame d-rvs. end.
end.
...
on choose of b-chg-pump in frame d-rvs
do:
...
PROCEDURE sort-brbr-line :
  ...
  case sort-labelbr-line:
        when '*'  then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by get-mark (buffer ub.rvs-line) .   . END.
        when 'Артикул'  then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.goods.artic .   . END.
        when 'Название'  then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.goods.gds-name .   . END.
        when 'Скл.место'  then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.pl-code .   . END.
        when 'Номер резервуара'  then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by place.loc1 .   . END.
        when 'Факт остаток'  then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.state-measure-qnty .   . END.
        when 'Измер. остаток'  then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.measure-qnty .   . END.
        when 'Учет'  then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.system-qnty .   . END.
        when 'Первонач.учет'  then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.orig-system-qnty .   . END.
        when 'Факт в!трубопроводе'  then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.state-add-qnty .   . END.
        when 'Отклонение(факт)'  then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by deviation-fact(buffer ub.rvs-line) .   . END.
        when 'Отклонение(измер)'  then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by deviation-measure(buffer ub.rvs-line) .   . END.
        when 'Допустимое!отклонение'  then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.tolerance .   . END.
        when 'Факт брутто'  then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.state-brutto-qnty .   . END.
        when ub.rvs-line.brutto-qnty:label in browse br-line then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.brutto-qnty .   . END.
        when ub.rvs-line.state-density:label in browse br-line then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.state-density .   . END.
        when ub.rvs-line.density:label in browse br-line then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.density .   . END.
        when ub.rvs-line.state-measure-cli-qnty:label in browse br-line then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.state-measure-cli-qnty .   . END.
        when ub.rvs-line.measure-cli-qnty:label in browse br-line then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.measure-cli-qnty .   . END.
        when ub.rvs-line.system-cli-qnty:label in browse br-line then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.system-cli-qnty .   . END.
        when ub.rvs-line.orig-system-cli-qnty:label in browse br-line then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.orig-system-cli-qnty .   . END.
        when ub.rvs-line.state-brutto-cli-qnty:label in browse br-line then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.state-brutto-cli-qnty .   . END.
        when ub.rvs-line.brutto-cli-qnty:label in browse br-line then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.brutto-cli-qnty .   . END.
        when ub.rvs-line.state-mh-qnty:label in browse br-line then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.state-mh-qnty .   . END.
        when ub.rvs-line.meas-mh-qnty:label in browse br-line then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.meas-mh-qnty .   . END.
        when ub.rvs-line.state-am-qnty:label in browse br-line then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.state-am-qnty .   . END.
        when ub.rvs-line.meas-am-qnty:label in browse br-line then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.meas-am-qnty .   . END.
        when ub.rvs-line.state-cf-qnty:label in browse br-line then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.state-cf-qnty .   . END.
        when ub.rvs-line.meas-cf-qnty:label in browse br-line then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.meas-cf-qnty .   . END.
        when ub.rvs-line.state-level-total:label in browse br-line then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.state-level-total .   . END.
        when ub.rvs-line.level-total:label in browse br-line then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.level-total .   . END.
        when ub.rvs-line.state-level-petrol:label in browse br-line then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.state-level-petrol .   . END.
        when ub.rvs-line.level-petrol:label in browse br-line then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.level-petrol .   . END.
        when ub.rvs-line.state-level-water:label in browse br-line then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.state-level-water .   . END.
        when ub.rvs-line.level-water:label in browse br-line then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.level-water .   . END.
        when ub.rvs-line.state-temperature:label in browse br-line then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.state-temperature .   . END.
        when ub.rvs-line.temperature:label in browse br-line then DO:   open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code by ub.rvs-line.temperature .   . END.
    otherwise do:
      open query br-line    for each  ub.rvs-line no-lock where              ub.rvs-line.rvs-code =    r-doc.rvs-code      , first ub.goods        no-lock where              ub.goods.gds-code        = ub.rvs-line.gds-code      , first ub.place                where              ub.place.obj-type        = ub.rvs-line.obj-type and              ub.place.obj-code        = ub.rvs-line.obj-code and              ub.place.pl-code         = ub.rvs-line.pl-code.
...
on start-search, ctrl-o of br-pump in frame d-rvs do:
   run sort-brbr-pump
     (input (if available ub.rvs-line-pump
             then recid(ub.rvs-line-pump)
             else ?
            )
     ).
end.
PROCEDURE sort-brbr-pump :
  ...
  case sort-labelbr-pump:
        when 'ТРК'  then DO:   open query br-pump    for each ub.rvs-line-pump no-lock where             ub.rvs-line-pump.rvs-code = ub.rvs-line.rvs-code and             ub.rvs-line-pump.obj-type = ub.rvs-line.obj-type and             ub.rvs-line-pump.obj-code = ub.rvs-line.obj-code and             ub.rvs-line-pump.pl-code  = ub.rvs-line.pl-code  and             ub.rvs-line-pump.gds-code = ub.rvs-line.gds-code by ub.rvs-line-pump.pump-code .   . END.
        when 'П'  then DO:   open query br-pump    for each ub.rvs-line-pump no-lock where             ub.rvs-line-pump.rvs-code = ub.rvs-line.rvs-code and             ub.rvs-line-pump.obj-type = ub.rvs-line.obj-type and             ub.rvs-line-pump.obj-code = ub.rvs-line.obj-code and             ub.rvs-line-pump.pl-code  = ub.rvs-line.pl-code  and             ub.rvs-line-pump.gds-code = ub.rvs-line.gds-code by ub.rvs-line-pump.nozzle-code .   . END.
        when ub.rvs-line-pump.state-mh-qnty:label in browse br-pump then DO:   open query br-pump    for each ub.rvs-line-pump no-lock where             ub.rvs-line-pump.rvs-code = ub.rvs-line.rvs-code and             ub.rvs-line-pump.obj-type = ub.rvs-line.obj-type and             ub.rvs-line-pump.obj-code = ub.rvs-line.obj-code and             ub.rvs-line-pump.pl-code  = ub.rvs-line.pl-code  and             ub.rvs-line-pump.gds-code = ub.rvs-line.gds-code by ub.rvs-line-pump.state-mh-qnty .   . END.
        when ub.rvs-line-pump.meas-mh-qnty:label in browse br-pump then DO:   open query br-pump    for each ub.rvs-line-pump no-lock where             ub.rvs-line-pump.rvs-code = ub.rvs-line.rvs-code and             ub.rvs-line-pump.obj-type = ub.rvs-line.obj-type and             ub.rvs-line-pump.obj-code = ub.rvs-line.obj-code and             ub.rvs-line-pump.pl-code  = ub.rvs-line.pl-code  and             ub.rvs-line-pump.gds-code = ub.rvs-line.gds-code by ub.rvs-line-pump.meas-mh-qnty .   . END.
        when ub.rvs-line-pump.state-am-qnty:label in browse br-pump then DO:   open query br-pump    for each ub.rvs-line-pump no-lock where             ub.rvs-line-pump.rvs-code = ub.rvs-line.rvs-code and             ub.rvs-line-pump.obj-type = ub.rvs-line.obj-type and             ub.rvs-line-pump.obj-code = ub.rvs-line.obj-code and             ub.rvs-line-pump.pl-code  = ub.rvs-line.pl-code  and             ub.rvs-line-pump.gds-code = ub.rvs-line.gds-code by ub.rvs-line-pump.state-am-qnty .   . END.
        when ub.rvs-line-pump.meas-am-qnty:label in browse br-pump then DO:   open query br-pump    for each ub.rvs-line-pump no-lock where             ub.rvs-line-pump.rvs-code = ub.rvs-line.rvs-code and             ub.rvs-line-pump.obj-type = ub.rvs-line.obj-type and             ub.rvs-line-pump.obj-code = ub.rvs-line.obj-code and             ub.rvs-line-pump.pl-code  = ub.rvs-line.pl-code  and             ub.rvs-line-pump.gds-code = ub.rvs-line.gds-code by ub.rvs-line-pump.meas-am-qnty .   . END.
        when ub.rvs-line-pump.state-cf-qnty:label in browse br-pump then DO:   open query br-pump    for each ub.rvs-line-pump no-lock where             ub.rvs-line-pump.rvs-code = ub.rvs-line.rvs-code and             ub.rvs-line-pump.obj-type = ub.rvs-line.obj-type and             ub.rvs-line-pump.obj-code = ub.rvs-line.obj-code and             ub.rvs-line-pump.pl-code  = ub.rvs-line.pl-code  and             ub.rvs-line-pump.gds-code = ub.rvs-line.gds-code by ub.rvs-line-pump.state-cf-qnty .   . END.
        when ub.rvs-line-pump.meas-cf-qnty:label in browse br-pump then DO:   open query br-pump    for each ub.rvs-line-pump no-lock where             ub.rvs-line-pump.rvs-code = ub.rvs-line.rvs-code and             ub.rvs-line-pump.obj-type = ub.rvs-line.obj-type and             ub.rvs-line-pump.obj-code = ub.rvs-line.obj-code and             ub.rvs-line-pump.pl-code  = ub.rvs-line.pl-code  and             ub.rvs-line-pump.gds-code = ub.rvs-line.gds-code by ub.rvs-line-pump.meas-cf-qnty .   . END.
        when ub.rvs-line-pump.state-mh-cnt:label in browse br-pump then DO:   open query br-pump    for each ub.rvs-line-pump no-lock where             ub.rvs-line-pump.rvs-code = ub.rvs-line.rvs-code and             ub.rvs-line-pump.obj-type = ub.rvs-line.obj-type and             ub.rvs-line-pump.obj-code = ub.rvs-line.obj-code and             ub.rvs-line-pump.pl-code  = ub.rvs-line.pl-code  and             ub.rvs-line-pump.gds-code = ub.rvs-line.gds-code by ub.rvs-line-pump.state-mh-cnt .   . END.
        when ub.rvs-line-pump.meas-mh-cnt:label in browse br-pump then DO:   open query br-pump    for each ub.rvs-line-pump no-lock where             ub.rvs-line-pump.rvs-code = ub.rvs-line.rvs-code and             ub.rvs-line-pump.obj-type = ub.rvs-line.obj-type and             ub.rvs-line-pump.obj-code = ub.rvs-line.obj-code and             ub.rvs-line-pump.pl-code  = ub.rvs-line.pl-code  and             ub.rvs-line-pump.gds-code = ub.rvs-line.gds-code by ub.rvs-line-pump.meas-mh-cnt .   . END.
        when ub.rvs-line-pump.state-el-cnt:label in browse br-pump then DO:   open query br-pump    for each ub.rvs-line-pump no-lock where             ub.rvs-line-pump.rvs-code = ub.rvs-line.rvs-code and             ub.rvs-line-pump.obj-type = ub.rvs-line.obj-type and             ub.rvs-line-pump.obj-code = ub.rvs-line.obj-code and             ub.rvs-line-pump.pl-code  = ub.rvs-line.pl-code  and             ub.rvs-line-pump.gds-code = ub.rvs-line.gds-code by ub.rvs-line-pump.state-el-cnt .   . END.
        when ub.rvs-line-pump.meas-el-cnt:label in browse br-pump then DO:   open query br-pump    for each ub.rvs-line-pump no-lock where             ub.rvs-line-pump.rvs-code = ub.rvs-line.rvs-code and             ub.rvs-line-pump.obj-type = ub.rvs-line.obj-type and             ub.rvs-line-pump.obj-code = ub.rvs-line.obj-code and             ub.rvs-line-pump.pl-code  = ub.rvs-line.pl-code  and             ub.rvs-line-pump.gds-code = ub.rvs-line.gds-code by ub.rvs-line-pump.meas-el-cnt .   . END.
        when ub.rvs-line-pump.state-am-cnt:label in browse br-pump then DO:   open query br-pump    for each ub.rvs-line-pump no-lock where             ub.rvs-line-pump.rvs-code = ub.rvs-line.rvs-code and             ub.rvs-line-pump.obj-type = ub.rvs-line.obj-type and             ub.rvs-line-pump.obj-code = ub.rvs-line.obj-code and             ub.rvs-line-pump.pl-code  = ub.rvs-line.pl-code  and             ub.rvs-line-pump.gds-code = ub.rvs-line.gds-code by ub.rvs-line-pump.state-am-cnt .   . END.
        when ub.rvs-line-pump.meas-am-cnt:label in browse br-pump then DO:   open query br-pump    for each ub.rvs-line-pump no-lock where             ub.rvs-line-pump.rvs-code = ub.rvs-line.rvs-code and             ub.rvs-line-pump.obj-type = ub.rvs-line.obj-type and             ub.rvs-line-pump.obj-code = ub.rvs-line.obj-code and             ub.rvs-line-pump.pl-code  = ub.rvs-line.pl-code  and             ub.rvs-line-pump.gds-code = ub.rvs-line.gds-code by ub.rvs-line-pump.meas-am-cnt .   . END.
        when ub.rvs-line-pump.state-cf-cnt:label in browse br-pump then DO:   open query br-pump    for each ub.rvs-line-pump no-lock where             ub.rvs-line-pump.rvs-code = ub.rvs-line.rvs-code and             ub.rvs-line-pump.obj-type = ub.rvs-line.obj-type and             ub.rvs-line-pump.obj-code = ub.rvs-line.obj-code and             ub.rvs-line-pump.pl-code  = ub.rvs-line.pl-code  and             ub.rvs-line-pump.gds-code = ub.rvs-line.gds-code by ub.rvs-line-pump.state-cf-cnt .   . END.
        when ub.rvs-line-pump.meas-cf-cnt:label in browse br-pump then DO:   open query br-pump    for each ub.rvs-line-pump no-lock where             ub.rvs-line-pump.rvs-code = ub.rvs-line.rvs-code and             ub.rvs-line-pump.obj-type = ub.rvs-line.obj-type and             ub.rvs-line-pump.obj-code = ub.rvs-line.obj-code and             ub.rvs-line-pump.pl-code  = ub.rvs-line.pl-code  and             ub.rvs-line-pump.gds-code = ub.rvs-line.gds-code by ub.rvs-line-pump.meas-cf-cnt .   . END.
        when ub.rvs-line-pump.icnt-code:label in browse br-pump then DO:   open query br-pump    for each ub.rvs-line-pump no-lock where             ub.rvs-line-pump.rvs-code = ub.rvs-line.rvs-code and             ub.rvs-line-pump.obj-type = ub.rvs-line.obj-type and             ub.rvs-line-pump.obj-code = ub.rvs-line.obj-code and             ub.rvs-line-pump.pl-code  = ub.rvs-line.pl-code  and             ub.rvs-line-pump.gds-code = ub.rvs-line.gds-code by ub.rvs-line-pump.icnt-code .   . END.
        when ub.rvs-line-pump.rvs-prev-code:label in browse br-pump then DO:   open query br-pump    for each ub.rvs-line-pump no-lock where             ub.rvs-line-pump.rvs-code = ub.rvs-line.rvs-code and             ub.rvs-line-pump.obj-type = ub.rvs-line.obj-type and             ub.rvs-line-pump.obj-code = ub.rvs-line.obj-code and             ub.rvs-line-pump.pl-code  = ub.rvs-line.pl-code  and             ub.rvs-line-pump.gds-code = ub.rvs-line.gds-code by ub.rvs-line-pump.rvs-prev-code .   . END.
    otherwise do:
      open query br-pump    for each ub.rvs-line-pump no-lock where             ub.rvs-line-pump.rvs-code = ub.rvs-line.rvs-code and             ub.rvs-line-pump.obj-type = ub.rvs-line.obj-type and             ub.rvs-line-pump.obj-code = ub.rvs-line.obj-code and             ub.rvs-line-pump.pl-code  = ub.rvs-line.pl-code  and             ub.rvs-line-pump.gds-code = ub.rvs-line.gds-code.
...
on window-close of frame d-rvs apply "end-error":u to self.
...
enable b-exit b-help b-lkp b-lkp-pump br-line br-pump b-history b-notes with frame d-rvs.
assign ub.rvs-line.temperature:read-only in browse br-line = yes
       ub.rvs-line-pump.rvs-prev-code:read-only in browse br-pump = yes.
if r-doc.status_ = 'новый':U and
   (pardoc-mode = 'ДОБАВЛЕНИЕ':U or
    pardoc-mode = 'ИЗМЕНЕНИЕ':U        ) then do:
      enable r-doc.wrkr
             r-doc.agnt
             r-doc.boss
             r-wrkr r-agnt r-boss
             with frame d-rvs.
   if r-doc.rvs-type <> 'смена':U and
      not (r-doc.rvs-type = 'контроль':U and r-doc.is-full = yes) then
      enable b-add b-del b-mark with frame d-rvs.
   enable b-meas with frame d-rvs.
end.
if
   pardoc-mode = 'ИЗМЕНЕНИЕ':U then do:
   enable b-chg b-chg-pump with frame d-rvs.
end.
...
assign
  v-str-recid21 = trim( string( recid( ub.rvs-line ) , "->>>>>>>>>>>9":U ) )
  v-num-entry21 = lookup( v-str-recid21 , del-list )
.
if v-num-entry21 > 0 then do:
  assign
    entry( v-num-entry21, del-list ) = "":U
    del-list = trim( replace( del-list , chr(44) + chr(44) , chr(44) ) , chr(44) )
  .
end.
else do:
  assign
    del-list = del-list + ( if del-list = "":U then "":U else chr(44) ) + v-str-recid21
  .
end.
...
if valid-handle( g#lib-rvs ) <> yes then do:       run str/lib-rvs.p persistent no-error.       if error-status :error or valid-handle( g#lib-rvs ) <> yes then do:         message "Error starting lib-rvs.p" skip( 0 )           g#lib-rvs                        skip( 0 )           g#lib-rvs    :type               skip( 0 )           g#lib-rvs    :file-name          skip( 0 )           error-status :get-message( 1 )   skip( 0 )           return-value                     skip( 0 )         view-as alert-box error.         stop.       end.      end.     run lib-rvs_crrvslin in g#lib-rvs ( input r-doc.obj-type ,
                      ...
                      input cur_shift-obj.shift-num ) no-error .
      if error-status :error then do:
...
if pardoc-mode = 'ДОБАВЛЕНИЕ':U or
   ...
   find last prev_shift-obj where prev_shift-obj.obj-type = cur_shift-obj.obj-type and
                                  ...
                                  prev_shift-obj.status_  = 'зкр':U         and
   ...
   if available prev_shift-obj then do:
      find last prev_rvs-doc where prev_rvs-doc.obj-type   = prev_shift-obj.obj-type   and
                                   ...
                                   prev_rvs-doc.status_    = 'факт':U                   and
                                   prev_rvs-doc.rvs-type   = 'смена':U              no-lock no-error.
   end.
   find last prev_icnt-doc where
        ...
        and prev_icnt-doc.status_  = 'факт':U use-index fact-order no-lock no-error.
end.
...
case pardoc-mode :
  when 'ДОБАВЛЕНИЕ':U then do:
    if parrvs-type = 'смена':U then do:
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run curobjdt in g#library
  ...
  ,output v-obj-date
       ...
       assign
        ...
        .
       if parrvs-type = 'контроль':U and parall-place then
       ...
       if (r-doc.rvs-type = 'смена':U or parall-place) then do:
...
if parman = "boss" and paraction = "button" then do:
  ...
  find cli-buf where cli-buf.obj-code = input frame d-rvs r-doc.boss
                 and cli-buf.obj-type = 'чел':U no-lock no-error.
  assign v-ref-rec28 = ( if available cli-buf then recid( cli-buf ) else ? ).
  v-ref-rec = ( if available cli-buf then recid( cli-buf ) else ? ).
  release cli-buf.
  if not available cli-buf or ( NOT can-do( 'чел':U, cli-buf.obj-type ) ) then do:
    run ref/cli-all.w (  input parparentproc
...
if parman = "wrkr" and paraction = "button" then do:
  ...
  find cli-buf where cli-buf.obj-code = input frame d-rvs r-doc.wrkr
                 and cli-buf.obj-type = 'чел':U no-lock no-error.
  assign v-ref-rec31 = ( if available cli-buf then recid( cli-buf ) else ? ).
  v-ref-rec = ( if available cli-buf then recid( cli-buf ) else ? ).
  release cli-buf.
  if not available cli-buf or ( NOT can-do( 'чел':U, cli-buf.obj-type ) ) then do:
    run ref/cli-all.w (  input parparentproc
...
define buffer meas_pump-nozzle for ub.pump-nozzle.
  if available ub.rvs-line-pump then do:
    ...
    run waitfram-show in this-procedure ( input "Просматриваем измеряемые ТРК" ).
if valid-handle( g#lib-rvs ) <> yes then do:       run str/lib-rvs.p persistent no-error.       if error-status :error or valid-handle( g#lib-rvs ) <> yes then do:         message "Error starting lib-rvs.p" skip( 0 )           g#lib-rvs                        skip( 0 )           g#lib-rvs    :type               skip( 0 )           g#lib-rvs    :file-name          skip( 0 )           error-status :get-message( 1 )   skip( 0 )           return-value                     skip( 0 )         view-as alert-box error.         stop.       end.      end.     run lib-rvs_measpmnz in g#lib-rvs ( input ub.rvs-line-pump.obj-type ,
                      input ub.rvs-line-pump.obj-code ,
                      input-output table tt-pump-nozzle ) no-error .
    if error-status :error then do:
        message "Ошибка при определении пистолетов ТРК для измерения."
                return-value
...
do:
  if (valid-handle(g#library2) <> true) then do:   run gbl/library2.p persistent no-error .   if error-status :error or (valid-handle(g#library2) <> true) then do:     message       "Error starting library2.p" skip       g#library2 skip       g#library2 :type skip       g#library2 :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run chk-actg in g#library2
    ...
    ,input  v-cntxt-userid
    ,input  0
    ,input  'actn_rvs-shift_upd-revision-trk':U
    ,input  'object':U
    ,input  r-doc.host-code
    ,input  r-doc.obj-type
    ,input  r-doc.obj-code
...
do:
  if (valid-handle(g#library2) <> true) then do:   run gbl/library2.p persistent no-error .   if error-status :error or (valid-handle(g#library2) <> true) then do:     message       "Error starting library2.p" skip       g#library2 skip       g#library2 :type skip       g#library2 :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run chk-actg in g#library2
    ...
    ,input  v-cntxt-userid
    ,input  0
    ,input  'actn_rvs-control_upd-revision-trk':U
    ,input  'object':U
    ,input  r-doc.host-code
    ,input  r-doc.obj-type
    ,input  r-doc.obj-code
