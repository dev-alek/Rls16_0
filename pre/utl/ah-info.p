  ...
  :
    ...
    :
      ...
      assign
        ...
        buf_temp-obj-arh.archive-type = 'arh':U
        buf_temp-obj-arh.sort-code    = 1
        buf_temp-obj-arh.obj-deleted  = v-obj-deleted
      .
      run clntattr-value in this-procedure
        (input  buf_temp-obj-arh.obj-type
        ,input  buf_temp-obj-arh.obj-code
        ,input  'arh-calc':U
        ,output v-attr-value
        ,output v-attr-type
        ) .
      ...
      assign
        ...
        buf_temp-obj-arh.obj-code     = buf_clients.obj-code
        buf_temp-obj-arh.db-num       = buf_clients.db-num
        buf_temp-obj-arh.archive-type = 'ahsp':U
      ...
      .
      find first buf_batchprocess no-lock
        where buf_batchprocess.bp_type       = 'ahsp':U
          and buf_batchprocess.bp_status     = 'N':U
          and buf_batchprocess.CharKey_Three = buf_temp-obj-arh.obj-type
          and buf_batchprocess.Key#_One      = buf_temp-obj-arh.obj-code
        no-error .
      ...
      assign
        ...
        buf_temp-obj-arh.obj-code     = buf_clients.obj-code
        buf_temp-obj-arh.db-num       = buf_clients.db-num
        buf_temp-obj-arh.archive-type = 'aht':U
...
procedure scan-lock-prc :
  ...
  :
    ...
    for each buf_batchprocess no-lock
      where buf_batchprocess.bp_type   = "lock" + 'btpr':U
        and buf_batchprocess.bp_status = 'N':U
    on error undo, return error return-value
    :
      ...
      then do:
        find first buf_temp-obj-arh no-lock
          where buf_temp-obj-arh.obj-type     = buf_batchprocess.charkey_one
            ...
            and buf_temp-obj-arh.archive-type = 'arh':U
          no-error .
    ...
    for each buf_batchprocess no-lock
      where buf_batchprocess.bp_type   = "lock" + 'ahsp':U
        and buf_batchprocess.bp_status = 'N':U
    on error undo, return error return-value
    :
      find first lock_batchprocess exclusive-lock
      ...
      then do:
        find first buf_temp-obj-arh no-lock
          where buf_temp-obj-arh.obj-type     = buf_batchprocess.charkey_one
            and buf_temp-obj-arh.obj-code     = buf_batchprocess.key#_one
            and buf_temp-obj-arh.archive-type = 'ahsp':U
          no-error .
        if available buf_temp-obj-arh
        then do:
          assign
    ...
    for each buf_batchprocess no-lock
      where buf_batchprocess.bp_type   = "lock" + 'ahtb':U
        and buf_batchprocess.bp_status = 'N':U
    on error undo, return error return-value
    :
      find first lock_batchprocess exclusive-lock
      ...
      then do:
        find first buf_temp-obj-arh no-lock
          where buf_temp-obj-arh.obj-type     = buf_batchprocess.charkey_one
            and buf_temp-obj-arh.obj-code     = buf_batchprocess.key#_one
            and buf_temp-obj-arh.archive-type = 'aht':U
          no-error .
        if available buf_temp-obj-arh
        then do:
          assign
    ...
    for each buf_batchprocess no-lock
      where buf_batchprocess.bp_type   = "lock" + 'rsar':U
        and buf_batchprocess.bp_status = 'N':U
    on error undo, return error return-value
    :
      find first lock_batchprocess exclusive-lock
    ...
    for each buf_batchprocess no-lock
      where buf_batchprocess.bp_type   = "lock" + 'rsas':U
        and buf_batchprocess.bp_status = 'N':U
    on error undo, return error return-value
    :
      find first lock_batchprocess exclusive-lock
    ...
    for each buf_batchprocess no-lock
      where buf_batchprocess.bp_type   = "lock" + 'rsat':U
        and buf_batchprocess.bp_status = 'N':U
    on error undo, return error return-value
    :
      find first lock_batchprocess exclusive-lock
