...
define buffer buf2_temp-ef for vidtemp-ef1.
  ...
  :
    ...
    v-fnamelist = "car-reg-number,car-brand,ef-format,issue-code,issued-by,issue-date,valid-from,valid-date,petrol-code-1,petrol-code-2,petrol-code-3,petrol-code-4".
