...
main_block:
do
on error  undo main_block, return error substitute( "&1. &2&3&4", vss-workfile, return-value, chr(10), error-status :get-message ( 1 ) )
  ...
  :
    ...
    if available ub.goods then do:
      ...
      assign
        ...
        ub.c-contract-specif.VAT-type      = 'в т. ч.':U
  ...
  :
    ...
    if available ub.goods then do:
      ...
      assign
        ...
        ub.contract-specif.VAT-type      = 'в т. ч.':U
