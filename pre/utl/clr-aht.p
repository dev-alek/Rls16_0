...
define variable vss-description as character no-undo initial "ѕолна€ очистка складского архива по типам приобретени€ и удаление атрибутов".
  ...
  if error-status :error then do:
    ...
    then do:
      message
        ...
        "Ќевозможно очистить складской архив по типам приобретени€" skip
        view-as alert-box error .
    end.
    undo, return error "¬ данный момент рассчитываетс€ складской архив по типам приобретени€" .
  end.
