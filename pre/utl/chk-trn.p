...
for each trn-doc no-lock
  where trn-doc.doc-type = 'при':U
    and trn-doc.status_  = 'факт':U
    and trn-doc.internal = true
    and trn-doc.discnt-type = 'прво':U
:
      ...
      if l-fix-documents = true then do:
        ...
        :
          ...
          run utl/fctnumch.p
            ...
            ,input 'trn-doc':U
            ,input v-new-trn-doc-fact-num
            ,input l-log-fact-num-change
            ).
          run utl/fctnumch.p
            (input ub.price-doc.doc-num
            ,input 'price-doc':U
            ,input v-new-price-doc-fact-num
            ,input l-log-fact-num-change
            ).
        end.
      end.
