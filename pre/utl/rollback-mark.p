...
v-marking = GetCodeIdent(v-mark) .
    ...
    for each buf_marking-lines exclusive-lock where buf_marking-lines.mark begins v-marking and buf_marking-lines.out-code = 'free-zone':U:
       run nws/cmd-del.p
   ...
   delete buf_marking-lines .
    ...
    for each buf_marking-lines exclusive-lock where buf_marking-lines.mark begins v-marking and buf_marking-lines.out-code = 'out-zone':U:
       run nws/cmd-del.p
      ( input "marking-lines":U
      ,input (buffer buf_marking-lines:handle)
      ,input ""
