...
define variable vss-description as character no-undo init "»нициализаци€ партий на основании складских документов".
...
.
message
  "¬ы хотите обрабатывать свободную зону?" skip
  "free-zone" skip
...
.
message
  "¬ы хотите обрабатывать расходную зону?" skip
  "out-zone" skip
...
.
message
  "¬ы хотите обрабатывать архивные партии?" skip
...
.
message
  "»нициализаци€ партий по внешним приходам." skip
  "Ѕудут обработаны:" skip
