...
:
  ...
  :
    if not (ub.cash-desk.pos-type = 'MARIA':U
          or
          ub.cash-desk.pos-type = 'r-keeper':U
          ) then next.
    for each ub.cd-clu no-lock where
            ub.cd-clu.obj-type = 'маг':U
