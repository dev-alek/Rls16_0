...
define variable vss-include-info4 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
  ...
  run gbl/d-askw.w
    (input "Вопрос"
    ,input vss-description + chr(10)
        + "Результат работы программы записывается в файлы:" + chr(10) + chr(10)
        + "allgdsoat.txt - значения атрибутов," + chr(10)
...
procedure initialise-ov-on :
  ...
  for each ub.price-doc exclusive-lock
    where price-doc.status_  = 'разрешен':U
...
procedure initialise-inv-on :
  ...
  for each ub.trn-doc exclusive-lock
    where ub.trn-doc.obj-type     = p-obj-type
      ...
      and ub.trn-doc.internal     = no
      and ub.trn-doc.doc-type     = 'инв':U
      and ub.trn-doc.ext-doc-type = 'ap':U
      ...
      and ub.trn-doc.internal     = no
      and ub.trn-doc.doc-type     = 'инв':U
      and ub.trn-doc.ext-doc-type = 'vp':U
      and ub.trn-doc.status_      = 'накл':U
      and ub.trn-doc.flag_        = no
  :
