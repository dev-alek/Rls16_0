...
DO:
    ...
    OPEN QUERY br-table FOR EACH temp_goods NO-LOCK.
END.
ON CHOOSE OF bt-attr IN FRAME Dialog-Frame
DO:
    ...
    :
        ...
        :
            ...
            run ref/fgdsobj1.p (
                ...
                , input buf_temp_goods.fbr-obj-type
                , input buf_temp_goods.fbr-obj-code
                , input ( buf_temp_goods.is-cd            = "+":U )
                , input ( buf_temp_goods.is-menu          = "+":U )
                , input ( buf_temp_goods.is-modificator   = "+":U )
                , input ( buf_temp_goods.is-null-price    = "+":U )
                , input ( buf_temp_goods.is-season        = "+":U )
                , input ( buf_temp_goods.is-semi-finished = "+":U )
            ) no-error.
            if error-status:error
            then do:
                message
