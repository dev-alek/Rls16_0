...
PROCEDURE MyEnable :
ASSIGN
cb-data-type:LIST-ITEMS IN FRAME Dialog-Frame = 'character,date,decimal,integer,logical':U + chr(44) + 'handle':U
cb-param-mode:LIST-ITEMS IN FRAME Dialog-Frame = 'input,output,input-output,buffer,input table,output table,input-output table':u .
cb-fields:LIST-ITEMS IN FRAME Dialog-Frame = 'doc_chk-date,doc_chk-time,doc_dc-category,doc_dc-d-pcnt,doc_dc-cash-d-pcnt,doc_recalc-gline-num,doc_recalc-pline-num,doc_st-for-discnt-r-b,doc_to-pay-r-b,doc_base-rate,doc_obj-code':U + chr(44) +
                                              'gline_line-num,gline_src-discnt,gline_src-code,gline_src-price,gline_start-src-price,gline_price-base,gline_src-qnty,gline_doc-qnty,gline_b-code,gline_gds-code,gline_sum-grp-code,gline_src-price-netto,gline_price-base-netto,gline_without-gds-discnt,gline_without-subtotal-discnt,gline_cli-base-rate,gline_recalc-line-num':U + chr(44) +
                                              'dline_discnt-value-abs,dline_discnt-value-pcnt,dline_rule-num,dline_nonunique,dline_templ-rl-root,dline_value-type,dline_delta-discnt,dline_discnt-role,dline_charkey,dline_intended,dline_object-sum,dline_not-found':U + chr(44) +
                                              'cntxt_chk-discnt-table,cntxt_chk-gds-table,cntxt_chk-pay-table':U + chr(44) +
                                              'pline_line-num,pline_exch-rate,pline_exch-scale,pline_tot-sum,pline_recalc-line-num':U
.
ASSIGN
...
b-quit
B-Help
f-param-num WHEN p-mode <> 'ПРОСМОТР':U
f-param-name WHEN p-mode <> 'ПРОСМОТР':U
cb-data-type WHEN p-mode <> 'ПРОСМОТР':U
Cb-param-mode WHEN p-mode <> 'ПРОСМОТР':U
f-param-descr WHEN p-mode <> 'ПРОСМОТР':U
cb-fields WHEN p-mode <> 'ПРОСМОТР':U
WITH FRAME Dialog-Frame.
VIEW FRAME Dialog-Frame.
...
END PROCEDURE.
PROCEDURE proc-save :
IF p-mode = 'ПРОСМОТР':U THEN UNDO, RETURN ERROR.
...
f-param-descr
cb-fields
v-param-value = f-param-name + chr(44) +
                cb-data-type + chr(44) +
                cb-param-mode + chr(44) +
                f-param-descr + chr(44) +
                cb-fields.
END PROCEDURE.
