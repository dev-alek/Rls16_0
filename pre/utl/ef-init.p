  ...
  if v-setted then do:
    ...
    or buf2_temp-ef.issue-date <> ? then do:
      ...
      run ref/view-chg.w (
                          ...
                          ,input "Данные на МБ"
                          ,input ""
                          ,input ("Данный МБ УЖЕ СОДЕРЖИТ ИДЕНТИФИКАЦИОННУЮ ИНФОРМАЦИЮ" + chr(10) +
                                 "Внимательно просмотрите отличающиеся поля (ЕСЛИ ОНИ ЕСТЬ), прежде чем принять решение об инициализации")
