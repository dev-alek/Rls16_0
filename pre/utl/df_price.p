...
put unformatted
  '# Файл деноминации полей, хранящих денежные суммы' + chr(10)
  '# !!!! Внимание !!!!' + chr(10)
  '# Данный файл сгенерирован автоматически при помощи программы df_price.p' + chr(10)
...
:
  ...
  :
    ...
    put unformatted
      ...
      '# DESCRIPTION "' + _Field._Desc + '"' + chr(10)
      '# DECIMALS ' + STRING(_Field._Decimals) + chr(10)
      '# FORMAT "' + _Field._Format + '"' + chr(10)
      '  FORMAT "' + v-new-format + '"' + chr(10)
      + chr(10)
    .
    output close .
  end.
