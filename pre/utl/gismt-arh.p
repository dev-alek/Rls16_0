...
define variable vFileReq1     as character no-undo.
define variable vFileReq2     as character no-undo.
define variable vFileReq3     as character no-undo.
define variable vFileReq4     as character no-undo.
define variable vFileReqPathArh1 as character no-undo.
define variable vFileReqPathArh2 as character no-undo.
define variable vFileReqPathArh3 as character no-undo.
define variable vFileReqPathArh4 as character no-undo.
define variable vFileReqPath1 as character no-undo.
define variable vFileReqPath2 as character no-undo.
define variable vFileReqPath3 as character no-undo.
define variable vFileReqPath4 as character no-undo.
define variable vFileArh     as character no-undo.
define variable vFolderPath  as character no-undo.
define variable vArchPath    as character no-undo.
define variable vFileArhPath as character no-undo.
define variable vArhName     as character no-undo.
define variable vMyWorkDir   as character no-undo.
