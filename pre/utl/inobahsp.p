...
procedure process-object :
  ...
  :
    ...
    assign
      v-delete-attr-list  = 'ahsp-detail':U
          + chr(44) + 'ahsp-start':U
          + chr(44) + 'ahsp-del':U
    ...
    run doclslib-export-doc-list in this-procedure
      ...
      ,input "Инициализация складского архива по поставщикам"
      ) .
      ...
      :
        ...
        :
          ...
          :
            ...
            assign
                                                                                                                              buf_temp-stk-supp-tot.new-fact-qnty      = buf_temp-stk-supp-tot.new-fact-qnty      + v-fact-qnty           buf_temp-stk-supp-tot.new-sum-base       = buf_temp-stk-supp-tot.new-sum-base       + v-sum-base            buf_temp-stk-supp-tot.new-sum-rubl       = buf_temp-stk-supp-tot.new-sum-rubl       + v-sum-rubl            buf_temp-stk-supp-tot.new-vat-base       = buf_temp-stk-supp-tot.new-vat-base       + v-vat-base            buf_temp-stk-supp-tot.new-vat-rubl       = buf_temp-stk-supp-tot.new-vat-rubl       + v-vat-rubl            buf_temp-stk-supp-tot.new-slt-base       = buf_temp-stk-supp-tot.new-slt-base       + v-slt-base            buf_temp-stk-supp-tot.new-slt-rubl       = buf_temp-stk-supp-tot.new-slt-rubl       + v-slt-rubl            buf_temp-stk-supp-tot.new-road-tax-base  = buf_temp-stk-supp-tot.new-road-tax-base  + v-road-tax-base       buf_temp-stk-supp-tot.new-road-tax-rubl  = buf_temp-stk-supp-tot.new-road-tax-rubl  + v-road-tax-rubl       buf_temp-stk-supp-tot.new-excise-base    = buf_temp-stk-supp-tot.new-excise-base    + v-excise-base         buf_temp-stk-supp-tot.new-excise-rubl    = buf_temp-stk-supp-tot.new-excise-rubl    + v-excise-rubl         buf_temp-stk-supp-tot.new-transport-base = buf_temp-stk-supp-tot.new-transport-base + v-transport-base      buf_temp-stk-supp-tot.new-transport-rubl = buf_temp-stk-supp-tot.new-transport-rubl + v-transport-rubl      buf_temp-stk-supp-tot.new-other-base     = buf_temp-stk-supp-tot.new-other-base     + v-other-base          buf_temp-stk-supp-tot.new-other-rubl     = buf_temp-stk-supp-tot.new-other-rubl     + v-other-rubl
            .
          end.
        end.
      end.
