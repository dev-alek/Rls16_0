...
:
  ...
  assign
    ...
    v-new-description = replace(v-new-description, chr(10), ' ')
  .
...
:
  ...
  :
    ...
    put stream slog unformatted
      'ADD TABLE "' + _File._File-Name + '"' + chr(10)
      .
    put stream slog unformatted
      '  DESCRIPTION ' .
    export stream slog
    ...
    :
      ...
      then do:
        ...
        and _field._format = ">>>>9" then do:
          ...
          assign
            v-field-format = replace(v-field-format, chr(44), '':U)
          .
      ...
      then do:
        put stream slog unformatted
          '  ORDER ' + string(_Field._Order) + chr(10).
      end.
...
procedure export_index :
  ...
  :
      put stream slog unformatted
        'ADD INDEX "' + _Index._Index-name  + '" ON "' + _File._File-Name + '"' + chr(10)
        .
