...
:
    output stream out-stream to "fbrout.txt".
    ...
    run write-log in this-procedure ( "Приход Уч.цены руб.  ", buf_fbr-doc.in-rubl ).
    ...
    run write-log in this-procedure ( "Приход Пр.ц.НДС руб. ", buf_fbr-doc.in-vat-rubl ).
    ...
    run write-log in this-procedure ( "Расход Уч.цены руб.  ", buf_fbr-doc.out-rubl ).
    ...
    run write-log in this-procedure ( "Расход Пр.ц.НДС руб. ", buf_fbr-doc.out-vat-rubl ).
    ...
    :
        ...
        :
            ...
            then do:
                ...
                run write-log in this-procedure ( "Уч.цена руб.         ", buf_fbr-line.price-rubl ).
                ...
                run write-log in this-procedure ( "Сумма уч.ц. руб.     ", buf_fbr-line.price-sum-rubl ).
                run write-log in this-procedure ( "Сумма НДС уч.ц. б.в. ", buf_fbr-line.price-sum-vat-base ).
                run write-log in this-procedure ( "Сумма НДС уч.ц. руб. ", buf_fbr-line.price-sum-vat-rubl ).
            end.
            else do:
...
:
    ...
    :
        ...
        otherwise do:
            put stream out-stream unformatted
                substitute( "&2: &3&1", chr(10), p-name-string, p-value-string )
            .
        end.
    end case.
end.
