...
if (valid-handle(ibs.th.gbl.gbl-hndllib:g#lib-trn) <> true) then do:   run str/lib-trn.p persistent no-error .   if error-status :error or (valid-handle(ibs.th.gbl.gbl-hndllib:g#lib-trn) <> true) then do:     message       "Error starting lib-trn.p" skip       ibs.th.gbl.gbl-hndllib:g#lib-trn skip       ibs.th.gbl.gbl-hndllib:g#lib-trn :type skip       ibs.th.gbl.gbl-hndllib:g#lib-trn :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run lib-trn_is-petrl in g#lib-trn
  ...
  , output varis-pieces
    ...
    find first buf-first_doc-line share-lock
      where buf-first_doc-line.obj-type   = parobj-type
        ...
        and buf-first_doc-line.status_    = 'факт':U
    ...
    if available buf-first_doc-line then do:
      ...
      if available buf-first_inv-line then do:
        if lookup( buf-first_trn-doc.ext-doc-type, 'ee,ep,es,we,ev,em,wm,eo':U ) > 0 then do:
          assign
            v-sign = -1.0
          .
        end.
        ...
        if buf-first_trn-doc.doc-type = 'инв':U then do:
      ...
      if not available buf_inv-line then do:
        ...
        find last buf-prev_doc-line exclusive-lock
          where buf-prev_doc-line.obj-type   = buf_doc-line.obj-type
            ...
            and buf-prev_doc-line.status_    = 'факт':U
        ...
        put stream LogStream unformatted
          ...
          .
        output stream LogStream close.
        if absolute( buf_doc-line.fact-qnty - v-qnty * v-sign ) <= 0.001
          and v-cli-qnty = 0.0
        then do:
          case buf_trn-doc.doc-type :
            when 'инв':U then do:
              if v-pl-qnty = 1
                and absolute( buf_doc-line.cli-qnty - v-cli-qnty * v-sign ) > 0.001
              then do:
                assign
            ...
            :
              ...
              then do:
                ...
                if v-qnty <> 0.0 then do:
                  assign
                    buf_doc-pl.cli-fact-qnty = v-new-cli-qnty * buf_doc-pl.fact-qnty / v-qnty
        ...
        if buf_parts.out-code <> 'free-zone':U then do:
          ...
          if buf-parts_trn-doc.status_ <> 'факт':U then do:
            find first buf-parts_doc-pl exclusive-lock
              ...
              .
            if buf-parts_trn-doc.doc-type = 'инв':U then do:
