...
define variable vss-include-info8 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
  ...
  define variable v-cntxt-is-admin      as logical   no-undo .
    ...
    define variable v-good-counter          as int          init 0      no-undo.
    define variable v-was-changed           as logical      init no     no-undo.
    define variable v-today                 as date                     no-undo.
    define variable v-time                  as integer                  no-undo.
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run hostcode in g#library
  (input  v-g-ut-stk-store-type
  ,input  v-g-ut-stk-store-code
  ,output v-g-ut-stk-host-code
  )  .
    object-on-this-firm:
    for each temp-obj
    ...
    :
        ...
        then do:
            ...
            then do:
                ...
                where ub.stk-line.obj-type  = buf_gds-obj.obj-type
                    ...
                    and ub.stk-line.sum-type  = 'cost':U
        ...
        :
            assign
                ...
                temp-good.sum-last = temp-good.sum-last +  ub.stk-line.sum-rubl
            .
            leave.
        end.
        for each ub.stk-line
        ...
        :
            assign
                ...
                temp-good.sum-first     = temp-good.sum-first +  ub.stk-line.sum-rubl
            .
            leave.
        end.
        if v-last-tmp-obj = yes and v-temp-exists = yes
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run bcodeprc in g#library
  (input  temp-fact-ord.obj-type
  ,input  temp-fact-ord.obj-code
  ,input  gp-b-code
  ,input  0
  ,input  gp-fact-order
  ,output gp-doc-num
