...
for each old-dis-card-type  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-dis-card-type.
   buffer-copy old-dis-card-type to new-dis-card-type.
end.
for each old-dis-card-type-attr  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-dis-card-type-attr.
   buffer-copy old-dis-card-type-attr to new-dis-card-type-attr.
end.
for each old-dis-card-mask  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-dis-card-mask.
   buffer-copy old-dis-card-mask to new-dis-card-mask.
end.
for each old-dis-card-mask-attr  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-dis-card-mask-attr.
   buffer-copy old-dis-card-mask-attr to new-dis-card-mask-attr.
end.
if varstay-history then do:
for each old-c-dis-card-type  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-c-dis-card-type.
   buffer-copy old-c-dis-card-type to new-c-dis-card-type.
end.
for each old-c-dis-card-type-attr  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-c-dis-card-type-attr.
   buffer-copy old-c-dis-card-type-attr to new-c-dis-card-type-attr.
end.
for each old-c-dis-card-mask  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-c-dis-card-mask.
   buffer-copy old-c-dis-card-mask to new-c-dis-card-mask.
end.
for each old-c-dis-card-mask-attr  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-c-dis-card-mask-attr.
   buffer-copy old-c-dis-card-mask-attr to new-c-dis-card-mask-attr.
end.
end.
for each old-dis-dct-rule  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-dis-dct-rule.
   buffer-copy old-dis-dct-rule to new-dis-dct-rule.
end.
for each old-dis-dct-rule-attr  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-dis-dct-rule-attr.
   buffer-copy old-dis-dct-rule-attr to new-dis-dct-rule-attr.
end.
if varstay-history then do:
for each old-c-dis-dct-rule  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-c-dis-dct-rule.
   buffer-copy old-c-dis-dct-rule to new-c-dis-dct-rule.
end.
end.
for each old-dis-rule  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-dis-rule.
   buffer-copy old-dis-rule to new-dis-rule.
end.
if varstay-history then do:
for each old-c-dis-rule  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-c-dis-rule.
   buffer-copy old-c-dis-rule to new-c-dis-rule.
end.
end.
for each old-dis-rule-attr  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-dis-rule-attr.
   buffer-copy old-dis-rule-attr to new-dis-rule-attr.
end.
if varstay-history then do:
for each old-c-dis-rule-attr  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-c-dis-rule-attr.
   buffer-copy old-c-dis-rule-attr to new-c-dis-rule-attr.
end.
end.
for each old-dis-time-rule  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-dis-time-rule.
   buffer-copy old-dis-time-rule to new-dis-time-rule.
end.
if varstay-history then do:
for each old-c-dis-time-rule  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-c-dis-time-rule.
   buffer-copy old-c-dis-time-rule to new-c-dis-time-rule.
end.
end.
for each old-dis-time-rule-attr  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-dis-time-rule-attr.
   buffer-copy old-dis-time-rule-attr to new-dis-time-rule-attr.
end.
for each old-dis-cfg-rule  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-dis-cfg-rule.
   buffer-copy old-dis-cfg-rule to new-dis-cfg-rule.
end.
for each old-dis-cfg-rule-attr  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-dis-cfg-rule-attr.
   buffer-copy old-dis-cfg-rule-attr to new-dis-cfg-rule-attr.
end.
if varstay-history then do:
for each old-c-dis-cfg-rule  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-c-dis-cfg-rule.
   buffer-copy old-c-dis-cfg-rule to new-c-dis-cfg-rule.
end.
end.
for each old-drt-prop  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-drt-prop.
   buffer-copy old-drt-prop to new-drt-prop.
end.
if varstay-history then do:
for each old-c-drt-prop  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-c-drt-prop.
   buffer-copy old-c-drt-prop to new-c-drt-prop.
end.
end.
for each old-dis-some-rule  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-dis-some-rule.
   buffer-copy old-dis-some-rule to new-dis-some-rule.
end.
for each old-dis-some-rule-attr  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-dis-some-rule-attr.
   buffer-copy old-dis-some-rule-attr to new-dis-some-rule-attr.
end.
if varstay-history then do:
for each old-c-dis-some-rule  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-c-dis-some-rule.
   buffer-copy old-c-dis-some-rule to new-c-dis-some-rule.
end.
end.
for each old-dis-card  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-dis-card.
   buffer-copy old-dis-card to new-dis-card.
end.
for each old-dis-obj  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-dis-obj.
   buffer-copy old-dis-obj to new-dis-obj.
end.
for each old-dis-host  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-dis-host.
   buffer-copy old-dis-host to new-dis-host.
end.
for each old-dis-card-property  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-dis-card-property.
   buffer-copy old-dis-card-property to new-dis-card-property.
end.
for each old-dis-card-long  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-dis-card-long.
   buffer-copy old-dis-card-long to new-dis-card-long.
end.
for each old-dis-card-long-attr  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-dis-card-long-attr.
   buffer-copy old-dis-card-long-attr to new-dis-card-long-attr.
end.
for each old-dis-dc-rule  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-dis-dc-rule.
   buffer-copy old-dis-dc-rule to new-dis-dc-rule.
end.
for each old-dis-dc-rule-attr  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-dis-dc-rule-attr.
   buffer-copy old-dis-dc-rule-attr to new-dis-dc-rule-attr.
end.
if varstay-history then do:
for each old-c-dis-card  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-c-dis-card.
   buffer-copy old-c-dis-card to new-c-dis-card.
end.
for each old-c-dis-obj  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-c-dis-obj.
   buffer-copy old-c-dis-obj to new-c-dis-obj.
end.
for each old-c-dis-host  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-c-dis-host.
   buffer-copy old-c-dis-host to new-c-dis-host.
end.
for each old-c-dc-hist  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-c-dc-hist.
   buffer-copy old-c-dc-hist to new-c-dc-hist.
end.
for each old-c-dis-card-property  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-c-dis-card-property.
   buffer-copy old-c-dis-card-property to new-c-dis-card-property.
end.
for each old-c-dis-card-long  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-c-dis-card-long.
   buffer-copy old-c-dis-card-long to new-c-dis-card-long.
end.
for each old-c-dis-card-long-attr  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-c-dis-card-long-attr.
   buffer-copy old-c-dis-card-long-attr to new-c-dis-card-long-attr.
end.
for each old-c-dis-dc-rule  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-c-dis-dc-rule.
   buffer-copy old-c-dis-dc-rule to new-c-dis-dc-rule.
end.
end.
_payment:
...
on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
  ...
  or not (old-payment.source-type = 'накл':U
         or
         old-payment.source-type = 'касс':U)
  then do:
    ...
    if old-payment.source-type = 'накл':U then do:
    ...
    if old-payment.source-type = 'касс':U then do:
...
where old-stop-list.status_ = 'факт':U
...
define buffer new-payment for dst.payment.
  ...
  :
     ...
     find first new-payment where
          ...
          and new-payment.status_ = 'факт':U
