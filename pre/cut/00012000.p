...
for each old-c-db  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-c-db.
   buffer-copy old-c-db to new-c-db.
end.
  end.
for each old-db-info  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-db-info.
   buffer-copy old-db-info to new-db-info.
end.
for each old-db-status  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-db-status.
   buffer-copy old-db-status to new-db-status.
end.
for each old-db-status-attr  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-db-status-attr.
   buffer-copy old-db-status-attr to new-db-status-attr.
end.
  for each old-db-attr no-lock
  on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2))
  :
    if vartype-cut = 0
      and old-db-attr.attr-code = 'cut-fin-date':U
    then do:
      next.
    end.
    create new-db-attr.
...
for each old-db-rec-attr  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-db-rec-attr.
   buffer-copy old-db-rec-attr to new-db-rec-attr.
end.
for each old-hist-nws-option  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-hist-nws-option.
   buffer-copy old-hist-nws-option to new-hist-nws-option.
end.
  if varstay-history then do:
for each old-c-hist-nws-option  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-c-hist-nws-option.
   buffer-copy old-c-hist-nws-option to new-c-hist-nws-option.
end.
  end.
for each old-hist-nws-option-attr  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-hist-nws-option-attr.
   buffer-copy old-hist-nws-option-attr to new-hist-nws-option-attr.
end.
  if varstay-history then do:
for each old-c-hist-nws-option-attr  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-c-hist-nws-option-attr.
   buffer-copy old-c-hist-nws-option-attr to new-c-hist-nws-option-attr.
end.
  end.
