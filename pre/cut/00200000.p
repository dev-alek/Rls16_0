...
for each old-schedule  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-schedule.
   buffer-copy old-schedule to new-schedule.
end.
for each old-schedule-attr  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-schedule-attr.
   buffer-copy old-schedule-attr to new-schedule-attr.
end.
