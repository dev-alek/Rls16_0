...
for each old-attr-prop  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-attr-prop.
   buffer-copy old-attr-prop to new-attr-prop.
end.
for each old-custom-labels  no-lock on error undo, return error SUBSTITUTE("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2)):
   create new-custom-labels.
   buffer-copy old-custom-labels to new-custom-labels.
end.
