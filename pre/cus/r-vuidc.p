...
define NEW SHARED temp-table temp-cards no-undo
...
cli-code
.
define NEW SHARED temp-table temp-gds no-undo
field d-card like ub.dis-card.d-card
field cli-type like ub.dis-card.cli-type
field cli-code like ub.dis-card.cli-code
...
Sheetf.Excel-Column-Lable =
                            "Дисконтная карта" + chr(44) +
                            "Код" + chr(44) +
                            "Дата перв.покупки" + chr(44) +
                            "Маг перв.покупки" + chr(44) +
                            "Дата посл.покупки(за период)" + chr(44) +
                            "Маг посл.покупки" + chr(44) +
                            "Фамилия" + chr(44) +
                            "Имя" + chr(44) +
                            "Отчество" + chr(44) +
                            "Организация" + chr(44) +
                            ...
                            "Адрес" + chr(44) +
                            "А/я" + chr(44) +
                            "Паспортные данные" + chr(44) +
                            "Примечание"
Sheetf.Sizes = "16,12,10,8,10,8,40,20,20,40,20,21,20,20,20,40,6,60,8,60,60"
sheetf.colformat = "3=dd/mm/yyyy;5=dd/mm/yyyy":U + chr(4) + "1=@;12=@"
.
...
by temp-cards.cli-code:
  ...
  for each buf_obj no-lock where
          buf_obj.obj-type = 'маг':U
       OR buf_obj.obj-type = 'скл':U:
    _chk-doc2:
    ...
    :
      if lookup(string(buf_chk-doc.chk-type), '14,15,16,36,17,8,11,12,13,40,69,101,106,108,169,196,114,115,116,117,111,112,136,113,101,106,108,208,2,3,4,5,7,43,44':U) > 0 then next _chk-doc2.
  ...
  if first-of(temp-cards.cli-code) then do:
    ...
    CASE temp-cards.cli-type:
      when 'чел':U then do:
        ...
        (chr(4) + temp-cards.d-card)                  CHR(9)
        (temp-cards.cli-type + string(temp-cards.cli-code)) CHR(9)
        string(v-first-date, "99/99/9999")                  CHR(9)
        (v-first-obj-type + string(v-first-obj-code))       CHR(9)
        string(temp-cards.last-date, "99/99/9999")          CHR(9)
        (temp-cards.last-obj-type + string(temp-cards.last-obj-code))       CHR(9)
        buf_clients.obj-name                                CHR(9)
        buf_person.name1                                    CHR(9)
        buf_person.name2                                    CHR(9)
        buf_person.firm-name                                CHR(9)
        buf_person.position                                 CHR(9)
        (chr(1) + buf_person.inn)                     CHR(9)
        buf_person.phone1                                   CHR(9)
        buf_person.fax                                      CHR(9)
        buf_person.e-mail                                   CHR(9)
        buf_person.city                                     CHR(9)
        buf_person.ind                                      CHR(9)
        buf_person.address                                  CHR(9)
        buf_person.post-box                                 CHR(9)
        (buf_person.passp-num + chr(32) +
        buf_person.passp-ser + chr(32) +
        buf_person.given-by)                                CHR(9)
        buf_clients.PS
        skip.
      end.
      when 'орг':U then do:
        ...
        (temp-cards.last-obj-type + string(temp-cards.last-obj-code))       CHR(9)
        buf_clients.obj-name                                CHR(9)
        buf_firm.engl-name                                  CHR(9)
                                                            CHR(9)
                                                            CHR(9)
        buf_firm.director                                   CHR(9)
        (chr(1) + buf_firm.inn)                       CHR(9)
        buf_firm.phone                                      CHR(9)
        buf_firm.fax                                        CHR(9)
        buf_firm.e-mail                                     CHR(9)
        buf_firm.city                                       CHR(9)
        buf_firm.ind                                        CHR(9)
        buf_firm.addres1                                    CHR(9)
                                                            CHR(9)
                                                            CHR(9)
        (buf_clients.Ps + chr(32) + buf_firm.contact-psn)
        skip.
      end.
    END CASE.
  end.
...
Sheetf.Excel-Column-Lable =
                            ...
                            "Код" + chr(44) +
                            "Фамилия" + chr(44) +
                            "Скидка клиента%" + chr(44) +
                            "Дата чека" + chr(44) +
                            "Номер магазина" + chr(44) +
                            "Код продавца" + chr(44) +
                            "Код кассира" +  chr(44) +
                            "Скидка итоговая (%)" +  chr(44) +
                            "Код товара" +  chr(44) +
                            "Артикул товара" +  chr(44) +
...
sheetf.colformat = "5=dd/mm/yyyy" + chr(1) + "1=@"
.
run rep/extitle.p (2) .
...
:
  ...
  if Make-Excel then  put   stream ForExcel unformatted
  (chr(1) + temp-gds.d-card)                             CHR(9)
  (temp-gds.cli-type + string(temp-gds.cli-code))     CHR(9)
  v-name                                              CHR(9)
  temp-gds.src-d-pcnt                                 CHR(9)
  string(temp-gds.chk-date, "99/99/9999")                                   CHR(9)
  temp-gds.obj-code                                   CHR(9)
  temp-gds.sales-man                                  CHR(9)
  temp-gds.cashier                                    CHR(9)
  temp-gds.d-pcnt                                     CHR(9)
  temp-gds.gds-code                                   CHR(9)
  temp-gds.artic                                      CHR(9)
  temp-gds.gds-name                                   CHR(9)
  temp-gds.doc-qnty                                   CHR(9)
  temp-gds.price-base                                 CHR(9)
  (temp-gds.price-base - temp-gds.discnt)             CHR(9)
  temp-gds.discnt                                     CHR(9)
  round((temp-gds.price-base - temp-gds.discnt) *
          temp-gds.doc-qnty, 2)                        CHR(9)
  temp-gds.cash-rate                                  CHR(9)
  temp-gds.cash-scale
  skip.
END.
