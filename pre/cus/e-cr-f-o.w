...
PROCEDURE adm-disable :
    DISABLE RECT-9 T-sale WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-9 T-sale WITH FRAME F-Main.
...
ON LEAVE OF date-sale-1 IN FRAME F-Main
DO :
...
END .
ON LEAVE OF date-sale-2 IN FRAME F-Main
DO:
    assign date-sale-1 date-sale-2 .
  if ( date-sale-2 <> ? and    date-sale-1 <> ? ) and
...
END.
ON VALUE-CHANGED OF T-sale IN FRAME F-Main
DO:
 assign frame F-Main  T-sale .
if T-sale = true  then do:
        display  date-sale-1 date-sale-2 with frame F-Main .
        enable  date-sale-1 date-sale-2 with frame F-Main .
end.
else do:
        display  date-sale-1 date-sale-2 with frame F-Main .
        disable  date-sale-1 date-sale-2 with frame F-Main .
end.
END.
...
on ' ' of date-sale-1 in frame F-Main
do:
...
on delete-character of date-sale-1 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-d of date-sale-1 in frame F-Main
do:
...
on ctrl-b of date-sale-1 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-e of date-sale-1 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-f of date-sale-1 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
  ...
  define MENU m-ed-date15
    ...
    .
  if date-sale-1 :POPUP-MENU in frame F-Main = ?
  then do:
    ASSIGN
      date-sale-1 :POPUP-MENU in frame F-Main = MENU m-ed-date15 :HANDLE
      date-sale-1 :MENU-MOUSE in frame F-Main = 3
    .
  end.
  define variable v-label-handle15 as handle no-undo .
  assign
    v-label-handle15 = date-sale-1 :side-label-handle in frame F-Main
  .
  ...
  ON CHOOSE OF MENU-ITEM m-ed-date15-1 in menu m-ed-date15 DO:
    apply "ctrl-b":U to date-sale-1 in frame F-Main .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date15-2 in menu m-ed-date15 DO:
    apply "ctrl-d":U to date-sale-1 in frame F-Main .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date15-3 in menu m-ed-date15 DO:
    apply "ctrl-e":U to date-sale-1 in frame F-Main .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date15-4 in menu m-ed-date15 DO:
    apply "ctrl-f":U to date-sale-1 in frame F-Main .
  END.
define variable vss-include-info16 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
on ' ' of date-sale-2 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on delete-character of date-sale-2 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-d of date-sale-2 in frame F-Main
do:
  define variable v-curr-sv-date as date no-undo .
  if (can-query (self, "sensitive")
     and
...
on ctrl-b of date-sale-2 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-e of date-sale-2 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-f of date-sale-2 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
  ...
  define MENU m-ed-date17
    ...
    .
  if date-sale-2 :POPUP-MENU in frame F-Main = ?
  then do:
    ASSIGN
      date-sale-2 :POPUP-MENU in frame F-Main = MENU m-ed-date17 :HANDLE
      date-sale-2 :MENU-MOUSE in frame F-Main = 3
    .
  end.
  define variable v-label-handle17 as handle no-undo .
  assign
    v-label-handle17 = date-sale-2 :side-label-handle in frame F-Main
  .
  ...
  ON CHOOSE OF MENU-ITEM m-ed-date17-1 in menu m-ed-date17 DO:
    apply "ctrl-b":U to date-sale-2 in frame F-Main .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date17-2 in menu m-ed-date17 DO:
    apply "ctrl-d":U to date-sale-2 in frame F-Main .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date17-3 in menu m-ed-date17 DO:
    apply "ctrl-e":U to date-sale-2 in frame F-Main .
  END.
  ON CHOOSE OF MENU-ITEM m-ed-date17-4 in menu m-ed-date17 DO:
    apply "ctrl-f":U to date-sale-2 in frame F-Main .
  END.
...
END PROCEDURE.
PROCEDURE my-var :
assign frame F-Main date-sale-1 date-sale-2 T-sale .
 ReportHeader =
