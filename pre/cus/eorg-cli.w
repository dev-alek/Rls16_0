...
if v-num-entry14 > 0 then do:
  ...
  .
    ...
    if last-event:function <> "MOUSE-SELECT-DBLCLICK" then do:
        ...
        apply "VALUE-CHANGED" to br-ext-contragent in frame Dialog-Frame.
    end.
  ...
  apply "entry" to br-ext-contragent in frame Dialog-Frame.
END.
...
DO:
   find first X_ext-classif no-lock   where X_ext-classif.Key#_One=integer(fill-in-code-th:screen-value)
                                         ...
                                         and X_ext-classif.classif-subject = 'clients':U
                                         and X_ext-classif.classif-name = 'code_org_client':U no-error.
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse br-ext-contragent :handle
      .
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY br-ext-contragent FOR EACH X_ext-classif NO-LOCK,        FIRST X_clients NO-LOCK INDEXED-REPOSITION.
END PROCEDURE.
PROCEDURE MyEnable :
ENABLE
b-quit
...
run gbl/flt-get.p
  ...
  then do:
    ...
    define variable  parameter-7-27 as character no-undo .
      ...
      parameter-4-27 =
        (
          if (" X_ext-classif.classif-subject = 'clients':U                           and X_ext-classif.classif-name = 'code_org_client':U" + " " + where-phrase-27) <> ""
          then  substitute('X_ext-classif.classif-subject = &1&2&1                           and X_ext-classif.classif-name = &1&3&1', chr(34), 'clients':U, 'code_org_client':U) + " " + where-phrase-27
          else "true"
        )
    ...
    :
      assign
        l-disable-where-27 =
          (" X_ext-classif.classif-subject = 'clients':U                           and X_ext-classif.classif-name = 'code_org_client':U" + " " + where-phrase-27 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-ext-contragent:handle
  ...
  if l-filter-open-27 = false then do:
    OPEN QUERY br-ext-contragent FOR EACH X_ext-classif
      where  X_ext-classif.classif-subject = 'clients':U                           and X_ext-classif.classif-name = 'code_org_client':U
...
APPLY "entry" TO br-ext-contragent.
if available X_ext-classif then do:
    APPLY "VALUE-CHANGED":U to br-ext-contragent.
END.
END PROCEDURE.
...
if v-ok then do:
  ...
  run ref/extclas1.p ( INPUT 'ДОБАВЛЕНИЕ':U
                      ...
                      ,INPUT-OUTPUT v-rid
                      ,INPUT 'clients':U
                      ,INPUT 'code_org_client':U
                      ,input  (-1)
                      ,input v-obj-code
                      ,input v-ext-obj-code
                      ,input 0
                      ,input v-obj-type
                      ,input v-ext-obj-type
                      ,input ""
