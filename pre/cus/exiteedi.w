...
assign
  v-str-recid15 = trim( string( recid( X_ext-classif ) , "->>>>>>>>>>>9":U ) )
...
if v-num-entry15 > 0 then do:
  ...
  .
    ...
    if last-event:function <> "MOUSE-SELECT-DBLCLICK" then do:
        ...
        apply "VALUE-CHANGED" to br-exiteedi in frame Dialog-Frame.
    end.
  ...
  apply "entry" to br-exiteedi in frame Dialog-Frame.
END.
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse br-exiteedi :handle
      .
...
do:
   if available X_ext-classif then v-rep-rec = recid(X_ext-classif). RUn OpenBR in this-procedure ( input yes, input no, input '':U).  reposition br-exiteedi to recid v-rep-rec no-error.
    apply "VALUE-CHANGED" to br-exiteedi.
end.
define variable vss-include-info27 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
do:
  br-exiteedi :SET-REPOSITIONED-ROW(5, "CONDITIONAL") .
end.
MAIN-BLOCK:
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY br-exiteedi FOR EACH X_ext-classif NO-LOCK,            FIRST X_clients NO-LOCK,            FIRST X_ext-system NO-LOCK     INDEXED-REPOSITION.
END PROCEDURE.
PROCEDURE MyEnable :
ENABLE
b-quit
...
run gbl/flt-get.p
  ...
  then do:
    ...
    define variable  parameter-7-30 as character no-undo .
      assign
      parameter-3-30 =
                              "FOR EACH X_ext-classif"
      parameter-4-30 =
        (
          if (" X_ext-classif.classif-subject = 'clients':U                           and X_ext-classif.classif-name = 'exite-edi':U                           AND X_ext-classif.db-num = - 1" + " " + where-phrase-30) <> ""
          then  substitute('X_ext-classif.classif-subject = &1&2&1                           and X_ext-classif.classif-name = &1&3&1                           AND X_ext-classif.db-num = - 1', chr(34), 'clients':U, 'exite-edi':U) + " " + where-phrase-30
          else "true"
        )
      parameter-5-30 = (" " + "" + " " + substitute(', FIRST X_clients NO-LOCK WHERE                                   X_clients.obj-type = ENTRY(2, X_eXt-classif.uniq-key-rec, chr(3)) AND                                   X_clients.obj-code = integer(ENTRY(3, X_eXt-classif.uniq-key-rec, chr(3))),                                    FIRST X_ext-system NO-LOCK WHERE                                    X_ext-system.esys-id = X_ext-classif.key#_one                                    AND X_ext-system.db-num = 0'))
    ...
    :
      assign
        l-disable-where-30 =
          (" X_ext-classif.classif-subject = 'clients':U                           and X_ext-classif.classif-name = 'exite-edi':U                           AND X_ext-classif.db-num = - 1" + " " + where-phrase-30 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-exiteedi:handle
  ...
  if l-filter-open-30 = false then do:
    OPEN QUERY br-exiteedi FOR EACH X_ext-classif
      where  X_ext-classif.classif-subject = 'clients':U                           and X_ext-classif.classif-name = 'exite-edi':U                           AND X_ext-classif.db-num = - 1
    , FIRST X_clients NO-LOCK WHERE                                   X_clients.obj-type = ENTRY(2, X_eXt-classif.uniq-key-rec, chr(3)) AND                                   X_clients.obj-code = integer(ENTRY(3, X_eXt-classif.uniq-key-rec, chr(3))),                                   FIRST X_ext-system NO-LOCK WHERE                                   X_ext-system.esys-id = X_ext-classif.key#_one                                   AND X_ext-system.db-num = 0
      INDEXED-REPOSITION
  .
      assign
        l-query-was-opened = true
...
run gbl/flt-get.p
  ...
  then do:
    ...
    define variable  parameter-7-32 as character no-undo .
      ...
      parameter-4-32 =
        (
          if (" X_ext-classif.classif-subject = 'clients':U                           and X_ext-classif.classif-name = 'exite-edi':U                           AND X_ext-classif.db-num = - 1 AND X_ext-classif.key#_one = v-esys-id" + " " + where-phrase-32) <> ""
          then  substitute('X_ext-classif.classif-subject = &1&2&1                           and X_ext-classif.classif-name = &1&3&1                           AND X_ext-classif.db-num = - 1 AND X_ext-classif.key#_one = &4 ', chr(34), 'clients':U, 'exite-edi':U, v-esys-id) + " " + where-phrase-32
          else "true"
        )
      parameter-5-32 = (" " + "" + " " + substitute(', FIRST X_clients NO-LOCK WHERE                                   X_clients.obj-type = ENTRY(2, X_eXt-classif.uniq-key-rec, chr(3)) AND                                   X_clients.obj-code = integer(ENTRY(3, X_eXt-classif.uniq-key-rec, chr(3))),                                    FIRST X_ext-system NO-LOCK WHERE                                    X_ext-system.esys-id = X_ext-classif.key#_one                                    AND X_ext-system.db-num = 0'))
    ...
    :
      assign
        l-disable-where-32 =
          (" X_ext-classif.classif-subject = 'clients':U                           and X_ext-classif.classif-name = 'exite-edi':U                           AND X_ext-classif.db-num = - 1 AND X_ext-classif.key#_one = v-esys-id" + " " + where-phrase-32 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-exiteedi:handle
  ...
  if l-filter-open-32 = false then do:
    OPEN QUERY br-exiteedi FOR EACH X_ext-classif
      where  X_ext-classif.classif-subject = 'clients':U                           and X_ext-classif.classif-name = 'exite-edi':U                           AND X_ext-classif.db-num = - 1 AND X_ext-classif.key#_one = v-esys-id
    , FIRST X_clients NO-LOCK WHERE                                   X_clients.obj-type = ENTRY(2, X_eXt-classif.uniq-key-rec, chr(3)) AND                                   X_clients.obj-code = integer(ENTRY(3, X_eXt-classif.uniq-key-rec, chr(3))),                                   FIRST X_ext-system NO-LOCK WHERE                                   X_ext-system.esys-id = X_ext-classif.key#_one                                   AND X_ext-system.db-num = 0
      INDEXED-REPOSITION
  .
      assign
...
run gbl/flt-get.p
  ...
  then do:
    ...
    define variable  parameter-7-34 as character no-undo .
      ...
      parameter-4-34 =
        (
          if (" X_ext-classif.classif-subject = 'clients':U                           and X_ext-classif.classif-name = 'exite-edi':U                           AND X_ext-classif.db-num = - 1                           AND X_ext-classif.uniq-key-rec = p-dop-par " + " " + where-phrase-34) <> ""
          then  substitute('X_ext-classif.classif-subject = &1&2&1                           and X_ext-classif.classif-name = &1&3&1                           AND X_ext-classif.db-num = - 1                           AND X_ext-classif.uniq-key-rec = &1&4&1 ', chr(34), 'clients':U, 'exite-edi':U, p-dop-par ) + " " + where-phrase-34
          else "true"
        )
      parameter-5-34 = (" " + "" + " " + substitute(', FIRST X_clients NO-LOCK WHERE                                   X_clients.obj-type = ENTRY(2, X_eXt-classif.uniq-key-rec, chr(3)) AND                                   X_clients.obj-code = integer(ENTRY(3, X_eXt-classif.uniq-key-rec, chr(3))),                                    FIRST X_ext-system NO-LOCK WHERE                                    X_ext-system.esys-id = X_ext-classif.key#_one                                    AND X_ext-system.db-num = 0'))
    ...
    :
      assign
        l-disable-where-34 =
          (" X_ext-classif.classif-subject = 'clients':U                           and X_ext-classif.classif-name = 'exite-edi':U                           AND X_ext-classif.db-num = - 1                           AND X_ext-classif.uniq-key-rec = p-dop-par " + " " + where-phrase-34 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-exiteedi:handle
  ...
  if l-filter-open-34 = false then do:
    OPEN QUERY br-exiteedi FOR EACH X_ext-classif
      where  X_ext-classif.classif-subject = 'clients':U                           and X_ext-classif.classif-name = 'exite-edi':U                           AND X_ext-classif.db-num = - 1                           AND X_ext-classif.uniq-key-rec = p-dop-par
    , FIRST X_clients NO-LOCK WHERE                                   X_clients.obj-type = ENTRY(2, X_eXt-classif.uniq-key-rec, chr(3)) AND                                   X_clients.obj-code = integer(ENTRY(3, X_eXt-classif.uniq-key-rec, chr(3))),                                   FIRST X_ext-system NO-LOCK WHERE                                   X_ext-system.esys-id = X_ext-classif.key#_one                                   AND X_ext-system.db-num = 0
      INDEXED-REPOSITION
  .
      assign
...
APPLY "entry" TO br-exiteedi.
if available X_ext-classif then do:
    APPLY "VALUE-CHANGED":U to br-exiteedi.
END.
END PROCEDURE.
...
do:
  if (valid-handle(g#library2) <> true) then do:   run gbl/library2.p persistent no-error .   if error-status :error or (valid-handle(g#library2) <> true) then do:     message       "Error starting library2.p" skip       g#library2 skip       g#library2 :type skip       g#library2 :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run chk-actg in g#library2
    ...
    ,input  v-cntxt-userid
    ,input  0
    ,input  'actn_rh-attr-edi_update':U
    ,input  'global':U
    ,input  0
    ,input  '':U
    ,input  0
...
if p-list-mode = "esys-id" then do:
 find first buf_ext-system no-lock where
  ...
  run bge/oxmlexts.p (
            input parparentproc
          , input 2
          , input substitute("esys-type = &1", '9':U)
...
.
if (buf_clients.obj-type = 'орг':U and not can-find(first ub.sysconf no-lock where ub.sysconf.host-code = buf_clients.obj-code))
or buf_clients.obj-type = 'чел':U then do:
  find first buf2_ext-classif no-lock where
            buf2_ext-classif.classif-subject = 'clients':U
  ...
  if available buf2_ext-classif then do:
    ...
    if not buf_ext-system.whole-send-news = integer ('9':U) then do:
      run gbl/d-list.w (
                  INPUT "b-sel":U
                  ,INPUT "Выберите схему работы"
                  ,INPUT 'without-ordrsp':U + chr(44) + 'with-ordrsp':U
                  ,INPUT 'Без ORDRSP':U + chr(44) + 'С ORDRSP':U
                  ,INPUT chr(44)
                  ,INPUT "":U
                  ,output v-ordrsp-option).
    end.
    else v-ordrsp-option = 'with-ordrsp':U.
...
run ref/extclas1.p ( INPUT 'ДОБАВЛЕНИЕ':U
                    ...
                    ,input 0
                    ,input 0
                    ,input v-ordrsp-option
                    ,input '':U
                    ,input '':U
                    ,input (if buf_clients.obj-type = 'орг':U then 1000000000 else 0) + buf_clients.obj-code
...
if not glog then undo, return error.
if X_clients.obj-type = 'маг':U
or X_clients.obj-type = 'скл':U then do:
...
END.
define variable v-type as character no-undo .
if not X_ext-system.whole-send-news = integer ('9':U) then do:
  run gbl/d-list.w (
              INPUT "b-sel":U
              ,INPUT "Выберите схему работы"
              ,INPUT 'without-ordrsp':U + chr(44) + 'with-ordrsp':U
...
CASE p-schema:
  WHEN 'without-ordrsp':U THEN DO:
    RETURN 'Без ORDRSP':U.
  END.
  WHEN 'with-ordrsp':U THEN DO:
    RETURN 'С ORDRSP':U.
  END.
  OTHERWISE DO:
    RETURN "".
