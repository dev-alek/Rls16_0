...
PROCEDURE adm-disable :
    DISABLE RECT-6 RECT-5 RECT-7 TOGGLE-1 RADIO-SET-1 RADIO-SET-2 WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-6 RECT-5 RECT-7 TOGGLE-1 RADIO-SET-1 RADIO-SET-2 WITH FRAME F-Main.
...
run userobjs_select-many in this-procedure
  ...
  ,output v-user-select
    ...
    if v-user-select <> true then do:
      ...
      display RADIO-SET-2 with frame F-Main .
    end.
    else do:
      define buffer buf_userobjs_temp-user-obj for userobjs_temp-user-obj .
      for each buf_userobjs_temp-user-obj :
...
END PROCEDURE.
PROCEDURE my-var :
  Assign frame F-Main RADIO-SET-1 RADIO-SET-2 TOGGLE-1 TOGGLE-2 FILL-IN-3 .
  Assign
    STR-obj-type = ''
    STR-obj-code = ''
    STR-obj-name = ''
