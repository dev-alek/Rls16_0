...
for each obj-list no-lock:
  ...
  for each buf_chk-gds no-lock where
    ...
    buf_chk-doc.pay-desk                                                   CHR(9)
    buf_chk-doc.chk-num                                                    CHR(9)
    buf_chk-doc.chk-date                                                   CHR(9)
    string(buf_chk-doc.chk-time, "HH:MM")                                  CHR(9)
...
.
display stream PrnLibStream
"Итого" + chr(32) + string(accum-count) + chr(32) + "чеков" @ buf_chk-doc.doc-code
...
with FRAME CHk-List  .
if Make-Excel then  put   stream ForExcel unformatted
("Итого" + chr(32) + string(accum-count) + chr(32) + "чеков")  CHR(9)
"на"                                                                       CHR(9)
"сумму"                                                                    CHR(9)
                                                                           CHR(9)
                                                                           CHR(9)
...
string(accum-netto, "->>>,>>>,>>9.99") skip(0)
(if T-SLt-sum
then (
      string(("в том числе НсП" + chr(32) +
              string(f-slt-pc, ">9.99%") + chr(32)), "X(45)") +
      string(v-slt-sum, "->>>,>>>,>>9.99") + chr(10)
      )
else "":U)
string("Сумма агентского вознаграждения составляет", "X(45)")
string(v-agent-profit , "->>>,>>>,>>9.99") skip(0)
string("Подлежит перечислению принципиалу", "X(45)")
string(v-principial-profit , "->>>,>>>,>>9.99") skip(2)
string("От имени Агента", "X(20)") chr(32) string(buf_clients.obj-name, "X(25)") chr(32)
...
fill(chr(32), 49) "М.П."
skip(2)
string("От имени Принципиала", "X(20)") chr(32) string(buf_goods.gds-name, "X(25)") chr(32)
"отчет принял" chr(32) fill("_", 13)
skip(0)
fill(chr(32), 58)
"(подпись)"
skip
...
(if T-SLt-sum
then (
      "в том числе НсП" + CHR(9) +
                          CHR(9) +
      string(f-slt-pc, ">9.99%")  + CHR(9) +
                                    CHR(9) +
                                    CHR(9) +
      string(v-slt-sum, "->>>,>>>,>>9.99") + chr(10)
      )
else "":U)
"Сумма агентского вознаграждения составляет"       CHR(9)
                                                   CHR(9)
                                                   CHR(9)
                                                   CHR(9)
                                                   CHR(9)
string(v-agent-profit , "->>>,>>>,>>9.99") skip(0)
"Подлежит перечислению принципиалу"                 CHR(9)
                                                    CHR(9)
                                                    CHR(9)
                                                    CHR(9)
                                                    CHR(9)
string(v-principial-profit , "->>>,>>>,>>9.99") skip(2)
"От имени Агента"                                   CHR(9)
