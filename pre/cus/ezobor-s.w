...
PROCEDURE adm-disable :
    DISABLE RECT-8 RECT-5 RECT-6 SortType Tog-obj Classify ShowZero-2 VAT-Cost ShowZero VAT-CRSA VAT-sale WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-8 RECT-5 RECT-6 SortType Tog-obj Classify ShowZero-2 VAT-Cost ShowZero VAT-CRSA VAT-sale WITH FRAME F-Main.
...
END.
ON VALUE-CHANGED OF ShowZero IN FRAME F-Main
DO:
     assign ShowZero.
  ...
  else enable ShowZero-3 with frame F-Main .
END.
ON VALUE-CHANGED OF ShowZero-2 IN FRAME F-Main
DO:
      assign ShowZero-2.
  if ShowZero-2 = no then do:
     ShowZero = no .
     ShowZero-3 = no .
     display ShowZero ShowZero-3 with frame F-Main .
     disable ShowZero ShowZero-3 with frame F-Main .
  end.
  else enable ShowZero with frame F-Main .
END.
...
case Classify :
  when "no-classify" then do:
     if tog-obj = true then
        run cus/rzobr-1y.p (input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
      else
        run cus/rzobr-1n.p (input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
  end.
  when "prod" then do:
     if tog-obj = true then
        run cus/rzobr-3y.p (input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
      else
        run cus/rzobr-3n.p (input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
  end.
  when "grp-goods" then do:
     if tog-obj = true then
        run cus/rzobr-2y.p (input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
      else
        run cus/rzobr-2n.p (input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
  end.
  when "prod/grp-goods" then do:
     if tog-obj = true then
        run cus/rzobr-4y.p (input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
      else
        run cus/rzobr-4n.p (input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
  end.
  when "grp-goods/prod" then do:
     if tog-obj = true then
        run cus/rzobr-5y.p (input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
      else
        run cus/rzobr-5n.p (input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
  end.
  when "vat-ps" then do:
     if tog-obj = true then
        run cus/rzobr-6y.p (input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
      else
        run cus/rzobr-6n.p (input v-cntxt-obj-code , input v-cntxt-obj-type , input base-type  , input base-code  ,input Classify ,input SortType ,                    input SumsOnly  ,  input ShowZero  ,  input ShowZero-2 , input tog-obj    ,input tog-lavel,input var-lavel,                    input vat-cost, input vat-crsa , input vat-sale ) .
  end.
end case.
END PROCEDURE.
PROCEDURE my-var :
