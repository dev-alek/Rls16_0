...
define variable vss-workfile    as character no-undo init "$Workfile: r-pychk.p $":U .
define variable vss-archive     as character no-undo init "$Archive: cus/r-pychk.p $":U .
...
define input parameter p-rv as integer no-undo .
