...
define variable vss-include-info9 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
  define NEW SHARED temp-table temp-goods no-undo
...
PROCEDURE adm-disable :
    DISABLE RECT-2 RECT-3 RECT-1 R-curr T-terms F-val b-valp T-price-brutto T-price-netto button-prod T-qnty-all E-post T-VAT T-slt T-part-code F-val-name WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-2 RECT-3 RECT-1 R-curr T-terms F-val b-valp T-price-brutto T-price-netto button-prod T-qnty-all E-post T-VAT T-slt T-part-code F-val-name WITH FRAME F-Main.
...
DO:
    ...
    for each cli-list:
        assign
        E-post:screen-value = E-post:screen-value + cli-list.obj-name + chr(10) .
    end.
END.
...
PROCEDURE local-initialize :
  ...
  APPLY "VALUE-CHANGED" TO r-curr in frame F-Main.
END PROCEDURE.
PROCEDURE My-report :
...
ReportHeader =  (if (frame F-Main r-curr = 1 )
                then
                ("Валюта  поставки:  " + F-val-name + chr(10))
                else ""
               ) +
               "Поставщики: " + chr(10) + E-post
               .
END PROCEDURE.
