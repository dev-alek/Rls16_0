...
PROCEDURE adm-disable :
    DISABLE RECT-7 RECT-9 RECT-8 RECT-5 RAD-otkl RAD-Post Ed-otkl-prc Ed-otkl-prc-2 Ed-otkl-tmh Ed-otkl-tmm RAD-Post-2 tg-zay WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-7 RECT-9 RECT-8 RECT-5 RAD-otkl RAD-Post Ed-otkl-prc Ed-otkl-prc-2 Ed-otkl-tmh Ed-otkl-tmm RAD-Post-2 tg-zay WITH FRAME F-Main.
...
END PROCEDURE.
PROCEDURE my-var :
  assign frame F-Main   RAD-Post .
  assign frame F-Main   RAD-Post-2 .
  assign frame F-Main   RAD-otkl .
  assign frame F-Main   Ed-otkl-prc .
  assign frame F-Main   Ed-otkl-tmm .
  assign frame F-Main   Ed-otkl-tmh .
  assign frame F-Main   tg-zay .
  str1 = "Выбор заказов: " .
  case RAD-otkl :
    when 1 then do:
      str1 = str1 + "все" .
