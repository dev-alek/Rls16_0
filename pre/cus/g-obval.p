...
define variable vss-workfile    as character no-undo init "$Workfile: g-obval.p $":U .
define variable vss-archive     as character no-undo init "$Archive: cus/g-obval.p $":U .
