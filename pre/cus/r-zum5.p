...
field uchet-with-vat-price as decimal
...
field VAT-price            as decimal
field sale-price           as decimal
field sale-price-pr        as decimal
field sale-sum             as decimal
field doc-price            as decimal
field doc-sum              as decimal
field doc-discnt-sum       as decimal
field doc-discnt           as decimal
INDEX p1 IS PRIMARY   b-code doc-code in-code part-code
.
define   temp-table sj-parts no-undo
field gds-code  like ub.goods.gds-code
field qnty      as   decimal
field doc-code   like ub.trn-doc.doc-code
field supp-type like ub.goods.prod-type
...
.
define   temp-table sj-gds-dtl no-undo
field gds-code  like ub.goods.gds-code
field b-code    like ub.bar-code.b-code
field prt-code  like ub.gds-dtl.prt-code
field qnty      as   decimal
...
PUT stream PrnLibStream UNFORMATTED
replace(sheetf.Excel-Column-Lable, chr(44), p-XL-delim)
SKIP(0).
run rep/extitle.p (1).
_obj-list:
  ...
  CASE p-by:
    ...
    when 5 then do:
      for each doc-list no-lock:
         ...
         if doc-list.ext-doc-type = 'es':U
         or doc-list.ext-doc-type = 'rs':U
         or doc-list.ext-doc-type = 'ee':U
         or doc-list.ext-doc-type = 're':U
         or doc-list.ext-doc-type = 'we':U
         then
...
if v-need-postformat then do:
  assign
  sheetf.colformat = sheetf.colformat + chr(4) + "13=@"
  .
end.
...
define buffer buf_sj-gds-dtl for sj-gds-dtl.
  ...
  :
    ...
    then return.
    is-out = if lookup(buf_trn-doc.ext-doc-type, 'ie,re,rs,vt,im':U) > 0 then 1 else -1.
   _docline:
...
assign
  ...
  price-rubl-without-tax-sale = price-rubl-with-tax-sale - vat-rubl-sale - slt-rubl-sale - road-tax-rubl-sale.
      ...
      for each sj-goods :
        ...
        skip.
        if Make-Excel then  put   stream ForExcel unformatted
        entry(lookup(buf_trn-doc.ext-doc-type, 'ie,ee,ep,es,re,rs,we,vt,vp,iv,ev,rv,em,wm,im,ot,ap,mp,pc,io,eo':U), 'приход внешний,расход внешний,возврат пост.,касса продажа,возврат внешний,касса возврат,списание,инвентаризация,пересортица,приход внутренний,расход внутренний,возврат внутренний,расход  произв.,списан. произв.,приход  произв.,переоценка,коррекция учетных цен,корректировка отрицательных партий,смена типа приобретения,приход внутриобъектный,расход внутриобъектный':U) CHR(9)
        p-doc-code     CHR(9)
        (obj-list.obj-type + string(obj-list.obj-code)) CHR(9)
        string(buf_trn-doc.doc-date, "99/99/9999") CHR(9)
        string(buf_trn-doc.fact-date, "99/99/9999") CHR(9)
        string(buf_trn-doc.cli-type + string(buf_trn-doc.cli-code)) CHR(9)
        buf_trn-doc.pay-code CHR(9)
        buf_goods.gds-code CHR(9)
        sj-goods.b-code CHR(9)
        buf_goods.gds-name CHR(9)
        buf_goods.grp-name CHR(9)
        (if available buf_gds-prt
        then buf_gds-prt.f-name
        else "Неизвестный признак!!!") CHR(9)
        string(if IsEngFrm(sj-goods.artic)
            then (chr(4) + buf_goods.artic)
            else buf_goods.artic) CHR(9)
        string(buf_goods.prod-type + string(buf_goods.prod-code))            CHR(9)
        (if avail buf_clients
        then buf_clients.obj-name
        else string(buf_goods.prod-type  + string( buf_goods.prod-code)))
                                       CHR(9)
        buf_goods.struct               CHR(9)
        buf_goods.unit-base            CHR(9)
        (is-out *
        sj-goods.qnty)                  CHR(9)
        string(sj-goods.supp-type  + string( sj-goods.supp-code))           CHR(9)
        (if avail buf_sup_clients
        then buf_sup_clients.obj-name
        else string(sj-goods.supp-type  + string( sj-goods.supp-code)))
                                        CHR(9)
        sj-goods.supp-purch-code       CHR(9)
        sj-goods.supp-pay-code         CHR(9)
        sj-goods.in-code               CHR(9)
        sj-goods.part-code             CHR(9)
        sj-goods.uchet-with-vat-price  CHR(9)
        (is-out *
        sj-goods.uchet-with-vat-sum)    CHR(9)
        sj-goods.supp-vat-pc           CHR(9)
        (is-out *
        sj-goods.supp-vat-sum)          CHR(9)
        sj-goods.VAT-pc                CHR(9)
        (is-out *
        sj-goods.VAT-sum)               CHR(9)
        sj-goods.sale-price            CHR(9)
        (is-out *
        sj-goods.sale-sum)              CHR(9)
        sj-goods.doc-price             CHR(9)
        (is-out *
        sj-goods.doc-sum)               CHR(9)
        (is-out *
        sj-goods.doc-discnt-sum)
        skip.
        delete sj-goods.
