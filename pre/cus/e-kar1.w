...
PROCEDURE adm-disable :
    DISABLE RS-method WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RS-method WITH FRAME F-Main.
...
REPORTHeader skip
"N чека" CHR(9)
"Дата чека" CHR(9) 'Артикул':U format "X(16)" CHR(9)
"Произ-ль" CHR(9) 'название':U skip.
...
_chk-gds:
  FOR EACH buf_chk-doc No-LOCK WHERE
    ...
    buf_goods.artic format "x(16)" CHR(9)
    buf_goods.prod-code CHR(9)
