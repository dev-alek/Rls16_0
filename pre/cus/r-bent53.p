         ...
         gds-zap-prod-name  = clients.obj-name.
          If break_group1 = true  THEN  DO :
            ...
            if NOT xSumsOnly or (par-3 = "4" Or par-3 = "5" ) THEN DO :
                ...
                if Make-Excel then  put   stream ForExcel unformatted tmp#stroka0  skip.
            End.
          End.
          IF (par-3 = "4"  OR  par-3 = "5")  THEN DO:
            ...
            if NOT xSumsOnly THEN DO:
                fr = true .
                if Make-Excel then  put   stream ForExcel unformatted CHR(9) temp-str  skip.
            End.
            break_group1 = false.
          END.
       break_group = false.
 ...
 CASE CAPS(p7) :
   WHEN "B1":U  Then DO:
      if Make-Excel then  put   stream ForExcel unformatted
          p3   CHR(9)
          ( if flag-dop-bc = true   then  CHR(9) else "" )
          p4   CHR(9)
          p5   CHR(9)
          p6   CHR(9)
          .
          For each tmp#obj-list :
          if Make-Excel then  put   stream ForExcel unformatted
          excel-qnty (tmp#obj-list.b1-ostatok-end[1] ) CHR(9)
          excel-sum  (tmp#obj-list.b1-ostatok-end[2] ) CHR(9).
          assign
          ...
          End.
          if Make-Excel then  put   stream ForExcel unformatted
          excel-qnty (tot-qnty ) CHR(9)
          excel-sum  (tot-sum  ) CHR(9)
          Skip.
          run clear-b1 .
      End.
   WHEN "BI":U Then DO:
      if Make-Excel then  put   stream ForExcel unformatted
          ...
          For each tmp#obj-list :
          if Make-Excel then  put   stream ForExcel unformatted
          excel-qnty  (tmp#obj-list.bi-ostatok-end[1] ) CHR(9)
          excel-sum   (tmp#obj-list.bi-ostatok-end[2] ) CHR(9).
          assign
   ...
   WHEN ""  Then DO:
     if Show-Negativ = true OR  (Show-Negativ = false and NOT can-find ( first tmp#obj-list where tmp#obj-list.ostatok-end[1] = 0 and
             ...
             THEN  DO:
               if Make-Excel then  put   stream ForExcel unformatted
               ( p3)   CHR(9)
               ( if flag-dop-bc = true   then ( v-dop-bc + CHR(9)) else "" )
               ( p4)   CHR(9)
               ( p5)   CHR(9)
               ( p6)   CHR(9)
                .
               ...
               For each tmp#obj-list :
               if Make-Excel then  put   stream ForExcel unformatted
                excel-qnty ( tmp#obj-list.ostatok-end[1] ) CHR(9)
                excel-sum  ( tmp#obj-list.ostatok-end[2] ) CHR(9).
                assign
