...
v-n = num-entries( str1 , "chr(10)"  )   .   do l-ii = 1 to v-n :        l-len = length (entry( l-ii , str1  , "chr(10)")) .                       l-m = integer( l-len / 120 ) + 1 .                                                      do l-jj = 1 to  l-m  :                                                                      num#str# = num#str# + 1 .                                                               run macr_excel_char_with_format in this-procedure (                  substring(entry( l-ii , str1  , "chr(10)") , (( 120 * l-jj ) - 119 )  , 120 )  , num#str# , num#col# ) .      end.                                                                                                         end.
v-n = num-entries( str2 , "chr(10)"  )   .   do l-ii = 1 to v-n :        l-len = length (entry( l-ii , str2  , "chr(10)")) .                       l-m = integer( l-len / 120 ) + 1 .                                                      do l-jj = 1 to  l-m  :                                                                      num#str# = num#str# + 1 .                                                               run macr_excel_char_with_format in this-procedure (                  substring(entry( l-ii , str2  , "chr(10)") , (( 120 * l-jj ) - 119 )  , 120 )  , num#str# , num#col# ) .      end.                                                                                                         end.
v-n = num-entries( str3 , "chr(10)"  )   .   do l-ii = 1 to v-n :        l-len = length (entry( l-ii , str3  , "chr(10)")) .                       l-m = integer( l-len / 120 ) + 1 .                                                      do l-jj = 1 to  l-m  :                                                                      num#str# = num#str# + 1 .                                                               run macr_excel_char_with_format in this-procedure (                  substring(entry( l-ii , str3  , "chr(10)") , (( 120 * l-jj ) - 119 )  , 120 )  , num#str# , num#col# ) .      end.                                                                                                         end.
v-n = num-entries( str4 , "chr(10)"  )   .   do l-ii = 1 to v-n :        l-len = length (entry( l-ii , str4  , "chr(10)")) .                       l-m = integer( l-len / 120 ) + 1 .                                                      do l-jj = 1 to  l-m  :                                                                      num#str# = num#str# + 1 .                                                               run macr_excel_char_with_format in this-procedure (                  substring(entry( l-ii , str4  , "chr(10)") , (( 120 * l-jj ) - 119 )  , 120 )  , num#str# , num#col# ) .      end.                                                                                                         end.
v-n = num-entries( reportheader , "chr(10)"  )   .   do l-ii = 1 to v-n :        l-len = length (entry( l-ii , reportheader  , "chr(10)")) .                       l-m = integer( l-len / 120 ) + 1 .                                                      do l-jj = 1 to  l-m  :                                                                      num#str# = num#str# + 1 .                                                               run macr_excel_char_with_format in this-procedure (                  substring(entry( l-ii , reportheader  , "chr(10)") , (( 120 * l-jj ) - 119 )  , 120 )  , num#str# , num#col# ) .      end.                                                                                                         end.
  num#str# = num#str# + 1.
  num#col# = 1.
  run macr_excel_char_with_format in this-procedure (  "  Цены указаны в РУБ"     , num#str#  , num#col#  ) .
...
procedure make-tt :
 ...
 for each obj-list
     ...
     for each buf_trn-doc no-lock where
         ...
         buf_trn-doc.doc-type = 'спи':U  and
