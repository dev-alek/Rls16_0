...
if p-fact = true then do:
  v-list-st = v-list-st  + 'факт':U + ",".
end.
if p-new = true then do:
  v-list-st = v-list-st +  'новый':U + ",".
end.
if p-per   = true then do:
  v-list-st = v-list-st +  'разрешено':U + ",".
end.
if p-req   = true then do:
  v-list-st = v-list-st +  'запрос':U + ",".
end.
if p-ship   = true then do:
  v-list-st = v-list-st +  'отгружено':U + "," .
end.
...
define variable v-trn-dater as date no-undo .
          ...
          buf_ord-line.doc-code = v-ord-doc-code
            ...
            first buf_trn-doc no-lock
              ...
              if available temp-main then do :
                ...
                if buf_trn-doc.doc-type = 'рас':U then do :
                ...
                if buf_trn-doc.doc-type = 'возврат':U then do :
                  temp-main.fact-qnty = temp-main.fact-qnty -  if available buf_doc-line then  buf_doc-line.fact-qnty else 0 .
                end.
              end.
              find current temp-i.
