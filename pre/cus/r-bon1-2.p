...
define SHARED temp-table temp-bon1 no-undo
...
cashier-psn-code
.
define SHARED temp-table temp-bon1-gds no-undo
field gds-code like ub.goods.gds-code
...
define variable pol7 as character no-undo .
define variable pol8 as decimal   no-undo .
define variable pol9 as decimal   no-undo .
define variable pol10 as decimal  no-undo .
define variable pol11n as decimal  no-undo .
define variable pol11b as decimal  no-undo .
define variable pol12 as decimal  no-undo .
define variable pol13 as character  no-undo .
define variable acc-sum as decimal no-undo .
define variable acc-pay-sumn as decimal no-undo .
define variable acc-pay-sumb as decimal no-undo .
define variable acc-discnt-value-abs as decimal no-undo .
define variable d-acc-sum as decimal no-undo .
define variable d-acc-pay-sumn as decimal no-undo .
define variable d-acc-pay-sumb as decimal no-undo .
define variable d-acc-discnt-value-abs as decimal no-undo .
...
for each obj-list no-lock:
  ...
  by buf_temp-bon1.chk-time :
    ...
    display stream PrnLibStream
    (string(buf_temp-bon1.chk-date, "99.99.99") + chr(32) + string(buf_temp-bon1.chk-time, "HH:MM:SS")) @ pol2
    (string(buf_temp-bon1.shift-date, "99.99.99") + chr(32) + string(buf_temp-bon1.shift-name, "X(2)")) @ pol3
    ...
    with frame frame-1.
    if Make-Excel then  put   stream ForExcel unformatted
    (string(buf_temp-bon1.chk-date, "99.99.99") + chr(32) + string(buf_temp-bon1.chk-time, "HH:MM:SS")) CHR(9)
    (string(buf_temp-bon1.shift-date, "99.99.99") + chr(32) + string(buf_temp-bon1.shift-name, "X(2)")) CHR(9)
    buf_temp-bon1.doc-code CHR(9)
    buf_temp-bon1.d-card CHR(9)
     buf_temp-bon1-gds.gds-name CHR(9)
     buf_temp-bon1.src-qnty CHR(9)
     buf_temp-bon1.src-price CHR(9)
     (buf_temp-bon1.src-price * buf_temp-bon1.src-qnty) CHR(9)
    (if buf_temp-bon1.op-code = 1
     then "-"
     else string(buf_temp-bon1.pay-sum, "-999,999,999.99")) CHR(9)
    (if buf_temp-bon1.op-code = 2
     then "-"
     else string(buf_temp-bon1.pay-sum, "-999,999,999.99")) CHR(9)
     buf_temp-bon1.discnt-value-abs CHR(9)
     ...
     acc-pay-sumn = acc-pay-sumn +  (if buf_temp-bon1.op-code = 1
                                    then 0
                                    else buf_temp-bon1.pay-sum)
     acc-pay-sumb = acc-pay-sumb +  (if buf_temp-bon1.op-code = 2
                                    then 0
                                    else buf_temp-bon1.pay-sum)
     ...
     d-acc-pay-sumn = d-acc-pay-sumn +  (if buf_temp-bon1.op-code = 1
                                    then 0
                                    else buf_temp-bon1.pay-sum)
     d-acc-pay-sumb = d-acc-pay-sumb +  (if buf_temp-bon1.op-code = 2
                                    then 0
                                    else buf_temp-bon1.pay-sum)
     .
     ...
     then do:
        ...
        with frame frame-1.
        if Make-Excel then  put   stream ForExcel unformatted
        substitute("Итого за &1", string(buf_temp-bon1.chk-date, "99.99.99")) CHR(9)
        CHR(9)
        CHR(9)
        CHR(9)
        CHR(9)
