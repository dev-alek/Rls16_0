...
define variable vss-workfile    as character no-undo init "$Workfile: e-zum4.p $":U .
define variable vss-archive     as character no-undo init "$Archive: cus/e-zum4.p $":U .
define variable vss-description as character no-undo init "–‡Ò¯ËÂÌÌ˚È ˝ÍÒÔÓÚ ÒÚÓÍ ˜ÂÍÓ‚ ‚ Excel ‰Îˇ ÷”Ã‡ - Ò ÒÓÒÚ‡‚ÓÏ Ò˚¸ˇ".
  ...
  CASE X-Radio-Task > 1 :
    WHEN YES THEN DO:
      ...
      FOR EACH buf_inkas No-LOCK WHERE
        ...
        if buf_inkas.status_ = 'Ù‡ÍÚ':U
        or buf_inkas.status_ = 'Á‡ÔÓÒ':U then next.
        IF X-Radio-Task = 3 AND
  ...
  WHEN YES then do:
    FOR EACH obj-list WHERE
      ...
      FOR EACH buf_sale-doc NO-LOCK WHERE
           ...
           AND buf_sale-doc.status_ = 'Ù‡ÍÚ':U
           AND buf_sale-doc.chr-office = 'Û':U
           AND (
...
if NOT found then do:
  ...
  message "ÕÂ ·˚ÎÓ ÌËÍ‡ÍÓÈ ‚˚Û˜ÍË  ‚ ÚÂ˜ÂÌËÂ Á‡‰‡ÌÌÓ„Ó ¬‡ÏË ÔÂËÓ‰‡ ‚ÂÏÂÌË." view-as alert-box.
  return.
end.
...
output stream PrnLibStream to value ( ReportFileName ) page-size 0  .
run waitfram-show in this-procedure ("∆‰ËÚÂ...").
PUT stream PrnLibStream UNFORMATTED
space(20)
"–‡Ò¯ËÂÌÌ˚È › —œŒ–“ ÒÚÓÍ ˜ÂÍÓ‚" skip
...
" ¿——»–"                  p-XL-delim
"œ–Œƒ¿¬≈÷"                p-XL-delim
"ƒ»— ŒÕ“Õ¿ﬂ_ ¿–“¿"        p-XL-delim
"Œ“◊≈“_Œ_œ–Œƒ¿∆≈"         p-XL-delim
"ÕŒÃ≈–_—“–Œ »"            p-XL-delim
"√–”œœ¿ “Œ¬¿–Œ¬"          p-XL-delim
"√À¿¬Õ€…  Œƒ “Œ¬¿–¿"      p-XL-delim
"¡¿–- Œƒ œ–»«Õ¿ ¿"         p-XL-delim
"ÿ ¿À¿/œ–»«Õ¿ "           p-XL-delim
"¿–“» ”À"                 p-XL-delim
"“»œ œ–Œ»«¬Œƒ»“≈Àﬂ"       p-XL-delim
" Œƒ œ–Œ»«¬Œƒ»“≈Àﬂ"       p-XL-delim
"—Œ—“¿¬ —€–‹ﬂ"            p-XL-delim
" ŒÀ»◊≈—“¬Œ"              p-XL-delim
"—”ÃÃ¿ ¬€–”◊ »"           p-XL-delim
"— »ƒ ¿"                  p-XL-delim
"—”ÃÃ¿ œ–Œƒ¿∆Õ€’ ÷≈Õ"     p-XL-delim
" Œƒ_ŒœÀ¿“€"              p-XL-delim
"—”ÃÃ¿_ŒœÀ¿“€"            p-XL-delim
SKIP.
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run gdsbcode in g#library
  ...
  ,output v-b-code
      ...
      (if num-entries(buf_chk-doc.doc-code, chr(47)) = 5
      then entry(2, buf_chk-doc.doc-code, chr(47))
      else "?")                             p-XL-delim
      ...
      buf_chk-gds.line-num                      p-XL-delim
      ...
      (v-root-name +
       (if v-node-name = "":U
        then "":U
        else chr(47)) + v-node-name)  p-XL-delim
      v-artic                               p-XL-delim
      ...
      (buf_chk-gds.price-base - buf_chk-gds.discnt) p-XL-delim
      (buf_chk-gds.discnt   * buf_chk-gds.doc-qnty) p-XL-delim
      (buf_chk-gds.doc-qnty *
       buf_chk-gds.price-base)                  p-XL-delim
                                            p-XL-delim
                                            p-XL-delim
      SKIP.
    END.
    FOR EACH buf_chk-pay No-LOCK WHERE
      ...
      buf_chk-doc.d-card                        p-XL-delim
      buf_chk-doc.out-code                      p-XL-delim
      buf_chk-pay.line-num                      p-XL-delim
                                            p-XL-delim
                                            p-XL-delim
                                            p-XL-delim
                                            p-XL-delim
                                            ...
                                            p-XL-delim
                                            p-XL-delim
      buf_chk-pay.pay-code                      p-XL-delim
      (if v-curr-r-b = 'base':U
       then buf_chk-pay.tot-base
       else buf_chk-pay.tot-rubl)               p-XL-delim
      SKIP.
    END.
    IF ((ACCUM COUNT buf_chk-gds.doc-code)  + (ACCUM COUNT buf_chk-pay.doc-code)) MODULO 50 = 0 then
    run waitfram-show in this-procedure ("∆‰ËÚÂ..." + "Œ·˙ÂÍÚ " + string(obj-list.obj-code) + " Œ·‡·ÓÚ‡ÌÓ " +
                  string(ACCUM COUNT buf_chk-gds.doc-code) + " ÒÚÓÍ ˜ÂÍÓ‚").
  END.
END.
define variable vss-include-info17 as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".
output stream PrnLibStream CLOSE.
message "ŒÚ˜ÂÚ ‚˚‚Â‰ÂÌ ‚ Ù‡ÈÎ:" SKIP
                ReportFileName
