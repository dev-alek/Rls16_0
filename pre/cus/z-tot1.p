...
run macr_excel_char_with_format in this-procedure ( string( p-ship-time,"hh:mm") , num#str# , num#col#  ).
 run macr_cell_format in this-procedure  (
        ...
        1        ,
        6        ,
       ( if p-doc-type <> 'ОФ':U then 24    else 17 )
         )
        .
num#col# =  0.
num#str# = num#str# + 1 .
...
put  stream macr_excel unformatted  'COLUMN.WIDTH(15,,,,)'  skip.
  put  stream macr_excel unformatted
       substitute('select("r&1c&2:r&3c&4 ")' , 6  , 1 , num#str# ,  num#col# ) + chr(10)  +
        'BORDER( 2 , 2 , 2 , 2 , 8 , ) '  + chr(10) +
       'ALIGNMENT(3 , , 4 , 4 ,)'  + chr(10)
       .
num#col# =  0.
...
p-res = (buf_ord-doc.whole-send-news <> integer('2':U)).
