...
FOR EACH benefits NO-LOCK
    ...
    BENEFITS.qnty  CHR(9)
    BENEFITS.PRICE-BASE CHR(9)
    BENEFITS.PRICE-NETTO CHR(9)
    BENEFITS.DISCNT
    SKIP.
    ACCUMULATE
    ...
    IF LAST-OF(BENEFITS.dcpc) THEN DO:
      if Make-Excel then  put   stream ForExcel unformatted
      ("ИТОГО: (" + string(BENEFITS.dcpc, "->9%") + ")") CHR(9)
      ACCUM TOTAL BY BENEFITS.dcpc BENEFITS.qnty CHR(9)
      ACCUM TOTAL BY BENEFITS.dcpc (BENEFITS.qnty * BENEFITS.PRICE-BASE) CHR(9)
      ACCUM TOTAL BY BENEFITS.dcpc (BENEFITS.qnty * BENEFITS.PRICE-NETTo) CHR(9)
    ...
    IF Multi-obj AND LAST-OF(BENEFITS.OBJ-CODE) THEN DO:
      ...
      ACCUM TOTAL BY BENEFITS.obj-code BENEFITS.qnty CHR(9)
      ACCUM TOTAL BY BENEFITS.obj-code (BENEFITS.qnty * BENEFITS.PRICE-BASE) CHR(9)
      ACCUM TOTAL BY BENEFITS.obj-code (BENEFITS.qnty * BENEFITS.PRICE-NETTo) CHR(9)
    ...
    IF LAST(BENEFITS.OBJ-CODE) THEN DO:
      if Make-Excel then  put   stream ForExcel unformatted
      "ИТОГО ПО ВСЕМ " CHR(9)
      ACCUM TOTAL BENEFITS.qnty CHR(9)
      ACCUM TOTAL (BENEFITS.qnty * BENEFITS.PRICE-BASE) CHR(9)
      ACCUM TOTAL (BENEFITS.qnty * BENEFITS.PRICE-NETTo) CHR(9)
