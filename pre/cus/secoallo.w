...
if v-uf-List_ <> "" then do:
  if entry( 1  , v-uf-List_, chr(4)) <> "" then do : assign tog-1  = logical(entry( 1  , v-uf-List_, chr(4))). end.
  if entry( 2  , v-uf-List_, chr(4)) <> "" then do : assign tog-2  = logical(entry( 2  , v-uf-List_, chr(4))). end.
  if entry( 4  , v-uf-List_, chr(4)) <> "" then do : assign tog-4  = logical(entry( 4  , v-uf-List_, chr(4))). end.
  if entry( 5  , v-uf-List_, chr(4)) <> "" then do : assign tog-5  = logical(entry( 5  , v-uf-List_, chr(4))). end.
  if entry( 6  , v-uf-List_, chr(4)) <> "" then do : assign tog-6  = logical(entry( 6  , v-uf-List_, chr(4))). end.
  if entry( 7  , v-uf-List_, chr(4)) <> "" then do : assign tog-7  = logical(entry( 7  , v-uf-List_, chr(4))). end.
  if entry( 8  , v-uf-List_, chr(4)) <> "" then do : assign tog-8  = logical(entry( 8  , v-uf-List_, chr(4))). end.
  if entry( 9  , v-uf-List_, chr(4)) <> "" then do : assign tog-9  = logical(entry( 9  , v-uf-List_, chr(4))). end.
  if entry( 10 , v-uf-List_, chr(4)) <> "" then do : assign tog-10 = logical(entry( 10 , v-uf-List_, chr(4))). end.
  if entry( 11 , v-uf-List_, chr(4)) <> "" then do : assign tog-11 = logical(entry( 11 , v-uf-List_, chr(4))). end.
  if entry( 12 , v-uf-List_, chr(4)) <> "" then do : assign tog-12 = logical(entry( 12 , v-uf-List_, chr(4))). end.
  if entry( 13 , v-uf-List_, chr(4)) <> "" then do : assign tog-13 = logical(entry( 13 , v-uf-List_, chr(4))). end.
  if entry( 14 , v-uf-List_, chr(4)) <> "" then do : assign tog-14 = logical(entry( 14 , v-uf-List_, chr(4))). end.
  if entry( 15 , v-uf-List_, chr(4)) <> "" then do : assign tog-15 = logical(entry( 15 , v-uf-List_, chr(4))). end.
  if entry( 16 , v-uf-List_, chr(4)) <> "" then do : assign tog-16 = logical(entry( 16 , v-uf-List_, chr(4))). end.
  if entry( 17 , v-uf-List_, chr(4)) <> "" then do : assign tog-17 = logical(entry( 17 , v-uf-List_, chr(4))). end.
  if entry( 18 , v-uf-List_, chr(4)) <> "" then do : assign tog-18 = logical(entry( 18 , v-uf-List_, chr(4))). end.
  if entry( 19 , v-uf-List_, chr(4)) <> "" then do : assign tog-19 = logical(entry( 19 , v-uf-List_, chr(4))). end.
  if entry( 20 , v-uf-List_, chr(4)) <> "" then do : assign tog-20 = logical(entry( 20 , v-uf-List_, chr(4))). end.
  if entry( 21 , v-uf-List_, chr(4)) <> "" then do : assign tog-21 = logical(entry( 21 , v-uf-List_, chr(4))). end.
  if entry( 22 , v-uf-List_, chr(4)) <> "" then do : assign tog-22 = logical(entry( 22 , v-uf-List_, chr(4))). end.
  if entry( 23 , v-uf-List_, chr(4)) <> "" then do : assign tog-23 = logical(entry( 23 , v-uf-List_, chr(4))). end.
  if entry( 24 , v-uf-List_, chr(4)) <> "" then do : assign tog-24 = logical(entry( 24 , v-uf-List_, chr(4))). end.
  if entry( 26 , v-uf-List_, chr(4)) <> "" then do : assign tog-26 = logical(entry( 26 , v-uf-List_, chr(4))). end.
  if entry( 27 , v-uf-List_, chr(4)) <> "" then do : assign tog-27 = logical(entry( 27 , v-uf-List_, chr(4))). end.
  if entry( 28 , v-uf-List_, chr(4)) <> "" then do : assign tog-28 = logical(entry( 28 , v-uf-List_, chr(4))). end.
  if entry( 29 , v-uf-List_, chr(4)) <> "" then do : assign tog-29 = logical(entry( 29 , v-uf-List_, chr(4))). end.
  if entry( 30 , v-uf-List_, chr(4)) <> "" then do : assign tog-30 = logical(entry( 30 , v-uf-List_, chr(4))). end.
  if entry( 31 , v-uf-List_, chr(4)) <> "" then do : assign tog-31 = logical(entry( 31 , v-uf-List_, chr(4))). end.
  if entry( 32 , v-uf-List_, chr(4)) <> "" then do : assign tog-32 = logical(entry( 32 , v-uf-List_, chr(4))). end.
  if entry( 33 , v-uf-List_, chr(4)) <> "" then do : assign tog-33 = logical(entry( 33 , v-uf-List_, chr(4))). end.
  if entry( 34 , v-uf-List_, chr(4)) <> "" then do : assign tog-34 = logical(entry( 34 , v-uf-List_, chr(4))). end.
assign
  tog-3  = yes
  tog-25 = yes
no-error .
...
v-str = '' .
v-i = 0 .
v-str = string(tog-1  , "yes/no") + chr(4) +
        ...
        string(tog-7  , "yes/no") + chr(4) +
        string(tog-8  , "yes/no") + chr(4) +
        string(tog-9  , "yes/no") + chr(4) +
        string(tog-10 , "yes/no") + chr(4) +
        string(tog-11 , "yes/no") + chr(4) +
        string(tog-12 , "yes/no") + chr(4) +
        string(tog-13 , "yes/no") + chr(4) +
        string(tog-14 , "yes/no") + chr(4) +
        string(tog-15 , "yes/no") + chr(4) +
        string(tog-16 , "yes/no") + chr(4) +
        string(tog-17 , "yes/no") + chr(4) +
        string(tog-18 , "yes/no") + chr(4) +
        string(tog-19 , "yes/no") + chr(4) +
        string(tog-20 , "yes/no") + chr(4) +
        string(tog-21 , "yes/no") + chr(4) +
        string(tog-22 , "yes/no") + chr(4) +
        string(tog-23 , "yes/no") + chr(4) +
        string(tog-24 , "yes/no") + chr(4) +
        string(tog-25 , "yes/no") + chr(4) +
        string(tog-26 , "yes/no") + chr(4) +
        string(tog-27 , "yes/no") + chr(4) +
        string(tog-28 , "yes/no") + chr(4) +
        string(tog-29 , "yes/no") + chr(4) +
        string(tog-30 , "yes/no") + chr(4) +
        string(tog-31 , "yes/no") + chr(4) +
        string(tog-32 , "yes/no") + chr(4) +
        string(tog-33 , "yes/no") + chr(4) +
        string(tog-34 , "yes/no") + chr(4)
  .
