...
define variable vss-description as character no-undo init "Состояние запаса по объектам + Доп БК (закладка № 2)".
...
DEFINE RECTANGLE RECT-6
     EDGE-PIXELS 2 GRAPHIC-EDGE  NO-FILL
     SIZE 16.13 BY 7.79.
DEFINE VARIABLE ShowZero AS LOGICAL INITIAL yes
...
DEFINE FRAME F-Main
     ...
     Tog-lavel AT ROW 5.67 COL 15
     var-lavel AT ROW 5.67 COL 25.88 COLON-ALIGNED NO-LABEL
...
END PROCEDURE.
PROCEDURE my-var :
assign frame F-Main SumsOnly ShowZero  Classify SortType
Tog-lavel var-lavel.
