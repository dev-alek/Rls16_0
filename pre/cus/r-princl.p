...
v-principial-profit       column-label "Сумма подлежащая!перечисл. принцип-лу" format "->>>,>>>,>>9.99"
...
"№" + chr(44) +
"Наименование фирмы (принципиала)" + chr(44) +
"Сумма продаж" + chr(44) +
"В том числе сумма НсП" + chr(44) +
"Сумма продаж без НсП" + chr(44) +
"Сумма агентского вознаграждения" + chr(44) +
...
for each temp-goods no-lock :
  ...
  temp-goods.netto         CHR(9)
  v-slt-sum                CHR(9)
  v-without-slt-sum        CHR(9)
  v-agent-profit           CHR(9)
  v-principial-profit
  skip.
end.
...
.
display stream PrnLibStream
"Итого" + chr(32) + string(accum-count) + chr(32) + "фирм" @ temp-goods.gds-name
...
if Make-Excel then  put   stream ForExcel unformatted
CHR(9)
("Итого" + chr(32) + string(accum-count) + chr(32) + "фирм")  CHR(9)
accum-netto                                                               CHR(9)
v-slt-sum                                                                 CHR(9)
v-without-slt-sum                                                         CHR(9)
v-agent-profit                                                            CHR(9)
...
put stream PrnLibStream unformatted
skip(2)
"Главный бухгалтер фирмы" chr(32)
buf_clients.obj-name fill(chr(32), 5)
buf_sysconf.snr-accnt chr(32) fill("_", 15)
skip(0)
fill(chr(32), 30 + length(buf_clients.obj-name) + length(buf_sysconf.snr-accnt))
"(подпись)"
skip(0)
fill(chr(32), 30 + length(buf_clients.obj-name) + length(buf_sysconf.snr-accnt)) "М.П."
skip.
if Make-Excel then  put   stream ForExcel unformatted
skip(2)
                                                    CHR(9)
("Главный бухгалтер фирмы" + chr(32) +
 buf_clients.obj-name + chr(32))                       CHR(9)
                                                    CHR(9)
                                                    CHR(9)
buf_sysconf.snr-accnt                               CHR(9)
                                                    CHR(9)
SKIP(0)
                                                   CHR(9)
                                                   CHR(9)
