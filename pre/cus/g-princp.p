...
define variable vss-workfile    as character no-undo init "$Workfile: g-princp.p $":U .
define variable vss-archive     as character no-undo init "$Archive: cus/g-princp.p $":U .
