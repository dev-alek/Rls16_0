...
define variable vss-include-info0 as character format "x(65)" no-undo initial "@(#)$Workfile: ord-trnz.p $ $Revision: aea5316774be, 0, rls $".
...
assign
  ttt_ord-doc-rcv.status_  = 'поставка':U
  .
