    ...
    if last-of (buf_temp-bon1.item-name) then do:
      ...
      if last(buf_temp-bon1.item-name) then do:
        ...
        by item_temp-bon1.item-name:
            ...
            if Make-Excel then  put   stream ForExcel unformatted
            "Итого" CHR(9)
            item_temp-bon1.item-name CHR(9)
            CHR(9)
            CHR(9)
            CHR(9)
            CHR(9)
            CHR(9)
            item_temp-bon1.src-qnty  CHR(9)
            CHR(9)
            CHR(9)
            item_temp-bon1.src-sum CHR(9)
        ...
        by op_temp-bon1.item-name:
            ...
            CHR(9)
            op_temp-bon1.src-qnty  CHR(9)
            CHR(9)
            CHR(9)
            op_temp-bon1.src-sum CHR(9)
