...
DO:
  ...
  OPEN QUERY BROWSE-3 FOR EACH tmp-ord NO-LOCK.
END.
...
OR MOUSE-SELECT-DBLCLICK OF BROWSE-3 IN FRAME Dialog-Frame
DO:
  if not available tmp-ord then do:
   ...
   IF     tmp-ord.mm = true THEN DO:
           tmp-ord.mm = false.
           disp "" @ Tmp-ord.mm with browse BROWSE-3.
    End.
    Else DO:
           tmp-ord.mm = true.
           disp "*" @ tmp-ord.mm with browse BROWSE-3.
    End.
     ...
     apply "ROW-DISPLAY" to BROWSE-3 in frame Dialog-Frame.
     g#log = BROWSE-3:select-next-row ().
END.
ON ROW-DISPLAY OF BROWSE-3 IN FRAME Dialog-Frame
DO:
if tmp-ord.mm = true then DO:
      tmp-ord.mm          :fgcolor in browse BROWSE-3 = brown_color.
      tmp-ord.doc-code    :fgcolor in browse BROWSE-3 = brown_color.
      tmp-ord.flag_       :fgcolor in browse BROWSE-3 = brown_color.
      tmp-ord.status_     :fgcolor in browse BROWSE-3 = brown_color.
      tmp-ord.doc-date    :fgcolor in browse BROWSE-3 = brown_color.
      tmp-ord.host-code   :fgcolor in browse BROWSE-3 = brown_color.
      tmp-ord.cli-type    :fgcolor in browse BROWSE-3 = brown_color.
      tmp-ord.cli-name    :fgcolor in browse BROWSE-3 = brown_color.
  End.
  Else DO:
      tmp-ord.mm          :fgcolor in browse BROWSE-3 = black_color.
      tmp-ord.doc-code    :fgcolor in browse BROWSE-3 = black_color.
      tmp-ord.flag_       :fgcolor in browse BROWSE-3 = black_color.
      tmp-ord.status_     :fgcolor in browse BROWSE-3 = black_color.
      tmp-ord.doc-date    :fgcolor in browse BROWSE-3 = black_color.
      tmp-ord.host-code   :fgcolor in browse BROWSE-3 = black_color.
      tmp-ord.cli-type    :fgcolor in browse BROWSE-3 = black_color.
      tmp-ord.cli-name    :fgcolor in browse BROWSE-3 = black_color.
  End.
END.
