...
PROCEDURE enable_UI :
  ...
  OPEN QUERY BROWSE-3 FOR EACH tt_doc-line NO-LOCK where tt_doc-line.artic     = buf_goods.artic and tt_doc-line.prod-type = buf_goods.prod-type and tt_doc-line.prod-code = buf_goods.prod-code  ,        first buf_trn-doc no-lock where       buf_trn-doc.doc-code = tt_doc-line.doc-code ,        first buf_clients no-lock where       buf_clients.obj-code = buf_trn-doc.cli-code and       buf_clients.obj-type = buf_trn-doc.cli-type  INDEXED-REPOSITION.
END PROCEDURE.
