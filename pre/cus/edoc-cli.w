...
if v-num-entry15 > 0 then do:
  ...
  .
    ...
    if last-event:function <> "MOUSE-SELECT-DBLCLICK" then do:
        ...
        apply "VALUE-CHANGED" to br-edoc-cli in frame Dialog-Frame.
    end.
  ...
  apply "entry" to br-edoc-cli in frame Dialog-Frame.
END.
  ...
  :
    ...
    :
      assign
        ...
        v-diasize-browse-handle     = browse br-edoc-cli :handle
      .
...
PROCEDURE enable_UI :
  ...
  OPEN QUERY br-edoc-cli FOR EACH X_ext-classif NO-LOCK,        FIRST X_clients NO-LOCK INDEXED-REPOSITION.
END PROCEDURE.
PROCEDURE MyEnable :
ENABLE
b-quit
...
run gbl/flt-get.p
  ...
  then do:
    ...
    define variable  parameter-7-28 as character no-undo .
      ...
      parameter-4-28 =
        (
          if (" X_ext-classif.classif-subject = 'clients':U                           and X_ext-classif.classif-name = 'clients-edoc-nn':U                           AND X_ext-classif.db-num = - 1" + " " + where-phrase-28) <> ""
          then  substitute('X_ext-classif.classif-subject = &1&2&1                           and X_ext-classif.classif-name = &1&3&1                           AND X_ext-classif.db-num = - 1', chr(34), 'clients':U, 'clients-edoc-nn':U) + " " + where-phrase-28
          else "true"
        )
    ...
    :
      assign
        l-disable-where-28 =
          (" X_ext-classif.classif-subject = 'clients':U                           and X_ext-classif.classif-name = 'clients-edoc-nn':U                           AND X_ext-classif.db-num = - 1" + " " + where-phrase-28 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-edoc-cli:handle
  ...
  if l-filter-open-28 = false then do:
    OPEN QUERY br-edoc-cli FOR EACH X_ext-classif
      where  X_ext-classif.classif-subject = 'clients':U                           and X_ext-classif.classif-name = 'clients-edoc-nn':U                           AND X_ext-classif.db-num = - 1
...
run gbl/flt-get.p
  ...
  then do:
    ...
    define variable  parameter-7-30 as character no-undo .
      ...
      parameter-4-30 =
        (
          if (" X_ext-classif.classif-subject = 'clients':U                           and X_ext-classif.classif-name = 'clients-edoc-nn':U                           AND X_ext-classif.db-num = - 1 AND X_ext-classif.key#_one = v-esys-id" + " " + where-phrase-30) <> ""
          then  substitute('X_ext-classif.classif-subject = &1&2&1                           and X_ext-classif.classif-name = &1&3&1                           AND X_ext-classif.db-num = - 1 AND X_ext-classif.key#_one = &4 ', chr(34), 'clients':U, 'clients-edoc-nn':U, v-esys-id) + " " + where-phrase-30
          else "true"
        )
      parameter-5-30 = (" " + "" + " " + substitute(', FIRST X_clients NO-LOCK WHERE                                   X_clients.obj-type = ENTRY(2, X_eXt-classif.uniq-key-rec, chr(3)) AND                                   X_clients.obj-code = integer(ENTRY(3, X_eXt-classif.uniq-key-rec, chr(3)))'))
    ...
    :
      assign
        l-disable-where-30 =
          (" X_ext-classif.classif-subject = 'clients':U                           and X_ext-classif.classif-name = 'clients-edoc-nn':U                           AND X_ext-classif.db-num = - 1 AND X_ext-classif.key#_one = v-esys-id" + " " + where-phrase-30 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input QUERY br-edoc-cli:handle
  ...
  if l-filter-open-30 = false then do:
    OPEN QUERY br-edoc-cli FOR EACH X_ext-classif
      where  X_ext-classif.classif-subject = 'clients':U                           and X_ext-classif.classif-name = 'clients-edoc-nn':U                           AND X_ext-classif.db-num = - 1 AND X_ext-classif.key#_one = v-esys-id
    , FIRST X_clients NO-LOCK WHERE                                   X_clients.obj-type = ENTRY(2, X_eXt-classif.uniq-key-rec, chr(3)) AND                                   X_clients.obj-code = integer(ENTRY(3, X_eXt-classif.uniq-key-rec, chr(3)))
      INDEXED-REPOSITION
  .
      assign
...
APPLY "entry" TO br-edoc-cli.
if available X_ext-classif then do:
    APPLY "VALUE-CHANGED":U to br-edoc-cli.
END.
END PROCEDURE.
...
if buf_ext-system.esys-type < integer('1':U)
then do:
  message
