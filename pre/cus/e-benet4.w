...
define variable vss-description as character no-undo init "Отчет о реализации для BENETTON (EXCEL)".
...
DEFINE VARIABLE FILL-IN-3 AS CHARACTER FORMAT "X(256)":U INITIAL "abbr_rub"
      VIEW-AS TEXT
...
"по типу ткани", "sort-type":U
     SIZE 20.75 BY 3.88 NO-UNDO.
...
DEFINE FRAME F-Main
     ...
     FILL-IN-3 AT ROW 9 COL 39 COLON-ALIGNED NO-LABEL
...
PROCEDURE adm-disable :
    DISABLE RECT-6 RECT-8 RECT-5 Tog-obj SortType Classify RADIO-SET-1 tog-kass tog-ras tog-voz Tog-1 week-1 week-12 week-2 week-22 week-3 week-32 week-4 week-42 week-5 week-52 FILL-IN-3 WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-6 RECT-8 RECT-5 Tog-obj SortType Classify RADIO-SET-1 tog-kass tog-ras tog-voz Tog-1 week-1 week-12 week-2 week-22 week-3 week-32 week-4 week-42 week-5 week-52 FILL-IN-3 WITH FRAME F-Main.
...
DO:
  ...
  case radio-set-1 :
  when 1 then DO:
          disable max-amount max-amount-2 min-sum with frame F-Main .
         end.
  when 2 then DO:
          enable max-amount with frame F-Main .
          disable max-amount-2 min-sum with frame F-Main .
         end.
  when 3 then DO:
          disable max-amount with frame F-Main .
          enable max-amount-2 min-sum with frame F-Main .
           end.
  End case.
     display max-amount max-amount-2 min-sum with frame F-Main .
END.
ON VALUE-CHANGED OF Tog-1 IN FRAME F-Main
DO:
  assign tog-1 .
  if tog-1 then
  enable week-1 week-12 week-2 week-22 week-3 week-32 week-4 week-42 week-5 week-52 with frame F-Main.
  else
  disable week-1 week-12 week-2 week-22 week-3 week-32 week-4 week-42 week-5 week-52 with frame F-Main.
  display week-1 week-12 week-2 week-22 week-3 week-32 week-4 week-42 week-5 week-52 with frame F-Main.
END.
...
on delete-character of week-1 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-d of week-1 in frame F-Main
do:
...
on ctrl-b of week-1 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-e of week-1 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-f of week-1 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
  ...
  define MENU m-ed-date14
    ...
    .
  if week-1 :POPUP-MENU in frame F-Main = ?
  then do:
    ASSIGN
      week-1 :POPUP-MENU in frame F-Main = MENU m-ed-date14 :HANDLE
      week-1 :MENU-MOUSE in frame F-Main = 3
    .
  end.
  define variable v-label-handle14 as handle no-undo .
  assign
    v-label-handle14 = week-1 :side-label-handle in frame F-Main
  .
...
on delete-character of week-12 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-d of week-12 in frame F-Main
do:
  define variable v-curr-sv-date as date no-undo .
  if (can-query (self, "sensitive")
     and
...
on ctrl-b of week-12 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-e of week-12 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-f of week-12 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
  ...
  define MENU m-ed-date16
    ...
    .
  if week-12 :POPUP-MENU in frame F-Main = ?
  then do:
    ASSIGN
      week-12 :POPUP-MENU in frame F-Main = MENU m-ed-date16 :HANDLE
      week-12 :MENU-MOUSE in frame F-Main = 3
    .
  end.
  define variable v-label-handle16 as handle no-undo .
  assign
    v-label-handle16 = week-12 :side-label-handle in frame F-Main
  .
...
on delete-character of week-2 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-d of week-2 in frame F-Main
do:
  define variable v-curr-sv-date as date no-undo .
  if (can-query (self, "sensitive")
     and
...
on ctrl-b of week-2 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-e of week-2 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-f of week-2 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
  ...
  define MENU m-ed-date18
    ...
    .
  if week-2 :POPUP-MENU in frame F-Main = ?
  then do:
    ASSIGN
      week-2 :POPUP-MENU in frame F-Main = MENU m-ed-date18 :HANDLE
      week-2 :MENU-MOUSE in frame F-Main = 3
    .
  end.
  define variable v-label-handle18 as handle no-undo .
  assign
    v-label-handle18 = week-2 :side-label-handle in frame F-Main
  .
...
on delete-character of week-22 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-d of week-22 in frame F-Main
do:
  define variable v-curr-sv-date as date no-undo .
  if (can-query (self, "sensitive")
     and
...
on ctrl-b of week-22 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-e of week-22 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-f of week-22 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
  ...
  define MENU m-ed-date20
    ...
    .
  if week-22 :POPUP-MENU in frame F-Main = ?
  then do:
    ASSIGN
      week-22 :POPUP-MENU in frame F-Main = MENU m-ed-date20 :HANDLE
      week-22 :MENU-MOUSE in frame F-Main = 3
    .
  end.
  define variable v-label-handle20 as handle no-undo .
  assign
    v-label-handle20 = week-22 :side-label-handle in frame F-Main
  .
...
on delete-character of week-3 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-d of week-3 in frame F-Main
do:
  define variable v-curr-sv-date as date no-undo .
  if (can-query (self, "sensitive")
     and
...
on ctrl-b of week-3 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-e of week-3 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-f of week-3 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
  ...
  define MENU m-ed-date22
    ...
    .
  if week-3 :POPUP-MENU in frame F-Main = ?
  then do:
    ASSIGN
      week-3 :POPUP-MENU in frame F-Main = MENU m-ed-date22 :HANDLE
      week-3 :MENU-MOUSE in frame F-Main = 3
    .
  end.
  define variable v-label-handle22 as handle no-undo .
  assign
    v-label-handle22 = week-3 :side-label-handle in frame F-Main
  .
...
on delete-character of week-32 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-d of week-32 in frame F-Main
do:
  define variable v-curr-sv-date as date no-undo .
  if (can-query (self, "sensitive")
     and
...
on ctrl-b of week-32 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-e of week-32 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-f of week-32 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
  ...
  define MENU m-ed-date24
    ...
    .
  if week-32 :POPUP-MENU in frame F-Main = ?
  then do:
    ASSIGN
      week-32 :POPUP-MENU in frame F-Main = MENU m-ed-date24 :HANDLE
      week-32 :MENU-MOUSE in frame F-Main = 3
    .
  end.
  define variable v-label-handle24 as handle no-undo .
  assign
    v-label-handle24 = week-32 :side-label-handle in frame F-Main
  .
...
on delete-character of week-4 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-d of week-4 in frame F-Main
do:
  define variable v-curr-sv-date as date no-undo .
  if (can-query (self, "sensitive")
     and
...
on ctrl-b of week-4 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-e of week-4 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-f of week-4 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
  ...
  define MENU m-ed-date26
    ...
    .
  if week-4 :POPUP-MENU in frame F-Main = ?
  then do:
    ASSIGN
      week-4 :POPUP-MENU in frame F-Main = MENU m-ed-date26 :HANDLE
      week-4 :MENU-MOUSE in frame F-Main = 3
    .
  end.
  define variable v-label-handle26 as handle no-undo .
  assign
    v-label-handle26 = week-4 :side-label-handle in frame F-Main
  .
...
on delete-character of week-42 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-d of week-42 in frame F-Main
do:
  define variable v-curr-sv-date as date no-undo .
  if (can-query (self, "sensitive")
     and
...
on ctrl-b of week-42 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-e of week-42 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
...
on ctrl-f of week-42 in frame F-Main
do:
  if (can-query (self, "sensitive")
     and
     self :sensitive = true
  ...
  define MENU m-ed-date28
    ...
    .
  if week-42 :POPUP-MENU in frame F-Main = ?
  then do:
    ASSIGN
      week-42 :POPUP-MENU in frame F-Main = MENU m-ed-date28 :HANDLE
      week-42 :MENU-MOUSE in frame F-Main = 3
    .
  end.
  define variable v-label-handle28 as handle no-undo .
  assign
    v-label-handle28 = week-42 :side-label-handle in frame F-Main
  .
...
PROCEDURE local-initialize :
  ...
  :
   ...
   disable max-amount-2 min-sum with frame F-Main .
   RAdio-set-1:screen-value      in frame F-Main = '1'.
   Tog-obj:screen-value      in frame F-Main = 'yes'.
   Tog-1:screen-value      in frame F-Main = 'yes'.
   Tog-kass:screen-value      in frame F-Main = 'yes'.
   Tog-ras:screen-value      in frame F-Main = 'yes'.
   Tog-voz:screen-value      in frame F-Main = 'yes'.
   Tog-lavel:screen-value      in frame F-Main = 'no'.
   var-lavel:screen-value    in frame F-Main = '1'.
   min-sum:screen-value      in frame F-Main = '0'.
   max-amount:screen-value   in frame F-Main = '20'.
   max-amount-2:screen-value in frame F-Main = '20'.
   max-amount   = 20.
   max-amount-2 = 20.
END PROCEDURE.
PROCEDURE my-report :
if tog-obj = true  then do:
      run cus/r-benet4.p
          (input v-cntxt-obj-code,input v-cntxt-obj-type,input base-type, input base-code, input Classify, input SortType, input false, input false, input Tog-obj, input tog-lavel, input var-lavel, input radio-set-1,input max-amount, input max-amount-2,input min-sum, input tog-kass,input tog-ras, input tog-voz, input fo1,input fo12, input fo2,input fo22,input fo3,input fo32,input fo4,input fo42,input fo5,input fo52,input tog-1 ). .
end.
Else do:
        run cus/r-bene4n.p
            (input v-cntxt-obj-code,input v-cntxt-obj-type,input base-type, input base-code, input Classify, input SortType, input false, input false, input Tog-obj, input tog-lavel, input var-lavel, input radio-set-1,input max-amount, input max-amount-2,input min-sum, input tog-kass,input tog-ras, input tog-voz, input fo1,input fo12, input fo2,input fo22,input fo3,input fo32,input fo4,input fo42,input fo5,input fo52,input tog-1 ). .
...
End.
ReportNAme = "О Т Ч Е Т   О   Р Е А Л И З А Ц И И   Т О В А Р А".
...
When 3 then
    ReportHeader = ReportHeader + string(max-amount-2) + ' с наименьшей реализацией, но большей ' + string(min-sum) + ' руб.' + chr(10).
End case.
ReportHeader = ReportHeader +
               "Виды продаж : " + if (tog-kass) then 'касса продажа':U Else ""   .
ReportHeader = ReportHeader +  " , " +
                if (tog-ras) then 'расход внешний':U Else ""   .
ReportHeader = ReportHeader +  " , " +
                if (tog-voz) then 'возврат внешний':U Else ""   .
   if tog-1 then DO:
...
PROCEDURE state-changed :
  ...
  DEFINE INPUT PARAMETER p-state      AS CHARACTER NO-UNDO.
  define variable month-1 as date no-undo .
  define variable month-2 as date no-undo .
...
if month-2 = ? THEN   DO:
    ...
    run gbl/lastdate.p
      ...
      ,output month-2  ).
    End.
NN = Weekday(DAte(month(month-1 ),1,year(month-1)))  .
...
if date(week-1:screen-value in frame F-Main) <> ? then
 assign frame F-Main
week-1
week-12
week-2
