...
def
new shared
temp-table alt-obj-list no-undo
  field obj-type like ub.clients.obj-type
  field obj-code like ub.clients.obj-code
  field obj-name like ub.clients.obj-name
  field obj-id   as integer
...
PROCEDURE adm-disable :
    DISABLE RECT-12 RECT-3 Classify Itog x-cost x-sale x-dis WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-12 RECT-3 Classify Itog x-cost x-sale x-dis WITH FRAME F-Main.
