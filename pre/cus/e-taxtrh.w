...
PROCEDURE adm-disable :
    DISABLE RECT-6 RECT-8 RECT-7 RS-By WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-6 RECT-8 RECT-7 RS-By WITH FRAME F-Main.
...
Assign
frame F-Main RS-by
good-choice = (IF X-selectGood = 1 then no else yes)
method = "artic"
negparts = no
.
Assign
...
'ИНН' chr(32) buf_firm.inn chr(32) host-cli.obj-name SKIP
clients.obj-name SKIP(2)
"Грузополучатель: ИНН" chr(32) real-firm.inn chr(32) real-cli.obj-name SKIP
"Поставщик: " host-cli.obj-name SKIP
"Плательщик: " real-cli.obj-name SKIP
"Основание:" skip
"Примечание:" chr(32) v-direction skip
