...
DEFINE BUFFER buf-po_ord-doc-rcv FOR ub.ord-doc-rcv.
DEFINE BUFFER buf-po_trn-doc FOR ub.trn-doc.
...
define variable vss-description as character no-undo init "Список заказов Покупатель-Объект ".
...
define variable filter-point  as character no-undo init "Список заказов ПО" .
define variable filter-point0 as character no-undo init "Заказы ПО" .
...
( input p-rec as recid , input m as char) FORWARD.
DEFINE BUTTON b-add
     LABEL "&Добавить":L
...
DEFINE BUTTON b-history
     LABEL "&История":L
     SIZE 12 BY 1 TOOLTIP "История заказа".
DEFINE BUTTON b-lkp
     LABEL "&Просмотр":L
...
DEFINE BUTTON b-move
     ...
     SIZE 16.88 BY 1 TOOLTIP "Сформировать заявки по заказам".
DEFINE BUTTON b-move-to
     LABEL "Отправить":L
     SIZE 16.88 BY 1 TOOLTIP "Перенаправить заказ новый+ на распределение".
DEFINE BUTTON b-open
     LABEL "&Открыть":L
     SIZE 12 BY 1 TOOLTIP "Открыть запр+ до запр-".
DEFINE BUTTON b-print
     LABEL "Пе&чать":L
     SIZE 12 BY 1 TOOLTIP "Печать заказа".
...
DEFINE BUTTON b-sch
     LABEL "&Фильтр":L
     SIZE 12 BY 1 TOOLTIP "Фильтр по списку заказов".
DEFINE BUTTON b-sel
     LABEL "Вы&бор ":L
...
DEFINE NEW SHARED QUERY br-docs FOR
      buf-po_ord-doc SCROLLING.
DEFINE QUERY br-zapr FOR
      buf-po_ord-doc-rcv,
      ub.ord-chain,
      buf-po_trn-doc SCROLLING.
DEFINE BROWSE br-docs
  QUERY br-docs NO-LOCK DISPLAY
      mark-string(recid( buf-po_ord-doc), rid-list) COLUMN-LABEL '*' FORMAT "X(1)"
      buf-po_ord-doc.status_ COLUMN-LABEL 'Статус' Format "X(6)"
      buf-po_ord-doc.flag_ COLUMN-LABEL 'OK' format "+/-"
      buf-po_ord-doc.doc-code COLUMN-LABEL '№ док-та'
      buf-po_ord-doc.doc-date COLUMN-LABEL 'Создан' FORMAT "99/99/99"
      buf-po_ord-doc.fact-date COLUMN-LABEL 'Факт' FORMAT "99/99/99"
      ( buf-po_ord-doc.cli-type +  string(buf-po_ord-doc.cli-code)) COLUMN-LABEL 'Код' format "x(12)"
      buf-po_ord-doc.cli-name COLUMN-LABEL 'Покупатель' format "x(20)"
      buf-po_ord-doc.qnty COLUMN-LABEL 'Количество'
      buf-po_ord-doc.sum-rubl COLUMN-LABEL 'Сумма в руб.'
      f-direct ( recid( buf-po_ord-doc )) COLUMN-LABEL '>' format "x(1)"
  ENABLE
       buf-po_ord-doc.status_
    WITH NO-ROW-MARKERS SEPARATORS SIZE 95.38 BY 9.83
         BGCOLOR 15 .
DEFINE BROWSE br-zapr
  QUERY br-zapr NO-LOCK DISPLAY
      buf-po_trn-doc.doc-code
      buf-po_trn-doc.doc-type FORMAT "X(3)"
      buf-po_trn-doc.status_ COLUMN-LABEL "Стат" FORMAT "X(4)"
      buf-po_trn-doc.flag_ COLUMN-LABEL "Ок" FORMAT "+/-"
      buf-po_trn-doc.cli-type + string(buf-po_trn-doc.cli-code)  COLUMN-LABEL "Контрагент" FORMAT "X(12)"
      buf-po_trn-doc.obj-type + string(buf-po_trn-doc.obj-code)  COLUMN-LABEL "Объект"
      buf-po_trn-doc.doc-date
      buf-po_trn-doc.fact-date
      buf-po_trn-doc.tot-lines
      buf-po_trn-doc.fact-qnty COLUMN-LABEL "Количество" FORMAT ">>>>>>>>9.<<<"
      buf-po_trn-doc.tot-rubl  COLUMN-LABEL "Сумма руб." FORMAT ">>>>>>>>>9.99"
    WITH NO-ROW-MARKERS SEPARATORS SIZE 94.75 BY 7.46.
DEFINE FRAME Dialog-Frame
     b-quit AT ROW 1 COL 2
     b-sel AT ROW 1 COL 14
     b-history AT ROW 1 COL 26
     b-sch AT ROW 1 COL 38
     b-move-to AT ROW 1 COL 62
     b-help AT ROW 1 COL 84.38
     ...
     b-close AT ROW 2 COL 62
     b-move AT ROW 2 COL 62
     b-print AT ROW 2 COL 84.38
     ...
     B-lkp-2 AT ROW 15.25 COL 1
     B-close-trn AT ROW 15.25 COL 11
     B-rez AT ROW 15.25 COL 21
     br-zapr AT ROW 16.25 COL 1.5
     sch-num AT ROW 3.25 COL 80.38 COLON-ALIGNED NO-LABEL
     loc-boss AT ROW 14.38 COL 4.63 COLON-ALIGNED
     loc-agnt AT ROW 14.38 COL 27.88 COLON-ALIGNED
     loc-wrkr AT ROW 14.38 COL 53 COLON-ALIGNED
     loc-creid AT ROW 14.38 COL 80.38 COLON-ALIGNED
...
DO:
find current buf-po_ord-doc no-lock no-error .
if not available buf-po_ord-doc then return no-apply .
do on stop undo, return no-apply :
  find current buf-po_ord-doc exclusive-lock .
end.
 define variable rr as recid no-undo .
 if not available buf-po_ord-doc then return.
   if not( buf-po_ord-doc.status_ = 'новый':U and buf-po_ord-doc.flag_ = false ) then do:
      message "Нельзя корректировать заказ! " view-as alert-box  .
      return.
  end.
 rr = recid(buf-po_ord-doc) .
    run cus/ord-pou.w
      ( input parParentProc ,
        input-output rr  ,
        input 'ИЗМЕНЕНИЕ':U ).
...
DO:
  ...
  if not available buf-po_ord-doc then return.
  rr = recid(buf-po_ord-doc) .
  run ord-close in this-procedure (recid(buf-po_ord-doc)) .
...
DO:
 if not available buf-po_trn-doc   then return.
 message "Закрыть внутренний запрос ?"
  view-as alert-box question
  buttons yes-no
  update g-log.
  if g-log = false then return no-apply.
  if not (buf-po_trn-doc.status_  = 'запрос':U   ) then do:
    message "Закрыть можно только ЗАПР !"
            view-as alert-box information .
    return no-apply.
  end.
  run close-zapr in this-procedure (buf-po_trn-doc.doc-code) .
  OPEN QUERY br-zapr FOR EACH buf-po_ord-doc-rcv WHERE                   buf-po_ord-doc-rcv.doc-code = buf-po_ord-doc.doc-code NO-LOCK,          each ub.ord-chain no-lock where             ub.ord-chain.doc-code = buf-po_ord-doc-rcv.rcv-code and             ub.ord-chain.doc-type = 'rcv'                  and             ub.ord-chain.rel-doc-type = 'trn'             ,               EACH buf-po_trn-doc  where            buf-po_trn-doc.doc-code = ub.ord-chain.rel-doc-code  NO-LOCK.
END.
...
DO:
  ...
  run ord-del in this-procedure ( recid(buf-po_ord-doc)) .
END.
...
if not available buf-po_ord-doc then return no-apply .
    ...
    (
    parParentProc,
    buf-po_ord-doc.host-code,
    buf-po_ord-doc.doc-code,
    "" ) .
END.
...
if not available buf-po_ord-doc then return no-apply .
 ...
 rr = recid(buf-po_ord-doc) .
      ...
      next-prev = no.
      do while next-prev <> ?:
        if not available buf-po_ord-doc then do:
...
DO:
   if available buf-po_trn-doc then do:
      run str/showdoc.p
          (input parparentproc
          ,input buf-po_trn-doc.doc-code
          ,input ""
          ,input ""
          ,input 0
          ,input true
...
DO:
if not available buf-po_ord-doc then return.
if not( buf-po_ord-doc.status_ = 'новый':U  and
       buf-po_ord-doc.flag_ = yes )  then do :
        Message
          "Нельзя перенаправить распределять  заказ в статусе "
          caps(buf-po_ord-doc.status_) + string(buf-po_ord-doc.flag_,"+/-") skip
          "Документ" buf-po_ord-doc.doc-code view-as alert-box information
          .
        return.
      end.
 if v-cntxt-db-num = 0 and buf-po_ord-doc.order-type = 3 then do:
        Message
 ...
 if v-cntxt-db-num <> 0 and buf-po_ord-doc.order-type = 2 then do:
        Message
  ...
  find first buf_clients no-lock where
              buf_clients.obj-code = buf-po_ord-doc.obj-code and
              buf_clients.obj-type = buf-po_ord-doc.obj-type no-error .
 ...
 define variable rr as recid no-undo .
    ...
    message "Перенаправить распределение заказа в другую БД по СПН ?"
        ...
        if g-log = true then do:
            find current buf-po_ord-doc  exclusive-lock  no-error .
            if v-cntxt-db-num = 0 then do:
               buf-po_ord-doc.order-type = 3 .
            end.
            else do:
               buf-po_ord-doc.order-type = 2 .
            end.
        end.
  apply "VALUE-CHANGED" TO BR-docs IN FRAME Dialog-Frame.
  apply "entry" TO BR-docs IN FRAME Dialog-Frame.
...
DO:
  ...
  if not available buf-po_ord-doc then return.
  rr = recid(buf-po_ord-doc) .
  run ord-open in this-procedure ( recid(buf-po_ord-doc) ) .
  run openbr in this-procedure (yes, no, '':u).
  reposition br-docs to recid rr no-error.
  apply "VALUE-CHANGED" TO BR-docs IN FRAME Dialog-Frame.
  apply "entry" TO BR-docs IN FRAME Dialog-Frame.
...
DO:
  if ( available buf-po_ord-doc ) AND ( rid-list = "" ) then
    rid-list = string( recid( buf-po_ord-doc ) ) .
END.
...
if (valid-handle(g#library) <> true) then do:   run gbl/library.p persistent no-error .   if error-status :error or (valid-handle(g#library) <> true) then do:     message       "Error starting library.p" skip       g#library skip       g#library :type skip       g#library :file-name skip       error-status :get-message(1) skip       return-value skip       view-as alert-box error .     stop .   end. end. run usrfulnm in g#library
  (input  buf-po_ord-doc.creid
  ,output loc-creid
  )  .
 find first buf_clients no-lock where
         buf_clients.obj-type = 'чел':U  and
         buf_clients.obj-code  = buf-po_ord-doc.boss no-error.
    if available buf_clients then loc-boss = buf_clients.obj-name.
    else loc-boss = "".
 find first buf_clients no-lock where
         buf_clients.obj-type = 'чел':U  and
         buf_clients.obj-code  = buf-po_ord-doc.agnt no-error.
    if available buf_clients then loc-agnt = buf_clients.obj-name.
    else loc-agnt = "".
 find first buf_clients no-lock where
         buf_clients.obj-type = 'чел':U  and
         buf_clients.obj-code  = buf-po_ord-doc.wrkr no-error.
...
do:
  ...
  then do:
    ASSIGN
      sch-date :POPUP-MENU in frame Dialog-Frame = MENU m-ed-date20 :HANDLE
      sch-date :MENU-MOUSE in frame Dialog-Frame = 3
    .
  end.
  define variable v-label-handle20 as handle no-undo .
  assign
    v-label-handle20 = sch-date :side-label-handle in frame Dialog-Frame
  .
...
do:
  ...
  then do:
    ASSIGN
      sch-fact :POPUP-MENU in frame Dialog-Frame = MENU m-ed-date22 :HANDLE
      sch-fact :MENU-MOUSE in frame Dialog-Frame = 3
    .
  end.
  define variable v-label-handle22 as handle no-undo .
  assign
    v-label-handle22 = sch-fact :side-label-handle in frame Dialog-Frame
  .
...
DEF VAR cur-clmn-numbr-docs as INT EXTENT 11 no-undo.
...
ON ctrl-cursor-right OF BROWSE br-docs do:
  RUN re-move-clmnbr-docs ( 5, 11).
END.
ON ctrl-cursor-left OF BROWSE br-docs do:
  RUN re-move-clmnbr-docs (11, 5).
END.
...
on start-search, ctrl-o of br-docs in frame Dialog-Frame do:
   run sort-brbr-docs
     (input (if available buf-po_ord-doc
             then recid(buf-po_ord-doc)
             else ?
            )
     ).
end.
PROCEDURE sort-brbr-docs :
  ...
  case sort-labelbr-docs:
        when '*'  then DO:   assign       sort-column-name = substitute('dynamic-function(&1mark-string&1, recid(buf-po_ord-doc), &1&2&1)', chr(34), rid-list)     .     run OpenBr(yes, no, '':U).   . END.
        when 'Статус'  then DO:    assign       sort-column-name = "buf-po_ord-doc.status_"     .     run OpenBr(yes, no, '':U).   . END.
        when 'OK'  then DO:    assign       sort-column-name = "buf-po_ord-doc.flag_"     .     run OpenBr(yes, no, '':U).   . END.
        when '№ док-та'  then DO:    assign       sort-column-name = "buf-po_ord-doc.doc-code"     .     run OpenBr(yes, no, '':U).   . END.
        when 'Создан'  then DO:    assign       sort-column-name = "buf-po_ord-doc.doc-date"     .     run OpenBr(yes, no, '':U).   . END.
        when 'Факт'  then DO:    assign       sort-column-name = "buf-po_ord-doc.fact-date"     .     run OpenBr(yes, no, '':U).   . END.
        when 'Код'  then DO:    assign       sort-column-name = "( buf-po_ord-doc.cli-type +  string(buf-po_ord-doc.cli-code))"     .     run OpenBr(yes, no, '':U).   . END.
        when 'Покупатель'  then DO:    assign       sort-column-name = "buf-po_ord-doc.cli-name"     .     run OpenBr(yes, no, '':U).   . END.
        when 'Количество'  then DO:    assign       sort-column-name = "buf-po_ord-doc.qnty"     .     run OpenBr(yes, no, '':U).   . END.
        when 'Сумма в руб.'  then DO:    assign       sort-column-name = "buf-po_ord-doc.sum-rubl"     .     run OpenBr(yes, no, '':U).   . END.
        when '>'  then DO:   assign       sort-column-name = substitute('dynamic-function(&1f-direct&1, recid(buf-po_ord-doc))', chr(34))     .     run OpenBr(yes, no, '':U).   . END.
    otherwise do:
      assign
        sort-column-name = ""
      .
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ...
   buf-po_ord-doc.status_:read-only in browse br-docs = true .
  ...
  hide b-move b-move-to in frame Dialog-Frame .
...
END PROCEDURE.
PROCEDURE enable_UI :
  DISPLAY sch-code sch-date sch-fact sch-num loc-boss loc-agnt loc-wrkr
          loc-creid
      WITH FRAME Dialog-Frame.
  ENABLE b-quit b-sel b-history b-sch b-move-to b-help b-mark b-add b-lkp b-chg
         b-del b-open b-close b-move b-print sch-code sch-date sch-fact br-docs
         B-lkp-2 br-zapr sch-num loc-boss loc-agnt loc-wrkr loc-creid
      WITH FRAME Dialog-Frame.
  VIEW FRAME Dialog-Frame.
  OPEN QUERY br-docs FOR EACH buf-po_ord-doc NO-LOCK.    OPEN QUERY br-zapr FOR EACH buf-po_ord-doc-rcv WHERE                   buf-po_ord-doc-rcv.doc-code = buf-po_ord-doc.doc-code NO-LOCK,          each ub.ord-chain no-lock where             ub.ord-chain.doc-code = buf-po_ord-doc-rcv.rcv-code and             ub.ord-chain.doc-type = 'rcv'                  and             ub.ord-chain.rel-doc-type = 'trn'             ,               EACH buf-po_trn-doc  where            buf-po_trn-doc.doc-code = ub.ord-chain.rel-doc-code  NO-LOCK.
END PROCEDURE.
PROCEDURE main-ord :
 do
 on error undo, return error substitute("&1 &2 &3", return-value, error-status:get-message(1), error-status:get-message(2))
...
p-file-label = "Заказы Покупатель-Объект".
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-29 as character no-undo .
      assign
      parameter-3-29 =
                              "FOR EACH buf-po_ord-doc"
      parameter-4-29 =
        (
          if (" buf-po_ord-doc.host-code = par-host-code and buf-po_ord-doc.obj-code = p-obj-code and buf-po_ord-doc.obj-type = p-obj-type and buf-po_ord-doc.doc-type = p-doc-type" + " " + where-phrase-29) <> ""
          then  substitute(' buf-po_ord-doc.host-code = &2 and buf-po_ord-doc.obj-code = &3 and buf-po_ord-doc.obj-type = &1&4&1 and buf-po_ord-doc.doc-type = &1&5&1  ' , chr(34) , par-host-code , p-obj-code , p-obj-type , p-doc-type)  + " " + where-phrase-29
          else "true"
        )
      parameter-5-29 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-29 =
          (" buf-po_ord-doc.host-code = par-host-code and buf-po_ord-doc.obj-code = p-obj-code and buf-po_ord-doc.obj-type = p-obj-type and buf-po_ord-doc.doc-type = p-doc-type" + " " + where-phrase-29 = "")
      .
  ...
  if l-filter-open-29 = false then do:
    OPEN QUERY br-docs FOR EACH buf-po_ord-doc
      where  buf-po_ord-doc.host-code = par-host-code and buf-po_ord-doc.obj-code = p-obj-code and buf-po_ord-doc.obj-type = p-obj-type and buf-po_ord-doc.doc-type = p-doc-type
       USE-INDEX by-obj
  .
      assign
        l-query-was-opened = true
  ...
  assign
    doc-rec = recid( buf-po_ord-doc )
  .
  do
  on stop undo, leave
  on error undo, leave
  :
    if query br-docs:handle:get-buffer-handle(1) = (buffer buf-po_ord-doc:handle) then do:
      assign
      parameter-2-29 = (if p-find-next then "true":u else "false":u )
      parameter-4-29 =
        "where ":u +  substitute(' buf-po_ord-doc.host-code = &2 and buf-po_ord-doc.obj-code = &3 and buf-po_ord-doc.obj-type = &1&4&1 and buf-po_ord-doc.doc-type = &1&5&1  ' , chr(34) , par-host-code , p-obj-code , p-obj-type , p-doc-type)  + " ":u + where-phrase-29 + " ":u + p-find-condition + " " + ""
      parameter-5-29 = " USE-INDEX by-obj "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query br-docs:handle
                          ,input rowid(buf-po_ord-doc)
                          ,input logical(parameter-2-29)
                          ,input no-lock
                          ,input (buffer buf-po_ord-doc:handle)
                          ,input parameter-4-29
                          ,input parameter-5-29
                          ) no-error.
      .
      ...
      assign
      parameter-2-29 = (if p-find-next then "true":u else "false":u )
      parameter-3-29 =  "FOR EACH buf-po_ord-doc"
      parameter-4-29 =
        (
          if (" buf-po_ord-doc.host-code = par-host-code and buf-po_ord-doc.obj-code = p-obj-code and buf-po_ord-doc.obj-type = p-obj-type and buf-po_ord-doc.doc-type = p-doc-type" + " " + where-phrase-29) <> ""
          then  substitute(' buf-po_ord-doc.host-code = &2 and buf-po_ord-doc.obj-code = &3 and buf-po_ord-doc.obj-type = &1&4&1 and buf-po_ord-doc.doc-type = &1&5&1  ' , chr(34) , par-host-code , p-obj-code , p-obj-type , p-doc-type)  + " " + where-phrase-29
...
if p-open-query then do:
  ...
  then do:
    ...
    define variable  parameter-7-31 as character no-undo .
      ...
      parameter-4-31 =
        (
          if (" buf-po_ord-doc.host-code = par-host-code and buf-po_ord-doc.obj-code = p-obj-code and buf-po_ord-doc.obj-type = p-obj-type and buf-po_ord-doc.doc-type = p-doc-type  and buf-po_ord-doc.status_= p-status_" + " " + where-phrase-31) <> ""
          then  substitute(' buf-po_ord-doc.host-code = &2 and buf-po_ord-doc.obj-code = &3 and buf-po_ord-doc.obj-type = &1&4&1 and buf-po_ord-doc.doc-type = &1&5&1  and buf-po_ord-doc.status_ = &1&6&1 ' , chr(34) , par-host-code , p-obj-code , p-obj-type , p-doc-type , p-status_)  + " " + where-phrase-31
          else "true"
        )
      parameter-5-31 = (" " + "" + " " + "")
    ...
    :
      assign
        l-disable-where-31 =
          (" buf-po_ord-doc.host-code = par-host-code and buf-po_ord-doc.obj-code = p-obj-code and buf-po_ord-doc.obj-type = p-obj-type and buf-po_ord-doc.doc-type = p-doc-type  and buf-po_ord-doc.status_= p-status_" + " " + where-phrase-31 = "")
      .
      run fltopend_fltopend in this-procedure  ( input this-procedure:handle
                          ,input query br-docs:handle
  ...
  if l-filter-open-31 = false then do:
    OPEN QUERY br-docs FOR EACH buf-po_ord-doc
      where  buf-po_ord-doc.host-code = par-host-code and buf-po_ord-doc.obj-code = p-obj-code and buf-po_ord-doc.obj-type = p-obj-type and buf-po_ord-doc.doc-type = p-doc-type  and buf-po_ord-doc.status_= p-status_
       USE-INDEX by-obj-type
  .
      assign
        l-query-was-opened = true
  ...
  :
    if query br-docs:handle:get-buffer-handle(1) = (buffer buf-po_ord-doc:handle) then do:
      ...
      parameter-4-31 =
        "where ":u +  substitute(' buf-po_ord-doc.host-code = &2 and buf-po_ord-doc.obj-code = &3 and buf-po_ord-doc.obj-type = &1&4&1 and buf-po_ord-doc.doc-type = &1&5&1  and buf-po_ord-doc.status_ = &1&6&1 ' , chr(34) , par-host-code , p-obj-code , p-obj-type , p-doc-type , p-status_)  + " ":u + where-phrase-31 + " ":u + p-find-condition + " " + ""
      parameter-5-31 = " USE-INDEX by-obj-type "
    .
      run fltopend_fltfindd in this-procedure  (
                          input this-procedure:handle
                          ,input query br-docs:handle
      ...
      assign
      parameter-2-31 = (if p-find-next then "true":u else "false":u )
      parameter-3-31 =  "FOR EACH buf-po_ord-doc"
      parameter-4-31 =
        (
          if (" buf-po_ord-doc.host-code = par-host-code and buf-po_ord-doc.obj-code = p-obj-code and buf-po_ord-doc.obj-type = p-obj-type and buf-po_ord-doc.doc-type = p-doc-type  and buf-po_ord-doc.status_= p-status_" + " " + where-phrase-31) <> ""
          then  substitute(' buf-po_ord-doc.host-code = &2 and buf-po_ord-doc.obj-code = &3 and buf-po_ord-doc.obj-type = &1&4&1 and buf-po_ord-doc.doc-type = &1&5&1  and buf-po_ord-doc.status_ = &1&6&1 ' , chr(34) , par-host-code , p-obj-code , p-obj-type , p-doc-type , p-status_)  + " " + where-phrase-31
...
if  buf-po_ord-doc.status_ = 'факт':U  then do:
...
run OpenBr in this-procedure
    (input false
    ,input par-next
    ,input substitute("and buf-po_ord-doc.doc-code begins &1 "
      , pardoc-code)
    ).
 apply "VALUE-CHANGED" to br-docs in frame Dialog-Frame.
  end.
...
run OpenBr in this-procedure
    (input false
    ,input par-next
    ,input substitute("and buf-po_ord-doc.doc-date = &1 "
      , ppp )
    ) no-error .
...
run OpenBr in this-procedure
    (input false
    ,input par-next
    ,input substitute("and buf-po_ord-doc.fact-date = &1 "
      , ppp )
    ) no-error .
    if error-status :error then
       message "За эту дату не найдено ни одной записи !" view-as alert-box .
...
find first fl no-lock where recid(fl) = p-rec no-error .
if error-status :error then return chr(42) .
v-res = chr(42) .
v-res-0 = chr(32) .
if v-cntxt-db-num = 0 then
...
END FUNCTION.
FUNCTION mark-string RETURNS CHARACTER
( input p-rec as recid , input m as char):
define buffer fl for ub.ord-doc .
find first fl no-lock where recid(fl) = p-rec no-error .
