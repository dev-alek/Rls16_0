...
PROCEDURE adm-disable :
    DISABLE RECT-8 RS-by2 RS-By WITH FRAME F-Main.
...
PROCEDURE adm-enable :
    ENABLE UNLESS-HIDDEN RECT-8 RS-by2 RS-By WITH FRAME F-Main.
  ...
  CASE RS-BY:
    ...
    when 5 then do:
        ...
        if not available doc-list then do:
          assign
          rs-by = 1.
          display rs-by with frame F-Main .
        end.
    end.
    when 4
    then do:
...
.
assign
sheetf.colformat =  "4=dd/mm/yyyy;5=dd/mm/yyyy;13=0":U
sheetf.Excel-Column-Lable =
                          "Тип документа"                 + chr(44) +
                          "Номер документа"               + chr(44) +
                          "Объект"                        + chr(44) +
                          "Дата документа"                + chr(44) +
                          "Дата факт документа"           + chr(44) +
                          "Контрагент"                    + chr(44) +
                          "Код оплаты документа"          + chr(44) +
                          "Код товара"                    + chr(44) +
                          "Бар-код"                        + chr(44) +
                          "Название товара"               + chr(44) +
                          "Группа товара"                 + chr(44) +
                          "Признак шкалы товара"          + chr(44) +
                          "Артикул"                       + chr(44) +
                          ...
                          "Количество"                    + chr(44) +
                          "Поставщик"                     + chr(44) +
                          "Название поставщика"           + chr(44) +
                          "Код типа приобертения партии товара"      + chr(44) +
                          "Код оплаты партии товара"      + chr(44) +
                          "Номер документа поставки"      + chr(44) +
                          "Номер партии"                  + chr(44) +
                          "Уч цена"                       + chr(44) +
                          "Сумма учетных цен"             + chr(44) +
                          "Ставка НДС поставщика"         + chr(44) +
                          "Сумма НДС поставщика"          + chr(44) +
                          "Ставка НДС документа"          + chr(44) +
                          "Сумма НДС документа"           + chr(44) +
                          "Цена продажи на момент закр. док-та"          + chr(44) +
                          "Сумма продажных цен"           + chr(44) +
                          "Цена документа"                + chr(44) +
                          "Сумма цен по документу"        + chr(44) +
                          "Сумма скидки"
sheetf.Sizes =
                          "15"                            + chr(44) +
                          "14"                            + chr(44) +
