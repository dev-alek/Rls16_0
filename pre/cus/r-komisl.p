...
v-sum-without-slt-sale    column-label "Получено!комиссионером" format "->>,>>>,>>>,>>9.99"
v-sum-with-tax-cost       column-label "Подлежит!перечислению!комитенту" format "->>,>>>,>>>,>>9.99"
v-sum-benefit-with-VAT    column-label "Комиссионное!вознаграждение!с НДС" format "->>,>>>,>>>,>>9.99"
v-sum-benefit-without-VAT column-label "Комиссионное!вознаграждение!без НДС" format "->>,>>>,>>>,>>9.99"
...
assign
str3 = str3 + chr(10) + "НДС принимается равным" + chr(32) + string(18.00, ">9.99%")
sheetf.Excel-Column-Lable =
"№"  + chr(44) +
"Наименование поставщика" + chr(44) +
"Получено комиссионером" + chr(44) +
"Подлежит перечислению комитенту" + chr(44) +
"Комиссионное вознаграждение с НДС" + chr(44) +
...
"НДС принимается равным" chr(32) string(18.00, ">9.99%") skip(0)
.
FORM HEADER
...
by sj-goods.supp-code:
  ...
  v-sum-benefit-without-VAT = v-sum-benefit-with-VAT / (1 + 18.00 / 100 )
  ...
  v-nn                                                   CHR(9)
  v-supp-name                                            CHR(9)
  (sj-goods.sum-with-tax-sale_ - sj-goods.sum-slt-sale_) CHR(9)
  sj-goods.sum-with-tax-cost                             CHR(9)
  v-sum-benefit-with-VAT                                 CHR(9)
  v-sum-benefit-without-VAT
  skip.
END.
...
if Make-Excel then  put   stream ForExcel unformatted
                          CHR(9)
"ИТОГО"                   CHR(9)
a-sum-without-slt-sale    CHR(9)
a-sum-with-tax-cost       CHR(9)
a-sum-benefit-with-VAT    CHR(9)
