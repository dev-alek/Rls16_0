...
Изменение истории атрибутов типов алкогол
...
TRIGGER PROCEDURE FOR WRITE OF ub.c-alc-type-attr.
...
:
   ...
   run str/callnews.p
      (input "c-alc-type-attr"
      ,input (buffer ub.c-alc-type-attr:handle)
      ) no-error .
