...
Триггер на удаление arh-fin-doc-an
...
TRIGGER PROCEDURE FOR DELETE OF arh-fin-doc-an.
...
define variable vss-description as character no-undo init "Триггер на удаление arh-fin-doc-an".
{ cmp/vssrevis.i }
{ cmp/trg-def.i  }
main-block:
do
