...
Триггер на удаление истории шапки групп блюд
...
TRIGGER PROCEDURE FOR DELETE OF ub.c-fbr-gds-grp-hist.
...
define variable vss-description as character no-undo init "Триггер на удаление истории шапки групп блюд".
...
:
  ...
  "Нельзя удалять ГОЛОВНУЮ запись ИСТОРИИ  ГРУПП БЛЮД"
