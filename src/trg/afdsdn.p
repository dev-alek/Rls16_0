...
Триггер на удаление arh-fin-doc-schet-nal
...
TRIGGER PROCEDURE FOR DELETE OF arh-fin-doc-schet-nal.
...
define variable vss-description as character no-undo init "Триггер на удаление arh-fin-doc-schet-nal".
{ cmp/vssrevis.i }
{ cmp/trg-def.i  }
main-block:
do
