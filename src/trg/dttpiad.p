...
Триггер на удаление атрибутов типов данных для импорта.
...
TRIGGER PROCEDURE FOR DELETE OF ub.datatype-imp-attr .
...
define variable vss-description as character no-undo init "Триггер на удаление атрибутов типов данных для импорта.".
{ cmp/vssrevis.i }
{ cmp/trg-def.i  }
