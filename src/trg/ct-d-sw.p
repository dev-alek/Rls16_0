...
Триггер на запись c-trn-doc-sum для новостей
...
trigger procedure for write of ub.c-trn-doc-sum new buffer newb old buffer oldb.
...
define variable vss-description as character no-undo initial "Триггер на запись c-trn-doc-sum для новостей":U.
