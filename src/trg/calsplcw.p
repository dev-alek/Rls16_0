...
Удаление истории лицензий поставщиков алкогол
...
TRIGGER PROCEDURE FOR WRITE OF ub.c-alc-supp-lic.
...
:
   ...
   run str/callnews.p
      (input "c-alc-supp-lic"
      ,input (buffer ub.c-alc-supp-lic:handle)
      ) no-error .
