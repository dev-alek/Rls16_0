...
Триггер на удаление arh-fin-doc-contr-schet
...
TRIGGER PROCEDURE FOR DELETE OF ub.arh-fin-doc-contr-schet.
...
define variable vss-description as character no-undo init "Триггер на удаление arh-fin-doc-contr-schet".
{ cmp/vssrevis.i }
{ cmp/trg-def.i  }
main-block:
do
