...
Триггер на запись истории группы на кассе
...
TRIGGER PROCEDURE FOR WRITE OF ub.c-cd-grp OLD old_c-cd-grp .
...
define variable vss-description as character no-undo init "Триггер на запись истории группы на кассе".
...
:
  ...
  or (g#news
      and ( g#db-num > 0 )
      and ub.c-cd-grp.corr-user-name = {&nts-user}
