...
TRIGGER PROCEDURE FOR DELETE OF ub.c-PromoCriterion.
...
{ cmp/vssrevis.i }
  ...
  undo, throw new Progress.Lang.AppError(
    substitute(  "&1: Ошибка удаления истории промо-акций [&2]." +
                " Запрещено уделание истории из таблицы c-PromoCriterion [id=&3]",
                 vss-workfile, ub.c-PromoCriterion.idAction, ub.c-PromoCriterion.id  )
  ) .
