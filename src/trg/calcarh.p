...
:
  ...
  /* признак того, что на объекте имеется рассчитанный складской архив по товарам */
  ...
  then do:
    ...
    run day-begin-fact-order in this-procedure
      ...
      ,output v-arh-detail-fact-order /* p-day-begin-fact-order */
      ).

    run doclslib-check-arh-exist in this-procedure
      (input  p-obj-type              /* p-obj-type       */
      ,input  p-obj-code              /* p-obj-code       */
      ,input  v-arh-detail-fact-order /* p-cut-fact-order */
    ...
    then do:
      /* на выбранном объекте уже есть складской архив по товарам */

      /* определяем документы, для которых есть складской архив по товарам */
      ...
      /* считываем дату перерасчета складского архива по товарам */
      ...
      then do:
        ...
        run gbl/d-askw.w
          (input "Вопрос"
          ,input "На объекте уже есть рассчитанный складской архив по товарам" + {&new-line}
          ...
          ,input "Пересчитать складской архив по товарам начиная с даты " +
              ...
              + "Удалить весь складской архив по товарам и рассчитать его на основе документов" + {&new-line}
              + (if v-arh-detail-date <> ?
        ...
        case v-num :
          when 1
          then do:
            /* пересчитать складской архив по товарам начиная с v-last-fact-date */
            run cb-doclslib-log in this-procedure
          ...
          when 3
          then do:
            /* удалить и пересчитать складской архив по товарам */
            assign
  ...
  run utl/arhiscr.p
    ...
    ,input  ""                            /* p-source-type           */
    ,input  ""                            /* p-source-ref            */
    ,input  v-last-fact-date              /* p-source-date           */
  ...
  /* очистка складского архива по товарам, начиная с выбранной даты */
  run cb-doclslib-log in this-procedure
