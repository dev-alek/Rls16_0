...
Триггер на yдаление финансового архива по складским документам
...
TRIGGER PROCEDURE FOR DELETE OF ub.arh-trn-doc-contract .
...
define variable vss-description as character no-undo init "Триггер на yдаление финансового архива по складским документам ".
{ cmp/vssrevis.i " " }
{ cmp/trg-def.i }
...
:
  /*Удаляются и пересчитываются в trndocdl*/
  /*
