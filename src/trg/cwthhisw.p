...
Триггер на запись шапки истории МЦ
...
TRIGGER PROCEDURE FOR WRITE OF ub.c-wth-hist.
...
define variable vss-description as character no-undo init "Триггер на запись шапки истории МЦ".
