...
Триггер на запись атрибута ТРК
...
TRIGGER PROCEDURE FOR WRITE OF ub.pump-attr OLD old-pump-attr.
...
define variable vss-description as character no-undo init "Триггер на запись атрибута ТРК".
{ cmp/vssrevis.i }
{ cmp/trg-def.i  }
{ gbl/cur-time.i }
...
:
  ...
  if not g#news then do:
    run trg/pumpatrh.p ( buffer old-pump-attr, buffer ub.pump-attr ).
  end.
