...
Триггер на удаление записей номеров пакетов новостей, принятых данной БД от других внешних систем.
...
trigger procedure for delete of ub.esys-pck-rcvd .
...
define variable vss-description as character no-undo init "Триггер на удаление записей номеров пакетов новостей, принятых данной БД от других внешних систем.".
{ cmp/vssrevis.i }
{ cmp/trg-def.i  }
