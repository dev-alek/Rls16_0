...
Триггер на запись атрибутов внешней системы
...
TRIGGER PROCEDURE FOR WRITE OF ub.ext-system-attr .
...
define variable vss-description as character no-undo init "Триггер на запись атрибутов внешней системы".
{ cmp/vssrevis.i }
{ cmp/trg-def.i  }
{ bge/esysattr.i }
