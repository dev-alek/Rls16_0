...
удаление записи в логе событий на кассе
...
*/
TRIGGER PROCEDURE FOR DELETE OF cd-event-log.
...
:
   /* историю НЕ пишем */
   define buffer buf_cd-event-log-attr      for cd-event-log-attr .

   FOR EACH buf_cd-event-log-attr
       EXCLUSIVE-LOCK
       :
       DELETE buf_cd-event-log-attr.
   END.

   run nws/cmd-del.p
      ( input "cd-event-log":U
