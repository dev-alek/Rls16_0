...
Удаление истории лицензий продавцов алкогол
...
TRIGGER PROCEDURE FOR WRITE OF ub.c-alc-sale-lic.
...
:
   ...
   run str/callnews.p
      (input "c-alc-sale-lic"
      ,input (buffer ub.c-alc-sale-lic:handle)
      ) no-error .
