...
Триггер на запись user-login-attr
...
TRIGGER PROCEDURE FOR WRITE OF ub.user-login-attr OLD BUFFER old-user-login-attr .
...
define variable vss-description as character no-undo init "Триггер на запись таблицы user-login-attr".
{ cmp/vssrevis.i }
{ cmp/trg-def.i  }
{ gbl/cur-time.i }
