...
Триггер на удаление arh-fin-doc-schet-obj
...
TRIGGER PROCEDURE FOR DELETE OF ub.arh-fin-doc-schet-obj .
...
define variable vss-description as character no-undo init "Триггер на удаление arh-fin-doc-schet-obj".
{ cmp/vssrevis.i }
{ cmp/trg-def.i  }
