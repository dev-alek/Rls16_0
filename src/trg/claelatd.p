...
Триггер на удаление истории атрибута элемента раскладки
...
TRIGGER PROCEDURE FOR DELETE OF ub.c-layout-elem-attr.
...
define variable vss-description as character no-undo init "Триггер на удаление истории атрибута элемента раскладки".
...
:
  ...
  "Нельзя удалять запись ИСТОРИИ АТРИБУТА ЭЛЕМЕНТА РАСКЛАДКИ"
