...
Тригер на корректировку Групп оборотов покупателей для ценообразовани

Автор: Чернова Светлана Александровна
Дата создания: 02/13/06
Author: Svetlana Chernova
Creation date: 02/13/06

*/

TRIGGER PROCEDURE FOR WRITE OF ub.turnover-group OLD old_turnover-group.
...
define variable vss-description as character no-undo init "Тригер на корректировку Групп оборотов покупателей для ценообразовани".
{ cmp/vssrevis.i }
{ cmp/trg-def.i  }
{ gbl/cur-time.i }
...
run cur-time in this-procedure(output v-today, output start-time).
      ...
      assign
        ub.c-turnover-group.chip-num           = next-value (s-corr-chip, {&db-name_schema})
