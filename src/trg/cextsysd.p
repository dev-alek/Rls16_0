...
Триггер на удаление истории внешней системы Open XML.
...
TRIGGER PROCEDURE FOR DELETE OF ub.c-ext-system .
...
define variable vss-description as character no-undo init "Триггер на удаление истории внешней системы Open XML.".
{ cmp/vssrevis.i }
{ cmp/trg-def.i  }
