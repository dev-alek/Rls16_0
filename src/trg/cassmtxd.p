...
Триггер на удаление ассортиментной матрицы истории
...
TRIGGER PROCEDURE FOR delete OF ub.c-assortment-matrix .
...
for each  ub.c-assortment-matrix-goods exclusive-lock where
          ub.c-assortment-matrix-goods.asmt-id = ub.c-assortment-matrix.asmt-id and
          ub.c-assortment-matrix-goods.db-num  = ub.c-assortment-matrix.db-num :
