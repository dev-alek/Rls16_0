...
Триггер на удаление записей маршрутизации во внешнии системы.
...
trigger procedure for delete of ub.esys-route-dump .
...
define variable vss-description as character no-undo init "Триггер на удаление записей маршрутизации во внешнии системы.".
{ cmp/vssrevis.i }
{ cmp/trg-def.i  }
