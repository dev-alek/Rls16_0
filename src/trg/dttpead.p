...
Триггер на удаление атрибутов типов данных для экспорта.
...
TRIGGER PROCEDURE FOR DELETE OF ub.datatype-exp-attr .
...
define variable vss-description as character no-undo init "Триггер на удаление атрибутов типов данных для экспорта.".
{ cmp/vssrevis.i }
{ cmp/trg-def.i  }
