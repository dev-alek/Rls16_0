...
Триггер на запись истории атрибутов партий на объекте
...
TRIGGER PROCEDURE FOR WRITE OF ub.c-parts-obj-attr.
...
define variable vss-description as character no-undo init "Триггер на запись истории атрибутов партий на объекте".
