...
Триггер на удалние истории связки РЕЗЕРВУАР-ТРК-ПИСТОЛЕТ
...
TRIGGER PROCEDURE FOR DELETE OF ub.c-pl-pump-nozzle.
...
define variable vss-description as character no-undo initial "Триггер на удалние истории связки РЕЗЕРВУАР-ТРК-ПИСТОЛЕТ":U.
...
message
  ...
  "Нельзя удалять запись истории связки РЕЗЕРВУАР-ТРК-ПИСТОЛЕТ"
