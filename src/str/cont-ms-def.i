...
Creation date: 08/02/2011
	...
	Last change:  NIA   1 Mar 2011    1:40 pm
*/

&scoped-define vssseq {&sequence}
define variable vss-include-info{&vssseq} as character format "x(65)" no-undo initial "@(#)$Workfile$ $Revision$".

/* Эти константы закладываем в переменные, чтобы использовать в AppBuilder */
...
ASSIGN
   ...
   v-DELIM_CHR_3               = "," /* Убрали  CHR(3) */
   .
/* Для работы с процедурой MS-Contract-EXTENT-3 */
...
FUNCTION Can-Find-Spec RETURN LOGICAL (
   ...
   /*  */
   IF iTmp-Extent3[1] = 2 THEN DO: /* подчиненный договор  */
      ASSIGN
   ...
   END. ELSE DO:
      ASSIGN
         ...
         .
   END.
   /* На всякий случай развязываем Gds-Code  */
...
/*************
  Процедура, очень похожая на функцию
  Возвращает: Extent 3
              [1] - признак договора
              [2] - Host-code
              [3] - Contract-code
