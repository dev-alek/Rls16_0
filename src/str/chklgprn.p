...
$Workfile: chklgprn.p $
$Archive: str/chklgprn.p $

Печать списка товаров чеков из механизма списка чеков в формате Excel
...
&SCOPED-DEFINE UNDERLINE-FRAME-gds ~
      ...
      ~{ rep/dincol.i un 17 for-price-base fill9~} ~
      ~{ rep/dincol.i un 18 for-gds-discnt fill10~} ~
...
&SCOPED-DEFINE underline-gds ~{&PutExcel} ~
      ...
      ~{ rep/dincol.i unx 17 for-price-base fill9~} ~
      ~{ rep/dincol.i unx 18 for-gds-discnt fill10~} ~
