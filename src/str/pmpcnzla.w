...
Просмотр карточки истории изменения соответствия ТРК-пистолет
...
define frame {&FRAME-NAME}
  {&table}.nozzle-code at row  1.25 col 11.00 {&align} {&fill-in} 10.50 by 1.00    label "Пистолет" fgcolor  4
  {&table}.pump-code   at row  2.50 col 11.00 {&align} {&fill-in}  3.50 by 1.00    label "ТРК"      fgcolor  4
  ...
  {&table}.is-meas     at row  5.00 col  2.50          {&toggle}  23.50 by 1.00
  {&table}.status_     at row  6.25 col 11.00 {&align} {&fill-in}  9.50 by 1.00
  {&table}.PS          at row  7.50 col  1.50          {&editor}                no-label            bgcolor 15
...
do on error   undo Main-Block, leave Main-Block
  ...
  assign frame {&FRAME-NAME} :title = substitute(
    ...
    {&table}.pump-code, {&table}.nozzle-code, {&table}.obj-type, {&table}.obj-code, bf_cli.obj-name, p-mode ).

  display {&table}.nozzle-code
          {&table}.pump-code
          {&table}.obj-type
          {&table}.obj-code
          {&table}.is-meas
