...
&Scoped-Define ENABLED-OBJECTS EDITOR-1 Btn_Cancel
...
DEFINE FRAME DIALOG-1
     ...
     Btn_Cancel AT ROW 6.42 COL 7
     SPACE(5.24) SKIP(0.86)
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  do while true:
    ind = ind + 1.
    if ind >= waiting or search(fname) = ? then do:
      /* файл удален */
      return . /* --->>>--- */
    end.
