...
Экран просмотра платежей по складскому документу
...
{ gbl/diasize.i &browse-name=b-fin-doc}
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  ASSIGN FRAME
    {&FRAME-NAME}:TITLE = "Платежи по складскому документу " + pardoc-code.
  FIND FIRST bf_trn-doc WHERE bf_trn-doc.doc-code = pardoc-code NO-LOCK.
  RUN cr-tt-fd IN THIS-PROCEDURE.
  assign
  tt-fd.sum-rubl:label in browse b-fin-doc         = "Сумма платежа ({&abbr_rub})"
