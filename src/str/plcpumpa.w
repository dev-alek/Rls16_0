...
Просмотр карточки истории изменения соответствия ТРК танку
...
define frame {&FRAME-NAME}
  ...
  {&table}.obj-type   at row  3.75 col 11.00 {&align} {&fill-in}  4.50 by 1.00    label "Объект"
  {&table}.obj-code   at row  3.75 col 18.00          {&fill-in} 10.50 by 1.00 no-label
    bf_cli.obj-name   at row  3.75 col 29.00          {&fill-in} 70.00 by 1.00 no-label            fgcolor  4
  {&table}.status_    at row  5.00 col 11.00 {&align} {&fill-in}  9.50 by 1.00
  {&table}.PS         at row  6.50 col  1.50          {&editor}                no-label            bgcolor 15
  bf_goods.gds-name   at row 10.50 col 11.00 {&align} {&fill-in} 49.50 by 1.00    label "Топливо"  fgcolor  4
  bf_pl-gds.status_   at row 10.50 col 63.00          {&fill-in}  9.50 by 1.00                     fgcolor  4
  bf_pl-gds.fact-qnty at row 12.00 col 11.00 {&align} {&fill-in} 16.50 by 1.00    label "Факт"     fgcolor 12
  bf_pl-gds.free-qnty at row 12.00 col 33.00          {&fill-in} 16.50 by 1.00    label "Свободно" fgcolor 12
  bf_pl-gds.tolerance at row 12.00 col 63.00          {&fill-in} 13.50 by 1.00                     fgcolor 12
...
do on error   undo Main-Block, leave Main-Block
  ...
  assign frame {&FRAME-NAME} :title = substitute(
    ...
    {&table}.pump-code, {&table}.pl-code, {&table}.obj-type, {&table}.obj-code, bf_cli.obj-name, p-mode ).
