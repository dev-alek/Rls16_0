...
&if  "{&subject}" = "pay" &then
  run adm/shattri.p (
      ...
      ,input  {&cd-buffer}.obj-code
      ,input  {&attr-cd-type-ibm}
      ,input  {&attr-cd-type-ibm_ibmnalc} /*p-param-code*/
      ,output v-value-character
      ,output v-value-date
      ,output v-value-decimal
      ,output v-value-integer
  ...
  run adm/shattri.p (
      ...
      ,input  {&cd-buffer}.obj-code
      ,input  {&attr-cd-type-ibm}
      ,input  {&attr-cd-type-ibm_multicurr} /*p-param-code*/
      ,output v-value-character
      ,output v-value-date
      ,output v-value-decimal
      ,output v-value-integer
...
run adm/shattri.p (
    ...
    ,input  {&cd-buffer}.obj-code
    ,input  {&attr-cd-type-ibm}
    ,input  {&attr-cd-type-ibm_cdtaxlst} /*p-param-code*/
    ,output v-value-character
    ,output v-value-date
    ,output v-value-decimal
    ,output v-value-integer
...
run adm/shattri.p (
    ...
    ,input  {&cd-buffer}.obj-code
    ,input  {&attr-cd-type-ibm}
    ,input  {&attr-cd-type-ibm_cd-vat} /*p-param-code*/
    ,output v-value-character
    ,output v-value-date
    ,output v-value-decimal
    ,output v-value-integer
