...
define variable vss-workfile    as character no-undo init "$Workfile: e-sjcrdq.p $":U .
define variable vss-archive     as character no-undo init "$Archive: cmp/e-sjcrdq.p $":U .
