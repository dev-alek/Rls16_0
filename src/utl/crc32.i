...
/*------------------------------------------------------------------------
    ...
    Author(s)   : SSlivenko
    Created     : Sun Nov 28 16:29:23 AST 2021
    Notes       :
  ----------------------------------------------------------------------*/
...
(INPUT intOperand1 AS INT64,
 INPUT intOperand2 AS INT64):
    ...
    END.                                              
    RETURN iXOResult.
END . /*End of METHOD BinaryXOR */        

&if "{1}" = "class"
&then
method public INT64 ShiftRight
&else
...
&if "{1}" = "class"
&then
method public INTEGER BinaryAND
&else
...
END . /* End of FUNCTION BinaryAND */

&if "{1}" = "class"
&then
method public CHARACTER intToHex
&else
...
&if "{1}" = "class"
&then
method public INT64 crc32Table
&else
