...
define input parameter p-slt-rate-code      as integer  no-undo.
...
define input parameter par-BarDis           as integer no-undo . /*главный код товара берется из: 1 - артикула, 2 - кода товара */
...
define variable vss-workfile    as character no-undo init "$Workfile: impgdstx.p $":U .
define variable vss-archive     as character no-undo init "$Archive: utl/impgdstx.p $":U .
...
:
            ...
            run ref/goods01.p (
                ...
                , input par-BarDis         /*главный код товара берется из: 1 - артикула, 2 - кода товара */
