...
файл запроса имени файла импорта и запуска некоей прорграммы
...
DEFINE INPUT PARAMETER for-title as char.
DEFINE INPUT PARAMETER for-run as char.
...
define variable vss-description as character no-undo init "запроса имени файла импорта и запуска некоей прорграммы".
{ cmp/vssrevis.i }
{ cmp/showinf.i }
...
&Scoped-Define ENABLED-OBJECTS B-exit b-quit B-Help B-file file-name
...
DEFINE FRAME Dialog-Frame
     ...
     B-file AT ROW 4.71 COL 44.38
     file-name AT ROW 4.75 COL 16.63 COLON-ALIGNED
     SPACE(21.50) SKIP(6.53)
...
DO:
  run value(for-run)(input file-name).
END.
...
ON CHOOSE OF B-file IN FRAME Dialog-Frame /* Btn 1 */
DO:
...
------------------------------------------------------------------------------*/
  ...
  ENABLE B-exit b-quit B-Help B-file file-name
      WITH FRAME Dialog-Frame.
