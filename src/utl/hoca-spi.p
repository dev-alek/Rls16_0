...
define variable vss-workfile    as character no-undo init "$Workfile: hoca-spi.p $":U .
define variable vss-archive     as character no-undo init "$Archive: utl/hoca-spi.p $":U .
