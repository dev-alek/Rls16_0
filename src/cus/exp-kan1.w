...
3  - номер чека по кассе
4  - дата пробития чека в формате ГГГГ-ММ-ДД
5  - время пробития чека в формате ЧЧ:ММ:СС
6  - артикул товара-цвет-размер  (цвет-размер - товар шкальный, шкала 2-х мерная)
7  - количество
8  - продажная цена единицы товара без учета скидки, но включающая налоги НДС и НсП.
9  - ставка НДС в %
10 - ставка НсП в %
11 - сумма скидки на единицу товара
        ...
        if trim(v_os-file) = "" then do:
             message "Не задан файл для экспорта". pause.
              ...
              put stream txt  unformatted
                 "SHOP ID; CASH REGISTER ID; ID NUMBER OF DOCUMENT; DATE; TIME; INDEX-COLOR-SIZE; QUANTITY; PRICE WITHOUT DISCOUNT OF ONE ITEM; VAT IN %; SALES IN %; AMOUNT OF DISCOUNT OF ONE ITEM; TYPE OF PAYMENT; FIDELITY CARD NUMBER"
              skip.
              _chk-doc:
