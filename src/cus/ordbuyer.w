...
Список заказов Покупатель-Объект
...
&scop col-l6  'Факт'
&scop col-l7  'Код'
&scop col-l8  'Покупатель'
&scop col-l9  'Количество'
&scop col-l10 'Сумма в {&abbr_rub}.'
&scop col-l11 '>'


&scop cop-l1   mark-string(recid( buf-po_ord-doc), rid-list)
&scop dyn_cop-l1 substitute('dynamic-function(&1mark-string&1, recid(buf-po_ord-doc), &1&2&1)', ~{&double-quote~}, rid-list)
&scop cop-l2   buf-po_ord-doc.status_
&scop cop-l3   buf-po_ord-doc.flag_
&scop cop-l4   buf-po_ord-doc.doc-code
&scop cop-l5   buf-po_ord-doc.doc-date
&scop cop-l6   buf-po_ord-doc.fact-date
&scop cop-l7   ( buf-po_ord-doc.cli-type +  string(buf-po_ord-doc.cli-code))
&scop cop-l8   buf-po_ord-doc.cli-name
&scop cop-l9   buf-po_ord-doc.qnty
&scop cop-l10  buf-po_ord-doc.sum-rubl
&scop cop-l11  f-direct ( recid( buf-po_ord-doc ))
&scop dyn_cop-l11  substitute('dynamic-function(&1f-direct&1, recid(buf-po_ord-doc))', ~{&double-quote~})
...
&Scoped-define INTERNAL-TABLES buf-po_ord-doc buf-po_ord-doc-rcv ord-chain ~
buf-po_trn-doc

/* Definitions for BROWSE br-docs                                       */
&Scoped-define FIELDS-IN-QUERY-br-docs {&cop-l1} {&cop-l2} {&cop-l3} {&cop-l4} {&cop-l5} {&cop-l6} {&cop-l7} {&cop-l8} {&cop-l9} {&cop-l10} {&cop-l11}
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-docs {&cop-l2}
&Scoped-define SELF-NAME br-docs
&Scoped-define QUERY-STRING-br-docs FOR EACH buf-po_ord-doc NO-LOCK
&Scoped-define OPEN-QUERY-br-docs OPEN QUERY {&SELF-NAME} FOR EACH buf-po_ord-doc NO-LOCK.
&Scoped-define TABLES-IN-QUERY-br-docs buf-po_ord-doc
&Scoped-define FIRST-TABLE-IN-QUERY-br-docs buf-po_ord-doc


/* Definitions for BROWSE br-zapr                                       */
&Scoped-define FIELDS-IN-QUERY-br-zapr buf-po_trn-doc.doc-code buf-po_trn-doc.doc-type buf-po_trn-doc.status_ buf-po_trn-doc.flag_ buf-po_trn-doc.cli-type + string(buf-po_trn-doc.cli-code) buf-po_trn-doc.obj-type + string(buf-po_trn-doc.obj-code) buf-po_trn-doc.doc-date buf-po_trn-doc.fact-date buf-po_trn-doc.tot-lines buf-po_trn-doc.fact-qnty buf-po_trn-doc.tot-rubl /* buf-po_trn-doc.out-code */
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-zapr
&Scoped-define SELF-NAME br-zapr
&Scoped-define QUERY-STRING-br-zapr FOR EACH buf-po_ord-doc-rcv WHERE                   buf-po_ord-doc-rcv.doc-code = buf-po_ord-doc.doc-code NO-LOCK, ~
         each ub.ord-chain no-lock where             ub.ord-chain.doc-code = buf-po_ord-doc-rcv.rcv-code and             ub.ord-chain.doc-type = 'rcv'                  and             ub.ord-chain.rel-doc-type = 'trn'             , ~
              EACH buf-po_trn-doc  where            buf-po_trn-doc.doc-code = ub.ord-chain.rel-doc-code  NO-LOCK
&Scoped-define OPEN-QUERY-br-zapr OPEN QUERY br-zapr FOR EACH buf-po_ord-doc-rcv WHERE                   buf-po_ord-doc-rcv.doc-code = buf-po_ord-doc.doc-code NO-LOCK, ~
         each ub.ord-chain no-lock where             ub.ord-chain.doc-code = buf-po_ord-doc-rcv.rcv-code and             ub.ord-chain.doc-type = 'rcv'                  and             ub.ord-chain.rel-doc-type = 'trn'             , ~
              EACH buf-po_trn-doc  where            buf-po_trn-doc.doc-code = ub.ord-chain.rel-doc-code  NO-LOCK.
&Scoped-define TABLES-IN-QUERY-br-zapr buf-po_ord-doc-rcv ub.ord-chain ~
buf-po_trn-doc
&Scoped-define FIRST-TABLE-IN-QUERY-br-zapr buf-po_ord-doc-rcv
&Scoped-define SECOND-TABLE-IN-QUERY-br-zapr ub.ord-chain
&Scoped-define THIRD-TABLE-IN-QUERY-br-zapr buf-po_trn-doc
...
&Scoped-Define ENABLED-OBJECTS b-quit b-sel b-history b-sch b-move-to ~
b-help b-mark b-add b-lkp b-chg b-del b-open b-close b-move b-print ~
sch-code sch-date sch-fact br-docs B-lkp-2 br-zapr sch-num loc-boss ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-docs Dialog-Frame _FREEFORM
  QUERY br-docs NO-LOCK DISPLAY
      ...
      {&cop-l7} COLUMN-LABEL {&col-l7} format "x(12)"
      {&cop-l8} COLUMN-LABEL {&col-l8} format "x(20)"
      {&cop-l9} COLUMN-LABEL {&col-l9}
      {&cop-l10} COLUMN-LABEL {&col-l10}
      {&cop-l11} COLUMN-LABEL {&col-l11} format "x(1)"
  ENABLE
       {&cop-l2}
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-zapr Dialog-Frame _FREEFORM
  QUERY br-zapr NO-LOCK DISPLAY
      ...
      buf-po_trn-doc.tot-rubl  COLUMN-LABEL "Сумма {&abbr_rub}." FORMAT ">>>>>>>>>9.99"
      /* buf-po_trn-doc.out-code */
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: buf-po_ord-doc B "NEW SHARED" ? ub ord-doc
      TABLE: buf-po_ord-doc-rcv B "?" ? ub ord-doc-rcv
      TABLE: buf-po_trn-doc B "?" ? ub trn-doc
   END-TABLES.
 */
...
/* Query rebuild information for BROWSE br-docs
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH buf-po_ord-doc NO-LOCK.
     _END_FREEFORM
...
/* Query rebuild information for BROWSE br-zapr
     _START_FREEFORM
OPEN QUERY br-zapr FOR EACH buf-po_ord-doc-rcv WHERE
                  buf-po_ord-doc-rcv.doc-code = buf-po_ord-doc.doc-code NO-LOCK,
  each ub.ord-chain no-lock where
            ub.ord-chain.doc-code = buf-po_ord-doc-rcv.rcv-code and
            ub.ord-chain.doc-type = 'rcv'                  and
            ub.ord-chain.rel-doc-type = 'trn'
            ,

      EACH buf-po_trn-doc  where
           buf-po_trn-doc.doc-code = ub.ord-chain.rel-doc-code  NO-LOCK.
     _END_FREEFORM
     _Options          = "NO-LOCK"
     _Where[1]         = "buf-po_ord-doc-rcv.doc-code = buf-po_ord-doc.doc-code"
     _JoinCode[2]      = "buf-po_ord-doc-rcv.doc-code = buf-po_ord-doc.doc-code"
     _Query            is OPENED
*/  /* BROWSE br-zapr */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Список заказов ПО */
DO:
...
do on stop undo, return no-apply :
  find current buf-po_ord-doc exclusive-lock .  /* сетевая проверка */
end.

 define variable rr as recid no-undo .

 /* todo - добавить проверку права */

 if not available buf-po_ord-doc then return.
   if not( buf-po_ord-doc.status_ = {&g___new} and buf-po_ord-doc.flag_ = false ) then do:
...
DO:
 ...
 message "Закрыть внутренний запрос ?"
  ...
  if not (buf-po_trn-doc.status_  = {&inquiry}   ) then do:
...
if available buf-po_ord-doc then do:
    { gbl/markstrn.i buf-po_ord-doc rid-list }
...
if not( buf-po_ord-doc.status_ = {&g___new}  and
 ...
 if v-cntxt-db-num = 0 and buf-po_ord-doc.order-type = {&order-type-ubd} then do:
        Message
 ...
 if v-cntxt-db-num <> 0 and buf-po_ord-doc.order-type = {&order-type-gbd} then do:
        Message
    ...
    message "Перенаправить распределение заказа в другую БД по СПН ?"
        ...
        if g-log = true then do:
            ...
            if v-cntxt-db-num = 0 then do:
               buf-po_ord-doc.order-type = {&order-type-ubd} .
            end.
            else do:
               buf-po_ord-doc.order-type = {&order-type-gbd} .
            end.
        end.
  apply "VALUE-CHANGED" TO BR-docs IN FRAME Dialog-Frame.
  apply "entry" TO BR-docs IN FRAME Dialog-Frame.
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  hide b-move b-move-to in frame {&frame-name} .
...
&scop flt-open-open-query OPEN QUERY br-docs FOR EACH buf-po_ord-doc

&scop flt-open-dyn_open-query  FOR EACH buf-po_ord-doc

&scop flt-open-query-handle query br-docs:handle

&scop flt-open-find-buffer-name buf-po_ord-doc
...
&scop flt-open-table-name buf-po_ord-doc
...
&scop flt-open-find-buffer-def define buffer buf-po_ord-doc for ord-doc.
...
filter-point = filter-point0 + par-mode.
  ...
  CASE par-mode :
    WHEN {&obj} THEN DO:
      ...
      { gbl/fltopend.i
        &where-cond = " buf-po_ord-doc.host-code = par-host-code and buf-po_ord-doc.obj-code = p-obj-code and buf-po_ord-doc.obj-type = p-obj-type and buf-po_ord-doc.doc-type = p-doc-type"
        &dyn_where-cond = " substitute(' buf-po_ord-doc.host-code = &2 and buf-po_ord-doc.obj-code = &3 and buf-po_ord-doc.obj-type = &1&4&1 and buf-po_ord-doc.doc-type = &1&5&1  ' , ~{&double-quote~} , par-host-code , p-obj-code , p-obj-type , p-doc-type) "
    ...
    WHEN "status":U THEN DO:
      ...
      { gbl/fltopend.i
        &where-cond = " buf-po_ord-doc.host-code = par-host-code and buf-po_ord-doc.obj-code = p-obj-code and buf-po_ord-doc.obj-type = p-obj-type and buf-po_ord-doc.doc-type = p-doc-type  and buf-po_ord-doc.status_= p-status_"
        &dyn_where-cond = " substitute(' buf-po_ord-doc.host-code = &2 and buf-po_ord-doc.obj-code = &3 and buf-po_ord-doc.obj-type = &1&4&1 and buf-po_ord-doc.doc-type = &1&5&1  and buf-po_ord-doc.status_ = &1&6&1 ' , ~{&double-quote~} , par-host-code , p-obj-code , p-obj-type , p-doc-type , p-status_) "
...
if  buf-po_ord-doc.status_ = {&fact}  then do:
