...
define variable vss-workfile    as character no-undo init "$Workfile: g-ost-bd.p $":U .
define variable vss-archive     as character no-undo init "$Archive: cus/g-ost-bd.p $":U .
