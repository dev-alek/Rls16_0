...
define variable vss-workfile    as character no-undo init "$Workfile: g-autocu.p $":U .
define variable vss-archive     as character no-undo init "$Archive: cus/g-autocu.p $":U .
