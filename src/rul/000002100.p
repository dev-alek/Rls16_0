/*------------------------------------------------------------------------
    ...
    Description : Экспорт price-doc 1C ERP RN
...
using ibs.th.bge.1crn.subjects.check-fuel-docs from propath.
...
procedure proc-main :
  ...
  do
    ...
    do:
      ...
      v-doc-num  = v-newbh:buffer-field("rvs-code"):buffer-value.
    end.
    else 
    do:
      /*    v-price-doc-obj-type = v-oldbh::obj-type.*/
      /*    v-price-doc-obj-code = v-oldbh::obj-code.*/
      v-doc-num  = v-oldbh:buffer-field("rvs-code"):buffer-value.
    end.
...
procedure load-ruleset-context :
  ...
  do
    ...
    case p-ruleset-id:
      when {&edoc-proc_18_event_rvs-doc_135} then 
        do:
          if v-has-newbh
            and v-newbh:table <> {&table_rvs-doc} then 
          do:
