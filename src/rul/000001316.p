...
/* ------------------------- &end-hn-option -----------------------------------*/
  ...
  On error undo _d-card, retry _d-card:
    ...
    /* ------------------------- &start-rule& -----------------------------------*/
/* Сумма накоплений -> % скидки на товар
...
_1316:
do:
                                                                      /* Salience 0 rule_id 1316*/
/* define variable Card1 as class Dis-card_ no-undo .*/
                                                                      /* Salience 1 rule_id 1316*/
/* define variable v-netto-sum1 as  decimal no-undo .*/
                                                                      /* salience 2 rule_id 1316*/
IF  Card1:find_dis-card_( INPUT v-current-d-card) = true  THEN do:   
                                                                      /* Salience 3 rule_id 1316*/
 v-netto-sum1 = 0 .
/* salience 4 in upper-rule-id 1316*/
  _1318:
  do:
                                                                      /* salience 0 rule_id 1318*/
  IF  Card1:emitent-host-code = 0  THEN do:   
/* salience 1 in upper-rule-id 1318*/
    _1320:
    do:
                                                                      /* Salience 0 rule_id 1320*/
/*     define variable Tot-sum1 as class Dis-tot_ no-undo .*/
                                                                      /* salience 1 rule_id 1320*/
    IF  Tot-sum1:find_dis-tot_( INPUT v-current-d-card) = true  THEN do:   
/* salience 2 in upper-rule-id 1320*/
      _1319:
      do:
                                                                      /* salience 0 rule_id 1319*/
      IF  p-r-b = "rubl" AND p-is-over = false  THEN do:   
/* salience 1 in upper-rule-id 1319*/
        _1324:
        do:
                                                                      /* Salience 0 rule_id 1324*/
         v-netto-sum1 = Tot-sum1:pay-tot-rubl .

        end. /*of rule 1324*/
      end. /*of rule 1324*/
                                                                      /* salience 2 rule_id 1319*/
      IF  p-r-b = "rubl" AND p-is-over = true  THEN do:   
/* salience 3 in upper-rule-id 1319*/
        _1325:
        do:
                                                                      /* Salience 0 rule_id 1325*/
         v-netto-sum1 = Tot-sum1:pay-tot-rubl_byf# .

        end. /*of rule 1325*/
      end. /*of rule 1325*/
                                                                      /* salience 4 rule_id 1319*/
      IF  p-r-b = "base" AND p-is-over = false  THEN do:   
/* salience 5 in upper-rule-id 1319*/
        _1326:
        do:
                                                                      /* Salience 0 rule_id 1326*/
         v-netto-sum1 = Tot-sum1:pay-tot-base .

        end. /*of rule 1326*/
      end. /*of rule 1326*/
                                                                      /* salience 6 rule_id 1319*/
      IF  p-r-b = "base" AND p-is-over = true  THEN do:   
/* salience 7 in upper-rule-id 1319*/
        _1328:
        do:
                                                                      /* Salience 0 rule_id 1328*/
         v-netto-sum1 = Tot-sum1:pay-tot-base_byf# .
                                                                      ...
                                                                      /* salience 2 rule_id 1318*/
  IF  Card1:emitent-host-code > 0  THEN do:   
/* salience 3 in upper-rule-id 1318*/
    _1317:
    do:
                                                                      /* Salience 0 rule_id 1317*/
/*     define variable Tot-sum-host1 as class Dis-tot_host no-undo .*/
                                                                      /* salience 1 rule_id 1317*/
    IF  Tot-sum-host1:find_dis-tot_host( INPUT v-current-d-card, INPUT ( Card1:emitent-host-code )) = true  THEN do:   
/* salience 2 in upper-rule-id 1317*/
      _1322:
      do:
                                                                      /* salience 0 rule_id 1322*/
      IF  p-r-b = "rubl" AND p-is-over = false  THEN do:   
/* salience 1 in upper-rule-id 1322*/
        _1327:
        do:
                                                                      /* Salience 0 rule_id 1327*/
         v-netto-sum1 = Tot-sum-host1:pay-tot-rubl .

        end. /*of rule 1327*/
      end. /*of rule 1327*/
                                                                      /* salience 2 rule_id 1322*/
      IF  p-r-b = "rubl" AND p-is-over = true  THEN do:   
/* salience 3 in upper-rule-id 1322*/
        _1321:
        do:
                                                                      /* Salience 0 rule_id 1321*/
         v-netto-sum1 = Tot-sum-host1:pay-tot-rubl_byf# .

        end. /*of rule 1321*/
      end. /*of rule 1321*/
                                                                      /* salience 4 rule_id 1322*/
      IF  p-r-b = "base" AND p-is-over = false  THEN do:   
/* salience 5 in upper-rule-id 1322*/
        _1329:
        do:
                                                                      /* Salience 0 rule_id 1329*/
         v-netto-sum1 = Tot-sum-host1:pay-tot-base .

        end. /*of rule 1329*/
      end. /*of rule 1329*/
                                                                      /* salience 6 rule_id 1322*/
      IF  p-r-b = "base" AND p-is-over = true  THEN do:   
/* salience 7 in upper-rule-id 1322*/
        _1323:
        do:
                                                                      /* Salience 0 rule_id 1323*/
