...
Задание и просмотр параметров вызова правил - ШАБЛОН ДЛЯ ВСЕХ ПРОФАЙЛОВ типа REP
...
/*
custom-par = ВАШИ СОБСТВЕННЫЕ ПАРАМЕТРЫ + {&comma-char} + custom-par.

дальше идет вызов d-report.w с ВАШЕЙ формой

параметры элементов задания отчета на первой закладке устанавлеиваете так, как Вам надо!!!!

run rep/d-report.w
    ( input parparentproc      /* 0 */
    , input 'rep/e-your.w'   /* 1 */
    , input "ТВОЙ ОТЧЕТ"   /* 2 */
    , input 0                  /* 3 date  */
    , input ""                 /* 4  товары*/
    , input ""                 /* 5 */
