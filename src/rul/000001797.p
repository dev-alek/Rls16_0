...
Card1 = new Dis-card_{&constructor_1} .
 define variable Payment-sums as class Dis-card-payment_host no-undo .
...
Payment-sums = new Dis-card-payment_host{&constructor_1} .
...
/* ------------------------- &end-hn-option -----------------------------------*/
  ...
  On error undo _d-card, retry _d-card:
    ...
    /* ------------------------- &start-rule& -----------------------------------*/
/* Зачисление платежа на ДК
 */

_1797:
do:
                                                                      /* Salience 0 rule_id 1797*/
/* define variable Card1 as class Dis-card_ no-undo .*/
                                                                      /* Salience 1 rule_id 1797*/
/* define variable Tot1 as class Dis-tot_ no-undo .*/
                                                                      /* Salience 2 rule_id 1797*/
/* define variable Tot-firm1 as class Dis-tot_host no-undo .*/
                                                                      /* Salience 3 rule_id 1797*/
/* define variable Payment-sums as class Dis-card-payment_host no-undo .*/
                                                                      /* Salience 4 rule_id 1797*/
 Payment-sums:find_dis-card-payment_host( INPUT v-current-d-card) .
                                                                      /* salience 6 rule_id 1797*/
IF  Card1:find_dis-card_( INPUT v-current-d-card) = true  THEN do:   
/* salience 7 in upper-rule-id 1797*/
  _1799:
  do:
                                                                      /* salience 0 rule_id 1799*/
  IF  Tot-firm1:find_dis-tot_host( INPUT v-current-d-card, INPUT v-current-host-code) = false  THEN do:   
/* salience 1 in upper-rule-id 1799*/
    _1801:
    do:
                                                                      /* salience 0 rule_id 1801*/
    IF  Tot-firm1:create_dis-tot_host( INPUT v-current-d-card, INPUT v-current-host-code) = false  THEN do:   
/* salience 1 in upper-rule-id 1801*/
      _1802:
      do:
                                                                      /* Salience 0 rule_id 1802*/
       undo _main, return error v-last-error-message .
                                                                      ...
                                                                      /* Salience 2 rule_id 1799*/
   Tot-firm1:pay-tot-base = Tot-firm1:pay-tot-base + Payment-sums:pay-tot-base .
                                                                      /* Salience 3 rule_id 1799*/
   Tot-firm1:pay-tot-rubl = Tot-firm1:pay-tot-rubl + Payment-sums:pay-tot-rubl .
                                                                      /* salience 4 rule_id 1799*/
  IF  Tot-firm1:dis-tot_hostsave( ) = false  THEN do:   
/* salience 5 in upper-rule-id 1799*/
    _1803:
    do:
                                                                      /* Salience 0 rule_id 1803*/
     undo _main, return error v-last-error-message .

    end. /*of rule 1803*/
  end. /*of rule 1803*/
                                                                      /* salience 6 rule_id 1799*/
  IF  Tot1:find_dis-tot_( INPUT v-current-d-card) = false  THEN do:   
/* salience 7 in upper-rule-id 1799*/
    _1798:
    do:
                                                                      /* salience 0 rule_id 1798*/
    IF  Tot1:create_dis-tot_( INPUT v-current-d-card) = false  THEN do:   
/* salience 1 in upper-rule-id 1798*/
      _1800:
      do:
                                                                      /* Salience 0 rule_id 1800*/
       undo _main, return error v-last-error-message .
                                                                      ...
                                                                      /* Salience 8 rule_id 1799*/
   Tot1:pay-tot-base = Tot1:pay-tot-base + Payment-sums:pay-tot-base .
                                                                      /* Salience 9 rule_id 1799*/
   Tot1:pay-tot-rubl = Tot1:pay-tot-rubl + Payment-sums:pay-tot-rubl .
                                                                      /* salience 10 rule_id 1799*/
  IF  Tot1:dis-tot_save( ) = false  THEN do:   
/* salience 11 in upper-rule-id 1799*/
    _1804:
    do:
                                                                      /* Salience 0 rule_id 1804*/
     undo _main, return error v-last-error-message .
...
&scop release_1 release_ ( )
Payment-sums:Dis-card-payment_host{&release_1} .
