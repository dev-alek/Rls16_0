...
Задание и просмотр параметров вызова правил - профайл 71
...
define variable vss-description as character no-undo init "Задание и просмотр параметров вызова правил - профайл 71".
{ cmp/vssrevis.i }
{ cmp/str-glbl.i }
{ rul/calldscr.i }
{ gbl/key-rec.i }
...
custom-par = "all,{&Excel-yes}"  + {&comma-char} +
...
run rep/d-report.w
    ...
    , input 'rep/e-cashbk.w'   /* 1 */
    , input "Кассовая книга (Отчет кассира)":U
