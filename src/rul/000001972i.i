...
Дата создания: 08/16/08
Author: Bakhtadze Natalya
Creation date: 08/16/08
...
then  do:
  ...
  v-bh[{&chk-discnt}]:buffer-field("line-num"):buffer-value = (if buf_temp-discnt-role.table-name = {&table_dis-gds-rule}
                                                              ...
                                                              else v-bh[{&chk-context}]:buffer-field("lng"):buffer-value)
  ...
  v-bh[{&chk-discnt}]:buffer-field("object-line-num"):buffer-value = (if buf_temp-discnt-role.table-name = {&table_dis-gds-rule}
                                                                      then v-bh[{&chk-gds}]:buffer-field("line-num"):buffer-value
                                                                      else v-bh[{&chk-context}]:buffer-field("lnd"):buffer-value
                                                                      )
  ...
  v-bh[{&chk-discnt}]:buffer-field("object-sum"):buffer-value = (if buf_temp-discnt-role.table-name = {&table_dis-gds-rule}
                                                                 ...
                                                                 else v-bh[{&chk-context}]:buffer-field("st-for-discnt-r-b"):buffer-value)
  .
  /*
  ...
  */
  ...
  if v-bh[{&chk-discnt}]:buffer-field("line-type"):buffer-value = integer({&discnt-sub-total}) then do:
    assign
    v-discnt = v-bh[{&chk-discnt}]:buffer-field("discnt-value-abs"):buffer-value
