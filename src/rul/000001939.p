...
/* ------------------------- &end-hn-option -----------------------------------*/
  ...
  On error undo _d-card, retry _d-card:
    ...
    /* ------------------------- &start-rule& -----------------------------------*/
/* Маршрутизация сумм по ДК по продаже/внешней накладной во внешнюю  систему
Маршрутизируемые данные удовлетворяют схеме exe/sale-card-doc-ds.xsd */

_1939:
do:
                                                                      /* Salience 0 rule_id 1939*/
/* define variable Card1 as class Dis-card_ no-undo .*/
                                                                      /* Salience 1 rule_id 1939*/
/* define variable ExpData1 as class Route-data_ no-undo .*/
                                                                      /* Salience 2 rule_id 1939*/
/* define variable Sale-sums as class Dis-card-sale_obj no-undo .*/
                                                                      /* salience 3 rule_id 1939*/
IF  num-rec = 1  THEN do:   
/* salience 4 in upper-rule-id 1939*/
  _1940:
  do:
                                                                      /* salience 0 rule_id 1940*/
  IF  v-current-doc-type <> {&hn-source-trn-doc}  THEN do:   
/* salience 1 in upper-rule-id 1940*/
    _1941:
    do:
                                                                      /* Salience 0 rule_id 1941*/
     leave _1939 .

    end. /*of rule 1941*/
  end. /*of rule 1941*/
                                                                      /* salience 2 rule_id 1940*/
  IF  ExpData1:route-data_read-xmlschema( INPUT p-xsd-file) = false  THEN do:   
/* salience 3 in upper-rule-id 1940*/
    _1943:
    do:
                                                                      /* Salience 0 rule_id 1943*/
     undo _main, return error v-last-error-message .

    end. /*of rule 1943*/
  end. /*of rule 1943*/
                                                                      /* salience 4 rule_id 1940*/
...
/* salience 5 in upper-rule-id 1940*/
    _1942:
    do:
                                                                      /* Salience 0 rule_id 1942*/
     undo _main, return error v-last-error-message .

    end. /*of rule 1942*/
  end. /*of rule 1942*/
                                                                      /* Salience 6 rule_id 1940*/
   ExpData1:route-data_create-record( INPUT "sale-card-doc") .
                                                                      /* Salience 7 rule_id 1940*/
   ExpData1:route-data_copy-field( INPUT "sale-card-doc", INPUT "sale-doc", INPUT  Sale-sums:get_dis-card-sale_obj_field( INPUT "sale-doc") ) .
                                                                      /* Salience 8 rule_id 1940*/
   ExpData1:route-data_copy-field( INPUT "sale-card-doc", INPUT "sale-type", INPUT  Sale-sums:get_dis-card-sale_obj_field( INPUT "sale-type") ) .
                                                                      /* Salience 9 rule_id 1940*/
   ExpData1:route-data_copy-field( INPUT "sale-card-doc", INPUT "sale-date", INPUT  Sale-sums:get_dis-card-sale_obj_field( INPUT "doc-date") ) .
                                                                      /* Salience 10 rule_id 1940*/
   ExpData1:route-data_copy-field( INPUT "sale-card-doc", INPUT "obj-type", INPUT  Sale-sums:get_dis-card-sale_obj_field( INPUT "obj-type") ) .
                                                                      /* Salience 11 rule_id 1940*/
   ExpData1:route-data_copy-field( INPUT "sale-card-doc", INPUT "obj-code", INPUT  Sale-sums:get_dis-card-sale_obj_field( INPUT "obj-code") ) .
                                                                      /* Salience 12 rule_id 1940*/
   ExpData1:route-data_copy-field( INPUT "sale-card-doc", INPUT "action", INPUT  Sale-sums:get_dis-card-sale_obj_field( INPUT "action") ) .
                                                                      /* salience 13 rule_id 1940*/
  IF  ExpData1:esys-add-dump( INPUT "sale-card-doc", INPUT v-esys-cmd-proc-handle, INPUT v-esys-cmd-code, '+update') = false  THEN do:   
/* salience 14 in upper-rule-id 1940*/
    _1948:
    do:
                                                                      /* Salience 0 rule_id 1948*/
     undo _main, return error v-last-error-message .
                                                                      ...
                                                                      /* salience 5 rule_id 1939*/
IF  Card1:find_dis-card_( INPUT v-current-d-card) = true  THEN do:   
/* salience 6 in upper-rule-id 1939*/
  _1944:
  do:
                                                                      /* Salience 0 rule_id 1944*/
   Sale-sums:find_dis-card-sale_obj( INPUT v-current-d-card) .
                                                                      /* Salience 1 rule_id 1944*/
   ExpData1:route-data_create-record( INPUT "sale-card-line") .
                                                                      /* Salience 3 rule_id 1944*/
   ExpData1:route-data_copy-record( INPUT "sale-card-line", INPUT  Sale-sums:get_dis-card-sale_obj() ) .
                                                                      /* salience 4 rule_id 1944*/
  IF  ExpData1:esys-add-dump( INPUT "sale-card-line", INPUT v-esys-cmd-proc-handle, INPUT v-esys-cmd-code, '+update') = false  THEN do:   
/* salience 5 in upper-rule-id 1944*/
    _1945:
    do:
                                                                      /* Salience 0 rule_id 1945*/
     undo _main, return error v-last-error-message .
                                                                      ...
                                                                      /* salience 7 rule_id 1939*/
IF  (last(temp-d-card.d-card)) = true  THEN do:   
/* salience 8 in upper-rule-id 1939*/
  _1946:
  do:
                                                                      /* salience 0 rule_id 1946*/
...
/* salience 1 in upper-rule-id 1946*/
    _1947:
    do:
                                                                      /* Salience 0 rule_id 1947*/
     undo _main, return error v-last-error-message .
