...
Задание и просмотр параметров вызова правил для профайла 4
...
define variable vss-description as character no-undo init "Задание и просмотр параметров вызова правил для профайла 4".
{ cmp/vssrevis.i }
{ gbl/waitfram.i }
{ cmp/str-glbl.i }
{ cmp/showinf.i }
...
DEFINE VARIABLE f-rule-num AS INTEGER FORMAT ">>>>>>9":U INITIAL 0
     LABEL "Правило зависимости СУММА НАКОПЛЕНИЙ  -> КАТЕГОРИЯ ДК"
     VIEW-AS FILL-IN
...
substitute("Параметры Простого прогрессивного алгоритма зависимости Сумма накоплений -> категория скидки ДК (профайл &1)", p-profile-id).
