...
/* ------------------------- &end-hn-option& -----------------------------------*/
  ...
  :
    ...
    ExpData1:route-data_copy-field-character( INPUT "doc_line", "Comment", INPUT  "" /*в ord-dtl-rcv.ps нету*/ ) .
    ExpData1:route-data_copy-field-character( INPUT "doc_line", "SN", INPUT  "" /*в ord-dtl-rcv сер номеров нету*/ ) .
...
:
  ...
  or ( v-direction = {&close-doc} + {&delim-par} + "from" ) /*закрытие заказа\поставки на факт - удаление документа*/
  then do:
