...
Задание и просмотр параметров вызова правил для профайла 8
...
&scop rule-sale-in  1557
&scop rule-sale-out 1557
&scop rule-trn-in   1557
&scop rule-trn-out  1557
&scop rule-recalc   1557
...
DEFINE VARIABLE f-prev-rule-num AS INTEGER FORMAT ">>>>>>9":U INITIAL 0
     LABEL "Правило зависимости СУММА НАКОПЛЕНИЙ  -> % СКИДКИ на итог в  пред. периоде"
     VIEW-AS FILL-IN
...
substitute("Параметры Интервального Алгоритма зависимости Сумма накоплений -> % скидки на итог с обнул. итогов пересч-м по пред. пер-ду и снижением по 1(профайл &1)", p-profile-id).
