...
Sale-sums = new Dis-card-sale_obj{&constructor_1} .
 define variable Tot-period-firm1 as class Dis-tot_host no-undo .
...
Tot-period-firm1 = new Dis-tot_host{&constructor_1} .
 define variable Tot-period1 as class Dis-tot_ no-undo .
&scop constructor_1 ( input parparentproc, input p-parent-handle, input p-log-handle, input this-procedure:handle, input p-cont-handle, input v-current-lock, input v-current-wait, input v-save, input 5)
Tot-period1 = new Dis-tot_{&constructor_1} .
...
_1361:
do:
                                                                      /* Salience 0 rule_id 1361*/
/* define variable Card1 as class Dis-card_ no-undo .*/
                                                                      /* salience 1 rule_id 1361*/
IF  get_current_sum-id_by-date( INPUT v-current-doc-date, INPUT p-caller-id) = "?"  THEN do:   
/* salience 2 in upper-rule-id 1361*/
  _1362:
  do:
                                                                      /* Salience 0 rule_id 1362*/
   leave _1361 .

  end. /*of rule 1362*/
end. /*of rule 1362*/
                                                                      /* salience 3 rule_id 1361*/
IF  Card1:find_dis-card_( INPUT v-current-d-card) = true  THEN do:   
/* salience 4 in upper-rule-id 1361*/
  _1364:
  do:
                                                                      /* Salience 0 rule_id 1364*/
/*   define variable Tot-period-firm1 as class Dis-tot_host no-undo .*/
                                                                      /* salience 1 rule_id 1364*/
  IF  Tot-period-firm1:find_dis-tot_host_date( INPUT v-current-d-card, INPUT v-current-host-code, INPUT v-current-doc-date, INPUT p-caller-id) = false  THEN do:   
/* salience 2 in upper-rule-id 1364*/
    _1363:
    do:
                                                                      /* salience 1 rule_id 1363*/
    IF  Tot-period-firm1:create_dis-tot_host_date( INPUT v-current-d-card, INPUT v-current-host-code, INPUT v-current-doc-date, INPUT p-caller-id) = false  THEN do:   
/* salience 2 in upper-rule-id 1363*/
      _1366:
      do:
                                                                      /* Salience 0 rule_id 1366*/
       undo _main, return error v-last-error-message .
                                                                      ...
                                                                      /* Salience 3 rule_id 1364*/
/*   define variable Sale-sums as class Dis-card-sale_obj no-undo .*/
                                                                      /* Salience 4 rule_id 1364*/
   Sale-sums:find_dis-card-sale_obj( INPUT v-current-d-card) .
                                                                      /* Salience 5 rule_id 1364*/
   Tot-period-firm1:gds-tot-base = Tot-period-firm1:gds-tot-base + Sale-sums:gds-tot-base .
                                                                      /* Salience 6 rule_id 1364*/
   Tot-period-firm1:gds-tot-rubl = Tot-period-firm1:gds-tot-rubl + Sale-sums:gds-tot-rubl .
                                                                      /* Salience 7 rule_id 1364*/
   Tot-period-firm1:gds-dis-base = Tot-period-firm1:gds-dis-base + Sale-sums:gds-dis-base .
                                                                      /* Salience 8 rule_id 1364*/
   Tot-period-firm1:gds-dis-rubl = Tot-period-firm1:gds-dis-rubl + Sale-sums:gds-dis-rubl .
                                                                      /* Salience 9 rule_id 1364*/
   Tot-period-firm1:pay-tot-base = Tot-period-firm1:pay-tot-base + Sale-sums:pay-tot-base .
                                                                      /* Salience 10 rule_id 1364*/
   Tot-period-firm1:pay-tot-rubl = Tot-period-firm1:pay-tot-rubl + Sale-sums:pay-tot-rubl .
                                                                      /* Salience 11 rule_id 1364*/
   Tot-period-firm1:num-chk = Tot-period-firm1:num-chk + Sale-sums:num-chk .
                                                                      /* Salience 12 rule_id 1364*/
/*   define variable Tot-period1 as class Dis-tot_ no-undo .*/
                                                                      /* salience 13 rule_id 1364*/
  IF  Tot-period1:find_dis-tot_date( INPUT v-current-d-card, INPUT v-current-doc-date, INPUT p-caller-id) = false  THEN do:   
/* salience 14 in upper-rule-id 1364*/
    _1365:
    do:
                                                                      /* salience 1 rule_id 1365*/
    IF  Tot-period1:create_dis-tot_date( INPUT v-current-d-card, INPUT v-current-doc-date, INPUT p-caller-id) = false  THEN do:   
/* salience 2 in upper-rule-id 1365*/
      _1367:
      do:
                                                                      /* Salience 0 rule_id 1367*/
       undo _main, return error v-last-error-message .
                                                                      ...
                                                                      /* Salience 15 rule_id 1364*/
   Tot-period1:gds-tot-base = Tot-period1:gds-tot-base + Sale-sums:gds-tot-base .
                                                                      /* Salience 16 rule_id 1364*/
   Tot-period1:gds-tot-rubl = Tot-period1:gds-tot-rubl + Sale-sums:gds-tot-rubl .
                                                                      /* Salience 17 rule_id 1364*/
   Tot-period1:gds-dis-base = Tot-period1:gds-dis-base + Sale-sums:gds-dis-base .
                                                                      /* Salience 18 rule_id 1364*/
   Tot-period1:gds-dis-rubl = Tot-period1:gds-dis-rubl + Sale-sums:gds-dis-rubl .
                                                                      /* Salience 19 rule_id 1364*/
   Tot-period1:pay-tot-base = Tot-period1:pay-tot-base + Sale-sums:pay-tot-base .
                                                                      /* Salience 20 rule_id 1364*/
   Tot-period1:pay-tot-rubl = Tot-period1:pay-tot-rubl + Sale-sums:pay-tot-rubl .
                                                                      /* Salience 21 rule_id 1364*/
   Tot-period1:num-chk = Tot-period1:num-chk + Sale-sums:num-chk .
                                                                      /* salience 22 rule_id 1364*/
  IF  Tot-period-firm1:dis-tot_hostsave( ) = false  THEN do:   
/* salience 23 in upper-rule-id 1364*/
    _1368:
    do:
                                                                      /* Salience 0 rule_id 1368*/
     undo _main, return error v-last-error-message .

    end. /*of rule 1368*/
  end. /*of rule 1368*/
                                                                      /* salience 24 rule_id 1364*/
  IF  Tot-period1:dis-tot_save( ) = false  THEN do:   
/* salience 25 in upper-rule-id 1364*/
    _1369:
    do:
                                                                      /* Salience 0 rule_id 1369*/
     undo _main, return error v-last-error-message .
...
&scop release_1 release_ ( )
Tot-period-firm1:Dis-tot_host{&release_1} .
&scop release_1 release_ ( )
Sale-sums:Dis-card-sale_obj{&release_1} .
&scop release_1 release_ ( )
Tot-period1:Dis-tot_{&release_1} .
