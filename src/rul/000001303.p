...
---------------------------&start-codex_id=1;ruleset_id=5;-------------------------------
ДОКУМЕНТ <-> ДК на объекте
Обновление данных по ДК на объекте при импорте из внешних систем
---------------------------&end-codex_id=1;ruleset_id=5;------------------------------
...
&scop constructor_1 ( input parparentproc, input p-parent-handle, input p-log-handle, input this-procedure:handle, input p-cont-handle, input v-current-lock, input v-current-wait, input v-save)
tot-obj1 = new Dis-tot_obj{&constructor_1} .
        ...
        :
          ...
          /*надо создать запись payment если это не оплата в кредит!!!*/
            ...
            run ref/payment1.p (
                          ...
                          ,input {&fact} /*p-status*/
                          ,input chr(10) + substitute( 'obj-type=&1,obj-code=&2', vchk-pay.obj-type, string( vchk-pay.obj-code ) ) /*'':U*/ /*PS*/
                          ,input g#userid
                          ,input g#userid
                          )
                          no-error.
...
&scop release_1 release_ ( )
tot-obj1:Dis-tot_obj{&release_1} .
&scop release_1 release_ ( )
