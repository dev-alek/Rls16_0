...
Вспомогательный файл для кодекса правил 18 набор правил 24
...
&scop my-message substitute(".............Импорт данных по Спецификациям из ВС")
  {&display-message}.
  &scop my-message substitute("Импорт данных по Спецификациям из файла &1", file-name)
  {&display-message}.
...
ImpData1:Route-data_{&release_2} .
  ...
  if error-status:error then do:
    if return-value <> '' then do:
      &scop my-message substitute("Ошибка при сохранении данных по спецификации из ВС:&1&2&1&3", {&new-line}, return-value , error-status :get-message(1)  )
      {&display-message}.
    end.
