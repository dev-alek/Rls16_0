...
/* ------------------------- &end-hn-option -----------------------------------*/
  ...
  On error undo _d-card, retry _d-card:
    ...
    /* ------------------------- &start-rule& -----------------------------------*/
/* Сумма накоплений -> категория карты
...
_1346:
do:
                                                                      /* Salience 0 rule_id 1346*/
/* define variable Card1 as class Dis-card_ no-undo .*/
                                                                      /* Salience 1 rule_id 1346*/
/* define variable v-netto-sum1 as  decimal no-undo .*/
                                                                      /* salience 2 rule_id 1346*/
IF  Card1:find_dis-card_( INPUT v-current-d-card) = true  THEN do:   
                                                                      /* Salience 3 rule_id 1346*/
 v-netto-sum1 = 0 .
/* salience 4 in upper-rule-id 1346*/
  _1349:
  do:
                                                                      /* salience 0 rule_id 1349*/
  IF  Card1:emitent-host-code = 0  THEN do:   
/* salience 1 in upper-rule-id 1349*/
    _1353:
    do:
                                                                      /* Salience 0 rule_id 1353*/
/*     define variable Tot-sum1 as class Dis-tot_ no-undo .*/
                                                                      /* salience 1 rule_id 1353*/
    IF  Tot-sum1:find_dis-tot_( INPUT v-current-d-card) = true  THEN do:   
/* salience 2 in upper-rule-id 1353*/
      _1348:
      do:
                                                                      /* salience 0 rule_id 1348*/
      IF  p-r-b = "rubl" AND p-is-over = false  THEN do:   
/* salience 1 in upper-rule-id 1348*/
        _1347:
        do:
                                                                      /* Salience 0 rule_id 1347*/
         v-netto-sum1 = Tot-sum1:pay-tot-rubl .

        end. /*of rule 1347*/
      end. /*of rule 1347*/
                                                                      /* salience 2 rule_id 1348*/
      IF  p-r-b = "rubl" AND p-is-over = true  THEN do:   
/* salience 3 in upper-rule-id 1348*/
        _1359:
        do:
                                                                      /* Salience 0 rule_id 1359*/
         v-netto-sum1 = Tot-sum1:pay-tot-rubl_byf# .

        end. /*of rule 1359*/
      end. /*of rule 1359*/
                                                                      /* salience 4 rule_id 1348*/
      IF  p-r-b = "base" AND p-is-over = false  THEN do:   
/* salience 5 in upper-rule-id 1348*/
        _1355:
        do:
                                                                      /* Salience 0 rule_id 1355*/
         v-netto-sum1 = Tot-sum1:pay-tot-base .

        end. /*of rule 1355*/
      end. /*of rule 1355*/
                                                                      /* salience 6 rule_id 1348*/
      IF  p-r-b = "base" AND p-is-over = true  THEN do:   
/* salience 7 in upper-rule-id 1348*/
        _1358:
        do:
                                                                      /* Salience 0 rule_id 1358*/
         v-netto-sum1 = Tot-sum1:pay-tot-base_byf# .
                                                                      ...
                                                                      /* salience 2 rule_id 1349*/
  IF  Card1:emitent-host-code > 0  THEN do:   
/* salience 3 in upper-rule-id 1349*/
    _1351:
    do:
                                                                      /* Salience 0 rule_id 1351*/
/*     define variable Tot-sum-host1 as class Dis-tot_host no-undo .*/
                                                                      /* salience 1 rule_id 1351*/
    IF  Tot-sum-host1:find_dis-tot_host( INPUT v-current-d-card, INPUT ( Card1:emitent-host-code )) = true  THEN do:   
/* salience 2 in upper-rule-id 1351*/
      _1350:
      do:
                                                                      /* salience 0 rule_id 1350*/
      IF  p-r-b = "rubl" AND p-is-over = false  THEN do:   
/* salience 1 in upper-rule-id 1350*/
        _1354:
        do:
                                                                      /* Salience 0 rule_id 1354*/
         v-netto-sum1 = Tot-sum-host1:pay-tot-rubl .

        end. /*of rule 1354*/
      end. /*of rule 1354*/
                                                                      /* salience 2 rule_id 1350*/
      IF  p-r-b = "rubl" AND p-is-over = true  THEN do:   
/* salience 3 in upper-rule-id 1350*/
        _1357:
        do:
                                                                      /* Salience 0 rule_id 1357*/
         v-netto-sum1 = Tot-sum-host1:pay-tot-rubl_byf# .

        end. /*of rule 1357*/
      end. /*of rule 1357*/
                                                                      /* salience 4 rule_id 1350*/
      IF  p-r-b = "base" AND p-is-over = false  THEN do:   
/* salience 5 in upper-rule-id 1350*/
        _1356:
        do:
                                                                      /* Salience 0 rule_id 1356*/
         v-netto-sum1 = Tot-sum-host1:pay-tot-base .

        end. /*of rule 1356*/
      end. /*of rule 1356*/
                                                                      /* salience 6 rule_id 1350*/
      IF  p-r-b = "base" AND p-is-over = true  THEN do:   
/* salience 7 in upper-rule-id 1350*/
        _1352:
        do:
                                                                      /* Salience 0 rule_id 1352*/
         v-netto-sum1 = Tot-sum-host1:pay-tot-base_byf# .
                                                                      ...
                                                                      /* Salience 5 rule_id 1346*/
 Card1:category = dis-rule_00059( INPUT p-rule-num, INPUT v-current-doc-date, INPUT v-current-doc-time, INPUT v-netto-sum1) .
                                                                      /* salience 6 rule_id 1346*/
IF  Card1:dis-card_save( ) = false  THEN do:   
/* salience 7 in upper-rule-id 1346*/
  _1360:
  do:
                                                                      /* Salience 0 rule_id 1360*/
