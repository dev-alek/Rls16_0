...
Задание и просмотр параметров вызова правил для профайла 5
...
define variable vss-description as character no-undo init "Задание и просмотр параметров вызова правил для профайла 5".
{ cmp/vssrevis.i }
{ gbl/waitfram.i }
{ cmp/str-glbl.i }
{ cmp/showinf.i }
...
substitute("Параметры Интервального Алгоритма зависимости Сумма накоплений -> % скидки на товар с обнул. итогов пересч-м по пред. пер-ду (профайл &1)", p-profile-id).
