...
Импорт данных по документам прихода , рахода , возврата и инвентаризации
...
ImpData1:Route-data_{&release_2} .
    ...
    _rule:
      ...
      /* ------------------------- &start-rule& -----------------------------------*/
          ...
          end. /*IF  ImpData1:current-tbl-name( ) = "trn-doc"  THEN do:*/
          ...
          end. /*IF  ImpData1:current-tbl-name( ) = "doc-line"  THEN do:*/
      /* ------------------------- &end-rule -------------------------------------*/
      end.
    end.
    v-retry-action = 0 .
