...
Задание и просмотр параметров вызова правил - профайл 69
...
define variable vss-description as character no-undo init "Задание и просмотр параметров вызова правил - профайл 69".
{ cmp/vssrevis.i }
{ cmp/str-glbl.i }
{ rul/calldscr.i }
{ gbl/key-rec.i }
...
RUN rcps_get-value IN this-procedure  (
                                  input "p-r-b"
                                  ,INPUT-output v-index-id
                                  ,output v-r-b /*p-value-character*/
                                  ,output v-value-date /*p-value-date*/
                                  ,output v-value-decimal /*p-value-decimal*/
...
custom-par = "all,{&Arc-OT-yes},{&Arc-Supp-yes},{&send-check}"  + {&comma-char} +
              substitute("X-SET_PAY_TYPE=&1", v-price-type) + {&comma-char} +
              substitute("X-SET_val_TYPE=&1", (if v-r-b = {&r-b-base} then {&v-base} else {&v-rubl})) + {&comma-char} +
             custom-par.
