...
Задание и просмотр параметров вызова правил для профайла 7
...
define variable vss-description as character no-undo init "Задание и просмотр параметров вызова правил для профайла 7".
{ cmp/vssrevis.i }
{ gbl/waitfram.i }
{ cmp/str-glbl.i }
{ cmp/showinf.i }
...
&scop rule-sale-in  1525
&scop rule-sale-out 1525
&scop rule-trn-in   1525
&scop rule-trn-out  1525
&scop rule-recalc   1525
...
substitute("Параметры Интервального Алгоритма зависимости Сумма накоплений -> категория скидки с обнул. итогов пересч-м по пред. пер-ду (профайл &1)", p-profile-id).
