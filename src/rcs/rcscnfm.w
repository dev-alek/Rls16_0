...
Объекты РКС - настройка идентификаторов
...
define variable vss-description as character no-undo init "Объекты РКС - настройка идентификаторов.".
{ cmp/vssrevis.i }
{ cmp/trg-def.i  }
{ rcs/rcsimp.i   }
{ cmp/showinf.i  }
...
&Scoped-define INTERNAL-TABLES rcs-shops

/* Definitions for BROWSE BROWSE-1                                      */
&Scoped-define FIELDS-IN-QUERY-BROWSE-1 rcs-shops.status_ rcs-shops.name ~
rcs-shops.id rcs-shops.obj-type rcs-shops.obj-code
&Scoped-define ENABLED-FIELDS-IN-QUERY-BROWSE-1
&Scoped-define FIELD-PAIRS-IN-QUERY-BROWSE-1
&Scoped-define OPEN-QUERY-BROWSE-1 OPEN QUERY BROWSE-1 FOR EACH rcs-shops SHARE-LOCK.
&Scoped-define TABLES-IN-QUERY-BROWSE-1 rcs-shops
&Scoped-define FIRST-TABLE-IN-QUERY-BROWSE-1 rcs-shops
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-1 Dialog-Frame _STRUCTURED
  QUERY BROWSE-1 SHARE-LOCK NO-WAIT DISPLAY
      rcs-shops.status_ COLUMN-LABEL "*" FORMAT "X(1)"
      rcs-shops.name
      rcs-shops.id
      rcs-shops.obj-type COLUMN-LABEL "Тип"
      rcs-shops.obj-code COLUMN-LABEL "Код" FORMAT "zzzzzz9"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 78 BY 17.71.
...
DEFINE FRAME Dialog-Frame
     ...
     b-help AT ROW 1.17 COL 70
     BROWSE-1 AT ROW 2.38 COL 2
     SPACE(1.12) SKIP(0.28)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE
         TITLE "Объекты РКС - настройка идентификаторов"
...
/* Query rebuild information for BROWSE BROWSE-1
     _TblList          = "ub.rcs-shops"
     _Options          = "SHARE-LOCK"
     _FldNameList[1]   > ub.rcs-shops.status_
"rcs-shops.status_" "*" "X(1)" "character" ? ? ? ? ? ? no ?
     _FldNameList[2]   = ub.rcs-shops.name
     _FldNameList[3]   = ub.rcs-shops.id
     _FldNameList[4]   > ub.rcs-shops.obj-type
"rcs-shops.obj-type" "Тип" ? "character" ? ? ? ? ? ? no ?
     _FldNameList[5]   > ub.rcs-shops.obj-code
"rcs-shops.obj-code" "Код" "zzzzzz9" "integer" ? ? ? ? ? ? no ?
     _Query            is OPENED
*/  /* BROWSE BROWSE-1 */
&ANALYZE-RESUME
...
:
    ...
    .
    if rcs-shops.status_ = '{&delim-flt}'
    then do:
        /* снимаем отметку */
        assign
            rcs-shops.status_ = ''
...
define input parameter p-id  as character    no-undo.
    ...
    find first buf_rcs-shops exclusive-lock
