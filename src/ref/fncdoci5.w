...
Карточка истории приходного АПЗ
...
def var vss-description as character no-undo init "Карточка истории приходного АПЗ".
{ cmp/vssrevis.i }
...
&scop in-form-list    "F-curr-abbr,an-uchet-value,cel-nazn-value,cor-acc1-value,cor-acc-value,doc-date," + ~
                      "including,naznach-plat,payer-name,prn-doc-code,receiver-name,receiver-okpo,payer-sign1,receiver-sign1," + ~
...
tt-c-fin-doc.cel-nazn-value tt-c-fin-doc.contract-curr ~
tt-c-fin-doc.cor-acc-value tt-c-fin-doc.an-uchet-value tt-c-fin-doc.sum-doc ~
tt-c-fin-doc.curr-code tt-c-fin-doc.exch-rate tt-c-fin-doc.exch-scale ~
tt-c-fin-doc.sum-rubl tt-c-fin-doc.sum-base tt-c-fin-doc.contract-rate ~
...
tt-c-fin-doc.including tt-c-fin-doc.PS tt-c-fin-doc.payer-sign1 ~
...
f-cor-acc-descr f-an-uchet-descr F-curr-abbr F-debet F-credit
...
DEFINE FRAME Dialog-Frame
     ...
     tt-c-fin-doc.str-podr-name AT ROW 5 COL 46.88 COLON-ALIGNED NO-LABEL
          ...
          SIZE 50 BY 1
          FGCOLOR 4
     tt-c-fin-doc.cor-acc1-value AT ROW 6 COL 16.25 COLON-ALIGNED
          LABEL "Корсчет"
          VIEW-AS FILL-IN
          SIZE 14 BY 1
          FGCOLOR 4
     f-cor-acc1-descr AT ROW 6 COL 35.38 COLON-ALIGNED NO-LABEL
     tt-c-fin-doc.cel-nazn-value AT ROW 7 COL 3.25
          LABEL "Код цел.назн."
          VIEW-AS FILL-IN
          SIZE 14 BY 1
          FGCOLOR 4
     f-cel-nazn-descr AT ROW 7 COL 35.38 COLON-ALIGNED NO-LABEL
...
DEFINE FRAME Dialog-Frame
     ...
     tt-c-fin-doc.cor-acc-value AT ROW 8 COL 9.25
          LABEL "Корсчет"
          VIEW-AS FILL-IN
          SIZE 14 BY 1
          FGCOLOR 4
     f-cor-acc-descr AT ROW 8 COL 35.38 COLON-ALIGNED NO-LABEL
     tt-c-fin-doc.an-uchet-value AT ROW 9 COL 5.25
          LABEL "Код ан. уч."
          VIEW-AS FILL-IN
          SIZE 14 BY 1
          FGCOLOR 4
     f-an-uchet-descr AT ROW 9 COL 35.38 COLON-ALIGNED NO-LABEL
...
DEFINE FRAME Dialog-Frame
     tt-c-fin-doc.PS AT ROW 19 COL 50.5 NO-LABEL
          VIEW-AS EDITOR SCROLLBAR-VERTICAL
          SIZE 48 BY 2 TOOLTIP "Дополнительная информация, не печатающаяся в АПЗ"
     tt-c-fin-doc.payer-sign1 AT ROW 21.04 COL 1
          LABEL "Гл. бухгалтер"
          VIEW-AS FILL-IN
          SIZE 30.88 BY 1
          FGCOLOR 4
     tt-c-fin-doc.receiver-sign1 AT ROW 21.04 COL 57.75 COLON-ALIGNED
          LABEL "Кассир"
          VIEW-AS FILL-IN
          SIZE 24.38 BY 1
          FGCOLOR 4
     F-debet AT ROW 6.25 COL 1.5 NO-LABEL
     F-credit AT ROW 8.25 COL 1.5 NO-LABEL
...
CASE p-view:
  when "full":U then do:
    ...
    .
    display
    f-debet                       when (X_sysconf.is-corr-acc or X_sysconf.is-code-cel-nazn)
    f-credit                      when (X_sysconf.is-cassa-acc or X_sysconf.is-an-uchet)
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY RS-view f-cor-acc1-descr f-cel-nazn-descr f-contract-curr-abbr
          ...
          f-an-uchet-descr F-curr-abbr F-debet F-credit
      WITH FRAME Dialog-Frame.
  IF AVAILABLE tt-c-fin-doc THEN
    DISPLAY tt-c-fin-doc.perm-date tt-c-fin-doc.prn-doc-code
          ...
          tt-c-fin-doc.cor-acc1-value tt-c-fin-doc.cel-nazn-value
          tt-c-fin-doc.contract-curr tt-c-fin-doc.cor-acc-value
          tt-c-fin-doc.an-uchet-value tt-c-fin-doc.sum-doc
          tt-c-fin-doc.curr-code tt-c-fin-doc.exch-rate tt-c-fin-doc.exch-scale
          tt-c-fin-doc.sum-rubl tt-c-fin-doc.base-rate tt-c-fin-doc.base-scale
          tt-c-fin-doc.sum-base tt-c-fin-doc.contract-rate
...
if not available locked_c-fin-doc then do:
  message
  vss-workfile vss-revision vss-description skip
  "Не найдена запись ИСТОРИИ ПРИХОДНОГО АПЗ"
  view-as alert-box error .
  undo, return error.
end.
create tt-c-fin-doc.
