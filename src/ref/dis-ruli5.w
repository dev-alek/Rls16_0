...
Редактирование правил скидок - категорийная скидка, задаваемая через ТПЛ
...
&Scoped-define FIELDS-IN-QUERY-BR-term-dr entry (lookup (string(tt0-term_dis-rule.value-type), {&discnt-v-list}), {&discnt-v-list-full}) tt0-term_dis-rule.dis-kat tt0-term_dis-rule.charkey_one tt0-term_dis-rule.des tt0-term_dis-rule.rule-num
...
tt-dis-rule.value-type tt-dis-rule.dis-kat tt-dis-rule.CharKey_One ~
...
tt-dis-rule.dis-kat tt-dis-rule.CharKey_One tt-dis-rule.time-rule-num ~
