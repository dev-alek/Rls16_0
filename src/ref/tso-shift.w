...
define output parameter p-num as integer no-undo format ">>9" .
...
DEFINE FRAME Dialog-Frame
     ...
     p-num at row 2.5 col 2 format ">>9"  label "Номер смены"
     SPACE(0.5) SKIP(0.5)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Введите номер смены"
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  assign
    p-num = 1
  . 
  display p-num with frame {&FRAME-NAME}.
  enable  p-num with frame {&FRAME-NAME}.   
  RUN enable_UI.
