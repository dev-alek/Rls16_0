...
Ввод данных для нового клиента во внешнем классификаторе Синхронизации клиентов ДИАДОК
...
DEFINE OUTPUT PARAMETER p-ext-obj-code AS character NO-UNDO.
...
define variable vss-description as character no-undo init "Ввод данных для нового клиента во внешнем классификаторе Синхронизации клиентов ДИАДОК" .
{ cmp/vssrevis.i }
{ cmp/str-glbl.i  }
{ cmp/library.i }
{ cmp/showinf.i }
...
b-choose-client fi-ext-obj-code 
&Scoped-Define DISPLAYED-OBJECTS fi-obj-type fi-obj-code fi-ext-obj-code 
...
ON GO OF FRAME d-add-ext-client /* Синхронизация клиентов ДИАДОК */
DO:
  define buffer buf_db for ub.db .
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-add-ext-client d-add-ext-client
ON WINDOW-CLOSE OF FRAME d-add-ext-client /* Синхронизация клиентов ДИАДОК */
DO:
...
------------------------------------------------------------------------------*/
  DISPLAY fi-obj-type fi-obj-code fi-ext-obj-code 
...
------------------------------------------------------------------------------*/
    ...
    DISPLAY
    fi-obj-type fi-obj-code fi-ext-obj-code /*fi-db-num*/
    WITH FRAME d-add-ext-client.
  ENABLE
  B-exit
  B-quit
  B-Help
  fi-obj-type fi-obj-code b-choose-client fi-ext-obj-code /*fi-db-num b-choose-db*/
  WITH FRAME d-add-ext-client.
  VIEW FRAME d-add-ext-client.
END PROCEDURE.
