...
$Workfile: findoc05.p $
$Archive: ref/findoc05.p $

Проверка платежа  типа income-payoff
...
define variable vss-workfile    as character no-undo init "$Workfile: findoc05.p $":U .
define variable vss-archive     as character no-undo init "$Archive: ref/findoc05.p $":U .
define variable vss-description as character no-undo init "Проверка платежа типа income-payoff".
{ cmp/vssrevis.i }
