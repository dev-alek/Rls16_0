...
procedure bc-oattr_tooltip :
  ...
  on error undo, return error
  :
    &scop proc-name bc-oattr_tooltip
    {&run_proc_attr-lib}
      (input  p-code
      ,output p-tooltip
      ,output p-label
...
procedure bc-oattr_delete :
  ...
  on error undo, return error
  :
    &scop proc-name bc-oattr_delete
    {&run_proc_attr-lib}
      (input  p-b-code
      ,input  p-code
      ,input  p-obj-type
...
procedure bc-oattr_manual-edit :
  ...
  on error undo, return error
  :
    &scop proc-name bc-oattr_manual-edit
    {&run_proc_attr-lib}
      (input  p-code
...
procedure bc-oattr_batch-edit :
  ...
  on error undo, return error
  :
    &scop proc-name bc-oattr_batch-edit
    {&run_proc_attr-lib}
      (input  p-code
      ,output p-section-num
      ) no-error .
...
define output parameter p-setted as logical no-undo .
  ...
  on error undo, return error
  :
    &scop proc-name bc-oattr_taracode-bc
    {&run_proc_attr-lib}
      (input  parparentproc
      ,input  p-b-code
      ,input  p-obj-type
