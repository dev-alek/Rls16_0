...
assign
file-name            = entry(1, p-parameter, {&delim-par})
p-stop-list-code     = entry(2, p-parameter, {&delim-par})
p-mode               = entry(3, p-parameter, {&delim-par})
v-close              = logical(entry(4, p-parameter, {&delim-par}))
no-error
.
...
if p-mode = {&update} then do:
  ...
  buf0_stop-list.status_ = {&g___new}
  .
  if error-status:error then do:
    run write-log-and-file in p-log-handle (
          input 1
  ...
  on error undo _stroka2, next _stroka2 :
    ...
    &scop stop-status-code string(v-stop-status)
      ...
      run discprop-write in this-procedure (
                                              ...
                                              ,input '':U /*p-obj-type*/
                                              ,input 0 /*p-obj-code*/
                                              ,input {&dc-prop_dc-petrol} /*p-dtm-code        */
                                              ,input {&dc_prop_dc-petrol_sum-limit} /*p-node-code*/
                                              ,input ? /*p-dt-code         */
                                              ...
                                              /*p-sum-id*/
                                              ,input '':U /*p-value-character */
                                              ,input ? /*p-value-date      */
                                              ,input (- temp-imp.lim-kr) /* p-value-decimal   */
