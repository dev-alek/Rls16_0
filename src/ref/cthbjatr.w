...
&Scoped-define FIELDS-IN-QUERY-br-thbj-attr mark-string(recid(X_c-thbj-attr), v-rid-list) X_c-thbj-attr.corr-date string(X_c-thbj-attr.corr-time, "HH:MM:SS":U) usrfulnf(X_c-thbj-attr.corr-user-name) get-action(X_c-thbj-attr.action) X_c-thbj-attr.corr-user-db-num X_c-thbj-attr.is-news X_c-thbj-attr.obj-type + string(X_c-thbj-attr.obj-code) if v-find then get-param-name(X_c-thbj-attr.upper-prop-code, X_c-thbj-attr.prop-code, output v-dop) else "":U get-subject(X_c-thbj-attr.subject)   
