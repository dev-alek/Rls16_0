...
$Workfile: findoci4.w $
$Archive: ref/findoci4.w $

Карточка редактирования платежного поручени
...
&scop brief-view-tab-order   ~{&buttons-tab-order~} + ~
                            ...
                            "obj-type,obj-code,b-obj,b-payer-schet,b-payer-view," + v-sum-curr-tab-order + ~
                            "receiver-type,receiver-code,b-receiver,receiver-name,b-receiver-schet,b-receiver-view," +  ~
...
&scop full-view-tab-order   ~{&buttons-tab-order~} + ~
                            ...
                            v-an-uchet-tab-order +  "b-payer-schet,b-payer-view," + v-sum-curr-tab-order + ~
                            "receiver-type,receiver-code,b-receiver,receiver-name,b-receiver-schet,b-receiver-view," +  ~
                            "naznach-plat,PS,payer-sign1,payer-sign2"

&scop contract-view-tab-order  ~{&buttons-tab-order~} + ~
                            "prn-doc-code,vid-plat,doc-date,obj-type,obj-code,b-obj," + ~
                             v-contract-tab-order +  "b-payer-schet,b-payer-view," + v-sum-curr-tab-order + ~
                            "receiver-type,receiver-code,b-receiver,receiver-name,b-receiver-schet,b-receiver-view," +  ~
                            "naznach-plat,PS,payer-sign1,payer-sign2"
...
&scop in-form-list    "F-curr-abbr,an-uchet-value,cel-nazn-value,cor-acc-value,doc-date," + ~
                      "naznach-plat,receiver-name,receiver-inn,receiver-kpp,receiver-bank-name,receiver-bank-city,receiver-bik,receiver-r-schet,receiver-c-schet," + ~
                      "prn-doc-code,payer-name,payer-inn,payer-kpp,payer-bank-name,payer-bank-city,payer-bik,payer-r-schet,payer-c-schet,payer-sign1,payer-sign2" + ~
                      "sum-doc"
...
tt-fin-doc.contract-curr tt-fin-doc.cel-nazn-value tt-fin-doc.payer-name ~
tt-fin-doc.payer-bank-name tt-fin-doc.payer-bank-city ~
tt-fin-doc.payer-c-schet tt-fin-doc.sum-doc tt-fin-doc.curr-code ~
...
tt-fin-doc.receiver-name tt-fin-doc.receiver-bank-city ~
...
&Scoped-Define ENABLED-OBJECTS B-exit b-quit b-other B-tax B-print B-hist ~
B-Help RS-view B-obj B-cor-acc B-an-uchet f-contract-curr-abbr ~
B-contract-view B-cel-nazn B-payer-schet B-payer-view f-rest-con-sum ~
B-currency B-calc B-receiver B-receiver-schet B-receiver-view
...
tt-fin-doc.receiver-kpp tt-fin-doc.receiver-type tt-fin-doc.receiver-code ~
...
or p-mode = {&add-copy} then do:
  run ref/finfnoco.p (
                ...
                ,input {&expense-cashless} /*p-fin-doc-type*/
                ,input {&FDEDT_expense_cashless} /*p-fin-ext-doc-type*/
                ,input p-obj-type
                ,input p-obj-code
...
if p-mode = {&add-def} and tt-fin-doc.receiver-type = "":U then do:
  assign
