...
assign
filter-point0 = ({&goods} + {&comma-char} + {&receipts})
.
...
&GLOBAL-DEFINE receipt-code string(c-doc.chk-type)
&SCOPED-DEFINE sort-clmn_3 mark-string(recid(chk-gds), rid-list)
&SCOPED-DEFINE dyn_sort-clmn_3  substitute('dynamic-function(&1mark-string&1, recid(chk-gds), &1&2&1)', ~{&double-quote~}, rid-list)
&scoped-define label-clmn_3 '*'
&SCOPED-DEFINE sort-clmn_5 ~{&receipt-name~}
&scoped-define label-clmn_5 'Тип_чека'
&SCOPED-DEFINE sort-clmn_9 (string (c-doc.chk-time, 'HH:MM'))
&scoped-define label-clmn_9 'Время'
&SCOPED-DEFINE sort-clmn_13 (chk-gds.discnt / chk-gds.price-base * 100)
&scoped-define label-clmn_13 '%'
&SCOPED-DEFINE sort-clmn_14 (chk-gds.price-base - chk-gds.discnt)
&scoped-define label-clmn_14 'Нетто цена'
&SCOPED-DEFINE sort-clmn_15  chk-gds.pump
&scoped-define label-clmn_15 'ТРК'
&SCOPED-DEFINE sort-clmn_16 chk-gds.nozzle-code
&scoped-define label-clmn_16 'Пист'
&SCOPED-DEFINE sort-clmn_17 chk-gds.loc1
&scoped-define label-clmn_17 'Рез'
&SCOPED-DEFINE sort-clmn_18 ~{&wro-name~}
&scoped-define label-clmn_18 'Код_спис'
/*
&SCOPED-DEFINE sort-clmn_20 shift-name-no-err(buffer c-doc)
&scoped-define label-clmn_20 '№_см.'
*/
...
&Scoped-define INTERNAL-TABLES bar-code chk-gds c-doc

/* Definitions for BROWSE BR-docs                                       */
&Scoped-define FIELDS-IN-QUERY-BR-docs bar-code.b-code c-doc.office {&sort-clmn_3} c-doc.doc-code {&sort-clmn_5} chk-gds.line-num c-doc.chk-num c-doc.chk-date {&sort-clmn_9} chk-gds.doc-qnty chk-gds.price-base chk-gds.discnt {&sort-clmn_13} {&sort-clmn_14} {&sort-clmn_15} {&sort-clmn_16} {&sort-clmn_17} {&sort-clmn_18} c-doc.shift-date shift-name-no-err(buffer c-doc) c-doc.netto c-doc.tot-doc c-doc.discnt c-doc.sub-discnt c-doc.pay-desk c-doc.cashier c-doc.sales-man c-doc.out-code c-doc.d-card
...
&Scoped-define QUERY-STRING-BR-docs FOR EACH bar-code NO-LOCK, ~
             EACH chk-gds NO-LOCK, ~
             EACH c-doc NO-LOCK
&Scoped-define OPEN-QUERY-BR-docs OPEN QUERY {&SELF-NAME} FOR EACH bar-code NO-LOCK, ~
             EACH chk-gds NO-LOCK, ~
             EACH c-doc NO-LOCK.
&Scoped-define TABLES-IN-QUERY-BR-docs ub.bar-code ub.chk-gds c-doc
&Scoped-define FIRST-TABLE-IN-QUERY-BR-docs ub.bar-code
&Scoped-define SECOND-TABLE-IN-QUERY-BR-docs ub.chk-gds
&Scoped-define THIRD-TABLE-IN-QUERY-BR-docs c-doc


/* Definitions for DIALOG-BOX Dialog-Frame                              */

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS b-quit B-mark b-sel b-lkp b-onlybcode B-del ~
B-sale B-print B-sch B-Help Cb-chk-type RS-sort BR-docs ED-notes sch-bcode ~
sch-code sch-date sch-price mark-num
&Scoped-Define DISPLAYED-OBJECTS Cb-chk-type RS-sort ED-notes sch-bcode ~
sch-code sch-date sch-price mark-num
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BR-docs Dialog-Frame _FREEFORM
  ...
  {&sort-clmn_3} COLUMN-LABEL {&label-clmn_3} FORMAT "X(1)":U
  c-doc.doc-code COLUMN-LABEL "Номер_чека" FORMAT "X(20)":U
  {&sort-clmn_5} COLUMN-LABEL {&label-clmn_5} FORMAT "X(8)":U
  ...
  {&sort-clmn_13} COLUMN-LABEL {&label-clmn_13} FORMAT "->>9.<%":U
  {&sort-clmn_14} COLUMN-LABEL {&label-clmn_14} FORMAT "->>>,>>>,>>9.99":U
  {&sort-clmn_15} COLUMN-LABEL {&label-clmn_15} FORMAT ">9":U
  {&sort-clmn_16} COLUMN-LABEL {&label-clmn_16} FORMAT ">>9":U
  {&sort-clmn_17} COLUMN-LABEL {&label-clmn_17} FORMAT "X(3)":U
  {&sort-clmn_18} COLUMN-LABEL {&label-clmn_18} FORMAT "X(10)":U
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      ...
      TABLE: find_bar-code B "?" ? ub bar-code
...
/* Query rebuild information for BROWSE BR-docs
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH bar-code NO-LOCK,
      EACH chk-gds NO-LOCK,
      EACH c-doc NO-LOCK.
     _END_FREEFORM
...
&Scoped-define SELF-NAME b-onlybcode
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL b-onlybcode Dialog-Frame
ON CHOOSE OF b-onlybcode IN FRAME Dialog-Frame /* Этот БК */
DO:
...
if not avail bar-code then return no-apply.
   run ref/gds-chk.w (
                  ...
                  ,input bttns
                  ,input "gds-chks":U + {&comma-char} + par-mode
                  ,input ? /*pardoc-rec*/
                  ,input parobj-type
                  ,input parobj-code
                  ,input parout-code
...
if not error-status:error then do:
    ...
    apply "entry" to sch-bcode in frame {&frame-name}.
end.
...
ON VALUE-CHANGED OF MENU-ITEM m-one-time /* Игнорировать повторение строк чеков с таким же бар-кодом */
DO:
  assign
...
&Scoped-define SELF-NAME sch-bcode
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL sch-bcode Dialog-Frame
ON CTRL-J OF sch-bcode IN FRAME Dialog-Frame /* бар-коду */
DO:
  run proc-find-bcode in this-procedure ( input yes, input string(input frame {&frame-name} sch-bcode)) no-error.
  if error-status:error then return no-apply.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL sch-bcode Dialog-Frame
ON RETURN OF sch-bcode IN FRAME Dialog-Frame /* бар-коду */
DO:
  run proc-find-bcode in this-procedure ( input no, input string(input frame {&frame-name} sch-bcode)) no-error.
  if error-status:error then return no-apply.
END.
...
{ gbl/brwrefre.i "v-doc-rec = recid(bar-code). run OpenBr in this-procedure ( input yes, input no, input '':U). reposition br-docs to recid v-doc-rec no-error. v-doc-rec = ?. ~
...
&ext-col = 29
&start-column  = 6
&sort-clmn_1   = "BAR-CODE.B-CODE"
&sort-clmn_2   = "c-doc.office"
&label-clmn_3  = "{&label-clmn_3}"
&sort-clmn_3   = "{&sort-clmn_3}"
&dyn_sort-clmn_3  = "{&dyn_sort-clmn_3}"
&sort-clmn_4   = "c-doc.doc-code"
&label-clmn_5  = "{&label-clmn_5}"
&sort-clmn_5   = "{&sort-clmn_5}"
&sort-clmn_7   = "c-doc.chk-num"
&sort-clmn_8   = "c-doc.chk-date"
&label-clmn_9  = "{&label-clmn_9}"
&sort-clmn_9   = "{&sort-clmn_9}"
&sort-clmn_10   = "chk-gds.doc-qnty"
&sort-clmn_11  = "chk-gds.price-base"
&sort-clmn_12  = "chk-gds.discnt"
...
&sort-clmn_19  = "c-doc.shift-date"
&sort-clmn_25  = "c-doc.pay-desk"
&sort-clmn_26  = "c-doc.cashier"
&sort-clmn_27  = "c-doc.sales-man"
&sort-clmn_28  = "c-doc.out-code"
&sort-clmn_29  = "c-doc.d-card"
...
p-chk-type = integer(cb-chk-type)
br-docs:NUM-LOCKED-COLUMNS IN FRAME {&frame-name} = 9
...
title0 = "Список чеков по товару" + {&space-char} +
...
&scop flt-open-open-query OPEN QUERY br-docs FOR EACH bar-code

&scop flt-open-dyn_open-query  FOR EACH bar-code
...
&scop flt-open-table-name bar-code
...
CASE RS-sort:
  when "unsort":U then do:
    CASE par-mode :
      WHEN {&all}        THEN DO:
&scop flt-open-open-query-tail  , EACH chk-gds No-LOCK WHERE chk-gds.b-code = bar-code.b-code, FIRST c-doc No-LOCK WHERE c-doc.doc-code = chk-gds.doc-code
      ...
      { gbl/fltopend.i
          &where-cond = " bar-code.gds-code = buf_goods.gds-code "
          &dyn_where-cond = " substitute(' bar-code.gds-code = &1 ', buf_goods.gds-code)"
          &use-ind    = "  "
          &by         = " " }
      END.
...
&scop flt-open-dyn_open-query-tail  substitute(', EACH chk-gds No-LOCK WHERE chk-gds.b-code = bar-code.b-code, FIRST c-doc No-LOCK WHERE c-doc.doc-code = chk-gds.doc-code ~
...
&scop flt-open-open-query-tail  , EACH chk-gds No-LOCK WHERE chk-gds.b-code = bar-code.b-code and chk-gds.out-code = parout-code, FIRST c-doc No-LOCK WHERE c-doc.doc-code = chk-gds.doc-code ~
                                  AND c-doc.d-card = pard-card AND c-doc.obj-code = parobj-code and (p-chk-type = 0 or c-doc.chk-type = p-chk-type)

&scop flt-open-dyn_open-query-tail  substitute(', EACH chk-gds No-LOCK WHERE chk-gds.b-code = bar-code.b-code and chk-gds.out-code = "&1", FIRST c-doc No-LOCK WHERE c-doc.doc-code = chk-gds.doc-code ~
                                  AND c-doc.d-card = "&2" AND c-doc.obj-type = "&3" and c-doc.obj-code = &4 and (&5 = 0 or c-doc.chk-type = &5)' ~
                                     ,parout-code ~
                                     ,pard-card  ~
                                     ,parobj-code ~
                                     ,parobj-type ~
      ...
      WHEN {&sale}   THEN DO:
&scop flt-open-open-query-tail , EACH chk-gds No-LOCK WHERE chk-gds.b-code = bar-code.b-code and chk-gds.out-code = parout-code , FIRST c-doc No-LOCK WHERE c-doc.doc-code = chk-gds.doc-code ~
                                  and (p-chk-type = 0 or c-doc.chk-type = p-chk-type)

&scop flt-open-dyn_open-query-tail substitute(', EACH chk-gds No-LOCK WHERE chk-gds.b-code = bar-code.b-code and chk-gds.out-code = "&1" , FIRST c-doc No-LOCK WHERE c-doc.doc-code = chk-gds.doc-code ~
                                  and ( &2 = 0 or c-doc.chk-type = &2)' ~
                                  ,parout-code ~
                                  ,p-chk-type )
      ...
      define buffer buf_inkas for ub.inkas.
        ...
        if p-open-query then do:
          assign
          frame {&frame-name}:TITLE = substitute("&1 Чеки по отчету &2 Объект &3&4 &5"
                                                      ,title0
                                                      ,parout-code
                                                      ,parobj-type
                                                      ,parobj-code
      ...
      END.
      WHEN "free":U    THEN DO:
&scop flt-open-open-query-tail  , EACH chk-gds No-LOCK WHERE chk-gds.b-code = bar-code.b-code and chk-gds.out-code = ?, FIRST c-doc No-LOCK WHERE c-doc.doc-code = chk-gds.doc-code ~
                                  AND c-doc.obj-type = parobj-type AND c-doc.obj-code = parobj-code and (p-chk-type = 0 or c-doc.chk-type = p-chk-type)
&scop flt-open-dyn_open-query-tail  substitute(', EACH chk-gds No-LOCK WHERE chk-gds.b-code = bar-code.b-code and chk-gds.out-code = ?, FIRST c-doc No-LOCK WHERE c-doc.doc-code = chk-gds.doc-code ~
                                  AND c-doc.obj-type = "&1" AND c-doc.obj-code = &2 and (&3 = 0 or c-doc.chk-type = &3)' ~
                                                 ,parobj-type ~
                                                 ,parobj-code ~
                                                 ,p-chk-type )
        ...
        if p-open-query then do:
          assign
          frame {&frame-name}:TITLE = substitute("&1 НЕ включенные в отчеты чеки Объект &2&3 &4"
                                                      ,title0
                                                      ,parobj-type
                                                      ,parobj-code
                                                      , (if p-chk-type = 0 then '':u else {&receipt-name})
  ...
  when "doc-code":U then do:
    CASE par-mode :
      ...
      WHEN {&all}        THEN DO:
&scop flt-open-open-query-tail  , EACH chk-gds No-LOCK WHERE chk-gds.b-code = bar-code.b-code,  ~
     ...
     assign
      ...
      { gbl/fltopend.i
          ...
          &dyn_where-cond = " substitute(' bar-code.gds-code = &1 ', buf_goods.gds-code)"
          &use-ind    = "  "
          &by         = " by chk-gds.chk-date  descending " }
      END.
      WHEN {&g___object} THEN DO:
...
&scop flt-open-dyn_open-query-tail  substitute(', EACH chk-gds No-LOCK WHERE chk-gds.b-code = bar-code.b-code and chk-gds.out-code = "&1", FIRST c-doc No-LOCK WHERE c-doc.doc-code = chk-gds.doc-code ~
      ...
      END.
      WHEN {&sale}   THEN DO:
&scop flt-open-open-query-tail , EACH chk-gds No-LOCK WHERE chk-gds.b-code = bar-code.b-code and chk-gds.out-code = parout-code , ~
                                  FIRST c-doc No-LOCK WHERE c-doc.doc-code = chk-gds.doc-code ~
                                  and (p-chk-type = 0 or c-doc.chk-type = p-chk-type)

&scop flt-open-dyn_open-query-tail substitute(', EACH chk-gds No-LOCK WHERE chk-gds.b-code = bar-code.b-code and chk-gds.out-code = "&1" , ~
                                  FIRST c-doc No-LOCK WHERE c-doc.doc-code = chk-gds.doc-code ~
                                  and (&2 = 0 or c-doc.chk-type = &2p-chk-type)' ~
                                  ,parout-code ~
                                  ,p-chk-type )
      ...
      WHEN "free":U    THEN DO:
&scop flt-open-open-query-tail  , EACH chk-gds No-LOCK WHERE chk-gds.b-code = bar-code.b-code and chk-gds.out-code = ?, FIRST c-doc No-LOCK WHERE c-doc.doc-code = chk-gds.doc-code ~
                                 AND c-doc.obj-type = parobj-type AND c-doc.obj-code = parobj-code ~
                                 and (p-chk-type = 0 or c-doc.chk-type = p-chk-type)

&scop flt-open-dyn_open-query-tail  substitute(', EACH chk-gds No-LOCK WHERE chk-gds.b-code = bar-code.b-code and chk-gds.out-code = ?, FIRST c-doc No-LOCK WHERE c-doc.doc-code = chk-gds.doc-code ~
                                 AND c-doc.obj-type = "&1" AND c-doc.obj-code = &2 ~
                                 and (&3 = 0 or c-doc.chk-type = &3)' ~
                                 ,parobj-type ~
                                 ,parobj-code ~
                                 ,p-chk-type )
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE proc-find-bcode Dialog-Frame
...
apply "entry":u to sch-bcode in frame {&frame-name} .
