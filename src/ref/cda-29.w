...
Редактирование атрибутов кассы "cd-type-ibs-th"
...
CB-cashless-system t-rcpt-ord-slip-print t-card-reader-plug b-interface ~
...
rs-rmethod-coeff CB-cashless-system t-rcpt-ord-slip-print ~
t-card-reader-plug t-rcpt-ord-alt-print CB-cctv-system ~
...
DO:
  ...
  f-customer-display-adv:SCREEN-VALUE in frame {&frame-name} = f-customer-display-adv
  .
END.
...
ON LEAVE OF f-customer-display-adv2 IN FRAME Dialog-Frame /* Теrст рекл. на дисплее покупателя2 */
DO:
  ASSIGN
  ...
  CASE t-cash-drawer-plug:
    ...
    WHEN YES THEN DO:
        IF p-mode <> {&lookup} THEN DO:
          ...
          f-cash-drawer-plug-port
          RS-cash-drawer-level
          /* rs-cash-drawer-plug-type */ /*Закомментировано, пока не разработан механизм подключения к ком-порту */
          t-cash-drawer-open
          f-cash-drawer-limit
          WITH FRAME {&FRAME-NAME}.
        END.
...
DO:
  ...
  CASE t-customer-display-plug:
    ...
    WHEN YES THEN DO:
        IF p-mode <> {&lookup} THEN DO:
          enable
          /* f-customer-display-port  */  /*Пока не используется*/
          cb-customer-display-type
          f-customer-display-adv1
          f-customer-display-adv2
          WITH FRAME {&FRAME-NAME}.
...
FOR EACH thbjattr_thbj-attr:
  ...
  CASE thbjattr_thbj-attr.upper-prop-code :
    WHEN {&cda-ibs-th_main} THEN DO:
      CASE v-entry:
        WHEN {&cda-ibs-th_main_cash-shift} THEN DO:
          ASSIGN
          ...
          .
        END.
       WHEN {&cda-ibs-th_main_nalc} THEN DO:
          ASSIGN
          ...
          END.
        END.
       WHEN {&cda-ibs-th_main_salesman-mandatory} THEN DO:
          ASSIGN
          ...
          .
        END.
        WHEN {&cda-ibs-th_main_manual-discnt} THEN DO:
          ASSIGN
          ...
          .
        END.
        WHEN {&cda-ibs-th_main_log-level} THEN DO:
          ASSIGN
          ...
          .
        END.
        WHEN {&cda-ibs-th_main_clear-cash-counter} THEN DO:
          ASSIGN
          ...
          .
        END.
        WHEN {&cda-ibs-th_main_qnty-change} THEN DO:
          ASSIGN
     ...
     END CASE.
   END.
   WHEN {&cda-ibs-th_devices} THEN DO:
     CASE v-entry:
       WHEN {&cda-ibs-th_devices_cash-drawer-plug} THEN DO:
         ASSIGN
         ...
         .
       END.
       WHEN {&cda-ibs-th_devices_cash-drawer-plug-type} THEN DO:
         ASSIGN
         ...
         rs-cash-drawer-plug-type:private-data in frame {&frame-name} = "recid=" + string(recid(thbjattr_thbj-attr))
           .
       END.
       WHEN {&cda-ibs-th_devices_cash-drawer-plug-port} THEN DO:
         ASSIGN
         ...
         .
       END.
       WHEN {&cda-ibs-th_devices_cash-drawer-plug-imp} THEN DO:
         ASSIGN
         ...
         .
       END.
       WHEN {&cda-ibs-th_devices_cash-drawer-open} THEN DO:
        ASSIGN
        ...
        .
       END.
       WHEN {&cda-ibs-th_devices_cash-drawer-limit} THEN DO:
         ASSIGN
         ...
         .
       END.
       WHEN {&cda-ibs-th_devices_card-reader-plug} THEN DO:
         ASSIGN
         ...
         .
       END.
       WHEN {&cda-ibs-th_devices_customer-display-plug} THEN DO:
         ASSIGN
         ...
         .
       END.
        WHEN {&cda-ibs-th_devices_customer-display-adv} THEN DO:
          ASSIGN
        ...
        END.
       WHEN {&cda-ibs-th_devices_keyboard-type} THEN DO:
         ASSIGN
         ...
         .
       END.
       WHEN {&cda-ibs-th_devices_keyboard-layout-id} THEN DO:
         ASSIGN
       ...
       WHEN {&cda-ibs-th_devices_cashless-system} THEN DO:
         ASSIGN
       ...
       WHEN {&cda-ibs-th_devices_customer-display-type} THEN DO:
         ASSIGN
         ...
         .
       END.
       WHEN {&cda-ibs-th_devices_customer-display-port} THEN DO:
         ASSIGN
         ...
         .
       END.
      WHEN {&cda-ibs-th_devices_cctv-system} THEN DO:
         ASSIGN
         ...
         .
       END.
       WHEN {&cda-ibs-th_devices_cctv-system-address} THEN DO:
         ASSIGN
      ...
      END CASE.
    END.
    WHEN {&cda-ibs-th_fisreg} THEN DO:
      CASE v-entry:
        WHEN {&cda-ibs-th_fisreg_cash-drawer-level} THEN DO:
         ASSIGN
      ...
      END case.
    END.
    WHEN {&cda-ibs-th_rec-print} THEN DO:
      CASE v-entry:
        WHEN {&cda-ibs-th_rec-print_max-netto} THEN DO:
          ASSIGN
          ...
          .
        END.
        WHEN {&cda-ibs-th_rec-print_advert-text} THEN DO:
         ASSIGN
        ...
        END.
        WHEN {&cda-ibs-th_rec-print_cliche-lines} THEN DO:
          ASSIGN
        ...
        END.
        WHEN {&cda-ibs-th_rec-print_print-good-code} THEN DO:
             ASSIGN
             ...
             .
        END.
        when {&cda-ibs-th_rec-print_rmethod-type} then do:
         ASSIGN
        ...
        when {&cda-ibs-th_rec-print_rmethod-coeff} then do:
         ASSIGN
       ...
       when {&cda-ibs-th_rec-print_rcpt-ord-slip-print} then do:
         ASSIGN
       ...
       when {&cda-ibs-th_rec-print_rcpt-ord-alt-print} then do:
         ASSIGN
      ...
      END CASE.
    END.
    when {&cda-ibs-th_interface} then do:
      case v-entry:
       WHEN {&cda-ibs-th_interface_screen-type} THEN DO:
         ASSIGN
         ...
         .
       END.
       WHEN {&cda-ibs-th_interface_screen-layout-id} THEN DO:
         ASSIGN
...
DO on error undo, return error return-value:
 ...
 FOR EACH temp-widget WHERE
   ...
   if temp-widget.name_ = 'f-com-port' and 
      Locked_cash-desk.fr-type <> {&fr-type-prim08tk} then
   do:
     ASSIGN
       temp-widget.HANDLE_:VISIBLE = no .
...
.
  ...
  find first thbjattr_thbj-attr where
            thbjattr_thbj-attr.upper-prop-code = {&cda-ibs-th_fisreg}
        and thbjattr_thbj-attr.prop-code = {&cda-ibs-th_fisreg_cash-pay-list}
  ...
  find first thbjattr_thbj-attr where
            thbjattr_thbj-attr.upper-prop-code = {&cda-ibs-th_fisreg}
        and thbjattr_thbj-attr.prop-code = {&cda-ibs-th_fisreg_pay-names}
        and thbjattr_thbj-attr.obj-type = p-obj-type
        and thbjattr_thbj-attr.obj-code = p-obj-code  .
  assign
