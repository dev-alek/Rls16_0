...
Список истории курса валюты ЦБ
...
&Scoped-define INTERNAL-TABLES X_c-curr-bank temp-changes

/* Definitions for BROWSE br-ccur                                       */
&Scoped-define FIELDS-IN-QUERY-br-ccur mark-string(RECID(X_c-curr-bank), v-rid-list) usrfulnf(X_c-curr-bank.corr-user-name) X_c-curr-bank.corr-date string(X_c-curr-bank.corr-time, "HH:MM") X_c-curr-bank.curr-code X_c-curr-bank.exch-date
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-ccur
&Scoped-define SELF-NAME br-ccur
&Scoped-define QUERY-STRING-br-ccur FOR EACH X_c-curr-bank NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br-ccur OPEN QUERY {&SELF-NAME} FOR EACH X_c-curr-bank NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br-ccur X_c-curr-bank
&Scoped-define FIRST-TABLE-IN-QUERY-br-ccur X_c-curr-bank
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: X_c-curr-bank B "?" ? ub c-curr-bank
...
/* Query rebuild information for BROWSE br-ccur
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH X_c-curr-bank NO-LOCK INDEXED-REPOSITION.
     _END_FREEFORM
...
DO:
  ...
  if available X_c-curr-bank then do:
    { gbl/markstrn.i X_c-curr-bank v-rid-list }
...
{ gbl/brwrefre.i "v-doc-rec = recid(X_c-curr-bank). run OpenBr in this-procedure. reposition br-ccur to recid v-doc-rec no-error. v-doc-rec = ?. ~
              apply 'value-changed' to br-ccur. " }
{ gbl/srt-clmn.i
  &browse-name    = "br-ccur"
  &frame-name     = "{&frame-name}"
  &table-name     = "{&first-table-in-query-{&browse-name}}"
  &sort-clmn_1    = "X_c-curr-bank.exch-date"
