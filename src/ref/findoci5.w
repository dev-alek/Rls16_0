...
$Workfile: findoci5.w $
$Archive: ref/findoci5.w $

Карточка редактирования приходного акта погашения задолженности
...
&scop brief-view-tab-order  ~{&buttons-tab-order~} + ~
                           ...
                           "payer-type,payer-code,b-payer,payer-name,b-payer-view,naznach-plat," +  ~
...
&scop in-form-list    "F-curr-abbr,an-uchet-value,cel-nazn-value,cor-acc1-value,cor-acc-value,doc-date," + ~
                      "naznach-plat,payer-name,prn-doc-code,receiver-name,receiver-okpo,payer-sign1,receiver-sign1," + ~
...
&Scoped-Define ENABLED-FIELDS tt-fin-doc.prn-doc-code tt-fin-doc.doc-date ~
...
tt-fin-doc.contract-curr tt-fin-doc.cor-acc-value tt-fin-doc.an-uchet-value ~
...
&Scoped-Define ENABLED-OBJECTS B-exit b-quit B-tax B-cards B-print B-hist ~
B-Help RS-view B-obj B-receiver-view B-cor-acc1 B-cel-nazn ~
f-contract-curr-abbr B-contract-view B-cor-acc B-an-uchet f-rest-con-sum ~
B-currency B-calc B-payer B-payer-view
&Scoped-Define DISPLAYED-FIELDS tt-fin-doc.perm-date ~
tt-fin-doc.prn-doc-code tt-fin-doc.fin-doc-code tt-fin-doc.user-name-perm ~
...
tt-fin-doc.receiver-type tt-fin-doc.receiver-okpo tt-fin-doc.receiver-name ~
tt-fin-doc.receiver-code tt-fin-doc.str-podr-type tt-fin-doc.str-podr-code ~
tt-fin-doc.str-podr-name tt-fin-doc.cor-acc1-value ~
tt-fin-doc.cel-nazn-value tt-fin-doc.contract-curr tt-fin-doc.cor-acc-value ~
...
&Scoped-Define DISPLAYED-OBJECTS RS-view f-cor-acc1-descr f-cel-nazn-descr ~
f-contract-curr-abbr f-contract-prn-code f-contract-date f-contract-type ~
f-cor-acc-descr f-an-uchet-descr f-rest-con-sum F-curr-abbr F-debet ~
F-credit
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Приходный АПЗ - Получатель */
DO:
...
if v-cmp <> "":U
or  entry((if num-entries(locked_fin-doc.receiver-sign1, {&delim-par}) > 1
           then 2
           else 1)
           , locked_fin-doc.receiver-sign1, {&delim-par}
         ) <> tt-fin-doc.receiver-sign1
then do:
  message
...
run uf-set in this-procedure(
    input  ({&uf-findoci-p} + {&delim-par} + {&income-payoff})
    ,input  g#userid
    ,input RS-view
    ,input v-uf-Naim
...
or p-mode = {&add-copy} then do:
  run ref/finfnoco.p (
                ...
                ,input {&income-payoff} /*p-fin-doc-type*/
                ,input {&FDEDT_income_payoff} /*p-fin-ext-doc-type*/
                ,input p-obj-type
                ,input p-obj-code
...
if p-mode = {&add-def} and tt-fin-doc.contract-code = 0 then do:
  assign
  tt-fin-doc.payer-type = (if tt-fin-doc.payer-type = "":U then {&cmp} else tt-fin-doc.payer-type)
  .
end.
assign
v-head-position = (if num-entries(tt-fin-doc.receiver-sign1, {&delim-par}) > 1
                    then entry(1, tt-fin-doc.receiver-sign1, {&delim-par})
                    else "":U)
tt-fin-doc.receiver-sign1:label  = tt-fin-doc.receiver-sign1:label  + " - ":U +
                          v-head-position
tt-fin-doc.receiver-sign1 =   (if num-entries(tt-fin-doc.receiver-sign1, {&delim-par}) > 1
                                  then entry(2, tt-fin-doc.receiver-sign1, {&delim-par})
                                  else entry(1, tt-fin-doc.receiver-sign1, {&delim-par}))
.
...
tt-fin-doc.payer-sign1
tt-fin-doc.receiver-sign1
tt-fin-doc.receiver-sign1  =   v-head-position + {&delim-par} + tt-fin-doc.receiver-sign1
.
