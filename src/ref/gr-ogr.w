...
Добавление новой группы объектов
...
define variable vss-description as character no-undo init "Добавление новой группы объектов".
{ cmp/vssrevis.i }
{ cmp/str-glbl.i }
{ cmp/library.i  }
{ cmp/showinf.i      }
...
DEFINE VARIABLE v-name LIKE ub.grp-obj-price.name
...
DEFINE FRAME Dialog-Frame
     ...
     v-name AT ROW 4.25 COL 27 COLON-ALIGNED HELP
          ""
          LABEL "Название группы объектов" FORMAT "X(80)"
     SPACE(3.49) SKIP(1.74)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE
         TITLE "Добавление группы объектов  для ценообразования"
...
/* SETTINGS FOR FILL-IN v-name IN FRAME Dialog-Frame
   LIKE = ub.grp-obj-price.name-group EXP-LABEL EXP-FORMAT EXP-HELP EXP-SIZE      */
...
assign
  ...
  ub.grp-obj-price.gop-id       = next-value ( s-gop , {&db-name_schema} )
  ...
  ub.grp-obj-price.name-group       = v-name
  p-recid = recid(ub.grp-obj-price)
.
