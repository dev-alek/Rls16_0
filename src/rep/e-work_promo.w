...
&Scoped-Define ENABLED-OBJECTS rect-3 t-itog 
&Scoped-Define DISPLAYED-OBJECTS t-itog 
...
DEFINE FRAME F-Main
     t-itog AT ROW 1.75 COL 4.5 WIDGET-ID 42
...
&Scoped-define SELF-NAME t-itog
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL t-itog F-Frame-Win
ON VALUE-CHANGED OF t-itog IN FRAME F-Main /* Только итоги */
DO:
  assign t-itog .
END.
...
define variable     det-mode            as integer      no-undo init 0.
    do:
        run rep/r-work_promo.p (input my-handle,
                                input t-itog
                               ).
    end.
end procedure.
