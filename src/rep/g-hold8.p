...
define variable vss-workfile    as character no-undo init "$Workfile: g-hold8.p $":U .
define variable vss-archive     as character no-undo init "$Archive: rep/g-hold8.p $":U .
