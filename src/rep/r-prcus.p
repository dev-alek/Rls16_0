...
$Workfile: r-prcus.p $
$Archive: rep/r-prcus.p $

Прайс-лист по группам покупатей
...
define variable vss-workfile    as character no-undo init "$Workfile: r-prcus.p $":U .
define variable vss-archive     as character no-undo init "$Archive: rep/r-prcus.p $":U .
define variable vss-description as character no-undo init "Прайс-лист по группам покупатей".
{ cmp/vssrevis.i }
{ cmp/str-glbl.i }
{ gbl/cur-time.i }
{ cmp/r-pril.i   }
...
v-Reportname = "ПРАЙС-ЛИСТ по группам покупателей"  .
...
field bgr-id  as decimal
field bgr-db-num   as decimal
