...
Отчет по межфирменным операциям - динамика закупки  (закладка № 2)
...
&Scoped-Define ENABLED-OBJECTS RECT-6 RECT-5 dat RADIO-SET-1
&Scoped-Define DISPLAYED-OBJECTS dat RADIO-SET-1
...
------------------------------------------------------------------------------*/
assign frame {&frame-name} dat RADIO-SET-1 .
...
if x-SET_val_TYPE = 1 then ReportHeader = "Цены указаны в: {&abbr_rublyah}" + chr(10).
