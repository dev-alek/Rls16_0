...
define variable vss-workfile    as character no-undo init "$Workfile: g-slg-g.p $":U .
define variable vss-archive     as character no-undo init "$Archive: rep/g-slg-g.p $":U .
