...
Процедура подсчета фактической суммы продажных цен (со структурой налогов) для товара или услуги по партиям для строки документа.
...
vat-pc
slt-pc
sum-base - сумма со всеми налогами
sum-rubl - сумма со всеми налогами
vat-base
vat-rubl
slt-base
slt-rubl
