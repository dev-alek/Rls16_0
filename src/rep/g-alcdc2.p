...
define variable vss-workfile    as character no-undo init "$Workfile: g-alcdc2.p $":U .
define variable vss-archive     as character no-undo init "$Archive: rep/g-alcdc2.p $":U .
