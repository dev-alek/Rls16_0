...
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-3 MainTypes Rs-name 
&Scoped-Define DISPLAYED-OBJECTS MainTypes Rs-name 
...
------------------------------------------------------------------------------*/
    ...
    ChosedType = integer(MainTypes:screen-value in frame {&FRAME-NAME}).
