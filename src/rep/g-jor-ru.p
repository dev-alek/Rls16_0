...
def var vss-workfile    as character no-undo init "$Workfile: g-jor-ru.p $":U .
def var vss-archive     as character no-undo init "$Archive: rep/g-jor-ru.p $":U .
