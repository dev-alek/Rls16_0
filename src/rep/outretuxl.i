...
Обработка данных для заполнения шаблона расходной накладной с упаковками
...
&global-define outretxl-it_qntyup       "it_qntyup":U
...
&global-define outretxl-f_PassFname     "f_PassFname":U
&global-define outretxl-f_AcceptFname   "f_AcceptFname":U
...
:
    ...
    put stream excel-line unformatted
        ...
        {&tabulation}   buf_temp_line-data.qntyup
        {&tabulation}   buf_temp_line-data.qntycart
