...
&Scoped-Define ENABLED-OBJECTS type-pos 
&Scoped-Define DISPLAYED-OBJECTS type-pos 
...
DEFINE FRAME F-Main
     type-pos AT ROW 1.95 COL 16 COLON-ALIGNED WIDGET-ID 4
...
/*------------------------------------------------------------------------------
  ...
  Notes:
------------------------------------------------------------------------------*/
/* define variable reportname as char initial " «Количество работающих ККМ на АЗК/АЗС за период» " no-undo. */
