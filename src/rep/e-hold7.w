...
Отчет по межфирменным операциям - динамика списани  (закладка № 2)
...
def var vss-description as character no-undo init "Отчет по межфирменным операциям - динамика списани  (закладка № 2)".
{ cmp/vssrevis.i }
...
ReportNAme = "Динамика списания за "  + String(dat) + " год." .
