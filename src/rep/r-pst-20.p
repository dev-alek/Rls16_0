...
define variable vss-workfile    as character no-undo init "$Workfile: r-pst-20.p $":U .
define variable vss-archive     as character no-undo init "$Archive: rep/r-pst-20.p $":U .
