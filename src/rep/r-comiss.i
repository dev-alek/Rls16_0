...
Оборотная ведомость по товарам, принятым на комиссию
...
*/
/*
Отчет о комиссионном вознаграждении
Оборотная ведомость по товарам, принятым на комиссию
Количество (1) берется из консигнации-закупки
продажная  (5) рассчитывается как продажная_цена консигнации-выгоды  +  продажная_цена консигнации-закупки
Комиссия   (8) рассчитывается как продажная_цена консигнации-выгоды
...
define buffer buf_aht-stk-line  for ub.aht-stk-line .
 ...
 find last  ub.aht-stk-line where
                  ...
                  and   ub.aht-stk-line.sum-type   = "c"     /* тип приобретения */
 ...
 find last  buf_aht-stk-line where
                  ...
                  and   buf_aht-stk-line.sum-type   = "b"     /* тип приобретения */
                        use-index category no-lock no-error.
        ...
        then do:
            if  tprintrubl  then
                  assign
                        ...
                        ostatok-start[5]  = ostatok-start[5] + round( buf_aht-stk-line.crsa-sum-rubl ,2) + round( ub.aht-stk-line.crsa-sum-rubl ,2)        /* смма в прод ценах       5  */
                        ostatok-start[6]  = ostatok-start[6] + round( buf_aht-stk-line.crsa-vat-rubl ,2) + round( ub.aht-stk-line.crsa-vat-rubl ,2)      /* НДС  в прод ценах       6  */
                        ostatok-start[7]  = ostatok-start[7] + round( buf_aht-stk-line.sale-discnt-rubl ,2)   /* Скидка в ценах док      7  */
                        ostatok-start[8]  = ostatok-start[8] + round( buf_aht-stk-line.crsa-sum-rubl ,2)   /* смма в док ценах        8  */
                        ostatok-start[9]  = ostatok-start[9] + round( buf_aht-stk-line.crsa-vat-rubl ,2)      /* НДС  в док ценах        9  */
                        ostatok-start[10] = ostatok-start[10] + round( buf_aht-stk-line.crsa-slt-rubl ,2)      /* НсП в ценах док         10 */
                        .
              else
                  assign
                        ostatok-start[1]  = ostatok-start[1] + round( ub.aht-stk-line.fact-qnty,3)            /* факт количество         1  */
                        ...
                        ostatok-start[4]  = ostatok-start[4] + 0                                          /* цены посредника         4  */
                        ostatok-start[5]  = ostatok-start[5] + round( buf_aht-stk-line.crsa-sum-base ,2) + round( ub.aht-stk-line.crsa-sum-base ,2)     /* смма в прод ценах       5  */
                        ostatok-start[6]  = ostatok-start[6] + round( buf_aht-stk-line.crsa-vat-base ,2) + round( ub.aht-stk-line.crsa-vat-base ,2)     /* НДС  в прод ценах       6  */
                        ostatok-start[7]  = ostatok-start[7] + round( buf_aht-stk-line.sale-discnt-base ,2)   /* Скидка в ценах док      7  */
                        ostatok-start[8]  = ostatok-start[8] + round( buf_aht-stk-line.crsa-sum-base ,2)       /* смма в док ценах        8  */
                        ostatok-start[9]  = ostatok-start[9] + round( buf_aht-stk-line.crsa-vat-base ,2)      /* НДС  в док ценах        9  */
                        ostatok-start[10] = ostatok-start[10] + round( buf_aht-stk-line.crsa-slt-base ,2)      /* НсП в ценах док         10 */
                  .
             end.
/* на конец -------------------------------------------------------------------------------------------------------------*/
 find last  ub.aht-stk-line where
 ...
 find last  buf_aht-stk-line where
        ...
        if available ub.aht-stk-line and
           available buf_aht-stk-line then do:
            if  tprintrubl  then
                  assign
                        ostatok-end[1]  = ostatok-end[1] + round( ub.aht-stk-line.fact-qnty,3)            /* факт количество         1  */
                        ...
                        ostatok-end[5]  = ostatok-end[5] + round( buf_aht-stk-line.crsa-sum-rubl ,2) + round( ub.aht-stk-line.crsa-sum-rubl ,2)       /* смма в прод ценах       5  */
                        ostatok-end[6]  = ostatok-end[6] + round( buf_aht-stk-line.crsa-vat-rubl ,2) + round( ub.aht-stk-line.crsa-vat-rubl ,2)     /* НДС  в прод ценах       6  */
                        ostatok-end[7]  = ostatok-end[7] + round( buf_aht-stk-line.sale-discnt-rubl ,2)   /* Скидка в ценах док      7  */
                        ostatok-end[8]  = ostatok-end[8] + round( buf_aht-stk-line.crsa-sum-rubl ,2)    /* смма в док ценах        8  */
                        ostatok-end[9]  = ostatok-end[9] + round( buf_aht-stk-line.crsa-vat-rubl ,2)      /* НДС  в док ценах        9  */
                        ostatok-end[10] = ostatok-end[10] + round( buf_aht-stk-line.crsa-slt-rubl ,2)      /* НсП в ценах док         10 */
                        .
              else
                  assign
                        ostatok-end[1]  = ostatok-end[1] + round( ub.aht-stk-line.fact-qnty,3)             /* факт количество         1  */
                        ...
                        ostatok-end[4]  = ostatok-end[4] +  0                                          /* цены посредника         4  */
                        ostatok-end[5]  = ostatok-end[5] +  round( buf_aht-stk-line.crsa-sum-base ,2) + round( ub.aht-stk-line.crsa-sum-rubl     , 2)       /* смма в прод ценах       5  */
                        ostatok-end[6]  = ostatok-end[6] +  round( buf_aht-stk-line.crsa-vat-base ,2) + round( ub.aht-stk-line.crsa-vat-base , 2)     /* НДС  в прод ценах       6  */
                        ostatok-end[7]  = ostatok-end[7] +  round( buf_aht-stk-line.sale-discnt-base ,2)   /* Скидка в ценах док      7  */
                        ostatok-end[8]  = ostatok-end[8] +  round( buf_aht-stk-line.crsa-sum-base ,2)    /* смма в док ценах        8  */
                        ostatok-end[9]  = ostatok-end[9] +  round( buf_aht-stk-line.crsa-vat-base ,2)      /* НДС  в док ценах        9  */
                        ostatok-end[10] = ostatok-end[10] + round( buf_aht-stk-line.crsa-slt-base ,2)      /* НсП в ценах док         10 */
                  .
             end.
...
&endif
    ...
    /* приход */
              ...
              assign
                     ...
                     prih[8 ]   = prih[8]   +  if tprintrubl then ub.aht-ot-line.crsa-sum-rubl else  ub.aht-ot-line.crsa-sum-base /* смма в прод ценах       5  */
    ...
    /* расход */
              ...
              when {&tdedt_spi_vnesh}      then
              do:
/*                message "Продажная" ub.aht-ot-line.crsa-sum-rubl  skip
                        "НсП crsa" ub.aht-ot-line.crsa-slt-rubl
                        "НсП sale" ub.aht-ot-line.sale-slt-rubl
                        .
                        */
                assign
                    rash[5 ]   = rash[5]   +  if tprintrubl then ub.aht-ot-line.crsa-sum-rubl else  ub.aht-ot-line.crsa-sum-base /* смма в прод ценах       5  */
                    ...
                    rash[8 ]   = rash[8]   +  if tprintrubl then ub.aht-ot-line.crsa-sum-rubl - ub.aht-ot-line.sale-slt-rubl  else  ub.aht-ot-line.crsa-sum-base - ub.aht-ot-line.sale-slt-base /* смма в док ценах        8  */
    ...
    /* касса */
              ...
              do:
                  assign
                    ...
                    kassa[8 ]   = kassa[8]   +  if tprintrubl then ub.aht-ot-line.crsa-sum-rubl - ub.aht-ot-line.crsa-slt-rubl else  ub.aht-ot-line.crsa-sum-base - ub.aht-ot-line.crsa-slt-base /* смма в док ценах        8  */
  ...
  /* инвентаризация */
          when       {&tdedt_inv}            or
          when       {&tdedt_chg_purch_code} or
          when       {&tdedt_peresort}       then
              do:
              assign
                inv[5 ]   = inv[5]   +  if tprintrubl then ub.aht-ot-line.crsa-sum-rubl else  ub.aht-ot-line.crsa-sum-base /* смма в прод ценах       5  */
                inv[6 ]   = inv[6]   +  if tprintrubl then ub.aht-ot-line.crsa-vat-rubl else  ub.aht-ot-line.crsa-vat-base /* НДС  в прод ценах       6  */
                inv[7 ]   = inv[7]   +  if tprintrubl then ub.aht-ot-line.sale-discnt-rubl else  ub.aht-ot-line.sale-discnt-base /* Скидка в ценах док      7  */
                inv[8 ]   = inv[8]   +  if tprintrubl then ub.aht-ot-line.crsa-sum-rubl else  ub.aht-ot-line.crsa-sum-base /* смма в док ценах        8  */
          ...
          when       {&tdedt_corr_acc_price} then
              do:
                 assign
                    ...
                    overturn[8 ]   = overturn[8]   +  if tprintrubl then ub.aht-ot-line.crsa-sum-rubl else  ub.aht-ot-line.crsa-sum-base /* смма в док ценах        8  */
