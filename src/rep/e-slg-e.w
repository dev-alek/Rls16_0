...
Оперативный отчет по закончившимся наименованиям (закладка № 2)
...
def var vss-description as character no-undo init "Оперативный отчет по закончившимся наименованиям (закладка № 2)".
{ cmp/vssrevis.i }
...
&Scoped-Define ENABLED-OBJECTS RECT-6 NullStr
&Scoped-Define DISPLAYED-OBJECTS NullStr
