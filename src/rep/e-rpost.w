...
&Scoped-Define ENABLED-OBJECTS RECT-7 RECT-6 RECT-5 RECT-8 RECT-9 RADPost ~
PostName SortType Tog-obj Cli-art Classify type-stor Show-vat-Cost Showcost ~
Showsale ShowZero-2 ShowZero SumsOnly 
&Scoped-Define DISPLAYED-OBJECTS RADPost PostName SortType Tog-obj Cli-art ~
Classify type-stor Show-vat-Cost Showcost Show-vat-Sale Showsale ShowZero-2 ~
ShowZero SumsOnly 
...
/* SETTINGS FOR TOGGLE-BOX Show-vat-Sale IN FRAME F-Main
   NO-ENABLE                                                            */
ASSIGN 
...
assign Showsale.
  if showsale then DO:
                  ...
                  enable Show-vat-Sale  with frame {&frame-name}.
                  End.
              else do:
                                     Show-vat-Sale = no.
                   enable  type-stor with frame {&frame-name}.
                   disable Show-vat-Sale  with frame {&frame-name} .
                    display Show-vat-Sale  with frame {&frame-name}.
