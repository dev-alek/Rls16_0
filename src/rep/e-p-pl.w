...
Анализ цен поставщиков (закладка № 2)
...
&Scoped-Define ENABLED-OBJECTS RECT-7 PostName RADPost T-null
&Scoped-Define DISPLAYED-OBJECTS PostName RADPost T-null
...
------------------------------------------------------------------------------*/
assign frame {&frame-name} PostName  RADPost t-null  .
