...
Оборотная ведомость по поставшикам по архивам (закладка № 2)
...
&Scoped-Define ENABLED-OBJECTS RECT-6 RECT-7 RECT-5 RECT-8 RECT-9 RADPost ~
PostName SortType Tog-obj Showcost Classify Showsale type-stor t-in ~
SumsOnly ShowParts ShowZero-2 Cli-art
&Scoped-Define DISPLAYED-OBJECTS RADPost PostName SortType Tog-obj Showcost ~
Classify Showsale type-stor t-in SumsOnly ShowParts ShowZero-2 ShowZero ~
Cli-art
...
assign Showsale.
  if showsale then DO:
                  ...
                  End.
              else enable type-stor with frame {&frame-name}.
END.
...
------------------------------------------------------------------------------*/
assign frame {&frame-name} type-stor
