...
Почасовая статистика розничных продаж по КОЛИЧЕСТВУ ПОКУПОК
...
&Scoped-Define ENABLED-OBJECTS T-dis-card BR-dis-card-type RS-OPTION
&Scoped-Define DISPLAYED-OBJECTS T-dis-card RS-dis-card RS-OPTION
...
assign
    g#rep-tblname = ""
    g#rep-tblrid = -125
    g#rep-updflds = "Почасовая статистика (ПОКУПКИ) " +
                                string(X-date-start) + ".." + string( X-date-end ) .
*/
    if vxl then
