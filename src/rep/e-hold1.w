...
Отчет по межфирменным операциям - динамика продаж  (закладка № 2)
...
------------------------------------------------------------------------------*/
  ...
  /* !!!!!!!!!!!!!!!!!!!!!!!!!! */
/*  run holdattr-write in this-procedure (input v-cat-code ,input {&hold-attr-begin-date} ,input string('01/06/2002')) no-error .*/
