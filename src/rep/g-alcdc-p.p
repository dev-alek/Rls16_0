...
$Workfile: g-alcdc-p.p $
$Archive: rep/g-alcdc-p.p $
...
define variable vss-workfile    as character no-undo init "$Workfile: g-alcdc-p.p $":U .
define variable vss-archive     as character no-undo init "$Archive: rep/g-alcdc-p.p $":U .
...
run rep/d-report.w
    ( input parParentProc ,                                                     /* 0 */
      input 'rep/e-alcdc-p.w',                                                  /* 1 RUN */
      input "Приложение 12 - Пиво",                                             /* 2 Title */
      input 2,                                                                  /* 3 dates */    
