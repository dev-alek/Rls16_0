...
Печатная форма ОП-12. АКТ О РЕАЛИЗАЦИИ ГОТОВЫХ ИЗДЕЛИЙ КУХНИ
...
&scop P-X1 153        /*длина внутренней линии от начала  2-й колонки до начала  5-й*/
&scop P-X2 75         /*длина внутренней линии от начала  5-й колонки до начала  7-й*/
&scop P-C2-S    {&P-S} + 7
&scop P-C3-S    {&P-S} + 14
&scop P-C4-S    {&P-S} + 63
&scop P-C5-S    {&P-S} + 76
...
&scop P-C8-S    {&P-S} + 130
&scop P-C9-S    {&P-S} + 149
&scop P-C10-S   {&P-S} + 168
&scop P-C11-S   {&P-S} + 193
&scop P-E       {&P-S} + 193
...
&scop P1-C6-S  {&P1-S} + 40
&scop P1-C7-S  {&P1-S} + 61
&scop P1-C8-S  {&P1-S} + 81
&scop P1-E     {&P1-S} + 101
&scop P1-EXT1  178              /*Количество символов для суммы прописью*/
...
find first clients no-lock where clients.obj-type = {&cmp} and clients.obj-code = t-doc.host-code .
{ rep/r-cliprp.i }
assign
...
/*---S----- Шапка документа ------------------------*/
put stream Out-Stream  skip string( "Страница " + string( PAGE-NUMBER( Out-Stream ), ">>9" ) ) format "X(13)" at right-field( {&P-E}, 13) .
put stream Out-Stream
  skip    space({&P-S}) v-single-line format  "X(19)"             at 180
  skip    space({&P-S}) "| "                                      at 180
                  {&g___code}                               at 188
                  "|"                                       at {&P-E}
  skip    space({&P-S}) "Форма по ОКУД" format "X(14)"            at 166
                  "| "                                      at 180
                  "0330512"
                  "|"                                       at {&P-E}
  skip    space({&P-S}) "Организация:                         "
             v-organization             format "X(100)"
             "по ОКПО"                  format "X(7)"       at 172
             "| "                                           at 180
             t-okpo                     format "X(16)" "|"  at {&P-E}
  skip    space({&P-S}) "Струрное подразделение:              "
...
put stream Out-Stream
    skip space({&P-S})
      ...
      ( if t-doc.status_ <> {&fact}  then string( "Статус документа: " + t-doc.status_ + " " + string( t-doc.flag_, "+/-" ) ) else " " )   at 150 format "X(30)"
.
...
put stream Out-Stream
   ...
   skip space({&P-S})
     ...
     "Номер"
     ":" at {&P-C3-S}
     "Готовое изделие " at center-field( {&P-C3-S}, {&P-C5-S}, 17)
     ":" at {&P-C5-S}
     "Реализовано" at center-field( {&P-C5-S}, {&P-C10-S}, 15)
     ":" at {&P-C10-S}
     "|" at {&P-E}
   skip space({&P-S})
     "| по "
     ...
     "каль-"
     ":" at {&P-C3-S}
     v-single-line format "X({&P-X1})" at ({&P-C3-S} + 1)
     ":" at {&P-C10-S}
     "|" at {&P-E}
   skip
     space({&P-S})
     ...
     ":" at {&P-C6-S}
     "По ценам продажи" at center-field( {&P-C6-S}, {&P-C8-S}, 17)
     ":" at {&P-C8-S}
     "По учетным ценам" at center-field( {&P-C8-S}, {&P-C10-S}, 17)
     ":" at {&P-C10-S}
     "Примечание" at center-field( {&P-C10-S}, {&P-E}, 10)
     "|" at {&P-E}
   skip space({&P-S})
     "|рядку"
     ":"                  at {&P-C2-S}
     ...
     ":"                  at {&P-C5-S}
     ":"                  at {&P-C6-S}
     v-single-line format "X({&P-X2})" at ({&P-C6-S} + 1)
     ":"                  at {&P-C10-S}
     "|"                  at {&P-E}
   skip space({&P-S})
     "|"
     ...
     ":"                  at {&P-C5-S}
     ":"                  at {&P-C6-S}
     "Цена, {&abbr_rub}.{&abbr_kop}" at center-field( {&P-C6-S}, {&P-C7-S}, 17)
     ":"                  at {&P-C7-S}
     "Сумма, {&abbr_rub}.{&abbr_kop}" at center-field( {&P-C7-S}, {&P-C8-S}, 17)
     ":"                  at {&P-C8-S}
     "Цена, {&abbr_rub}.{&abbr_kop}" at center-field( {&P-C8-S}, {&P-C9-S}, 17)
     ":"                  at {&P-C9-S}
     "Сумма, {&abbr_rub}.{&abbr_kop}" at center-field( {&P-C9-S}, {&P-C10-S}, 17)
     ":"                  at {&P-C10-S}
     "|"                  at {&P-E}
   skip space({&P-S})
     "|"
...
/*    t-doc.doc-qnty  @ v-need-qnty*/
  ...
  put stream Out-Stream
    skip
     space({&P1-S}) "СПРАВКА: Израсходовано на приготовление блюд" skip
     space({&P1-S}) "   специй                % к обороту на сумму ______________________  руб ____ коп"  skip
     space({&P1-S}) "   соли                  % к обороту на сумму ______________________  руб ____ коп"  skip
     space({&P1-S}) "                                       Итого  ______________________  руб ____ коп"  skip
     space({&P1-S}) "Члены комиссии:"  skip
     space({&P1-S}) "Заведующий производством (бригадир)"
    ...
    skip
      ...
      "расшифровка подписи"                     at center-field( {&P1-C8-S}, {&P1-E}, 19)
    skip (2)
          space({&P1-S})   "Выручка кассы  " caps(substring(s1, 1, {&P1-EXT1})) format "X({&P1-EXT1})"
    skip  space({&P1-S})   "Стоимость реализованных изделий, указанная в настоящем акте, соответствует кассовым чекам."
    skip
     space({&P1-S}) "Кассир "
      v-underline format "X(19)"                at {&P1-C7-S}
      v-underline format "X(30)"                at {&P1-C8-S}
