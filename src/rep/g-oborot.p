...
define variable vss-workfile    as character no-undo init "$Workfile: g-oborot.p $":U .
define variable vss-archive     as character no-undo init "$Archive: rep/g-oborot.p $":U .
