...
define variable vss-workfile    as character no-undo init "$Workfile: g-ob-prd.p $":U .
define variable vss-archive     as character no-undo init "$Archive: rep/g-ob-prd.p $":U .
