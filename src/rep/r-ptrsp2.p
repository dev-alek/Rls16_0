...
:
  ...
  run rep/rpychk0.p ( input "r-ptrsp2"
                     ...
                     ,input ? /*p-date-from*/
                     ,input ? /*p-date-to*/
                     ,input bf_shift-obj.shift-date /*p-shift-date-from*/
                     ,input ? /*p-shift-date-to*/
                     ,input bf_shift-obj.shift-num /*X-shift-start*/
                     ,input ? /*X-shift-end*/
                     ,input ? /*p-inkas-code*/
                     ).
...
/*        end. /*if error-status :error or*/*/
      ...
      assign
        tt_line.sum-sale = tt_line.sum-sale   +  (if v-curr-r-b = {&r-b-rubl}
                                                  or v-base-code = 0
