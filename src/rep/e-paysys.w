...
&Scoped-Define ENABLED-OBJECTS RECT-7 EDITOR-3 RADIO-SET-3 f-sum 
&Scoped-Define DISPLAYED-OBJECTS EDITOR-3 RADIO-SET-3 f-sum 
...
&Scoped-define SELF-NAME f-sum
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL f-sum s-object
ON LEAVE OF f-sum IN FRAME F-Main /* Ограничение по сумме */
DO:
    assign f-sum .
  END.
