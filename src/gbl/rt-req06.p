...
define variable vss-workfile    as character no-undo init "$Workfile: rt-req06.p $":U .
define variable vss-archive     as character no-undo init "$Archive: gbl/rt-req06.p $":U .
