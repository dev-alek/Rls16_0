...
define variable vss-workfile    as character no-undo init "$Workfile: gtcurobj.p $":U .
define variable vss-archive     as character no-undo init "$Archive: gbl/gtcurobj.p $":U .
