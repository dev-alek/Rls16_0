...
Сканирует все объекты и фирмы и помещает их во временные таблицы
...
Этот файл не следует использовать для новых программ.
Он был написан в связи с тем, что в таблице clients отсутствовало поле фирмы
Удобно в случаях, когда необходимо отобрать все объекты,
относящиеся к определенной фирме
