...
$Workfile: macroexl.p $
$Archive: gbl/macroexl.p $

Программа запуска excel и создания макро

Автор: Перваков Михаил Сергеевич
Дата создания: 10/04/01
...
define variable vss-workfile    as character no-undo init "$Workfile: macroexl.p $":U .
define variable vss-archive     as character no-undo init "$Archive: gbl/macroexl.p $":U .
define variable vss-description as character no-undo init "Программа запуска excel и выполнения программы макро".
{ cmp/vssrevis.i }
{ cmp/str-glbl.i }
