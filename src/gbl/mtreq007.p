...
define variable vss-workfile    as character no-undo init "$Workfile: mtreq007.p $":U .
define variable vss-archive     as character no-undo init "$Archive: gbl/mtreq007.p $":U .
...
:
  ...
  :
    ...
    then do:
      assign
        p-error-message = substitute( "Ошибка удаления строки чека &6.&1&2&1&3&1&4&1&5"
                                    , {&new-line}
                                    , return-value
