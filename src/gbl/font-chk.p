...
define variable vss-workfile    as character no-undo init "$Workfile: font-chk.p $":U .
define variable vss-archive     as character no-undo init "$Archive: gbl/font-chk.p $":U .
