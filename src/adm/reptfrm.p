...
define variable vss-workfile    as character no-undo initial "$Workfile: reptfrm.p $":U .
define variable vss-archive     as character no-undo initial "$Archive: adm/reptfrm.p $":U .
