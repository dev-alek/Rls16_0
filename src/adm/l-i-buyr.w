...
$Workfile: l-i-buyr.w $
$Archive: adm/l-i-buyr.w $

Окно входа в экран покупател
...
define variable vss-workfile    as character no-undo init "$Workfile: l-i-buyr.w $":U .
define variable vss-archive     as character no-undo init "$Archive: adm/l-i-buyr.w $":U .
define variable vss-description as character no-undo init "Окно входа в Экран покупателя".
{ cmp/vssrevis.i }
{ cmp/str-glbl.i }
{ cmp/showinf.i  }
{ adm/auto-def.i new }
