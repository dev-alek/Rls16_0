...
Запрос строки для поиска и фильтрации в правах
...
define variable vss-description as character no-undo init "Запрос строки для поиска и фильтрации в правах".
{ cmp/vssrevis.i }
{ cmp/str-glbl.i }
{ cmp/library.i  }
{ cmp/showinf.i  }
...
&Scoped-Define ENABLED-OBJECTS B-exit b-quit b-clear b-help v-name
...
DEFINE FRAME Dialog-Frame
     ...
     v-name AT ROW 2.5 COL 11.5  WIDGET-ID 2
     SPACE(0.99) SKIP(0.37)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE
         TITLE "Поиск в правах (в названиях и описаниях прав и темах)"
...
------------------------------------------------------------------------------*/
  ...
  ENABLE B-exit b-quit b-clear b-help v-name
      WITH FRAME Dialog-Frame.
