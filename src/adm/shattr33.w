...
Редактирование опций настроек работы с МЦ

Автор: Гридчина Полина Дмитриевна
Дата создания: 08/28/08
Author: Polina Gridchina
Creation date: 08/28/08
...
define variable vss-description as character no-undo init "Редактирование опций настроек работы с МЦ".
{ cmp/vssrevis.i }
{ gbl/waitfram.i }
{ cmp/str-glbl.i }
{ cmp/library.i }
...
&Scoped-Define ENABLED-OBJECTS B-exit b-quit B-Help t-clsfact t-prsdoc
&Scoped-Define DISPLAYED-OBJECTS t-clsfact t-prsdoc
...
DEFINE FRAME Dialog-Frame
     ...
     t-clsfact AT ROW 2.77 COL 2.5
     t-prsdoc AT ROW 4 COL 2.5 WIDGET-ID 8
     SPACE(46.24) SKIP(0.70)
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Настройки МЦ */
DO:
...
{ gbl/rethndmv.i v-tab-order underline-tb "APPLY 'CHOOSE' TO b-exit in frame {&frame-name}." }
  ...
  IF p-mode = {&UPDATE} THEN DO:
    FIND FIRST LOCKED_thbj-attr EXCLUSIVE-LOCK WHERE
        ...
        AND   LOCKED_thbj-attr.upper-prop-code = {&attr-wthdoc}
...
------------------------------------------------------------------------------*/
  DISPLAY t-clsfact t-prsdoc
      WITH FRAME Dialog-Frame.
  ENABLE B-exit b-quit B-Help t-clsfact t-prsdoc
      WITH FRAME Dialog-Frame.
...
FOR EACH thbjattr_thbj-attr:
  ...
  IF v-entry = {&attr-wthdoc_prsdoc} THEN DO:
    ASSIGN
    ...
    .
  END.
  IF v-entry = {&attr-wthdoc_clsfact} THEN DO:
    ASSIGN
...
v-tab-order = "f-stfactpref,f-numsfact,t-clsfact,f-inwpcode".
/* ASSIGN                                                                                */
/* wthdoc_objdflt-cd:LIST-ITEMS IN FRAME {&FRAME-NAME} = {&comma-char} + {&cd-type-codes-real}. */
DISPLAY
