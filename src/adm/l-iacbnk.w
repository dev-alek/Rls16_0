...
$Workfile: l-iacbnk.w $
$Archive: adm/l-iacbnk.w $

Окно входа в СЭИКБ

Автор: Бахтадзе Наталья Викторовна
Дата создания: 06/18/05
...
define variable vss-workfile    as character no-undo init "$Workfile: l-iacbnk.w $":U .
define variable vss-archive     as character no-undo init "$Archive: adm/l-iacbnk.w $":U .
define variable vss-description as character no-undo init "Окно входа в СЭИКБ".
{ cmp/vssrevis.i }
{ cmp/str-glbl.i }
{ adm/auto-def.i new }
