...
Выбор параметров для выгрузки счетов-фактур
...
&Scoped-Define ENABLED-OBJECTS RECT-1 Btn_OK Btn_Cancel b-help date_from ~
date_to rs-1 bt-sel-host
&Scoped-Define DISPLAYED-OBJECTS date_from date_to rs-1 ed-object
...
DO:
    ...
    :
      assign
        v-obj-list = v-obj-list + (if v-obj-list <> "" then {&new-line} else "" )
...
------------------------------------------------------------------------------*/
  do on error undo, return error :
    ...
    assign rs-1  .
    display rs-1  with frame {&frame-name}  .
  end.
END PROCEDURE.
