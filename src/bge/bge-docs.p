...
define variable vss-workfile    as character no-undo init "$Workfile: bge-docs.p $":U .
define variable vss-archive     as character no-undo init "$Archive: bge/bge-docs.p $":U .
