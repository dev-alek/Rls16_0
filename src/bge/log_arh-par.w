...
DEFINE FRAME Dialog-Frame
     ...
     b-dir-sel AT ROW 2.5 COL 78
     v-directory AT ROW 2.5 COL 3 
     SPACE(2) SKIP(1)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE
         TITLE "Параметры архивации логов"
...
DEFINE INPUT PARAMETER p-param-list AS CHARACTER NO-UNDO.
  ...
  run gbl/lock-prc.p
    ...
    ,input ""
    ,input (
    "Сохранение параметров импорта из ААЗС "
    )
    ,input yes
  ...
  FIND FIRST buf_schedule-attr NO-LOCK WHERE
    ...
    and buf_schedule-attr.attr-code = ({&attr-schd-free-id} + {&delim-par} + 'imp-aazs') NO-ERROR.
  ...
  DO:
    MESSAGE
      substitute("Уже есть расписание сохранения параметров импорта из ААЗС  для БД &1&2" +
      "номер расписания &3"
