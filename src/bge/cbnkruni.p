...
define variable vss-workfile    as character no-undo init "$Workfile: cbnkruni.p $":U .
define variable vss-archive     as character no-undo init "$Archive: bge/cbnkruni.p $":U .
