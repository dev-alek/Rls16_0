...
define variable vss-workfile    as character no-undo init "$Workfile: shd-ahz.p $":U .
define variable vss-archive     as character no-undo init "$Archive: bge/shd-ahz.p $":U .
