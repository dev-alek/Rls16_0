...
Выбор параметров для экспорта по расписанию.
...
tb-cst-code tb-chk-pay-code tb-parts tb-pay-desk tb-not-fact-docs ~
...
&Scoped-define SELF-NAME tb-exp-s-f
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tb-exp-s-f Dialog-Frame
ON VALUE-CHANGED OF tb-exp-s-f IN FRAME Dialog-Frame /* Счета-фактуры */
DO:
    assign
        tb-exp-s-f
    .
